...
Qualcomm Proprietary
  ...
  $Header: //components/rel/rfdevice_qtuner.mpss/1.32/api/rfdevice_qtuner_typedef.h#1 $
  $DateTime: 2021/03/09 04:14:45 $
  $Author: pwbldsvc $
 
when         who   what, where, why
--------   ---   --------------------------------------------------------------- 
06/10/15   yb    Added API for reading tune code and NVG status
...
typedef boolean (*qtuner_get_tune_code_fn_ptr)(rfdevice_comm_intf *rfdevice_comm,
	                                       rf_buffer_intf* script);

typedef boolean (*qtuner_get_nvg_status_fn_ptr)(rfdevice_comm_intf *rfdevice_comm,
	                                       rf_buffer_intf* script);
...
{ 
  ...
  /* Get tune code */
  qtuner_get_tune_code_fn_ptr get_tune_code;
  /* Get NVG status */
  qtuner_get_nvg_status_fn_ptr get_nvg_status;
