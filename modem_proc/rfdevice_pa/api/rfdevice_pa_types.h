...
Copyright (c) 2011-20 by Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/rfdevice_pa.mpss/1.32/api/rfdevice_pa_types.h#1 $

when       who     what, where, why
-------------------------------------------------------------------------------
05/29/20   vp      Added support for QPA2625
08/16/16   dbc     Add rffev20_usid_p3 flag to rfdevice_pa_info_type to support
                   RFFE v2.0 burst procedure for programming the USID 
...
typedef enum
{
  ...
  RFDEVICE_PA_SET_BIAS_EDGE_DATA,
