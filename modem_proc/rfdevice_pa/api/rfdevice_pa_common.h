...
$Header: //components/rel/rfdevice_pa.mpss/1.32/api/rfdevice_pa_common.h#1 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
12/31/19   smi    Add support to get RFFE device register address list
08/16/16   dbc     Added get_rffev20_usid_p3_setting() API
...
/* Constructor overloaded for physical device support */
  rfdevice_pa_common(rfdevice_physical_device *phy_dev_obj_ptr,rfc_phy_device_info_type *phy_device_info, rfc_logical_device_info_type *logical_device_info); 
        ...
        boolean get_rffev20_usid_p3_setting();
