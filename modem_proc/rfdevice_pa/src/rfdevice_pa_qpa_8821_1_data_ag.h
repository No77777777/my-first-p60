...
#ifndef RFDEVICE_PA_QPA_8821_1_DATA_AG
#define RFDEVICE_PA_QPA_8821_1_DATA_AG
...
class rfdevice_pa_qpa_8821_1_data_ag:public rfdevice_pa_data
{
public:
    ...
    ~rfdevice_pa_qpa_8821_1_data_ag(void);  /*  Destructor  */
	
protected:
  rfdevice_pa_qpa_8821_1_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_pa_data *rfdevice_pa_qpa_8821_1_data_ptr;
