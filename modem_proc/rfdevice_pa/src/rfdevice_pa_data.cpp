...
$DateTime: 2021/03/09 04:58:52 $ $Author: pwbldsvc $
$Header: //components/rel/rfdevice_pa.mpss/1.32/src/rfdevice_pa_data.cpp#1 $
...
uint32 rfdevice_pa_data::get_max_bw_supported(void)
{
  // Default to 20 MHz for PA objects with this method unimplemented
  return 20000;
}