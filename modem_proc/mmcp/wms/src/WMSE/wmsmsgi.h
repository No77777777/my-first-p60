...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/wms/src/WMSE/wmsmsgi.h#1 $
...
#define WMS_MESSAGE_TYPE_RESERVED       3
  ...
  uint32                                mo_retry_period[MAX_AS_IDS];
  uint32                                mo_retry_interval[MAX_AS_IDS];
  uint32                                timerf_value[WMS_MSG_TRANSPORT_ARR_MAX];
