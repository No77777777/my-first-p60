...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/wms/src/CMCNas/inc/CMCNas.h#1 $
...
{
   return me->pfnSendData( as_id, transport_type, pSCAddress, uMsgID, uTPDULength, pTPDUData, msg_type );
}
...
{
   return me->pfnSendReport( as_id, uConnectionID, bSuccess, uRPCause, uTPDULength, pTPDUData, msg_type );
}
