/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/wms/src/CMCNas/src/CMCNas_MN.c#1 $
...
)
{
  ...
  mn_cmd_ptr->cmd.sm_rl_data_req.sms_msg_type             = msg_type;
...
)
{
  ...
  mn_cmd_ptr->cmd.sm_rl_report_req.sms_msg_type         = msg_type;
