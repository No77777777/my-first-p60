/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/wms/src/qmi_wms/src/qmi_wms.c#1 $
...
---------------------------------------------------------------------------*/
  ...
  #define WMSI_BC_WAC_LEN_MAX            (1400)
...
---------------------------------------------------------------------------*/
  ...
  #define WMSI_PRM_TYPE_ASYNC_SEND_IND_FAILURE_TYPE              (0x14)
  #define WMSI_PRM_TYPE_ASYNC_SEND_IND_FAILURE_CAUSE             (0x15) 
  #define WMSI_PRM_TYPE_ASYNC_SEND_IND_USER_DATA                 (0x17)

  #define WMSI_PRM_TYPE_ASYNC_MEM_STORE_IND_FAILURE_TYPE         (0x14)
  #define WMSI_PRM_TYPE_ASYNC_MEM_STORE_IND_FAILURE_CAUSE        (0x15)
  #define WMSI_PRM_TYPE_ASYNC_MEM_STORE_IND_USER_DATA            (0x17)

  #define WMSI_PRM_TYPE_RAW_SEND_FAILURE_TYPE                    (0x13)
  #define WMSI_PRM_TYPE_RAW_SEND_FAILURE_CAUSE                   (0x14)

  #define WMSI_PRM_TYPE_SEND_FROM_MEM_STORE_FAILURE_TYPE         (0x14)
  #define WMSI_PRM_TYPE_SEND_FROM_MEM_STORE_FAILURE_CAUSE        (0x16)

  #define WMSI_PRM_TYPE_TRANSPORT_MWI_ADDR                       (0x02)  
  #define WMSI_PRM_TYPE_TRANSPORT_MWI_DETAILS                    (0x10) 
  /* WMS_SET_SMSC_ADDR TLVs */
  #define WMSI_PRM_TYPE_SMSC_TYPE           (0x10)
  #define WMSI_PRM_TYPE_SMSC_INDEX          (0x11)
...
/*---------------------------------------------------------------------------
  QMI WMS report lower-layer error codes enum
---------------------------------------------------------------------------*/
typedef enum
{
  WMSI_REPORT_LL_ERR_CODES_DISABLE = 0x0000,
  WMSI_REPORT_LL_ERR_CODES_ENABLE  = 0x0001,
  WMSI_REPORT_LL_ERR_CODES_MAX,
  WMSI_REPORT_LL_ERR_CODES_MAX32   = 0x7FFFFFFF /* forces enum values to 32 bits */
} qmi_wmsi_report_ll_err_codes_e_type;
...
/*---------------------------------------------------------------------------
  QMI WMS Radio Access technology enum
---------------------------------------------------------------------------*/
typedef enum
{
  WMSI_SYS_RAT_GSM_RADIO_ACCESS   = 0x0000,        /**< GSM. */
  WMSI_SYS_RAT_UMTS_RADIO_ACCESS  = 0x0001,       /**< UMTS. */
  WMSI_SYS_RAT_LTE_RADIO_ACCESS   = 0x0002,        /**< LTE. */
  WMSI_SYS_RAT_CDMA_RADIO_ACCESS  = 0x0003,       /**< CDMA. */
  WMSI_SYS_RAT_MAX,
  WMSI_SYS_RAT_MAX32              = 0x7FFFFFFF /* forces enum values to 32 bits */
} qmi_wmsi_radio_access_tech_e_type;
#endif
...
/*---------------------------------------------------------------------------
  QMI WMS Reject Type enum (GWL)
---------------------------------------------------------------------------*/
typedef enum
{
  WMSI_OTA_REJECT_CAUSE       = 0x0001,
  WMSI_REJECT_CAUSE_MAX,
  WMSI_REJECT_CAUSE_MAX32     = 0x7FFFFFFF /* forces enum values to 32 bits */
} qmi_wmsi_reject_e_type;
...
typedef enum
{
  ...
  WMSI_MESSAGE_BLOCKED_DUE_TO_ACTIVE_1X_VOICE_OR_DATA_CALL = 0x0001,
...
/*---------------------------------------------------------------------------
  QMI WMS Raw Send TLV id enum
---------------------------------------------------------------------------*/
typedef enum
{
  WMSI_TLV_TYPE_REQ_PARAM        = 0x01,
  WMSI_TLV_TYPE_FORCE_ON_DC      = 0x02,
  WMSI_TLV_TYPE_FOLLOW_ON_DC     = 0x03,
  WMSI_TLV_TYPE_LINK_CONTROL     = 0x04,
  WMSI_TLV_TYPE_SMS_ON_IMS       = 0x05,
  WMSI_TLV_TYPE_RETRY_MESSAGE    = 0x06,
  WMSI_TLV_TYPE_RETRY_MESSAGE_ID = 0x07,
  WMSI_TLV_TYPE_USER_DATA        = 0x08,
  WMSI_TLV_TYPE_LINK_ENABLE_MODE = 0x09,
  WMSI_TLV_TYPE_SMS_COMMAND_MODE  = 0x0B,
  WMSI_TLV_TYPE_MAX
} qmi_wmsi_raw_send_tlv_e_type;

/* (ASYNC) RAW_SEND REQ TLVs */
  #define WMSI_OPTIONAL_PRM_TYPE_ONE    (0x10)
  #define WMSI_OPTIONAL_PRM_TYPE_TWO    (0x11)
  #define WMSI_OPTIONAL_PRM_TYPE_THREE  (0x12)
  #define WMSI_OPTIONAL_PRM_TYPE_FOUR   (0x13)
  #define WMSI_OPTIONAL_PRM_TYPE_FIVE   (0x14)
  #define WMSI_OPTIONAL_PRM_TYPE_SIX    (0x15)
  #define WMSI_OPTIONAL_PRM_TYPE_SEVEN  (0x16)
  #define WMSI_OPTIONAL_PRM_TYPE_EIGHT  (0x17)
  #define WMSI_OPTIONAL_PRM_TYPE_NINE   (0x18)
  #define WMSI_OPTIONAL_PRM_TYPE_TEN    (0x19)

/* (ASYNC) SEND_FROM_MEM_STORE REQ TLVs */
  #define WMSI_PRM_TYPE_MEM_STORE_SMS_ON_IMS    (0x10)
  #define WMSI_PRM_TYPE_ASYNC_MEM_STORE_REQ_USER_DATA (0x11)

/* WMS_SEND_ACK TLVs */
  #define WMSI_PRM_TYPE_3GPP2_FAIL_INFO     (0x10)
  #define WMSI_PRM_TYPE_3GPP_FAIL_INFO      (0x11)
  #define WMSI_PRM_TYPE_ACK_FAILURE_CAUSE   (0x10)
  #define WMSI_PRM_TYPE_SEND_ACK_SMS_ON_IMS (0x12)
  #define WMSI_PRM_TYPE_ASYNC_SEND_ACK_REQ_USER_DATA  (0x13)
...
typedef struct qmi_wmsi_report_event_info_s
{
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
  /*Broadcast SMS RAT info*/
  boolean                           bc_sms_rat_incl;
  qmi_wmsi_radio_access_tech_e_type radio_access_tech;
#endif
  ...
  uint32                         wac_data_len;
  uint8                          wac_data[WMSI_BC_WAC_LEN_MAX];
...
typedef struct qmi_wmsi_client_state_s
{
  ...
  struct
  {
    ...
    boolean reg_smsc_addr_events;
    boolean mem_full_ind_events;
  } indication_reg;
...
typedef enum {
  ...
  WMSI_SERVICE_READY_STATUS_3GPP_LIMITED = 0x0004,
  WMSI_SERVICE_READY_STATUS_3GPP2_LIMITED = 0x0005,
  WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2_LIMITED = 0x0006,
  WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2 = 0x0007,
  WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2_LIMITED = 0x0008,
...
static struct
{
  ...
  qmi_wmsi_transport_layer_type transport_layer[WMSI_SUBSCRIPTION_MAX];
  qmi_wmsi_transport_nw_reg_status_type transport_nw_reg_status[WMSI_SUBSCRIPTION_MAX];
  ...
  uint32                       dbg_retry_period[WMSI_SUBSCRIPTION_MAX];
  uint32                       dbg_retry_interval[WMSI_SUBSCRIPTION_MAX];
...
void qmi_wmsi_generate_transport_layer_info_ind(qmi_wmsi_subscription_e_type);
void qmi_wmsi_generate_transport_nw_reg_info_ind(qmi_wmsi_subscription_e_type);
...
boolean qmi_wmsi_check_transport_layer_cache(wms_msg_transport_reg_info_s_type *, qmi_wmsi_subscription_e_type);
void qmi_wmsi_update_transport_layer_cache(wms_msg_transport_reg_info_s_type *, qmi_wmsi_subscription_e_type);
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
qmi_wmsi_radio_access_tech_e_type qmi_wmsi_from_wms_rat
(
  wms_radio_access_tech_e_type wms_rat
);
#endif
...
qmi_wmsi_reject_e_type qmi_wms_rej_type_to_wmsi_rej_type
(
  wms_reject_e_type rej_type
);
...
qmi_wmsi_raw_send_tlv_e_type qmi_wmsi_get_raw_send_tlv_type
(
  boolean,
  uint8
);
...
)
{
  ...
  if ( (QMI_SVC_CLID_UNUSED != hdr->client_id)  && (WMSI_MAX_CLIDS >= hdr->client_id) )
  {
    ...
    if (cl_sp)
    {
      ...
      //Default setting is to send SMSC address indication to QMI clients.
      cl_sp->indication_reg.reg_smsc_addr_events = TRUE;
	  
      //Default setting is to send memory full indication to QMI clients.
 	  cl_sp->indication_reg.mem_full_ind_events = TRUE;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (FALSE == qmi_wmsi_global.inited)
  {
    ...
    for (i = 0; i < WMSI_SUBSCRIPTION_MAX; i++)
    {
      qmi_wmsi_global.transport_layer[i].state = WMSI_TRANSPORT_LAYER_STATE_UNINIT;
      qmi_wmsi_global.transport_layer[i].registered_ind = FALSE;
      qmi_wmsi_global.transport_layer[i].transport_type = 0;
      qmi_wmsi_global.transport_layer[i].transport_cap = 0;
      qmi_wmsi_global.transport_layer[i].as_id = 0;
    }

    for (i = 0; i < WMSI_SUBSCRIPTION_MAX; i++)
    {
       qmi_wmsi_global.transport_nw_reg_status[i].state = WMSI_TRANSPORT_NW_REG_STATE_UNINIT;
       qmi_wmsi_global.transport_nw_reg_status[i].nw_reg_status = 0;
       qmi_wmsi_global.transport_nw_reg_status[i].as_id = 0;
    }
  ...
  -------------------------------------------------------------------------*/
    ...
    for (i = 0; i < WMSI_SUBSCRIPTION_MAX; i++)
    {
       qmi_wmsi_global.dbg_retry_period[i]   = WMSI_DBG_RETRY_TIMER_MAX;
       qmi_wmsi_global.dbg_retry_interval[i] = WMSI_DBG_RETRY_TIMER_MAX;
    }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
      ...
      (WMSI_CMD_VAL_ASYNC_SEND_ACK == cmd_type))
  {
              ...
              (WMSI_CMD_VAL_ASYNC_SEND_FROM_MEM_STORE == cmd_type) )
    {
     ...
     /* Special handling for 3GPP2 SMS failure when SMS and voice/data call is not allowed on 1X simultaneously */
     if ((NULL != cmd_node) && (QMI_ERR_MESSAGE_NOT_SENT == errval))
     {
        PACK(struct)
        {
          uint8  message_delivery_failure_type;
        } v_failure_type;

        PACK(struct)
        {
          uint8  message_delivery_failure_cause;
        } v_failure_cause;

        v_failure_type.message_delivery_failure_type = WMSI_MESSAGE_DELIVERY_FAILURE_PERM;
        if (!qmi_svc_put_param_tlv(&response,
                                   (WMSI_CMD_VAL_ASYNC_RAW_SEND == cmd_type)?
                                   WMSI_PRM_TYPE_ASYNC_SEND_IND_FAILURE_TYPE :
                                   WMSI_PRM_TYPE_ASYNC_MEM_STORE_IND_FAILURE_TYPE,
                                   sizeof(v_failure_type),
                                   &v_failure_type))
        {
          goto clean_up;
        }

        v_failure_cause.message_delivery_failure_cause = WMSI_MESSAGE_BLOCKED_DUE_TO_ACTIVE_1X_VOICE_OR_DATA_CALL;
        if (!qmi_svc_put_param_tlv(&response,
                                   (WMSI_CMD_VAL_ASYNC_RAW_SEND == cmd_type)?
                                   WMSI_PRM_TYPE_ASYNC_SEND_IND_FAILURE_CAUSE :
                                   WMSI_PRM_TYPE_ASYNC_MEM_STORE_IND_FAILURE_CAUSE,
                                   sizeof(v_failure_cause),
                                   &v_failure_cause))
        {
          goto clean_up;
        }
  ...
  else
  {
    ...
    /* Special handling for 3GPP2 SMS failure when SMS and voice/data call is not allowed on 1X simultaneously */
    if ( ( (WMSI_CMD_VAL_RAW_SEND == cmd_type) ||
           (WMSI_CMD_VAL_SEND_FROM_MEM_STORE == cmd_type) ) &&
           (QMI_ERR_MESSAGE_NOT_SENT == errval) )
    {
      PACK(struct)
      {
        uint8  message_delivery_failure_type;
      ...
      v_failure_type.message_delivery_failure_type = WMSI_MESSAGE_DELIVERY_FAILURE_PERM;
      if (!qmi_svc_put_param_tlv(&response,
                                 (WMSI_CMD_VAL_RAW_SEND == cmd_type)?
                                 WMSI_PRM_TYPE_RAW_SEND_FAILURE_TYPE :
                                 WMSI_PRM_TYPE_SEND_FROM_MEM_STORE_FAILURE_TYPE,
                                 sizeof(v_failure_type),
                                 &v_failure_type))
      {
        goto clean_up;
      ...
      if (!qmi_svc_put_param_tlv(&response,
                                 (WMSI_CMD_VAL_RAW_SEND == cmd_type)?
                                 WMSI_PRM_TYPE_RAW_SEND_FAILURE_CAUSE :
                                 WMSI_PRM_TYPE_SEND_FROM_MEM_STORE_FAILURE_CAUSE,
                                 sizeof(v_failure_cause),
                                 &v_failure_cause))
      {
        goto clean_up;
  ...
  switch (event)
  {
    ...
    case WMS_MSG_EVENT_SMSC_ADDR_CHANGE:
      ...
      if (NULL != msg_evt_ptr)
      {
        ...
        /* Deep copy WAC details if available */
        if (WMS_MSG_EVENT_RECEIVED_MESSAGE == event)
        {
          if (info_ptr->mt_message_info.wac_info.len > 0 && NULL != info_ptr->mt_message_info.wac_info.data)
          {
            qmi_wmsi_deep_copy((void**)&msg_evt_ptr->data.msg_event.event_info.mt_message_info.wac_info.data,
                               (void*)info_ptr->mt_message_info.wac_info.data,
                               info_ptr->mt_message_info.wac_info.len);
          }
          else
          {
            msg_evt_ptr->data.msg_event.event_info.mt_message_info.wac_info.data = NULL;
            msg_evt_ptr->data.msg_event.event_info.mt_message_info.wac_info.len = 0;
          }
        }
  ...
  switch (msg_evt_ptr->event)
  {
    ...
    case WMS_MSG_EVENT_SUBMIT_REPORT:
      if (WMS_CLIENT_TYPE_QMI == event_info->submit_report_info.client_id)
      {
        ...
        MSG_HIGH_2(" is_sms_is_over_ims : %d,sms_over_ims_cause : %d", 
                          event_info->submit_report_info.ims_cause_info.sms_over_ims,event_info->submit_report_info.ims_cause_info.ims_cause_value); 
    ...
    case WMS_MSG_EVENT_TRANSPORT_REG:
      subscription = qmi_wms_get_subscription_from_asid(event_info->transport_reg_info.as_id);
      if (WMSI_SUBSCRIPTION_MAX == subscription)
      {
        return;
      }

      if (qmi_wmsi_check_transport_layer_cache(&event_info->transport_reg_info, subscription))
      {
        qmi_wmsi_update_transport_layer_cache(&event_info->transport_reg_info, subscription);

        qmi_wmsi_generate_transport_layer_info_ind(subscription);
      }
      break;
...
)
{
  ...
  switch (event)
  {
    ...
    case WMS_CFG_EVENT_MS_READY_STATUS:
    ...
    case WMS_CFG_EVENT_MS_READY:
      {
        ...
        {
          switch(qmi_wmsi_global.service_ready_status[sub].status)
          {
            case WMSI_SERVICE_READY_STATUS_3GPP2:
            case WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2:
              qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2;
              break;

            case WMSI_SERVICE_READY_STATUS_3GPP2_LIMITED:
            case WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2_LIMITED:
              qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2_LIMITED;
              break;

            case WMSI_SERVICE_READY_STATUS_NONE:
            case WMSI_SERVICE_READY_STATUS_3GPP_LIMITED:
              qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP;
              break;

            default: /* No change if already 3GPP or 3GPP_and_3GPP2 ready */
        ...
        if (WMS_CFG_SYS_CDMA == event_info->ms_ready.sys_type)
        {
          switch(qmi_wmsi_global.service_ready_status[sub].status)
          {
            case WMSI_SERVICE_READY_STATUS_3GPP:
            case WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2_LIMITED:
              qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2;
              break;

            case WMSI_SERVICE_READY_STATUS_3GPP_LIMITED:
            case WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2_LIMITED:
              qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2;
              break;
    ...
    case WMS_CFG_EVENT_MS_READY_STATUS:
      {
        ...
        sub = qmi_wms_get_subscription_from_asid(event_info->ms_ready_status.as_id);
        ...
        if (WMS_CFG_SYS_GW == event_info->ms_ready_status.sys_type)
        {
          if (WMS_CFG_READY_STATUS_LIMITED == event_info->ms_ready_status.ready_status)
          {
            switch(qmi_wmsi_global.service_ready_status[sub].status)
            {
              case WMSI_SERVICE_READY_STATUS_3GPP2_LIMITED:
              case WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2_LIMITED:
                qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2_LIMITED;
                break;

              case WMSI_SERVICE_READY_STATUS_3GPP2:
              case WMSI_SERVICE_READY_STATUS_3GPP_AND_3GPP2:
                qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_LIMITED_AND_3GPP2;
                break;

              case WMSI_SERVICE_READY_STATUS_NONE:
              case WMSI_SERVICE_READY_STATUS_3GPP:
                qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP_LIMITED;
                break;
        ...
        if (WMS_CFG_SYS_CDMA == event_info->ms_ready_status.sys_type)
        {
          ...
          if (WMS_CFG_READY_STATUS_LIMITED == event_info->ms_ready_status.ready_status)
          {
            switch(qmi_wmsi_global.service_ready_status[sub].status)
            {
              ...
              case WMSI_SERVICE_READY_STATUS_NONE:
              case WMSI_SERVICE_READY_STATUS_3GPP2:
                qmi_wmsi_global.service_ready_status[sub].status = WMSI_SERVICE_READY_STATUS_3GPP2_LIMITED;
                break;
...
)
{
  ...
  MSG_HIGH_1("Processing transport status: as id %d", status_info->as_id);
  sub = qmi_wms_get_subscription_from_asid(status_info->as_id);
  ...
  if ((WMSI_TRANSPORT_NW_REG_STATE_UNINIT == qmi_wmsi_global.transport_nw_reg_status[sub].state)||
      (qmi_wmsi_global.transport_nw_reg_status[sub].nw_reg_status !=
       qmi_wms_to_wmsi_transport_nw_reg( status_info->transport_status )) || 
      (qmi_wmsi_global.transport_nw_reg_status[sub].as_id != status_info->as_id)
     )
  {
    /* Update the Transport NW Reg cache */
    qmi_wmsi_global.transport_nw_reg_status[sub].state = WMSI_TRANSPORT_NW_REG_STATE_INIT;
    qmi_wmsi_global.transport_nw_reg_status[sub].nw_reg_status =
      qmi_wms_to_wmsi_transport_nw_reg(status_info->transport_status);
    qmi_wmsi_global.transport_nw_reg_status[sub].as_id = status_info->as_id;
    
    /* Generate the Transport NW Reg Info Indication */
    qmi_wmsi_generate_transport_nw_reg_info_ind(sub);
  }
...
)
{
  ...
  boolean                    cmd_buf_must_be_freed = TRUE;
  qmi_wmsi_subscription_e_type sub_index;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    case WMS_DBG_EVENT_RETRY_PERIOD:
      sub_index = qmi_wms_get_subscription_from_asid(info_ptr->as_id);

      if (WMSI_SUBSCRIPTION_MAX == sub_index)
      {
        MSG_ERROR_0( "Unable to map as_id in WMS_DBG_EVENT_RETRY_PERIOD to a subscription" );
        return;
      }

      qmi_wmsi_global.dbg_retry_period[sub_index] = info_ptr->retry_period;
    ...
    case WMS_DBG_EVENT_RETRY_INTERVAL:
      ...
      if (WMSI_SUBSCRIPTION_MAX == sub_index)
      {
        MSG_ERROR_0( "Unable to map as_id in WMS_DBG_EVENT_RETRY_INTERVAL to a subscription" );
        return;
      }

      qmi_wmsi_global.dbg_retry_interval[sub_index] = info_ptr->retry_interval;
...
)
{
  ...
  if (cl_sp)
  {
    ...
    status = ds_qmi_fw_send_ind(&hdr, cmd_type, ind);
   	wms_log_msg_ind_notify_packet(cmd_type,hdr.client_id,status);
...
)
{
  ...
  if (WMSI_TRANSPORT_LAYER_STATE_UNINIT == qmi_wmsi_global.transport_layer[sub].state)
  {
    /* The cache is uninitialized */
    return TRUE;
  }

  if (qmi_wmsi_global.transport_layer[sub].as_id !=  wms_transport_reg_info->as_id)
  {
    return TRUE;
  }

  if (qmi_wmsi_global.transport_layer[sub].registered_ind != wms_transport_reg_info->is_registered)
  {
    return TRUE;
  }

  if (qmi_wmsi_global.transport_layer[sub].transport_type != transport_type)
  {
    return TRUE;
  }

  if (qmi_wmsi_global.transport_layer[sub].transport_cap != transport_cap)
  {
    return TRUE;
  }
...
{
  memset(&qmi_wmsi_global.transport_layer[sub], 0, sizeof(qmi_wmsi_global.transport_layer[sub]));

  qmi_wmsi_global.transport_layer[sub].state          = WMSI_TRANSPORT_LAYER_STATE_INIT;
  qmi_wmsi_global.transport_layer[sub].registered_ind = wms_transport_reg_info->is_registered;
  qmi_wmsi_global.transport_layer[sub].as_id          = wms_transport_reg_info->as_id;

  qmi_wmsi_global.transport_layer[sub].transport_type =
    qmi_wms_to_wmsi_transport_type(wms_transport_reg_info->transport_type);

  qmi_wmsi_global.transport_layer[sub].transport_cap  =
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
      ...
      (WMS_MSG_EVENT_STATUS_REPORT == event))
  {
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
    wmsi_event_ptr->bc_sms_rat_incl   = FALSE;
#endif
    ...
    if ( (WMS_MSG_EVENT_RECEIVED_MESSAGE == event) &&
         (event_info_ptr->mt_message_info.wac_info.len > 0) &&
         (event_info_ptr->mt_message_info.wac_info.len <= WMSI_BC_WAC_LEN_MAX) &&
         (event_info_ptr->mt_message_info.wac_info.data != NULL) )
    {
      wmsi_event_ptr->wac_data_len = event_info_ptr->mt_message_info.wac_info.len;
      memscpy((void *)&wmsi_event_ptr->wac_data[0], wmsi_event_ptr->wac_data_len,
              (void *)event_info_ptr->mt_message_info.wac_info.data, event_info_ptr->mt_message_info.wac_info.len);
    }
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
      if (WMS_TELESERVICE_BROADCAST == event_info_ptr->mt_message_info.message.u.cdma_message.teleservice)
      {
         wmsi_event_ptr->bc_sms_rat_incl   = TRUE;
         wmsi_event_ptr->radio_access_tech = qmi_wmsi_from_wms_rat(event_info_ptr->mt_message_info.rat);
      }
#endif
    }
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
      /*For GW BC messages, include SMS RAT. */
      if (WMSI_MSG_FORMAT_GW_BC == wmsi_event_ptr->format)
      {
         wmsi_event_ptr->bc_sms_rat_incl   = TRUE;
         wmsi_event_ptr->radio_access_tech = qmi_wmsi_from_wms_rat(event_info_ptr->mt_message_info.rat);
      }
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
    wmsi_event_ptr->bc_sms_rat_incl   = TRUE;
    wmsi_event_ptr->radio_access_tech = qmi_wmsi_from_wms_rat(event_info_ptr->etws_msg_info.rat);
#endif
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  /*-------------------------------------------------------------------------
    ...
    process the request.
  -------------------------------------------------------------------------*/
  if (!(set_event_report_req_pdu->report_mt_message_valid) &&  !(set_event_report_req_pdu->report_call_control_info_valid) && 
      !(set_event_report_req_pdu->report_mwi_message_valid) && !(set_event_report_req_pdu->report_ll_err_codes_valid))
  {
    errval = QMI_ERR_MISSING_ARG;
  }
  else
  {
    ...
    /*-------------------------------------------------------------------------
      change error code reporting if tlv included in request
    -------------------------------------------------------------------------*/
    if (set_event_report_req_pdu->report_ll_err_codes_valid)
    {
      switch (set_event_report_req_pdu->report_ll_err_codes)
      {
        case WMSI_REPORT_LL_ERR_CODES_DISABLE:
          wms_cl_sp->report_status.report_ll_err_codes = FALSE;
          break;

        case WMSI_REPORT_LL_ERR_CODES_ENABLE:
          wms_cl_sp->report_status.report_ll_err_codes = TRUE;
          break;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((event_info_ptr->mask & WMSI_REPORT_STATUS_EV_MT_MSG))
  {
    if (FALSE == event_info_ptr->is_etws)
    {
      ...
      if ( (event_info_ptr->wac_data_len > 0) &&
           (event_info_ptr->wac_data_len <= WMSI_BC_WAC_LEN_MAX) )
      {
         ind_pdu->warning_area_valid = TRUE;
         ind_pdu->warning_area_len = (uint32)event_info_ptr->wac_data_len;
         (void)memscpy(&ind_pdu->warning_area[0], ind_pdu->warning_area_len, event_info_ptr->wac_data, event_info_ptr->wac_data_len);
      }
...
#if !defined(FEATURE_MODEM_ATC) || defined (FEATURE_MODEM_AT_CP)
    if (event_info_ptr->bc_sms_rat_incl)
    {
      ind_pdu->bc_sms_rat_info = (wms_bc_rat_info_enum_v01)event_info_ptr->radio_access_tech;
      if (WMSI_SYS_RAT_MAX < event_info_ptr->radio_access_tech)
      {
        MSG_HIGH_0("Wrong broadcast SMS RAT");
        QMI_WMSI_MEM_FREEIF(ind_pdu);
        return;
      }
 
      ind_pdu->bc_sms_rat_info_valid = TRUE;
    }
#endif
  }
...
#pragma pack(push, 1) // Save previous, and turn on 1 byte alignment
  ...
  PACK(struct)
  {
    uint8 link_enable_mode;
  } v_in_opt8;

  PACK(struct)
  {
    uint8 sms_is_command_tpdu;
  } v_in_opt10;
...
#pragma pack(pop) // Revert alignment to what it was previously
  ...
  boolean            got_raw_msg_tlv = FALSE;
  boolean            got_force_on_dc = FALSE;
  boolean            got_follow_on_dc = FALSE;
  boolean            got_link_control_tlv = FALSE;
  boolean            got_sms_on_ims_tlv = FALSE;
  boolean            got_retry_message_tlv = FALSE;
  boolean            got_retry_message_id_tlv = FALSE;
  boolean            got_user_data_tlv = FALSE;
  boolean            got_link_enable_mode_tlv = FALSE;
  boolean            force_on_dc = FALSE;
  boolean            sms_command_mode_tlv = FALSE;
  uint8              type;
  uint16             len;
  uint16             expected_len;
  void *             value;
  uint16             raw_message_data_tlv_len = 0;
  qmi_wms_cmd_node_type *       cmd_node = NULL;
  wms_client_message_s_type client_msg;
  ...
  boolean                  sms_command   = FALSE;
  qmi_wms_tid_type         tid;
  wms_client_ch_pref_e_type ch_pref;
  wms_dc_so_e_type so;
  boolean follow_on_dc;     
  qmi_wmsi_raw_send_tlv_e_type tlv_name;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  memset(&v_in_opt1, 0, sizeof(v_in_opt1));
  memset(&v_in_opt2, 0, sizeof(v_in_opt2));
  memset(&v_in_opt3, 0, sizeof(v_in_opt3));
  memset(&v_in_opt4, 0, sizeof(v_in_opt4));
  memset(&v_in_opt5, 0, sizeof(v_in_opt5));
  memset(&v_in_opt6, 0, sizeof(v_in_opt6));
  memset(&client_msg, 0, sizeof(wms_client_message_s_type));
  memset(&v_in_opt8, 0, sizeof(v_in_opt8));
  memset(&v_in_opt10, 0, sizeof(v_in_opt10));

  if (WMSI_CMD_VAL_ASYNC_RAW_SEND == ((qmi_cmd_buf_type *)cmd_buf_p)->cmd_type)
  {
    async_send = TRUE;
    memset(&v_in_opt7, 0, sizeof(v_in_opt7));
  }
...
while (*sdu_in)
  {
    ...
    expected_len = 0;
    value = NULL;
    tlv_name = qmi_wmsi_get_raw_send_tlv_type(async_send, type);

    switch (tlv_name)
    {
      case WMSI_TLV_TYPE_REQ_PARAM:
        if (sizeof(v_in_req) >= len)
        {
          got_raw_msg_tlv = TRUE;
          raw_message_data_tlv_len = len;
          value = &v_in_req;
        }
        else
        {
      ...
      case WMSI_TLV_TYPE_FORCE_ON_DC:
        expected_len = sizeof(v_in_opt1);
        got_force_on_dc = TRUE;
        value = (void *) &v_in_opt1;
        break;

      case WMSI_TLV_TYPE_FOLLOW_ON_DC:
        expected_len = sizeof(v_in_opt2);
        got_follow_on_dc = TRUE;
        value = (void *) &v_in_opt2;
        break;

      case WMSI_TLV_TYPE_LINK_CONTROL:
        expected_len = sizeof(v_in_opt3);
        got_link_control_tlv = TRUE;
        value = (void *) &v_in_opt3;
        break;

      case WMSI_TLV_TYPE_SMS_ON_IMS:
        expected_len = sizeof(v_in_opt4);
        got_sms_on_ims_tlv = TRUE;
        value = (void *) &v_in_opt4;
        break;

      case WMSI_TLV_TYPE_RETRY_MESSAGE:
        expected_len = sizeof(v_in_opt5);
        got_retry_message_tlv = TRUE;
        value = (void *) &v_in_opt5;
        break;

      case WMSI_TLV_TYPE_RETRY_MESSAGE_ID:
        expected_len = sizeof(v_in_opt6);
        got_retry_message_id_tlv = TRUE;
        value = (void *) &v_in_opt6;
        break;

      case WMSI_TLV_TYPE_USER_DATA:
        expected_len = sizeof(v_in_opt7);
        got_user_data_tlv = TRUE;
        value = (void *) &v_in_opt7;
        break;

      case WMSI_TLV_TYPE_LINK_ENABLE_MODE:
        expected_len = sizeof(v_in_opt8);
        got_link_enable_mode_tlv = TRUE;
        value = (void *) &v_in_opt8;
        break;

      case WMSI_TLV_TYPE_SMS_COMMAND_MODE:
        expected_len = sizeof(v_in_opt10);
        sms_command_mode_tlv = TRUE;
        value = (void *) &v_in_opt10;
        break;
    ...
    if ((0 != expected_len) && (len != expected_len))
    {
      MSG_HIGH_3( "Invalid TLV len (%d) expected (%d) for type (%d)",
                  len,
                  expected_len,
                  type );
      errval = QMI_ERR_MALFORMED_MSG;
...
if (WMS_FORMAT_MAX == qmi_wmsi_to_wms_format((qmi_wmsi_message_format_e_type)v_in_req.msg_format))
  {
    errval = QMI_ERR_INVALID_ARG;
    goto send_result;
  }
  ...
  if ((raw_message_data_tlv_len != 3 + v_in_req.msg_len) ||
     (0 == v_in_req.msg_len) || (WMSI_MAX_LEN < v_in_req.msg_len))
  {
    errval = QMI_ERR_INVALID_ARG;
    goto send_result;
  }
  ...
  if (got_force_on_dc)
  {
    if (v_in_opt1.so > WMS_DC_SO_14)
    {
      errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    }

    if (WMSI_MSG_FORMAT_GW_PP == (qmi_wmsi_message_format_e_type)v_in_req.msg_format)
    {
  ...
  if (got_follow_on_dc)
  {
    ...
    {
      MSG_HIGH_1("follow_on_dc = %d", v_in_opt2.follow_on_dc);
    }
  }

  if (got_link_control_tlv)
  {
    if (WMSI_LINK_TIMER_MAX < v_in_opt3.link_timer)
    {
      MSG_HIGH_1("Link timer %d exceeds maximum of 5 seconds", v_in_opt3.link_timer);
      errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    }

    if (WMSI_MSG_FORMAT_CDMA == (qmi_wmsi_message_format_e_type)v_in_req.msg_format)
    {
  ...
  if (got_sms_on_ims_tlv)
  {
    sms_on_ims = (v_in_opt4.sms_on_ims == 1) ? TRUE : FALSE;
    if (sms_on_ims && got_force_on_dc && v_in_opt1.force_on_dc)
    {
  ...
  if (got_link_enable_mode_tlv)
  {
    ...
    link_enable_mode = (v_in_opt8.link_enable_mode == 1) ? WMS_LINK_CONTROL_ENABLE_ALL : WMS_LINK_CONTROL_ENABLED_ONE;
  }

  if(sms_command_mode_tlv)
  {
    MSG_HIGH_1("sms_command = %d", v_in_opt10.sms_is_command_tpdu);
    sms_command = (v_in_opt10.sms_is_command_tpdu == 1) ? TRUE : FALSE;
  }
  ...
  -----------------------------------------------------------------------*/
  switch ((qmi_wmsi_message_format_e_type)v_in_req.msg_format)
  {
#ifdef FEATURE_GWSMS
    case WMSI_MSG_FORMAT_GW_PP:
      /* fill in message header values */
      client_msg.msg_hdr.message_mode = WMS_MESSAGE_MODE_GW;
      client_msg.msg_hdr.tag          = WMS_TAG_MO_NOT_SENT;
      client_msg.msg_hdr.mem_store    = WMS_MEMORY_STORE_NONE;
      client_msg.msg_hdr.index        = WMS_DUMMY_MESSAGE_INDEX;

      /* message format */
      client_msg.u.gw_message.raw_ts_data.format =
      qmi_wmsi_to_wms_format((qmi_wmsi_message_format_e_type)v_in_req.msg_format);
      ...
      /* message length is the length of the PDU minus the length of the SMSC
         ...
         the SMSC address */
      if (v_in_req.msg_len > v_in_req.msg_data[0] + 1)
      {
        client_msg.u.gw_message.raw_ts_data.len = v_in_req.msg_len - 1 -
                                                  v_in_req.msg_data[0];
        if(sms_command)
        {
          /* T_PDU type for MO */
          client_msg.u.gw_message.raw_ts_data.tpdu_type = v_in_req.msg_data[1] & 0x03;
        }
        else
        {
          /* T_PDU type to SUBMIT for MO */
          client_msg.u.gw_message.raw_ts_data.tpdu_type = WMS_TPDU_SUBMIT;
        }
      }
      else
      {
      ...
      /* error checking */
      if ((WMS_FORMAT_MAX <= client_msg.u.gw_message.raw_ts_data.format) ||
          (WMSI_MAX_LEN   <= client_msg.u.gw_message.raw_ts_data.len))
      {
        errval = QMI_ERR_INVALID_ARG;
        goto send_result;
      }

      if (0 != v_in_req.msg_data[0])
      {
        if ((v_in_req.msg_len <= v_in_req.msg_data[0]) ||
            (2                >  v_in_req.msg_data[0]))
        {
          errval = QMI_ERR_INVALID_ARG;
          goto send_result;
        }

        data_ptr = (uint8 *) v_in_req.msg_data;
        data_ptr++;
        if (! qmi_wmsi_bin_to_addr(data_ptr,
                                   v_in_req.msg_data[0],
                                   &client_msg.u.gw_message.sc_address))
        {
      ...
      else
      {
        ...
        (void)memscpy(&client_msg.u.gw_message.sc_address,
      ...
      data_ptr = (uint8 *) v_in_req.msg_data;
      data_ptr += (v_in_req.msg_data[0] + 1);
      (void)memscpy(client_msg.u.gw_message.raw_ts_data.data,
                    client_msg.u.gw_message.raw_ts_data.len,
                    data_ptr,
                    client_msg.u.gw_message.raw_ts_data.len);
    ...
    case WMSI_MSG_FORMAT_CDMA:
      /* fill in message header values */
      client_msg.msg_hdr.message_mode = WMS_MESSAGE_MODE_CDMA;
      client_msg.msg_hdr.tag          = WMS_TAG_MO_NOT_SENT;
      client_msg.msg_hdr.mem_store    = WMS_MEMORY_STORE_NONE;
      client_msg.msg_hdr.index        = WMS_DUMMY_MESSAGE_INDEX;

      /* message format */
      client_msg.u.cdma_message.raw_ts.format =
        qmi_wmsi_to_wms_format((qmi_wmsi_message_format_e_type)v_in_req.msg_format);

      /* message length */
      client_msg.u.cdma_message.raw_ts.len = v_in_req.msg_len;

      /* error checking */
      if ((WMS_FORMAT_MAX <= client_msg.u.cdma_message.raw_ts.format) ||
          (WMSI_MAX_LEN   <= client_msg.u.cdma_message.raw_ts.len))
      {
        errval = QMI_ERR_INVALID_ARG;
        goto send_result;
      }
      ...
      (void)memscpy(client_msg.u.cdma_message.raw_ts.data,
                    v_in_req.msg_len,
                    v_in_req.msg_data,
                    v_in_req.msg_len);

      errval = (qmi_error_e_type) qmi_wmsi_from_wms_status(
        wms_ts_cdma_OTA2cl(v_in_req.msg_data, v_in_req.msg_len, &client_msg));
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    if (got_retry_message_tlv)
    {
      retry_message = (v_in_opt5.retry_message == 1) ? TRUE : FALSE;

      if (got_retry_message_id_tlv)
      {
        retry_message_id = v_in_opt6.retry_message_id;
      }
    }
    ...
    if (WMSI_MSG_FORMAT_CDMA == (qmi_wmsi_message_format_e_type)v_in_req.msg_format)
    {
      ...
      if (got_force_on_dc)
      {
        force_on_dc = (v_in_opt1.force_on_dc != 0) ? TRUE : FALSE;
      ...
      if ( got_follow_on_dc ) 
      {
        follow_on_dc = (v_in_opt2.follow_on_dc != 0) ? TRUE : FALSE;
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    cmd_node->cache.raw_send.got_user_data_tlv = got_user_data_tlv;
    if (async_send)
    {
      cmd_node->cache.raw_send.user_data = v_in_opt7.user_data;
  ...
  if (WMS_RPT_OK != event_info_ptr->submit_report_info.report_status)
  {
    ...
    else
    {
      ...
      if (QMI_ERR_MESSAGE_DELIVERY_FAILURE == errval)
      {
        ...
        if ((WMS_MESSAGE_MODE_CDMA == event_info_ptr->submit_report_info.message_mode) &&
            (WMS_RPT_1X_AND_VOICE_NOT_ALLOWED == event_info_ptr->submit_report_info.report_status))
        {
          raw_send_ind_pdu->message_delivery_failure_cause       = (wms_message_delivery_failure_cause_enum_v01)WMSI_MESSAGE_BLOCKED_DUE_TO_ACTIVE_1X_VOICE_OR_DATA_CALL;
          raw_send_ind_pdu->message_delivery_failure_cause_valid = TRUE;
        }
    ...
    if (TRUE == cmd_node->wms_cl_sp->report_status.report_ll_err_codes)
    {
       qmi_wmsi_reject_e_type reject_type = qmi_wms_rej_type_to_wmsi_rej_type(event_info_ptr->submit_report_info.err_info.wms_rej_type);

       /* Lower Layer Reject cause information TLV*/
       if ( (WMS_MESSAGE_MODE_GW == event_info_ptr->submit_report_info.message_mode) &&
            (WMSI_REJECT_CAUSE_MAX != reject_type) ) 
       {
         raw_send_ind_pdu->rej_cause_info.reject_type  = (wms_reject_type_enum_v01)reject_type;
         raw_send_ind_pdu->rej_cause_info.reject_value = (uint8)event_info_ptr->submit_report_info.err_info.wms_rej_value;

         raw_send_ind_pdu->rej_cause_info_valid = TRUE;
       }
    }

    if(TRUE == event_info_ptr->submit_report_info.ims_cause_info.sms_over_ims)
    {
      raw_send_ind_pdu->sms_ims_rej_cause_info = event_info_ptr->submit_report_info.ims_cause_info.ims_cause_value;
      raw_send_ind_pdu->sms_ims_rej_cause_info_valid = TRUE;
    }
  }
  ...
  if (WMS_RPT_OK != event_info_ptr->submit_report_info.report_status)
  {
    ...
    else
    {
      ...
      if (QMI_ERR_MESSAGE_DELIVERY_FAILURE == errval)
      {
        ...
        if ((WMS_MESSAGE_MODE_CDMA == event_info_ptr->submit_report_info.message_mode) &&
            (WMS_RPT_1X_AND_VOICE_NOT_ALLOWED == event_info_ptr->submit_report_info.report_status))
        {
          mem_send_ind_pdu->message_delivery_failure_cause       = (wms_message_delivery_failure_cause_enum_v01)WMSI_MESSAGE_BLOCKED_DUE_TO_ACTIVE_1X_VOICE_OR_DATA_CALL;
          mem_send_ind_pdu->message_delivery_failure_cause_valid = TRUE;
        }
    ...
    if (TRUE == cmd_node->wms_cl_sp->report_status.report_ll_err_codes)
    {
       ...
       if ( (WMS_MESSAGE_MODE_GW == event_info_ptr->submit_report_info.message_mode) &&
            (WMSI_REJECT_CAUSE_MAX != reject_type) ) 
       {
         mem_send_ind_pdu->rej_cause_info.reject_type  = (wms_reject_type_enum_v01)reject_type;
         mem_send_ind_pdu->rej_cause_info.reject_value = (uint8)event_info_ptr->submit_report_info.err_info.wms_rej_value;

         mem_send_ind_pdu->rej_cause_info_valid = TRUE;
       }
    }
    if(TRUE == event_info_ptr->submit_report_info.ims_cause_info.sms_over_ims)
    {
      mem_send_ind_pdu->sms_ims_rej_cause_info = event_info_ptr->submit_report_info.ims_cause_info.ims_cause_value;
      mem_send_ind_pdu->sms_ims_rej_cause_info_valid = TRUE;
    }
  }
  ...
  if (WMS_RPT_OK != event_info_ptr->submit_report_info.report_status)
  {
    ...
    else
    {
      ...
      if (QMI_ERR_MESSAGE_DELIVERY_FAILURE == errval)
      {
        ...
        if ((WMS_MESSAGE_MODE_GW == event_info_ptr->submit_report_info.message_mode) &&
            (WMS_RPT_MO_CONTROL_DISALLOW == event_info_ptr->submit_report_info.report_status))
        {
          mem_send_resp_pdu->message_delivery_failure_cause       = (wms_message_delivery_failure_cause_enum_v01 )WMSI_MESSAGE_BLOCKED_DUE_TO_CALL_CONTROL;
          mem_send_resp_pdu->message_delivery_failure_cause_valid = TRUE;
        ...
        if ((WMS_MESSAGE_MODE_CDMA == event_info_ptr->submit_report_info.message_mode) &&
            (WMS_RPT_1X_AND_VOICE_NOT_ALLOWED == event_info_ptr->submit_report_info.report_status))
        {
          mem_send_resp_pdu->message_delivery_failure_cause       = (wms_message_delivery_failure_cause_enum_v01)WMSI_MESSAGE_BLOCKED_DUE_TO_ACTIVE_1X_VOICE_OR_DATA_CALL;
          mem_send_resp_pdu->message_delivery_failure_cause_valid = TRUE;
        }
    ...
    if (TRUE == cmd_node->wms_cl_sp->report_status.report_ll_err_codes)
    {
       ...
       if ( (WMS_MESSAGE_MODE_GW == event_info_ptr->submit_report_info.message_mode) &&
            (WMSI_REJECT_CAUSE_MAX != reject_type) ) 
       {
         mem_send_resp_pdu->rej_cause_info.reject_type  = (wms_reject_type_enum_v01)reject_type;
         mem_send_resp_pdu->rej_cause_info.reject_value = (uint8)event_info_ptr->submit_report_info.err_info.wms_rej_value;

         mem_send_resp_pdu->rej_cause_info_valid = TRUE;
       }
    }
    if(TRUE == event_info_ptr->submit_report_info.ims_cause_info.sms_over_ims)
    {
      mem_send_resp_pdu->sms_ims_rej_cause_info = event_info_ptr->submit_report_info.ims_cause_info.ims_cause_value;
      mem_send_resp_pdu->sms_ims_rej_cause_info_valid = TRUE;
    }
  }

  if (WMS_MO_CTRL_STATUS_MOD == cmd_node->cache.raw_send.mo_ctrl_status)
  {
    mem_send_resp_pdu->call_control_modified_info.alpha_id_len = cmd_node->cache.raw_send.alpha_id_len;

    (void)memscpy(mem_send_resp_pdu->call_control_modified_info.alpha_id,
                  cmd_node->cache.raw_send.alpha_id_len,
                  cmd_node->cache.raw_send.alpha_id,
                  cmd_node->cache.raw_send.alpha_id_len);
	
    mem_send_resp_pdu->call_control_modified_info_valid = TRUE;
  }
  ...
  if (WMS_RPT_OK != event_info_ptr->submit_report_info.report_status)
  {
    ...
    else
    {
      ...
      if (QMI_ERR_MESSAGE_DELIVERY_FAILURE == errval)
      {
        ...
        if ((WMS_MESSAGE_MODE_CDMA == event_info_ptr->submit_report_info.message_mode) &&
            (WMS_RPT_1X_AND_VOICE_NOT_ALLOWED == event_info_ptr->submit_report_info.report_status))
        {
          raw_send_resp_pdu->message_delivery_failure_cause       = (wms_message_delivery_failure_cause_enum_v01)WMSI_MESSAGE_BLOCKED_DUE_TO_ACTIVE_1X_VOICE_OR_DATA_CALL;
          raw_send_resp_pdu->message_delivery_failure_cause_valid = TRUE;
        }
    ...
    if (TRUE == cmd_node->wms_cl_sp->report_status.report_ll_err_codes)
    {
       ...
       if ( (WMS_MESSAGE_MODE_GW == event_info_ptr->submit_report_info.message_mode) &&
            (WMSI_REJECT_CAUSE_MAX != reject_type) ) 
       {
         raw_send_resp_pdu->rej_cause_info.reject_type  = (wms_reject_type_enum_v01)reject_type;
         raw_send_resp_pdu->rej_cause_info.reject_value = (uint8)event_info_ptr->submit_report_info.err_info.wms_rej_value;

         raw_send_resp_pdu->rej_cause_info_valid = TRUE;
       }
    }
   
    if(TRUE == event_info_ptr->submit_report_info.ims_cause_info.sms_over_ims)
    {
      raw_send_resp_pdu->sms_ims_rej_cause_info = (uint16_t)event_info_ptr->submit_report_info.ims_cause_info.ims_cause_value;
      raw_send_resp_pdu->sms_ims_rej_cause_info_valid = TRUE;
    } 
  }
...
)
{
  ...
  /* maximum number of messages in SIM/NV can be 255 and index will be 0-254 */
...
)
{
  ...
  struct
  {
    uint8  smsc_addr[WMSI_SMSC_ADDRESS_MAX];
  } v_in_req;

  struct
  {
    uint8  smsc_type[WMSI_ADDRESS_TYPE_MAX];
  } v_in_opt1;
  ...
  boolean            got_smsc_addr_tlv = FALSE;
  boolean            got_index_tlv = FALSE;
  boolean            got_smsc_type_tlv = FALSE;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  while (*sdu_in)
  {
    ...
    case WMSI_PRM_TYPE_SMSC_TYPE:
      if (sizeof(v_in_opt1) >= len)
      {
        got_smsc_type_tlv = TRUE;
        value = &v_in_opt1;
      }
      else
      {
    ...
    case WMSI_PRM_TYPE_SMSC_INDEX:
      if (sizeof(v_in_opt2) >= len)
      {
        value = &v_in_opt2;
        got_index_tlv = TRUE;
      }
  ...
  if (! (got_smsc_addr_tlv))
  {
    errval = QMI_ERR_MISSING_ARG;
    goto send_result;
  }

  if (got_index_tlv && (WMSI_MESSAGE_LIST_MAX <= v_in_opt2.index) )
  {
    errval = QMI_ERR_INVALID_INDEX;
    goto send_result;
  }

  if (got_smsc_type_tlv)
  {
    uint8 i;
	  
    // Check for :- SMSC address type string must be terminated with a NULL character.
    for (i = 0; i < WMSI_ADDRESS_TYPE_MAX; i++)
    {
      if ('\0' == v_in_opt1.smsc_type[i])
      {
        break;
      }
    }
	  
    if (WMSI_ADDRESS_TYPE_MAX == i)
    {
      // NULL character not found in entire string.
      errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    } 
  }
  ...
  if (!qmi_wmsi_str_to_addr(&dummy_addr,
                            (uint8 *) v_in_req.smsc_addr,
                            (uint8 *) v_in_opt1.smsc_type,
                            QMI_WMS_TEXT_MODE,
                            WMSI_MSG_MODE_GW))
  {
    errval = QMI_ERR_INVALID_ARG;
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    */
    if (got_index_tlv)
    {
      template_msg_ptr->msg_hdr.index = v_in_opt2.index;
...
#pragma pack(pop) // Revert alignment to what it was previously
  ...
  qmi_result_e_type  result;
  boolean            retval;
  boolean            got_send_ack_tlv = FALSE;
  boolean            got_3gpp2_fail_info_tlv = FALSE;
  boolean            got_3gpp_fail_info_tlv = FALSE;
  boolean            got_sms_on_ims_tlv = FALSE;
  boolean            sms_on_ims = FALSE;
  boolean            got_user_data_tlv = FALSE;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (SYS_MODEM_AS_ID_NONE == as_id)
  {
    MSG_HIGH_0("Invalid Subscription");
    errval = QMI_ERR_INTERNAL;
    goto send_result;
  }
  ...
  while (*sdu_in)
  {
    ...
    switch (type)
    {
      case QMI_TYPE_REQUIRED_PARAMETERS:
        ...
        got_send_ack_tlv = TRUE;
        value = (void *) &v_in_req;
        break;

      case WMSI_PRM_TYPE_3GPP2_FAIL_INFO:
        expected_len = sizeof(v_in_opt1);
        got_3gpp2_fail_info_tlv = TRUE;
        value = &v_in_opt1;
        break;

      case WMSI_PRM_TYPE_3GPP_FAIL_INFO:
        expected_len = sizeof(v_in_opt2);
        got_3gpp_fail_info_tlv = TRUE;
        value = &v_in_opt2;
        break;

      case WMSI_PRM_TYPE_SEND_ACK_SMS_ON_IMS:
        expected_len = sizeof(v_in_opt3);
        got_sms_on_ims_tlv = TRUE;
        value = &v_in_opt3;
        break;

      case WMSI_PRM_TYPE_ASYNC_SEND_ACK_REQ_USER_DATA:
        expected_len = sizeof(v_in_opt4);
        got_user_data_tlv = TRUE;
        value = &v_in_opt4;
        break;
  ...
  ack_info.transaction_id = v_in_req.transaction_id;
  if (WMS_MESSAGE_MODE_MAX <= v_in_req.message_mode)
  {
    errval = QMI_ERR_INVALID_ARG;
    goto send_result;
  }

  ack_info.message_mode = (wms_message_mode_e_type)v_in_req.message_mode;

  if (WMS_MESSAGE_MODE_CDMA == ack_info.message_mode)
  {
    /* used to hold 'success' state as well*/
    ack_info.u.cdma.error_class = (v_in_req.success == 1) ? WMS_ERROR_NONE : WMS_ERROR_TEMP;
    if (got_3gpp2_fail_info_tlv)
    {
      ack_info.u.cdma.error_class = (wms_error_class_e_type)v_in_opt1.error_class;
      ack_info.u.cdma.tl_status = (wms_cdma_tl_status_e_type)v_in_opt1.tl_status;
    }
  }
  else if (WMS_MESSAGE_MODE_GW == ack_info.message_mode)
  {
    ack_info.u.gw.success = (v_in_req.success == 1) ? TRUE : FALSE;
    if (got_3gpp_fail_info_tlv)
    {
      ack_info.u.gw.rp_cause = (wms_rp_cause_e_type)v_in_opt2.rp_cause;
      ack_info.u.gw.u.error.tp_cause = (wms_tp_cause_e_type)v_in_opt2.tp_cause;
    }
  }
  ...
  if (got_sms_on_ims_tlv)
  {
     sms_on_ims = (v_in_opt3.sms_on_ims == 1) ? TRUE : FALSE;
  }
  else if (qmi_wmsi_mobile_is_ims_registered(as_id))
  {
     sms_on_ims = TRUE;
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    cmd_node->async_cmd = FALSE;
    cmd_node->cache.send_ack.got_user_data_tlv = got_user_data_tlv;
    if (async_send_ack)
    {
      cmd_node->cache.send_ack.user_data = v_in_opt4.user_data;
      cmd_node->async_cmd = TRUE;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  errval = (qmi_error_e_type)
           qmi_wmsi_from_wms_status (wms_dbg_ms_set_retry_period(qmi_wmsi_global.wms_cid,
                                                              (wms_cmd_cb_type) qmi_wms_cmd_status_cb,
                                                              (void *) cmd_buf_p,
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  errval = (qmi_error_e_type)
    qmi_wmsi_from_wms_status (wms_dbg_ms_set_retry_interval(qmi_wmsi_global.wms_cid,
                                                         (wms_cmd_cb_type) qmi_wms_cmd_status_cb,
                                                         (void *) cmd_buf_p,
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  wms_message_mode = qmi_wmsi_to_wms_message_mode(message_mode);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for (cl_idx = 0; cl_idx < WMSI_MAX_CLIDS; cl_idx++)
  {
    ...
    {
      if (cl_sp->indication_reg.mem_full_ind_events)
      {
...
#pragma pack(pop) // Revert alignment to what it was previously
  ...
  wms_client_message_s_type client_msg;
  qmi_wms_cmd_node_type *       cmd_node = NULL;
  boolean            got_mem_store_tlv = FALSE;
  boolean            got_sms_on_ims_tlv = FALSE;
  boolean            sms_on_ims = FALSE;
  boolean            got_user_data_tlv = FALSE;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  memset(&v_in_req, 0, sizeof(v_in_req));
  memset(&v_in_opt, 0, sizeof(v_in_opt));
  memset(&client_msg, 0, sizeof(wms_client_message_s_type));
  ...
  while (*sdu_in)
  {
    ...
    switch (type)
    {
      case QMI_TYPE_REQUIRED_PARAMETERS:
        expected_len = sizeof(v_in_req);
        got_mem_store_tlv = TRUE;
        value = (void *) &v_in_req;
        break;

      case WMSI_PRM_TYPE_MEM_STORE_SMS_ON_IMS:
        expected_len = sizeof(v_in_opt);
        got_sms_on_ims_tlv = TRUE;
        value = (void *) &v_in_opt;
        break;

      case WMSI_PRM_TYPE_ASYNC_MEM_STORE_REQ_USER_DATA:
        expected_len = sizeof(v_in_opt2);
        got_user_data_tlv = TRUE;
        value = (void *) &v_in_opt2;
        break;
  ...
  /*-----------------------------------------------------------------------
    ...
    validate the input parameters
  -----------------------------------------------------------------------*/
  if (WMSI_MSG_MODE_MAX <= (qmi_wmsi_message_mode_e_type) v_in_req.message_mode)
  {
    errval = QMI_ERR_INVALID_ARG;
    goto send_result;
  }

  switch ((qmi_wmsi_message_mode_e_type) v_in_req.message_mode)
  {
#ifdef FEATURE_GWSMS
    case WMSI_MSG_MODE_GW:
      message_mode = WMSI_MSG_MODE_GW;
  ...
  /* message storage type */
  storage_type = qmi_wmsi_to_wms_storage((qmi_wmsi_memory_storage_e_type)
                                         v_in_req.storage_type,
                                         message_mode);
  /* set the read storage index */
  storage_index = v_in_req.storage_index;
  ...
  client_msg.msg_hdr.message_mode = qmi_wmsi_to_wms_message_mode(message_mode);
  client_msg.msg_hdr.tag = WMS_TAG_NONE;
  client_msg.msg_hdr.mem_store = storage_type;
  client_msg.msg_hdr.index = storage_index;
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    if (got_sms_on_ims_tlv)
    {
      sms_on_ims = (v_in_opt.sms_on_ims == 1) ? TRUE : FALSE;
    }
    else if (qmi_wmsi_mobile_is_ims_registered(as_id))
    {
      sms_on_ims = TRUE;
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    if (async_mem_send)
    {
      cmd_node->cache.raw_send.user_data = v_in_opt2.user_data;
      cmd_node->async_cmd = TRUE;
...
)
{
  ...
  errval = qmi_wmsi_get_message_waiting_resp((wms_get_message_waiting_resp_msg_v01*)response_pdu, sub);
  send_result:
  ENCODE_RESPONSE_TLV(wms_get_message_waiting_resp_msg_v01, QMI_WMS_GET_MESSAGE_WAITING_RESP_V01); 
  QMI_WMSI_MEM_FREEIF(response_pdu);
  return response;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for (cl_idx = 0; cl_idx < WMSI_MAX_CLIDS; cl_idx++)
  {
    ...
    {
      if (cl_sp->indication_reg.reg_smsc_addr_events)
      {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (set_indication_reg_req_pdu->reg_smsc_addr_info_events_valid)
  {
    if (WMSI_INDICATION_MAX <= set_indication_reg_req_pdu->reg_smsc_addr_info_events)
    {
      errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    }
  ...
  if (set_indication_reg_req_pdu->mem_full_ind_events_valid)
  {
    if (WMSI_INDICATION_MAX <= set_indication_reg_req_pdu->mem_full_ind_events)
    {
 	  errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    }
  ...
  if (set_indication_reg_req_pdu->reg_smsc_addr_info_events_valid)
  {
    if (WMSI_INDICATION_DISABLE == set_indication_reg_req_pdu->reg_smsc_addr_info_events)
    {
      wms_cl_sp->indication_reg.reg_smsc_addr_events = FALSE;
    }
    else if (WMSI_INDICATION_ENABLE == set_indication_reg_req_pdu->reg_smsc_addr_info_events)
    {
      wms_cl_sp->indication_reg.reg_smsc_addr_events = TRUE;
    }
  }
  
  if (set_indication_reg_req_pdu->mem_full_ind_events_valid)
  {
    if (WMSI_INDICATION_DISABLE == set_indication_reg_req_pdu->mem_full_ind_events)
    {
       wms_cl_sp->indication_reg.mem_full_ind_events = FALSE;
    }
    else if (WMSI_INDICATION_ENABLE == set_indication_reg_req_pdu->mem_full_ind_events)
    {
       wms_cl_sp->indication_reg.mem_full_ind_events = TRUE;
    }
  }
...
)
{
  ...
  if (qmi_wms_get_subscription_from_asid( qmi_wmsi_global.transport_layer[sub].as_id ) != sub)
  {
  ...
  if (qmi_wmsi_global.transport_layer[sub].registered_ind)
  {
    transport_layer_info_resp_pdu.transport_layer_info_valid          = TRUE;
    transport_layer_info_resp_pdu.transport_layer_info.transport_type = (uint8)qmi_wmsi_global.transport_layer[sub].transport_type;
    transport_layer_info_resp_pdu.transport_layer_info.transport_cap  = (uint8)qmi_wmsi_global.transport_layer[sub].transport_cap;
  }

  transport_layer_info_resp_pdu.registered_ind       = qmi_wmsi_global.transport_layer[sub].registered_ind;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (qmi_wmsi_global.transport_layer[sub].registered_ind)
  {
    ...
    ind_pdu->transport_layer_info.transport_type = (uint8)qmi_wmsi_global.transport_layer[sub].transport_type;
    ind_pdu->transport_layer_info.transport_cap  = (uint8)qmi_wmsi_global.transport_layer[sub].transport_cap;
  }

  ind_pdu->registered_ind = qmi_wmsi_global.transport_layer[sub].registered_ind;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for (cl_idx = 0; cl_idx < WMSI_MAX_CLIDS; cl_idx++)
  {
    ...
    if ((NULL != cl_sp) &&
        (QMI_SVC_CLID_UNUSED != cl_sp->common.clid) &&
        (cl_sp->subscription_status.subscription_type == sub))
    {
      if (cl_sp->indication_reg.reg_transport_layer_events)
      {
        qmi_wmsi_transport_layer_info_ind(cl_sp, sub);
      }
    }
  }
...
)
{
  ...
  if (qmi_wms_get_subscription_from_asid( qmi_wmsi_global.transport_nw_reg_status[sub].as_id ) != sub)
  {
  ...
  get_transport_nw_reg_resp_pdu.transport_nw_reg_status       = (uint8)qmi_wmsi_global.transport_nw_reg_status[sub].nw_reg_status;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  ind_pdu->transport_nw_reg_status = (uint8)qmi_wmsi_global.transport_nw_reg_status[sub].nw_reg_status;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for (cl_idx = 0; cl_idx < WMSI_MAX_CLIDS; cl_idx++)
  {
        ...
        (cl_sp->subscription_status.subscription_type == sub))
    {
      ...
      {
        qmi_wmsi_transport_nw_reg_info_ind(cl_sp, sub);
      }
    }
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    {
      // Send MWI indication to client.
      MSG_HIGH_0("QMI_WMS sends missed MWI indication");
...
)
{
  ...
  /*-------------------------------------------------------------------------
    Build the response from back to front
  -------------------------------------------------------------------------*/
  get_ind_reg_resp_pdu.mem_full_ind_events_valid = TRUE;
  get_ind_reg_resp_pdu.mem_full_ind_events       = wms_cl_sp->indication_reg.mem_full_ind_events;  

  get_ind_reg_resp_pdu.reg_smsc_addr_info_events_valid = TRUE;
  get_ind_reg_resp_pdu.reg_smsc_addr_info_events       = wms_cl_sp->indication_reg.reg_smsc_addr_events;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (WMSI_DBG_RETRY_TIMER_MAX != qmi_wmsi_global.dbg_retry_period[as_id])
  {
    /* DBG retry period already read from WMS, return cached value */
    /*-------------------------------------------------------------------------
      Build the response from back to front
    -------------------------------------------------------------------------*/
    get_retry_period_resp_pdu.retry_period       = qmi_wmsi_global.dbg_retry_period[as_id];
    get_retry_period_resp_pdu.retry_period_valid = TRUE;	
  }
  else
  {
    errval = (qmi_error_e_type) qmi_wmsi_from_wms_status(
               wms_dbg_ms_get_retry_period(qmi_wmsi_global.wms_cid,
                                          (wms_cmd_cb_type) qmi_wms_cmd_status_cb,
                                          (void *) cmd_buf_p,
                                          as_id));
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (WMSI_DBG_RETRY_TIMER_MAX != qmi_wmsi_global.dbg_retry_interval[as_id])
  {
    /* DBG retry interval already read from WMS, return cached value */
    /*-------------------------------------------------------------------------
      Build the response from back to front
    -------------------------------------------------------------------------*/
    get_retry_interval_resp_pdu.retry_interval       = qmi_wmsi_global.dbg_retry_interval[as_id];
    get_retry_interval_resp_pdu.retry_interval_valid = TRUE;
  }
  else
  {
    errval = (qmi_error_e_type) qmi_wmsi_from_wms_status(
               wms_dbg_ms_get_retry_interval(qmi_wmsi_global.wms_cid,
                                          (wms_cmd_cb_type) qmi_wms_cmd_status_cb,
                                          (void *) cmd_buf_p,
                                          as_id));
...
)
{
  ...
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  memset(&get_service_ready_resp_pdu, 0, sizeof(wms_get_service_ready_status_resp_msg_v01));
...
)
{
  ...
  MSG_HIGH_1("message_mode %d", wms_msg_mode);
  return wms_msg_mode;
}
...
{
  qmi_wmsi_radio_access_tech_e_type qmi_rat;

  switch (wms_rat)
  {
    case WMS_SYS_RAT_GSM_RADIO_ACCESS:
      qmi_rat = WMSI_SYS_RAT_GSM_RADIO_ACCESS;
      break;

    case WMS_SYS_RAT_UMTS_RADIO_ACCESS:
      qmi_rat = WMSI_SYS_RAT_UMTS_RADIO_ACCESS;
      break;

    case WMS_SYS_RAT_LTE_RADIO_ACCESS:
      qmi_rat = WMSI_SYS_RAT_LTE_RADIO_ACCESS;
      break;

    case WMS_SYS_RAT_CDMA_RADIO_ACCESS:
      qmi_rat = WMSI_SYS_RAT_CDMA_RADIO_ACCESS;
      break;

    default:
      qmi_rat = WMSI_SYS_RAT_MAX;
      break;
  }
...
)
{
  ...
  switch (wms_err)
  {
    ...
    case WMS_CMD_ERR_1X_AND_VOICE_NOT_ALLOWED:
...
/* This function can be used for enumerating over furture reject types */
qmi_wmsi_reject_e_type qmi_wms_rej_type_to_wmsi_rej_type(
  wms_reject_e_type rej_type
)
{
  qmi_wmsi_reject_e_type wmsi_rej_type;

  switch (rej_type)
  {
    case WMS_OTA_REJECT_CAUSE:
      wmsi_rej_type = WMSI_OTA_REJECT_CAUSE;
      break;

    default:
      wmsi_rej_type = WMSI_REJECT_CAUSE_MAX;
      break;
  }

  return wmsi_rej_type;
}
...
{
  qmi_wmsi_raw_send_tlv_e_type tlv_type;
  switch (type)
  {
     case QMI_TYPE_REQUIRED_PARAMETERS:
       tlv_type = WMSI_TLV_TYPE_REQ_PARAM;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_ONE:
       tlv_type = WMSI_TLV_TYPE_FORCE_ON_DC;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_TWO:
       tlv_type = WMSI_TLV_TYPE_FOLLOW_ON_DC;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_THREE:
       tlv_type = WMSI_TLV_TYPE_LINK_CONTROL;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_FOUR:
       tlv_type = WMSI_TLV_TYPE_SMS_ON_IMS;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_FIVE:
       tlv_type = WMSI_TLV_TYPE_RETRY_MESSAGE;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_SIX:
       tlv_type = WMSI_TLV_TYPE_RETRY_MESSAGE_ID;
       break;

     case WMSI_OPTIONAL_PRM_TYPE_SEVEN:
       /* The 7th optional TLV is the user data TLV in case of
          ASYNC RAW SEND and Link Enable Mode TLV in case of SYNC
          RAW SEND */
       if (is_async)
       {
         tlv_type = WMSI_TLV_TYPE_USER_DATA;
       }
       else
       {
         tlv_type = WMSI_TLV_TYPE_LINK_ENABLE_MODE;
       }
       break;

     case WMSI_OPTIONAL_PRM_TYPE_EIGHT:
       /* No 8th optional TLV in case of SYNC RAW SEND */
       if (is_async)
       {
         tlv_type = WMSI_TLV_TYPE_LINK_ENABLE_MODE;
       }
       ...
       {
         tlv_type = WMSI_TLV_TYPE_MAX;
       }
       break;

     case WMSI_OPTIONAL_PRM_TYPE_NINE:
       if (is_async)
       {
         tlv_type = WMSI_TLV_TYPE_MAX;
       }
       ...
       {
         tlv_type = WMSI_TLV_TYPE_SMS_COMMAND_MODE;
       }
       MSG_HIGH_1("for SYNC: 9th:%d",tlv_type);
       break;
     case WMSI_OPTIONAL_PRM_TYPE_TEN:
       ...
       MSG_HIGH_1("for ASYNC: 10th:%d",tlv_type);
...
{
  if ((client_as_id == qmi_wmsi_global.transport_layer[client_as_id].as_id) &&
      (WMSI_TRANSPORT_LAYER_STATE_INIT == qmi_wmsi_global.transport_layer[client_as_id].state) &&
      (TRUE == qmi_wmsi_global.transport_layer[client_as_id].registered_ind) &&
      (WMSI_TRANSPORT_TYPE_IMS == qmi_wmsi_global.transport_layer[client_as_id].transport_type))
  {
    return TRUE;
  }
