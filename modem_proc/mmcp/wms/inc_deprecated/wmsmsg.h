...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/wms/inc_deprecated/wmsmsg.h#1 $
...
typedef struct
{
  ...
  wms_msg_transport_update_sms_retry_status_cb_type  sms_retry_cb; //CB provided by transport layer to inform SMS retry status
#endif
...
void wms_msg_lte_rrc_msg_state_ind( 
   sys_modem_as_id_e_type         as_id,
   wms_msg_transport_type_e_type  transport_id,
