...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/wms/inc_deprecated/wmsbc.h#1 $
...
#define WMS_BC_SECS_IN_SIX_MIN    (6 * 60)
...
typedef struct wms_cell_info_struct
{
   ...
   uint32        phy_cell_id;  /* Physical cell id */
...
extern boolean wms_is_KDDI_PLMN(
lte_rrc_plmn_s   *plmn
);
#endif
