...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_rf.h#1 $
...
typedef struct
{
  policyman_base_t gwBandsBase;
  policyman_base_t lteBandsBase;
  policyman_base_t tdsBandsBase;
} rf_bands_base_t;
...
*/
rf_bands_item_t * policyman_get_bands_for_ueMode(
