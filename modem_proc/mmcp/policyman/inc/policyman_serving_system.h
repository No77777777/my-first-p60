...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_serving_system.h#1 $
...
#define PRINT_LOCATION_INFO(loc)                                               \
  POLICYMAN_MSG_HIGH_7( "location_info sub0: (user %d, sub %d, validforlocation %d) sub1: (user %d, sub %d, validforlocation %d) hlos %d", \
                         loc.subs[SYS_MODEM_AS_ID_1].haveLocationFromUser,    \
                         loc.subs[SYS_MODEM_AS_ID_1].haveLocationOnSub,       \
                         loc.subs[SYS_MODEM_AS_ID_1].subIsValidForLocation,   \
                         loc.subs[SYS_MODEM_AS_ID_2].haveLocationFromUser,    \
                         loc.subs[SYS_MODEM_AS_ID_2].haveLocationOnSub,       \
                         loc.subs[SYS_MODEM_AS_ID_2].subIsValidForLocation,   \
                         loc.haveHLOSLocation )


typedef struct
{
  boolean   haveLocationFromUser;
  boolean   haveLocationOnSub;
  boolean   subIsValidForLocation;
} subs_location_info_t;

typedef struct
{
  subs_location_info_t  subs[POLICYMAN_NUM_SUBS];
...
/*-------- policyman_mdump_ssinfo --------*/
void policyman_ssinfo_mdump(
    policyman_ss_info_t *pSsInfo
);
