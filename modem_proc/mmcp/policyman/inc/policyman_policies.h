...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_policies.h#1 $
...
/*-------- policyman_mdump_policies --------*/
void policyman_policies_mdump(
  void
);
