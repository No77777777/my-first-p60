...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_dbg.h#1 $
...
#define POLICYMAN_UT_MSG_7(str, a, b, c, d, e, f, g)
#define POLICYMAN_UT_MSG_8(str, a, b, c, d, e, f, g, h)
#define POLICYMAN_UT_MSG_9(str, a, b, c, d, e, f, g, h, i)
...
#define POLICYMAN_UT_MSG_S7(str, a, b, c, d, e, f, g)
#define POLICYMAN_UT_MSG_S8(str, a, b, c, d, e, f, g, h)
...
#ifdef FEATURE_QSH_MDUMP 
#define POLICYMAN_ERR_FATAL(str, a, b, c)\
    qsh_mdump_set_crash_client(QSH_CLT_PM, QSH_CLT_PM); \
    ERR_FATAL("=POLICYMAN= " str, a, b, c)
#else
...
#define POLICYMAN_CL_MSG_LOW_4(str, a, b, c, d)                 \
  do                                                            \
  {                                                             \
    if (MSG_LEGACY_LOW & (MSG_BUILD_MASK_MSG_SSID_POLICYMAN))   \
    {                                                           \
      if (policyman_caller_is_client())                         \
      {                                                         \
        POLICYMAN_MSG_LOW_4(str, a, b, c, d);                   \
      }                                                         \
    }                                                           \
  } while (0)  
...
#define POLICYMAN_CL_MSG_MED_4(str, a, b, c, d)                 \
  do                                                            \
  {                                                             \
    if (MSG_LEGACY_MED & (MSG_BUILD_MASK_MSG_SSID_POLICYMAN))   \
    {                                                           \
      if (policyman_caller_is_client())                         \
      {                                                         \
        POLICYMAN_MSG_MED_4(str, a, b, c, d);                   \
      }                                                         \
    }                                                           \
  } while (0)
...
#define POLICYMAN_CL_MSG_HIGH_4(str, a, b, c, d)                \
  do                                                            \
  {                                                             \
    if (MSG_LEGACY_HIGH & (MSG_BUILD_MASK_MSG_SSID_POLICYMAN))  \
    {                                                           \
      if (policyman_caller_is_client())                         \
      {                                                         \
        POLICYMAN_MSG_HIGH_4(str, a, b, c, d);                  \
      }                                                         \
    }                                                           \
  } while (0)
...
#define POLICYMAN_CL_MSG_ERROR_4(str, a, b, c, d)               \
  do                                                            \
  {                                                             \
    if (MSG_LEGACY_ERROR & (MSG_BUILD_MASK_MSG_SSID_POLICYMAN)) \
    {                                                           \
      if (policyman_caller_is_client())                         \
      {                                                         \
        POLICYMAN_MSG_ERROR_4(str, a, b, c, d);                 \
      }                                                         \
    }                                                           \
  } while (0)
