...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_efs.h#1 $
...
#define POLICYMAN_POST_POLICY_XML_NAME         "post.xml"
#define POLICYMAN_POST_POLICY_EFS_PATH         POLICYMAN_EFS_ROOT_DIR "/" POLICYMAN_POST_POLICY_XML_NAME
...
#define POLICYMAN_CA_COMBO_ROOT_DIR           "/ca_band_combos"
