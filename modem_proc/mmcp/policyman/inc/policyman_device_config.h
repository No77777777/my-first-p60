...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_device_config.h#1 $
...
#define  DEV_CFG_STR_E911_CONFIG     "e911_config"
#define  DEV_CFG_STR_CONFIG          "config"
...
typedef struct
{
  ...
  uint32                *pECallRatMask;         /* e911 subphone Rat Masks */
  boolean                forceUpdate;          /* Tells update code to update despite no changes */
  boolean                readFromDefault;
} device_configuration_t;
...
#define POLICYMAN_DEVICE_CONFIG_VERSION_NUM   4
...
void policyman_device_config_mdump(
  policyman_item_t const *pItem
);
