...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/inc/policyman_msgr_i.h#1 $
...
typedef void (*policyman_msgr_cb_fn_t) (msgr_hdr_s *pMsg, void *pContext, sys_modem_as_id_e_type  subsId);


/*-------- policyman_msgr_register_for_subs --------*/
/**
@brief  Register for a particular message UMID for a given subscription
