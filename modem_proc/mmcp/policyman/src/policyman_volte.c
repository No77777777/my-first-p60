...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/src/policyman_volte.c#1 $
...
)
{
  ...
  volte_enabled_state = policyman_ph_get_volte_enabled_state(pState, subsId);
  ...
  {
    policyman_ph_set_volte_enabled_state(pState, subsId, pVolteAction->volte_state );
  }
  return TRUE;
}
