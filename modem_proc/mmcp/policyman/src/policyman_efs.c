...
/*
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/policyman/src/policyman_efs.c#1 $
...
STATIC efs_file_entry efs_files[] = {
    ...
    { POLICYMAN_FREQ_LIST_NV_PATH,        policyman_efs_obliterate_persist_file, FALSE },
    { POLICYMAN_POST_POLICY_EFS_PATH,     policyman_efs_obliterate_device_file,  TRUE  },
};
