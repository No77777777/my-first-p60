...
$Header: //components/rel/mmcp.mpss/7.9.0/cust/inc/custmmode.h#1 $
...
** ---------------------------------------------------------------------*/
  ...
  */
  ...
  /* Define 3GPP related scan optimizations
  */
  #ifdef FEATURE_UTILS_CAFI_ENABLED
  #define FEATURE_MMODE_CAFI
  #endif 
  ...
  */
  ...
  /* Enhanced debug feature expands strings in run time & may affect
  ** the performance
  */
  #define FEATURE_SD_ENHANCED_DEBUG_MSG

  #if !defined( FEATURE_DISABLE_MMODE_DEBUG_STRING )
    #define CM_CRIT_STRING_MAPS_ACTIVE
  #endif
...
** ---------------------------------------------------------------------*/
  ...
  */
  ...
  #define FEATURE_SD_DEBUG_BUFFER
...
** ------------------------------------------------------------------------*/
  ...
  #if !defined( FEATURE_MMOC_LOW_MEM_TARGET )&& !defined( FEATURE_DISABLE_MMODE_DEBUG_STRING )
