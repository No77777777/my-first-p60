...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sm_cm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
/* ---------------------------------------------------------------------
** Primitive  : SMREG_DATA_CALL_ACTIVITY_IND
** Description:  Notification of data call cleanup or MMS activity from DS
** -------------------------------------------------------------------*/
typedef struct smreg_data_call_activity_ind
{
  sys_data_activity_e_type   activity;
  sys_modem_as_id_e_type     as_id;
} smreg_data_call_activity_ind_T;
