...
$Header: //components/rel/mmcp.mpss/7.9.0/api/bmcl1if.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum wcdma_priority_tag 
{
  LOW_PRIORITY ,
  HIGH_PRIORITY,
  CRITICAL_PRIORITY
