...
$Header: //components/rel/mmcp.mpss/7.9.0/api/rabmtask.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern boolean rabm_rabid_validate_per_sub(sys_modem_as_id_e_type as_id, rab_query_T query_type, byte Rabid);
