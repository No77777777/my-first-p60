...
$Header: //components/rel/mmcp.mpss/7.9.0/api/rlcbmcif.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern void cb_rlc_ctch_pdu_dropped_per_sub(dword pdu_sfn,sys_modem_as_id_e_type as_id);
extern void cb_rlc_ctch_pdu_dropped(dword pdu_sfn);
extern void cb_get_start_pdu_from_rlc(byte *rlc_pdu_ptr, byte sdu_len, sys_modem_as_id_e_type as_id);
#endif/*BMC_RLC_H*/
