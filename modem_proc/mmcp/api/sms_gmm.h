...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sms_gmm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct
{
   ...
   boolean overall_sms_status; /*0-inactive 1-CS or IMS SMS active*/
