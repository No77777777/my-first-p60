...
$Header: //components/rel/mmcp.mpss/7.9.0/api/smtask_v.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
/* Message posted from QSH call back to SM Queue*/
#define  SM_QSH_MESSAGE_IND  0x01

typedef struct sm_qsh_message_ind_s
{
  IMH_T                      IMH;
  qsh_client_cb_params_s     param;
}sm_qsh_message_ind_s_type;
...
{   
  ...
  {  
    ...
    gmmsm_establish_resend_ind_T  gmmsm_establish_resend_ind;
    ...
    smreg_data_call_activity_ind_T   data_call_activity;
    ...
    timer_expiry_T                timer_expiry;
     sm_qsh_message_ind_s_type        qsh_message_ind;
  } cmd;
