...
$Header: //components/rel/mmcp.mpss/7.9.0/api/mm_as_types.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct nas_lai_reject_list_tag
{
   forbidden_lai_T  lai[MAX_NO_FORBIDDEN_LAIS];
   byte                    write_ptr;
   byte                    length;
}nas_lai_reject_list_T;
...
typedef enum cs_domain_no_response_e
{
CALL_STATE_NORMAL = 0,
CALL_STATE_MO_REJECT_CAUSE15,
CALL_STATE_MT_PAGE_NO_SETUP	
}cs_domain_no_response_e_type;
