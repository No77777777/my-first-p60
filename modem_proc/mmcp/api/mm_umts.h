...
$Header: //components/rel/mmcp.mpss/7.9.0/api/mm_umts.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern boolean mm_is_call_in_progress(sys_modem_as_id_e_type as_id );
#endif
#endif
