...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sys_stru.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct forbidden_lai
{
    inter_task_lai_T lai;
    boolean is_lai_added_due_to_t3247;
}forbidden_lai_T;
