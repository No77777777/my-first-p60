...
/*==============================================================================
                           Module definitions
==============================================================================*/
/* NOTE: MMOC modules should take 0x51 to 0x54
** Max num modules allowed for TECH_MM is 84 or 0x54 */
...
enum
{
  ...
  MSGR_DEFINE_UMID(MM, MMOC, IND, VFR, 0x02, mmoc_vfr_map_s_type),
    /* MM_MMOC_VFR_IND */
