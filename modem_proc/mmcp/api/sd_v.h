...
/**===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/sd_v.h#3 $
...
#define SD_MCC_MACAU                455
#define SD_MCC_JAPAN                440
#define SD_MCC_SOUTH_KOREA          450
#define SD_MCC_HONGKONG             454
#define SD_MCC_NETHERLANDS          204

#define SD_MNC_CHINATEL_CDMA_DEFAULT     3
#define SD_MNC_CHINATEL_3GPP_DEFAULT    11
#define SD_MNC_CHINATEL_3GPP_NETHERLANDS 4
#define SD_MNC_CHINATEL_3GPP_HONGKONG_1  3
#define SD_MNC_CHINATEL_3GPP_HONGKONG_2  4

#define SD_CT_MNC1		         3
#define SD_CT_MNC2			 11
#define SD_CT_MNC3           12  
...
#define SD_BAND_LTE_EUTRAN_BAND46    SYS_BAND_LTE_EUTRAN_BAND46
#define SD_BAND_LTE_EUTRAN_BAND47    SYS_BAND_LTE_EUTRAN_BAND47
#define SD_BAND_LTE_EUTRAN_BAND48    SYS_BAND_LTE_EUTRAN_BAND48
#define SD_BAND_LTE_EUTRAN_BAND66    SYS_BAND_LTE_EUTRAN_BAND66
#define SD_BAND_LTE_EUTRAN_BAND71    SYS_BAND_LTE_EUTRAN_BAND71
#define SD_BAND_LTE_EUTRAN_BAND250   SYS_BAND_LTE_EUTRAN_BAND250
...
typedef enum {
 ...
 /**<  UL: 807.5 -  824;  DL: 852 � 869 */
  ...
  SD_SBAND_LTE_EUTRAN_BAND46 = SYS_SBAND_LTE_EUTRAN_BAND46,
  /**< DL: 5150-5925 */

  SD_SBAND_LTE_EUTRAN_BAND47 = SYS_SBAND_LTE_EUTRAN_BAND47,
  /**< DL: ? */

  SD_SBAND_LTE_EUTRAN_BAND48 = SYS_SBAND_LTE_EUTRAN_BAND48,
  /**< DL: ? */
  ...
  SD_SBAND_LTE_EUTRAN_BAND250 = SYS_SBAND_LTE_EUTRAN_BAND250,
...
/** structure of Emergency callback modes
*/

typedef struct {
  boolean               enter;
  /* enter or exit. true if enter. */
...
typedef enum{
  ...
  SD_GENERIC_CB_E911_LTE_FULL_SRV_ADDED,
  SD_GENERIC_CB_MAX
...
/** Type for LTE and TDS bands
**  The LTE structure supports 256 bands
*/

typedef struct {
  sys_lte_band_mask_e_type         lte_band; /**< LTE band class preference. */
...
typedef struct {
  ...
  sd_ss_band_pref_e_type           band;     /**< Band class preference CHGW*/
  sd_chan_type                     chan;     /**< CDMA Channel/AMPS A/B system, */
  sd_mode_e_type                   mode;     /**< Mode -  CDMA /GWL /HDR */
  sd_3GPP_band_s_type               *gwl_band_ptr;
        /** pointer to LTE + TDS bands , valid only if mode = SD_MODE_GWL */
} sd_sys_s_type;
...
#define SD_SS_HYBR_HDR     MM_STACK_1
...
/*SD report for sending E911 scan failure and mode pref*/
typedef void (sd_si_emerg_srch_fail_f_type)
(
  mm_sub_stk_id_s_type   mm_id,
  sd_ss_mode_pref_e_type mode_pref
);
...
typedef union {
  ...
  sd_full_srv_added_rpt_type     lte_full_srv_added_rpt;
...
typedef enum {
  ...
  SD_SS_ORIG_MODE_VAL_NORMAL_OR_CSFB_ORG_OR_VOLTE
                                     = BM( SD_SS_ORIG_MODE_NORMAL ) | \
                                       BM( SD_SS_ORIG_MODE_PPCSFB_NORMAL_ORIG ) | \
                                       BM( SD_SS_ORIG_MODE_PPCSFB_EMERG_ORIG )  | \
                                       BM( SD_SS_ORIG_MODE_1XCSFB_NORMAL_ORIG ) | \
...
typedef struct {
  ...
  **
  ** A value of MM_STACK_ALL_REDIR_DELAY_NONE indicates that this
...
typedef enum {
  ...
  SD_SS_ACC_REAS_PWR_UP_REG,    /**< Powerup Registration from 1XCP*/
...
typedef enum {
  ...
  SD_SS_ACC_TERM_ACC_SUCCESS,   /* When any access attempt terminates due to
                                ...
                                **
                                */
  SD_SS_ACC_TERM_FADE,          /* When any access attempt is terminated due to FADE */
...
@DESCRIPTION
  ...
  measurement is requested). stack MM_STACK_0 would be used to retrieve
  data.
...
===========================================================================*/
extern  boolean                   sd_ss_meas_list_rprt_per_ss(
...
DESCRIPTION
  Wrapper function to return the latest SS-Action other than CONTINUE for
  the subs passed in as the argument. it always assumes stack = 0 for passed
  sub
...
extern sd_ss_act_e_type          sd_ss_act_get_per_sub(
       ...
       sd_ss_act_s_type          *rtrn_act_ptr,
            ...
            */
       sys_modem_as_id_e_type    asubs_id
            /* the subs id to get the last SS-Action from
            */
);
...
===========================================================================*/
extern  void          sd_ss_set_hdr_deact_by_hybr2_bsr( sys_modem_as_id_e_type asubs_id );
...
@FUNCTION sd_ss_ind_term

@DESCRIPTION
  Inform SD to clear the SD buffers as the user commanded the MS power-off, perform a reset or
  enter LPM.
...
FUNCTION sd_ss_ind_cdma_acq_schm_per_subs
...
FUNCTION sd_ss_ind_hdr_acq_sid4
...
(
        ...
        /* Corresponding sub and stack to be used for this stack
        */
        mm_sub_stk_id_s_type                     mm_id
            /* sub and stack id
            */
...
===========================================================================*/
sd_ss_act_e_type    sd_ss_ind_gw_data_suspended_ss (
    mm_sub_stk_id_s_type  mm_id
    /* sub and stack id
    */
);
...
===========================================================================*/
extern boolean  sd_misc_is_true_power_save(
    mm_sub_stk_id_s_type  mm_id
    /* sub and stack id
    */
);
...
===========================================================================*/
extern boolean sd_ss_is_acq_status(
    mm_sub_stk_id_s_type mm_id,
    /* sub and stack id
    */
...
===========================================================================*/
extern boolean sd_is_manual_bst_valid(
  sys_modem_as_id_e_type asubs_id
);
...
DESCRIPTION
  ...
  Get  value set to SDSS_FLAG_LOC_BASE_BSR in MM_STACK_2
...
===========================================================================*/
extern boolean   sd_misc_get_hdr_more_pref_plmn_list(sys_modem_as_id_e_type   asubs_id, sys_plmn_list_s_type * plmn_list );
...
FUNCTION sd_ss_set_avoid_plmn_list_flag

DESCRIPTION
Set flag to indicate avoid plmn list is not null.
...
===========================================================================*/
extern void sd_ss_set_avoid_plmn_list_flag
(
    sys_modem_as_id_e_type          as_id,
    /* sub id
    */

    boolean   avoid_plmn_flag   
);
...
FUNCTION sd_ss_get_avoid_plmn_list_flag

DESCRIPTION
Get the value of avoid plmn list flag.
...
===========================================================================*/
extern boolean sd_ss_get_avoid_plmn_list_flag
(
    sys_modem_as_id_e_type          as_id
    /* sub id
    */    
