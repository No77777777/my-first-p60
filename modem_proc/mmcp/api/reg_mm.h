...
$Header: //components/rel/mmcp.mpss/7.9.0/api/reg_mm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  MMR_SECURE_CALL_IND         = 0x17,
  MMR_DDS_SWITCH_IND          = 0x18,
  MMR_HIGH_PRIORITY_ACTIVITY_IND = 0x19, 
 ...
 ,MMR_SUITABLE_SEARCH_END_IND = 0x8F
  ...
  ,MMR_REFRESH_STAGE_IND = 0xAB
  ,MMR_REG_REQ_IGNORED_IND = 0xAC
  ,MMR_LTE_PESUDO_RESEL_LOW_PRIORITY_IND = 0xAD
  ,MMR_SIM_STATE_REVALIDATE_IND = 0xAE
  ,MMR_ME_BLOCKED_STATUS_IND = 0xAF 
  ,MMR_T3245_EXPIRY_IND = 0xB0 
  ,MMR_NON_ACQ_UPDATE_IND = 0xB1
 } reg_to_mm_cmd_type;
...
typedef enum mmr_reg_req_e
{
  ...
  MMR_REG_REQ_ACQ_HIGH_PRIOIRTY_SEL_W_O_EPLMN,
  MMR_REG_REQ_MAX
} mmr_reg_req_e_type;
...
typedef struct mmr_plmn_search_req_s
{
  ...
  /* Below variables are only applicable to inquisitive manual search */
  sys_arfcn_list_s_type                     arfcn_list;
    /* arfcn to scan */
  sys_preferred_plmn_list_s_type            preferred_plmn_list;
  uint8                                     max_search_time; 
...
/******************************************************************************/
/*                                                                            */
/*  MMR_HIGH_PRIORITY_ACTIVITY_IND                                            */
/*                                                                            */
/******************************************************************************/
typedef struct mmr_high_priority_activity_ind_s
{
  IMH_T                                      message_header;
  boolean                                    local_detach;
  sys_modem_as_id_e_type                     as_id;
} mmr_high_priority_activity_ind_s_type;
...
/******************************************************************************/
/*                                                                            */
/*  MMR_REFRSH_STAGE_IND                                                 */
/*                                                                            */
/******************************************************************************/
typedef struct mmr_refresh_stage_ind_s
{
  IMH_T                                    message_header;
  mmgsdi_refresh_stage_enum_type           refresh_stage; 
  sys_modem_as_id_e_type                   as_id;
} mmr_refresh_stage_ind_s_type;
...
/******************************************************************************/
/*                                                                            */
/*  MMR_T3245_EXPIRY_IND                                                 */
/*                                                                            */
/******************************************************************************/
typedef struct mmr_t3245_expiry_ind_s  
{
  IMH_T                                    message_header;
  sys_modem_as_id_e_type                    as_id;
} mmr_t3245_expiry_ind_s_type;
...
/*                                                                            */
/******************************************************************************/
typedef struct mmr_me_blocked_status_ind
{
  IMH_T                                               message_header;
  boolean                                             is_me_blocked;
  sys_modem_as_id_e_type                              as_id;
} mmr_me_blocked_status_ind_type;
#endif
...
typedef struct mmr_secure_call_ind_s 
{
  IMH_T                          message_header;
  sys_secure_call_e_type type;
  sys_modem_as_id_e_type         as_id;
}mmr_secure_call_ind_s_type;
/******************************************************************************/
/*                                                                            */
...
/******************************************************************************/
/*                                                                            */
/*  MMR_NON_ACQ_UPDATE_IND                                                            */
/*                                                                            */
/******************************************************************************/

typedef struct mmr_non_acq_update_ind_s
{
  IMH_T                                     message_header;
  sys_modem_as_id_e_type                    as_id;
  sys_voice_domain_pref_e_type              voice_domain_pref;

} mmr_non_acq_update_ind_s_type;
#endif
