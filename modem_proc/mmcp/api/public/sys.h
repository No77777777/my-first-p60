...
/*============================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/public/sys.h#3 $
...
#define GPP2_SUPPORT_ON_SEC_SUB
...
/** Macros to extract the low/high 16bits of a QWORD (64 bits).
*/
#define QWORD_LOW16( qword )  ( (word) ((uint64) qword & (uint64) 0xFFFF))
#define QWORD_HIGH16( qword ) ( (word) ((uint64) qword >> 48) )
...
#define CM_16_BIT_FFFF 0xFFFF
/** Service capability type provided by the protocol stack.
*/


#define SYS_INVALID_MCC 1665
/** Invalid location - 1665 is 0xFFF in BCD encoding and considered invalid MCC.
*/
...
typedef enum
{
  ...
  */
  ...
  SYS_BAND_LTE_EUTRAN_BAND66 = 168,
   ...
   SYS_BAND_LTE_EUTRAN_BAND250 = 169,
  /**< UL: 3400-3800; DL: 3400 -3800 . */
  ...
  SYS_BAND_LTE_EUTRAN_BAND46 = 176,
  /**< DL: 5150-5925 MHz. */

  SYS_BAND_LTE_EUTRAN_BAND47 = 177,
  /**< DL: ? MHz. */

  SYS_BAND_LTE_EUTRAN_BAND48 = 178,
  /**< DL: ? MHz. */

  SYS_BAND_LTE_EUTRAN_BAND71 = 179,
  /**< UL: ?; DL: ? */
...
typedef enum {
  ...
  SYS_SBAND_LTE_EUTRAN_BAND46 = 45,
  /**< DL: 5150-5925 */

  SYS_SBAND_LTE_EUTRAN_BAND47 = 46,
  /**< DL: ? */

  SYS_SBAND_LTE_EUTRAN_BAND48 = 47,
  /**< DL: ? */
  ...
  SYS_SBAND_LTE_EUTRAN_BAND250 = 249,
    /**< UL: 3400-3800; DL: 3400-3800 */
...
/**< Maximum number of MCCs for Emergency call in Full Service. */
#define SYS_EMERG_CALL_MCC_LIST_MAX 5

/**< Maximum number of arfcn for peridic manual search */
#define MAX_WCDMA_ARFCN_LIST_COUNT      10
#define MAX_LTE_ARFCN_LIST_COUNT      10

#define MAX_PREFERRED_PLMN_LIST_SIZE 40

/**< Maximum number of MCCs for Emergency call in Full Service. */
#define SYS_EMERG_CALL_MCC_LIST_MAX 5

/**< Maximum number of MCCs for Emergency call in no sim case. */
#define SYS_EMERG_CALL_END_NO_SIM_MCC_LIST_MAX 3

/**< Maximum number of MCCs which needs Emergency call to be retried for rej from network in no sim case. */
#define SYS_DISABLE_EMERG_CALL_END_NO_SIM_MCC_LIST_MAX 20
...
typedef enum
{
  ...
  */
  ...
  SYS_SRV_DOMAIN_CS_VOLTE,
    /**< Circuit switched and VoLTE capable. */

  SYS_SRV_DOMAIN_VOLTE,
    /**< VoLTE only capable. */
...
typedef enum
{
  ...
  SYS_IMS_REG_END_CAUSE_VOLTE_OFF  = 4,
  /**<when user switch VOLTE OFF*/

  SYS_IMS_REG_END_CAUSE_TEMPORARY_IMMEAD_RETRY    = 5,
      /**< Temporary failure from IMS  and IMS will perform immeadiate retry
      EX: IMS receives PDN down indication with RS RA failues*/
...
typedef struct
{
  ...
  boolean cs_signalling_bar_status;
  /**< Cell barring status for CS Signalling */

  boolean ps_signalling_bar_status;
  /**< Cell barring status for PS Signalling */
...
/** Get drx request status.
*/
typedef enum
{
  /** @cond
  */
  SYS_DRX_STATUS_NONE = -1,       /* FOR INTERNAL USE ONLY */
  /** @endcond
  */
  SYS_DRX_STATUS_SUCCESS,
  SYS_DRX_STATUS_NO_SERVICE,
  SYS_DRX_STATUS_NOT_IDLE,
  SYS_DRX_STATUS_OTHER

} sys_get_drx_status_e_type;
...
typedef enum
{
  ...
  SYS_LTE_BW_NRB_6 = 6,
  /*! 3MHz bandwidth */
  SYS_LTE_BW_NRB_15 = 15,
  /*! 5MHz bandwidth */
  SYS_LTE_BW_NRB_25 = 25,
  /*! 10MHz bandwidth */
  SYS_LTE_BW_NRB_50 = 50,
  /*! 15MHz bandwidth */
  SYS_LTE_BW_NRB_75 = 75,
  /*! 20MHz bandwidth */
  SYS_LTE_BW_NRB_100 = 100,
  /*! Minimum supported bandwidth */
  SYS_LTE_BW_MIN = SYS_LTE_BW_NRB_6,
  /*! Maximum supported bandwidth */
  SYS_LTE_BW_MAX = SYS_LTE_BW_NRB_100,
  /*! Unknown Bandwidth */
  SYS_LTE_BW_UNKNOWN
} sys_lte_bandwidth_e;
...
typedef struct sys_cell_info_s
{
  ...
  sys_lte_bandwidth_e	   lte_bandwidth;
    /**< Bandwidth of the serving system cell. Applicable for LTE systems. */
...
typedef struct
{
  ...
  uint32 mcc[SYS_EMERG_CALL_MCC_LIST_MAX];
  
} sys_emerg_call_full_srv_mcc_list_s_type;

typedef struct
{

  uint32 mcc[SYS_EMERG_CALL_END_NO_SIM_MCC_LIST_MAX];

} sys_emerg_call_end_no_sim_mcc_list_s_type;

typedef struct
{

  uint32 mcc[SYS_DISABLE_EMERG_CALL_END_NO_SIM_MCC_LIST_MAX];

} sys_disable_emerg_call_end_no_sim_mcc_list_s_type;
...
typedef enum
{
  ...
  */
  ...
  SYS_PLMN_LIST_ABORT_ON_TRM_FAILURE,
  SYS_PLMN_LIST_PERIODIC_PARTIAL,
  /* status when partial result is provided when the srch is periodic */
...
/** @brief Detailed EHPLMN list.
*/
typedef struct sys_ehplmn_plmn_list_s
{
...
/* CNM  timer bitmask values */
#define SYS_MM_TIMER_T3242_INFO_MASK  SYS_BM_64BIT(0)
#define SYS_MM_TIMER_T3243_INFO_MASK  SYS_BM_64BIT(1)
/* NAS bitmask values */
...
#define SYS_NAS_TIMER_EXPIRY_INFO_MASK  SYS_BM_64BIT(7)
#define SYS_NAS_INACTIVITY_TIMER_RESUME_INFO_MASK        SYS_BM_64BIT(8)
...
#define SYS_NAS_INFO_MASK_ALL           ( SYS_NAS_REGISTRATION_INFO_MASK | \
                                          ...
                                          SYS_NAS_TIMER_EXPIRY_INFO_MASK | \
                                          SYS_NAS_INACTIVITY_TIMER_RESUME_INFO_MASK)
...
typedef enum
{
  ...
  SYS_DEREG_SUCCESS,
  SYS_DEREG_ERROR,
}ecall_dereg_resp_e_type;

typedef enum
{
  SYS_INACTIVITY_TIMER_SUCCESS,
  SYS_INACTIVITY_TIMER_ERROR,
}sys_ecall_inactivity_timer_response_e_type;
/** @} */ /* end_addtogroup SI */
...
typedef struct sys_registered_nw_info_s
{
   ...
   ecall_dereg_resp_e_type   ecall_inactivity_completed;   /* ecall inactivity completed or not*/
...
typedef struct sys_nas_timer_expiry_info_s
{
  uint64  timer_bitmask;
  /* Indication of which timer has expired. */

}sys_nas_timer_expiry_info_s_type;
...
typedef struct sys_nas_information_s
{
   ...
   sys_nas_timer_expiry_info_s_type  timer_expiry_info;
   sys_ecall_inactivity_timer_response_e_type   ecall_inactivity_timer_response;
...
typedef enum
{
  SYS_CONN_REL_INVALID=-1,
  SYS_CONN_REL_NORMAL, /*!< 0 */
  SYS_CONN_REL_RLF, /*!< 1 */
  SYS_CONN_REL_CRE_FAILURE, /*!< 2 */
  SYS_CONN_REL_OOS_DURING_CRE, /*!< 3 */
  SYS_CONN_REL_ABORTED, /*!< 4 */
  SYS_CONN_REL_SIB_READ_ERROR,  /*!< 5 */ 
  SYS_CONN_REL_ABORTED_IRAT_SUCCESS, /*!< 6 */
  SYS_CONN_REL_RLF_SEC_NOT_ACTIVE, /*!< 7 */
  SYS_CONN_REL_IRAT_TO_LTE_ABORTED, /*!< 8 */
  SYS_CONN_REL_IRAT_FROM_LTE_TO_G_CCO_SUCCESS, /*!< 9 */
  SYS_CONN_REL_IRAT_FROM_LTE_TO_G_CCO_ABORTED, /*!< 10 */
  SYS_CONN_REL_IRAT_FROM_LTE_TO_G_SGLTE_SRVCC_SUCCESS, /*!< 11 */
  SYS_CONN_REL_RLF_NONDDS_SPV_TMR_EXPIRY, /*!< 12*/
  SYS_CONN_REL_OOS_RF_UNAVAILABLE_DURING_CRE, /*!< 13 */
  SYS_CONN_REL_LOCAL, /*!< 14 -only for RRC local release after hold timer expiration. */
  SYS_CONN_REL_PDCP_REL_CAUSED_BY_LTA,  /*!< 15 - PDCP release after long LTA, expect DS reestablish DRB immediately after connection release */
  SYS_CONN_REL_MAX
}sys_lte_rrc_conn_rel_cause_e_type;

typedef struct sys_inact_timer_info_s
{
  sys_lte_rrc_conn_rel_cause_e_type     lte_rrc_conn_rel_cause;
  
  uint32                                long_cdrx_length;
}sys_lte_rrc_data_inact_timer_info_s_type;
...
/** ENUM of VFRs used by lower layers
*/
typedef enum sys_vfr_e {
...
typedef enum
{
  ...
  SYS_SUBS_FEATURE_MODE_DUAL_MULTIMODE,      /* subs configured for Multimode */
} sys_subs_feature_t;
...
typedef enum scan_scope_rule_e {
  ...
  SYS_SCAN_SCOPE_RULE_ACQ_DB_ALT_BPLMN = BM(0),
  /**< ACQ_DB scan_scope type for Alternating ACQ DB Scans in BPLMN Timeline */
  ...
  SYS_SCAN_SCOPE_RULE_ACQ_DB_BPLMN = BM(5),
...
/* Enumeration for the type of sScans for different searches per sub */
typedef enum sub_scan_scope_rule_e {

  SYS_SUB_SCAN_SCOPE_RULE_FULL_BAND = 0,
  /**< Default scan_scope type i.e FULL_BAND for all searches */  

  SYS_SUB_SCAN_SCOPE_RULE_EM_CALL_ORIG = BM(0),
    /**< ACQ_DB sub_scan_scope type for Em call orig */    
  
  /** @cond  */
  SYS_SUB_SCAN_SCOPE_RULE_MAX = BM(7)
  /** @endcond */

}sys_sub_scan_scope_rule_e_type;
...
typedef enum sys_volte_call_state {
/** @cond
*/

  SYS_CALL_STATUS_END,  /**< volte call ended*/

  SYS_CALL_STATUS_START, /**< volte call started */

  SYS_CALL_STATUS_CONNECTED, /**< volte call connected */

/** @cond
*/
  SYS_CALL_STATUS_MAX           /* internal only */
/** @endcond
*/
} sys_volte_call_state_e_type;
...
typedef enum sys_cmsds_plmn_block_e {

  SYS_CMSDS_PLMN_BLOCK_NONE=-1,
  /* internal */

  SYS_CMSDS_PLMN_BLOCK_IMS_ONLY,
  /* When IMS reg permanent failure on non DDS sub,
  ** directly perform plmn blocking, regardless of CSFB support
  */

  SYS_CMSDS_PLMN_BLOCK_IMS_CSFB
  /* When IMS reg permanent failure on non DDS sub,
  ** consider CSFB before performing plmn blocking
  */

} sys_cmsds_plmn_block_e_type;
...
FUNCTION sys_map_sys_mode_to_access_tech

DESCRIPTION
  Mapping function from sys_mode ==> access_tech.
...
===========================================================================*/
sys_radio_access_tech_e_type sys_map_sys_mode_to_access_tech(
sys_sys_mode_e_type sys_mode
);

typedef enum sys_data_activity_e {
  SYS_DATA_ACTIVITY_NONE = -1,
  SYS_DATA_ACTIVITY_CLEANUP_REQ,   
    /* Start of data call clean-up due to dds switch */
  SYS_DATA_ACTIVITY_CLEANUP_CNF,   
    /* End of data call cleanup */
  SYS_DATA_ACTIVITY_ON_DEMAND_START,  
    /* Start of non-IMS data activity from AP */
  SYS_DATA_ACTIVITY_ON_DEMAND_END,
    /* End of non-IMS data activity from AP */
  SYS_DATA_ACTIVITY_MAX
} sys_data_activity_e_type;

/*
Qualifiers                          Comment/Details of Procedures                            TRM reason(s)      Enum name
======                          ========================                    ==========    ====================
  CS CALL                           All MO/MT CS Voice Call over all RATs.                   Traffic               SYS_PROC_TYPE_CS_CALL
                                        This includes the CSFB Voice call , which
                                        is a CS Voice call when moved to G/W/T.

SUPLEMENTARY SERVICE     All Call independent Supplementary Services.           Traffic               SYS_PROC_TYPE_SUPLEMENTARY_SERVICE
                                       Legacy behavior is to use traffic priority for SS,
                                       we should keep as Voice Call priority. For user
                                       voice call and SS are similar services.

  High Priority                                                                                          Traffic                  SYS_PROC_TYPE_HP_CS_REGISTRATION
     CS REGISTRATION


High Priority                    TAU for LTE fast return.                                       Traffic                SYS_PROC_TYPE_HP_PS_REGISTRATION
  PS REGISTRATION

SMS                                 All MO/MT SMS over CS or PS domain over all            Access              SYS_PROC_TYPE_SMS
                                      technology (Exception for MT SMS over GSM �
                                      which will be consider as Voice Call priority).

CS REGISTRATION             CS Registration includes: Location Update (LU),         Access              SYS_PROC_TYPE_CS_REGISTRATION
                                      IMSI Detach.

PS REGISTRATION             PS Registration includes: Attach, Routing Area           Access              SYS_PROC_TYPE_PS_REGISTRATION
                                      Update (RAU), Tracking Area Update (TAU), Detach.

PS CALL SIGNALING          Include the duration of NAS signaling procedures        Access                SYS_PROC_TYPE_PS_CALL_SIGNALING
                                      only. Starting from service request procedures for
                                      PS Call, till NAS PDP activation/modify/deactivation
                                      are finished.

PS CALL USER PLANE         All MO/MT PS data call                                           Background Traffic   SYS_PROC_TYPE_PS_CALL_USER_PLANE

HIGH PRIORITY PS CALL    This is the case where DS can indicate the PDN          Traffic                   SYS_PROC_TYPE_HIGH_PRIORITY_PS_CALL
                                      is activated with HIGH Priority (based on QCI bit).
                                      Also this is a scope if PS data is used for
                                      conversation like high priority type.

VOLTE CALL                     VoLTE call                                                             Traffic                   SYS_PROC_TYPE_VOLTE_CALL

IMS SMS                          IMS based SMS                                                      Access                     SYS_PROC_TYPE_IMS_SMS

EMBMS                            LTE eMBMS call                                                     Background Traffic/    SYS_PROC_TYPE_EMBMS
                                                                                                               Traffic

SRBS                              signalling radio bears                                             Background Traffic      SYS_PROC_TYPE_SRBS

INTRA FCELL RESELECTION                                                                          Channel Maintenance    SYS_PROC_TYPE_INTRA_FCELL_RESELECTION
INTER FCELL RESELECTION                                                                          Channel Maintenance    SYS_PROC_TYPE_INTER_FCELL_RESELECTION
IRAT CELL RESELECTION                                                                      Acquisition, Channel Maintenance    SYS_PROC_TYPE_IRAT_CELL_RESELECTION
INTRA FCELL MEASUREMENT                                                                        Channel Maintenance    SYS_PROC_TYPE_INTRA_FCELL_MEASUREMENT
INTER FCELL MEASUREMENT                                                                        Channel Maintenance    SYS_PROC_TYPE_INTER_FCELL_MEASUREMENT
IRAT MEASUREMENT                                                                                   Channel Maintenance    SYS_PROC_TYPE_IRAT_MEASUREMENT
SYSTEM INFO READING                                                                               Channel Maintenance    SYS_PROC_TYPE_SYSTEM_INFO_READING
CMAS PWS ETWS                                                                                       Channel Maintenance    SYS_PROC_TYPE_CMAS_PWS_ETWS
NEIGHBOR CELL MONITOR                                                                          Channel Maintenance    SYS_PROC_TYPE_NEIGHBOR_CELL_MONITOR
PAGE                                                                                                        Page                          SYS_PROC_TYPE_PAGE
EXTENDED PAGE                                                                                        Page                           SYS_PROC_TYPE_EXTENDED_PAGE
REDIRECTION                                                                                         Acquisition,                     SYS_PROC_TYPE_REDIRECTION
                                                                                                           Channel Maintenance,
                                                                                                           Background Traffic

CCO                                                                                                      Background Traffic           SYS_PROC_TYPE_CS_HANDOVER
CS HANDOVER                                                                                        Traffic                            SYS_PROC_TYPE_CCO
PS HANDOVER                                                                                        Background Traffic            SYS_PROC_TYPE_PS_HANDOVER
SRVCC                                                                                                   Traffic                            SYS_PROC_TYPE_SRVCC
CSFB                                                                                                     Traffic                            SYS_PROC_TYPE_CSFB
ACQUISTION                                                                                           Acquisition                     SYS_PROC_TYPE_ACQUISTION
OOS SCAN                                                                                              Acquisition                     SYS_PROC_TYPE_OOS_SCAN
BPLMN SEARCH                                                                                      Acquisition, Channel Maintenance    SYS_PROC_TYPE_BPLMN_SEARCH
MANUAL PLMN                                                                                        Acquisition Inversion,       SYS_PROC_TYPE_MANUAL_PLMN
                                                                                                           Channel Maintenance
CGI                                     SON CGI                                                     Acquisition                     SYS_PROC_TYPE_CGI 

*/

typedef enum
{
  SYS_PROC_TYPE_NONE = -1,
  SYS_PROC_TYPE_CS_CALL = 0,
  SYS_PROC_TYPE_SUPPLEMENTARY_SERVICE = 1,
  SYS_PROC_TYPE_HIGH_PRIORITY_PS_CALL = 2,
  SYS_PROC_TYPE_SMS = 3,
  SYS_PROC_TYPE_CS_REGISTRATION = 4,
  SYS_PROC_TYPE_PS_REGISTRATION = 5,
  SYS_PROC_TYPE_PS_CALL_SIGNALING = 6,
  SYS_PROC_TYPE_TEST_LOOPBACK = 7,

  SYS_PROC_TYPE_PS_CALL_USER_PLANE = 21,
  SYS_PROC_TYPE_VOLTE_CALL = 23,
  SYS_PROC_TYPE_IMS_SMS = 24,
  SYS_PROC_TYPE_EMBMS = 25,
  SYS_PROC_TYPE_SRBS = 26,
  SYS_PROC_TYPE_INTRA_FCELL_RESELECTION = 27,
  SYS_PROC_TYPE_INTER_FCELL_RESELECTION = 28,
  SYS_PROC_TYPE_IRAT_CELL_RESELECTION = 29,
  SYS_PROC_TYPE_INTRA_FCELL_MEASUREMENT = 30,
  SYS_PROC_TYPE_INTER_FCELL_MEASUREMENT = 31,
  SYS_PROC_TYPE_IRAT_MEASUREMENT = 32,
  SYS_PROC_TYPE_SYSTEM_INFO_READING = 33,
  SYS_PROC_TYPE_CMAS_PWS_ETWS = 34,
  SYS_PROC_TYPE_NEIGHBOR_CELL_MONITOR = 35,
  SYS_PROC_TYPE_PAGE = 36,
  SYS_PROC_TYPE_EXTENDED_PAGE = 37,
  SYS_PROC_TYPE_REDIRECTION = 38,
  SYS_PROC_TYPE_CCO = 39,
  SYS_PROC_TYPE_CS_HANDOVER = 40,
  SYS_PROC_TYPE_PS_HANDOVER = 41,
  SYS_PROC_TYPE_SRVCC = 42,
  SYS_PROC_TYPE_CSFB = 43,
  SYS_PROC_TYPE_ACQUISITION = 44,
  SYS_PROC_TYPE_OOS_SCAN = 45,
  SYS_PROC_TYPE_BPLMN_SEARCH = 46,
  SYS_PROC_TYPE_MANUAL_PLMN = 47,
  SYS_PROC_TYPE_CSG_SEARCH = 48,
  SYS_PROC_TYPE_RLF_RECOVERY = 49,
  SYS_PROC_TYPE_PANIC_SEARCH = 50,
  SYS_PROC_TYPE_DIVERSITY_CHAIN = 51,
  SYS_PROC_TYPE_SCELL = 52,
  SYS_PROC_TYPE_CGI = 53,
  SYS_PROC_TYPE_IMS_MMS = 54,
  SYS_PROC_TYPE_MMS = 55,
  SYS_PROC_TYPE_IMS_REGISTRATION = 56,
  SYS_PROC_TYPE_IMS_UT = 57,
  SYS_PROC_TYPE_NON_IMS_OTHERS = 58,
  SYS_PROC_TYPE_RS_RA = 59,
  SYS_PROC_TYPE_NONE_DELAYED = 60,
  SYS_PROC_TYPE_ELS = 61,
  SYS_PROC_TYPE_MAX
...
typedef enum {
  ...
  */
  SYS_NONACQ_INFO_NONE = -1,

  SYS_NONACQ_INFO_VOICE_DOMAIN_PREF,

  /* For internal use and range check
  */
  SYS_NONACQ_INFO_MAX

} sys_nonacq_info_e_type;
...
typedef struct 
{
  ...
  uint32 nonAcqValue;
  /*SD will let MM know about new change which mm will use to perform TAU/RAU*/

  sys_voice_domain_pref_e_type voice_domain_pref;
}sys_non_acq_param_s_type;

/* Inquisitive search types */
...
typedef enum {
  ...
  SYS_SRCH_PRIORITY_LOW,
    /**< manual srch priority is low comparing to data call */

  SYS_SRCH_PRIORITY_HIGH
    /**< manual srch priority is high comparing to data call. */

}sys_srch_priority_e_type;


/** @brief frequency list.
*/
typedef struct sys_arfcn_list_s
{

  uint8  wcdma_count;
    /**< wcdma arfcn count */

  uint16  wcdma_arfcn[MAX_WCDMA_ARFCN_LIST_COUNT];

  uint8  lte_count;
    /**< lte arfcn count */

  uint32  lte_arfcn[MAX_LTE_ARFCN_LIST_COUNT];

} sys_arfcn_list_s_type;

typedef struct sys_preferred_plmn_list_s 
{
  sys_plmn_id_s_type  plmn_list[MAX_PREFERRED_PLMN_LIST_SIZE];
  uint8               count;
  
} sys_preferred_plmn_list_s_type;

typedef struct sys_incremental_results_s
{
  boolean  enabled;
  uint8    periodicity;
  
} sys_incremental_results_s_type;

/* This structure is used by QMI and MMODE for clubbing inquisitive
** manual search parameters into one unified structure
*/
typedef struct sys_periodic_frequency_scan_info_s
{
  sys_arfcn_list_s_type           arfcn_list;
  uint16                            search_periodicity;

  sys_preferred_plmn_list_s_type  preferred_plmn_list;

  uint64                          next_uptime;
  /* next periodic MPLMN search uptime*/
  
  uint64                          max_uptime;
  /* max uptime in modem for periodic MPLMN search. Last MPLMN search with High priority will be 
  ** attempted when timer expires.
  */
  
  uint8                           attempts;
  /* Num of complete attempts for AS periodic MPLMN search. The value will not be increased if
  ** SD or AS aborts the search attempt.
  */
  sys_srch_priority_e_type        priority;
  /* One-time srch: high; periodic srch: High for the last attempt and low for others.
  */

  uint8                           network_type;
    /* Type of network indicated in the get_networks API. */

  uint64                          network_band_pref;
    /* band preference */

  sys_lte_band_mask_e_type        network_lte_band_pref;
    /* LTE band preference */

  uint8                           network_list_type;
    /* The network list type */
    
  boolean                         ignore_manual_bst;

  sys_modem_as_id_e_type          asubs_id;

} sys_periodic_frequency_scan_info_s_type;
...
typedef struct
{
  ...
  */
  ...
  /** RAT specific Cell Identifier
  * For GSM : NA
  * For WCDMA: PSC
  * For TDS: CP_ID
  * For LTE: PCI (physical cell id)
  */
  uint16 psc_pci;
...
typedef struct sys_active_rat_info_s
{
  sys_radio_access_tech_e_type active_rat[MAX_AS_IDS];
}sys_active_rat_info_s_type;

extern void mm_active_rat_per_subs(sys_active_rat_info_s_type *active_rat_info);

/**
Type of Service for Access Barring .
*/
typedef enum
{
  /** @cond
  */
  SYS_ACCESS_SERVICE_TYPE_NONE =0,  /* Default */
  /** @endcond
  */

  SYS_ACCESS_SERVICE_TYPE_MO_SIGNALLING = 1,
    /**< MO Signalling. */

  SYS_ACCESS_SERVICE_TYPE_MO_DATA = 2,
    /**< MO Data. */

  SYS_ACCESS_SERVICE_TYPE_VOICE = 3,
    /**< Voice. */

  SYS_ACCESS_SERVICE_TYPE_VIDEO = 4,
    /**< Video. */

  SYS_ACCESS_SERVICE_TYPE_EMERG = 5,
    /**< Emergency. */

  SYS_ACCESS_SERVICE_TYPE_SMS = 6,
    /**< SMS. */

  SYS_ACCESS_SERVICE_TYPE_CSFB = 7,
    /**< CSFB. */

  /** @cond
  */
  SYS_ACCESS_SERVICE_TYPE_MAX   /* FOR INTERNAL USE ONLY! */
  /** @endcond
  */

} sys_access_service_e_type;
/*~ SENTINEL sys_access_service_e_type.SYS_ACCESS_SERVICE_TYPE_MAX */
