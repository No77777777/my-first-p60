...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/public/cmll.h#3 $
...
typedef enum cm_name_e
{
  ...
  */
  ...
  CM_MM_SRVCC_HANDOVER_FAILURE_IND_INTERNAL, /* CM internal, indicate HO_COMPLETE fail*/

  #ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
  CM_MM_LTE_SUSPEND_CNF, /* NAS indication to CM about LTE suspend complete */
  #endif

  CM_END_PRE_ALERT_MT_VOLTE_CALL,
  CM_ME_BLOCKED_STATUS_IND, /* MSIM specific, block devide as Sub received reject cause #6, Illegal ME */
  ...
  */
  ...
  CM_MCFG_PROCEED_WITH_REFRESH_F, /* Indicate MMOC is done processing deactivations of stacks */
  CM_CS_EMERG_SCAN_FAIL_F,   /* Indicate CS EMERG scan request failed */
  CM_SUSPEND_RESUME_F,       /* Report sent by MMOC to indicate suspend and resume is completed*/
  /* 532 */
  CM_SUBS_CHGD_DONE,
  CM_EMERG_SRCH_FAIL_F,    /* Report sent by SD on to indicate one round of E911 scan completion */
  CM_HOLD_ACQ,             /* Report sent by MMOC to indicate one sub 
                              is on-hold due to the other sub acquisition */
  CM_NO_HOLD_ACQ,          /* Report sent by MMOC to indicate no sub acquisition
                              is on hold */
  /* 536 */
  CM_E911_LTE_FULL_SRV_ADDED_F, /* Report sent by SD to indicate that SD has requested
                                   full LTE service even though LTE is not in the idle capability */
  CM_RPT_SD_END,
 ...
 /* 634 */
  ...
  CM_IP_CALL_IND_CANCEL_IMS_CALL_RSP, /* IP APP sending the cancel rsp(upgrade/downgrade/cancelHold/cancelResume) */
  CM_IP_SUPS_PASSWORD_CHG_CONF,       /* IMS sends the Confirmation for the Password Change Conf*/
  CM_IP_IND_EPDN_RAT_CHANGE,		  /* IMS indication to CM for EPDN RAT change*/

  CM_IP_CALL_SIP_DTMF_IND,  /* DTMF indication sent by IMS */
  ...
  */
  ...
  /* 812 */
  CM_VA_LCH_RSP,  /* Response from Voice Agent for Local Call Hold Command */
  CM_AUTO_REG_TIMER_RPT,
  
  CM_QRARB_RESTART_RPT,  /* QRARB module report to start recovery after QLINK critical error */
