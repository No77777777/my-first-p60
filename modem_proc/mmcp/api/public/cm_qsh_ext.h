...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/public/cm_qsh_ext.h#1 $
...
/*CM KPI versions*/
#define CM_QSH_EVENT_VOWIFI_CALL_STATUS_VER 1
#define CM_QSH_EVENT_VOLTE_CALL_STATUS_VER 1
#define CM_QSH_EVENT_CS_CALL_END_VER 1
#define CM_QSH_EVENT_SRVCC_VER 1
#define CM_QSH_EVENT_ONLINE_VER 1
#define CM_QSH_EVENT_SIM_READY_VER 1
#define CM_QSH_EVENT_SERVICE_STATUS_VER 1
#define CM_QSH_EVENT_LPM_VER 1


/* Max number of last sent/received commands/reports at CMREGPRX */
#define CM_DBG_MAX_DEBUG_BUFFER_SIZE   50

/* Stack 1 & 2 will be used SUB1 in CSFB & SRLTE respectively
** Stack 3 will be used for Subs 2 */
#define CM_DBG_NUM_OF_GW_STACKS    3
// Shouldn't this be defined based on DS, SXLTE feature flag etc.
...
typedef enum {
  ...
  /* 49 */
  CM_QSH_EVENT_MO_CALL_DELAY,              /* Denotes delay between call orig and ring */
  CM_QSH_EVENT_MPLMN_ABORT,                /* Denotes MPLMN abort from AS */
  CM_QSH_EVENT_RSSI_FLUCTUATION,           /* Denotes RSSI frequently fluctuating */
  
  /* 52 */
  CM_QSH_EVENT_PPCSFB_CALL_END,            /* Denotes PPCSFB call ended */
  CM_QSH_EVENT_1XCSFB_CALL_END,            /* Denotes 1XCSFB call ended */
  CM_QSH_EVENT_PPCSFB_CALL_SETUP_FAILED,   /* Denotes PPCSFB call setup failed */
  CM_QSH_EVENT_1XCSFB_CALL_SETUP_FAILED,   /* Denotes 1XCSFB call setup failed */
  
  /* 56 */
  CM_QSH_EVENT_DDS_CHANGE,                 /* Denotes Default Data change */
  CM_QSH_EVENT_STANDBY_PREF_CHANGE,        /* Denotes standby pref change */
  CM_QSH_EVENT_LIMITED_REGIONAL_SERVICE,   /* Denotes Limited Regional Service */
  CM_QSH_EVENT_CALL_MUTE,                 /*3rd party use only*/

  /* 59 */
  CM_QSH_EVENT_DS_CLEANUP_TIMER_START,     /* Denotes DS cleanup starts */
  CM_QSH_EVENT_IMS_CLEANUP_TIMER_START,    /* Denotes IMS cleanup starts */
  CM_QSH_EVENT_STANDBY_BUFFERED_ACT,       /* Denotes Subscription activation is buffered */
  CM_QSH_EVENT_STANDBY_BUFFERED_DEACT,     /* Denotes Subscription deactivation is buffered */

  /*59*/
  CM_QSH_EVENT_VOLTE_CALL_STATUS,     /* Denotes VOLTE call is in progress. cm_qsh_evt_call_state*/
  CM_QSH_EVENT_VOWIFI_CALL_STATUS,          /* Denotes a VOWIFI call originated. cm_qsh_evt_call_state*/
  CM_QSH_EVENT_CS_CALL_END,          /* cm_qsh_evt_call_state*/
  CM_QSH_EVENT_SRVCC,                       /*cm_qsh_evt_srvcc*/
  
  /*63*/
  CM_QSH_EVENT_SERVICE_STATUS,             /*sys_srv_status_e_type*/
  CM_QSH_EVENT_ONLINE,                     /* Denotes device is exiting LPM/online.*/
  CM_QSH_EVENT_SIM_READY,                  /* Denotes deivce is online and sim is ready.*/
  CM_QSH_EVENT_LPM,                     /* Denotes device is entering LPM.*/

  CM_QSH_EVENT_FIELD_DEBUG_ANY_FAILURE = 100,
  CM_QSH_EVENT_MAX
}cm_qsh_event_e;
...
/* VOLTE/VOWIFI call state definition*/
typedef enum{
  CM_QSH_CALL_STATE_NONE,
  CM_QSH_CALL_START,
  CM_QSH_CALL_END,
  CM_QSH_CALL_IN_PROGRESS,
  CM_QSH_CALL_RINGING
}cm_qsh_evt_call_state;

/*call end category*/
typedef enum{
  CM_QSH_CALL_END_NORMAL,
  CM_QSH_CALL_END_NW_REL,
  CM_QSH_CALL_END_UE_REL,
  CM_QSH_CALL_END_AS_FAIL,
  CM_QSH_CALL_END_OTHER
}cm_qsh_call_end_reason;

typedef enum{
  CM_QSH_SRV_NONE = -1,
  CM_QSH_FULL_SRV = SYS_SRV_STATUS_SRV,
  CM_QSH_NO_SRV = SYS_SRV_STATUS_NO_SRV,
  CM_QSH_LTD_SRV = SYS_SRV_STATUS_LIMITED,
  CM_QSH_LTD_REGIONAL_SRV = SYS_SRV_STATUS_LIMITED_REGIONAL
}cm_qsh_srv_status;
...
typedef PACK(struct)
{
    ...
    /*SS on which CMD/RPT is sent/received */
    uint8                        ss;
    ...
    uint16                               msg_name;
    // As of now, not adding Message Name or Payload.
...
typedef struct cm_qsh_metric_call_end_info_s
{
  ...
  uint8             call_direction;
  /* CM call direction ; possible values are defined in cm_call_direction_e_type.*/
...
===========================================================================*/
cm_qsh_metric_serving_cell_info_s_type  *cmdbg_qsh_last_sent_serving_cell_metric_ptr(void);
