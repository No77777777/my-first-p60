...
$Header: //components/rel/mmcp.mpss/7.9.0/api/public/wms.h#2 $
...
typedef enum
{
  WMS_REGULAR_SMS,      /**< Normal SMS. */
  WMS_E911_SMS,         /**< SMS to/from 911. */
/** @cond 
*/
  WMS_SMS_MAX, 
  WMS_SMS_MAX32 = 0x10000000   /* pad to 32 bit int */
/** @endcond */
} wms_message_e_type;
/*~ SENTINEL wms_message_e_type.WMS_SMS_MAX */
/** @} */ /* end_addtogroup client_group */
...
/** SMS Radio Access Technology.
*/
typedef enum
{
  WMS_SYS_RAT_NONE = -1,               /**< For internal use. */
  WMS_SYS_RAT_GSM_RADIO_ACCESS,        /**< GSM. */
  WMS_SYS_RAT_UMTS_RADIO_ACCESS,       /**< UMTS. */
  WMS_SYS_RAT_LTE_RADIO_ACCESS,        /**< LTE. */
  WMS_SYS_RAT_CDMA_RADIO_ACCESS,       /**< CDMA. */
/** @cond 
*/
  WMS_SYS_RAT_MAX, 
  WMS_SYS_RAT_MAX32 = 0x10000000   /* pad to 32 bit int */
/** @endcond */
} wms_radio_access_tech_e_type;
/*~ SENTINEL wms_radio_access_tech_e_type.WMS_SYS_RAT_MAX */
/** @} */ /* end_addtogroup client_group */
...
/* Maximum size of transport type information in WMS */
#define WMS_MSG_TRANSPORT_ARR_MAX   2
...
/** @anonenum{WMS_BC_WAC_LEN_MAX} 
  Maximum number of bytes for an warning area coordinate string;
  value: 1400. 
  \n 
*/
enum { WMS_BC_WAC_LEN_MAX         = 1400 };
/** @} */ /* end_addtogroup common_type_defs_group */
...
/*#define WMS_SMS_STATUS_IND 0x11 */

#ifdef FEATURE_SMS_PWS_OVER_LTE
extern sys_modem_as_id_e_type wms_global_as_id ;
#endif
...
typedef enum
{
   WMS_MSG_SMS_START, 
   WMS_MSG_SMS_END, 
   WMS_MSG_SMS_STATE_TYPE_MAX = 0x10000000
}wms_sms_state_e_type; 
...
typedef enum
{
  ...
  WMS_CMD_MSG_SMS_CALLBACK,                /**< WMS callback. */
...
typedef enum {
   ...
   WMS_MSG_TRANSPORT_NW_REG_STATUS_NO_SRV_ALLOW_ACK,  /**< No service, but allow MT SMS Ack. */
...
#define WMS_MSG_TRANSPORT_UPDATE_SMS_RETRY_STATUS    7
#define WMS_MSG_TRANSPORT_UPDATE_RAT                 8
...
/** @ingroup common_cb_group_wms_msg_transport_mo_sms_cb_type
  ...
  @param[in]  as_id      Subscription on which SMS is initiated.
  @param[in]  msg_type   Normal or 911 SMS.
...
{ 
   ...
   wms_message_e_type                ims_msg_type; /**< SMS type - normal or E911. */
...
typedef enum
{
  WMS_CAUSE_UNKNOWN,          /**< For internal use only. */
  WMS_OTA_REJECT_CAUSE,       /**< Over-The-Air rejection. */
  WMS_AS_REJECT_CAUSE,        /**< Access Stratum rejection. */
  WMS_MM_REJECT_CAUSE,        /**< Mobility Management rejection. */
  WMS_CNM_MN_REJECT_CAUSE,    /**< Mobile Network or Connection Manager rejection. */
  WMS_EMM_REJECT_CAUSE,       /**< EPS Connection Management (ECM) rejection. */
  WMS_ONEX_CSFB_REJECT_CAUSE  /**< Circuit-Switched Fallback (CSFB) rejection. */
...
typedef enum 
{
   WMS_CFG_READY_STATUS_NONE,   /**< NOT READY. */
   WMS_CFG_READY_STATUS_FULL,   /**< FULL READY. */
   WMS_CFG_READY_STATUS_LIMITED,   /**< LIMITED READY. */
   WMS_CFG_READY_STATUS_NO_SRV /**< NOT READY. */
} wms_cfg_ready_status_e_type; 
/** @} */ /* end_addtogroup config_group_data_types */

/** @addtogroup config_group_data_types
@{ */
/** Event data for Ready event II.
*/
typedef struct 
{
   wms_cfg_sys_e_type          sys_type; /**< System type (GSM/WCDMA or CDMA). */
   sys_modem_as_id_e_type      as_id;    /**< Active subscription ID. */
   wms_cfg_ready_status_e_type ready_status;    /**< Ready Status Type. */
} wms_cfg_ms_ready_status_s_type;
/** @} */ /* end_addtogroup config_group_data_types */
...
typedef enum
{
  ...
  WMS_CFG_EVENT_MS_READY_STATUS,        /**< Ready Status for client services event in 
                                            Dual SIM Dual Standby (DSDS) mode. */
...
/*~ CASE WMS_CFG_EVENT_CELL_CHANGE wms_cfg_event_info_u.cell_change_type */
 ...
 /*~ CASE WMS_CFG_EVENT_MS_READY wms_cfg_event_info_u.ms_ready */
   ...
   wms_cfg_ms_ready_status_s_type  ms_ready_status;
     /**< Event information associated with WMS_CFG_EVENT_MS_READY_STATUS. */
  /*~ CASE WMS_CFG_EVENT_MS_READY_STATUS wms_cfg_event_info_u.ms_ready_status */
...
*/
#define WMS_GW_CB_SRV_ID_CMAS_MSGID27    4396

/** CMAS CBS Message Identifier for CMAS Public Safety Alerts
    for additional languages.
*/
#define WMS_GW_CB_SRV_ID_CMAS_MSGID28    4397

/** CMAS CBS Message Identifier for CMAS State/Local WEA Test.
*/
#define WMS_GW_CB_SRV_ID_CMAS_MSGID29    4398

/** CMAS CBS Message Identifier for CMAS State/Local WEA Test
    for additional languages.
*/
#define WMS_GW_CB_SRV_ID_CMAS_MSGID30    4399
...
typedef struct wms_etws_msg_s
{
  ...
  sys_modem_as_id_e_type            as_id;
    /**< Active subscription ID. */
  wms_radio_access_tech_e_type      rat; 
   /**< RAT on which ETWS notification is received. */
} wms_etws_msg_s_type;
...
/** Warning area coordinates received in the LTE/NR CMAS message
 *  from the network.
*/
typedef struct wms_bc_warning_area_coordinates_s
{
  uint32   len;     /**< Length of a octet string for WAC. */
  uint8   *data;   /**< Pointer to a octet string for WAC. */
} wms_bc_warning_area_coordinates_s_type;
...
typedef struct wms_mt_message_info_s
{
  ...
  wms_radio_access_tech_e_type   rat; 
    /**< Used only for differentiating RAT on which broadcast SMS is received. 
         For other MT SMS, it is set to NONE. */
  wms_msg_transport_verstat_status_e_type  verstat_status;
    /**< Verstat status from IMS. */
  wms_message_e_type             msg_type;
    /**< Used for differentiating SMS received - normal or 911 */
  wms_bc_warning_area_coordinates_s_type wac_info;
    /**< Information about Warning area coordinates received in the LTE/NR CMAS message
         from the network */
...
typedef struct wms_ll_cause_info_s
{  
  wms_reject_e_type      wms_rej_type;
  byte                   wms_rej_value;
}wms_ll_cause_info_s_type;

typedef struct wms_ims_cause_info_s
{  
  boolean           sms_over_ims;
  uint16             ims_cause_value; 
}wms_ims_cause_info_s_type;
...
typedef struct wms_submit_report_info_s
{
  ...
  wms_ll_cause_info_s_type    err_info;
   /**  OTA-reject cause sent from lower layers */
   wms_ims_cause_info_s_type  ims_cause_info;
   /** IMS cause info sent from lower layers */
  wms_gw_tpdu_type_e_type     tpdu_type;
...
/** @ingroup messaging_group_wms_msg_transport_update_sms_retry_status_cb_type
  SMS/EMS Transport Layer SMS retry status callback function.

  @dependencies
  None.
*/
typedef boolean (*wms_msg_transport_update_sms_retry_status_cb_type) (
  sys_modem_as_id_e_type  as_id,
  boolean                 retry_possible,
  wms_message_e_type      msg_type
);

/*=========================================================================
FUNCTION  wms_msg_transport_ms_reg_sms_retry_status_cb
===========================================================================*/
/** @ingroup messaging_group_wms_msg_transport_ms_reg_sms_retry_status_cb
  ...
  @param[in] mo_sms_cb        Transport SMS retry status callback function pointer; 
                              see #wms_msg_transport_update_sms_retry_status_cb_type.
...
/*~ FUNCTION  wms_msg_transport_reg_sms_retry_status_cb
...
*/
typedef struct wms_dbg_event_info_s
{
...
/*~ CASE WMS_DBG_EVENT_RETRY_PERIOD   wms_dbg_event_info_u.retry_period   */
  ...
  sys_modem_as_id_e_type           as_id; /**< Sub id corresponding to the event */
...
/*=========================================================================
FUNCTION  wms_msg_ms_set_retry_period
===========================================================================*/
/** @ingroup messaging_group_wms_msg_ms_set_retry_period
  Specifies the SMS message retry period per sub.
...
/*=========================================================================
FUNCTION  wms_msg_ms_get_retry_period
===========================================================================*/
/** @ingroup messaging_group_wms_msg_ms_get_retry_period
  Retrieves the current SMS message retry period per sub.
...
/*=========================================================================
FUNCTION  wms_msg_ms_transport_init
===========================================================================*/
/** @ingroup messaging_group_wms_msg_ms_transport_init
  Allows the SMS Transport Layer to register with WMS to handle MO and MT SMS 
  messages with specified capability.
...
/*=========================================================================
FUNCTION
  wms_msg_gw_submit_msg_is_concatenated

DESCRIPTION
  Checks whether Submit message is a part of Concatenated SM or not.
...
SIDE EFFECTS
  None
=========================================================================*/
wms_status_e_type wms_ts_submit_msg_is_concatenated(
  const wms_client_message_s_type   *message_ptr,
  boolean*                           is_concatenated
);
...
/** @ingroup debug_group_wms_dbg_get_retry_interval
  Retrieves the current retry interval value per sub
...
===========================================================================*/
/** @ingroup debug_group_wms_dbg_ms_set_retry_interval
...
===========================================================================*/
/** @ingroup debug_group_wms_dbg_ms_get_retry_period
...
===========================================================================*/
/** @ingroup debug_group_wms_dbg_ms_set_retry_period
...
/** Configuration event mask.
*/
#define WMS_CFG_EVENT_MASK_MS_READY_STATUS      (1 << WMS_CFG_EVENT_MS_READY_STATUS)
...
#define wms_msg_get_retry_period( a, b ) wms_cfg_ms_get_retry_period( a, b, wms_get_default_as_id() )
#define wms_msg_set_retry_period( a, b ) wms_cfg_ms_set_retry_period( a, b, wms_get_default_as_id() )
#define wms_dbg_get_retry_interval( a, b, c ) wms_dbg_ms_get_retry_interval( a, b, c, wms_get_default_as_id() )
#define wms_dbg_set_retry_interval( a, b, c, d ) wms_dbg_ms_set_retry_interval( a, b, c, d, wms_get_default_as_id() )
#define wms_dbg_get_retry_period( a, b, c ) wms_dbg_ms_get_retry_period( a, b, c, wms_get_default_as_id() )
#define wms_dbg_set_retry_period( a, b, c, d ) wms_dbg_ms_set_retry_period( a, b, c, d, wms_get_default_as_id() )
