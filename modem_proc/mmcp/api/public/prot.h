...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/public/prot.h#2 $ $DateTime: 2021/06/21 05:49:21 $ $Author: pwbldsvc $
...
typedef struct {
  ...
  */
  ...
  /* Indicate SD whether UE is in fullrat
  */
  ...
  */
  ...
  /* Indicate the pending E911 state from CM */
