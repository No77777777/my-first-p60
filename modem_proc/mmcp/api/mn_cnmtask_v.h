...
$Header: //components/rel/mmcp.mpss/7.9.0/api/mn_cnmtask_v.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#if defined(FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_DUMP)
/*                       QSH to MN/CNM PRIMITIVES            */
    mncnm_qsh_msg_T                  qsh_msg_ind;
#endif
} cmd;
