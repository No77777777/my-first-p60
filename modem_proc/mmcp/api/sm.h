...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct 
{
  ...
  pdp_address_T          req_pdp_addr;        /* To store the PDP Address mentioned in Modify PDP */
