...
$Header: //components/rel/mmcp.mpss/7.9.0/api/tc_rrc.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $ 
...
** ------------------------------------------------------------------------*/
typedef struct rrctc_test_loopback_cnf
{ 
  sys_modem_as_id_e_type  as_id;
} rrctc_test_loopback_cnf_T;

/* --------------------------------------------------------------------------
** Primitive : RRCTC_TEST_LOOPBACK_REJ, RRC rejects LB mode indication from TC
** ------------------------------------------------------------------------*/
typedef struct rrctc_test_loopback_rej
{ 
  sys_modem_as_id_e_type  as_id;
} rrctc_test_loopback_rej_T;
