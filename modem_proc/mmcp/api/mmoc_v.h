...
/**===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/mmoc_v.h#2 $
...
typedef enum {
  ...
  MMOC_CMD_SUSPEND_STACK,              /* Suspend status of stack has changed. */
  ...
  MMOC_CMD_SUSPEND_RESUME_IND,        /* Command to do suspend/resume operation
                                      */
...
typedef struct {
  ...
  /* camp_mode preference of the SUB */  
  sd_ss_fullrat_pref_e_type       fullrat_status;
  /* Full rat status of the sub */

  uint32                          rat_capability;
  /* Current ue rat capability*/
...
typedef enum{
  ...
  MMOC_PREF_SYS_ADDL_ACTION_POLICY_PS_DETACH = BM(3),
      /* PS detach due to policy change */

  MMOC_PREF_SYS_ADDL_ACTION_FORCE_LIMITED_SRV = BM(4),
      /* Force the Limited SRV due to net sel mode limited */
...
@DESCRIPTION
  This function will be used to queue the command to MMoC 
  to perform operating mode change with pending emergency call
...
@SIDE EFFECTS
  None.
===========================================================================*/
extern  void                           mmoc_cmd_oprt_mode_chgd2
(
...
(
        ...
        mm_sub_stk_id_s_type    subs_stack,
...
===========================================================================*/
extern void                           mmoc_cmd_get_networks_extn
(
...
@SIDE EFFECTS
  None.
===========================================================================*/
extern  void                           mmoc_cmd_suspend_stack
(

        mm_sub_stk_id_s_type           mm_id,
          /**< Sub and stack that need to be suspended
          */
...
@SIDE EFFECTS
  None.
===========================================================================*/
extern  void                          mmoc_cmd_suspend_stack_new
(
...
DESCRIPTION
  This function will be used to command the MMoC to start  QLINK error recovery.  This
  function will queue the error recovery indication command to the MMoC task.
...
SIDE EFFECTS
  None.
===========================================================================*/
void                           mmoc_cmd_suspend_resume_ind(void );
