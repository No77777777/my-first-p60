...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/cmwll.h#1 $
...
typedef struct
{
  ...
  union
  {
    ...
    cm_connection_state_ind_T        cm_connection_state_info;
      /* Connection state indication for call reestablishment */

#ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
    cm_mm_lte_suspend_cnf_s_type  lte_suspend_cnf;
      /* LTE suspend cnf in response to LTE suspend req */
#endif

#ifdef FEATURE_DUAL_SIM
    cm_me_blocked_status_ind_s_type  me_blocked_status_ind;
#endif
  } cmd;
