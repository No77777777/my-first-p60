...
$Header: //components/rel/mmcp.mpss/7.9.0/api/cmlog.h#1 $
...
LOG_RECORD_DEFINE(LOG_CM_CALL_EVENT_C)
  ...
  int32                 direction;
    /**<
      ...
      It can be Mobile originated or Mobile terminated
...
@return
  byte - The service status
*/
byte cmlog_get_srv_status ( void );

/*-------- cmlog_get_operating_mode --------*/
/**
@brief
