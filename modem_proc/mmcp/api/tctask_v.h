...
$Header: //components/rel/mmcp.mpss/7.9.0/api/tctask_v.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  {  
    ...
    cmtc_close_lb_ready_ind_T    cm_close_lb_ready_ind;

    /*--------------------------------------------------------*/
    /* Commands sent from RRC to TC                            */
    /*--------------------------------------------------------*/
    rrctc_test_loopback_cnf_T     rrc_test_loopback_cnf;
    rrctc_test_loopback_rej_T     rrc_test_loopback_rej;
