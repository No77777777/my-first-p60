...
$Header: //components/rel/mmcp.mpss/7.9.0/api/reg_task_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  union cmd_u_type
  {
    ...
    */
    ...
    mmr_me_blocked_status_ind_type                mmr_me_blocked_status_ind;
#endif
    /*
    ** CM ==> REG
    */
    ...
    cm_secure_call_s_type                        cm_secure_call_req;
    cm_dds_switch_ind_s_type                     cm_dds_switch_ind;
    cm_high_priority_activity_ind_s_type         cm_high_priority_activity_ind;
    cm_roaming_ind_s_type                        cm_roaming_ind;
	cm_3gpp2_status_ind_s_type                   cm_3gpp2_status_ind;
    /*
    ** Timers
    */
