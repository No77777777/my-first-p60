...
$Header: //components/rel/mmcp.mpss/7.9.0/api/mn_sms.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct ota_reject_cause_tag
{ 
