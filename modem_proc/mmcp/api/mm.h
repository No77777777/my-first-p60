...
$Header: //components/rel/mmcp.mpss/7.9.0/api/mm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct mm_nas_nv_items
{
   ...
   /*ver 15*/
   byte                       delete_guti_in_gw_when_lte_not_in_rat_list; /*index 23*/
   /*ver 16*/
   byte                       cb_dup_detection_for_emc_msg_disable; /*index 24*/
   /*ver 17*/
   byte                       send_auh_resp_on_invalid_gsm_kc_len;
} mm_nas_nv_items_T;
...
extern boolean gmm_per_subs_always_on_data_enabled(sys_modem_as_id_e_type as_id);
/*===========================================================================
...
extern boolean mm_get_full_srv_req_in_emerg_per_subs
(
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
  sys_modem_as_id_e_type sub_id
#else
...
extern cs_domain_no_response_e_type mm_per_subs_get_cs_domain_no_rsp_type
(
 sys_modem_as_id_e_type as_id
);
...
extern boolean gmm_check_ps_signalling_connection_active(sys_modem_as_id_e_type as_id);

/*===========================================================================

FUNCTION log_util_log_packet_commit

DESCRIPTION 
  This function is a wrapper for log_commit 
...
extern void cm_update_non_acq_param_to_nas(sys_non_acq_param_s_type non_acq_param);



extern sys_sim_state_e_type reg_cm_read_sim_state
(
		sys_modem_as_id_e_type as_id
);
#endif /* _MM_H_ */
