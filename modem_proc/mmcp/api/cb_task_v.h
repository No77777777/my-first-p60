...
$Header: //components/rel/mmcp.mpss/7.9.0/api/cb_task_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef union cb_command_body_tag
{
  ...
  cb_reg_dds_info_s_type  dds_info_ind;

  cb_reg_3gpp2_stack_status_ind_s_type cb_3gpp2_stack_status_ind;
