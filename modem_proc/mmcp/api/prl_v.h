...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/prl_v.h#1 $
...
typedef enum
{
  ...
  */
  ...
  PRL_LTE_EUTRAN_43 = 42,
   ...
   /* values 44-45  reserved for future use
  */
  PRL_LTE_EUTRAN_46 = 45,

   /* values 46-49  reserved for future use
  */
  PRL_LTE_EUTRAN_47 = 46,
  PRL_LTE_EUTRAN_48 = 47,

  PRL_LTE_EUTRAN_66 = 50,
  PRL_LTE_EUTRAN_71 = 54, //prl conversion tool generated band 71 as 54. 
  PRL_LTE_EUTRAN_250 = 249,
...
/* The 3GPP generic acquisition record
*/
typedef PACKED struct PACKED_POST
{
  byte version[3];
...
typedef struct {
  ...
  */
  ...
  /* PR_LIST_SOURCE field - set to UNDETERMINED if PRL is not loaded.
  ** PRL is tied to CDMA's subscription.
  */
  prl_source_info_e_type    pr_list_source;
