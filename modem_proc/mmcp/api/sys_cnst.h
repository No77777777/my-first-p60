...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sys_cnst.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define MM_REJ_DOMAIN_CHNG                  (MS_INTERNAL_CAUSE_VALUE_BASE+58)
#define MM_REJ_ACCESS_CLASS_BLOCKED_GSM               (MS_INTERNAL_CAUSE_VALUE_BASE+60)
#define MM_REJ_ACCESS_CLASS_BLOCKED_WCDMA             (MS_INTERNAL_CAUSE_VALUE_BASE+61)
#define MM_REJ_ACCESS_CLASS_BLOCKED_TDSCDMA           (MS_INTERNAL_CAUSE_VALUE_BASE+62)
#define MM_REJ_ACCESS_CLASS_BLOCKED_LTE               (MS_INTERNAL_CAUSE_VALUE_BASE+63)
...
#define EMM_REJ_SERVCIE_REQ_FAILURE_EPS_SERVICE_NOT_ALLOWED (MS_INTERNAL_CAUSE_VALUE_BASE+54)
#define EMM_REJ_SERVICE_REQ_FAILURE_CS_DOMAIN_TEMP_NOT_AVAILABLE (MS_INTERNAL_CAUSE_VALUE_BASE+55)
#define EMM_REJ_HARD_FAIL                   (MS_INTERNAL_CAUSE_VALUE_BASE+56)
...
/*!< Time transfer failure from 1x search */
#define ONEX_REJ_1XCSFB_HO_FAILURE_SRCH_TT_FAIL          (MS_INTERNAL_CAUSE_VALUE_BASE+10)

/*!< TCH init fail from 1xCP */
#define ONEX_REJ_1XCSFB_HO_FAILURE_TCH_INIT_FAIL         (MS_INTERNAL_CAUSE_VALUE_BASE+11)

/*!< User ended the call */
#define ONEX_REJ_1XCSFB_HO_FAILURE_USER_CALL_END         (MS_INTERNAL_CAUSE_VALUE_BASE+12)

/*!< call retry attempts exhausted from 1xCP*/
#define ONEX_REJ_1XCSFB_HO_FAILURE_RETRY_EXHAUST         (MS_INTERNAL_CAUSE_VALUE_BASE+13)

/*!< Registration reject from n/w*/
#define ONEX_REJ_1XCSFB_HO_FAILURE_CALL_REL_REG_REJ      (MS_INTERNAL_CAUSE_VALUE_BASE+14)

/*!< Release order from n/w*/  
#define ONEX_REJ_1XCSFB_HO_FAILURE_CALL_REL_NW_REL_ODR   (MS_INTERNAL_CAUSE_VALUE_BASE+15)
