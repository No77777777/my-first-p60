...
$Header: //components/rel/mmcp.mpss/7.9.0/api/reg_sim.h#2 $ $DateTime: 2021/07/04 05:41:23 $ $Author: pwbldsvc $
...
extern boolean  reg_nv_read_voice_roaming
(
#ifdef FEATURE_DUAL_SIM
   sys_modem_as_id_e_type   as_id
#endif
);
extern boolean  reg_nv_read_domestic_voice_roaming
(
#ifdef FEATURE_DUAL_SIM
   sys_modem_as_id_e_type   as_id
#endif
