...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/prot_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum {
  ...
  PROT_CMD_3GPP2_STAT_CHGD,            /* 3GPP2 status changed  */
...
typedef enum {
  ...
  PROT_SUBSC_TYPE_3GPP,
  PROT_SUBSC_TYPE_3GPP2
...
typedef enum {
  ...
  PROT_SUBSC_CHG_NONE    = 0,
  PROT_SUBSC_CHG_3GPP    = BM(PROT_SUBSC_TYPE_3GPP),
  PROT_SUBSC_CHG_3GPP2   = BM(PROT_SUBSC_TYPE_3GPP2),
  PROT_SUBSC_CHG_ALL     = BM(PROT_SUBSC_TYPE_3GPP) | BM(PROT_SUBSC_TYPE_3GPP2),
...
typedef enum {
  ...
  PROT_SUBSC_MASK_NONE    = 0,
  PROT_SUBSC_MASK_3GPP    = BM(PROT_SUBSC_TYPE_3GPP),
  PROT_SUBSC_MASK_3GPP2   = BM(PROT_SUBSC_TYPE_3GPP2),
  PROT_SUBSC_MASK_ALL     = BM(PROT_SUBSC_TYPE_3GPP) | BM(PROT_SUBSC_TYPE_3GPP2),
  PROT_SUBSC_MASK_MAX     /* For internal use */

} prot_subsc_mask_e_type;
