...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sm_gmm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
** Primitive : GMMSM_ESTABLISH_IND.
** ------------------------------------------------------------------------*/
typedef struct gmmsm_establish_resend_ind
{ 
  sm_cm_status_T      cause;    /* defined in sys_type.h as byte */

  sys_modem_as_id_e_type    as_id;

} gmmsm_establish_resend_ind_T;
...
** ------------------------------------------------------------------------*/
extern boolean sm_check_pdp_procedure_pending
(
#ifdef FEATURE_DUAL_SIM
  sys_modem_as_id_e_type as_id
#else
