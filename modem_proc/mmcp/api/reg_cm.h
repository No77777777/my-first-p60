...
$Header: //components/rel/mmcp.mpss/7.9.0/api/reg_cm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  REG_CM_NETWORK_LIST_ABORT_ON_TRM_FAILURE,        
...
typedef enum {
  ...
  REG_CM_SCAN_STATUS_ABORTED_STOP_MODE,
...
typedef struct cm_network_list_req_s
{
  ...
  ** in bplmn search by lower layers*/  
  ...
  sys_srch_priority_e_type                     srch_priority;
    /* srch priority relative to data call, etc */
...
typedef struct cm_roaming_ind
{
   ...
   boolean                      domestic_voice_roaming_allowed;
   sys_modem_as_id_e_type       as_id;
...
typedef struct cm_high_priority_activity_ind_s
{
  IMH_T                          message_header;
  boolean                        local_detach;
  sys_modem_as_id_e_type         as_id;
  sys_modem_stack_id_e_type      stack_id;
} cm_high_priority_activity_ind_s_type;
...
/*                                                                            */
/******************************************************************************/
typedef struct cm_secure_call_req_s
{
  IMH_T                     message_header;
  sys_secure_call_e_type     type;
  sys_modem_as_id_e_type    as_id;
  sys_modem_stack_id_e_type                          stack_id;
} cm_secure_call_s_type;
...
typedef struct cm_me_blocked_status_ind_s
{
  IMH_T                                               message_header;
  boolean                                             is_me_blocked;
  sys_modem_as_id_e_type                              as_id;
} cm_me_blocked_status_ind_s_type;
#endif
...
typedef struct cm_3gpp2_status_ind_s
{
  IMH_T                                    message_header;
