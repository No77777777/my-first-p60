...
$Header: //components/rel/mmcp.mpss/7.9.0/api/sys_plmn_selection.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
/* Band for a given RAT is defined in a union. One rat,one band approach*/
  ...
  */
  ...
  /*should be used to indicate CM that the vplmn camped is not the manually selected plmn or the NAS requested plmn.*/
  boolean                                    only_for_ui;
} sys_plmn_service_state_s_type;
