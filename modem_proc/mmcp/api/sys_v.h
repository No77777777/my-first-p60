...
/**===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/api/sys_v.h#1 $
...
/*Interface changes for FR41221*/
#define SYS_AVOID_PLMN_LIST_MAX_LENGTH 5
...
typedef enum sys_secure_call_e
{
  SYS_SECURE_CALL_NONE,
  SYS_SECURE_CALL_START,
  SYS_SECURE_CALL_END,
  SYS_SECURE_CALL_MAX
}sys_secure_call_e_type;
...
/*Interface changes for FR41221*/
typedef struct sys_aplmn_list_s
{
  /*Flag to determine if the struct is initialized*/
  boolean                                   is_initialized;
  /*Current index in the list. */
  uint8                                     index;
  /*Total number of plmns being avoided.*/
  uint8                            num_of_plmns_to_avoid;
  
  sys_plmn_id_s_type                        plmn[SYS_AVOID_PLMN_LIST_MAX_LENGTH];
} sys_aplmn_list_s_type;
...
extern void sys_add_avoid_plmn_to_list
(
...
===========================================================================*/
extern sys_band_class_e_type sys_map_sband_to_band_class(
...
extern void  sys_err_fatal_null_ptr_exception_debug(void);
 ...
 */
  ...
  SYS_PS_DETACH_TYPE_POLICY_CHANGE,
...
typedef enum {
  ...
  */
  ...
  /* NAS will use this to start PLMN selection with the highest priority RAT
  ** in the RAT priority list instead of the last camped RAT (RPLMN).
  */
  SYS_ADDTNL_INFO_IGNORE_RPLMNACT,

  /*Setting the Addtional Info for the Non-AIS SIM Card Limited service Req*/
  SYS_ADDTNL_INFO_FORCE_LIMITED_SRV,
...
typedef enum
{
  SYS_RAT_ACTIVATION_STATUS_NONE = -1,        /* FOR INTERNAL USE ONLY */
  SYS_RAT_ACTIVATION_STATUS_ACTIVATED = 0,
  SYS_RAT_ACTIVATION_STATUS_DEACTIVATION_IN_PROGRESS = 1,
  SYS_RAT_ACTIVATION_STATUS_DEACTIVATED = 2
}sys_rat_activation_status;
