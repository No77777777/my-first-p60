...
$Header: //components/rel/mmcp.mpss/7.9.0/api/cbwmsif.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct cb_data_ind_tag
{
  ...
  byte cb_page[88];
    ...
    /*  rat on which CB message received 
    we can use tech_e type as this enum available
    across modules*/
