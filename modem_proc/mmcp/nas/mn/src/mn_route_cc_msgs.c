...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mn/src/mn_route_cc_msgs.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern void MN_handle_cs_sig_conn_rel_ind(IMH_T    *message);
...
VOID_FUNC   MN_route_CC_to_MN_messages(IMH_T    *message)
{
   ...
   switch(message->message_id)
   {
       ...
       case MNCC_CS_SIG_CONN_REL_IND:
           ...
           MN_handle_cs_sig_conn_rel_ind(message);
