...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mn/src/mn_sms_msg_util.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
MN_get_cp_user_data(connection_id_T connection_id, 
               ...
               #endif
                    ,nas_msg_e_type  sms_msg_type
                    )
{
   sm_rl_transaction_information_T *sm_data_ptr;
   control_sm_rl_return_data_T      return_data;
   SM_RL_REPORT_IND_T               *SM_RL_REPORT_IND = NULL;
   SM_RL_DATA_IND_T                 *SM_RL_DATA_IND = NULL;
   int                              index = 0;
      ...
      case RP_ACK_N:    
         {
            ...
            */
            ...
            if(valid_message)
            {
               ...
               */
               return_data = MN_control_SMS_RL(connection_id, s_sms_ack, NAS_REGULAR_SMS);
      ...
      case RP_ERROR_N:
         {
            ...
            */
            ...
            if (valid_message)
            {
               ...
               */
               return_data = MN_control_SMS_RL(connection_id, smr_event, NAS_REGULAR_SMS);
      ...
      case RP_DATA_N:
         {
            ...
            */
...
#endif
               SM_RL_DATA_IND->sms_msg_type = sms_msg_type;
            ...
            if (valid_message)
            {
                ...
                */
                return_data = MN_control_SMS_RL(connection_id,s_mt_sms_request, NAS_REGULAR_SMS);
            ...
            */
            else /*valid_message == FALSE */
            {
               ...
               */
               (void)MN_control_SMS_RL(connection_id, s_sms_to_idle, NAS_REGULAR_SMS);
            }
   ...
   {   
       ...
       }
       {
         ...
         if(CNM_is_GW_MT_SMS_in_progress() == FALSE)
         {
           ...
           mn_rpdu.sms_msg_type = SM_RL_REPORT_REQ->sms_msg_type;
...
sms_ims_state_e_type UASMS_put_mn_ims_msg(SM_RL_IMS_MSG_T  ims_msg)
{
...
#if defined(FEATURE_DUAL_SIM )
  {
    if(MNCNM_IS_SINGLE_STACK)
    {
      if(!( (mn_as_id == SYS_MODEM_AS_ID_NONE) || ( mn_as_id == ims_msg.as_id)))
      {
         sms_status = SMS_TRANSACTION_UNKNOWN;
         MSG_HIGH_DS_2(MN_SUB,"=MNCNM= Dropping MT SMS over IMS as other service is going on other SUB:mn_as_id = %d , sms status= %d",mn_as_id,sms_status);
         return sms_status;
      }
    }
  }
  ...
  { /* Report ERROR INDICATION to MN on all the ACTIVE MO/MT SMSs. In LTE system which is always connected, 
    ...
    { 
      ...
      if(TRUE == send_error)
      {
        ...
        p_mnsms_error_ind->ota_reject.reject_type = 0;
        p_mnsms_error_ind->ota_reject.reject_cause = 0;
...
#endif
          mnsms_est_ind.sms_msg_type = ims_msg.sms_msg_type;
...
VOID_FUNC
MN_put_MNIMS_MO_RPDU(nas_msg_e_type sms_msg_type)
{
  ...
  mn_rpdu.sms_msg_type = sms_msg_type;
