...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mn/src/mn_ss_cc_processing.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
int component_number)
{
   ...
   else if( ( Multicall_Status_index = MN_whereami(facility_data->connection_id) ) < MULTICALL_STATUS_SIZE)
   {
     ...
     {
        MSG_HIGH_DS_1(MN_SUB,"=MNCNM= =MN= BC.ITC  : %d",mn_call_information_p[facility_data->connection_id]->bearer_capability_1.information_transfer_capability );
