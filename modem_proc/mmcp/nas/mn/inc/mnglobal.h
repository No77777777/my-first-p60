...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mn/inc/mnglobal.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define MN_SUB (mn_message_as_id)
...
#define MSG_HIGH_MN_DS( sub , str, p1, p2, p3)\
    MSG_4 (MSG_SSID_DFLT, MSG_LVL_HIGH, "ds%d" str , sub, (p1), (p2), (p3))
