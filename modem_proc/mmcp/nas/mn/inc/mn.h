...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mn/inc/mn.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
int MN_put_registerSS_ARG(byte *, registerSS_ARG_T,sys_modem_as_id_e_type as_id);
...
#ifdef FEATURE_QSH_DUMP
mn_rrcmn_rab_status_debug_e_type mn_rab_status_get
(
  mn_dsda_as_id_e_type as_id
)__attribute__((section(".uncompressible.text")));

#ifdef FEATURE_NAS_VOC_REL_AFTER_CALL_HOLD
boolean MN_turned_on_vocoder_get
(
  mn_dsda_as_id_e_type as_id
)__attribute__((section(".uncompressible.text")));
#endif
