...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/tc/src/tc.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern sys_modem_as_id_e_type tc_as_id;


#ifdef FEATURE_DUAL_WCDMA
extern byte tc_message_as_id;
#define TC_SUB (tc_message_as_id)
#else
#define TC_SUB  1
#endif
...
/* ---------------------------------------------------------------------------
* TEST LOOPBACK MODE #4 state enumeration.
* --------------------------------------------------------------------------*/
typedef enum
{
  TEST_LOOPBACK_MODE4_NONE,
  TEST_LOOPBACK_MODE4_PENDING_CM_RRC_CONFIRM,
  TEST_LOOPBACK_MODE4_PENDING_RRC_CONFIRM,
  TEST_LOOPBACK_MODE4_PENDING_CM_CONFIRM,
  TEST_LOOPBACK_MODE4_CLOSED,
  TEST_LOOPBACK_MODE4_OPEN
} test_loopback_mode4_state_T;
...
extern test_loopback_mode4_state_T lb_mode4_state; /* This has the current state of loopback Mode4 operation*/
