...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/tc/src/tcrabm.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
void tc_notify_rabm(ue_mode_type_T mode_type)
{
  ...
  if (rabm_cmd != NULL)
  {
    ...
    rabm_cmd->cmd.tc_mode_change_ind.as_id = tc_as_id;
#endif
