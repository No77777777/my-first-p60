...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/nas/tc/src/tc_loopback.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
DESCRIPTION
  This function will extract SIM_ID from all incoming primitives and enables  
  processing of  the primitive in the context of extracted SIM_ID
...
SIDE EFFECTS
  None
===========================================================================*/
boolean tc_get_as_id(tc_cmd_type*);

/*===========================================================================
FUNCTION TC_GET_AS_ID

DESCRIPTION
  This function will set the TC AS ID when ACTIVATE RB TEST MODE message received
  and there is no RB TEST MODE activated on that SUB.
...
SIDE EFFECTS
  None
===========================================================================*/
void tc_set_as_id(byte* , byte , sys_modem_as_id_e_type );
