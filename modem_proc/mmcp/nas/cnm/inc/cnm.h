...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/inc/cnm.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef struct cnm_qsh_debug_metrics_s
{
  qsh_client_metric_context_id_t signaling_metric_context_id;
  cnm_qsh_metric_signaling_s     *ota_signaling_ptr;
}cnm_qsh_debug_metrics_s_type;
#endif
...
#ifdef FEATURE_QSH_EVENT_METRIC
extern cnm_qsh_debug_metrics_s_type cnm_qsh_debug_metrics_sim[MAX_AS_IDS];
...
#ifdef FEATURE_QSH_EVENT_METRIC
extern cnm_qsh_debug_metrics_s_type cnm_qsh_debug_metrics;
#endif
...
cc_state_T get_next_state
(
  mn_dsda_as_id_e_type as_id
