...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_ss_transaction_msgs.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
VOID_FUNC   CNM_start_mt_ss_request(  IMH_T *SS_input_primitive )
{
   ...
   if (type == REGISTER)
   {
      ...
      mnss_begin_ind.as_id = get_as_id();
#endif
