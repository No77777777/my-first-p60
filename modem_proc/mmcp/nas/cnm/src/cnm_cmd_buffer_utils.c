...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_cmd_buffer_utils.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
VOID_FUNC * CNM_alloc( unsigned int size ) 
{
  ...
  if ( p_mem == NULL )
  {
    MSG_FATAL_MN_DS(MN_SUB,"gs_alloc failure for CNM task", 0, 0, 0);
  }
