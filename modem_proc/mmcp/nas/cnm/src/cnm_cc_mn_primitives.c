...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_cc_mn_primitives.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
                               ...
                               byte                 *p_cause)
{
  ...
  p_mncc_rej_ind->as_id = get_as_id();
#endif
...
#ifdef FEATURE_DUAL_SIM 
   p_mncc_user_user_data_ind->as_id = get_as_id();
#endif
...
#ifdef FEATURE_DUAL_SIM 
   p_mncc_congestion_ind->as_id = get_as_id();
#endif
                     ...
                     ie_progress_indicator_T *p_ie_progress )
{
   ...
   //Changes for as_id
#ifdef FEATURE_DUAL_SIM 
  p_mncc_progress_ind->as_id = get_as_id();
#endif
