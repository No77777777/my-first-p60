...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_process_mm_primitives.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#ifdef FEATURE_DUAL_SIM 
      mncc_reest_ind.as_id = get_as_id();
#endif
