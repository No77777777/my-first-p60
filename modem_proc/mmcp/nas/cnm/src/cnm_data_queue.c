...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_data_queue.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
 ...
 */
   ...
   else
   {
      ...
      ERR("In CNM, cnm_data_queue full", 0, 0, 0);
   }
}
