...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_send_mn_msgs.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
                                   ...
                                   reject_cause_T rej_value )
{
   ...
   else if(p_cnm_request_id->CNM_service_type == SHORT_MESSAGE_SERVICE_ESTABLISHMENT)
   {
      ...
      CNM_send_MNSMS_ERROR_IND( p_cnm_request_id->connection_id, (byte)0,NORMAL_UNSPECIFIED,rej_value,rej_type,MMCC_SMS_CS);
#else
