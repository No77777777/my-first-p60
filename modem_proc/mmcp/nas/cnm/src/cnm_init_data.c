...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_init_data.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
VOID_FUNC CNM_initialise_CNM_data( void )
{
   ...
   cnm_qsh_debug_metrics_sim[0].ota_signaling_ptr = NULL;
   cnm_qsh_debug_metrics_sim[1].ota_signaling_ptr = NULL;
#else
