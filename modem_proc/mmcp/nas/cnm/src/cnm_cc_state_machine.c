...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_cc_state_machine.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
cc_state_T get_next_state( mn_dsda_as_id_e_type as_id )
{
  int i;
