...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_timers.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
     ...
     */
        ...
        if(transaction_id < MAXNO_CC_TRANSACTIONS)
        {
           ...
           case PD_CC:       /* if this is a CC transaction */
            ...
            default:
                MSG_ERROR_DS_1(MN_SUB,"=MNCNM= Unexpected PD: received PD = %d",(dword) GET_PD(ti_pd));
                break;
        ...
        {
           MSG_ERROR_DS_1(MN_SUB,"=MNCNM= Incorrect data = %d received from timer module",ti_pd);
        }
    }  /* event not defined */
