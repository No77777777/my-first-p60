...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_cc_process_specific_msgs1.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
VOID_FUNC   CNM_process_alerting_message( connection_id_T connection_id, boolean syntax_ok, byte cause)
{
   ...
   */
   ...
   if ( syntax_ok)
   {
      ...
      mncc_alerting_ind.as_id = get_as_id();
#endif
      ...
      if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
      {
        ...
        GET_IMH_LEN (length, &(mncc_alerting_ind.message_header));

#ifdef FEATURE_DUAL_SIM
        length -= 1;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_alerting_ind.as_id;
#else
        ...
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)ALERTING;
...
VOID_FUNC   CNM_process_call_proceeding_message( connection_id_T connection_id, boolean syntax_ok, byte cause)
{
...
#ifdef FEATURE_DUAL_SIM 
   mncc_call_proc_ind.as_id = get_as_id();
#endif
   ...
   if ( syntax_ok == TRUE )
   {
      ...
      if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
      {
        ...
        GET_IMH_LEN (length, &(mncc_call_proc_ind.message_header));

#ifdef FEATURE_DUAL_SIM
        length -= 1;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_call_proc_ind.as_id;
#else
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)CALL_PROCEEDING;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = (cnm_cause_debug_type)RESERVED;
        cnm_qsh_metric_log_done();
...
VOID_FUNC   CNM_process_connect_message( connection_id_T connection_id, boolean syntax_ok, byte cause)
{
...
#ifdef FEATURE_DUAL_SIM 
   mncc_setup_cnf.as_id =get_as_id();
#endif
   ...
   if(syntax_ok)
   {
      ...
      if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
      {
        ...
        GET_IMH_LEN (length, &(mncc_setup_cnf.message_header));

#ifdef FEATURE_DUAL_SIM
        length -= 1;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_setup_cnf.as_id;
#else
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)CONNECT;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = (cnm_cause_debug_type)RESERVED;
        cnm_qsh_metric_log_done();
...
VOID_FUNC   CNM_process_connect_ack_message( connection_id_T connection_id ) 
{
...
#ifdef FEATURE_DUAL_SIM 
   mncc_setup_compl_ind.as_id = get_as_id();
#endif
   ...
   CNM_send_message((IMH_T *)&mncc_setup_compl_ind, 
      ...
      if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
      {
        ...
        GET_IMH_LEN (length, &(mncc_setup_compl_ind.message_header));

#ifdef FEATURE_DUAL_SIM
        length -= 1;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_setup_compl_ind.as_id;
#else
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)CONNECT_ACK;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = (cnm_cause_debug_type)RESERVED;
        cnm_qsh_metric_log_done();
   ...
   */
   ...
   if ( syntax_ok == TRUE && progress_ind_valid == TRUE )
   {
      ...
      if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
      {
        ...
        GET_IMH_LEN (length, &(mncc_progress_ind.message_header));

#ifdef FEATURE_DUAL_SIM
        length -= 1;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_progress_ind.as_id;
#else  
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif

        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)PROGRESS;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
        cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = (cnm_cause_debug_type)RESERVED;
        cnm_qsh_metric_log_done();
...
VOID_FUNC   CNM_process_setup_message( connection_id_T connection_id, boolean syntax_ok, byte cause)
{
...
#ifdef FEATURE_DUAL_SIM 
   mncc_setup_ind.as_id = get_as_id();
#endif
   ...
   if ( syntax_ok )
   {
      ...
      {
         MSG_ERROR_DS_3(MN_SUB,"=MNCNM= BC-bad combination of BC info: %d, %d, %d", connection_id, BC_repeat, BC2);
         syntax_ok = FALSE;
         cause = CONDITIONAL_IE_ERROR;
      ...
      {
         MSG_ERROR_DS_3(MN_SUB,"=MNCNM= BC-bad combination of LLC info : %d, %d, %d", connection_id, LLC_repeat, LLC_2);
         syntax_ok = FALSE;
         cause = CONDITIONAL_IE_ERROR;
      ...
      {
         MSG_ERROR_DS_3(MN_SUB,"=MNCNM= BC-bad combination of HLC info : %d, %d, %d", connection_id, HLC_repeat, HLC_2);
         syntax_ok = FALSE;
         cause = CONDITIONAL_IE_ERROR;
      }
      else
   ...
   if ( syntax_ok )
   {
      ...
      CNM_send_message( (IMH_T *)&mncc_setup_ind,
               ...
               if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
               {
                 ...
                 GET_IMH_LEN (length, &(mncc_setup_ind.message_header));

#ifdef FEATURE_DUAL_SIM
                 length -= 1;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_setup_ind.as_id;
#else
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)SETUP;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = (cnm_cause_debug_type)RESERVED;
                 cnm_qsh_metric_log_done();
...
#ifdef FEATURE_QSH_EVENT_METRIC
   byte                       disconnect_cause = RESERVED;
#endif
...
#ifdef FEATURE_DUAL_SIM 
      p_mncc_disc_ind->as_id = get_as_id();
#endif
       ...
       */
       ...
       if( syntax_ok )
       {
        ...
        if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
        {
          ...
          GET_IMH_LEN (length, &(p_mncc_disc_ind->message_header));

#ifdef FEATURE_DUAL_SIM
          length -= 1;
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)p_mncc_disc_ind->as_id;
#else
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)DISCONNECT;
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
          cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = disconnect_cause;
          cnm_qsh_metric_log_done();
        }
#endif
       }
...
#endif
            cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
            cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)RELEASE;
            cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.direction = CN_TO_UE_DIRECTION;
            cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.length = length;
            cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.cause_value = cause;
            cnm_qsh_metric_log_done();
          }
#endif
       }
...
#ifdef FEATURE_DUAL_SIM 
       p_mncc_rel_ind->as_id = get_as_id();
#endif
           ...
           */
    
           {
               ...
               if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
               {
                 ...
                 GET_IMH_LEN (length, &(p_mncc_rel_ind->message_header));

#ifdef FEATURE_DUAL_SIM
                 length -= 1;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)p_mncc_rel_ind->as_id;
#else
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
      ...
      if ( last_state == CC_STATE_U1 )
      {
         ...
         CNM_send_message( (IMH_T *)&mncc_rej_ind,
               ...
               if ( cnm_qsh_debug_metrics.ota_signaling_ptr != NULL ) 
               {
                 ...
                 GET_IMH_LEN (length, &(mncc_rej_ind.message_header));

#ifdef FEATURE_DUAL_SIM
                 length -= 1;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = (byte)mncc_rej_ind.as_id;
#else
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.as_id = SYS_MODEM_AS_ID_NONE;
#endif
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.protocol_discriminator = PROTOCOL_DISCRMINATOR_CC_DEBUG;
                 cnm_qsh_debug_metrics.ota_signaling_ptr->metric_sig.message_type = (cnm_message_id_debug_type)RELEASE_COMPLETE;
