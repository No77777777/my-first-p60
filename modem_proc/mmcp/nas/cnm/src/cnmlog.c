...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnmlog.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
VOID_FUNC CNM_log_rp_event(byte mti, byte mref, byte mcause)
{
    ...
    nas_event_report_payload(EVENT_SMS_STATISTICS, 3, rp_event_data,mn_message_as_id);
...
/*lint +e578 */
    ...
    if(events)
    {
        nas_event_report_payload(EVENT_UMTS_CALLS_STATISTICS, 1, &events,mn_message_as_id);
    }
}
