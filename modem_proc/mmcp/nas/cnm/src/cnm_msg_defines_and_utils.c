...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cnm/src/cnm_msg_defines_and_utils.c#2 $    $DateTime: 2021/10/24 23:41:41 $ $Author: pwbldsvc $
...
extern boolean mm_is_srvcc_call_in_progress
(
 ...
 **********************************************************************************/
   ...
   {
      MSG_ERROR_DS_1(MN_SUB,"=MNCNM= Syntax error in IE: given IEI = %d", (dword) IEI);
...
boolean CNM_check_if_any_service_object_exists(void ) 
{
 ...
 sys_modem_as_id_e_type as_id = SYS_MODEM_AS_ID_NONE;
  ...
  /*Check to see if there is any SRVCC call in progress */
  if (mm_is_srvcc_call_in_progress (as_id))
  {
     transactions_in_progress = TRUE;
     MSG_HIGH_DS_0(MN_SUB,"=MNCNM= =MN= SRVCC call in progress.");
  }
