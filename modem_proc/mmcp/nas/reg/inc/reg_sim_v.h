...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/inc/reg_sim_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#if defined (FEATURE_DUAL_SIM) || defined(FEATURE_SGLTE)
extern boolean reg_sim_changed_sim[MAX_NAS_STACKS];
#define reg_sim_changed  reg_sim_changed_sim[reg_as_id]
extern boolean reg_sim_swapped_sim[MAX_NAS_STACKS];
#define reg_sim_swapped  reg_sim_swapped_sim[reg_as_id]
extern reg_as_id_e_type reg_sim_swapped_target_as_id_sim[MAX_NAS_STACKS];
#define reg_sim_swapped_target_as_id reg_sim_swapped_target_as_id_sim[reg_as_id]
extern boolean reg_debug_perso_status_sim[MAX_NAS_STACKS];
#define reg_debug_perso_status reg_debug_perso_status_sim[reg_as_id]
#else
extern boolean reg_sim_changed;
extern boolean reg_debug_perso_status;
#endif
...
#ifdef FEATURE_LTE
#define REG_SIM_BACKOFF_FPLMN_LIST_LENGTH 20
typedef enum
{
...
typedef struct reg_sim_plmn_timer_info_s
{
  ...
  /* 
  ** This parameter will have the array index if blocked directly by NAS or other modules, otherwise
  ** If PLMN is blocked based on EPLMN check then this will have the value of the primary 
  ** backoff forbidden PLMN index
  */
  uint8                    eplmn_index;
...
==============================================================================*/
extern boolean reg_sim_get_backoff_fplmn_info
(
...
==============================================================================*/
extern void reg_sim_clear_backoff_fplmn_list_with_cause
(
  sys_block_plmn_cause_e_type cause
);
...
extern boolean reg_sim_read_ehplmn_from_sim(reg_sim_plmn_list_s_type* ehplmn_list);
...
extern  boolean reg_sim_is_home_plmn_to_be_camped(sys_srv_domain_e_type  req_service_domain);
extern  boolean reg_sim_check_home_mcc(sys_mcc_type current_mcc);
...
extern reg_sim_backoff_fplmn_list_info_s_type reg_sim_backoff_fplmn_list_sim[MAX_NAS_STACKS];
...
RETURN VALUE
  None
==============================================================================*/
extern void reg_sim_remove_plmn_with_matching_mcc_from_backoff_fplmn_list
(
  sys_plmn_id_s_type plmn_id,
  sys_block_plmn_cause_e_type cause
);
