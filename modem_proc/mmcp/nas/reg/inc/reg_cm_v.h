...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/inc/reg_cm_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern boolean cm_secure_call_req_is_valid     
(
...
==============================================================================*/
extern boolean cm_high_priority_activity_ind_is_valid
(
...
extern boolean cm_3GPP2_status_ind_is_valid
(
