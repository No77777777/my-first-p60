...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/inc/reg_mm_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern nas_crit_sect_type mm_sim_swap_crit_sec;
#endif
...
/*===========================================================================
 ...
 ===========================================================================*/
extern boolean is_sim_swap_event_handled_by_only_one_task
(
...
/*===========================================================================
 ...
 ===========================================================================*/
extern void set_sim_swap_event_handled_by_only_one_task
(
  sys_modem_as_id_e_type local_as_id,
  boolean flag
);
...
extern boolean mmr_secure_call_ind_is_valid
(
  const mmr_secure_call_ind_s_type*    msg_p
);
#endif
