...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_log.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
Return Value: cell_list_type
==============================================================================*/
	 	 		 
extern cell_list_type* reg_log_lte_cell_ist
(
