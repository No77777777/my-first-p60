...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_state.c#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern ULogHandle reg_get_ulog_handle(void);
...
void reg_state_process_cm_data_priority_ind(sys_proc_type_e_type  proc_type);
#endif
...
static boolean                        reg_state_set_mcs_pri_sim[MAX_NAS_STACKS] = { FALSE, FALSE};
#define reg_state_set_mcs_pri reg_state_set_mcs_pri_sim[reg_as_id]

static sys_radio_access_tech_e_type reg_state_lp_rat_sim[MAX_NAS_STACKS] = { -1, -1};  // sanity : crash if received -1 with true value from mcs
#define reg_state_lp_rat reg_state_lp_rat_sim[reg_as_id]

static sys_radio_access_tech_e_type reg_state_hp_rat_sim[MAX_NAS_STACKS] = { -1, -1};
#define reg_state_hp_rat reg_state_hp_rat_sim[reg_as_id]

#else
static boolean                        reg_state_set_mcs_pri = FALSE;
static sys_radio_access_tech_e_type                        reg_state_lp_rat= -1;
static sys_radio_access_tech_e_type                        reg_state_hp_rat = -1;
#endif
#if defined(FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)
...
#endif
#ifdef FEATURE_DUAL_SIM
uint32  reg_subs_capability_mask_sim[MAX_AS_IDS];
#define reg_subs_capability_mask reg_subs_capability_mask_sim[reg_sub_id]
#endif

#ifdef FEATURE_QSH_DUMP
reg_qsh_dump_data_s_type *reg_qsh_dump_tag_0_ptr;
reg_qsh_dump_data_s_type *reg_qsh_dump_tag_1_ptr;
#endif
...
reg_debug_cm_sim_available_status_e_type reg_debug_cm_sim_available_status_sim[MAX_NAS_STACKS] = {REG_DEBUG_SIM_AVAILABLE_UNKNOWN, REG_DEBUG_SIM_AVAILABLE_UNKNOWN, REG_DEBUG_SIM_AVAILABLE_UNKNOWN};
#define reg_debug_cm_sim_available_status reg_debug_cm_sim_available_status_sim[reg_as_id]

#elif defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE 
reg_debug_cm_sim_available_status_e_type reg_debug_cm_sim_available_status_sim[MAX_NAS_STACKS] = {REG_DEBUG_SIM_AVAILABLE_UNKNOWN, REG_DEBUG_SIM_AVAILABLE_UNKNOWN};
#define reg_debug_cm_sim_available_status reg_debug_cm_sim_available_status_sim[reg_as_id]

#else
reg_debug_cm_sim_available_status_e_type reg_debug_cm_sim_available_status = REG_DEBUG_SIM_AVAILABLE_UNKNOWN;
#endif
...
static reg_cm_transaction_id_type     reg_state_last_cm_transaction_id_sim[MAX_NAS_STACKS] = { 0, 0, 0};
#define reg_state_last_cm_transaction_id reg_state_last_cm_transaction_id_sim[reg_as_id]
...
static uint8 reg_state_mmr_trans_id_sim[MAX_NAS_STACKS]  = { 0, 0, 0};
#define reg_state_mmr_trans_id reg_state_mmr_trans_id_sim[reg_as_id]
...
static sys_lac_type             reg_state_prev_tac_sim[MAX_NAS_STACKS] = { 0xFF,0xFF,0xFF};
#define reg_state_prev_tac      reg_state_prev_tac_sim[reg_as_id]
...
static boolean reg_state_cfl_hplmn_timer_search_ongoing_sim[MAX_NAS_STACKS] = {FALSE,FALSE,FALSE};
#define reg_state_cfl_hplmn_timer_search_ongoing reg_state_cfl_hplmn_timer_search_ongoing_sim[reg_as_id]
...
static reg_state_manual_search_param_s_type reg_state_manual_search_params_sim[MAX_NAS_STACKS] = {
{
 SYS_SRCH_PRIORITY_NORMAL,
 {FALSE,0
} 
},
{
...
#define reg_state_manual_search_params reg_state_manual_search_params_sim[reg_as_id]

static sys_plmn_id_s_type  reg_state_hplmn_timer_start_plmn_sim[MAX_NAS_STACKS] = {{{0xFF, 0xFF, 0xFF}},{{0xFF, 0xFF, 0xFF}}};
#define reg_state_hplmn_timer_start_plmn reg_state_hplmn_timer_start_plmn_sim[reg_as_id]
...
static reg_cm_transaction_id_type     reg_state_last_cm_transaction_id_sim[MAX_NAS_STACKS] = { 0, 0};
#define reg_state_last_cm_transaction_id reg_state_last_cm_transaction_id_sim[reg_as_id]

static boolean                        reg_state_cm_initiated_registration_sim[MAX_NAS_STACKS] = { FALSE, FALSE};
#define reg_state_cm_initiated_registration reg_state_cm_initiated_registration_sim[reg_as_id]
static uint8 reg_state_mmr_trans_id_sim[MAX_NAS_STACKS]  = { 0, 0};
#define reg_state_mmr_trans_id reg_state_mmr_trans_id_sim[reg_as_id]
static sys_plmn_service_state_s_type  reg_state_service_state_sim[MAX_NAS_STACKS] = {
  {
  SYS_SIM_STATE_NOT_AVAILABLE,
...
static sys_lac_type             reg_state_prev_tac_sim[MAX_NAS_STACKS] = {0xFF, 0xFF};
#define reg_state_prev_tac      reg_state_prev_tac_sim[reg_as_id]
...
static boolean reg_state_cfl_hplmn_timer_search_ongoing_sim[MAX_NAS_STACKS] = {FALSE,FALSE};
#define reg_state_cfl_hplmn_timer_search_ongoing reg_state_cfl_hplmn_timer_search_ongoing_sim[reg_as_id]
...
static reg_cm_transaction_id_type     reg_state_last_cm_transaction_id = 0;
static boolean                        reg_state_cm_initiated_registration = FALSE;
static uint8                          reg_state_mmr_trans_id = 0;
...
static sys_lac_type                   reg_state_prev_tac = {0xFF};
...
static boolean reg_state_cfl_hplmn_timer_search_ongoing = FALSE;
...
static reg_state_manual_search_param_s_type reg_state_manual_search_params = {
SYS_SRCH_PRIORITY_NORMAL, 
{FALSE,0
}
};

static sys_plmn_id_s_type  reg_state_hplmn_timer_start_plmn = {{0xFF, 0xFF, 0xFF}};

#endif /* FEATURE_DUAL_SIM || FEATURE_SGLTE*/

#if defined FEATURE_DUAL_SIM
#if defined FEATURE_TRIPLE_SIM
boolean cm_sim_available_req_pended_sim[MAX_NAS_STACKS] = {FALSE, FALSE, FALSE};
#else
boolean cm_sim_available_req_pended_sim[MAX_NAS_STACKS] = {FALSE, FALSE};
#endif
#endif
...
#if FEATURE_TRIPLE_SIM 
sys_secure_call_e_type reg_state_secure_call_req_type_sim[MAX_NAS_STACKS]={SYS_SECURE_CALL_NONE,SYS_SECURE_CALL_NONE,SYS_SECURE_CALL_NONE};
#define reg_state_secure_call_req_type reg_state_secure_call_req_type_sim[reg_as_id]
#elif defined FEATURE_DUAL_SIM
sys_secure_call_e_type reg_state_secure_call_req_type_sim[MAX_NAS_STACKS]={SYS_SECURE_CALL_NONE,SYS_SECURE_CALL_NONE};
#define reg_state_secure_call_req_type reg_state_secure_call_req_type_sim[reg_as_id]
#else
sys_secure_call_e_type reg_state_secure_call_req_type = SYS_SECURE_CALL_NONE;
#endif
#endif
...
static boolean                           reg_state_mm_waiting_for_reg_req_sim[MAX_NAS_STACKS];
#define reg_state_mm_waiting_for_reg_req reg_state_mm_waiting_for_reg_req_sim[reg_sub_id]
...
static sys_plmn_id_s_type                    reg_state_rlf_plmn_sim[MAX_NAS_STACKS] = {{{0xFF, 0xFF, 0xFF}}, {{0xFF, 0xFF, 0xFF}}, {{0xFF, 0xFF, 0xFF}}};
static sys_radio_access_tech_e_type   reg_state_rlf_rat_sim[MAX_NAS_STACKS] = {SYS_RAT_NONE, SYS_RAT_NONE, SYS_RAT_NONE}; 
#else
static sys_plmn_id_s_type                    reg_state_rlf_plmn_sim[MAX_NAS_STACKS] = {{{0xFF, 0xFF, 0xFF}}, {{0xFF, 0xFF, 0xFF}}};
static sys_radio_access_tech_e_type   reg_state_rlf_rat_sim[MAX_NAS_STACKS] = {SYS_RAT_NONE, SYS_RAT_NONE}; 
#endif

#define reg_state_rlf_plmn reg_state_rlf_plmn_sim[reg_as_id]
#define reg_state_rlf_rat reg_state_rlf_rat_sim[reg_as_id]
#else
...
static reg_mm_lte_cell_info_s_type reg_state_lte_cell_info_ind_sim[MAX_NAS_STACKS] = {FALSE, FALSE};
#define reg_state_lte_cell_info_ind reg_state_lte_cell_info_ind_sim[reg_sub_id]
#else
...
)
{
  ...
  if(to_reg)
  {
    MSG_HIGH_DS_2(REG_SUB, "=REG= Received message MS: %d   MSG_ID: %d ", message_set, message_id);
  }
  else
  {
    MSG_HIGH_DS_2(REG_SUB, "=REG= sent message MS: %d   MSG_ID: %d ", message_set, message_id);
  }

  if (reg_get_ulog_handle() != NULL)
  {
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
    ULOG_RT_PRINTF_7(reg_get_ulog_handle(),
            "DS: SUB %d =REG= Message Set: %d Message ID: %d present_reg_state: %d to_reg: %d mode_pref: %d msg_info: %d",
            reg_as_id + 1,
            message_set,
            message_id,
            reg_state_curr_p->number(),
            to_reg,
            mode_pref,
            reg_msg_info);
#else
    ULOG_RT_PRINTF_6(reg_get_ulog_handle(),
            "=REG= Message Set: %d Message ID: %d present_reg_state: %d to_reg: %d mode_pref: %d msg_info: %d",
            message_set,
            message_id,
            reg_state_curr_p->number(),
            to_reg,
...
reg_state_e_type reg_state_current_state_get(void)
{
...
FUNCTION NAME
  ...
  reg_state_set_gstk_event_flag_per_subs

==============================================================================*/
void reg_state_set_gstk_event_flag_per_subs(boolean flag, sys_modem_as_id_e_type as_id)
{
  reg_need_to_send_gstk_event_sim[as_id] = flag;
}
...
#endif
sys_srch_priority_e_type reg_state_get_manual_search_priority(void)
{
  return reg_state_manual_search_params.srch_priority;
}

boolean reg_state_get_manual_search_increment_search_status(void)
{
  return reg_state_manual_search_params.incremental_results.enabled;
}

uint8 reg_state_get_manual_search_periodicty(void)
{
  return reg_state_manual_search_params.incremental_results.periodicity;
}
void reg_state_set_manual_search_param( sys_srch_priority_e_type srch_priority, 
	                                    sys_incremental_results_s_type	incremental_results)
{
  reg_state_manual_search_params.srch_priority = srch_priority;
  reg_state_manual_search_params.incremental_results.enabled = incremental_results.enabled;
  reg_state_manual_search_params.incremental_results.periodicity = incremental_results.periodicity;
}
/*==============================================================================
...
)
{
  ...
  MSG_HIGH_DS_7(REG_SUB, "=REG= list_search_type %d srch_priority %d Enabled %d Periodicity %d WcDMA count %d LTe count %d preferred_plmn_list count %d ",msg_p->list_search_type,msg_p->srch_priority,msg_p->incremental_results.enabled, msg_p->incremental_results.periodicity,msg_p->arfcn_list.wcdma_count,msg_p->arfcn_list.lte_count,msg_p->preferred_plmn_list.count);

  if(msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_PLMN_LIST_SEARCH && 
  	  (msg_p->srch_priority == SYS_SRCH_PRIORITY_LOW) &&
      ...
      reg_state_curr_p->number() == REG_STATE_AUTOMATIC_SEARCH))
  {
	...
	MSG_HIGH_DS_1(REG_SUB, "=REG= loop back list confirmation to CM with Aborted status, as list request of type %d	sent when other search is in progress",msg_p->list_search_type);
  ...
  if(((msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_SRV_SEARCH_BGND) &&
           ((reg_state_curr_p->number() == REG_STATE_INACTIVE) ||reg_sim_card_mode == MMGSDI_APP_UNKNOWN))
#ifdef FEATURE_SGLTE
     ||(REG_SGLTE_DUAL_STACK && reg_as_id == reg_ps_stack_id && reg_state_service_state.sim_state == SYS_SIM_STATE_PS_INVALID &&
...
#endif
    || ((msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_PLMN_LIST_SEARCH || msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_PCI_PLMN_LIST_SEARCH) && reg_state_last_stop_mode_reason != SYS_STOP_MODE_REASON_NONE)
    )
   {
     sys_found_plmn_list_u_type     *available_list= NULL;
     MSG_HIGH_DS_1(REG_SUB, "=REG= loop back list confirmation to CM, as list request of type %d  sent on PS stack when sim is not PS valid OR received in REG_STATE_INACTIVE",msg_p->list_search_type);
    /* Immediately respond CM_NETWORK_LIST_CNF with SEARCH FAILED */
     available_list = (sys_found_plmn_list_u_type *)modem_mem_calloc(1,sizeof(sys_found_plmn_list_u_type), MODEM_MEM_CLIENT_NAS);
     ...
     available_list->plmn_list.length = 0;
     if(msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_PLMN_LIST_SEARCH && reg_state_last_stop_mode_reason == SYS_STOP_MODE_REASON_MODE_CHANGE)
     {
     	 MSG_HIGH_DS_0(REG_SUB, "=REG= MPLMN search aborted with REG_MM_PLMN_SEARCH_ABORTED_DUE_TO_NO_LOCK");
         reg_send_cm_network_list_cnf
         (
          reg_state_cm_transaction_id_get(),
          reg_sim_read_rplmn(reg_mode_req_service_domain_get()),
     ...
     modem_mem_free(available_list, MODEM_MEM_CLIENT_NAS);
     if((msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_PLMN_LIST_SEARCH || 
         msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_PCI_PLMN_LIST_SEARCH) && 
         reg_state_last_stop_mode_reason != SYS_STOP_MODE_REASON_NONE)
    { 
     reg_state_cm_transaction_id = reg_state_last_cm_transaction_id;
    }
     available_list = NULL;
     return reg_state_curr_p;
   }
if((msg_p->list_search_type == REG_CM_NETWORK_LIST_REQ_SRV_SEARCH_BGND) &&
           ...
           ((reg_sim_per_subs_int_voice_forbidden( reg_state_service_state.plmn,(sys_modem_as_id_e_type)reg_sub_id )) || 
            (reg_sim_per_subs_domestic_voice_forbidden( reg_state_service_state.plmn,(sys_modem_as_id_e_type)reg_sub_id )))
#else
           ((reg_sim_int_voice_forbidden( reg_state_service_state.plmn )) || 
            (reg_sim_domestic_voice_forbidden( reg_state_service_state.plmn )))
#endif
  ...
  higher_priority_plmn_list = (sys_plmn_rat_list_s_type *)modem_mem_calloc(1, sizeof(sys_plmn_rat_list_s_type), MODEM_MEM_CLIENT_NAS);
  ...
  for(i = 0; i < msg_p->rat_pri_list_info.num_items; i++)
  {
    ...
    {
#if (LTE_BAND_NUM == 256)
      MSG_HIGH_DS_8(REG_SUB, "=REG= : LTE bands 1_64: 0x%08x %08x,LTE bands 65_128: 0x%08x %08x \
	                            : LTE bands 129_192: 0x%08x %08x,LTE bands 193_256: 0x%08x %08x",
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap.bits_1_64),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap.bits_1_64),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap.bits_65_128),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap.bits_65_128),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap. bits_129_192),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap. bits_129_192),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap.bits_193_256),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap.bits_193_256));
#else
      MSG_HIGH_DS_2(REG_SUB, "=REG= LTE band_cap = 0x%08x %08x ",
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.lte_band_cap)); 
#endif
    }
    else
    {
      MSG_HIGH_DS_2(REG_SUB, "=REG= band_cap = 0x%08x %08x",
                 QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.chgwt_band_cap),
                 QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[i].band_cap.chgwt_band_cap));
    }
  }
  MSG_HIGH_DS_1(REG_SUB, "=REG= MCC mode band filter num_items = %d",
  msg_p->mcc_mode_band_filter.num_items);
  for(i =0; i< msg_p->mcc_mode_band_filter.num_items ;i++)
  {
    ...
    if(msg_p->mcc_mode_band_filter.priority_list_info[i].acq_sys_mode == SYS_SYS_MODE_LTE)
    {
      ...
      MSG_HIGH_DS_8(REG_SUB, "=REG= : LTE bands 1_64: 0x%08x %08x,LTE bands 65_128: 0x%08x %08x \
	                            : LTE bands 129_192: 0x%08x %08x,LTE bands 193_256: 0x%08x %08x",
               QWORD_HIGH(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_1_64),
               QWORD_LOW(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_1_64),
               QWORD_HIGH(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_65_128),
               QWORD_LOW(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_65_128),
               QWORD_HIGH(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_129_192),
               QWORD_LOW(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_129_192),
               QWORD_HIGH(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_193_256),
               QWORD_LOW(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap.bits_193_256));
#else
     MSG_HIGH_DS_2(REG_SUB, "=REG= LTE band_cap = 0x%08x %08x ",
               QWORD_HIGH(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap),
               QWORD_LOW(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.lte_band_cap)); 
#endif
    }
    else
    {
      MSG_HIGH_DS_2(REG_SUB, "=REG= band_cap = 0x%08x %08x",
                 QWORD_HIGH(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.chgwt_band_cap),
                 QWORD_LOW(msg_p->mcc_mode_band_filter.priority_list_info[i].band_cap.chgwt_band_cap));
    }
  }
  ...
  */
  ...
  reg_state_set_manual_search_param(msg_p->srch_priority,msg_p->incremental_results);
...
)
{
  ...
  boolean                       do_reg_and_mm_rat_prio_match = FALSE;
  boolean                       system_change_no_rat_order_change = FALSE;
  uint32                        addtn_info;

  boolean reg_full_srv_req_in_emerg = mm_get_full_srv_req_in_emerg_per_subs(
#ifdef FEATURE_DUAL_SIM
  ...
  uint32 index;
  boolean last_cm_initiated_registration = FALSE;
  
  addtn_info = msg_p->additional_info;
#ifdef FEATURE_HA_MAINLINE_ONLY_ENABLE
#if defined (FEATURE_DUAL_SIM) && defined (FEATURE_LTE)
  if ((emm_check_rrc_ra_cap_update_pending((sys_modem_as_id_e_type)reg_sub_id) == TRUE) &&
      (reg_bit_mask_check(msg_p->additional_info, (byte)SYS_ADDTNL_INFO_FORCE_RADIO_CAP_UPDATE) == FALSE))
  {
    addtn_info = reg_mode_set_ra_cap_update(msg_p->additional_info);
    MSG_HIGH_DS_1(REG_SUB, "=REG= Updating additional_info in CM_SERVICE_REQ = %d", addtn_info);
  }
#endif
#endif

  MSG_HIGH_DS_4(REG_SUB, "=REG= NEW RAT priority list num_items = %d Scan Scope type = %d, additional_info in CM_SERVICE_REQ = %d Voice domain pref = %d",
                        msg_p->rat_pri_list_info.num_items,msg_p->scan_scope,addtn_info,
  ...
  for(index = 0; index < msg_p->rat_pri_list_info.num_items; index++)
  {
    ...
    MSG_HIGH_DS_2(REG_SUB, "=REG= sys_mode = %d bst_rat_acq_required = %d ",
        ...
        MSG_HIGH_DS_8(REG_SUB, "=REG= : LTE band_cap 1_64: 0x%08x %08x,LTE band_cap 65_128: 0x%08x %08x \
		                           : LTE band_cap 129_192: 0x%08x %08x,LTE band_cap 193_256: 0x%08x %08x",
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_1_64),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_1_64),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_65_128),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_65_128),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_129_192),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_129_192),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_193_256),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap.bits_193_256));

        MSG_HIGH_DS_8(REG_SUB, "=REG= : LTE bst_band_cap 1_64: 0x%08x %08x,LTE bst_band_cap 65_128: 0x%08x %08x \
		                            : LTE bst_band_cap 129_192: 0x%08x %08x,LTE bst_band_cap 193_256: 0x%08x %08x",
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_1_64),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_1_64),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_65_128),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_65_128),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_129_192),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_129_192),
               QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_193_256),
               QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap.bits_193_256));
#else
        MSG_HIGH_DS_6(REG_SUB, "=REG= sys_mode = %d bst_rat_acq_required = %d LTE band_cap = 0x%08x %08x LTE bst_band_cap = 0x%08x %08x",
                      msg_p->rat_pri_list_info.priority_list_info[index].acq_sys_mode,
					  msg_p->rat_pri_list_info.priority_list_info[index].bst_rat_acq_required,
                      QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap),
                      QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.lte_band_cap),
                      QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap),
                      QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.lte_band_cap));
#endif
      }
      else
      {

        MSG_HIGH_DS_6(REG_SUB, "=REG= sys_mode = %d bst_rat_acq_required = %d band_cap = 0x%08x %08x bst_band_cap = 0x%08x %08x",
                      msg_p->rat_pri_list_info.priority_list_info[index].acq_sys_mode,
                      msg_p->rat_pri_list_info.priority_list_info[index].bst_rat_acq_required,
                      QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.chgwt_band_cap),
                      QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].band_cap.chgwt_band_cap),
                      QWORD_HIGH(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.chgwt_band_cap),
                      QWORD_LOW(msg_p->rat_pri_list_info.priority_list_info[index].bst_band_cap.chgwt_band_cap)); 

      }
  }
  if(!reg_mode_rat_pri_list_match(&msg_p->rat_pri_list_info,reg_mode_rat_pri_list_get()))
  {
    ...
    {
       MSG_HIGH_DS_2(REG_SUB, "=REG= OLD RAT list sys_mode = %d bst_rat_acq_required = %d",
                      rat_pri_list_info->priority_list_info[index].acq_sys_mode,
					  rat_pri_list_info->priority_list_info[index].bst_rat_acq_required);
  ...
  if ( ( ( (msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_AUTOMATIC) &&
           (msg_p->parameters.automatic.type != MMR_REG_REQ_USER_SELECTION) )||
         ( (msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_MANUAL)  &&
           (msg_p->parameters.manual.type != MMR_REG_REQ_USER_SELECTION) ) ) &&
       (msg_p->scan_scope != SYS_SCAN_SCOPE_ACQ_DB) )
         
  {
     if (reg_mode_is_lte_band_filtering_applicable(&(msg_p->rat_pri_list_info)))
     {
       reg_mode_lte_scan_pref_set(REG_MODE_LTE_SCAN_TDD);
     }
  }
#endif
  ...
  reg_mode_set_volte_call_in_progress(addtn_info,msg_p->network_selection_mode, msg_p->parameters.automatic.type);
#endif
  reg_mode_set_higher_priority_plmn_selection_started(FALSE);
#ifdef FEATURE_SVLTE_DUAL_SIM
  reg_mode_timed_service_req_set(addtn_info);
#endif

  reg_state_camped_ind_received_set(FALSE);
  reg_mode_fallback_control_set (FALSE);

#if !defined (FEATURE_LTE)
  reg_mode_set_emergency_call(addtn_info);
#endif

  memset(&service_state, 0x00, sizeof(sys_plmn_service_state_s_type));
  reg_state_cm_transaction_id         = msg_p->transaction_id;
  last_cm_initiated_registration = reg_state_cm_initiated_registration;
  ...
  if(reg_state_last_stop_mode_reason == SYS_STOP_MODE_REASON_MODE_CHANGE || reg_state_last_stop_mode_reason == SYS_STOP_MODE_REASON_NO_SYS)
  {
    MSG_HIGH_DS_1(REG_SUB, "=REG= CM_SERVICE_REQ -looped back when stack deact in progress for reason %d",reg_state_last_stop_mode_reason);
  ...
  if(reg_mode_req_service_domain_get() != msg_p->req_service_domain)
  {
    if((msg_p->req_service_domain == SYS_SRV_DOMAIN_PS_ONLY) ||
       (msg_p->req_service_domain == SYS_SRV_DOMAIN_CS_PS) ||
       (reg_state_service_state_sim[reg_as_id].active_rat == SYS_RAT_TDS_RADIO_ACCESS))
    {
      reg_send_cb_dds_info_ind(TRUE);
    }
    else
    {
      reg_send_cb_dds_info_ind(FALSE);
    }
  }
/*Sending cb service ind with None rat*/
  if(reg_state_curr_p->number() == REG_STATE_INACTIVE || reg_state_reg_service_domain_get() != msg_p->req_service_domain) 
  {
    reg_send_cb_service_ind(reg_state_service_status_get(),FALSE,reg_state_active_rat_get());
  }
#endif
  ...
  if(reg_bit_mask_check(addtn_info,
                         (byte)SYS_ADDTNL_INFO_IGNORE_RPLMNACT) == TRUE)
  {
  ...
  if(((msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_AUTOMATIC)||
      ...
      (((reg_last_mm_message_only_for_reg == FALSE) || 
       ...
       (last_cm_initiated_registration == FALSE)))
  {
  ...
  */
  ...
  if ((msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_LIMITED) ||
      ((msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_LIMITED_ROUTINE_ACQUISITION) &&
            ((reg_sim_card_mode == MMGSDI_APP_SIM) || (reg_sim_card_mode == MMGSDI_APP_USIM))) ||
      ((msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_LIMITED_MANUAL_ACQUISITION) &&
    ...
    reg_send_mmr_clear_lai_reject_list_req();
         ...
         !((reg_state_curr_p->number() == REG_STATE_REGISTERING) 
          ...
          && (!(reg_bit_mask_check(addtn_info,
                         ...
                         reg_full_srv_req_in_emerg == TRUE))
#endif
         )
    {
...
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
      do_reg_and_mm_rat_prio_match = reg_mode_rat_pri_list_match(reg_mode_curr_rat_pri_list_get(), &mm_rat_pri_list_info_sim[reg_as_id]);
#else
      do_reg_and_mm_rat_prio_match = reg_mode_rat_pri_list_match(reg_mode_curr_rat_pri_list_get(), &mm_rat_pri_list_info);
#endif
NAS_EXIT_CRIT_SECT(mm_rat_prioritylist_crit_sec);
      ...
      if((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_SYSTEM_CHANGE) &&
         (reg_mode_rat_pri_list_order_match(&msg_p->rat_pri_list_info, reg_mode_rat_pri_list_get()) &&
          (reg_bit_mask_check(addtn_info,
                         (byte)SYS_ADDTNL_INFO_IGNORE_RPLMNACT) == FALSE)))
      {
      ...
      */
      ...
      if (((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_SYNC_UP) &&
           (reg_state_service_state.service_status != SYS_SRV_STATUS_NO_SRV) &&
             (do_reg_and_mm_rat_prio_match == TRUE) &&
              (mm_compare_ms_op_mode_per_sub(reg_as_id, reg_mode_req_service_domain_get())))||
          ...
          ((((((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_NORMAL) ||
              ...
              (msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_MMSS_START_RPLMN))
               &&((!reg_sim_is_home_plmn_to_be_camped(msg_p->req_service_domain)) ||
              (reg_sim_is_home_plmn_to_be_camped(msg_p->req_service_domain) && (sys_plmn_match(hplmn, reg_state_service_state.plmn)))))
||
      ...
      if (((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_SYNC_UP) &&
           (reg_state_service_state.service_status != SYS_SRV_STATUS_NO_SRV) &&
             (do_reg_and_mm_rat_prio_match == TRUE) &&
            (mm_compare_ms_op_mode_per_sub((sys_modem_as_id_e_type)reg_as_id, reg_mode_req_service_domain_get()))) ||
          ...
          ((((((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_NORMAL) ||
             ...
             (msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_MMSS_START_RPLMN)) 
          &&((!reg_sim_is_home_plmn_to_be_camped(msg_p->req_service_domain)) ||
              (reg_sim_is_home_plmn_to_be_camped(msg_p->req_service_domain) && (reg_sim_is_ehplmn(reg_state_service_state.plmn))))) 
            ||((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_USER_SELECTION ||
            msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_BETTER_SYSTEM_RESELECTION  ||
            msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_MMSS_START_HPLMN) &&
          ...
          (reg_mode_is_bst_set_for_rat(&msg_p->rat_pri_list_info,reg_state_service_state.active_rat))
           ...
           ((msg_p->ps_for_request == FALSE) ||
            (reg_state_service_state.reg_service_domain == SYS_SRV_DOMAIN_CS_PS) ||
            (reg_state_service_state.reg_service_domain == SYS_SRV_DOMAIN_PS_ONLY))
           &&
           ...
           (allowed_service_domain == reg_state_reg_service_domain_get()
            || msg_p->req_service_domain == SYS_SRV_DOMAIN_CS_VOLTE)
#ifdef FEATURE_LTE
              ...
              )
      {
        MSG_HIGH_DS_2(REG_SUB, "=REG= CM_SERVICE_REQ - AUTOMATIC - PLMN selection from camped PLMN/RAT,\
                         ...
                         msg_p->parameters.automatic.type,addtn_info);
     ...
     else if ((reg_sim_is_home_plmn_to_be_camped(msg_p->req_service_domain) && 
                  ((((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_NORMAL) ||
                    (msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_MMSS_START_RPLMN)) &&
                   (reg_state_service_state.service_status == SYS_SRV_STATUS_NO_SRV))||
                  (msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_SYSTEM_CHANGE)||
...
#endif
        if ((reg_sim_is_hplmn_to_be_selected()) && // Check flag required or not
            (reg_nv_hplmn_cfl_search_timer_get() != 0) &&
            (reg_mode_is_rlf_plmn_is_higher_priority_ehplmn() == FALSE))
        {
          reg_mode_set_hplmn_to_be_selected(TRUE);
        }
...
#ifdef FEATURE_LTE
        /* If service request is sent to acquire full service for emergency call
           then remove the camped plmn from backoff forbidden plmn list if the mcc
           of the camped plmn is present in the mcc list where full service is needed
           for emergency call */
        if((msg_p->parameters.automatic.type == REG_CM_SERVICE_REQ_NORMAL) &&
           (reg_bit_mask_check(addtn_info,
                         (byte)SYS_ADDTNL_INFO_EMERG_CALL) == TRUE) &&
           (sd_ss_current_mcc_match_mcc_list_emerg_call_full_srv(&reg_state_service_state.plmn, 
                                                          (sys_modem_as_id_e_type)reg_sub_id)))
        {
          reg_sim_remove_plmn_with_matching_mcc_from_backoff_fplmn_list(
                     reg_state_service_state.plmn, 
   ...
   else if (msg_p->network_selection_mode == SYS_NETWORK_SELECTION_MODE_MANUAL_CSG)
   {
    ...
    else
    {
     ...
     if(msg_p->network_selection_mode != SYS_NETWORK_SELECTION_MODE_LIMITED_MANUAL_ACQUISITION)
     {
      reg_mode_update_service_available_rat(SYS_RAT_NONE);
     }
  ...
  else
  {
    ...
    switch (allowed_service_domain)
    {
      ...
      case SYS_SRV_DOMAIN_CS_VOLTE:
        MSG_HIGH_DS_0(REG_SUB, "=REG= CS AND VOLTE SERVICE ALLOWED");
        break;

      case SYS_SRV_DOMAIN_VOLTE:
        MSG_HIGH_DS_0(REG_SUB, "=REG= VOLTE ONLY SERVICE ALLOWED");
        break;
#endif 
...
)
{
  ...
  ue_nas_rel_compliance_type reg_mm_nv_nas_rel_compliance = mm_get_nv_nas_rel_compliance_per_subs(
#ifdef FEATURE_DUAL_SIM
  (sys_modem_as_id_e_type)reg_sub_id
#endif
  );
  ...
  /* Pend the processing of request if sim swap is in progress */
  if(reg_state_is_sim_swap_in_progress())
  {
    /* SIM swap handled at one task (REG/MM) but in progress at other task (MM/REG). Pend the current request. */
    MSG_HIGH_DS_0(REG_SUB, "=REG= SIM swap event handling is in progress. pending the cm_sim_available_req.");
    cm_sim_available_req_pended = TRUE;
    return next_state_p;
  }

  reg_debug_cm_sim_available_status = REG_DEBUG_SIM_AVAILABLE_STARTED;
...
*/
  ...
  if((reg_sim_mmgsdi_info.client_id == 0) || (reg_waiting_for_open_session_cnf))
  {
    ...
    reg_debug_cm_sim_available_status = REG_DEBUG_SIM_AVAILABLE_PENDED_WAITING_FOR_MMGSDI_SESSION;
  ...
  else if (reg_sim_mmgsdi_info.session_id == 0)
  {
    if (!reg_sim_open_session())
    {
      ...
      reg_debug_cm_sim_available_status = REG_DEBUG_SIM_AVAILABLE_FAILED_MMGSDI_SESSION_OPEN_FAILED;      
      reg_send_cm_sim_available_cnf(reg_state_cm_transaction_id);
    }
    else
    {
      reg_need_to_process_sim_avail_req = TRUE;
      reg_debug_cm_sim_available_status = REG_DEBUG_SIM_AVAILABLE_PENDED_REQUESTED_MMGSDI_SESSION;
      MSG_HIGH_DS_0(REG_SUB, "=REG= Waiting for MMGSDI open session as session_id=0");
      reg_send_mmr_sim_available_req
      (
#ifdef FEATURE_DUAL_SIM
        reg_sim_mode_pref
  ...
  else
  {
    ...
    {
      MSG_HIGH_DS_0(REG_SUB, "=REG= SIM load failed");    
      reg_debug_cm_sim_available_status = REG_DEBUG_SIM_AVAILABLE_FAILED_LOAD_CARD_MODE_FAILED;
      reg_send_cm_sim_available_cnf(reg_state_cm_transaction_id);
    }
  }
  reg_state_start_hplmn_search_timer_at_power_up = TRUE;
  if (reg_mm_nv_nas_rel_compliance > NV_NAS_COMPLIANCE_REL6)
  {
...
)
{
     ...
     )
  {
    ...
    reg_state_set_cfl_hplmn_timer_search_ongoing(FALSE);
  }
...
#ifdef FEATURE_DUAL_SIM
      if(reg_mode_lte_enabled_on_sub(reg_subs_capability_mask))
#endif
      {
...
)
{
  ...
  switch(msg_p->oprt_mode)
  {
    ...
    case SYS_OPRT_MODE_LPM:
     if ((reg_sim_state_get() == SYS_SIM_STATE_NOT_AVAILABLE) ||
          (reg_sim_state_get() == SYS_SIM_STATE_CS_PS_INVALID))
     {
         /* Mark sim as legal */
...
#ifdef FEATURE_DUAL_SIM
      reg_mode_clear_ehplmn_forbidden((sys_modem_as_id_e_type)reg_as_id); //FR38535 
      reg_mode_clear_ehplmn_gprs_forbidden((sys_modem_as_id_e_type)reg_as_id);
#else
      reg_mode_clear_ehplmn_forbidden();
      reg_mode_clear_ehplmn_gprs_forbidden();
      ...
      reg_send_cm_fplmn_list_ind(SYS_FORBIDDEN_LIST_TYPE_LTE_BACKOFF_FPLMN);
#endif
      if(reg_nv_is_lpm_power_off_enabled()|| mm_get_t3247_behavior_enabled())
      {
        reg_nv_write_cache();
#ifdef FEATURE_DUAL_SIM
        if(reg_is_t3245_timer_active((sys_modem_as_id_e_type)reg_as_id))
...
FUNCTION NAME
  ...
  reg_state_ignore_reg_cnf

==============================================================================*/

boolean reg_state_ignore_reg_cnf
(
  mmr_reg_cnf_s_type* msg_p
)
{
  boolean reg_cnf_ignored = FALSE;
  if((reg_state_mmr_trans_id != msg_p->trans_id) &&
     ((msg_p->cause == MMR_CAUSE_NONE) ||
      (msg_p->cause == MMR_CAUSE_NOT_SPECIFIED)))
  {
    ...
    MSG_HIGH_DS_2(REG_SUB, "=REG= REG request ignored due to trans id mismatch sent id %d, recvd id %d",
               reg_state_mmr_trans_id, msg_p->trans_id);
    reg_cnf_ignored = TRUE;
  }
  return reg_cnf_ignored;
}
...
)
{
  ...
  sys_plmn_id_s_type hplmn;
#endif
  reg_state_p_type   state_p = &reg_state_registering;
  sys_srv_domain_e_type        allowed_service_domain;
  ...
  reg_mode_3gpp_capability_s_type *automatic_plmn_selection_foreground_rat_list = reg_mode_get_foreground_search_rat_list();
  ...
  if(reg_state_ignore_reg_cnf(msg_p))
  {
    return reg_state_curr_p;
  }
    reg_mode_set_higher_priority_plmn_selection_started(FALSE);
     ...
     )
  {
                         ...
                         (byte)SYS_ADDTNL_INFO_EMERG_CALL) == TRUE)))
    {
      ...
      if(automatic_plmn_selection_foreground_rat_list->num_items > 0)
      {
        reg_mode_remove_rat_from_3gpp_rat_list(automatic_plmn_selection_foreground_rat_list, 
...
#ifdef FEATURE_DUAL_DATA
  if(msg_p->service_state.sim_state == SYS_SIM_STATE_CS_INVALID && 
     reg_mode_req_service_domain_get() == SYS_SRV_DOMAIN_VOLTE &&
     reg_mode_network_selection_mode_get() != SYS_NETWORK_SELECTION_MODE_LIMITED)
  {
    reg_mode_remove_rat_from_rat_pri_list(reg_mode_rat_pri_list_get(), SYS_SYS_MODE_GSM);
    reg_mode_filter_available_plmn_list_rat(SYS_RAT_GSM_RADIO_ACCESS);
    reg_mode_remove_rat_from_rat_pri_list(reg_mode_rat_pri_list_get(), SYS_SYS_MODE_WCDMA);
    reg_mode_filter_available_plmn_list_rat(SYS_RAT_UMTS_RADIO_ACCESS);
    reg_mode_remove_rat_from_rat_pri_list(reg_mode_rat_pri_list_get(), SYS_SYS_MODE_TDS);
    reg_mode_filter_available_plmn_list_rat(SYS_RAT_TDS_RADIO_ACCESS);
  }
#endif
#endif
  ...
  */
  ...
  available_plmn_list = (sys_detailed_plmn_list_s_type *)modem_mem_calloc(1, file_size, MODEM_MEM_CLIENT_NAS);
...
#ifdef FEATURE_NAS_ENABLE_LTE_BAND_FILTERING
  /*Reset the LTE BAND flag*/
  if ( (msg_p->service_state.service_status == SYS_SRV_STATUS_NO_SRV) &&
       (reg_mode_lte_scan_pref_get() == REG_MODE_LTE_SCAN_TDD) &&
       (msg_p->service_state.active_rat == SYS_RAT_LTE_RADIO_ACCESS) )
  {
     reg_mode_lte_scan_pref_set(REG_MODE_LTE_SCAN_FDD);
     reg_mode_append_available_plmn_list(available_plmn_list, reg_mode_req_plmn_get(), reg_mode_req_rat_get());
  }
  else if ( (msg_p->service_state.service_status != SYS_SRV_STATUS_NO_SRV)  ||
            ( (reg_mode_lte_scan_pref_get() == REG_MODE_LTE_SCAN_FDD) &&
              (msg_p->service_state.active_rat == SYS_RAT_LTE_RADIO_ACCESS) ) )
  {
     reg_mode_lte_scan_pref_set(REG_MODE_LTE_SCAN_NONE);
  }
    ...
    */
    if ( !sys_plmn_id_is_undefined(msg_p->service_state.plmn) )
    {
      ...
      reg_ssgccs_send_camp_status(reg_state_service_state.roaming_ind,msg_p->service_state.plmn);
    }
  ...
  #endif
    else if (reg_state_cm_initiated_ps_detach == TRUE && msg_p->cause == MMR_CAUSE_NOT_SPECIFIED)
    {
      MSG_HIGH_DS_0(REG_SUB, "=REG= Finish PLMN Selection since PS detach in progress");
      finished = TRUE;
    }
#ifdef FEATURE_DUAL_DATA
          /* In L+L mode , on non-DDS sub if CS invalid is found*/
          /* LTE full service with CS invalid-stop plmn sel*/
          /* WTG limited service with CS invalid - stop plmn selection*/
    else if (msg_p->cause == MMR_CAUSE_NOT_SPECIFIED &&
        // no T on non-DDS sub
        msg_p->service_state.sim_state == SYS_SIM_STATE_CS_INVALID &&
       (msg_p->service_state.active_rat == SYS_RAT_GSM_RADIO_ACCESS || msg_p->service_state.active_rat == SYS_RAT_UMTS_RADIO_ACCESS) && 
        // CS_VOLTE will be converted to VOLTE when CS is invalid. For actual VOLTE only, CM will never add GW rat
        reg_mode_req_service_domain_get() == SYS_SRV_DOMAIN_VOLTE) 
    {
        MSG_HIGH_DS_1(REG_SUB, "=REG= Stopping plmn selection due to CS bein invalid on GSM rat in L+L mode, service status =%d",reg_state_service_state.service_status);
        finished = TRUE;
    }    
#endif
    else
	 ...
	 //if UE camps on LTE cell without emc support and e911 call is pending then find service on next rat
      ...
      case MMR_CAUSE_FAILURE_INITIATE_PLMN_SELECTION:
        ...
        case MMR_CAUSE_FAILURE_FOREGROUND_PLMN_SEARCH:
          managed_roaming_plmn = (sys_detailed_plmn_list_info_s_type *)modem_mem_calloc(1, sizeof(sys_detailed_plmn_list_info_s_type), MODEM_MEM_CLIENT_NAS);

          reg_check_for_null_ptr((void*)managed_roaming_plmn );

          if ( managed_roaming_plmn != NULL ) 
          {
               ...
               reg_mode_network_selection_mode_get() == SYS_NETWORK_SELECTION_MODE_LIMITED_ROUTINE_ACQUISITION)
            {
              reg_state_user_resel_plmn = reg_state_service_state.plmn;
              reg_state_user_resel_plmn_rat = reg_state_service_state.active_rat;
              if(!reg_mode_start_preferred_plmn_search())
              {
                reg_mode_start_foreground_plmn_search();
              }
              finished = FALSE;
      ...
      *  and no service is found. */
      ...
      else
      {
        ...
        */
        ...
        {
          if((reg_timers_is_hplmn_timer_active() == TRUE) && 
            (!sys_plmn_match(reg_state_get_hplmn_timer_prev_plmn(), reg_state_service_plmn_get())))
          {
            MSG_HIGH_DS_0(REG_SUB, "=REG= hplmn timer restarted due to PLMN change");
            reg_timers_start_hplmn_search_period_timer();
          }
          reg_timers_stop_all_irat_search_period_timer();
        ...
        if(!sys_plmn_id_is_undefined(msg_p->service_state.plmn))
        {
		  ...
		  reg_state_prev_tac = msg_p->service_state.tac;
        }
       ...
       if(reg_state_service_state.service_status == SYS_SRV_STATUS_SRV)
       {
         ...
         sys_plmn_undefine_plmn_id(&reg_state_rlf_plmn);
...
#if !defined (FEATURE_LTE)
        reg_mode_set_emergency_call(FALSE);
#endif
...
)
{
  ...
  reg_nv_imp_variable_prints();
  reg_sim_imp_variable_prints();
  reg_send_cb_service_ind(msg_p->service_state.service_status,FALSE,msg_p->service_state.active_rat);
    ...
    if (reg_state_service_state.service_status == SYS_SRV_STATUS_LIMITED)
    {
      if(reg_last_mm_message_only_for_reg == FALSE)
      {
        ...
        if ((reg_state_service_state.sim_state               == msg_p->service_state.sim_state) &&
            ...
            (reg_state_service_state.emc_attached            == msg_p->service_state.emc_attached) &&
            (msg_p->cause                                    == MMR_CAUSE_NOT_SPECIFIED )
#ifdef FEATURE_FEMTO_CSG
...
/*If No service is due to RLF then save PLMN into RLF PLMN and set PLMN in reg service state to undefined*/
  ...
  else if (msg_p->cause == MMR_CAUSE_FAILURE_PLMN_NOT_ALLOWED_FOR_GPRS_SERVICES)
  {
     if(reg_mode_network_selection_mode_get() == SYS_NETWORK_SELECTION_MODE_MANUAL 
           ...
           && (!(msg_p->service_state.sim_state == SYS_SIM_STATE_PS_INVALID &&
            (reg_mode_is_only_req_rat_present_in_rat_pri_list(reg_mode_rat_pri_list_get(), SYS_SYS_MODE_LTE) ||
			reg_mode_is_rat_pri_list_empty(reg_mode_rat_pri_list_get())==TRUE)))
#endif
        )
     {
        reg_mode_start_manual_plmn_selection
  ...
  */
  ...
  /*
  ** Set the camped indication to FALSE
  */
    reg_state_camped_ind_received_set(FALSE);
...
#if defined FEATURE_DUAL_SIM
  reg_nv_imsi_s_type invalid_imsi;
#endif
...
#ifdef FEATURE_DUAL_SIM
	/* Check if sim swap is done at both REG and MM tasks otherwise assume something went wrong and trigger crash */
	NAS_ENTER_CRIT_SECT(mm_sim_swap_crit_sec);
    if((reg_sim_swapped == FALSE) &&
        is_sim_swap_event_handled_by_only_one_task((sys_modem_as_id_e_type)reg_as_id))
    {
      /* SIM swap handling is failed at REG. Reset NV IMSI, so that it will be considered as new SIM */
      MSG_HIGH_DS_4(REG_SUB, "=REG= SIM swap handling is failed at REG. reg_sim_changed=%d, reg_debug_sim_swap_status=%d, reg_debug_perso_status=%d, reg_sim_card_mode=%d", 
                 reg_sim_changed, reg_debug_sim_swap_status, reg_debug_perso_status, reg_sim_card_mode);
      set_sim_swap_event_handled_by_only_one_task((sys_modem_as_id_e_type)reg_as_id, FALSE);
      memset(&invalid_imsi, 0, sizeof(reg_nv_imsi_s_type));
      (void)reg_nv_write_imsi(&invalid_imsi);
    }
...
#ifdef FEATURE_DUAL_SIM
  /* Process pended cm_sim_available_req on other sub */
  reg_state_process_pended_cm_sim_available_req();
#endif
...
==============================================================================*/
void reg_state_process_pended_cm_sim_available_req
(
  void
)
{
  reg_as_id_e_type reg_as_id_temp = REG_AS_ID_1;
  reg_as_id_e_type reg_as_id_current = reg_as_id;
  cm_sim_available_req_s_type sim_avail_req_msg;

  MSG_HIGH_DS_0(REG_SUB, "=REG= check for pending cm_sim_available_req..");

  for(reg_as_id_temp = REG_AS_ID_1; (reg_as_id_temp < reg_sim_max_subscription) && (reg_as_id_temp < MAX_AS_IDS); reg_as_id_temp++)
  {
    if(cm_sim_available_req_pended_sim[reg_as_id_temp])
    {
      reg_set_as_id(reg_as_id_temp);

      cm_sim_available_req_pended = FALSE;

      sim_avail_req_msg.message_header.message_set = MS_CM_REG;
      sim_avail_req_msg.message_header.message_id = CM_SIM_AVAILABLE_REQ;
      sim_avail_req_msg.message_header.message_len_lsb = (sizeof(cm_sim_available_req_s_type) - sizeof(IMH_T)) % 256;
      sim_avail_req_msg.message_header.message_len_msb = (sizeof(cm_sim_available_req_s_type) - sizeof(IMH_T)) / 256;

      sim_avail_req_msg.transaction_id = reg_state_cm_transaction_id;
      sim_avail_req_msg.mode_pref = reg_sim_mode_pref;
      sim_avail_req_msg.session_type = reg_sim_mmgsdi_info.session_type;
      sim_avail_req_msg.nv_context_id = reg_nv_context_id;
      sim_avail_req_msg.as_id = (sys_modem_as_id_e_type)reg_sub_id;
      sim_avail_req_msg.stack_id = reg_set_cm_stack_id();

      MSG_HIGH_DS_3(REG_SUB, "=REG= Process pending cm_sim_available_req mode_pref:%d session_type:%d nv_context_id: %d ", 
                          sim_avail_req_msg.mode_pref,
                          sim_avail_req_msg.session_type,
                          sim_avail_req_msg.nv_context_id);

      reg_state_next_p = reg_state_curr_p->process_cm_sim_available_req(&sim_avail_req_msg);
...
FUNCTION NAME
  ...
  reg_state_is_sim_swap_in_progress

==============================================================================*/
boolean reg_state_is_sim_swap_in_progress
(
  void
)
{
  ...
  NAS_ENTER_CRIT_SECT(mm_sim_swap_crit_sec);
  for(;local_as_id < MAX_AS_IDS; local_as_id++)
  {
    if(is_sim_swap_event_handled_by_only_one_task(local_as_id))
    {
      MSG_HIGH_DS_1(REG_SUB, "=REG= SIM swap event handling is in progress at AS ID: %d", local_as_id);
      NAS_EXIT_CRIT_SECT(mm_sim_swap_crit_sec);
      return TRUE;
    }
  }
...
)
{
...
#ifdef FEATURE_DUAL_SIM
  // PLMN blocking from DS can come at any point, even if current camped RAT is not LTE
  // Drop the message when current SUB is not LTE enabled/ multimode to avoid crash
  if(reg_mode_lte_enabled_on_sub(reg_subs_capability_mask) == FALSE)
  {
  	MSG_HIGH_DS_0(REG_SUB, "Ignoring PLMN block request with no LTE on current SUB");
    return reg_state_curr_p;
  }
#endif
  switch(msg_p->type)
  {
    case SYS_BLOCK_PLMN_BLOCK:
      ...
      reg_send_mmr_block_plmn_req(msg_p->plmn, msg_p->timer_count, FALSE,msg_p->cause,REG_SIM_BACKOFF_FPLMN_LIST_LENGTH); 
      break;
   ...
   case SYS_BLOCK_PLMN_UNBLOCK_FORCE_PREF:
    ...
    case SYS_BLOCK_PLMN_RESET:
      ...
      {
        if(msg_p->cause == SYS_BLOCK_PLMN_CAUSE_NONE)
        {
          reg_sim_clear_backoff_fplmn_list();
        }
        else
        {
          reg_sim_clear_backoff_fplmn_list_with_cause(msg_p->cause);
        }
        reg_send_cm_fplmn_list_ind(SYS_FORBIDDEN_LIST_TYPE_LTE_BACKOFF_FPLMN);
      }
      break;
    ...
    else
    {
      ...
      
      {
		...
		(
           ...
           reg_mode_allowed_service_domain(reg_mode_req_plmn_get(),reg_mode_req_service_domain_get()),  /* req_service_domain     */
           reg_mode_curr_rat_pri_list_get(),
#ifdef FEATURE_LTE
           reg_mode_sms_only_get(),
           0 
...
FUNCTION NAME
  ...
  reg_state_unexpected_hplmn_cfl_search_timer_expiration

==============================================================================*/
reg_state_p_type reg_state_unexpected_cfl_hplmn_search_timer_expiration
(
  void
)
{
  reg_state_p_type next_state_p = reg_state_curr_p;
  MSG_ERROR_DS_0(REG_SUB, "=REG= HPLMN CFL Search Timer expiration - Unexpected");
  return next_state_p;
}
    ...
    case MS_CM_REG:
      switch( reg_cmd_p->cmd.hdr.message_id )
      {
       ...
       /*reg_msg_info : bits 2-0 : network_selection_mode
        ...
        case CM_HIGH_PRIORITY_ACTIVITY_IND:
          reg_msg_info =(byte)(reg_cmd_p->cmd.cm_high_priority_activity_ind.local_detach);
          break;
		  
		case CM_3GPP2_STATUS_IND:
		  reg_msg_info = ((byte)(reg_cmd_p->cmd.cm_3gpp2_status_ind.is_stack_active)) << 4 | ((byte)(reg_cmd_p->cmd.cm_3gpp2_status_ind.active_rat));
		  break;
...
FUNCTION NAME
  ...
  This function will set the reg_as_id, reg_sub_id and message_as_id

==============================================================================*/

void  reg_set_as_id(reg_as_id_e_type as_id)
{
  reg_as_id = as_id;
  reg_message_as_id = (byte)(as_id + 1);
  reg_sub_id = reg_sub_id_stack[as_id];
}
          ...
          switch( reg_cmd_p->cmd.hdr.message_id )
          {
            ...
            case CM_SERVICE_REQ:
             if(reg_get_sub_id(reg_cmd_p->cmd.cm_service_req.as_id,reg_cmd_p->cmd.hdr))
             {
               ...
               if ((REG_SUB_IS_SGLTE) &&
                   (reg_cmd_p->cmd.cm_service_req.stack_id == (SYS_MODEM_STACK_ID_1)) &&
                   (IS_SGLTE_SPLIT_IN_PROGRESS)&& 
                   (reg_state_service_state_sim[reg_ps_stack_id].service_status == SYS_SRV_STATUS_SRV)&&
                   (reg_state_service_state_sim[reg_ps_stack_id].active_rat == SYS_RAT_GSM_RADIO_ACCESS)&&
                   (reg_cmd_p->cmd.cm_service_req.req_service_domain == SYS_SRV_DOMAIN_PS_ONLY))
               {
                  MSG_HIGH_DS_0(REG_SUB, "=REG= Delaying Service cnf to CM until stack split gets completed ");
                  /*Saving transaction id and cm_initiated_registration inorder to send service_cnf instead of service_ind after stack split completion*/
                  reg_state_cm_initiated_registration_sim[reg_ps_stack_id] = TRUE;
                  reg_state_cm_transaction_id_sim[reg_ps_stack_id] = reg_cmd_p->cmd.cm_service_req.transaction_id;
                  return FALSE;
               }
#endif
            ...
            case CM_SIM_AVAILABLE_REQ:
              ...
              break;
#ifdef FEATURE_CMCC_SECURE_CALL
            case CM_SECURE_CALL_REQ:
              if(reg_get_sub_id(reg_cmd_p->cmd.cm_secure_call_req.as_id,reg_cmd_p->cmd.hdr))
              {
                reg_as_id = reg_get_stack_id(reg_cmd_p->cmd.cm_secure_call_req.stack_id);
              }
              break;
#endif
...
#endif
            case CM_HIGH_PRIORITY_ACTIVITY_IND:
              if(reg_get_sub_id(reg_cmd_p->cmd.cm_high_priority_activity_ind.as_id,reg_cmd_p->cmd.hdr))
              {
                reg_as_id = reg_get_stack_id(reg_cmd_p->cmd.cm_high_priority_activity_ind.stack_id);
              }
              break;
	    case CM_ROAMING_IND:
              ...
              break;
       case CM_3GPP2_STATUS_IND:
              reg_as_id = reg_cmd_p->cmd.cm_3gpp2_status_ind.as_id;
	       break;
            default:
        ...
        case MS_MM_REG:
          ...
          switch( reg_cmd_p->cmd.hdr.message_id )
          {
            ...
            case MMR_REG_REQ_IGNORED_IND:
              reg_as_id = reg_cmd_p->cmd.mmr_reg_req_ignored_ind.as_id;
              break;
            ...
            case MMR_ME_BLOCKED_STATUS_IND:
             reg_as_id = reg_cmd_p->cmd.mmr_me_blocked_status_ind.as_id;
             break;
#ifdef FEATURE_LTE
            case MMR_NON_ACQ_UPDATE_IND:
              reg_as_id = reg_cmd_p->cmd.mmr_non_acq_update_ind.as_id;
              break;
#endif
...
#ifdef FEATURE_LTE
            case REG_CFL_SEARCH_TIMER:
             reg_as_id = REG_AS_ID_1;
                break;

#ifdef FEATURE_DUAL_SIM 
            case REG_CFL_SEARCH_TIMER_SIM_ID_2:
              reg_as_id = REG_AS_ID_2;
              break;
#ifdef FEATURE_TRIPLE_SIM
            case REG_CFL_SEARCH_TIMER_SIM_ID_3:
              reg_as_id = REG_AS_ID_3;
              break;
#endif
#endif
...
{
  reg_state_s_type *state_p = reg_state_curr_p;
  boolean int_voice_roaming_chgd = reg_nv_write_voice_roaming(roaming_ind->international_voice_roaming_allowed);
  boolean domestic_voice_roaming_chgd = reg_nv_write_domestic_voice_roaming(roaming_ind->domestic_voice_roaming_allowed);
  MSG_HIGH_DS_2(REG_SUB, "=REG= Roaming Indication Received with International Roaming = %d Domestic Roaming = %d",roaming_ind->international_voice_roaming_allowed,roaming_ind->domestic_voice_roaming_allowed);
  MSG_HIGH_DS_2(REG_SUB, "=REG= int_voice_roaming_chgd= %d domestic_voice_roaming_chgd = %d",int_voice_roaming_chgd,domestic_voice_roaming_chgd);
  if(int_voice_roaming_chgd == TRUE || domestic_voice_roaming_chgd == TRUE)
  {
  /*If Domestic or international voice changed ON -> OFF then do local cs ps detach based on camping criteria*/
    if((reg_state_service_state.service_status != SYS_SRV_STATUS_NO_SRV) &&
       (((int_voice_roaming_chgd == TRUE ) &&
         (roaming_ind->international_voice_roaming_allowed == FALSE) &&
         (reg_sim_check_mcc_same_country(reg_state_service_state.plmn) == FALSE)) ||
        ((domestic_voice_roaming_chgd ==TRUE) &&
         (roaming_ind->domestic_voice_roaming_allowed == FALSE) &&
         (reg_sim_check_mcc_same_country(reg_state_service_state.plmn) == TRUE) &&
#ifdef FEATURE_EQUIVALENT_HPLMN
          (reg_sim_is_ehplmn(reg_state_service_state.plmn) == FALSE )
#else
          (sys_plmn_match(reg_sim_read_hplmn(), reg_state_service_state.plmn) == FALSE)
#endif 
         )))
    {
    ...
    if(((reg_state_service_state.service_status != SYS_SRV_STATUS_NO_SRV) &&
         (((int_voice_roaming_chgd == TRUE ) &&
           ...
           (reg_sim_check_mcc_same_country(reg_state_service_state.plmn) == FALSE)) ||
          ((domestic_voice_roaming_chgd ==TRUE) &&
           (roaming_ind->domestic_voice_roaming_allowed == TRUE) &&
#ifdef FEATURE_EQUIVALENT_HPLMN
           (reg_sim_is_ehplmn(reg_state_service_state.plmn) == FALSE)
#else
           (sys_plmn_match(reg_sim_read_hplmn(), reg_state_service_state.plmn) == FALSE)
  ...
  switch( reg_cmd_p->cmd.hdr.message_set )
  {
    ...
    */
    case MS_CM_REG:
      ...
      switch( reg_cmd_p->cmd.hdr.message_id )
      {
        ...
        case CM_DS_STAT_CHGD_REQ:
          if(cm_ds_stat_chgd_req_is_valid(&(reg_cmd_p->cmd.cm_ds_stat_chgd_req)) )
          {
            ...
            if(reg_cmd_p->cmd.cm_ds_stat_chgd_req.dual_standby_mode == SYS_MODEM_DS_PREF_DUAL_STANDBY ||
				reg_cmd_p->cmd.cm_ds_stat_chgd_req.dual_standby_mode == SYS_MODEM_DS_PREF_DUAL_STANDBY_NO_TUNEAWAY ||
				reg_cmd_p->cmd.cm_ds_stat_chgd_req.dual_standby_mode == SYS_MODEM_DS_PREF_TRIPLE_STANDBY ||
				reg_cmd_p->cmd.cm_ds_stat_chgd_req.dual_standby_mode == SYS_MODEM_DS_PREF_TRIPLE_STANDBY_NO_TUNEAWAY)
            {
              dual_mode = TRUE;
            }
			else
            ...
            MSG_HIGH_DS_2(REG_SUB, "=REG= CM_DS_STAT_CHGD_REQ, ds stusus %d, dual_mode = %d",
                                reg_cmd_p->cmd.cm_ds_stat_chgd_req.dual_standby_mode,dual_mode);

            reg_send_mmr_ds_stat_chgd_req(dual_mode,reg_cmd_p->cmd.cm_ds_stat_chgd_req.dual_standby_mode,
        ...
        case CM_MULTIMODE_SUBS_CHGD_REQ:
          MSG_HIGH_DS_2(REG_SUB, "=REG= CM_MULTIMODE_SUBS_CHGD_REQ{\n subs capability[0]= 0x%x,subs capability[1]=0x%x \n}",
                           reg_cmd_p->cmd.cm_multimode_subs_chgd_req.subs_capability_mask[0],
                           reg_cmd_p->cmd.cm_multimode_subs_chgd_req.subs_capability_mask[1]);
          if(cm_multimode_subs_chgd_req_is_valid(&reg_cmd_p->cmd.cm_multimode_subs_chgd_req))
          {
            memscpy(reg_subs_capability_mask_sim, MAX_AS_IDS*sizeof(uint32),
                    reg_cmd_p->cmd.cm_multimode_subs_chgd_req.subs_capability_mask,
                    MAX_AS_IDS*sizeof(uint32));
            reg_send_mmr_multimode_subs_chgd_req(reg_cmd_p->cmd.cm_multimode_subs_chgd_req.subs_capability_mask);
          }
          else
          {
     ...
     case CM_DATA_PRIORITY_IND:
        if(cm_data_priority_ind_is_valid(&(reg_cmd_p->cmd.cm_data_prio_ind)))
        {
          MSG_HIGH_DS_1(REG_SUB, "=REG= CM_DATA_PRIORITY_IND  priority %d",
                                                              reg_cmd_p->cmd.cm_data_prio_ind.proc_type);
          reg_state_process_cm_data_priority_ind(reg_cmd_p->cmd.cm_data_prio_ind.proc_type);
        }
...
#ifdef FEATURE_CMCC_SECURE_CALL
      case CM_SECURE_CALL_REQ: 
       if(cm_secure_call_req_is_valid(&(reg_cmd_p->cmd.cm_secure_call_req)))
       {
           MSG_HIGH_DS_1(REG_SUB, "=REG= CM_SECURE_CALL_REQ  type = %d",
                                                              reg_cmd_p->cmd.cm_secure_call_req.type);
           reg_state_process_cm_secure_call_req(reg_cmd_p->cmd.cm_secure_call_req.type);
       }
       break;
#endif
#ifdef FEATURE_FEMTO_CSG
     ...
     case CM_DDS_SWITCH_IND:
          if(cm_dds_switch_ind_is_valid(&(reg_cmd_p->cmd.cm_dds_switch_ind)))
          {
            ...
            reg_send_mmr_dds_switch_ind(reg_cmd_p->cmd.cm_dds_switch_ind.target_dds_sub,reg_cmd_p->cmd.cm_dds_switch_ind.data_call_pending);
            reg_set_as_id(reg_cmd_p->cmd.cm_dds_switch_ind.target_dds_sub);
#ifdef FEATURE_LTE
            reg_sim_clear_backoff_fplmn_list_with_cause(SYS_BLOCK_PLMN_CAUSE_IMS_REGISTRATION_FAILURE);
#endif
          }
          else
          {
     ...
     case CM_HIGH_PRIORITY_ACTIVITY_IND:
          if(cm_high_priority_activity_ind_is_valid(&(reg_cmd_p->cmd.cm_high_priority_activity_ind)))
          {
            MSG_HIGH_DS_0(REG_SUB, "=REG= CM_HIGH_PRIORITY_ACTIVITY_IND ");
            reg_send_mmr_high_priority_activity_ind
            (
              reg_cmd_p->cmd.cm_high_priority_activity_ind.local_detach
            );
          }
          else
          {
            MSG_HIGH_DS_0(REG_SUB, "=REG= CM_HIGH_PRIORITY_ACTIVITY_IND  - Invalid");
          }
          break;
	...
	case CM_ROAMING_IND:
   	...
   	case CM_3GPP2_STATUS_IND:
#ifdef FEATURE_DUAL_SIM
		  if(cm_3GPP2_status_ind_is_valid(&(reg_cmd_p->cmd.cm_3gpp2_status_ind)))
		  {
            MSG_HIGH_DS_2(REG_SUB, "=REG= CM_3GPP2_STATUS_IND active rat = %d stack status = %d ",
                                            reg_cmd_p->cmd.cm_3gpp2_status_ind.active_rat,
                                            reg_cmd_p->cmd.cm_3gpp2_status_ind.is_stack_active);

			reg_send_cb_3gpp2_stack_status_ind(reg_cmd_p->cmd.cm_3gpp2_status_ind.is_stack_active,
				                               reg_cmd_p->cmd.cm_3gpp2_status_ind.active_rat);
    ...
    case MS_MM_REG:
      ...
      switch( reg_cmd_p->cmd.hdr.message_id )
      {
        ...
        case MMR_SIM_AVAILABLE_CNF:
          ...
          /* Check if sim swap is done at both REG and MM tasks otherwise assume something went wrong and trigger crash */
          NAS_ENTER_CRIT_SECT(mm_sim_swap_crit_sec);
          MSG_HIGH_DS_3(REG_SUB, "=REG= sim_swap_event_handled_by_only_one_task=%d, reg_sim_changed=%d, reg_sim_swapped=%d", 
                     is_sim_swap_event_handled_by_only_one_task((sys_modem_as_id_e_type)reg_as_id), reg_sim_changed, reg_sim_swapped);

          if(is_sim_swap_event_handled_by_only_one_task((sys_modem_as_id_e_type)reg_as_id) && 
             ((reg_sim_card_mode == MMGSDI_APP_SIM) || (reg_sim_card_mode == MMGSDI_APP_USIM)) &&
             (reg_sim_swapped == FALSE))
          {
            for (idx = REG_AS_ID_1; idx < MAX_AS_IDS; idx++)
            {
              MSG_HIGH_DS_8(REG_SUB, "=REG= ASID=%d, reg_sim_changed=%d, reg_sim_swapped=%d, reg_debug_sim_swap_status=%d, reg_debug_cm_sim_available_status=%d, reg_debug_perso_status=%d, reg_sim_card_mode=%d, reg_sim_swapped_target_as_id=%d", 
                       idx, reg_sim_changed_sim[idx], reg_sim_swapped_sim[idx],
                       reg_debug_sim_swap_status_sim[idx], reg_debug_cm_sim_available_status_sim[idx], reg_debug_perso_status_sim[idx],
                       reg_sim_card_mode_sim[idx], reg_sim_swapped_target_as_id_sim[idx]);
            }

            /* SIM swap handled at one task (REG/MM) but not done at other task (MM/REG). */
            NAS_EXIT_CRIT_SECT(mm_sim_swap_crit_sec);
            MSG_FATAL_DS(REG_SUB,"=REG= ERR: sim_swap_event_handled_by_only_one_task still got set when we send CM_SIM_AVAILABLE_CNF.", 0, 0, 0);
          }

          if(is_sim_swap_event_handled_by_only_one_task((sys_modem_as_id_e_type)reg_as_id) &&
             (reg_need_to_process_sim_avail_req == FALSE))
          {
            /* SIM swap handling is failed either at REG or MM. Reset NV IMSI for both the SIMs, so that they will be considered as new SIMs */
            set_sim_swap_event_handled_by_only_one_task((sys_modem_as_id_e_type)reg_as_id, FALSE);
            memset(&invalid_imsi, 0, sizeof(reg_nv_imsi_s_type));
            (void)reg_nv_write_imsi(&invalid_imsi);
            if((reg_sim_swapped == TRUE) && (reg_as_id != reg_sim_swapped_target_as_id))
            {
              /* Change context to target SUB */
              reg_set_as_id(reg_sim_swapped_target_as_id);

              (void)reg_nv_write_imsi(&invalid_imsi);

              /* Change context to current SUB */
              reg_set_as_id(reg_as_id);
            }
          }
          NAS_EXIT_CRIT_SECT(mm_sim_swap_crit_sec);
        ...
        case MMR_STOP_MODE_CNF:
          if (mmr_stop_mode_cnf_is_valid(&(reg_cmd_p->cmd.mmr_stop_mode_cnf)) &&
 		               (reg_state_cm_transaction_id_get() == reg_cmd_p->cmd.mmr_stop_mode_cnf.trans_id))
          {
            MSG_HIGH_DS_1(REG_SUB, "=REG= MMR_STOP_MODE_CNF trans_id 0x%x",reg_state_cm_transaction_id_get());
          ...
          {
            MSG_HIGH_DS_1(REG_SUB, "=REG= MMR_STOP_MODE_CNF - Invalid, trans_id 0x%x",reg_state_cm_transaction_id_get());
          }
          break;
#if defined(FEATURE_HSDPA) || defined(FEATURE_GSM_DTM)
        case MMR_CELL_SERVICE_IND:
...
#ifdef FEATURE_DUAL_SIM
          case MMR_ME_BLOCKED_STATUS_IND:
           reg_state_process_mmr_me_blocked_status_ind(reg_cmd_p->cmd.mmr_me_blocked_status_ind.is_me_blocked);
           break;
#endif

#ifdef FEATURE_LTE
         case MMR_NON_ACQ_UPDATE_IND:
           reg_state_process_non_acq_update_ind(reg_cmd_p->cmd.mmr_non_acq_update_ind.voice_domain_pref);
           break;
#endif
...
#if defined FEATURE_DUAL_SIM
         case REG_CFL_SEARCH_TIMER_SIM_ID_2:
#if defined FEATURE_TRIPLE_SIM_DUAL_SIM
         case REG_CFL_SEARCH_TIMER_SIM_ID_3:
#endif
#endif
           MSG_HIGH_DS_0(REG_SUB, "=REG= REG HPLMN CFL Search Timer expired");
           reg_state_next_p = reg_state_curr_p->process_cfl_search_timer_expiration();
           if ((reg_state_curr_p != reg_state_next_p) &&
               (reg_state_next_p == &reg_state_automatic_search))
           {
             reg_state_cfl_hplmn_timer_search_ongoing = TRUE;
           }
           break;
#endif
        default:
...
FUNCTION NAME
  ...
  reg_state_mmr_trans_id_set

==============================================================================*/

uint8 reg_state_mmr_trans_id_set
(
  void
)
{

  return ++reg_state_mmr_trans_id;
}
...
FUNCTION NAME
  ...
  reg_state_last_stop_mode_reason_get

==============================================================================*/

sys_stop_mode_reason_e_type reg_state_last_stop_mode_reason_get
(
  void
)
{
  return reg_state_last_stop_mode_reason;
}
...
FUNCTION NAME
  ...
  reg_state_service_status_get_per_subs

==============================================================================*/

sys_srv_status_e_type reg_state_service_status_get_per_subs
(
  sys_modem_as_id_e_type as_id
)
{
...
FUNCTION NAME
  ...
  reg_state_service_tac_get

==============================================================================*/

word reg_state_service_tac_get
(
  void
)
{
  return reg_state_service_state.tac;
}
...
FUNCTION NAME
  ...
  reg_state_prev_tac_get

==============================================================================*/

sys_lac_type reg_state_prev_tac_get
(
  void
)
{
  return reg_state_prev_tac;
}
...
FUNCTION NAME
  ...
  reg_state_reset_plmn_search_transaction_id

==============================================================================*/

void reg_state_reset_plmn_search_transaction_id
(
  void
)
{
  ...
  {
    reg_state_plmn_search_transaction_id_sim[as_id] = 0;
  }
#else
  reg_state_plmn_search_transaction_id = 0;
#endif
}
...
FUNCTION NAME
  ...
  reg_state_camped_ind_received_get

==============================================================================*/

boolean reg_state_camped_ind_received_get
(
 void
)
{
  return reg_state_camped_ind_received;
}
...
void reg_state_log_variables(void)
{
...
#endif  
  {
    ...
    MSG_HIGH_DS_1( i+1, "=REG= REG STATE %d", reg_state_curr_p_sim[i]->number());
    /* get SIM CARD MODE */
    session_info_query.query_type = MMGSDI_SESSION_INFO_QUERY_BY_TYPE;
    ...
    {
      MSG_ERROR_DS_0(i+1, "=REG= SIM card mode get failed!!!");
    }

    MSG_HIGH_DS_3( i+1, "=REG= reg_need_to_process_sim_avail_req/waiting_for_open=%x, session_type = %d, reg_sim_card_mode=%d", 
...
void reg_state_log_variables(void)
{
  ...
  MSG_HIGH_DS_5(REG_SUB, "=REG= REG STATE %d, reg_sim_card_mode=%d, reg_need_to_process_sim_avail_req=%d, reg_waiting_for_open_session_cnf=%d, session_type = %d", 
                 reg_state_curr_p->number(),reg_sim_card_mode,
...
)
{
  ...
  reg_send_mmr_set_drx_req(msg_p->drx_coefficient, msg_p->active_rat, msg_p->client_type);
...
)
{
  ...
  if ((msg_p->active_rat != SYS_RAT_NONE) &&
      (msg_p->active_rat != SYS_RAT_MAX))
  {
     reg_send_mmr_set_drx_req(msg_p->drx_coefficient, msg_p->active_rat, msg_p->client_type);
  }
  else
...
#ifdef FEATURE_DUAL_SIM
  reg_send_mmr_t3245_expiry_ind();  
  if(mm_emm_is_illegal_me_on_any_sub ((sys_modem_as_id_e_type)reg_as_id))
  {
    MSG_HIGH_DS_0(REG_SUB,"=REG= Don't send legal subscription upon T3245 expiry as received ILLEGAL ME on any other SUB");
  }
  else
#endif
  {
...
void reg_state_process_cm_data_priority_ind(sys_proc_type_e_type  proc_type)
{
   ...
   reg_send_mmr_data_priority_ind(proc_type);
}
#endif

#ifdef FEATURE_CMCC_SECURE_CALL
void reg_state_process_cm_secure_call_req(sys_secure_call_e_type secure_type_req)
{
   reg_state_secure_call_req_type = secure_type_req;
   reg_send_mmr_secure_call_ind(secure_type_req);
}
#endif
#ifdef FEATURE_SGLTE
/*==============================================================================
...
)
{
  ...
  lte_cell_list_entry = (lte_cell_list_type*) modem_mem_calloc(1, sizeof(lte_cell_list_type),MODEM_MEM_CLIENT_NAS);
  reg_check_for_null_ptr((void*)lte_cell_list_entry );

  if ( lte_cell_list_entry != NULL ) 
  {
...
cell_list_type* reg_state_create_new_cell_list_entry(sys_lac_type lac,word cell_id, rex_timer_cnt_type timer_count )       
{
  ...
  cell_list_entry = (cell_list_type*) modem_mem_calloc(1, sizeof(cell_list_type),MODEM_MEM_CLIENT_NAS);

  reg_check_for_null_ptr((void*)cell_list_entry ) ;

  if ( cell_list_entry != NULL ) 
  {
...
byte* reg_convert_lte_list_into_array(lte_cell_list_type* lte_list_ptr, uint32 *length,boolean lte_available)  
{
  ...
  reg_state_dump_the_list(lte_list_ptr,lte_available);
  ...
  byte_array = (byte*)modem_mem_calloc(1, total_size_for_array,MODEM_MEM_CLIENT_NAS);
...
lte_cell_list_type* reg_convert_byte_array_to_lte_cell_list( lte_cell_list_type* lte_list_ptr, byte *byte_array, boolean lte_available)
{
  ...
  reg_state_dump_the_list(lte_list_temp_ptr,lte_available);
...
void reg_state_set_cfl_hplmn_timer_search_ongoing(boolean value)
{
  reg_state_cfl_hplmn_timer_search_ongoing = value;
}

boolean reg_state_get_cfl_hplmn_timer_search_ongoing (void)
{
  return reg_state_cfl_hplmn_timer_search_ongoing;
}
...
boolean reg_state_cell_id_changed(sys_plmn_service_state_s_type service_state_local, word cell_id)
{
  ...
  MSG_HIGH_DS_4(REG_SUB, "=REG= LTE IRAT BPLMN : Cell Changed =%d, Force BPLMN search =%d Cell Id = %d, reg_state_hplmn_irat_timer_count = %d ",ret_value,reg_state_force_bplmn_search_start,reg_state_cell_id, reg_state_hplmn_irat_timer_count);  
  return ret_value;
}
...
void reg_state_dump_the_list(lte_cell_list_type* temp_list_ptr,  boolean lte_available)
{
  lte_cell_list_type*      list_ptr = NULL;
  cell_list_type*          curr_cell_id_ptr = NULL;	
  boolean                  plmn_id_is_undefined;
  boolean                  mnc_includes_pcs_digit;
  uint32                   mcc;
  uint32                   mnc;
  ...
  uint8                    length_of_list = 0;
  list_ptr = temp_list_ptr;
  
  if(list_ptr == NULL)
  {
    MSG_HIGH_DS_1(REG_SUB, "=REG= LTE IRAT BPLMN : List(%d) is empty",lte_available);
    return;
  }
  while (list_ptr != NULL)
  {
    ...
    while(temp_cell_id_ptr != NULL)
    {
      ...
      MSG_HIGH_DS_4(REG_SUB, "=REG=  LAC - CELL_ID - COUNTER - EARFCN Count   %d - %d - %d - %d",temp_cell_id_ptr->lac, temp_cell_id_ptr->cell_id,temp_cell_id_ptr->count,earfcn_curr.count);
  ...
  list_ptr = temp_list_ptr;
  curr_cell_id_ptr = list_ptr->cell_ptr;
  while (list_ptr != NULL)
  {
    curr_cell_id_ptr = reg_log_lte_cell_ist(&list_ptr,lte_available, (sys_modem_as_id_e_type)reg_sub_id,curr_cell_id_ptr,&length_of_list);
  ...
  while(lte_local_list_ptr != NULL)
  {
    if(sys_plmn_match(lte_local_list_ptr->plmn ,plmn) && lte_local_list_ptr->rat == rat)
    {
      ...
      while(cell_list_local_ptr != NULL)
      {
	    ...
	    if(cell_list_local_ptr !=NULL && prev_cell_list_ptr == cell_list_local_ptr)
        {
            MSG_FATAL_DS(REG_SUB,"=REG= LTE IRAT BPLMN : LIST is cyclic", 0, 0, 0);
        }
      }
      if(prev_lte_list_ptr != NULL)
      {
    ...
    if(lte_local_list_ptr !=NULL && prev_lte_list_ptr == lte_local_list_ptr)
    {
      MSG_FATAL_DS(REG_SUB,"=REG= LTE IRAT BPLMN : LIST is cyclic", 0, 0, 0);
    }
  }
...
#endif 
boolean reg_state_get_mcs_pri(void)
{
  return reg_state_set_mcs_pri;
}

sys_radio_access_tech_e_type reg_state_get_mcs_low_priority_rat(void)
{
  return reg_state_lp_rat;
}

sys_radio_access_tech_e_type reg_state_get_mcs_high_priority_rat(void)
{
  return reg_state_hp_rat;
}

void reg_state_set_mcs_pri_req(boolean status,reg_as_id_e_type as_id)
{
   reg_state_set_mcs_pri_sim[as_id] = status;
}

void reg_state_set_mcs_low_priority_rat(sys_radio_access_tech_e_type rat,reg_as_id_e_type as_id)
{
   reg_state_lp_rat_sim[as_id] = rat;
}

void reg_state_set_mcs_high_priority_rat(sys_radio_access_tech_e_type rat,reg_as_id_e_type as_id)
{
   reg_state_hp_rat_sim[as_id] = rat;
}
...
void reg_state_send_indication_on_other_stack(void)
{
  ...
  if(reg_state_service_state.service_status == SYS_SRV_STATUS_SRV && (MMCNM_IS_MODE_DUAL_STANDBY))
  {
    ...
    reg_set_as_id(buffered_reg_as_id);
  }
}
#endif
...
FUNCTION NAME
  ...
  reg_state_get_power_up_system_selection_per_subs

==============================================================================*/
boolean reg_state_get_power_up_system_selection_per_subs
(
  sys_modem_as_id_e_type as_id
)
{
  return reg_state_power_up_system_selection_sim[as_id];
}
#endif
/*==============================================================================
...
FUNCTION NAME
  ...
  reg_state_cm_sim_update_ind_pending_get

==============================================================================*/

boolean reg_state_cm_sim_update_ind_pending_get  
(
  void
)
{
  return reg_state_cm_sim_update_ind_pending;
}
...
FUNCTION NAME
  ...
  reg_state_cm_sim_update_ind_pending_set

==============================================================================*/

void reg_state_cm_sim_update_ind_pending_set 
(
  boolean value
)
{
  reg_state_cm_sim_update_ind_pending = value;
}
...
reg_state_p_type reg_state_process_mmr_me_blocked_status_ind
(
  boolean is_me_blocked
) 

{
  MSG_HIGH_DS_0(REG_SUB, "=REG= Received MMR_ME_BLOCKED_IND for blocking");
  reg_send_cm_me_blocked_status_ind( is_me_blocked);
  return reg_state_curr_p;
}
...
FUNCTION NAME
  ...
  reg_state_unexpected_mmr_me_blocked_status_ind

==============================================================================*/
reg_state_p_type reg_state_unexpected_mmr_me_blocked_status_ind
(
  boolean is_me_blocked
) 
{
  MSG_ERROR_DS_0(REG_SUB, "=REG= MMR_BLOCKED_IND - Unexpected");
  return reg_state_curr_p;
}
#endif
...
FUNCTION NAME
  ...
  reg_state_process_mmr_non_acq_update_ind

==============================================================================*/

void reg_state_process_non_acq_update_ind
(
...

{
  ...
  lte_cs_domain_param = reg_mode_lte_cs_domain_param_get();
  MSG_HIGH_DS_0(REG_SUB, "=REG= Received MMR_NON_ACQ_UPDATE_IND");
  if(lte_cs_domain_param.voice_domain_pref != voice_domain_pref)
  {
    lte_cs_domain_param.voice_domain_pref = voice_domain_pref;
    reg_mode_lte_cs_domain_param_set(lte_cs_domain_param);
  }
}
#endif
...
FUNCTION NAME
  ...
  reg_qsh_dump_data_get
 
DESCRIPTION 
 
   This function collects selected static data to be passed to QSH task
   during crash

==============================================================================*/
void reg_qsh_dump_data_get(
    reg_debug_data_s_type *dump_data_ptr, 
    reg_as_id_e_type as_id)REG_QSH_ATTR_UNCOMPRESS;
...
{    
    ...
    ASSERT(dump_data_ptr != NULL);
#if defined (FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)    
    dump_data_ptr->reg_state_camped_ind_received_debug = reg_state_camped_ind_received_sim[as_id];
    dump_data_ptr->reg_state_cm_initiated_registration_debug = reg_state_cm_initiated_registration_sim[as_id];
    dump_data_ptr->reg_state_cm_sim_update_ind_pending_debug = reg_state_cm_sim_update_ind_pending_sim[as_id];
    dump_data_ptr->reg_state_cm_transaction_id_debug = reg_state_cm_transaction_id_sim[as_id];
    dump_data_ptr->reg_state_irat_hplmn_timer_search_ongoing_debug = reg_state_irat_hplmn_timer_search_ongoing_sim[as_id];
    dump_data_ptr->reg_state_irat_lte_timer_search_ongoing_debug = reg_state_irat_lte_timer_search_ongoing_sim[as_id];
    dump_data_ptr->reg_state_is_roaming_plmn_to_be_camped_debug = reg_state_is_roaming_plmn_to_be_camped_sim[as_id];
    dump_data_ptr->reg_state_last_stop_mode_reason_debug = reg_state_last_stop_mode_reason_sim[as_id];
    dump_data_ptr->reg_state_plmn_search_transaction_id_debug = reg_state_plmn_search_transaction_id_sim[as_id];
    dump_data_ptr->reg_state_rlf_plmn_debug = reg_state_rlf_plmn_sim[as_id];
    dump_data_ptr->reg_state_rlf_rat_debug = reg_state_rlf_rat_sim[as_id];
    dump_data_ptr->reg_state_service_state_debug = reg_state_service_state_sim[as_id];
    dump_data_ptr->reg_state_user_resel_plmn_rat_debug = reg_state_user_resel_plmn_rat_sim[as_id];
    dump_data_ptr->reg_state_user_resel_plmn_debug = reg_state_user_resel_plmn_sim[as_id];

    dump_data_ptr->reg_sub_config_debug = reg_sub_config_sim[as_id];
    dump_data_ptr->reg_sub_id_debug = (reg_as_id_debug_e_type)reg_sub_id;
    dump_data_ptr->reg_sub_id_stack_debug = (reg_as_id_debug_e_type)reg_sub_id_stack[as_id];
    dump_data_ptr->reg_waiting_for_open_session_cnf_debug = reg_waiting_for_open_session_cnf_sim[as_id];
    dump_data_ptr->reg_sub_config_debug = reg_sub_config;
#else
    dump_data_ptr->reg_state_camped_ind_received_debug = reg_state_camped_ind_received;
    dump_data_ptr->reg_state_cm_initiated_registration_debug = reg_state_cm_initiated_registration;
    dump_data_ptr->reg_state_cm_sim_update_ind_pending_debug = reg_state_cm_sim_update_ind_pending;
    dump_data_ptr->reg_state_cm_transaction_id_debug = reg_state_cm_transaction_id;
    dump_data_ptr->reg_state_irat_hplmn_timer_search_ongoing_debug = reg_state_irat_hplmn_timer_search_ongoing;
    dump_data_ptr->reg_state_irat_lte_timer_search_ongoing_debug = reg_state_irat_lte_timer_search_ongoing;
    dump_data_ptr->reg_state_is_roaming_plmn_to_be_camped_debug = reg_state_is_roaming_plmn_to_be_camped;
    dump_data_ptr->reg_state_last_stop_mode_reason_debug = reg_state_last_stop_mode_reason;
    dump_data_ptr->reg_state_plmn_search_transaction_id_debug = reg_state_plmn_search_transaction_id;
    dump_data_ptr->reg_state_rlf_plmn_debug = reg_state_rlf_plmn;
    dump_data_ptr->reg_state_rlf_rat_debug = reg_state_rlf_rat;
    dump_data_ptr->reg_state_service_state_debug = reg_state_service_state;
    dump_data_ptr->reg_state_user_resel_plmn_rat_debug = reg_state_user_resel_plmn_rat;
    dump_data_ptr->reg_state_user_resel_plmn_debug = reg_state_user_resel_plmn;
    dump_data_ptr->reg_sub_id_debug = (reg_as_id_debug_e_type)reg_sub_id;    
    dump_data_ptr->reg_waiting_for_open_session_cnf_debug = reg_waiting_for_open_session_cnf;

#endif
    dump_data_ptr->reg_state_prev_plmn_debug = reg_state_prev_plmn;
    get_dump_reg_mode_vars (dump_data_ptr, as_id);
    get_dump_reg_mode_higher_priority_plmn_selection_vars(dump_data_ptr, as_id);
    get_dump_reg_mode_manual_plmn_selection_vars (dump_data_ptr, as_id);
    get_dump_reg_mode_limited_service_vars (dump_data_ptr, as_id);
    get_dump_reg_mode_plmn_selection_vars (dump_data_ptr, as_id);
    get_dump_reg_mode_automatic_plmn_selection_vars (dump_data_ptr, as_id);
    get_dump_reg_mode_sim_vars (dump_data_ptr, as_id);
    get_dump_reg_mode_send_vars (dump_data_ptr, as_id);   
}


void reg_qsh_dump_data_get_buffer(
    reg_qsh_dump_debug_buffer_s_type *dump_data_ptr) REG_QSH_ATTR_UNCOMPRESS;

void reg_qsh_dump_data_get_buffer(
    reg_qsh_dump_debug_buffer_s_type *dump_data_ptr)    
{    
    int index = 0;
    int i = 0;
   
    /* reg_debug_buffer_index points to the oldest sample */
    index = (int32)reg_debug_buffer_index;      
    for (i = 0;i < REG_DEBUG_DUMP_BUFFER_SIZE; ++i)
    {
        index = (int32) index - 1;
        if(index < 0)
        {
           index = REG_DEBUG_MESSAGE_BUFFER_SIZE - 1;
        }
#if defined (FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)    
        dump_data_ptr->debug_buffer[i].as_id = 
          reg_debug_buffer[index].as_id;
#endif

        dump_data_ptr->debug_buffer[i].reg_message_direction= 
          reg_debug_buffer[index].to_reg;

        dump_data_ptr->debug_buffer[i].reg_qsh_info_debug_buffer.message_id = 
          reg_debug_buffer[index].message_id;

        dump_data_ptr->debug_buffer[i].reg_qsh_info_debug_buffer.message_set=
          reg_debug_buffer[index].message_set;
    }
}

void reg_populate_qsh_dump_data
(
  reg_qsh_dump_data_s_type *dump_data_ptr, 
  reg_qsh_dump_tag_e tag
) REG_QSH_ATTR_UNCOMPRESS;
...
)
{
  ...
  qsh_client_dump_tag_hdr_init((qsh_dump_tag_hdr_s *)dump_data_ptr,(uint16)tag,
                                   (sizeof(reg_qsh_dump_data_s_type) - sizeof(qsh_dump_tag_hdr_s)));
 
  if (tag == REG_QSH_DUMP_TAG_AS_ID_2) 
  {
    as_id = REG_AS_ID_2;
  }
  
   reg_qsh_dump_data_get(&(dump_data_ptr->reg_debug_data),as_id);
}


void reg_populate_qsh_dump_data_buffer
(
  reg_qsh_dump_debug_buffer_s_type *dump_data_ptr,
  reg_qsh_dump_tag_e tag
) REG_QSH_ATTR_UNCOMPRESS;
...
{  
  qsh_client_dump_tag_hdr_init((qsh_dump_tag_hdr_s *)dump_data_ptr,(uint16)tag,
                                   (sizeof(reg_qsh_dump_debug_buffer_s_type) - 
                                    sizeof(qsh_dump_tag_hdr_s)));
     
  reg_qsh_dump_data_get_buffer(dump_data_ptr);
}

void reg_qsh_debug_callback(qsh_client_cb_params_s * params)
REG_QSH_ATTR_UNCOMPRESS;
...
{    
    ...
    ASSERT(params != NULL);   
    if ((params->action) != QSH_ACTION_DUMP_COLLECT)
    {
        return;
    }

    /* Calculate the space remaining in the caller's memory*/
    remaining_size = params->action_params.dump_collect.dump_iovec.size_bytes;

    dump_ptr = (byte *)(params->action_params.dump_collect.dump_iovec.addr);

    /* Extract the dump mask */    
    if (QSH_DUMP_TAG_ENABLED(params->action_params.dump_collect.dump_tag_mask,REG_QSH_DUMP_TAG_AS_ID_1))
    {
       if(remaining_size >= sizeof(reg_qsh_dump_data_s_type))
       {
         /* Populate the size of a block*/
         reg_populate_qsh_dump_data((reg_qsh_dump_data_s_type *)dump_ptr, REG_QSH_DUMP_TAG_AS_ID_1);
         dump_ptr = dump_ptr + (sizeof(reg_qsh_dump_data_s_type));
         remaining_size = remaining_size - sizeof(reg_qsh_dump_data_s_type);
         total_size_written += sizeof(reg_qsh_dump_data_s_type);
       }
    }
    
    if (QSH_DUMP_TAG_ENABLED(params->action_params.dump_collect.dump_tag_mask,REG_QSH_DUMP_TAG_AS_ID_2))
    {
        /* Populate the size of a block*/
      if(remaining_size >= sizeof(reg_qsh_dump_data_s_type))
      {
          reg_populate_qsh_dump_data((reg_qsh_dump_data_s_type *)dump_ptr, REG_QSH_DUMP_TAG_AS_ID_2);
          dump_ptr = dump_ptr + (sizeof(reg_qsh_dump_data_s_type));
          remaining_size = remaining_size - sizeof(reg_qsh_dump_data_s_type);
          total_size_written += sizeof(reg_qsh_dump_data_s_type);
      }
    }
    if(QSH_DUMP_TAG_ENABLED(params->action_params.dump_collect.dump_tag_mask,REG_QSH_DUMP_TAG_DEBUG_BUFFER))
    {
        /* Populate the size of a block*/
      if(remaining_size >= sizeof(reg_qsh_dump_debug_buffer_s_type))
      {
         reg_populate_qsh_dump_data_buffer((reg_qsh_dump_debug_buffer_s_type *)dump_ptr, 
                                           REG_QSH_DUMP_TAG_DEBUG_BUFFER);
         total_size_written += sizeof(reg_qsh_dump_debug_buffer_s_type);
      }
    }

    qsh_client_action_done_init(&client_action_done);
    client_action_done.cb_params_ptr = params; 
...
/*===========================================================================
FUNCTION NAME 
  reg_state_set_hplmn_timer_prev_plmn

DESCRIPTION
  Function to set the global variable holding the plmn id in which the hplmn
search timer is started.
  
RETURN VALUE
  void
===========================================================================*/
void reg_state_set_hplmn_timer_prev_plmn (sys_plmn_id_s_type plmn)
{
  reg_state_hplmn_timer_start_plmn = plmn;
}

/*===========================================================================
FUNCTION NAME 
  reg_timers_is_hplmn_timer_active

DESCRIPTION
  Function to get the plmn id in which the hplmn search timer is started.
  
RETURN VALUE
  sys_plmn_id_s_type - hplmn search timer started plmn id
===========================================================================*/
sys_plmn_id_s_type reg_state_get_hplmn_timer_prev_plmn (void)
{
  return reg_state_hplmn_timer_start_plmn;
}
