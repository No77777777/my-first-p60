...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_state.h#1 $
...
*/
#define REG_QSH_ATTR_UNCOMPRESS __attribute__((section(".uncompressible.text")))
#endif
...
typedef struct reg_state_manual_search_param_s
{
  /* manual srch priority relative to data call, etc */
  sys_srch_priority_e_type 					            srch_priority;

  /* incremental search results info */
  sys_incremental_results_s_type						incremental_results;

}reg_state_manual_search_param_s_type;

#ifdef FEATURE_CMCC_SECURE_CALL
#if FEATURE_TRIPLE_SIM 
extern sys_secure_call_e_type reg_state_secure_call_req_type_sim[MAX_NAS_STACKS];
#define reg_state_secure_call_req_type reg_state_secure_call_req_type_sim[reg_as_id]
#elif defined FEATURE_DUAL_SIM
extern sys_secure_call_e_type reg_state_secure_call_req_type_sim[MAX_NAS_STACKS];
#define reg_state_secure_call_req_type reg_state_secure_call_req_type_sim[reg_as_id]
#else
extern sys_secure_call_e_type reg_state_secure_call_req_type ;
#endif
#endif

#if defined(FEATURE_DUAL_SIM)
extern uint32 reg_subs_capability_mask_sim[MAX_AS_IDS];
#define reg_subs_capability_mask reg_subs_capability_mask_sim[reg_sub_id]
#endif


#ifdef FEATURE_SGLTE
extern boolean reg_state_sglte_merge_in_progress;
extern boolean reg_state_sglte_split_in_progress;
...
#if defined (FEATURE_DUAL_SIM ) || defined(FEATURE_SGLTE)
#define REG_SUB (reg_message_as_id)
#ifndef FEATURE_DUAL_SIM
#define REG_LOCAL_SUB (reg_message_as_id)
#else
#define REG_LOCAL_SUB (as_id+1)
#endif
#else
#define REG_SUB 0
...
#define REG_DEBUG_MESSAGE_BUFFER_SIZE      100
extern byte reg_msg_info;


typedef enum reg_debug_cm_sim_available_status_e
{
  REG_DEBUG_SIM_AVAILABLE_UNKNOWN,
  REG_DEBUG_SIM_AVAILABLE_STARTED,
  REG_DEBUG_SIM_AVAILABLE_PENDED_WAITING_FOR_MMGSDI_SESSION,
  REG_DEBUG_SIM_AVAILABLE_FAILED_MMGSDI_SESSION_OPEN_FAILED,      
  REG_DEBUG_SIM_AVAILABLE_PENDED_REQUESTED_MMGSDI_SESSION,
  REG_DEBUG_SIM_AVAILABLE_MMGSDI_SESSION_AVAILABLE,
  REG_DEBUG_SIM_AVAILABLE_LOAD_CARD_MODE_SUCCESS,   
  REG_DEBUG_SIM_AVAILABLE_FAILED_LOAD_CARD_MODE_FAILED
} reg_debug_cm_sim_available_status_e_type;
...
extern sys_srch_priority_e_type reg_state_get_manual_search_priority(void);

extern boolean reg_state_get_manual_search_increment_search_status(void);

extern sys_rat_pri_list_info_s_type reg_state_manual_rat_pri_list_info_get(void);

extern uint8 reg_state_get_manual_search_periodicty(void);
extern void reg_state_set_manual_search_param( sys_srch_priority_e_type srch_priority, 
	                                    sys_incremental_results_s_type	incremental_results);
#if defined(FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)
extern sys_overall_feature_t reg_sub_config_sim[MAX_AS_IDS];
#define reg_sub_config reg_sub_config_sim[reg_sub_id]

extern boolean cm_sim_available_req_pended_sim[MAX_AS_IDS];
#define cm_sim_available_req_pended cm_sim_available_req_pended_sim[reg_as_id]
...
#if defined(FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)
extern reg_debug_cm_sim_available_status_e_type reg_debug_cm_sim_available_status_sim[MAX_NAS_STACKS];
#define reg_debug_cm_sim_available_status reg_debug_cm_sim_available_status_sim[reg_as_id]
#else
extern reg_debug_cm_sim_available_status_e_type reg_debug_cm_sim_available_status;
#endif
...
typedef reg_state_p_type reg_state_cfl_hplmn_search_timer_expiration_f_type
(
  void
);
...
typedef reg_state_p_type reg_state_mmr_me_blocked_status_ind_f_type
(
...
#ifdef FEATURE_DUAL_SIM
  reg_state_mmr_me_blocked_status_ind_f_type*  process_mmr_me_blocked_status_ind; 
#endif
...
#ifdef FEATURE_LTE
  reg_state_cfl_hplmn_search_timer_expiration_f_type* process_cfl_search_timer_expiration;
#endif
...
#ifdef FEATURE_DUAL_SIM
extern reg_state_mmr_me_blocked_status_ind_f_type reg_state_process_mmr_me_blocked_status_ind; 
#endif
...
#ifdef FEATURE_DUAL_SIM
extern reg_state_mmr_me_blocked_status_ind_f_type  reg_state_unexpected_mmr_me_blocked_status_ind; 
#endif
...
extern reg_state_cfl_hplmn_search_timer_expiration_f_type reg_state_unexpected_cfl_hplmn_search_timer_expiration;
...
FUNCTION NAME
  ...
  get_dump_reg_mode_vars
 
DESCRIPTION 
 
   This function returns the static data collected from the reg module

==============================================================================*/
extern void get_dump_reg_mode_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id) REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_higher_priority_plmn_selection_vars
...
==============================================================================*/
extern void get_dump_reg_mode_higher_priority_plmn_selection_vars(reg_debug_data_s_type* ptr, reg_as_id_e_type as_id) REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_manual_plmn_selection_vars
...
==============================================================================*/
extern void get_dump_reg_mode_manual_plmn_selection_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id) REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_limited_service_vars
...
==============================================================================*/
extern void get_dump_reg_mode_limited_service_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id) REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_plmn_selection_vars
...
==============================================================================*/
extern void get_dump_reg_mode_plmn_selection_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id) REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_automatic_plmn_selection_vars
...
==============================================================================*/
extern void get_dump_reg_mode_automatic_plmn_selection_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id) REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_sim_vars
...
==============================================================================*/
extern void get_dump_reg_mode_sim_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id)
REG_QSH_ATTR_UNCOMPRESS;
/*==============================================================================

FUNCTION NAME

  get_dump_reg_mode_send_vars
...
==============================================================================*/
extern void get_dump_reg_mode_send_vars (reg_debug_data_s_type* ptr, reg_as_id_e_type as_id)
REG_QSH_ATTR_UNCOMPRESS;
...
DESCRIPTION
  ...
  Function that processes Pending cm_sim_available_req for other subs
...
==============================================================================*/
extern void reg_state_process_pended_cm_sim_available_req
(
  void
);
...
DESCRIPTION
  ...
  Function that checks if SIM swap handling is in progress for any SUB
...
==============================================================================*/
extern boolean reg_state_is_sim_swap_in_progress
(
  void
);
#endif
...
extern uint8 reg_state_mmr_trans_id_set
(
  void
);
...
extern sys_stop_mode_reason_e_type reg_state_last_stop_mode_reason_get
(
  void
);
/*==============================================================================
...
DESCRIPTION
  ...
  Function that returns the current service status per sub of the MS.

RETURN VALUE

  sys_srv_status_e_type       The current service status of the MS per sub.

==============================================================================*/

extern sys_srv_status_e_type reg_state_service_status_get_per_subs
(
  sys_modem_as_id_e_type as_id
);
/*==============================================================================
...
extern sys_lac_type reg_state_prev_tac_get
(
  void
);
...
extern word reg_state_service_tac_get
(
  void
);
...
extern reg_state_e_type reg_state_current_state_get(void);
...
FUNCTION NAME
  ...
  reg_state_process_cm_secure_call_req

==============================================================================*/

extern void reg_state_process_cm_secure_call_req(sys_secure_call_e_type secure_type_req);
#endif
...
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
extern void reg_state_set_gstk_event_flag_per_subs(boolean flag, sys_modem_as_id_e_type as_id);
#endif
...
#endif
boolean reg_state_get_mcs_pri();
sys_radio_access_tech_e_type reg_state_get_mcs_low_priority_rat();
sys_radio_access_tech_e_type reg_state_get_mcs_high_priority_rat();
...
==============================================================================*/
extern boolean reg_state_get_power_up_system_selection_per_subs
(
  sys_modem_as_id_e_type as_id
);
#endif
...
==============================================================================*/
extern void reg_state_reset_plmn_search_transaction_id
(
  void
);
...
extern boolean reg_state_cm_sim_update_ind_pending_get 
(
  void
);
...
extern void reg_state_cm_sim_update_ind_pending_set 
(
  boolean value
);
...
extern boolean reg_state_camped_ind_received_get
(
 void
);

#ifdef FEATURE_DUAL_SIM
extern reg_state_p_type reg_state_process_mmr_me_blocked_status_ind
(
  boolean is_me_blocked
);
#endif
...
FUNCTION NAME
 ...
 reg_state_get_cfl_hplmn_timer_search_ongoing

==============================================================================*/
extern boolean reg_state_get_cfl_hplmn_timer_search_ongoing (void);
...
FUNCTION NAME
 ...
 reg_state_set_cfl_hplmn_timer_search_ongoing

==============================================================================*/
extern void reg_state_set_cfl_hplmn_timer_search_ongoing(boolean value);


extern void reg_state_process_non_acq_update_ind
(
...
RETURN VALUE
  void
===========================================================================*/
extern void reg_state_set_hplmn_timer_prev_plmn (sys_plmn_id_s_type plmn);
...
===========================================================================*/
extern sys_plmn_id_s_type reg_state_get_hplmn_timer_prev_plmn (void);
