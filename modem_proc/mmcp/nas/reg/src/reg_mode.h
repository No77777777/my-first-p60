...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_mode.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum reg_mode_automatic_mode_e
{
  ...
  REG_MODE_AUTOMATIC_MODE_IRAT_TO_LTE,
...
typedef enum reg_mode_lte_scan_e
{
  REG_MODE_LTE_SCAN_NONE = -1,                   /* FOR INTERNAL USE ONLY! */
  REG_MODE_LTE_SCAN_TDD,
  REG_MODE_LTE_SCAN_FDD,
  REG_MODE_LTE_SCAN_MAX                          /* FOR INTERNAL USE ONLY! */
} reg_mode_lte_scan_e_type;
#endif
...
typedef boolean reg_mode_start_preferred_plmn_search_f_type
(
  sys_network_selection_mode_e_type    network_selection_mode,	
  sys_mode_pref_e_type				   mode_pref,				
  sys_srv_domain_e_type 			   req_service_domain
...
typedef struct reg_mode_s
{
  ...
  reg_mode_start_preferred_plmn_search_f_type*                 start_preferred_plmn_search;
#if defined(FEATURE_LTE) || defined(FEATURE_WRLF_SYSTEM_SEL)
...
FUNCTION NAME
  ...
  reg_eplmn_list_equivalent_plmn
...
extern boolean reg_eplmn_list_equivalent_plmn(sys_plmn_id_s_type plmn);
...
DESCRIPTION
  ...
  Function that returns the network selection mode per sub maintained within reg_mode.

RETURN VALUE

  sys_network_selection_mode_e_type Network selection mode per sub maintained within
                                    reg_mode.

==============================================================================*/

extern sys_network_selection_mode_e_type reg_mode_network_selection_mode_get_per_subs
(
...
DESCRIPTION
  ...
  Function that copy the net sel mode maintained within reg_mode from given src stack to target stack
...
extern void reg_mode_copy_network_selection_mode
(
...
extern void reg_mode_set_emergency_call
(
  uint32 additional_info
);  

extern boolean reg_mode_get_emergency_call 
(
  void
);
#endif
...
extern boolean reg_mode_start_preferred_plmn_search
(
  void
);
...
FUNCTION NAME
  ...
  reg_mode_keep_ehplmn_to_available_plmn_list

DESCRIPTION

  Function that keeps the contents of the available EHPLMN list to the available
  PLMN list based on EHPLMN priority order.

RETURN VALUE

  boolean flag indicating if the available PLMN list is updated or not.

==============================================================================*/

#if defined(FEATURE_EQUIVALENT_HPLMN)
extern boolean reg_mode_keep_ehplmn_to_available_plmn_list(); 
#endif
...
extern boolean reg_mode_hplmn_available
(
...
FUNCTION NAME
  ...
  reg_mode_is_camped_plmn_is_higher_priority_ehplmn

DESCRIPTION

  Function that determines if current camped PLMN is highest priority EHPLMN.

RETURN VALUE

  boolean flag indicating whether current camped PLMN is highest priority EHPLMN.


==============================================================================*/

#if defined(FEATURE_EQUIVALENT_HPLMN)
extern boolean reg_mode_is_camped_plmn_is_higher_priority_ehplmn(sys_plmn_id_s_type plmn_id);
extern boolean reg_mode_is_avail_plmn_list_contains_higher_priority_ehplmn(const sys_detailed_plmn_list_s_type* available_plmn_list_p);
extern boolean reg_mode_is_rlf_plmn_is_higher_priority_ehplmn(void);
...
extern reg_mode_start_preferred_plmn_search_f_type            reg_mode_unexpected_start_preferred_plmn_search;
#if defined(FEATURE_LTE) || defined(FEATURE_WRLF_SYSTEM_SEL)
...
extern void reg_mode_remove_plmn_from_available_background_list
(
  sys_plmn_id_s_type                   plmn,
  sys_radio_access_tech_e_type         rat
); 
...
DESCRIPTION
  ...
  Function to convert access tech to acq mode.
...
extern void reg_mode_filter_background_plmn_list
(
   void
);
...
extern void reg_mode_filter_bsr_plmn
(
  sys_detailed_plmn_list_s_type *plmn_list
);
...
#define MAX_TEMP_LIST 20

typedef struct reg_mode_temp_ehplmn_forbidden_s
{
	sys_plmn_id_s_type plmn[MAX_TEMP_LIST];
    byte length;
}reg_mode_temp_ehplmn_forbidden_s_type;


typedef struct reg_mode_temp_ehplmn_gprs_forbidden_s
{
	sys_plmn_id_s_type plmn[MAX_TEMP_LIST];
    byte length;
}reg_mode_temp_ehplmn_gprs_forbidden_s_type;
/*==============================================================================
FUNCTION NAME
...
DESCRIPTION 
  This function returns the value to indicate the pass of GW reselection
  during CSFB fallback.

DEPENDENCIES
  none

RETURN VALUE
  TRUE if the first pass of the CSFB reselection is executed

SIDE EFFECTS
  none

==============================================================================*/
extern boolean reg_mode_fallback_control_get 
(
    void
);
/*==============================================================================
FUNCTION NAME
  ...
  reg_mode_fallback_control_set

DESCRIPTION 
  This function sets the pass of GW reselection
  during CSFB fallback.
...
void reg_mode_update_lte_scan_bands
(
   sys_rat_pri_list_info_s_type  *rat_list, 
   reg_mode_lte_scan_e_type lte_band_type
);
...
#endif
extern void reg_mode_add_ehplmn_temp_forbidden
(
	sys_plmn_id_s_type		plmn
#ifdef FEATURE_DUAL_SIM
		   ,sys_modem_as_id_e_type	as_id
...
extern boolean reg_mode_is_ehplmn_forbidden
(
	sys_plmn_id_s_type		plmn
#ifdef FEATURE_DUAL_SIM
	   ,sys_modem_as_id_e_type	as_id
...
extern void reg_mode_clear_ehplmn_forbidden
(
#ifdef FEATURE_DUAL_SIM
		   sys_modem_as_id_e_type	as_id
#endif
...
extern void reg_mode_add_ehplmn_temp_gprs_forbidden
(
	sys_plmn_id_s_type		plmn
#ifdef FEATURE_DUAL_SIM
	   ,sys_modem_as_id_e_type	as_id
...
extern boolean reg_mode_is_ehplmn_gprs_forbidden
(
	sys_plmn_id_s_type		plmn
#ifdef FEATURE_DUAL_SIM
	   ,sys_modem_as_id_e_type	as_id
...
extern void reg_mode_clear_ehplmn_gprs_forbidden
(
#ifdef FEATURE_DUAL_SIM
		   sys_modem_as_id_e_type	as_id
#endif
...
extern void reg_mode_remove_ehplmn_temp_forbidden
(
	sys_plmn_id_s_type		plmn
#ifdef FEATURE_DUAL_SIM
		   ,sys_modem_as_id_e_type	as_id
...
extern void reg_mode_remove_ehplmn_temp_gprs_forbidden
(
	sys_plmn_id_s_type		plmn
#ifdef FEATURE_DUAL_SIM
		   ,sys_modem_as_id_e_type	as_id
...
extern boolean reg_mode_hplmn_timer_restart(const sys_detailed_plmn_list_s_type*       found_list);
...
extern void reg_mode_filter_available_plmn_list_with_rat_bst
(
  sys_rat_pri_list_info_s_type *rat_pri_list_info
);
extern boolean reg_mode_get_higher_priority_plmn_selection_started(sys_modem_as_id_e_type as_id);
extern void reg_mode_set_higher_priority_plmn_selection_started(boolean status);

extern void reg_mode_prioritize_mcs_rat_order
(
...
extern sys_radio_access_tech_e_type reg_mode_get_last_rplmn_rat();

extern void reg_mode_prioritize_rat_pri_list
(
  reg_mode_3gpp_capability_s_type *rplmn_rat_order,
  sys_radio_access_tech_e_type hp_rat,
  byte pos
...
extern void reg_mode_deprioritize_rat_pri_list
(
  reg_mode_3gpp_capability_s_type *rplmn_rat_order,
  sys_radio_access_tech_e_type hp_rat
);
...
==============================================================================*/
extern uint32 reg_mode_set_ra_cap_update
(
  uint32 additional_info
);
#endif
...
sys_plmn_id_s_type reg_mode_priotitize_hplmn_over_rplmn
(
  sys_plmn_id_s_type rplmn
);
...
==============================================================================*/
extern boolean reg_mode_skip_eplmn_list
(
