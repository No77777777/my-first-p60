...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_timers.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define REG_INTERLACE_SCAN_TIMER_DEFUALT_VALUE (rex_timer_cnt_type)10
...
extern void reg_timers_start_hplmn_cfl_search_period_timer
(
  void
);
...
==============================================================================*/
extern void reg_timers_stop_hplmn_cfl_search_period_timer
(
  void
);
...
extern void reg_timers_start_hplmn_cfl_search_period_timer_10sec
(
  void
);
...
===========================================================================*/
boolean reg_timers_is_hplmn_timer_active();
