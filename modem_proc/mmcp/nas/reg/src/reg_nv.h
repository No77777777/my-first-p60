...
typedef enum reg_debug_sim_swap_status_e
{
  REG_DEBUG_SIM_SWAP_UNDEFINED,
  REG_DEBUG_SIM_CARD_MODE_NOT_DEFINED,
  REG_DEBUG_SIM_IMSI_READ_FAILED,
  REG_DEBUG_SIM_IMSI_ILLEGAL,
  REG_DEBUG_NV_IMSI_READ_FAILED,
  REG_DEBUG_SIM_CHANGED_NOT_SWAPPED_NV_READ_FAILED,
  REG_DEBUG_SIM_CHANGED_NOT_SWAPPED_SUB_AVAILABLE,
  REG_DEBUG_SIM_CHANGED_NOT_SWAPPED_NO_MATCH,
  REG_DEBUG_SIM_CHANGED,
  REG_DEBUG_SIM_CHANGED_SWAP_DONE_AT_REG_AND_MM,
  REG_DEBUG_SIM_CHANGED_SWAP_DONE_AT_REG
} reg_debug_sim_swap_status_e_type;

#ifdef FEATURE_NAS_ENABLE_LTE_BAND_FILTERING
typedef enum reg_td_op_device_type_e
{
   REG_TD_OP_DEVICE_TYPE_NONE,
   REG_TD_OP_DEVICE_TYPE_1,
   REG_TD_OP_DEVICE_TYPE_2,
   REG_TD_OP_DEVICE_TYPE_MAX
} reg_td_op_device_type_e_type;
#endif

#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_SGLTE)                    
extern reg_debug_sim_swap_status_e_type reg_debug_sim_swap_status_sim[MAX_NAS_STACKS];
#define reg_debug_sim_swap_status reg_debug_sim_swap_status_sim[reg_as_id]
#else
extern reg_debug_sim_swap_status_e_type reg_debug_sim_swap_status;
#endif
...
#endif
extern boolean                                reg_nv_is_home_plmn_to_be_selcted_in_home_country;
...
typedef struct reg_nv_items
{
  ...
  byte is_home_plmn_to_be_selcted_in_home_country;  /*version 7*/
  byte reserved[18];
}reg_nv_items_T;
...
DESCRIPTION
  ...
  This function populates the current VPLMN list into given buffer
...
DESCRIPTION
  ...
  This function saves given VPLMN list into current VPLMN list
...
extern boolean reg_nv_home_plmn_to_be_selcted_in_home_country_get(void);
...
DESCRIPTION
  ...
  Function that writes the IMSI into NVRAM.  This is a blocking call
  that returns only after writing the data into NVRAM.

RETURN VALUE

  boolean  Flag indicating if IMSI was written successfully (TRUE) or
           not (FALSE).

==============================================================================*/

extern boolean reg_nv_write_imsi
(
  reg_nv_imsi_s_type* imsi_p
);
...
FUNCTION reg_handle_sim_swap

DESCRIPTION
  This function handles SIM soft swap scenario. Swaps NVs and corresponding caches of current SUB with the respective
  data of given SUB.
...
===========================================================================*/
extern void reg_handle_sim_swap
(
  reg_as_id_e_type reg_as_id_target
);
#endif
...
extern void reg_nv_set_csg_support (sys_csg_support_e_type value,reg_as_id_e_type id);
...
extern boolean reg_nv_check_cfl_search_enabled(void);
...
{
   uint32    cfl_fast_scan_time;
   uint32    max_fast_scan_time;
   uint16    scan_time_intv;
} lte_cfl_search_timer_config_T;
...
extern uint8     reg_cfl_hplmn_search_counter_sim[MAX_AS_IDS];
#define reg_cfl_hplmn_search_counter  reg_cfl_hplmn_search_counter_sim[reg_sub_id]

extern lte_cfl_search_timer_config_T     reg_nv_cfl_search_config_sim[MAX_AS_IDS];
...
extern uint8                             reg_cfl_hplmn_search_counter;
extern lte_cfl_search_timer_config_T     reg_nv_cfl_search_config;
...
FUNCTION NAME
  ...
  reg_nv_allow_hplmn_timer_restart_value_get
...
==============================================================================*/
extern boolean  reg_nv_write_domestic_voice_roaming
(
...
SIDE EFFECTS
  None
===========================================================================*/
extern reg_sim_plmn_w_act_s_type  * reg_nv_get_preferred_plmn_list(uint32 *preferred_plmn_length);
...
DESCRIPTION 
  ...
  from NV.
==============================================================================*/
extern uint8 reg_nv_td_op_device_type_get(void);
#endif
...
==============================================================================*/
extern uint32 reg_nv_hplmn_cfl_search_timer_get(void);
