...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_send.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
(
  ...
  ,const sys_arfcn_list_s_type   *arfcn_list
  ,const sys_preferred_plmn_list_s_type  *preferred_plmn_list
...
#ifdef FEATURE_DUAL_SIM
extern void reg_send_mmr_t3245_expiry_ind 
(
  void
);
#endif
...
#ifdef FEATURE_DUAL_SIM
extern void reg_send_cm_me_blocked_status_ind
(
...
(
  uint32  *subs_capability_mask_ptr
);
...
(
 sys_modem_as_id_e_type target_dds_sub, boolean always_on_data
);
...
void reg_send_mmr_sim_busy_ind(boolean sim_busy, sys_modem_as_id_e_type as_id);
#endif
...
/*============================================================================== 
FUNCTION NAME:  reg_send_mmr_secure_call_ind

DESCRIPTION
  This REG function sends MMR_SECURE_CALL_IND to MM.

RETURN VALUE
  none
==============================================================================*/
void reg_send_mmr_secure_call_ind
(
   sys_secure_call_e_type reg_secure_call_type
);
#endif
...
/*==============================================================================
 FUNCTION NAME
   ...
   reg_send_mmr_refresh_stage_ind

 DESCRIPTION
   Function to send MMR_REFRESH_STAGE_IND to MM

 RETURN VALUE

   None
 ==============================================================================*/
extern void reg_send_mmr_refresh_stage_ind
(
  mmgsdi_refresh_stage_enum_type  stage
);

extern void reg_send_cb_dds_info_ind(boolean dds_info);
extern void reg_send_cb_service_ind(sys_srv_status_e_type service_status,boolean reg_inactive,sys_radio_access_tech_e_type rat);
#ifdef FEATURE_DUAL_SIM
extern void reg_send_cb_3gpp2_stack_status_ind(  boolean  is_stack_active,sys_sys_mode_e_type active_mode);
#endif
...
extern void reg_send_mmr_high_priority_activity_ind
(
