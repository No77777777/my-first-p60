...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/reg/src/reg_state_inactive.c#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#ifdef FEATURE_LTE
  reg_state_unexpected_cfl_hplmn_search_timer_expiration,
#endif
  number,
  output_name
};
