...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cb/src/cb_state.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern cb_active_substate_id_type cb_active_substate_get_per_sub(cb_as_id_e_type as_id);
#endif
extern cb_active_substate_id_type cb_active_substate_get(void);
