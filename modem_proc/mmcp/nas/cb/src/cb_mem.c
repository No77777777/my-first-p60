...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cb/src/cb_mem.c#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/19/15   kvk     Renamed cb_free and cb_alloc to cb_mem_free and cb_mem_alloc 
...
#ifdef FEATURE_MODEM_HEAP
extern cb_alloc_descriptor_type *cb_find_alloc
(
...
)
{
  ...
  {
    MSG_ERROR_DS_0(CB_SUB,"CB: No memory descriptor left") ;
  }
...
)
{
  ...
  {
    MSG_FATAL_DS( CB_SUB,"CB: Access violation",0,0,0) ;
  }
...
)
{
  *mem_pool_size = actual_mem_pool_alloc_size ;
  ...
  {
    MSG_ERROR_DS_0(CB_SUB,"CB init: Can not allocate mem descriptor") ;
...
)
{
  ...
  */
...
#endif
  {
   ...
   cb_message_as_id = (byte)(cb_as_id + 1);
#endif
  MSG_HIGH_DS_1(CB_SUB,"CB: Memory pools have been allocated successfully (%d bytes)",total_memory_pool_size) ;
...
)
{
  if (allocated_list_ptr == NULL)
  {
    ...
    **/
    MSG_FATAL_DS( CB_SUB,"CB: Allocated block descriptor list does not exist",0,0,0) ;
  }
  else
  {
...
)
{
  ...
  if (required_length <= *current_pool_size)
  {
    ...
    {
      MSG_ERROR_DS_0(CB_SUB,"CB: Memory pool is fragmented") ;
    }
  }
...
)
{
  ...
  {
    MSG_ERROR_DS_0(CB_SUB,"CB: Alloc block descriptor list does not exist") ;
  }
...
)
{
  ...
  switch(merge_rule)
  {
    ...
    case CB_MERGE_INTO_LIST:
      ...
      break ;
    default:
      MSG_FATAL_DS( CB_SUB,"CB: Unknown merge type",0,0,0) ;
  }
...
)
{
      ...
      ((byte *)memory_block_ptr < (cb_first_tx_schedule_pool+FIRST_TX_SCHEDULE_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_first_tx_schedule_ctrl_pool",0,0,0);
    }
#endif
           ...
           ((byte *)memory_block_ptr < (cb_retx_schedule_pool+RETX_SCHEDULE_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_retx_schedule_ctrl_pool",0,0,0);
    }
#endif
           ...
           ((byte *)memory_block_ptr < (cb_new_msg_pool+NEW_MSG_BIT_MAP_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_new_msg_ctrl_pool",0,0,0);
    }
#endif
      ...
      ((byte *)memory_block_ptr < (cb_user_page_info_pool+USER_PAGE_INFO_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_user_page_info_ctrl_pool",0,0,0);
    }
#endif
           ...
           ((byte *)memory_block_ptr < (cb_message_list_pool+MESSAGE_LIST_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_message_list_ctrl_pool",0,0,0);
    }
#endif
           ...
           ((byte *)memory_block_ptr < (cb_missing_page_pool+MISSING_PAGE_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_missing_page_ctrl_pool",0,0,0);
    }
#endif
           ...
           ((byte *)memory_block_ptr < (cb_skip_sequence_pool+SKIP_SEQUENCE_POOL_SIZE)))
  {
    ...
    {
      MSG_FATAL_DS( CB_SUB,"CB: Access violation in cb_skip_sequence_ctrl_pool",0,0,0);
    }
#endif
  ...
  else
  {
    ...
    MSG_FATAL_DS( CB_SUB,"CB: Access violation %X",(uint32)memory_block_ptr,0,0) ;
  }
  ...
  else
  {
    ...
    MSG_FATAL_DS( CB_SUB,"CB: Memory access violation %X",(uint32)memory_block_ptr,0,0) ;
  }
...
)
{
  ...
  switch (mem_alloc_id)
  {
    ...
    case CB_FIRST_TX_SCHEDULE_ALLOC_ID:
      ...
      if(cb_first_tx_schedule_pool == NULL)
      {
        if (( (cb_first_tx_schedule_pool = (byte *) modem_mem_calloc(1,FIRST_TX_SCHEDULE_POOL_SIZE,MODEM_MEM_CLIENT_NAS) ) != NULL) )
        {
          ...
          {
            MSG_HIGH_DS_2(CB_SUB, "memory allocated for cb_first_tx_schedule_pool with location %x, cb_first_tx_schedule_ctrl_pool with location %x",
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"FIRST TX SCHEDULE pool size is initialized here as %x", cb_current_first_tx_schedule_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_first_tx_schedule_ctrl_pool %x", (int) cb_first_tx_schedule_ctrl_pool,0,0 );
          }
        }
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_first_tx_schedule_pool", 0,0,0 );
        }
      }
#endif
      current_pool_size = &cb_current_first_tx_schedule_pool_size;
    ...
    case CB_RETX_SCHEDULE_ALLOC_ID:
      ...
      if(cb_retx_schedule_pool == NULL)
      {
        if(( (cb_retx_schedule_pool = (byte *) modem_mem_calloc(1,RETX_SCHEDULE_POOL_SIZE,MODEM_MEM_CLIENT_NAS) ) != NULL) )
        {
          ...
          {
            MSG_HIGH_DS_2(CB_SUB, "memory allocated for cb_retx_schedule_pool with location %x, cb_retx_schedule_ctrl_pool with location %x",
                                     cb_first_tx_schedule_pool,cb_first_tx_schedule_ctrl_pool);
            if (cb_mem_pool_init(cb_retx_schedule_pool,
                                 RETX_SCHEDULE_POOL_SIZE,
                                 &cb_retx_schedule_pool_size,
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"RETX SCHEDULE pool size is initialized here as %x",cb_retx_schedule_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_retx_schedule_ctrl_pool %x", (int) cb_retx_schedule_ctrl_pool,0,0 );
          }
        }
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_retx_schedule_pool", 0,0,0 );
        }
      }
#endif
      current_pool_size = &cb_retx_schedule_pool_size;
    ...
    case CB_NEW_MSG_ALLOC_ID:
      ...
      if(cb_new_msg_pool == NULL)
      {
        if(( (cb_new_msg_pool = (byte *) modem_mem_calloc(1,NEW_MSG_BIT_MAP_POOL_SIZE,MODEM_MEM_CLIENT_NAS) ) != NULL) )
        {
          ...
          {
            MSG_HIGH_DS_2(CB_SUB, "memory allocated for cb_new_msg_pool with location %x,cb_new_msg_ctrl_pool with location %x",
                                            cb_first_tx_schedule_pool,cb_first_tx_schedule_ctrl_pool);
            if (cb_mem_pool_init(cb_new_msg_pool,
                                 NEW_MSG_BIT_MAP_POOL_SIZE,
                                 &cb_current_new_msg_pool_size,
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"NEW MESSAGE pool size is initialized here as %x",cb_current_new_msg_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_new_msg_ctrl_pool %x", (int) cb_new_msg_ctrl_pool,0,0 );
          }
        } 
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_new_msg_pool", 0,0,0 );
        }
      }
#endif
      current_pool_size = &cb_current_new_msg_pool_size;
    ...
    case CB_RETX_SCHEDULE_ALLOC_ID:
      ...
      MSG_ERROR_DS_0(CB_SUB,"CB: DRX mode is not supported") ;
    ...
    case CB_USER_PAGE_INFO_ALLOC_ID:
      ...
      if (cb_user_page_info_pool == NULL )
      {
        if(( (cb_user_page_info_pool = (byte *) modem_mem_calloc(1,USER_PAGE_INFO_POOL_SIZE,MODEM_MEM_CLIENT_NAS) ) != NULL) )
        {
          ...
          {
            MSG_HIGH_DS_2(CB_SUB, "Memory allocated for cb_user_page_info_pool with location %x, cb_user_page_info_ctrl_pool and location is %x",
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"USER PAGE INFO pool size is initialized here as %x",cb_user_page_info_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_user_page_info_ctrl_pool %x", (int) cb_user_page_info_ctrl_pool,0,0 );
          }
        }
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_user_page_info_pool", 0,0,0 );
        }
      }
#endif
      current_pool_size = &cb_user_page_info_pool_size ;
    ...
    case CB_MESSAGE_LIST_ALLOC_ID:
      ...
      if( cb_message_list_pool == NULL )
      {
        ...
        {
          MSG_HIGH_DS_2(CB_SUB, "memory allocated for cb_message_list_pool with location %x, cb_message_list_ctrl_pool and location is %x",
          ...
          if( ( cb_message_list_ctrl_pool == NULL ) && ((( cb_message_list_ctrl_pool = (cb_alloc_descriptor_type *) modem_mem_calloc(1,sizeof(cb_alloc_descriptor_type) *MESSAGE_LIST_NUMBER_OF_RECORDS,MODEM_MEM_CLIENT_NAS) ) != NULL) ))
          {
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"MESSAGE LIST pool size is initialized here as %x",cb_message_list_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_message_list_ctrl_pool %x", (int) cb_message_list_ctrl_pool,0,0 );
          }
        }
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_message_list_pool", 0,0,0 );
        }
      }
#endif
      current_pool_size = &cb_message_list_pool_size ;
    ...
    case CB_MISSING_PAGE_ALLOC_ID:
      ...
      if (cb_missing_page_pool == NULL)
      {
        if((( cb_missing_page_pool = (byte *) modem_mem_calloc(1,MISSING_PAGE_POOL_SIZE,MODEM_MEM_CLIENT_NAS) ) != NULL))
        {
          ...
          {
            MSG_HIGH_DS_2(CB_SUB, "memory allocated for cb_missing_page_pool with location %x, cb_missing_page_ctrl_pool and location is %x",
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"MISSING PAGE pool size is initialized here as %x",cb_missing_page_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_missing_page_ctrl_pool %x", (int) cb_missing_page_ctrl_pool,0,0 );
          }
        }
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_missing_page_pool %x", (int)cb_missing_page_pool,0,0 );
        }
      }
#endif
      current_pool_size = &cb_missing_page_pool_size ;
    ...
    case CB_SKIP_SEQUENCE_ALLOC_ID:
      ...
      if (cb_skip_sequence_pool == NULL )
      {
        if((( cb_skip_sequence_pool = (byte *) modem_mem_calloc(1,SKIP_SEQUENCE_POOL_SIZE,MODEM_MEM_CLIENT_NAS) ) != NULL) )
        {
          ...
          {
            MSG_HIGH_DS_2(CB_SUB, "Memory allocated for cb_skip_squence_pool with location %x, cb_skip_sequence_ctrl_pool and location is %x", 
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"SKIP SEQUENCE pool size is initialized here as %x",cb_skip_sequence_pool_size);
            }
          }
          else
          {
            MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_skip_sequence_ctrl_pool %x", (int) cb_skip_sequence_ctrl_pool,0,0 );
          }
        }
        else
        {
          MSG_FATAL_DS( CB_SUB, "ERROR: Unable to allocate memory for cb_skip_sequence_pool", 0,0,0 );
        }
      }
#endif
      current_pool_size = &cb_skip_sequence_pool_size ;
    ...
    default:
      MSG_FATAL_DS( CB_SUB,"CB: Illigal mem_alloc_id = %d",(int)mem_alloc_id,0,0) ;
  }
  ...
  {
    MSG_ERROR_DS_3(CB_SUB,"CB: Not enough memory (%d of %d) to allocate %d",
  ...
  else if(!cb_find_alloc(allocated_buffer,current_alloc_ptr))
  {
    MSG_FATAL_DS( CB_SUB,"CB: Buffer not allocated = %d",(int)allocated_buffer,0,0) ;
  }
...
void cb_free_dynamic_pool_NDRX(void )
{
  if(cb_user_page_info_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_user_page_info_pool and location is %x",cb_user_page_info_pool);
  }
  if(cb_user_page_info_ctrl_pool != NULL)
  {
    modem_mem_free((cb_alloc_descriptor_type*) cb_user_page_info_ctrl_pool,MODEM_MEM_CLIENT_NAS);
    cb_user_page_info_ctrl_pool = NULL;
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_user_page_info_ctrl_pool and location is %x",cb_user_page_info_ctrl_pool);
  }
  if(cb_message_list_pool != NULL)
  {
    modem_mem_free((byte*) cb_message_list_pool,MODEM_MEM_CLIENT_NAS);
    cb_message_list_pool = NULL;
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_message_list_pool and location is %x",cb_message_list_pool);
  }
  if(cb_message_list_ctrl_pool != NULL)
  {
    modem_mem_free((cb_alloc_descriptor_type*) cb_message_list_ctrl_pool,MODEM_MEM_CLIENT_NAS);
    cb_message_list_ctrl_pool = NULL;
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_message_list_ctrl_pool and location is %x",cb_message_list_ctrl_pool);
  }
  if(cb_missing_page_pool != NULL)
  {
    modem_mem_free((byte*) cb_missing_page_pool,MODEM_MEM_CLIENT_NAS);
    cb_missing_page_pool = NULL;
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_missing_page_pool and location is %x",cb_missing_page_pool);
  }
  if(cb_missing_page_ctrl_pool != NULL)
  {
    modem_mem_free((cb_alloc_descriptor_type*) cb_missing_page_ctrl_pool,MODEM_MEM_CLIENT_NAS);
    cb_missing_page_ctrl_pool = NULL;
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_missing_page_ctrl_pool and location is %x",cb_missing_page_ctrl_pool);
  }
}
...
void cb_free_skip_pool_if_needed(void)
{
  ...
  if(cb_skip_sequence_alloc == NULL)
  {
    if(cb_skip_sequence_pool != NULL)
    {
      ...
      MSG_HIGH_DS_1(CB_SUB, "Freeing cb_skip_sequence_pool and location is %x",cb_skip_sequence_pool); 
    }
    if(cb_skip_sequence_ctrl_pool != NULL)
    {
      modem_mem_free((cb_alloc_descriptor_type*) cb_skip_sequence_ctrl_pool,MODEM_MEM_CLIENT_NAS);
      cb_skip_sequence_ctrl_pool = NULL;
      MSG_HIGH_DS_1(CB_SUB, "Freeing cb_skip_sequence_ctrl_pool and location is %x",cb_skip_sequence_ctrl_pool);
    }
  }
}
...
void cb_free_dynamic_pool_DRX(void )
{
  if(cb_first_tx_schedule_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_first_tx_schedule_pool and location is %x",cb_first_tx_schedule_pool);
  }
  ...
  if(cb_first_tx_schedule_ctrl_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_first_tx_schedule_ctrl_pool and location is %x",cb_first_tx_schedule_ctrl_pool);
  }
  ...
  if(cb_retx_schedule_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_retx_schedule_pool and location is %x",cb_retx_schedule_pool);
  }
  ...
  if(cb_retx_schedule_ctrl_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_retx_schedule_ctrl_pool and location is %x",cb_retx_schedule_ctrl_pool);
  }
  ...
  if(cb_new_msg_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_new_msg_pool and location is %x",cb_new_msg_pool);
  }
  ...
  if(cb_new_msg_ctrl_pool != NULL)
  {
    ...
    MSG_HIGH_DS_1(CB_SUB, "Freeing cb_new_msg_ctrl_pool and location is %x",cb_new_msg_ctrl_pool);
  }

}
#endif

cb_alloc_descriptor_type *cb_find_alloc
(
  void *memory_block_ptr,
  cb_alloc_descriptor_type **entry_allocated_block_ptr
)
