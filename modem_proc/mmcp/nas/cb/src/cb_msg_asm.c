...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cb/src/cb_msg_asm.c#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
05/19/15  vm       Offtarget fix
...
void cb_send_data_event_packet(cb_message_list_type *msg_ptr)
{
  ...
  */
  ...
  (void) nas_event_report_payload(EVENT_NAS_CB_PAGE_RECEIVED, 5, (void *)event_packet,
                                      cb_message_as_id);
...
)
{
  ...
  *data_coding_scheme = paging_block[CB_DATA_CODING_SCHEME] ;
  ...
  MSG_HIGH_DS_7(CB_SUB,"CB: Received Message ID %02X, GS %02X, Message Code %02X, Update Number %02X, %d of %d pages, data coding scheme %X ",
                      *message_id,*gs,*message_code,*update_number,*page_number,*number_of_pages,*data_coding_scheme) ;
...
)
{
  ...
  switch (sequence_number)
  {
    ...
    break ;
#else
    MSG_ERROR_DS_0(CB_SUB,"CB: Scheduling message is not supported") ;
    ...
    case CB_FOURTH_PAGING_BLOCK :
      ...
      break ;
    default:
      MSG_FATAL_DS( CB_SUB,"Illigal sequence number (%d)",sequence_number,0,0) ;
  }
...
)
{
  ...
  MSG_HIGH_DS_0(CB_SUB,"CB: Received new message page") ;
...
)
{
  ...
  **Update number should be same  */
  MSG_HIGH_DS_2(CB_SUB,"Update number_mask=%d New Update number=%d",update_number_mask, new_update_number);
  return (((update_number_mask) & (1<<(UPDATE_NUM_MASK - new_update_number))) != 0? TRUE : FALSE) ;
}
...
)
{
  ...
  {
    MSG_HIGH_DS_0(CB_SUB,"CB:Duplication detection disabled, dont discard the page") ;
    return FALSE;
  }

  if(is_update_number_not_changed (current_page_info->update_number_mask,
                                  new_update_number))
  {
    if (current_page_info->gs_indicator == new_gs)
    {
      ...
      {
        MSG_FATAL_DS( CB_SUB,"CB: Illigal actie RAT",0,0,0) ;
      }
#endif
    }
    else
    {
      MSG_HIGH_DS_0(CB_SUB,"GS indicator has been changed") ;
    }
  }
...
)
{
  ...
  */
  switch (CB_CALCULATE_PAGING_SLOT(received_fn))
  {
    ...
    default:
      MSG_ERROR_DS_0(CB_SUB,"First paging block sqn. is out of sequence") ;
      return NULL ;
  }
  ...
  if (page_type == CB_SCHEDULING_PAGE)
  {
    ...
    {
      MSG_ERROR_DS_0(CB_SUB,"CB DRX: Schedule message is corrupted") ;
      return NULL ;
    }
    ...
    {
      MSG_ERROR_DS_0(CB_SUB,"CB DRX: Discarding Unscheduled schedule message in DRX mode") ;
      return NULL ;
    }
    ...
    {
      MSG_ERROR_DS_0(CB_SUB,"CB DRX: Schedule Message is overlapping with current sch period -> discarding");
      return NULL ;
    }
                                        ...
                                        current_message,0xFFFF)) == NULL) 
    {
      ...
      {
        MSG_ERROR_DS_0(CB_SUB,"CB: Not enough memory") ;
        return NULL ;
      }
  ...
  MSG_HIGH_DS_4(CB_SUB,"CB: Received first paging block with message id = %d message code = %d number_pagers = %d, present_in_search list = %d",
                                      ...
                                      current_message_ptr,message_id)) == NULL) 
  {
	...
	{
	  MSG_HIGH_DS_0(CB_SUB,"CB: WMS filters out current CB page") ;

      return NULL ;
	}
    MSG_HIGH_DS_1(CB_SUB,"CB: Mesage ID %d not found. Creating cache", message_id);
    ...
    /* MSG_HIGH_DS_0(CB_SUB,"CB: Received Base FN is %d",received_fn) ; */
  ...
  else
  {
    ...
    if (cb_find_message_code_with_gs(new_message_ptr,message_code) == NULL)
    {
      ...
      */
      ...
      {
        MSG_ERROR_DS_0(CB_SUB,"CB: Not enough memory") ;
        new_message_ptr->message_header.current_message_descriptor = new_message_ptr->message_header.message_info;
        return NULL ;
      }
    ...
    else
    {
      ...
      {
        MSG_HIGH_DS_2(CB_SUB,"CB: Duplication is detected, Msg. ID %02X, Code %02X",
      ...
      else
      {
        ...
        /* Refresh base FN */
        current_message_ptr->message_header.fn = received_fn ;
		cb_check_if_dup = (current_page_info->update_number_mask) & (1<<(UPDATE_NUM_MASK - update_number));
            ...
            (cb_check_if_dup == 0))
        {
          ...
          current_page_info->update_number_mask = (current_page_info->update_number_mask) | (1<<(UPDATE_NUM_MASK - update_number));
  ...
  switch (page_type)
  {
    ...
    break ;
    default:
      MSG_FATAL_DS( CB_SUB,"Invalid page type",0,0,0) ;
  }
  /*lint -e774*/
  ...
  {
    MSG_FATAL_DS( CB_SUB,"Unrecoverable error",0,0,0) ;
  }
  /*lint +e774*/
  ...
  MSG_HIGH_DS_0(CB_SUB,"CB: Finished processing first paging block") ;
...
)
{
  ...
  {
    MSG_ERROR_DS_0(CB_SUB,"CB: Invalid LPD") ;
  ...
  {
    MSG_HIGH_DS_0(CB_SUB,"CB: Null block -> can skip the rest of blocks") ;
  ...
  {
    MSG_HIGH_DS_1(CB_SUB,"CB: Received block is out of sequence (%d)",sequence_number) ;
...
)
{
  ...
  switch (message_type)
  {
    case CB_NORMAL_PAGE :
      {
        ...
        else
        {
          ...
          {
            cb_start_timer( CB_TIMER_DUP_DET, 
                            cb_dup_timer_value,
#if defined (FEATURE_NAS_CBS_DSDS) && defined (FEATURE_TWO_3GPP_SIM)
                            cb_as_id
#else
...
#ifdef FEATURE_GSM_CB_DRX_SUPPORTED
    {
      ...
      break;
    default:
      MSG_FATAL_DS( CB_SUB,"Illegal message type id",0,0,0) ;
  }
  ...
  switch (page_assembling_state)
  {
    case CB_RECEIVING_FIRST_PB_STATE :
      {
        ...
        switch (sequence_number)
        {
          ...
          default:
            ...
            {
              MSG_ERROR_DS_1(CB_SUB,"CB: Received block num. %d when expected first",
                                                       sequence_number+1) ;
    ...
    case CB_RECEIVING_SECOND_PB_STATE :
      if (sequence_number != CB_SECOND_PAGING_BLOCK)
      {
        if (!cb_skiped_fn(received_fn))
        {
          MSG_ERROR_DS_1(CB_SUB,"CB: Received block num. %d when expected second",
                                                       sequence_number+1) ;
    ...
    case CB_RECEIVING_THIRD_PB_STATE :
      if (sequence_number != CB_THIRD_PAGING_BLOCK)
      {
        if (!cb_skiped_fn(received_fn))
        {
          MSG_ERROR_DS_1(CB_SUB,"CB: Received block num. %d when expected third",sequence_number+1) ;
    ...
    case CB_RECEIVING_FOURTH_PB_STATE :
      if (sequence_number != CB_FOURTH_PAGING_BLOCK)
      {
        if (!cb_skiped_fn(received_fn))
        {
          MSG_ERROR_DS_1(CB_SUB,"CB: Received block num. %d when expected fourth",sequence_number+1) ;
      ...
      break ;
    default:
      MSG_FATAL_DS( CB_SUB,"Illigal message assembling state ID",0,0,0) ;
  }
  ...
  if (current_message != NULL)
  {
     ...
     else
     {
                     ...
                     cb_calculate_base_fn(received_fn,sequence_number))
       {
         ...
         MSG_ERROR_DS_2(CB_SUB,"CB: Received message starting at FN %d when expected %d",
    ...
    if (current_message->message_header.current_message_descriptor->current_page == NULL)        
    {
      ...
      MSG_ERROR_DS_0(CB_SUB,"CB: current page ptr is NULL,\
    ...
    {
      MSG_FATAL_DS( CB_SUB,"Invalid current Message",0,0,0);
    }
  }
...
)
{
  switch (CB_CALCULATE_PAGING_SLOT(missing_fn))
  {
    ...
    case CB_FIFTH_BLOCK:
      ...
      MSG_HIGH_DS_0(CB_SUB,"CB: First paging block is missing, Next state is CB_RECEIVING_FIRST_PB_STATE") ;
    ...
    case CB_SIXTH_BLOCK:
      ...
      {
        if(((cb_skip_block & (1 << CB_THIRD_BLOCK)) == FALSE) &&
           ((cb_skip_block & (1 << CB_SEVENTH_BLOCK)) == FALSE))
        {
          MSG_HIGH_DS_0(CB_SUB,"CB: Next state is CB_RECEIVING_THIRD_PB_STATE") ;

          page_assembling_state = CB_RECEIVING_THIRD_PB_STATE ;
        }
        else if(((cb_skip_block & (1 << CB_FOURTH_BLOCK)) == FALSE) &&
                ((cb_skip_block & (1 << CB_EIGHTH_BLOCK)) == FALSE))
        {
          MSG_HIGH_DS_0(CB_SUB,"CB: Next state is CB_RECEIVING_FOURTH_PB_STATE") ;

          page_assembling_state = CB_RECEIVING_FOURTH_PB_STATE ;
        }
        else
        {
          MSG_HIGH_DS_0(CB_SUB,"CB: Next state is CB_RECEIVING_FIRST_PB_STATE") ;
    ...
    case CB_SEVENTH_BLOCK:
      ...
      {
        if(((cb_skip_block & (1 << CB_FOURTH_BLOCK)) == FALSE) &&
           ((cb_skip_block & (1 << CB_EIGHTH_BLOCK)) == FALSE))
        {
          MSG_HIGH_DS_0(CB_SUB,"CB: Next state is CB_RECEIVING_FOURTH_PB_STATE") ;
    ...
    case CB_EIGHTH_BLOCK:
      ...
      break ;
    default:
      MSG_ERROR_DS_1(CB_SUB,"CB: Out of sequence missing block indication (%d)",missing_fn) ;
      break ;
  }
  ...
  */
...
#endif
  {
    MSG_ERROR_DS_0(CB_SUB,"CB: Not enough memory to allocate sec_page_data_buffer") ;
    return ;
  }
#endif
                                   ...
                                   msg_sfn_allocation,received_sfn)) != 0xFFFF)
  {
       ...
       ((*current_message_ptr)->message_header.message_id <= CB_BMC_ETWS_FUTURE_EXTENSION_03))
    {
      ...
      MSG_HIGH_DS_1(CB_SUB,"CB ETWS: Received ETWS Seconadry Notification with message id %d",(*current_message_ptr)->message_header.message_id);
      for(page_index = 0;
      ...
      if(CB_BMC_MULTISIM_ENABLE&&
	      cb_active_substate_get() != CB_ACTIVE_DRX && cb_current_wcdma_priority != CRITICAL_PRIORITY)
      {
        cb_current_wcdma_priority = CRITICAL_PRIORITY;
        cb_stop_timer(CB_WCDMA_PRIORITY_THRESHOLD_TIMER,cb_as_id);
        cb_start_timer(CB_WCDMA_PRIORITY_THRESHOLD_TIMER,CB_WCDMA_PRIORITY_THRESHOLD_TIMEOUT_VALUE_2*1000,cb_as_id);
                                                                  ...
                                                                  page_index++)
    {
      ...
      if (new_incoming_page != NULL)
      {
       ...
       (*current_message_ptr)->message_header.
        ...
        MSG_HIGH_DS_4(CB_SUB,"BMC: Processing %d from %d offset into %d, Total length %d",
        ...
        if (page_properties & CB_BMC_PAGE_LENGTH_IND_MASK)
        {
          ...
          MSG_HIGH_DS_1(CB_SUB,"BMC: Received page length is equal to %d",
                                        new_incoming_page->page_length) ;
        }
        ...
        if ((received_paging_bloks & paging_bloks_mask) == paging_bloks_mask)
        {
          ...
          */
          cb_bmc_forge_page_header(new_incoming_page->page_buffer,
                                    ...
                                    current_number_of_pages) ;
#ifdef FEATURE_NAS_REL6
          MSG_HIGH_DS_2(CB_SUB,"SN is %x %x ",(new_incoming_page->page_buffer[0]),(new_incoming_page->page_buffer[1]));
...
#ifdef FEATURE_UMTS_BMC_MSIM
          if(CB_BMC_MULTISIM_ENABLE&&
		     cb_active_substate_get() != CB_ACTIVE_DRX && cb_current_wcdma_priority != CRITICAL_PRIORITY && cb_check_if_emergency_message(current_message_id))
          {
            cb_current_wcdma_priority = CRITICAL_PRIORITY;
            cb_stop_timer(CB_WCDMA_PRIORITY_THRESHOLD_TIMER,cb_as_id);
            cb_start_timer(CB_WCDMA_PRIORITY_THRESHOLD_TIMER,CB_WCDMA_PRIORITY_THRESHOLD_TIMEOUT_VALUE_2*1000,cb_as_id);
  ...
  {
    MSG_HIGH_DS_1(CB_SUB,"CB: Received PDU has not been expected (SFN %d)",
                                                            received_sfn) ;
  }
  ...
  *msg_type = rlc_pdu_ptr[CB_BMC_MESSAGE_TYPE_OFFSET] ;
  ...
  if (*msg_type == CBS_SCHEDULE_TYPE)
  {
    ...
    *scheduling_period_length = 
    ...
    MSG_HIGH_DS_1(CB_SUB,"CB: Received Scheduling message with Scheduling Period length = %d",
                                               *scheduling_period_length) ;
  }
  else if (*msg_type == CBS_MESSAGE_TYPE)
  {
    ...
    *number_of_pages = rlc_pdu_ptr[CB_BMC_NUMBER_OF_PAGES_OFFSET] ;
    ...
    MSG_HIGH_DS_6(CB_SUB,"CB: Received Message ID %02X, GS %02X, Message Code %02X, Update Number %02X, data coding scheme %X, Number of pages %d",
  ...
  */
  ...
  switch (msg_type)
  {
    case CBS_MESSAGE_TYPE  :
      {
        ...
        */
        ...
        {
          MSG_HIGH_DS_1(CB_SUB,"BMC: Message too long (%d pages), truncated to 15 pages",
                              number_of_pages) ;
        ...
        {
          MSG_HIGH_DS_1(CB_SUB,"Truncating RLC PDU - PDU length %d is greater than MAX supported data message length",*pdu_length);
          *pdu_length = CB_BMC_MAX_DATA_MESSAGE_LENGTH;
        }

        if ( *pdu_length != (incoming_message_length_draft - li_length) ) 
        {
          MSG_HIGH_DS_2(CB_SUB,"BMC: Message length (%d) not equal to expected length (%d)",
    ...
    case CBS_SCHEDULE_TYPE :
      ...
      {
        MSG_HIGH_DS_1(CB_SUB,"Truncating RLC PDU - PDU length %d is greater than MAX supported scheduling message length",*pdu_length);
        *pdu_length = CB_BMC_MAX_SCHEDULING_LENGTH;
      }

      if ( *pdu_length > (incoming_message_length_draft - li_length) ) 
      {
        MSG_HIGH_DS_2(CB_SUB,"BMC: Message length (%d) more than the expected length hence truncating to expected length(%d)",
                                                       *pdu_length, incoming_message_length_draft - li_length) ;
        *pdu_length = incoming_message_length_draft - li_length;
      }
      ...
      */
      ...
      break ;
    default:
      MSG_ERROR_DS_0(CB_SUB,"Unsupported message type") ;
...
)
{
      ...
      */
      switch ((cb_bmc_description_field_type)(*rlc_pdu_ptr))
      {
        ...
        default:
          ...
          MSG_ERROR_DS_0(CB_SUB,"CB: Illigal message description field id") ;
  ...
  if(pdu_length!=0)
  {
    ...
    MSG_HIGH_DS_0(CB_SUB,"Future extension Bitmap is included");
...
)
{
  ...
  MSG_HIGH_DS_0(CB_SUB,"BMC: Skipping entire message") ;
...
)
{
  ...
  if (skip_index > 0)
  {
    MSG_HIGH_DS_0(CB_SUB,"BMC: Skipping SFN list") ;
...
)
{
  ...
  *serial_number = ((rrc_etws_prim_notification_ind->sr_num[0] << 8) | 
  ...
  MSG_HIGH_DS_2(CB_SUB,"CB ETWS: Received CB Message ID %02X, Serial number ID %02X",*message_id,*serial_number) ;
}
...
{
  if(is_update_number_not_changed (existing_message_code->update_number_mask,
                                  new_update_number))
  {
    MSG_HIGH_DS_2(CB_SUB,"CB ETWS: GS indicator: old = %d, new = %d",existing_message_code->gs_indicator,new_gs);
...
static boolean is_etws_message_id_requested( word message_id)
{
  ...
  **Search list
  */
  MSG_HIGH_DS_1(CB_SUB,"CB ETWS: Received Eartquake ETWS ID = %d",message_id);
  switch (message_id) 
  {
...
)
{
    ...
    *message_code = (word)message_code_high | 
    ...
    /* Extract Update Number */
    *update_number = (byte)(serial_number & CB_BMC_UPDATE_NUMBER_MASK) ;
    MSG_HIGH_DS_3(CB_SUB,"CB ETWS: Received CB GS %02X, Message Code %02X, Update Number %02X",
...
)
{
  ...
  {
    MSG_HIGH_DS_0(CB_SUB,"CB ETWS:Subscription W+G is enabled SO PrimaryNotification Should  discarded");
    return;
  }
#endif
#endif
  ...
  */
  ...
  MSG_HIGH_DS_2(CB_SUB,"CB ETWS: Received message id %d , present in search list = %d" ,message_id,message_id_requested);
  ...
  else
  {
    ...
    */
    ...
    if((new_message_ptr = cb_find_etws_message( basic_etws_list_entry_point,
                          message_id)) == NULL)
    {
      MSG_HIGH_DS_0(CB_SUB,"CB ETWS: Received New message id - create new message entry" );
      /* 
      ...
      */
      ...
      {
        MSG_ERROR_DS_0(CB_SUB,"CB ETWS: Not enough memory") ;
        return ;
      }
      /* 
    ...
    else
    {
      ...
      */
      ...
      {
        MSG_HIGH_DS_1(CB_SUB,"CB ETWS: serial_number %d not found",serial_number) ;
        /* 
      ...
      else
      {
                                                  ...
                                                  gs, update_number))
         {
           ...
           MSG_HIGH_DS_2(CB_SUB,"CB ETWS: Duplicate ETWS Primary Ind with message id %d and serial number %d", message_id, serial_number);
           return;
         }
         else //The update no has been changed or the GS value has been changed so please update the field 
         {
           ...
           current_etws_message_code->update_number_mask = (current_etws_message_code->update_number_mask) | (1<<(UPDATE_NUM_MASK - update_number));
...
)
{
  ...
  */
...
#endif  //FEATURE_BMC_RLC_MULTIPLE_PDU_SUPPORT
  {
...
#endif  //FEATURE_BMC_RLC_MULTIPLE_PDU_SUPPORT
    {
           ...
           ((rlc_pdu_ptr[CB_BMC_MESSAGE_TYPE_OFFSET] != CBS_SCHEDULE_TYPE) || (pdu_length >= CB_BMC_SCHEDULING_MSG_HEADER_LENGTH+1+1)))
      {
...
#ifndef FEATURE_BMC_RLC_MULTIPLE_PDU_SUPPORT
        MSG_HIGH_DS_2(CB_SUB,"BMC: Received PDU by RLC (SFN %d), first_pdu_indicator = %d",received_sfn,first_pdu_indicator) ;
#endif
        ...
        if (status == FALSE)
        {
          MSG_ERROR_DS_0(CB_SUB,"Invalid Fields in CB message header");
          return;
        }
        ...
        */
        ...
        {
          MSG_HIGH_DS_2(CB_SUB,"BMC: Received a new message (%d,%d)",message_id,message_code) ;
        }

        for (i=0; i<cb_bmc_msg_sfn_allocation_length; i++)
        {
          MSG_HIGH_DS_1(CB_SUB,"BMC: Expected SFN %d",cb_bmc_msg_sfn_allocation[i].sfn) ;
        }

#ifndef FEATURE_BMC_RLC_MULTIPLE_PDU_SUPPORT
        MSG_HIGH_DS_1(CB_SUB,"BMC: Next Expected message SFN %d",cb_bmc_next_expected_message_sfn) ;
#endif
        ...
        switch (message_type)
        {
          case CBS_MESSAGE_TYPE: /* Regular Cell Broadcast message */
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"Message %02X is not in the search list",message_id); 
#ifndef FEATURE_BMC_RLC_MULTIPLE_PDU_SUPPORT
            ...
            */
            ...
            {
              MSG_HIGH_DS_1(CB_SUB,"Message ID %d not found",message_id) ;
            ...
            else
            {
              ...
              */
              if (cb_find_message_code_with_gs(new_message_ptr,message_code) == NULL)
              {
                ...
                MSG_HIGH_DS_1(CB_SUB,"Message code %d not found",message_code) ;
...
#ifdef FEATURE_UMTS_BMC_DRX_SUPPORTED
           cb_schedule_index = (cb_schedule_index+1)%2;
           memscpy(cb_scheduling_message[cb_schedule_index],CB_BMC_MAX_RLC_DATA_LENGTH,rlc_pdu_ptr,pdu_length);
...
#else
            MSG_HIGH_DS_0(CB_SUB,"CB: Scheduling is not supported") ;
          ...
          default:
            MSG_HIGH_DS_1(CB_SUB,"Message type %02X is not supported",message_type) ;
      ...
      {
        MSG_HIGH_DS_0(CB_SUB,"CB: Message too short, PDU discarded") ;
    ...
    {
      MSG_HIGH_DS_0(CB_SUB,"CB: Unrecognizable PDU format, PDU discarded") ;
  ...
  else
  {
                             ...
                             cb_bmc_msg_sfn_allocation,received_sfn) != 0xFFFF)
    {
      switch (message_type)
      {
        ...
        */
        ...
        {
            MSG_HIGH_DS_0(CB_SUB,"BMC: Reset SFN table") ;
            cb_bmc_msg_sfn_allocation_length = 0; 
        }
    ...
    {
      MSG_HIGH_DS_1(CB_SUB,"BMC: Received unexpected RLC PDU (%d)",received_sfn) ;
    }
  }
#endif //FEATURE_BMC_RLC_MULTIPLE_PDU_SUPPORT
#ifdef FEATURE_UMTS_BMC_DRX_SUPPORTED
...
)
{
  ...
  {
     MSG_ERROR_DS_0(CB_SUB,"NULL RLC params");
  }
  return FALSE;
#endif
}
