...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cb/src/cbmsg.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern byte cb_skip_block_sim[MAX_AS_IDS];
...
#define CB_BMC_MULTISIM_ENABLE  (cb_multisim_standby==TRUE)
