...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/cb/src/cb_task.c#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
static ULogHandle cb_ulog_handle = NULL;

/*===========================================================================
...
void cb_send_cmd(cb_command_type *cmd_ptr)
{
   ...
   else
   {
      ...
      MSG_FATAL_DS( CB_SUB,"Trying to put a null pointer on the CB queue", 0,0,0);
   }
}
...
cb_command_body_type *cb_get_cmd(byte message_set, byte message_id)
{
  ...
  switch (message_set)
  {
    case MS_WMS_CB:
      switch (message_id)
      {
        ...
        case CB_DUAL_STANDBY_STATUS_IND:
          ...
          break ;
        default:
          MSG_ERROR_DS_1(CB_SUB,"Unknown message ID (%d)",message_id) ;
          break ;
      }
      break ;
    case MS_CB_RR:
    ...
    case MS_CB_L1:
      break ;
    default :
      MSG_ERROR_DS_1(CB_SUB,"Unknown message set (%d)",message_set) ;
      break ;
  }
...
void cb_put_cmd(cb_command_body_type *cmd_ptr)
{
  ...
  {
    MSG_ERROR_DS_0(CB_SUB,"Unable to send message to CB task");
  }
} /* end cb_put_cmd() */
...
void cb_handle_message( cb_command_type* message )
{
  ...
  {
     MSG_ERROR_DS_0(CB_SUB,"NO CB message!");
  }
}
...
/*===========================================================================
FUNCTION cb_get_ulog_handle

DESCRIPTION
Returns ULOG Handle for CB task
...
SIDE EFFECTS
  None
===========================================================================*/
ULogHandle cb_get_ulog_handle(void)
{
  return cb_ulog_handle;
}

/*===========================================================================
FUNCTION cb_ulog_register

DESCRIPTION
This function call registers CB Task with ULOG
...
SIDE EFFECTS
  None
===========================================================================*/
void cb_ulog_register(void)
{
  ULogResult result = ULogFront_RealTimeInit(&cb_ulog_handle,
                               "NAS_CB_ULOG",  
                               512, 
                               ULOG_MEMORY_LOCAL,
                               ULOG_LOCK_OS);
  MSG_HIGH_DS_1(CB_SUB,"CB: ULOG REGISTER RESULT: %d", result);
}
...
/*lint -esym(715,dummy) */
{
  ...
  {
      MSG_ERROR_DS_0(CB_SUB,"CB: Failed to initialize input queue!");
  }
  ...
  if (               gs_init(GS_QUEUE_RLC_CB,
         ...
         (gs_get_handler_ptr)cb_handle_message) != GS_SUCCESS)
  {
      MSG_ERROR_DS_0(CB_SUB,"CB: Failed to initialize RLC input queue!");
  }
#endif
   ...
   {
      MSG_HIGH_DS_0(CB_SUB,"Not enough memory for CB task");
   }
#endif
