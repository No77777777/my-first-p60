...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/mmact.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
void mm_activate_state( boolean rat_change )
{
  if (!rat_change)
  {
     mm_check_and_perform_action_invalid_state_detection((sys_modem_as_id_e_type)mm_as_id, DEBUG_INVALID_STATE_POWER_UP);
