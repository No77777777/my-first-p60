...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/mm_sim.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
===========================================================================*/
#ifdef FEATURE_LTE
extern void mm_post_non_acq_param_change_ind(non_acq_param_change_info_s_type param_info);
#endif
...
extern boolean mm_check_sim_swap_event
(
...
extern void mm_write_nv_after_sim_swap
(
  void
);

extern void mm_write_nv_psloci
(
  void
);

extern void mm_swap_nv_imsi
(
