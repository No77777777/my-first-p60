...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/msg_lib_declarations.h#1 $
$Author: pwbldsvc $
...
#define ADJUST_OFFSET_AND_BUF_LEN_ESM(num_bits_read,offset_ptr,buffer_len_ptr,esm_len_ptr)\
            {*offset_ptr = *offset_ptr + num_bits_read;\
             *buffer_len_ptr = *buffer_len_ptr - num_bits_read;\
...
SIDE EFFECTS
===========================================================================*/
extern void msg_lib_skip_unknown_iei
(
  byte    iei,
  byte    *src,
  word    *pos,
