...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/emm_connection_handler.h#1 $
...
extern emm_reg_container_type emm_reg_container_sim[MAX_AS_IDS];
#define emm_reg_container emm_reg_container_sim[mm_as_id]
#else
extern emm_reg_container_type emm_reg_container;
#endif
