...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/gmmllcm.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern boolean gmmllcm_is_start_non_drx_ind_sent(void); 
