...
DESCRIPTION
  This function re-evaluate  priorty process and send update to LRRC if required 
...
FUNCTION NAME
  ...
  emm_clear_shared_emc_supported_plmn_list
...
/*===========================================================================
FUNCTION    emm_volte_only_set

DESCRIPTION
  This function sets volte only flag
...
SIDE EFFECTS
  None
===========================================================================*/
void emm_volte_only_set(sys_srv_domain_e_type srv_domain);
#endif 
...
#ifdef FEATURE_DUAL_SIM
extern void emm_send_illegal_event_for_current_sub
(
  void
);

extern void emm_send_illegal_event_for_other_sub
(
  void
);

extern void emm_set_non_illegal_cause
(
  void
);

extern void emm_set_illegal_non_illegal_cause
(
  byte cause
);
...
/*===========================================================================
 ...
 SIDE EFFECTS
   None
 ===========================================================================*/
boolean emm_check_if_pdn_conn_req_for_emergency_bearer_services
(
   req_type_T req
);
...
extern void emm_process_lte_paging_cycle
(
...
===========================================================================*/
extern void emm_send_ra_cap_update_fail_ind(void);
