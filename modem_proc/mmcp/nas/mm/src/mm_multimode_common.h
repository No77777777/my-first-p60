...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/mm_multimode_common.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
/*===========================================================
  Note -mm_csfb_state_type - update debug enum "mm_csfb_state_debug_type "
...
extern void emm_paused_mm_timer (timer_id_T  timer_id);
extern void emm_resume_paused_timer(timer_id_T  timer_id);
...
void emm_set_radio_cap_update_state(emm_radio_cap_update_enum_T  radio_cap_update);
emm_radio_cap_update_enum_T emm_get_radio_cap_update_state(void);
...
extern void mm_csfb_rej_pending_call(mm_cmd_type  *cmd_ptr);
...
extern void emm_set_gmm_drx_coff_client_rat(sys_radio_access_tech_e_type drx_rat);
...
extern sys_radio_access_tech_e_type emm_get_gmm_drx_coff_client_rat(void);
...
extern uint8 mm_reg_req_trans_id_get(void);
extern void mm_reg_req_trans_id_set(uint8 trans_id);
extern void mm_reg_req_trans_id_reset(void);
...
FUNCTION NAME:
  ...
  This API sets the transaction ID of the on-going MMR_STOP_MODE_REQ processing in LTE
...
FUNCTION  mm_emm_get_secure_call_status

DESCRIPTION: 
 
This function returns  the secure call status
...
extern sys_secure_call_e_type mm_emm_get_secure_call_status
(
  void
);
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean mm_is_ms_id_changed
(
...
SIDE EFFECTS
  None
===========================================================================*/
boolean mm_emm_wlan_call_in_progress
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
...
This function checks if SMS is on-going
...
SIDE EFFECTS
  None
===========================================================================*/
boolean mm_emm_ims_sms_in_progress
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
...
===========================================================================*/
extern boolean mm_emm_csfb_domain_change_in_progress
(
  mm_cmd_type  *cmd_ptr
);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void mm_emm_radio_cap_enquiry_failure(void);
