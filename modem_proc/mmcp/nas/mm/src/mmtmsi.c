...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/mmtmsi.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
void mm_perform_tmsi_reallocation(mm_cmd_type* msg_p)
{
   ...
   mm_qsh_ota_metric_signaling_log(TMSI_REALLOCATION_COMMAND,CN_TO_UE_DIRECTION,
     (uint8) (tmsi_reallocation_command_msg->mobile_identity_data[1] & (byte)(0x07)), MM_GMM_NO_FAILURE_DEBUG);
#endif
