...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/emm_update_lib.h#1 $
...
extern boolean emm_ignore_attach_accept
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);

extern boolean emm_ignore_esm_information_request
(
  emm_ctrl_data_type *emm_ctrl_data_ptr,
...
extern void emm_start_detach_on_pti_mismatch
(
  emm_ctrl_data_type    *emm_ctrl_data_ptr,
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_process_tau_accept_in_emm_registered_state
(
  lte_nas_emm_tau_accept_type *emm_tau_accept_ptr,
  emm_ctrl_data_type          *emm_ctrl_data_ptr
);
...
DESCRIPTION
  This function is to process notification of MO CS or VoLTE call end on
  non-DDS sub and send TAU if pended.
...
DESCRIPTION
  This function sends start/fail QEVENTs based on the scenario for NAS OTA msg
...
extern void emm_send_nas_ota_qevent
(
...
extern void emm_timer_drx_prohibit_expire
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
...
===========================================================================*/
extern void emm_timer_radio_cap_enquiry_expiry
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
