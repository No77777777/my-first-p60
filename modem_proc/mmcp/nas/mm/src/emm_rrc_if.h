...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/emm_rrc_if.h#1 $
...
FUNCTION    emm_send_dds_sub_info_ind
...
(
  lte_rrc_force_esr_status_type_e ignore_irat_status,
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
#endif
...
FUNCTION    EMM_RRC_ELS_CONN_ABORT_REQ
