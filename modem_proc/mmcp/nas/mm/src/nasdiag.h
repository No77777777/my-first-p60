...
/*==================================================================  
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/nasdiag.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $  
...
enum {
    ...
    NAS_DIAG_T3212_F,
    NAS_DIAG_T3312_F,
    NAS_DIAG_EMM_STATE_INFO_F,
    NAS_DIAG_DED_BC_STATE_F,
    NAS_MAX_CMD_F
};
/************************************************************************** 
    PACKET DEFINITIONS
...
/* NAS EMM state Diag Request Packet
 */

DIAGPKT_SUBSYS_REQ_DEFINE(NAS, NAS_DIAG_EMM_STATE_INFO_F)
  /* SUB ID*/
  sys_modem_as_id_e_type    as_id;
DIAGPKT_REQ_END
 ...
 /* The response packet is defined below.
 */
DIAGPKT_SUBSYS_RSP_DEFINE(NAS, NAS_DIAG_EMM_STATE_INFO_F)
  /* EMM States */
  boolean  emm_state_diag;
DIAGPKT_RSP_END


/* NAS dedicated bearer States Diag Request Packet
 */
DIAGPKT_SUBSYS_REQ_DEFINE(NAS, NAS_DIAG_DED_BC_STATE_F)
  /* SUB ID*/
  sys_modem_as_id_e_type    as_id;
DIAGPKT_REQ_END
 ...
 /* The response packet is defined below.
 */
DIAGPKT_SUBSYS_RSP_DEFINE(NAS, NAS_DIAG_DED_BC_STATE_F)
  /* dedicated bearer States */
  boolean  ded_bc_exists;/*0 Not exist 1 Exist*/
DIAGPKT_RSP_END
