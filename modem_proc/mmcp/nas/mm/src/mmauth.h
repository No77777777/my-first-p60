...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/mmauth.h#2 $ $DateTime: 2023/10/08 15:22:21 $ $Author: pwbldsvc $
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean auth_is_cs_ckik_derived_from_gsmkc(void);
