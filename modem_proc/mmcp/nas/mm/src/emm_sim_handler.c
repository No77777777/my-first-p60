...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/emm_sim_handler.c#1 $
...
( 
  ...
  boolean emm_is_swap_in_progress
)
{
  ...
  if(emm_is_swap_in_progress == FALSE &&  emm_ctrl_data_ptr->emm_tai_list_ptr == NULL)
  {
...
)
{
  ...
  if(emm_ctrl_data_ptr->emc_srv_status == LTE_NAS_EMC_SRV_ONLY)
  {
    MSG_HIGH_DS_0(MM_SUB, "=EMM= EMC attached. Do not invalidate mobility info");
    return;
  }
