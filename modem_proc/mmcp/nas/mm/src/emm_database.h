...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/emm_database.h#1 $
...
extern boolean is_nas_emm_attach_tau_timeout_sim[MAX_AS_IDS];
...
typedef enum
{
  EMM_BARRING_NO_MASK = 0,
  EMM_BARRING_MASK_SUB1 = EMM_BARRING_MAX ,
  EMM_BARRING_MASK_SUB2 = EMM_BARRING_MAX *2,
}emm_subs_barring_mask;
...
#if defined(FEATURE_DUAL_SIM) && defined(FEATURE_DUAL_DATA)
extern emm_reg_service_report_type reg_service_report_sim[MAX_AS_IDS];
...
extern emm_ctrl_data_type *emm_db_get_ctrl_data_per_subs
(
