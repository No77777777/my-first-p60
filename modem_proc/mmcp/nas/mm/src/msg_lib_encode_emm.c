...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/src/msg_lib_encode_emm.c#1 $
$Author: pwbldsvc $
  ...
  switch(out_buf->nas_hdr.msg_id)
  {
    case ATTACH_REQUEST:
      ...
      *pos += plain_nas_first_two_octets;
      ...
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
        (uint8)(out_buf->emm_outgoing_msg.attach_req.eps_attach_req),
        LTE_NAS_CAUSE_NONE);
#endif
      break;
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
        (uint8)(out_buf->emm_outgoing_msg.mo_detach_req.detach_req.mo_detach),
        LTE_NAS_CAUSE_NONE);
#endif
      break;
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
         0xff, out_buf->emm_outgoing_msg.security_mode_rej.emm_cause);
#endif
      break;
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
         0xff, out_buf->emm_outgoing_msg.auth_fail.emm_cause);
#endif
      break;
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
        (uint8)(out_buf->emm_outgoing_msg.tau_req.eps_update.eps_update_val),
        LTE_NAS_CAUSE_NONE);
#endif
      break;
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
         0xff, out_buf->emm_outgoing_msg.mo_emm_status.emm_cause);
#endif
      break;
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log(out_buf->nas_hdr.msg_id,UE_TO_CN_DIRECTION,
        (uint8)(out_buf->emm_outgoing_msg.ext_service_req.service_type),
        LTE_NAS_CAUSE_NONE);
#endif
      break;
#if defined (FEATURE_LTE_REL9)
...
#ifdef FEATURE_QSH_EVENT_METRIC
      emm_qsh_ota_metric_signaling_log((lte_nas_message_id)EMM_SERVICE_REQUEST_DEBUG,UE_TO_CN_DIRECTION,
                                                         0xff, LTE_NAS_CAUSE_NONE);
#endif
