...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/inc/gmm_v.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
/*===========================================================
  Note -gmm_state_type - update debug enum "gmm_state_debug_type "
...
/*===========================================================
  Note -gmm_substate_type - update debug enum "gmm_substate_debug_type "
  when this is updated
============================================================*/
/* -------------------------------------------------------
...
extern void gmm_reset_old_ptmsi(void);
extern boolean gmm_is_camped_on_hplmn(void);
extern boolean gmm_get_map_rej_cause7_to_rej_cause14(void);
extern boolean gmm_get_gsm_map_rej_hplmn_cause7_to_rej_cause14(void);
//CMCC GSM Rej7
