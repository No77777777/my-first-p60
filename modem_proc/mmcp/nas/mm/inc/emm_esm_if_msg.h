...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/inc/emm_esm_if_msg.h#1 $
...
enum
{
  ...
  MSGR_DEFINE_UMID(NAS, EMM, CMD, PS_CALL_STATUS , 0x08, emm_ps_call_status_ind_cmd_T )
#endif
} ;
...
#endif
#ifdef FEATURE_DUAL_SIM
  emm_ps_call_status_ind_cmd_T  emm_ps_call_status_ind;
#endif
} emm_msgr_cmd_type ;
