...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/inc/mmtask_int.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define SIM_MM_PURGE_GUTI_IND 0x06

/* 
** Messages posted from MCFG callback to MM Queue or QSH call back to MM Queue
** Please note that message set is same for both(MS_MM_MM)
*/
#define MM_MCFG_REFRESH_IND 0x00
#define MM_QSH_MESSAGE_IND 0x01
#define MM_NON_ACQ_PARAM_CHANGE_IND 0x02
