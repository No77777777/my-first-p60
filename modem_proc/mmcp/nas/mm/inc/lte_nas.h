...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/inc/lte_nas.h#1 $
$Author: pwbldsvc $
...
/*===========================================================
  Note -lte_nas_emc_srv_status_type - update debug enum "lte_nas_emc_srv_status_debug_type "
  also enum "lte_nas_emc_srv_status_sm_debug_type" when this is updated
============================================================*/
typedef enum
{
