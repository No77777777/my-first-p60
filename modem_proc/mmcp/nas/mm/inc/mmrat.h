...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/inc/mmrat.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
/*===========================================================
  Note -mm_rat_handler_status_type - update debug enum "mm_rat_handler_status_debug_type "
...
/*===========================================================
  Note -mm_interrat_change_state_type - update debug enum "mm_interrat_change_state_debug_type "
  when this is updated
============================================================*/
/*
** Inter-RAT status codes
