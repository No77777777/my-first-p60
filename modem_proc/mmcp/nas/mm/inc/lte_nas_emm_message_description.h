...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/mm/inc/lte_nas_emm_message_description.h#1 $
$Author: pwbldsvc $
...
#define MAX_CLI_DIGITS 20 /*Figure 10.5.93/3GPP TS 24.008 Calling party BCD number information element
                           "Number of Digits" starts from 5th octet, there could be MAX 14 octets, so there could be MAX 
                           10 octets (i.e. 10*2 digits). If it contains an odd number of digits, bits 5 to 8 of the last 
                           octet shall be filled with an end mark coded as "1111". */

#define BCD_NUMBER_END_MARKER 0x0F
...
/*================================================================
  Note -lte_nas_emm_eps_update_val_type - update debug enum "lte_nas_emm_eps_update_val_debug_type "
...
/*===========================================================
  Note -lte_nas_emm_attach_type - update debug enum "lte_nas_emm_attach_debug_type "
  when this is updated
============================================================*/
...
/*===========================================================
  Note -lte_nas_emm_mt_detach_type - update debug enum "lte_nas_emm_mt_detach_debug_type "
  when this is updated
============================================================*/
...
/*===========================================================
  Note -emm_mo_detach_type - update debug enum "emm_mo_detach_debug_type "
  when this is updated
============================================================*/
...
/*===========================================================
  Note -emm_detach_reason_type - update debug enum "emm_detach_reason_debug_type "
  when this is updated
============================================================*/
...
/*===========================================================
  Note -ue_id_type - update debug enum "ue_id_debug_type "
  when this is updated
============================================================*/
...
typedef enum 
{  
  UNSECUR_REDIRECTION_TO_GRR_ALLOWED,
  UNSECUR_REDIRECTION_TO_GRR_NOT_ALLOWED
}lte_nas_emm_network_policy_type;
...
/*===========================================================
  Note -lte_nas_paging_identity_type - update debug enum "lte_nas_paging_identity_debug_type "
  when this is updated
============================================================*/
typedef enum
{
