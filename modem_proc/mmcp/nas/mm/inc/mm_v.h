...
/*
** All the functions that can be called for QSH dump collect should use this attribute
** Otherwise functions wont be accessible in error fatal context if they are compressed
*/
#if defined(FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_DUMP)
#define MM_QSH_ATTR_UNCOMPRESS __attribute__((section(".uncompressible.text")))
#else
#define MM_QSH_ATTR_UNCOMPRESS 
#endif
/*===========================================================================
...
#define mm_clear_lu_attempt_counter( ) {\
      ...
      mm_lu_preemption_failure_count =0;\
}
...
FUNCTION  EMM_SEND_RRC_MANUAL_SEARCH_IND

DESCRIPTION
  This function sends EMM_SEND_RRC_MANUAL_SEARCH_IND
...
===========================================================================*/
#if defined (FEATURE_DUAL_SIM) && !defined (FEATURE_MODEM_ATC )
extern void emm_send_rrc_manual_search_indication(boolean search_status);
#endif
...
extern void mm_lu_buffer_rej_cause_reset(void);
...
#endif
#if (defined FEATURE_LTE_REL12) || (defined FEATURE_NAS_REL12_SPEC_CHANGE)
...
extern sys_ue_mode_e_type mm_current_ue_mode_sim[MAX_AS_IDS];
#define mm_current_ue_mode mm_current_ue_mode_sim[mm_sub_id]
#else
...
typedef enum 
{
   ILLEGAL_ME_SUB_NO_CAUSE,
   ILLEGAL_ME_ON_CURRENT_SUB,
   ILLEGAL_ME_ON_OTHER_SUB,
   NON_ILLEGAL_ME_ON_OTHER_SUB  
} illegal_me_sub_type;
#endif

typedef enum
{
  EMM_TAU_LOCAL_REL_NONE,
  EMM_TAU_LOCAL_REL_MANUAL_SERACH,
  EMM_TAU_LOCAL_REL_MAC_INACTIVITY,
  EMM_TAU_LOCAL_REL_MAX
}emm_tau_local_rel_enum_T;

#ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
typedef enum
{
  ELS_ABORT_NO_CAUSE,
  ELS_ABORT_ON_MO_CALL,
  ELS_ABORT_ON_MPLMN_SRCH
}emm_els_conn_abort_e_type;
#endif


#ifdef FEATURE_CMCC_SECURE_CALL
#if defined FEATURE_DUAL_SIM 
extern sys_secure_call_e_type mm_emm_secure_status_type_sim[MAX_NAS_STACKS];
#define mm_emm_secure_status_type mm_emm_secure_status_type_sim[mm_as_id]
#else
extern sys_secure_call_e_type  mm_emm_secure_status_type ;
#endif
#endif
...
extern boolean mm_is_multisim_device;

extern illegal_me_sub_type mm_illegal_me_sub_sim[MAX_NAS_STACKS];
#define mm_illegal_me_sub mm_illegal_me_sub_sim[mm_as_id]
...
#define MM_IS_LPLUSL_MODE \
  ((mm_subs_capability_mask_sim[MM_AS_ID_1] & SYS_SYS_MODE_MASK_LTE) && \
   (mm_subs_capability_mask_sim[MM_AS_ID_2] & SYS_SYS_MODE_MASK_LTE))
#endif

#if defined(FEATURE_DUAL_SIM) && defined (FEATURE_DUAL_DATA)
#define MM_IS_NON_DDS_SUB (mm_dds_sub != mm_as_id)
#endif


typedef enum mm_debug_mmr_sim_available_status_e
{
  MM_DEBUG_SIM_AVAILABLE_UNKNOWN,
  MM_DEBUG_SIM_AVAILABLE_STARTED,
  MM_DEBUG_SIM_AVAILABLE_PENDED_WAITING_FOR_MMGSDI_SESSION,
  MM_DEBUG_SIM_AVAILABLE_FAILED_MMGSDI_SESSION_OPEN_FAILED,	  
  MM_DEBUG_SIM_AVAILABLE_PENDED_REQUESTED_MMGSDI_SESSION,
  MM_DEBUG_SIM_AVAILABLE_MMGSDI_SESSION_AVAILABLE,
  MM_DEBUG_SIM_AVAILABLE_CARD_MODE_UNKNOWN,
  MM_DEBUG_SIM_AVAILABLE_LOAD_CARD_MODE_SUCCESS,	
  MM_DEBUG_SIM_AVAILABLE_FAILED_LOAD_CARD_MODE_FAILED
} mm_debug_mmr_sim_available_status_e_type;

typedef enum mm_debug_sim_swap_status_e
{
  MM_DEBUG_UNDEFINED,
  MM_DEBUG_SIM_CARD_MODE_NOT_DEFINED,
  MM_DEBUG_SIM_IMSI_READ_FAILED,
  MM_DEBUG_SIM_IMSI_ILLEGAL,
  MM_DEBUG_NV_IMSI_READ_FAILED,
  MM_DEBUG_SIM_CHANGED_NOT_SWAPPED_NV_IMSI_READ_FAILED,
  MM_DEBUG_SIM_CHANGED_NOT_SWAPPED_SUB_AVAILABLE,
  MM_DEBUG_SIM_CHANGED_NOT_SWAPPED_IMSI_NO_MATCH,
  MM_DEBUG_SIM_CHANGED,
  MM_DEBUG_SIM_CHANGED_SWAP_DONE_AT_REG_AND_MM,
  MM_DEBUG_SIM_CHANGED_SWAP_DONE_AT_MM
} mm_debug_sim_swap_status_e_type;

#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_SGLTE)
extern mm_debug_sim_swap_status_e_type mm_debug_sim_swap_status_sim[MAX_NAS_STACKS];
#define mm_debug_sim_swap_status mm_debug_sim_swap_status_sim[mm_as_id]
extern mm_debug_mmr_sim_available_status_e_type mm_debug_mmr_sim_available_status_sim[MAX_NAS_STACKS];
#define mm_debug_mmr_sim_available_status mm_debug_mmr_sim_available_status_sim[mm_as_id]
extern boolean mm_sim_swapped_sim[MAX_NAS_STACKS];
#define mm_sim_swapped mm_sim_swapped_sim[mm_as_id]
...
#else
extern mm_debug_sim_swap_status_e_type mm_debug_sim_swap_status;
extern mm_debug_mmr_sim_available_status_e_type mm_debug_mmr_sim_available_status;
#endif

#if defined FEATURE_DUAL_SIM
extern boolean  gmm_force_for_always_on_data_sim[MAX_NAS_STACKS] ;
#define  gmm_force_for_always_on_data gmm_force_for_always_on_data_sim[mm_as_id]
#else
extern boolean  gmm_force_for_always_on_data;
#endif

#if defined FEATURE_DUAL_SIM
extern boolean mm_dds_switch_while_rrc_conn_active_sim[MAX_NAS_STACKS];
#define mm_dds_switch_while_rrc_conn_active mm_dds_switch_while_rrc_conn_active_sim[mm_as_id]
#else
extern boolean mm_dds_switch_while_rrc_conn_active;
#endif

#ifdef FEATURE_QSH_EVENT_NOTIFY_TO_QSH
#ifdef FEATURE_DUAL_SIM
extern boolean mm_qsh_event_enabled_sim[MAX_AS_IDS][MM_QSH_EVENT_MAX];
#else
extern boolean mm_qsh_event_enabled[MM_QSH_EVENT_MAX];
#endif
#endif
...
typedef enum
{
  EMC_BLOCKED_PLMN_LIST,
  EMC_SHARED_PLMN_LIST
 }emm_plmn_list_type;

typedef struct mm_service_req_params_tag
{
...
typedef struct
{
  sys_srch_priority_e_type   srch_priority;
  boolean    enabled;
}mm_emm_manual_search_param_T;

extern sys_manual_search_timer_value_type mm_emm_manual_search_timer_value;

#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_SGLTE)
extern mm_emm_manual_search_param_T mm_emm_manual_search_param_sim[MAX_NAS_STACKS];
#define mm_emm_manual_search_param mm_emm_manual_search_param_sim[mm_as_id]
#else
extern mm_emm_manual_search_param_T mm_emm_manual_search_param;
#endif

extern void mm_emm_manual_search_timer_set(uint8 periodicity,sys_arfcn_list_s_type  arfcn_list,sys_rat_pri_list_info_s_type rat_pri_list_info);
...
#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_SGLTE)
extern sys_nas_timer_expiry_info_s_type  mm_timer_expiry_info_sim[MAX_AS_IDS];
#define  mm_timer_expiry_info  mm_timer_expiry_info_sim[mm_as_id]

extern boolean mm_is_lu_triggered_in_ecall_mode_sim[MAX_AS_IDS];
#define  mm_is_lu_triggered_in_ecall_mode  mm_is_lu_triggered_in_ecall_mode_sim[mm_as_id]


#else
extern sys_nas_timer_expiry_info_s_type  mm_timer_expiry_info;

extern boolean mm_is_lu_triggered_in_ecall_mode;
...
/*===========================================================
  Note -held_service_request_T - update debug enum "held_service_request_debug_T "
...
/*===========================================================
  Note -WtoGCCO_in_progress_enum_T - update debug enum "WtoGCCO_in_progress_debug_enum_T "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -wcdma_rlf_state_enum_T - update debug enum "wcdma_rlf_state_debug_enum_T "
  when this is updated
============================================================*/
/* ------------------------------
**  WRLF state
...
/*===========================================================
  Note -mm_connection_type_T - update debug enum "mm_connection_debug_type_T "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -mm_rlf_stop_mode_pending_enum_T - update debug enum
  "mm_rlf_stop_mode_pending_debug_enum_T " when this is updated
============================================================*/
typedef enum
{
...
typedef enum
{
  DEBUG_INVALID_STATE_POWER_UP,
  DEBUG_INVALID_STATE_STOP_MODE_CNF,
  DEBUG_INVALID_STATE_DEBUG_BUFFER_INCOM_MSG
} mm_debug_trigger_enum_T ;


typedef enum
{
  NAS_DRX_CFG_REQ_NONE,
  NAS_DRX_CFG_REQ_PENDING,
  NAS_DRX_CFG_REQ_PROCESSING
} nas_drx_set_cfg_req_enum_T;
...
#ifdef FEATURE_DUAL_SIM
#define MM_STD_RADIO_PREEMPTION         68
#endif
/*
...
/*===========================================================
  Note -serving_plmn_info_T - update debug enum "serving_plmn_info_debug_T "
  when this is updated
============================================================*/
...
/*===========================================================
  Note -mmrrc_connection_status_T - update debug enum "mmrrc_connection_status_debug_T "
  when this is updated
============================================================*/
typedef enum 
{
...
typedef struct emm_location_info_s
{
  byte        lai[LAI_SIZE];
  boolean     lai_exists;
...
extern byte mm_message_as_id;

#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE 
#define MSG_MED_DS( sub , str, p1, p2, p3)\
    MSG_4 (MSG_SSID_DFLT, MSG_LVL_MED, "ds%d" str , sub, (p1), (p2), (p3))
    
#define MSG_LOW_DS( sub , str, p1, p2, p3)\
    MSG_4 (MSG_SSID_DFLT, MSG_LVL_LOW, "ds%d" str , sub, (p1), (p2), (p3))
    
#define MSG_ERROR_DS( sub , str, p1, p2, p3)\
    MSG_4 (MSG_SSID_DFLT, MSG_LVL_ERROR, "ds%d" str , sub, (p1), (p2), (p3))
...
#define MSG_FATAL_DS( sub , str, p1, p2, p3)\
    qsh_mdump_set_crash_client(QSH_CLT_MM,QSH_CLT_MM); \
    ERR_FATAL ("ds%d" str , sub, (p1), (p2))
#else
#define MSG_FATAL_DS( sub , str, p1, p2, p3)\
    ERR_FATAL ("ds%d" str , sub, (p1), (p2))
#endif
...
extern byte                      mm_lu_preemption_failure_count_sim[MAX_NAS_STACKS];
...
extern boolean                   mm_gw_intersystem_change_during_additional_mo_conn_sim[MAX_NAS_STACKS];
...
extern boolean                   mm_integrity_protected_during_lu_sim[MAX_NAS_STACKS];
...
extern boolean                   mm_manual_mode_irat_ho_in_non_user_sel_cell_sim[MAX_NAS_STACKS];
...
extern boolean                   mm_is_camped_on_updated_lai_sim[MAX_NAS_STACKS];
...
extern boolean                 mm_user_selection_sim[MAX_NAS_STACKS];
...
extern boolean                   mm_hard_abort_deep_sleep_pending_sim[MAX_NAS_STACKS];
...
/* mm_gmm_reg_failed_cell_id is to store the cell id 
where location update got failed because of 
d,f,g of section  4.4.9 of 24.008  and attach and rau
got failed because of b) and d) of section 4.7.3.1.5
and 4.7.5.1.5 of 24.008 respectively*/

extern uint32    mm_gmm_reg_failed_cell_id_sim[MAX_NAS_STACKS];
...
extern uint8 mm_reg_req_trans_id_sim[MAX_NAS_STACKS];
#define mm_reg_req_trans_id mm_reg_req_trans_id_sim[mm_as_id]
...
#define  mm_lu_preemption_failure_count (mm_lu_preemption_failure_count_sim[mm_as_id])
...
#define  mm_is_camped_on_updated_lai (mm_is_camped_on_updated_lai_sim[mm_as_id])
#define  mm_gw_intersystem_change_during_additional_mo_conn (mm_gw_intersystem_change_during_additional_mo_conn_sim[mm_as_id])
...
#define  mm_integrity_protected_during_lu (mm_integrity_protected_during_lu_sim[mm_as_id])
...
#define  mm_manual_mode_irat_ho_in_non_user_sel_cell (mm_manual_mode_irat_ho_in_non_user_sel_cell_sim[mm_as_id])
...
#define  mm_hard_abort_deep_sleep_pending (mm_hard_abort_deep_sleep_pending_sim[mm_as_id])
...
#define  mm_gmm_reg_failed_cell_id (mm_gmm_reg_failed_cell_id_sim[mm_as_id])
...
#define  mm_user_selection (mm_user_selection_sim[mm_as_id])
...
extern byte  mm_lu_buffer_rej_cause_sim[MAX_NAS_STACKS][MAX_LU_ATTEMPT_SIZE];
#define      mm_lu_buffer_rej_cause mm_lu_buffer_rej_cause_sim[mm_as_id]
...
extern sys_network_selection_mode_e_type  mm_last_requested_network_selection_mode_sim[MAX_NAS_STACKS];
#define mm_last_requested_network_selection_mode mm_last_requested_network_selection_mode_sim[mm_as_id]

/*structure to store some params of last sent rrc service req */
extern mm_service_req_params_T *mm_last_sent_serv_req_params_ptr_sim[MAX_NAS_STACKS];
#define mm_last_sent_serv_req_params_ptr mm_last_sent_serv_req_params_ptr_sim[mm_as_id]
...
extern boolean mm_waiting_for_mocall_connect_sim[MAX_NAS_STACKS];
#define mm_waiting_for_mocall_connect mm_waiting_for_mocall_connect_sim[mm_as_id]
...
extern boolean mm_rrc_est_cause_sent_for_call_sim[MAX_NAS_STACKS];
#define mm_rrc_est_cause_sent_for_call mm_rrc_est_cause_sent_for_call_sim[mm_as_id]
...
extern mmrrc_connection_status_T  mm_backup_rrc_connection_status_sim[MAX_NAS_STACKS];
#define  mm_backup_rrc_connection_status mm_backup_rrc_connection_status_sim[mm_as_id]

extern mmrrc_connection_status_T  mm_backup_cs_session_status_sim[MAX_NAS_STACKS];
#define  mm_backup_cs_session_status mm_backup_cs_session_status_sim[mm_as_id]

extern mmrrc_connection_status_T  mm_backup_ps_session_status_sim[MAX_NAS_STACKS];
#define  mm_backup_ps_session_status mm_backup_ps_session_status_sim[mm_as_id]
...
extern byte mm_last_page_type_sim[MAX_NAS_STACKS];
#define mm_last_page_type mm_last_page_type_sim[mm_as_id]

extern boolean mm_retry_page_rsp_sim[MAX_NAS_STACKS];
#define mm_retry_page_rsp mm_retry_page_rsp_sim[mm_as_id]

extern boolean mm_conn_mode_manual_search_enabled_sim[MAX_AS_IDS];
#define mm_conn_mode_manual_search_enabled  mm_conn_mode_manual_search_enabled_sim[mm_sub_id]

extern boolean mm_nv_conn_mode_manual_search_sim[MAX_AS_IDS];
#define mm_nv_conn_mode_manual_search  mm_nv_conn_mode_manual_search_sim[mm_sub_id]



extern boolean mm_disable_g_upon_fallback_sim[MAX_AS_IDS];
#define mm_disable_g_upon_fallback  mm_disable_g_upon_fallback_sim[mm_sub_id]
...
extern byte                      mm_lu_preemption_failure_count;
...
extern boolean                   mm_is_camped_on_updated_lai;
extern boolean                   mm_gw_intersystem_change_during_additional_mo_conn;
...
extern boolean                   mm_integrity_protected_during_lu;
...
extern boolean                   mm_manual_mode_irat_ho_in_non_user_sel_cell;
...
extern boolean                   mm_hard_abort_deep_sleep_pending;
...
extern uint32    mm_gmm_reg_failed_cell_id;
...
extern uint8 mm_reg_req_trans_id;
...
extern byte mm_lu_buffer_rej_cause[MAX_LU_ATTEMPT_SIZE];
...
/* Flag to remember last network selection mode send to RR/RRC */
extern sys_network_selection_mode_e_type  mm_last_requested_network_selection_mode;

/*structure to store some params of last sent rrc service req */
extern mm_service_req_params_T *mm_last_sent_serv_req_params_ptr;
...
extern boolean mm_rrc_est_cause_sent_for_call;
#ifdef FEATURE_NAS_REL10
...
extern mmrrc_connection_status_T  mm_backup_rrc_connection_status;
extern mmrrc_connection_status_T  mm_backup_cs_session_status;
extern mmrrc_connection_status_T  mm_backup_ps_session_status;
...
extern byte mm_last_page_type;
extern boolean mm_retry_page_rsp;

extern boolean  mm_conn_mode_manual_search_enabled;
extern boolean  mm_nv_conn_mode_manual_search;


extern boolean  mm_disable_g_upon_fallback;
...
#if defined  FEATURE_LTE 
#ifdef FEATURE_DUAL_SIM
extern uint32 mm_extend_lte_disable_duration_sim[MAX_AS_IDS];
#define mm_extend_lte_disable_duration mm_extend_lte_disable_duration_sim[mm_sub_id]
#else
...
#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_SGLTE)
extern uint32 mm_subs_capability_mask_sim[MAX_AS_IDS];
...
#ifdef FEATURE_DUAL_SIM
extern boolean mm_proc_status_sim[MAX_AS_IDS][SYS_PROC_TYPE_TEST_LOOPBACK + 1];
#define mm_proc_status mm_proc_status_sim[mm_as_id]
extern sys_proc_type_e_type mm_last_proc_type_sent_sim[MAX_AS_IDS];
#define mm_last_proc_type_sent mm_last_proc_type_sent_sim[mm_as_id]
#endif
#if defined  FEATURE_DUAL_SIM || defined FEATURE_1XSRLTE
extern sys_proc_type_e_type mm_ds_proc_type_sim[MAX_AS_IDS];
#define mm_ds_proc_type mm_ds_proc_type_sim[mm_as_id]
#endif
...
#if defined(FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)
extern boolean      mm_reg_req__pended_due_to_csg_read_sim[MAX_NAS_STACKS];
#define  mm_reg_req__pended_due_to_csg_read mm_reg_req__pended_due_to_csg_read_sim[mm_as_id]
#else
extern boolean      mm_reg_req__pended_due_to_csg_read;
#endif
#endif

#if defined(FEATURE_DUAL_SIM) || defined (FEATURE_SGLTE)
#define MM_SUB (mm_message_as_id)
#ifdef FEATURE_DUAL_SIM
#define MM_LOCAL_SUB (as_id+1)
#else
...
#if defined(FEATURE_DUAL_SIM)
extern byte mm_nv_vamos_feature_support_sim[MAX_AS_IDS];
#define mm_nv_vamos_feature_support mm_nv_vamos_feature_support_sim[mm_sub_id]
#else
...
extern boolean                    full_srv_req_in_emerg_sim[MAX_AS_IDS];
#define full_srv_req_in_emerg full_srv_req_in_emerg_sim[mm_sub_id]

extern boolean                    mm_map_rej_cause7_to_rej_cause14_sim[MAX_AS_IDS];
#define mm_map_rej_cause7_to_rej_cause14 mm_map_rej_cause7_to_rej_cause14_sim[mm_sub_id]

extern boolean                    mm_map_rej_hplmn_cause7_to_rej_cause14_sim[MAX_AS_IDS];
#define mm_map_rej_hplmn_cause7_to_rej_cause14 mm_map_rej_hplmn_cause7_to_rej_cause14_sim[mm_sub_id]
//CMCC GSM Rej7

extern boolean                    emergency_call_after_lu_in_lpm_sim[MAX_AS_IDS];
#define emergency_call_after_lu_in_lpm emergency_call_after_lu_in_lpm_sim[mm_sub_id]
#else
...
extern boolean                    mm_map_rej_cause7_to_rej_cause14;
extern boolean                    mm_map_rej_hplmn_cause7_to_rej_cause14;
#endif
...
extern byte                      mm_del_emm_params_on_gw_ps_reject;
extern byte                      mm_send_auth_rsp_on_invalid_gsm_kc_len;
#ifdef FEATURE_NAS_REL11
extern mm_nas_nv_sim_parameters_T mm_nas_nv_sim_hfns;
#endif
extern boolean                   mm_is_qrd_device;
extern boolean                   mm_nv_enable_csg;
...
extern sys_csg_support_e_type     mm_nv_csg_support_sim[MAX_NAS_STACKS];
#define mm_nv_csg_support   mm_nv_csg_support_sim[mm_sub_id]
...
extern boolean mm_ecall_dereg_in_wrong_state_sim[MAX_NAS_STACKS];
...
#define mm_ecall_dereg_in_wrong_state mm_ecall_dereg_in_wrong_state_sim[mm_as_id]
#endif
#else
...
extern boolean mm_ecall_dereg_in_wrong_state;
...
#if defined(FEATURE_QSH_EVENT_METRIC) && defined (FEATURE_DUAL_SIM)
#define mm_qsh_debug_metrics mm_qsh_debug_metrics_sim[mm_sub_id]
#endif
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
...
extern mm_as_id_e_type  mm_dds_sub;

extern reject_cause_T mm_map_cause();
...
extern boolean              mm_reg_req_ignored_sim[MAX_NAS_STACKS];
#define  mm_reg_req_ignored mm_reg_req_ignored_sim[mm_as_id]

#ifdef TEST_FRAMEWORK
#error code not present
#else
sys_rat_activation_status mm_tds_rat_status_sim[MAX_NAS_STACKS];
#endif
#define  mm_tds_rat_status mm_tds_rat_status_sim[mm_as_id]
#endif
...
#ifdef FEATURE_DUAL_SIM 
extern byte                      gsm_wcdma_amr_codec_preference_sim[MAX_AS_IDS];
#define  gsm_wcdma_amr_codec_preference gsm_wcdma_amr_codec_preference_sim[mm_sub_id]
#else
...
extern boolean mm_sub_is_rat_enabled(sys_radio_access_tech_e_type rat);
...
void            mm_check_for_page_replay(byte rr_abort_cause);
...
#if defined(FEATURE_DUAL_SIM) && defined(FEATURE_LTE)
boolean         mm_sms_over_ims_in_progress_in_other_sub(void);
#endif            
...
void            mm_add_forbidden_regional_roaming( inter_task_lai_T *, boolean is_lai_added_due_to_t3247);
void            mm_add_forbidden_national_roaming( inter_task_lai_T *,boolean);
...
void            mm_read_imeisv( byte *);
#ifdef FEATURE_NAS_SINGLE_IMEI
boolean         mm_is_single_imei_behavior_applicable(sys_plmn_id_s_type );
#endif
...
#ifdef FEATURE_DUAL_SIM
void mm_rr_preemption_ind(mm_cmd_type * msg_p);
#endif
...
#ifdef FEATURE_DUAL_SIM
extern void mm_send_mmr_me_blocked_status_ind(boolean is_me_blocked, mm_as_id_e_type mm_local_as_id); 
#endif
...
void mm_add_lai_in_reject_list(inter_task_lai_T* lai, boolean is_lai_due_to_t3247);
...
extern void mmcoord_handle_deep_sleep(void);

#ifdef FEATURE_DUAL_SIM
extern void mm_emm_send_illegal_event_on_current_sub
(
  void
);

extern void mm_emm_send_illegal_event_on_other_sub
(
  void
);

extern boolean mm_emm_is_illegal_me_on_any_sub
(
  sys_modem_as_id_e_type as_id
);

extern void mm_emm_send_legal_event_on_other_subs_per_subs
(
  mm_as_id_e_type as_id
); 

extern void mm_emm_send_legal_event_on_other_subs
(
  void
);
extern void mm_gmm_send_illegal_event_on_other_subs
(
  void
);
extern void mm_gmm_send_illegal_event_for_current_sub
(
  void
);
extern void mm_gmm_set_non_illegal_cause
(
  void
); 

extern void mm_gmm_set_illegal_non_illegal_cause
(
  byte cause
); 

extern void mm_emm_unblock_me
(
  void
);  
...
#if defined (FEATURE_DUAL_SIM) && defined (FEATURE_TDSCDMA)
extern void mm_resume_ignored_mmr_reg_req(mm_as_id_e_type as_id);
#endif
...
#if defined (FEATURE_DUAL_SIM) && defined (FEATURE_TDSCDMA)
extern boolean mm_check_dual_tds_concurrency
(
  sys_rat_pri_list_info_s_type *rat_priority_list
);
extern boolean mm_check_ignore_mmr_reg_req(sys_rat_pri_list_info_s_type *rat_priority_list);
#endif


#ifdef FEATURE_NAS_SINGLE_IMEI
extern sys_modem_as_id_e_type mm_sim_get_as_id_from_slot(mmgsdi_slot_id_enum_type  slot_id);
#endif

boolean non_acq_bit_mask_check(uint32 value, byte bit_mask);
...
typedef struct mm_qsh_debug_metrics_s
{
  qsh_client_metric_context_id_t signaling_metric_context_id;
  mm_qsh_metric_signaling_s *ota_signaling_ptr;
  qsh_client_metric_context_id_t debug_buffer_metric_context_id;
  mm_qsh_metric_debug_buffer_s *debug_buffer_ptr;
}mm_qsh_debug_metrics_s_type;

#ifdef FEATURE_DUAL_SIM
extern mm_qsh_debug_metrics_s_type mm_qsh_debug_metrics_sim[MAX_AS_IDS];
#else
extern mm_qsh_debug_metrics_s_type mm_qsh_debug_metrics;
#endif
#endif
...
int8 mm_waiting_for_regs_complete_txn_get
(
  mm_as_id_e_type as_id
)MM_QSH_ATTR_UNCOMPRESS;

byte mm_get_lu_cause_per_subs
(
  mm_as_id_e_type as_id
)MM_QSH_ATTR_UNCOMPRESS;
...
#if defined(FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_DUMP)
#ifdef FEATURE_QSH_MDUMP 
QSH_MDUMP_FN_ATTR void mm_qsh_debug_callback
(
  qsh_client_cb_params_s *param
);
#else
...
/*===========================================================
  Note - Emm update status - update debug enum "emm_eps_update_status_debug_type "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -lte_nas_tau_cause_type - update debug enum "lte_nas_tau_cause_debug_type "
  when this is updated
============================================================*/
...
/*===========================================================
  Note -nas_mm_tin_type - update debug enum "nas_mm_tin_debug_type "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -emm_esr_type - update debug enum "emm_esr_debug_type "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -emm_pending_reg_ack_enum_T - update debug enum "emm_pending_reg_ack_debug_enum_T "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -emm_ps_detach_status - update debug enum "emm_ps_detach_debug_status "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -emm_l2gcco_in_progress_enum_T - update debug enum "emm_l2gcco_in_progress_debug_enum_T "
  when this is updated
============================================================*/
typedef enum
{
...
/*===========================================================
  Note -sg_association_to_be_established_enum_T - update debug enum 
  "sg_association_to_be_established_debug_enum_T " when this is updated
============================================================*/
...
typedef enum
{
  ...
  EMM_RADIO_CAP_UPDATE_PENDING_FOR_LTE,
...
typedef struct
{
  ...
  boolean    overall_sms_status; /* 0 -inactive 1-MO/MT CS or IMS active */
}wms_sms_status_type;
...
/*===========================================================
  Note -emm_ps_resumption_status_enum_T - update debug enum 
   "emm_ps_resumption_status_debug_enum_T " when this is updated
============================================================*/
typedef enum
{
...
#ifdef FEATURE_LTE_REL9
typedef struct emm_emc_backoff_timer_info_s
{
  sys_plmn_id_s_type       plmn;
  rex_timer_cnt_type       timer_count;
} emm_emc_backoff_timer_info_s_type;

typedef struct emm_emc_blocked_plmn_list_s
{
  uint8                   length;
  emm_emc_backoff_timer_info_s_type       plmn_timer_list[LTE_RRC_MAX_PLMN_LIST_SIZE];
} emm_emc_blocked_plmn_list_s_type;
#endif


/* If this EFS is enabled in MBN for first time, set force_tau_nondds to TRUE */
typedef struct emm_nas_nv_items
{
   byte                       version;
   byte                       emm_plmn_block_on_rej_15_8;  //ver -->0
   boolean                    use_lte_disable_duration_timer_nv;//ver-->1
   boolean                    emm_plmn_block_on_rej_15_roaming; //ver -->2
   boolean                    psm_local_detach_enabled; //ver -->3
   boolean                    csfb_perform_reg;  //ver -->4
   boolean                    emm_fake_cell_attempt_enabled; //ver ->5
   boolean                    force_esr_nondds; //ver ->6
   boolean                    force_tau_nondds; //ver ->7
 /**** following 2 fields has been added to be in sync with NEW PLs NV structure,No other purpose */
   boolean                    redirection_policy_home;  //ver ->8
   boolean                    redirection_policy_roam;  //ver ->9
/************************************************************************************************/
   boolean                    emm_map_cause_12_to_13;  //ver ->10
   boolean                    set_sg_flag_on_lau;                          //Ver->11
   boolean                    is_detach_req_on_pti_mismatch; //ver ->12
   boolean                    force_tau_during_manual_search; //ver ->13
   boolean                    force_esr_tau_on_dds;                     //Ver->14
   boolean                    skip_acb_check_drb_est_ims_registration;      //VER->15 //Not needed
   byte                       reserved[15];
...
typedef enum
{
  NAS_NON_ACQ_REQ_NONE,
  NAS_NON_ACQ_REQ_PENDING,
  NAS_NON_ACQ_REQ_PROCESSING
}nas_non_acq_req_enum_T;


typedef enum
{
  EMM_CSFB_CON_REL_PEND_NONE,
  EMM_CSFB_CON_REL_PEND_ESR,
  EMM_CSFB_CON_REL_PEND_REDIR,
  EMM_CSFB_CON_REL_PEND_TAU,
  EMM_CSFB_CON_REL_PEND_DRB,
  EMM_CSFB_CON_REL_PEND_MAX
}emm_csfb_con_pen_enum_T;
...
typedef struct emm_ctrl_data_tag
{
  ...
  byte                          dual_switch_pti;

  boolean                       is_pti_mismatch;
  
  boolean                       is_detach_req_on_pti_mismatch;
    
  struct emm_agent_list_tag    *client_list ;

  mmtel_call_status_type        mmtel_call_status;

  boolean                      emm_nv_local_rel_tau_dds;
#if defined(FEATURE_DUAL_SIM) && defined (FEATURE_DUAL_DATA)
  boolean emm_nv_force_esr_nondds;
  boolean emm_nv_force_tau_nondds;
  boolean esr_tau_pending_conn_rel;
  boolean paging_conn_est;
  boolean local_rel_tau_after_csfb_tau;
  boolean nas_sms_pending_con_rel;
  boolean efs_loc_rel_tau_after_nas_sms;
  emm_csfb_con_pen_enum_T second_tau_after_csfb_needed;
#endif
  boolean emm_nv_tau_radio_cap_update;
  ...
  */
  ...
  /* Pointer to Mutex for forbidden_for_service_list_ptr */
  pthread_mutex_t              *forbidden_for_service_list_mutex_ptr;
  ...
  /* NV flag to enable estimation of dl count from SQN */
  boolean                       estimate_dl_count_from_sqn;
  /* bitmap to keep track of the receive status of last 8 consecutive DL NAS COUNTs */
  byte                          dl_nas_count_bmp;
  ...
  boolean                    emm_nv_reattach_after_sync_up_fail;
  ...
  nas_drx_set_cfg_req_enum_T    *set_drx_req_pending_ptr;
  ...
  */
  ...
  /*Flag for starting TAU or not after 1xcsfb call ended for 1xSRLTE feature or 
    or after call end for ELS feature */
  boolean   lte_suspend_tau_needed;
...
#ifdef FEATURE_QSH_EVENT_METRIC
  mm_qsh_debug_metrics_s_type *qsh_debug_metrics_ptr;
#endif
#ifdef FEATURE_DUAL_SIM
  boolean                  dual_switch_pended;
  boolean                 *dds_switch_pended_ptr;
#endif
#if defined  FEATURE_DUAL_SIM || defined FEATURE_1XSRLTE
  boolean                  ps_call_in_progress;
#endif
  boolean                   apn_switch;
  boolean                   volte_persistent_active_flag;

  /* rau pending due to lower layer failure  in LTE and RAU needs to be performed on GW */
  boolean rau_pending_ll_failure;
  dword est_nas_count; /* used in handover to estimate whether the received dl count from key indication is valid */
  boolean                   *abort_ps_detach_ptr; 
 ...
 /* 24.301 5.6.1.6 Abnormal cases in the UE i)  */
...
#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_LTE_REL10)
  boolean             responding_to_page;
#endif
  /*RLF state*/
  boolean                  rlf_state;
  /*Feature flag for ignoring bearer ctxt status IE in TAU accept msg*/
  boolean                  skip_bc_status_ie;
  /*bearer ctxt status IE included in  TAU request msg*/
  boolean                  bc_status_ie_included;
#ifdef FEATURE_LTE_REL10
  ...
  boolean             csfb_perform_reg;
#endif
#if defined  FEATURE_DUAL_SIM || defined FEATURE_1XSRLTE
  sys_proc_type_e_type *ds_proc_type_ptr;
#endif
#if defined(FEATURE_DUAL_SIM) && defined (FEATURE_DUAL_DATA)
  sys_rat_activation_status last_non_dds_lte_status;
#endif

#ifdef FEATURE_LTE_REL9
  lte_rrc_shared_plmn_list_s        emc_shared_plmn_list;
  rex_timer_type                    emc_backoff_timer;
  dword                             emc_backoff_timer_value;
  emm_emc_blocked_plmn_list_s_type  emc_blocked_plmn_list;
  boolean                           switch_plmn;
#endif
  ...
  boolean                          ignore_attach_pti_mismatch;
  boolean                          combined_update_with_imsi_needed;
  nas_non_acq_req_enum_T           emm_voice_domain_change_pended;


#ifdef FEATURE_DUAL_SIM
  illegal_me_sub_type              *emm_illegal_me_sub;
  boolean                          *is_multisim_device;
#endif
 lte_nas_emm_tai_lst_info_type      *emm_emc_tai_list_ptr;
#ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
  emm_els_conn_abort_e_type        emm_els_conn_abort_reason;
#endif
  boolean                          emm_cs_allow_in_volte_resource_reserve;
  boolean                          emm_is_conn_abort_pended;
  boolean                          t3346_started_emc_call_pending;
  /* indicates whether we need gto send GSTK IDLE event in LTE*/
  boolean             send_idle_event_gstk;
  boolean                          emm_map_cause_17_to_cause_18;
  boolean                          enable_3417_ext_mt_timer;
#ifdef FEATURE_LTE_REL14
  lte_nas_replayed_msg_type        replayed_msg;
#endif
  boolean                          emm_early_mcc_detection_started;
#ifdef FEATURE_LAPP
  lte_nas_emm_ue_additional_security_type  ue_additional_security_capability;  // UE additional security capabilities
#endif
#ifdef FEATURE_LTE_REL13
  uint16                           nas_ciot_capability_config;
#endif
  boolean 						     emm_network_policy_exists;
  lte_nas_emm_network_policy_type    emm_unsec_redir_allowed;
  boolean 						     redirection_policy_home;  
  boolean 						     redirection_policy_roam;  
  boolean                            emm_map_cause_12_to_13;
  boolean                            emm_is_cause_12_to_13_mapped;
  boolean                            set_sg_flag_on_lau;
  uint32                             radio_nv_cap_enquiry_timer;
  uint8                              radio_nv_cap_enquiry_timer_expiry_ignore;
  uint8                              nw_initial_cap_enq_ratmask;
  uint8                              ue_initial_cap_enq_ratmask;
  boolean                            ra_nv_cap_enquiry_skip_opt;

  uint8                              ra_cap_enquiry_nw_ratmask;
  emm_tau_local_rel_enum_T           tau_local_release;
  boolean                            force_tau_during_manual_search;
  boolean                            hold_tau_trm_for_local_release;
  boolean                            tau_pending_after_msearch_abort;
  boolean							 skip_second_tau_during_msearch;
  uint8                              local_rel_plus_tau_during_msearch_counter;
  boolean 							 is_periodic_tau_required;
  uint8                             t3411_value_during_mmtel_call;
  boolean      is_syncup_tau_for_local_bear_deact_needed;
  uint8                              pdn_reject_cause_55_cnt;
  boolean                            cell_changed_flag;
  boolean                           skip_acb_check_drb_est_ims_registration; //Skip ACB check for IMS registration
  boolean                            esm_proc_retry_ind;
} emm_ctrl_data_type ;
#endif
...
extern mm_cmd_type *mm_pending_mmr_ps_detach_req_ptr_sim[MAX_NAS_STACKS];
...
extern void mm_check_and_perform_action_invalid_state_detection(
  sys_modem_as_id_e_type as_id,
...
extern sys_pch_state_s_type mm_rrc_pch_state_info_sim[MAX_NAS_STACKS];
#define mm_rrc_pch_state_info mm_rrc_pch_state_info_sim[mm_as_id]
extern boolean mm_nv_exclude_old_lai_type_ie_sim[MAX_AS_IDS];
#define mm_nv_exclude_old_lai_type_ie mm_nv_exclude_old_lai_type_ie_sim[mm_sub_id]
#else
...
extern void mm_send_rr_mo_csfb_failure_ind(boolean depriotize_cells);
...
extern sys_srv_domain_e_type  mm_get_effective_req_srv_domain
(
...
===========================================================================*/
void mm_send_rrc_lai_reject_list_ind( nas_lai_reject_list_T* list );
...
===========================================================================*/
void mm_send_rr_lai_reject_list_ind( nas_lai_reject_list_T* list );
...
extern void mm_clear_pending_attach_req(void);
...
#ifdef FEATURE_DUAL_SIM
#ifdef FEATURE_FEMTO_CSG
extern void mm_sim_swap_allowed_csg_list(mm_as_id_e_type mm_as_id_target);
#endif
#ifdef FEATURE_NAS_REL10
extern void mm_sim_swap_backoff_remaining_info(mm_as_id_e_type mm_as_id_target);
#endif
extern void mm_handle_sim_swap(mm_as_id_e_type mm_as_id_target);
#endif

extern boolean mm_is_serv_req_cause_changed_leading_opt_plmn_srch( rrc_mm_service_req_cause_e_type service_req_cause );
extern rrc_mm_service_req_cause_e_type mm_get_serv_req_cause(mm_cmd_type *message);
extern boolean mm_get_is_ehplmn_to_be_camped(void);
...
extern boolean mm_in_conn_management_state(void);
extern boolean mm_check_if_emcall_allowed(void);
...
#ifdef FEATURE_FEMTO_CSG
extern void mmsim_update_nv_csg_support_data(void);
#endif
...
===========================================================================*/
extern void mm_send_mmcnm_srvcc_handover_complete(void);
...
extern void mm_pend_lu_rau_on_ll_failure_in_lte(void);
...
FUNCTION MM_SEND_RR_DDS_SUB_IND

DESCRIPTION
  This function sends a RR_DDS_SUB_IND to RR.
...
FUNCTION MM_SEND_RRC_DDS_SUB_IND

DESCRIPTION
  This function sends a RRC_DDS_SUB_IND to RR.
...
FUNCTION MM_SEND_RR_PROCEDURE_IND

DESCRIPTION
  This function sends a RR_PROCEDURE_IND to RR.
...
void mm_send_rr_procedure_ind(sys_proc_type_e_type proc_type);

/*===========================================================================

FUNCTION MM_SEND_RRC_PROCEDURE_IND

DESCRIPTION
  This function sends a RRC_PROCEDURE_IND to RR.
...
===========================================================================*/
void mm_send_rrc_procedure_ind(sys_proc_type_e_type proc_type);

/*===========================================================================

FUNCTION MM_SEND_RRC_ABNORMAL_CALL_END_IND

DESCRIPTION
  This function sends a RRC_ABNORMAL_CALL_END_IND to RRC.
...
void mm_send_rrc_abnormal_call_end_ind(sys_modem_as_id_e_type as_id);

/*===========================================================================

FUNCTION mm_set_as_id_rrc_abnormal_call_end_ind
...
FUNCTION mm_get_as_id_rrc_abnormal_call_end_ind

===========================================================================*/
sys_modem_as_id_e_type mm_get_as_id_rrc_abnormal_call_end_ind();

/*===========================================================================

FUNCTION MM_SEND_PROCEDURE_IND

DESCRIPTION
  This function sends a RR_PROCEDURE_IND/RRC_PROCEDURE_IND
...
===========================================================================*/
void mm_send_procedure_ind(sys_proc_type_e_type proc_type);
#endif
...
===========================================================================*/
extern void mm_send_rr_multimode_subs_chgd_req(mmr_multimode_subs_chgd_req_s_type*  subs_chgd_req_ptr);

extern void mm_send_rrc_multimode_subs_chgd_ind(mmr_multimode_subs_chgd_req_s_type*  subs_chgd_req_ptr);
/*===========================================================================
...
#ifdef FEATURE_DUAL_SIM
void mm_send_tdsrrc_subscription_id_ind(void);
#endif

extern void mm_send_rrc_barring_info_ind
(
   cs_domain_no_response_e_type call_response_type
);
#endif
#ifdef FEATURE_CMCC_SECURE_CALL
extern void mm_send_rrc_secure_call_ind    
(
...
===========================================================================*/
extern sys_proc_type_e_type mm_evaluate_proc_type(void);

/*===========================================================================

FUNCTION MM_PROC_STATUS_SET

DESCRIPTION
  This function sets the mm_proc_status array for a particular procedure.
...
===========================================================================*/
extern void mm_proc_status_set
(
  sys_proc_type_e_type proc_type,
  boolean value
);

extern void mm_last_proc_type_sent_set
(
  sys_proc_type_e_type proc_type
);

#ifdef FEATURE_TDSCDMA
void mm_tds_rat_status_set
(
...
#endif
#ifdef FEATURE_QSH_EVENT_NOTIFY_TO_QSH
void mm_emm_notify_page_event_qsh();
#endif
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
...
DESCRIPTION 
  This function checks if on going SMS needs to be terminated
...
extern byte mm_get_gsm_wcdma_amr_codec_per_subs
(
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
  sys_modem_as_id_e_type as_id
#else
...
FUNCTION mm_check_plmn_forbidden_national_roaming

DESCRIPTION 
  This function returns a valus indicating if a PLMN is forbidden
...
===========================================================================*/
 ...
 boolean mm_check_plmn_forbidden_national_roaming(sys_plmn_id_s_type plmn);
...
extern boolean mm_compare_ms_op_mode_per_sub
(
  sys_modem_as_id_e_type as_id, 
  sys_srv_domain_e_type srv_domain
);
...
/*===========================================================================
FUNCTION mm_send_rr_irat_allowed_status_ind

DESCRIPTION 
  This function sends a status of future IRAT to the geran RR
...
===========================================================================*/
 ...
 void mm_send_rr_irat_allowed_status_ind(void);
/*===========================================================================

FUNCTION mm_redirection_allowed_status_ind

DESCRIPTION 
  This function sends a status of a possible redirection
...
FUNCTION emm_redirection_allowed_status_ind
...
extern boolean mm_is_dos_mitigation_required_for_cs_domain( byte msg_id,byte reject_cause);
extern void mm_perform_dos_mitigation_action(byte msg_id,byte reject_cause);

extern void mm_clear_t3247_specific_lai_reject_list(void);

extern void  mm_clear_dos_non_dos_forbidden_LAIs(boolean is_lai_t3247_specific);
...
extern boolean mm_is_lai_forbidden_due_to_dos_mitigation(inter_task_lai_T * p_lai);
...
(
 const sys_sim_state_e_type sim_state
  ...
  extern void mm_emm_clear_dos_counters_per_subs(mm_as_id_e_type mm_local_as_id); 
  /*===========================================================================
...
#ifdef FEATURE_LTE
extern void mm_send_mmr_non_acq_update_ind(sys_voice_domain_pref_e_type voice_domain_pref);
#endif
...
extern boolean mm_check_mms_progress_on_non_dds_sub(void);

extern void mm_send_rrc_g_meas_stop_ind(boolean status);
extern boolean mm_is_plmn_an_hplmn(
  sys_plmn_id_s_type plmn 
#if defined FEATURE_DUAL_SIM
  ,sys_modem_as_id_e_type as_id
#endif
...
extern void mm_rrc_est_cause_sent_for_call_set(boolean value);

extern boolean mm_rrc_est_cause_sent_for_call_get(void);
/*===========================================================================
