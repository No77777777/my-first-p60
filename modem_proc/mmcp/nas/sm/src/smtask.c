...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/sm/src/smtask.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define SM_QSH_METRIC_DEFAULT_CONFIG_COUNT 2
#else
#define SM_QSH_METRIC_DEFAULT_CONFIG_COUNT 1
#endif
#define SM_QSH_METRIC_SIGNALING_ELEMENT_COUNT 50
qsh_ext_metric_cfg_s  sm_qsh_metric_default_cfg_arr[SM_QSH_METRIC_DEFAULT_CONFIG_COUNT];
#endif
...
extern void sm_qsh_debug_callback(qsh_client_cb_params_s *param);
#endif
...
#endif 
byte sm_message_as_id = 1;
#ifdef FEATURE_DUAL_SIM
#ifdef FEATURE_DUAL_DATA
boolean sm_pdp_sig_in_progress_last_sent_sim[MAX_AS_IDS][2];
#define sm_pdp_sig_in_progress_last_sent sm_pdp_sig_in_progress_last_sent_sim[sm_as_id]
#else
boolean sm_pdp_sig_in_progress_last_sent[2];
#endif
#endif
...
#ifdef FEATURE_QSH_EVENT_METRIC
sm_qsh_debug_metrics_s_type sm_qsh_debug_metrics_sim[MAX_AS_IDS];
#define sm_qsh_debug_metrics sm_qsh_debug_metrics_sim[sm_as_id]
#endif
...
sys_data_activity_e_type sm_data_call_activity_status_sim[MAX_AS_IDS];
#define sm_data_call_activity_status sm_data_call_activity_status_sim[sm_as_id]
...
#ifdef FEATURE_QSH_EVENT_METRIC
sm_qsh_debug_metrics_s_type sm_qsh_debug_metrics;
#endif
#ifdef FEATURE_DUAL_SIM
...
#ifdef FEATURE_QSH_DUMP
//Global  variables
sm_qsh_dump_tag_debug_data_s *sm_qsh_dump_tag_0_ptr;
sm_qsh_dump_tag_debug_buffer_s *sm_qsh_dump_tag_1_ptr;
#endif
...
void sm_init( void )
{
  ...
  for ( sm_as_id = SM_AS_ID_1; sm_as_id < (sm_as_id_type_e)MAX_AS_IDS; sm_as_id ++ )
  {
...
#ifdef FEATURE_DUAL_DATA
    sm_data_call_activity_status = SYS_DATA_ACTIVITY_NONE;
#endif
...
#endif
#ifdef FEATURE_QSH_EVENT_METRIC
   sm_qsh_debug_metrics.ota_signaling_ptr = NULL;
#endif
#ifdef FEATURE_GSM_GPRS      
   ...
   #endif
#ifdef FEATURE_DUAL_SIM
   sm_pdp_sig_in_progress_last_sent[0] = FALSE;
   sm_pdp_sig_in_progress_last_sent[1] = FALSE;
#endif
#ifdef FEATURE_LTE
...
#ifdef FEATURE_QSH_EVENT_METRIC
/*===========================================================================
FUNCTION SM_PROCESS_QSH_METRICS_IND
...
SIDE EFFECTS
  None
===========================================================================*/
void sm_process_qsh_message_ind
( 
  sm_cmd_type *cmd_ptr 
)
{
  ...
  sm_as_id_type_e as_id =
   (sm_as_id_type_e)cmd_ptr->cmd.qsh_message_ind.param.action_params.metric_cfg.subs_id;
#endif
  sm_qsh_metric_e metric_id = 
    (sm_qsh_metric_e)(cmd_ptr->cmd.qsh_message_ind.param.action_params.metric_cfg.id);

  MSG_HIGH_DS_1(SM_SUB, "=SM= Received SM_QSH_MESSAGE_IND metric_id %d", metric_id);

  switch(metric_id)
  {
    case SM_QSH_METRIC_SIGNALING:
      {
#ifdef FEATURE_DUAL_DATA
        sm_qsh_debug_metrics_sim[as_id].signaling_metric_context_id = 
        ...
        {
          sm_qsh_debug_metrics_sim[as_id].ota_signaling_ptr = 
             (sm_qsh_metric_signaling_s *)cmd_ptr->cmd.qsh_message_ind.param.action_params.metric_cfg.start_addr;
        }
        else
        {
          sm_qsh_debug_metrics_sim[as_id].ota_signaling_ptr = NULL;
        }
#else
        sm_qsh_debug_metrics.signaling_metric_context_id = 
          cmd_ptr->cmd.qsh_message_ind.param.action_params.metric_cfg.metric_context_id;
        if(cmd_ptr->cmd.qsh_message_ind.param.action_params.metric_cfg.action == QSH_METRIC_ACTION_START)
        {
...
#if defined(FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_DUMP)
/*===========================================================================
FUNCTION sm_qsh_register

DESCRIPTION
This function call registers SM Task with QSH
...
SIDE EFFECTS
  None
===========================================================================*/
void sm_qsh_register(void)
{
  qsh_client_reg_s client_reg;
  qsh_client_reg_init(&client_reg);
  client_reg.cb_action_support_mask = QSH_ACTION_NONE;
  client_reg.client = QSH_CLT_SM;
  client_reg.client_cb_ptr = sm_qsh_debug_callback;
  client_reg.major_ver = SM_QSH_MAJOR_VER;
  client_reg.minor_ver = SM_QSH_MINOR_VER;
#ifdef FEATURE_QSH_DUMP
...
#ifdef FEATURE_QSH_EVENT_METRIC
  qsh_client_metric_cfg_init(sm_qsh_metric_default_cfg_arr,
                          SM_QSH_METRIC_DEFAULT_CONFIG_COUNT);

  //Signaling metric enable for AS_ID_1
  sm_qsh_metric_default_cfg_arr[0].id = SM_QSH_METRIC_SIGNALING;
  sm_qsh_metric_default_cfg_arr[0].subs_id = SYS_MODEM_AS_ID_1;
  sm_qsh_metric_default_cfg_arr[0].fifo.element_size_bytes = 
                                    sizeof(sm_qsh_metric_signaling_s);
  sm_qsh_metric_default_cfg_arr[0].fifo.element_count_total = 
                                SM_QSH_METRIC_SIGNALING_ELEMENT_COUNT;
#ifdef FEATURE_DUAL_DATA
  //Signaling metric enable for AS_ID_2
  sm_qsh_metric_default_cfg_arr[1].id = SM_QSH_METRIC_SIGNALING;
  sm_qsh_metric_default_cfg_arr[1].subs_id = SYS_MODEM_AS_ID_2;
  sm_qsh_metric_default_cfg_arr[1].fifo.element_size_bytes =
                                     sizeof(sm_qsh_metric_signaling_s);
  sm_qsh_metric_default_cfg_arr[1].fifo.element_count_total =
                                  SM_QSH_METRIC_SIGNALING_ELEMENT_COUNT;
#endif
  ...
  client_reg.metric_info.metric_cfg_arr_ptr = 
                             &sm_qsh_metric_default_cfg_arr[0];
#endif

#ifdef FEATURE_QSH_DUMP
  client_reg.dump_info.max_size_bytes = sizeof(sm_qsh_dump_tag_debug_data_s) +
...
SIDE EFFECTS
  None
===========================================================================*/
ULogHandle sm_get_ulog_handle(void)
{
      ...
      while ((sm_cmd_ptr = (sm_cmd_type*) q_get(&sm_cmd_q)) != NULL)
      {
       if(sm_get_as_id(sm_cmd_ptr) == TRUE)
       {
        ...
        switch (sm_cmd_ptr->header.message_set)
        {
          ...
          case MS_SM_SM:
#ifdef FEATURE_QSH_EVENT_METRIC
            if(sm_cmd_ptr->cmd.qsh_message_ind.IMH.message_id == SM_QSH_MESSAGE_IND)
            {
              sm_process_qsh_message_ind(sm_cmd_ptr);
            }
#endif
            break;
  ...
  ** ------------------------------------------------------------*/
  if (sm_timer_type == TIMER_ESTABLISH_PENDING)
  {
    ...
    if ((max_est_timer_count < MAX_EST_TIMER_CNT)
         ...
         &&
        (sm_data_call_activity_status_get() != SYS_DATA_ACTIVITY_CLEANUP_REQ)
#endif
       )
    {
