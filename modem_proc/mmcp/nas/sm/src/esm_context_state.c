...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/sm/src/esm_context_state.c#1 $
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING act_default_bearer_ctxt_req in %s state",
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING act_default_bearer_ctxt_accept in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING act_dedicated_bearer_ctxt_req in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING act_dedicated_bearer_ctxt_accept in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING sig_conn_released_ind in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING deact_dedicated_bearer_ctxt_req in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING default_bearer_ctxt_reject in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING dededicated_bearer_ctxt_reject in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING modify_bearer_ctxt_req in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING modify_bearer_ctxt_rej in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
...
{
  MSG_HIGH_DS_1(SM_SUB, "ESM: DISCARDING modify_bearer_ctxt_accept in %s state",
	               ctxt_ptr->eps_bearer_state_ptr->get_state_name());
