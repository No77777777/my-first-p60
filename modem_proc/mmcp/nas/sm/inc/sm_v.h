...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/sm/inc/sm_v.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define SM_QSH_ATTR_UNCOMPRESS __attribute__((section(".uncompressible.text")))
#else
#define SM_QSH_ATTR_UNCOMPRESS 
#endif
...
#define SM_PS_DEFAULT_PRI 0
#define SM_PS_HIGH_PRI 1
#endif 
/*=========================================================================
...
typedef struct sm_qsh_debug_metrics_s
{
  qsh_client_metric_context_id_t signaling_metric_context_id;
  sm_qsh_metric_signaling_s *ota_signaling_ptr;
}sm_qsh_debug_metrics_s_type;

#ifdef FEATURE_DUAL_DATA
extern sm_qsh_debug_metrics_s_type sm_qsh_debug_metrics_sim[MAX_AS_IDS];
#define sm_qsh_debug_metrics sm_qsh_debug_metrics_sim[sm_as_id]
#else
extern sm_qsh_debug_metrics_s_type sm_qsh_debug_metrics;
#endif
#endif
...
extern sys_data_activity_e_type sm_data_call_activity_status_sim[MAX_AS_IDS];
...
#ifdef FEATURE_DUAL_DATA
sys_data_activity_e_type sm_data_call_activity_status_get(void);
#endif
...
#ifdef FEATURE_DUAL_SIM
/* -----------------------------------------------------------------------
** FUNCTION     : send_gmm_ps_call_status_ind(), defined in smgmm.c

** DESCRIPTION  : Sends the GMMSM_PS_CALL_STATUS_IND command to the GMM task.
** ----------------------------------------------------------------------- */
extern void send_gmm_ps_call_status_ind(byte pri_type, boolean pdp_sig_in_progress);
...
/* --------------------------------------------------------------------------
** Primitive : SM_GET_NV_NAS_REL_COMPLAINCE, return ue_nas_rel_compliance_type
**  
** ------------------------------------------------------------------------*/
extern ue_nas_rel_compliance_type  sm_get_nv_nas_rel_compliance(void);
/* --------------------------------------------------------------------------
** Primitive : SM_GET_WCDMA_HSUPA_CATEGORY, return byte
**  
** ------------------------------------------------------------------------*/
extern byte sm_get_wcdma_hsupa_category(void);
