...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/sm/inc/esm_common.h#1 $
...
/*===========================================================
  Note -esm_bc_on_attach_def_bearer_state_T - update 
  debug enum "esm_bc_on_attach_def_bearer_state_debug_T " when this is updated
============================================================*/
typedef enum
{
