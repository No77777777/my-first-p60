...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/services/src/gsvoiceif.c#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
void ghdi_mvs_cb_func(mvs_event_type *event) 
{
  ...
  /* TBD */
            ...
            {
#if defined (FEATURE_INTER_RAT_HO_OPT) ||  defined(FEATURE_LTE)                  
