...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/services/inc/ghdi_exp_int.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
extern void ghdi_clear_hw_classmark_cache(
#ifdef FEATURE_DUAL_SIM
sys_modem_as_id_e_type as_id
#else
void
...
#ifdef FEATURE_DUAL_SIM
extern ghdi_status_T ghdi_ds_read_hw_classmark(hw_classmark_T *hw_classmark,sys_modem_as_id_e_type as_id);
#endif
