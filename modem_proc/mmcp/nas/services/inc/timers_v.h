...
$Header: //components/rel/mmcp.mpss/7.9.0/nas/services/inc/timers_v.h#1 $    $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
#define TIMER_MM_DUAL_SWITCH              59
...
#define TIMER_TDS_RAT_DEACTIVATION 62
#define TIMER_MM_PAGE_RETRY         63
#define TIMER_FRLTE         64


#define GSM_EXTENDED_BLOCK_TIMER         65
...
#define TIMER_T3425                     92

#define TIMER_EMC_BACKOFF              93
#define EMM_MT_PAGE_EXT_PRI_TIMER      94

#define TIMER_T3247                    95

#ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
#define TIMER_ELS_CONN_REL             96
#endif

#define TIMER_ESR_CONN_REL 97

#define TIMER_PROHIBIT_DS_DRX          98

#define TIMER_T3417_EXT_MT            99

#define TIMER_RADIO_CAP_ENQ           100

#define TIMER_LOCAL_REL_MSEARCH       101

#define TIMER_HOLD_TRM_LOCAL_REL     102

#define MIN_EMM_TIMER                  TIMER_T3410

#define MAX_EMM_TIMER                  TIMER_HOLD_TRM_LOCAL_REL

/*EMM Timers End here*/

#define MIN_MM_TIMER                  TIMER_T3210

#define MAX_MM_TIMER                  TIMER_HOLD_TRM_LOCAL_REL
...
#define MAX_MM_ONLY_TIMER             GSM_EXTENDED_BLOCK_TIMER
...
#ifdef FEATURE_LTE
#define REG_CFL_SEARCH_TIMER               0x17

#ifdef FEATURE_DUAL_SIM
#define REG_CFL_SEARCH_TIMER_SIM_ID_2      0x18
#ifdef FEATURE_TRIPLE_SIM 
#define REG_CFL_SEARCH_TIMER_SIM_ID_3      0x19
#endif
#endif
#endif
...
#define CB_WCDMA_PRIORITY_THRESHOLD_TIMER  0x03
...
#define CB_WCDMA_PRIORITY_THRESHOLD_TIMEOUT_VALUE_1  5
#define CB_WCDMA_PRIORITY_THRESHOLD_TIMEOUT_VALUE_2  120
/*
