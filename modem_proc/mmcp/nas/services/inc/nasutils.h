...
#define MSG_HIGH_DS_0( sub , str)\
    MSG_1 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub)

#define MSG_HIGH_DS_1( sub , str, p1)\
    MSG_2 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1))

#define MSG_HIGH_DS_2( sub , str, p1, p2)\
    MSG_3 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1), (p2))

#define MSG_HIGH_DS_3( sub , str, p1, p2, p3)\
    MSG_4 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1), (p2), (p3))

#define MSG_HIGH_DS_4( sub , str,p1, p2, p3, p4)\
    MSG_5 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub,(p1), (p2), (p3), (p4))

#define MSG_HIGH_DS_5( sub , str, p1, p2, p3, p4, p5)\
    MSG_6 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5))

#define MSG_HIGH_DS_6( sub , str, p1, p2, p3, p4, p5, p6)\
    MSG_7 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6))

#define MSG_HIGH_DS_7( sub , str, p1, p2, p3, p4, p5, p6, p7)\
    MSG_8 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7))

#define MSG_HIGH_DS_8( sub , str, p1, p2, p3, p4, p5, p6, p7, p8)\
    MSG_9 (MSG_SSID_DFLT, MSG_LVL_HIGH,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7), (p8))
	

#define MSG_MED_DS_0( sub , str)\
    MSG_1 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub)

#define MSG_MED_DS_1( sub , str, p1)\
    MSG_2 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub, (p1))

#define MSG_MED_DS_2( sub , str, p1, p2)\
    MSG_3 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub, (p1), (p2))
...
#define MSG_MED_DS_4( sub , str,p1, p2, p3, p4)\
    MSG_5 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub,(p1), (p2), (p3), (p4))

#define MSG_MED_DS_5( sub , str, p1, p2, p3, p4, p5)\
    MSG_6 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5))

#define MSG_MED_DS_6( sub , str, p1, p2, p3, p4, p5, p6)\
    MSG_7 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6))

#define MSG_MED_DS_7( sub , str, p1, p2, p3, p4, p5, p6, p7)\
    MSG_8 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7))

#define MSG_MED_DS_8( sub , str, p1, p2, p3, p4, p5, p6, p7, p8)\
    MSG_9 (MSG_SSID_DFLT, MSG_LVL_MED,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7), (p8))
	
    
#define MSG_LOW_DS_0( sub , str)\
    MSG_1 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub)

#define MSG_LOW_DS_1( sub , str, p1)\
    MSG_2 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub, (p1))

#define MSG_LOW_DS_2( sub , str, p1, p2)\
    MSG_3 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub, (p1), (p2))
...
#define MSG_LOW_DS_4( sub , str,p1, p2, p3, p4)\
    MSG_5 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub,(p1), (p2), (p3), (p4))

#define MSG_LOW_DS_5( sub , str, p1, p2, p3, p4, p5)\
    MSG_6 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5))

#define MSG_LOW_DS_6( sub , str, p1, p2, p3, p4, p5, p6)\
    MSG_7 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6))

#define MSG_LOW_DS_7( sub , str, p1, p2, p3, p4, p5, p6, p7)\
    MSG_8 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7))

#define MSG_LOW_DS_8( sub , str, p1, p2, p3, p4, p5, p6, p7, p8)\
    MSG_9 (MSG_SSID_DFLT, MSG_LVL_LOW,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7), (p8))

#define MSG_ERROR_DS_0( sub , str)\
    MSG_1 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub)

#define MSG_ERROR_DS_1( sub , str, p1)\
    MSG_2 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub, (p1))

#define MSG_ERROR_DS_2( sub , str, p1, p2)\
    MSG_3 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub, (p1), (p2))
...
#define MSG_ERROR_DS_4( sub , str,p1, p2, p3, p4)\
    MSG_5 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub,(p1), (p2), (p3), (p4))

#define MSG_ERROR_DS_5( sub , str, p1, p2, p3, p4, p5)\
    MSG_6 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5))

#define MSG_ERROR_DS_6( sub , str, p1, p2, p3, p4, p5, p6)\
    MSG_7 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6))

#define MSG_ERROR_DS_7( sub , str, p1, p2, p3, p4, p5, p6, p7)\
    MSG_8 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7))

#define MSG_ERROR_DS_8( sub , str, p1, p2, p3, p4, p5, p6, p7, p8)\
    MSG_9 (MSG_SSID_DFLT, MSG_LVL_ERROR,"DS: SUB %d " str , sub, (p1), (p2), (p3), (p4), (p5), (p6), (p7), (p8))
/*
