...
$Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/inc/sd_i.h#1 $
...
#define SD_MEM_FREE(x,y)  sdtask_mem_free((void**)(&(x)),y);
...
typedef struct
{
  ...
  */
  ...
  /* Flag to indicate whether acq fail is because of
  ** limited to no srv mapping when WRLF or other sub in srv.
  ** This avoids sending unnecessary no service internal and
  ** power save state to CM
  */
  boolean                              is_suppress_no_srv_rpt;
