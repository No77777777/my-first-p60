...
$Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdi.h#1 $
...
/*---------------------------------------------------------------------------
                         DEFAULT VALUES FOR SD TIMERS READ FROM EFS
---------------------------------------------------------------------------*/
...
#define SD_CALL_END_TELEBSR_DELTA_TIMER 20
#define SD_LTE_TELE_BSR_MAX_TIME 0

#if !(defined(FEATURE_SD_ALT_CDMA_BSR_SCAN_1) || defined(FEATURE_SD_ALT_EVDO_PWRUP_ALG_1))
#define SD_HDR_ALT_ALGR    0
#else
#define SD_HDR_ALT_ALGR    1
#endif

/* Min timer difference required to update an already running timer */
#define SDSS_MIN_TIMER_DIFF                   2

/*Range checks for BSR and OOS */
#define SD_3GPP_T_NORM_MAX_RANGE_LOW          10
#define SD_3GPP_T_NORM_MAX_RANGE_HIGH         300
#define SD_TIMER_MIN                          1
#define SD_3GPP_REPS_PER_STAGE_MIN            1
#define SD_3GPP_REPS_PER_STAGE_MAX            30
#define SD_3GPP_MAX_TIME_DELTA                60
...
#define SD_MMSS_BSR_INIT_VAL_NON_FULL_SYS     5
...
#define SD_TELE_BSR_ALGR_NDDS_DFT_VAL                        1   
#define SD_CDMA_TELE_BSR_STAGE1_TIME_NDDS_DFT_VAL            180
#define SD_CDMA_TELE_BSR_STAGE2_TIME_NDDS_DFT_VAL            180
#define SD_LTE_TELE_BSR_TIME_NDDS_DFT_VAL                    180
#define SD_TMR_LTE_LONG_RESEL_NDDS_DFT_VAL                   1440
#define SD_LTE_NOT_AVAIL_ACQ_FAIL_MAX_COUNT_NDDS_DFT_VAL     2
#define SD_LTE_TELE_BSR_STAGE_NDDS_DFT_VAL                   4
#define SD_LTE_TELE_BSR_RPT_COUNT_NDDS_DFT_VAL               2


#define SD_HDR_MAPE_AVOIDANCE_TIMER_DEFAULT          120
#define SD_HDR_MAPE_AVOIDANCE_TIMER_MAX              960
...
#define SD_ENHANCED_F3_DBG_NV_READ_FAIL    BM(4)
/*To debug the F3 pertaining to NV Read Fail */

#define SD_ENHANCED_F3_DBG_BRINGUP         BM(5)
/* To debug bringup issues / corner cases  */
