...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdprl.h#1 $
...
void sdprl_extract_mcc_mnc_from_cdma_imsi
(
  void
);
...
DESCRIPTION
  Checks if Primary Subscription is CT
...
extern boolean                         sdprl_plmn_roam_need_update
(
