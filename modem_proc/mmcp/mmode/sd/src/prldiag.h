...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/prldiag.h#1 $
...
#define DIAG_PR_LIST_WR_EXT_F  0
#define DIAG_PR_LIST_RD_EXT_F  1
#define SDLOG_MAX_F 2
...
DIAGPKT_SUBSYS_REQ_DEFINE(SD, DIAG_PR_LIST_WR_EXT_F)
byte seq_num;                       /* Sequence number */
byte more;                          /* More to come? */
byte nam;                           /* which NAM this is associated with */
word num_bits;                      /* length in bits of valid data */
...
DIAGPKT_SUBSYS_RSP_DEFINE(SD, DIAG_PR_LIST_WR_EXT_F)
byte rl_status;                   /* Status of block, as above */
#ifdef FEATURE_NV_ENUMS_ARE_WORDS
#error code not present
#else
...
DIAGPKT_SUBSYS_REQ_DEFINE(SD, DIAG_PR_LIST_RD_EXT_F)
byte seq_num;                       /* Sequence number */
byte nam;                           /* PR_LIST for this NAM */
byte asubs_id;                      /* Asubs id */
DIAGPKT_REQ_END
...
DIAGPKT_SUBSYS_RSP_DEFINE(SD, DIAG_PR_LIST_RD_EXT_F)
byte rl_status;                              /* Status of block, as above */
#ifdef FEATURE_NV_ENUMS_ARE_WORDS
#error code not present
#else
