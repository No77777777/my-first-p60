...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sddbg.h#1 $
...
do {\
qsh_mdump_set_crash_client(QSH_CLT_SD,QSH_CLT_SD); \
}while(0)
#else
#define QSH_MDUMP_SET \
do {\
...
#define SD_ERR_FATAL_0(str)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=SD= " str, 0, 0, 0 );\
}while(0)

#define SD_ERR_FATAL_1(str, a)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=SD= " str, (a), 0, 0 );\
}while(0)

#define SD_ERR_FATAL_2(str, a, b)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=SD= " str, (a), (b), 0 );\
}while(0)

#define SD_ERR_FATAL_3(str, a, b, c)\
do {\
QSH_MDUMP_SET;\
 ERR_FATAL( "=SD= " str, (a), (b), (c) );\
}while(0)
...
#define SD_ERR_3(str, a, b, c)       MSG_3( MSG_SSID_SD,             \
                                          MMODE_MSG_LEGACY_MED,      \
                                          "=SD= " str, (a), (b), (c) )
#define SD_ERR_1_EXT(str, a, sub_id)             MSG_1_EXT_V1( MSG_SSID_SD,             \
...
#define SD_MSG_HIGH_0_EXT(str, sub_id)        MSG_EXT_V1( MSG_SSID_SD,               \
                                              MMODE_MSG_LEGACY_HIGH, sub_id,           \
                                              "=SD= " str )
#define SD_MSG_HIGH_1_EXT(str, a, sub_id)  MSG_1_EXT_V1( MSG_SSID_SD,            \
                                           MMODE_MSG_LEGACY_HIGH, sub_id,  \
                                           "=SD= " str, (a) )
#define SD_MSG_HIGH_2_EXT(str, a, b, sub_id)     MSG_2_EXT_V1( MSG_SSID_SD,          \
                                           MMODE_MSG_LEGACY_HIGH, sub_id,    \
                                           "=SD= " str, (a), (b) )
#define SD_MSG_MED_2_EXT(str, a, b, sub_id)      MSG_2_EXT_V1( MSG_SSID_SD,               \
                                           MMODE_MSG_LEGACY_HIGH, ub_id,             \
                                           "=SD= " str, (a), (b) )
#define SD_MSG_HIGH_3_EXT(str, a, b, c, sub_id)  MSG_3_EXT_V1( MSG_SSID_SD,          \
                                         MMODE_MSG_LEGACY_HIGH, sub_id,    \
                                         "=SD= " str, (a), (b), (c) )
#define SD_MSG_MED_3_EXT(str, a, b, c, sub_id)   MSG_3_EXT_V1( MSG_SSID_SD,               \
                                                 MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                 "=SD= " str, (a), (b), (c) )
#define SD_MSG_HIGH_4_EXT(str, a, b, c, d, sub_id)  MSG_4_EXT_V1( MSG_SSID_SD,   \
                                           MMODE_MSG_LEGACY_HIGH, sub_id,   \
                                           "=SD= " str, (a), (b), (c), (d) )
#define SD_MSG_MED_4_EXT(str, a, b, c, d, sub_id)  MSG_4_EXT_V1( MSG_SSID_SD,    \
                                           MMODE_MSG_LEGACY_HIGH, sub_id,   \
                                           "=SD= " str, (a), (b), (c), (d) )
#define SD_MSG_HIGH_5_EXT(str, a, b, c, d, e, sub_id)  MSG_5_EXT_V1( MSG_SSID_SD,            \
                                             MMODE_MSG_LEGACY_HIGH, sub_id,    \
                                             "=SD= " str, (a), (b), (c), (d), (e) )
#define SD_MSG_MED_5_EXT(str, a, b, c, d, e, sub_id)  MSG_5_EXT_V1( MSG_SSID_SD,             \
                                               MMODE_MSG_LEGACY_HIGH, sub_id,  \
                                               "=SD= " str, (a), (b), (c), (d), (e) )
#define SD_MSG_HIGH_6_EXT(str, a, b, c, d, e, f, sub_id)    MSG_6_EXT_V1( MSG_SSID_SD,      \
                                              MMODE_MSG_LEGACY_HIGH, sub_id,          \
                                              "=SD= " str, (a), (b), (c), (d), (e), (f) )
#define SD_MSG_MED_6_EXT(str, a, b, c, d, e, f, sub_id)    MSG_6_EXT_V1( MSG_SSID_SD,         \
                                                MMODE_MSG_LEGACY_HIGH, sub_id,          \
                                                "=SD= " str, (a), (b), (c), (d), (e), (f) )

#else

#define SD_MSG_HIGH_0_EXT(str, sub_id)        MSG( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=SD= " str )
#define SD_MSG_HIGH_1_EXT(str, a, sub_id)  MSG_1( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=SD= " str, (a) )
#define SD_MSG_HIGH_2_EXT(str, a, b, sub_id)     MSG_2( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=SD= " str, (a), (b) )
#define SD_MSG_MED_2_EXT(str, a, b, sub_id)      MSG_2( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,             \
                                         "=SD= " str, (a), (b) )
#define SD_MSG_HIGH_3_EXT(str, a, b, c, sub_id)  MSG_3( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=SD= " str, (a), (b), (c) )
#define SD_MSG_MED_3_EXT(str, a, b, c, sub_id)   MSG_3( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,             \
                                         "=SD= " str, (a), (b), (c) )
#define SD_MSG_HIGH_4_EXT(str, a, b, c, d, sub_id)  MSG_4( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=SD= " str, (a), (b), (c), (d) )
#define SD_MSG_MED_4_EXT(str, a, b, c, d, sub_id)  MSG_4( MSG_SSID_SD,               \
                                         MMODE_MSG_LEGACY_HIGH,             \
                                         "=SD= " str, (a), (b), (c), (d) )
#define SD_MSG_HIGH_5_EXT(str, a, b, c, d, e, sub_id)  MSG_5( MSG_SSID_SD,               \
                                           MMODE_MSG_LEGACY_HIGH,            \
                                           "=SD= " str, (a), (b), (c), (d), (e) )
#define SD_MSG_MED_5_EXT(str, a, b, c, d, e, sub_id)  MSG_5( MSG_SSID_SD,               \
                                           MMODE_MSG_LEGACY_HIGH,             \
                                           "=SD= " str, (a), (b), (c), (d), (e) )
#define SD_MSG_HIGH_6_EXT(str, a, b, c, d, e, f, sub_id)    MSG_6( MSG_SSID_SD,               \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=SD= " str, (a), (b), (c), (d), (e), (f) )
#define SD_MSG_MED_6_EXT(str, a, b, c, d, e, f, sub_id)    MSG_6( MSG_SSID_SD,               \
                                              MMODE_MSG_LEGACY_HIGH,             \
                                              "=SD= " str, (a), (b), (c), (d), (e), (f) )
...
#define SD_MSG_SCRIPT(string, string_array,sub, stk) \
          MSG_SPRINTF_3(MSG_SSID_DFLT, MSG_LEGACY_HIGH, string "%s ** on sub %d stk %d", string_array, sub, stk)
#endif

/* Message macro wrapper used to print out appropriate log message with subsciption id 
** depending on whether the feature to print enhanced F3 messages for activated scripts
** has been enabled.
*/
#ifdef FEATURE_SD_ENHANCED_DEBUG_MSG
#define SD_MSG_SCRIPT_EXT(string, string_array,sub, stk, diag_sub) \
          MSG_SPRINTF_3_EXT(MSG_SSID_DFLT, MSG_LEGACY_HIGH, DIAG_EXT_API_VERSION_1, diag_sub,\
                            string "%s ** on sub %d stk %d", string_array, sub, stk)
#endif
...
#error code not present
#else
#define SD_ASSERT_STACK_ACTIVE(stk_id)
#endif

#ifdef SD_DEBUG
#error code not present
#else
#define SD_ASSERT_STACK_ACTIVE_SUBS(asubs_id,stk_id)
#endif
