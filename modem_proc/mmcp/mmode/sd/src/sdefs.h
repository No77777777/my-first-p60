...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdefs.h#5 $
...
#define SDEFS_SUB_SCAN_SCOPE_F_NAME       "/nv/item_files/modem/mmode/sd/sub_scan_scope"
#define SDEFS_ENABLE_FULLRAT_OPTIMISATION_F_NAME "/nv/item_files/modem/mmode/enable_fullrat_optimisation"
#define SDEFS_MMODE_MRU_EXT_NAM_1_F_NAME "/sd/mru001_ext"
#define SDEFS_MMODE_MRU_EXT_NAM_2_F_NAME "/sd/mru002_ext"
#define SDEFS_FULL_SRV_REQ_EMERG_EXT_F_NAME "/nv/item_files/modem/mmode/sd/full_srv_req_in_emerg_ext"
#define SDEFS_FOLLOW_TOT_F_NAME "/nv/item_files/modem/mmode/follow_tot"
#define SDEFS_EMERG_CALL_1X_SCAN_FIRST_NAL_RESTRICTED_F_NAME "/nv/item_files/modem/mmode/sd/em_call_1x_scan_first_restricted"

#define SDEFS_MCC_LIST_EMERG_CALL_FULL_SRV_F_NAME "/nv/item_files/modem/mmode/sd/mcc_list_emerg_call_full_srv"
#define SDEFS_SD_DEVICE_CONFIG_TIMERS_F_NAME "/nv/item_files/modem/mmode/sd/sd_device_config_timers"
#define SDEFS_SKIP_EMERG_CALL_FULL_SRV_F_NAME "/nv/item_files/modem/mmode/sd/skip_emerg_call_full_srv"
#define SDEFS_SD_PSUEDO_PRL_CREATION_F_NAME        "/nv/item_files/modem/mmode/sd/sd_psuedo_prl_creation"
#define SDEFS_PSAP_CALL_BACK_MANDATORY_F_NAME        "/nv/item_files/modem/mmode/psap_call_back_mandatory"
#define SDEFS_E911_PRIORITIZE_CS_F_NAME "/nv/item_files/modem/mmode/sd/e911_prioritize_cs"
#define SDEFS_SPECIAL_SCAN_MCC_LIST_F_NAME "/nv/item_files/modem/mmode/sd/special_scan_mcc_list"
...
typedef enum
{
  ...
  SDEFS_MRU_NAM_1,          /**< EFS id for MRU for NAM 1 - NV65627 */
  SDEFS_MRU_NAM_2,          /**< EFS id for MRU for NAM 2 - NV65628 */
  SDEFS_MMSS_TIMER,         /**< EFS id MMSS timer */
  SDEFS_BST_TBL,            /**< EFS BST table */
  SDEFS_MMSS_EQPRL,         /**< EFS id for Equivalent PRL created for MMSS */
  SDEFS_SDSSSCR_TIMERS,     /**< EFS id for storing Timers used SD Scripts -NV65819 */
  ...
  /* Enter all EFS items that can be read and written to by SD above this - NV69730
  */
  SDEFS_QMSS_ENABLED,       /**< EFS id for enabling QMSS/QRD Features - NV70301 */
  SDEFS_OPERATOR_NAME,      /**< EFS id for operator name - NV70302 */
  SDEFS_1XCSFB_ECBM,        /**< EFS id for 1X_CSFB_ECBM Feature - NV70354 */
  SDEFS_LOCK_SID_NID,       /**< EFS id for Lock SID NID */
  SDEFS_FULL_SRV_REQ_EMERG, /**< EFS id for FULL SRV REQ in emerge orig - NV72621 */
  SDEFS_MANUAL_SRCH_BST_TBL,/**< EFS id for manual search bst table */
  SDEFS_MANUAL_SEARCH_IN_WRLF, /**< EFS id for MANU SEARCH in WRLF - NV72592 */
  SDEFS_1XCSFB_CALL_END_OPT,   /**< EFS id for 1X_CSFB call end optimisation  Feature - NV72590 */
  SDEFS_BUFFER_INT_SRV_LOST, /**< EFS id for buffering no srv due to TRM failure - NV72597 */
  SDEFS_RECENTLY_ACQUIRED_LIST, /* EFS id for RAL */
  SDEFS_EMERGENCY_RAT_ACQ_ORDER, /* NV72589 */
  SDEFS_EXTEND_LBSR_1x_ACTIVE, /* NV73539 */
  SDEFS_ROAM_IND_UPDATE_IN_L_TO_1X_HO, /*EFS for controlling the romaing ins updation during L to 1X HO - NV73583*/
  SDEFS_1XSIB8_SCAN_OPT,    /* EFS id for 1x scan based on SIB8 info feature - NV73577 */
  SDEFS_ENHANCED_F3_DBG_RULE,  /* EFS id for enabling enhanced F3 - NV73873 */
  SDEFS_MRU_EXT_NAM_1,      /*EFS ID for extended MRU structure(with 256 LTE bands) for NAM 1 - NV73942 */
  SDEFS_MRU_EXT_NAM_2,      /*EFS ID for extended MRU structure(with 256 LTE bands) for NAM 2 - NV73943 */
  SDEFS_FULL_SRV_REQ_EMERG_EXT, /**< EFS id for FULL SRV REQ in emerg orig EXT - NV73969 */
  SDEFS_MCC_LIST_EMERG_CALL_FULL_SRV, /* EFS ID for MCC list on which emergency call needs to be attempted in full service - NV74042*/
  SDEFS_EMERG_CALL_1X_SCAN_FIRST_NAL_RESTRICTED, /* EFS ID for China Emergency Number categorization feature status */
  SDEFS_SD_DEVICE_CONFIG_TIMERS, /* EFS ID for 1x and LTE telescopic timers on non DDS sub */
  SDEFS_SKIP_EMERG_CALL_FULL_SRV,/* EFS ID to skip SDEFS_MCC_LIST_EMERG_CALL_FULL_SRV*/
  SDEFS_PSAP_CALL_BACK_MANDATORY,/*EFS ID to ensure PSAP call back will be possible when originating EM call -- NV74379*/
  SDEFS_E911_PRIORITIZE_CS,  /*EFS ID for prioritising CS RATs for Emerg Orig*/
  SDEFS_SPECIAL_SCAN_MCC_LIST, /* EFS ID for special scan MCC list - NV74698 */
  ...
  */
  SDEFS_MMSS_IGNORE_UPLMN,  /**< EFS ignore uplmn - NV65605 */
  SDEFS_FEATURE_JCDMA,     /* EFS id for JCDMA feature - NV65810 */
  SDEFS_WCDMA_FREQ_LOCK,   /* EFS id for WCDMA FREQ LOCK status - NV65818 */
  SDEFS_CUSTOM_EMERG_INFO, /* EFS id for custom emerg info - NV71522 */
  SDEFS_SCAN_SCOPE_RULE,   /* EFS id for scan_scope_type - NV73502 */
  SDEFS_CSG_AUTO_MODE,    /*  EFS id for csg auto mode info - NV72541 */
  SDEFS_EHRPD_OPT_REDIAL, /* EFS id for new opt SR feature - NV72593 */
  SDEFS_C2K_RESEL_SPLMN, /* NV72518 */
  SDEFS_EMERG_CALL_AFTER_LU_IN_LPM, /* NV73629 */
  SDEFS_EMERG_CALL_1X_SCAN_FIRST, /* EFS ID for 1x scan first for China operators - NV73825 */
  SDEFS_CUSTOM_VOWIFI_CONFIG, /* NV73545 */
  SDEFS_SUB_SCAN_SCOPE, /* NV73909 */
  SDEFS_ENABLE_FULLRAT_OPTIMISATION, /* NV73929 */
  SDEFS_FOLLOW_TOT, /* EFS ID for following tot in mmss config - NV74001 */
  SDEFS_SD_PSUEDO_PRL_CREATION,
  SDEFS_MAX
} sdefs_id_e_type;
...
FUNCTION sdefs_file_exists_per_subs

DESCRIPTION
  Returns if the item file exists in the NV

DEPENDENCIES
  None

RETURN VALUE
  TRUE if the NV item exists
  FALSE if the NV item does not exist

SIDE EFFECTS
  None

==========================================================================*/
extern boolean                  sdefs_file_exists_per_subs(
