...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdprl.c#1 $
...
typedef struct
{
  ...
  */
  ...
  sys_mcc_type                    cdma_mcc;
  /*Stores MCC of Primary 1x Subscription*/

  sys_mnc_type                    cdma_mnc;
  /*Stores MNC of Primary 1x Subscription*/
...
)
{
  ...
  if( global_sd_asubs_id >= MAX_SIMS || global_sd_asubs_id < 0 ||
      sdprl[global_sd_asubs_id] == NULL
    )
  {
    return ret_plmn;
  }

  sdprl_ptr = sdprl[global_sd_asubs_id];
  ...
  */
  ...
  if (prl_sr != NULL)
  {
    SD_MEM_FREE((prl_sr), MODEM_MEM_CLIENT_MMODE);
  }
  else
  {
    sys_err_fatal_null_ptr_exception();
  ...
  if (prl_parser != NULL)
  {
    SD_MEM_FREE((prl_parser), MODEM_MEM_CLIENT_MMODE);
  }
  else
  {
    sys_err_fatal_null_ptr_exception();
...
EXTERN void sdprl_free_gwl_more_pref_list(sys_sys_mode_e_type sys_mode)
{
  ...
  for (ix=0; ix<more_pref_list->num && node_ptr!= NULL; ix++)
  {
    ...
    node_ptr =node_ptr->next;
    SD_MEM_FREE(node_ptr_temp, MODEM_MEM_CLIENT_MMODE);
  }
...
)
{
  ...
  if(lte_band_pref != NULL)
  {
    ...
    lte_band_pref->bit_143_128   = (word) ((word)  sd_lte_band_pref.bits_129_192 & 0xffff );
    lte_band_pref->bit_159_144   = (word) ((uint64)sd_lte_band_pref.bits_129_192 >> 16 );
    lte_band_pref->bit_175_160   = (word) ((uint64)sd_lte_band_pref.bits_129_192 >> 32 );
    lte_band_pref->bit_191_176   = (word) ((uint64)sd_lte_band_pref.bits_129_192 >> 48 );

    lte_band_pref->bit_207_192   = (word) ((word)  sd_lte_band_pref.bits_193_256 & 0xffff );
    lte_band_pref->bit_223_208   = (word) ((uint64)sd_lte_band_pref.bits_193_256 >> 16 );
    lte_band_pref->bit_239_224   = (word) ((uint64)sd_lte_band_pref.bits_193_256 >> 32 );
    lte_band_pref->bit_255_240   = (word) ((uint64)sd_lte_band_pref.bits_193_256 >> 48 );
#else /*LTE_BAND_NUM=64 making sd_lte_band_pref a uint64 datatype */
...
)
{
  ...
  if(sd_lte_band_pref != NULL)
  {
    ...
    band.bits_65_128 |= (uint64)((uint64)lte_band_pref.bit_127_112<<48);

    band.bits_129_192  = (uint64)lte_band_pref.bit_143_128;
    band.bits_129_192 |= (uint64)((uint64)lte_band_pref.bit_159_144<<16);
    band.bits_129_192 |= (uint64)((uint64)lte_band_pref.bit_175_160<<32);
    band.bits_129_192 |= (uint64)((uint64)lte_band_pref.bit_191_176<<48);

    band.bits_193_256  = (uint64)lte_band_pref.bit_207_192;
    band.bits_193_256 |= (uint64)((uint64)lte_band_pref.bit_223_208 <<16);
    band.bits_193_256 |= (uint64)((uint64)lte_band_pref.bit_239_224 <<32);
    band.bits_193_256 |= (uint64)((uint64)lte_band_pref.bit_255_240 <<48);
#else /* LTE_BAND_NUM = 64 making sys_lte_band_mask_e_type band a uint64 datatype.*/
    ...
    case SD_MODE_HDR_:
...
#endif
      {
        switch( band )
        {
          ...
          case SD_BAND_BC3:
            return sdprl_cdma_bc3_chan_to_blksys( chan );
          case SD_BAND_BC4:
            return sdprl_cdma_bc4_chan_to_blksys( chan );
          case SD_BAND_BC5:
            return sdprl_cdma_bc5_chan_to_blksys( chan );
          case SD_BAND_BC6:
            return sdprl_cdma_bc6_chan_to_blksys( chan );
          case SD_BAND_BC10:
            return sdprl_cdma_bc10_chan_to_blksys( chan );
          case SD_BAND_BC11:
            return sdprl_cdma_bc11_chan_to_blksys( chan );
          case SD_BAND_BC12:
            return sdprl_cdma_bc12_chan_to_blksys( chan );
          case SD_BAND_BC14:
            return sdprl_cdma_bc14_chan_to_blksys( chan );
          case SD_BAND_BC15:
            return sdprl_cdma_bc15_chan_to_blksys( chan );
          case SD_BAND_BC16:
            return sdprl_cdma_bc16_chan_to_blksys( chan );
          case SD_BAND_BC17:
            return sdprl_cdma_bc17_chan_to_blksys( chan,mode );
          case SD_BAND_BC18:
            return sdprl_cdma_bc18_chan_to_blksys( chan );
          case SD_BAND_BC19:
            return sdprl_cdma_bc19_chan_to_blksys( chan );
          default:
            break;
        }
      }
  ...
  */
  for( i=0; (sr_ptr=sdsr_list_get_ptr(SDSR_PRL_LST, i)) != NULL; i++ )
  {
    if( sdss_sr_is_mode_pref(sr_ptr, mode_pref) &&
        sdss_sr_is_band_pref(sr_ptr, band_pref, lte_band_pref, tds_band_pref, MM_STACK_0) )
    {
      return TRUE;
    }
  }
...
)
{
  ...
  */
  ...
  /* Populate plmn field.
  */
  if( prl_acq_rec_ptr->acq_type == PRL_ACQ_REC_3GPP_GENERIC ||
...
)
{
  ...
  */
  ...
  (void) sdnv_read_extn(NV_HOME_SID_NID_I, item_ptr, (uint16)global_sd_asubs_id);
...
)
{
  ...
  */
  ...
  (void) sdnv_read_extn(NV_SID_NID_LOCK_I, item_ptr, (uint16)global_sd_asubs_id);
  ...
  */
  ...
  if ( (sdss_get_operator_name ( global_sd_asubs_id ) == SD_OPERATOR_CT))
  {
    /*Read Persistent Lock Sid Nid*/
    if(sdefs_fs_read_per_subs(SDEFS_LOCK_SID_NID, (byte *)&sdprl_locked_buf,&size, global_sd_asubs_id ))
    {
    ...
    else
    {
      ...
      */
      ...
      if(!sdefs_fs_write_per_subs(SDEFS_LOCK_SID_NID,(byte *)&sdprl_locked_buf,sizeof(sdprl_sid_nid_lock_type),global_sd_asubs_id))
      {
        SD_MSG_HIGH_0("1x_sub2 FAIL : LOCK SID NID WRITE");
      }
    }
  }
    ...
    const prli_sys_rec_type *prl_sr)
{
  ...
  if (prl_ar != NULL)
  {
    ...
    SD_MEM_FREE((prl_ar), MODEM_MEM_CLIENT_MMODE);
  }
...
)
{
  ...
  memscpy( mru_buf,
           mru_buf_size,
           sdprl[global_sd_asubs_id]->nam_info[nam].mem_mru_tbl,
           sizeof(sdprl[global_sd_asubs_id]->nam_info[nam].mem_mru_tbl)
...
)
{
  ...
  memscpy( sdprl[global_sd_asubs_id]->nam_info[nam].mem_mru_tbl,
           sizeof(sdprl[global_sd_asubs_id]->nam_info[nam].mem_mru_tbl),
           mru_buf,
           mru_buf_size );
...
)
{
  ...
  memscpy( mru_buf,
           mru_buf_size,
           sdprl[global_sd_asubs_id]->nam_info[nam].mru_tbl,
           sizeof(sdprl[global_sd_asubs_id]->nam_info[nam].mru_tbl) );
  SD_CRIT_SECT_EXIT();
...
)
{
  ...
  SD_CRIT_SECT_ENTER();
  memscpy( sdprl[global_sd_asubs_id]->nam_info[nam].mru_tbl,
           sizeof(sdprl[global_sd_asubs_id]->nam_info[nam].mru_tbl),
           mru_buf,
           mru_buf_size );
  SD_CRIT_SECT_EXIT();
...
)
{
  ...
  */
#if defined(LTE_BAND_NUM) && (LTE_BAND_NUM == 256)
  if( !sdefs_fs_read_per_subs(efs_id_ext, (byte *)&mru_buf_ext, &size_mru_ext,global_sd_asubs_id ))
#endif
  {
    if(sdss_get_enhanced_f3_dbg_rule() & SD_ENHANCED_F3_DBG_NV_READ_FAIL)
    {
      SD_MSG_HIGH_1("MRU_READ: MRU EXT NV failed, sub %d", global_sd_asubs_id);
    }
    if( !sdefs_fs_read_per_subs(efs_id, (byte *)&mru_parameters, &size_mru,global_sd_asubs_id ))
    {
      if(sdss_get_enhanced_f3_dbg_rule() & SD_ENHANCED_F3_DBG_NV_READ_FAIL)
      {
        SD_MSG_HIGH_1("MRU_READ: MRU NV failed, sub %d", global_sd_asubs_id);
      }
  ...
  */
  ...
  for( i=0;
       ...
       i < NV_MRU_TABLE_SIZE &&
       i < ARR_SIZE(mru_parameters.entry);
...
static  void                      sdprl_custom_home_read( void )
{
  ...
  ** conversion.
  */
  if( !sdnv_read_extn(NV_ROAM_IND_CUSTOM_HOME_I,
                      (nv_item_type *) roam_ind_custom_home, (uint16)global_sd_asubs_id))
  {
    ...
    */
    ...
    (void)sdnv_write_extn(NV_ROAM_IND_CUSTOM_HOME_I,
                          (nv_item_type *) roam_ind_custom_home,(uint16)global_sd_asubs_id);
#endif
...
)
{
  ...
  SD_MSG_HIGH_2( "MRU_WRITE: NAM=%d, sub %d", nam, global_sd_asubs_id);
  ...
  */
  ...
  /* #------# */
  sdefs_fs_write_per_subs(efs_id, (byte *)&mru_parameters, size_mru,global_sd_asubs_id );
  ...
  sdefs_fs_write_per_subs(efs_id, (byte *)&mru_buf_ext, size_mru_ext,global_sd_asubs_id );
#endif
...
)
{
  ...
  */
  ...
  /* Return NULL if in manual mode but not copying for user list
  ** or not in manual mode but is copying for user list
  */
  if(list != SDSR_GWL_LAST_USER_SYS && sid_exp.net_select_mode == SD_NET_SELECT_MODE_MANUAL_SYS )
  {
    sr_ref = SDSR_REF_NULL;
  }
  else if(list == SDSR_GWL_LAST_USER_SYS && sid_exp.net_select_mode != SD_NET_SELECT_MODE_MANUAL_SYS)
  {
    sr_ref = SDSR_REF_NULL;
  }
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
)
{
  ...
  */
  ...
  SD_MEM_FREE(mru_buf,MODEM_MEM_CLIENT_MMODE);
...
{
  sdprl_s_type    *sdprl_ptr = sdprl[asubs_id];
  ...
  SD_MSG_HIGH_3("MRU_UPDATE: During LPM, record index %d, mode %d, sub %d",
                index, mode, global_sd_asubs_id);

  /* Point at structure that contains the information of the specified NAM.
    */
  nam_ptr = &sdprl_ptr->nam_info[sdprl[asubs_id]->curr_nam];
...
)
{
  ...
  sdsr_s_type       *sr_ptr;
  sd_mmode_mru_table_entry_u_type mru_buf[NV_MRU_TABLE_SIZE];
  sd_mmode_mru_table_entry_u_type hdr_mru_buf[NV_MRU_TABLE_SIZE];
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  SD_MSG_HIGH_6("MRU LIST_TO_NAM: list %d cnt %d, hybr_list %d cnt %d, user_list %d cnt %d",
                list, sdsr_list_cnt(list),
                hybr_list, sdsr_list_cnt(hybr_list),
                user_list, sdsr_list_cnt(user_list));
  ...
  */
  ...
  /*Get the MRUs from the nam_sel to hdr_mru_buf to restore the previous values when hybr MRU list is empty
  * This is to make sure the hybr MRU systems are not lost
  */

  else
  {
    sdprl_get_nam_mru( nam, sizeof(hdr_mru_buf), hdr_mru_buf );
    SD_ASSERT( SDPRL_MRU_NUM_HYBR_ENTRIES < NV_MRU_TABLE_SIZE);
    ...
    {
      memscpy(&mru_buf[i], sizeof(mru_buf[i]),
              &hdr_mru_buf[i], sizeof(hdr_mru_buf[i]));
    }
  }
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
#if defined(FEATURE_SD_LTE) || defined FEATURE_GSM
          mru_buf[i].gwl.mode = (byte) sr_ptr->sys.mode;
          sdprl_map_sd_band_pref_to_mru_band_pref3(
            sr_ptr->sys.band,
            &mru_buf[i].gwl.band_pref,
...
#if defined(SD_GSM_SUPPORTED) || defined(SD_WCDMA_SUPPORTED)  || defined(FEATURE_SD_LTE)
    if( prl_acq_rec.acq_type == PRL_ACQ_REC_3GPP_GENERIC ||
...
)
{
  ...
  pch_a = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].pch_a;
  pch_b = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].pch_b;
  sch_a = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].sch_a;
  sch_b = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].sch_b;
...
)
{
  ...
  jtacs_pch_a = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].jtacs_pch_a;
  jtacs_pch_b = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].jtacs_pch_b;
  jtacs_sch_a = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].jtacs_sch_a;
  jtacs_sch_b = sdprl[global_sd_asubs_id]->nam_info[sdprl[global_sd_asubs_id]->curr_nam].jtacs_sch_b;
      ...
      switch( acq_rec->type.gwl_generic.pri_lst[i] )
      {
        case SD_MODE_GSM:
          ...
          */
          ...
          if( SD_GET_COMMON_BAND( sd_sr_ptr->sid.gw.band.chgwt_band, band_pref ))
          {
            return SDPRL_MATCH_SID_MODE_BAND_CHAN;
          }
        ...
        {
          sys_lte_band_mask_e_type lte_band_pref = SYS_LTE_BAND_MASK_CONST_NONE;
          sys_lte_band_mask_e_type sd_sr_lte_band =  (sd_sr_ptr->sid.gw.band.lte_band);
...
)
{
  ...
  switch( acq_rec->acq_type )
  {
    ...
    case PRL_ACQ_REC_RESERVED2:
    case PRL_ACQ_REC_RESERVED3:
...
)
{
  ...
  */
  ...
  SD_MEM_FREE(acq_rec,MODEM_MEM_CLIENT_MMODE);
  ...
  */
  if ( i < ARR_SIZE(nam_ptr->lock_sid_nid))
  {
    ...
    */
    ...
    if ( (sdss_get_operator_name ( global_sd_asubs_id ) == SD_OPERATOR_CT)  && sdprl_is_ct_sim_card() )
    {
      /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
)
{
  ...
  if((lte_ss == MM_STACK_ALL) || (mcc_list_ptr == NULL))
  {
    return;
  }
...
)
{
  ...
  sdsr_s_type           sr;/* This being used only for 1x manipulation, it is ok to not use sdsr_create_sr_rec_copy */
  sdprl_s_type          *sdprl_ptr        = NULL;
  sdsr_e_type           geo_lst;
  ...
  */
  ...
  if ( ( ss == MM_STACK_0 || ss == MM_STACK_1 ) && mcc_list_ptr )
  {
...
)
{
  ...
  */
  ...
  SD_MEM_FREE((trav_parser), MODEM_MEM_CLIENT_MMODE);
...
FUNCTION sdprl_create_pref_lst_per_geo

DESCRIPTION
  create the GEO_PREF list for input system record based on the input GEO idx
...
static void sdprl_create_pref_lst_per_geo
(
  word            geo_idx,
  const sdsr_s_type *sr1_ptr
)
{
  ...
  sdprl_parser_s_type         *prl_parser_geo = NULL;
  sdprl_s_type                *sdprl_ptr = NULL;
  prli_sys_rec_type           prl_sr;
  ...
  sdprl_parser_lists_init( parser_lists,
                           SDSR_MAX,
                           SDSR_GEO_ACQ_PREF_LST,
                           SDSR_MAX );
  /*init prl_parser_geo to sr1*/
  if((prl_parser_geo = (sdprl_parser_s_type *)modem_mem_alloc(sizeof (sdprl_parser_s_type),
                       MODEM_MEM_CLIENT_MMODE)) == NULL)
  {
    sys_err_fatal_null_ptr_exception();
  }
  ...
  {
    memset(prl_parser_geo, 0, sizeof (sdprl_parser_s_type));
  }
  sdprl_parser_init( prl_parser_geo,
                     MM_STACK_0,
                     (byte *) sdprl_ptr->prl_ptr,
                     sdprl_ptr->prl_hdr_ptr );

  while(sdprl_parser_next_match(prl_parser_geo, sr1_ptr, &prl_sr, NULL))
  {
    if(prl_parser_geo->geo_idx == geo_idx)
    {

      sdprl_parser_app_geo_pref_assn( prl_parser_geo,
                                      parser_lists,
                                      sr1_ptr->sys.mode,
                                      NULL,
                                      MM_STACK_2,
  ...
  sdsr_list_print(SDSR_GEO_ACQ_PREF_LST, FALSE);

  if (parser_lists != NULL)
  {
    SD_MEM_FREE((parser_lists), MODEM_MEM_CLIENT_MMODE);
  }
  else
  {
    sys_err_fatal_null_ptr_exception();
  ...
  if (prl_parser_geo != NULL)
  {
    SD_MEM_FREE((prl_parser_geo), MODEM_MEM_CLIENT_MMODE);
  }
  else
  {
    sys_err_fatal_null_ptr_exception();
...
EXTERN  boolean                   sdprl_is_more_pref_upto_2(
  ...
  multimode_stack_e_type               sr1_ss,
  /* System selection - MAIN or HDR.
  */

  multimode_stack_e_type               sr2_ss,
  /* System selection - MAIN or HDR.
  */
  ...
  */
  boolean                  *is_geo_match,

  boolean                   is_create_geo_pref_req
  /*if need to create GEO_PREF_LIST*/
)
{
  sdprl_s_type                *sdprl_ptr = NULL;
  ...
  */
  ...
  SD_MSG_HIGH_6("sdprl_is_more_pref_upto_2, sr1.prl=%d, sr2.prl=%d, sr1.mode=%d, sr2.mode=%d, depth=%d, is_create_geo_pref_req=%d",
                sr1_ptr->prl, sr2_ptr->prl, sr1_ptr->sys.mode, sr2_ptr->sys.mode, depth, is_create_geo_pref_req);
          ...
          sdprl_parser_sys_is_in_geo(prl_parser, sr1_ptr) )
      {
        ...
        */
        ...
        if( sdprl_parser_sys_is_more_pref(prl_parser,
                                          ...
                                          sr2_ptr->sys.mode) )
        {
          /*if both systems are in same GEO, and sr1 is more preferred, generate the pref list within that GEO for sr1 */
          if(is_create_geo_pref_req)
          {
            sdprl_create_pref_lst_per_geo(prl_parser->geo_idx, sr1_ptr);
          }
          if (prl_sr != NULL)
          {
          ...
          if (prl_parser != NULL)
          {
            SD_MSG_HIGH_2("sdprl_parser_sys_is_more_pref:,geo_idx=%d,lvl:%d",prl_parser->geo_idx,match_lvl);
            SD_MEM_FREE((prl_parser), MODEM_MEM_CLIENT_MMODE);
          }
          else
          {
  ...
  */
      ...
      sdss_sr_is_prl(sr2_ptr, SDSS_PRL_VAL_ALLOWED) )
  {
    ...
    if( comp > 0 )
    {
      ...
      SD_MSG_HIGH_1( "compare prl for ALLOW SYS ,TRUE:comp:%d",comp);
      return TRUE;
    }
...
===========================================================================*/
EXTERN  boolean                   sdprl_is_more_or_same_pref(
...
)
{
  ...
  */
  ...
  SD_MSG_HIGH_3("sdprl_is_mode_or_same_pref, sr1.prl=%d, sr2_local.prl=%d, depth=%d",
  ...
  */
      ...
      sdss_sr_is_prl(sr2_ptr_local, SDSS_PRL_VAL_ANY_PREF) )
  {
    ...
    */
    do
    {
      if( sdprl_sys_is_match(sr1_ptr, prl_sr, &match_lvl) &&
          (byte) match_lvl >= sr1_ptr->match_lvl &&
          sdprl_parser_sys_is_in_geo(prl_parser, sr1_ptr) )
      {
        /* We found a GEO that contains both systems. If system 2 is not more
        ** preferred return TRUE. Else, return FALSE.
        */
        SD_MSG_HIGH_3("GEO found,geo_idx=%d,sr2_sys_idx=%d,lvl:%d",prl_parser->geo_idx,prl_parser->sys_idx,match_lvl);
        if( !sdprl_parser_sys_is_more_pref(prl_parser,
    ...
    while( sdprl_parser_next_match(prl_parser, sr1_ptr, prl_sr, NULL) );
  ...
  */
  ...
  return sdprl_is_more_pref_upto_2(sr1_ss, sr2_ss, sr1_ptr, sr2_ptr,depth, NULL, FALSE);
...
FUNCTION sdprl_update_cdma_imsi
...
EXTERN void sdprl_update_cdma_imsi(
  sys_modem_as_id_e_type asubs_id,
...
{
  SD_MSG_HIGH_2("sdprl_update_cdma_imsi - cdma_imsi: data size %d card_imsi_val:%x",
                data_size, card_imsi_val);
  ...
  memset(sdprl[asubs_id]->cdma_imsi,0,SD_CT_CDMA_IMSI_LEN);
  memscpy(sdprl[asubs_id]->cdma_imsi,SD_CT_CDMA_IMSI_LEN,card_imsi_val,data_size);
}

/*===========================================================================

FUNCTION sdprl_extract_mcc_mnc_from_cdma_imsi

DESCRIPTION
  Update the MCC and MNC from card_imsi value
...
EXTERN void sdprl_extract_mcc_mnc_from_cdma_imsi
(
  void
)
{
  ...
  word decode_card_mcc=0, decode_card_mnc =0;
  word encoded_mcc =0 ;
  byte encoded_mnc =0;
  ...
  */
  encoded_mcc =  (sdprl_ptr->cdma_imsi[SD_CT_CDMA_IMSI_LEN - 1] & 0x3);
  encoded_mcc =  (encoded_mcc<< 8);
  encoded_mcc |=  sdprl_ptr->cdma_imsi[SD_CT_CDMA_IMSI_LEN - 2];
  encoded_mnc =   sdprl_ptr->cdma_imsi[SD_CT_CDMA_IMSI_LEN - 4] ;

  SD_MSG_HIGH_2("MMGSDI_CDMA_IMSI_M read - MCC:%d, MNC:%d ", encoded_mcc,encoded_mnc);

  if((encoded_mcc != SD_MCC_NONE)&&(encoded_mnc != SD_IMSI_11_12_NONE))
  {
    sd_decode_3gpp2_mcc(&decode_card_mcc,encoded_mcc);
    sd_decode_3gpp2_mnc(&decode_card_mnc,encoded_mnc);

    sdprl_ptr->cdma_mcc = (sys_mcc_type)decode_card_mcc;
    sdprl_ptr->cdma_mnc = (sys_mnc_type)decode_card_mnc;

    SD_MSG_HIGH_2("CDMA_IMSI_M  - MCC:%d, MNC:%d ", sdprl_ptr->cdma_mcc,sdprl_ptr->cdma_mnc);
  }
}
#endif
...
FUNCTION sdprl_update_3gpp_imsi
...
EXTERN void sdprl_update_3gpp_imsi(
...
)
{
  ...
  SD_MSG_HIGH_2("sdprl_update_3gpp_imsi - gwl_mcc:%d,gwl_mnc:%d", mcc,mnc);
  sdprl_ptr->gwl_mcc = mcc;
  sdprl_ptr->gwl_mnc = mnc;
}
...
FUNCTION sdprl_update_3gpp2_imsi
...
EXTERN void sdprl_update_3gpp2_imsi(
...
)
{
  ...
  SD_MSG_HIGH_2("sdss_update_3gpp_imsi - gwl_mcc:%d,gwl_mnc:%d", mcc,mnc);
  sdprl_ptr->cdma_mcc = mcc;
  sdprl_ptr->cdma_mnc = mnc;
}
...
static boolean sdprl_set_roam_ind_cmp_imsi_oh_mcc_mnc(word srv_sys_mcc, byte srv_sys_mnc)
{
...
#if defined(FEATURE_MMODE_CDMA_800) || defined(FEATURE_MMODE_CDMA_1900)
  word decode_mcc=0, decode_mnc=0;
  ...
  */
  if((sdprl_ptr->cdma_mcc == SD_MCC_NONE)||(sdprl_ptr->cdma_mnc == SD_IMSI_11_12_NONE))
  {
    sdprl_extract_mcc_mnc_from_cdma_imsi();
  ...
  */
  ...
  SD_MSG_HIGH_3(" decode_mcc - %d , decode_card_mcc - %d, decode_mnc - %d ", decode_mcc,sdprl_ptr->cdma_mcc,decode_mnc);

  if ( (decode_mcc !=  sdprl_ptr->cdma_mcc) || ((decode_mnc !=  SD_CT_MNC1) && (decode_mnc !=  SD_CT_MNC2) && (decode_mnc !=  SD_CT_MNC3)))
  {
    return TRUE;
  }
...
EXTERN boolean sdprl_is_ct_sim_card(
  void
)
{
  sdprl_s_type      *sdprl_ptr = NULL;
  /*CT SIM PLMNs*/
  /*HOME - 1x - 460-03; 3GPP - 460-11*/
  /*ROAM - 3GPP - 204-04; 454-03;454-04*/
...
#if defined(FEATURE_MMODE_CDMA_800) || defined(FEATURE_MMODE_CDMA_1900)
  SD_MSG_HIGH_3("sdprl_is_ct_sim_card - cdma_mcc:%d gwl_mcc:%d,gwl_mnc:%d",sdprl_ptr->cdma_mcc,sdprl_ptr->gwl_mcc,sdprl_ptr->gwl_mnc);
  if( (sdprl_ptr->cdma_mcc == SD_MCC_CHINA) || ( (sdprl_ptr->cdma_mcc == SD_MCC_NONE )&&
      (sdprl_ptr->gwl_mcc == SD_MCC_CHINA    && sdprl_ptr->gwl_mnc == SD_MNC_CHINATEL_3GPP_DEFAULT)))
#else
  SD_MSG_HIGH_2("sdprl_is_ct_sim_card - gwl_mcc:%d,gwl_mnc:%d",sdprl_ptr->gwl_mcc,sdprl_ptr->gwl_mnc);
  if( sdprl_ptr->gwl_mcc == SD_MCC_CHINA && sdprl_ptr->gwl_mnc == SD_MNC_CHINATEL_3GPP_DEFAULT)
#endif
  {
    return TRUE;
  }
...
)
{
  ...
  */
  ...
  prl_hdr_ptr        = sdprl_ptr->prl_hdr_ptr;
  ...
  */
  sd_sr_ptr = sdsr_create_sr_rec_copy(list_ptr);
  ...
  */
      ...
      sdprl_parser_next_match(prl_parser, sd_sr_ptr, prl_sr, &match_lvl) )
  {
    ...
    /* CAND_GW_SYS needs to be populated for MM_STACK_2 also
       ** This helps reacquire CAND_SYS on MAIN stack in case ue_mode changed
  ...
  */
      ...
      extract == SDPRL_EXTRACT_MATCH_ONLY )
  {
    ...
    /*delete memory allocated for TEMP system record */
    sdsr_delete_sr_rec_copy(sd_sr_ptr);
    return geo_sys_idx;
  }
  ...
  */
  ...
  if ((ss == MM_STACK_0) && (sdss_get_operator_name ( global_sd_asubs_id ) == SD_OPERATOR_CT )
      && sdprl_is_ct_sim_card() &&  (sd_sr_ptr->sys.mode == SYS_SYS_MODE_CDMA) )
  {
  ...
  */
  if( ! is_prl_match )
  {
    ...
    ** domains
    */
    if(!sdss_gw_sim_domain_valid(global_sd_mm_id))
    {
  ...
  */
  ...
  if ( ( ss == MM_STACK_1 ) &&  hdr_mcc_list_ptr)
  {
  ...
  */
  ...
  if (more_pref_plmn_list != NULL)
  {
    SD_MEM_FREE((more_pref_plmn_list), MODEM_MEM_CLIENT_MMODE);
  }
  /*delete memory allocated for TEMP system record */
  sdsr_delete_sr_rec_copy(sd_sr_ptr);
...
===========================================================================*/
boolean                         sdprl_plmn_roam_need_update
(
...
)
{
  ...
  */
  SD_ASSERT( sd_sr_ptr->sys.mode == SD_MODE_GWL );
  ...
  */
  if ( plmn_forbidden &&
       !sdss_match_prev_plmn_acq_type(MM_STACK_0, SDSS_GWL_ACQ_FIRST_PLMN) &&
       (sd_sr_ptr->sid_expected.net_select_mode != SD_NET_SELECT_MODE_MANUAL_SYS ||
        sys_plmn_match( sd_sr_ptr->sid_expected.prm.gwl.plmn.plmn_id, plmn) ) )
  {
    sd_sr_ptr->prl  = (byte) SDSS_PRL_NEG;
  ...
  conn_status = mm_per_stacks_get_connection_status(global_sd_asubs_id,
...
static  boolean                   sdprl_ral_read(sys_modem_as_id_e_type asubs_id)
{
  ...
  /* Initialize the RAM to default values if the read operation failed */
  if( !sdefs_fs_read_per_subs(efs_id, (byte *)&ral_parameters, &size_ral, asubs_id ) || (size_ral_exp > size_ral))
  {
    /* Initialize the entries SD_MODE_INACT for all.
    */
    for( i = 0;
...
EXTERN  boolean                   sdprl_init( void )
{
  ...
  */
  ...
  for( i=0; i < ARR_SIZE(sdprl_ptr->nam_info); i++ )
  {
    ...
    */
    ...
    (void) sdnv_read_extn(NV_PCDMACH_I, item_ptr, (uint16)global_sd_asubs_id);
    ...
    */
    ...
    (void) sdnv_read_extn(NV_SCDMACH_I, item_ptr, (uint16)global_sd_asubs_id);
    ...
    */
    item_ptr->pcdmach.nam = i;
    (void) sdnv_read_extn(NV_JTACS_PCDMACH_I, item_ptr, (uint16)global_sd_asubs_id);
    ...
    */
    item_ptr->scdmach.nam = i;
    (void) sdnv_read_extn(NV_JTACS_SCDMACH_I, item_ptr, (uint16)global_sd_asubs_id);
  ...
  */
  ...
  (void) sdnv_read_extn(NV_SRDA_ENABLED_I, item_ptr, (uint16)global_sd_asubs_id);
  ...
  if(sdss_is_ral_stored_in_efs(global_sd_asubs_id))
  {
    ...
    sdprl_ral_read(global_sd_asubs_id);
  }

  /*Initializing IMSI default values*/
  sdprl_ptr->gwl_mcc = SYS_WILDCARD_MCC;
  sdprl_ptr->gwl_mnc = SYS_WILDCARD_MNC;
#if defined(FEATURE_CDMA_800) || defined(FEATURE_CDMA_1900)
  memset(sdprl_ptr->cdma_imsi,0,SD_CT_CDMA_IMSI_LEN);
  sdprl_ptr->cdma_mcc = SD_MCC_NONE;
  sdprl_ptr->cdma_mnc = SD_IMSI_11_12_NONE;
#endif
...
{
  SD_MSG_HIGH_3("MRU_UPDATE: update_type %d, global sub %d, sub %d",
                update_type,
                global_sd_asubs_id,
                asubs_id);
  ...
  */
  ...
  if(update_type == SD_MRU_CLEAN)
  {
    sdprl_clr_mru();
    is_mru_buffe_update_offline = TRUE;
  }
  else if(update_type == SD_MRU_UPDATE)
  {
    SD_ASSERT( mru_table != NULL );

    if(!sdprl_mru_update_record(  asubs_id, mode,
                                  mru_table,
                                  index
                               ))
    {
...
EXTERN  void                      sdprl_save( void )
{
  ...
  */
  if(sdss_is_c2k_alt_algr_operation())
  {
    /* Save LTE Avail File
    */
    sdss_lte_avail_file_save(global_sd_asubs_id);
  }
  ...
  if(sdss_is_ral_stored_in_efs(global_sd_asubs_id))
  {
    ...
    sdprl_ral_save(SDSR_ACQED_LST,global_sd_asubs_id);
    /* write back into EFS */
    sdprl_ral_write(global_sd_asubs_id);
  }

  if(sdss_is_featuremode(SYS_OVERALL_FEATURE_MODE_MULTISIM) &&
      sdss_is_ral_stored_in_efs(global_sd_asubs_id))
  {
    sdprl_ral_save(SDSR_HYBR_1_ACQED_LST,global_sd_asubs_id);
    sdprl_ral_write(global_sd_asubs_id);
  }
...
FUNCTION sdprl_add_gwl_manual_sys
...
SIDE EFFECTS
  None.
===========================================================================*/
EXTERN void                      sdprl_add_gwl_manual_sys(
...
)
{
  ...
  */
  ...
  {
    sid_exp.gw_ss = MM_STACK_2;
  }
  else
  {
    sid_exp.gw_ss = MM_STACK_0;
  }

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

  sid_exp.net_select_mode = SD_NET_SELECT_MODE_MANUAL_SYS;
  sid_exp.prm.gwl.plmn.lac = PRL_WILDCARD_LAC;
  ...
  */
  ...
  if( tbl_ptr != NULL )
  {
    sr_ptr = sdsr_create_sr_rec_copy(tbl_ptr);
    if(sr_ptr != NULL)
    {
      sr_ptr->sid_expected.net_select_mode = SD_NET_SELECT_MODE_LIMITED;
      sdsr_tbl_store8( sr_ptr);
    }
    sdsr_delete_sr_rec_copy(sr_ptr);
  }
...
===========================================================================*/
EXTERN word           sdprl_encode_3gpp_acq_rec  (
  word                        offset,
  ...
  /* the acq rec with with 3gpp acq rec info*/
)
{
  ...
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  if(acq_rec_ptr->acq_type != PRL_ACQ_REC_3GPP_GENERIC)
  {
  ...
  */
  len = FSIZ(prl_3gpp_generic_type, version);
  SD_B_PACKB( (byte)(acq_rec_ptr->type.gwl_generic.version),
              new_buf_ptr,
              offset,
              len );
  offset      += len;
  ...
  */
  len = FSIZ(prl_3gpp_generic_type, num_of_rats);
  ...
  for(i = 0; i < acq_rec_ptr->type.gwl_generic.num_of_rats; i++)
  {
    /* Encode sys_mode
    */
    len = FSIZ(prl_3gpp_generic_type, sys_mode);
    ...
    */
    ...
    /* Encode num_of_bands
    */
    len = FSIZ(prl_3gpp_generic_type, num_bands);
    ...
    */
    ...
    {
      len  = FSIZ(prl_3gpp_generic_type, band);
      ...
      len = FSIZ(prl_3gpp_generic_type, uarfcn_incl);
      ...
      */
      ...
      {
        len = FSIZ(prl_3gpp_generic_type, uarfcn);
...
===========================================================================*/
EXTERN void  sdprl_update_tot_list( multimode_stack_e_type ss )
{
  ...
  */
  ...
  sdsr_list_del_sys(MM_STACK_0, SDSR_SCRATCH_LST,SDSR_CAT_GWL_SYS);
  ...
  */
  ...
  for(i = 0; i < rat_acq_order.num_rat; i++)
  {
    ...
    {
      case SYS_SYS_MODE_CDMA:
        sdsr_list_del_sys(MM_STACK_0,SDSR_SCRATCH_LST,SDSR_CAT_NON_CDMA);
        break;
      case SYS_SYS_MODE_HDR:
        sdsr_list_del_sys(MM_STACK_0,SDSR_SCRATCH_LST,SDSR_CAT_NON_HDR);
        break;
      case SYS_SYS_MODE_GSM:
        sdsr_list_del_sys(MM_STACK_0,SDSR_SCRATCH_LST,SDSR_CAT_NON_GSM);
        break;
      case SYS_SYS_MODE_WCDMA:
        sdsr_list_del_sys(MM_STACK_0,SDSR_SCRATCH_LST,SDSR_CAT_NON_WCDMA);
        break;
      case SYS_SYS_MODE_LTE:
        sdsr_list_del_sys(MM_STACK_0,SDSR_SCRATCH_LST,SDSR_CAT_NON_LTE);
        break;
      case SYS_SYS_MODE_NONE:
      case SYS_SYS_MODE_MAX:
      case SYS_SYS_MODE_NO_SRV:
...
{
  static boolean is_sdprl_acq_map_q_initialized[MAX_AS_IDS] = {FALSE, FALSE};
  ...
  if(!is_sdprl_acq_map_q_initialized[global_sd_asubs_id])
  {
    SD_CRIT_SECT_ENTER();
    if(sdprl_acq_map_q[global_sd_asubs_id] == NULL)
    {
      SD_MSG_HIGH_1("Allocate SDPRL_ACQ_MAP_Q asubs_id %d",global_sd_asubs_id);
      if((sdprl_acq_map_q[global_sd_asubs_id] = modem_mem_alloc(sizeof(q_type),MODEM_MEM_CLIENT_MMODE)) == NULL )
      {
        SD_ERR_FATAL_0("Mem alloc failed");
      }
      memset(sdprl_acq_map_q[global_sd_asubs_id], 0, sizeof(q_type));
    }

    if(!is_sdprl_acq_map_q_initialized[global_sd_asubs_id])
    {
      // Initialize the sdprl_acq_map_q
      is_sdprl_acq_map_q_initialized[global_sd_asubs_id] = TRUE;
      (void) q_init( sdprl_acq_map_q[global_sd_asubs_id]);
...
static void sdprl_check_dealloc_mem_for_map_tbl(void)
{
  ...
  for (
    cur_ptr = q_last_get(sdprl_acq_map_q[global_sd_asubs_id]) ;
    cur_ptr != NULL ;
    cur_ptr = q_last_get(sdprl_acq_map_q[global_sd_asubs_id])
  )
  {
    ...
    {
      SD_MEM_FREE(cur_ptr->sdprl_acq_map_tbl.sdprl_acqix_list, MODEM_MEM_CLIENT_MMODE);
      cur_ptr->sdprl_acq_map_tbl.sdprl_acqix_list=NULL;
    }

    SD_MEM_FREE( cur_ptr, MODEM_MEM_CLIENT_MMODE);
  }
...
static void sdprl_acq_map_q_add(word acq_ix, word num_sys )
{
  ...
  q_type          *sdprl_acq_map_q_ptr = NULL;
  ...
  sdprl_acq_map_q_ptr = sdprl_acq_map_q[global_sd_asubs_id];
  ...
  q_counter = q_cnt( sdprl_acq_map_q_ptr);


  // check if this is the first entry into queue
  if ( q_counter == 0 )
  {
    q_put( sdprl_acq_map_q_ptr, &new_acq_map_ptr->link);
  }
  else
  {
    /* Insert the new system at the beginning of the queue*/
#ifdef FEATURE_Q_NO_SELF_QPTR
    q_insert( sdprl_acq_map_q_ptr,
              & new_acq_map_ptr->link,
              & ((sdprl_acq_map_tbl_type *) q_check( sdprl_acq_map_q_ptr ))->link );
#else
...
)
{
  ...
  acq_map_ptr = q_linear_search( sdprl_acq_map_q[global_sd_asubs_id], sdprl_acq_map_q_search, &compare_val );
...
)
{
  ...
  {
    SD_MSG_LOW_4("ACQ_MAP_TBL: Acq ix: %d, sdsr_ref :%d num %d size %d",\
                 acq_ix, sr_ref, num, acq_map_ptr->sdprl_acq_map_tbl.size);
  }

  if (num < acq_map_ptr->sdprl_acq_map_tbl.size)
  {
  ...
  {
    SD_ERR_0("ACQ_MAP_TBL: Number of entries exceed the size allocated for acq_index");
    sr_ptr = sdsr_tbl_get_ptr( sr_ref );
    if (sr_ptr != NULL)
    {
      sdsr_print(sr_ptr, TRUE, sr_ref);
    }
  }
}
...
/*lint -esym(550, num_gwl_sys) */
{
  ...
  SD_MSG_HIGH_1("allocate_mem_acq_map_tbl, rec cnt %d", ix);
...
/*lint -esym(715,sys_idx) */
{
  ...
  if( acq_rec_type== PRL_ACQ_REC_3GPP_GENERIC ||
...
void sdprl_make_hdr_colloc_list( void )
{
  ...
  */
  ...
  SD_MSG_HIGH_4("NAM_SEL_MORE: make_hdr_colloc_list, list cnt %d %d %d %d",
                sdsr_list_cnt(SDSR_ACQ_COLLOC_LST),
                sdsr_list_cnt(SDSR_HDR_ACQ_COLLOC_LST),
                sdsr_list_cnt(SDSR_SRV_COLLOC_LST),
                sdsr_list_cnt(SDSR_HDR_SRV_COLLOC_LST));
...
)
{
  ...
  pch_a = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].pch_a;
  pch_b = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].pch_b;
  sch_a = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].sch_a;
  sch_b = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].sch_b;

  jtacs_pch_a = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].jtacs_pch_a;
  jtacs_pch_b = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].jtacs_pch_b;
  jtacs_sch_a = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].jtacs_sch_a;
  jtacs_sch_b = sdprl_ptr->nam_info[sdprl_ptr->curr_nam].jtacs_sch_b;
...
static void sdprl_allocate_memory_for_sdsr_tbl(void)
{
  ...
  SD_MSG_HIGH_3("Size of  SDSR TABLE : %d Records, num_gwl_sys %d, sdprl_tbl_temp_list.num %d",\
                num_acq_sys, num_gwl_sys, sdprl_tbl_temp_list.num);
...
===========================================================================*/
void sdprl_copy_active_nam_mru_to_lists( uint8 active_stacks )
{
...
#if defined FEATURE_HDR
  if(active_stacks & MM_STACK_1_MASK)
  {
  ...
  sdprl_mru_cpy( SDSR_MRU_LST, hybr_mru_lst, user_mru_lst, sdprl[global_sd_asubs_id]->curr_nam );
...
)
{
  ...
  */
  ...
  /* If CDMA is capability for current sub,
  ...
  */
  if( ! prl_init(
        ...
        (boolean)(subs_capability & SYS_SYS_MODE_MASK_CDMA)) )
  {
  ...
  */
  ...
  /* If capability has CDMA, populate MMSS related info for this sub */
  if(subs_capability & BM(SYS_SYS_MODE_CDMA))
  {
#ifdef FEATURE_MMSS_3_1
    if(sdmmss_create_equivalent_prl(global_sd_asubs_id))
    {
      /* Point at the newly created PRL.
      */
      sdprl_ptr->prl_ptr = prl_buf_get_ptr();
      sdss_update_is_mmss_operation(TRUE);

    }
    else if(prl_is_extended_prl(global_sd_asubs_id) &&
            sdss_get_subsc_type(global_sd_asubs_id) == SDSS_SUBSC_1X_GW &&
            sdprl_is_3gpp_record_in_prl())
    {
      SD_MSG_HIGH_1("NAM_SEL_MORE: 3GPP system record in PRL sub %d", global_sd_asubs_id);
      /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
#endif /*FEATURE_MMSS_3_1 */
    {
      sdss_update_is_mmss_operation(FALSE);
  ...
  sdsr_lists_init();
  sdsr_lists_allocate(stack_active, global_sd_asubs_id);

  is_mmss = sdss_is_mmss_operation();
  SD_MSG_HIGH_6("NAM_SEL_MORE: is_back_up %d, is_hyb_backup %d, stack_active %d global_sd_asubs_id %d, is_mmss %d, is_mru_buffe_update_offline %d", 
                   is_back_up, is_hyb_backup, stack_active, global_sd_asubs_id,
                   is_mmss,
                   is_mru_buffe_update_offline);
  ...
  if(is_hyb_backup && (stack_active & MM_STACK_1_MASK))
  {
    SD_MSG_HIGH_0("NAM_SEL_MORE: sdsr_add_last_hybrid_acq_sys");
    /*lint -e{746}*/
    sdsr_add_last_hybrid_acq_sys();
  }

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  SD_MSG_HIGH_0("NAM_SEL_MORE: copy nam to MRU list");

  sdprl_copy_active_nam_mru_to_lists(stack_active);

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  if(sdss_is_ral_stored_in_efs(global_sd_asubs_id))
  {
    /* add records from EFS RAL to SR table */
    SD_MSG_HIGH_0("NAM_SEL_MORE: ral_cpy");
  ...
  */
  ...
  if(is_mmss)
  {
    SD_MSG_HIGH_0("NAM_SEL_MORE: sdmmss_update_tot_list");
    sdmmss_update_tot_list();

    SD_MSG_HIGH_0("NAM_SEL_MORE: update_mmss_gwl_list");
  ...
  SD_MSG_HIGH_1("NAM_SEL_MORE: acq_tbl_cpy, sub %d", global_sd_asubs_id);
  ...
  */
  ...
  SD_MSG_HIGH_6("NAM_SEL_MORE: add_sr_ref_in_acq_tbl, list cnt %d %d %d %d %d %d",
                sdsr_list_cnt(SDSR_MMSS_GWL_LST),
                sdsr_list_cnt(SDSR_TOT_LST),
                sdsr_list_cnt(SDSR_ACQED_LST),
                   sdsr_list_cnt(SDSR_GWL_LST),
                sdsr_list_cnt(SDSR_ACQ_SYS),
                sdsr_list_cnt(SDSR_PRL_LST));


  sdprl_add_sr_ref_in_acq_tbl();
  SD_MSG_HIGH_0("NAM_SEL_MORE: add_sr_ref_in_acq_tbl done");
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if(is_mmss)
  {
    ...
    ** table
    */
    sdprl_update_tot_list(MM_STACK_0);
    SD_MSG_HIGH_1("NAM_SEL_MORE: list cnt SDSR_TOT_LST %d", sdsr_list_cnt(SDSR_TOT_LST));

    /* Populate GWL_LTD_LST and GWL_MANUAL_LST with SDSR_MMSS_GW_LST.
    */
    for( i=0; i < sdsr_list_cnt( SDSR_MMSS_GWL_LST ); i++ )
    {
      sdsr_list_update_gw_sys(MM_STACK_0,
                              sdsr_list_get_ref( SDSR_MMSS_GWL_LST, i),
                              FALSE,
                              FALSE,
                              FALSE,
                              TRUE);
      SD_MSG_HIGH_0("NAM_SEL_MORE: update_gw_sys for stack 0");

      if(stack_active & MM_STACK_2_MASK)
      {
        sdsr_list_update_gw_sys(MM_STACK_2,
                                sdsr_list_get_ref( SDSR_MMSS_GWL_LST, i),
                                FALSE,
                                FALSE,
                                FALSE,
                                TRUE);
        SD_MSG_HIGH_0("NAM_SEL_MORE: update_gw_sys for stack 2");
      }
...
#endif
  {
    SD_MSG_MED_1("non MMSS:copying prl lst to tot lst, sub %d", global_sd_asubs_id);
    sdsr_list_cpy(SDSR_TOT_LST,SDSR_PRL_LST);
  }

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  if(stack_active & MM_STACK_1_MASK)
  {
    SD_MSG_HIGH_0("NAM_SEL_MORE: sdprl_make_hdr_colloc_list");
    sdprl_make_hdr_colloc_list();
  }

#ifdef FEATURE_GPSONE_MSBASED
  SD_MSG_HIGH_0("NAM_SEL_MORE: sdsr_list_store_and_app SDSR_PRL_LST");
  ...
  ** records.
      *//*lint -e774 */ /* Constant value Boolean*/
  {
    ...
    boolean is_prl_gwl = sdss_sr_list_is_mode_pref(SDSR_PRL_LST, SD_SS_MODE_PREF_TDS_GSM_WCDMA_LTE);
    SD_MSG_HIGH_2("NAM_SEL_MORE: is_prl_gwl %d, sdprl_ptr->prl_hdr_ptr %d",
                  is_prl_gwl, sdprl_ptr->prl_hdr_ptr);
#endif
    if( ( sdprl_ptr->prl_hdr_ptr != NULL &&
          sdprl_ptr->prl_hdr_ptr->sspr_p_rev == PRL_SSPR_P_REV_1 )
#if (defined FEATURE_WCDMA) || (defined FEATURE_GSM)
        ||
        !is_prl_gwl
#endif
    ...
    {
      SD_MSG_HIGH_1("Dflt gwl list populated, sub %d", global_sd_asubs_id);
  ...
  if (!is_mmss)
  {
    SD_MSG_HIGH_0("NAM_SEL_MORE: SDSR_GWL_LST    update_gw_sys");
  }
  ...
  */
  if (!is_mmss)
  {
    SD_MSG_HIGH_0("NAM_SEL_MORE: SDSR_PRL_LST   update_gw_sys");
  }
  ...
  if ( prl_is_extended_prl(global_sd_asubs_id) &&
       sdss_sr_list_is_mode_pref(SDSR_PRL_LST, SD_SS_MODE_PREF_TDS_GSM_WCDMA_LTE) &&
       !is_mmss
       && sdsr_list_cnt(SDSR_MANUAL_LST) == 0 )
  {
    SD_MSG_HIGH_0("NAM_SEL_MORE: add_gwl_manual_sys");
    sdprl_add_gwl_manual_sys( SDSR_MANUAL_LST );
  }
  ...
  ** return TRUE.
  */
  SD_MSG_HIGH_6("NAM_SEL_MORE: set prl_active_status to TRUE, list cnt %d %d %d %d %d %d",
                sdsr_list_cnt(SDSR_MMSS_GWL_LST),
                sdsr_list_cnt(SDSR_TOT_LST),
                sdsr_list_cnt(SDSR_ACQED_LST),
                sdsr_list_cnt(SDSR_GWL_LST),
  ...
  */
   ...
   */
  sdss_set_avoid_list_updated_flag(global_sd_asubs_id, TRUE);
...
EXTERN  void                      sdprl_clr_mru( void )
{
  ...
  */
  ...
  if( global_sd_asubs_id >= MAX_SIMS || global_sd_asubs_id < SYS_MODEM_AS_ID_1 ||
      sdprl[global_sd_asubs_id] == NULL)
  {
    return;
  }

  SD_MSG_HIGH_1("MRU_CLEAR: sub %d", global_sd_asubs_id);

  curr_nam=sdprl[global_sd_asubs_id]->curr_nam;
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
FUNCTION sdprl_mru_file_exists

DESCRIPTION
  Checks if the MRU NV file exists
...
==========================================================================*/
static  boolean                   sdprl_mru_file_exists(
  sys_modem_as_id_e_type   asubs_id,
  sd_nam_e_type            nam
)
{
  ...
  if(asubs_id >= MAX_SIMS || asubs_id < SYS_MODEM_AS_ID_1)
  {
    return FALSE;
  }
  ...
  #if defined(LTE_BAND_NUM) && (LTE_BAND_NUM == 256)
  efs_id_ext = (nam == SD_NAM_1) ? SDEFS_MRU_EXT_NAM_1 : SDEFS_MRU_EXT_NAM_2;
  #endif
  efs_id = (nam == SD_NAM_1) ? SDEFS_MRU_NAM_1 : SDEFS_MRU_NAM_2;

  #if defined(LTE_BAND_NUM) && (LTE_BAND_NUM == 256)
  if(!sdefs_file_exists_per_subs(efs_id_ext, asubs_id))
  #endif
  {
    if(!sdefs_file_exists_per_subs(efs_id, asubs_id))
    {
      return FALSE;
    }
    else
...
FUNCTION sdprl_mru_refresh

DESCRIPTION
  Reset the SD MRU buffers and MRU list if the MRU NV file does not exist
...
)
{
  ...
  SD_MSG_HIGH_1("MRU REFRESH on sub %d", asubs_id);

  /* For each nam, reset the SD MRU buffers if the MRU NV file does not exist
  */
  for(i = 0; i < ARR_SIZE(sdprl_ptr->nam_info); i++)
  {
    if(!sdprl_mru_file_exists(asubs_id, (sd_nam_e_type)i))
    {
      sdsr_e_type   hdr_mru_lst = SDSR_MAX_LST;
      sdsr_e_type   user_mru_lst = SDSR_MAX_LST;

      SD_MSG_HIGH_3("MRU REFRESH, clear MRU for sub %d, nam %d, curr_nam %d", asubs_id, i, sdprl_ptr->curr_nam);

      /* For the current nam, also reset the MRU list if the MRU NV file does not exist
      */
      if((sd_nam_e_type)i == sdprl_ptr->curr_nam)
      {
        #if defined FEATURE_HDR
      ...
      /* Set all the MRU entries to SD_MODE_INACT
      */
      for(j = 0; j < NV_MRU_TABLE_SIZE; j++)
      {
        mru_buf[j].mode = (byte) SD_MODE_INACT;
      }
...
FUNCTION sdprl_mru_check_write

DESCRIPTION
  Write the MRU from SD to the NV if the NV MRU file does not exist
...
==========================================================================*/
EXTERN  void                      sdprl_mru_check_write(
  sys_modem_as_id_e_type   asubs_id
)
{
  sdprl_s_type    *sdprl_ptr = NULL;
  ...
  SD_MSG_HIGH_1("MRU CHECK_WRITE on sub %d", asubs_id);

  /* For the current nam, write the MRU from SD to the NV if the NV MRU file does not exist
  */
  if(!sdprl_mru_file_exists(asubs_id, sdprl_ptr->curr_nam))
  {
    sdsr_e_type   hdr_mru_lst = SDSR_MAX_LST;
    sdsr_e_type   user_mru_lst = SDSR_MAX_LST;

    SD_MSG_HIGH_2("MRU CHECK_WRITE, write MRU to NV for sub %d, nam %d", asubs_id, sdprl_ptr->curr_nam);
    ...
    sdprl_mru_write(sdprl_ptr->curr_nam);
  }
}
...
===========================================================================*/
EXTERN boolean sdprl_write_to_prl_buffer(sys_modem_as_id_e_type as_id)
{
  ...
  if(old_prl_buf_ptr == NULL ||
      old_prl_hdr_ptr == NULL)
  {
    sys_err_fatal_null_ptr_exception();
    return FALSE;
  }
  ...
  */
  ...
  else
  {
    ...
    SD_MEM_FREE( new_prl_buf_ptr, MODEM_MEM_CLIENT_MMODE);
  ...
  */
  for(i = 0 ; i < acq_tbl_ptr->num_entries ; i++)
  {
    ...
    offset = sdprl_encode_3gpp_acq_rec ( offset,
                                         new_prl_buf_ptr,
  ...
  */
  ...
  SD_MSG_HIGH_3_EXT( "Eqprl:PRL size=%d,PRL ID=%d,SSPR_PREV=%d", new_prl_hdr.pr_list_size,
  ...
  */
  ...
  SD_MSG_MED_3_EXT("EqPRL:pref_only=%d roam_ind %d num_acq_recs %d",
  ...
  */
  ...
  SD_MSG_HIGH_1_EXT("num sys recs=%d", new_prl_hdr.num_sys_recs, (as_id+1));
  ...
  */
  ...
  else
  {
    ...
    */
    sdprl_log_eqprl_print(new_prl_buf_ptr, as_id);
    if(sdefs_fs_write_per_subs(SDEFS_MMSS_EQPRL,
                               new_prl_buf_ptr,
                               (int32)size + (CRC_LENGTH/8),global_sd_asubs_id))
    {
...
static void sdprl_prune_more_pref_sdsr_list(sdprl_gwl_morepref_list_s_type *list,sd_splmn_info_list_s *splmn_info_ptr)
{
  ...
  if(no_match_map !=NULL)
  {
    ...
    SD_MEM_FREE(no_match_map,MODEM_MEM_CLIENT_MMODE);
  }
  else
  {
...
extern void sdprl_alloc(sys_modem_as_id_e_type asubs_id)
{
  if( asubs_id >= MAX_SIMS || asubs_id < SYS_MODEM_AS_ID_1)
  {
    return;
  }
  if(sdprl[asubs_id] != NULL)
  {
    SD_ASSERT("already allocated");
    return;
  }

  if((sdprl[asubs_id] = (sdprl_s_type *)modem_mem_alloc
                        (sizeof(sdprl_s_type), MODEM_MEM_CLIENT_MMODE)) == NULL)
  {
    SD_ERR_FATAL_1("Cannot allocate sdprl for sub %d ",asubs_id);
    return ;
  }

  /* Memset allocated buffer */
  memset((void *)sdprl[asubs_id],0,sizeof(sdprl_s_type));
}


/*===========================================================================

FUNCTION sdprl_log_eqprl_print

DESCRIPTION
  Print the content of Eq-PRL

DEPENDENCIES
  Eq-PRL must have been generated by this time
...
===========================================================================*/
static  void                      sdprl_log_eqprl_print(

  byte                        *new_prl_buf_ptr,
  /* Eq-PRL to be printed
  */
  sys_modem_as_id_e_type       as_id
)
{
  int           j,packets;
  log_code_type         log_code    = LOG_SDSR_EQPRL_C;
  /* Code to be logged.
  */

  unsigned int            log_pkt_len = sizeof( LOG_SDSR_EQPRL_C_type );
  unsigned int            eqprl_len   = sizeof( new_prl_buf_ptr );

  LOG_SDSR_EQPRL_C_type  *log_ptr  = NULL;
  /* log pointer to the log record type.
  */

  packets = (int)(ceil((double)eqprl_len/LOG_EQPRL_MAX_SIZE));

  for(j=0; j< packets; ++j)
  {
    log_ptr = (LOG_SDSR_EQPRL_C_type *) log_alloc_ex( log_code,
              log_pkt_len );
    /* If allocation failed, just return.
    */
    if ( log_ptr == NULL )
    {
      SD_MSG_HIGH_0 ("Mem alloc failed for Eq-PRLlog generation");
      return;
    }

    log_ptr->version = 1;

    log_ptr->sequence_no = j+1;

    log_ptr->is_complete = (log_ptr->sequence_no == packets);


    log_ptr->size = (log_ptr->is_complete)?(eqprl_len - j*LOG_EQPRL_MAX_SIZE):LOG_EQPRL_MAX_SIZE;

    memscpy(log_ptr->prl_buf, LOG_EQPRL_MAX_SIZE, new_prl_buf_ptr + (j*LOG_EQPRL_MAX_SIZE),log_ptr->size);

    log_util_log_packet_commit(as_id, log_ptr);
  }
} /* sdsr_list_print */

#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
FUNCTION sdprl_qsh_mdump_collect
  
DESCRIPTION
  This function collects the mdump for sdprl global variable
...
QSH_MDUMP_FN_ATTR
#endif
void sdprl_qsh_mdump_collect()
{
  int sub;

  qsh_mdump_collect_high(&sdprl[0],MAX_SIMS*sizeof(sdprl_s_type *));
  
  for(sub = SYS_MODEM_AS_ID_1; sub < MAX_SIMS; sub++)
  {
    qsh_mdump_collect_high(sdprl[sub],sizeof(sdprl_s_type));
    if(sdprl[sub])
    {
        qsh_mdump_collect_high(sdprl[sub]->prl_ptr,sizeof(byte));
        qsh_mdump_collect_high(sdprl[sub]->prl_hdr_ptr,sizeof(prl_hdr_s_type));
    }   
  }
}
#endif
