...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdefs.c#5 $
...
static const sdefs_tbl_s_type sdefs_tbl[] =
{
  ...
  {SDEFS_ENHANCED_F3_DBG_RULE, SDEFS_ENHANCED_F3_DBG_F_NAME},
  {SDEFS_SUB_SCAN_SCOPE,      SDEFS_SUB_SCAN_SCOPE_F_NAME},
  {SDEFS_ENABLE_FULLRAT_OPTIMISATION, SDEFS_ENABLE_FULLRAT_OPTIMISATION_F_NAME},
  {SDEFS_MRU_EXT_NAM_1,           SDEFS_MMODE_MRU_EXT_NAM_1_F_NAME},
  {SDEFS_MRU_EXT_NAM_2,           SDEFS_MMODE_MRU_EXT_NAM_2_F_NAME},
  {SDEFS_FULL_SRV_REQ_EMERG_EXT,  SDEFS_FULL_SRV_REQ_EMERG_EXT_F_NAME },
  {SDEFS_MCC_LIST_EMERG_CALL_FULL_SRV, SDEFS_MCC_LIST_EMERG_CALL_FULL_SRV_F_NAME}, 
  {SDEFS_FOLLOW_TOT, SDEFS_FOLLOW_TOT_F_NAME},
  {SDEFS_EMERG_CALL_1X_SCAN_FIRST_NAL_RESTRICTED, SDEFS_EMERG_CALL_1X_SCAN_FIRST_NAL_RESTRICTED_F_NAME},
       
   {SDEFS_SD_DEVICE_CONFIG_TIMERS,SDEFS_SD_DEVICE_CONFIG_TIMERS_F_NAME},
  {SDEFS_SKIP_EMERG_CALL_FULL_SRV, SDEFS_SKIP_EMERG_CALL_FULL_SRV_F_NAME},
  {SDEFS_SD_PSUEDO_PRL_CREATION, SDEFS_SD_PSUEDO_PRL_CREATION_F_NAME},
  {SDEFS_PSAP_CALL_BACK_MANDATORY, SDEFS_PSAP_CALL_BACK_MANDATORY_F_NAME},
   {SDEFS_E911_PRIORITIZE_CS,  SDEFS_E911_PRIORITIZE_CS_F_NAME},
  {SDEFS_SPECIAL_SCAN_MCC_LIST, SDEFS_SPECIAL_SCAN_MCC_LIST_F_NAME},
...
)
{
  ...
  */
  ...
  //if file to be read have more size then the size intended to be copied in buffer for efs item  
  ...
  */
  ...
  if(mcfg_status != MCFG_FS_STATUS_OK)
  {
    SD_MSG_LOW_4("mcfg fs read error efs_id %d sub_id %d status %d errno %d", efs_id ,sub_id, mcfg_status, mcfg_fs_errno(MCFG_FS_TYPE_EFS));
    *size_ptr = 0;
    return FALSE;
  }
...
==========================================================================*/
boolean                  sdefs_file_exists_per_subs(
...
)
{
  ...
  if((mcfg_fs_stat(file, &st, MCFG_FS_TYPE_EFS, mcfg_subs) != MCFG_FS_STATUS_OK) &&
...
)
{
  ...
  /* If the file is NV ITEM Files, redirect to sdefs_fs_read_per_subs() */
  ...
  */
  SD_MSG_HIGH_2("Open file ID %d, buffer size %d", efs_id, *size_ptr);
...
)
{
  ...
  SD_MSG_HIGH_1("Write file ID %d", efs_id);
...
)
{
  ...
  */
  SD_MSG_HIGH_2("EFS_WRITE: efs_id = %d, sub_id %d", efs_id, sub_id);
  ...
  if(status != MCFG_FS_STATUS_OK)
  {
    SD_MSG_HIGH_3("EFS_WRITE: error, sub_id %d, status=%d, errno %d", sub_id, status,
...
===========================================================================*/
jcdma_me_capability *sd_jcdma_ptr()
{
...
boolean sdefs_csg_auto_mode_bsr_disable(void)
{
  ...
  {
    SD_MSG_HIGH_0("sdefs_csg_auto_mode_bsr_disable returns FALSE");
    return FALSE;
  }
