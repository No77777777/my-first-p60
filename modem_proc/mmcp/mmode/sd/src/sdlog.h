...
/**
  ...
  @brief This file provides the log type definitions for SD20.
*/
/*===*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
$Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdlog.h#1 $
...
#define LOG_EQPRL_MAX_SIZE  5115

/** List print */
LOG_RECORD_DEFINE(LOG_SDSR_EQPRL_C)
...
byte prl_buf[LOG_EQPRL_MAX_SIZE];

LOG_RECORD_END


/*---------------------------------------------------------------------------
                     LOG_SDSR_LIST_PRINT_C
---------------------------------------------------------------------------*/

#define LOG_LIST_MAX_SIZE  50
/** List print */
LOG_RECORD_DEFINE(LOG_SDSR_LIST_PRINT_C)
...
} system_record[LOG_LIST_MAX_SIZE];
LOG_RECORD_END
...
typedef struct
{
  ...
  */
  ...
  /**
    Defined by multimode_stack_e_type
    - 0 = MM_STACK_0
    - 1 = MM_STACK_1
    - 2 = SD_SS_HYBR_WLAN
  */
...
typedef enum
{
  ...
  SDLOG_SS_TIMER_REASON_RESTRICTED = 3,
  /**< Unused reason to maintain backward compatibility */
...
typedef struct
{
  ...
  byte ss_type;
  /**<
    ss type for which timer is started. Values defined in multimode_stack_e_type
    - 0 = MM_STACK_0
    - 1 = MM_STACK_1
    - 2 = SD_SS_HYBR_WLAN
    - 3 = MM_STACK_2
