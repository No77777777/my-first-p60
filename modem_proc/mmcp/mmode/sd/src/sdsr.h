...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/sd/src/sdsr.h#1 $
...
typedef enum
{
  ...
  ** same as the order of systems in SDSR_PRL_LST list */
  ...
  /* A list of references to system records that
  ** represent more preferred systems for sys on hybrid 2
  ** stack within the same GEO with 1x srving sys on main
  **
  ** Initialized: To an empty list at power-up
  **
  ** Updated: When LTE is acquired or during
  ...
  **/
  ...
  SDSR_RECENT_CAMPED_PREF_LST,
   /* A list of references to system records that
  ** represent more preferred systems for sys which is 
  ** most recently camped on MM_STACK_0 or MM_STACK_2 
  ** and in same GEO
  **
  ** Initialized: To an empty list at power-up
  **
  ...
  **/
  ...
  SDSR_HYBR_1_LST,         /* FOR RANGE CHECKING */
  /* 78 */
  SDSR_HYBR_1_PRL_LST,
  ...
  ** --------------------
  */
  SDSR_1ST_SYS,          /* FOR RANGE CHECKING */
  ...
  ** Cleared: Never */
  ...
  SDSR_GW_CAND_SYS,  /* 141 */
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

  SDSR_HDR_SYS_,        /* FOR RANGE CHECKING */
  ...
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  /* 162 */
  SDSR_HYBR_1_SYS,        /* FOR RANGE CHECKING */
...
typedef struct
{
  ...
  */
  multimode_stack_e_type          sched_ss;
  ...
  */
  multimode_stack_e_type                last_acq_ss;
...
===========================================================================*/
extern void                  sdsr_tbl_reset_per_ss( multimode_stack_e_type ss );
...
FUNCTION sdsr_lists_allocate

DESCRIPTION
  Allocate stack specific SDSR lists for SUBs
...
FUNCTION  sdsr_chk_lte_band_equal
...
DESCRIPTION
  delete memory allocated for a system record
