...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_voice_cmd_list.h#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  QMI_VOICE_CMD_GET_SUPPORTED_MSGS         = 0x001E,
  ...
  QMI_VOICE_CMD_SET_ALL_CALL_FWD_SUPS      = 0x0076
