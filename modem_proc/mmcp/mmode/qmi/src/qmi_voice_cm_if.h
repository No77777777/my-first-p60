...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_voice_cm_if.h#9 $ $DateTime: 2022/11/09 00:17:53 $ $Author: pwbldsvc $
...
#define QMI_VOICE_CM_IF_MAX_SUBADDRESS_DIGITS 21
#define QMI_VOICE_CM_IF_MAX_IP_ALERT_INFO_LEN 512
#define QMI_VOICE_CM_IF_MAX_CALL_COMP_SUBJECT_LEN 64
#define QMI_VOICE_CM_IF_MAX_CALL_COMP_PIC_URL_LEN 256
#define QMI_VOICE_CM_IF_MAX_CALL_COMP_ORG_HDR_LEN 256
#define QMI_VOICE_CM_IF_MAX_SIP_DTMF_LEN 128
...
#define QMI_VOICE_CM_IF_MAX_UTF16_DATA_LENGTH QMI_VOICE_CM_IF_MAX_USS_DATA_LEN
...
#define QMI_VOICE_AVOID_PLMN_LIST_MAX_LENGTH 5
...
#define   QMI_SS_ERROR_IMS_USSD_ERROR_CODE_TAG            0x91

#define   QMI_CM_IF_SS_ERROR_CAUSE_403_FORBIDDEN          0x00
#define   QMI_CM_IF_SS_ERROR_CAUSE_404_NOT_FOUND          0x02

#define   QMI_CM_IF_SS_ERROR_CAUSE_IMS_USSD_ERROR_UNSPECIFIED          0x01
#define   QMI_CM_IF_SS_ERROR_CAUSE_IMS_USSD_ERROR_LANG_ALPHA_NO_SUPPORT          0x02
#define   QMI_CM_IF_SS_ERROR_CAUSE_IMS_USSD_ERROR_UNEXPECTED_DATA          0x03
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_CALL_STATE_PRE_INCOMING   = 0x0B
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_CMD_GET_SUPPORTED_MSGS,
  ...
  QMI_VOICE_CM_IF_CMD_SECURE_CALL_MODE,
  QMI_VOICE_CM_IF_CMD_SET_WWAN_911_TIMER,
  QMI_VOICE_CM_IF_CMD_GET_WWAN_911_TIMER,
  QMI_VOICE_CM_IF_CMD_CALL_ENCRYPTION,
  QMI_VOICE_CM_IF_CMD_SPEECH_CODEC_INFO,
  QMI_VOICE_CM_IF_CMD_IMS_CALL_CANCEL_REQ,
  QMI_VOICE_CM_IF_CMD_AVOID_PLMN_REQ,
  QMI_VOICE_CM_IF_CMD_SET_ALL_CALL_FWD_SUPS,
  QMI_VOICE_CM_IF_CMD_SIP_DTMF,

  QMI_VOICE_CM_IF_CMD_INDICATION_REGISTER_RESP,
  QMI_VOICE_CM_IF_CMD_GET_SUPPORTED_MSGS_RESP,
  ...
  QMI_VOICE_CM_IF_CMD_SECURE_CALL_MODE_RESP,
  QMI_VOICE_CM_IF_CMD_SET_WWAN_911_TIMER_RESP,
  QMI_VOICE_CM_IF_CMD_GET_WWAN_911_TIMER_RESP,
  QMI_VOICE_CM_IF_CMD_CALL_ENCRYPTION_RESP,
  QMI_VOICE_CM_IF_CMD_SPEECH_CODEC_INFO_RESP,
  QMI_VOICE_CM_IF_CMD_IMS_CALL_CANCEL_RESP,
  QMI_VOICE_CM_IF_CMD_AVOID_PLMN_RESP,
  QMI_VOICE_CM_IF_CMD_SET_ALL_CALL_FWD_SUPS_RESP,
  QMI_VOICE_CM_IF_CMD_SIP_DTMF_RESP,
  ...
  QMI_VOICE_CM_IF_CMD_ECALL_STATUS_IND,
  QMI_VOICE_CM_IF_CMD_CALL_REEST_STATUS_IND,
  QMI_VOICE_CM_IF_CMD_VICE_DIALOG_IND,
  QMI_VOICE_CM_IF_CMD_MT_CALL_END_AUTO_REJECT_IND,
  QMI_VOICE_CM_IF_CMD_SIP_DTMF_IND,
  ...
  QMI_VOICE_CM_IF_CMD_SECURE_CALL_MODE_CMD_CB,
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_EVT_CALL_LOCAL_HOLD               = QMI_VOICE_CM_IF_EVT_CALL_BASE + CM_CALL_EVENT_LOCAL_HOLD,
  QMI_VOICE_CM_IF_EVT_CALL_REEST_STATUS       = QMI_VOICE_CM_IF_EVT_CALL_BASE + CM_CALL_EVENT_VOICE_CALL_REESTABLISHMENT,
  QMI_VOICE_CM_IF_EVT_CALL_CANCEL_IMS_CALL_RSP      = QMI_VOICE_CM_IF_EVT_CALL_BASE + CM_CALL_EVENT_CANCEL_IMS_CALL_RSP,
  QMI_VOICE_CM_IF_EVT_CALL_PRE_INCOM      = QMI_VOICE_CM_IF_EVT_CALL_BASE + CM_CALL_EVENT_PRE_INCOM,
  ...
  QMI_VOICE_CM_IF_EVT_IP_SIP_DTMF                = QMI_VOICE_CM_IF_EVT_INBAND_BASE + CM_EVENT_IP_SIP_DTMF,
  QMI_VOICE_CM_IF_EVT_IP_SIP_DTMF_IND             = QMI_VOICE_CM_IF_EVT_INBAND_BASE + CM_EVENT_IP_SIP_DTMF_IND,
  ...
  QMI_VOICE_CM_IF_EVT_MSGR_BASE                     = 0x20000,
  QMI_VOICE_CM_IF_EVT_MSGR_GET_WWAN_911_TIMER_CONF  = 0x20001,
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_VIDEO_CRBT         = 0x0C,
  QMI_VOICE_CM_IF_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_VIDEO_CRBT       = 0x0D
...
//VT upgrade-downgrade failure causes
  ...
  QMI_FAILURE_CAUSE_SIP_503_SERVER_UNAVAILABLE = 392,
  QMI_FAILURE_CAUSE_NOT_ACCEPTABLE_GLOBAL = 609,
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_PREF_VOICE_SERVICE_OPT_EVRC_SO73           = 0x0049,
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_CC_RESULT_SUPS_MODIFIED_TO_VT,
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_CC_MOD_TO_VT = 0x03
  #endif
...
typedef enum
{
  QMI_VOICE_CM_IF_CALL_REESTAB_STARTED   = 0x00,
  QMI_VOICE_CM_IF_CALL_REESTAB_SUCCESS   = 0x01
} qmi_voice_cm_if_call_reestab_status_e_type;
...
typedef enum
{
  ...
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_UL_DATA_CNF_FAILURE_TXN=239,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_UL_DATA_CNF_FAILURE_HO=240,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_UL_DATA_CNF_FAILURE_CONN_REL=241,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_UL_DATA_CNF_FAILURE_RLF=242,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_UL_DATA_CNF_FAILURE_CTRL_NOT_CONN=243,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_SUCCESS=244,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE=245,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_ABORTED=246,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_ACCESS_BARRED=247,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_CELL_RESEL=248,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_CONFIG_FAILURE=249,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_TIMER_EXPIRED=250,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_LINK_FAILURE=251,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_NOT_CAMPED=252,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_SI_FAILURE=253,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_EST_FAILURE_CONN_REJECT=254,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_NORMAL=255,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_RLF=256,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_CRE_FAILURE=257,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_OOS_DURING_CRE=258,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_ABORTED=259,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_SIB_READ_ERROR=260,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_CONN_REL_ABORTED_IRAT_SUCCESS=261,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_LRRC_RADIO_LINK_FAILURE=262,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_DETACH_WITH_REATTACH_LTE_NW_DETACH=263,
  QMI_VOICE_CM_IF_END_ACCESS_STRATUM_REJ_DETACH_WITH_OUT_REATTACH_LTE_NW_DETACH=264,
  ...
  QMI_VOICE_CM_IF_END_CSFB_NOT_FEASIBLE_IN_ROAM_CS_NW = 391,

QMI_VOICE_CM_IF_END_SIP_503_SERVER_UNAVAILABLE = 392,
  ...
  QMI_VOICE_CM_IF_END_CAUSE_CALL_CONFERENCE_ONGOING = 419,
  ...
  QMI_VOICE_CM_IF_END_INCOMING_REJ_CAUSE_CALL_ONGOING_CB_ENABLED = 608,
  
  //Additional 1xCSFB reject causes
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_MSG_INVAILD = 500,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_MSG_IGNORE = 501,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_ACQ_FAIL = 502,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_CALL_REL_REL_ORDER = 503,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_CALL_REL_REORDER = 504,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_CALL_REL_INTERCEPT_ORDER = 505,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_CALL_REL_NORMAL = 506,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_CALL_REL_SO_REJ = 507,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAIL_CALL_REL_OTASP_SPC_ERR = 508,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE_SRCH_TT_FAIL = 509,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE_TCH_INIT_FAIL = 510,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE_USER_CALL_END = 511,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE_RETRY_EXHAUST = 512,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE_CALL_REL_REG_REJ = 513,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE_CALL_REL_NW_REL_ODR = 514,
  QMI_VOICE_CM_IF_END_1XCSFB_HO_FAILURE = 515,
  //Additonal EMM Reject Causes
  QMI_VOICE_CM_IF_END_EMM_REJ_TIMER_T3417_EXT_EXP = 600,
  QMI_VOICE_CM_IF_END_EMM_REJ_TIMER_T3417_EXP = 601,
  QMI_VOICE_CM_IF_END_EMM_REJ_SERVICE_REQ_FAILURE_LTE_NW_REJECT = 602,
  QMI_VOICE_CM_IF_END_EMM_REJ_SERVICE_REQ_FAILURE_CS_DOMAIN_NOT_AVAILABLE = 603,
  QMI_VOICE_CM_IF_END_EMM_REJ = 604,
  QMI_VOICE_CM_IF_END_CALL_COMPLETED_ELSEWHERE = 605,
  QMI_VOICE_CM_IF_END_CAUSE_RETRY_ON_IMS_WITHOUT_RTT=606,
  QMI_VOICE_CM_IF_END_NOT_ACCEPTABLE_GLOBAL = 609,
...
typedef struct
{
  uint32         notif_type;
  uint16         notif_reason;
  char          notif_text[CM_MAX_NUMBER_CHARS];

} qmi_voice_cm_if_prog_info_notif;
...
typedef enum
{
  QMI_VOICE_CM_IF_CANCEL_CALL_UPGRADE = 0x01,
  QMI_VOICE_CM_IF_CANCEL_CALL_DOWNGRADE = 0x02,
  QMI_VOICE_CM_IF_CANCEL_CALL_HOLD = 0x03,
  QMI_VOICE_CM_IF_CANCEL_CALL_RESUME = 0x04  
} qmi_voice_cm_if_ims_call_cancel_req_cancel_e_type;
...
typedef struct
{
  ...
  uint8     subaddr[QMI_VOICE_CM_IF_MAX_SUBADDRESS_DIGITS];
  /**< Array of subaddress digits. */
} qmi_voice_cm_if_called_party_subaddress_s_type;
...
typedef struct
{
  uint32_t call_composer_subject_len; 
  uint16_t call_composer_subject[QMI_VOICE_CM_IF_MAX_CALL_COMP_SUBJECT_LEN];
}qmi_voice_cm_if_call_composer_subject_s_type;

typedef struct
{
  char call_composer_pic_url[QMI_VOICE_CM_IF_MAX_CALL_COMP_PIC_URL_LEN + 1];
}qmi_voice_cm_if_call_composer_pic_url_s_type;

typedef struct
{
  uint32_t call_composer_org_header_len; 
  uint16_t call_composer_org_header[QMI_VOICE_CM_IF_MAX_CALL_COMP_ORG_HDR_LEN];
}qmi_voice_cm_if_call_composer_org_header_s_type;

typedef struct
{
  uint32         local_rtt_cap;
  uint32         peer_rtt_cap;
} qmi_voice_cm_if_rtt_capabilities;

typedef struct
{
  boolean local_call_comp_support;
  boolean peer_call_comp_support;
} qmi_voice_cm_if_call_composer_capabilities;
...
typedef struct 
{
  uint16 ip_alert_info_length;
  uint8 ip_alert_info_buf[QMI_VOICE_CM_IF_MAX_IP_ALERT_INFO_LEN];
} qmi_voice_cm_if_ip_alert_info_s_type;

/** @brief structure of customized ringing signal info
**
*/
typedef struct {

  uint64 original_call_type;

  uint32 crs_type;

}qmi_voice_cm_if_ip_crs_info_s_type;
...
typedef struct
{
  ...
  boolean                                       is_call_composer_subject_valid;
  qmi_voice_cm_if_call_composer_subject_s_type  call_composer_subject;

  boolean                                       is_call_composer_picture_url_valid;
  ...
  boolean                                         is_call_composer_org_header_valid;
...
typedef struct
{
  ...
  uint8                    call_id;
  boolean                  is_mod_to_vt;/* sups modified to voice+video */
...
typedef struct
{
  ...
  boolean            is_rtt_mode_valid;
  uint32             rtt_mode;
  boolean           is_secure_call_valid;
  boolean           is_secure_call;
  boolean                  is_speech_codec_mask_valid;
  uint64                   speech_codec_mask;
  uint8       is_priority_speech_codec_valid;
  uint32       priority_speech_codec;
...
typedef  struct
{
  ...
  boolean                                   all_call_fwd_reason_valid;
  uint8                                     all_call_fwd_reason;
} qmi_voice_cm_if_set_all_call_fwd_sups_req_s;
...
typedef struct
{
  uint16                        wwan_911_timer_value;
} qmi_voice_cm_if_set_wwan_911_timer_s;
...
typedef struct
{
     uint8 cancel_type;
     uint8 call_id;
}qmi_voice_cm_if_ims_call_cancel_req_s;

typedef struct
{
  byte                                identity[3];
    /**< Public Land Mobile Network ID. */
}qmi_voice_plmn_id_s_type;

typedef struct
{
     uint8 plmn_list_to_avoid_len;
     qmi_voice_plmn_id_s_type plmn_list_to_avoid[QMI_VOICE_AVOID_PLMN_LIST_MAX_LENGTH];
}qmi_voice_cm_if_avoid_plmn_req_s;
...
{
  qmi_error_e_type        error;
} qmi_voice_cm_if_set_wwan_911_timer_resp_s;

typedef struct
{
  qmi_error_e_type        error;
  boolean                 is_wwan_911_timer_value_available;
  uint16                  wwan_911_timer_value;
} qmi_voice_cm_if_get_wwan_911_timer_resp_s;
...
typedef struct
{
  ...
  uint8                   call_id;
  uint8                   cancel_type;
}qmi_voicei_cm_if_ims_call_cancel_resp_s;

typedef struct
{
  qmi_error_e_type        error;
} qmi_voice_cm_if_avoid_plmn_resp_s;
...
{
  uint8               status;
} qmi_voice_cm_if_call_reest_status_ind_s;
/*===========================================================================
...
typedef struct
{
  ...
  {
    /* requests*/
    qmi_get_supported_msgs_req_v01                          supported_msg_req;
    ...
    qmi_voice_cm_if_set_all_call_fwd_sups_req_s             all_call_fwd_sups;
    ...
    voice_secure_call_mode_req_msg_v02                      secure_call_mode_req;
    voice_set_wwan_911_timer_req_msg_v02                    set_wwan_911_timer_req;
    voice_get_wwan_911_timer_req_msg_v02                    get_wwan_911_timer_req;
    voice_call_encryption_req_msg_v02                       call_encryption_req;
    voice_get_speech_codec_info_req_msg_v02                 get_speech_codec_info;
    voice_ims_call_cancel_req_msg_v02                       ims_call_cancel_req;
    voice_avoid_plmn_list_req_msg_v02                       avoid_plmn_list_req;
    ...
    voice_secure_call_mode_resp_msg_v02                      secure_call_mode_resp;
    voice_set_wwan_911_timer_resp_msg_v02                   set_wwan_911_timer_resp;
    ...
    voice_ims_call_cancel_resp_msg_v02                   ims_call_cancel_resp;
    voice_avoid_plmn_list_resp_msg_v02                   avoid_plmn_list_resp;
    voice_set_all_call_fwd_sups_resp_msg_v02                set_all_call_fwd_resp;
    ...
    voice_call_reestablishment_status_ind_msg_v02     call_reestablishment_status_ind;
    ...
    voice_sip_dtmf_ind_msg_v02                              sip_dtmf_ind;
...
void qmi_voice_cm_if_mcfg_refresh_otasp(   uint16 subs_index);
