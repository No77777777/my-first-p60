...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_voice_cm_sups.h#1 $ $DateTime: 2010/03/16 22:23:17 $ $Author: ndanturi $
...
boolean qmi_voice_cm_if_set_all_call_fwd_sups_is_valid(qmi_voice_cm_if_set_all_call_fwd_sups_req_s *in_data_ptr);
