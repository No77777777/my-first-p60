...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_nas_msg.h#1 $ $Change: 31300932 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
typedef enum
{
  NAS_RF_LTE_BW_NRB_6     = 0x00,
  NAS_RF_LTE_BW_NRB_15    = 0x01,
  NAS_RF_LTE_BW_NRB_25    = 0x02,
  NAS_RF_LTE_BW_NRB_50    = 0x03,
  NAS_RF_LTE_BW_NRB_75    = 0x04,
  NAS_RF_LTE_BW_NRB_100   = 0x05,
  NAS_RF_MAX_BW           = 0xFFFFFFFF
} nas_rf_bandwidth_e_type;
#endif
...
#ifdef FEATURE_MMODE_LTE_BANDWIDTH
  PACK(struct) nas_0031_rsp_t12_p_s
  {
    uint8 num_instances;
    PACK(struct)
    {
      uint8                    radio_if;
      nas_rf_bandwidth_e_type  bandwidth;
    }
    instances[NAS_0031_RSP_MAX_RADIO_IFS];
  } t12;
#endif
...
struct nas_007A_req_s
{
  ...
  struct nas_007A_req_t11_s
  {
    uint16 emerg_mode_pref;
  } t11;
...
struct nas_007A_req_p_s
{
  ...
  PACK(struct) nas_007A_req_t11_p_s
  {
    uint16 emerg_mode_pref;
  } t11;
};
...
struct nas_007B_ind_s
{
  struct nas_007B_ind_t10_s
  {
...
struct nas_007B_ind_p_s
{
  PACK(struct) nas_007B_ind_t10_p_s
  {
    boolean is_ready_due_to_csfb;
  } t10;
};
...
/*---------------------------------------------------------------------------
 * QMI_NAS_E911_SEARCH_FAIL_IND
---------------------------------------------------------------------------*/
#define NAS_00CE_IND_T01        (0x01)        

struct nas_00CE_ind_s
{
  struct nas_00CE_ind_t01_s
  {
    uint16 emerg_mode_pref;
  } t01; 
...
struct nas_00CE_ind_p_s
{
  PACK(struct) nas_00CE_ind_t01_p_s
  {    
    uint16 emerg_mode_pref;
  } t01;
};
...
typedef enum
{
  ...
  NAS_00A1_IMS_CALL_STATUS_CONNECTED    = 0x02,
  NAS_00A1_IMS_CALL_STATUS_MAX     = 0xFFFFFFFF,
} nas_00A1_ims_call_status_e_type;

typedef enum
{
  NAS_00A1_RAT_WLAN = 0x06,
  NAS_00A1_RAT_LTE   = 0x08
} nas_00A1_rat_e_type;

#define  NAS_00A1_IMS_CALL_TYPE_MIN              0x00
#define  NAS_00A1_IMS_CALL_TYPE_VOICE            0x01
#define  NAS_00A1_IMS_CALL_TYPE_NORMAL_VIDEO     0x02
#define  NAS_00A1_IMS_CALL_TYPE_SMS              0x04
#define  NAS_00A1_IMS_CALL_TYPE_EMERGENCY        0x08
#define  NAS_00A1_IMS_CALL_TYPE_MAX              0x10

typedef uint64 nas_00A1_ims_call_type_mask_e_type;
...
struct nas_00A1_req_s
{
  ...
  struct nas_00A1_req_t11_s
  {
    nas_00A1_rat_e_type sys_mode;
  } t11;
...
struct nas_00A1_req_p_s
{
  ...
  PACK(struct) nas_00A1_req_t11_p_s
  {
    nas_00A1_rat_e_type sys_mode;
  } t11;
};
