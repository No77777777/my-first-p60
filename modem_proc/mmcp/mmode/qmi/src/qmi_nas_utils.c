...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_nas_utils.c#2 $ $DateTime: 2022/09/01 04:52:39 $ $Author: pwbldsvc $
  ...
  else
  {
    switch ( p_info->stack_info[stack].sys_mode )
    {
      case SYS_SYS_MODE_GSM:
        status = QMI_NAS_RADIO_IF_GSM;
        break;
      case SYS_SYS_MODE_WCDMA:
        status = QMI_NAS_RADIO_IF_UMTS;
        break;
      case SYS_SYS_MODE_LTE:
        status = QMI_NAS_RADIO_IF_LTE;
        break;
      case SYS_SYS_MODE_CDMA:
        status = QMI_NAS_RADIO_IF_CDMA20001X;
        break;
      case SYS_SYS_MODE_HDR:
        status = QMI_NAS_RADIO_IF_CDMA20001XEVDO;
        break;
      case SYS_SYS_MODE_TDS:
        status = QMI_NAS_RADIO_IF_TDSCDMA;
        break;
      default:
        break;
...
sys_radio_access_tech_e_type qmi_nas_radio_if_2_sys_radio_access( nas_radio_if_enum_v01 radio_if )
{
  ...
  switch( radio_if )
  {
    case NAS_RADIO_IF_GSM_V01:
      radio_access_tech = SYS_RAT_GSM_RADIO_ACCESS;
      break;
    case NAS_RADIO_IF_UMTS_V01:
      radio_access_tech = SYS_RAT_UMTS_RADIO_ACCESS;
      break;
    case NAS_RADIO_IF_LTE_V01:
      radio_access_tech = SYS_RAT_LTE_RADIO_ACCESS;
      break;
    case NAS_RADIO_IF_TDSCDMA_V01:
      radio_access_tech = SYS_RAT_TDS_RADIO_ACCESS;
      break;
    default:
...
/*===========================================================================
  FUNCTION qmi_nas_sys_mode_to_radio_if()

  DESCRIPTION
    Converts sys_sys_mode_e_type to nas_radio_if_enum_v01 type

  PARAMETERS
    sys_sys_mode_e_type: RAT to convert

  RETURN VALUE
    corresponding radio_if
===========================================================================*/
nas_radio_if_enum_v01 qmi_nas_sys_mode_to_radio_if( sys_sys_mode_e_type sys_mode )
{
  nas_radio_if_enum_v01 radio_if = NAS_RADIO_IF_NO_SVC_V01;

  switch ( sys_mode )
  {
    case SYS_SYS_MODE_HDR:
      radio_if = NAS_RADIO_IF_CDMA_1XEVDO_V01;
      break;
    case SYS_SYS_MODE_LTE:
      radio_if = NAS_RADIO_IF_LTE_V01;
      break;
    case SYS_SYS_MODE_GSM:
      radio_if = NAS_RADIO_IF_GSM_V01;
      break;
    case SYS_SYS_MODE_WCDMA:
      radio_if = NAS_RADIO_IF_UMTS_V01;
      break;
    case SYS_SYS_MODE_CDMA:
      radio_if = NAS_RADIO_IF_CDMA_1X_V01;
      break;
    case SYS_SYS_MODE_TDS:
      radio_if = NAS_RADIO_IF_TDSCDMA_V01;
      break;
    case SYS_SYS_MODE_WLAN:
      radio_if = NAS_RADIO_IF_WLAN_V01;
      break;
    default:
      QM_MSG_HIGH_1("unknown radio if %d", sys_mode);
      radio_if = NAS_RADIO_IF_NO_SVC_V01;
      break;
  }
...
nas_active_band_enum_v01 qmi_nas_cm_bc_2_qmi_bc( sys_band_class_e_type cm_bc )
{
  ...
  switch ( cm_bc )
  {
    ...
    case SYS_BAND_LTE_EUTRAN_BAND46:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_46_V01;
      break;
    case SYS_BAND_LTE_EUTRAN_BAND47:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_47_V01;
      break;
    case SYS_BAND_LTE_EUTRAN_BAND48:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_48_V01;
      break;
    ...
    case SYS_BAND_LTE_EUTRAN_BAND125:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_125_V01;
      break;
    case SYS_BAND_LTE_EUTRAN_BAND126:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_126_V01;
      break;
    case SYS_BAND_LTE_EUTRAN_BAND127:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_127_V01;
      break;
    case SYS_BAND_LTE_EUTRAN_BAND250:
      qmi_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_250_V01;
      break;
...
{
  enum qmi_nas_hdr_personality_e qmi_val = QMI_NAS_HDR_PERSONALITY_UNKNOWN;

  switch ( cm_val )
  {
    case SYS_PERSONALITY_HRPD:
      qmi_val = QMI_NAS_HDR_PERSONALITY_HRPD;
      break;
    case SYS_PERSONALITY_EHRPD:
      qmi_val = QMI_NAS_HDR_PERSONALITY_EHRPD;
      break;
    default:
      break;
  }
...
{
  nas_eutra_cell_status_enum_type_v01 qmi_val = NAS_EUTRA_CELL_PRESENCE_UNKNOWN_V01;

  switch ( cm_eutra_status )
  {
    case SYS_EUTRA_CELL_PRESENT          :
      qmi_val = NAS_EUTRA_CELL_PRESENT_V01;
      break;
    case SYS_EUTRA_CELL_NOT_PRESENT      :
      qmi_val = NAS_EUTRA_CELL_NOT_PRESENT_V01;
      break;
    case SYS_EUTRA_DETECTION_UNKNOWN     :
      qmi_val = NAS_EUTRA_CELL_PRESENCE_UNKNOWN_V01;
      break;
    case SYS_EUTRA_DETECTION_UNSUPPORTED :
      qmi_val = NAS_EUTRA_CELL_DETECTION_UNSUPPORTED_V01;
      break;
    default:
...
mmgsdi_rat_enum_type qmi_nas_rat_qmi_to_mmgsdi( enum qmi_nas_radio_if_e qmi_rat )
{
  ...
  switch ( qmi_rat )
  {
    case QMI_NAS_RADIO_IF_GSM:
      mmgsdi_val = MMGSDI_RAT_GSM;
      break;
    case QMI_NAS_RADIO_IF_UMTS:
      mmgsdi_val = MMGSDI_RAT_UMTS;
      break;
    case QMI_NAS_RADIO_IF_LTE:
      mmgsdi_val = MMGSDI_RAT_LTE;
      break;
    case QMI_NAS_RADIO_IF_TDSCDMA:
      mmgsdi_val = MMGSDI_RAT_TDS;
      break;
    default:
...
enum qmi_nas_radio_if_e qmi_nas_rat_mmgsdi_to_qmi( mmgsdi_rat_enum_type mmgsdi_rat )
{
  ...
  {
    case MMGSDI_RAT_GSM:
      qmi_val = QMI_NAS_RADIO_IF_GSM;
      break;
    case MMGSDI_RAT_UMTS:
      qmi_val = QMI_NAS_RADIO_IF_UMTS;
      break;
    case MMGSDI_RAT_LTE:
      qmi_val = QMI_NAS_RADIO_IF_LTE;
      break;
    case MMGSDI_RAT_TDS:
      qmi_val = QMI_NAS_RADIO_IF_TDSCDMA;
      break;
    default:
...
)
{
  ...
  if( sys_info_limits & QMI_NAS_LIMIT_BY_RAC )
  {
    ...
    if ( ( new_ind->gsm_rac_valid                                    &&
         ...
         ( new_ind->tds_rac_valid                                    &&
           old_ind->tds_rac_valid                                    &&
           new_ind->tds_rac != old_ind->tds_rac ) ||
         QMI_NAS_XOR( new_ind->gsm_rac_valid, old_ind->gsm_rac_valid )  ||
         QMI_NAS_XOR( new_ind->wcdma_rac_valid, old_ind->wcdma_rac_valid ) ||
         QMI_NAS_XOR( new_ind->tds_rac_valid, old_ind->tds_rac_valid ) )
    {
      retval = TRUE;
    }
  }
  ...
  QM_MSG_HIGH_3("sys_info_limits  %d new wcdma_cs_signalling_bar_status %d old wcdma_cs_signalling_bar_status %d",sys_info_limits,new_ind->wcdma_cs_signalling_bar_status,old_ind->wcdma_cs_signalling_bar_status);
  ...
  if( sys_info_limits & QMI_NAS_LIMIT_BY_CS_BAR_STATUS )
  {
    ...
    if ( ( new_ind->gsm_sys_info3_valid                        &&
         ...
         (new_ind->wcdma_cs_signalling_bar_status != old_ind->wcdma_cs_signalling_bar_status )  )
    {
      retval = TRUE;
    }
  }
  ...
  if( sys_info_limits & QMI_NAS_LIMIT_BY_PS_BAR_STATUS )
  {
    ...
    if ( ( new_ind->gsm_sys_info3_valid                        &&
         ...
         QMI_NAS_XOR( new_ind->gsm_sys_info3_valid, old_ind->gsm_sys_info3_valid   )  ||
         QMI_NAS_XOR( new_ind->wcdma_sys_info3_valid, old_ind->wcdma_sys_info3_valid )  ||
         (new_ind->wcdma_ps_signalling_bar_status != old_ind->wcdma_ps_signalling_bar_status )  )
    {
      retval = TRUE;
    }
  }
...
{
  sys_sys_mode_e_type cm_val = SYS_SYS_MODE_NONE;

  switch ( radio_if )
  {
    case NAS_RADIO_IF_CDMA_1XEVDO_V01:
      cm_val = SYS_SYS_MODE_HDR;
      break;
    case NAS_RADIO_IF_LTE_V01:
      cm_val = SYS_SYS_MODE_LTE;
      break;
    case NAS_RADIO_IF_GSM_V01:
      cm_val = SYS_SYS_MODE_GSM;
      break;
    case NAS_RADIO_IF_UMTS_V01:
      cm_val = SYS_SYS_MODE_WCDMA;
      break;
    case NAS_RADIO_IF_CDMA_1X_V01:
      cm_val = SYS_SYS_MODE_CDMA;
      break;
    case NAS_RADIO_IF_TDSCDMA_V01:
      cm_val = SYS_SYS_MODE_TDS;
      break;
    case NAS_RADIO_IF_WLAN_V01:
      cm_val = SYS_SYS_MODE_WLAN;
      break;
    default:
...
nas_voice_sms_status_e_type qmi_nas_map_voice_sms_status_cm_to_qmi( sys_cm_domain_sel_domain_e_type domain )
{
  ...
  switch( domain )
  {
    ...
    case SYS_CM_DOMAIN_SEL_DOMAIN_IMS     :
      retval = NAS_VOICE_SMS_STATUS_IMS;
      break;
    case SYS_CM_DOMAIN_SEL_DOMAIN_1X      :
      retval = NAS_VOICE_SMS_STATUS_1X;
      break;
    case SYS_CM_DOMAIN_SEL_DOMAIN_3GPP    :
      retval = NAS_VOICE_SMS_STATUS_3GPP;
      break;
...
void qmi_nas_update_global_ims_pref( cm_mm_msim_ss_info_s_type *p_ss_info )
{
  ...
  enum qmi_nas_subs_e              subs = (enum qmi_nas_subs_e)p_ss_info->asubs_id;
  ...
  QM_MSG_HIGH_1("Updating ims_pref cache on sub %d", subs);
  ...
  {
    if(qmi_nasi_global.ims_pref_cache[subs].lte_mask_valid)
    {
      QM_MSG_HIGH("LTE cache reset");
    }
    qmi_nasi_global.ims_pref_cache[subs].lte_mask_valid = FALSE;
    qmi_nasi_global.ims_pref_cache[subs].lte_call_mask = 0;
  }
  ...
  if ( ( p_ss_info->number_of_stacks == 1 &&
       ...
       ( p_ss_info->number_of_stacks > 1 &&
         ( p_ss_info->stack_info[STACK_INDEX_1].sys_mode != SYS_SYS_MODE_HDR || p_ss_info->stack_info[STACK_INDEX_1].srv_status != SYS_SRV_STATUS_SRV ||
           ( p_ss_info->stack_info[STACK_INDEX_1].srv_domain != SYS_SRV_DOMAIN_CS_PS && p_ss_info->stack_info[STACK_INDEX_1].srv_domain != SYS_SRV_DOMAIN_PS_ONLY && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CAMPED ) ) ) )
  {
    if(qmi_nasi_global.ims_pref_cache[subs].hdr_mask_valid)
    {
      QM_MSG_HIGH("HDR cache reset");
    }
    qmi_nasi_global.ims_pref_cache[subs].hdr_mask_valid = FALSE;
    qmi_nasi_global.ims_pref_cache[subs].hdr_call_mask = 0;
  }
  ...
  if ( p_ss_info->stack_info[STACK_INDEX_0].sys_mode != SYS_SYS_MODE_GSM || p_ss_info->stack_info[STACK_INDEX_0].srv_status != SYS_SRV_STATUS_SRV ||
       ( p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CS_PS && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_PS_ONLY && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CAMPED ) )
  {
    if(qmi_nasi_global.ims_pref_cache[subs].gsm_mask_valid)
    {
      QM_MSG_HIGH("GSM cache reset");
    }
    qmi_nasi_global.ims_pref_cache[subs].gsm_mask_valid = FALSE;
    qmi_nasi_global.ims_pref_cache[subs].gsm_call_mask = 0;
  }
  ...
  if ( p_ss_info->stack_info[STACK_INDEX_0].sys_mode != SYS_SYS_MODE_WCDMA || p_ss_info->stack_info[STACK_INDEX_0].srv_status != SYS_SRV_STATUS_SRV ||
       ( p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CS_PS && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_PS_ONLY && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CAMPED ) )
  {
    if(qmi_nasi_global.ims_pref_cache[subs].wcdma_mask_valid)
    {
      QM_MSG_HIGH("WCDMA cache reset");
    }
    qmi_nasi_global.ims_pref_cache[subs].wcdma_mask_valid = FALSE;
    qmi_nasi_global.ims_pref_cache[subs].wcdma_call_mask = 0;
  }
  ...
  if ( p_ss_info->stack_info[STACK_INDEX_0].sys_mode != SYS_SYS_MODE_CDMA || p_ss_info->stack_info[STACK_INDEX_0].srv_status != SYS_SRV_STATUS_SRV ||
       ( p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CS_PS && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_PS_ONLY && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CAMPED ) )
  {
    if(qmi_nasi_global.ims_pref_cache[subs].cdma_mask_valid)
    {
      QM_MSG_HIGH("CDMA cache reset");
    }
    qmi_nasi_global.ims_pref_cache[subs].cdma_mask_valid = FALSE;
    qmi_nasi_global.ims_pref_cache[subs].cdma_call_mask = 0;
  }
  ...
  if ( p_ss_info->stack_info[STACK_INDEX_0].sys_mode != SYS_SYS_MODE_TDS || p_ss_info->stack_info[STACK_INDEX_0].srv_status != SYS_SRV_STATUS_SRV ||
       ( p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CS_PS && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_PS_ONLY && p_ss_info->stack_info[STACK_INDEX_0].srv_domain != SYS_SRV_DOMAIN_CAMPED ) )
  {
    if(qmi_nasi_global.ims_pref_cache[subs].tds_mask_valid)
    {
      QM_MSG_HIGH("TDS cache reset");
    }
    qmi_nasi_global.ims_pref_cache[subs].tds_mask_valid = FALSE;
    qmi_nasi_global.ims_pref_cache[subs].tds_call_mask = 0;
  }
}
...
nas_active_band_enum_v01  qmi_nas_qmi_sys_lte_bc_2_lte_bc(sys_sband_lte_e_type  sys_lte_bc )
{
  ...
  switch ( sys_lte_bc )
  {
    case SYS_SBAND_LTE_EUTRAN_BAND1 :
      nas_lte_bc = NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_1_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND2 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_2_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND3 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_3_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND4 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_4_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND5 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_5_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND6 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_6_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND7 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_7_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND8 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_8_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND9 :
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_9_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND10:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_10_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND11:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_11_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND12:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_12_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND13:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_13_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND14:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_14_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND17:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_17_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND18:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_18_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND19:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_19_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND20:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_20_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND21:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_21_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND23:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_23_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND24:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_24_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND25:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_25_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND26:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_26_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND27:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_27_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND28:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_28_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND29:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_29_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND30:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_30_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND31:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_31_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND32:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_32_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND33:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_33_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND34:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_34_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND35:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_35_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND36:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_36_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND37:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_37_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND38:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_38_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND39:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_39_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND40:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_40_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND41:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_41_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND42:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_42_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND43:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_43_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND46:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_46_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND47:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_47_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND48:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_48_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND66:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_66_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND71:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_71_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND125:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_125_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND126:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_126_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND127:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_127_V01;
      break;
    case SYS_SBAND_LTE_EUTRAN_BAND250:
      nas_lte_bc =  NAS_ACTIVE_BAND_E_UTRA_OPERATING_BAND_250_V01;
      break;
    default:
...
/*===========================================================================
  FUNCTION qmi_nas_map_cm_asubs_to_1x_mmgsdi_session()

  DESCRIPTION
    Map CM asubs id to 1x MMGSDI session
  ...
  SIDE EFFECTS
    None
===========================================================================*/
mmgsdi_session_type_enum_type qmi_nas_map_cm_asubs_to_1x_mmgsdi_session( sys_modem_as_id_e_type asubs_id )
{
  mmgsdi_session_type_enum_type session = MMGSDI_1X_PROV_PRI_SESSION;
...
/*===========================================================================
  FUNCTION qmi_nas_map_bound_sub_to_ph_info()

  DESCRIPTION
    Map qmi sub id to ph info ptr
  ...
  SIDE EFFECTS
    None
===========================================================================*/
qmi_cm_ph_info_s_type *qmi_nas_map_bound_sub_to_ph_info(
...
)
{
  ...
  if(bound_subs==QMI_NAS_SUBS_TERTIARY)
  {
...
/*===========================================================================
  FUNCTION qmi_nas_map_cm_asubs_to_ph_info()

  DESCRIPTION
    Map cm asub id to ph info ptr
  ...
  SIDE EFFECTS
    None
===========================================================================*/
qmi_cm_ph_info_s_type *qmi_nas_map_cm_asubs_to_ph_info(
...
===========================================================================*/
sys_modem_as_id_e_type qmi_nas_get_variant(
...
/*===========================================================================
  FUNCTION qmi_nas_reset_incremental_net_scan_prefs()

  DESCRIPTION
    Resets incremental network scan preferences.
  ...
  SIDE EFFECTS
    None
===========================================================================*/
void qmi_nas_reset_incremental_net_scan_prefs(boolean clr_status)
{
  qmi_nasi_global.net_scan_started = FALSE;
  qmi_nasi_global.is_net_scan_periodic = FALSE;
  qmi_nasi_global.net_scan_type = CM_NETWORK_LIST_NONE;
...
/*===========================================================================
  FUNCTION qmi_nas_map_geran_sys_band_active_band()

  DESCRIPTION
    Maps eng_mode_sys_band_T to nas_active_band_enum_v01
  ...
  SIDE EFFECTS
    None
===========================================================================*/
nas_active_band_enum_v01 qmi_nas_map_geran_sys_band_active_band(eng_mode_sys_band_T band)
{

  switch(band)
  {
    case ENG_MODE_SYS_BAND_EGSM_900:
      return NAS_ACTIVE_BAND_GSM_900_EXTENDED_V01;
    case ENG_MODE_SYS_BAND_PGSM_900:
      return NAS_ACTIVE_BAND_GSM_900_PRIMARY_V01;
    case ENG_MODE_SYS_BAND_PCS_1900:
      return NAS_ACTIVE_BAND_GSM_1900_V01;
    case ENG_MODE_SYS_BAND_DCS_1800:
      return NAS_ACTIVE_BAND_GSM_1800_V01;
    case ENG_MODE_SYS_BAND_CELL_850:
      return NAS_ACTIVE_BAND_GSM_850_V01;
    default:
      QM_MSG_ERROR_1("invalid qmi bc %d", band);
      return NAS_ACTIVE_BAND_BC_0_V01;
...
/*===========================================================================
  FUNCTION qmi_nas_map_sys_wcdma_rrc_state()

  DESCRIPTION
    Maps sys wcdma RRC state to nas_wcdma_rrc_state_enum_v01
  ...
  SIDE EFFECTS
    None
===========================================================================*/
nas_wcdma_rrc_state_enum_v01 qmi_nas_map_sys_wcdma_rrc_state(sys_wcdma_rrc_state_e_type state)
{

  switch(state)
  {
    case SYS_WCDMA_RRC_STATE_DISCONNECTED:
        return NAS_WCDMA_RRC_STATE_DISCONNECTED_V01;
    case SYS_WCDMA_RRC_STATE_CELL_FACH:
        return NAS_WCDMA_RRC_STATE_CELL_FACH_V01;
    case SYS_WCDMA_RRC_STATE_CELL_DCH:
        return NAS_WCDMA_RRC_STATE_CELL_DCH_V01;
    case SYS_WCDMA_RRC_STATE_CELL_PCH:
        return NAS_WCDMA_RRC_STATE_CELL_PCH_V01;
    case SYS_WCDMA_RRC_STATE_URA_PCH:
        return NAS_WCDMA_RRC_STATE_URA_PCH_V01;
    default:
        QM_MSG_ERROR_1("invalid WCDMA RRC state %d", state);
        return NAS_WCDMA_RRC_STATE_DISCONNECTED_V01;
  }
}
#ifndef REMOVE_QMI_NAS_GET_ARFCN_LIST_V01
/*===========================================================================
  FUNCTION qmi_nas_map_lte_rrc_state()

  DESCRIPTION
    Maps sys LTE RRC state to lte_rrc_state_ext_e_type_v01
  ...
  SIDE EFFECTS
    None
===========================================================================*/
lte_rrc_state_ext_e_type_v01 qmi_nas_map_lte_rrc_state(lte_rrc_state_e state)
{

  switch(state)
  {

    case LTE_RRC_STATE__IDLE_CAMPED:
        return LTE_RRC_STATE_EXT_IDLE_CAMPED_NORMAL_V01;
    case LTE_RRC_STATE__CONNECTING:
        return LTE_RRC_STATE_EXT_CONNECTING_V01;
    case LTE_RRC_STATE__CONNECTED:
        return LTE_RRC_STATE_EXT_CONNECTED_V01;
    case LTE_RRC_STATE__CLOSING:
        return LTE_RRC_STATE_EXT_CLOSING_V01;
    default:
        QM_MSG_ERROR_1("invalid WCDMA RRC state %d", state);
        return LTE_RRC_STATE_EXT_NULL_V01;
  }
