...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_voice.c#7 $ $DateTime: 2010/04/22 22:49:27 $ $voiceor: nlocanin $
...
#define VOICEI_IND_REG_ECALL_STATUS_NOTIFY     (0x25)
#define VOICEI_IND_REG_CALL_REEST_STATUS_NOTIFY (0x26)
#define VOICEI_IND_REG_VICE_DIALOG_INFO_NOTIFY (0x27)
#define VOICEI_IND_REG_MT_CALL_END_AUTO_REJECT_NOTIFY (0x29)
#define VOICEI_IND_REG_SIP_DTMF_EVENT_NOTIFY (0x2F)
...
#define VOICEI_GET_CALL_CALLED_PARTY_SUBADDRESS (0x25)
...
#define VOICEI_ALL_CALL_IND_CALLED_PARTY_SUBADDRESS         (0x30)
...
#define VOICEI_ALL_CALL_IND_IS_CONF_ENABLED                 (0x37)
#define VOICEI_ALL_CALL_IND_RTT_MODE                        (0x38)
#define VOICEI_ALL_CALL_IND_RTT_CAP                         (0x39)
#define VOICEI_ALL_CALL_IND_ALTERNATE_SIP_URIS               (0x3A)
#define VOICEI_ALL_CALL_IND_IP_ALERT_INFO                   (0x3B)
#define VOICEI_ALL_CALL_IND_VERSTAT_INFO                    (0x3E)
#define VOICEI_ALL_CALL_IND_CALL_COMP_CAP                   (0x42)
#define VOICEI_ALL_CALL_IND_CALL_COMP_IMP                   (0x43)
#define VOICEI_ALL_CALL_IND_CALL_COMP_SUBJECT               (0x44)
#define VOICEI_ALL_CALL_IND_CALL_COMP_PIC_URL               (0x45)
#define VOICEI_ALL_CALL_IND_CALL_COMP_POINT_LOC             (0x46)
#define VOICEI_ALL_CALL_IND_CALL_COMP_CIRCLE_LOC            (0x47)
#define VOICEI_ALL_CALL_IND_SILENT_UI                       (0x48)
#define VOICEI_ALL_CALL_IND_ORIGINAL_CALL_TYPE              (0x49)
#define VOICEI_ALL_CALL_IND_CRS_TYPE                        (0x4A)


#define VOICEI_ALL_CALL_IND_TIR_MODE                        (0x41)
#define VOICEI_ALL_CALL_IND_EMERG_SRV_CATEG                 (0x3F)
#define VOICEI_ALL_CALL_IND_PROG_INFO_NOTIF                 (0x4B)
...
#define VOICEI_GET_ALL_CALL_CALLED_PARTY_SUBADDRESS (0x29)
...
#define VOICEI_GET_ALL_CALL_RTT_MODE                (0x2E)
#define VOICEI_GET_ALL_CALL_RTT_CAP                 (0x2F)
#define VOICEI_GET_ALL_CALL_ALTERNATE_SIP_URIS       (0x30)
#define VOICEI_GET_ALL_CALL_COMP_CAP               (0x31)
#define VOICEI_GET_ALL_CALL_COMP_IMP               (0x32)
#define VOICEI_GET_ALL_CALL_COMP_SUBJECT           (0x33)
#define VOICEI_GET_ALL_CALL_COMP_PIC_URL           (0x34)
#define VOICEI_GET_ALL_CALL_COMP_POINT_LOC         (0x35)
#define VOICEI_GET_ALL_CALL_COMP_CIRCLE_LOC        (0x36)
...
#define VOICEI_SET_ALL_CALL_SUPS_FWD_NUM      (0x10)
#define VOICEI_SET_ALL_CALL_FWD_SC            (0x11)
#define VOICEI_SET_ALL_CALL_FWD_NR_TIMER      (0x12)
#define VOICEI_SET_ALL_CALL_FWD_NUM_TYPE_PLAN (0x13)
#define VOICEI_SET_ALL_CALL_FWD_START_TIME    (0x14)
#define VOICEI_SET_ALL_CALL_FWD_END_TIME      (0x15)
#define VOICEI_SET_ALL_CALL_FWD_SUPS_REASON   (0x16)
...
#define VOICEI_GET_WWAN_911_TIMER           (0x10)
...
#define VOICEI_MNG_IP_CALLS_RTT_MODE     (0x1A)
#define VOICEI_MNG_IP_CALLS_IS_SECURE_CALL     (0x1B)
#define VOICEI_MNG_IP_CALLS_SPEECH_CODEC_MASK     (0x1C)
#define VOICEI_MNG_IP_CALLS_PRI_SPEECH_CODEC     (0x1D)
...
#define VOICEI_CALL_REESTAB_STATUS      (0x01)
...
typedef enum
{
  ...
  VOICEI_CMD_SECURE_CALL_MODE,
  VOICEI_CMD_SET_WWAN_911_TIMER,
  VOICEI_CMD_GET_WWAN_911_TIMER,
  VOICEI_CMD_CALL_ENCRYPTION_REQ,
  VOICEI_CMD_GET_SPEECH_CODEC_INFO,
  VOICEI_CMD_AVOID_PLMN_LIST,
  VOICEI_CMD_IMS_CALL_CANCEL,
  VOICEI_CMD_SET_ALL_CALL_FWD_SUPS,
  VOICEI_CMD_SIP_DTMF,
  VOICEI_CMD_MAX, 
...
typedef enum
{
  ...
  VOICEI_CMD_VAL_GET_SUPPORTED_MSGS     = 0x001E,
  ...
  VOICEI_CMD_VAL_SECURE_CALL_MODE = 0x0067,
  VOICEI_CMD_VAL_SET_WWAN_911_TIMER = 0x0068,
  VOICEI_CMD_VAL_GET_WWAN_911_TIMER = 0x0069,
  VOICEI_CMD_VAL_ECALL_STATUS_IND = 0x006A,
  VOICEI_CMD_VAL_CALL_REESTABLISHMENT_STATUS_IND = 0x006B,
  VOICEI_CMD_VAL_CALL_ENCRYPTION_REQ = 0x006D,
  VOICEI_CMD_VAL_GET_SPEECH_CODEC_INFO = 0x006E,
  VOICEI_CMD_VAL_IMS_CALL_CANCEL = 0x006F,
  VOICEI_CMD_VAL_AVOID_PLMN_LIST = 0x0070,
  VOICEI_CMD_VAL_SET_ALL_CALL_FWD_SUPS = 0x0076,
  VOICEI_CMD_VAL_SIP_DTMF = 0x007D,
  VOICEI_CMD_VAL_SIP_DTMF_IND = 0x007E,
...
typedef struct qmi_voicei_client_state_s
{
  ...
  struct
  {
    ...
    boolean                      reg_ecall_status_events;
    boolean                      reg_call_reest_status_events;
    boolean                      reg_vice_dialog_info_events;
    boolean 			 reg_mt_call_end_auto_reject_events;
    boolean                      reg_sip_dtmf_event;
  } voice_info;
  struct
  {
...
static VOICE_HDLR_PROTOTYPE(qmi_voicei_get_supported_msgs);
...
static VOICE_HDLR_PROTOTYPE(qmi_voicei_sip_dtmf_req);
...
static VOICE_HDLR_PROTOTYPE(qmi_voicei_set_all_call_fwd_sups);
...
static dsm_item_type *qmi_voicei_secure_call_mode(void *, void *, void *, dsm_item_type **);

static VOICE_HDLR_PROTOTYPE(qmi_voicei_set_wwan_911_timer_req);
static VOICE_HDLR_PROTOTYPE(qmi_voicei_get_wwan_911_timer_req);

static dsm_item_type *qmi_voicei_call_encryption_req(void *, void *, void *, dsm_item_type **);

static dsm_item_type* qmi_voicei_ims_call_cancel_req(void*, void*, void*, dsm_item_type **);
static dsm_item_type* qmi_voicei_avoid_plmn_req(void*, void*, void*, dsm_item_type **);
...
static qmi_svc_cmd_hdlr_type  qmi_voicei_cmd_callbacks[VOICEI_CMD_MAX] =
{
...
#endif
#ifndef REMOVE_QMI_VOICE_GET_SUPPORTED_MSGS_V02
  VOICE_HDLR( VOICEI_CMD_VAL_GET_SUPPORTED_MSGS, qmi_voicei_get_supported_msgs ),
#endif
...
#endif
#ifndef REMOVE_QMI_VOICE_SET_ALL_CALL_FWD_SUPS_V02
  VOICE_HDLR( VOICEI_CMD_VAL_SET_ALL_CALL_FWD_SUPS, qmi_voicei_set_all_call_fwd_sups ),
#endif
...
#endif
#ifndef REMOVE_QMI_VOICE_SECURE_CALL_MODE_V02
  VOICE_HDLR( VOICEI_CMD_VAL_SECURE_CALL_MODE, qmi_voicei_secure_call_mode),
#endif
#ifndef REMOVE_QMI_VOICE_SET_WWAN_911_TIMER_V02
  VOICE_HDLR( VOICEI_CMD_VAL_SET_WWAN_911_TIMER, qmi_voicei_set_wwan_911_timer_req),
#endif
#ifndef REMOVE_QMI_VOICE_GET_WWAN_911_TIMER_V02
  VOICE_HDLR( VOICEI_CMD_VAL_GET_WWAN_911_TIMER, qmi_voicei_get_wwan_911_timer_req),
#endif
  ...
  #endif
#ifndef REMOVE_QMI_VOICE_IMS_CALL_CANCEL_REQ_V02
  VOICE_HDLR( VOICEI_CMD_VAL_IMS_CALL_CANCEL, qmi_voicei_ims_call_cancel_req),
#endif
#ifndef REMOVE_QMI_VOICE_AVOID_PLMN_LIST_REQ_V02
  VOICE_HDLR( VOICEI_CMD_VAL_AVOID_PLMN_LIST, qmi_voicei_avoid_plmn_req),
#endif
#ifndef REMOVE_QMI_VOICE_SIP_DTMF_REQ_V02
  VOICE_HDLR( VOICEI_CMD_VAL_SIP_DTMF, qmi_voicei_sip_dtmf_req),
#endif
...
static void qmi_voicei_ecall_status_ind
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);

static void qmi_voicei_set_wwan_911_timer_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);

static void qmi_voicei_get_wwan_911_timer_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);

static void qmi_voicei_call_reestablishment_status_ind
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);
...
static void qmi_voicei_sip_dtmf_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);
...
static void qmi_voicei_get_supported_msgs_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);
...
static void qmi_voicei_set_all_call_fwd_sups_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);
...
static void qmi_voicei_ims_call_cancel_resp
(
   const qmi_voice_cm_if_info_item_s *const data_ptr
);
#ifndef REMOVE_QMI_VOICE_AVOID_PLMN_LIST_REQ_V02
static void qmi_voicei_avoid_plmn_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);
#endif
static void qmi_voicei_sip_dtmf_ind
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
);
...
)
{
  ...
  QM_ASSERT (user_data_ptr);

  data_ptr = (qmi_mmode_cmd_data_buf_type *) user_data_ptr;
  QM_ASSERT (data_ptr->cmd.cm_if_data_ptr->header.cmd < QMI_VOICE_CM_IF_CMD_MAX);
  ...
  {
    case QMI_VOICE_CM_IF_CMD_GET_SUPPORTED_MSGS_RESP:
      qmi_voicei_get_supported_msgs_resp( data_ptr->cmd.cm_if_data_ptr );
      break;
    ...
    case QMI_VOICE_CM_IF_CMD_SUPS_SET_SUPS_SERVICE_RESP:
      ...
      break;
    case QMI_VOICE_CM_IF_CMD_SET_ALL_CALL_FWD_SUPS_RESP:
      qmi_voicei_set_all_call_fwd_sups_resp( data_ptr->cmd.cm_if_data_ptr );
      break;
    ...
    case QMI_VOICE_CM_IF_CMD_E911_ORIG_FAIL_IND:
      ...
      break;
    case QMI_VOICE_CM_IF_CMD_ECALL_STATUS_IND:
      qmi_voicei_ecall_status_ind( data_ptr->cmd.cm_if_data_ptr );
      break;
    case QMI_VOICE_CM_IF_CMD_SET_WWAN_911_TIMER_RESP:
      qmi_voicei_set_wwan_911_timer_resp(data_ptr->cmd.cm_if_data_ptr);
      break;
    case QMI_VOICE_CM_IF_CMD_GET_WWAN_911_TIMER_RESP:
      qmi_voicei_get_wwan_911_timer_resp(data_ptr->cmd.cm_if_data_ptr);
      break;
    case QMI_VOICE_CM_IF_CMD_CALL_REEST_STATUS_IND:
      qmi_voicei_call_reestablishment_status_ind(data_ptr->cmd.cm_if_data_ptr);
      break;
    ...
    case QMI_VOICE_CM_IF_CMD_SPEECH_CODEC_INFO_RESP:
      ...
      break;
    case QMI_VOICE_CM_IF_CMD_IMS_CALL_CANCEL_RESP:
       qmi_voicei_ims_call_cancel_resp(data_ptr->cmd.cm_if_data_ptr);
        break;
    #ifndef REMOVE_QMI_VOICE_AVOID_PLMN_LIST_REQ_V02
    case QMI_VOICE_CM_IF_CMD_AVOID_PLMN_RESP:
       qmi_voicei_avoid_plmn_resp(data_ptr->cmd.cm_if_data_ptr);
	   break;
    #endif
    ...
    case QMI_VOICE_CM_IF_CMD_SIP_DTMF_RESP:
      qmi_voicei_sip_dtmf_resp(data_ptr->cmd.cm_if_data_ptr);
      break;

    case QMI_VOICE_CM_IF_CMD_SIP_DTMF_IND:
      qmi_voicei_sip_dtmf_ind(data_ptr->cmd.cm_if_data_ptr);
      break;
  ...
  QM_MEM_FREE(data_ptr->cmd.cm_if_data_ptr);
#else
  (void) cmd;
  (void) user_data_ptr;
...
)
{
  ...
  QM_MSG_MED_3("Status of QMI Voice indication(%d) sent to client %d: %d",
               cmd_type, common_hdr.client_id, status);
  return status;
...
)
{
  ...
  cl_sp = QM_MEM_ALLOC(sizeof(qmi_voicei_client_state_type));
  if ( cl_sp == NULL )
  {
    QM_ASSERT(cl_sp);
  }
...
)
{
  ...
  cl_sp_ptr->voice_info.reg_sups_other_events = FALSE;
  ...
  cl_sp_ptr->voice_info.reg_ecall_status_events = FALSE;
  cl_sp_ptr->voice_info.reg_call_reest_status_events = FALSE;
  cl_sp_ptr->voice_info.reg_vice_dialog_info_events = FALSE;
  cl_sp_ptr->voice_info.reg_mt_call_end_auto_reject_events = FALSE;
  cl_sp_ptr->voice_info.reg_sip_dtmf_event = FALSE;
...
)
{
  ...
  cmd_ptr->cmd.qmi_ptr = QM_MEM_ALLOC(sizeof(qmi_mmode_common_cmd_type));
...
)
{
  ...
  if(cl_sp)
  {
    ...
    cl_sp->voice_info.reg_sups_other_events = TRUE;
    ...
    cl_sp->voice_info.reg_ecall_status_events = FALSE;
    cl_sp->voice_info.reg_call_reest_status_events = FALSE;
    ...
    cl_sp->voice_info.reg_sip_dtmf_event = FALSE;
...
)
{
  ...
  cmd_ptr->cmd.qmi_ptr = QM_MEM_ALLOC(
...
{
  qmi_mmode_cmd_data_buf_type *data_ptr = NULL;
  qmi_mmode_common_cmd_type *qmi_info = NULL;

  QM_ASSERT (user_data_ptr);

  data_ptr = (qmi_mmode_cmd_data_buf_type *) user_data_ptr;
  QM_ASSERT(data_ptr->cmd.qmi_ptr);
  QM_ASSERT (data_ptr->cmd.qmi_ptr->id < QMI_VOICE_CM_IF_CMD_MAX);
...
{
  qmi_common_client_state_type *cmn_cl_sp = NULL;
  ...
  *client_sp_p = (qmi_voicei_client_state_type *) qmi_voicei_get_client_sp_by_clid(cmn_cl_sp->clid);
  ...
  cmd_ptr->cmd.cm_if_data_ptr = QM_MEM_ALLOC(sizeof(*(cmd_ptr->cmd.cm_if_data_ptr)));
...
)
{
  ...
  if(cmd_ptr != NULL)
  {
    QM_MEM_FREE(cmd_ptr->cmd.cm_if_data_ptr);
    qmi_mmode_free_cmd_data_buf(cmd_ptr);
  }
...
)
{
  ...
  boolean            got_sups_other_event=FALSE;
  ...
  boolean            got_ecall_status_event = FALSE;
  boolean      got_call_reest_status_event = FALSE;
  boolean      got_vice_dialog_info_event = FALSE;
  boolean      got_reg_mt_call_end_auto_reject_event = FALSE;
  boolean      got_reg_sip_dtmf_event = FALSE;
  uint8              priv_event, dtmf_event, sups_event, call_event, handover_event,sups_other_event;
  ...
  uint8              ecall_status_event;
  uint8        call_reest_status_event;
  uint8        vice_dialog_info_event;
  uint8        reg_mt_call_end_auto_reject_event;
  uint8        reg_sip_dtmf_event;
  ...
  if(client_sp != NULL)
  {
    ...
    sups_other_event = client_sp->voice_info.reg_sups_other_events;
    ...
    ecall_status_event = client_sp->voice_info.reg_ecall_status_events;
    call_reest_status_event = client_sp->voice_info.reg_call_reest_status_events;
    vice_dialog_info_event  = client_sp->voice_info.reg_vice_dialog_info_events;
    reg_mt_call_end_auto_reject_event = client_sp->voice_info.reg_mt_call_end_auto_reject_events;
    reg_sip_dtmf_event = client_sp->voice_info.reg_sip_dtmf_event;
  }
  else
  {
    QM_MSG_ERROR_1("Invalid client with id %d", cmn_cl_sp->clid);
  ...
  while (*sdu_in)
  {
    ...
    switch (type)
    {
      ...
      case VOICEI_IND_REG_SUPS_OTHER_NOTIFY:
	expected_len = sizeof(sups_other_event);
	value = &sups_other_event;
        got_sups_other_event = TRUE;
	break;
      ...
      case VOICEI_IND_REG_ADD_CALL_INFO_NOTIFY:
        ...
        break;
      case VOICEI_IND_REG_ECALL_STATUS_NOTIFY:
        expected_len = sizeof(ecall_status_event);
        value = &ecall_status_event;
        got_ecall_status_event = TRUE;
        break;
      case VOICEI_IND_REG_CALL_REEST_STATUS_NOTIFY:
        expected_len = sizeof(call_reest_status_event);
        value = &call_reest_status_event;
        got_call_reest_status_event = TRUE;
        break;
      ...
      case VOICEI_IND_REG_MT_CALL_END_AUTO_REJECT_NOTIFY:
        expected_len = sizeof(reg_mt_call_end_auto_reject_event);
	value = &reg_mt_call_end_auto_reject_event;
	got_reg_mt_call_end_auto_reject_event = TRUE;
	break;

      case VOICEI_IND_REG_SIP_DTMF_EVENT_NOTIFY:
        expected_len = sizeof(reg_sip_dtmf_event);
        value = &reg_sip_dtmf_event;
        got_reg_sip_dtmf_event = TRUE;
        break;
  ...
  if (got_priv_event||got_dtmf_event||got_sups_event ||got_call_event ||
      ...
      got_add_call_info_event || got_ecall_status_event || got_call_reest_status_event ||got_vice_dialog_info_event ||
      got_reg_mt_call_end_auto_reject_event || got_sups_other_event || got_reg_sip_dtmf_event)
  {
  ...
  client_sp->voice_info.reg_sups_other_events     = sups_other_event;
  ...
  client_sp->voice_info.reg_ecall_status_events = ecall_status_event;
  client_sp->voice_info.reg_call_reest_status_events = call_reest_status_event;
  client_sp->voice_info.reg_vice_dialog_info_events = vice_dialog_info_event;
  client_sp->voice_info.reg_mt_call_end_auto_reject_events = reg_mt_call_end_auto_reject_event;
  client_sp->voice_info.reg_sip_dtmf_event = reg_sip_dtmf_event;
  ...
  QM_MSG_MED_8("uus event = %d, aoc event = %d, conf event = %d, ext brst intl event = %d, page miss event = %d, cc result event = %d ,vice_dialog_info_event =%d, reg_mt_call_end_auto_reject_event = %d",
               uus_event, aoc_event, conf_event, ext_brst_intl_event, page_miss_event, cc_result_event, vice_dialog_info_event, reg_mt_call_end_auto_reject_event);
  QM_MSG_MED_7("conf parts = %d, tty info event = %d, e911_orig_fail=%d, add call info %d, audio rat change event = %d, ecall status event = %d ,call_reest_status_event = %d",
               conf_parts_event, tty_info_event, e911_orig_fail_event, add_call_info_event, audio_rat_change_event, ecall_status_event, call_reest_status_event);
  QM_MSG_MED_2("sups_other_event = %d, reg_sip_dtmf_event %d", sups_other_event, reg_sip_dtmf_event);
...
/*===========================================================================
  FUNCTION QMI_VOICEI_GETS_UPPORTED_MSGS()
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type *qmi_voicei_get_supported_msgs
(
  void             *sp,
  void             *cmd_buf_p,
  void             *cl_sp,
...
)
{
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_GET_SUPPORTED_MSGS_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.supported_msg_req),
                                         (uint32_t) sizeof(qmi_get_supported_msgs_req_v01));
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_GET_SUPPORTED_MSGS;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
)
{
  ...
  dsm_item_type          *response;
  qmi_error_e_type        errval;
  qmi_voice_cm_if_all_call_info_s       *all_call_info = NULL;
  uint8     i, num_of_instances=0,alpha_len=0;
  int       tot_len=0, uus_len=0, cnap_len=0, rp_num_len=0, tag, diags_len=0, con_len=0;
  int       redirect_len=0,called_len=0, subaddr_len=0;
  uint8     len_SIP_URI=0;
  struct
  {
    uint8      call_id;
  ...
  if( QMI_ERR_NONE == errval )
  {
    ...
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
          ...
          (info->ip_hist_info.ip_hist_info_length != 0) )
      {
        ...
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->ip_hist_info.ip_hist_info_buf, 2*info->ip_hist_info.ip_hist_info_length) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->ip_hist_info.ip_hist_info_length, sizeof(info->ip_hist_info.ip_hist_info_length)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->ip_hist_info.ip_hist_info_length) + 2*info->ip_hist_info.ip_hist_info_length + sizeof(info->call_id);
        QM_MSG_MED_1("ip_hist_info added for call id %d", info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_IP_HIST_INFO;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->sip_error_code, sizeof(info->sip_error_code)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))) )
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->sip_error_code) + sizeof(info->call_id);
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_SIP_ERROR_CODE;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    /* Called Party Subaddress Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      subaddr_len = sizeof(info->called_party_subaddress.extension_bit) + \
                    sizeof(info->called_party_subaddress.subaddr_type) + \
                    sizeof(info->called_party_subaddress.odd_even_ind) + \
                    sizeof(info->called_party_subaddress.subaddr_len) + \
                    info->called_party_subaddress.subaddr_len;

      if( (info->is_called_party_subaddress_available) &&
          (info->called_party_subaddress.subaddr_len < QMI_VOICE_CM_IF_MAX_SUBADDRESS_DIGITS) &&
          (info->called_party_subaddress.subaddr_len != 0) &&
          ( (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_SETUP) ||
            (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_INCOMING) ) )
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->called_party_subaddress.subaddr, info->called_party_subaddress.subaddr_len) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->called_party_subaddress.subaddr_len, sizeof(info->called_party_subaddress.subaddr_len)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->called_party_subaddress.odd_even_ind, sizeof(info->called_party_subaddress.odd_even_ind)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->called_party_subaddress.subaddr_type, sizeof(info->called_party_subaddress.subaddr_type)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->called_party_subaddress.extension_bit, sizeof(info->called_party_subaddress.extension_bit)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += subaddr_len + sizeof(info->call_id);
        QM_MSG_MED_2("Called Party Subaddress (len=%d) added for call id %d", info->called_party_subaddress.subaddr_len, info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_CALLED_PARTY_SUBADDRESS;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if( info->is_num_available )
      {
        ...
        QM_MSG_MED_2("RP Number Ext present, length %d, call id %d", info->num.len, info->call_id);
      }
    }
    ...
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if(info->is_num_available && (info->num.len<=CM_MAX_CALLED_INFO_CHARS))
      {
        ...
        QM_MSG_MED_2("RP Number present, length %d, call id %d", info->num.len, info->call_id);
      }
    }
    ...
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if(info->is_num_available && (info->num.len>CM_MAX_CALLED_INFO_CHARS))
      {
        ...
        num_of_instances++;
        tot_len += rp_num_len + sizeof(info->call_id);
        QM_MSG_MED_2("SIP URI present, length %d, call id %d", info->num.len, info->call_id);
      }
    }
    ...
    /* RTT mode Optional TLV */
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];

      if(info->is_rtt_mode_available)
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->rtt_mode, sizeof(info->rtt_mode)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))) )
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->rtt_mode) + sizeof(info->call_id);
        QM_MSG_MED_2("RTT MODE = %d for call id %d", info->rtt_mode, info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_RTT_MODE;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    /* RTT local and peer call capabilities info Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if(info->is_rtt_cap_available)
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->rtt_cap.peer_rtt_cap, sizeof(info->rtt_cap.peer_rtt_cap)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->rtt_cap.local_rtt_cap, sizeof(info->rtt_cap.local_rtt_cap)) &&        
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->rtt_cap.local_rtt_cap)  + sizeof(info->rtt_cap.peer_rtt_cap) + sizeof(info->call_id);
        QM_MSG_MED_3("RTT call capabilities local:%d peer:%d added for call id %d",
                     info->rtt_cap.local_rtt_cap, info->rtt_cap.peer_rtt_cap, info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_RTT_CAP;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)info->alternate_uri.alternate_uri_buf, info->alternate_uri.alternate_uri_length) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->alternate_uri.alternate_uri_length, sizeof(info->alternate_uri.alternate_uri_length)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))) )
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->alternate_uri.alternate_uri_length) + info->alternate_uri.alternate_uri_length + sizeof(info->call_id);
        QM_MSG_MED_2("Alternate SIP URI present, length %d, call id %d", info->alternate_uri.alternate_uri_length, info->call_id );
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_ALTERNATE_SIP_URIS;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    /* Call_composer local and peer capabilities info Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if(info->is_call_comp_cap_available)
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->call_comp_cap.peer_call_comp_support, sizeof(info->call_comp_cap.peer_call_comp_support)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_comp_cap.local_call_comp_support, sizeof(info->call_comp_cap.local_call_comp_support)) &&        
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->call_comp_cap.local_call_comp_support)  + sizeof(info->call_comp_cap.peer_call_comp_support) + sizeof(info->call_id);
        
        QM_MSG_MED_3("call_composer capabilities local:%d peer:%d added for call id %d",
                     info->call_comp_cap.local_call_comp_support,
                     info->call_comp_cap.peer_call_comp_support, 
                     info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_COMP_CAP;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
     ...
     /* Call composer importance Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if(info->is_call_composer_importance_available)
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_importance, sizeof(info->call_composer_importance)) &&
               QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->call_composer_importance) + sizeof(info->call_id);
        QM_MSG_MED_2("CALL_COMPOSER: importance %d for call_id %d", 
                        info->call_composer_importance,
                        info->call_id);
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_COMP_IMP;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    /* Call composer subject Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if((info->is_call_composer_subject_valid) &&
          (info->call_composer_subject.call_composer_subject_len < QMI_VOICE_CM_IF_MAX_CALL_COMP_SUBJECT_LEN) &&
          (info->call_composer_subject.call_composer_subject_len != 0)
        )
      {
        if( !(QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_subject.call_composer_subject, (2 * info->call_composer_subject.call_composer_subject_len)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_subject.call_composer_subject_len, sizeof(uint8)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(uint8) + (2*info->call_composer_subject.call_composer_subject_len) + sizeof(info->call_id);
        
        QM_MSG_MED_2("CALL_COMPOSER: subject len %d for call id %d", 
                         info->call_composer_subject.call_composer_subject_len,
                         info->call_id);
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_COMP_SUBJECT;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
     ...
     /* Call composer PIC URL Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if(info->is_call_composer_picture_url_valid) 
      {
        uint16 call_composer_picture_url_len = strlen(info->call_composer_picture_url.call_composer_pic_url);
        
        if(!(QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_picture_url.call_composer_pic_url, call_composer_picture_url_len) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&call_composer_picture_url_len, sizeof(uint16)) &&
              QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id)))
           )
        {
          num_of_instances = 0;
        ...
        num_of_instances++;
        tot_len += call_composer_picture_url_len + sizeof(call_composer_picture_url_len) + sizeof(info->call_id);
        
        QM_MSG_HIGH_1("CALL_COMPOSER: URL: call_id %d", 
                         info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_COMP_PIC_URL;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    /* Call composer point locations Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if((info->call_composer_location.location_included) &&
          (info->call_composer_location.geo_shape == CM_CALL_COMP_GEO_POINT))
      {
        if(!(QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_location.geo_info.geo_point.longitude,
               sizeof(info->call_composer_location.geo_info.geo_point.longitude)) &&
             QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_location.geo_info.geo_point.latitude,
               sizeof(info->call_composer_location.geo_info.geo_point.latitude)) &&
             QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->call_composer_location.geo_info.geo_point.latitude) +  
                   sizeof(info->call_composer_location.geo_info.geo_point.longitude) +
                   sizeof(info->call_id);

        QM_MSG_HIGH_1("CALL_COMPOSER: POINT LOC: call_id %d", 
                         info->call_id);
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_COMP_POINT_LOC;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
    ...
    /* Call composer circle locations Optional TLV */
    num_of_instances = 0;
    tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      ...
      if((info->call_composer_location.location_included) &&
          (info->call_composer_location.geo_shape == CM_CALL_COMP_GEO_CIRCLE))
      {
        if(!(QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_location.geo_info.geo_circle.radius,
               sizeof(info->call_composer_location.geo_info.geo_circle.radius)) &&
             QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_location.geo_info.geo_circle.longitude,
               sizeof(info->call_composer_location.geo_info.geo_circle.longitude)) &&
             QMI_SVC_PKT_PUSH(&response, (void *)&info->call_composer_location.geo_info.geo_circle.latitude,
              sizeof(info->call_composer_location.geo_info.geo_circle.latitude)) &&
             QMI_SVC_PKT_PUSH(&response, (void *)&info->call_id, sizeof(info->call_id))))
        {
          num_of_instances = 0;
          dsm_free_packet(&response);
        ...
        num_of_instances++;
        tot_len += sizeof(info->call_composer_location.geo_info.geo_circle.latitude) +  
                   sizeof(info->call_composer_location.geo_info.geo_circle.longitude) +
                   sizeof(info->call_composer_location.geo_info.geo_circle.radius) +
                   sizeof(info->call_id);

        QM_MSG_HIGH_1("CALL_COMPOSER: CIRCLE LOC: call_id %d", 
                         info->call_id);
      }
    }
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_GET_ALL_CALL_COMP_CIRCLE_LOC;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&response, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&response, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&response, (void *)&tag, VOICEI_TLV_TAG_SIZE)
...
/*===========================================================================
  FUNCTION QMI_VOICEI_SEND_GET_SUPPORTED_MSGS_RESP()
...
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type *) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.get_supported_msgs_resp),
                                    (uint32_t) sizeof(qmi_get_supported_msgs_resp_v01),
                                    &response )
    )
  {
    qmi_voicei_send_response_enc( (void *)cmd_buf_p, response);
...
}/* qmi_voicei_get_suppported_msgs_resp */
...
)
{
  ...
  uint8                   barr_sc_count=0, barr_num_count=0,fail_cause_len=0;
  uint8 tag=0;
  uint8 i=0, j=0;
  struct
  {
  ...
  if(data_ptr->data.get_call_barring_resp.sc_barr_num_list_valid)
  {
    ...
    for(i=0; i<barr_sc_count; i++)
    {
      ...
      QM_MEM_FREE((void *)barred_num->barr_num_list_info);
...
/*===========================================================================
  FUNCTION QMI_VOICEI_SUPS_SET_ALL_CALL_FWD_SUPS_RESP()
...
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type *) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.set_all_call_fwd_resp),
                                    (uint32_t) sizeof(voice_set_all_call_fwd_sups_resp_msg_v02),
                                    &response )
    )
  {
    qmi_voicei_send_response_enc( (void *)cmd_buf_p, response);
...
}/* qmi_voicei_set_all_call_fwd_sups_resp */
...
)
{
  ...
  int       tot_len=0, cnap_len = 0, alpha_len=0,rp_num_len = 0, tag,con_len=0,diags_len=0, subaddr_len=0;
  ...
  for( j = 0; j < VOICEI_MAX_CLIDS; j++ )
  {
         ...
         (cl_sp->asubs_info.as_id == data_ptr->header.as_id)))
    {
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        {
          /* ip_hist_info_length is the number of UTF16 characters */
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->ip_hist_info.ip_hist_info_buf, 2*info->ip_hist_info.ip_hist_info_length) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->ip_hist_info.ip_hist_info_length, sizeof(info->ip_hist_info.ip_hist_info_length)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_IP_HIST_INFO;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      /* Sip Error code info Optional TLV */
      num_of_instances = 0;
      tot_len = 0;
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_sip_error_code_available)
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->sip_error_code, sizeof(info->sip_error_code)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += sizeof(info->sip_error_code) + sizeof(info->call_id);
          QM_MSG_MED_1("Sip Error code  added for call id %d", info->call_id);
        }
      }
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_SIP_ERROR_CODE;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if( (info->is_called_party_subaddress_available) &&
            ...
            ( (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_SETUP) ||
              (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_INCOMING) ) )
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->called_party_subaddress.subaddr, info->called_party_subaddress.subaddr_len) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->called_party_subaddress.subaddr_len, sizeof(info->called_party_subaddress.subaddr_len)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->called_party_subaddress.odd_even_ind, sizeof(info->called_party_subaddress.odd_even_ind)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->called_party_subaddress.subaddr_type, sizeof(info->called_party_subaddress.subaddr_type)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->called_party_subaddress.extension_bit, sizeof(info->called_party_subaddress.extension_bit)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALLED_PARTY_SUBADDRESS;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      /* IP Alert Info Optional TLV */
      QM_MSG_HIGH("qmi_voicei_all_call_status_ind:populate ip_alert_info");
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if( (info->is_ip_alert_info_available) &&
            (info->ip_alert_info.ip_alert_info_length < QMI_VOICE_CM_IF_MAX_IP_ALERT_INFO_LEN) &&
            (info->ip_alert_info.ip_alert_info_length != 0) )
          {
            /* ip_alert_info_length is the number of UTF8 characters */
            if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->ip_alert_info.ip_alert_info_buf, info->ip_alert_info.ip_alert_info_length) &&
                  QMI_SVC_PKT_PUSH(&ind, (void *)&info->ip_alert_info.ip_alert_info_length, sizeof(info->ip_alert_info.ip_alert_info_length)) &&
                  QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
            {
              num_of_instances = 0;
              dsm_free_packet(&ind);
            ...
            num_of_instances++;
            tot_len += sizeof(info->ip_alert_info.ip_alert_info_length) + info->ip_alert_info.ip_alert_info_length + sizeof(info->call_id);
            QM_MSG_HIGH_2("ip_alert_info added for call id %d,tot_len:%d", info->call_id,tot_len);
          }
        }
        ...
        {
          tot_len += sizeof(num_of_instances);
          tag = VOICEI_ALL_CALL_IND_IP_ALERT_INFO;
          /* Put the num_of_instances, total length, Tag id */
          QM_MSG_HIGH_2("ip_alert_info add tag for call,tot_len=%d,num_inst:%d",tot_len,num_of_instances);
          if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
               QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
              ) )
    ...
    /* CRS Info Optional TLV */
	  num_of_instances = 0;
      tot_len = 0;
    QM_MSG_HIGH("qmi_voicei_all_call_status_ind:populate crs_type");
	for(i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++)
	{
	  const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];
          QM_MSG_HIGH_2("ALL CALL STATUS is_crs_info_available %d call_state %d ", info->is_crs_info_available,info->call_state);
	  if((info->is_crs_info_available) && (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_INCOMING ))
	  {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->crs_info.crs_type, sizeof(info->crs_info.crs_type)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += sizeof(info->crs_info.crs_type) + sizeof(info->call_id);
          QM_MSG_HIGH_2("ALL CALL STATUS crs_type added for call id %d SIZE crs_type %d ", info->call_id,sizeof(info->crs_info.crs_type));
	  }
	}
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_ALL_CALL_IND_CRS_TYPE;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
	...
	/* CRS Info Optional TLV */
	  num_of_instances = 0;
      tot_len = 0;
	QM_MSG_HIGH("qmi_voicei_all_call_status_ind:populate original_call_type");
	for(i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++)
	{
	  const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];
	  uint8 qmi_original_call_type = (uint8)info->crs_info.original_call_type;
	  if((info->is_crs_info_available) && (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_INCOMING ))
	  {
            if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&qmi_original_call_type, sizeof(qmi_original_call_type)) &&
                  QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
            {
              num_of_instances = 0;
              dsm_free_packet(&ind);
            ...
            num_of_instances++;
            tot_len += sizeof(qmi_original_call_type) + sizeof(info->call_id);

            QM_MSG_MED_2("original_call_type %d added for call id %d",info->crs_info.original_call_type, info->call_id);
	  }
	}
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_ALL_CALL_IND_ORIGINAL_CALL_TYPE;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
	...
	/* CRS Info Optional TLV */
	  num_of_instances = 0;
      tot_len = 0;
	QM_MSG_HIGH("qmi_voicei_all_call_status_ind:populate silent_ui");
	for(i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++)
	{
	  const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];
	  if((info->is_silent_ui_available) && (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_INCOMING))
	  {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->silent_ui, sizeof(info->silent_ui)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += sizeof(info->silent_ui) + sizeof(info->call_id);

		QM_MSG_MED_2("silent_ui %d added for call id %d",info->silent_ui, info->call_id);
	  }
	}
    ...
    {
      tot_len += sizeof(num_of_instances);
      tag = VOICEI_ALL_CALL_IND_SILENT_UI;
      /* Put the num_of_instances, total length, Tag id */
      if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
           QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
           QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      /* Emergency service category Optional TLV */
      num_of_instances = 0;
      tot_len = 0;
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];
        if( info->is_emerg_srv_categ_available )
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->emerg_srv_categ,sizeof(info->emerg_srv_categ) )&&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += sizeof(info->emerg_srv_categ) + sizeof(info->call_id);
          QM_MSG_MED_2("emerg_srv_categ %d added for call id %d",info->emerg_srv_categ, info->call_id);
        }
      }
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_EMERG_SRV_CATEG;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_num_available)
        {
          ...
          tot_len += info->num.len + sizeof(info->num.len) + sizeof(info->num.num_plan) +\
                     sizeof(info->num.num_type) + sizeof(info->num.si) + sizeof(info->num.pi) + sizeof(info->call_id);
          QM_MSG_MED_2("Remote Pty Number Ext2 present, length %d, call id %d", info->num.len, info->call_id);
        }
      }
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->conf_is_enabled_available)
        {
          con_len = sizeof(info->conf_is_enabled);

          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->conf_is_enabled, con_len) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))) )
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += con_len + sizeof(info->call_id);
          QM_MSG_MED_2("Is conf available value = %d call id = %d",info->conf_is_enabled, info->call_id);
        }
      }
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_IS_CONF_ENABLED;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_num_available && (info->num.len>CM_MAX_CALLED_INFO_CHARS))
        {
          ...
          QM_MSG_MED_2("Ext Remote Pty number present, length %d, call id %d", info->num.len, info->call_id);
        }
      }
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_conn_num_available && (info->conn_num_data.len>CM_MAX_CALLED_INFO_CHARS))
        {
          ...
          QM_MSG_MED_2("Ext connected number present, length %d, call id %d", info->conn_num_data.len, info->call_id);
        }
      }
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_rtt_mode_available)
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->rtt_mode, sizeof(info->rtt_mode)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))) )
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_RTT_MODE;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      /* TIR mode Optional TLV */
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];

        if(info->is_tir_mode_available && (info->call_state == QMI_VOICE_CM_IF_CALL_STATE_INCOMING || info->call_state == QMI_VOICE_CM_IF_CALL_STATE_WAITING))
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->tir_mode, sizeof(info->tir_mode)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))) )
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += sizeof(info->tir_mode) + sizeof(info->call_id);
          QM_MSG_MED_2("TIR Mode = %d for call id %d", info->tir_mode, info->call_id);
        }
      }
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_TIR_MODE;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_rtt_cap_available)
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->rtt_cap.peer_rtt_cap, sizeof(info->rtt_cap.peer_rtt_cap)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->rtt_cap.local_rtt_cap, sizeof(info->rtt_cap.local_rtt_cap)) &&           
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_RTT_CAP;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if( (info->is_alternate_uri_available) &&
            ...
            (info->alternate_uri.alternate_uri_length > 0) )
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)info->alternate_uri.alternate_uri_buf, info->alternate_uri.alternate_uri_length) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->alternate_uri.alternate_uri_length, sizeof(info->alternate_uri.alternate_uri_length)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))) )
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_ALTERNATE_SIP_URIS;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
...
/*******************************************************************************/
     ...
     /* Robocall Verstat Info Optional TLV */
      for( i=0; i<all_call_info->num_of_calls; i++ )
      {
        ...
        {
          verstat_len = sizeof(info->is_unwanted_call.is_nw_support_unwanted_call) +
                        sizeof(info->is_unwanted_call.mt_call_verstat);

          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->is_unwanted_call.mt_call_verstat, sizeof(info->is_unwanted_call.mt_call_verstat)) &&
                 QMI_SVC_PKT_PUSH(&ind, (void *)&info->is_unwanted_call.is_nw_support_unwanted_call, sizeof(info->is_unwanted_call.is_nw_support_unwanted_call)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))) )
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += verstat_len + sizeof(info->call_id);
            QM_MSG_HIGH_4("SIZE: is_unwanted_call struct: %d, is_nw_support_unwanted_call bool: %d, mt_call_verstat enum: %d, total_len: %d",
                        sizeof(info->is_unwanted_call),
                        sizeof(info->is_unwanted_call.is_nw_support_unwanted_call),
                        sizeof(info->is_unwanted_call.mt_call_verstat),
                        tot_len);			
          QM_MSG_HIGH_3("nw_support_unwanted_call = %d, mt_call_verstat = %d, call id = %d",
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_VERSTAT_INFO;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_call_comp_cap_available)
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_comp_cap.peer_call_comp_support, sizeof(info->call_comp_cap.peer_call_comp_support)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_comp_cap.local_call_comp_support, sizeof(info->call_comp_cap.local_call_comp_support)) &&        
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALL_COMP_CAP;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_call_composer_importance_available)
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_importance, sizeof(info->call_composer_importance)) &&
                 QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALL_COMP_IMP;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_subject.call_composer_subject, (2 * info->call_composer_subject.call_composer_subject_len)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_subject.call_composer_subject_len, sizeof(uint8)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALL_COMP_SUBJECT;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_call_composer_picture_url_valid) 
        {
          ...
          if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_picture_url.call_composer_pic_url, call_composer_picture_url_len) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&call_composer_picture_url_len, sizeof(uint16)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id)))
             )
          {
            num_of_instances = 0;
          ...
          QM_MSG_HIGH_2("CALL_COMPOSER: URL: call_id %d, pic_url_len %d", 
                           info->call_id,
                           call_composer_picture_url_len);
        }
      }
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALL_COMP_PIC_URL;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if((info->call_composer_location.location_included) &&
            (info->call_composer_location.geo_shape == CM_CALL_COMP_GEO_POINT))
        {
          if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_location.geo_info.geo_point.longitude,
                 sizeof(info->call_composer_location.geo_info.geo_point.longitude)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_location.geo_info.geo_point.latitude,
                 sizeof(info->call_composer_location.geo_info.geo_point.latitude)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALL_COMP_POINT_LOC;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if((info->call_composer_location.location_included) &&
            (info->call_composer_location.geo_shape == CM_CALL_COMP_GEO_CIRCLE))
        {
          if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_location.geo_info.geo_circle.radius,
                 sizeof(info->call_composer_location.geo_info.geo_circle.radius)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_location.geo_info.geo_circle.longitude,
                 sizeof(info->call_composer_location.geo_info.geo_circle.longitude)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_location.geo_info.geo_circle.latitude,
                sizeof(info->call_composer_location.geo_info.geo_circle.latitude)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_CALL_COMP_CIRCLE_LOC;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
...
/*******************************************************************************/
      ...
      for( i=0; (i<all_call_info->num_of_calls) && (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
      {
        ...
        if(info->is_prog_info_notif_available)
        {
          if( !(QMI_SVC_PKT_PUSH(&ind, (void *)&info->prog_info.notif_text, sizeof(info->prog_info.notif_text)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->prog_info.notif_reason, sizeof(info->prog_info.notif_reason)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->prog_info.notif_type, sizeof(info->prog_info.notif_type)) &&
                QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len += sizeof(info->prog_info.notif_text)  + sizeof(info->prog_info.notif_reason) +\
                     sizeof(info->prog_info.notif_type)  + sizeof(info->call_id);
          QM_MSG_HIGH_1("prog_info_notif added for call id %d", info->call_id);
        }
      }
      ...
      {
        tot_len += sizeof(num_of_instances);
        tag = VOICEI_ALL_CALL_IND_PROG_INFO_NOTIF;
        /* Put the num_of_instances, total length, Tag id */
        if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&num_of_instances, sizeof(num_of_instances)) &&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tot_len, VOICEI_TLV_LENGTH_SIZE)&&
             QMI_SVC_PKT_PUSH(&ind, (void *)&tag, VOICEI_TLV_TAG_SIZE)
	  ...
	  /* Call composer organization header Optional TLV */

	  num_of_instances = 0;
      tot_len = 0;
    for( i=0; (i<all_call_info->num_of_calls) && 
            (i<QMI_VOICE_CM_IF_CALL_ID_MAX_PER_SUBS); i++ )
    {
      
	  const qmi_voice_cm_if_call_info_s *const info = &all_call_info->call_info[i];

      if (info->call_state != QMI_VOICE_CM_IF_CALL_STATE_PRE_INCOMING) continue;
      
      if (info->is_call_composer_org_header_valid && 
         info->call_composer_org_header.call_composer_org_header_len
            <= QMI_VOICE_CM_IF_MAX_CALL_COMP_ORG_HDR_LEN &&
         info->call_composer_org_header.call_composer_org_header_len
            > 0
      )
      {

       if(!(QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_org_header.call_composer_org_header,
                  (2 * info->call_composer_org_header.call_composer_org_header_len)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_composer_org_header.call_composer_org_header_len,
                sizeof(info->call_composer_org_header.call_composer_org_header_len)) &&
               QMI_SVC_PKT_PUSH(&ind, (void *)&info->call_id, sizeof(info->call_id))))
          {
            num_of_instances = 0;
            dsm_free_packet(&ind);
          ...
          num_of_instances++;
          tot_len +=  2 * info->call_composer_org_header.call_composer_org_header_len +
                     sizeof(info->call_composer_org_header.call_composer_org_header_len) +
                     sizeof(info->call_id);
      
          QM_MSG_HIGH_2("CALL_COMPOSER: ORG HEADER: all call status call_id %d, len %d", 
                         info->call_id,
                         info->call_composer_org_header.call_composer_org_header_len);
        }
...
)
{
  ...
  for( j = 0; j < VOICEI_MAX_CLIDS; j++ )
  {
    cl_sp = (qmi_voicei_client_state_type *)voice_sp->client[j];
    if( (cl_sp != NULL)&& (cl_sp->common.clid != QMI_SVC_CLID_UNUSED) &&
        ((cl_sp->voice_info.reg_sups_events)||(cl_sp->voice_info.reg_sups_other_events)) &&
        (!cl_sp->asubs_info.is_bind_set_by_client ||
         (cl_sp->asubs_info.as_id == data_ptr->header.as_id)))
    {
...
)
{
  ...
  int                            j;
  dsm_item_type                 *ind = NULL;
  voice_conf_participant_status_info_ind_msg_v02 *conf_part_status_info_ptr  = NULL;/*CHECK*/

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  conf_part_status_info_ptr = (voice_conf_participant_status_info_ind_msg_v02 *)&data_ptr->data;

  QM_MSG_MED_3("Participant status IND: call_id=%d, op=%d, status_sip_code =%d",
               conf_part_status_info_ptr->call_id,
               conf_part_status_info_ptr->op_status.operation,
               conf_part_status_info_ptr->op_status.sip_status);
...
)
{
  ...
  int                            j;
  dsm_item_type                 *ind = NULL;
  qmi_voice_cm_if_e911_orig_fail_ind_s *e911_orig_info_ptr = NULL;
  struct qmi_voice_e911_orig_fail_ind_s_type orig_ind;
  memset(&orig_ind,0,sizeof(orig_ind));

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  e911_orig_info_ptr = (qmi_voice_cm_if_e911_orig_fail_ind_s *)&data_ptr->data;

  QM_MSG_MED_2 ("E911 orig info IND:call_id=%d,end_reason=%d",
                e911_orig_info_ptr->call_id,e911_orig_info_ptr->end_reason);
...
/*===========================================================================
  FUNCTION qmi_voicei_call_reest_status_ind()
...
)
{
  ...
  for( j = 0; j < VOICEI_MAX_CLIDS; j++ )
  {
    cl_sp = (qmi_voicei_client_state_type *)voice_sp->client[j];
    if( (cl_sp != NULL) && (cl_sp->common.clid != QMI_SVC_CLID_UNUSED) &&
        (cl_sp->voice_info.reg_call_reest_status_events) &&
        (!cl_sp->asubs_info.is_bind_set_by_client ||
         (cl_sp->asubs_info.as_id == data_ptr->header.as_id)) )
    {
      ind = NULL;
      if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                        QMI_IDL_INDICATION,
                                        (uint16_t) QMI_VOICE_CALL_REESTABLISHMENT_STATUS_IND_V02,
                                        (void *) &(data_ptr->data.call_reestablishment_status_ind),
                                        (uint32_t) sizeof(voice_call_reestablishment_status_ind_msg_v02),
                                        &ind )
        )
      {
        if( !qmi_voicei_send_indication( cl_sp,
                                         VOICEI_CMD_VAL_CALL_REESTABLISHMENT_STATUS_IND,
                                         ind )
          )
        {
          QM_MSG_MED_1("QMI_VOICE_CALL_REESTABLISHMENT_STATUS_IND could not be sent to client with clid=%d.", cl_sp->common.clid);
        }
      }
    }
  }
} /* qmi_voicei_call_reest_status_ind() */
...
/*===========================================================================
  FUNCTION qmi_voicei_ecall_status_ind()
...
)
{
  ...
  int                            j;
  dsm_item_type                 *ind = NULL;
  voice_ecall_status_ind_msg_v02 *ecall_status_info_ptr = NULL;

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ecall_status_info_ptr = (voice_ecall_status_ind_msg_v02 *)&data_ptr->data;

  QM_MSG_MED_2("eCall status IND: conn_idx=%d, msd_transmission_status=%d",
               ecall_status_info_ptr->call_id, ecall_status_info_ptr->msd_transmission_status);
  ...
  for( j = 0; j < VOICEI_MAX_CLIDS; j++ )
  {
    cl_sp = (qmi_voicei_client_state_type *)voice_sp->client[j];
    if((cl_sp != NULL) && (cl_sp->common.clid != QMI_SVC_CLID_UNUSED) &&
        (cl_sp->voice_info.reg_ecall_status_events) &&
        (!cl_sp->asubs_info.is_bind_set_by_client ||
         (cl_sp->asubs_info.as_id == data_ptr->header.as_id)))
    {
      ind = NULL;
      ...
      if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                        QMI_IDL_INDICATION,
                                        (uint16_t) QMI_VOICE_ECALL_STATUS_IND_V02,
                                        (void *) &(data_ptr->data.ecall_status_ind),
                                        (uint32_t) sizeof(voice_ecall_status_ind_msg_v02),
                                        &ind )
        )
      {
        qmi_voicei_send_indication( cl_sp,QMI_VOICE_ECALL_STATUS_IND_V02,ind );
      }
...
/*===========================================================================
  FUNCTION QMI_VOICEI_SET_WWAN_911_TIMER_REQ()
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type *qmi_voicei_set_wwan_911_timer_req
(
  void             *sp,
  void             *cmd_buf_p,
  void             *cl_sp,
...
)
{
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_SET_WWAN_911_TIMER_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.set_wwan_911_timer_req),
                                         (uint32_t) sizeof(voice_set_wwan_911_timer_req_msg_v02));
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_SET_WWAN_911_TIMER;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
send_result:
  return qmi_voicei_send_result(errval, cmd_ptr);
} /* qmi_voicei_set_wwan_911_timer_req() */


/*===========================================================================
  FUNCTION QMI_VOICEI_SET_WWAN_911_TIMER_RESP()
...
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type *) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.set_wwan_911_timer_resp),
                                    (uint32_t) sizeof(voice_set_wwan_911_timer_resp_msg_v02),
                                    &response )
    )
  {
    qmi_voicei_send_response_enc( (void *)cmd_buf_p, response);
  }
} /* qmi_voicei_set_wwan_911_timer_resp() */

/*===========================================================================
  FUNCTION QMI_VOICEI_GET_WWAN_911_TIMER_REQ()
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type *qmi_voicei_get_wwan_911_timer_req
(
  void             *sp,
  void             *cmd_buf_p,
  void             *cl_sp,
...
)
{
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_GET_WWAN_911_TIMER_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.get_wwan_911_timer_req),
                                         (uint32_t) sizeof(voice_get_wwan_911_timer_req_msg_v02));
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_GET_WWAN_911_TIMER;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
send_result:
  return qmi_voicei_send_result(errval, cmd_ptr);
} /* qmi_voicei_get_wwan_911_timer_req() */


/*===========================================================================
  FUNCTION QMI_VOICEI_GET_WWAN_911_TIMER_RESP()
...
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type *) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.get_wwan_911_timer_resp),
                                    (uint32_t) sizeof(voice_get_wwan_911_timer_resp_msg_v02),
                                    &response )
    )
  {
    qmi_voicei_send_response_enc( (void *)cmd_buf_p, response);
  }
} /* qmi_voicei_get_wwan_911_timer_resp() */
...
/*===========================================================================
  FUNCTION QMI_VOICEI_SET_ALL_CALL_FWD_SUPS()
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type *qmi_voicei_set_all_call_fwd_sups
(
  void             *sp,
  void             *cmd_buf_p,
  void             *cl_sp,
...
)
{
  ...
  while (*sdu_in)
  {
    ...
    {
      case QMI_TYPE_REQUIRED_PARAMETERS:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.service);
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.service;
        got_v_in_required = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_FWD_SC:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.service_class);
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.service_class;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.service_class_valid = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_SUPS_FWD_NUM:
        value = cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_number;
        if(len > sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_number))
        {
          QM_MSG_MED("Invalid calling number length");
          errval = QMI_ERR_ARG_TOO_LONG;
        ...
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_number_len = (uint8)len;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_number_valid = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_FWD_NR_TIMER:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.no_reply_timer);
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.no_reply_timer;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.no_reply_timer_valid = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_FWD_NUM_TYPE_PLAN:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.num_type_plan);
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.num_type_plan;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.num_type_plan_valid = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_FWD_START_TIME:
        if(len > sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_start_time))
        {
          QM_MSG_MED("Invalid Start time length");
          errval = QMI_ERR_ARG_TOO_LONG;
          goto send_result;
        }
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_start_time;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_start_time_valid = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_FWD_END_TIME:
        if(len > sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_end_time))
        {
          QM_MSG_MED("Invalid End time length");
          errval = QMI_ERR_ARG_TOO_LONG;
          goto send_result;
        }
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_end_time;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.fwd_end_time_valid = TRUE;
        break;
      case VOICEI_SET_ALL_CALL_FWD_SUPS_REASON:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.all_call_fwd_reason);
        if(len > sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.all_call_fwd_reason))
        {
          QM_MSG_MED("Invalid End time length");
          errval = QMI_ERR_ARG_TOO_LONG;
          goto send_result;
        }
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.all_call_fwd_reason;
        cmd_ptr->cmd.cm_if_data_ptr->data.all_call_fwd_sups.all_call_fwd_reason_valid = TRUE;
        break;
  ...
  cmd_ptr->cmd.cm_if_data_ptr->header.cmd = QMI_VOICE_CM_IF_CMD_SET_ALL_CALL_FWD_SUPS;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
} /* qmi_voicei_set_all_call_fwd_sups() */
...
)
{
  ...
  uint16             len;
  qmi_mmode_cmd_data_buf_type   *cmd_ptr = NULL;
  qmi_voice_cm_if_set_srvcc_call_context_s  *srvcc_calls_info = NULL;
  qmi_voicei_client_state_type *client_sp = NULL;
  ...
  while (*sdu_in)
  {
    ...
    switch (type)
    {
      case QMI_TYPE_REQUIRED_PARAMETERS:
        ...
        else
        {
          ...
          for(i=0; i<srvcc_calls_info->num_calls; i++)
          {
            ...
            QM_MSG_MED_8("Instance ID %d Call Type %d Call State %d, Call Substate %d Is_Mpty %d Direction %d, Num Len %d Num %d",
                         srvcc_calls_info->srvcc_calls[i].instance_id, srvcc_calls_info->srvcc_calls[i].call_type, srvcc_calls_info->srvcc_calls[i].call_state,
                         srvcc_calls_info->srvcc_calls[i].call_substate, srvcc_calls_info->srvcc_calls[i].is_mpty_call, srvcc_calls_info->srvcc_calls[i].direction,
                         srvcc_calls_info->srvcc_calls[i].num_len, srvcc_calls_info->srvcc_calls[i].num_len);
          }
        }
        break;
      ...
      case VOICEI_SRVCC_CALL_CONFIG_REQ_CALL_NUM_PI:
        ...
        {
          if (srvcc_calls_info->num_pi_list_len > QMI_VOICE_CM_IF_MAX_SRVCC_CALLS)
          {
            QM_MSG_HIGH_1("Invalid num_pi_list_len TLV %d",
                                 srvcc_calls_info->num_pi_list_len);
            errval = QMI_ERR_MALFORMED_MSG;
            goto send_result;
          }
      ...
      case VOICEI_SRVCC_CALL_CONFIG_REQ_CALL_NAME:
        ...
        {
          if (srvcc_calls_info->caller_name_list_len > QMI_VOICE_CM_IF_MAX_SRVCC_CALLS)
          {
            QM_MSG_HIGH_1("Invalid caller_name_list_len TLV %d",
                               srvcc_calls_info->caller_name_list_len);
            errval = QMI_ERR_MALFORMED_MSG;
            goto send_result;
          }
...
)
{
  ...
  if(client_sp != NULL)
  {
    if((cm_get_device_mode() == SYS_MODEM_DEVICE_MODE_SINGLE_SIM) && ((uint8)cmd_ptr->cmd.cm_if_data_ptr->data.bind_subscription.subs_type != QMI_VOICE_CM_IF_AS_ID_PRIMARY ))
	{
		QM_MSG_MED_1("single sim device, error for subs type (%d)", cmd_ptr->cmd.cm_if_data_ptr->data.bind_subscription.subs_type);
...
)
{
  ...
  voice_uss_info_type_v02         *uusd_data = NULL;
...
)
{
  ...
  while (*sdu_in)
  {
    ...
    switch (type)
    {
      ...
      case VOICEI_MNG_IP_CALLS_RTT_MODE:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.rtt_mode);
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.rtt_mode;
        cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.is_rtt_mode_valid = TRUE;
        break;

      case VOICEI_MNG_IP_CALLS_IS_SECURE_CALL:
        expected_len = sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.is_secure_call);
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.is_secure_call;
        cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.is_secure_call_valid = TRUE;
        break;

      case VOICEI_MNG_IP_CALLS_SPEECH_CODEC_MASK:
        if(len > sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.speech_codec_mask))
        {
          QM_MSG_MED("Invalid Speech Codec Mask length");
          errval = QMI_ERR_ARG_TOO_LONG;

          goto send_result;
        }
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.speech_codec_mask;
        cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.is_speech_codec_mask_valid = TRUE;
        break;

      case VOICEI_MNG_IP_CALLS_PRI_SPEECH_CODEC:
        if(len > sizeof(cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.priority_speech_codec))
        {
          QM_MSG_MED("Invalid Pri Speech Codec length");
          errval = QMI_ERR_ARG_TOO_LONG;

          goto send_result;
        }
        value = &cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.priority_speech_codec;
        cmd_ptr->cmd.cm_if_data_ptr->data.manage_calls_info.is_priority_speech_codec_valid = TRUE;
        break;
...
/*===========================================================================
  FUNCTION QMI_VOICE_IMS_CALL_CANCEL_REQ()

  DESCRIPTION
    Allows APPS to cancel the upgrade/downgrade/hold/resume for a VOLTE call
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type* qmi_voicei_ims_call_cancel_req
(
  void *            sp,
  void *            cmd_buf_p,
  void *            cl_sp,
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  QM_MSG_HIGH("Inside qmi_voicei_ims_call_cancel_req "); 
  cmd_ptr = qmi_mmode_get_cmd_data_buf();
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_IMS_CALL_CANCEL_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.ims_call_cancel_req),
                                         (uint32_t) sizeof(voice_ims_call_cancel_req_msg_v02));
   QM_MSG_HIGH_1("Errval %d",errval); 
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_IMS_CALL_CANCEL_REQ;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
} /* qmi_voicei_ims_call_cancel_req() */

/*===========================================================================
  FUNCTION QMI_VOICE_CM_IF_EVT_CALL_CANCEL_IMS_RSP
...
)
{
  ...
  QM_MSG_HIGH("Inside qmi_voicei_ims_call_cancel_resp ");
  cmd_buf_p = (qmi_cmd_buf_type *) data_ptr->header.handle;
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type*) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.ims_call_cancel_resp),
                                    (uint32_t) sizeof(voice_ims_call_cancel_resp_msg_v02),
                                    &response )
    )
  {
     QM_MSG_HIGH("idl_message_encode success");
     qmi_voicei_send_response_enc((void*)cmd_buf_p, response);
  }
}/* qmi_voicei_ims_call_cancel_resp() */

#ifndef REMOVE_QMI_VOICE_AVOID_PLMN_LIST_REQ_V02
/*===========================================================================
  FUNCTION QMI_VOICE_AVOID_PLMN_LIST_REQ()

  DESCRIPTION
  Allows AP to send a list of plmns to avoid in a e911 call.
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type* qmi_voicei_avoid_plmn_req
(
  void *            sp,
  void *            cmd_buf_p,
  void *            cl_sp,
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_AVOID_PLMN_LIST_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.avoid_plmn_list_req),
                                         (uint32_t) sizeof(voice_avoid_plmn_list_req_msg_v02));
   QM_MSG_HIGH_1("Errval %d",errval); 
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_AVOID_PLMN_REQ;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
} /* qmi_voicei_avoid_plmn_req() */

/*===========================================================================
  FUNCTION QMI_VOICE_AVOID_PLMN_LIST_RESP
...
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type*) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.avoid_plmn_list_resp),
                                    (uint32_t) sizeof(voice_avoid_plmn_list_resp_msg_v02),
                                    &response )
    )
  {
     QM_MSG_HIGH("idl_message_encode success");
...
/*===========================================================================
  FUNCTION QMI_VOICEI_SECURE_CALL_MODE
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static dsm_item_type *qmi_voicei_secure_call_mode
(
  void             *sp,
  void             *cmd_buf_p,
  void             *cl_sp,
...
)
{
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_SECURE_CALL_MODE_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.secure_call_mode_req),
                                         (uint32_t) sizeof(voice_secure_call_mode_req_msg_v02));
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_SECURE_CALL_MODE;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
/*===========================================================================
  FUNCTION QMI_VOICEI_SECURE_CALL_MODE_RESP
  ...
  SIDE EFFECTS
    None
===========================================================================*/
void qmi_voicei_secure_call_mode_resp
(
  const qmi_voice_cm_if_info_item_s *const data_ptr
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type *) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.secure_call_mode_resp),
                                    (uint32_t) sizeof(voice_secure_call_mode_resp_msg_v02),
                                    &response )
    )
  {
    qmi_voicei_send_response_enc( (void *)cmd_buf_p, response);
...
/*===========================================================================
  FUNCTION QMI_VOICE_POPULATE_GET_SUPPORTED_MSGS_REQSP()

  DESCRIPTION
    Forms the gets the supported MSGS's
  ...
  SIDE EFFECTS
    None
===========================================================================*/
boolean qmi_voicei_populate_get_supported_msgs_resp
(
  qmi_get_supported_msgs_resp_v01 *get_supported_msgs_resp
)
{
  uint32             index  = 0;
  uint16             byte_pos = 0;
  ...
  if ( get_supported_msgs_resp == NULL)
  {
    /*Not enough memory to allocate for QMI_NASI_FORCE_LTE_SCAN_RESP*/
    return FALSE;
  }

  /*-----------------------------------------------------------------------*/
  
  for(index = VOICEI_CMD_INDICATION_REGISTER; index < VOICEI_CMD_MAX; index++)
  {
    byte_pos = (qmi_voicei_cmd_callbacks[index].cmd_type) / 8;
    bit_pos =  (qmi_voicei_cmd_callbacks[index].cmd_type) % 8;

    if (byte_pos < QMI_GET_SUPPORTED_MESSAGES_ARRAY_MAX_V01)
    {
      get_supported_msgs_resp->supported_msgs[byte_pos] |= SYS_BM(bit_pos);
    
      if (byte_pos >= get_supported_msgs_resp->supported_msgs_len )
      {
        get_supported_msgs_resp->supported_msgs_len      =  (byte_pos + 1);
      }
    }
  }

  get_supported_msgs_resp->supported_msgs_valid      = TRUE;
...
/*===========================================================================
  ...
  FUNCTION QMI_VOICEI_SIP_DTMF_REQ()

  DESCRIPTION
    Handle the SIP DTMF request received from control point
...
===========================================================================*/
static dsm_item_type *qmi_voicei_sip_dtmf_req
(
  void             *sp,
  void             *cmd_buf_p,
  void             *cl_sp,
...
)
{
  ...
  errval = qmi_mmode_idl_message_decode( voice_svc_obj,
                                         (uint16_t)QMI_VOICE_SIP_DTMF_REQ_V02,
                                         sdu_in,
                                         (void *) &(cmd_ptr->cmd.cm_if_data_ptr->data.sip_dtmf_req),
                                         (uint32_t) sizeof(voice_sip_dtmf_req_msg_v02));
  if(errval) goto send_result;

  cmd_ptr->cmd.cm_if_data_ptr->header.cmd    = QMI_VOICE_CM_IF_CMD_SIP_DTMF;
  cmd_ptr->cmd.cm_if_data_ptr->header.handle = (uint32)cmd_buf_p;
  cmd_ptr->cmd.cm_if_data_ptr->header.as_id  = QMI_VOICE_CM_IF_AS_ID_PRIMARY;
...
/*===========================================================================
  ...
  FUNCTION QMI_VOICEI_SIP_DTMF_RESP()

  DESCRIPTION
    Send SIP DTMF resp to control point
...
)
{
  ...
  if( qmi_mmode_idl_message_encode( voice_svc_obj,
                                    QMI_IDL_RESPONSE,
                                    (uint16_t) ( (qmi_cmd_buf_type *) cmd_buf_p )->cmd_type,
                                    (void *) &(data_ptr->data.sip_dtmf_resp),
                                    (uint32_t) sizeof(voice_sip_dtmf_resp_msg_v02),
                                    &response )
    )
  {
    qmi_voicei_send_response_enc( (void *)cmd_buf_p, response);
  }
} /* qmi_voicei_sip_dtmf_resp() */


/*===========================================================================

  FUNCTION qmi_voicei_sip_dtmf_ind()

  DESCRIPTION
    Send MT SIP DTMF indication from network to user
...
)
{
  ...
  for( j = 0; j < VOICEI_MAX_CLIDS; j++ )
  {
    ...
    if ((cl_sp != NULL) &&
        ...
        (cl_sp->voice_info.reg_sip_dtmf_event) &&
        (!cl_sp->asubs_info.is_bind_set_by_client ||
         (cl_sp->asubs_info.as_id == data_ptr->header.as_id)))
    {
      ind = NULL;
      if (qmi_mmode_idl_message_encode(voice_svc_obj,
                                       QMI_IDL_INDICATION,
                                       (uint16_t) QMI_VOICE_SIP_DTMF_IND_V02,
                                       (void *) &(data_ptr->data.sip_dtmf_ind),
                                       (uint32_t) sizeof(voice_sip_dtmf_ind_msg_v02),
                                       &ind))
      {
        qmi_voicei_send_indication(cl_sp, QMI_VOICE_SIP_DTMF_IND_V02, ind);
      }
    }
    else if (cl_sp != NULL)
    {
      QM_MSG_HIGH_5("SIP_DTMF: ind not sent: clid %d, reg_sip_dtmf_event %d, is_bind_set_by_client %d, as_id %d %d",
                    cl_sp->common.clid,
                    cl_sp->voice_info.reg_sip_dtmf_event,
                    cl_sp->asubs_info.is_bind_set_by_client,
                    cl_sp->asubs_info.as_id,
                    data_ptr->header.as_id);
    }
  }
} 
