...
GENERAL DESCRIPTION
 ...
 QUALCOMM Proprietary and Confidential.
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/network_access_service_impl_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
static const uint32_t nas_get_cell_location_info_resp_msg_impl_array_v01[] =
{
    ...
    QMI_SI_TLV_SET(0x33)      /* lte_cell_snr */
