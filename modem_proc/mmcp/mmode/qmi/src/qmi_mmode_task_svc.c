...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_mmode_task_svc.c#1 $
...
)
{
  ...
  QM_ASSERT( buf_ptr != NULL );
  QM_ASSERT( buf_size > 0 );
...
{
  return !((qm_efs_get_enhanced_f3_dbg_rule() & QMI_MMODE_ENHANCED_F3_DBG_MED) == 0);
}
