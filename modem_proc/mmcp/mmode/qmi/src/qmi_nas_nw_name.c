...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/qmi/src/qmi_nas_nw_name.c#1 $ $DateTime: 2021/06/15 22:40:27 $ $Author: pwbldsvc $
...
)
{
  ...
  if( qmi_nas_mmgsdi_is_valid_qmi_session(qmi_session) )
  {
    ...
    QM_MEM_FREE( eons[qmi_session][OLD_RECORD].spn.eons_data.data_ptr );
    eons[qmi_session][OLD_RECORD].spn.eons_data.data_ptr = NULL;

    if ( eons[qmi_session][OLD_RECORD].first_stack_info.is_valid)
    {
      QM_MEM_FREE( eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_ptr );
      eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_ptr = NULL;

      QM_MEM_FREE( eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_ptr );
      eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_ptr = NULL;

      QM_MEM_FREE( eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_additional_info.info_data.data_ptr );
      ...
      {
        QM_MEM_FREE( eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_additional_names[i].plmn_long_name.plmn_name.eons_data.data_ptr );
        ...
        QM_MEM_FREE( eons[qmi_session][OLD_RECORD].first_stack_info.operator_info.plmn_additional_names[i].plmn_short_name.plmn_name.eons_data.data_ptr );
    ...
    {
      QM_MEM_FREE( eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_ptr );
      eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_ptr = NULL;

      QM_MEM_FREE( eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_ptr );
      eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_ptr = NULL;

      QM_MEM_FREE( eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_additional_info.info_data.data_ptr );
      ...
      {
        QM_MEM_FREE( eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_additional_names[i].plmn_long_name.plmn_name.eons_data.data_ptr );
        ...
        QM_MEM_FREE( eons[qmi_session][OLD_RECORD].sec_stack_info.operator_info.plmn_additional_names[i].plmn_short_name.plmn_name.eons_data.data_ptr );
    ...
    {
      eons[qmi_session][NEW_RECORD].spn.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].spn.eons_data.data_len);
    ...
    if ( eons[qmi_session][NEW_RECORD].first_stack_info.is_valid )
    {
      ...
      {
        eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_len);
      ...
      {
        eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_len);
      ...
      {
        eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_additional_info.info_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_additional_info.info_data.data_len);
      ...
      for ( i = 0; i < eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.num_plmn_additional_names; i++ )
      {
        ...
        {
          eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_additional_names[i].plmn_long_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_additional_names[i].plmn_long_name.plmn_name.eons_data.data_len);
        ...
        {
          eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_additional_names[i].plmn_short_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].first_stack_info.operator_info.plmn_additional_names[i].plmn_short_name.plmn_name.eons_data.data_len);
    ...
    if ( eons[qmi_session][NEW_RECORD].sec_stack_info.is_valid )
    {
      ...
      {
        eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_long_name.plmn_name.eons_data.data_len);
      ...
      {
        eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_short_name.plmn_name.eons_data.data_len);
      ...
      {
        eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_additional_info.info_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_additional_info.info_data.data_len);
      ...
      for ( i = 0; i < eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.num_plmn_additional_names; i++ )
      {
        ...
        {
          eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_additional_names[i].plmn_long_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_additional_names[i].plmn_long_name.plmn_name.eons_data.data_len);
        ...
        {
          eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_additional_names[i].plmn_short_name.plmn_name.eons_data.data_ptr = QM_MEM_ALLOC(eons[qmi_session][NEW_RECORD].sec_stack_info.operator_info.plmn_additional_names[i].plmn_short_name.plmn_name.eons_data.data_len);
