...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/inc/cm_i.h#1 $
...
typedef union cm_sd_rpt_u
{
  ...
  cm_emerg_srch_fail_type               emerg_srch_fail;
  cm_subs_chg_done_type                 sub_done;
  cm_mcfg_proceed_with_refresh_type     mcfg_proceed_with_refresh;
  cm_hold_acq_type                      hold_acq;
  cm_e911_lte_full_srv_added_type       e911_lte_full_srv_added;
} cm_sd_rpt_u_type;
