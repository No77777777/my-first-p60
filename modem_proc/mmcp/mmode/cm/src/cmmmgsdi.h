...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmmmgsdi.h#1 $
...
#define CMMMGSDI_MAX_SESSIONS             6
...
typedef enum
{
  ...
  CMMMGSDI_STATE_SUBSCRIPTION_PENDED    = 3,
  CMMMGSDI_STATE_MAX                    = 4
...
typedef struct cm_mmgsdi_sub_info_s
{
...
typedef struct cmmmgsdi_s
{
  ...
  cm_mmgsdi_sub_info_s_type  sub_info[MAX_SIMS];
...
#define AS_ID_TO_GW_SESSION(as_id) \
       (as_id == SYS_MODEM_AS_ID_3?MMGSDI_GW_PROV_TER_SESSION:\
       (as_id == SYS_MODEM_AS_ID_2?MMGSDI_GW_PROV_SEC_SESSION:MMGSDI_GW_PROV_PRI_SESSION))
#else
#define AS_ID_TO_GW_SESSION(as_id) \
       (as_id == SYS_MODEM_AS_ID_2?MMGSDI_GW_PROV_SEC_SESSION:MMGSDI_GW_PROV_PRI_SESSION)
#endif
...
#ifdef FEATURE_MMODE_TRIPLE_SIM
#define AS_ID_TO_1X_SESSION(as_id) \
       (as_id == SYS_MODEM_AS_ID_3?MMGSDI_1X_PROV_TER_SESSION:\
       (as_id == SYS_MODEM_AS_ID_2?MMGSDI_1X_PROV_SEC_SESSION:MMGSDI_1X_PROV_PRI_SESSION))
#else
#define AS_ID_TO_1X_SESSION(as_id) \
       (as_id == SYS_MODEM_AS_ID_2?MMGSDI_1X_PROV_SEC_SESSION:MMGSDI_1X_PROV_PRI_SESSION)
#endif
...
#ifdef FEATURE_MMODE_TRIPLE_SIM
#define SESSION_TO_AS_ID(session_type) \
       ((session_type == MMGSDI_1X_PROV_TER_SESSION || session_type == MMGSDI_GW_PROV_TER_SESSION)?\
       SYS_MODEM_AS_ID_3:\
       ((session_type == MMGSDI_1X_PROV_SEC_SESSION || session_type == MMGSDI_GW_PROV_SEC_SESSION)?\
...
DESCRIPTION
  Returns valid cc object from mmgsdi_read_req cache for tid passed

RETURN VALUE
 call control object if found
...
extern boolean cmmmgsdi_is_jcdma_card_white_equiv(sys_modem_as_id_e_type asubs_id);
...
FUNCTION cmmmgsdi_count_given_state_per_subs

DESCRIPTION
  This function counts number of given state on all sessions on that sub
...
uint8 cmmmgsdi_count_given_state_per_subs
(
cmmmgsdi_session_state_type  state, sys_modem_as_id_e_type asubs_id
);


cm_mmgsdi_session_id_table_entry_s_type *cm_mmgsdi_ssn_tbl_get_entry_by_id
(
  mmgsdi_session_id_type session_id
);
...
extern cm_mmgsdi_session_id_table_entry_s_type *
cm_mmgsdi_ssn_tbl_get_entry_by_current_state
(
  sys_modem_as_id_e_type asubs_id,
