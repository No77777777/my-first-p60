...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmals.c#1 $
...
)
{
  ...
  */
  ...
  else if (line_switching == CM_ALS_LINE_SWITCHING_NOT_ALLOWED )
  {
              ...
              CM_ALS_ORANGE_MAX_DYNAMIC_FLAGS_BUFFER_LEN)
          {
            ...
            */
            ...
            if((sim_items_read & CMALS_LINE_SWITCHING_READ_MASK)
                && IS_VALID_PH_SUB_PTR(SYS_MODEM_AS_ID_1)
                && cmph_ptr()->sub_info[SYS_MODEM_AS_ID_1]->is_3gpp_subs_avail
    ...
    */
    if (sim_items_read == CMALS_SIM_READ_COMPLETED)
    {
      ...
      */
      ...
      asubs_id = cm_mmgsdi_ssn_tbl_get_subs_id_for_id(cnf_ptr->response_header.session_id);
      ...
      CM_MSG_LOW_2("Queue CM_PH_CMD_ALS_SIM_INFO_AVAIL, sub %d, session_id %d",
                 cmd_info_ptr->cmd_subs, cnf_ptr->response_header.session_id);
  ...
  */
  ...
  switch(line)
  {
    ...
    case CM_ALS_LINE_02:
      ...
      *itc_ptr = cmph_ptr()->device_prop.itc_aux_val_to_use;
      break;
...
)
{
  ...
  */
  ...
  if(*itc_ptr == cmph_ptr()->device_prop.itc_aux_val_to_use)
  {
    CM_MSG_LOW_0("line 2");
