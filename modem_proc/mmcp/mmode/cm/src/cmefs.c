...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmefs.c#10 $
...
static const cmefs_tbl_s_type cmefs_tbl[] =
{
  ...
  { CMEFS_ID_LTE_RPM_INFO,              CMEFS_NV_MMODE_DIR "lte_rpm_info"},
  ...
  { CMEFS_CMREGPRX_DBG_MSGS,            CMEFS_NV_MMODE_DIR "cmregprx_dbg_msgs"},
  ...
  { CMEFS_BUFFER_SYS_SEL_PREF,          CMEFS_NV_MMODE_DIR "buffer_sys_sel_pref"},
  ...
  { CMEFS_MANUAL_SEARCH_PERIODIC_TIMER, CMEFS_NV_MMODE_DIR "manual_search_timer"},
  ...
  { CMEFS_CLEAR_MANUAL_PLMN,                      CMEFS_NV_MMODE_DIR "clear_mplmn"},
  { CMEFS_PS_SIGNALLING_WAIT_TIMER,      CMEFS_NV_MMODE_DIR "ps_signalling_wait_timer"},
  { CMEFS_SDS_PLMN_BLOCKING_TYPE,       CMEFS_NV_MMODE_DIR "sds_plmn_blocking_type"},
  { CMEFS_REG_SMS_RETRY_TIMER_VALUE,    CMEFS_NV_MMODE_DIR "reg_sms_retry_timer"},
  { CMEFS_PS_CALL_ORIG_HOLD_TIMER,      CMEFS_NV_MMODE_DIR "ps_call_orig_hold_timer"},
  { CMEFS_LTE_SOFT_FAILURE_RETRY_COUNT,      CMEFS_NV_MMODE_DIR "lte_softfailure_count"},
  { CMEFS_ENABLE_VOLTE_ON_STACK2,       CMEFS_NV_MMODE_DIR "enable_volte_on_stack2"},
  { CMEFS_SDS_PLMN_BLOCKING_SYNC,      CMEFS_NV_MMODE_DIR "plmn_blocking_sync"},
  { CMEFS_ALLOW_CS_PAGE_DURING_MT_VOLTE_CALL, CMEFS_NV_MMODE_DIR "allow_cs_page_during_mt_volte_call"},
  { CMEFS_E911_PRIORITIZE_PS,                CMEFS_NV_MMODE_DIR "e911_prioritize_ps"},
  { CMEFS_RPM_FEATURE_ENABLED,           CMEFS_NV_MMODE_DIR "rpm_feature_enabled"},
  { CMEFS_POWERDOWN_TIMESTAMP,                 CMEFS_NV_MMODE_DIR "powerdown_timestamp"},
  { CMEFS_NON_DDS_LTE_REMOVAL_TIMER,           CMEFS_NV_MMODE_DIR "non_dds_lte_removal_timer"},
  { CMEFS_E911_PREF_OVER_PS_DURING_WLAN,CMEFS_NV_MMODE_DIR "e911_pref_over_ps_during_wlan"},
  { CMEFS_EMERG_CALL_REJ_IN_ACQ_HOLD,           CMEFS_NV_MMODE_DIR "emerg_call_rej_in_acq_hold"},
  { CMEFS_AFFCN_LIST_INFO,              CMEFS_NV_MMODE_DIR "qmi/arfcn_list_info"},
{ CMEFS_REG_SMS_SW_VER,                       CMEFS_NV_MMODE_DIR "reg_sms_sw_version"},
  { CMEFS_E911_WLAN_TO_LTE_HANDOVER, "/nv/item_files/modem/data/dsmgr/wlan_lte_emc_ho_enabled"},
  { CMEFS_MSIM_VOLTE_ESR_SUPPORT,     CMEFS_NV_MMODE_DIR "msim_volte_esr_support"},
  { CMEFS_MCC_LIST_EMERG_CALL_END_NO_SIM, CMEFS_NV_MMODE_DIR "mcc_list_emerg_call_end_no_sim"},
  { CMEFS_TAU_RADIO_CAP_UPDATE, "/nv/item_files/modem/nas/tau_radio_cap_update" },
  { CMEFS_DISABLE_MCC_LIST_EMERG_CALL_END_NO_SIM, CMEFS_NV_MMODE_DIR "disable_emerg_call_end_on_nw_rej_mcc"},
  { CMEFS_UE_BASED_SUPS,               CMEFS_NV_MMODE_DIR "ue_based_sups"},
  { CMEFS_UE_BASED_SUPS_MODE,        CMEFS_NV_MMODE_DIR "ue_based_sups_mode"},
  { CMEFS_SYNC_UE_BASED_CW_WITH_CS, CMEFS_NV_MMODE_DIR "sync_ue_based_cw_with_cs"},
  { CMEFS_IMMEDIATE_SUPS_SYNC_WITH_CS, CMEFS_NV_MMODE_DIR "immediate_sups_sync_with_cs_req"},
  { CMEFS_CW_EXT_CONFIG_INFO, CMEFS_NV_MMODE_DIR "cw_ext_config_info"},
  { CMEFS_SUPS_ENABLE_STATUS_NW, CMEFS_NV_MMODE_DIR "sups_enable_status_nw"},
  { CMEFS_GPP_WIFI_CELLULAR_SCAN_TIMER, CMEFS_NV_MMODE_DIR "wifi_cellular_scan_timer"},
  { CMEFS_ALLOW_MT_PAGE_CONCURRENCY, CMEFS_NV_MMODE_DIR "allow_mt_page_concurrency"},
  { CMEFS_ONLINE_EMERG_PENDING_SUPP, CMEFS_NV_MMODE_DIR "online_emerg_pending_supp"},
  { CMEFS_SKIP_NO_SRV_BUFFERING_ON_RAT_REMV, CMEFS_NV_MMODE_DIR "skip_no_srv_buffering_on_rat_remv"},
  { CMEFS_PREV_UE_BASED_CW,CMEFS_NV_MMODE_DIR "prev_ue_based_cw"},
  { CMEFS_ADDTNL_CHAR_FOR_VOICE_CC, CMEFS_NV_MMODE_DIR "addtnl_char_for_voice_cc"}
};
...
*/
static boolean c2k_sxlte_opti_array[MAX_SIMS][C2K_SXLTE_OPTI_ARRAY_USED];
...
/nv/item_files/modem/mmode/n_min_MO_call_soft_retry_Subscription01\n\
/nv/item_files/modem/mmode/n_maxSIB8\n\
/nv/item_files/modem/mmode/n_maxSIB8_Subscription01\n\
...
/nv/item_files/modem/mmode/sd/1xcsfb_ecbm_status_Subscription01\n\
...
/nv/item_files/modem/mmode/lte_do_irat_duration_Subscription01\n\
...
/nv/item_files/modem/mmode/supportfordualrxues_Subscription01\n\
/nv/item_files/modem/mmode/sxlte_timers\n\
/nv/item_files/modem/mmode/sxlte_timers_Subscription01\n\
/nv/item_files/modem/mmode/msim_standby_esr_support\n\
/nv/item_files/modem/mmode/3gpp2_ps_call_optimization\n\
/nv/item_files/modem/mmode/3gpp2_ps_call_optimization_Subscription01\n\
...
/nv/item_files/modem/mmode/sd/c2k_resel_splmn_supp_Subscription01\n\
/nv/item_files/modem/mmode/sd/buffer_int_srv_lost\n\
/nv/item_files/modem/mmode/sd/buffer_int_srv_lost_Subscription01\n\
/nv/item_files/modem/mmode/sd/1xcsfb_call_end_opt\n\
/nv/item_files/modem/mmode/sd/1xcsfb_call_end_opt_Subscription01\n\
...
/nv/item_files/modem/mmode/1xsrvcc_stn_sr_number_Subscription01\n\
...
/nv/item_files/modem/mmode/scan_scope_rule_Subscription01\n\
...
/nv/item_files/modem/mmode/sd/extend_lbsr_if_1x_active_Subscription01\n\
...
/nv/item_files/modem/mmode/c2k_switch_2_srlte_Subscription01\n\
...
/nv/item_files/modem/mmode/sd/roam_ind_update_in_l_to_1x_ho_Subscription01\n\
...
/nv/item_files/modem/mmode/attach_complete_timer_Subscription01\n\
...
/nv/item_files/modem/mmode/cmregprx_dbg_msgs\n\
/nv/item_files/modem/mmode/buffer_sys_sel_pref\n\
/nv/item_files/modem/mmode/1x_hold_srv_timer\n\
/nv/item_files/modem/mmode/1x_hold_srv_timer_Subscription01\n\
...
/nv/item_files/modem/mmode/hold_hy2_oper_flag_timer_Subscription01\n\
/nv/item_files/modem/mmode/manual_search_timer\n\
/nv/item_files/modem/mmode/cdma_less\n\
/nv/item_files/modem/mmode/cdma_less_Subscription01\n\
/nv/item_files/modem/mmode/mtcsfb_call_redial\n\
/nv/item_files/modem/mmode/mtcsfb_call_redial_Subscription01\n\
/nv/item_files/modem/mmode/self_activation_support\n\
/nv/item_files/modem/mmode/self_activation_support_Subscription01\n\
/nv/item_files/modem/mmode/sd/loc_base_bsr_mcc_list\n\
/nv/item_files/modem/mmode/sd/loc_base_bsr_mcc_list_Subscription01\n\
/sd/lte_avail_file\n\
/sd/lte_avail_file_Subscription01\n\
/sd/lte_not_avail_file\n\
/sd/lte_not_avail_file_Subscription01\n\
/sd/bst_tbl\n\
/sd/bst_tbl_Subscription01\n\
/nv/item_files/modem/nas/ignore_uplmn\n\
/nv/item_files/modem/nas/ignore_uplmn_Subscription01\n\
/nv/item_files/modem/mmode/lock_parameters\n\
/nv/item_files/modem/mmode/lock_parameters_Subscription01\n\
/sd/mru002\n\
/sd/mru002_Subscription01\n\
/sd/mru001\n\
/sd/mru001_Subscription01\n\
/sd/mmss_eqprl\n\
/sd/mmss_eqprl_Subscription01\n\
...
/nv/item_files/modem/mmode/clear_mplmn\n\
/nv/item_files/modem/mmode/ps_signalling_wait_timer\n\
/nv/item_files/modem/mmode/sds_plmn_blocking_type\n\
/nv/item_files/modem/mmode/sds_plmn_blocking_type_Subscription01\n\
/nv/item_files/modem/mmode/sd/sub_scan_scope\n\
/nv/item_files/modem/mmode/reg_sms_retry_timer\n\
/nv/item_files/modem/mmode/ps_call_orig_hold_timer\n\
/nv/item_files/modem/mmode/lte_softfailure_count\n\
/sd/mru002_ext\n\
/sd/mru002_ext_Subscription01\n\
/sd/mru001_ext\n\
/sd/mru001_ext_Subscription01\n\
/nv/item_files/modem/mmode/enable_volte_on_stack2\n\
/nv/item_files/modem/mmode/enable_volte_on_stack2_Subscription01\n\
/nv/item_files/modem/mmode/sd/full_srv_req_in_emerg_ext\n\
/nv/item_files/modem/mmode/sd/full_srv_req_in_emerg_ext_Subscription01\n\
/nv/item_files/modem/mmode/plmn_blocking_sync\n\
/nv/item_files/modem/mmode/allow_cs_page_during_mt_volte_call\n\
/nv/item_files/modem/mmode/allow_cs_page_during_mt_volte_call_Subscription01\n\
/nv/item_files/modem/mmode/e911_prioritize_ps\n\
/nv/item_files/modem/mmode/e911_prioritize_ps_Subscription01\n\
/nv/item_files/modem/mmode/rpm_feature_enabled\n\
/nv/item_files/modem/mmode/rpm_feature_enabled_Subscription01\n\
/nv/item_files/modem/mmode/follow_tot\n\
/nv/item_files/modem/mmode/follow_tot_Subscription01\n\
/nv/item_files/modem/mmode/powerdown_timestamp\n\
/nv/item_files/modem/mmode/non_dds_lte_removal_timer\n\
/nv/item_files/modem/mmode/non_dds_lte_removal_timer_Subscription01\n\
/nv/item_files/modem/mmode/e911_pref_over_ps_during_wlan\n\
/nv/item_files/modem/mmode/emerg_call_rej_in_acq_hold\n\
/nv/item_files/modem/mmode/emerg_call_rej_in_acq_hold_Subscription01\n\
/nv/item_files/modem/mmode/sd/em_call_1x_scan_first_restricted\n\
/nv/item_files/modem/mmode/qmi/arfcn_list_info\n\
/nv/item_files/modem/mmode/sd/mcc_list_emerg_call_full_srv\n\
/nv/item_files/modem/mmode/sd/mcc_list_emerg_call_full_srv_Subscription01\n\
/nv/item_files/modem/mmode/enable_fullrat_optimisation\n\
/nv/item_files/modem/mmode/sd/sd_device_config_timers\n\
/nv/item_files/modem/mmode/msim_volte_esr_support\n\
/nv/item_files/modem/mmode/msim_volte_esr_support_Subscription01\n\
/nv/item_files/modem/mmode/mcc_list_emerg_call_end_no_sim\n\
/nv/item_files/modem/mmode/disable_emerg_call_end_on_nw_rej_mcc\n\
/nv/item_files/modem/mmode/ue_based_sups\n\
/nv/item_files/modem/mmode/ue_based_sups_Subscription01\n\
/nv/item_files/modem/mmode/ue_based_sups_mode\n\
/nv/item_files/modem/mmode/ue_based_sups_mode_Subscription01\n\
/nv/item_files/modem/mmode/sync_ue_based_cw_with_cs\n\
/nv/item_files/modem/mmode/sync_ue_based_cw_with_cs_Subscription01\n\
/nv/item_files/modem/mmode/immediate_sups_sync_with_cs_req\n\
/nv/item_files/modem/mmode/immediate_sups_sync_with_cs_req_Subscription01\n\
/nv/item_files/modem/mmode/cw_ext_config_info\n\
/nv/item_files/modem/mmode/cw_ext_config_info_Subscription01\n\
/nv/item_files/modem/mmode/sups_enable_status_nw\n\
/nv/item_files/modem/mmode/sups_enable_status_nw_Subscription01\n\
/nv/item_files/modem/mmode/wifi_cellular_scan_timer\n\
/nv/item_files/modem/mmode/wifi_cellular_scan_timer_Subscription01\n\
/nv/item_files/modem/mmode/allow_mt_page_concurrency\n\
/nv/item_files/modem/mmode/sd/sd_psuedo_prl_creation\n\
/nv/item_files/modem/mmode/psap_call_back_mandatory\n\
/nv/item_files/modem/mmode/psap_call_back_mandatory_Subscription01\n\
/nv/item_files/modem/mmode/online_emerg_pending_supp\n\
/nv/item_files/modem/mmode/sd/e911_prioritize_cs\n\
/nv/item_files/modem/mmode/sd/e911_prioritize_cs_Subscription01\n\
/nv/item_files/modem/mmode/skip_no_srv_buffering_on_rat_remv\n\
/nv/item_files/modem/mmode/skip_no_srv_buffering_on_rat_remv_Subscription01\n\
/nv/item_files/modem/mmode/prev_ue_based_cw\n\
/nv/item_files/modem/mmode/prev_ue_based_cw_Subscription01\n\
/nv/item_files/modem/mmode/sd/special_scan_mcc_list\n\
/nv/item_files/modem/mmode/addtnl_char_for_voice_cc\n\
/nv/item_files/modem/mmode/addtnl_char_for_voice_cc_Subscription01\n\
";
...
)
{
  ...
  return c2k_sxlte_opti_array[asubs_id][opti_index];
}

/*===========================================================================

FUNCTION cmefs_get_addr_c2k_sxlte_opti
...
void cmefs_init_c2k_sxlte_opti()
{
  ...
  */
  ...
  {
    if(cmefs_get(CMEFS_MMODE_1XSXLTE_OPTIMIZATION,
                 (byte *)&efs_opti, size_of_opti_struct, (sys_modem_as_id_e_type)i))
    {
      memscpy(c2k_sxlte_opti_array[i], sizeof(c2k_sxlte_opti_array[i]), efs_opti.opti, sizeof(c2k_sxlte_opti_array[i]));
    }
    else
    {
      ...
      */
      ...
      for(opti_index = 0; opti_index < sizeof(c2k_sxlte_opti_array[i]); opti_index++)
      {
      ...
      cmefs_fs_write(CMEFS_MMODE_1XSXLTE_OPTIMIZATION,
                     (byte *)&efs_opti,
...
)
{
  ...
  */
  CM_MSG_HIGH_2("Open file id %d, buffer size %d", efs_id, *size_ptr);
...
)
{
  ...
  */
  CM_MSG_HIGH_1("Open file id %d", efs_id);
...
)
{
  ...
  */
  CM_MSG_HIGH_2("mcfg_fs_write file id %d, sub_id %d", efs_id, sub_id);
...
)
{
  ...
  */
  ...
  {
    CM_MSG_HIGH_3("mcfg_fs_stat sub_id %d, status %d, errno %d", 
                   mcfg_subs, mcfg_status, mcfg_fs_errno(MCFG_FS_TYPE_EFS));
    return FALSE;
  }

  /* if file to be read is larger 
   ** than the size intended to be copied to the buffer for efs item
   ** return to prevent memory overflow.
  */
  if(st.st_size > ((uint32)size))
    return FALSE;
