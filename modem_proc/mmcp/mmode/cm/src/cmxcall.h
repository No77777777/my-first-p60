...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmxcall.h#1 $
...
===========================================================================*/
extern void cmxcall_unsuspend_hybrid_operation( sys_modem_as_id_e_type asubs_id);
...
===========================================================================*/
extern boolean cmxcall_outgoing_data_call_proceed( sys_modem_as_id_e_type asubs_id  );
...
extern sys_vfr_e_type cm_vfr_map[MAX_AS_IDS];
