...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmaccessctrl.h#1 $
...
typedef struct
{
  ...
  uint64    dereg_1x_timer;
} cmac_s_type;

extern cmac_s_type *cmac_local[MAX_SIMS];
...
cmac_s_type **cmac_ptr_addr(void);
...
===========================================================================*/
boolean cmac_is_in_emergency_only(sys_modem_as_id_e_type);
...
extern boolean cmac_is_1x_ppp_dereg_end(sys_modem_as_id_e_type);
...
===========================================================================*/
boolean cmac_is_in_thermal_emergency(sys_modem_as_id_e_type);
...
boolean cmac_is_reason_mask_set(sys_modem_as_id_e_type);
