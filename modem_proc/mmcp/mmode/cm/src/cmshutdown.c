...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmshutdown.c#1 $
...
/*===========================================================================
FUNCTION cmshutdown_qsh_mdump_collect
  
DESCRIPTION
  This function collects the mdump for cmshutdown global variables
...
QSH_MDUMP_FN_ATTR
#endif
void cmshutdown_qsh_mdump_collect()
{
  qsh_mdump_collect_high(&cm_shutdown_client_id,sizeof(cm_client_id_type));
}
#endif
