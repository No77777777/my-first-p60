...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmbcmcs.h#1 $
...
typedef struct cmbcmcs_s
{
  ...
  */
  ...
  multimode_stack_e_type           waiting_pwrsave_exit_for_ss;
...
** --------------------------------------------------------------------------
*/
/* This pointer should not be exposed to the outside world. Currently it is
** needed for unit test. So exposing ONLY FOR UT.
*/
#ifdef CM_DEBUG
