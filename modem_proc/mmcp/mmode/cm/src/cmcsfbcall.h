...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmcsfbcall.h#1 $
...
FUNCTION cmcsfbcall_handle_srv_ind
...
===========================================================================*/
extern void cmcsfbcall_unforce_csfb_call_end_preferences(
...
===========================================================================*/
extern void cmcsfbcall_unforce_hard_failure_preferences(
  sys_modem_as_id_e_type  asubs_id
);
