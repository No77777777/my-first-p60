...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/sys.c#1 $
...
/*===========================================================================
FUNCTION sys_map_sd_mode_pref_to_sys_mode_mask
...
===========================================================================*/
sys_sys_mode_mask_e_type sys_map_sd_mode_pref_to_sys_mode_mask(
...
)
{
  ...
  */
  ...
  if(mode_pref & SD_SS_MODE_PREF_CDMA)
  {
  ...
  if(mode_pref & SD_SS_MODE_PREF_WCDMA)
  {
    mode_capability =(sys_sys_mode_mask_e_type)
                     ((uint64)mode_capability | (uint64)SYS_SYS_MODE_MASK_WCDMA);
  }

  if(mode_pref & SD_SS_MODE_PREF_GSM)
  {
    mode_capability =(sys_sys_mode_mask_e_type)
...
#ifdef FEATURE_LTE
  if(mode_pref & SD_SS_MODE_PREF_LTE)
  {
    mode_capability =(sys_sys_mode_mask_e_type)
  ...
  if(mode_pref & SD_SS_MODE_PREF_TDS)
  {
    mode_capability =(sys_sys_mode_mask_e_type)
...
==============================================================================*/
void sys_add_avoid_plmn_to_list
(
  sys_aplmn_list_s_type             *plmn_list,
  const sys_plmn_id_s_type          *plmn_ptr
)

{
  if(plmn_list == NULL ||
	  plmn_ptr  == NULL)
  {
    CM_MSG_HIGH_0("plmn_list or plmn_ptr - NULL");
    return;
  }

  if(SYS_AVOID_PLMN_LIST_MAX_LENGTH <=plmn_list->index)
  {
	plmn_list->index = 0;
  }
  plmn_list->plmn[plmn_list->index] = *plmn_ptr;
  plmn_list->index++;
...
sys_lte_band_mask_e_type sys_lte_band_pref_lte_const_any()
{
  ...
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND46 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND47 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND48 );
  /* LTE-U bands. */
#if(LTE_BAND_NUM == 256)
  ...
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND250 );
  ...
  */
  switch( lte_band )
  {
    ...
    case SYS_BAND_LTE_EUTRAN_BAND46:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND46;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND47:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND47;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND48:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND48;
      break;
    ...
    case SYS_BAND_LTE_EUTRAN_BAND250:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND250;
      break;
...
FUNCTION sys_map_sband_to_band_class

DESCRIPTION
  Mapping function from sys_sband_e_type ==> sys_band_class_e_type.
...
===========================================================================*/
sys_band_class_e_type sys_map_sband_to_band_class(

  sys_sband_e_type   sband
)
{
  switch (sband)
  {
    case SYS_SBAND_BC0_A:
    case SYS_SBAND_BC0_B:
      return SYS_BAND_BC0;
    ...
    case SYS_SBAND_BC10:
      return SYS_BAND_BC10;

    case SYS_SBAND_BC11:
      return SYS_BAND_BC11;

    case SYS_SBAND_BC12:
      return SYS_BAND_BC12;

    case SYS_SBAND_BC14:
      return SYS_BAND_BC14;

    case SYS_SBAND_BC15:
      return SYS_BAND_BC15;

    case SYS_SBAND_BC16:
      return SYS_BAND_BC16;

    case SYS_SBAND_BC17:
      return SYS_BAND_BC17;

    case SYS_SBAND_BC18:
      return SYS_BAND_BC18;

    case SYS_SBAND_BC19:
      return SYS_BAND_BC19;
    ...
    case SYS_SBAND_GSM_450:
      return SYS_BAND_GSM_450;

    case SYS_SBAND_GSM_480:
      return SYS_BAND_GSM_480;

    case SYS_SBAND_GSM_750:
      return SYS_BAND_GSM_750;

    case SYS_SBAND_GSM_850:
      return SYS_BAND_GSM_850;

    case SYS_SBAND_GSM_RGSM_900:
      return SYS_BAND_GSM_RGSM_900;

    case SYS_SBAND_GSM_PCS_1900:
      return SYS_BAND_GSM_PCS_1900;

    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    case SYS_SBAND_WCDMA_I_IMT_2000:
      return SYS_BAND_WCDMA_I_IMT_2000;

    case SYS_SBAND_WCDMA_II_PCS_1900:
      return SYS_BAND_WCDMA_II_PCS_1900;

    case SYS_SBAND_WCDMA_III_1700:
      return SYS_BAND_WCDMA_III_1700;

    case SYS_SBAND_WCDMA_IV_1700:
      return SYS_BAND_WCDMA_IV_1700;

    case SYS_SBAND_WCDMA_V_850:
      return SYS_BAND_WCDMA_V_850;

    case SYS_SBAND_WCDMA_VI_800:
      return SYS_BAND_WCDMA_VI_800;

    case SYS_SBAND_WCDMA_VII_2600:
      return SYS_BAND_WCDMA_VII_2600;

    case SYS_SBAND_WCDMA_VIII_900:
      return SYS_BAND_WCDMA_VIII_900;

    case SYS_SBAND_WCDMA_IX_1700:
      return SYS_BAND_WCDMA_IX_1700;

    case SYS_SBAND_WCDMA_XI_1500:
      return SYS_BAND_WCDMA_XI_1500;

    case SYS_SBAND_WCDMA_XIX_850:
      return SYS_BAND_WCDMA_XIX_850;

    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    case SYS_SBAND_WLAN_US_2400:
      return SYS_BAND_WLAN_US_2400;

    case SYS_SBAND_WLAN_EUROPE_2400:
      return SYS_BAND_WLAN_EUROPE_2400;

    case SYS_SBAND_WLAN_FRANCE_2400:
      return SYS_BAND_WLAN_FRANCE_2400;

    case SYS_SBAND_WLAN_SPAIN_2400:
      return SYS_BAND_WLAN_SPAIN_2400;

    case SYS_SBAND_WLAN_JAPAN_2400:
      return SYS_BAND_WLAN_JAPAN_2400;

    case SYS_SBAND_WLAN_US_5000:
      return SYS_BAND_WLAN_US_5000;

    case SYS_SBAND_WLAN_EUROPE_5000:
      return SYS_BAND_WLAN_EUROPE_5000;

    case SYS_SBAND_WLAN_FRANCE_5000:
      return SYS_BAND_WLAN_FRANCE_5000;

    case SYS_SBAND_WLAN_SPAIN_5000:
      return SYS_BAND_WLAN_SPAIN_5000;

    case SYS_SBAND_WLAN_JAPAN_5000:
      return SYS_BAND_WLAN_JAPAN_5000;

    default:
      CM_MSG_HIGH_1("Invalid sys_sband_e_type %d",sband);
...
{
  sys_radio_access_tech_e_type access_tech = SYS_RAT_MAX;
  switch(sys_mode)
  {
    case SYS_SYS_MODE_GSM:
      access_tech = SYS_RAT_GSM_RADIO_ACCESS;
      break;

    case SYS_SYS_MODE_WCDMA:
      access_tech = SYS_RAT_UMTS_RADIO_ACCESS;
      break;


    case SYS_SYS_MODE_LTE:
      access_tech = SYS_RAT_LTE_RADIO_ACCESS;
      break;

    case SYS_SYS_MODE_TDS:
      access_tech = SYS_RAT_TDS_RADIO_ACCESS;
      break;
