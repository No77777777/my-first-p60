...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmsms.h#1 $
...
** with a SMS object
*/
typedef struct cmsms_sub_info_s
{
...
typedef struct cmsms_s
{
  ...
  cmsms_sub_info_s_type  *sub_info[MAX_SIMS];
