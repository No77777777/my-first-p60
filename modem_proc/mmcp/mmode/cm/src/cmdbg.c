...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmdbg.c#3 $
...
#define SET_SUBS_DATA(ptr, subs_data)   \
  ...
  {\
    ...
    ptr->subs_data.active_stacks              = subs_data ## _ptr->active_stacks;\
    ptr->subs_data.is_perso_locked            = subs_data ## _ptr->is_perso_locked;\
    ptr->subs_data.sub_avail                  = subs_data ## _ptr->sub_avail;\
    ptr->subs_data.prot_subsc_chg             = subs_data ## _ptr->prot_subsc_chg;\
    ...
    ptr->subs_data.gpp_session_type           = subs_data ## _ptr->gpp_session_type;\
    ptr->subs_data.srv_domain_pref            = subs_data ## _ptr->srv_domain_pref;\
    ptr->subs_data.gpp2_session_type          = subs_data ## _ptr->gpp2_session_type;\
    ptr->subs_data.hybr_pref                  = subs_data ## _ptr->hybr_pref;\
    ptr->subs_data.ue_mode                    = subs_data ## _ptr->ue_mode;\
    ptr->subs_data.is_ue_mode_substate_srlte  = subs_data ## _ptr->is_ue_mode_substate_srlte;\
    ptr->subs_data.camp_mode  = subs_data ## _ptr->camp_mode;\
  }
...
#if defined(FEATURE_CM_DEBUG_BUFFER) || defined(MMODE_ADDITIONAL_DEBUG_INFO)
uint8 unique_idx = 0;
#endif
...
static const char *cm_ph_cmd_e_type_string_map[ CM_PH_CMD_MAX ] =
{
  ...
  "CM_PH_CMD_UI_READY_STATUS",
  "CM_PH_CMD_CLOSE_LB_READY",
  "CM_PH_CMD_TRIGGER_ECALL_INACTIVITY",
  "CM_PH_CMD_INFORM_SECURE_CALL_CAPABILITY",
  "CM_PH_CMD_ECALL_TIMER_AND_RESIDUAL_VALUE",
  "CM_PH_CMD_SET_ROAMING_PREF",
  "CM_PH_CMD_DDS_SWITCH_ALLOWED",
  "CM_PH_CMD_SET_PROC_TYPE"
};
...
static const char *cm_call_cmd_e_type_string_map[ CM_CALL_CMD_MAX ] =
{
  ...
  "CM_CALL_CMD_SECURE_CALL",
  "CM_CALL_CMD_DRVCC_SETUP_REQ",
  "CM_CALL_CMD_INFORM_SECURE_CONTEXT_INFO",
  "CM_CALL_CMD_DATA_ACTIVITY",
  "CM_CALL_CMD_CANCEL_IMS_CALL_REQ"
};
...
static const char *cm_call_event_e_type_string_map[ CM_CALL_EVENT_MAX ] =
{
  ...
  "CM_CALL_EVENT_VOICE_CALL_REESTABLISHMENT",
  "CM_CALL_EVENT_CANCEL_IMS_CALL_RSP",
  "CM_CALL_EVENT_1x_ORIG_FAIL",
  "CM_CALL_EVENT_PRE_INCOM"
};
...
static const char *cm_ph_event_e_type_string_map[ CM_PH_EVENT_MAX ] =
{
  ...
  "CM_PH_EVENT_SUB_BLOCKED_STATUS"
};
...
static const char *cm_inband_event_e_type_string_map[ CM_INBAND_EVENT_MAX ] =
{
  ...
  "CM_EVENT_IP_SIP_DTMF_IND",
  "CM_EVENT_IP_SIP_DTMF"
};
...
static const char *cm_ss_event_e_type_string_map[ CM_SS_EVENT_MAX ] =
{
  ...
  "CM_SS_EVENT_LTE_DATA_INACTIVITY_TIMER_INFO"
};
...
static const char *cm_call_cmd_err_e_type_string_map[ CM_CALL_CMD_ERR_MAX ] =
{
  ...
  "CM_CALL_CMD_ERR_SRVCC_IN_PROG",
  "CM_CALL_CMD_ERR_SUBSCRIPTION_P",
  "CM_CALL_CMD_ERR_DATA_ACTIVITY_P",
  "CM_CALL_CMD_ERR_DUAL_LTE_P",
  "CM_CALL_CMD_ERR_DUAL_SWITCH",
  "CM_CALL_CMD_ERR_SUB_ON_HOLD",
  "CM_CALL_CMD_ERR_MPLMN_IN_PROGRESS",
  "CM_CALL_CMD_ERR_IMEI_NOT_ACCEPTED"
};
...
static const char *cm_ph_cmd_err_e_type_string_map[ CM_PH_CMD_ERR_MAX ] =
{
  ...
  "CM_PH_CMD_ERR_INVALID_CLOSE_LB_READY",
  "CM_PH_CMD_ERR_MCFG_REFRESH_DEACT_ONGOING",
  "CM_PH_CMD_ERR_INVALID_PROC_TYPE",
  "CM_PH_CMD_ERR_RS_RA_PENDING",
  "CM_PH_CMD_ERR_RF_HW",
  "CM_PH_CMD_ERR_GPS"
};
...
static const char *cm_name_sd_type_string_map [(CM_RPT_SD_END - CM_RPT_SD_BEGIN) - 1] = /*lint !e641 !e656 */
{
  ...
  */
  ...
  "CM_BSR_STAT_CHGD_F",
  "CM_KICK_HYBR2_F",
  "CM_MCFG_PROCEED_WITH_REFRESH_F",
  "CM_CS_EMERG_SCAN_FAIL_F",
  "CM_SUSPEND_RESUME_F",
  "CM_SUBS_CHGD_DONE",
  "CM_EMERG_SRCH_FAIL_F",
  "CM_WAIT_FOR_OTHER_SUB",
  "CM_NO_WAIT_FOR_OTHER_SUB",
  "CM_E911_LTE_FULL_SRV_ADDED_F"
};
  ...
  /*lint -restore */
{
  ...
  "CM_MM_SRVCC_HANDOVER_FAILURE_IND_INTERNAL",
#ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
  "CM_MM_LTE_SUSPEND_CNF",
#endif
  "CM_END_PRE_ALERT_MT_VOLTE_CALL",
  "CM_ME_BLOCKED_STATUS_IND"
};
/*lint -restore */
...
const char *cm_mode_pref_e_type_string_map[ CM_MODE_PREF_MAX ] =
{
  ...
  "CM_MODE_PREF_CDMA_HDR_WCDMA_LTE",
  "CM_MODE_PREF_CDMA_GSM_TDS",
  "CM_MODE_PREF_CDMA_WCDMA_TDS",
  "CM_MODE_PREF_CDMA_TDS",
  "CM_MODE_PREF_CDMA_GSM_LTE_TDS",
  "CM_MODE_PREF_CDMA_WCDMA_LTE_TDS"
} ;

/* Provide strings for multimode_stack values */
/*lint -esym(528, multimode_stack_e_type_string_map)
** Not used in some configurations
*/
static const char *multimode_stack_e_type_string_map[ MM_STACK_ALL + 1 ] = /*lint !e641 */
{
...
void cmdbg_init( void )
{
  ...
  int index                         = 0;
  boolean cmregprx_dbg_msgs = FALSE;
  int32   cmregprx_dbg_msgs_size = sizeof(boolean);

  dbg_ptr->debug_buf_idx            = -1;
  for (index = 0; index < CM_DEBUG_BUFFER_SIZE; index++)
  {
    dbg_ptr->cm_msg_debug_buf[index].timestamp         =  0;
    dbg_ptr->cm_msg_debug_buf[index].idx               =  0;
  ...
  /* Read EFS file to determine whether CMREGPRX reports are allowed
  ** in the CM debug buffer
  */
  if(cmefs_read(CMEFS_CMREGPRX_DBG_MSGS,
                (byte *)&cmregprx_dbg_msgs,
                &cmregprx_dbg_msgs_size)
    )
  {
    cmregprx_dbg_msgs = (boolean)cmregprx_dbg_msgs;

    if((cmregprx_dbg_msgs > TRUE) ||
       (cmregprx_dbg_msgs < FALSE))
    {
      // Invalid EFS value
      dbg_ptr->cmregprx_dbg_msgs = FALSE;
      CM_MSG_HIGH_2 ("EFS: cmregprx_dbg_msgs invalid value %d, default to %d",
                     cmregprx_dbg_msgs, dbg_ptr->cmregprx_dbg_msgs);
    }
    else
    {
      // Store valid EFS value
      dbg_ptr->cmregprx_dbg_msgs = cmregprx_dbg_msgs;
      CM_MSG_HIGH_1 ("EFS read succ. cmregprx_dbg_msgs = %d",
                     dbg_ptr->cmregprx_dbg_msgs);
    }
  }
  else
  {
    dbg_ptr->cmregprx_dbg_msgs = FALSE;
    CM_ERR_1 ("Failed to read /nv/item_files/modem/mmode/cmregprx_dbg_msgs, default to %d",
              dbg_ptr->cmregprx_dbg_msgs);
  }
}
  ...
  void                  *buff)
{
  ...
  switch ((cm_ph_cmd_e_type)event_type)
  {
    ...
    case CM_PH_CMD_PERSO_INFO_AVAILABLE:
    {
      ...
      subs_xx_buff->asubs_id   = ph_cmd_ptr->info.cmd_subs;
      subs_xx_buff->subs_xx_bitmask = 0;
      subs_xx_buff->subs_xx_bitmask |= ((ph_cmd_ptr->info.gwl_sub_avail_status == 0) ?BM(0):0);
      subs_xx_buff->subs_xx_bitmask |= ((ph_cmd_ptr->info.cdma_sub_avail_status == 0) ?BM(1):0);
      subs_xx_buff->current_active_subs  = ph_ptr->device_prop.msim_prop.active_subs;
      subs_xx_buff->current_user_standby_pref = ph_ptr->device_prop.msim_prop.user_standby_pref;
      subs_xx_buff->current_internal_standby_pref = ph_ptr->device_prop.msim_prop.internal_standby_pref;
      subs_xx_buff->refresh_sub_mask = cmph_get_subs_with_mcfg_refresh_ongoing();
      subs_xx_buff->is_standby_pref_buffered = ph_ptr->device_prop.msim_prop.is_standby_pref_buffered;
    ...
    case CM_PH_CMD_SUBSCRIPTION_NOT_AVAILABLE:
    {
      ...
      subs_xx_buff->asubs_id   = ph_cmd_ptr->info.cmd_subs;
      subs_xx_buff->subs_xx_bitmask = 0;
      subs_xx_buff->subs_xx_bitmask |= ((ph_cmd_ptr->info.gwl_sub_not_avail_status == 0) ?BM(0):0);
      subs_xx_buff->subs_xx_bitmask |= ((ph_cmd_ptr->info.cdma_sub_not_avail_status == 0) ?BM(1):0);
      subs_xx_buff->current_active_subs  = ph_ptr->device_prop.msim_prop.active_subs;
      subs_xx_buff->current_user_standby_pref = ph_ptr->device_prop.msim_prop.user_standby_pref;
      subs_xx_buff->current_internal_standby_pref = ph_ptr->device_prop.msim_prop.internal_standby_pref;
      subs_xx_buff->refresh_sub_mask = cmph_get_subs_with_mcfg_refresh_ongoing();
    ...
    case CM_PH_CMD_DUAL_STANDBY_PREF:
    {
      ...
      ds_pref_buff->dds_switch_type     = ph_cmd_ptr->info.dds_switch_type;
      ds_pref_buff->current_active_subs  = ph_ptr->device_prop.msim_prop.active_subs;
      ds_pref_buff->current_user_standby_pref = ph_ptr->device_prop.msim_prop.user_standby_pref;
      ds_pref_buff->current_internal_standby_pref = ph_ptr->device_prop.msim_prop.internal_standby_pref;
      ds_pref_buff->current_default_data_subs = ph_ptr->device_prop.msim_prop.default_data_subs;
      ds_pref_buff->refresh_sub_mask = cmph_get_subs_with_mcfg_refresh_ongoing();
      ds_pref_buff->is_standby_pref_buffered = ph_ptr->device_prop.msim_prop.is_standby_pref_buffered;
  ...
  void                  *buff)
{
  ...
  switch((cm_call_cmd_e_type)event_type)
  {
    ...
    case CM_CALL_CMD_RAB_REESTAB:
    {
      ...
      call_xx_buff->cmd_subs          = call_cmd_ptr->cmd_subs;
    ...
    case CM_CALL_CMD_PS_DATA_AVAILABLE:
    {
      ...
      ps_data_avail_buff->cmd_subs          = call_cmd_ptr->cmd_subs;
...
void cmdbg_add_rpt_to_dbg_buffer(
  ...
  void                  *buff)
{
  /* Add CMREGPRX reports if enabled in EFS */
  if(cmdbg_ptr()->cmregprx_dbg_msgs)
  {
  ...
  switch((cm_name_type)event_type)
  {
    case CM_DATA_SUSPEND_CHGD_F:
    {
      ...
      data_suspend_buff->as_id              = ((cm_rpt_type *)buff)->asubs_id;
      data_suspend_buff->stack_id           = ((cm_rpt_type *)buff)->cmd.data_suspend_chgd.stack_id;
      data_suspend_buff->data_suspend = ((cm_rpt_type *)buff)->cmd.data_suspend_chgd.data_suspend;
    ...
    case CM_BSR_STAT_CHGD_F:
    {
      ...
      bsr_stat_chgd_buff->as_id              = ((cm_cdma_bsr_stat_type *)buff)->hdr.asubs_id;
    ...
    case CM_HYBR_BSR_TO_HDR_F:
    {
      ...
      hybr_bsr_hdr_buff->as_id              = ((cm_hybr_bsr_to_hdr_type *)buff)->hdr.asubs_id;
    ...
    case CM_SRV_IND_INFO_F:
    {
      ...
      srv_ind_buff->as_id                 = ((cm_srv_ind_info_type *)buff)->hdr.asubs_id;
      srv_ind_buff->stack_id              = ((cm_srv_ind_info_type *)buff)->stack_id;
    ...
    case CM_ACQ_FAIL_F:
    {
      CMDBG_MEM_ALLOC(ss_buff, cm_rpt_stack_entry_s_type)

      ss_buff->as_id              = ((cm_acq_fail_type *)buff)->hdr.asubs_id;
      ss_buff->stack_id                = ((cm_acq_fail_type *)buff)->stack_id;
    ...
    case CM_FULL_SRV_LOST_F:
    {
      ...
      ss_buff->as_id              = ((cm_full_srv_lost_type *)buff)->hdr.asubs_id;
      ss_buff->stack_id                = ((cm_full_srv_lost_type *)buff)->stack_id;
    ...
    case CM_OK_TO_ORIG_F:
    {
      ...
      ok_to_orig_buff->as_id              = ((cm_ok_to_orig_type *)buff)->hdr.asubs_id;
      ok_to_orig_buff->stack_id            = ((cm_ok_to_orig_type *)buff)->stack_id;
    ...
    case CM_SUSPEND_SS_F:
    {
      ...
      suspend_ss_buff->as_id         = ((cm_suspend_ss_s_type *)buff)->hdr.asubs_id;
      suspend_ss_buff->stack_id      = ((cm_suspend_ss_s_type *)buff)->stack_id;
  ...
  void                  *buff)
{
  switch((cm_dbg_buff_msg_rtr_e_type)event_type)
  {
    case CM_DBG_BUFF_MSGR_RTR_PM_CFG_UPDATE_IND:
    {
      ...
      for (index = 0; index < MAX_SIMS && pm_policy_buff->policy.sub_policy[index]; index ++)
      {
        pm_policy_buff->maxcap[index] = pm_policy_buff->policy.sub_policy[index]->policy_items.policy_max_mode_capability;
        pm_policy_buff->ratcap[index] = pm_policy_buff->policy.sub_policy[index]->policy_items.policy_mode_capability;
        pm_policy_buff->current_maxcap[index] = (uint32)cmmsc_get_curr_msc_max_cap((sys_modem_as_id_e_type)index);
        pm_policy_buff->current_ratcap[index] = (uint32)cmmsc_get_msc_rat_cap((sys_modem_as_id_e_type)index);
        pm_policy_buff->policy_changes[index] = pm_policy_buff->policy.sub_policy[index]->policy_changes;
        pm_policy_buff->sub_policy[index] = *(pm_policy_buff->policy.sub_policy[index]);
      }
...
void cmdbg_welcome_new_entry()
{
  ...
  cmdbg_ptr()->cm_msg_debug_buf[cmdbg_ptr()->debug_buf_idx].idx       = cmdbg_get_unique_idx();
}
...
void                                 cmdbg_add_subs_cmd_to_buffer(
  ...
  const mmoc_subs_data_s_type          *subs1_data_ptr,
  const mmoc_subs_data_s_type          *subs2_data_ptr,
  const mmoc_subs_data_s_type          *subs3_data_ptr
)
{
  CMDBG_MEM_ALLOC(subs_entry_buff, cm_mmoc_subsc_chgd_cmd_entry_s_type)
  subs_entry_buff->chg_type                 = chg_type;
  subs_entry_buff->prot_subsc_chg1          = prot_subsc_chg1;
  subs_entry_buff->prot_subsc_chg2          = prot_subsc_chg2;
  subs_entry_buff->prot_subsc_chg3          = prot_subsc_chg3;
  subs_entry_buff->nam                      = nam;
  subs_entry_buff->active_subs              = active_subs;
  subs_entry_buff->device_mode              = device_mode;

  // Service domain not valid for CDMA payload
  SET_SUBS_DATA(subs_entry_buff, subs1_data)
#if defined(FEATURE_MMODE_DUAL_SIM)
  SET_SUBS_DATA(subs_entry_buff, subs2_data)
#endif
#if defined(FEATURE_MMODE_TRIPLE_SIM)
  SET_SUBS_DATA(subs_entry_buff, subs3_data)
#endif
...
FUNCTION cmdbg_add_oprt_mode_cmd_to_buffer

DESCRIPTION
  Add oprt mode change command from cm to mmoc to cm debug buffer.
...
===========================================================================*/
void  cmdbg_add_oprt_mode_cmd_to_buffer (
  sys_oprt_mode_e_type              cmd_oprt_mode
)
{
  CMDBG_MEM_ALLOC(cm_mmoc_cmd_buff, cm_mmoc_oprt_mode_cmd_entry_s_type)

  cm_mmoc_cmd_buff->cmd_oprt_mode     = cmd_oprt_mode;
  cm_mmoc_cmd_buff->current_oprt_mode = cmph_ptr()->device_prop.ph_oprt_mode.oprt_mode;
  cmdbg_add_to_dbg_buffer(CM_BUFF_MMOC_CMD_TYPE, MMOC_CMD_OPRT_MODE_CHGD, ((void *)cm_mmoc_cmd_buff));
}
...
void cmdbg_stringmap_verify()
{
  ...
  {
    CM_ASSERT(multimode_stack_e_type_string_map[i]!= NULL);
  }
...
#ifdef CMDEBUG_STRING_MAPS_ACTIVE
#ifdef FEATURE_HDR_HYBRID
  cmdbg_print_message("- stack = %d(%s)",
                      call_ptr->mm_id.stk_id,
                      CMDBG_STR_MAP_LOOKUP(call_ptr->mm_id.stk_id,
                      MM_STACK_ALL + 1,
                      multimode_stack_e_type_string_map));
...
#else
#ifdef FEATURE_HDR_HYBRID
  CM_MSG_HIGH_2("- stack = %d favored_hybr_pref = %d", call_ptr->mm_id.stk_id, call_ptr->favored_mode_pref);
...
#else
      CM_MSG_HIGH_3_EXT("<<CM%d callevt=%d <%d>", call_info_ptr->asubs_id +1,
                        call_event, call_info_ptr->call_id, (call_info_ptr->asubs_id+1));
#endif
...
#else
      CM_MSG_HIGH_2("<<CM%d ssevt=%d", 1, ss_event);
#endif
...
#else
  CM_MSG_HIGH_6("CALL_PREF: sub %d, call_type = %d srv_type = %d mode pref = %d fav mode pref = %d fav hybr pref = %d",
                   asubs_id, call_type, srv_type, mode_pref, favored_mode_pref, favored_hybr_pref);
#endif
