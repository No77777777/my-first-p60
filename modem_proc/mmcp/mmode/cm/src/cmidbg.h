...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmidbg.h#1 $
...
#define MSG_EXT_V1( SSID, level, sub_id, str)
#define MSG_1_EXT_V1( SSID, level, sub_id, str, a )
#define MSG_2_EXT_V1( SSID, level, sub_id, str, a, b )
#define MSG_3_EXT_V1( SSID, level, sub_id, str, a, b, c )
#define MSG_4_EXT_V1( SSID, level, sub_id, str, a, b, c, d )
#define MSG_5_EXT_V1( SSID, level, sub_id, str, a, b, c, d, e )
#define MSG_6_EXT_V1( SSID, level, sub_id, str, a, b, c, d, e, f)
...
do {\
qsh_mdump_set_crash_client(QSH_CLT_CM,QSH_CLT_CM); \
}while(0)
#else
#define QSH_MDUMP_SET \
do {\
...
#define CM_ERR_FATAL_0(str)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=CM= " str, 0, 0, 0 );\
}while(0)

#define CM_ERR_FATAL_1(str, a)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=CM= " str, (a), 0, 0 );\
}while(0)

#define CM_ERR_FATAL_2(str, a, b)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=CM= " str, (a), (b), 0 );\
}while(0)

#define CM_ERR_FATAL_3(str, a, b, c)\
do {\
QSH_MDUMP_SET;\
ERR_FATAL( "=CM= " str, (a), (b), (c) );\
}while(0)
...
#define CM_MSG_HIGH_0_EXT(str, sub_id)   MSG_EXT_V1( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                         "=CM= " str)
#define CM_MSG_HIGH_1_EXT(str, a, sub_id)  MSG_1_EXT_V1( MSG_SSID_CM,               \
                                           MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                           "=CM= " str, (a) )
#define CM_MSG_HIGH_2_EXT(str, a, b, sub_id)  MSG_2_EXT_V1( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                              "=CM= " str, (a), (b) )
#define CM_MSG_HIGH_3_EXT(str, a, b, c, sub_id)  MSG_3_EXT_V1( MSG_SSID_CM,               \
                                                 MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                 "=CM= " str, (a), (b), (c) )
#define CM_MSG_HIGH_4_EXT(str, a, b, c, d, sub_id)  MSG_4_EXT_V1( MSG_SSID_CM,               \
                                                    MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                    "=CM= " str, (a), (b), (c), (d) )
#define CM_MSG_HIGH_5_EXT(str, a, b, c, d, e, sub_id)  MSG_5_EXT_V1( MSG_SSID_CM,               \
                                                       MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                       "=CM= " str, (a), (b), (c), (d), (e) )
#define CM_MSG_HIGH_6_EXT(str, a, b, c, d, e, f, sub_id)  MSG_6_EXT_V1( MSG_SSID_CM,               \
                                                          MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                          "=CM= " str, (a), (b), (c), (d), (e), (f) )

#define CM_MSG_MED_0_EXT(str, sub_id)    MSG_EXT_V1( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_MED, sub_id,      \
                                         "=CM= " str )
#define CM_MSG_MED_1_EXT(str, a, sub_id)         MSG_1_EXT_V1( MSG_SSID_CM,               \
                                                 MMODE_MSG_LEGACY_MED, sub_id,            \
                                                 "=CM= " str, (a) )
#define CM_MSG_MED_2_EXT(str, a, b, sub_id)     MSG_2_EXT_V1( MSG_SSID_CM,               \
                                                MMODE_MSG_LEGACY_MED, sub_id,            \
                                                "=CM= " str, (a), (b) )
#define CM_MSG_MED_3_EXT(str, a, b, c, sub_id)   MSG_3_EXT_V1( MSG_SSID_CM,               \
                                                 MMODE_MSG_LEGACY_MED, sub_id,             \
                                                 "=CM= " str, (a), (b), (c) )

#define CM_MSG_MED_4_EXT(str, a, b, c, d, sub_id)  MSG_4_EXT_V1( MSG_SSID_CM,               \
                                                   MMODE_MSG_LEGACY_MED, sub_id,            \
                                                   "=CM= " str, (a), (b), (c), (d) )
#define CM_MSG_MED_5_EXT(str, a, b, c, d, e, sub_id)   MSG_5_EXT_V1( MSG_SSID_CM,               \
                                                       MMODE_MSG_LEGACY_MED, sub_id,            \
                                                       "=CM= " str, (a), (b), (c), (d), (e) )
#define CM_MSG_MED_6_EXT(str, a, b, c, d, e, f, sub_id)   MSG_6_EXT_V1( MSG_SSID_CM,               \
                                                          MMODE_MSG_LEGACY_MED, sub_id,      \
                                                          "=CM= " str, (a), (b), (c), (d), (e), (f) )

#define CM_MSG_HIGH_2_ASID_EXT(str, sub, a,sub_id)  MSG_2_EXT_V1( MSG_SSID_CM,              \
                                                    MMODE_MSG_LEGACY_HIGH, sub_id,           \
                                                    "=CM= AS_ID %d, " str, sub, (a))
#define CM_MSG_HIGH_3_ASID_EXT(str, sub, a, b, sub_id)  MSG_3_EXT_V1( MSG_SSID_CM,              \
                                                        MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                        "=CM= AS_ID %d, " str, sub, (a), (b))
#define CM_MSG_HIGH_4_ASID_EXT(str, sub, a, b, c, sub_id)  MSG_4_EXT_V1( MSG_SSID_CM,              \
                                                           MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                           "=CM= AS_ID %d, " str, sub, (a), (b), (c))
#define CM_MSG_HIGH_5_ASID_EXT(str, sub, a, b, c, d, sub_id)  MSG_5_EXT_V1( MSG_SSID_CM,              \
                                                              MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d))
#define CM_MSG_HIGH_6_ASID_EXT(str, sub, a, b, c, d, e, sub_id)  MSG_6_EXT_V1( MSG_SSID_CM,              \
                                                                 MMODE_MSG_LEGACY_HIGH, sub_id,            \
                                                                 "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d), (e))

#else

#define CM_MSG_HIGH_0_EXT(str, sub_id)   MSG( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str )
#define CM_MSG_HIGH_1_EXT(str, a, sub_id)  MSG_1( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a) )
#define CM_MSG_HIGH_2_EXT(str, a, b, sub_id)  MSG_2( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a), (b) )
#define CM_MSG_HIGH_3_EXT(str, a, b, c, sub_id)  MSG_3( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a), (b), (c) )
#define CM_MSG_HIGH_4_EXT(str, a, b, c, d, sub_id)  MSG_4( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a), (b), (c), (d) )
#define CM_MSG_HIGH_5_EXT(str, a, b, c, d, e, sub_id)  MSG_5( MSG_SSID_CM,               \
                                           MMODE_MSG_LEGACY_HIGH,            \
                                           "=CM= " str, (a), (b), (c), (d), (e) )
#define CM_MSG_HIGH_6_EXT(str, a, b, c, d, e, f, sub_id)  MSG_6( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= " str, (a), (b), (c), (d), (e), (f) )

#define CM_MSG_MED_0_EXT(str, sub_id)    MSG( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_MED,             \
                                         "=CM= " str )
#define CM_MSG_MED_1_EXT(str, a, sub_id)         MSG_1( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_MED,             \
                                         "=CM= " str, (a) )
#define CM_MSG_MED_2_EXT(str, a, b, sub_id)     MSG_2( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_MED,             \
                                         "=CM= " str, (a), (b) )
#define CM_MSG_MED_3_EXT(str, a, b, c, sub_id)   MSG_3( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_MED,             \
                                         "=CM= " str, (a), (b), (c) )

#define CM_MSG_MED_4_EXT(str, a, b, c, d, sub_id)  MSG_4( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_MED,             \
                                         "=CM= " str, (a), (b), (c), (d) )
#define CM_MSG_MED_5_EXT(str, a, b, c, d, e, sub_id)   MSG_5( MSG_SSID_CM,               \
                                           MMODE_MSG_LEGACY_MED,             \
                                           "=CM= " str, (a), (b), (c), (d), (e) )
#define CM_MSG_MED_6_EXT(str, a, b, c, d, e, f, sub_id)   MSG_6( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_MED,             \
                                              "=CM= " str, (a), (b), (c), (d), (e), (f) )

#define CM_MSG_HIGH_2_ASID_EXT(str, sub, a,sub_id)  MSG_1( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a) )
#define CM_MSG_HIGH_3_ASID_EXT(str, sub, a, b, sub_id)  MSG_2( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a), (b) )
#define CM_MSG_HIGH_4_ASID_EXT(str, sub, a, b, c, sub_id)  MSG_3( MSG_SSID_CM,               \
                                         MMODE_MSG_LEGACY_HIGH,            \
                                         "=CM= " str, (a), (b), (c))
#define CM_MSG_HIGH_5_ASID_EXT(str, sub, a, b, c, d, sub_id)  MSG_4( MSG_SSID_CM,               \
                                           MMODE_MSG_LEGACY_HIGH,            \
                                           "=CM= " str, (a), (b), (c), (d) )
#define CM_MSG_HIGH_6_ASID_EXT(str, sub, a, b, c, d, e, sub_id)  MSG_5( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= " str, (a), (b), (c), (d), (e))
#endif

/*-------------------------------------------------------------------------*/
#define CM_MSG_HIGH_6_ASID(str, sub, a, b, c, d, e)  MSG_6( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d), (e))
#define CM_MSG_MED_6_ASID(str, sub, a, b, c, d, e)  MSG_6( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_MED,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d), (e))
#define CM_MSG_LOW_6_ASID(str, sub, a, b, c, d, e)  MSG_6( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_LOW,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d), (e))
#define CM_MSG_HIGH_5_ASID(str, sub, a, b, c, d)  MSG_5( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d))
#define CM_MSG_MED_5_ASID(str, sub, a, b, c, d)  MSG_5( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_MED,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d))
#define CM_MSG_LOW_5_ASID(str, sub, a, b, c, d)  MSG_5( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_LOW,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c), (d))
#define CM_MSG_HIGH_4_ASID(str, sub, a, b, c)  MSG_4( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c))
#define CM_MSG_MED_4_ASID(str, sub, a, b, c)  MSG_4( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_MED,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c))
#define CM_MSG_LOW_4_ASID(str, sub, a, b, c)  MSG_4( MSG_SSID_CM,               \
                                              MMODE_MSG_LEGACY_LOW,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b), (c))
#define CM_MSG_HIGH_3_ASID(str, sub, a, b)  MSG_3( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b))
#define CM_MSG_MED_3_ASID(str, sub, a, b)  MSG_3( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_MED,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b))
#define CM_MSG_LOW_3_ASID(str, sub, a, b)  MSG_3( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_LOW,            \
                                              "=CM= AS_ID %d, " str, sub, (a), (b))
#define CM_MSG_HIGH_2_ASID(str, sub, a)  MSG_2( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= AS_ID %d, " str, sub, (a))
#define CM_MSG_MED_2_ASID(str, sub, a)  MSG_2( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_MED,            \
                                              "=CM= AS_ID %d, " str, sub, (a))
#define CM_MSG_LOW_2_ASID(str, sub, a)  MSG_2( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_LOW,            \
                                              "=CM= AS_ID %d, " str, sub, (a))
#define CM_MSG_HIGH_1_ASID(str, sub)  MSG_1( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_HIGH,            \
                                              "=CM= AS_ID %d, " str, sub)
#define CM_MSG_MED_1_ASID(str, sub)  MSG_1( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_MED,            \
                                              "=CM= AS_ID %d, " str, sub)
#define CM_MSG_LOW_1_ASID(str, sub)  MSG_1( MSG_SSID_CM,              \
                                              MMODE_MSG_LEGACY_LOW,            \
                                              "=CM= AS_ID %d, " str, sub)
...
#elif defined CM_CRIT_STRING_MAPS_ACTIVE
#define CMDBG_CMD_MSG(cmdtype, cmd, max_cmd, strmap, client_id)            \
          cmdbg_print_message( ">>CM " cmdtype " %d, tsk=%s, client_type=%d",\
                               cmd,                                          \
                               cmclient_get_task_name(client_id),            \
                               cmclient_get_client_type(client_id))
#else
#define CMDBG_CMD_MSG(cmdtype, cmd, max_cmd, strmap, client_id)            \
