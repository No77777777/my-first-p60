...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmssidmi.h#1 $
...
typedef struct
{
  ...
  */
  ...
  sys_sys_mode_e_type                 cmssidm_bs;
} cmssidm_sub_info_s_type;
...
typedef struct
{
  ...
  cmssidm_sub_info_s_type       *sub_info[MAX_SIMS];
...
SIDE EFFECTS
  None.
===========================================================================*/
EXTERN cmssidm_sub_info_s_type *cmssidm_get_sub_info_ptr
(
