...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmipqvp.c#1 $
...
*/
{
  ...
  cmipapp_id_allocate_s_type   qvp_info;

  /* First get an app id
  */
  qvp_info.call_type = qvp_call_type;
  qvp_info.sys_mode = qvp_sys_mode;
  qvp_info.app_id_ptr = &qvp_id;
  qvp_info.asubs_id = SYS_MODEM_AS_ID_1;
  if(cmipapp_id_allocate_sub(qvp_info) != CMIPAPP_STATUS_OK)
  {
