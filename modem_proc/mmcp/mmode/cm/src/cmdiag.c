...
$Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmdiag.c#1 $
...
*/
{
  ...
  switch (req->so)
  {
    ...
    case CMDIAG_SO_VOICE13:
      cai_so = CAI_SO_VOICE_13K;
      eCM_Call_Type = CM_CALL_TYPE_VOICE;
      break;

    case CMDIAG_SO_LOOPBACK:
      cai_so = CAI_SO_LOOPBACK;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;

    case CMDIAG_SO_LOOPBACK_13K:
      cai_so = CAI_SO_LOOPBACK_13K;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;

#ifdef FEATURE_IS2000
    case CMDIAG_SO_LOOPBACK_SO55:
      cai_so = CAI_SO_LOOPBACK_SO55;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;
#endif

    case CMDIAG_SO_MARKOV:
      cai_so = CAI_SO_MARKOV;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;

    case CMDIAG_SO_MARKOV_13K:
      cai_so = CAI_SO_MARKOV_13K;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;

    case CMDIAG_SO_RS2_MARKOV:
      cai_so = CAI_SO_RS2_MARKOV;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;

    case CMDIAG_SO_RS1_MARKOV:
      cai_so = CAI_SO_RS1_MARKOV;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;

#ifdef FEATURE_IS2000
    case CMDIAG_SO_MARKOV_SO54:
      cai_so = CAI_SO_MARKOV_SO54;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;
#endif
    ...
    case CAI_SO_MARKOV_SO74:
      cai_so = CAI_SO_MARKOV_SO74;
      eCM_Call_Type = CM_CALL_TYPE_TEST;
      break;
#endif

    case CMDIAG_SO_EVRC:
      cai_so = CAI_SO_VOICE_EVRC;
      eCM_Call_Type = CM_CALL_TYPE_VOICE;
      break;

#ifdef FEATURE_VOC_4GV_NW
    case CAI_SO_VOICE_EVRC_NW:
      cai_so = CAI_SO_VOICE_EVRC_NW;
      eCM_Call_Type = CM_CALL_TYPE_VOICE;
      break;
    ...
    case CMDIAG_SO_RS2_SMS:
      cai_so = CAI_SO_RS2_SMS;
      eCM_Call_Type = CM_CALL_TYPE_SMS;
      break;
...
/*lint -esym(715,pkt_len)*/
{
  ...
  for(i=0; cmutil_is_as_id_valid((sys_modem_as_id_e_type)i); i++)
  {
    if(ph_ptr->device_prop.msim_prop.active_subs & BM(i))
    {
  ...
  if (rsp_ptr != NULL)
  {
    ...
    rsp_ptr->call_state            = cmcall_overall_call_state_per_subs(asubs_id);
    rsp_ptr->oprt_mode             = diag_client_ptr->oprt_mode;
    rsp_ptr->system_mode           = diag_client_ptr->sub_info[asubs_id].sys_mode;
    rsp_ptr->mode_pref             = diag_client_ptr->sub_info[asubs_id].mode_pref;
    rsp_ptr->acq_order_pref        = diag_client_ptr->sub_info[asubs_id].acq_order_pref;
    rsp_ptr->srv_domain_pref       = diag_client_ptr->sub_info[asubs_id].srv_domain_pref;
    rsp_ptr->band_pref             = (int)diag_client_ptr->sub_info[asubs_id].band_pref;
    rsp_ptr->roam_pref             = diag_client_ptr->sub_info[asubs_id].roam_pref;
    rsp_ptr->hybr_pref             = diag_client_ptr->sub_info[asubs_id].hybr_pref;
    rsp_ptr->network_sel_mode_pref = diag_client_ptr->sub_info[asubs_id].network_sel_mode_pref;
    rsp_ptr->srv_status            = diag_client_ptr->sub_info[asubs_id].srv_status;
    rsp_ptr->ciot_lte_mode         = SYS_SYS_MODE_NO_SRV;
  }
  /*lint -restore */
...
/*lint -esym(715,pkt_len) */
{
...
#ifdef CM_GW_SUPPORTED
  cm_gw_ps_orig_params_s_type  ps_call_orig_params;
#endif
  ...
  else
  {
    ...
    CM_MSG_HIGH_1("CDMA call origination call_type %d", req_ptr->call_type);
    if ((cm_call_type_e_type)(req_ptr->call_type) == CM_CALL_TYPE_VOICE ||
        (cm_call_type_e_type)(req_ptr->call_type) == CM_CALL_TYPE_TEST
       )
    {
...
#ifdef CM_GW_SUPPORTED
    if ((cm_call_type_e_type)(req_ptr->call_type) == CM_CALL_TYPE_PS_DATA)
    {
      /* accept is not handled by lower layers */
      ps_call_orig_params.accept= FALSE;

      /* By default ps call is a primary pdp activation */
      ps_call_orig_params.primary_pdp                           = TRUE;
      ...
      -------------------------------------------------------------------------*/
      ps_call_orig_params.qos.valid                             = TRUE;
      ps_call_orig_params.qos.delay_class                       = 0x0;
      ps_call_orig_params.qos.reliability_class                 = 0x0;
      ps_call_orig_params.qos.peak_throughput                   = 0x0;
      ps_call_orig_params.qos.precedence_class                  = 0x0;
      ps_call_orig_params.qos.mean_throughput                   = 0x0;
      ps_call_orig_params.qos.traffic_class                     = 0x0;
      ps_call_orig_params.qos.deliver_order                     = 0x0;
      ps_call_orig_params.qos.deliver_err_sdu                   = 0x0;
      ps_call_orig_params.qos.max_sdu_size                      = 0x0;
      ps_call_orig_params.qos.max_bit_rare_uplink               = 0x0;
      ps_call_orig_params.qos.max_bit_rare_downlink             = 0x0;
      ps_call_orig_params.qos.residual_ber                      = 0x0;
      ps_call_orig_params.qos.sdu_err_ratio                     = 0x0;
      ps_call_orig_params.qos.tranfer_delay                     = 0x0;
      ps_call_orig_params.qos.traffic_priority                  = 0x0;
      ps_call_orig_params.qos.guarantee_ber_uplink              = 0x0;
      ps_call_orig_params.qos.guarantee_ber_dwnlink             = 0x0;
      ps_call_orig_params.qos.sig_ind                           = FALSE;
      ps_call_orig_params.qos.src_stat_desc                     = 0x0;
      ps_call_orig_params.qos.ext_max_bit_rate_downlink         = 0x0;
      ps_call_orig_params.qos.ext_gtd_bit_rate_downlink         = 0x0;
      ps_call_orig_params.qos.ext_max_bit_rate_uplink           = 0x0;
      ps_call_orig_params.qos.ext_gtd_bit_rate_uplink           = 0x0;
      ps_call_orig_params.qos.ext2_gtd_bit_rate_uplink           = 0x0;
      ps_call_orig_params.qos.ext2_max_bit_rate_uplink           = 0x0;
      ps_call_orig_params.qos.ext2_gtd_bit_rate_downlink         = 0x0;
      ps_call_orig_params.qos.ext2_max_bit_rate_downlink         = 0x0;

      /*------------------------------------------------------------------------
      Minimum Subscribed QOS : NOTE: All values are set to 0x0 implying
      subscribed value : ref TS24.008 sec 10.5.6.5
      -------------------------------------------------------------------------*/
      ps_call_orig_params.minimum_qos.valid                     = TRUE;
      ps_call_orig_params.minimum_qos.delay_class               = 0x0;
      ps_call_orig_params.minimum_qos.reliability_class         = 0x0;
      ps_call_orig_params.minimum_qos.peak_throughput           = 0x0;
      ps_call_orig_params.minimum_qos.precedence_class          = 0x0;
      ps_call_orig_params.minimum_qos.mean_throughput           = 0x0;
      ps_call_orig_params.minimum_qos.traffic_class             = 0x0;
      ps_call_orig_params.minimum_qos.deliver_order             = 0x0;
      ps_call_orig_params.minimum_qos.deliver_err_sdu           = 0x0;
      ps_call_orig_params.minimum_qos.max_sdu_size              = 0x0;
      ps_call_orig_params.minimum_qos.max_bit_rare_uplink       = 0x0;
      ps_call_orig_params.minimum_qos.max_bit_rare_downlink     = 0x0;
      ps_call_orig_params.minimum_qos.residual_ber              = 0x0;
      ps_call_orig_params.minimum_qos.sdu_err_ratio             = 0x0;
      ps_call_orig_params.minimum_qos.tranfer_delay             = 0x0;
      ps_call_orig_params.minimum_qos.traffic_priority          = 0x0;
      ps_call_orig_params.minimum_qos.guarantee_ber_uplink      = 0x0;
      ps_call_orig_params.minimum_qos.guarantee_ber_dwnlink     = 0x0;
      ps_call_orig_params.minimum_qos.sig_ind                   = FALSE;
      ps_call_orig_params.minimum_qos.src_stat_desc             = 0x0;
      ps_call_orig_params.minimum_qos.ext_max_bit_rate_downlink = 0x0;
      ps_call_orig_params.minimum_qos.ext_gtd_bit_rate_downlink = 0x0;
      ps_call_orig_params.minimum_qos.ext_max_bit_rate_uplink   = 0x0;
      ps_call_orig_params.minimum_qos.ext_gtd_bit_rate_uplink   = 0x0;
      ps_call_orig_params.minimum_qos.ext2_gtd_bit_rate_uplink   = 0x0;
      ps_call_orig_params.minimum_qos.ext2_max_bit_rate_uplink   = 0x0;
      ps_call_orig_params.minimum_qos.ext2_gtd_bit_rate_downlink = 0x0;
      ps_call_orig_params.minimum_qos.ext2_max_bit_rate_downlink = 0x0;

      /* pdp address TS24.0.0.8, 10.5.6.4*/
      ps_call_orig_params.pdp_addr.valid                        = TRUE;

      /* IETF allocated address */
      ps_call_orig_params.pdp_addr.pdp_type_org                 = 1;

      /* PDP type number value IPv4 address*/
      ps_call_orig_params.pdp_addr.pdp_type_num                 = 0x21;
      ps_call_orig_params.pdp_addr.pdp_addr_len                 = 0;

      /* APN */
      ps_call_orig_params.apn_name.valid                        = FALSE;
      ps_call_orig_params.apn_name.apn_addr_len                 = 0;
      ps_call_orig_params.apn_name.address[0]                   = 0;

      /* config options */
      ps_call_orig_params.config_options.valid                  = FALSE;

      ps_call_orig_params.h_comp                     = SYS_PDP_HEADER_COMP_OFF;
      ps_call_orig_params.d_comp                     = SYS_PDP_DATA_COMP_OFF;

      /* Origination tft parameters */
      ps_call_orig_params.tft.valid                             = FALSE;
      ps_call_orig_params.tft.tft_total_length                  = 0;
      ps_call_orig_params.tft.operation_code                    = 0;
      ps_call_orig_params.tft.num_filters                       = 0;
      ps_call_orig_params.tft.filter_list[0].identifier         = 0;
      ps_call_orig_params.tft.filter_list[0].eval_precedence    = 0;
      ps_call_orig_params.tft.filter_list[0].content_length     = 0;
      ps_call_orig_params.tft.filter_list[0].filter_contents[0] = 0;
      ...
      */
      ...
      ps_call_orig_params.pdp_group_id                          = 0;

      ps_call_orig_params.assoc_pri_profile_num                 = 0;

      ps_call_orig_params.profile_number                        = 0;
      ...
      rsp_ptr->status = cm_mm_call_cmd_orig_exten3(
                          ...
                          &calling_number,
                          &calling_number,
                          &alpha,        /* Alpha buffer for call  */
                          NULL,              /* CDMA call orig params  */
                          NULL, /* GW CS call orig params */
                          &ps_call_orig_params,              /* GW PS call orig params */
                          CM_CALL_ID_INVALID,
                          CM_ORIG_CLIENT_CATEG_USER,
                          &wcdma_call_id
                        );
...
/*lint -esym(818, req_pkt)*/
{
  ...
  if (rsp_ptr != NULL)
  {
    ...
    rsp_ptr->ccm = cmwaoc_get_ccm(SYS_MODEM_AS_ID_1);
  }
  /*lint -restore */
...
PACKED void *cmdiag_orig_thr_tbl_reset (PACKED void *req_pkt, uint16 pkt_len)
{
  ...
  else
  {
    ...
    rsp_ptr->status =  cm_ss_cmd_orig_thr_update_tbl1(
                         NULL,
                         NULL,
...
/*lint -esym(818, req_pkt)*/
{
  ...
  rsp_ptr->hsdpa_hsupa_support = (uint8)diag_client_ptr->sub_info[asubs_id].cell_srv_ind.hs_ind;
  rsp_ptr->dtm_support = (uint8)diag_client_ptr->sub_info[asubs_id].cell_srv_ind.dtm_supp;
  rsp_ptr->reserved1 = 0;
  rsp_ptr->reserved2 = 0;
  rsp_ptr->reserved3 = 0;
...
/*lint -esym(715,pkt_len)*/
{
  ...
  if (req_ptr != NULL)
  {
    CM_MSG_HIGH_1("cmdiag_cm_state_info_per_subs, passed subID = %d", req_ptr->asubs_id );
  }
  if (rsp_ptr != NULL && req_ptr != NULL )
  {
    if(req_ptr->asubs_id < MAX_SIMS)
    {
      asubs_id = req_ptr->asubs_id;
    }
    rsp_ptr->oprt_mode             = diag_client_ptr->oprt_mode;
    /* Fill the response packet */
    /* Query Call Manager for State information */
...
/*lint -esym(818, req_pkt)*/
{
  ...
  {
    /* Fill the response packet */
    if(!cmutil_is_as_id_valid((sys_modem_as_id_e_type)req_ptr->asubs_id))
    {
      rsp_ptr->ccm = 0;
    }
    else
    {
      /* Query Call Manager for CCM information */
      rsp_ptr->ccm = cmwaoc_get_ccm((sys_modem_as_id_e_type)req_ptr->asubs_id);
    }
  }
  /*lint -restore */
...
/*lint -esym(818, req_pkt)*/
{
  ...
  if(cmutil_is_as_id_valid(req_ptr->asubs_id))
  {
    asubs_id = req_ptr->asubs_id;
  }
  /* Filling cell service indication */
  ...
  if (rsp_ptr != NULL)
  {
    ...
    rsp_ptr->status = cm_ph_cmd_dual_standby_pref
                      (
                        ...
                        cmph_ptr()->device_prop.msim_prop.dds_switch_type,
                        FALSE
                      );
  }
...
Description:
       ...
       In SSIM configs it will return invalid info.
...
)
{
  ...
  {
#ifdef FEATURE_MMODE_DUAL_SIM
    rsp_ptr->active_subs = ph_ptr->device_prop.msim_prop.active_subs;
    rsp_ptr->standby_pref = (sys_modem_dual_standby_pref_e_type)ph_ptr->device_prop.msim_prop.standby_pref;
    rsp_ptr->default_data_subs = (sys_modem_as_id_e_type)ph_ptr->device_prop.msim_prop.default_data_subs;
    rsp_ptr->priority_subs = (sys_modem_as_id_e_type)ph_ptr->device_prop.msim_prop.priority_subs;
#else
    rsp_ptr->active_subs = SYS_MODEM_AS_ID_NO_ACTIVE_MASK;
    rsp_ptr->standby_pref = SYS_MODEM_DS_PREF_NONE;
    rsp_ptr->default_data_subs = SYS_MODEM_AS_ID_NONE;
    rsp_ptr->priority_subs = SYS_MODEM_AS_ID_NONE;
#endif
  }
...
/*lint -esym(715,pkt_len)*/
{
  ...
  cmlog_client_s_type *diag_client_ptr = cmlog_get_diag_client();
  sys_modem_as_id_e_type  asubs_id = cmmsc_get_1x_sub();
  ...
  if (rsp_ptr != NULL)
  {
    /* Fill the response packet */
    /* Query Call Manager for State information */
    rsp_ptr->active_channel    = diag_client_ptr->sub_info[asubs_id].active_channel;
    rsp_ptr->band_class        = diag_client_ptr->sub_info[asubs_id].band_class;
    rsp_ptr->packet_zone       = diag_client_ptr->sub_info[asubs_id].packet_zone;
    rsp_ptr->roam_status       = diag_client_ptr->sub_info[asubs_id].roam_status;
    rsp_ptr->latitude          = diag_client_ptr->sub_info[asubs_id].latitude;
    rsp_ptr->longitude         = diag_client_ptr->sub_info[asubs_id].longitude;
    rsp_ptr->mcc               = diag_client_ptr->sub_info[asubs_id].mcc;
