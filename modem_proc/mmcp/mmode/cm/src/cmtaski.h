...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmtaski.h#1 $
...
#define cm_mem_malloc(x) cm_mem_malloc_debug(x)
...
#define cm_mem_free(x) cm_mem_free_debug(x, __func__, __LINE__)
#elif (defined __GNUC__) || (defined T_WINNT)
#define cm_mem_free(x) cm_mem_free_debug(x, __FUNCTION__, __LINE__)
#endif
/*===========================================================================
...
==============================================================================*/
extern boolean cmtask_is_there_a_high_priority_activity_with_exclusions
(
  mm_sub_stk_id_s_type mm_id,
  ...
  */
  ...
  /* Activity to be excluded in comparisions
  */
...
===========================================================================*/
extern boolean cmtask_is_valid_report(
