...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmipappi.h#1 $
...
===========================================================================*/
extern boolean cmipapp_is_srv_dom_ps_detach(sys_modem_as_id_e_type    asubs_id );
...
===========================================================================*/
extern boolean  cmipsups_client_cmd_forward_ip(
...
RETURN VALUE
  cmipapp_id_type
===========================================================================*/
extern cmipapp_id_type cmipapp_find_ics_support_app(
  sys_modem_as_id_e_type  asubs_id
);
