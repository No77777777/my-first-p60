...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmcall.h#6 $
...
#define CMCALL_SR_EMERGENCY_MAX_SCAN_TIME_MSIM       180  /* seconds */
/* Maximum timer to wait for one round of scan to complete before ending
** the silent redial - this is a guide timer in case one round scan report does not come
** to CM.
*/

#define CMCALL_SR_EMERGENCY_MSIM_WIFI_EXTRA       5  /* seconds */
/* for cs fall back wifi, add additional timer on top of configured 
** fall_back_to_wifi_from_cs or wlan_fallback_timer
*/
...
#define CMCALL_EXTENDED_LTE_SOFT_FAILURE_COUNT     5
/* Special extended lte soft failure count to extend the number of soft retrys
** when NAS is in LTE_NAS_IRAT_INVALID_STATE and not PERSISTENT
*/
...
typedef enum cm_call_lch_state_e
{
  /** @cond
  */
  CM_CALL_LCH_STATE_NONE,   /* FOR INTERNAL CM USE ONLY! */
  /** @endcond
  */
  CM_CALL_LCH_WAIT_VA_RSP,
  /** Request sent to VA*/

  CM_CALL_LCH_WAIT_IMS_RSP,
  /** @cond
  */
  CM_CALL_LCH_STATE_MAX       /* FOR INTERNAL CM USE ONLY! */
  /** @endcond
  */
} cm_call_lch_state_e_type;
/*~ SENTINEL cm_call_lch_state_e_type.CM_CALL_LCH_STATE_MAX */
...
/* Enumeration of reasons for which call prefs are held 
*/
typedef enum cm_call_hold_reas_e {

  CM_CALL_HOLD_REAS_NONE,
    /**< @internal */

  CM_CALL_HOLD_REAS_TERM_MAN_SRCH,
    /**< call prefs held for terminate manual search to complete*/

  CM_CALL_HOLD_REAS_HOLD_TIMER,
    /**< call prefs held due to hold hy2 timer running */

  CM_CALL_HOLD_REAS_RLF_NO_RESOURCE,
    /**< call prefs held due to RLF with no resource*/

  CM_CALL_HOLD_REAS_MAX
    /**< @internal */

} cm_call_hold_reas_e_type;
...
typedef struct cmcall_voip_sr_s
{
 ...
 /* whether redial in IMS is allowed again as per IMS reject cause */
  boolean                       is_ims_redial_allowed;
...
typedef struct cm_sr_s
{
  ...
  */
  ...
  dword 					  gpp_cellular_to_wifi_fb_timer;
  /* After this timer expiry if no WWAN system was found, then attempt
	  call over WLAN, if WLAN was available */
#endif
  ...
  */
  ...
  dword                    last_call_delay_evt_sent_timestamp;
  /* Silent redial sequence start uptime
  */

  sd_ss_mode_pref_e_type      remove_mode;
  /* CS RAT mask removed during emergency call redial due to failure.
  */
} cm_sr_s_type;
...
typedef struct
{
  ...
  uint64 last_CCM_started;
  uint64 carry_forward_CCM;
...
typedef struct
{
  ...
  ** This field is not used. This data is stored in the PH sub ptr sub_3gpp2_pref.is_privacy
  */
...
typedef struct
{
  ...
  */
  ...
  /* conference capability of remote party
  ...
  */
  ...
  boolean silent_ui;
  /* Silent ui indicates wether CRS type should get played or not*/

  cm_ip_call_prog_info_notif_s_type   ipcall_prog_info_notif;
...
typedef struct cmcc_object_s
{
  ...
  uint16             tid; /* Tid for CC Object, For supp cmd set to 0 */
...
typedef struct
{
  ...
  cmcall_ssac_sub_info_s_type                  *sub_info[MAX_SIMS];
...
typedef struct cmcall_s
{
  ...
  */
  ...
  /* Id containing sub id and stack id.
  */
  ...
  */
  ...
  boolean                     is_381_for_emergency;
  /* to mark the reorigination on LTE when end cause is 381  */
  ...
  */
  sys_srv_status_e_type        prev_srv_status[MAX_SIMS][MAX_STACKS];
  ...
  */
  boolean                      force_top_pref_bkup;
  /* Store the force_top_pref value here when device enters FULL RAT mode */
  ...
  */
  ...
  uint16                             cc_object_tid;
  /**<
  ** Stores call control object TID for this call
  ** Used to map call_obj in MMGSDI call back
  */

  cm_call_hold_state_e_type          call_hold_state;
  /* Indicates call hold state  if active or local hold*/
  uint32 call_lch_state;
  /* indicates the state of VA for LCH handling None when no response is awaited
  and REQ_SENT when request is sent and response is awaited from Voice agent */
  ...
  */
  ...
  boolean                            is_emerg_on_other_sub;
  boolean                            wait_for_scan_completion;
  /* Indicate if cm is waiting for one round of scan to complet.  This is used for
  ** multisim e911 to consider at least one round of scan before ending the call.
  */
#endif
  ...
  cm_1x_msg_type     msg_type;    /*Marks Message Type from LL*/

  boolean    is_em_vt;

  /* Is PS been actually attempted for E911 call - 
  ** if origination is sent to IMS */
  boolean    is_ps_attempt_done;

  /*Is CS domain attempted for E911 call*/
  boolean    is_emerg_cs_attempted;

  /* If current call attempt is a PS attempt, it will count as PS attempt if
  ** 1.call failed on CS and adding LTE back to find LTE service
  ** 2.After this, UE can acqurie LTE service capable of IMS e911 or CSFB
  **   and call orig should go over either IMS or CSFB.
  */
  boolean    is_emerg_ps_redial_attempt;

  /*remember curent LTE plmn when doing CSFB. in case GW not available send that PLMN to LRRC to avoid camp*/
  sys_plmn_id_s_type  lte_plmn_before_csfb;

  boolean    hold_call;
  /**< This will be true for voice/emergency call when a network search is terminated and voice/emergency call is put on hold for that duration */
  ...
  boolean                            is_progress_info_ind_sent;
  /* Is call progress info ind sent */
#endif

  boolean is_gw_cs_orig_ever_sent;
  /* Is orig ever sent to NAS for GW CS call. This is used to decide if shorten sr is needed */

  boolean                            is_cs_attempted_before_fallback_expiry;
  /* flag to indicate if CS has been attempted even once */
   /* Special Emergency Processing */
  boolean special_emergency;

  boolean is_externally_allocated;
  /* Indicates that a module external to MMODE allocated this call object */

  boolean is_ip_orig_sent;
  /* Indicates that orig was sent to IMS for IP call */

  boolean                            is_wlan_attempted;
  // Flag to check wlan is already attempted once. 

  cmcall_ssac_chk_e_type   ssac_chk_result;
  /* Indicates ssac barring check result for this call */
  
  cm_call_hold_reas_e_type call_hold_reas;
  /* Reason for which call preferences are held */

  cm_call_verstat_s_type mt_call_verstat;
  /* unwanted_robocall_call features */

  boolean               is_call_end_implicit_detach;
  
  boolean speech_codec_info_valid;
  /*Flag to check if speech codec is set or not.*/

  boolean                 is_convert_emerg_wlan;
  ...
  cm_call_type_e_type original_call_type;
  /* Call type at time of origination - VOICE, SMS, E911, etc
  */

  uint8 tir_mode;
  /* To set mode associated with TIR */

  boolean is_lte_srv_no_e911_supp;

  boolean                    is_sip380_std_emc_categ;
  /*indicate if emerg srv category received with 380 response is standard */
...
typedef struct call_secure_info_sub_prop_s
{
  boolean                   is_secure_call;
  cm_call_direction_e_type  direction;
  dword                     mo_secure_uptime;
  boolean                   secure_call_enabled;

} call_secure_info_sub_prop_s_type;

typedef struct call_secure_info_s
{
  call_secure_info_sub_prop_s_type sub_prop[MAX_SIMS];

} call_secure_info_s_type;
...
#define CMCALL_IS_HDR_ORIG_ALLOWED(call_ptr) \
          ( call_ptr->mm_id.stk_id  == MM_STACK_1||   \
            ...
            (call_ptr->mm_id.stk_id  == MM_STACK_0 &&                           \
             !cmph_get_config_hybr_status(call_ptr->mm_id.asubs_id) &&                         \
...
===========================================================================*/
void cmcall_load_orig_plan(cmcall_s_type *call_ptr);
...
FUNCTION cmcall_get_sub_with_emerg_call

DESCRIPTION
  Return the asubs_id on which an emergency call is present.
...
===========================================================================*/
extern sys_modem_as_id_e_type  cmcall_get_sub_with_emerg_call(void);
...
FUNCTION cm_call_id_allocate_new

DESCRIPTION

  Allocate a call Id and get a call object.
  The parameter is_externally_allocated will be TRUE when an external
  module calls cm_call_id_allocate which will then call this API. When CM 
  internally allocates a call id the parameter will be FALSE.

DEPENDENCIES
  cm_init_before_task_start() must have already been called.

RETURN VALUE
  The allocated call id, or CM_CALL_ID_INVALID if allocation was unsuccessful

SIDE EFFECTS

===========================================================================*/
cm_call_id_type cm_call_id_allocate_new
(
  boolean is_externally_allocated
);
...
FUNCTION cmcall_call_ids_allocated_with_type_per_as_id
...
===========================================================================*/
byte cmcall_call_ids_allocated_with_type_per_as_id
(
  sys_modem_as_id_e_type   asubs_id,
  cm_call_type_e_type      call_type
);
...
FUNCTION cmcall_endall_non_emerg_calls_except_gw_ps

DESCRIPTION
  Ends all non-emergency calls, non-gw ps calls
...
===========================================================================*/
void  cmcall_endall_non_emerg_calls_except_gw_ps
(
  cm_call_end_e_type end_reason,
...
FUNCTION cmcall_endall_non_emerg_calls_per_subs_except_vowifi_gw_ps
...
===========================================================================*/
void  cmcall_endall_non_emerg_calls_per_subs_except_vowifi_gw_ps
(
  cm_call_end_e_type end_reason,
...
FUNCTION cmcall_get_sd_ok_to_orig_mode
  Gets ok to orig mode sent by SD.
...
===========================================================================*/
sd_mode_e_type cmcall_get_sd_ok_to_orig_mode(void);

/*===========================================================================

FUNCTION cmcall_clean_cs_call_from_q

DESCRIPTION
  Delete all the objects that no call id is allocated.
...
===========================================================================*/
void  cmcall_clean_cs_call_from_q(
  sys_modem_as_id_e_type     asubs_id
);
...
/*===========================================================================
FUNCTION  cmcall_post_cs_failure_plmn_avoid_or_block

DESCRIPTION
Handle PLMN blocking and adding to avoid list during cs to ps redial

===========================================================================*/
void  cmcall_post_cs_failure_plmn_avoid_or_block(
  cmcall_s_type        *call_ptr
);

/*===========================================================================

FUNCTION cmcall_set_lte_plmn_before_csfb_no_vops()

DESCRIPTION
  Function to set lte plmn before csfb.

RETURN VALUE
  None.

===========================================================================*/
void cmcall_set_lte_plmn_before_csfb_no_vops(
  cmcall_s_type           *call_ptr
);
/*===========================================================================

FUNCTION cmcall_is_psap_callback_possible_on_lte
...
===========================================================================*/
boolean  cmcall_is_psap_callback_possible_on_lte(
  mm_sub_stk_id_s_type mm_id
);

/*===========================================================================

FUNCTION cmcall_set_lte_plmn_before_csfb_for_ims_state_deregistered()
...
===========================================================================*/
void cmcall_set_lte_plmn_before_csfb_for_ims_state_deregistered(
  cmcall_s_type           *call_ptr,
...
FUNCTION  cmcall_cleanup_gw_ps_call_locally
DESCRIPTION
  Ends GW PS calls locally
...
===========================================================================*/
void  cmcall_cleanup_gw_ps_call_locally(sys_modem_as_id_e_type subs_id,cm_call_end_e_type end_reason);
...
===========================================================================*/
extern multimode_stack_e_type cmcall_determine_stk_for_origination(
  cm_mode_pref_e_type    mode_pref,
...
FUNCTION cmcall_is_there_a_call_type_no_call_id_per_sub
...
===========================================================================*/
extern cm_call_id_type cmcall_is_there_a_call_type_no_call_id_per_sub
(
  sys_modem_as_id_e_type   asubs_id,
...
FUNCTION cmcall_is_there_a_call_type_per_device
...
===========================================================================*/
cm_call_id_type cmcall_is_there_a_call_type_per_device
(
  cm_call_type_e_type call_type
);
...
FUNCTION cmcall_is_there_cellular_call_per_device
...
===========================================================================*/
cm_call_id_type cmcall_is_there_cellular_call_per_device
(
...
FUNCTION cmcall_is_there_a_cellular_call_type_per_sub

DESCRIPTION
  Checks is there is a requested call type.on the specified sub
  which is not a WLAN call
...
===========================================================================*/
cm_call_id_type cmcall_is_there_a_cellular_call_type_per_sub
(
  sys_modem_as_id_e_type       asubs_id,
  cm_call_type_e_type          call_type,
  multimode_stack_e_type      *stack_id
...
(
  sys_modem_as_id_e_type       asubs_id,
  /* Subscription on which the call was originated/ended */
...
(
  ...
  uint64                      call_type_mask,
  /* Call types to search */
  boolean ignore_idle_calls
);

/*===========================================================================

FUNCTION cmcall_is_there_a_voice_call_except_volte_vowlan

DESCRIPTION
  Checks is there is a voice call except volte/vowlan
...
===========================================================================*/
extern cm_call_id_type cmcall_is_there_a_voice_call_except_volte_vowlan
(
  sys_modem_as_id_e_type  as_id,
  cm_call_id_type         ignore_call_id
);
...
===========================================================================*/
extern cm_call_id_type cmcall_is_there_a_call_type_no_call_id_per_device
(
...
/*===========================================================================
FUNCTION cmcall_is_there_cs_activity

DESCRIPTION
  Checks if there is any cs activity (voice/emergency/ECBM/CS_DATA/SMS call)
  in UE.
...
===========================================================================*/
boolean cmcall_is_there_cs_activity
(
  sys_modem_as_id_e_type   asubs_id
);

/*===========================================================================
FUNCTION cmcall_is_there_a_1x_ps_data_call

DESCRIPTION
  Checks if there is 1x PS DATA call in UE.
...
===========================================================================*/
boolean cmcall_is_there_a_1x_ps_data_call
(
  sys_modem_as_id_e_type   asubs_id
);
...
FUNCTION cmcall_find_active_cs_call_per_sub
...
===========================================================================*/
extern cm_call_id_type cmcall_find_active_cs_call_per_sub(
...
FUNCTION  cmcall_check_if_fop_needed_for_ss

DESCRIPTION
  Checks if there is a call of the given type and in the given state
  per stack and if orig_sent_on_mode is NONE.

  FOP Follow on proced bit set by NAS based on cs_for_req and ps_for_req
...
extern boolean cmcall_check_if_fop_needed_ss (
...
===========================================================================*/
extern boolean cmcall_is_hybr_hdr_call (
  cm_call_id_type *call_id_ptr,
  sys_modem_as_id_e_type  asubs_id
);
...
===========================================================================*/
extern cmcall_s_type *cmcall_is_hybr_hdr_orig (
  sys_modem_as_id_e_type  asubs_id
);
...
FUNCTION cmcall_is_there_active_ppcsfb_call_per_sub

DESCRIPTION
  Checks is there is a  requested Active CSFB call type.
...
===========================================================================*/
cm_call_id_type cmcall_is_there_active_ppcsfb_call_per_sub
(
  sys_modem_as_id_e_type  asubs_id,
...
FUNCTION cmcall_fill_connected_call_status_per_sub

DESCRIPTION
  Fill connected call information in call_info_ptr passed as parameter
  ignore_call_id will be ignored while filling the info
...
===========================================================================*/
void cmcall_fill_connected_call_status_per_sub(
  cm_mm_call_info_s_type   *call_info_ptr,
  /* Copy call state info into this buffer */
...
DESCRIPTION
  Check if there are any calls in the specified call_mode
...
===========================================================================*/
boolean  cmcall_call_mode_per_sub (
...
===========================================================================*/
extern boolean cmcall_check_if_no_srv(
  sys_modem_as_id_e_type  asubs_id,
  boolean check_hdr
);
...
===========================================================================*/
extern multimode_stack_e_type cmcall_det_ss_from_sys_mode(
...
===========================================================================*/
extern cm_call_id_type cmcall_get_voip_call_id( sys_modem_as_id_e_type  asubs_id );
...
===========================================================================*/
extern boolean cmcall_end_active_1x_datacalls_no_force(cm_call_end_e_type end_cause);
...
extern boolean cmcall_end_active_1x_datacalls (sys_modem_as_id_e_type asubs_id,
    boolean is_force);
...
extern boolean cmcall_end_active_HDR_datacalls (cm_call_end_e_type   end_status);

/*===========================================================================

FUNCTION  cmcall_end_active_data_calls_remove_orig_end

DESCRIPTION
 Ends all active data calls then remove orig end from priority queue
...
===========================================================================*/
extern void cmcall_end_active_data_calls_remove_orig_end (void);
...
FUNCTION cmcall_is_ip_call_originated

DESCRIPTION
  Check whether an orig is sent for VOLTE/IP call
...
===========================================================================*/
cm_call_id_type cmcall_is_ip_call_originated(void);
...
DESCRIPTION
  Checks if there is a VOLTE call on a particular sub

DEPENDENCIES
  None

RETURN VALUE
  Valid call id if there is a VOLTE call, CM_CALL_ID_INVALID otherwise
...
FUNCTION cmcall_is_there_volte_call_sub_ignore
...
===========================================================================*/
cm_call_id_type cmcall_is_there_volte_call_sub_ignore(
  sys_modem_as_id_e_type  as_id,
  cm_call_id_type         ignore_call_id
    /* skip this call id while checking */
);
...
===========================================================================*/
cm_call_id_type cmcall_is_there_vowlan_call(void);

/*===========================================================================

FUNCTION cmcall_is_there_vowlan_call_sub

DESCRIPTION
  Checks is there is a requested VOWLAN call type per sub
...
===========================================================================*/
cm_call_id_type cmcall_is_there_vowlan_call_sub(
  sys_modem_as_id_e_type  as_id
);
...
FUNCTION cmcall_is_there_volte_call_obj_per_sub
...
===========================================================================*/
cm_call_id_type cmcall_is_there_volte_call_obj_per_sub
(
  cm_call_type_mask_type         call_type_mask,
  /* Call type to search */
...
FUNCTION cmcall_is_there_volte_call_obj_per_device
...
===========================================================================*/
cm_call_id_type cmcall_is_there_volte_call_obj_per_device
(
  cm_call_type_mask_type         call_type_mask
  /* Call type to search */
);
...
FUNCTION cmcall_is_there_call_on_hold_per_sub

DESCRIPTION
  Function used to determine if there is a call whose preferences are buffered
...
===========================================================================*/
extern cm_call_id_type cmcall_is_there_call_on_hold_per_sub
	(
	  cm_call_type_mask_type		 call_type_mask,
	  /* Call type to search */
	  ...
	  boolean                        skip_hold_call_chk,
	
	  cm_call_hold_reas_e_type      hold_reas
	);


/*===========================================================================

FUNCTION cmcall_is_hold_call_prefs

DESCRIPTION
  Buffer call prefs if
  1.call originated during ongoin manual search, wait for terminate
  2.if IMS voice/vt call originated when SRLTE->CSFB happened and hold hy2
    timer is runining . Wait for LTE full service to be reported or timer expiry
  3.If IMS voice/vt call originated but current sub is in RLF due to no TRM
...
===========================================================================*/
extern boolean cmcall_is_hold_call_prefs (
  cmcall_s_type    *call_ptr
);
...
FUNCTION cmcall_find_active_voice_call_except_wlan

DESCRIPTION
  Checks is there is active non vowlan voice call
...
===========================================================================*/
cm_call_id_type cmcall_find_active_voice_call_except_wlan(void);
...
FUNCTION cmcall_find_active_voice_call_per_sub
...
===========================================================================*/
cm_call_id_type cmcall_find_active_voice_call_per_sub(
...
FUNCTION cmcall_find_active_sms_call_per_sub
...
===========================================================================*/
cm_call_id_type cmcall_find_active_sms_call_per_sub(
  sys_modem_as_id_e_type         asubs_id
);

/*===========================================================================

FUNCTION cmcall_find_active_cs_data_call_per_sub
...
===========================================================================*/
cm_call_id_type cmcall_find_active_cs_data_call_per_sub(
  sys_modem_as_id_e_type         asubs_id
);
...
===========================================================================*/
void cmcall_ssac_process_srv_update(
  sys_modem_as_id_e_type  asubs_id
);
...
===========================================================================*/
void cmcall_end_stale_gw_ps_calls(mm_sub_stk_id_s_type  mm_id);
...
===========================================================================*/
boolean cmcall_is_esr_allowed_in_hvolte(
  sys_modem_as_id_e_type asubs_id
);
...
extern void cmcall_ssac_delay_timer_cb(unsigned long asubs_id);


/*===========================================================================
FUNCTION cmcall_ssac_sub_info_ptr
...
extern cmcall_ssac_sub_info_s_type  *cmcall_ssac_sub_info_ptr(
  sys_modem_as_id_e_type asubs_id
);

/*===========================================================================
FUNCTION cmcall_ssac_sub_info_mem_free

DESCRIPTION
  clean call ssac sub info based on asubs_id
...
===========================================================================*/
extern void cmcall_ssac_sub_info_mem_free(
  sys_modem_as_id_e_type asubs_id
);
...
FUNCTION cmcall_end_pre_alert_mt_volte_call

DESCRIPTION
  Send VOLTE call end request to IMS for pending MT VOLTE calls
...
===========================================================================*/
void  cmcall_end_pre_alert_mt_volte_call(
  mm_sub_stk_id_s_type  mm_id
);
...
===========================================================================*/
void cmcall_recalculate_csfb_type(
  mm_sub_stk_id_s_type   mm_id
);
...
===========================================================================*/
multimode_stack_e_type cmcall_det_ss_for_volte_call(
...
FUNCTION cmcall_secure_info_ptr

DESCRIPTION
  Fetches the secure call info
...
===========================================================================*/
extern call_secure_info_s_type *cmcall_secure_info_ptr(void);

/*===========================================================================

FUNCTION cmcall_secure_info_sub_prop_ptr

DESCRIPTION

  Return a pointer to get call secure sub prop
...
RETURN VALUE
  ...
  Pointer to call_secure_info

SIDE EFFECTS
  None

===========================================================================*/
extern call_secure_info_sub_prop_s_type *cmcall_secure_info_sub_prop_ptr(
  sys_modem_as_id_e_type  asubs_id
);
...
FUNCTION cmcall_generic_rpt_proc

DESCRIPTION
  Process Generic reports in cmcall
...
/*===========================================================================
FUNCTION cmcall_check_and_send_call_end_to_va

DESCRIPTION
   Check if this call end is last voice call to be ended on given sub.
   If yes the send call end indication to Voice agent
...
===========================================================================*/
void cmcall_check_and_send_call_end_to_va(
  cmcall_s_type    *call_ptr);

/*===========================================================================

FUNCTION cmcall_send_high_prio_activity_ind
...
void cmcall_send_high_prio_activity_ind (
  /* call pointer */
  cmcall_s_type  *call_ptr,
...
/*===========================================================================
FUNCTION cmcall_unforce_call_end_pref_immediately
...
===========================================================================*/
void cmcall_unforce_call_end_pref_immediately(
...
boolean cmcall_process_cs_to_ps_redial(
  ...
  boolean is_multiple_ps_attempt_valid
);
...
FUNCTION cmcall_unforce_and_resume_other_sub

DESCRIPTION
  Unforces emergency call preferences and resumes other sub
  if other sub is suspended due to emergency call
...
void cmcall_unforce_and_resume_other_sub(
  mm_sub_stk_id_s_type          mm_id,
  cm_call_id_type               call_id
);
#endif
...
FUNCTION cmcall_unforce_call_end_pending_policy
...
===========================================================================*/
void cmcall_unforce_call_end_pending_policy(
  mm_sub_stk_id_s_type          mm_id,
  cm_call_id_type               call_id
);
...
FUNCTION cmcall_get_e911_call_mode_per_sim_status

DESCRIPTION
   If SIM is not available get latest call mode from PM per pLMN else from PMPRX
...
===========================================================================*/
void cmcall_get_e911_call_mode_per_sim_status(sys_modem_as_id_e_type     asubs_id,
...
FUNCTION cmcall_update_voice_call_status_to_ll

DESCRIPTION
  This function updates the voice call status on asubs_id to L via message
  router interface
...
===========================================================================*/
void cmcall_update_voice_call_status_to_ll(
  cm_voice_call_status_e_type status,
  /* voice call status */
...
FUNCTION cmcall_update_speech_codec_info

DESCRIPTION
Indicates
1. If a Voice or Emergency call is active
2. Call info_type is GW_CS and
3. Call origination is already sent to Protocols (NAS)
4. Update speech codec info for all GW CS call with speech_codec_info_value != TRUE.
...
===========================================================================*/
void cmcall_update_speech_codec_info
(
  sys_modem_as_id_e_type  asubs_id
);
...
FUNCTION cmcall_update_speech_codec_info_for_gw_cs_calls

DESCRIPTION
Indicates
1. If a Voice or Emergency call is active
2. Call info_type is either GW_CS and
3. Update speech codec info for all GW CS calls.
...
===========================================================================*/
void cmcall_update_speech_codec_info_for_gw_cs_calls
(
...
FUNCTION cmcall_is_active_audio_call_per_sub_except_wlan

DESCRIPTION
  Checks is there is active voice/emergency/VT call/VS call

DEPENDENCIES
  None

RETURN VALUE
  TRUE , if there is such call
  FALSE, otherwise
...
===========================================================================*/
boolean cmcall_is_active_audio_call_per_sub_except_wlan( sys_modem_as_id_e_type         asubs_id);

/*===========================================================================

FUNCTION cmcall_is_active_audio_call_per_sub

DESCRIPTION
  Checks is there is active voice/wlan/emergency/VT call/VS call
...
===========================================================================*/
boolean cmcall_is_active_audio_call_per_sub( sys_modem_as_id_e_type         asubs_id);

/*===========================================================================

FUNCTION cmcall_is_active_audio_call_per_sub_ext

DESCRIPTION
  Checks is there is active voice/wlan/emergency/VT call/VS call/3rd Party call
...
===========================================================================*/
boolean cmcall_is_active_audio_call_per_sub_ext( sys_modem_as_id_e_type asubs_id);

/*===========================================================================

FUNCTION cmcall_is_present_cellular_ip_call_per_sub
...
===========================================================================*/
boolean cmcall_is_present_cellular_ip_call_per_sub(sys_modem_as_id_e_type asubs_id);


/*===========================================================================

FUNCTION cmcall_get_vocoder_needed_on_call

DESCRIPTION
  This function indicates wthether vocoder service is needed or not

DEPENDENCIES
  none

RETURN VALUE
  Returns TRUE if call_type needs voice services, otherwise returns FALSE.

SIDE EFFECTS
  none

===========================================================================*/
boolean cmcall_get_vocoder_needed_on_call(
  cm_call_type_e_type           call_type
  /* call type */
...
===========================================================================*/
sys_sys_mode_e_type cmcall_is_ipcall_possible(
...
FUNCTION cmcall_set_force_pref_flag_false

DESCRIPTION
  Set the force_pref flags of all ongoing calls to FALSE when sub enters FULL
  RAT mode.
...
===========================================================================*/
void cmcall_set_force_pref_flag_false(
...
FUNCTION cmcall_fetch_call_id_by_call_state_call_type

DESCRIPTION
 This function fetches the call_id by the call_state and call_type provided
 in the function  .
...
===========================================================================*/
cm_call_id_type cmcall_fetch_call_id_by_call_state_call_type(
    cm_call_state_e_type               call_state,
	uint8                              call_subst,
	cm_call_type_mask_type             call_type_mask
);
...
FUNCTION cmcall_restore_force_pref_flag

DESCRIPTION
  Reset the force_pref flags of all ongoing calls to original values when sub
  exits FULL RAT mode.
...
===========================================================================*/
void cmcall_restore_force_pref_flag(
...
FUNCTION cmcall_find_and_end_1x_datacalls

DESCRIPTION
  Check and end 1x data call on the specified sub.

DEPENDENCIES
  none

RETURN VALUE
  Boolean indicating if a 1x data call is ended.

SIDE EFFECTS
  none

===========================================================================*/
boolean cmcall_find_and_end_1x_datacalls(
  sys_modem_as_id_e_type  asubs_id
);
#endif
...
FUNCTION cmcall_is_last_voice_call_ending

DESCRIPTION
  Checks if currently there is just one voice call left in IDLE state when
  forcing new preferences due to that call ending.

DEPENDENCIES
  None

RETURN VALUE
  TRUE , if this is the last voice call ending
  FALSE, otherwise
...
===========================================================================*/
boolean cmcall_is_last_voice_call_ending
(
  cm_call_id_type                   call_id
  /* Call ID to search */
);
...
FUNCTION cmcall_is_there_volte_call_stack2

DESCRIPTION
  Checks is there is a VOLTE call on stack 2.

DEPENDENCIES
  None

RETURN VALUE
  TRUE if there is volte call on stack 2, FALSE otherwise

SIDE EFFECTS
  none

===========================================================================*/
boolean cmcall_is_there_volte_call_stack2
(
  sys_modem_as_id_e_type as_id
);
...
FUNCTION cmcall_reset_call_sr

DESCRIPTION
  Process cases where call was held and reset hold flag acc. to hold reason
  1.either SRV CNF/SRV IND for PPCSFB calls
  2.or LTE service acq/hold_hy2 timer expiry for IMS calls
...
===========================================================================*/
extern void cmcall_reset_call_sr (
  sys_modem_as_id_e_type   asubs_id,
  cm_call_hold_reas_e_type  hold_reas 
);

/*===========================================================================
FUNCTION cmcall_is_cross_sub_concurrency_allowed

DESCRIPTION
  Checks if the current call should be allowed based on the call activity on the other sub
...
===========================================================================*/
boolean cmcall_is_cross_sub_concurrency_allowed(
  cm_call_type_e_type     call_type,
    /* call type of the call which is being checked */

  sys_modem_as_id_e_type  asubs_id,
    /* sub of the call which is being checked */

  boolean                 is_1x_data
    /* TRUE if the call call which is being checked is a 1x/HDR PS data call */
);

/*===========================================================================
FUNCTION cmcall_cmd_proc_data_activity

DESCRIPTION
  add/remove PS based on data_activity
...
===========================================================================*/
void cmcall_cmd_proc_data_activity(cm_call_cmd_s_type   *call_cmd_ptr);
...
/*===========================================================================
FUNCTION get_cm_call_obj_array

DESCRIPTION
   Return address of first element of array 
...
===========================================================================*/
cmcall_s_type** get_cm_call_obj_array(void);

/*===========================================================================

FUNCTION cmcall_barr_due_to_ue_based_cb_enabled

DESCRIPTION
Checks if ue_based call barring is enabled and barr calls accordingly

DEPENDENCIES

RETURN VALUE
  True if call is barred
...
extern boolean cmcall_barr_due_to_ue_based_cb_enabled(cmcall_s_type  *call_ptr);

/*===========================================================================

FUNCTION cmcall_is_there_a_cs_voice_call

DESCRIPTION
  Checks is there is a voice call except vops/vowlan
...
===========================================================================*/
extern cm_call_id_type cmcall_is_there_a_cs_voice_call
(
  sys_modem_as_id_e_type  as_id,
  cm_call_id_type         ignore_call_id
);
...
FUNCTION cmcall_msim_is_cross_sub_concurrency_forbidden

DESCRIPTION
  Checks if the current call should be allowed based on the call activity
  on the other sub
...
RETURN VALUE
  TRUE if call should be forbidden

SIDE EFFECTS
  none

===========================================================================*/
boolean cmcall_msim_is_cross_sub_concurrency_forbidden(
  const cmcall_s_type          *call_ptr,
    /* call which needs to be checked */

  boolean                 is_1x_data
    /* TRUE if the call which is being checked is a 1x/HDR PS data call */
);

/*===========================================================================

FUNCTION cmcall_emg_check_and_block_lte_plmn

DESCRIPTION
  This function will check and block the LTE
  PLMN if e911 call is not supported over IMS and CS domain.
  
RETURN VALUE
  None

===========================================================================*/
void cmcall_emg_check_and_block_lte_plmn(
  cmcall_s_type          *call_ptr,
  mm_sub_stk_id_s_type    mm_id,
  boolean                 ext_ims,
...
FUNCTION cmcall_get_emerg_call_id

DESCRIPTION
  Return the call id of the existing emergency call, if present
  Else, return invalid call id
...
===========================================================================*/
extern cm_call_id_type cmcall_get_emerg_call_id(sys_modem_as_id_e_type  asubs_id);
...
FUNCTION cmcall_emg_avoid_plmn_clear

DESCRIPTION
  Upon call end for emergency call, clear avoid plmn list if it was avoided earlier and 
  reset plmn blocking during the emergency call.

RETURN VALUE
  none

===========================================================================*/
void  cmcall_emg_avoid_plmn_clear(
  sys_modem_as_id_e_type   asubs_id,
  boolean                  int_ims,
  boolean                  check_ecbm
);
