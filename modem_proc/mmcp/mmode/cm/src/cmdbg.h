...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmdbg.h#2 $
...
typedef struct cm_ph_cmd_subs_xx_entry_s
{
  ...
  uint8                                current_active_subs;
  sys_modem_dual_standby_pref_e_type   current_user_standby_pref;
  sys_modem_dual_standby_pref_e_type               current_internal_standby_pref;
  uint8                                refresh_sub_mask;
...
typedef struct cm_ph_cmd_ds_pref_chgd_entry_s
{
  ...
  uint8                                current_active_subs;
  sys_modem_dual_standby_pref_e_type   current_user_standby_pref;
  sys_modem_as_id_e_type               current_default_data_subs;
  sys_modem_dual_standby_pref_e_type               current_internal_standby_pref;
  uint8                                refresh_sub_mask;
  boolean                              is_standby_pref_buffered;
...
// CM_ACQ_FAIL_F
typedef struct cm_rpt_stack_entry_s
{
  sys_modem_as_id_e_type  as_id;
  multimode_stack_e_type stack_id;
} cm_rpt_stack_entry_s_type;
...
typedef struct cm_pm_policy_chg_entry_s
{
  ...
  uint32                       current_ratcap[MAX_SIMS];
  uint32                       ratcap[MAX_SIMS];
  uint32                       current_maxcap[MAX_SIMS];
  uint32                       maxcap[MAX_SIMS];
  policy_change_mask           policy_changes[MAX_SIMS];
...
typedef struct cm_mmoc_prot_gen_cmd_entry_s
{
  ...
  sd_ss_mode_pref_e_type               stack_mode_cap;
  cm_mode_pref_e_type                  ph_mode_pref;
  cm_mode_pref_e_type                  prst_ph_mode_pref;
...
typedef struct cmdbg_subs_data_s
{
  ...
  /* 3GPP preferences */
  mmgsdi_session_type_enum_type   gpp_session_type;
  sd_ss_srv_domain_pref_e_type    srv_domain_pref;

  /* 3GPP2 preferences */
  mmgsdi_session_type_enum_type   gpp2_session_type;
  sd_ss_hybr_pref_e_type          hybr_pref;
...
typedef struct cm_mmoc_subsc_chgd_cmd_entry_s
{
  ...
  cmdbg_subs_data_s_type               subs1_data;
  cmdbg_subs_data_s_type               subs2_data;
  cmdbg_subs_data_s_type               subs3_data;
} cm_mmoc_subsc_chgd_cmd_entry_s_type;

// MMOC_CMD_DUAL_STANDBY_CHGD
typedef struct cm_mmoc_dual_standby_cmd_entry_s
{
  sys_modem_dual_standby_pref_e_type   standby_pref;
  uint8                                active_subs;
  sys_modem_device_mode_e_type         device_mode;
  boolean                              is_mcfg_deact;
  uint8                                current_active_subs;
  sys_modem_dual_standby_pref_e_type               current_internal_standby_pref;
  uint8                                refresh_sub_mask;
  boolean                              is_standby_pref_buffered;
} cm_mmoc_dual_standby_cmd_entry_s_type;

// mmoc_cmd_oprt_mode_chgd
typedef struct cm_mmoc_oprt_mode_cmd_entry_s
{
  sys_oprt_mode_e_type                 cmd_oprt_mode;
  sys_oprt_mode_e_type                 current_oprt_mode;
} cm_mmoc_oprt_mode_cmd_entry_s_type;
...
===========================================================================*/
void cmdbg_welcome_new_entry(void);
...
===========================================================================*/
uint8 cmdbg_get_unique_idx(void);
#endif
