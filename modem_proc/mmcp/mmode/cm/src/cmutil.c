...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/mmode/cm/src/cmutil.c#3 $
...
typedef enum
{
  CMUTIL_CONVERSION_SUCCESS = 0,
  CMUTIL_TARGET_EXHAUSTED = 1,
  CMUTIL_SOURCE_EXHAUSTED = 2,
  CMUTIL_SOURCE_ILLEGAL
}cm_util_conversion_result_e_type;
...
static const struct country_record_s   country_list_1 [] =
{
  /*Country code, mcc, IDD */

  {7, 289 , "00"},  /*Abkhazia*/
  {93, 412, "00"},  /*Afghanistan*/
  {355,276, "00"},  /*Albania*/
  {213,603, "00"},  /*Algeria*/
  {684,544, "011"}, /*American Samoa*/
  {376,213, "00"},  /* Andorra*/
  {244,631, "00"},  /*Angola*/
  {1264,365, "011"},/*Anguilla*/
  {1268,344, "011"},/*Antigua and Barbuda*/
  {54,722, "00"},   /*Argentina Republic*/
  {374,283, "00"},  /*Armenia*/
  {297,363, "00"},  /*Aruba*/
  {61,505, "0011"}, /*Australia*/
  {43,232, "00"},   /*Austria*/
  {994,400, "810"}, /*Azerbaijan*/
  
  {1242,364, "011"},/*Bahamas*/
  {973,426, "00"},  /*Bahrain*/
  {880,470, "00"},  /*Bangladesh*/
  {1246,342, "011"},/*Barbados*/
  {375,257, "810"},  /*Belarus*/
  {32,206, "00"},   /*Belgium*/
  {501,702, "00"},  /*Belize*/
  {229,616, "00"},  /*Benin*/
  {1441,350, "011"}, /*Bermuda*/
  {975,402, "00"},  /*Bhutan*/
  {591,736, "0010"},  /*Bolivia*/
  {387,218, "00"},  /*Bosnia*/
  {267,652, "00"},  /*Botswana*/
  {55,724, "0014"},   /*Brazil*/
  {284,348, "00"},  /*British Virgin Islands*/
  {673,528, "00"},  /*Brunei Darussalam*/
  {359,284, "00"},  /*Bulgaria*/
  {226,613, "00"},  /*Burkina Faso*/
  {257,642, "00"},  /*Burundi*/
  
  {855,456, "00"},  /*Cambodia*/
  {237,624, "00"},  /*Cameroon*/
  {1,302, "011"},    /*Canada*/
  {238,625, "00"},  /*Cape Verde*/
  {1345,346, "011"}, /*Cayman Islands*/
  {236,623, "00"},  /*Central African Republic*/
  {235,622, "15"},  /*Chad*/
  {56,730, "00"},   /*Chile*/
  {86,460, "00"},   /*China*/
  {57,732, "05"},   /*Colombia*/
  {269,654, "00"},  /*Comoros*/
  {243,630, "00"},  /*Congo Dem Republic*/
  {682,548, "00"},  /*Cook Islands*/
  {506,712, "00"},  /*Costa Rica*/
  {385,219, "00"},  /*Croatia*/
  {53,368, "119"},   /*Cuba*/
  {599,362, "00"},  /*Curacao*/
  {357,280, "00"},  /*Cyprus*/
  {420,230, "00"},  /*Czech Republic*/
  
  {45,238, "00"},   /*Denmark*/
  {253,638, "00"},  /*Djibouti*/
  {1767,366, "011"}, /*Dominica*/
  {1809,370, "011"}, /*Dominican Republic*/
  
  {593,740, "00"},  /*Ecuador*/
  {20,602, "00"},   /*Egypt*/
  {503,706, "00"},  /*El Salvador*/
  {240,706, "00"},  /*Equatorial Guinea*/
  {291,657, "00"},  /*Eritrea*/
  {372,248, "00"},  /*Estonia*/
  {251,636, "00"},  /*Ethiopia*/
  
  {500,750, "00"},  /*Falkland Islands*/
  {298,288, "00"},  /*Faroe Islands*/
  {679,542, "00"},  /*Fiji*/
  {358,244, "00"},  /*Finland*/
  {33,208, "00"},   /*France*/
  {594,340, "00"},  /*French Guiana*/
  {689,547, "00"},  /*French Polynesia*/
  ...
  {49,262, "00"},   /*Germany*/
  {233,620, "00"},  /*Ghana*/
  {350,266, "00"},  /*Gibralter*/
  {30,202, "00"},   /*Greece*/
  {299,290, "009"},  /*Greenland*/
  {1473,352, "011"}, /*Grenada*/
  {590,340, "00"},  /*Guadeloupe*/
  {1671,311, "011"}, /*Guam*/
  {502,704, "00"},  /*Guatemala*/
  {224,611, "00"},  /*Guinea*/
  {245,632, "00"},  /*Guinea Bissau*/
  {592,738, "00"},  /*Guyana*/
  
  {509,372, "00"},  /*Haiti*/
  {504,708, "00"},  /*Honduras*/
  {852,454, "001"},  /*Hongkong*/
  {36,216, "00"},   /*Hungary*/
  
  {354,274, "00"},  /*Iceland*/
  {91,404, "00"},   /*India*/
  {62,510, "001"},   /*Indonesia*/
  {882,901, "00"},  /*International Networks*/
  {98,432, "00"},   /*Iran*/
  {964,418, "00"},  /*Iraq*/
  {353,272, "00"},  /*Ireland*/
  {972,425, "00"},  /*Israel*/
  {39,222, "00"},   /*Italy*/
  {225,612, "00"},  /*Ivory Coast*/
  
  {1876,338, "011"}, /*Jamaica*/
  {81,440, "010"},   /*Japan*/
  {962,416, "00"},  /*Jordan*/
  
  {7,401, "810"},    /*Kazakhstan*/
  {254,639, "000"},  /*Kenya*/
  {686,545, "00"},  /*Kiribati*/
  {850,467, "00"},  /*Korea N*/
  {82,450, "001"},   /*Korea S*/
  {965,419, "00"},  /*Kuwait*/
  {996,437, "00"},  /*Kyrgzstan*/
  ...
  {231,618, "00"},  /*Liberia*/
  {218,606, "00"},  /*Libya*/
  {423,295, "00"},  /*Liechtenstein*/
  {370,295, "00"},  /*Lithuania*/
  {352,270, "00"},  /*Luxemburg*/
  
  {853,455, "00"},  /*Macao*/
  {389,294, "00"},  /*Macedonia*/
  {261,646, "00"},  /*Madagascar*/
  {265,650, "00"},  /*Malawi*/
  {60,502, "00"},   /*Malaysia*/
  {960,472, "00"},  /*Maldives*/
  {223,610, "00"},  /*Mali*/
  {356,278, "00"},  /*Malta*/
  {596,340, "00"},  /*Martinique*/
  {222,609, "020"},  /*Mauritius*/
  {52,334, "00"},   /*Mexico*/
  {691,550, "011"},  /*Micronesia*/
  {373,259, "00"},  /*Moldova*/
  {377,212, "00"},  /*Monaco*/
  {976,428, "001"},  /*Mongolia*/
  {382,297, "99"},  /*Montenegro*/
  {1664,354, "011"}, /*Montserrat*/
  {212,604, "00"},  /*Morocco*/
  {258,643, "00"},  /*Mozambique*/
  {95,414, "00"},   /*Myanmar*/
  
  {264,649, "00"},  /*Namibia*/
  {977,429, "00"},  /*Nepal*/
  {31,204, "00"},   /*Netherlands*/
  {599,362, "00"},  /*Netherlands Antilles*/
  {687,546, "00"},  /*New Caledonia*/
  {64,530, "00"},   /*New Zealand*/
  {505,710, "00"},  /*Nicargua*/
  {227,614, "00"},  /*Niger*/
  {234,621, "009"},  /*Nigeria*/
  {47,242, "00"},   /*Norway*/  
  ...
  {92,410, "00"},   /*Pakistan*/
  {680,552, "00"},  /*Palau*/
  {970,425, "00"},  /*Palestinian*/
  {507,714, "00"},  /*Panama*/
  {675,537, "05"},  /*Papua New Guinea*/
  {595,744, "002"},  /*Paraguay*/
  {51,716, "00"},   /*Peru*/
  {63,515, "00"},   /*Phillippines*/
  {48,260, "00"},   /*Poland*/
  {351,268, "00"},  /*Portugal*/
  {1,330, "011"},    /*Puerto Rico*/
  ...
  {1869,356, "011"}, /*Saint Kitts and Nevis*/
  {1758,358, "011"}, /*Saint Lucia*/
  {1685,549, "011"}, /*Samoa*/
  {378,292, "00"},  /*San Marino*/
  {239,626, "00"},  /*Sao Tome & Principe*/
  {870,901, "00"},  /*Satellite Networks*/
  {966,420, "00"},  /*Saudi Arabia*/
  {221,608, "00"},  /*Senegal*/
  {381,220, "99"},  /*Serbia*/
  {248,633, "00"},  /*Seychelles*/
  {232,619, "00"},  /*Sierra Leone*/
  {65,525, "001"},   /*Singapore*/
  {421,231, "00"},  /*Slovakia*/
  {386,293, "00"},  /*Slovenia*/
  {677,540, "00"},  /*Soloman Islands*/
  {252,637, "00"},  /*Somalia*/
  {27,655, "09"},   /*South Africa*/
  {34,214, "00"},   /*Spain*/
  {94,413, "00"},   /*Sri Lanka*/
  {508,308, "00"},  /*St. Pierre & Miquelon*/
  {1784,360, "011"}, /*St. Vincent & Gren*/
  {249,634, "00"},  /*Sudan*/
  {597,746, "00"},  /*Suriname*/
  {268,653, "00"},  /*Swaziland*/
  {46,240, "00"},   /*Sweden*/
  {41,228, "00"},   /*Switzerland*/
  {963,417, "00"},  /*Syrian Arab Republic*/
  
  {886,466, "002"},  /*Taiwan*/
  {992,436, "810"},  /*Tajikstan*/
  {255,640, "00"},  /*Tanzania*/
  {66,520, "001"},   /*Thailand*/
  {670,514, "00"},  /*Timor-Leste*/
  {228,615, "00"},  /*Togo*/
  {676,539, "00"},  /*Tonga*/
  {1868,374, "011"}, /*Trinidad and Tobago*/
  {216,605, "00"},  /*Tunisia*/
  {90,286, "00"},   /*Turkey*/
  {993,438, "810"},  /*Turkmenistan*/
  ...
  {1,310, "011"},    /*US*/
  {598,748, "00"},  /*Uruguay*/
  {998,434, "810"},  /*Uzbekistan*/
  
  {678,541, "00"},  /*Vanautu*/
  {58,734, "00"},   /*Venezuela*/
  {84,452, "00"},   /*Viet Nam*/
  {1340,376, "011"}, /*Virgin Islands*/
  {967,421, "011"},  /*Yemen*/
...
static boolean cmutil_resolve_curr_mcc (
  ...
  sys_plmn_mcc_list *ret_curr_mcc
  ...
  */
  ...
  if (is_sid_cnflct)
  {
    ...
    */
    ...
    {
      ret_curr_mcc->count = 1;
      ret_curr_mcc->mcc_list[0] = found_mcc;
  ...
  else
  {
         ...
         ++list_index)
    {
      if((curr_sid >= country_list[list_index].sid1) &&
          ...
          ret_curr_mcc->count < SD_PLMN_MCC_LIST_MAX)
      {
        ret_curr_mcc->mcc_list[ret_curr_mcc->count] = country_list[list_index].mobile_country_code;
        ret_curr_mcc->count++;

      }
    }
    if(ret_curr_mcc->count != 0)
    {
      return TRUE;
    }
...
)
{
  ...
  if (cmutil_resolve_curr_mcc (curr_sid, curr_ltm, curr_daylt, curr_mcc))
  {
...
/*lint -esym(818,converted_num_ptr)*/
{
  ...
  */
  ...
  /* MCC */
  CM_MSG_HIGH_3("serving_mcc %d, home_mcc %d, current_mcc %d", serving_mcc, home_mcc, current_mcc);
...
/*lint -esym(818,converted_num_ptr)*/
{
  ...
  CM_MSG_HIGH_6 ("CONVERT_NUM: num conv req %d, number length %d, plus_dial_setting %d, home_mcc %d, current_mcc %d, call_type %d",
                 num_conv_req,
                 num_details_for_conv_ptr->num.len,
                 num_details_for_conv_ptr->hs_based_plus_dial_setting,
                 num_details_for_conv_ptr->home_mobile_country_code,
                 num_details_for_conv_ptr->current_mobile_country_code,
                 num_details_for_conv_ptr->call_type);
...
/*lint -esym(818,country_info_ptr)*/
{
  ...
  cm_mm_ss_info_sub_prop_s_type *ss_info_sub_prop_ptr = cmss_get_info_sub_prop(cmmsc_get_1x_sub());
  ...
  {
    if(( req_mcc = ss_info_sub_prop_ptr->sub_info.gpp2_sub_info.hpcd_info.current_mcc) == CM_INVALID_MOBILE_COUNTRY_CODE)
    {
...
boolean cmutil_is_dialed_number_international(sys_mcc_type current_mcc, cm_num_s_type num)
{

  boolean   is_serving_mcc_found = FALSE;
  /* serving mcc in list of countries */

  int  serving_mcc_index = 0;
  ...
  /* Find entry in country list for serving MCC */
  for (i = 0; i < (int)ARR_SIZE(country_list_1); ++i)
  {
    if  (sys_mcc_same_country(country_list_1[i].mobile_country_code,current_mcc))
    {
      is_serving_mcc_found = TRUE;
      serving_mcc_index = i;
      break;
  ...
  else if(cmutil_number_cmp( &num, 
                             (size_t)pos_of_first_digit, 
                             country_list_1[serving_mcc_index].inter_dialed_digits,
                             strlen(country_list_1[serving_mcc_index].inter_dialed_digits)))
  {
    pos_of_first_digit = strlen(country_list_1[serving_mcc_index].inter_dialed_digits);
  }
  else
  {
     CM_MSG_HIGH_0("Dialed number is not international, neither start with '+' nor IDD");
     return FALSE;
  }

  /* Convert country code into string */
  if ( !snprintf (serving_cc_str, CMUTIL_COUNTRY_CODE_LEN,
                  "%d", country_list_1[serving_mcc_index].country_code) )
  {
    CM_ERR_2 (" Country code %d for loop %d Invalid",
              country_list_1[serving_mcc_index].country_code, serving_mcc_index);
  }

  CM_MSG_HIGH_3("Dialed number %d, country_code %d, serving_mcc %d", num.buf, country_list_1[serving_mcc_index].country_code, current_mcc);

  /* If outgoing number starts with serving country code - number is not international*/
  if( cmutil_number_cmp( &num,
                         (size_t)pos_of_first_digit,
                         serving_cc_str,
                         strlen(serving_cc_str)))
  {
    CM_MSG_HIGH_0("Dialed number is not international");
    return FALSE;
  }
  else
  {
    CM_MSG_HIGH_0("Dialed number is international");
    return TRUE;
  }
}


boolean cmutil_is_dialed_number_international_except_home( sys_mcc_type home_mcc, sys_mcc_type current_mcc, cm_num_s_type num)
{
  boolean is_number_international = cmutil_is_dialed_number_international(current_mcc,num);

  boolean   is_home_mcc_found = FALSE;
  /* serving mcc in list of countries */

  int  home_mcc_index = 0;

  char home_cc_str [CMUTIL_COUNTRY_CODE_LEN];
  /* Carries country code */
  ...
  {
    /* Clear CC string */
     memset (home_cc_str, 0, sizeof(home_cc_str));
    
     /* Find entry in country list for serving MCC */
     for (i = 0; i < (int)ARR_SIZE(country_list_1); ++i)
     {
       if  (sys_mcc_same_country(country_list_1[i].mobile_country_code,home_mcc))
       {
         is_home_mcc_found = TRUE;
         home_mcc_index = i;
         break;
       }
     }
    
     if ( !is_home_mcc_found )
     {
       CM_MSG_HIGH_0("Country matching with MCC not found, return");
     ...
     /* Convert country code into string */
     if ( !snprintf (home_cc_str, CMUTIL_COUNTRY_CODE_LEN,
                     "%d", country_list_1[home_mcc_index].country_code) )
     {
       CM_ERR_2 (" Country code %d for loop %d Invalid",
                 country_list_1[home_mcc_index].country_code, home_mcc_index);
     }
     ...
     CM_MSG_HIGH_3("dialed number %d, country_code %d, home_mcc %d", num.buf,country_list_1[home_mcc_index].country_code, home_mcc);
    ...
    if( cmutil_number_cmp( &num,
                           ...
                           strlen(home_cc_str)))
    {
      CM_MSG_HIGH_0("Dialed number is international and to home");
      return FALSE;
    }
    else 
    {
     CM_MSG_HIGH_0("Dialed number is international but not to home");
     return TRUE;                     
    }
  }
  else
...
uint8 cmutil_num_of_subs_avail(void)
{
  ...
  for (sub = SYS_MODEM_AS_ID_1; IS_VALID_PH_SUB_PTR(sub); sub++)
  {
    ph_sub_ptr = cmph_get_sub_ptr(sub);

    if (ph_sub_ptr &&
        (ph_sub_ptr->is_3gpp_subs_avail || ph_sub_ptr->is_3gpp2_subs_avail))
    {
      num_of_subs_avail++;
    }
  }

  CM_MSG_HIGH_1("oprt_mode_online: num_of_subs_avail %d", num_of_subs_avail);
...
{
  return cm_is_esr_allowed_in_srlte_per_subs(SYS_MODEM_AS_ID_1);
}
...
===========================================================================*/
boolean cm_is_esr_allowed_in_srlte_per_subs(
  sys_modem_as_id_e_type asubs_id
)
{
  cmsds_sub_prop_s_type   *sds_sub_prop_ptr = cmsds_get_sub_prop_ptr(asubs_id);

  if(!cmutil_is_as_id_valid(asubs_id) || sds_sub_prop_ptr == NULL)
  {
    return FALSE;
  }

  if((sds_sub_prop_ptr->gpp2_sub_info.is_esr_supported || sds_sub_prop_ptr->gpp2_sub_config.supportfordualrxues)
...
#endif
      && cmss_get_info_srv_status(asubs_id, MM_STACK_2) == SYS_SRV_STATUS_SRV)
  {
    return TRUE;
  }
  else
...
{
  short sub =SYS_MODEM_AS_ID_1;
  cmph_sub_info_s_type *ph_sub_ptr = NULL;

  for(sub=SYS_MODEM_AS_ID_1; IS_VALID_PH_SUB_PTR(sub); sub++)
  {
    ph_sub_ptr = cmph_get_sub_ptr(sub);
    if(ph_sub_ptr && ph_sub_ptr->ps_pref.priority_type == SYS_DATA_PRIORITY_HIGH)
    {
...
===========================================================================*/
void cm_print_lte_band_mask(
  sys_lte_band_mask_e_type lte_band_pref
)
{
#if (LTE_BAND_NUM == 256)
  CM_MSG_MED_4("LTE bands 193_256: 0x%08x %08x, 129_192: 0x%08x %08x",
  ...
  CM_MSG_MED_4("LTE bands  65_128: 0x%08x %08x,  1_64:   0x%08x %08x",
...
)
{
  ...
  return( SD_MODE_CONTAIN( sd_mode_pref, SD_SS_MODE_PREF_CDMA_HDR) );
}

/*===========================================================================

FUNCTION cmutil_cmp_act_priorities
...
}/* cmutil_cmp_act_priorities */

/*===========================================================================

FUNCTION cmutil_is_as_id_valid
...
)
{
  ...
  if (as_id == SYS_MODEM_AS_ID_1)
  {
    status = TRUE;
            ...
            as_id < MAX_SIMS &&
            (uint8)as_id < cmpmprx_get_num_of_sims())
  {
    status = TRUE;
  }
...
FUNCTION cmutil_is_valid_lte_mode_band_pref
...
===========================================================================*/
boolean cmutil_is_valid_lte_mode_band_pref(
...
} /* cmutil_is_valid_lte_mode_band_pref() */

/*===========================================================================

FUNCTION cmutil_is_valid_mode_band_pref
...
===========================================================================*/
boolean cmutil_is_valid_mode_band_pref(
...
)
{
  ...
  */
  sd_mode_pref = cmph_map_cm_mode_pref_to_sd_mode_pref( mode_pref );
  return (sd_misc_is_supp_pref( sd_mode_pref, cmutil_map_cm_band_pref_to_sd_band_pref(band_pref)));

} /* cmutil_is_valid_mode_band_pref() */

/*===========================================================================

FUNCTION cmutil_is_valid_tds_mode_band_pref
...
===========================================================================*/
boolean cmutil_is_valid_tds_mode_band_pref(
...
)
{
  ...
  */
  ...
  return sd_misc_is_supp_pref_tds( sd_mode_pref,
                                   cmutil_map_cm_tds_band_pref_to_sd_tds_band_pref(tds_band_pref) );

} /* cmutil_is_valid_tds_mode_band_pref() */

/*===========================================================================

FUNCTION cmutil_map_cm_acq_order_pref_to_sd
...
===========================================================================*/
sd_ss_acq_order_pref_e_type  cmutil_map_cm_acq_order_pref_to_sd
(
...
} /* cmutil_map_cm_acq_order_pref_to_sd */
...
===========================================================================*/
sd_ss_band_pref_e_type   cmutil_map_cm_band_pref_to_sd_band_pref(
...
FUNCTION cmutil_map_cm_net_sel_mode_pref_to_camp_pref
...
===========================================================================*/
sd_ss_pref_camp_mode_e_type cmutil_map_cm_net_sel_mode_pref_to_camp_pref
(
...
FUNCTION cmutil_map_cm_network_sel_mode_pref_to_orig_mode
...
SIDE EFFECTS
  none
===========================================================================*/
sd_ss_orig_mode_e_type  cmutil_map_cm_network_sel_mode_pref_to_orig_mode
(
...
)
{
  ...
  if(network_sel_mode_pref != CM_NETWORK_SEL_MODE_PREF_AUTOMATIC)
  {
...
} /* cmutil_map_cm_network_sel_mode_pref_to_orig_mode */

/*===========================================================================

FUNCTION cmutil_map_cm_prl_pref_to_sd_prl_pref_e_type
...
===========================================================================*/
sd_ss_prl_pref_e_type cmutil_map_cm_prl_pref_to_sd_prl_pref(
...
} /* cmutil_map_cm_prl_pref_to_sd_prl_pref */

/*===========================================================================

FUNCTION cmutil_map_cm_roam_pref_to_sd_roam_pref
...
===========================================================================*/
sd_ss_roam_pref_e_type cmutil_map_cm_roam_pref_to_sd_roam_pref(
...
} /* cmutil_map_cm_roam_pref_to_sd_roam_pref */

/*===========================================================================

FUNCTION cmutil_map_cm_srv_domain_pref_to_sd
...
===========================================================================*/
sd_ss_srv_domain_pref_e_type cmutil_map_cm_srv_domain_pref_to_sd
(
  cm_srv_domain_pref_e_type  srv_domain_pref
)
{
  sd_ss_srv_domain_pref_e_type mapped_service_domain = SD_SS_SRV_DOMAIN_PREF_CS_ONLY;
...
} /* cmutil_map_cm_srv_domain_pref_to_sd */

/*===========================================================================

FUNCTION cmutil_map_cm_tds_band_pref_to_sd_tds_band_pref
...
===========================================================================*/
sd_ss_band_pref_e_type   cmutil_map_cm_tds_band_pref_to_sd_tds_band_pref(
...
FUNCTION cmutil_map_mode_pref_cm2nv
...
===========================================================================*/
nv_mode_enum_type cmutil_map_mode_pref_cm2nv( cm_mode_pref_e_type  cm_mode )
{
...
} /* cmutil_map_mode_pref_cm2nv() */

/*===========================================================================

FUNCTION cmutil_map_mode_pref_nv2cm
...
===========================================================================*/
cm_mode_pref_e_type cmutil_map_mode_pref_nv2cm( nv_mode_enum_type  nv_mode )
{
  switch (nv_mode)
  {
...
} /* cmutil_map_mode_pref_nv2cm() */


/*===========================================================================

FUNCTION cmutil_map_otasp_act_code_to_sd_band
...
===========================================================================*/
sd_band_e_type   cmutil_map_otasp_act_code_to_sd_band(
...
} /* cmutil_map_otasp_act_code_to_sd_band() */


/*===========================================================================

FUNCTION cmutil_map_otasp_act_code_to_sd_blksys
...
===========================================================================*/
sd_blksys_e_type   cmutil_map_otasp_act_code_to_sd_blksys(
...
} /* cmutil_map_otasp_act_code_to_sd_blksys() */

/*===========================================================================

FUNCTION cmutil_map_sd_band_pref_to_cm_band_pref
...
===========================================================================*/
cm_band_pref_e_type  cmutil_map_sd_band_pref_to_cm_band_pref(
...
} /* cmutil_map_sd_band_pref_to_cm_band_pref() */

/*===========================================================================
FUNCTION cmutil_map_sd_mode_pref_to_sys_mode_mask
...
===========================================================================*/
sys_sys_mode_mask_e_type cmutil_map_sd_mode_pref_to_sys_mode_mask(
...
===========================================================================*/
cm_band_pref_e_type  cmutil_map_sd_tds_band_pref_to_cm_tds_band_pref(
...
/*===========================================================================
FUNCTION cmutil_map_sys_mode_mask_to_sd_mode_pref
...
===========================================================================*/
sd_ss_mode_pref_e_type   cmutil_map_sys_mode_mask_to_sd_mode_pref(

  sys_sys_mode_mask_e_type mode_capability
  /* Mode pref to map */
)
{
  return (sd_ss_mode_pref_e_type)mode_capability;
}

/*===========================================================================

FUNCTION cmutil_map_sys_mode_to_srv_type
...
RETURN VALUE
  srv_type of the call, else NONE

SIDE EFFECTS
  None

===========================================================================*/
cm_srv_type_e_type cmutil_map_sys_mode_to_srv_type
(
...
FUNCTION cmutil_misc_intersect_mode_pref
...
===========================================================================*/
cm_mode_pref_e_type cmutil_misc_intersect_mode_pref(
...
} /* cmutil_misc_intersect_mode_pref */


/*===========================================================================

FUNCTION cmutil_map_cm_emerg_mode_pref_to_sd_mode_pref

DESCRIPTION
  Map CM_MODE_PREF_EMERGENCY to SD mode-preference type.
...
===========================================================================*/
sd_ss_mode_pref_e_type   cmutil_map_cm_emerg_mode_pref_to_sd_mode_pref( void )
{
  sys_modem_as_id_e_type sub = cmcall_get_sub_with_emerg_call();

#if (defined(FEATURE_3GPP_CSFB) || defined (FEATURE_LTE_TO_1X) || defined (FEATURE_IP_CALL)) && defined (FEATURE_LTE)
  if(sub == SYS_MODEM_AS_ID_NONE)
  {
    CM_MSG_HIGH_0("cmutil_map_cm_emerg_mode_pref_to_sd_mode_pref: No emerg call present");

    sub = cmph_get_sub_in_emergency_cb();
  ...
  /* If CM task has not completed initialization, return ANY. */
#ifndef CM_DEBUG
  ...
  if(cmcall_is_active_ip_app(SYS_SYS_MODE_HDR,CM_CALL_TYPE_EMERGENCY, sub) &&
      cmmsc_auto_is_hybr_hdr_call_allowed(sub))
  {
    return SD_SS_MODE_PREF_ANY;
  }
  ...
  else if(!cmsds_is_LTE_emerg_call_possible(sub))
  {
...
FUNCTION cmutil_map_sys_sys_mode_to_sd_mode
...
===========================================================================*/
sd_mode_e_type cmutil_map_sys_sys_mode_to_sd_mode(sys_sys_mode_e_type mode)
{
  switch(mode)
  {

    case SYS_SYS_MODE_NO_SRV:
      return SD_MODE_INACT;
    case SYS_SYS_MODE_CDMA:
      return SD_MODE_CDMA;
    case SYS_SYS_MODE_GSM:
      return SD_MODE_GSM;
...
FUNCTION cmutil_map_cm_hybr_pref_to_sd_hybr_pref
...
===========================================================================*/
sd_ss_hybr_pref_e_type   cmutil_map_cm_hybr_pref_to_sd_hybr_pref
(
...
FUNCTION cmutil_map_sd_hybr_pref_to_cm_hybr_pref
...
===========================================================================*/
cm_hybr_pref_e_type cmutil_map_sd_hybr_pref_to_cm_hybr_pref
(
  ...
  */
  ...
  switch( hybr_pref )
  {
    case SD_SS_HYBR_PREF_CDMA__HDR:
      return CM_HYBR_PREF_CDMA__HDR;
    case SD_SS_HYBR_PREF_CDMA__LTE__HDR:
      return CM_HYBR_PREF_CDMA__LTE__HDR;
    case SD_SS_HYBR_PREF_CDMA__GWL__HDR:
      return CM_HYBR_PREF_CDMA__GWL__HDR;
...
} /* cmutil_map_sd_hybr_pref_to_cm_hybr_pref() */

/*===========================================================================

FUNCTION cmutil_map_sd_srv_domain_pref_to_sys
...
SIDE EFFECTS
  None.
===========================================================================*/
sys_srv_domain_e_type           cmutil_map_sd_srv_domain_pref_to_sys
(
  ...
  */
  switch ( srv_domain_pref )
  {
    ...
    case SD_SS_SRV_DOMAIN_PREF_CS_VOLTE:
      sys_srv_domain_pref = SYS_SRV_DOMAIN_CS_VOLTE;
      break;

    case SD_SS_SRV_DOMAIN_PREF_VOLTE:
      sys_srv_domain_pref = SYS_SRV_DOMAIN_VOLTE;
      break;

    case SD_SS_SRV_DOMAIN_PREF_NONE:
      sys_srv_domain_pref = SYS_SRV_DOMAIN_NONE;
      break;
...
FUNCTION cmutil_get_supp_mode_pref
...
===========================================================================*/
cm_mode_pref_e_type cmutil_get_supp_mode_pref(
...
FUNCTION cmutil_get_variant

DESCRIPTION
  Extract the variant (asubs_id) from the MSGR message
...
===========================================================================*/
sys_modem_as_id_e_type cmutil_get_variant(
...
)
{
  ...
  if(msgr_hdr_ptr == NULL)
  {
    return asubs_id;
  }

  asubs_id = MSGR_GET_VARIANT(msgr_hdr_ptr);
  MSGR_CLEAR_VARIANT(msgr_hdr_ptr->id);
...
FUNCTION cmutil_is_periodic_manual_search

DESCRIPTION
  Decides whether the command is a periodic frequency search

DEPENDENCIES
  None

RETURN VALUE
  TRUE if this is a periodic frequency search
  FALSE otherwise
...
===========================================================================*/
boolean cmutil_is_periodic_manual_search()
{
  cmph_s_type *ph_ptr = cmph_ptr();
  
  return (ph_ptr->device_prop.pf_scan_info != NULL &&
          ph_ptr->device_prop.pf_scan_info->search_periodicity != 0);
}

/*===========================================================================

FUNCTION cmutil_are_there_concurrent_manual_searches

DESCRIPTION
  Returns TRUE if there are concurrent manual searches existing in CM.
  This happens when a periodic search is buffered due to an ongoing CSG or
  internal manual search.
...
===========================================================================*/
boolean cmutil_are_there_concurrent_manual_searches(  
    sys_modem_as_id_e_type         asubs_id
)
{
  cmph_s_type *ph_ptr = cmph_ptr();
  cmph_sub_info_s_type *net_ph_sub_ptr = cmph_get_net_sub_ptr(asubs_id);
  
  return (ph_ptr->device_prop.pf_scan_info != NULL &&
          ph_ptr->device_prop.pf_scan_info->search_periodicity != 0 &&
          net_ph_sub_ptr != NULL &&
          cmph_is_get_networks_ongoing(asubs_id) &&
         (net_ph_sub_ptr->pref_info.network_list_type 
            != (cm_network_list_type_e_type)ph_ptr->device_prop.pf_scan_info->network_list_type ||
          net_ph_sub_ptr->pref_info.ignore_manual_bst
            != ph_ptr->device_prop.pf_scan_info->ignore_manual_bst));
}
/*===========================================================================

FUNCTION: cm_util_set_default_mt_setup_res_per_sub

DESCRIPTION
  This function will memset passed mt setup res structure
  and fill it with default parameters for accepting a MT CS call.
  
DEPENDENCIES
  Need to pass non null mt setup res structure
  
RETURN VALUE
  MT setup response with accept=TRUE

SIDE EFFECTS
  None

===========================================================================*/
void cm_util_set_default_mt_setup_res_per_sub(

  sys_modem_as_id_e_type          asubs_id,

  cm_mt_setup_res_T                    *cm_mt_setup_res
  /* output param, need to fill this */
...
)
{
  ...
  CM_ASSERT(cm_mt_setup_res != NULL);

  if(cm_mt_setup_res == NULL)
  {
    CM_MSG_HIGH_0("cm_util_set_default_mt_setup_res_per_sub setup_res NULL");
	return;
  }

  /* Populate mm id for call */
  mm_id.asubs_id = asubs_id;
  mm_id.stk_id = MM_STACK_0;
  
  /* Reset setup res parameters before filling it up */
  memset( cm_mt_setup_res, CM_CALL_CMD_PARAM_DEFAULT_VALUE, sizeof(cm_mt_setup_res_T) );

  /* The default bearer capability to use on incoming voice calls. */
  #ifdef CM_DEBUG
  #error code not present
#else
  qmi_voice_util_setup_ind_param_per_sub( &cm_mt_setup_res->bearer_capability_1, asubs_id);
  #endif
  
  /* populate mt setup res with received bearer capability parameters and 
  ** codec list 
  */
  /*passing NULL for parameters that dont get modified inside populate API */
  cmwcall_populate_mt_setup_response(mm_id,
  	                                 TRUE,
  	                                 &cm_mt_setup_res->cm_cc_cause,
  	                                 NULL,
  	                                 NULL,
  	                                 NULL,
	                                 cm_mt_setup_res);
...
#else
  SYS_ARG_NOT_USED(cm_mt_setup_res);
  SYS_ARG_NOT_CONST(cm_mt_setup_res);
  CM_ERR_0("cm_util_set_default_mt_setup_res_per_sub bc shouldn't be called. ");
...
FUNCTION: cmutil_utf8_to_utf16

DESCRIPTION
  This function will covert UTF8 encoded byte stream to UTF16 encoding format
  
DEPENDENCIES
  Need to pass non null UTF8 encoded byte stream
  
RETURN VALUE
  Length of UTF16 converted byte stream

SIDE EFFECTS
  None

===========================================================================*/
cm_util_conversion_result_e_type cmutil_get_num_bytes_to_read_from_utf8(uint8 *u8, uint8 *end, uint16* len)
{
  uint8 val=0;
  uint8 *utf8 = u8;
  ...
  if (utf8 > end)
  {
    return CMUTIL_SOURCE_EXHAUSTED;
  }

  memscpy(&val, sizeof(val), utf8, sizeof(*utf8));

  if (val <= 0x7F) // means first bit is not set so it's a 7 bit 
  {
    *len = 1;
    return CMUTIL_CONVERSION_SUCCESS;
  }
...
/* UTF8 Related Private APIS */

cm_util_code_point_e_type cmutil_get_codepoints_from_utf8(uint8* source, uint32 length, uint8* codePoints)
{
  uint8 val=0, shiftVal=0;
  uint8 *utf8 = (uint8*)source;
  cm_util_code_point_e_type eCPType = CMUTIL_TWO_BYTE;
  ...
  if (length == 2)
  {
    ...
    shiftVal = val >> 2;
    val = val << 6;
    codePoints[0] = shiftVal;
    codePoints[1] = val | codePoints[1];
  }
  if (length == 3)
  {
    val = *(utf8 + 2) & 0x3F;
  ...
  if (length == 4)
  {
    ...
    shiftVal = val >> 2;
    val = val << 6;
    codePoints[1] = shiftVal;
    codePoints[2] = val | codePoints[2];
	...
	eCPType = CMUTIL_THREE_BYTE;
  }

  return eCPType;
}

cm_util_conversion_result_e_type cmutil_codepoints_to_utf16(cm_util_code_point_e_type eCodePointType, uint8* targetString, uint8* targetEnd, uint16* targetLen, uint8 codePoints[])
{
  uint16 twoByte = 0;
  uint16 finalByte = 0xffff;
  uint32 fourBytes = 0;
  uint8 *target = targetString;

  cm_util_conversion_result_e_type result = CMUTIL_CONVERSION_SUCCESS;

  if (eCodePointType == CMUTIL_TWO_BYTE)
  {
    twoByte = ((codePoints[0] & finalByte) << 8) | (codePoints[1] & finalByte);

    if (twoByte >= 0xD800 && twoByte <= 0xDFFF)
    {
      result = CMUTIL_SOURCE_ILLEGAL;
      return result;
    }
    if (target + 1 > targetEnd)
    {
      result = CMUTIL_TARGET_EXHAUSTED;
      return result;
    }
    target[0] = codePoints[0];
    target[1] = codePoints[1];
    *targetLen = 2;
  }
  else if (eCodePointType == CMUTIL_THREE_BYTE)
  {
    if (target + 3 > targetEnd)
    {
      return result;
    }

    fourBytes = (fourBytes | codePoints[0]) << 16;
    fourBytes = fourBytes | ((uint32)codePoints[1] << 8);
    fourBytes = fourBytes | codePoints[2];

    fourBytes = fourBytes - 0x010000;

    twoByte = (uint16)((fourBytes & 0xFFC00) >> 10);
    twoByte = twoByte | (uint16)0xD800;

    target[0] = (uint8)((twoByte >> 8) & 0xFF);
    target[1] = (uint8)(twoByte & 0xFF);

    twoByte = (uint16)(fourBytes & 0x03FF);
    twoByte = twoByte | (uint16)0xDC00;

    target[2] = (uint8)((twoByte >> 8) & 0xFF);
    target[3] = (uint8)(twoByte & 0xFF);
...
uint16 cmutil_utf8_to_utf16(uint8 *sourceString, uint8* sourceEnd, uint8* targetString, uint8* targetEnd)
{
  uint8 codePoints[3];
  uint16 srcLen = 0;
  uint16 targetLen = 0;
  uint8 *source = sourceString;
  uint8 *target = targetString;

  cm_util_conversion_result_e_type result = CMUTIL_CONVERSION_SUCCESS;
  cm_util_code_point_e_type eCodePointType = CMUTIL_NONE_BYTE;

  CM_ASSERT(sourceString != NULL);
  CM_ASSERT(sourceEnd != NULL);
  CM_ASSERT(targetString != NULL);
  CM_ASSERT(targetEnd != NULL);

  while (source <= sourceEnd && target < targetEnd)
  {
    memset(codePoints, 0, sizeof(codePoints));
    result = cmutil_get_num_bytes_to_read_from_utf8(source, sourceEnd, &srcLen);

    if (result != CMUTIL_CONVERSION_SUCCESS)
    {
      break;
    }

    cmutil_get_codepoints_from_utf8(source, srcLen, codePoints);
    eCodePointType = srcLen >= 4 ? CMUTIL_THREE_BYTE : CMUTIL_TWO_BYTE;
    result = cmutil_codepoints_to_utf16(eCodePointType, target, targetEnd, &targetLen, codePoints);
    if (result != CMUTIL_CONVERSION_SUCCESS)
    {
      break;
    }
    source = source + srcLen;
    target = target + targetLen;
  }
  return ((uint8 *)target - (uint8 *)targetString);
}
/*===========================================================================

FUNCTION cmutil_is_roam_mcc

DESCRIPTION
  Indicates whether the MCC is valid and it is not home country

RETURN VALUE
  Boolean
===========================================================================*/
boolean cmutil_is_roam_mcc(
  sys_mcc_type current_mcc,
  sys_modem_as_id_e_type  asubs_id
)
{
  boolean nas_in_home = reg_sim_per_subs_check_home_mcc(current_mcc, asubs_id);
  boolean is_valid = (current_mcc == SYS_INVALID_MCC)?FALSE:TRUE;
  boolean imsi_in_home;
  sys_mcc_type home_mcc;
  ...
  sys_plmn_get_mcc(ph_sub_ptr->gwl_imsi_plmn, &home_mcc);
  imsi_in_home = sys_mcc_same_country(home_mcc, current_mcc);

  if (nas_in_home != imsi_in_home)
  {
    CM_MSG_HIGH_3("Is current MCC home MCC, from NAS %d, from IMSI %d, sub %d",
                  nas_in_home, imsi_in_home, asubs_id);
  }

  /* UE is considered in home if any of the below condition is true:
  ** - MCC is not valid
  ** - current MCC matches either NAS home MCC, or IMSI MCC
  */
  if(is_valid && !(nas_in_home || imsi_in_home)) return TRUE;
