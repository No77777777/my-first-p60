...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/ecall/hlap/src/ecall_msd.c#1 $ 
...
void ecall_construct_msd_struct(ecall_msd_structure_s_type *ecall_msd, uint8 ecall_msdversion)
{
  ecall_msd->ecall_msdversion = ecall_msdversion;     // 1B. MSD format version
  ...
  if (ecall_msdversion == ECALL_MSD_VERSION_2)
  {
    ecall_msd->ecall_vehicle_propulsionstorage.otherStorage        = FALSE;
  }
...
/*===========================================================================/
FUNCTION ECALL_SERIALISE_MSD_V1
...
==============================================================================*/
void ecall_serialise_msd_v1(const ecall_msd_structure_s_type *msd_struct, ecall_msd_array_type msd_byte_array)
{
  ...
  ECALL_MSG_0( ECALL_HIGH, "v1 serialise");
  
  /* Byte 0 */
  num_bits_to_write = 8;
  b_packb( msd_struct->ecall_msdversion, &msd_ptr_temp[byte_pos], start_pos_in_byte, num_bits_to_write);
...
/*===========================================================================/
FUNCTION ECALL_SERIALISE_MSD_V2
...
==============================================================================*/
void ecall_serialise_msd_v2(const ecall_msd_structure_s_type *msd_struct, ecall_msd_array_type msd_byte_array)
{
  ...
  ECALL_MSG_0( ECALL_HIGH, "v2 serialise");
  /* Byte 0 */
  num_bits_to_write = 8;
  b_packb( msd_struct->ecall_msdversion, &msd_ptr_temp[byte_pos], start_pos_in_byte, num_bits_to_write);
  byte_pos += 1; /*increment 1 byte*/
  ...
  num_bits_to_write = 8;
  start_pos_in_byte = 0;
  b_packb( ECALL_MSD_LENGTH_FOR_V_2, &msd_ptr_temp[byte_pos], start_pos_in_byte, num_bits_to_write);
  byte_pos += 1; /*increment 1 byte*/
  ...
  ECALL_MSG_2(ECALL_HIGH, "=dbg: direction %d, byte_pos %d",msd_struct->ecall_vehicledirection, byte_pos);
  /* Byte 30 */
  num_bits_to_write = 8;
  start_pos_in_byte = 5;
  b_packd( msd_struct->ecall_vehicledirection,  &msd_ptr_temp[byte_pos], start_pos_in_byte, num_bits_to_write);
 ...
 ECALL_MSG_2(ECALL_HIGH, "=dbg: ecall_numberOfPassengers %d, byte_pos %d",msd_struct->ecall_numberOfPassengers, byte_pos);
...
==============================================================================*/
void ecall_serialise_msd(const ecall_msd_structure_s_type *msd_struct, ecall_msd_array_type msd_byte_array, uint8 ecall_msdversion)
{

  switch(ecall_msdversion)
  {
    case ECALL_MSD_VERSION_1:
    {
      ecall_serialise_msd_v1(msd_struct, msd_byte_array);
      break;
    }

    case ECALL_MSD_VERSION_2:
    default:
    {
      ecall_serialise_msd_v2(msd_struct, msd_byte_array);
      break;
    }
  }
