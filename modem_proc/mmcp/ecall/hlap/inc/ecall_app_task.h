...
$Header: //components/rel/mmcp.mpss/7.9.0/ecall/hlap/inc/ecall_app_task.h#1 $
...
typedef struct
{
  ...
  union ecall_app_msgr_cmd_u
  {
    msgr_hdr_s hdr;   /* Message router header */
    union ecall_app_msgr_msg_u ecall_app;
  } cmd;
