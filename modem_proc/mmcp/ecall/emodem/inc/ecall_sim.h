...
$Header: //components/rel/mmcp.mpss/7.9.0/ecall/emodem/inc/ecall_sim.h#1 $
...
typedef struct
{
  ...
  sys_vsid_type                  vsid_cs_voice;         // Modem VSID for CS Voice call
#endif /* FEATURE_ECALL_HAS_SINGLE_VOICE_SESSION */

  /* Voice Agent State */
  boolean                            is_vsid_available;               // VSID available from CM PH Event
  boolean                            is_voice_agent_registered;       // Register status of Voice Agent
...
/*===========================================================================
   ...
   DESCRIPTION:
     This function will register with voice agent if it pending
