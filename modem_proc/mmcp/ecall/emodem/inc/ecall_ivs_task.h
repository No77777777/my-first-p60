...
$Header: //components/rel/mmcp.mpss/7.9.0/ecall/emodem/inc/ecall_ivs_task.h#1 $
...
typedef enum {
  ...
  ECALL_CMD_VOICE_AGENT_REGISTER,
  ECALL_CMD_VOICE_AGENT_DEREGISTER,
  ECALL_CMD_VOICE_AGENT_GRANT,
  ECALL_CMD_MAX
} ecall_cmd_id_e_type;
...
typedef struct {
  ...
  union 
  {
    ...
    ecall_voice_iresource_cmd_register_t   voice_agent_register_data;    /* ECALL_CMD_VOICE_AGENT_REGISTER */
    ecall_voice_iresource_cmd_deregister_t voice_agent_deregister_data;  /* ECALL_CMD_VOICE_AGENT_DEREGISTER */
    ecall_voice_iresource_cmd_grant_t      voice_agent_grant_data;       /* ECALL_CMD_VOICE_AGENT_GRANT */
  } data;
} ecall_cmd_type;
