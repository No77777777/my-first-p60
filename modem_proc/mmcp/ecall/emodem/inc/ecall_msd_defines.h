...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/ecall/emodem/inc/ecall_msd_defines.h#1 $ 
...
/* In 2 degrees step */
#define ECALL_MAX_DIR (180)
#define ECALL_MIN_DIR   (0)
...
#define ECALL_MSD_VERSION_1 1
#define ECALL_MSD_VERSION_2 2

#define ECALL_MSD_LENGTH_FOR_V_2 31
