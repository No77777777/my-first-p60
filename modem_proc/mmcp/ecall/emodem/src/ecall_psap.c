...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/7.9.0/ecall/emodem/src/ecall_psap.c#1 $ 
...
/*===========================================================================
FUNCTION      ECALL_DESERIALISE_MSD_V1
...
{ 
  ...
  /* Byte 0 */
  num_bits_to_read = 8;
  ecall_psap_msd_struct.ecall_msdversion = b_unpackb(&msd_byte_array[byte_pos], start_pos_in_byte, num_bits_to_read);
  byte_pos += 1;
...
/*===========================================================================
FUNCTION      ECALL_DESERIALISE_MSD_V2
...
{ 
  ...
  num_bits_to_read = 8;
  ecall_psap_msd_struct.ecall_msdversion = b_unpackb(&msd_byte_array[byte_pos], start_pos_in_byte, num_bits_to_read);
  byte_pos += 2; // Incrementing by 2 to skip msdlength_in_bytes

  /* Byte 1 */
  /* msdlength_in_bytes --> no op */
  ...
  start_pos_in_byte = 3;
  ecall_psap_msd_struct.ecall_vehicle_propulsionstorage.otherStorage = b_unpackb( &msd_byte_array[byte_pos], start_pos_in_byte, num_bits_to_read);
...
{
  uint8 msd_version = msd_byte_array_in[0];
  ...
  switch(msd_version)
  {
    ...
    {
      ecall_deserialise_msd_v1(msd_byte_array_in, len);
      break;
    }
    ...
    default:
    {
      ecall_deserialise_msd_v2(msd_byte_array_in, len);
      break;
    }
