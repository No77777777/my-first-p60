...
$Header: //components/rel/wcdma.mpss/8.4.0/rlc/inc/rlcdlam.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
===========================================================================*/
void rlci_dl_am_init(rlci_downlink_table_type *rlc_dl_table_ptr);
...
===========================================================================*/
void rlc_enh_free_reseq_q(rlci_uplink_table_type *rlc_ul_table_ptr,
                      rlci_downlink_table_type *rlc_dl_table_ptr,
                      rlci_dl_ctrl_blk_type *ctrl_blk, uint16 end_sn, 
                      uint16 start_sn);
...
===========================================================================*/
boolean rlci_enh_dl_am_insert_reseq
(
  rlci_uplink_table_type *rlc_ul_table_ptr,
...
===========================================================================*/
void rlci_enh_dl_am_process_ctrl_pdus(rlci_uplink_table_type *rlc_ul_table_ptr,
                                      rlci_downlink_table_type *rlc_dl_table_ptr,
...
===========================================================================*/
void rlci_enh_release_dl_am(rlci_uplink_table_type *rlc_ul_table_ptr,
                            rlci_downlink_table_type *rlc_dl_table_ptr,
                            rlci_dl_ctrl_blk_type *ctrl_blk_ptr,
...
uint16 rlci_enh_dl_am_process_mrw_sufi(rlci_uplink_table_type *rlc_ul_table_ptr,
                                       rlci_downlink_table_type *rlc_dl_table_ptr,
                                       rlci_dl_ctrl_blk_type *ctrl_blk, 
                                       mcalwcdma_dec_iovec_type *payload_ptr, 
                                       uint16                bit_offset);
...
void rlci_delete_patial_sdu_ptr
(
  rlci_uplink_table_type *rlc_ul_table_ptr,
  rlci_downlink_table_type *rlc_dl_table_ptr,
  rlci_dl_ctrl_blk_type *ctrl_blk_ptr
...
===========================================================================*/
void rlci_enh_dl_process_am_pdu(rlci_uplink_table_type *rlc_ul_table_ptr,
                                rlci_downlink_table_type *rlc_dl_table_ptr,
                                rlci_dl_ctrl_blk_type  *ctrl_blk_ptr,
                                complete_pdu_type *complete_pdu_ptr,
...
boolean rlci_enh_establish_dl_am(rlci_downlink_table_type *rlc_dl_table_ptr,
                     rlci_dl_ctrl_blk_type *ctl_blk_ptr,
                                 rlc_lc_id_type rlc_id);
...
===========================================================================*/
uint8 rlci_enh_calc_dl_li_length(rlc_li_e_type am_li_type, sys_modem_as_id_e_type as_id);
...
===========================================================================*/
void rlci_enh_am_discard_flag_handling
(
  rlci_uplink_table_type *rlc_ul_table_ptr,
  rlci_downlink_table_type *rlc_dl_table_ptr,
  rlci_dl_ctrl_blk_type *ctrl_blk
...
===========================================================================*/
uint16 rlci_enh_dl_am_process_mrw_ack_sufi(rlci_uplink_table_type *rlc_ul_table_ptr,
                                            rlci_downlink_table_type *rlc_dl_table_ptr,
                                            rlci_dl_ctrl_blk_type *ctrl_blk, 
...
===========================================================================*/
uint16 rlci_enh_dl_am_process_bitmap_sufi(rlci_uplink_table_type *rlc_ul_table_ptr,
                                          rlci_downlink_table_type *rlc_dl_table_ptr,
                                          rlci_dl_ctrl_blk_type *ctrl_blk, 
                                          dsm_item_type         **item_ptr, 
                                          uint16                bit_offset);
...
===========================================================================*/
uint16 rlci_enh_dl_am_process_list_sufi(rlci_uplink_table_type *rlc_ul_table_ptr,
                                        rlci_downlink_table_type *rlc_dl_table_ptr,
                                        rlci_dl_ctrl_blk_type *ctrl_blk, 
                                        dsm_item_type         **item_ptr, 
                                        uint16                bit_offset);
...
===========================================================================*/
uint16 rlci_enh_dl_am_process_window_sufi(rlci_uplink_table_type *rlc_ul_table_ptr,
                                          rlci_downlink_table_type *rlc_dl_table_ptr,
                                          rlci_dl_ctrl_blk_type *ctrl_blk, 
                                          dsm_item_type         **item_ptr, 
                                          uint16                bit_offset);
...
===========================================================================*/
void rlci_enh_dl_am_process_ack_sufi(rlci_uplink_table_type *rlc_ul_table_ptr,
                                     rlci_downlink_table_type *rlc_dl_table_ptr,
                                     rlci_dl_ctrl_blk_type *ctrl_blk, 
                                     dsm_item_type         **item_ptr,
                                     uint16                bit_offset);
...
===========================================================================*/
void rlci_enh_am_update_partial_sdu_ptr(rlci_uplink_table_type *rlc_ul_table_ptr,
                                        rlc_dl_am_reseq_q_type *reseq_q_ptr,
...
===========================================================================*/
uint16 rlci_enh_dl_am_process_poll_sufi
(
  rlci_uplink_table_type *rlc_ul_table_ptr,
  rlci_dl_ctrl_blk_type *ctrl_blk, 
  dsm_item_type         **item_ptr, 
