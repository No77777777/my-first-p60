...
$Header: //components/rel/wcdma.mpss/8.4.0/rlc/src/rlcdllog.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
(
  rlci_downlink_table_type *rlc_dl_table_ptr  /* Ptr to Transparent Mode Config Info    */
);

...
===========================================================================*/
void rlc_dl_enh_r7_pdu_log_pkt(rlci_downlink_table_type * dl_tbl_ptr);
...
===========================================================================*/
void rlc_dl_enh_tx_am_pdu_log_pkt(rlci_downlink_table_type *rlc_dl_table_ptr,
...
===========================================================================*/
void rlc_dl_enh_tx_um_pdu_log_pkt(rlci_downlink_table_type *rlc_dl_table_ptr, rlci_dl_ctrl_blk_type *ctrl_blk_ptr);
#endif
...
void rlci_enh_dl_log_info_handler(rlci_downlink_table_type *rlc_dl_table_ptr);
#endif /* RLCDLLOG_H */
