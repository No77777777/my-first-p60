...
$Header: //components/rel/wcdma.mpss/8.4.0/rlc/src/rlculum.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
===========================================================================*/
void rlci_ul_um_init(rlci_uplink_table_type *rlc_ul_table_ptr);
...
(
  ...
  l1_l2_data_type            *l1_ul_tx_buf_ptr   /* Buffer to store IO vectors    */
...
===========================================================================*/
void rlc_um_free_sdu_q
(
  rlci_uplink_table_type *rlc_ul_table_ptr,
  rlc_ul_chnl_e_type ul_chnl_type
);
...
===========================================================================*/
rlc_um_sdu_q_type* rlc_um_get_sdu_free_q
(
  rlci_uplink_table_type *rlc_ul_table_ptr,
  rlc_ul_chnl_e_type chnl_type
);
