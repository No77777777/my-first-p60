...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrccu.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/14/17   sp      Made changes to buffer the RLF indication received after sending suspend req and fail the corresponding resume to trigger cell selection
09/16/16   sp     Made changes to reset CU registration info once reconfig procedure is successful
03/21/16   sg     Made changes to fail reselection when Channel configuration for CUC is in progress
02/15/16   sp      Added an API which returns true if OC is not set during PCH state transition
...
09/06/15   ad      Made changes to trigger UL data indication for the AS_id passed by RLC.
...
typedef enum
{
  ...
  , RRCCU_WAIT_FOR_SIB7_CURRENT /*FEATURE_UPDATE_SIB7_FOR_PCH_TO_FACH*/
...
/* Below #defines are for logging purpose only */
  ...
  #define rrccu_substate_e_type_value15 RRCCU_WAIT_FOR_SIB7_CURRENT /*FEATURE_UPDATE_SIB7_FOR_PCH_TO_FACH*/
...
SIDE EFFECTS
  None
===========================================================================*/
void  rrccu_start_t_305_timer(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
boolean  rrccu_get_rabs_need_to_be_released_T314(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
boolean  rrccu_get_rabs_need_to_be_released_T315(sys_modem_as_id_e_type wrrc_as_id);
...
rrc_CellUpdateCause rrccu_get_cu_cause(sys_modem_as_id_e_type wrrc_as_id);
...
void rrccu_set_cu_cause_for_wait_timer(sys_modem_as_id_e_type wrrc_as_id, rrc_cell_update_cause_e_type cu_cause);
...
FUNCTION rrccu_check_if_cmd_is_buffered

DESCRIPTION
  This function checks if a given command is buffered in the
  internal variable
...
===========================================================================*/
boolean rrccu_check_if_cmd_is_buffered
(
  sys_modem_as_id_e_type wrrc_as_id, 
  uint8 command_id
);
...
FUNCTION rrccu_reset_the_buffered_cmd

DESCRIPTION
  This function resets the bit corresponding to the 
  given command in rrccu_int_data.rrccu_buffered_cmd_mask
...
===========================================================================*/
void rrccu_reset_the_buffered_cmd
(
  sys_modem_as_id_e_type wrrc_as_id, 
  uint8 command_id
);
...
===========================================================================*/
void rrccu_set_cu_cause_to_ul_data_indication(sys_modem_as_id_e_type wrrc_as_id );
...
rrc_RRC_StateIndicator rrccu_return_ordered_state(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
void rrcqsh_log_cuc_ota_params(sys_modem_as_id_e_type wrrc_as_id
);
/*===========================================================================
...
uint8 rrccu_get_num_rb_rel(sys_modem_as_id_e_type wrrc_as_id
);
...
boolean rrccu_get_cuc_for_srns_relocation(sys_modem_as_id_e_type wrrc_as_id
);
/*===========================================================================
FUNCTION rrc_qsh_get_establishment_cause
...
===========================================================================*/
uint8 rrc_qsh_get_establishment_cause(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
FUNCTION rrc_qsh_get_reconfig_status_ind
...
===========================================================================*/
uint8 rrc_qsh_get_reconfig_status_ind(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
FUNCTION rrc_qsh_get_security_revert_status
...
===========================================================================*/
uint8 rrc_qsh_get_security_revert_status(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
void rrccu_qsh_log_rlf_params(sys_modem_as_id_e_type wrrc_as_id,sys_rlf_weak_signal_e_type cause);
#endif
/*===========================================================================
...
boolean rrccu_check_if_cu_ordered_state_is_pch_and_oc_is_not_set(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
boolean rrccu_is_channel_config_in_process(sys_modem_as_id_e_type wrrc_as_id);
