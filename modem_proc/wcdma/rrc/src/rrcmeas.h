...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcmeas.h#3 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
#ifdef FEATURE_FEMTO_CSG
void rrcmeas_send_csg_mes_info_to_l1(sys_modem_as_id_e_type wrrc_as_id, rrc_csp_temp_csg_cell_list *);
#endif
/*===========================================================================
...
uint8 rrcmeas_get_substate(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
#endif
uint8 rrcmeas_return_substate(sys_modem_as_id_e_type wrrc_as_id);
#ifdef FEATURE_WCDMA_QSH_DUMP
__attribute__((section(".uncompressible.text")))
#endif
uint32 rrcmeas_get_meas_id_bitmask(sys_modem_as_id_e_type wrrc_as_id);
#ifdef FEATURE_WCDMA_W2L_PSEUDO_MEAS
/*===========================================================================

FUNCTION rrc_check_w_to_l_measurements_are_active()

DESCRIPTION

  This function check if W to L measurements are active
...
boolean rrc_check_w_to_l_measurements_are_active(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================

FUNCTION rrc_pseudo_meas_config_w2l_freq_in_dch()

DESCRIPTION

  This function configures fake w to l measurements to WL1
...
===========================================================================*/
uecomdef_status_e_type rrc_pseudo_meas_config_w2l_freq_in_dch(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================

FUNCTION rrc_pseudo_meas_deconfig_w2l_freq_in_dch()

DESCRIPTION

  This function de configures fake w to l measurements to WL1
...
===========================================================================*/
void rrc_pseudo_meas_deconfig_w2l_freq_in_dch(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================

FUNCTION rrc_meas_control_processing_active()

DESCRIPTION

  This function checks if any transaction id is invalid 
...
boolean rrc_meas_control_processing_active
(
  sys_modem_as_id_e_type wrrc_as_id
);
