...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrchsrachcfg.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
#define RRC_IS_HSRACH_TURNED_ON ((rrc_nv_rel_indicator & RRC_NV_REL_INDICATOR_REL8) && \
                                 (rrcnv_data.rrc_feature_nv_item_value & RRC_EFACH_ENABLED) && \
                                 (rrcnv_data.rrc_feature_nv_item_value & RRC_MAC_I_ENABLED) && \
                                 (rrcnv_data.rrc_feature_nv_item_value & RRC_HSRACH_ENABLED) && \
                                 (!(rrcnv_data.rrc_disable_cpc_fdpch_nv & (NV_FDPCH_DISABLE |NV_EFDPCH_DISABLE))))

#define RRC_IS_SIB5_DELAY_CU_ENABLED ((RRC_IS_HSRACH_TURNED_ON) && \
                                      (rrcnv_data.rrc_feature_nv_item_value & RRC_SIB5_DELAY_CELL_UPDATE_ENABLED))
