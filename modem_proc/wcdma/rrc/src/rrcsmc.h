...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcsmc.h#2 $
...
#define DL_DCCH_LATER_THAN_R3_CRIT_EXTN_CRIT_EXTN_CRIT_EXTN_CRIT_EXTN_CRIT_EXTN_LATER_THAN_R8_CRIT_EXTN_R9_LATER_THAN_R9_CRIT_EXTN_R10_POS 51

#define NUM_OF_BITS_FOR_DL_DCCH_LATER_THAN_R3_CRIT_EXTN_CRIT_EXTN_CRIT_EXTN_CRIT_EXTN_CRIT_EXTN_LATER_THAN_R8_CRIT_EXTN_R9_LATER_THAN_R9_CRIT_EXTN_R10 1
...
#define DL_DCCH_R10_INTEGRITY_PROTECTION_MODE_INFO_PRESENT_POS 54

#define NUM_OF_BITS_FOR_DL_DCCH_R10_INTEGRITY_PROTECTION_MODE_INFO_PRESENT 1
...
{
  uint8 nchan;
  uint16 sq_num[MAX_RB+1];
  uint8 act_time_present[MAX_RB+1];
  uint16 sq_num_for_complete[MAX_RB+1];
  uint8 lc_id_for_complete[MAX_RB+1];
...
typedef struct
{
  /*static var to hold all kinds of security config which is not calculated
    ...
    OTA message */
  rrcsmc_security_config_info_type  rrcsmc_int_ciph_info_bkp;
...
} rrcsmc_ext_data_type;

#ifdef FEATURE_DUAL_WCDMA 
extern rrcsmc_ext_data_type rrcsmc_ext_data_sim[MAX_RRC_STACKS];
#define rrcsmc_ext_data rrcsmc_ext_data_sim[WAS_ID_M]
#else
extern rrcsmc_ext_data_type rrcsmc_ext_data;
#endif
/* =======================================================================
**                          Macro Definitions
** ======================================================================= */
...
===========================================================================*/
boolean rrcsmc_is_integrity_prot_mode_info_present(sys_modem_as_id_e_type wrrc_as_id, uint8 *dl_sdu_ptr, uint8 msg_type);
...
void rrcsmc_init_procedure(sys_modem_as_id_e_type wrrc_as_id);
...
void rrcsmc_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
===========================================================================*/
rrcsmc_ip_status_e_type rrcsmc_check_integrity_status(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void rrcsmc_reset_smc_config_flag(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
===========================================================================*/
void rrcsmc_get_nv_items(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
rrcsmc_security_status_e_type rrcsmc_is_ciphering_enabled(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
===========================================================================*/
void rrcsmc_update_ciphering_activation_cfn(sys_modem_as_id_e_type wrrc_as_id,  uint8 ciphering_activation_cfn );
/*===========================================================================
...
===========================================================================*/
boolean rrcsmc_is_new_tm_rb_setup(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
RETURN VALUE
  uecomdef_status_e_type SUCCESS if Ciphering is started on TM RB's
                         FAILURE if Ciphering is not started on TM RB's  
===========================================================================*/
uecomdef_status_e_type rrcsmc_process_cipher_config_for_hho(sys_modem_as_id_e_type wrrc_as_id,  uint32 mac_d_hfn);
/*===========================================================================
...
===========================================================================*/
uint32 rrcsmc_step_2_cipher_config_for_hho (sys_modem_as_id_e_type wrrc_as_id);
...
FUNCTION rrcsmc_process_smc_message_if_it_is_buffered

DESCRIPTION
   This function checks if SMC message was buffered and processes it
