...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcuece.c#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
SIDE EFFECTS
  None
===========================================================================*/
void rrcuece_set_radio_capability_update_requirement (sys_modem_as_id_e_type wrrc_as_id)
{
  /* re-set the variable rrc_capability_update_requirement */
  memset(&rrcdata_misc_info.rrc_capability_update_requirement, 
...
)
{
       ...
       rrc_CapabilityUpdateRequirement,systemSpecificCapUpdateReqList))
  {
    ...
    {   
      ...
      {
        rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.value[i] = RRC_GSM_CAP;
        i++;
      }
      else
      {
  ...
  rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.count =(uint8) i;  
 
  /* Update UE Radio Capability Update Requirement */  
  rrcdata_misc_info.rrc_capability_update_requirement.ue_radio_capability_update_requirement =
...
)
{
       ...
       rrc_CapabilityUpdateRequirement_r7,systemSpecificCapUpdateReqList))
  {
    ...
    {   
      ...
      {
        rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.value[i] = RRC_GERANIU_CAP;
        i++;
      }
      else
      {
...
)
{
        ...
        rrc_CapabilityUpdateRequirement_r8,systemSpecificCapUpdateReqList))
  {
    ...
    {   
      ...
      {
        rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.value[i] = RRC_EUTRA_CAP;
        i++;
      }
      else
      {
...
FUNCTION rrcuece_copy_req_eutra_freq_band_list_r10  

DESCRIPTION
  This function stores the contents of R10 IE 'Requested E-UTRA Frequency Band list' if present in RRC connection setup message
...
===========================================================================*/
void rrcuece_copy_req_eutra_freq_band_list_r10(sys_modem_as_id_e_type wrrc_as_id, rrc_RRCConnectionSetup_r10 *r10_ptr)
{
  uint8 count =0;
  for(count = 0; count < rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.count && count < 16;count++)
  {
    ...
    {
      if((r10_ptr->m.vaj0NonCriticalExtensionsPresent) &&
         (r10_ptr->vaj0NonCriticalExtensions.rrcConnectionSetup_vaj0ext.m.capabilityUpdateRequirementPresent)
        )
        {
          uint8 index =0;
          rrc_EUTRAbandSpecificCapUpdateReqList list;
          WRRC_MSG0_HIGH("Vaj0ext NW requested eUTRAbandSpecificCapUpdateReqList Present");
          list = r10_ptr->vaj0NonCriticalExtensions.rrcConnectionSetup_vaj0ext.capabilityUpdateRequirement.eUTRAbandSpecificCapUpdateReqList;
          rrcdata_misc_info.rrc_capability_update_requirement.req_EUTRA_frequency_band_list_present = TRUE;
          rrcdata_misc_info.rrc_capability_update_requirement.num_requested_bands = 0;
          for(index=0; (index<list.n && index<RRC_NW_REQ_MAX_NUM_LTE_CAP_BANDS); index++)
          {
            rrcdata_misc_info.rrc_capability_update_requirement.requested_bands[index]= list.elem[index] - 1; //Subtraction by 1 is to match the enum.
            rrcdata_misc_info.rrc_capability_update_requirement.num_requested_bands++;
          }
        }
        break;
    }
      ...
      else /* ASN1 decoding is successful */
      {
        ...
        else /* Valid Transaction id */
        {
          ...
          /* Copy UE Capability Update Requirement from the UE Capability
             Enquiry message */
          rrcuece_copy_capability_update_requirement(wrrc_as_id,
            dcch_msg_ptr->message.u.ueCapabilityEnquiry.u.r3.
                   ...
                   v770NonCriticalExtensions.v860NonCriticalExtensions.ueCapabilityEnquiry_v860ext.capabilityUpdateRequirement.m.systemSpecificCapUpdateReqListPresent))
          {
              ...
              uint8 count = 0, i = rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.count;
              ...
              {   
                ...
                else if(systemSpecificCapUpdateReqList->elem[count] == rrc_SystemSpecificCapUpdateReq_r8_eutra)
                {
                  ...
                  if((WCDMA_RRC_IDLE_FEATURES(RRC_NW_REQ_LTE_BAND_CAP_REPORT))&&
                     (dcch_msg_ptr->message.u.ueCapabilityEnquiry.u.r3.laterNonCriticalExtensions.v4b0NonCriticalExtensions.v590NonCriticalExtensions.
                      v770NonCriticalExtensions.v860NonCriticalExtensions.m.vaj0NonCriticalExtensionsPresent) &&
                     (dcch_msg_ptr->message.u.ueCapabilityEnquiry.u.r3.laterNonCriticalExtensions.v4b0NonCriticalExtensions.v590NonCriticalExtensions.
                      v770NonCriticalExtensions.v860NonCriticalExtensions.vaj0NonCriticalExtensions.ueCapabilityEnquiry_vaj0ext.m.capabilityUpdateRequirementPresent))
                  {
                    uint8 index = 0;
                    rrc_EUTRAbandSpecificCapUpdateReqList list;
                    WRRC_MSG0_HIGH("Vaj0ext NW requested eUTRAbandSpecificCapUpdateReqList Present");
                    list = dcch_msg_ptr->message.u.ueCapabilityEnquiry.u.r3.laterNonCriticalExtensions.v4b0NonCriticalExtensions.v590NonCriticalExtensions.
                         v770NonCriticalExtensions.v860NonCriticalExtensions.vaj0NonCriticalExtensions.ueCapabilityEnquiry_vaj0ext.capabilityUpdateRequirement.eUTRAbandSpecificCapUpdateReqList;
                    rrcdata_misc_info.rrc_capability_update_requirement.req_EUTRA_frequency_band_list_present = TRUE;
                    rrcdata_misc_info.rrc_capability_update_requirement.num_requested_bands = 0;
                    for(index=0; (index<list.n && index<RRC_NW_REQ_MAX_NUM_LTE_CAP_BANDS); index++)
                    {
              ...
              /* Update the count for the Inter system Capability Update Requirement */
              rrcdata_misc_info.rrc_capability_update_requirement.system_specific_cap_update_req_list.count = i;
          }
...
)
{
  ...
  rrc_crash_debug_save_proc_substates(wrrc_as_id,RRC_PROCEDURE_UECE,RRC_INVALID_PROC_SUBSTATE,cmd_ptr->cmd_hdr.cmd_id);
  ...
  switch (rrc_state)
  {
    ...
    case RRC_STATE_CELL_DCH:  
      ...
      rrcuece_process_ue_capability_enquiry_msg(wrrc_as_id,cmd_ptr); 
      break;
    ...
    default: 
      ...
      WRRC_ERR1_FATAL("Event fwded to UECE in invalid State: %d",rrc_state);
      break;
   }  
} /* rrcuece_procedure_event_handler */
/*===========================================================================
