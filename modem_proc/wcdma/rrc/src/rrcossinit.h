...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcossinit.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
void rrc_obj_sys_init(sys_modem_as_id_e_type wrrc_as_id);
...
void rrc_osys_set_mem_functions(sys_modem_as_id_e_type wrrc_as_id);
