...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrclog.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrc_log_search_request_info
(
  sys_modem_as_id_e_type wrrc_as_id,
  uint8 search_type,
  void* ptr
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrc_log_search_confirm_info
(
  sys_modem_as_id_e_type wrrc_as_id, 
  uint8 cnf_type,
  void* ptr
