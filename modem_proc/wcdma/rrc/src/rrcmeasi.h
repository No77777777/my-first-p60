...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcmeasi.h#5 $ $DateTime: 2020/07/13 12:41:39 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  l1_inter_sys_cell_list_struct_type inter_sys_sib12_new_cell_list;
...
typedef struct
{
  ...
  /*-------------------------------------------------------------------
   ...
   --------------------------------------------------------------------*/
  intra_freq_meas_id_list_struct_type  intra_freq_meas_id_list[MAX_INTRA_FREQ_MEAS];
  intra_freq_meas_id_list_struct_type  tmp_intra_freq_meas_id_list[MAX_INTRA_FREQ_MEAS];
  /* Declared to store new intra freq cell list that is being built */
  l1_intra_freq_cell_list_struct_type intra_freq_sib12_new_cell_list;
  
  /*------------------------------------------------------------------------
     * Indicates if RACH report would be appended to RACH message
     * Initialized in rrcmeas_init_procedure fn
    --------------------------------------------------------------------------*/
  rach_report_crit_e_type sib11_rach_report_crit;
  rach_report_crit_e_type sib12_rach_report_crit;
  ...
  --------------------------------------------------------------------*/
  intra_freq_cell_list_struct_type  intra_freq_cell_list[MAX_NUM_CARR][L1_MAX_CELL_MEAS];
...
#ifdef FEATURE_LTE_TO_WCDMA
  boolean is_dch_to_pch_new_cell_ind_processed;
#endif
  
#ifdef FEATURE_EUTRA_DETECT
  boolean is_sib19_eutradetect_present;
#endif

#if defined (FEATURE_CGPS_UMTS_CP_WCDMA)
  boolean pos_meas_failure;
#endif
  
  boolean discard_EUTRA_info_from_SIB19;
  
  /* Every time SCR code is changed in Idle or Fach state, the old one is updated in this var */
  uint16 last_scr_code;

  /*-------------------------------------------------------------------
  STRUCTURE: l1_meas_sib_parm_struct_type
  Stores the SIB parameters from SIB 11.
  --------------------------------------------------------------------*/
  l1_meas_sib_parm_struct_type   *rrcmeas_sib12;
  l1_inter_freq_cell_list_struct_type *rrcmeas_inter_freq_sib11;
  l1_inter_freq_cell_list_struct_type *rrcmeas_inter_freq_sib12;
  l1_meas_trans_type            *state_transition_meas;
  
#if defined (FEATURE_CGPS)
  /* Stores the cell id, plm id, psc, freq everytime a new cell is selected */
  rrcmeas_plmn_cell_info_struct_type plmn_cell_info;
#endif
}rrcmeas_int_data_type;

typedef enum
{
  CM_STATUS_UNCHANGED,
  CM_STATUS_CHANGED
}rrcmeas_cm_info_changed_status_e_type;

typedef struct
{
  rrcmeas_cm_info_changed_status_e_type status;
  l1_cm_status_info_struct_type         status_info;
}rrc_cm_mode_info_type;
...
typedef struct
{
  ...
  boolean process_interfreq_interrat_meas_rel7;
   ...
   */
  boolean process_interfreq_uei_meas_rel7;

  /* this counter tracks the pending measurement reports in the rlc queue */
  uint8 rrcmeas_pending_rpt;

  boolean dch_to_pch_in_progress;
  ...
  /* SIB19 band mask of current cell used for filling capability */
#ifdef LTE_BAND_NUM
  sys_lte_band_mask_e_type rrcueci_sib19_band_mask;
#else
  sys_band_mask_type rrcueci_sib19_band_mask;
#endif

  rrc_cm_mode_info_type          cm_mode_info;

  /*-------------------------------------------------------------------
     STRUCTURE: l1_meas_sib_parm_struct_type
     Stores the SIB parameters from SIB 11.
   --------------------------------------------------------------------*/
  l1_meas_sib_parm_struct_type   *rrcmeas_sib11;

  wcdma_rrc_qmi_current_freqs_type current_freqs_info;
  wcdma_rrc_qmi_current_freqs_type backup_current_freqs_info;
}rrcmeas_ext_data_type;

#ifdef FEATURE_DUAL_WCDMA 
extern rrcmeas_ext_data_type rrcmeas_ext_data_sim[MAX_RRC_STACKS];
extern rrcifreq_ext_data_type rrcifreq_ext_data_sim[MAX_RRC_STACKS];
extern rrcirat_ext_data_type  rrcirat_ext_data_sim[MAX_RRC_STACKS];

#define rrcmeas_ext_data rrcmeas_ext_data_sim[WAS_ID_M]
#define rrcifreq_ext_data rrcifreq_ext_data_sim[WAS_ID_M]
#define rrcirat_ext_data rrcirat_ext_data_sim[WAS_ID_M]

#else
extern rrcmeas_ext_data_type rrcmeas_ext_data;
extern rrcifreq_ext_data_type rrcifreq_ext_data;
extern rrcirat_ext_data_type  rrcirat_ext_data;
#endif
...
===========================================================================*/
void rrcmeas_handle_dch_to_pch_state_change(sys_modem_as_id_e_type wrrc_as_id);
...
void rrcmeas_delete_meas(sys_modem_as_id_e_type wrrc_as_id, uint16* meas_id_ptr);
...
void rrcgps_get_cgps_ue_pos_capability
(
  sys_modem_as_id_e_type wrrc_as_id,
...
void rrcmeas_trash_and_send_meas_failure(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
void rrctvm_delete_sib_tvm_config(sys_modem_as_id_e_type wrrc_as_id);
...
void rrcmeas_handle_cell_sel_meas_req_in_fach(sys_modem_as_id_e_type wrrc_as_id);
...
void rrcgps_fill_measured_results_ganss_incl(sys_modem_as_id_e_type wrrc_as_id,
...
===================================================
*/
void rrcgps_fill_meas_ctrl_ganss_assistance_data(sys_modem_as_id_e_type wrrc_as_id,
  rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
  rrc_UE_Positioning_Measurement_r8 *up_Measurement_ptr
);
...
=====================================================
*/
void rrcgps_fill_lsm_assistance_data(sys_modem_as_id_e_type wrrc_as_id,
  rrc_DL_DCCH_Message *dcch_msg_ptr,
...
void rrcgps_fill_measured_results_pos_err_incl(sys_modem_as_id_e_type wrrc_as_id,
rrc_UL_DCCH_Message* msg_ptr,
rrc_meas_rpt_struct_type *lsm_meas_ptr
);
/* ====================================================
...
boolean rrcgps_fill_measured_result_pos_est_incl(sys_modem_as_id_e_type wrrc_as_id,
rrc_UL_DCCH_Message* msg_ptr,
rrc_meas_rpt_struct_type *lsm_meas_ptr
);
...
======================================================== */
void rrcgps_set_bitmask_IE_ext770(sys_modem_as_id_e_type wrrc_as_id,
rrc_UL_DCCH_Message* msg_ptr
);
/*===========================================================================
...
===========================================================================*/
void rrcgps_fill_generic_data_ganss_id(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_time_model_list(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_add_navigation_models(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_real_time_integrity(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_ref_meas_info(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type * meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_almanac_r8(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type * meas_ctrl_params_ptr,
...
void rrcgps_fill_generic_data_add_utc_models(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type * meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_aux_info(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type * meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_meas_ctrl_ganss_assistance_data_r9(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
...
===========================================================================*/
void rrcgps_fill_generic_data_ref_meas_info_r10(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type * meas_ctrl_params_ptr,
rrc_UE_Positioning_GANSS_ReferenceMeasurementInfo_r10 uePositioningGANSSReferenceMeasurementInfo,uint8 index);
...
===========================================================================*/
void rrcgps_fill_generic_data_almanac_r10(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type * meas_ctrl_params_ptr,
rrc_UE_Positioning_GANSS_Almanac_r10 uePositioningGANSSAlmanac,uint8 index);
...
===========================================================================*/
void rrcgps_fill_generic_data_time_model_list_r10(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
rrc_GANSSTimeModelsList_r10 ganssTimeModelsList,uint8 index);
...
DESCRIPTION
 ...
 Fills  ganss assistance data for rel10
...
===========================================================================*/
void rrcgps_fill_meas_ctrl_ganss_assistance_data_r10(sys_modem_as_id_e_type wrrc_as_id,
rrc_meas_ctrl_struct_type *meas_ctrl_params_ptr,
...
/*===========================================================================
FUNCTION   rrcueim_process_mcm_r10

DESCRIPTION

 Processed UE internal measurements rel 10
...
SIDE EFFECTS
 ...
 None
===========================================================================*/
uecomdef_status_e_type rrcueim_process_mcm_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_cmd_type* cmd_ptr,
  uint32 transaction_id
...
/*===========================================================================
FUNCTION   RRCMEAS_RETRIEVE_MEAS_OWNER_R10
...
rrcmeas_layer_e_type rrcmeas_retrieve_meas_owner_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
rrc_MeasurementCommand_r10* mcm_ptr,
uint32 meas_id
#if defined (FEATURE_CGPS_UMTS_CP_WCDMA)
,pos_info_struct_type* pos_info_ptr
#endif
...
FUNCTION   rrcmeas_process_mcm_r10

DESCRIPTION

    This function processed the Release 10 Meas Ctrl Message
...
FUNCTION   RRCMEAS_CONFIG_INTRA_FREQ_DB_R10
...
boolean rrcmeas_config_intra_freq_db_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
 l1_meas_ctrl_parm_struct_type* l1_mcm_ptr,
 meas_validity_enum_type m_validity,
...
/*===========================================================================
FUNCTION   RRCMEAS_PROCESS_MCM_ADDNL_MEAS_R10

DESCRIPTION

 Processed the additional measurements IE received in Rel 10 Measurement control message
...
SIDE EFFECTS
 ...
 None
===========================================================================*/
boolean rrcmeas_process_mcm_addnl_meas_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_MeasurementControl_r10 *mcm_r10,
  uint8 transaction_id,
...
FUNCTION   RRCMEAS_CHECK_IF_ADDNL_MEAS_ID_EXTN_IS_GIVEN_R10
...
===========================================================================*/
boolean rrcmeas_check_if_addnl_meas_id_extn_is_given_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_MeasurementControl_r10 *mcm_r10
);
...
FUNCTION   RRCMEAS_CHECK_IF_MEAS_ID_EXTN_IS_GIVEN_R10
...
===========================================================================*/
boolean rrcmeas_check_if_meas_id_extn_is_given_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
rrc_MeasurementControl_r10 *mcm_r10, 
uint8 *meas_id
...
/*===========================================================================
FUNCTION   rrctvm_process_traffic_vol_info_r10
...
SIDE EFFECTS
 ...
 None
===========================================================================*/
rrctvm_status_e_type rrctvm_process_traffic_vol_info_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_cmd_type* cmd_ptr,
  uint32 transaction_id
...
/*===========================================================================
FUNCTION   rrcqm_process_mcm_r10

DESCRIPTION

Process quality measurements rel 10
...
SIDE EFFECTS
 ...
 None
===========================================================================*/
uecomdef_status_e_type rrcqm_process_mcm_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_cmd_type* cmd_ptr,
  uint8 transaction_id
...
FUNCTION  RRCMEAS_PROCESS_MCM_INTRA_F_CELL_INFO_R10
...
rrcmeas_status_e_type rrcmeas_process_mcm_intra_f_cell_info_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
rrc_IntraFreqCellInfoList_r10* intra_freq_cell_info_list_ptr,
l1_intra_freq_meas_ctrl_struct_type* l1_intra_f_mcm_ptr
);

/*===========================================================================

FUNCTION  RRCMEAS_FILL_COMMON_MCM_INTRA_F_INFO_R10
...
rrcmeas_status_e_type rrcmeas_fill_common_mcm_intra_f_info_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
rrc_IntraFrequencyMeasurement_r10* intra_f_meas_ptr,
l1_intra_freq_meas_ctrl_struct_type* l1_intra_f_mcm_ptr,
l1_meas_ctrl_parm_struct_type *l1_mcm 
);

/*===========================================================================
FUNCTION   RRCMEAS_PROCESS_INTRAFREQ_R10

DESCRIPTION

 Processed Intra Freq Meas in Rel10 Meas Ctrl Message
...
SIDE EFFECTS
 ...
 None
===========================================================================*/
uecomdef_status_e_type rrcmeas_process_intrafreq_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_cmd_type* cmd_ptr,
  uint8 transaction_id
...
/*===========================================================================
FUNCTION   RRCMEAS_CHECK_ADDNL_MEAS_IN_DB_r10
...
SIDE EFFECTS
 ...
 None
===========================================================================*/
void rrcmeas_check_addtl_meas_in_db_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrcmeas_layer_e_type *primary_meas_type,
  rrc_MeasurementControl_r10 *mcm_r10, 
...
FUNCTION      RRCMEAS_FILL_NO_OF_REPORTING_CELLS_R10
...
uecomdef_status_e_type rrcmeas_fill_no_of_reporting_cells_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
rrc_ReportingCellStatus_r10  *rrc_rpt_cell_status_ptr,
l1_meas_rpt_cell_status_struct_type  *l1_rpt_cell_status_ptr
);
...
FUNCTION   RRCMEAS_PROCESS_COMPRESSED_MODE_STATUS_R10
...
uecomdef_status_e_type rrcmeas_process_compressed_mode_status_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_DPCH_CompressedModeStatusInfo_r10* rrc_cm_ptr,
  l1_cm_status_info_struct_type* l1_cm_ptr
);
...
FUNCTION   rrcmeas_handle_periodic_meas_sec_ul
...
===========================================================================*/
void rrcmeas_handle_periodic_meas_sec_ul
(
  sys_modem_as_id_e_type wrrc_as_id,
rrc_MeasurementControl_r10* mcm_r10,
l1_intra_freq_meas_ctrl_struct_type* l1_intra_f_mcm_ptr
...
FUNCTION   rrcmeas_init_cm_status_info

DESCRIPTION

 This function initialized CM status info db
...
void rrcmeas_init_cm_status_info(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
/*====================================================================
FUNCTION: RRCMEAS_SEND_QMI_CURRENT_FREQS_INFO_IND

DESCRIPTION:
  This function sends the current configured freqs to CMAPI provided if the info is changed.
...
void rrcmeas_send_qmi_current_freqs_info_ind( sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_e_type cmd_id);

/*====================================================================
FUNCTION: RRCMEAS_SEND_QMI_CURRENT_FREQS_INFO_RSP

DESCRIPTION:
  This function sends the rsp with the last configured freqs upon CMAPI req.
  CMAPI sends the Req when the display is getting ON.
...
SIDE EFFECTS:
====================================================================*/
void rrcmeas_send_qmi_current_freqs_info_rsp( sys_modem_as_id_e_type wrrc_as_id );

/*====================================================================
FUNCTION: rrcmeas_invalidate_qmi_current_freqs_info

DESCRIPTION:
  This function invalidates current configured freq info and update the same to CMAPI.
...
void rrcmeas_invalidate_qmi_current_freqs_info( sys_modem_as_id_e_type wrrc_as_id);
/*=======================================================================================

FUNCTION rrcmeas_ssgccs_update_UTRA_priority_info()

DESCRIPTION

  This function updates the SIB19 UTRA Neighbor & Priority information to SSGCCS QMI Client 
...
void rrcmeas_ssgccs_update_UTRA_priority_info(sys_modem_as_id_e_type wrrc_as_id,wcdma_ssgccs_3g_cell_info_ind_s *wcdma_info);
/*=======================================================================================
FUNCTION rrcmeas_ssgccs_update_GSM_priority_info()

DESCRIPTION

  This function updates the SIB19 GSM Neighbor & Priority information to SSGCCS QMI Client 
...
============================================================================================*/
void rrcmeas_ssgccs_update_GSM_priority_info(sys_modem_as_id_e_type wrrc_as_id, wcdma_ssgccs_3g_cell_info_ind_s *wcdma_info);
/*=======================================================================================
FUNCTION rrcmeas_ssgccs_update_EUTRA_priority_info()

DESCRIPTION

  This function updates the SIB19 EUTRA Neighbor & Priority information to SSGCCS QMI Client 
...
============================================================================================*/
void rrcmeas_ssgccs_update_EUTRA_priority_info(sys_modem_as_id_e_type wrrc_as_id,wcdma_ssgccs_3g_cell_info_ind_s *wcdma_info);

/*===========================================================================
FUNCTION rrcmeas_ssgccs_send_sib19_info()

DESCRIPTION

  This function updates the SIB19 Neighbor information to SSGCCS QMI Client 
...
===========================================================================*/
void rrcmeas_ssgccs_send_sib19_info(sys_modem_as_id_e_type wrrc_as_id,wcdma_ssgccs_3g_cell_info_ind_s *wcdma_info);
