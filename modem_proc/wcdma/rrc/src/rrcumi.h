...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcumi.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
void rrcumi_init_procedure(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
void rrcumi_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
