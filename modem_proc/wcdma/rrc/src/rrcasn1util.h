...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcasn1util.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/17/19   gc......Complation fix
...
extern OSCTXT enc_ctxt_sim[MAX_RRC_STACKS];
extern rrcasn1util_obj_ctxt_list_type *dec_ctxt_list_sim[MAX_RRC_STACKS];
#define enc_ctxt enc_ctxt_sim[WAS_ID_M]
#define dec_ctxt_list dec_ctxt_list_sim[WAS_ID_M]
#else
...
rrcasn1util_obj_ctxt_list_type dec_ctxt_list_glob_var[RRC_MAX_NUM_ASN1_CTXT];
#endif
...
===========================================================================*/
void rrc_free_dec_ctxt_list(sys_modem_as_id_e_type wrrc_as_id);
