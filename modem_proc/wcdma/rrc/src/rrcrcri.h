...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcrcri.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
typedef struct
{
  rrcrcr_substate_e_type rrcrcr_substate;
  uint32 rrcrcr_n_308;    /* Variable to store max number of 
                             RRC CONNECTION RELEASE COMPLETE 
                             retransmission */
  boolean rrcrcr_cell_reselection_occured; 
                          /* This indicates whether cell reselection
                             occured during RCR procedure */
  rrc_RRC_TransactionIdentifier rrcrcr_transaction_identifier;
                          /* This stores the transaction Id for
                             RRC Connection Release message */
  rrcrcr_error_indication_status_e_type rrcrcr_error_ind; 
                          /* This stores the information whether to 
                             include error cause in the RRC
                             Connection Release Complete Msg */
  rrc_redirect_req_type saved_redirect_info;
  boolean redirection_info_present;
  boolean rrc_ifreq_rdr_in_prgrs;
}rrcrcr_int_data_type;
...
/*===========================================================================
FUNCTION rrcrce_get_rcr_sub_state()
...
none
===========================================================================*/
rrcrcr_substate_e_type  rrcrce_get_rcr_sub_state(sys_modem_as_id_e_type wrrc_as_id);
