...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcllci.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/14/17   sp      Changes for LTA timeline optimization
12/01/15   as      Made changes to trigger cphy act cancel only if cphy setup is in progress for procedure which set OC
06/15/15   sp      Made changes to allow preemption for OC set cases in Cell_DCH state if activation time is sufficiently large
03/30/15   sp      Made changes to update pdu_size_present flag based on UL re-establish entity
...
typedef struct
{
  l1_ext_cmd_type   *cphy_setup_req_ptr;
}resume_data_s_type;
...
#endif /* FEATURE_WCDMA_DC_HSUPA */
  boolean wait_for_activation_time;/*Set to true if activation time is running at L1*/

  resume_data_s_type resume_data;
...
SIDE EFFECTS:
  None
===========================================================================*/
 void rrcllc_init_old_ul_rlc_size_backup(sys_modem_as_id_e_type wrrc_as_id);
/*====================================================================
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrcllc_store_last_active_cell_capability(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
SIDE EFFECTS:
  None.
====================================================================*/
boolean rrcllc_check_if_hsrach_to_legacy_cell_change_happened(sys_modem_as_id_e_type wrrc_as_id);
/*====================================================================
...
SIDE EFFECTS:
  None.
====================================================================*/
rrc_cell_capability_type rrcllc_get_old_cell_capability(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
  ...
  none
  ===========================================================================*/
  uint8  rrcllc_get_current_substate(sys_modem_as_id_e_type wrrc_as_id);
/*===========================================================================
...
SIDE EFFECTS:
  None
===========================================================================*/
rrc_proc_e_type rrcllc_get_current_chan_conf_under_process_procedure(sys_modem_as_id_e_type wrrc_as_id);
