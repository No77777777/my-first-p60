...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcdormancy.h#2 $
...
#define rrcdorm_substate_e_type_value0 RRCDORMANCY_INITIAL					 
#define rrcdorm_substate_e_type_value1 RRCDORMANCY_WAIT_FOR_CU_COMP_CNF			 																					 
#define rrcdorm_substate_e_type_value2 RRCDORMANCY_WAIT_FOR_L2ACK 				 																					 
#define rrcdorm_substate_e_type_value3 RRCDORMANCY_WAIT_FOR_SIG_CON_REL_COMPL 
...
typedef struct
{
  rrcdormancy_substate_e_type substate;
  rrcdormancy_fast_dormancy_req_type saved_fast_dormancy_req;
    
  /*Stores T323 timer and N/W support Status */ 
  rrcdormancy_conn_timers_and_constants_type conn_timers_and_constants;
  
  /* Stores the count that guard sending of SCRI in CELL_PCH/URA_PCH states */
  unsigned short v_316;

  uint8 max_scri_for_fd;
}rrcdorm_int_data_type;
...
void rrcdormancy_update_dormancy_params
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_T_323 t323_duration
);
