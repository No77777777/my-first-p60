...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrctcreconfig.c#3 $   
...
typedef struct {
  ...
  boolean rrctcrc_send_initiate_cu_flag;
  
  boolean rrctcrc_delete_crnti;
...
LOCAL rrctcrc_int_data_type tcrc_sim[MAX_RRC_STACKS];
#define tcrc tcrc_sim[WAS_ID_M]
#else
...
#endif
rrcrb_substate_e_type rrctcrc_get_current_sub_state(sys_modem_as_id_e_type wrrc_as_id)
{
...
===========================================================================*/
rrc_state_e_type rrctcrc_get_dest_state(sys_modem_as_id_e_type wrrc_as_id)
{
  return tcrc.state_indicated_by_msg;
}
 /*===========================================================================
 
 FUNCTION	rrctcrc_get_initiate_cu_flag()
 
 DESCRIPTION
  This function is used to return rrctcrc_send_initiate_cu_flag 
 ...
 ===========================================================================*/
 boolean rrctcrc_get_initiate_cu_flag(sys_modem_as_id_e_type wrrc_as_id)
 {
   return tcrc.rrctcrc_send_initiate_cu_flag;
 }
...
===========================================================================*/
boolean rrctcrc_is_proc_successful(sys_modem_as_id_e_type wrrc_as_id)
{
...
===========================================================================*/
void rrctcrc_update_failure_status(sys_modem_as_id_e_type wrrc_as_id,rrctc_msg_status_e_type status )
{
...
)
{
  ...
  (void)rrcsmc_append_start_list(wrrc_as_id,&msg_ptr->message.u.transportChannelReconfigurationComplete.
...
)
{
  ...
  /*Reports transport channel reconfiguration failure to QSH*/
  rrc_qsh_report_failure_ota_msg_event(wrrc_as_id,WRRC_UL_DCCH_MESSAGETYPE_TRANSPORTCHANNELRECONFIGURATIONFAILURE);
#endif

#ifdef FEATURE_WCDMA_QSH_EVENT_METRIC
  rrcqsh_log_uplink_dcch_ota_params(wrrc_as_id, WRRC_UL_DCCH_MESSAGETYPE_TRANSPORTCHANNELRECONFIGURATIONFAILURE, ptr);
#endif
  ...
  if(ul_lc_id != RRCLCM_RLC_LC_ID_NOT_FOUND)
  {
    ...
    {
      rrc_update_reconfig_waiting_for_l2ack_dch(wrrc_as_id, RRC_PROCEDURE_TCR);
      status = rrcsend_send_ul_sdu(wrrc_as_id,RRC_PROCEDURE_TCR,  /* Procedure is TCRC    */
...
===========================================================================*/     
static void send_tcrc_complete_message(sys_modem_as_id_e_type wrrc_as_id, boolean proc_wait_for_l2_ack )
{
  ...
  {
    rrctcr_append_start_list_to_tcrc_complete(wrrc_as_id, ptr);
  }
  else
  {
    if (rrcllc_get_rlc_size_change_status(wrrc_as_id) 
      && ((tcrc.state_indicated_by_msg == RRC_STATE_CELL_PCH || 
          ...
          || (rrc_get_rlc_size_change_status_for_procedure_id(wrrc_as_id,RRC_PROCEDURE_TCR) == TRUE)))
    {
      ...
      else if (rrc_get_rlc_size_change_status_for_procedure_id(wrrc_as_id,RRC_PROCEDURE_TCR) == TRUE)
      {
  ...
  if(ul_lc_id != RRCLCM_RLC_LC_ID_NOT_FOUND)
  {
    ...
    (void) rex_set_timer(&tcrc.rrctcrc_temp_timer, 5000);   /* 5 seconds */

    tcrc.rrctcrc_sig = rex_wait(wrrc_as_id, RRCTCRC_TEMP_TIMER_SIG);
    MSG_MED("RRCTCRC signal->%d", tcrc.rrctcrc_sig, 0, 0);
    (void) rex_clr_sigs(rex_self(), RRCTCRC_TEMP_TIMER_SIG);
#endif /* FEATURE_RRC_DELAY_TX_ON_NEW_CFG */


#ifdef FEATURE_WCDMA_QSH_EVENT_METRIC
  rrcqsh_log_uplink_dcch_ota_params(wrrc_as_id, WRRC_UL_DCCH_MESSAGETYPE_TRANSPORTCHANNELRECONFIGURATIONCOMPLETE, ptr);
#endif
    WRRC_MSG0_HIGH("Sending TCRC Complete Message to send-chain");
    if (proc_wait_for_l2_ack)
    {
      status = rrcsend_send_ul_sdu(wrrc_as_id,RRC_PROCEDURE_TCR,  /* Procedure is RRC_PROCEDURE_TCR    */
                                   (void *)ptr,        /* Message pointer     */
                                   ul_lc_id,           /* RLC id              */
                                   RRCSEND_L2ACK_REQUIRED  /* ACK is required */
                                   );
...
)
{
  ...
  else if (MSG_REL10 == msg_version)
  {
    rrc_TransportChannelReconfiguration_r10_IEs *tcreconfig_ptr = &msg_ptr->u.later_than_r3.criticalExtensions.u.
    criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.later_r8_criticalExtensions.u.later_r9_criticalExtensions.u.r10.transportChannelReconfiguration_r10;
    if (RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,dl_InformationPerRL_List) )
    {
      if(tcreconfig_ptr->dl_InformationPerRL_List.elem[0].modeSpecificInfo.t ==
          T_rrc_DL_InformationPerRL_r8_modeSpecificInfo_fdd)
      {
        rrctcrc_psc = tcreconfig_ptr->dl_InformationPerRL_List.elem[0].modeSpecificInfo.
        u.fdd->primaryCPICH_Info.primaryScramblingCode;
        result = TRUE;
      }
    }
  ...
  WRRC_MSG3_HIGH("Primary SCR in TCRC message %d result %d for msg_version:%d(0-MSG_REL99,1-MSG_REL5,2-MSG_REL6,3-MSG_REL7,4-MSG_REL8,5-MSG_REL9,6-MSG_REL10,other-MSG_INVALID)",rrctcrc_psc,result,msg_version);
  return result;
...
)
{
  ...
  {
    rrc_TransportChannelReconfiguration_r10_IEs *tcreconfig_ptr = &msg_ptr->u.later_than_r3.
    criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.later_r8_criticalExtensions.u.later_r9_criticalExtensions.u.r10.transportChannelReconfiguration_r10;

     /*check whether dl_counter_sync info is present or not . Do not check for
    the contents of DL_counter_sync_info. First the integrity check has tobe made
    with new integrity protection mode info in the message. Later we can check
    the dl_counter_sync_info contents and send a failure if PDCP info is present */
    if (RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,dl_CounterSynchronisationInfo) )
    {
      return TRUE;
    }
  }
...
)
{
  ...
  /*check whether the SRNS relocation is within Cell_DCH or not.
          ...
          ( rrc_get_state(wrrc_as_id) == RRC_STATE_CELL_DCH)))
    {
      WRRC_MSG2_ERROR("SRNS reloc with invalid states cur_state %d, msg_state %d",
             rrc_get_state(wrrc_as_id), tcrc.state_indicated_by_msg);
    ...
    /* store if new U-RNTI is present in the message */
          ...
          rrc_TransportChannelReconfiguration_r3_IEs,new_U_RNTI))
      {
        ...
        rrc_translate_urnti (wrrc_as_id,&(msg_ptr->u.r3.transportChannelReconfiguration_r3.new_U_RNTI),
                             &tcrc.new_urnti);
      }
    }
  }
   ...
   */
  tcrc.trans_to_dch_ciph_config_needed = FALSE;
  if((tcrc.state_indicated_by_msg == RRC_STATE_CELL_DCH) && ( rrc_get_state(wrrc_as_id) != RRC_STATE_CELL_DCH))
  {
      ...
      (tcrc.state_indicated_by_msg == RRC_STATE_URA_PCH))
  {
     ...
     if (tcrc.state_indicated_by_msg == RRC_STATE_URA_PCH)
     {
       ...
       else
       {
         ...
         {
           rrccu_update_ura_id (wrrc_as_id,&(msg_ptr->u.r3.transportChannelReconfiguration_r3.ura_Identity));
         }
         else
         {
...
)
{
       ...
       rrc_TransportChannelReconfiguration_r5_IEs,dl_HSPDSCH_Information) )
  {
    ...
    status = rrc_hsdpa_initial_validation(wrrc_as_id,tcrc_ptr->rrc_StateIndicator, 
  ...
  /*check whether the SRNS relocation is within Cell_DCH or not.
    ...
    /* store if new U-RNTI is present in the message */
      ...
      {
        tcrc.new_urnti_valid = TRUE;
        rrc_translate_urnti (wrrc_as_id,&(tcrc_ptr->new_U_RNTI),
                             &tcrc.new_urnti);
      }
    }
  }
      ...
      (tcrc.state_indicated_by_msg == RRC_STATE_URA_PCH))
  {
     ...
     if (tcrc.state_indicated_by_msg == RRC_STATE_URA_PCH)
     {
       ...
       else
       {
         ...
         {
           rrccu_update_ura_id (wrrc_as_id,&(tcrc_ptr->ura_Identity));
         }
         else
         {
           WRRC_MSG1_ERROR("Invalid URA ID length%d",
...
)
{
  ...
  {
    /* Check if network does not try to initiate HSDPA with invalid state */
    status = rrc_hsdpa_initial_validation_r6(wrrc_as_id,tcrc_ptr->rrc_StateIndicator, 
...
)
{
  ...
  if( (rrc_get_state(wrrc_as_id)) == (tcrc.state_indicated_by_msg) )
  {
  ...
  rrc_fill_rb_id_chan_req_from_standalone_db(wrrc_as_id,&rb_count, &ptr->cmd.chan_config_req);

  if(tcrc.state_indicated_by_msg == RRC_STATE_CELL_DCH)
  {
    /* Fill those RBs in chan_config_req for which RLC PDU size has changed and 
      that are already not present in chan_config_req*/
    rrc_fill_rb_id_chan_req_from_rb_list_mapped_to_dch(wrrc_as_id,&rb_count, &ptr->cmd.chan_config_req);
...
===========================================================================*/
static void rrctcrc_clear_procedure(sys_modem_as_id_e_type wrrc_as_id)
{
  ...
  tcrc.rrctcrc_send_initiate_cu_flag = FALSE;
  tcrc.rrctcrc_delete_crnti          = FALSE;
  ...
  rrc_common_procedure_clear(wrrc_as_id,RRC_PROCEDURE_TCR);
}
...
)
{
  ...
  {
    WRRC_MSG3_HIGH("Incomatible simultaneous reconfig! Rejecting TC RC message trans_id:%d,accepted tr_id:%d,rejected tr-id:%d", 
    ...
    if((transaction_id != tcrc.tr_ids.accepted_transaction ) && (transaction_id  != tcrc.tr_ids.rejected_transaction))
    {
         ...
         (RRCCU_STARTED == rrccu_get_cell_update_started_status(wrrc_as_id) ))
      {
        ...
        {
          send_tcrc_failure_message(wrrc_as_id,tcrc.status.failure_status,
        ...
        else
        {
          ...
          if (SUCCESS != rrccu_register_for_cell_update_to_complete(wrrc_as_id,RRC_PROCEDURE_TCR))
          {
...
)
{
  ...
  if (tcrc.cn_info_saved != FALSE)
  {
    if(tcrc.mm_cmd_ptr->cmd.hdr.message_id == (byte) RRC_SERVICE_IND_FROM_OTA_MSG )
    {
       ...
       rrc_ccm_update_service_info(wrrc_as_id, tcrc.mm_cmd_ptr);
    }
    /* Put the command on MM queue */
    rrc_send_rrc_message_to_mm(wrrc_as_id, tcrc.mm_cmd_ptr);
    /* clear the flag */
    tcrc.cn_info_saved = FALSE;
  }
      ...
      (indicate_rlc == TRUE))
  {
    ...
    rrcrb_register_with_rlc_for_ul_data_ind (wrrc_as_id,RRC_PROCEDURE_TCR);
  ...
  rrctcrc_clear_procedure(wrrc_as_id);
  ...
  rrccu_reset_registration_info_for_procedure(wrrc_as_id,RRC_PROCEDURE_TCR);
...
)
{
  ...
  if (FAILURE == 
      rrctcrc_check_and_send_failure_for_simul_reconfig(wrrc_as_id,
  ...
  message */
  validate_tcreconfig_r7(wrrc_as_id,tcreconfig_ptr );
  ...
  else
  {
    ...
    if(RRCRBR_R7_MSG_IE_PRESENT (tcreconfig_ptr,rrc_TransportChannelReconfiguration_r7_IEs,cn_InformationInfo) ) 
    {
      ...
      tcrc.mm_cmd_ptr = rrc_ccm_buid_service_ind_with_nas_cn_info_r6(wrrc_as_id,
    ...
    oc_status = rrcllc_set_ordered_config(wrrc_as_id, RRC_PROCEDURE_TCR,
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL7))
          {
            ...
            (rrccsp_check_initiate_cell_selection_handling(wrrc_as_id,&directed_cell_info) == FALSE))
          {
            ...
            {
              tcrc.rrctcrc_send_initiate_cu_flag = TRUE;
              tcrc.rrctcrc_delete_crnti          = TRUE;
            }
            else
            {
           ...
           )
        {
          /*  CellDCH<->CellDCH or CellFACH<->CellFACH or CellFACH->CellDCH
              ...
              (tcrc.state_indicated_by_msg==RRC_STATE_CELL_FACH))
           {
             ...
             if ((tcrc.rrctcrc_send_initiate_cu_flag == FALSE) &&
                (rrcrb_validate_directed_cell_info (wrrc_as_id,directed_cell_info) == FALSE))
             {
               if(RRCRBR_R7_MSG_IE_PRESENT(tcreconfig_ptr,rrc_TransportChannelReconfiguration_r7_IEs,new_C_RNTI) )
               {
                 ...
                 rrc_translate_crnti(wrrc_as_id,&tcreconfig_ptr->new_C_RNTI, 
                                       &c_rnti);
           ...
           rrctcrc_send_channel_config_req(wrrc_as_id);
                  ...
                  (tcrc.state_indicated_by_msg==RRC_STATE_CELL_FACH))
        {
          ...
          /*Initiate the cell selection*/
          rrcrb_send_initiate_cell_selection_req(wrrc_as_id, RRC_PROCEDURE_TCR,
                 ...
                 (tcrc.state_indicated_by_msg==RRC_STATE_CELL_PCH))
        {
          /*store the directed cell info */
           tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL7);

           /*Send the TCRC complete msg on old configuration */
           send_tcrc_complete_message(wrrc_as_id,TRUE);
           /*wait for L2ack */
                 ...
                 (tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
         ...
         // tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(msg_ptr);
          ...
          if(RRCRBR_R7_MSG_IE_PRESENT(tcreconfig_ptr,rrc_TransportChannelReconfiguration_r7_IEs,new_C_RNTI) )
          {
            ...
            {
              rrc_translate_urnti(wrrc_as_id,&tcreconfig_ptr->new_U_RNTI, 
                                  &u_rnti);
      ...
      case ORDERED_CONFIG_CONFIGURATION_SET_DEFERRED:
        WRRC_MSG0_HIGH("BUF_OTA:TCR processing deferred due to LTA!");
    
        tcrc.curr_substate = RRCRB_INITIAL;
        rrc_buffer_ota_info.transaction_id = tcrc.tr_ids.accepted_transaction;
        /* Indicate that an error occured */
        ordered_config_err_occured = TRUE;
        break;
...
)
{
  ...
  invalid or incompatible configuration given by the
  message */
  validate_tcreconfig_r8(wrrc_as_id,tcreconfig_ptr );
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL8))
          {
            directed_cell_info.pscr_present = TRUE;
            directed_cell_info.pscr = tcreconfig_ptr->dl_InformationPerRL_List.elem[0].
                                      modeSpecificInfo.u.fdd->primaryCPICH_Info.primaryScramblingCode;
        ...
        {
          /*store the directed cell info */
           tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL6);
                 ...
                 (tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          {  
            if(tcrc.state_indicated_by_msg==RRC_STATE_CELL_PCH)
            {
              tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL8);
            }
...
)
{
  ...
  invalid or incompatible configuration given by the
  message */
  validate_tcreconfig_r9(wrrc_as_id,tcreconfig_ptr );
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL9))
          {
            directed_cell_info.pscr_present = TRUE;
            directed_cell_info.pscr = tcreconfig_ptr->dl_InformationPerRL_List.elem[0].
                                      modeSpecificInfo.u.fdd->primaryCPICH_Info.primaryScramblingCode;
                 ...
                 (tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          {  
            if(tcrc.state_indicated_by_msg==RRC_STATE_CELL_PCH)
            {
              tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL9);
            }
...
FUNCTION   VALIDATE_TCRECONFIG_R10

DESCRIPTION

  This function validates the received R10 TCRC Message. This includes
  checking for unsupported or invalid configurations, unknown extensions
  and invalid IEs.
...
===========================================================================*/
static void validate_tcreconfig_r10
(
  sys_modem_as_id_e_type wrrc_as_id, 
  rrc_TransportChannelReconfiguration_r10_IEs* tcrc_ptr /* Pointer to rel-6 TCRC message */
)
{
  uecomdef_status_e_type status;
  ...
  if(RRCRB_R10_MSG_IE_PRESENT(tcrc_ptr,dl_HSPDSCH_Information) ) 
  {
  ...
  is not supported in the first release. This may be supported
  later */                                    
  if(RRCRB_R10_MSG_IE_PRESENT(tcrc_ptr,dl_CounterSynchronisationInfo) )
   {
  /*check whether the SRNS relocation is within Cell_DCH or not.
     SRNS relocation information can come in reconfiguration messages
     only when the state transition is Cell_DCH->Cell_DCH */
    ...
    /* store if new U-RNTI is present in the message */
      if(RRCRB_R10_MSG_IE_PRESENT(tcrc_ptr,new_U_RNTI) ) 
      {
        tcrc.new_urnti_valid = TRUE;
        rrc_translate_urnti (wrrc_as_id,&(tcrc_ptr->new_U_RNTI),
                             &tcrc.new_urnti);
  ...
  {
    //check to see if dl-dpch-common info is present while going to dch
    if((RRCRB_R10_MSG_IE_PRESENT(tcrc_ptr,dl_CommonInformation) )
        && (RRC_MSG_COMMON_BITMASK_IE(tcrc_ptr->dl_CommonInformation,rrc_DL_CommonInformation_r10,dl_dpchInfoCommon))
  ...
  {
     /* If UTRAN DRX coefficient is not present then it is invalid configuration */
     if (!(RRCRB_R10_MSG_IE_PRESENT(tcrc_ptr,utran_DRX_CycleLengthCoeff) )  )
     {
       WRRC_MSG1_ERROR("UTRAN DRX Coef not preset, State:%d", tcrc.state_indicated_by_msg);
       tcrc.status.failure_status = RRCTC_MSG_INVALID_CONFIG;
       return;
     ...
     {
       /*should we do it after getting l2ack for response??*/
       if (!(RRCRB_R10_MSG_IE_PRESENT(tcrc_ptr,ura_Identity) ) )
...
}/* end function validate_tcreconfig_r10 */

/*===========================================================================

FUNCTION   PROCESS_TCRECONFIG_R10
...
===========================================================================*/
static void process_tcreconfig_r10
(
  sys_modem_as_id_e_type wrrc_as_id, 
  rrc_RRC_TransactionIdentifier transaction_id,
...
)
{
  ...
  invalid or incompatible configuration given by the
  message */
  validate_tcreconfig_r10(wrrc_as_id, tcreconfig_ptr );
  ...
  else
  {
    ...
    /* Check if there is CN information present. If so, we need
    to send the information to the Cell Change manager */
    if(RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,cn_InformationInfo) ) 
    {
      WRRC_MSG0_HIGH("Saving CN info for NAS");
      tcrc.mm_cmd_ptr = rrc_ccm_buid_service_ind_with_nas_cn_info_r6(wrrc_as_id,
        &(tcreconfig_ptr->cn_InformationInfo) );
  ...
  /*If TCRC OTA provides "supportForChangeOfUE_Capability" IE, we need to store it in
           "rrccouec.rrc_ordered_rnc_cap_change_support" so that later once the procedure is over successfully, global
           "rrc_rnc_cap_change_support" can be updated accordingly. */  
    if(RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,
    supportForChangeOfUE_Capability))
    {
      if(tcreconfig_ptr->supportForChangeOfUE_Capability == TRUE)
      {
...
#endif	
    if(RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,ueMobilityStateIndicator) ) 
    {
      if(tcreconfig_ptr->ueMobilityStateIndicator == rrc_High_MobilityDetected_high_MobilityDetected)
      {
        WRRC_MSG0_HIGH("High Mobility Ind Set to TRUE in TCRC.");
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
        ...
        if((current_state==RRC_STATE_CELL_FACH) && 
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          if((RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,frequencyInfo) )
             && (RRC_CHECK_COMMON_MSG_TYPE(tcreconfig_ptr->frequencyInfo.modeSpecificInfo,
                     rrc_FrequencyInfo_modeSpecificInfo_fdd)))
          {
            directed_cell_info.freq_info_present = TRUE;
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL10))
          {
            directed_cell_info.pscr_present = TRUE;
            directed_cell_info.pscr = tcreconfig_ptr->dl_InformationPerRL_List.elem[0].
                                      modeSpecificInfo.u.fdd->primaryCPICH_Info.primaryScramblingCode;
          ...
          /*  CellDCH<->CellDCH or CellFACH<->CellFACH or CellFACH->CellDCH
              ...
              (tcrc.state_indicated_by_msg==RRC_STATE_CELL_FACH))
           {
             ...
             if ((tcrc.rrctcrc_send_initiate_cu_flag == FALSE) &&
                (rrcrb_validate_directed_cell_info (wrrc_as_id,directed_cell_info) == FALSE))
             {
               if(RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,new_C_RNTI)) 
               {
                 tcrc.new_crnti_valid = TRUE;
                 rrc_translate_crnti(wrrc_as_id,&tcreconfig_ptr->new_C_RNTI, 
                                       &c_rnti);
                 ...
                 (tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          {  
            if(tcrc.state_indicated_by_msg==RRC_STATE_CELL_PCH)
            {
              tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL10);
            }
         ...
         // tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(msg_ptr);
          ...
          if(RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,new_C_RNTI) )
          {
            ...
            rnti_update_info.crnti        = (uint16)c_rnti;
            /* check whether URNTI is also present in the message */
            if (RRCRB_R10_MSG_IE_PRESENT(tcreconfig_ptr,new_U_RNTI) )
            {
              rrc_translate_urnti(wrrc_as_id,&tcreconfig_ptr->new_U_RNTI, 
                                  &u_rnti);
              rnti_update_info.urnti_action = RRC_RNTI_UPDATE; 
...
)
{
  ...
  invalid or incompatible configuration given by the
  message */
  validate_tcreconfig_r5(wrrc_as_id,msg_ptr );
  ...
  else
  {
        ...
        rrc_TransportChannelReconfiguration_r5_IEs,cn_InformationInfo))
    {
       ...
       */
       primary_plmn_Id_present = rrctcrc_check_and_get_primary_plmn_id(wrrc_as_id,msg_ptr,
                                                                  &primary_plmn_Identity,MSG_REL5);
    
      tcrc.mm_cmd_ptr = rrc_ccm_buid_service_ind_with_nas_cn_info(wrrc_as_id,
                     &(tcreconfig_ptr->cn_InformationInfo) 
    ...
    rrctc_process_high_mobility_ind_in_non_critical_ext(wrrc_as_id,msg_ptr,MSG_REL5);
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL5))
          {
            directed_cell_info.pscr_present = TRUE;
            directed_cell_info.pscr = tcreconfig_ptr->dl_InformationPerRL_List.elem[0].
                                      modeSpecificInfo.u.fdd->primaryCPICH_Info.primaryScramblingCode;
        ...
        {
          /*store the directed cell info */
           tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL5);
...
)
{
  ...
  invalid or incompatible configuration given by the
  message */
  validate_tcreconfig_r6(wrrc_as_id,tcreconfig_ptr );
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL6))
          {
            directed_cell_info.pscr_present = TRUE;
            directed_cell_info.pscr = tcreconfig_ptr->dl_InformationPerRL_List.elem[0].
                                      modeSpecificInfo.u.fdd->primaryCPICH_Info.primaryScramblingCode;
      ...
      criticalExtensions.u.r6.m.v6b0NonCriticalExtensionsPresent)
  {
    ...
    rrctc_process_high_mobility_ind_in_non_critical_ext(wrrc_as_id,msg_ptr,MSG_REL6);
...
)
{
  ...
  if (TRUE == rrctcrc_validate_srns_relocation_info(wrrc_as_id,msg_ptr, msg_version))
  {
...
)
{
  ...
  if (msg_ptr->t != T_rrc_TransportChannelReconfiguration_r3)
  {
           ...
           T_rrc_TransportChannelReconfiguration_criticalExtensions_5_criticalExtensions))
    {
      ...
      { 
        ...
        if (FAILURE == rrctcrc_validate_and_check_integrity_for_srns_relocation(wrrc_as_id,
        ...
        process_tcreconfig_r5(wrrc_as_id,cmd_ptr);
      }
               ...
               T_rrc_TransportChannelReconfiguration_criticalExtensions_3_r6))
      {
        ...
        process_tcreconfig_r6(wrrc_as_id,
          msg_ptr->u.later_than_r3.rrc_TransactionIdentifier,
               ...
               T_rrc_TransportChannelReconfiguration_criticalExtensions_2_r7))
      {
        ...
        process_tcreconfig_r7(wrrc_as_id,
          msg_ptr->u.later_than_r3.rrc_TransactionIdentifier,
          (rrc_DL_DCCH_Message *)cmd_ptr->cmd.downlink_sdu_ind.decoded_msg,
                  ...
                  rrc_TransportChannelReconfiguration)))
      {
        ...
        process_tcreconfig_r8(wrrc_as_id,
          msg_ptr->u.later_than_r3.rrc_TransactionIdentifier,
          (rrc_DL_DCCH_Message *)cmd_ptr->cmd.downlink_sdu_ind.decoded_msg,
          &msg_ptr->u.later_than_r3.criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.
                  ...
                  rrc_TransportChannelReconfiguration)))
      {
        ...
        process_tcreconfig_r9(wrrc_as_id,
          msg_ptr->u.later_than_r3.rrc_TransactionIdentifier,
          (rrc_DL_DCCH_Message *)cmd_ptr->cmd.downlink_sdu_ind.decoded_msg,
          &msg_ptr->u.later_than_r3.criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.
      ...
      rrc_TransportChannelReconfiguration)))
      {
        ...
        process_tcreconfig_r10(wrrc_as_id,
        msg_ptr->u.later_than_r3.rrc_TransactionIdentifier,
        (rrc_DL_DCCH_Message *)cmd_ptr->cmd.downlink_sdu_ind.decoded_msg,
        &msg_ptr->u.later_than_r3.criticalExtensions.u.criticalExtensions.u.criticalExtensions.u.
        criticalExtensions.u.criticalExtensions.u.later_r8_criticalExtensions.u.later_r9_criticalExtensions.u.r10.transportChannelReconfiguration_r10
        );
      ...
      else
      {
        ...
        rrctcrc_send_tcrc_failure_unsupported_config(wrrc_as_id,
            msg_ptr->u.later_than_r3.rrc_TransactionIdentifier);      
      }
  ...
  invalid or incompatible configuration given by the
  message */
  validate_tcrc_message(wrrc_as_id,msg_ptr );
  ...
  else
  {
    ...
    rrctc_process_high_mobility_ind_in_non_critical_ext(wrrc_as_id,msg_ptr,MSG_REL99);
    ...
    switch( oc_status )
    {
      ...
      case ORDERED_CONFIG_SET:
               ...
               ||(tcrc.state_indicated_by_msg==RRC_STATE_URA_PCH)))
        {
          ...
          if (rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL99))
          {
            directed_cell_info.pscr_present = TRUE;
    ...
    if (
          ...
          /*  CellDCH<->CellDCH or CellFACH<->CellFACH or CellFACH->CellDCH
              ...
              (tcrc.state_indicated_by_msg==RRC_STATE_CELL_FACH))
           {
                ...
                (rrcrb_validate_directed_cell_info (wrrc_as_id,directed_cell_info) == FALSE))
             {
               ...
               {
                 tcrc.new_crnti_valid = TRUE;
                 rrc_translate_crnti(wrrc_as_id,&msg_ptr->u.r3.transportChannelReconfiguration_r3.new_C_RNTI, 
                                      &c_rnti);
                 tcrc.new_crnti = (uint16)c_rnti;
               }
               else
        ...
        {
          /*store the directed cell info */
           tcrc.directed_cell_info = rrctcrc_is_pcpich_info_present(wrrc_as_id,msg_ptr, MSG_REL99);
...
)
{
  ...
  if( ptr->chan_cfg_status != RRCLLC_CHAN_CFG_SUCCESS )
  {
    ...
    if (ptr->chan_cfg_status == RRCLLC_CHAN_CFG_FAILURE_OTHER)
    {
      ...
      {
        tcrc.curr_substate = RRCRB_WAIT_FOR_CELL_UPDATE_CNF;
        rrcrb_send_cell_update_initiate_req(wrrc_as_id,RRC_PROCEDURE_TCR, RRC_UNRECOVERABLE_ERROR, FALSE);
        return; 
      }
      ...
      configurations */
      (void)rrcllc_reset_ordered_config(wrrc_as_id,RRC_PROCEDURE_TCR,TRUE);
        /* Then clear all local variables that may
        need to be cleared */
        rrctcrc_clear_procedure(wrrc_as_id);
        /* Make sure we're back in the initial sub-state */
      ...
      if(rrc_get_state(wrrc_as_id) == RRC_STATE_CELL_FACH && tcrc.state_indicated_by_msg == RRC_STATE_CELL_DCH)
      {
    ...
    if (rrc_get_state(wrrc_as_id) == RRC_STATE_CELL_FACH && tcrc.state_indicated_by_msg == RRC_STATE_CELL_DCH)
    {
      ...
      rrcrb_send_cell_update_initiate_req(wrrc_as_id,RRC_PROCEDURE_TCR, RRC_PHY_CHAN_FAILURE,TRUE);
    ...
    else if (rrc_get_state(wrrc_as_id) == RRC_STATE_CELL_DCH && tcrc.state_indicated_by_msg == RRC_STATE_CELL_DCH)
    {
      tcrc.status.failure_status = RRCTC_PHY_CHAN_FAILURE;
      if(rrccu_return_cu_substate(wrrc_as_id) == RRCCU_WAIT_FOR_PENDING_CONFIG)
      {
        tcrc.curr_substate = RRCRB_WAIT_FOR_CELL_UPDATE_CNF;
        rrcrb_send_cell_update_initiate_req(wrrc_as_id,RRC_PROCEDURE_TCR, RRC_RADIO_LINK_FAILURE, FALSE);
        return; 
      }
      ...
      else if(ptr->chan_cfg_status == RRCLLC_CHAN_CFG_FAILURE_BACK_TO_OLD_CONFIG)
      {
        ...
        /* Send RRC_CELL_UPDATE_INITIATE_REQ command to CELL UPDATE Proc */
        rrcrb_send_cell_update_initiate_req(wrrc_as_id,RRC_PROCEDURE_TCR, RRC_RADIO_LINK_FAILURE,TRUE);
        /* Wait for CELL UPDATE to get a valid C_RNTI */
        tcrc.curr_substate = RRCRB_WAIT_FOR_CELL_UPDATE_CNF;
        tcrc.rrctcrc_send_initiate_cu_flag = FALSE;
        tcrc.rrctcrc_delete_crnti          = FALSE;
        ...
        (ordered_config.set_status == OC_SET_FOR_DCH_URA_PCH_TRANS))
  {
    ...
    {
      rrcrb_send_upd_ota_parms_ind(wrrc_as_id,RRC_PROCEDURE_TCR, CPHY_HIGH_MOBILITY_INCL);
    }
  }
       ...
       (tcrc.state_indicated_by_msg == RRC_STATE_URA_PCH)))
  {
    if (tcrc.state_indicated_by_msg == RRC_STATE_CELL_PCH) 
    {
      ...
      else
      {
        ...
        rrcrb_send_l1_drx_req (wrrc_as_id,RRC_PROCEDURE_TCR);

        rrctcrc_process_successful_proc_completion (wrrc_as_id,TRUE);
      }
      /* return from here */
      return;
    }
    else if (tcrc.state_indicated_by_msg == RRC_STATE_URA_PCH)
    {
      ...
      {
        rrcrb_send_ura_update_initiate_req(wrrc_as_id, RRC_PROCEDURE_TCR,
                                            RRC_URA_RESELECTION,
                                            FALSE);
      }
  ...
  if (tcrc.tcrc_for_srns_relocation == TRUE)
  {
    if (RRC_STATE_CELL_DCH == curr_state)
    {
      ...
      rrcrb_send_rlc_re_est_req_to_smc(wrrc_as_id,RRC_PROCEDURE_TCR, rb_type, TRUE);
  ...
  {   
    ...
    else
    {
      ...
      {  
        ...
        (void) rex_clr_sigs(rex_self(), RRCTCRC_TEMP_TIMER_SIG);
        (void) rex_set_timer(&tcrc.rrctcrc_temp_timer, RRCRB_PND_CFG_DELAY); 

        tcrc.rrctcrc_sig = rex_wait(RRCTCRC_TEMP_TIMER_SIG);
        MSG_MED("RRCTCRC signal->%d", tcrc.rrctcrc_sig, 0, 0);
        (void) rex_clr_sigs(rex_self(), RRCTCRC_TEMP_TIMER_SIG);
        rrcrb_send_cell_update_initiate_req(wrrc_as_id,RRC_PROCEDURE_TCR, RRC_UNRECOVERABLE_ERROR, FALSE);
      }
...
)
{
 ...
 /* Check if E-RNTI is not given in OTA then initiate cell update*/
           ...
           ptr->new_state == RRC_STATE_URA_PCH)
  {
    ...
    {
      WRRC_MSG3_HIGH("Recvd state change %d to %d tcrc state %d, No action",
...
)
{
  ...
  if( ptr->status == SUCCESS )
  {
    ...
    if (tcrc.tcrc_for_srns_relocation)
    {
      if (RRC_STATE_CELL_DCH == rrc_get_state(wrrc_as_id))
      {
        ...
        rrcrb_send_rlc_re_est_req_to_smc(wrrc_as_id,RRC_PROCEDURE_TCR, rb_type, FALSE);
        /* send the nas cn info if stored */
        if (tcrc.cn_info_saved != FALSE)
        {
          /* Put the command on MM queue */
  ...
  else
  {
    ...
    if (RRC_STATE_CELL_FACH == rrc_get_state(wrrc_as_id) &&
        ...
        (cu_cause == rrc_CellUpdateCause_re_enteredServiceArea || cu_cause == rrc_CellUpdateCause_rlc_unrecoverableError ||
         cu_cause == rrc_CellUpdateCause_radiolinkFailure))
    {
      (void)rrccu_register_for_cell_update_to_complete(wrrc_as_id, RRC_PROCEDURE_TCR);
    ...
    if (tcrc.tcrc_for_srns_relocation)
    {
      ...
      rrc_transition_to_disconnected_state(wrrc_as_id,RRC_PROCEDURE_TCR,RRC_TX_TO_DISCON_OTHER);
    }
  }
  ...
  if(tcrc.tcrc_for_srns_relocation == TRUE)
  {
    rrcdormancy_update_dormancy_for_srns_hho_cco(wrrc_as_id, RRC_PROCEDURE_TCR);
  }    
...
)
{
  ...
  switch( cmd_ptr->cmd_hdr.cmd_id )
  {
    ...
    case RRC_DOWNLINK_SDU_IND:
      ...
      process_tcrc_message( wrrc_as_id,cmd_ptr );
...
)
{
  ...
  case RRC_RE_EST_RLC_FOR_SRNS_CNF:
    ...
    rrctcrc_process_rlc_reestablishment_cnf(wrrc_as_id);
    break;

  case RRC_STATE_CHANGE_IND:

    /* Indication that RRC's state has changed */
    rrctcrc_process_state_change_ind(wrrc_as_id, &(cmd_ptr->cmd.state_change_ind) );
    break;
...
)
{
  ...
  switch( cmd_ptr->cmd_hdr.cmd_id )
  {
    ...
    case RRC_CHANNEL_CONFIG_CNF:
      ...
      rrctcrc_process_channel_config_cnf(wrrc_as_id, &(cmd_ptr->cmd.chan_config_cnf) );
      break;
  ...
  switch ( cmd_ptr->cmd_hdr.cmd_id )
  {
    case RRC_CELL_UPDATE_COMPLETE_CNF:
      ...
      else if(tcrc.status.failure_status == RRCTC_MSG_VALID)
      {
        ...
        {
          send_tcrc_complete_message(wrrc_as_id,FALSE);
        }
        /* prints rate for each transport channel */
        rrcllc_print_trans_chnl_rate(wrrc_as_id);
        /*if next state is Cell_PCH or URA_PCH then we have to 
...
)
{
  ...
  switch( cmd_ptr->cmd_hdr.cmd_id )
  {
    ...
    case RRC_DOWNLINK_L2ACK_IND:
      ...
      /* Confirmation from LLC for the channel configurations */
      rrctcrc_process_l2_ack_ind(wrrc_as_id, &(cmd_ptr->cmd.downlink_l2ack_ind) );
      break;
...
)
{
  ...
  case RRC_RNTI_UPDATE_CNF:
    ...
    {
      rrctcrc_process_rnti_update_cnf(wrrc_as_id);
    }
    else
    {
...
)
{
  ...
  switch ( cmd_ptr->cmd_hdr.cmd_id )
  {
    ...
    case RRC_NEW_CELL_IND:
      rrctcrc_process_new_cell_ind(wrrc_as_id, &(cmd_ptr->cmd.new_cell_ind) );
      break;
...
)
{
  ...
  WRRC_MSG4_HIGH("TCRC:L2ack status %d <0-Success 1-Failure> for MUI:%d, Lc_Id:%d, tcrc_subst:%d",
...
)
{
  ...
  switch( tcrc.curr_substate )
  {
    ...
    case RRCRB_WAIT_FOR_CELL_UPDATE_CNF:
      /* Call the event handler for RRCRB_WAIT_FOR_CELL_UPDATE_CNF substate */
      rrctcrc_fach_wfcucnf_event_handler(wrrc_as_id,  cmd_ptr);
      break;

    case RRCRB_WAIT_FOR_CHAN_CFG_CNF:
      /* Call the event handler for RRCRB_WAIT_FOR_CHAN_CFG_CNF substate */
      rrctcrc_fach_wfchcnf_substate_event_handler(wrrc_as_id,  cmd_ptr );
      break;

    case  RRCRB_WAIT_FOR_CELL_SELECTION_CNF:
      /* Call the event handler for RRCRB_WAIT_FOR_CHAN_CFG_CNF substate */
      rrctcrc_fach_wfcscnf_substate_event_handler(wrrc_as_id,  cmd_ptr );
      break;

    case RRCRB_WAIT_FOR_CRNTI_UPDATE_CNF:
        /* Call the event handler for RRCRB_WAIT_FOR_CRNTI_UPDATE_CNF substate */
        rrctcrc_fach_wfcrntiupdatecnf_substate_event_handler(wrrc_as_id,  cmd_ptr );
        break;

    case RRCRB_WAIT_FOR_L2_ACK:
      /* Call the event handler for RRCRB_WAIT_FOR_L2_ACK substate */
      rrctcrc_fach_wfl2ack_substate_event_handler(wrrc_as_id,  cmd_ptr );
      break;
...
)
{
  ...
  case RRCRB_WAIT_FOR_CELL_UPDATE_CNF:
    /* Call the event handler for RRCRB_WAIT_FOR_CELL_UPDATE_CNF substate */
    rrctcrc_pch_wfcucnf_event_handler(wrrc_as_id,  cmd_ptr);
    break;

  case RRCRB_WAIT_FOR_CELL_SELECTION_CNF:

    rrctcrc_pch_wfcscnf_event_handler(wrrc_as_id,  cmd_ptr);
    break;

  case RRCRB_WAIT_FOR_CHAN_CFG_CNF:

    /* Call the event handler for RRCRB_WAIT_FOR_CHAN_CFG_CNF substate */
    rrctcrc_pch_wfchcnf_substate_event_handler(wrrc_as_id,  cmd_ptr );
    break;
  ...
  default:
    ...
    MSG_MED("Command %x not processed in substate%d rrc_state%d", 
            cmd_ptr->cmd_hdr.cmd_id, tcrc.curr_substate, rrc_get_state(wrrc_as_id));
    break;
...
)
{
  ...
  switch( tcrc.curr_substate )
  {
    case RRCRB_WAIT_FOR_CHAN_CFG_CNF:
      ...
      rrctcrc_other_wfchcnf_substate_event_handler(wrrc_as_id,  cmd_ptr );
      break;

    case RRCRB_WAIT_FOR_L2_ACK:
      /* Call the event handler for WAIT_FOR_L2_ACK substate */
      rrctcrc_other_wfl2ack_substate_event_handler(wrrc_as_id,  cmd_ptr );
      break;

    case RRCRB_WAIT_FOR_CELL_UPDATE_CNF:
      rrctcrc_other_wfcucnf_substate_event_handler(wrrc_as_id,  cmd_ptr);
      break;

    case  RRCRB_WAIT_FOR_CELL_SELECTION_CNF:
      /* Call the event handler for RRCRB_WAIT_FOR_CHAN_CFG_CNF substate */
      rrctcrc_other_wfcscnf_substate_event_handler(wrrc_as_id,  cmd_ptr );
      break;
...
)
{
  ...
  rrc_crash_debug_save_proc_substates(wrrc_as_id,RRC_PROCEDURE_TCR,tcrc.curr_substate,cmd_ptr->cmd_hdr.cmd_id);
  ...
  switch (rrc_state)
  {
    ...
    case RRC_STATE_CELL_FACH:    
      ...
      for CELL_FACH state */
      rrctcrc_cell_fach_event_handler(wrrc_as_id, cmd_ptr);
      break;

    case RRC_STATE_CELL_DCH:    
      /* If it's CELL_DCH state, call the event handler
      for CELL_DCH state */
      rrctcrc_cell_dch_event_handler(wrrc_as_id, cmd_ptr);
      break;
    ...
    case RRC_STATE_CELL_PCH:
      /* If it's CELL_DCH state, call the event handler
      for CELL_PCH state */
      rrctcrc_pch_event_handler(wrrc_as_id, cmd_ptr);
      break;
    ...
    case RRC_STATE_DISCONNECTED: 
      ...
      rrctcrc_other_state_event_handler(wrrc_as_id, cmd_ptr);
      break;
...
{                                         
  ...
  if (srns_reloc == TRUE)
  {
    rrctcr_append_start_list_to_tcrc_complete(wrrc_as_id,msg_ptr);
  }
...
===========================================================================*/
void rrctcrc_init_procedure(sys_modem_as_id_e_type wrrc_as_id)
{
  ...
  to disconnected state. */
  rrcscmgr_register_for_scn(wrrc_as_id, RRC_PROCEDURE_TCR,  /* Procedure name */
  ...
  rex_def_timer(&tcrc.rrctcrc_temp_timer, rex_self(), RRCTCRC_TEMP_TIMER_SIG);
...
/*===========================================================================
FUNCTION rrctcrc_return_send_initiate_cu_flag
...
boolean rrctcrc_return_send_initiate_cu_flag(sys_modem_as_id_e_type wrrc_as_id)
{
  return tcrc.rrctcrc_send_initiate_cu_flag;
}
#endif
...
===========================================================================*/
void rrctcrc_set_failure_cause(sys_modem_as_id_e_type wrrc_as_id,rrcrb_msg_status_e_type cause)
{
...
{
  qsh_mdump_collect_high(&tcrc,sizeof(tcrc));
}
#endif
