...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcf9driver.c#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
   
when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/27/16   sg      Made changes to avoid printing security keys based on test mode
...
LOCAL rrcf9_int_data_type rrcf9_int_data_sim[MAX_RRC_STACKS];
#define rrcf9_int_data rrcf9_int_data_sim[WAS_ID_M]
#else
LOCAL rrcf9_int_data_type rrcf9_int_data;
#endif
...
{
  rrcf9_int_data.f9_fresh = fresh_value;
  WRRC_MSG1_HIGH("Fresh Value: 0x%x",  rrcf9_int_data.f9_fresh);
...
)
{
  ...
  {
    rrcf9_int_data.f9_cs_key[count] = cs_key[count];
  }

  for(count=0; count < (RRC_MAX_INTEGRITY_KEY_LENGTH); count++)
  {
    rrcf9_int_data.f9_ps_key[count] = ps_key[count];
  }
  if(rrc_get_test_mode_logging_status(wrrc_as_id) == TRUE)
  {
    WRRC_MSG8_HIGH("CS keys 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x", 
    rrcf9_int_data.f9_cs_key[0], rrcf9_int_data.f9_cs_key[1], rrcf9_int_data.f9_cs_key[2], rrcf9_int_data.f9_cs_key[3], rrcf9_int_data.f9_cs_key[4], rrcf9_int_data.f9_cs_key[5], rrcf9_int_data.f9_cs_key[6], rrcf9_int_data.f9_cs_key[7]);
    WRRC_MSG8_HIGH("CS keys 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x", 
    rrcf9_int_data.f9_cs_key[8], rrcf9_int_data.f9_cs_key[9], rrcf9_int_data.f9_cs_key[10], rrcf9_int_data.f9_cs_key[11], rrcf9_int_data.f9_cs_key[12], rrcf9_int_data.f9_cs_key[13], rrcf9_int_data.f9_cs_key[14], rrcf9_int_data.f9_cs_key[15]);
    WRRC_MSG8_HIGH("PS keys 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x ", 
    rrcf9_int_data.f9_ps_key[0], rrcf9_int_data.f9_ps_key[1], rrcf9_int_data.f9_ps_key[2], rrcf9_int_data.f9_ps_key[3], rrcf9_int_data.f9_ps_key[4], rrcf9_int_data.f9_ps_key[5], rrcf9_int_data.f9_ps_key[6], rrcf9_int_data.f9_ps_key[7]);
    WRRC_MSG8_HIGH("PS keys 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x ", 
    rrcf9_int_data.f9_ps_key[8], rrcf9_int_data.f9_ps_key[9], rrcf9_int_data.f9_ps_key[10], rrcf9_int_data.f9_ps_key[11], rrcf9_int_data.f9_ps_key[12], rrcf9_int_data.f9_ps_key[13], rrcf9_int_data.f9_ps_key[14], rrcf9_int_data.f9_ps_key[15]);
  }
...
)
{
  ...
  uint8 *key_ptr=NULL,bearer=0;  
    ...
    {
    key_ptr = rrcf9_int_data.f9_cs_key;
    }
    else
    {
    key_ptr = rrcf9_int_data.f9_ps_key;
    }
  ...
  rrcf9_int_data.f9_fresh,  /*!< Fresh value */
  count_i,                  /*!< Count */
...
#endif
  WRRC_MSG7_HIGH("Fresh = 0x%x, DIR %d, Count_I 0x%x, maci = 0x%x, CN Doamin = %d,Integrity Algo = %x[0=Invalid,1=UIA1,2=UIA2] in rrcsmc_int_ciph_info, msg_length_bits:%d",
  rrcf9_int_data.f9_fresh, dir, count_i, maci,cn_domain,integrity_algo,msg_length); 
