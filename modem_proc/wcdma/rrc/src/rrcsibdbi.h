...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcsibdbi.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  boolean cell_found_in_alt_sibdb; /* Set only if cell index is found in alternate sub*/
  boolean vtag_mismatch;
#endif
#ifdef FEATURE_FEMTO_CSG
...
typedef struct
{
  ...
  /*Used to hold max number priority*/
  uint8 rrcsib_cn_max_priority;
} rrcsibdb_int_data_type;
/* -----------------------------------------------------------------------
