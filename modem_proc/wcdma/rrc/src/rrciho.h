...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrciho.h#2 $   
...
typedef enum
{
  ...
  RRCIHO_WAIT_STATE_CHANGE_IND,     /* Waiting for State changed Ind   */
  RRCIHO_MAX_STATES
} rrciho_state_e_type;
...
extern rrciho_ext_data_type rrciho_ext_data_sim[MAX_RRC_STACKS];
#define rrciho_ext_data rrciho_ext_data_sim[WAS_ID_M]
#else
extern rrciho_ext_data_type rrciho_ext_data;
#endif

/* =======================================================================
...
===========================================================================*/
void * rrciho_get_rbs_ptr(sys_modem_as_id_e_type wrrc_as_id, uint32 *df_config_id);
...
===========================================================================*/
uecomdef_status_e_type rrciho_get_activation_time_for_wtog_ho (sys_modem_as_id_e_type wrrc_as_id, uint16 * act_time);
