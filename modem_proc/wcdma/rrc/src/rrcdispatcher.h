...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcdispatcher.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
extern void rrc_dispatcher (sys_modem_as_id_e_type wrrc_as_id);
