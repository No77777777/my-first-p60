...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrccui.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
/*===========================================================================
FUNCTION rrcu_process_cu_cnf_after_validation_r10
...
SIDE EFFECTS
  None
===========================================================================*/
void rrcu_process_cu_cnf_after_validation_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  void *msg_ptr,                           /* Pointer to Downlink Msg */
  rrc_CellUpdateConfirm_r10_IEs *cu_confirm_ptr,
  uint32 dl_sdu_type                       /* Downlink SDU type */  
  ,rrcrb_directed_cell_info_type          directed_cell_info
);

/*===========================================================================
FUNCTION rrccu_process_after_oc_config_set_r10
...
SIDE EFFECTS
  None
===========================================================================*/
void rrccu_process_after_oc_config_set_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_CellUpdateConfirm_r10_IEs *cu_confirm_ptr
  ,rrcrb_directed_cell_info_type          directed_cell_info
...
/*===========================================================================
FUNCTION rrccu_process_freq_redirection_info_r10
...
SIDE EFFECTS
  None
===========================================================================*/
boolean rrccu_process_freq_redirection_info_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_CellUpdateConfirm_r10_IEs * cu_confirm_ptr,
  rrcrb_directed_cell_info_type * directed_cell_info_ptr
...
FUNCTION rrccu_validate_rb_info_r10
...
===========================================================================*/
boolean rrccu_validate_rb_info_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
   rrc_CellUpdateConfirm_r10_IEs * cu_confirm_ptr
);
...
/*===========================================================================
FUNCTION rrccu_update_chan_config_rb_r10
...
===========================================================================*/
uint32 rrccu_update_chan_config_rb_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
 rrc_CellUpdateConfirm_r10_IEs * cu_confirm_ptr,
 rrc_rb_config_type * rb_info
...
/*===========================================================================
FUNCTION rrccu_validate_rel_rb_exist_in_reconfig_list_r10
...
===========================================================================*/
boolean rrccu_validate_rel_rb_exist_in_reconfig_list_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_CellUpdateConfirm_r10_IEs * cu_confirm_ptr
);
...
FUNCTION RRCCU_RESPONSE_TO_CELL_UPDATE_CONFIRM_R10
...
===========================================================================*/
rrccu_resp_msg_e_type rrccu_find_response_to_cell_update_confirm_r10
(
  sys_modem_as_id_e_type wrrc_as_id,
...
/*===========================================================================
FUNCTION RRCCU_PROCESS_CELL_UPDATE_CONFIRM_R10
...
===========================================================================*/
void rrccu_process_cell_update_confirm_r10
(    
  sys_modem_as_id_e_type wrrc_as_id,
  void *msg_ptr,                           /* Pointer to Downlink Msg */
  rrc_RRC_TransactionIdentifier rcvd_transaction_id,
...
void rrccu_log_cu_status(sys_modem_as_id_e_type wrrc_as_id, rrc_cu_uu_status_e_type cu_status, boolean is_cu);
/*===========================================================================
...
SIDE EFFECTS  None
===========================================================================*/
rrc_cu_uu_cause_e_type rrccu_map_cu_uu_cause_for_event_logging(sys_modem_as_id_e_type wrrc_as_id, boolean is_cu);
/*===========================================================================
...
SIDE EFFECTS  None
===========================================================================*/
rrc_cu_uu_failure_cause_e_type rrccu_get_cu_uu_failure_cause_for_event_logging(sys_modem_as_id_e_type wrrc_as_id, boolean is_cu);
