...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcmcm.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/14/20   sp      Mini dump phase-2 changes
09/21/16   ha      Made changes to calculate Maximum TA duration as per spec 25.331 
05/17/16   sp      Changes for LTA timeline optimization
...
/* max value of(N313 + T313)in ms N313=2s T313=15s as per spec 25.331*/
#define MAX_TA_TIMER_VALUE  17000
...
#define INVALID_MSGR_UMID 0xFFFFFFFF
...
typedef struct
{
  ...
  union
  {
    rrc_rr_cmd_type     rrcmcm_gsm_irat_cmd;
#ifdef FEATURE_LTE_TO_WCDMA
...
{
  /* MCM state */
  rrcmcm_state_e_type rrcmcm_state;
  ...
  uint16 rrcmcm_notification_counter;
...
#endif
  rrc_plmn_list_req_type *rrc_svd_plmn_req_ptr;
  /* RAT Mode */
  rrc_mode_e_type rrc_mode;

  /*set activation  cause of WCDMA */
  rrcmcm_activation_cause rrcmcm_act_cause;

  /*set last activation cause of WCDMA */
  rrcmcm_activation_cause rrcmcm_last_act_cause;

  /* Mode Preference */
  boolean rrc_dual_mode_enabled;

#if defined (FEATURE_WCDMA_TO_LTE) || defined (FEATURE_LTE_TO_WCDMA)
  boolean rrc_lte_mode_enabled;
#endif
  boolean is_ue_in_sglte_mode;
  sys_band_class_e_type start_band_class;
}rrcmcm_int_data_type;
...
===========================================================================*/
boolean rrcmcm_is_process_required(sys_modem_as_id_e_type wrrc_as_id,
...
SIDE EFFECTS
  None
===========================================================================*/
rrc_establish_cause_e_type rrcmcm_get_rrc_est_cause(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void rrcmcm_send_dual_mode_info_to_meas_ueci(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
===========================================================================*/
void rrcmcm_update_lte_mode_enabled_status(sys_modem_as_id_e_type wrrc_as_id,  boolean status );
#endif
#endif
...
void rrcmcm_reset_last_act_cause(sys_modem_as_id_e_type wrrc_as_id);
