...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcenhstatecfg.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
#define RRC_IS_EDRX_NV_TURNED_ON ((rrc_nv_rel_indicator & RRC_NV_REL_INDICATOR_REL8) && \
                                  (rrcnv_data.rrc_feature_nv_item_value & RRC_EFACH_DRX_ENABLED) && \
                                  (rrcnv_data.rrc_feature_nv_item_value & RRC_EFACH_ENABLED))
#endif
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrcenhstate_print_cmac_ul_config(sys_modem_as_id_e_type wrrc_as_id, mac_ul_config_type *mac_cmd_ptr);
