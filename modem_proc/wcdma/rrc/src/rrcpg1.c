...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/src/rrcpg1.c#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/16/18   sp      Made changes to process all page records in paging type-1 message
01/25/16   sg       Made changes to remove the GCF NV 947 read and get the value of this NV through an api
03/21/17   ha      Made changes to indicate false alarm if no real sib mod
05/19/15   sn      f3 reduction changes for cell resel, unlock handling, pg1
05/04/16   sn      f3 density reduction changes
04/29/16   ha      Made changes to rectify errors when qchat feature is enabled
01/06/16   sn      Changes to send true page indication to wl1 for UTRAN orginated pages 
...
boolean rrcpg1_match_found_conn_mode_cn_id_sim[MAX_RRC_STACKS] = {FALSE};
...
** ----------------------------------------------------------------------- */
#ifdef FEATURE_DUAL_WCDMA 
LOCAL rrcpg1_int_data_type rrcpg1_int_data_sim[MAX_RRC_STACKS];
#define rrcpg1_int_data rrcpg1_int_data_sim[WAS_ID_M]
#else
LOCAL rrcpg1_int_data_type rrcpg1_int_data;
#endif
...
)
{
  ...
  is_n_bcch_up = rrcllc_get_n_bcch_setup_status(wrrc_as_id);

  WRRC_MSG4_HIGH("sfn update: N-BCCH status %d, rrc %d, timer %d SIB change guard %d",
         is_n_bcch_up,
         rrc_state,
         rrcpg1_int_data.rrcpg1_bcch_mod_timer_status,
         rrcsibproc_ext_data.sib_change_safe_guard);
  ...
  {
    if ( rrcpg1_int_data.rrcpg1_bcch_mod_timer_status == FALSE)
    {
      ...
      {     
        ...
        {
          wrrc_free_cmd_buf( wrrc_as_id, rrc_cmd_ptr);
          rrc_cmd_ptr = NULL;
        }
      } 
    }
...
)
{
  ...
  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b1: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b1), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 1;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b2: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b2), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 2;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b3: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b3), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 3;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b4: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b4), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 4;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b5: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b5), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 5;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b6: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b6), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 6;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b7: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b7), 
                                                         GROUP_RELEASE_COPY_BYTE_4);
    compare_bit_mask_shift_right_length = 7;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b8: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b8), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 8;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b9: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b9), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 9;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b10: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b10), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 10;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b11: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b11), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 11;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b12: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b12), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 12;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b13: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b13), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 13;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b14: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b14), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 14;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b15: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b15), 
                                                         GROUP_RELEASE_COPY_BYTE_3);
    compare_bit_mask_shift_right_length = 15;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b16: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b16), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 16;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b17: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b17), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 17;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b18: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b18), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 18;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b19: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b19), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 19;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b20: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b20), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 20;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b21: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b21), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 21;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b22: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b22), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 22;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b23: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b23), 
                                                         GROUP_RELEASE_COPY_BYTE_2);
    compare_bit_mask_shift_right_length = 23;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b24: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b24), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 24;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b25: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b25), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 25;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b26: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b26), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 26;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b27: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b27), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 27;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b28: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b28), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 28;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b29: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b29), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 29;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b30: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b30), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
    compare_bit_mask_shift_right_length = 30;
    break;

  case T_rrc_U_RNTI_Group_u_RNTI_BitMaskIndex_b31: 
    u_rnti_group = rrcpg1_copy_group_bit_string_to_urnti(wrrc_as_id,*(group_release_info->uRNTI_Group.u.u_RNTI_BitMaskIndex_b31), 
                                                         GROUP_RELEASE_COPY_BYTE_1);
  ...
  if(U_RNTI_NOT_PRESENT == rrcllc_get_current_urnti(wrrc_as_id,&u_rnti_stored) )
  {
    WRRC_ERR0_FATAL("URNTI is not present");
  }

  WRRC_MSG3_HIGH("Stored-URNTI 0x%x, Group-URNTI 0x%x, Group-Bit-Mask %d", u_rnti_stored, u_rnti_group, 
...
)
{
    ...
    case T_rrc_PagingRecord_cn_Identity:
      ...
      { 
        case rrc_CN_DomainIdentity_cs_domain:
          rrcpg1_int_data.rrcpg1_cn_domain_id = RRC_CS_DOMAIN_CN_ID;
          break;

        case rrc_CN_DomainIdentity_ps_domain:
          rrcpg1_int_data.rrcpg1_cn_domain_id = RRC_PS_DOMAIN_CN_ID;
          break;
      ...
      switch(paging_record_ptr->u.cn_Identity->pagingCause)
      {
        case rrc_PagingCause_terminatingConversationalCall:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_TERM_CONV_CALL;
          break;

        case rrc_PagingCause_terminatingStreamingCall:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_TERM_STREAM_CALL;
          break;

        case rrc_PagingCause_terminatingInteractiveCall:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_TERM_INTERACT_CALL;
          break;

        case rrc_PagingCause_terminatingBackgroundCall:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_TERM_BACKGND_CALL;
          break;

        case rrc_PagingCause_terminatingHighPrioritySignalling:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_HIGH_PRI_SIGNALLING;
          break;

        case rrc_PagingCause_terminatingLowPrioritySignalling:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_LOW_PRI_SIGNALLING;
          break;

        case rrc_PagingCause_terminatingCauseUnknown:
          rrcpg1_int_data.rrcpg1_paging_cause = RRC_PAGE_CAUSE_UNKNOWN;
          break;
      ...
      switch(paging_record_ptr->u.cn_Identity->cn_pagedUE_Identity.t)
      {
        case T_rrc_CN_PagedUE_Identity_imsi_GSM_MAP:
          rrcpg1_int_data.rrcpg1_page_ue_id = RRC_PAGE_WITH_IMSI;
          break;
       
        case T_rrc_CN_PagedUE_Identity_tmsi_GSM_MAP:
          rrcpg1_int_data.rrcpg1_page_ue_id = RRC_PAGE_WITH_TMSI;
          break;

        case T_rrc_CN_PagedUE_Identity_p_TMSI_GSM_MAP:
          rrcpg1_int_data.rrcpg1_page_ue_id = RRC_PAGE_WITH_PTMSI;
          break;
  ...
  paging_event_info.paging_cause = rrcpg1_int_data.rrcpg1_paging_cause;
  /* Send the event */

  WRRC_EVENT_REPORT_PAYLOAD(EVENT_WCDMA_PAGE_RECEIVED, /* Paging event ID */
...
)
{
  ...
  boolean ignore_rem_page_records = FALSE; /* This local variable if set would indicate that
                                              remaining paging records should be looked
                                              at for a possible match */
 ...
 /* Check whether externsion chosen */
  ...
  while(!((match_found && ignore_rem_page_records) ||( idx >= RRC_MAX_PAGE1))) 
  {
    switch(pcch_msg_ptr->message.u.pagingType1.pagingRecordList.elem[idx].t)
    {
      case T_rrc_PagingRecord_cn_Identity:
        ...
        if( (rrc_get_state(wrrc_as_id) == RRC_STATE_CONNECTING) || 
            (rrc_get_state(wrrc_as_id) == RRC_STATE_DISCONNECTED) ) 
        {
          rrcpg1_int_data.rrcpg1_paging_type = RRCPG1_CN_ORIGINATED_PAGE;
                  ...
                  cn_Identity->cn_pagedUE_Identity.t)
          {
            case T_rrc_CN_PagedUE_Identity_imsi_GSM_MAP:
              ...
              if(rrcdata_sim_related_info.rrc_imsi_valid == TRUE)
              {
                /* Translate IMSI to internal format */
                rrc_translate_gsm_map_imsi(wrrc_as_id,pcch_msg_ptr->message.u.pagingType1.
                                           pagingRecordList.elem[idx].u.cn_Identity->
                                           cn_pagedUE_Identity.u.imsi_GSM_MAP,
                                           &imsi);
                /* Search for the IMSI match in the Paging Record */
                if( (imsi.num_digits == rrcdata_sim_related_info.rrc_imsi.num_digits) &&
                    (!memcmp((const char *) imsi.value,(const char *) rrcdata_sim_related_info.rrc_imsi.value,
                  ...
                  )
                {
                  ...
                  {
                    /*
                       If match found variable is already set, this means we have another matching record.
                       Forward the page indication to NAS before saving the new record details. 
                    */
                    rrcpg1_send_page_ind(wrrc_as_id);
                  }
                  rrcpg1_update_rrc_page_ind(wrrc_as_id,&pcch_msg_ptr->message.u.pagingType1.pagingRecordList.elem[idx]);
                  ...
                  status = RRCPG1_SUCCESS;
                      ...
                      the Paging Record */
              {
                WRRC_MSG1_MED("Page Recieved with IMSI when internal IMSI is invalid",
                          0);
              }
              break;
            ...
            case T_rrc_CN_PagedUE_Identity_tmsi_GSM_MAP:
              ...
              if(rrcdata_sim_related_info.rrc_tmsi_valid == TRUE)
              {
                ...
                if( (length_in_bytes == RRC_MAX_GSMMAP_TMSI_LENGTH) &&
                    (!memcmp((const char *)(RRC_GET_BITS_PTR_STRING_PTR(pcch_msg_ptr->message.u.pagingType1.
                     pagingRecordList.elem[idx].u.cn_Identity->cn_pagedUE_Identity.u.
                     tmsi_GSM_MAP)),
                     (const char *) rrcdata_sim_related_info.rrc_tmsi.value,RRC_MAX_GSMMAP_TMSI_LENGTH) ) 
                  )
                {
                  if(match_found)
                  {
                  ...
                  status = RRCPG1_SUCCESS;
                      ...
                      the Paging Record */
              {
                WRRC_MSG1_MED("Page Recieved with TMSI when internal TMSI is invalid",
                          0);
              }
              break;
            ...
            case T_rrc_CN_PagedUE_Identity_p_TMSI_GSM_MAP:
              /* Check whether TMSI recieved from NAS is valid */
              if(rrcdata_sim_related_info.rrc_ptmsi_valid == TRUE)
              {
                length_in_bits = RRC_GET_BITS_STRING_LEN_PTR(pcch_msg_ptr->message.u.pagingType1.
                   pagingRecordList.elem[idx].u.cn_Identity->cn_pagedUE_Identity.u.
                   p_TMSI_GSM_MAP);
                ...
                if( (length_in_bytes == RRC_MAX_GSMMAP_PTMSI_LENGTH ) &&
                    (!memcmp((const char *) (RRC_GET_BITS_PTR_STRING_PTR(pcch_msg_ptr->message.u.pagingType1.
                     pagingRecordList.elem[idx].u.cn_Identity->cn_pagedUE_Identity.u.
                     p_TMSI_GSM_MAP)),
                     (const char *) rrcdata_sim_related_info.rrc_ptmsi.value,RRC_MAX_GSMMAP_PTMSI_LENGTH) )
                  ) 
                {
                  if(match_found)
                  {
                  ...
                  status = RRCPG1_SUCCESS;
                      ...
                      the Paging Record */
              {
                WRRC_MSG1_MED("Page Recieved with PTMSI when internal PTMSI is invalid",
                          0);
              }
              break;
        ...
        {
          WRRC_MSG1_MED("Wrong CN orig page in State %d",rrc_get_state(wrrc_as_id));
      ...
      case T_rrc_PagingRecord_utran_Identity:
        ...
        {
          /*lint -e666 */
          WRRC_MSG1_MED("Wrong Paging Origination in State %d",rrc_get_state(wrrc_as_id));
          /*lint +e666 */
        }
        else
        {
          rrc_translate_urnti(wrrc_as_id,&pcch_msg_ptr->message.u.pagingType1.
          ...
          if(u_rnti == u_rnti_local)
          {
               ...
               u.utran_Identity->m.cn_OriginatedPage_connectedMode_UEPresent)
            {
              ...
              rrcpg1_int_data.rrcpg1_paging_type = RRCPG1_CN_ORIGINATED_PAGE_TO_CONNECTED_UE;
            ...
            else
            {
              ...
              rrcpg1_int_data.rrcpg1_paging_type = RRCPG1_UTRAN_ORIGINATED_PAGE_TO_CONNECTED_UE;

              status = RRCPG1_SUCCESS;
            }
            /*
               If there is a match in URNTI, there is no need to process remaining page records. 
            */
            ignore_rem_page_records = TRUE;
          }
        }
        break;
 ...
 /* Check whether externsion chosen */
     ...
     m.v860NonCriticalExtensionsPresent)
  {
       ...
       pagingType1_v860ext.m.etws_InformationPresent)
    {
      ...
      rrcbmc_send_etws_information_ind_message(wrrc_as_id,pcch_msg_ptr->message.u.pagingType1.laterNonCriticalExtensions.v590NonCriticalExtensions.
  ...
  while(local_paging_record_List->n > idx) 
  {
    ...
    {
      rrc_translate_urnti(wrrc_as_id,&local_paging_record_List->elem[idx].u.utran_SingleUE_Identity->
                          u_RNTI, &u_rnti);
      ...
      if(u_rnti == u_rnti_local)
      {
            ...
            T_rrc_RRC_ConnectionReleaseInformation_release)
        {
          ...
          rrcdata_misc_info.rrc_release_cause = rrcrcr_update_release_cause(wrrc_as_id,local_paging_record_List->elem[idx].u.
    ...
    else if(local_paging_record_List->elem[idx].t == T_rrc_PagingRecord2_r5_utran_GroupIdentity)
    {
      ...
      {
        if(SUCCESS == rrc_compare_group_release_info(wrrc_as_id,&local_group_release_list->
                                                     elem[idy].groupReleaseInformation))
        {
             ...
             T_rrc_RRC_ConnectionReleaseInformation_release)  
          {
            ...
            //update the release cause and return release enum
            rrcdata_misc_info.rrc_release_cause = rrcrcr_update_release_cause(wrrc_as_id,local_group_release_list->elem[idy].
                                                            rrc_ConnectionReleaseInformation.u.
                                                            release->releaseCause);
            return RRCPG1_RELEASE;
          }
...
void rrcpg1_send_page_ind(sys_modem_as_id_e_type wrrc_as_id)
{
  ...
  if( (mm_cmd_ptr =  mm_rrc_get_cmd_buf(RRC_PAGE_IND)) != NULL)
  {
    ...
    mm_cmd_ptr->cmd.rrc_page_ind.cn_domain_id = rrcpg1_int_data.rrcpg1_cn_domain_id;
  
    mm_cmd_ptr->cmd.rrc_page_ind.paging_cause = rrcpg1_int_data.rrcpg1_paging_cause;
  
    mm_cmd_ptr->cmd.rrc_page_ind.page_ue_id = rrcpg1_int_data.rrcpg1_page_ue_id;
  
#ifdef FEATURE_DUAL_SIM
    mm_cmd_ptr->cmd.rrc_page_ind.as_id = rrc_get_as_id(wrrc_as_id);
#endif
...
)
{
     ...
     (cmd_ptr->cmd.downlink_sdu_ind.dl_sdu_type == rrc_PCCH_Message_PDU) )
  {
    ...
    else /* ASN1 decoding is successful */
    {
      ...
      rrcpg1_int_data.rrcpg1_num_pages++;

       /* Get the OTA message pointer */
      pcch_msg_ptr = (rrc_PCCH_Message *) 
                     cmd_ptr->cmd.downlink_sdu_ind.decoded_msg;  
      
      WRRC_MSG5_HIGH("RRC state %d, RRC release indicator %d, Is IMSI valid: %d, Is TMSI valid: %d, Is PTMSI valid: %d",
                      rrc_get_state(wrrc_as_id),rrc_nv_rel_indicator,
                      rrcdata_sim_related_info.rrc_imsi_valid,
      ...
      {  
        ...
        {
          page_status = rrcpg1_validate_paging_type_msg_r5(wrrc_as_id,pcch_msg_ptr);
  
          if(RRCPG1_RELEASE == page_status)
          {
            //send cmd to transition to idle
            (void)rrc_transition_to_disconnected_state(wrrc_as_id,RRC_PROCEDURE_PG1, RRC_TX_TO_DISCON_OTHER);
          ...
          else if(RRCPG1_SUCCESS == page_status)
          {
            ...
            rrcpg1_int_data.rrcpg1_num_pages_matched++;
            /* This page is not a false alarm */
            false_paging_alarm = FALSE;
            WRRC_MSG3_HIGH("Paging type1, type:%d, cause:%d, id:%d",
                     rrcpg1_int_data.rrcpg1_paging_type,
                     rrcpg1_int_data.rrcpg1_paging_cause,
                     rrcpg1_int_data.rrcpg1_page_ue_id
                     );
          }
        }
      }
      ...
      {        
        page_status = rrcpg1_validate_paging_type_msg(wrrc_as_id,pcch_msg_ptr);
      ...
      if(RRCPG1_SUCCESS == page_status)
      {
        if (rrcpg1_int_data.rrcpg1_paging_type != RRCPG1_UTRAN_ORIGINATED_PAGE_TO_CONNECTED_UE)
        {
          if(rrcnv_data.rrc_do_not_forward_page_nv == FALSE)
          {
            rrcpg1_send_page_ind(wrrc_as_id);
          }
          else
        ...
        {
          if (RRC_STATE_CELL_PCH == rrc_get_state(wrrc_as_id) || 
              RRC_STATE_URA_PCH == rrc_get_state(wrrc_as_id) )
          {
          ...
          else
          {
            WRRC_MSG2_ERROR("Invalid paging type %d in rrc state %d", 
                      rrcpg1_int_data.rrcpg1_paging_type, rrc_get_state(wrrc_as_id));
          }
        }
      }
        ...
        bcch_ModificationInfo))
      {
        ...
        if ( rrcpg1_int_data.rrcpg1_bcch_mod_timer_status == FALSE)
        {
          ...
          if(((rrc_get_serving_cell_mib_value_tag(wrrc_as_id)) != (uint32)
              (pcch_msg_ptr->message.u.pagingType1.bcch_ModificationInfo.mib_ValueTag)) &&
             (RRC_NOT_CAMPED_ON != rrc_ccm_get_curr_camping_status(wrrc_as_id,RRC_PROCEDURE_CSP))
            )
          {
            /* Set the timer status to TRUE */
            rrcpg1_int_data.rrcpg1_bcch_mod_timer_status = TRUE;
#ifdef FEATURE_WCDMA_QSH_EVENT_METRIC 
            ...
            /* Start the timer */
            rrctmr_start_timer(wrrc_as_id,RRCTMR_IGNORE_BCCH_MOD_TIMER, 
          ...
          else
          {
            WRRC_MSG2_HIGH("Ignoring PG1 BCCH mod IE since Srv-cell's MIB tage=%d & rexd MIB tage in PG1 = %d",
                                 rrc_get_serving_cell_mib_value_tag(wrrc_as_id),
                                 pcch_msg_ptr->message.u.pagingType1.bcch_ModificationInfo.mib_ValueTag);
			false_paging_alarm = TRUE;
          }
        }
      ...
      WRRC_MSG3_HIGH("Total Pages: %d, False Alarms: %d, False_page: %d",rrcpg1_int_data.rrcpg1_num_pages,
                 (rrcpg1_int_data.rrcpg1_num_pages - rrcpg1_int_data.rrcpg1_num_pages_matched), false_paging_alarm);

      if(false_paging_alarm == TRUE)
      {
        wl1_drx_page_ind(FALSE,wrrc_as_id);
      }
      else
      {
        /* wl1 requirenent for true page indication*/
        wl1_drx_page_ind(TRUE, wrrc_as_id);
      }
            ...
            RRC_IGNORE_BCCH_MOD_TIMER_EXPIRED_IND)
  {
    ...
    rrcpg1_int_data.rrcpg1_bcch_mod_timer_status = FALSE;
  }
  else if(cmd_ptr->cmd_hdr.cmd_id == 
            RRC_BCCH_MODIFICATION_TIMER_EXPIRED_IND)
  {
    /*Post UPDATE_SIBS_CMD to SIB */
    rrcpg1_post_update_sibs_cmd(wrrc_as_id);
  }
  else
  {
  ...
  page_info.cn_id = rrcpg1_int_data.rrcpg1_cn_domain_id;
  page_info.paging_cause = rrcpg1_int_data.rrcpg1_paging_cause; 
  rrc_qsh_log_paging_params(wrrc_as_id, RRC_PROCEDURE_PG1,&page_info);
#endif
} /* rrcpg1_process_paging_type1_msg */
/*===========================================================================
...
)
{
  ...
  rrc_crash_debug_save_proc_substates(wrrc_as_id,RRC_PROCEDURE_PG1,RRC_INVALID_PROC_SUBSTATE,cmd_ptr->cmd_hdr.cmd_id);

  WRRC_MSG1_HIGH_OPT("function rrcpg1_procedure_event_handler is called in rrc_state = rrc_state_e_type_value%d",rrc_state);

#ifdef FEATURE_WCDMA_FREE_FLOATING_TASK
  if(RRC_CPHY_NUDGE_FOR_SFN_MISS_MATCH_REQ == cmd_ptr->cmd_hdr.cmd_id)
  {
    rrcpg1_ff_modify_sibs_for_sfn_update(wrrc_as_id);
    return;
  }
#endif
  ...
  switch (rrc_state)
  {
    ...
    case RRC_STATE_CONNECTING:
      rrcpg1_process_paging_type1_msg(wrrc_as_id,cmd_ptr); 
      break;
...
void rrcpg1_init_procedure(sys_modem_as_id_e_type wrrc_as_id)
{
  ...
  rrcpg1_int_data.rrcpg1_num_pages = 0; 
  /* Reset the count for no of pages that are matched */       
  rrcpg1_int_data.rrcpg1_num_pages_matched = 0; 
  /* Set the timer status to FALSE */
  rrcpg1_int_data.rrcpg1_bcch_mod_timer_status = FALSE;
  /*Init BCCH Mod info db here*/
  rrcpg1_int_data.bcch_mod_info.bcch_mod_info_db_valid = FALSE;
  rrcpg1_int_data.bcch_mod_info.bcch_mod_mib_v_tag = RRCPG1_INVALID_MIB_V_TAG;
  rrcpg1_int_data.bcch_mod_info.bcch_mod_timer_value = RRCPG1_INVALID_BCCH_MOD_TIMER_VAL;
...
)
{
  ...
  if((rrcpg1_int_data.bcch_mod_info.bcch_mod_info_db_valid == TRUE)&&
     (rrc_get_state(wrrc_as_id) != RRC_STATE_CELL_DCH)&&
     (rrcllc_get_ordered_config_status(wrrc_as_id) != OC_SET_FOR_CELL_DCH)&&
     ((rrc_get_serving_cell_mib_value_tag(wrrc_as_id)) != (uint32)
              rrcpg1_int_data.bcch_mod_info.bcch_mod_mib_v_tag)
    )
  {
    /* Build RRC_UPDATE_SIBS_IND command to post to SIB */
    /* Allocates the buffer to RRC Internal command */
...
)
{
  ...
  if(rrcpg1_int_data.bcch_mod_info.bcch_mod_info_db_valid  ==   FALSE)
  {
  ...
  else
  {
    ...
    if((rrcpg1_int_data.bcch_mod_info.bcch_mod_mib_v_tag == mib_v_tag)&&
       (rrcpg1_int_data.bcch_mod_info.bcch_mod_timer_value == bcch_mod_timer_val)
      )
    {
      WRRC_MSG2_HIGH("Duplicate BCCHModInfo rexd,Stored MIBVtag=%d,TimerVal=%d",
                                                                          rrcpg1_int_data.bcch_mod_info.bcch_mod_mib_v_tag,
                                                                          rrcpg1_int_data.bcch_mod_info.bcch_mod_timer_value);
      status = RRCPG1_BCCH_MOD_INFO_DUPLICATE;
    }
    else if(rrctmr_get_remaining_time(wrrc_as_id,RRC_BCCH_MODIFICATION_TIMER) != (uint64)0)
    {
...
)
{
  ...
  if(rrcpg1_set_bcch_mod_info_db(wrrc_as_id,
                     mib_v_tag,
                     bcch_mod_timer) == TRUE)
  {
  
    /* Actual value BCCH-ModificationTime = IE value * 8 */
    bcch_mod_sfn = ((uint32)rrcpg1_int_data.bcch_mod_info.bcch_mod_timer_value) << 3;
    current_sfn = (uint32)wl1_seq_get_sfn(wrrc_as_id);
    bcch_mod_timer_val = (bcch_mod_sfn > current_sfn)?
                         (bcch_mod_sfn - current_sfn):((4095 -current_sfn)+bcch_mod_sfn);
  
    WRRC_MSG3_HIGH("Current SFN=%d,bcch_mod_sfn=%d,bcch timer val=%d",
                                                                current_sfn,
                                                                bcch_mod_sfn,
                                                                bcch_mod_timer_val);
    if(bcch_mod_timer_val > RRCPG1_MAX_TIME_TO_SET_UP_PCCPCH)
    {
      ...
      rrctmr_start_timer(wrrc_as_id,RRC_BCCH_MODIFICATION_TIMER, 
                                                      bcch_mod_timer_val);
    }
    else
    {
...
)
{
  ...
  if(rrctmr_get_remaining_time(wrrc_as_id,RRC_BCCH_MODIFICATION_TIMER) != (uint64)0)
  {
    rrctmr_stop_timer(wrrc_as_id, RRC_BCCH_MODIFICATION_TIMER);
    abort_status = TRUE;
  }
...
)
{
  ...
  if((mib_v_tag < RRCPG1_INVALID_MIB_V_TAG)&&
     (mib_v_tag != 0))
  {
    rrcpg1_int_data.bcch_mod_info.bcch_mod_mib_v_tag  =  mib_v_tag;
    status = TRUE;
  }
  ...
  {
    rrcpg1_int_data.bcch_mod_info.bcch_mod_timer_value = bcch_mod_timer;
    status = TRUE;
  }
  ...
  WRRC_MSG3_HIGH("BCCH ModInfo DB is status %d with MibVtag=%d,BcchTimer=%d",
                  status,
                  mib_v_tag,
                  bcch_mod_timer);
  if(status == TRUE)
  {
    rrcpg1_int_data.bcch_mod_info.bcch_mod_info_db_valid = TRUE;
  }
  return status;
}
/*===========================================================================
...
)
{
  if(bcch_mod_time_present == TRUE)
  {
    ...
    bcch_mod_info_status = rrcpg1_check_for_duplicate_bcch_mod_info(wrrc_as_id,
                                                                     mib_v_tag,
                                                                     bcch_mod_time
                                                                   );
    if(bcch_mod_info_status == RRCPG1_BCCH_MOD_INFO_NOT_IN_PROCESS)
    {
      rrcpg1_process_bcch_mod_info(wrrc_as_id,
                                    mib_v_tag,
                                    bcch_mod_time
                                   );
    }
  ...
  else
  {
    ...
    /*Make sure that MIB Value Tag is populated properly
      ...
      from BCCHModInfo db*/
    status = rrcpg1_set_bcch_mod_info_db(wrrc_as_id,
                                         mib_v_tag,
                                         bcch_mod_time
                                        );
    if(status == TRUE)
...
===========================================================================*/
uint32 rrcpg1_get_num_pages(sys_modem_as_id_e_type wrrc_as_id)
{
  return rrcpg1_int_data.rrcpg1_num_pages;
}
/*===========================================================================
...
===========================================================================*/
uint32 rrcpg1_get_num_pages_matched(sys_modem_as_id_e_type wrrc_as_id)
{
  return rrcpg1_int_data.rrcpg1_num_pages_matched;
}
