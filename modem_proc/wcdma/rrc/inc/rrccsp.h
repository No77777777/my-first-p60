...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrccsp.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
31/08/18   ga      MAde cahnges for W-pref FR50563
11/13/17   sp      Made changes to save DDS sub id indicated by NAS
11/09/17   sas     Made changes to provide support for 1XSRLTE mode to WL1
03/14/16   sn      Changes for FR30515 
03/17/16   sn      Changes for FR30881
03/10/16   sas     Made changes to correctly send WCDMA capability to Wl1
...
typedef enum
{
  ...
  ,RRC_CSP_LTE_CELL_BARRED /* FEATURE_WCDMA_TO_LTE */
  ,RRC_CSP_LTE_FREQ_BARRED /* FEATURE_WCDMA_TO_LTE */
...
typedef struct
{
   ...
   */
  boolean rrc_add_l1_wakeup_time;
   ...
   */
  boolean rrc_drx_exp_when_wtng_for_mib;

  boolean DS_Immediate_preempt_waiting_for_init_cell_sel;

  boolean DS_Tuneaway_for_Immediate_preempt;

  boolean rrc_is_sim_id_valid;
  
  boolean wcdma_is_ue_in_dual_standby;

  boolean wcdma_is_ue_in_sxlte_mode;
  
  /* Below variable indicates whether UE should look for concurrency NV for connected mode features */
  boolean wcdma_look_for_concurrency_nv;
  ...
  sys_modem_as_id_e_type rrc_sim_id_recvd;

  sys_modem_device_mode_e_type wcdma_device_mode;

  wl1_common_fail_enum_type wl1_failure_cause;
...
/* As per systems recommendation, GSM lock for RACH can withstand a delay of 1 second
  ...
  uint8 delay_preempt_counter;

  /*Set to TRUE if RRC receives DL weak indication with no resource*/
  boolean rrc_dl_wk_no_res;

  /* Indicates if LTE capability is present in the current sub */
  boolean rrc_lte_capability_ind;  

  /* Indicates if TDS capability is present in the current sub */
  boolean rrc_tds_capability_ind;  

  /* Indicates if WCDMA capability is present in the current sub */
  boolean wcdma_capability_ind;

  /* Indicates if 1X SRLTE capability is present in the current sub */
  boolean rrc_1x_srlte_capability_ind;

  /* Holds the TRM priority requested by RRC */
  /* Currently used when requesting for lock after QTA end */
  trm_reason_enum_t rrc_trm_priority;

  /* Indicates the NAS procedure for which TRM lock is needed */
  sys_proc_type_e_type   nas_proc_type;

  /* Boolean to check if transport phy channel release have been already been sent */
  boolean tr_phy_chl_rel_sent;  

  sys_modem_as_id_e_type dds_sub_id;

  /* GSM PREF or LTE PREF */
  int8 fallback_type;  /*trm_idle_coll_fallback_enum_t*/

  /* Rat which will have least reselection priority (W/L) */
  sys_sys_mode_e_type least_priority_rat;

 /*Will be set to True once measurements are prioritized for Fallback*/
  boolean fallback_meas_configured;
 
  /*Will be set to True if g meas is to be barred during Fallback*/
  boolean stop_g_meas;
}rrc_dsds_int_data_type;

#ifdef FEATURE_DUAL_WCDMA
extern rrc_dsds_int_data_type rrc_dsds_int_data_sim[MAX_RRC_STACKS];
#define rrc_dsds_int_data rrc_dsds_int_data_sim[WAS_ID_M]
#else
...
extern const rrc_UARFCN rrc_ul_band_b_addl_channels[];
extern const rrc_UARFCN rrc_dl_band_b_addl_channels[];

/* Valid additional channels for 850 MHz band */
/* NOTE: These arrays must be zero-terminated. */
extern const rrc_UARFCN rrc_ul_band_c_addl_channels[];
extern const rrc_UARFCN rrc_dl_band_c_addl_channels[];

/* Valid additional channels for 800 MHz band */
/* NOTE: These arrays must be zero-terminated. */
extern const rrc_UARFCN rrc_ul_band_d_addl_channels[];
extern const rrc_UARFCN rrc_dl_band_d_addl_channels[];
...
extern const rrc_UARFCN rrc_ul_band_h_addl_channels[];
extern const rrc_UARFCN rrc_dl_band_h_addl_channels[];

extern const rrc_UARFCN rrc_ul_band_j_addl_channels[];
extern const rrc_UARFCN rrc_dl_band_j_addl_channels[];
...
===========================================================================*/
extern  void  rrc_cell_selection_procedure(sys_modem_as_id_e_type wrrc_as_id,  rrc_cmd_type  *cmd_ptr );
...
===========================================================================*/
extern  void  rrc_init_cell_selection_procedure(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
extern  void  rrccsp_get_serving_pccpch_parms(sys_modem_as_id_e_type wrrc_as_id, uint16 *scr_code_ptr, boolean *sttd_ptr);
...
===========================================================================*/
void rrccsp_get_neighbor_pccpch_parms(sys_modem_as_id_e_type wrrc_as_id, uint16 *scr_code_ptr,
                                      uint16 * freq_ptr);
...
===========================================================================*/
boolean  rrccsp_is_inter_frequency_cell_resel_in_progress(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
boolean  rrccsp_init_measurements_in_l1_on_cphy_idle(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void rrccsp_send_bplmn_search_cnf_to_rr(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void
rrccsp_send_bplmn_abort_cnf_to_rr(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
boolean rrccsp_is_in_bplmn_list (sys_modem_as_id_e_type wrrc_as_id, rrc_plmn_identity_type plmn_id
...
===========================================================================*/
void rrccsp_send_cphy_cell_bar_req(sys_modem_as_id_e_type wrrc_as_id, rrc_csp_cell_bar_info_e_type, uint32);
...
SIDE EFFECTS      None.
===========================================================================*/
void rrccsp_send_interrat_reselection_abort_cnf(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS      None.
===========================================================================*/
void rrccsp_send_interrat_reselection_reject(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void rrc_csp_get_aset_scr_pn(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void rrc_csp_send_bplmn_suspend_req(sys_modem_as_id_e_type wrrc_as_id, rrc_proc_e_type proc, rrc_bplmn_suspend_cause_e_type cause);
...
===========================================================================*/
void rrccsp_update_wtow_manual_bplmn_list_with_rplmn(sys_modem_as_id_e_type wrrc_as_id,
  rrc_plmn_identity_type plmn_id, rrc_int_cell_id_type cell_id);
...
===========================================================================*/
void rrccsp_prioritize_pending_commands(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
SIDE EFFECTS
                  None
===========================================================================*/
void rrc_csp_send_mm_plmn_list_cnf_as_aborted(sys_modem_as_id_e_type wrrc_as_id,  uint8);
...
===========================================================================*/
void rrccsp_save_req(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
SIDE EFFECTS      None.
===========================================================================*/
void rrccsp_send_gsm_interrat_bplmn_abort_req(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS      None.
===========================================================================*/
void rrccsp_send_gsm_interrat_bplmn_suspend_ind(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
boolean rrc_csp_is_ppac_valid(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  None.
====================================================================*/
uecomdef_status_e_type rrccsp_fill_nas_common_info(sys_modem_as_id_e_type wrrc_as_id,
...
SIDE EFFECTS:
  None.
====================================================================*/
uecomdef_status_e_type rrccsp_fill_nas_cn_specific_info(sys_modem_as_id_e_type wrrc_as_id,
...
===========================================================================*/
boolean rrccsp_is_band_class_enabled_in_ui_rf(sys_modem_as_id_e_type wrrc_as_id,
...
SIDE EFFECTS: NONE
=============================================================================*/
void rrccsp_check_and_teardown_sbcch_during_bplmn(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS      None.
===========================================================================*/
void rrccsp_send_gtow_redirection_abort_cnf(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS      None.
===========================================================================*/
void rrccsp_send_gtow_redirection_reject(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS      None
===========================================================================*/
boolean rrc_csp_is_reselection_cleared(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void rrccsp_handle_activation_rsp_for_mdsp_halt(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
boolean rrccsp_is_rrc_waiting_for_act_rsp_to_handle_mdsp_halt(sys_modem_as_id_e_type wrrc_as_id);
#endif
...
===========================================================================*/
void rrc_csp_fill_cgi_bplmn_tmr_exp(sys_modem_as_id_e_type wrrc_as_id);
#endif
...
/*===========================================================================
  ...
  SIDE EFFECTS
                None
===========================================================================*/
void rr_send_rrc_message_to_rr_internal(sys_modem_as_id_e_type wrrc_as_id,
  void *            message_ptr,
...
===========================================================================*/
sys_band_T rr_rrc_get_arfcn_band_internal(sys_modem_as_id_e_type wrrc_as_id,
  uint16                       arfcn,
...
===========================================================================*/
void rr_rrc_set_band_pref_internal(sys_modem_as_id_e_type wrrc_as_id, sys_band_mask_type     band_pref);
...
===========================================================================*/
void rr_rrc_set_bst_band_pref_internal(sys_modem_as_id_e_type wrrc_as_id, sys_band_mask_type     band_pref);
...
===========================================================================*/
void rr_rrc_clear_acq_chnl_info_internal(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
void rrccsp_force_send_deact_cnf(sys_modem_as_id_e_type wrrc_as_id);
#ifdef FEATURE_DUAL_SIM
/*===========================================================================
...
===========================================================================*/
void rrc_csp_bplmn_update_select_data_for_reattempt(sys_modem_as_id_e_type wrrc_as_id);
#endif
/*===========================================================================
...
uint8 rrccsp_convert_ecio_meas_to_report(sys_modem_as_id_e_type wrrc_as_id, int16 ecio);
...
boolean rrccsp_bar_forbid_cells
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_SysInfoType3 *sib3_ptr,
  rrc_plmn_identity_type plmn_id,
