...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrcdt.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
FUNCTION rrcscr_get_signalling_connection_sts
...
boolean rrcidt_check_if_est_cause_available(sys_modem_as_id_e_type wrrc_as_id, rrc_proc_e_type proc_id, 
...
boolean rrcidt_is_cs_call_initiate(sys_modem_as_id_e_type wrrc_as_id);
...
void rrcidt_set_sent_by_cu(sys_modem_as_id_e_type wrrc_as_id,  rrc_proc_e_type proc_id);
...
void rrcidt_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
void rrcudt_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
/*===========================================================================
...
void rrcscrr_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
void rrcddt_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
/*===========================================================================
...
void rrcscr_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
DESCRIPTION
  Returns the establishment cause for CS IDT
  
DEPENDENCIES
  None

RETURN VALUE
  CS establishment cause
