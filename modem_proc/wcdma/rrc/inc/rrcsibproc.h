...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrcsibproc.h#3 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/20/18   ak      Made changes for FR 53313
06/30/17   dj      An Api for L1 to check whether to ignore wakeup cancel or to do wakeup_cancel.
04/18/16   sr      Made changes to block QTA if NBCCH setup is in progress for inter f reselection
03/03/16   vs      Changes to update serving cell parameters from sib3/4 to L1
...
/* Empty mask duration after receiving MIB in G2W mode*/
#define RRCSIB_EMPTY_FRAMES 10
#endif
...
typedef struct{
  uint16 Fdd1_internal_band[MAX_FDD1_BANDS];
  uint16 Fdd2_internal_band[MAX_FDD2_BANDS];
  ...
  boolean rrcsib_powerup_init_done;
...
extern rrcsibproc_ext_data_type rrcsibproc_ext_data_sim[MAX_RRC_STACKS];
#define rrcsibproc_ext_data rrcsibproc_ext_data_sim[WAS_ID_M]
#else
extern rrcsibproc_ext_data_type rrcsibproc_ext_data;
#endif
...
extern boolean rrcrce_is_rce_procedure_active(sys_modem_as_id_e_type wrrc_as_id);
...
===========================================================================*/
extern void rrc_sib_proc_init(sys_modem_as_id_e_type wrrc_as_id);
...
DESCRIPTION
  ...
  This function will be used to check if frequency band indicator support 
  is present in sib5 or not.
...
===========================================================================*/
void rrcsib_check_for_redirection_bands_support
(
  sys_modem_as_id_e_type wrrc_as_id,
  boolean *supportoffrequencyband
);
#endif
...
===========================================================================*/
void rrc_sib_proc_variables_init(sys_modem_as_id_e_type wrrc_as_id);

/*===========================================================================
...
===========================================================================*/
boolean rrcsib_check_mib_read_status(sys_modem_as_id_e_type wrrc_as_id, boolean for_serv_cell);
/*===========================================================================
...
===========================================================================*/
uecomdef_status_e_type rrcsib_get_sib_7_update_status(sys_modem_as_id_e_type wrrc_as_id);
...
FUNCTION rrcsib_send_g2w_table

DESCRIPTION

  Generates and sends table in G2W mode
...
===========================================================================*/
boolean rrc_handle_wakeup_cancel
(
  sys_modem_as_id_e_type wrrc_as_id,
  uint32 reserve_occasion_ms
);
...
===========================================================================*/
void rrcsib_clear_altsub_sibdb_cell_index
(
  sys_modem_as_id_e_type wrrc_as_id,
  rrc_plmn_identity_type plmn,
  rrc_int_cell_id_type cell
