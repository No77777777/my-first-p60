...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrcllc.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/10/18   ak      Made changes to trash channel config before cell trans failure.
...
01/14/16   nr      Made changes to remove F3 in rrcllc_get_ordered_config_state_and_proc 
10/27/15   sp      Made changes to remove F3 in rrc_get_ordered_config_status function
...
typedef enum
{
  ...
  LLC_WAIT_CPHY_TRM_STOP_WCDMA_MODE_CNF, /* FEATURE_UMTS_1X_HANDOVER_UMTSMSM */

  LLC_WAIT_CPHY_RECOVER_CNF, /* FEATURE_WCDMA_HANDLE_MDSP_HALT */
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrcllc_init(sys_modem_as_id_e_type wrrc_as_id, rrcllc_init_e_type  init_type);
...
SIDE EFFECTS:
  None.
====================================================================*/
void  rrcllc_swap_oc_and_cc(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  ...
  this TrCH.
====================================================================*/
uint32 rrcllc_calculate_ul_tm_ccch_rlc_size(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  None.
====================================================================*/
rrcllc_oc_set_status_e_type rrcllc_get_ordered_config_status(sys_modem_as_id_e_type wrrc_as_id);
/*====================================================================
...
SIDE EFFECTS:
  None.
====================================================================*/
rrcllc_oc_set_status_e_type rrcllc_get_ordered_config_status_wo_f3(sys_modem_as_id_e_type wrrc_as_id);
/*====================================================================
...
SIDE EFFECTS:
  None.
====================================================================*/
rrcllc_toc_usage_e_type rrcllc_get_toc_usage(sys_modem_as_id_e_type wrrc_as_id);
/*====================================================================
...
SIDE EFFECTS:
  None.
====================================================================*/
rrcllc_oc_process_state_e_type rrcllc_get_ordered_config_process_state(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  None.
====================================================================*/
boolean rrcllc_reconfig_in_progress(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  None.
====================================================================*/
rrcllc_oc_set_status_e_type rrcllc_get_ordered_config_state_and_proc(sys_modem_as_id_e_type wrrc_as_id,
 ...
 SIDE EFFECTS:
   None.
 ====================================================================*/
 rrcllc_oc_set_status_e_type rrcllc_get_ordered_config_state_and_proc_wo_f3(sys_modem_as_id_e_type wrrc_as_id,
                                                    rrc_proc_e_type *proc_ptr,
                                                    rrcllc_oc_process_state_e_type *process_status_ptr
                                                     );
...
SIDE EFFECTS:
  None.
====================================================================*/
rrcllc_oc_set_status_e_type rrcllc_reset_ordered_config(sys_modem_as_id_e_type wrrc_as_id,
                                                   rrc_proc_e_type proc_id
                                                   ,boolean reset_toc
...
====================================================================*/
uint32 rrcllc_get_drx_info(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
====================================================================*/
void rrcllc_set_utran_drx_info(sys_modem_as_id_e_type wrrc_as_id,  uint32 utran_drx_coef );
...
====================================================================*/
rrcllc_crnti_status_e_type
rrcllc_get_current_crnti_status(sys_modem_as_id_e_type wrrc_as_id);
...
====================================================================*/
rrcllc_urnti_status_e_type
rrcllc_get_current_urnti(sys_modem_as_id_e_type wrrc_as_id, uint32 *urnti);
/*====================================================================
...
====================================================================*/
rrcllc_urnti_status_e_type
rrcllc_get_urnti_from_toc(sys_modem_as_id_e_type wrrc_as_id, uint32 *urnti);
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrcllc_update_lbt_mode_for_dchs(sys_modem_as_id_e_type wrrc_as_id,
...
void rrcllc_update_lbt_mode_for_fachs(sys_modem_as_id_e_type wrrc_as_id,
  l1_loop_back_mode_type_enum_type loopback_test_mode
);
...
====================================================================*/
uecomdef_status_e_type  rrcllc_update_sib1_data(sys_modem_as_id_e_type wrrc_as_id);
...
rrcllc_return_freq_for_fach_pch(sys_modem_as_id_e_type wrrc_as_id, rrc_freq_type  *freq);
...
=============================================================================*/
uecomdef_status_e_type
rrcllc_return_psc_for_fach_pch(sys_modem_as_id_e_type wrrc_as_id, rrc_scr_code_type  *psc);
...
====================================================================*/
boolean  rrcllc_can_oc_be_cleared_now(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrcllc_update_ciphering_config_info_for_first_tm_rb(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS:
  None.
====================================================================*/
void rrcllc_update_ciphering_config_info_for_handover(sys_modem_as_id_e_type wrrc_as_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
boolean rrcllc_error_recovery_in_progress(sys_modem_as_id_e_type wrrc_as_id);
...
=====================================================================*/
rrcllc_substate_e_type rrcllc_return_current_substate(sys_modem_as_id_e_type wrrc_as_id);
...
=====================================================================*/
boolean rrcllc_is_rab_release_in_progress(sys_modem_as_id_e_type wrrc_as_id);
...
=====================================================================*/
boolean rrcllc_check_going_to_old_config(sys_modem_as_id_e_type wrrc_as_id);
...
=====================================================================*/
boolean rrcllc_check_sufficient_act_time(sys_modem_as_id_e_type wrrc_as_id);
...
sys_modem_as_id_e_type wrrc_as_id
  ...
  /*====================================================================
  FUNCTION: rrcllc_is_pccpch_active()
  
  DESCRIPTION:
    This function will return TRUE if PCCPCH is active in semi permanent db
...
boolean rrcllc_is_pccpch_active(sys_modem_as_id_e_type wrrc_as_id);
...
/*===========================================================================
FUNCTION rrcllc_return_feature_dch_fach_opt_enabled
...
boolean rrcllc_return_feature_dch_fach_opt_enabled(sys_modem_as_id_e_type wrrc_as_id);

/*====================================================================
FUNCTION: rrcllc_trash_channel_config_if_cell_trans_fails()

DESCRIPTION:
This function trashes channel config in queue if cell trans fails.
...
rrcllc_substate_e_type rrcllc_trash_channel_config_if_cell_trans_fails(sys_modem_as_id_e_type wrrc_as_id);
