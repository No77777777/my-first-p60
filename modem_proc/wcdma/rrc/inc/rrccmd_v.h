...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrccmd_v.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/21/18   sp      Made changes to ignore OTA with duplicate trid
02/21/18   nr      CR973374: Made changes to not allow LTA if delay restriction IE is set
...
#ifdef FEATURE_DUAL_WCDMA
  extern rrc_buffer_ota_info_type rrc_buffer_ota_info_sim[MAX_RRC_STACKS];
  #define rrc_buffer_ota_info rrc_buffer_ota_info_sim[WAS_ID_M]
#else
  extern rrc_buffer_ota_info_type rrc_buffer_ota_info;
