...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrcrce.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
11/12/15   sp      Made changes to log call end info.
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 rrcrce_get_num_retries_count(sys_modem_as_id_e_type wrrc_as_id);
