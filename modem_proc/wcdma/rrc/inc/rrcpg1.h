...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrcpg1.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
/* Internal data structures to store information about pagint type 1 module */
typedef struct
{
  ...
  rrcpg1_paging_type_e_type     rrcpg1_paging_type;

  /* The UE ID used for paging */
  rrc_page_ue_id_choice_e_type  rrcpg1_page_ue_id;

  uint32 rrcpg1_num_pages;   
  /* Number of Paging Type 1 messages  received */

  uint32 rrcpg1_num_pages_matched; 
  /* Number of Pages that are  matched */
  boolean rrcpg1_bcch_mod_timer_status;
  /* Status of Timer to ignore BCCH Modifcation Info */

  /*Saved Mib value tag & BCCH Mod Time from OTA message*/
  rrcpg1_paging_bcch_mod_info bcch_mod_info;
}rrcpg1_int_data_type;
...
void rrcpg1_procedure_event_handler(sys_modem_as_id_e_type wrrc_as_id, rrc_cmd_type *cmd_ptr);
...
===========================================================================*/
void rrcpg1_ff_modify_sibs_for_sfn_update(sys_modem_as_id_e_type wrrc_as_id);
#endif
