...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrccspdb.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
#define RRCCSP_FINE_SCAN_SKIP_RANGE   rrcnv_data.wcdma_freq_skip_range_nv
...
#define  RRC_CSP_PCS_BAND              (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_PCS_BAND_INDEX]
#define  RRC_CSP_IMT2K_BAND            (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_IMT2K_BAND_INDEX]
#define  RRC_CSP_WCDMA_800_BAND        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_800_BAND_INDEX]
#define  RRC_CSP_WCDMA_850_BAND        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_850_BAND_INDEX]
#define  RRC_CSP_WCDMA_1800_BAND       (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1800_BAND_INDEX]
#define  RRC_CSP_WCDMA_900_BAND        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_900_BAND_INDEX]
#define  RRC_CSP_WCDMA_1700_BAND       (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1700_BAND_INDEX]
#define  RRC_CSP_WCDMA_1700_2100_BAND  (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1700_2100_BAND_INDEX]
#define  RRC_CSP_WCDMA_1500_BAND       (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1500_BAND_INDEX]
#define  RRC_CSP_WCDMA_BC19_BAND       (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_BC19_BAND_INDEX]
#define  RRC_CSP_BAND_MAX              0x1000

#ifdef FEATURE_DUAL_WCDMA
#define  WRRC_CSP_PCS_BAND(wrrc_as_id)              (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_PCS_BAND_INDEX]
#define  WRRC_CSP_IMT2K_BAND(wrrc_as_id)             (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_IMT2K_BAND_INDEX]
#define  WRRC_CSP_WCDMA_800_BAND(wrrc_as_id)         (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_800_BAND_INDEX]
#define  WRRC_CSP_WCDMA_850_BAND(wrrc_as_id)         (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_850_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1800_BAND(wrrc_as_id)        (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1800_BAND_INDEX]
#define  WRRC_CSP_WCDMA_900_BAND(wrrc_as_id)         (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_900_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1700_BAND(wrrc_as_id)        (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1700_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1700_2100_BAND(wrrc_as_id)   (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1700_2100_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1500_BAND(wrrc_as_id)        (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1500_BAND_INDEX]
#define  WRRC_CSP_WCDMA_BC19_BAND(wrrc_as_id)        (uint16)rrcnv_data_sim[wrrc_as_id].rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_BC19_BAND_INDEX]
#define  WRRC_CSP_BAND_MAX(wrrc_as_id)               0x1000
#else
#define  WRRC_CSP_PCS_BAND(wrrc_as_id)              (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_PCS_BAND_INDEX]
#define  WRRC_CSP_IMT2K_BAND(wrrc_as_id)             (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_IMT2K_BAND_INDEX]
#define  WRRC_CSP_WCDMA_800_BAND(wrrc_as_id)         (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_800_BAND_INDEX]
#define  WRRC_CSP_WCDMA_850_BAND(wrrc_as_id)         (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_850_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1800_BAND(wrrc_as_id)        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1800_BAND_INDEX]
#define  WRRC_CSP_WCDMA_900_BAND(wrrc_as_id)         (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_900_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1700_BAND(wrrc_as_id)        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1700_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1700_2100_BAND(wrrc_as_id)   (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1700_2100_BAND_INDEX]
#define  WRRC_CSP_WCDMA_1500_BAND(wrrc_as_id)        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_1500_BAND_INDEX]
#define  WRRC_CSP_WCDMA_BC19_BAND(wrrc_as_id)        (uint16)rrcnv_data.rrc_nv_band_priority_config.band_priority_list[RRC_CSP_WCDMA_BC19_BAND_INDEX]
#define  WRRC_CSP_BAND_MAX(wrrc_as_id)               0x1000
...
/* We need 4 NV ACQ lists as a NV item has a limitation of 128 bytes */
  nv_acq_list1_type    nv_acq_list1; /* Has 3 items */
  nv_acq_list1_type    nv_acq_list2; /* Has 3 items */
  nv_acq_list2_type    nv_acq_list3; /* Has 2 items */
  nv_acq_list2_type    nv_acq_list4; /* Has 2 items */
  nv_item_type         nv_wcdma_dl_freq; /* Only item */
  nv_item_type         nv_wcdma_dl_freq_enabled; /* Only item */

#ifdef FEATURE_FEMTO_CSG
  char wcdma_csg_efs_list_2[60];

  char wcdma_csg_efs_list_3[60];

  char wcdma_csg_efs_list_4[60];

  char wcdma_csg_efs_list_5[60];

#endif

  char wcdma_csg_efs_db[60];

  char wcdma_csg_efs_list_1[60];
 ...
 */
  rrc_plmn_identity_type   rrc_csp_last_req_plmn_id;
 ...
 * rrc_csp_get_next_acq_entry() with the one stored by it. Both should match.
 */
  rrc_csp_acq_e_type       rrc_csp_last_req_type_acq;

} rrccspdb_int_data_type;
...
SIDE EFFECTS
                  None
===========================================================================*/
boolean rrccsp_should_freq_be_skipped(sys_modem_as_id_e_type wrrc_as_id, rrc_freq_type freq, uint16 resolution);
...
SIDE EFFECTS       None
===========================================================================*/
void rrccsp_add_acq_db_and_nw_db_entries(sys_modem_as_id_e_type wrrc_as_id,
...
===========================================================================*/
void rrccsp_log_macro_fp_info(sys_modem_as_id_e_type wrrc_as_id, uint8);
#endif
