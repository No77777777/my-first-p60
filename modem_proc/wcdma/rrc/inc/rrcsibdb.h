...
$Header: //components/rel/wcdma.mpss/8.4.0/rrc/inc/rrcsibdb.h#2 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
FUNCTION RRC_SIBDB_SET_DECODED_SIBS_TO_NULL
...
===========================================================================*/
void rrc_sibdb_clear_a_cell_index(sys_modem_as_id_e_type wrrc_as_id,
uint32 dbindex
);
