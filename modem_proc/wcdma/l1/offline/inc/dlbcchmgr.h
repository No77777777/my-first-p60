...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dlbcchmgr.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     ---------------------------------------------------------
09/23/15    pr      Perform preliminary check also when delivering PCH data to MAC at first crc pass.
09/22/15    sl      Deliver PCH data to MAC at first crc pass itself.
...
SUB 1:
    Primary carrier - 1
*/
#define DL_BCCH_MAX_ALLOWED_PCCPCH 4
...
#define WL1_SIB_SCHEDULE_TABLE_SIZE 512
...
** bit array means we should read the SIB data at that SFN. */
  ...
  #ifdef FEATURE_DUAL_SIM
  uint8 sib_table[WL1_SIB_SCHEDULE_TABLE_SIZE];
  #endif
}dlbcchmgr_ext_cntrl_params_type;

extern dlbcchmgr_ext_cntrl_params_type dlbcchmgr_ext_cntrl_params[WCDMA_NUM_SUBS];

extern dl_bcch_cfg_struct_type dl_bcch_cfg_db[DL_BCCH_CFG_DB_SIZE];

extern const channel_cb_struct_type  dl_bcch_drx_cb_functions;
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_bcch_process_bch_crc_status_cmd(dl_bch_crc_status_type *cmd, wsub_id_e_type wsub_id);
...
extern void dl_bch_status_rpt (uint8 cctrch_table_index, boolean crc_status,
  uint32 eng, uint16 sfn, uint8 cfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_bcch_dealloc_cfg_db_idx(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern dl_ch_spec_cfg_db_idx_type dl_bcch_alloc_cfg_db_idx(dlchmgr_cfg_db_idx_type chmgr_cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_post_add_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        dl_bcch_per_cfg_db_init

DESCRIPTION     This function initializes the bcch  db for perticular cfg db idx. 
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_bcch_per_cfg_db_init(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id );
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void l1m_cphy_sib_sched_change_ind(const l1_ext_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void dl_sib_save_chan(const l1_setup_cmd_type* setup, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_pre_drop_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_bcch_is_bch_svc_on_cell(uint16 freq, uint16 psc, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern srch_cell_struct_type*  dl_bcch_get_cell_info_for_n_sib_read( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_post_drop_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_acq_bch_decode_done_cmd (dl_acq_bch_decode_done_cmd_type *acq_bch_decode_done, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_pre_resume_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_post_resume_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_post_suspend_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_bcch_send_acq_bch_decode_done_cmd(dlchmgr_cfg_db_idx_type chmgr_cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_bcch_send_srch_sfn_wrc_diff_done_cmd(dlchmgr_cfg_db_idx_type chmgr_cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_bcch_send_pccpch_weak_indication(dl_bcch_weak_ind_cmd_type *cmd, wsub_id_e_type wsub_id);
...
extern void dl_bcch_run_bler_state_machine(uint8 cctrch_idx, uint8 trch_idx, uint8 rece_cfn,
  uint8 num_err_blk, uint8 num_total_blk, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_bcch_update_sttd_info(dl_ch_spec_cfg_db_idx_type ch_spec_cfg_db_idx, boolean sttd_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_bcch_get_sttd_info(uint8 cctrch_idx, wsub_id_e_type wsub_id);

extern void dl_bcch_handle_wrong_cfn( wsub_id_e_type wsub_id);

#ifdef FEATURE_DUAL_SIM
/*=========================================================================
FUNCTION    DL_BCCH_SEND_SPECIFIC_SIB_MASK

DESCRIPTION
  Sends a fake SIB mask with specified mask type

PARAMETERS
   Parameter 1 - dl_bcch_sib_mask_type either all zeros or all ones. 
...
RETURN VALUE
  None
=========================================================================*/
extern void dl_bcch_send_specific_sib_mask(dl_bcch_sib_mask_type mask_type, boolean perform_sched_update, wsub_id_e_type wsub_id);

/*=========================================================================
FUNCTION    DL_BCCH_SEND_FAKE_SIB_SCHED_CHANGE_BEFORE_CELL_SEL_REQ
...
RETURN VALUE
  None
=========================================================================*/
extern void dl_bcch_send_fake_sib_sched_change_before_cell_sel_req( wsub_id_e_type wsub_id);
#endif /* FEATURE_DUAL_SIM */

/*===========================================================================
FUNCTION        DL_BCCH_IS_EARLY_DATA_DELIVERY_TO_MAC_FEASIBLE

DESCRIPTION     This function checks if PCH data can be delivered to MAC early
                In Legacy, if dynamic pass count >= min_pass_count at frame X
                then data would be delivered to MAC from frame X+1 onwards.
                With this new API, data delivery to MAC is feasible for the data
                decoded at frame X itself

DEPENDENCIES    None

RETURN VALUE
                TRUE: data can be delivered to MAC
                FALSE: otherwise

SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_bcch_is_early_data_delivery_to_mac_feasible(uint8 cctrch_idx, uint8 bch_decode_cfn, uint16 bch_decode_sfn, uint16 bch_tbset_energy, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        dl_bcch_get_chmgr_cfg_db_idx_from_psc_freq

DESCRIPTION     This function finds the dl channel manager config db index based on the 
                following conditions: given PSC, Freq, 
...
SIDE EFFECTS    None
===========================================================================*/
extern dlchmgr_cfg_db_idx_type dl_bcch_get_chmgr_cfg_db_idx_from_psc_freq(uint8 psc,uint8 freq,wsub_id_e_type wsub_id);
