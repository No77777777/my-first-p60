...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/seq_v.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
#define L1_NUM_PENDING_ACT_TIMES 5

typedef rex_crit_sect_type seq_crit_sect_type;
...
typedef struct
{
  ...
  uint8 delay;
  uint16 sfn;
  uint32 timetick_sclk;
}seq_cfn_delay_record;

typedef struct
{
  rex_crit_sect_type wcdma_seq_cfn_update_lock;
  rex_crit_sect_type wcdma_seq_sfn_cfn_mutex_lock;
  seq_crit_sect_type seq_crit_sect;
  /*Whenever S_BCH SFN sanity check handler runs it sets flag if decoded SFN matches with the TLM_SFN*/
  boolean seq_perform_sfn_sanity;
  /* Type of generic event currently active */
  seq_generic_event_enum_type seq_generic_event;
  rex_crit_sect_type wcdma_seq_pich_demod_event_enabled_lock;
}seq_ext_cntrl_params_type;

extern seq_ext_cntrl_params_type seq_ext_cntrl_params[WCDMA_NUM_SUBS];


typedef struct
{
  /* indicates whether or not the pich demod event is enabled */
  boolean seq_pich_demod_event_enabled;
  /* call back functions to get the l1 sequecer cfn */
  l1_cfn_update_notify_struct_type l1_seq_cfn_update_notify_info[L1_SEQ_CFN_REQ_MAX_CLIENTS];
  /* variable to keep track whether the interrupt sources are slaved to a
 * physical channel or the frame reference counter.
 */
  seq_align_type tl_align_source;
  uint16 cur_sfn;
  /* variable that returns the current physical channel or frame reference
 * counter the STMR is currently aligned to and the current time in slot,ticks
 */
  seq_align_struct_type align_type;
  /* incremented every time seq_non_dch_sfn_cfn_update_event_handler() is called */
  uint32 debug_counter;
  #ifdef FEATURE_QTA
  boolean l1_seq_pending_cmd_on_hold_for_qta;
  #endif /*FEATURE_QTA*/
  seq_cfn_delay_record seq_cfn_evt_delay_arr[100];
  uint8 seq_cfn_evt_delay_arr_cntr;
  #ifdef FEATURE_MDSP_DIAG_MSGS_ENABLED
  /*contains the last read idx and write idx*/
  uint16 l1_dsp_diag_read_idx;
  #endif /*FEATURE_MDSP_DIAG_MSGS_ENABLED*/
  /*The range of cur_extended_sfn is 0 to 0x7FFFFFFF; It is set during cell 
selection and reselection; It is same as cur_sfn with a a larger range;
cur_extended_sfn%4096 will be always equal to cur_sfn*/
  int32 cur_extended_sfn;
  #ifdef FEATURE_MDSP_DIAG_MSGS_ENABLED
  /*contains the last read idx and write idx*/
  uint16 l1_dsp_diag_wr_idx;
  #endif /*FEATURE_MDSP_DIAG_MSGS_ENABLED*/
  /* indicates whether the pich_demod event has fired yet at the expected SFN */
  boolean seq_pich_demod_done;
  uint8 cur_cfn;
  /* debug variable */
  uint8 debug_seq_tlm;
  /* Number of call back function registered to get l1 seq cfn for every cfn update event*/
  uint8 l1_seq_num_get_cfn_cb;
  l1_cfn_update_notify_struct_type seq_local_cfn_update_notify_struct;
  /* saved SFN at which the pich_demod event fired */
  uint16 seq_pich_demod_sfn;
  /* Array of pending Activation Times */
  seq_pending_cmd_struct_type pending_cmd[L1_NUM_PENDING_ACT_TIMES];
}seq_int_cntrl_params_type;
/*===========================================================================
...
FUNCTION SEQ_GET_ALIGN_TYPE_SUB0
...
SIDE EFFECTS
  None
===========================================================================*/
extern seq_align_struct_type seq_get_align_type_for_sub( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern seq_align_type seq_get_current_align_type( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 wl1_seq_get_sfn( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern int32 seq_get_extended_sfn( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 seq_get_cur_eul_subfn( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void seq_set_sfn_cfn(uint16 new_sfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  This function locks interrupts for updating the sfn value.
===========================================================================*/
extern void seq_set_sfn_cfn_wrc(uint16 new_sfn, wsub_id_e_type wsub_id);

/*===========================================================================
...
===========================================================================*/
extern void seq_load_sfn( uint16 new_sfn , wsub_id_e_type wsub_id);

/*===========================================================================
...
===========================================================================*/
extern void seq_load_cfn( uint16 new_cfn , wsub_id_e_type wsub_id);

/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean seq_set_activation_time_now( l1_ext_cmd_type* cmd , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean seq_check_pending_setup_req_ok_for_qta( wsub_id_e_type wsub_id);
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean seq_cancel_activation_time( uint8 seq_num , wsub_id_e_type wsub_id);

/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
extern void seq_act_time_cmd( seq_act_time_local_cmd_type* act_cmd , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void seq_non_dch_sfn_cfn_update_event_handler( wsub_id_e_type wsub_id);
...
===========================================================================*/
void seq_rf_tune_done_event_handler( wsub_id_e_type wsub_id);

/*===========================================================================
...
===========================================================================*/
void seq_pich_demod_event_handler( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void seq_enable_pich_demod_event( wsub_id_e_type wsub_id);
extern void seq_disable_pich_demod_event( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint8 seq_get_ul_dl_longest_tti(l1_ext_cmd_type* ext_cmd, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void seq_generic_event_handler( wsub_id_e_type wsub_id);
...
extern boolean l1_seq_register_cfn_update_cb_func(
  ...
  l1_cfn_update_notify_struct_type *cfn_update_notify_struct, wsub_id_e_type wsub_id);
...
extern void seq_generic_evt_configure(
  ...
  uint8, 
  /** event type */
  seq_generic_event_enum_type, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void seq_sfn_cfn_lock_mutex( wsub_id_e_type wsub_id); 
...
SIDE EFFECTS
  None
===========================================================================*/
extern void seq_sfn_cfn_unlock_mutex( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void seq_notify_cfn_update(uint8 cfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 seq_get_cur_eul_subfn_for_rx( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void seq_control_sfn_cfn_concurrency(boolean grab_mutex, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void seq_control_cfn_update_concurrency(boolean grab_mutex, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void seq_update_l1_cm_freeze_action_if_cmd_pending(wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean seq_is_pending_cmd_activation_timer_expired(wsub_id_e_type wsub_id);
...
FUNCTION seq_qsh_mdump_collect

DESCRIPTION
  To dump seq related parameters
...
===========================================================================*/
QSH_MDUMP_FN_ATTR void seq_qsh_mdump_collect( wsub_id_e_type wsub_id);
#endif
