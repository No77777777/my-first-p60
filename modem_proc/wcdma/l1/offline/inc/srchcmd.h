...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/srchcmd.h#4 $ $DateTime: 2020/07/15 00:02:21 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     -------------------------------------------------------- 
6/22/20     vb      FR61612: Cell Deprioritization fake cell
06/25/15    vn      Added struct content for SRCH CONFIG CPC DRX local command.
11/11/14    psr     Removed check_cell_barred, moved to srchcrutils
...
extern void srch_proc_srch_done( srch_done_cmd_type *cmd_ptr , wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srch_abort_srch_done( wsub_id_e_type wsub_id);
...
extern void srch_fs_req_cmd (l1_freq_scan_cmd_type *cmd, wsub_id_e_type wsub_id);
...
extern void srch_cell_parm_update ( l1_cell_parm_cmd_type *cmd_ptr , wsub_id_e_type wsub_id);
...
FUNCTION SRCHCR_CELL_DEPRIORITIZE_REQ 

DESCRIPTION
  This function processes cell deprioritize req from RRC
...
extern void srchcr_cell_deprioritize_req 
( 
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchacqproc_resource_avalble_cb(boolean success, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchacq_setup_pccpch_tti_hypo( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
    None.
===========================================================================*/
extern boolean srchacq_is_split_acq_mode_active( wsub_id_e_type wsub_id);
