...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dltriparm.h#3 $
...
/* max number of triages for which the finger is allowed to remain
   unlocked. After this count is exceeded the finger will be deassigned */
