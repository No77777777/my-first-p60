...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/edllog.h#3 $
...
#define EUL_DL_AGCH_RESULTS_INFO_LOG_PKT_SIZE(carr)  ( \
    FPOS(WCDMA_EUL_DL_AGCH_RESULTS_INFO_LOG_PACKET_type, agch_info) +  \
     (carr*sizeof(e_dl_log_agch_info_struct_type)))
