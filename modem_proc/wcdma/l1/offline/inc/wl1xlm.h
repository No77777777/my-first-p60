...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/wl1xlm.h#3 $
$DateTime: 2020/01/22 08:56:27 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/26/15   sr      Changes to retreive subid from rxlm_buff_id
02/14/15   nd/sa   Made changes for QTF
...
typedef struct
{
  ...
  wl1_xlm_rx_buf_type wl1_rxlm_buf[WL1_XLM_RX_CHAIN_MAX];
  /* Create WL1XLM critical section */
  rex_crit_sect_type wl1xlm_crit_sect;
  wl1_xlm_tx_buf_type wl1_txlm_buf[WL1_XLM_TX_CHAIN_MAX];
}wl1xlm_ext_cntrl_params_type;

extern wl1xlm_ext_cntrl_params_type wl1xlm_ext_cntrl_params[WCDMA_NUM_SUBS];
...
/*                         FUNCTIONS                                       */
/*-------------------------------------------------------------------------*/
extern void wl1xlm_int_cntrl_params_init();
extern void wl1xlm_ext_cntrl_params_init();
...
===========================================================================*/
void wl1_xlm_init_rx_buffers( wsub_id_e_type wsub_id);
...
boolean wl1_xlm_rx_get_chain_and_tech(
  ...
  /* Tech for the client */
  lm_tech_type  *tech, wsub_id_e_type wsub_id);
...
uint32 wl1_xlm_allocate_rxlm_buffer(
  ...
  wl1_xlm_rx_client_enum_type client, wsub_id_e_type wsub_id);
...
===========================================================================*/
void wl1_xlm_init_tx_buffers( wsub_id_e_type wsub_id);
...
uint32 wl1_xlm_allocate_txlm_buffer(
  /* Client to have RxLM buffer allocated for */
  wl1_xlm_tx_client_enum_type client, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_xlm_deallocate_all_active_rxlm_buffers( wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION wl1_xlm_is_rxlm_buff_id_in_use

DESCRIPTION
  Function check if the passed rxlm buff id matches for any client.
  ERR_FATALs.
...
===========================================================================*/
extern boolean wl1_xlm_is_rxlm_buff_id_in_use(uint32 rxlm_buff_id, wsub_id_e_type wsub_id);
