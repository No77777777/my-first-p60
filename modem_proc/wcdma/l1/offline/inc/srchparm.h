...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/srchparm.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
06/17/15   vn      Changes for new searcher thresholds for Jolokia.
...
#define SRCHPARM_PN_SRCH_ENG_THRESH_IDX 47
...
/* number of freq hypothesis step1 can search for ACQ in DR
   For ACQ in DR, freq hypothesis needs to be sent serially */
#define SRCHACQ_FREQ_HYPO_FOR_ACQ_IN_DR 1
...
-------------------------------------------------------------------------*/
#ifdef FEATURE_REL5
#define SRCH_MIN_CPICH_RSCP  ((l1m_query_rel5_supported(wsub_id)) ? 242 : 232)
...
#define SRCH_ANT_SEL_PRIMARY (wl1_rxd_get_prim_ant_id(wsub_id))
#define SRCH_ANT_SEL_DIV (wl1_rxd_get_div_ant_id(wsub_id))
