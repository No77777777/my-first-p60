...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/l1dlphychancfg.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     --------------------------------------------------------
04/04/16    ac      Add API to get configured HSDPA throughput per carrier
04/03/15    ac      Add API to get configured HSDPA throughput
...
/*===========================================================================
FUNCTION        hs_get_configured_throughput

DESCRIPTION     This function returns the configured HSDPA throughput in bps

DEPENDENCIES    None

RETURN VALUE    0 - error occurred (HSDPA not active, invalid UE category) 
                Otherwise - configured HSDPA throughput in bps 
 
SIDE EFFECTS    None.
===========================================================================*/
extern uint32 hs_get_configured_throughput(wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        hs_get_configured_throughput_per_carrier
...
SIDE EFFECTS    None.
===========================================================================*/
uint32 hs_get_configured_throughput_per_carrier(uint32 carr_idx, wsub_id_e_type wsub_id);
