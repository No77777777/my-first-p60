...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dlphch.h#4 $ $DateTime: 2020/06/16 06:12:20 $ $Author: pwbldsvc $
...
12/26/16    ta      Added new macro to check if RL db index is invalid
...
#define DL_PHCH_MAX_SCCPCH_RL 2

#define DL_PHCH_MAX_PCCPCH_RL 3
...
#define DL_PHCH_IS_PHCH_RL_DB_IDX_INVALID(phch_rl_db_idx)    \
    ((phch_rl_db_idx == DL_PHCH_INVALID_RL_ID) || \
     (phch_rl_db_idx >= DL_PHCH_MAX_RL_CFG))

#define EFDPCH_TIMING_MODE_1_MIN_SF   1
#define EFDPCH_TIMING_MODE_1_MAX_SF   8

/* Number of microseconds in a bpg. */
#define USEC_PER_BPG    (CEIL(1000, 15))
...
typedef void DL_PHCH_CFG_SET_MOD_TIMING_POST_CB_FUNC_TYPE(uint16 status, wsub_id_e_type wsub_id);
...
typedef struct
{
  /* This flag indicates whether a current DPCH setup is the first one
 * following a non-DCH state
*/
  boolean dl_first_dpch_setup;
/* will be set to TRUE if any RL enabled with CLTD during DPCH setup, that need
  synchronization procedure A */
  boolean dl_first_cltd_dpch_setup;
  /* this is the index into the active set cell database for the cell that
   is currently serving as the UE reference cell */
  uint16 dl_ref_cell_idx;

  /* array to maintain ref phch per hwch/combiner. This is needed for triage */
  l1_dl_phychan_enum_type dl_phch_ref_phch_per_hwch[DL_PHCH_MAX_NUM_COMB_CHAN];

  rex_crit_sect_type dl_phch_stmr_ctr_crit_sect;
}dlphch_ext_cntrl_params_type;
...
extern dlphch_ext_cntrl_params_type dlphch_ext_cntrl_params[WCDMA_NUM_SUBS];

/*===========================================================================
FUNCTION dl_phch_one_time_init
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_phch_one_time_init(void);

/*===========================================================================
FUNCTION dl_phch_app_specific_init
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_phch_app_specific_init(void);


/*===========================================================================
FUNCTION dl_phch_sub_specific_init
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_phch_sub_specific_init( wsub_id_e_type wsub_id);
...
extern dl_phch_cfg_handle_type dl_phch_add(
  ...
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_add_done_cb_ptr, wsub_id_e_type wsub_id);
...
extern dl_phch_cfg_handle_type dl_phch_recfg(
  ...
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_recfg_done_cb_ptr, wsub_id_e_type wsub_id);
...
extern boolean dl_phch_drop(
  ...
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_drop_done_cb_ptr, wsub_id_e_type wsub_id);
...
boolean dl_phch_reslam(
  ...
  /* call back function pointer after reconfigure operation is done */
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_reslam_done_cb_ptr, wsub_id_e_type wsub_id);
...
extern boolean dl_phch_suspend(
  ...
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_suspend_done_cb_ptr, wsub_id_e_type wsub_id);
...
extern boolean dl_phch_resume(
  ...
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_resume_done_cb_ptr, wsub_id_e_type wsub_id);
...
extern void dl_phch_cfg_done_handler(
  dl_phch_cfg_done_cmd_type* cmd, wsub_id_e_type wsub_id);
...
extern boolean dl_phch_add_aset_radio_links(
  ...
  /* call back function pointer after add operation is done */
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_aset_upd_done_cb_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern stmr_counter_source_enum_type dl_phch_allocate_stmr_ctr( wsub_id_e_type wsub_id);
...
extern boolean dl_phch_deallocate_stmr_ctr(
  ...
  uint16 stmr_cntr_id, wsub_id_e_type wsub_id);
...
extern void dl_phch_hold_cmd_handler(
  ...
  dl_phch_comb_ch_db_handle_type comb_ch_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_phch_update_pich_trans_time_offset(dl_phch_cfg_handle_type phch_cfg_db_idx, uint16 pi_pn_count, uint16 pi_offset_from_pich, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_phch_get_hwch_from_handle(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_phch_get_cctrch_idx(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_phch_get_slot_format_idx(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_phch_get_pilot_bits(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern l1_sf_enum_type dl_phch_get_spread_factor(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_phch_get_cfg_finger(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_phch_get_phch_tto(dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 dl_phch_get_active_phch_handle_mask( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 dl_phch_get_suspended_phch_handle_mask( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_phch_is_rl_configured_with_cltd(uint8 cell_db_idx, uint8 comb_id, wsub_id_e_type wsub_id);
...
extern uint16 dl_channel_get_psc(
  dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
extern void dl_phch_get_cell_info_from_handle(
  dl_phch_cfg_handle_type phch_handle, uint16 *freq, uint16 *psc, wsub_id_e_type wsub_id);
...
extern void dl_phch_get_ch_off_from_handle(dl_phch_cfg_handle_type phch_handle,
  uint16 *fr_off, uint32 *chip_off, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_phch_is_phch_suspended(dl_phch_cfg_handle_type phch_hdle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_phch_is_phch_inactive(dl_phch_cfg_handle_type phch_hdle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_phch_is_phch_active(dl_phch_cfg_handle_type phch_hdle, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint16 dl_phch_get_rl_tto(dl_phch_cfg_handle_type phch_hdle, uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_handle_hs_fing_cfg_post_aset( wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_phch_get_txdiv_status_for_hs( wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_phch_query_rl_idx_for_psc(uint16 psc, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_phch_get_hwch_for_phch(l1_dl_phychan_enum_type phch_type, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern dl_phch_cfg_handle_type dl_phch_get_phch_handle_from_hwch(uint8 hwch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_hho_retrive_phch_params_info( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_get_dpch_tpc_bits( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_phch_any_active_channels_on_cell(uint8 cell_db_index, wsub_id_e_type wsub_id);
...
extern boolean dl_check_cltd_rl_cpich_eng_above_thresh( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_check_all_rl_div_enabled( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_process_common_phychan_log_on_demand( wsub_id_e_type wsub_id);
#endif
...
===========================================================================*/
extern void dl_process_ded_phychan_log_on_demand( wsub_id_e_type wsub_id);
#endif
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_align_to_frc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_update_cltd_enable_flag( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
boolean dl_phch_get_cltd_enable_status( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void dl_phch_log_strm_ctr_info(uint32 *stmr_ctr_info_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint32 dl_phch_get_dpch_timing( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_update_align_cell_info(tlm_cell_info_struct_type *cell_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
uint8 dl_phch_get_cltd_slot_timing_mode(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
boolean dl_phch_is_fdpch_enabled( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
boolean dl_phch_is_ssc_enabled( wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void dl_phch_set_demod_config_pending_during_pich_setup(boolean set_cfg_pending, wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void dl_phch_send_pending_demod_config_cmd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern l1_sf_enum_type dl_phch_get_dpch_sf( wsub_id_e_type wsub_id);
...
extern uint8 dl_phch_get_dpch_num_tfci_bits( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_phch_get_dpch_num_pilot_bits( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
void dl_phch_hw_tpc_init( wsub_id_e_type wsub_id);
...
extern void dlphch_set_pich_auto_sccpch_bmsk(
  dl_phch_cfg_handle_type phch_cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void dl_phch_stmr_ctr_tt_handler( wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern boolean dl_phch_is_hsrach_fdpch_active( wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void dlphch_activate_hs_rach_fdpch( wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void dlphch_activate_hs_rach_fdpch_evt_handler( wsub_id_e_type wsub_id);

extern void dlphch_reset_hsrach_fpdch_status( wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void dl_phch_enable_dbg_msgs(boolean enable, wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void dl_set_dl_phch_nv_values( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_phch_get_doff(tlm_cfn_struct_type *doff, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_scch_order_sec_fdpch_ops_handler(boolean scch_ord_to_activate, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_phch_get_sec_fdpch_activation_status( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_send_mod_timing(dl_phch_cfg_handle_type phch_cfg_idx, seq_align_type align_type, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint32 dl_phch_get_ch_stmr_action_time(uint8 start_cfn, uint8 action_bpg, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern int8 dl_phch_calculate_rg_stmr_bpg_adj(uint32 rgchactiontime, uint32 hichactiontime, wsub_id_e_type wsub_id);
...
SIDE EFFECTS None
===========================================================================*/
extern void l1_get_phy_chan_info(l1_active_set_info_type* l1_active_set_info, wsub_id_e_type wsub_id);
...
extern boolean dl_phch_is_reslam_pending( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_phch_query_sec_rl_idx_for_psc(uint16 psc, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_set_mod_timing_post_cb(uint16 status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern dl_phch_cfg_handle_type dl_phch_get_phch_handle(l1_dl_phychan_enum_type phch_type, wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION dl_phch_qsh_mdump_collect

DESCRIPTION
  To dump minidump related parameters
...
SIDE EFFECTS
  None
===========================================================================*/
QSH_MDUMP_FN_ATTR void dl_phch_qsh_mdump_collect(void);

QSH_MDUMP_FN_ATTR void dl_phch_qsh_mdump_collect_sub(wsub_id_e_type wsub_id);
#endif
#endif /* DLPHCH_H */
