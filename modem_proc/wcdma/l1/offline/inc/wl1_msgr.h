...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/wl1_msgr.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/11/17   ss      Add support for MM_MMOC_VFR_IND to store the VFR ID for VSTMR
...
typedef mmoc_vfr_map_s_type stmr_vfr_map_type;
...
typedef union
{
  ...
  #endif /* FEATURE_WCDMA_MULTISIM_COEXISTENCE_SW */
/* Struct's to support X2W */
  wl1_irat_x2w_init_req_struct_type init_req;
  wl1_irat_x2w_rf_enter_ind_struct_type rf_enter;
  wl1_irat_x2w_pre_srch_req_struct_type pre_srch;
  wl1_irat_x2w_srch_req_struct_type srch_req;
  wl1_irat_x2w_rf_exit_req_struct_type rf_exit;
  wl1_irat_x2w_abort_req_struct_type abort_req;
  wl1_irat_x2w_deinit_req_struct_type deinit_req;
  wl1_irat_x2w_build_script_req_struct_type build_script;
  stmr_vfr_map_type vfr_id_mapping;
