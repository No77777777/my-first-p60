...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/wl1ulsarmgr.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  uint32 filt_val;
  /* Co-ex Tx filtering global variables */
  uint32 multisim_cxm_filt_val;
} wl1ulsarmgr_ext_cntrl_params_type;

extern wl1ulsarmgr_ext_cntrl_params_type wl1ulsarmgr_ext_cntrl_params;

typedef struct
{
  /* wcdma SAR tx power timer period in ms */
  uint8  wcdma_sar_tx_pwr_filt_tmr;
}wl1ulsarmgr_ext_persub_cntrl_params_type;

extern wl1ulsarmgr_ext_persub_cntrl_params_type wl1ulsarmgr_ext_persub_cntrl_params[WCDMA_NUM_SUBS];

typedef struct
{
  uint32 multisim_cxm_prev_filt_val_scal;
  uint32 prev_filt_val_scal;
} wl1ulsarmgr_int_cntrl_params_type;

typedef struct
{
  /* SAR NV item */
  wl1_ul_nv_struct_type wl1_ul_nv;
} wl1ulsarmgr_int_persub_cntrl_params_type;
...
SIDE EFFECTS
  None
===========================================================================*/
void wl1ulsar_tx_power_filter( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void wl1ulsar_tx_power_report(timer_cb_data_type cb_data);
...
SIDE EFFECTS
  None
===========================================================================*/
uint32 wl1ulsar_calc_linear_power_from_db10(int16 local_db10, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
void wl1ulsar_nv_handle( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
void wl1ulsarmgr_cleanup( wsub_id_e_type wsub_id);
...
SIDE EFFECTS     None.
=====================================================================================*/
uint16 wl1ulsar_calculate_ul_uarfcn(sys_band_class_e_type band, uint16 dl_uarfcn, wsub_id_e_type wsub_id);

/*==================================================================================

FUNCTION          wl1ulsar_get_ul_uarfcn_per_carr

DESCRIPTION       This function calculates the uplink frequency given the downlink 
                  frequency, for given carrier index.
...
SIDE EFFECTS     None.
=====================================================================================*/
uint16 wl1ulsar_get_ul_uarfcn_per_carr(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void wl1ulsar_send_cxm_stx_state_update(wl1ulsarmgr_tx_state_enum_type state, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        WL1ULSARMGR_EXT_CNTRL_PARAMS_INIT
...
SIDE EFFECTS
===========================================================================*/
extern void wl1ulsarmgr_ext_cntrl_params_init(void);

/*===========================================================================
FUNCTION wenc_enqueue_txpwr_sar_filtering_cmd

DESCRIPTION
  This function enqueues local command to perform SAR filtering.
...
SIDE EFFECTS
  None
===========================================================================*/
extern void wenc_enqueue_txpwr_sar_filtering_cmd(wsub_id_e_type wsub_id);
