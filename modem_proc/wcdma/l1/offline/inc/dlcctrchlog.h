...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dlcctrchlog.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     -------------------------------------------------------- 
10/19/15    ap      TPR log packet changes to include per_cell_sire values
06/03/15    sl      Code changes for new f/w log packet 0x41C4 V1
06/01/15    jk      FR 25383: Traffic-to-Pilot Ratio (TPR) Based Measurement Optimization.
