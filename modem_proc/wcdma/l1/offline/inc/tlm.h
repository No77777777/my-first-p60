...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/tlm.h#4 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     ---------------------------------------------------------
08/07/19    rv      Compilation fix for removing HS_RACH feature
05/24/18    gmr     Workaround to skip FMO gap if PN position drift is greater than 2 BPG
12/07/17    sl      Ensure Channel_config_wrc_time is SUB specific
02/12/16    ap      TLM fix for X2W HHO scenarios 
11/16/15    sl      Modify the existing TLM_API to retrieve CELL INFO from TLM_DB
10/06/15    pr      Mods for CFN/SFN calculation for 0x41b6
...
*/
#define TLM_GET_CFN() (wl1_seq_get_cfn(wsub_id))

/* This Macro reads the current software sfn
*/
#define TLM_GET_TFN() (wl1_seq_get_sfn(wsub_id))
...
/*This macro could be made as MSG_ERROR or WL1_ERR_FATAL*/
#define TLM_ERROR(string,param1, param2, param3)   \
            WL1_ERR_FATAL(string, param1, param2, param3)

/* This Macro reads the source of the RX timeline
*/
#define TLM_GET_RXTL_SRC() (stmr_get_cntr_src(MCALWCDMA_EVT_RX_TL_INTR ,wsub_id))
#define TLM_GET_TXTL_SRC() (stmr_get_cntr_src(MCALWCDMA_EVT_TX_TL_INTR ,wsub_id))
...
typedef struct {
  ...
  tlm_tfn_struct_type chan_cfg_time_wrc[WCDMA_NUM_SUBS];
...
typedef struct
{
  ...
  tlm_db_struct_type tlm_db;
  #endif
}tlm_ext_cntrl_params_type;

extern tlm_ext_cntrl_params_type tlm_ext_cntrl_params[WCDMA_NUM_SUBS];


typedef struct
{
  uint8 tm_error_excceding_128chips_cnt;
  tlm_tfn_struct_type tlm_tst_wrc_diff;
  tlm_tfn_struct_type nom_dpch_tst_diff_qty_in_tfn;
  /*This TST quantity does not contain SRCH_RF_TX_DELAY in it where as
  nom_dpch_tst_diff_qty_in_tfn contains that.*/
  tlm_tfn_struct_type tlm_btf_delay_in_tfn;
}tlm_int_cntrl_params_type;
...
extern void tlm_get_rx_tl_cfn_from_hw(tlm_cfn_struct_type *rxtl_cfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_init( wsub_id_e_type wsub_id);
...
extern void tlm_set_align(seq_align_type align_type, stmr_counter_source_enum_type cntr,
    tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off, wsub_id_e_type wsub_id);
...
extern void tlm_set_align_from_stored_info (seq_align_type align_type,  stmr_counter_source_enum_type cntr,
    tlm_cfn_struct_type *cfn_wrc, tlm_tfn_struct_type *tfn_wrc, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
uint16 tlm_get_wrc_frame_qty( wsub_id_e_type wsub_id);
...
extern void tlm_get_cfn_for_channel_config(
  tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off,
  tlm_ch_cfn_info_struct_type *cfn_info, wsub_id_e_type wsub_id);
...
extern void tlm_get_ch_cfn_from_wrc_diff( tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off,
  tlm_cfn_struct_type *wrc_cfn_diff, tlm_ch_cfn_info_struct_type *ch_cfn, wsub_id_e_type wsub_id);
...
extern void tlm_compute_sfn_wrc_diff(tlm_compute_sfn_wrc_input_struct_type *pccpch_data,
  tlm_tfn_struct_type *sfn_wrc, wsub_id_e_type wsub_id);
...
extern boolean tlm_get_ch_sfn(
  tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off,
  tlm_tfn_struct_type *ch_sfn, wsub_id_e_type wsub_id);
...
boolean tlm_get_sfn_and_wrc(
   tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off, 
   tlm_tfn_struct_type *ch_sfn, tlm_tfn_struct_type *wrc, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_comp_sfn_sfn_diff (tlm_cell_info_struct_type *nbr_cell_info, tlm_nw_diff_struct_type *sfn_sfn_diff, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_comp_sfn_cfn_diff (tlm_cell_info_struct_type *nbr_cell_info, tlm_nw_diff_struct_type *sfn_cfn_diff, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern boolean tlm_get_sfn_of_cells(tlm_cell_info_struct_type *cell_info_list, uint8 num_of_cells, tlm_tfn_struct_type *cell_sfn_list, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_adjust_wrc_tfn_frm_qty(uint16 cur_sfn, uint16 new_sfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_update_wrc_tfn_diff_after_timeline_interuption( wsub_id_e_type wsub_id);
...
extern void tlm_get_snapshot(tlm_snapshot_struct_type *out,
  tlm_snapshot_needed_mask_type mask, stmr_counter_source_enum_type rqstd_comb, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_get_rx_tl_cfn(tlm_cfn_struct_type *rxtl_cfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_update_align_cell_sfn_wrc_info(uint16 psc, uint16 freq, boolean sfn_wrc_valid, tlm_tfn_struct_type sfn_wrc_diff, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_update_align_cell_info(tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
void tlm_update_align_cell_info_for_aset(tlm_cell_info_struct_type *cell_info, tlm_tfn_struct_type *ch_off, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_indicate_combiner_slam_done(stmr_counter_source_enum_type hw_ch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void  tlm_set_align_cntr_hw_sw_cfn_diff_upd_needed(boolean hw_sw_cfn_diff_upd_needed, stmr_counter_source_enum_type hw_ch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_calculate_hw_sw_cfn_diff(boolean force_cmd, boolean status_dump_needed, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
stmr_counter_source_enum_type tlm_get_align_cntr( wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern uint16 tlm_comp_cnt_c_sfn_diff(tlm_cell_info_struct_type *cell_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
void tlm_submit_debug_message( tlm_cell_info_struct_type *cell_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern uint32 tlm_calculate_tm(uint32 cell_ref_pos, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_calculate_rx_tx_diff(tlm_cell_info_struct_type *cell_info, uint16 t_dpch, tlm_rx_tx_diff_struct_type *out, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern boolean tlm_get_extended_sfn(tlm_extended_sfn_struct_type *out_ext_sfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_calculate_tst_wrc_diff(int32 num_status_dump,  int32 ref_tx_pos, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_invalidate_tst_wrc_diff( wsub_id_e_type wsub_id);
...
uint32 tlm_get_align_cell_ch_timing( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
uint16 tlm_get_align_cell_sfn( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
void tlm_get_align_cell_sfn_timing(tlm_tfn_struct_type* sfn, wsub_id_e_type wsub_id);
...
extern void tlm_get_curr_align_cntr_val_and_frc_val(
  ...
  tlm_tfn_struct_type *frc_val, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_calculate_rx_tx_pos_for_rach_debug(tlm_rx_tx_pos_rach_debug_struct_type *rx_tx_pos, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_get_wrc_dynamic(tlm_tfn_struct_type *wrc, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_update_cell_timing(tlm_cell_info_struct_type *cell_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_get_tx_sys_time(tlm_tfn_struct_type *tst, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_get_cfn_from_cfn_wrc_diff(tlm_cfn_struct_type *ch_cfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_set_cfn_wrc_diff(tlm_tfn_struct_type *wrc_cfn_diff, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_get_aligned_cell_psc_and_ch_off(uint32 *psc, int32 *chip_offset, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern int32 tlm_calculate_tx_pos( wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION             TLM_ADVANCE_RETARD_CFN_WRC
FILE NAME            tlm.c

DESCRIPTION          This function advances/retards the cfn_wrc_diff in tlm_ext_cntrl_params.tlm_db
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_advance_retard_cfn_wrc(boolean advance, wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern int32 tlm_get_align_chan_pos( wsub_id_e_type wsub_id);
...
SIDE EFFECTS         None
===========================================================================*/
extern uint32 tlm_get_ch_stmr_action_time(tlm_tfn_struct_type *wrc_cfn_diff, tlm_tfn_struct_type *new_action_cfn, wsub_id_e_type wsub_id);
...
/*===========================================================================
FUNCTION             tlm_get_ch_cfn_for_cxm
FILE NAME            tlm.c

DESCRIPTION          This function uses the raw STMR read value and calculates the channel CFN

INPUT PARAMS         STMR read value and CFN info ptr
...
extern void tlm_get_ch_cfn_for_cxm(uint32 stmr_frame_read, tlm_tfn_struct_type *sfn_info, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION             TLM_GET_ALIGNED_CELL_INFO

DESCRIPTION          This function extracts the serving cell information from TLM_DB

INPUT PARAMS         CELL_INFO - Databse into which cell information gets populated
...
SIDE EFFECTS         None
===========================================================================*/
extern void tlm_get_align_cell_info(tlm_cell_info_struct_type *cell_info, wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION             TLM_GET_DRIFT_IN_PN_POS

DESCRIPTION          Gets the drift in cell ref position in FACH state

INPUT PARAMS         None

OUTPUT PARAMS        Drift in PN pos from the start of the call in FACH

DEPENDENCIES         Needs to be called only in FACH

RETURN VALUE         Drift in PN position in bpg

SIDE EFFECTS         None

===========================================================================*/
extern uint16 tlm_get_drift_in_pn_pos(wsub_id_e_type wsub_id);
