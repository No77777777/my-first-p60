...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/mdspasync.h#3 $
...
typedef struct
{
  ...
  uint16 agchRdIdx;
  uint16 hichRdIdx;
  uint16 edpch_param_db_idx[MAX_NUM_DCHSUPA_ACTIVE_CARR];
} mdspasync_ext_cntrl_params_type;

extern mdspasync_ext_cntrl_params_type mdspasync_ext_cntrl_params;

typedef struct
{
  WfwHiRgRsltStruct *wfw_intf_eul_dl_hich_rgch_async_read_ptr;
  WfwAgchRsltStruct *wfw_intf_eul_dl_async_read_ptr;

  /* The HICH and RGCH new config read is used to tackle the wrap around
  ** cases during reconfig. */
  boolean hich_new_cfg_read[MAX_NUM_DCHSUPA_ACTIVE_CARR];
  /* Flag to indicate whether the read on the new CFG for AGCH has begun*/
  boolean agch_new_cfg_read[MAX_NUM_DCHSUPA_ACTIVE_CARR];
  boolean rgch_new_cfg_read[MAX_NUM_DCHSUPA_ACTIVE_CARR];
  uint16  edpch_cm_param_db_idx;
} mdspasync_int_cntrl_params_type;
...
extern void mdspasync_read_agch_results (uint32 curr_sub_fn, wsub_id_e_type wsub_id);
extern void mdspasync_read_hich_rgch_results( uint32 curr_sub_fn, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean mdspasync_write_edpch_param(mdspasync_edpch_param_db_struct_type** edpch_param_ptr, wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
void mdspasync_init_e_dl_cm_slot_bitmasks (boolean init_agch, 
                                           ...
                                           uint16 init_rgch_ch_bmask, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    The mDSP EUL DL CM slot bitmasks for particualar channels
                updated
===========================================================================*/
void mdspasync_write_e_dl_cm_slot_bitmasks (mdspasync_edl_cm_bitmask_info * bitmask_buffer, uint8 num_carr, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mdspasync_read_eul_dl_chan_results(uint32 curr_sub_fn, wsub_id_e_type wsub_id);
/*===========================================================================
...
extern void mdspasync_write_edpch_cm_param(uint16 edch_cm_dtx_slots, 
                                             uint16 pseudo_edch_cm_dtx_slots, wsub_id_e_type wsub_id);
...
extern void mdspasync_update_wfw_debug_cmd(
  uint32 *debug_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS   None
===========================================================================*/
extern void wl1_init_e_ul_qta_vars(boolean skip_eul_qta_init, wsub_id_e_type wsub_id);
#endif
