...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dlacqpullin.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
typedef struct
{
  dl_acq_pullin_info_struct_type dl_acq_pullin_info;
}dlacqpullin_ext_cntrl_params_type;

extern dlacqpullin_ext_cntrl_params_type dlacqpullin_ext_cntrl_params[WCDMA_NUM_SUBS];

typedef struct
{
  int16 dl_acq_pullin_init_rotator;
  /* keep a count of how many paths have been tried for pullin */
  uint16 dl_pullin_cur_path_index;
  /* Variable indicating whether pullin in progress or NOT */
  boolean dl_acq_pullin_done_in_progress;
  dl_acq_pullin_done_cmd_type dl_acq_pullin_saved_pullin_done_cmd;
}dlacqpullin_int_cntrl_params_type;
...
SIDE EFFECTS    The peaks listed in the search pull-in set will have fingers
                assigned to them.
===========================================================================*/
extern void dl_acq_pullin_assign_fingers(int16 rotator, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_acq_enable_pullin_events(boolean enable, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void dl_acq_pullin_cmd(dl_acq_pullin_cmd_type *cmd, wsub_id_e_type wsub_id);
...
extern void dl_acq_pullin_compute_accum_cell_rssi( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern uint16 dl_acq_find_pullin_fing( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_acq_pullin_evt_cmd(dl_acq_pullin_evt_cmd_type *cmd, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void dl_acq_pullin_done_cmd(dl_acq_pullin_done_cmd_type *cmd, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void dl_acq_pullin_event_handler( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void dl_acq_resume_pullin_on_cell_cfg(wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void dl_acq_resume_pullin_done( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void dl_acq_pullin_resume_after_first_timeout( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern boolean dl_acq_pullin_is_complete( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern boolean dl_acq_get_sttd_pullin_psc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern uint8 dl_acq_pullin_get_pullin_set_cnt( wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
  FUNCTION     dlacqpullin_qsh_mdump_collect

  DESCRIPTION
  This function dumps all the required parameters from dlacqpullin internal and 
...
extern QSH_MDUMP_FN_ATTR void dlacqpullin_qsh_mdump_collect(wsub_id_e_type wsub_id);
#endif
