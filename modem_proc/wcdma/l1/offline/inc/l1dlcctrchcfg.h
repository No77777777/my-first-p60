...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/l1dlcctrchcfg.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
#define L1_CCTRCH_ID_COUNT (MCALWCDMA_DEC_TOTAL_CCTRCH_TABLES)
