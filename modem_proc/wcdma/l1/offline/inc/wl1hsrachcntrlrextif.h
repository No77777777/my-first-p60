...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/wl1hsrachcntrlrextif.h#3 $
...
#define WL1_HS_RACH_GET_AGCH_APPLY_SUBFN_REFERENCE() wl1hsrachcntrlr_ext_cntrl_params.wl1_hs_rach_config_params.agch_cfg_info.apply_subfn_reference

#define WL1_HS_RACH_GET_HICH_APPLY_SUBFN_REFERENCE() wl1hsrachcntrlr_ext_cntrl_params.wl1_hs_rach_config_params.hich_cfg_info.apply_subfn_reference

#define WL1_HS_RACH_GET_RGCH_APPLY_SUBFN_REFERENCE() wl1hsrachcntrlr_ext_cntrl_params.wl1_hs_rach_config_params.rgch_cfg_info.apply_subfn_reference

/* ===============================================
**                                   FUNCTION PROTOTYPES
** ===============================================*/
 extern void wl1_hs_rach_eul_ul_setup_drop( wsub_id_e_type wsub_id);
 ...
 SIDE EFFECTS
 ===========================================================================*/
 extern void wl1_hs_rach_deactivate_e_ul_cfg( wsub_id_e_type wsub_id);
 ...
 ===========================================================================*/
 extern void wl1_hs_rach_update_sg_cfg( wsub_id_e_type wsub_id);
 ...
 ===========================================================================*/
 void e_dl_update_num_e_rl(uint8 carr_idx, wsub_id_e_type wsub_id);
 ...
 /*===========================================================================
   ...
   ===========================================================================*/
 void e_dl_init_rls_tpc_set_info_before_cfg( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_hs_rach_dl_fdpch_setup_add(dl_phychan_add_type * add_dl_phychan_ptr, wsub_id_e_type wsub_id);
...
/*===========================================================================
 ...
 ===========================================================================*/
 extern boolean wl1_hs_rach_dl_fdpch_setup_resume( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_hs_rach_eul_dl_setup_add(l1_e_dl_info_struct_type *hs_rach_edl_cfg_ptr, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_hs_rach_eul_dl_setup_suspend( wsub_id_e_type wsub_id);
 ...
 /*===========================================================================
   ...
   ===========================================================================*/
   extern void wl1_hs_rach_eul_dl_setup_resume( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_hs_rach_eul_ul_setup_add( wsub_id_e_type wsub_id);
 ...
 /*===========================================================================
   ...
   ===========================================================================*/
   extern void wl1_hs_rach_eul_ul_setup_resume( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_hs_rach_eul_ul_setup_suspend( wsub_id_e_type wsub_id);
...
extern boolean wl1_hs_rach_validate_eul_ul_params(l1_e_hs_rach_info_struct_type *hs_rach_eul_info_ptr,
                                                  uint8 hs_rach_req_mask, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_hs_rach_activate_e_ul_cfg( wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS   This function activates the databases of EUL DL and
               performs the functions of activate config params
===========================================================================*/
extern void wl1_hs_rach_activate_e_dl_cfg( wsub_id_e_type wsub_id);
...
extern void wl1_hs_rach_edl_update_channel_info(uint16 tau_fdpch,
 	         mcalwcdma_hsrach_rsrc_idx_channel_param_struct_type *edch_rsrc_idx_chan_params, wsub_id_e_type wsub_id);
