...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/wl1tri.h#4 $
...
01/04/16    sr     Gracefully clear cell_cfg_cell_need_fing_mask when cell is deconfigured.
09/25/15    ap     Fix to perform ant switch only after successful trm ant swicth div set
...
06/26/15    sr     Changes to double num paths for dc
...
04/10/15    sr     W+W chnages for ACQ on SUB1
...
#define DL_TRI_MAX_PATHS_SUB_0 \
  ((SRCH_ASET_MAX_C0 * 6) + DL_MAX_NUM_FINGERS_PRI_CARRIER)

#define DL_TRI_MAX_PATHS_SUB_1 \
  ((SRCH_ASET_MAX_C0 * 6) + DL_MAX_NUM_FINGERS_PRI_CARRIER)
...
#define DL_TRI_SUB_0_PRI_CARR_MIN_FING_IDX (0)
#define DL_TRI_SUB_0_PRI_CARR_MAX_FING_IDX ((DL_MAX_NUM_FINGERS_PRI_CARRIER) - 1)

#define DL_TRI_SUB_0_PRI_CARR_MAX_FINGS \
  ((1) + DL_TRI_SUB_0_PRI_CARR_MAX_FING_IDX - DL_TRI_SUB_0_PRI_CARR_MIN_FING_IDX)
...
#define DL_TRI_SUB_1_PRI_CARR_MIN_FING_IDX (DL_MAX_NUM_FINGERS_PRI_CARRIER + DL_MAX_NUM_FINGERS_SEC_CARRIER)
#define DL_TRI_SUB_1_PRI_CARR_MAX_FING_IDX ((DL_MAX_NUM_FINGERS_PRI_CARRIER + DL_MAX_NUM_FINGERS_SEC_CARRIER + DL_MAX_NUM_FINGERS_PRI_CARRIER) - 1)

#define DL_TRI_SUB_1_PRI_CARR_MAX_FINGS \
  ((1) + DL_TRI_SUB_1_PRI_CARR_MAX_FING_IDX - DL_TRI_SUB_1_PRI_CARR_MIN_FING_IDX)
...
#define DL_TRI_SUB_0_PRI_CARR_MAX_USABLE_FING_IDX (DL_TRI_SUB_0_PRI_CARR_MAX_FING_IDX)
#define DL_TRI_SEC_CARR_MAX_USABLE_FING_IDX (DL_TRI_SEC_CARR_MAX_FING_IDX)
#define DL_TRI_SUB_1_PRI_CARR_MAX_USABLE_FING_IDX (DL_TRI_SUB_1_PRI_CARR_MAX_FING_IDX)
...
#define DLTRI_IS_CELL_FING_CFG_IN_PROG() (dl_tri_is_fing_cfg_in_progress(wsub_id) || (dl_cell_is_cell_cfg_in_prog(wsub_id)))
...
typedef void DL_TRI_RXD_TRANS_IND_CB_FUNC_TYPE (boolean tri_rxd_trans_success,wsub_id_e_type wsub_id);
...
typedef void (*WL1_TRI_CFG_REQ_POSTCB)(wsub_id_e_type wsub_id);


typedef struct{

  /* the actual number of paths in the path database at a given time */
  uint8 dl_tri_num_paths;

  /* the actual number of paths in the path database at a given time for Dual carrier*/
  uint8 dl_tri_num_paths_dc;

  /* The path database */
  dl_tri_path_struct_type dl_tri_paths[DL_TRI_MAX_PATHS_SUB_0];

  /* TRUE if triage needs to be held off for some reason */
  boolean dl_delay_triage;
  ...
  dl_tri_rl_set_struct_type dl_tri_rl_sets[DL_TRI_MAX_RL_SETS];

  /* SCCH order triage mutex */
  rex_crit_sect_type dltri_scch_ord_ops_mutex;
  rex_crit_sect_type dltri_modules_waiting_bmsk_mutex;

  /* critical section */
  rex_crit_sect_type dltri_rxd_crit_sect;

  /* triage mutex fing state change */
  rex_crit_sect_type triage_fing_upd_mutex;
  rex_crit_sect_type triage_reassign_list_mutex;
  rex_crit_sect_type triage_fing_switch_dcupa_mutex;
  rex_crit_sect_type dltri_remove_path_crit_sect;

}wl1tri_ext_cntrl_params_type;

extern wl1tri_ext_cntrl_params_type wl1tri_ext_cntrl_params[WCDMA_NUM_SUBS];
...
===========================================================================*/
void dl_tri_one_time_init(void);
...
SIDE EFFECTS    The above mentioned databases are initialized
===========================================================================*/
extern void dl_tri_app_specific_init(void);

/*===========================================================================
FUNCTION        DL_TRI_SUB_SPECIFIC_INIT

FILE            wl1tri.c

DESCRIPTION     This routine initializes the triage databases per sub
...
SIDE EFFECTS    The above mentioned databases are initialized
===========================================================================*/
extern void dl_tri_sub_specific_init(wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        DL_TRI_CONN_MODE_INIT

FILE            wl1tri.c

DESCRIPTION     This routine initializes the triage databases while entering conn mode
...
SIDE EFFECTS    The above mentioned databases are initialized
===========================================================================*/
extern void dl_tri_conn_mode_init(wsub_id_e_type wsub_id);
 ...
 SIDE EFFECTS    The above mentioned databases are initialized
 ===========================================================================*/
extern void dl_tri_init_for_fast_deconfig( wsub_id_e_type wsub_id);
...
===========================================================================*/
  dl_tri_per_rl_triage_info_struct_type* dl_tri_add_per_rl_triage_info(
    /* primary scrambling code */
     ...
     uint8 assoc_service, wsub_id_e_type wsub_id);
...
dl_tri_per_rl_triage_info_struct_type* dl_tri_query_per_rl_triage_info_cell_db(
  /* cell database index */
  uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
uint8 dltri_get_rl_ref_fing(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
uint8 dltri_get_strongest_fing(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dltri_get_strongest_fing_in_lock(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
dl_tri_freq_error_struct_type dl_tri_get_and_clear_freq_error_accum( wsub_id_e_type wsub_id);
...
===========================================================================*/
void dl_triage( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint32 dl_tri_get_assigned_fings_bmsk(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
extern uint8 dl_tri_get_fing_for_cell_config(
  ...
  dl_tri_ref_fing_phase_ind phase_ref_type, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void dltri_limit_path_spread(dl_tri_carr_id_enum_type triage_mode, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint8 dl_tri_find_paths(srch_cell_struct_type *aset[], uint8 num_cells, dl_tri_path_purpose path_purpose, wsub_id_e_type wsub_id);
...
extern uint8 dl_tri_get_idle_finger(
  ...
  dl_tri_idle_fing_mode_enum_type mode, wsub_id_e_type wsub_id);
...
/*===========================================================================
    ...
    SIDE EFFECTS    None
 ===========================================================================*/
extern void dl_tri_deassign_finger(uint8 fing, wsub_id_e_type wsub_id);
...
extern uint8 dl_tri_per_rl_triage_get_ref_fing(
    ...
    uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern uint32 dl_tri_get_fingers_per_rl(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_tri_deassign_fing_for_rl(uint16 psc, wsub_id_e_type wsub_id);
...
extern boolean dl_tri_set_per_rl_path_bias(
  ...
  uint8 cell_db_idx,
  /* the path weights to apply */
  uint8 factors[], wsub_id_e_type wsub_id);
...
extern void dl_tri_assign_finger_to_path(
  ...
  uint16 path, wsub_id_e_type wsub_id);  
...
SIDE EFFECTS    None.
===========================================================================*/
extern uint8 dl_tri_fing_assigned_to_strongest_path(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_tri_find_earliest_finger (uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_tri_find_earliest_finger_in_lock(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_tri_fing_standoff_status_clear(uint8 fing, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dltri_process_fing_avail_cmd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void dl_triage_without_status_dump(boolean pich_only_wakeup, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_tri_pch_init( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_tri_set_fing_to_strongest_path(uint8 fing, wsub_id_e_type wsub_id);

extern void dl_tri_post_cell_deconfig_check(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
extern boolean dl_tri_assign_fing(
  ...
  uint8 cellidx, wsub_id_e_type wsub_id);
...
extern void dl_tri_fing_cfg_cmd_done(
  ...
  int8 status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS   
===========================================================================*/
extern void dltri_process_rxd_update_cmd( wsub_id_e_type wsub_id);
...
extern void dl_tri_update_rxd_info(boolean enabled, boolean flush_rxd_cfg,
                              DL_TRI_RXD_TRANS_IND_CB_FUNC_TYPE *rxd_proc_tri_cb, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_tri_ta_log( wsub_id_e_type wsub_id);
...
extern uint8 dl_tri_get_num_locked_fings(uint8 cell_db_idx,
                                         uint8 *prim_fing_ctr,
                                         uint8 *div_fing_ctr, wsub_id_e_type wsub_id);
...
extern uint8 dl_tri_get_locked_fing_info(
  uint8 cell_db_idx,
  dl_tri_fing_pos_and_eng * pos_and_eng, boolean fw_tracked_fings_only, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint16 dl_tri_get_strongest_fing_rssi( uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
===========================================================================*/
void dltri_fing_ant_swap( wsub_id_e_type wsub_id);
...
boolean dl_tri_query_per_rl_triage_svc_info(
  /* cell database index */
  uint8 cell_db_idx, uint8 service, wsub_id_e_type wsub_id);
...
SIDE EFFECTS     None
===========================================================================*/
extern void dltri_update_fings_tpc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    The above mentioned databases are initialized
===========================================================================*/
extern void dl_tri_idle_init( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern boolean dl_tri_is_triage_suspended( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
 extern uint32 dl_tri_get_fing_pos(uint8 fing, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint32 dltri_total_fing_rssi(uint8 fing, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    None
===========================================================================*/
extern int16 dl_tri_get_fing_rot(uint8 fing, wsub_id_e_type wsub_id);

#ifdef FEATURE_WCDMA_ANT_SWITCH_SUPPORT
/*===========================================================================

FUNCTION dl_tri_is_ant_switch_ops_possible
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern boolean dl_tri_pre_process_ant_switch_ops(uint32 *finger_bmsk_for_commit, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dl_tri_perform_ant_switch_ops(uint32 *finger_bmsk_for_commit, wsub_id_e_type wsub_id);
#endif
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_tri_setup_workloop_config( wsub_id_e_type wsub_id);

extern void dl_tri_work_loop_event_handler( wsub_id_e_type wsub_id);

extern dl_tri_svc_mode_enum_type dl_tri_get_svc_mode( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_tri_set_svc_mode(dl_tri_svc_mode_enum_type svc_mode, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_tri_flush_rxd_cfg_prll_reacq(uint8 cell_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
 ===========================================================================*/
extern void dltri_enable_rxd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern uint8 dl_tri_get_assigned_fing_cnt(uint8 carr_idx, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern uint8 dl_tri_get_total_fing_cnt(uint8 carr_idx, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dl_tri_set_schic_for_mcvs( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern uint8 dl_tri_get_aset_fing_cnt(uint8 carr_idx, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS   None
===========================================================================*/
extern boolean dl_tri_is_fing_cfg_in_progress( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dltri_post_mcpm_update_cmd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS   None
===========================================================================*/
extern void dltri_post_tri_cb_cmd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS   None
===========================================================================*/
extern void dltri_process_tri_cb_cmd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dl_tri_cleanup_fings_upon_fast_cell_decfg(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_tri_check_cell_needs_fing(uint16 cell_db_idx, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION  dl_tri_clear_cell_needs_fing

DESCRIPTION
 This function will clear Triage internal dbase's cell cfg waiting for 
 free finger resource
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_tri_clear_cell_needs_fing(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dl_tri_ops_upon_scch_ord_reception(boolean, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern boolean  dl_tri_modify_fing_alloc(boolean switch_status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern uint32 dl_tri_get_total_hs_locked_fing_rssi(uint8 ant_id, uint8 carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern boolean dl_tri_is_hs_enabled(uint8 fing, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dl_tri_disable_rxd_transition_ops( wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern boolean dl_tri_is_any_fing_has_aset_service(uint32 fing_ena_mask);

/*===========================================================================
FUNCTION          dl_tri_get_finger_start_idx

DESCRIPTION       API returns start finger index for perticular SUB and carrier

DEPENDENCIES      None

RETURN VALUE     start fing idx

SIDE EFFECTS        None
===========================================================================*/
extern uint8 dl_tri_get_finger_start_idx(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION          dl_tri_get_finger_end_idx

DESCRIPTION       API returns ecd finger index for perticular SUB and carrier

DEPENDENCIES      None

RETURN VALUE     end fing idx

SIDE EFFECTS        None
===========================================================================*/
extern uint8 dl_tri_get_finger_end_idx(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION          dl_tri_trigger_ops_upon_scch_order_to_deactivate_dual_band_wrapper

DESCRIPTION       This funtions posts a local cmd to handle finger deassignment for scch carrier deactivation order
...
SIDE EFFECTS        None
===========================================================================*/
void dl_tri_trigger_ops_upon_scch_order_to_deactivate_dual_band_wrapper( wsub_id_e_type wsub_id);
...
/*===========================================================================
FUNCTION          dl_tri_qsh_mdump_collect

DESCRIPTION       dump these parameters while crash
...
SIDE EFFECTS      None
===========================================================================*/
QSH_MDUMP_FN_ATTR void  dl_tri_qsh_mdump_collect(void);
QSH_MDUMP_FN_ATTR void  dl_tri_qsh_mdump_collect_sub(wsub_id_e_type wsub_id);
#endif
#endif /* WL1TRI_H */
