...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dldec_common.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
typedef void DL_BLK_CRC_STATS_CB_FUNC_TYPE(
  ...
  uint8 num_total_blk, wsub_id_e_type);
...
extern void dl_dec_register_decoded_block_service_cb(
  ...
  dl_dec_decoded_block_svc_cb_func_struct_type* cb_ptr, wsub_id_e_type wsub_id);
...
extern void dl_dec_deregister_decoded_block_service_cb(
  ...
  uint8 trch_idx,
  /* Type of callback */
  uint8 cb_type_idx, wsub_id_e_type wsub_id);
