...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/l1task_v.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
RETURN VALUE    None
===========================================================================*/
void l1_process_immediate_meas_req (l1_immediate_meas_type *immed_meas, l1_meas_quan_enum_type meas_quan, wsub_id_e_type wsub_id) ;

/*===========================================================================
...
===========================================================================*/
extern boolean l1_is_s_criteria_met( int16 q_qualmin, int16 q_rxlevmin, int16 ue_max_tx_pwr, wsub_id_e_type wsub_id);
