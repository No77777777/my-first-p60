...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/mdsputil.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
#define ISSUE_CMD_INTR_TO_MDSP() \
 WL1_MSG3(HIGH,"Issue cmd interrupt to MDSP", 0, 0, 0) \
...
#define MDSP_16BIT_WRITE(port, val) WL1_ERR_FATAL("MDSP_16BIT_WRITE",0,0,0);


/* write a 32 bit value from the MDSP */
#define MDSP_32BIT_WRITE(port, val) WL1_ERR_FATAL("MDSP_32BIT_WRITE",0,0,0);
#else
...
===========================================================================*/
void mdsp_qsh_populate_common_dump_info(wl1_common_mini_debug_info_struct_type *common_dump_ptr, wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION        MDSP_QSH_POPULATE_COMMON_DUMP_INFO

DESCRIPTION     This function FW related info for QSH
...
void mdsp_qsh_populate_wfw_dump_info(wfw_qsh_dump_s*common_dump_ptr);
