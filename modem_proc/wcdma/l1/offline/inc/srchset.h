...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/srchset.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
03/08/16   rn      Added a new typedef for srchset_remove_from_nbch_set call back fucntion
...
09/14/08   uk      Externed Declaration of ext_srchsetutil_cntrl->srch_sleep_set, used to store the 
...
typedef void (*SRCHSET_REMOVE_NBCH_POST_PROCESSOR)( wsub_id_e_type wsub_id);
...
typedef struct
{
  /* this database contains different parameters useful during aset update procedure in searcher */
  srch_aset_upd_params_struct_type srchset_aset_upd_db;
  /* Structure used to hold interfreq cell info in a 'intrafreq cell' type. Needed 
  * for maintaining triage set */
   srch_cell_struct_type srch_inter_to_intraf_cell;
}srchset_ext_cntrl_params_mdump_type;

typedef struct
{
  boolean dpch_off_not_adjusted;
  uint16 ue_saved_ref_cell_psc_in_hho;
  /* Global used to set default TD state */
  boolean wl1_default_td_status;
  boolean choose_ref_cell;
  /* We identify ref cell with the scrambling code */
  uint16 ue_ref_cell_psc;
  /* used to sort maintain rssi based sorted list of GSM NSET */
  srch_gsm_cell_struct_type *srch_gsm_rssi_nset_sort_head;

  /*Mini Dump: Variables that need to be dumped moved to this structure*/
  srchset_ext_cntrl_params_mdump_type srchset_ext_cntrl_params_mdump;
}srchset_ext_cntrl_params_type;

extern srchset_ext_cntrl_params_type srchset_ext_cntrl_params[WCDMA_NUM_SUBS];


typedef struct
{
  /* Structure to hold the new ASET . This is needed when the new ASET contains 
 * cells that searcher does not have information about. In that case, the code
 * returns from the 'srchset_aset_update' function to perform step1,2,3. Since 
 * new ASET info will be lost, we store it in below structure */
  srch_aset_struct_type saved_aset;
  #ifdef FEATURE_WCDMA_DC_HSDPA
  uint8 srch_pend_delete_set_cnt;
  #endif
  /* SYNC_NSET index table */
  uint8 srch_tmp_sync_nset_cnt;
  #ifdef FEATURE_WCDMA_DC_HSDPA
  /* Cells that will be moved to SET_E once ASET update completes */
  srch_cell_struct_type *srch_pend_delete_set_ptr[SRCH_PEND_DELETE_SET_MAX];
  #endif
  srch_cell_struct_type *srch_interf_triage_ptr;
  srch_cell_struct_type *tmp_uset_cell_ptr[SRCH_USET_MAX_C0];
  uint8 srch_saved_set_cnt_before_hho[SRCHMEAS_MAX_NUM_CARR];
  /* Temporary List of Intra-Frequency NSET Cells for neighbors whose timing 
   is known */
  srch_cell_struct_type *srch_tmp_sync_nset_ptr[SRCH_SYNC_NSET_MAX_C0];
}srchset_int_cntrl_params_type;
...
=========================================================================*/
extern void srchset_ref_cell_changed_event( wsub_id_e_type wsub_id);
#endif

/*===========================================================================
...
=========================================================================*/
extern void srchset_reset_all_events(uint8, wsub_id_e_type wsub_id);
...
extern void srchset_move_cells_to_saved_set_for_hho( wsub_id_e_type wsub_id);
...
=========================================================================*/
void srchset_inter_rat_init_empty_cell( uint16 cell_index, srch_gsm_set_enum_type  set , wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srchset_init_uset_cell_params(srch_cell_struct_type  *cell_ptr,boolean new_detected, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
    None
===========================================================================*/
extern boolean srchset_check_interf_cell_as_intraf(uint16 freq, uint16 scr_code, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
    None
===========================================================================*/
extern void srchset_reset_inter_to_intraf_cell( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
 None 
===========================================================================*/
extern void srch_get_sfn_wrc_diff (uint16 psc, uint16 freq, sfn_wrc_diff_type *out, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
   None
===========================================================================*/
extern boolean srch_put_sfn_wrc_diff(uint16 psc, uint16 freq, sfn_wrc_diff_type *in, wsub_id_e_type wsub_id);

extern void srchset_process_nset_update(srch_nset_struct_type *new_nset, wsub_id_e_type wsub_id);
...
extern void srchset_remove_from_nbch_set(uint16 freq, uint16 psc,SRCHSET_REMOVE_NBCH_POST_PROCESSOR srch_post_processor, wsub_id_e_type wsub_id);
extern void srchset_remove_from_qice_nset(uint16 freq, uint16 psc);

extern boolean srchset_add_to_nbch_set(srch_cell_struct_type *cell_ptr, wsub_id_e_type wsub_id);
extern boolean srchset_can_cell_be_deleted(srch_cell_struct_type *cell_ptr, wsub_id_e_type wsub_id);


extern void srch_handle_cleanup_after_cell_trans(boolean cell_trans_in_prog, wsub_id_e_type wsub_id);
extern boolean srch_handle_cleanup_after_cell_trans_fail( wsub_id_e_type wsub_id);
...
/*=========================================================================
 ...
 SIDE EFFECTS : 
==========================================================================*/
uint16 srchset_get_deconfig_bmsk_for_timing_known_hho_cells( wsub_id_e_type wsub_id);
...
boolean srchset_cell_has_service(uint16 freq, uint16 scr_code, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  NONE
===========================================================================*/
srch_cell_struct_type* srchset_find_cell_for_cell_db_idx(uint8 cell_db_idx, wsub_id_e_type wsub_id);

boolean srchset_is_cell_timing_known(srch_cell_struct_type *cell_ptr);
boolean srchset_cell_exists_in_new_aset(uint16 freq, uint16 scr_code, uint8 carr_idx, wsub_id_e_type wsub_id);
boolean srchset_cell_exists_in_pn_set(uint16 freq, uint16 scr_code, wsub_id_e_type wsub_id);
boolean srchset_remove_from_pn_set(srch_cell_struct_type* cell_ptr, wsub_id_e_type wsub_id);
srch_cell_struct_type* srchset_cell_exists_in_triage_set(uint8 carr_idx, uint16 freq, uint16 scr_code, wsub_id_e_type wsub_id);
...
/*=========================================================================
 ...
 SIDE EFFECTS : 
==========================================================================*/
boolean srchset_get_txd_status( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void srchset_select_ref_cell( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void srchset_log_aset( wsub_id_e_type wsub_id);
...
/*=============================================================================
 ...
 SIDE EFFECTS : None
=============================================================================*/
extern boolean srchset_put_cell_to_pend_delete_set(srch_cell_struct_type* cell_ptr, wsub_id_e_type wsub_id);
...
=============================================================================*/
extern void srchset_flush_pend_delete_set( wsub_id_e_type wsub_id);
...
/*=============================================================================
 ...
 SIDE EFFECTS : None
=============================================================================*/
extern boolean srchset_cell_exists_in_pend_delete_set(srch_cell_struct_type* cell_ptr, wsub_id_e_type wsub_id);
...
extern void srchset_demote_cell_from_aset(srch_cell_struct_type* cell_ptr, 
                                          srch_set_enum_type target_set, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern uint8 srch_get_active_filt_bmsk( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean srchset_is_cell_invalidated(srch_cell_struct_type* cell_ptr , uint16 index, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION srchset_ext_cntrl_params_init
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchset_ext_cntrl_params_init( wsub_id_e_type wsub_id);


/*===========================================================================
FUNCTION srchset_int_cntrl_params_init
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchset_int_cntrl_params_init(wsub_id_e_type wsub_id);
...
/*===========================================================================
  FUNCTION     srchset_qsh_mdump_collect

  DESCRIPTION
  This function dumps all the required parameters from srchset internal and 
...
extern QSH_MDUMP_FN_ATTR void srchset_qsh_mdump_collect(wsub_id_e_type wsub_id);
#endif
