...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/mcalwcdma_edl.h#3 $
$DateTime: 2020/01/22 08:56:27 $
$Author: pwbldsvc $

when        who     what, where, why
--------    ---     --------------------------------------------------------
12/18/17    ss     Updating the event id which needs to be deallocated at UL   
...
#define MCALWCDMA_EDL_SET_PHCH_BMSK_VAR(val) \
  mcalwcdma_edl_ext_cntrl_params.mcalwcdma_e_dl_phch_cfg_upd_bmsk = val

#define MCALWCDMA_EDL_SHIFT_AND_SET_PHCH_BMSK_VAR(intf_buf_idx)\
  mcalwcdma_edl_ext_cntrl_params.mcalwcdma_e_dl_phch_cfg_upd_bmsk = \
      (mcalwcdma_edl_ext_cntrl_params.mcalwcdma_e_dl_phch_cfg_upd_bmsk | ((uint32)(0x1) << intf_buf_idx))

#define MCALWCDMA_EDL_GET_PHCH_BMSK_VAR() mcalwcdma_edl_ext_cntrl_params.mcalwcdma_e_dl_phch_cfg_upd_bmsk

#endif /*FEATURE_WCDMA_HS_RACH*/

/* MACRO to set the event id which needs to deallocated */
#define MCALWCDMA_EDL_SET_DISABLED_EVT(evt,wsub_id) \
  mcalwcdma_edl_ext_cntrl_params.mcalwcdma_e_dl_cfg_db.disabled_evt_id[wsub_id] = evt
...
typedef struct
{
  ...
  /* Global to store the event id which needs to be deallocated  */
  uint8 disabled_evt_id[WCDMA_NUM_SUBS];
...
typedef struct
{
  /* This global is set true during fast resume (LTA opts) and will be cleared in EUL frame boundary handler */
  boolean e_dl_config_in_progress;
  mcalwcdma_e_dl_config_db_struct_type mcalwcdma_e_dl_cfg_db;
  /* MCAL structure that stores the config information for EUL DL config */
  mcalwcdma_e_dl_channel_db_struct_type e_dl_mcal_info;
  uint32 mcalwcdma_e_dl_phch_cfg_upd_bmsk;
} mcalwcdma_edl_ext_cntrl_params_type;

extern mcalwcdma_edl_ext_cntrl_params_type mcalwcdma_edl_ext_cntrl_params;

typedef struct
{
  int16  dbg_post_call_back_comb_frame_qty;
  int32  dbg_post_call_back_frc_cx8;
  int32  dbg_post_call_back_cx8;
  int16  dbg_pre_call_back_comb_frame_qty;
  uint16 dbg_post_call_back_cfn;
  uint16 dbg_pre_call_back_cfn;
  int16  dbg_post_call_back_frc_frame_qty;
  int32  dbg_pre_call_back_frc_cx8;
  int32  dbg_post_call_back_comb_cx8;
  int32  dbg_pre_call_back_comb_cx8;
  int16  dbg_pre_call_back_frc_frame_qty;
  int32  dbg_pre_call_back_cx8;
} mcalwcdma_edl_int_cntrl_params_type;
...
** ======================================================================= */
 ...
 ===========================================================================*/
extern  void mcalwcdma_ernti_update(uint16 pri_ernti, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_e_dl_resume_phch( wsub_id_e_type wsub_id);
...
extern void mcalwcdma_e_dl_suspend_phch(uint16 agch_final_sfn,
                                           uint16 hich_final_sfn,uint16 rgch_final_sfn, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_phychan_cfg(mcalwcdma_e_dl_channel_db_struct_type *channel_db_ptr, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_cfg_evt_pre_proc( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_cfg_evt_post_proc( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_frm_evt_post_proc( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_update_tti_info( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_evt_handler(uint8 comb_id, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint8 mcalwcdma_e_dl_init_event( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_clean_event(uint8 evt_id, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_e_dl_set_event(uint8 evt_id,uint16 off_in_ticks, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_edl_deallocate_intf_buf_idx( wsub_id_e_type wsub_id);
