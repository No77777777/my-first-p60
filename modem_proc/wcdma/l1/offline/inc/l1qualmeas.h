...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/l1qualmeas.h#4 $ $DateTime: 2020/01/24 01:28:35 $ $Author: pwbldsvc $
...
#define L1_NUM_QUALMEAS_TO_BE_DUMPED 4
...
typedef struct
{
  boolean l1_quality_periodic_rpts_requested;
  uint16 l1_num_quality_meas_in_progress;
}l1qualmeas_ext_cntrl_params_mdump_type;

typedef struct
{
  l1_qual_meas_param_info_struct_type l1_quality_meas_db[L1_MAX_QUALITY_MEAS];

  /*Mini Dump: Variables that need to be dumped moved to this structure*/
  l1qualmeas_ext_cntrl_params_mdump_type l1qualmeas_ext_cntrl_params_mdump;
}l1qualmeas_ext_cntrl_params_type;


extern l1qualmeas_ext_cntrl_params_type l1qualmeas_ext_cntrl_params;


typedef struct
{
  l1_qual_meas_transport_channel_struct_type *l1_quality_trch_db[L1_MAX_TRANSPORT_CHANNEL_INDEX];
  /* Define lookup table as 32, since it is indexed on transport channel id [32+1] */
  l1_qual_meas_trch_lookup_table_struct_type l1_quality_lookup_db[L1_MAX_TRANSPORT_CHANNELS + 1];
  uint16 l1_num_transport_channel_in_trch_db;
  boolean l1qualmeas_heapmem_allocated;
  l1_qual_meas_param_info_struct_type tmp_quality_meas_parm_info;
}l1qualmeas_int_cntrl_params_type;
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean l1qualmeas_msmt_ctrl_msg_quality_meas_processing( l1_meas_cmd_type *cmd_ptr , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void l1qualmeas_init( wsub_id_e_type wsub_id );
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 l1qualmeas_find_index(uint16 measid , wsub_id_e_type wsub_id);
...
extern void l1qualmeas_send_periodic_report(uint16 meas_id , wsub_id_e_type wsub_id);
...
extern void l1qualmeas_update_quality_meas_info(uint8 trch_id, uint8 crc_results, uint8 crc_errors, uint32 tb_crc_result, wsub_id_e_type wsub_id);
...
extern void l1qualmeas_update_active_tr_ch(uint8 no_active_tr_ch, uint8 tr_ch_id [], wsub_id_e_type wsub_id); 
...
extern void l1qualmeas_process_crc_results(l1qualmeas_crc_update_cmd_type* cmd_ptr, wsub_id_e_type wsub_id);
...
extern void l1qualmeas_send_meas_report(uint16 meas_id, uint8 trch_id , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  The variable l1qualmeas_ext_cntrl_params.l1_num_quality_meas_in_progress may be changed.
===========================================================================*/
void l1qualmeas_remove_quality_measurement_index( uint16 meas_idx , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  The variable l1qualmeas_int_cntrl_params.l1_num_transport_channel_in_trch_db may be changed.
===========================================================================*/
void l1qualmeas_remove_transport_channel_measurement_index( uint16 trch_idx , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void l1qualmeas_remove_quality_measurements(uint16 meas_id , wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  The variable l1qualmeas_int_cntrl_params.l1_num_transport_channel_in_trch_db may be changed.
===========================================================================*/
void l1qualmeas_add_transport_channel_measurement_index( uint16 trch_id , wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
  FUNCTION     l1qualmeas_qsh_mdump_collect

  DESCRIPTION
  This function dumps all the required parameters from l1qualmeas internal and 
  ...
  None
  ===========================================================================*/
extern QSH_MDUMP_FN_ATTR void l1qualmeas_qsh_mdump_collect(wsub_id_e_type wsub_id);
#endif
#endif /* L1QUALMEAS_H */
