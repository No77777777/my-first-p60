...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/l1msm.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
#define WL1_HWIO_OUT(A, B)                   WL1_MSG3(HIGH,"WL1_HWIO : " #A " = 0x%x ",(B),0,0) 
#define WL1_HWIO_IN(A)                       (0)
#define WL1_HWIO_FMSK(A, B)                  (0)
#define WL1_HWIO_SHFT(A, B)                  (0)
#define WL1_HWIO_OUTI(A, B, C)               WL1_MSG3(HIGH,"WL1_HWIO%d : " #A " = 0x%x",B,C,0)  
