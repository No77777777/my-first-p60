...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/srchinterf.h#4 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/10/20   ac      Mini dump framework checkin
08/26/19   rs      Support for FR53313 WCDMA to LTE Pseudo measurement
07/15/15   jk      Evaluate interf cells in intraf mode only when CM is active.
...
typedef struct {
  boolean periodic;
  boolean addl    ;
} srch_interf_fresh_results_struct_type;

typedef struct
{
  /* The following variable determines if the inter frequency measurements need 
    to be restarted after an HHO. If the variable is set to TRUE; then inter- 
    frequency measurements are performed */
  boolean srch_inter_freq_meas_performed;
  srch_ofreq_cell_list_struct_type srch_ofreq_saved_set[SRCH_OFREQ_FREQ_MAX];
  srch_ofreq_cell_list_struct_type srch_ofreq_async_nset[SRCH_OFREQ_FREQ_MAX];
  /* The following two variables indicate if event triggered reports and
   periodic reports are requested respectively */
  boolean srch_interf_periodic_rpts_requested;
  boolean srch_interf_sec_cell_info_list_configured;
  srch_interf_vaset_freq_array_struct_type srch_interf_vaset_non_used_freq_array[L1_MAX_NON_USED_FREQ];
  /* This boolean is used to stop cleaning of interf meas db during interf HHO*/
  boolean srch_interf_reset_interf_meas_during_hho;
  srch_inter_freq_meas_parms_struct_type srch_inter_freq_meas_db[SRCH_MAX_INTERF_MEAS];
  boolean srch_interf_evt_trig_rpts_requested;
  srch_ofreq_cell_list_struct_type srch_ofreq_sync_nset[SRCH_OFREQ_FREQ_MAX];
  srch_ofreq_cell_list_struct_type srch_ofreq_monitored_set[SRCH_OFREQ_FREQ_MAX];
  /*Variable to track the number of parallel inter frequency measurements 
  going on at any given instant */
  uint16 srch_num_interf_meas_in_progress;
  uint16 srch_interf_num_non_used_freq;
  uint16 srch_interf_non_used_freq_array[L1_MAX_NON_USED_FREQ];
  /* store 2D TTT information. array is indexed using the meas idx for evt 2D in
the interf meas database */
  srchinterf_2d_info_struct_type evt_2d[SRCH_MAX_INTERF_MEAS];
}srchinterf_ext_cntrl_params_type;

extern srchinterf_ext_cntrl_params_type srchinterf_ext_cntrl_params[WCDMA_NUM_SUBS];
...
=======================================================================*/
extern boolean srch_interf_process_meas_ctrl_msg (l1_meas_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
...
DESCRIPTION
    ...
    In particular the following data structures are impacted
        ...
        srchinterf_ext_cntrl_params.srch_inter_freq_meas_db
     
RETURN VALUE
    void

=======================================================================*/
extern void srch_interf_reset_meas_dbase( wsub_id_e_type wsub_id);
...
=======================================================================*/
extern void srch_interf_update_cell_list_in_dch_init( wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION           SRCH_INTERF_RESET_ALL_INTERF_EVENT_TIMERS

DESCRIPTION
    This function reset all interf event timers.
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchinterf_reset_all_interf_event_timers(wsub_id_e_type wsub_id);
/*======================================================================
...
DESCRIPTION
    ...
    In particular the following data structures are impacted
        ...
        srchinterf_int_cntrl_params.srch_interf_vaset_intra_freq_evt_db
     
RETURN VALUE
    void

=======================================================================*/
extern void srch_interf_reset_vaset_event_dbase( wsub_id_e_type wsub_id);
...
=======================================================================*/
extern void srch_interf_remove_all_interf_cells( wsub_id_e_type wsub_id);
...
=======================================================================*/
extern void srch_interf_divide_cells_by_freq( wsub_id_e_type wsub_id);
...
extern void srch_interf_get_cell_info(l1_inter_freq_cell_list_struct_type *cell_list,
                                      l1_meas_ctrl_enum_type               parm_type, wsub_id_e_type wsub_id);
...
=======================================================================*/
extern void srch_inter_f_meas_sib_update(l1_meas_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
...
=======================================================================*/ 
extern boolean srch_interf_remove_interfreq_measurements(uint16 meas_id, wsub_id_e_type wsub_id);
...
=======================================================================*/
extern uint16 srch_interf_get_meas_idx_based_on_id(uint16 meas_id, wsub_id_e_type wsub_id);
/*======================================================================
...
extern void srch_interf_update_interf_rpt_trans_mode_info(uint16 meas_id,
                 l1_meas_report_trans_mode_enum_type rpt_trans_mode, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    
===========================================================================*/
extern void srch_interf_evaluate_events_2d_2f( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void srch_interf_send_periodic_meas_report(uint16 meas_id, wsub_id_e_type wsub_id);
/*======================================================================
...
=======================================================================*/
extern void srch_interf_dch_init( wsub_id_e_type wsub_id);
...
=======================================================================*/
extern void srch_interf_process_srch_done_signal ( wsub_id_e_type wsub_id) ;

/*=========================================================================
...
extern void srch_interf_fach_add_cells( wsub_id_e_type wsub_id);
/*=========================================================================
...
SIDE EFFECTS : None
=========================================================================*/
extern void srch_interf_filter_eng(uint32 *filt_eng, uint32 last_meas_eng, uint32 last_meas_gap, int8 filt_len,uint32 srch_period, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void srch_interf_handle_sync_state_for_evt2d_delay( wsub_id_e_type wsub_id);

/*=========================================================================

FUNCTION     : srch_interf_add_evt2d_delay_info 
               
DESCRIPTION  : This function will enable the srchinterf_ext_cntrl_params.evt_2d database indexed by meas_idx 
...
=========================================================================*/
LOCAL void srch_interf_add_evt2d_delay_info(uint16 meas_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
uint16 srch_interf_get_carr_freq(uint8 carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
uint8 srch_interf_get_carr_interf_idx(uint8 carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean srch_interf_is_carr_present_in_interf_db(uint8 carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None 
===========================================================================*/
extern uint8 srch_interf_determine_dc_carr_idx( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srch_interf_update_interf_cells_from_intraf_cell_info_list(l1_intra_freq_cell_list_struct_type *, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srch_interf_evaluate_interf_events_in_intraf_mode(uint8 carr_idx, wsub_id_e_type wsub_id);
...
extern void srch_interf_update_params_from_intraf_cell(boolean first_time ,srch_interf_cell_struct_type *, 
                                                               srch_cell_struct_type *, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srch_interf_multi_carr_config(uint8 carrier_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void srch_interf_multi_carr_deconfig(uint8 carrier_idx, wsub_id_e_type wsub_id);
#endif

/*===========================================================================
FUNCTION srchinterf_ext_cntrl_params_init
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchinterf_ext_cntrl_params_init( void );

/*===========================================================================
FUNCTION srchinterf_int_cntrl_params_init
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchinterf_int_cntrl_params_init( wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION           SRCHINTERF_GET_INTERF_K_VAL

DESCRIPTION
    This function returns filter value used for inter-frequency measurements.
...
SIDE EFFECTS
    None.
===========================================================================*/
int8 srchinterf_get_interf_k_val( wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION             SRCH_INTERF_CLEANUP

DESCRIPTION
    This function cleansup all the inter frequency cell information
...
SIDE EFFECTS
    None.
===========================================================================*/
void srch_interf_cleanup(wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
  FUNCTION     srchinterf_qsh_mdump_collect

  DESCRIPTION
  This function dumps all the required parameters from srchinterf internal and 
...
extern QSH_MDUMP_FN_ATTR void srchinterf_qsh_mdump_collect(wsub_id_e_type wsub_id);
#endif
#endif /* SRCHINTERF_H */
