...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/l1sapcommon.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
{ \
  if(!(val < bound)) \
  { \
    WL1_ERR_FATAL("Val %d Exceeds boundary value %d", val, bound, 0); \
  } \
}
