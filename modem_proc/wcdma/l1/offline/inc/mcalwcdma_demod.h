...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/mcalwcdma_demod.h#3 $
...
03/19/15    pr      FCDC changes for WplusW
03/10/15    pr      MCAL DL Changes for WplusW
...
typedef struct {
   ...
   *  valid */
  boolean results_under_process[WCDMA_NUM_SUBS];
  /** the reference count in Cx8 units */
  uint32 ref_cnt_cx8[WCDMA_NUM_SUBS];
  /** the TX system time in Cx8 units */
  uint32 tx_sys_time_cx8[WCDMA_NUM_SUBS];
  /** cell div info */
 ...
 */
/*============================================================================*/
extern void mcalwcdma_demod_init( wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION mcalwcdma_demod_one_time_init

DESCRIPTION
  This function performs a one time init of all MCAL DEMOD related items.
...
SIDE EFFECTS
  None
===========================================================================*/
extern void mcalwcdma_demod_app_specific_init( wsub_id_e_type wsub_id);
/*============================================================================*/
/**
...
extern void mcalwcdma_demod_fing_assign(
  ...
  mcalwcdma_demod_fing_config_struct_type *fing_config, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_disable_finger(
  ...
  uint8 fing, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_cell_config(
  ...
  mcalwcdma_demod_cell_config_struct_type *cell_config, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void mcalwcdma_demod_set_td_dirty_bit(uint8 cell, boolean tdDetDirtyBit, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_disable_cell(
  /** Finger index to be disabled   */
  uint8 cell, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_commit_demod_cfg(
  ...
  uint32 phychan_bmsk, wsub_id_e_type wsub_id);
...
extern uint32 mcalwcdma_demod_query_demod_cfg_request_state(
  ...
  /** resource bmsk */
  uint32 demod_resource_bmsk, wsub_id_e_type wsub_id);
 ...
 *
 *=========================================================================*/
extern int16 mcalwcdma_demod_get_freqcommon( wsub_id_e_type wsub_id);
 ...
 *
 *=========================================================================*/
extern int32 mcalwcdma_demod_get_tcxoaccum( wsub_id_e_type wsub_id);
...
extern boolean mcalwcdma_demod_status_dump(
  ...
  mcalwcdma_demod_status_dump_info_struct_type *result_buffer, wsub_id_e_type wsub_id);
 ...
 */
/*============================================================================*/
extern void mcalwcdma_demod_set_tddet_status(uint8 cell_id, uint8 td_val, wsub_id_e_type wsub_id);
 ...
 */
/*============================================================================*/
extern uint8 mcalwcdma_demod_get_tddet_status(uint8 cell_id, wsub_id_e_type wsub_id);
...
*/
/*===========================================================================*/
extern uint32 mcalwcdma_demod_get_td_divaccum_egy(uint8 cell_idx, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_set_qft_integration_length(
  /** qft int length */
  uint32 qft_int_len, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_set_qft_energy_threshold(
  /** qft egy threshold */
  uint32 qft_energy_thresh, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_set_qtt_coherent_integration_length(
  ...
  uint32 qtt_coh_int_len, wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_set_qtt_non_coherent_integration_length(
  ...
  uint32 qtt_non_coh_int_len, wsub_id_e_type wsub_id);
 ...
 */
/*============================================================================*/
extern void mcalwcdma_demod_set_td_det_thresh(uint32 td_det_thresh, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void mcalwcdma_demod_update_combiner_threshold(boolean set_new_threshold, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void mcalwcdma_demod_update_fing_pos_dsd_buf_dur_assign(uint8 fing, uint32 pnposCx8, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    combiner lock threshold changes in FW.
===========================================================================*/
extern void mcalwcdma_demod_revert_fing_cfg(uint8 fing, wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern void mcalwcdma_demod_fast_cell_finger_teardown(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
extern boolean mcalwcdma_demod_get_td_val_in_buf(uint8 cell_index, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void mcalwcdma_demod_set_init_rssi_pch_sleep( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void mcalwcdma_demod_fing_ant_switch(uint8 fing, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void mcalwcdma_demod_block_demod_cfg_cmds(boolean enable, wsub_id_e_type wsub_id);

#endif /* FEATURE_WCDMA_ANT_SWITCH_SUPPORT */
#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION mcalwcdma_demod_qsh_mdump_collect

DESCRIPTION
  This function collect dump of mcal related parameters.
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mcalwcdma_demod_qsh_mdump_collect(void);

QSH_MDUMP_FN_ATTR
void mcalwcdma_demod_qsh_mdump_collect_sub(wsub_id_e_type wsub_id);
#endif
