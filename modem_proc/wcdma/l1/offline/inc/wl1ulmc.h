...
#define WL1ULMCMGR_MUTEXLOCK() REX_ISR_LOCK(&wl1ulmc_ext_cntrl_params.wl1_ul_mcmgr_mutex)
#define WL1ULMCMGR_MUTEXFREE() REX_ISR_UNLOCK(&wl1ulmc_ext_cntrl_params.wl1_ul_mcmgr_mutex)
#define IS_SEC_CARR_UL_CFGD_OR_ACTIVE() (wl1ulmc_ext_cntrl_params.ul_dpch_carrier_state[WL1_SEC_UL_CARR_IDX] != UL_MC_DPCH_STATE_INIT)

#define IS_SEC_CARR_UL_ACTIVE() ((wl1ulmc_ext_cntrl_params.ul_dpch_carrier_state[WL1_SEC_UL_CARR_IDX] == UL_MC_DPCH_STATE_TX) || \
                                 (wl1ulmc_ext_cntrl_params.ul_dpch_carrier_state[WL1_SEC_UL_CARR_IDX] == UL_MC_DPCH_STATE_PCP_WAIT))
                                    
#define IS_SEC_CARR_UL_IN_PCP() (wl1ulmc_ext_cntrl_params.ul_dpch_carrier_state[WL1_SEC_UL_CARR_IDX] == UL_MC_DPCH_STATE_PCP_WAIT)
#define IS_SEC_CARR_UL_IN_TX()  (wl1ulmc_ext_cntrl_params.ul_dpch_carrier_state[WL1_SEC_UL_CARR_IDX] == UL_MC_DPCH_STATE_TX)


                                    
#define IS_SEC_CARR_UL_WAIT_FOR_SCCH_ORDER() (wl1ulmc_ext_cntrl_params.ul_dpch_carrier_state[WL1_SEC_UL_CARR_IDX] == UL_MC_DPCH_SCCH_ORDER_WAIT)                         
...
typedef struct
{
  ul_mc_dpch_state_enum_type ul_dpch_carrier_state[WL1_MAX_UL_CARR_IDX];
  /*FW requirement for DC HSUPA where back to back UL DPCCH cfg cmds should
  ** not be sent. There should atleast one frame boundary in between, since
  ** FW latches only at frame boundary. This below global ensures that
  ** Also when disabling Secondary UL, FW expects the cmd before slot 5*/
  wl1ulmcmgr_mdsp_cfg_cmd_type ul_sec_cfg_cmd_pending;
...
} wl1ulmc_ext_cntrl_params_type;

extern wl1ulmc_ext_cntrl_params_type wl1ulmc_ext_cntrl_params;
...
=========================================================================*/
extern void wl1ulmcmgr_cfg_validate(wl1_ul_carr_id_enum_type carr_idx,ul_phychan_add_type* ul_phychan_setup, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_add_validate(wl1_ul_carr_id_enum_type carr_idx,ul_phychan_add_type* ul_phychan_setup, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_drop_validate(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern ul_mc_dpch_state_enum_type wl1ulmcmgr_get_carr_state(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern int16 wl1ulmcmgr_get_ul_carr_dpcch_init_pwr(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern int16 wl1ulcmmgr_get_prim_ul_carr_tx_pwr( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_determine_dpcch_pwr_maint(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_calc_ul_dpcch_init_tx_pwr(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_perform_dpcch_init_pwr_ops(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_pcp_period_status(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_dpcch_st_mc_routine(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_set_ul_dpcch_state(wl1_ul_carr_id_enum_type carr_idx, ul_mc_dpch_state_enum_type next_state, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_set_async_dpcch_ctrl(wl1_ul_carr_id_enum_type carr_idx ,boolean disable_tx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1_disable_ul_dpcch(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_write_hw_wfw_dpcch_cfg_params(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_enable_ul_dpcch(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_req_ops(wl1ulmcmgr_intf_type* wl1ulmcmgr_intf_params, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern boolean wl1ulmcmgr_config_dpch(wl1ulmcmgr_intf_type* wl1ulmccfg_param, wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_dch_cleanup( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_dch_init( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void wl1ulmcmgr_init( wsub_id_e_type wsub_id);
...
extern void wl1ulmcmgr_send_sec_ul_dpcch_sync_cmd( wsub_id_e_type wsub_id);
...
=========================================================================*/
boolean wl1ulmcmgr_sec_carr_in_pcp_srb_delay( wsub_id_e_type wsub_id);
