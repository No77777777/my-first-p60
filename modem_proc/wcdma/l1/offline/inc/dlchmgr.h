...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dlchmgr.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     --------------------------------------------------------- 
01/10/20   ac      Mini dump framework checkin
08/26/15    ap      Adding lock protection for allocating cfg db idx
03/09/15    sr      DLCHMGR changes for W+W
02/28/12    rsr     W+W Phase 2 changes.
...
/*Keep the DlChMgr dynamic db size as 10. The worst possible channel combination is:
1. SCCPCH0
2. SCCPCH1
3. PICH
4. PCCPCH setup by RRC
5. PCCPCH setup by SRCH
For W+W, per sub we will need
1. SCCPCH0
2. SCCPCH1
3. PICH
4. PCCPCH setup by RRC
*/
#define DLCHMGR_CFG_DB_SIZE ((dlchmgr_cfg_db_idx_type)10)
...
typedef boolean DLCHMGR_CH_SPEC_PRE_OP_CB_FUNC_TYPE(
  dl_ch_spec_cfg_db_idx_type ch_spec_idx, wsub_id_e_type wsub_id);

typedef boolean DLCHMGR_CH_SPEC_PRE_ADD_CB_FUNC_TYPE(
  dl_ch_spec_cfg_db_idx_type ch_spec_idx, l1_dl_phychan_db_struct_type *phychan_db, wsub_id_e_type wsub_id);
  

typedef void DLCHMGR_GEN_OP_DONE_CB_FUNC_TYPE( wsub_id_e_type wsub_id);

typedef void DLCHMGR_GEN_OP_PROC_FUNC_TYPE( wsub_id_e_type wsub_id);

typedef void DLCHMGR_GEN_OP_CHECK_FUNC_TYPE( dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);

typedef boolean DLCHMGR_CH_SPEC_POST_OP_CB_FUNC_TYPE(
  dl_ch_spec_cfg_db_idx_type ch_spec_idx, wsub_id_e_type wsub_id);

typedef void DLCHMGR_RESPONSE_CB_FUNC_TYPE(
  dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
typedef void DL_CH_SPEC_MGR_INIT_CB_TYPE( wsub_id_e_type wsub_id );
...
typedef boolean DLCHMGR_CH_SPEC_POST_SUSP_RES_CB_FUNC_TYPE(
  dl_ch_spec_cfg_db_idx_type chspec_dyn_db_idx, wsub_id_e_type wsub_id);
...
typedef void DEMOD_HS_TD_UPDATE_CB_FUNC_TYPE(uint8 td_status, wsub_id_e_type wsub_id);

typedef struct
{
  /* Callback function reporting TD status to HS module */
  DEMOD_HS_TD_UPDATE_CB_FUNC_TYPE *demod_hs_td_update_cb;
}dlchmgr_ext_cntrl_params_type;

extern dlchmgr_ext_cntrl_params_type dlchmgr_ext_cntrl_params[WCDMA_NUM_SUBS];
...
extern rex_crit_sect_type dlchmgr_alloc_dealloc_cfg_db_idx;

#define DLCHMGR_CGF_DB_IDX_INIT_INTLOCK()  REX_ISR_LOCK(&dlchmgr_alloc_dealloc_cfg_db_idx)
#define DLCHMGR_CGF_DB_IDX_INIT_INTFREE()  REX_ISR_UNLOCK(&dlchmgr_alloc_dealloc_cfg_db_idx)
...
#define DLCHMGR_GET_WSUB_ID_FROM_CFG_DB_IDX(cfg_db_idx)  \
  (dlchmgr_cfg_db[cfg_db_idx].dyn_db.wsub_id)
...
#define DLCHMGR_GET_HWCH_FROM_CFG_DB_IDX(cfg_db_idx)  \
  (dl_phch_get_hwch_from_handle(DLCHMGR_GET_PHCH_HDLE_FROM_CFG_DB_IDX(cfg_db_idx) ,wsub_id))
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_init( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_ext_add (dl_phychan_add_type *add_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_int_add (dlchmgr_int_setup_struct_type *ch_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_ext_drop (l1_dl_phychan_enum_type phch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_aset_update (dl_phychan_add_type *aset_upd_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_drop (dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_ext_recfg(dl_phychan_recfg_type *recfg_info, wsub_id_e_type wsub_id);
...
extern void dlchmgr_add_done_cb (uint8 cctrch_idx, l1_dl_phychan_enum_type phch_type,
  dl_phch_cfg_handle_type phch_handle, boolean status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
boolean dlchmgr_check_for_pccpch_configured_for_sib_read( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern seq_align_type dlchmgr_get_align_type(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_handle_gen_op(dl_phychan_action_reason_enum_type gen_op_ext_type, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern mcalwcdma_dec_cctrch_id dlchmgr_get_cctrch_idx_idx_from_phch(l1_dl_phychan_enum_type phch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern dl_phch_cfg_handle_type dlchmgr_get_phch_hdle_idx_from_phch(l1_dl_phychan_enum_type phch, wsub_id_e_type wsub_id);
...
extern dl_ch_spec_cfg_db_idx_type dlchmgr_get_ch_spec_idx_from_phch(
  l1_dl_phychan_enum_type phch, boolean only_ext, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_wakeup_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_sleep_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_resume_phch (l1_dl_phychan_enum_type phch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_suspend_phch (l1_dl_phychan_enum_type phch, wsub_id_e_type wsub_id);
...
extern boolean dlchmgr_get_nbr_info_for_cell_trans(
  stmr_counter_source_enum_type *nbcch_cntr, tlm_cell_info_struct_type *ncell_info, wsub_id_e_type wsub_id);
...
extern void dlchmgr_upd_assoc_status_for_cfg_idx(dlchmgr_cfg_db_idx_type cfg_db_idx,
  boolean assoc_status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_send_setup_done(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_sccpch0_pich_add_drop_done(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_drx_cmd_rcvd( wsub_id_e_type wsub_id);
...
extern void dlchmgr_upd_drx_hdle_tbl(dlchmgr_cfg_db_idx_type cfg_db_idx,
  drx_entity_handle_type drx_hdle, wsub_id_e_type wsub_id);
...
extern void dlchmgr_register_hs_td_update_callback(
  ...
  DEMOD_HS_TD_UPDATE_CB_FUNC_TYPE *hs_td_update_cb, wsub_id_e_type wsub_id);
...
extern void dlchmgr_deregister_hs_td_update_callback( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    The ext_l1msetup_cntrl->l1_cphy_setup_status.dl_phychan_status field is updated
...
extern boolean dlchmgr_resume (drx_entity_handle_type entity_hdle,
  boolean fast_resume, wsub_id_e_type wsub_id);
...
extern boolean dlchmgr_suspend (drx_entity_handle_type entity_hdle,
  boolean fast_suspend, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_send_dl_weak_ind(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dlchmgr_pre_cell_trans_cb( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dlchmgr_post_cell_trans_cb(boolean cell_trans_status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_rl_dpch_frame_offset_not_zero(const l1_setup_cmd_type* setup_cmd_param, uint16 rl_tto, uint16 psc);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dlchmgr_is_drx_cleanup_needed(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_aich_send_add_drop_done(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
extern boolean dlchmgr_is_cell_fit_for_aset_addition(
  ...
  /** request type */
  boolean ext_req, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dlchmgr_setup_pich_auto_sccpch(boolean enable, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_clear_pich_auto_sccpch_bmsk( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dlchmgr_is_any_pccpch_active( wsub_id_e_type wsub_id);
...
/*===========================================================================
FUNCTION        dlchmgr_resume_aset_ops_done_cb

DESCRIPTION     This function invokes l1msetup cmd handler to handle the remaining
                part of cphy setup processing after sho 
...
SIDE EFFECTS    None
===========================================================================*/
void dlchmgr_resume_aset_ops_done_cb(uint8 cctrch_idx, l1_dl_phychan_enum_type phch_type,
                                  dl_phch_cfg_handle_type phch_handle, boolean status, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dlchmgr_send_dl_weak_ind_for_no_lock(l1_dl_phychan_enum_type phch, wsub_id_e_type wsub_id);
#endif
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_phychan_sec_fdpch_tto_validate(l1_setup_cmd_type *setup, wsub_id_e_type wsub_id);

/*------------------EXTERNAL FUNCTIONS DEFINITION END------------------------------------*/

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION        dlchmgr_qsh_mdump_collect_sub
...
SIDE EFFECTS    None.
===========================================================================*/
QSH_MDUMP_FN_ATTR void  dlchmgr_qsh_mdump_collect_sub( wsub_id_e_type wsub_id);
