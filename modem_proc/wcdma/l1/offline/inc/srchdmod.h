...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/srchdmod.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
05/16/18   nc      Turning off RxD on early ACQ failure  
...
11/12/03   sh      Added ext_wsrch_cntrl->srch_dmod_interf_nbr_cell_ptr for triage to track
...
#define SRCH_RF_TX_DELAY wl1_rfm_get_enc_btf_val(wsub_id)

/*--------------------------------------------------------------------------
...
SIDE EFFECTS    
===========================================================================*/
extern void srchdch_start_srch_state_machine(uint16 off, uint32 tm, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern uint16 srch_get_saved_rscp( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srchacq_rpt (boolean early_fail, boolean acq_status, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void srchdch_signal_dch_measurements( wsub_id_e_type wsub_id);
