...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/inc/dldemlog_v.h#4 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     --------------------------------------------------------
11/18/19    ta      Added new field BTF delay under timing information of 0x4186
02/08/16    sl      Changes for 0x4186 log packet version11
...
typedef PACKED struct PACKED_POST {
  ...
  */
  ...
  /*Btf delay in calculating UL-DPCH pos*/
  int16 btf_delay;
...
LOG_RECORD_DEFINE(WCDMA_FINGER_TA_INFO_LOG_PACKET)
  ...
  per_path_info_struct_type paths[DL_TRI_MAX_PATHS_SUB_0];
