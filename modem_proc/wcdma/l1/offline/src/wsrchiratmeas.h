...
#define SRCHCM_INTERF_SEARCH_DONE()      ( srchcmmeas_ext_cntrl_params[wsub_id].srchcm_interf_search_done_status )
#define SRCHCM_INTERF_SEARCH_CLEAR()     { srchcmmeas_ext_cntrl_params[wsub_id].srchcm_interf_search_done_status = FALSE; }

#ifdef FEATURE_WCDMA_CM_LTE_SEARCH

#define WSRCHIRATMEAS_GET_LTE_SRCH_RESULT_PTR() (&wsrchlte_ext_cntrl_params[wsub_id].wsrchlte_cm_meas_rsp_info)

#define WSRCHIRATMEAS_SEND_SORTED_CELLS_TO_DRV(cell_list,num_cells)          \
                  wsrchlte_save_sorted_cell_list(cell_list,num_cells ,wsub_id)
...
#define WSRCHIRATMEAS_FACH_EUTRA_MEAS_DB() (&wsrchiratmeas_ext_cntrl_params[wsub_id].wsrchiratmeas_eutra_freq_db)
#endif
...
{
  #ifdef FEATURE_WCDMA_CM_LTE_SEARCH
  /* Main LTE cell database, organized by frequency */
  wsrchiratmeas_freq_list_struct_type wsrchiratmeas_eutra_freq_db;
  #endif
  #ifdef FEATURE_WCDMA_CM_LTE_SEARCH
  l1_common_filter_coef_enum_type wsrchiratmeas_eutra_interrat_filter_coef[L1_MAX_FILTER_COEF_STORAGE];
  #endif
  #ifdef FEATURE_WCDMA_CM_LTE_SEARCH
  uint8 filt_idx_used_for_sort;
  #endif
  #ifdef FEATURE_WCDMA_CM_LTE_SEARCH
  wsrchiratmeas_lte_cell_struct_type wsrchiratmeas_sorted_lte_cell[WSRCHIRATMEAS_W2L_CELL_LIST_SIZE];
  #endif
}wsrchiratmeas_ext_cntrl_params_type;

extern wsrchiratmeas_ext_cntrl_params_type wsrchiratmeas_ext_cntrl_params[WCDMA_NUM_SUBS];


typedef struct
{
}wsrchiratmeas_int_cntrl_params_type;
...
SIDE EFFECTS
  None
===========================================================================*/
void wsrchiratmeas_process_srch_done_signal( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void wsrchiratmeas_process_eutra_srch_done_signal( wsub_id_e_type wsub_id);
...
/*===========================================================================
  ...
  DESCRIPTION
    ...
    used to access the elements of wsrchiratmeas_ext_cntrl_params[wsub_id].wsrchiratmeas_eutra_interrat_filter_coef. If
  ...
  SIDE EFFECTS
    None
 ===========================================================================*/
extern uint8 wsrchiratmeas_get_active_filt_idx( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
uint8 wsrchiratmeas_find_eutra_cell(uint16 freq_idx, uint16 phy_cell_id, wsub_id_e_type wsub_id);
...
void wsrchiratmeas_filter_meas_quant(   
   uint16 cell_idx,
   uint16 ts_last_srch, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
uint16 wsrchiratmeas_find_eutra_freq_info(uint32 earfcn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void wsrchiratmeas_delete_eutra_cell(uint16 freq_idx, uint16 cell_idx, wsub_id_e_type wsub_id);
...
LOCAL void wsrchiratmeas_lte_tdd_rank_cells(uint32 earfcn, wsub_id_e_type wsub_id);
...
/*===========================================================================
  ...
  SIDE EFFECTS
    wsrchiratmeas_ext_cntrl_params[wsub_id].wsrchiratmeas_sorted_lte_cell may be updated.
 ===========================================================================*/
...
/*===========================================================================
  ...
  SIDE EFFECTS
    None.
 ===========================================================================*/
void wsrchiratmeas_prepare_eutra_cell_list_for_drv(wsrchlte_cm_meas_rsp_info_struct_type* result, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
   None
=============================================================================*/
void wsrchiratmeas_fach_add_cells( wsub_id_e_type wsub_id);

void wsrchiratmeas_add_eutra_cells_for_eval(uint16 freq_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern boolean wsrchiratmeas_conn_state_cleanup(l1_module_enum_type irat_module, wsub_id_e_type wsub_id);

LOCAL void wsrchiratmeas_gsm_cleanup_done( wsub_id_e_type wsub_id);

LOCAL void wsrchiratmeas_interf_cleanup_done( wsub_id_e_type wsub_id);

#if defined(FEATURE_WCDMA_TO_LTE) && defined(FEATURE_WCDMA_CM_LTE_SEARCH)
LOCAL void wsrchiratmeas_lte_cleanup_done( wsub_id_e_type wsub_id);
#endif

/*===========================================================================
FUNCTION wsrchiratmeas_ext_cntrl_params_init
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void wsrchiratmeas_ext_cntrl_params_init( void );

/*===========================================================================
FUNCTION wsrchiratmeas_int_cntrl_params_init
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void wsrchiratmeas_int_cntrl_params_init( void );
