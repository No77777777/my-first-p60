...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/wl1edrxhsentity.h#3 $
...
#define WL1_EDRX_HS_RXB_OVERHEAD 5
...
#define WL1_EDRX_HS_ACTIVE()(wl1_edrx_hs_entity.entity_state != WL1_EDRX_HS_ENTITY_STATE_INACTIVE)
...
/*Using bit14 to log if HS state machine is in QTA state*/
#define EDRX_STATE_IN_QTA_GAP_BMSK   0x4000
#define EDRX_STATE_IN_QTA_GAP_REG   5
#define EDRX_STATE_IN_QTA_GAP_SHFT  14
...
===========================================================================*/
extern void wl1_edrx_hs_entity_init( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_edrx_hs_validate_edrx_params(l1_setup_cmd_type *setup_cmd, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_edrx_hs_cmd_processor(wl1_edrx_hs_entity_cmd_struct_type *cmd, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_edrx_hs_is_subfn_within_rx_active(uint16 scch_dec_subfr, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_edrx_hs_entity_query_edrx_params(uint8 *drx_cycle_len_fr,uint16 *rx_burst_fr, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_hs_flush_log_pkt(wl1_edrx_log_submit_cmd_type *log_cmd, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_cme_trigger_handler(wl1_edrx_cme_action_local_cmd_type *cme_cmd, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_hs_notify_edch_resource_state(boolean edch_resource_state, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_hs_trigger_hs_entity_wakeup( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_hs_suspend_hs( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_hs_resume_hs( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edrx_hs_resume_done_cb(boolean status, wsub_id_e_type wsub_id);
...
FUNCTION wl1_edrx_hs_entity_qta_freeze_unfreeze_hs

DESCRIPTION This function is called to freeze/unfreeze HS state machine during QTA. During QTA, HS state machine is frozen 
HS entity transitions to QTA state.On exiting QTA, it is unfrozen and put back to its prev state.
...
===========================================================================*/
extern void wl1_edrx_hs_entity_qta_freeze_unfreeze_hs(boolean freeze_hs, wsub_id_e_type wsub_id);

/*=========================================================================
FUNCTION    wl1_edrx_hs_entity_prioritize_rx_burst_over_qta

DESCRIPTION
  In EDRX+QTA cases Rx burst must be prioritized over non paging QTA. This function will be called by multisim to 
check if the upcoming QTA will collide with Rx Burst.
...
=========================================================================*/
boolean wl1_edrx_hs_entity_prioritize_rx_burst_over_qta(wsub_id_e_type wsub_id);

/*=========================================================================
FUNCTION    wl1_edrx_hs_check_if_rxburst_missed_due_to_lta
DESCRIPTION
 This API is an utility API which checks if RxBurst got missed due to LTA
...
=========================================================================*/
extern boolean wl1_edrx_hs_check_if_rxburst_missed_due_to_lta(wsub_id_e_type wsub_id);
#endif /*FEATURE_WCDMA_EFACH_MSIM*/
#endif /* FEATURE_WCDMA_HS_FACH_DRX */

#ifdef FEATURE_QSH_MDUMP 
/*=========================================================================
FUNCTION    wl1_edrx_hs_qsh_mdump_collect
DESCRIPTION
  To dump some parameters
...
=========================================================================*/
QSH_MDUMP_FN_ATTR void wl1_edrx_hs_qsh_mdump_collect(void);
#endif
