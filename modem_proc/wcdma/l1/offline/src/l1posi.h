...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/l1posi.h#3 $
...
/*
 */
#define  L1POS_MSG_HIGH(str, a,b,c)                WL1_MSG3(HIGH,str,a,b,c)
#define  L1POS_MSG_MED(str, a,b,c)                 WL1_MSG3(MED,str,a,b,c)
#define  L1POS_MSG_LOW(str, a,b,c)                 WL1_MSG3(LOW,str,a,b,c)
...
__inline boolean RRC_GET_LAI_IDENT( rrc_plmn_identity_type plmn_id,
                                    ...
                                    rrc_lai_type *p_lai_ident , wsub_id_e_type wsub_id)
{
