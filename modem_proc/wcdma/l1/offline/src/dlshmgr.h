...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlshmgr.h#3 $
...
extern void dlshmgr_enable_service(
  ...
  dlshmgr_svr_type_enum_type service_type, wsub_id_e_type wsub_id);
...
extern dlshmgr_svc_mask_type dlshmgr_get_l1_enab_svc_for_trch(
  ...
  uint8 trch_idx, wsub_id_e_type wsub_id);
...
/*===================================================================
FUNCTION dlshmgr_qsh_mdump_collect

DESCRIPTION
  Function to dump dlshmgr related parameters.
...
SIDE EFFECTS
  None
===================================================================*/
QSH_MDUMP_FN_ATTR void dlshmgr_qsh_mdump_collect();
#endif
