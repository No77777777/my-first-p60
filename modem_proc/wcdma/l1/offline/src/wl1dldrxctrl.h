...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/wl1dldrxctrl.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $   
...
10/20/15   raj      Added state check to unblock EUL ISR if CPC lite sleep or wakeup is in transition.
...
11/11/14   gp       Fix for incorrect datatype for edch inactivity timer that may lead to truncation
...
/** function pointer */
typedef void (*WL1_DL_DRXCTRL_ENTITY_OPS_HANDLER)(wsub_id_e_type wsub_id);
typedef void wl1_dl_drxctrl_ard_cb_func_type(boolean, wsub_id_e_type wsub_id);
typedef void wl1_dl_drxctrl_cme_cb_func_type(boolean, boolean,wsub_id_e_type wsub_id);

extern wl1_dl_drxctrl_cme_cb_func_type *wl1_dl_drxctrl_cme_act_deact_cb_func;
...
typedef struct
{
  ...
  boolean drx_logging_cmd_pending[WL1_DL_DRXCTRL_LOGGING_ARR_SIZE];
  /** Buffer info of all events which got triggered in N CFNs.* */
  wl1_dl_drxctrl_logging_event_info_struct_type wl1_dl_drxctrl_raw_log_arr[WL1_DL_DRXCTRL_LOGGING_ARR_SIZE][WL1_DL_DRXCTRL_MAX_LOG_BUF_IDX];   
...
typedef enum
{
  ...
  /* Client for QDTA */
  WL1_DL_DRXCTRL_RF_CTRL_FOR_QDTA,
...
#define WL1_DL_DRXCTRL_SET_DRX_STATE(curr_state) \
        WL1_CMN_MSG3(HIGH,"WL1DLDRXCTRL: Setting state %d curr state %d", curr_state, wl1_dl_drxctrl_db.drxctrl_curr_state, 0); \
        wl1_dl_drxctrl_db.drxctrl_curr_state = curr_state

#define WL1_DL_DRXCTRL_FREEZE_SCHEDULING_NOW() \
        WL1_CMN_MSG3(HIGH,"WL1DLDRXCTRL: Freezing scheduling", 0, 0, 0); \
        wl1_dl_drxctrl_db.scheduling_needed = FALSE

#define WL1_DL_DRXCTRL_UNFREEZE_SCHEDULING_NOW() \
        WL1_CMN_MSG3(HIGH,"WL1DLDRXCTRL: Unfreezing scheduling", 0, 0, 0); \
...
#define WL1_DL_DRXCTRL_FREEZE_LOGGING_NOW() \
        WL1_CMN_MSG3(HIGH,"WL1DLDRXCTRL: Freezing logging", 0, 0, 0); \
        wl1_dl_drxctrl_db.logging_enabled = FALSE

#define WL1_DL_DRXCTRL_UNFREEZE_LOGGING_NOW() \
        WL1_CMN_MSG3(HIGH,"WL1DLDRXCTRL: Unfreezing logging", 0, 0, 0); \
...
#define WL1_DL_DRXCTRL_SET_ENTITY_ACTIVE(entity_id) \
        WL1_MSG3(HIGH,"WL1DLDRXCTRL: Setting entity %d active curr_active_entities 0x%x", entity_id, wl1_dl_drxctrl_db.entity_db.active_entity_mask, 0); \
...
#define WL1_DL_DRXCTRL_SET_ENTITY_FREE(entity_id) \
        WL1_MSG3(HIGH,"WL1DLDRXCTRL: Freeing entity %d active curr_active_entities 0x%x", entity_id, wl1_dl_drxctrl_db.entity_db.active_entity_mask, 0); \
...
#define WL1_DL_DRXCTRL_INVOKE_ENTITY_WAKEUP_HANDLER(entity_id, tick_cnt) \
        ...
        {                                                                                                   \
          WL1_MSG4(HIGH, "WL1DLDRXCTRL: Waking up entity %d handler 0x%x wakeup cfn %d tick %d",                                        \
          ...
          wl1_dl_drxctrl_db.entity_db.entities[entity_id].entity_info.drx_entity_wakeup_handler(wsub_id);          \
        }
...
#define WL1_DL_DRXCTRL_INVOKE_ENTITY_SLEEP_HANDLER(entity_id) \
        ...
        {                                                                                                      \
          WL1_CMN_MSG3(MED, "WL1DLDRXCTRL: Sending entity %d to sleep handler 0x%x",                                    \
                   entity_id, wl1_dl_drxctrl_db.entity_db.entities[entity_id].entity_info.drx_entity_gotosleep_handler, 0);\
          wl1_dl_drxctrl_db.entity_db.entities[entity_id].entity_info.drx_entity_gotosleep_handler(wsub_id);          \
        }
...
#define WL1_DL_DRXCTRL_GET_CURR_SUBFM() \
        (stmr_get_current_time(MCALWCDMA_EVT_RX_TL_INTR, wsub_id)/HS_SUB_FRAME_LEN_UNIT_256_CHIP)
...
extern boolean wl1dldrxctrl_dbg_msg_enable;

#define WL1_DL_DRXCTRL_MSG1(str, a) \
if (wl1dldrxctrl_dbg_msg_enable) \
{ \
 WL1_MSG1(HIGH,str, a); \
}\
else \
...
#define WL1_DL_DRXCTRL_MSG2(str, a, b) \
if (wl1dldrxctrl_dbg_msg_enable) \
{ \
 WL1_MSG2(HIGH,str, a, b); \
}\
else \
{ \
  WL1_MSG2(LOW,str, a, b); \
}

#define WL1_DL_DRXCTRL_MSG3(str, a, b, c) \
if (wl1dldrxctrl_dbg_msg_enable) \
{ \
...
#define WL1_DL_DRXCTRL_MSG5(str, a, b, c, d, e) \
if (wl1dldrxctrl_dbg_msg_enable) \
{ \
...
#define WL1_DL_DRXCTRL_MSG6(str, a, b, c, d, e, f) \
if (wl1dldrxctrl_dbg_msg_enable) \
{ \
...
#define WL1_DL_DRXCTRL_MSG9(str, a, b, c, d, e, f, g, h, i) \
if (wl1dldrxctrl_dbg_msg_enable) \
{ \
...
===========================================================================*/
extern void wl1_dl_drxctrl_init( wsub_id_e_type wsub_id);
...
extern uint8 wl1_dl_drxctrl_register_entity(
  /** input entity info */
  wl1_dl_drxctrl_entity_intf_info_struct_type *input_entity_info, wsub_id_e_type wsub_id);
...
extern boolean wl1_dl_drxctrl_deregister_entity(
  /** entity id */
  uint8 entity_id, wsub_id_e_type wsub_id);
...
extern void wl1_dl_drxctrl_entity_schedule_update(
  ...
  wl1_dl_drxctrl_entity_ops_request_struct_type *input_control_info, wsub_id_e_type wsub_id);
...
extern void wl1_dl_drxctrl_configure_drx_mode(
  ...
  wl1_dl_drxctrl_setup_struct_type* setup_packet, wsub_id_e_type wsub_id);
...
extern void wl1_dl_drxctrl_evt_handler(
  /** generic event type */
  seq_generic_event_enum_type cpc_gen_evt_type, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_notify_cpc_status_to_clients(boolean status, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_start_drx( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_unfreeze_scheduling( wsub_id_e_type wsub_id);
...
===========================================================================*/
boolean wl1_dl_drxctrl_freeze_scheduling( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_cleanup( wsub_id_e_type wsub_id);
...
extern void wl1_dl_drxctrl_dtx_drx_offset_complete_notify(
  /** notify cfn */
  uint8 trigger_cfn, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_cpc_drx_cfg_done( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_freeze_unfreeze_for_CPC_scch_order(boolean freeze, wsub_id_e_type wsub_id);


/*===========================================================================
FUNCTION        wl1_dl_drxctrl_cpc_scch_order_ops
...
SIDE EFFECTS    None
==========================================================================*/
boolean wl1_dl_drxctrl_cpc_scch_order_ops(wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        wl1_dl_carrcfg_perform_scch_order_done_post_ops

DESCRIPTION     This function gets processed when L1_SCCH_ORD_DONE_CMD is posted after SCCH order
                handling is completed. It unsuspends cphy if needed.
...
SIDE EFFECTS    None
==========================================================================*/
void wl1_dl_drxctrl_cpc_scch_order_done_post_ops(wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern void wl1_dl_drxctrl_log_activity_times(uint8 subfm, uint32 input_key, uint16 input_val, wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern void wl1_dl_drxctrl_process_mdsp_event_log(wl1_dldrx_process_mdsp_evt_log_type *mdsp_evt_log, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_cfg_process_log_cmd(wl1_dldrx_cfg_log_cmd_type *cpcdrx_cfg_logging, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_process_log_cmd(uint8 buff_idx, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_vote_rf_state(wl1_dl_drxctrl_rf_ctrl_client_enum_type client_id, boolean rf_state, wsub_id_e_type wsub_id);

extern uint8 wl1_dl_drxctrl_get_sleep_log_mask(uint8 tick, wsub_id_e_type wsub_id);

extern uint8 wl1_dl_drxctrl_get_wakeup_log_mask(uint8 tick, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_dl_drxctrl_is_cpc_drx_active( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_configure_drx_pre_setup(hsdpa_setup_ops_enum_type hs_ops, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_register_act_deact_ard_cb_func(wl1_dl_drxctrl_ard_cb_func_type *ard_cb, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_register_act_deact_cme_cb_func(wl1_dl_drxctrl_cme_cb_func_type *cme_cb, wsub_id_e_type wsub_id);
...
extern int32 wl1_dl_drxctrl_delta_time_from_ref_time(
  ...
  /** event time */
  wl1_dl_drxctrl_time_var_struct_type *evt_time, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_start_edrx( wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern uint16 wl1_dl_drxctrl_get_next_wkup_sfn( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_wakeup_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_dl_drxctrl_sleep_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
===========================================================================*/
void wl1_dl_drxctrl_wakeup_edrx_for_slp_abort( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_edrx_get_edrx_configured_status( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_dl_drxctrl_query_edrx_active( wsub_id_e_type wsub_id);
...
FUNCTION WL1DLDRXCTRL_IS_DRX_STATE_RX_ACTIVE

DESCRIPTION : An API to check if DRX_CTLR state is in RxActive mode or not
...
===========================================================================*/
extern boolean wl1dldrxctrl_is_drx_state_rx_active();
...
FUNCTION wl1_dl_drxctrl_qta_register_wake_sleep_cb

DESCRIPTION : This function registers QTA entity with dldrxctrl.
...
===========================================================================*/
extern void  wl1_dl_drxctrl_qta_register_wake_sleep_cb(wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION wl1_dl_drxctlr_qta_sleep_cb

DESCRIPTION : Sleep cb called when dldrxctrl puts QTA entity to sleep.
...
===========================================================================*/
extern void wl1_dl_drxctlr_qta_sleep_cb(wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION wl1_dl_drxctlr_qta_wakeup_cb

DESCRIPTION : wake up cb called when dldrxctrl wakes up QTA entity
...
===========================================================================*/
extern void wl1_dl_drxctlr_qta_wakeup_cb(wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION wl1_dl_drxctlr_qta_start_drx

DESCRIPTION : This function is called when EDRX mode of operation starts to register QTA with dldrxctrl.
...
===========================================================================*/
extern void wl1_dl_drxctlr_qta_start_drx(wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION wl1_dl_drxctrl_qta_entity_schedule_update

DESCRIPTION : This internal qta entity schedule update function is used to call dldrxctrl entity schedule update to 
vote for sleep. QTA entity votes for fixed duration sleep to be woken up right before the start of QTA. It votes for indefinte sleep
after QTA ends.
...
===========================================================================*/
extern void wl1_dl_drxctrl_qta_entity_schedule_update(boolean sleep_indefinitely, uint32 num_bpgs, wsub_id_e_type wsub_id);

/*===========================================================================

FUNCTION wl1_dl_drxctrl_qta_stop_edrx

DESCRIPTION : This function deregisters QTA entity with dldrxctrl. It is invoked as a part of drxctrl cleanup during EDRX deconfig.
...
===========================================================================*/
extern void wl1_dl_drxctrl_qta_stop_edrx(wsub_id_e_type wsub_id);

/*=========================================================================
FUNCTION        wl1_qta_drxctrl_deregister_wake_sleep_cb
...
SIDE EFFECTS    None
=========================================================================*/
extern void wl1_qta_drxctrl_deregister_wake_sleep_cb(wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
==========================================================================*/
extern void wl1_dl_drxctrl_resume_cphy(uint8 evt, wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION        WL1_DL_DRXCTRL_qsh_mdump_collect

DESCRIPTION     Dump minidump parameters
...
SIDE EFFECTS    None
==========================================================================*/
extern QSH_MDUMP_FN_ATTR void wl1_dl_drxctrl_qsh_mdump_collect();
#endif
