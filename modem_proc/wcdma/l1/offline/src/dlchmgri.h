...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlchmgri.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
typedef struct {
  ...
  /*This table gives the mapping between DRX handles and Chanel Manager dynamic Db Idx*/
  dlchmgr_cfg_db_idx_type dlchmgr_drx_hdle_cfg_idx_map_tbl[DRX_ENTITY_NUM_TYPES];
} dlchmgr_db_struct_type;

typedef struct
{
  /* dlchmgr_db holds the information that is global for dlchmgr but not
   channel specific.*/
  dlchmgr_db_struct_type dlchmgr_db;
}dlchmgr_int_cntrl_params_type;
...
#define DLCHMGR_GET_GEN_OP_STAT_DB_IDX_FROM_DYN_IDX()  \
  (dlchmgr_int_cntrl_params[wsub_id].dlchmgr_db.gen_op_dyn_db.gen_op_stat_db_idx)

#define DLCHMGR_GET_CFG_DB_IDX_GEN_OP_BMASK_FROM_DYN_IDX()  \
  (dlchmgr_int_cntrl_params[wsub_id].dlchmgr_db.gen_op_dyn_db.gen_op_cfg_db_idx_bmask)

#define DLCHMGR_GET_GEN_OP_STATUS_FROM_DYN_IDX()  \
  (dlchmgr_int_cntrl_params[wsub_id].dlchmgr_db.gen_op_dyn_db.gen_op_status)
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL dlchmgr_cfg_db_idx_type dlchmgr_alloc_cfg_db_idx( wsub_id_e_type wsub_id);
...
LOCAL void dlchmgr_dealloc_cfg_db_idx
  (dlchmgr_cfg_db_idx_type dlchmgr_dyn_db_idx, wsub_id_e_type wsub_id);
...
LOCAL dlchmgr_cfg_db_idx_type dlchmgr_get_cfg_db_idx_from_dl_param
  (uint8 cctrch_idx, dl_phch_cfg_handle_type phch_handle, wsub_id_e_type wsub_id);
...
extern void dlchmgr_handle_cfg_idx_failure_ext_op(
  l1_dl_phychan_enum_type phch, l1_setup_ops_enum_type op, uint8 cctrch_index, wsub_id_e_type wsub_id);
...
LOCAL void dlchmgr_handle_cfg_idx_failure_int_op(
  dlchmgr_int_setup_struct_type *ch_info, l1_setup_ops_enum_type op, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL dlchmgr_static_db_idx_type dlchmgr_get_static_db_idx(dl_phychan_add_type *add_info, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_handle_cleanup_bmask(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_init_db(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
LOCAL dlchmgr_gen_op_stat_db_idx_enum_type dlchmgr_get_stat_db_idx_for_gen_op(
  dl_phychan_action_reason_enum_type gen_op_ext_type, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_check_for_gen_op_susp_all( dlchmgr_cfg_db_idx_type cfg_db_idx , wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_check_for_gen_op_drop_all( dlchmgr_cfg_db_idx_type cfg_db_idx , wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_gen_op_sleep_processed( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_gen_op_cell_trans_processed( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_gen_op_idle_req_processed( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_hdle_gen_op_post_ch_op(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_hdle_gen_op_done( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_drop_all( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_suspend_all( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_init_gen_op_db( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_fill_stat_info(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
LOCAL boolean dlchmgr_drop_sh_ch_for_gen_op(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
LOCAL dl_phch_state_enum_type dlchmgr_get_add_state(dlchmgr_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
LOCAL boolean dlchmgr_is_fach_to_dch_transition_with_hsrach(boolean chan_is_fdpch, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        dlchmgr_setup_int_pccpch

DESCRIPTION     Function which sets up internal pccpch
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dlchmgr_setup_int_pccpch(wsub_id_e_type wsub_id);
