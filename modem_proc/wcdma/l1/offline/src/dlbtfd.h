...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlbtfd.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
/* This variable maintains the failed BTFD decision for
   ...
   in INTLOCKS 
  */
  uint16 dl_btfd_failed_decision;
}dlbtfd_ext_cntrl_params_type;

extern dlbtfd_ext_cntrl_params_type dlbtfd_ext_cntrl_params;
...
extern boolean dl_find_guiding_trch(
  ...
  l1_dl_ctfc_info_struct_type     *ctfc_info, wsub_id_e_type wsub_id);
...
extern boolean dl_dob_status_fifo_info_btfd_update(
  ...
  uint8 dob_status_fifo_idx, wsub_id_e_type wsub_id);
