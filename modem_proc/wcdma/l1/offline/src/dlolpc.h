...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlolpc.h#3 $
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_olpc_read_olpc_nv_items( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_olpc_disable( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_olpc_check_for_windup( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_olpc_check_for_winddown( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_olpc_update_sir_target( wsub_id_e_type wsub_id);
...
void dl_olpc_update_target_ebnt_btfd_only_one_tb_w_crc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
void dl_olpc_fdpch_outage_init( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
void dl_olpc_fdpch_outage_thresh_init(uint8 ber_rate, wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
void dl_olpc_fdpch_compute_sir_target_from_outage(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
===================================================================*/
extern void dl_olpc_bump_sirtgt_post_evt_detection( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===================================================================*/
extern void dl_olpc_check_for_windup_efdpch( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===================================================================*/
extern boolean dl_olpc_get_windup_status_efdpch(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===================================================================*/
extern void dl_olpc_reset_windup_status_efdpch(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===================================================================*/
extern void dl_olpc_params_init( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===================================================================*/
extern void dl_olpc_freeze_sec_pwr_ctrl( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===================================================================*/
extern void dl_olpc_unfreeze_sec_pwr_ctrl( wsub_id_e_type wsub_id);
...
void dl_olpc_reset_windup_params( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  New estimate of bler for the given tr ch is computed
===================================================================*/
extern void dl_olpc_vars_mem_dealloc( wsub_id_e_type wsub_id);
extern void dl_olpc_vars_mem_alloc( wsub_id_e_type wsub_id);


#ifdef FEATURE_QSH_MDUMP 
/*===================================================================
FUNCTION dl_olpc_qsh_mdump_collect

DESCRIPTION
  Function to collect dump for olpc related parameters.
...
SIDE EFFECTS
  None
===================================================================*/
QSH_MDUMP_FN_ATTR void dl_olpc_qsh_mdump_collect(void);
#endif
#endif
