...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/wl1srchdlif.h#3 $
...
01/13/16   sl      Avoid decrementing the cell_cfg_count twice for one config removal from txd queue
01/04/16   rn      API to clear all TXD active and pending transactions
...
#define SRCH_CELL_STUCK_TIMER 5
...
typedef void (*SRCH_CELL_CFG_DECFG_POST_PROCESSOR)( wsub_id_e_type wsub_id);

typedef void (*SRCH_CME_NGHBR_CELL_DECONFIG_CB_FUNC_TYPE) (uint16  cell_bmsk, wsub_id_e_type wsub_id);
typedef void (*SRCH_CME_NGHBR_CELL_CONFIG_CB_FUNC_TYPE)   (uint16 cell_bmsk, wsub_id_e_type wsub_id);
...
typedef void (*SRCHFACH_FMO_DONE_CB_FUNC)(wsub_id_e_type wsub_id);
...
extern boolean srchbplmn_deconfigure_aset_cells(SRCH_CELL_CFG_DECFG_POST_PROCESSOR decfg_done_cb, wsub_id_e_type wsub_id);
#endif
...
extern void srch_schedule_txd_detection(srch_cell_struct_type *cell_ptr, uint8 num_retry_count, wsub_id_e_type wsub_id);
...
extern boolean srch_check_if_aset_dereg_in_progress( wsub_id_e_type wsub_id);

extern boolean srch_add_config_cells(srch_cell_struct_type * cell_ptr, wsub_id_e_type wsub_id);

extern boolean srch_add_deconfig_cells(srch_cell_struct_type * cell_ptr, wsub_id_e_type wsub_id);
extern boolean srch_check_any_cfg_ongoing(wsub_id_e_type wsub_id);
extern boolean srch_check_any_decfg_ongoing( wsub_id_e_type wsub_id);
extern boolean srch_check_if_any_cfg_decfg_in_progress( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean srch_is_cell_in_deconfig(srch_cell_struct_type * cell_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean srch_is_cell_in_config_for_cme(uint16 freq, uint16 scr_code, wsub_id_e_type wsub_id);
...
extern void srch_register_cme_txd_change_cb(
  ...
  SRCH_CME_TXD_CHANGE_CB_FUNC_TYPE *srch_cme_cb, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_deregister_cme_txd_change_cb( wsub_id_e_type wsub_id);
...
extern void srch_register_cme_srch_cell_info_cb(
  /* Callback function pointer */
  SRCH_CME_CELL_INFO_CB_FUNC_TYPE *srch_cme_cb, boolean call_cb_now, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_deregister_cme_srch_cell_info_cb( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_scan_cme_cell_info_hs( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_scan_cme_cell_info( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean srch_cme_configure_cme_non_aset_cell(uint16 psc, uint16 freq, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_cme_deconfigure_cme_non_aset_cell(uint16 cell_bmsk, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean srch_cme_configure_cme_aset_cell(uint16 psc, uint16 freq, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_cme_deconfigure_cme_aset_cell(uint16 cell_bmsk, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
extern void srch_cme_set_qice_status(uint8 carr_idx, boolean qice_stat, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean srch_cme_get_qice_status(uint8 carr_idx, wsub_id_e_type wsub_id);
...
extern void srch_configure_scpich_cell_mimo_mode(
  ...
  SRCH_CELL_CFG_DECFG_POST_PROCESSOR srch_post_processor,
  /* MIMO S_CPICH Imbalance Scale */
  uint16 s_cpich_imb_scale, wsub_id_e_type wsub_id);
...
extern void srch_configure_cell_params(
  ...
  srchdlif_cell_config_params_type *cell_params, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean srch_perform_aset_update(wl1_dl_carrcfg_cfg_param_struct* ord_cfg, wl1_dl_carrcfg_cfg_param_struct* curr_cfg, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  Will issue an WL1_ERR_FATAL crash if the command could not be posted
===========================================================================*/
extern void srch_notify_carrcfg_upon_aset_srch_done( wsub_id_e_type wsub_id);
...
===========================================================================*/
void srch_dc_meas_configuration(boolean meas_enable, wsub_id_e_type wsub_id);
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
extern srch_cell_struct_type* srch_get_serv_hs_cell(uint8 carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern boolean srch_chk_and_reg_srch_to_slp_cb( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
===========================================================================*/
extern void srch_check_if_cell_stuck(wsub_id_e_type wsub_id);
...
extern void srch_clear_txd_active_pending_transactions(srch_cell_struct_type *cell_ptr, wsub_id_e_type wsub_id);
