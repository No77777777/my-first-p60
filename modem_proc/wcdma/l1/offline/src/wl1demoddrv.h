...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/wl1demoddrv.h#3 $
...
--------    ---     --------------------------------------------------------
05/17/16    sl      F3 reduction
08/24/15    ap      Adding wsub_id paramter to function demod_is_at_least_one_finger_in_lock()
02/27/15    ap      Initial check-in for WL1 QSH framework 
04/22/15    sr      W+W changes for Demod Status Dump
...
--------------------------------------------------------------------------*/
#define FING_SOFT_LOCK_RSSI_THRESH DL_TRI_SOFT_LOCK_THRESH
...
#define STATUS_DUMP_ADJ_REF_CNT(sub) \
  (wl1demoddrv_ext_cntrl_params[wsub_id].demod_status_dump_info.ref_cnt >= (sub) ? \
    wl1demoddrv_ext_cntrl_params[wsub_id].demod_status_dump_info.ref_cnt - (sub) : \
    CHIPX8_PER_FRAME + wl1demoddrv_ext_cntrl_params[wsub_id].demod_status_dump_info.ref_cnt - (sub))

#define STATUS_DUMP_TX_SYS_TIME() \
  ((wl1demoddrv_ext_cntrl_params[wsub_id].demod_status_dump_info.tx_sys_time) & 0x7FFFF)

#define STATUS_DUMP_TX_CFN_SHORT() \
  (((wl1demoddrv_ext_cntrl_params[wsub_id].demod_status_dump_info.tx_sys_time) & 0x380000) >> 19)
...
#define MDSP_READ_COMBINED_FREQ_EST() \
  mcalwcdma_demod_get_freqcommon(wsub_id)
...
#define MDSP_READ_PICH_PI_VALUE()                        \
  mcalwcdma_fwsw_intf_addr_ptr->demodInfo.pichDemodInfo[wsub_id]. \
    result[0].indValue
#else
#define MDSP_READ_PICH_PI_VALUE()                        \
...
#define WL1_DEMODDRV_DSD_CLIENT_INFO_INTLOCK()  REX_ISR_LOCK(&wl1demoddrv_ext_cntrl_params[wsub_id].wl1_demoddrv_dsd_client_info_crit_sect)
#define WL1_DEMODDRV_DSD_CLIENT_INFO_INTFREE()  REX_ISR_UNLOCK(&wl1demoddrv_ext_cntrl_params[wsub_id].wl1_demoddrv_dsd_client_info_crit_sect)
...
typedef void (*WL1_DEMODDRV_DSD_CLIENT_FUNC_CB_PTR)( wsub_id_e_type wsub_id);
...
typedef struct
{
  rex_crit_sect_type wl1_demoddrv_dsd_client_info_crit_sect;
  status_dump_info_struct_type demod_status_dump_info;
}wl1demoddrv_ext_cntrl_params_type;

extern wl1demoddrv_ext_cntrl_params_type wl1demoddrv_ext_cntrl_params[WCDMA_NUM_SUBS];

typedef struct
{
  wl1_demoddrv_dsd_client_info_struct_type wl1_demoddrv_dsd_client_info;
}wl1demoddrv_int_cntrl_params_type;
/****************************************************************************
 ****************************************************************************
                            FUNCTION PROTOTYPES
 ****************************************************************************
...
SIDE EFFECTS    None.
===========================================================================*/
void demod_init( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
void demod_reset_status_dump_clients(wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean demod_is_at_least_one_finger_in_lock(wsub_id_e_type wsub_id);
...
===========================================================================*/
boolean demod_send_finger_cfg_cmd( wsub_id_e_type wsub_id);
...
extern boolean demod_status_dump(
  /* dsd client cb ptr*/
    demod_status_dump_cmd_request_struct_type *dsd_req_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void mcalwcdma_demod_post_dsd_done_cmd( wsub_id_e_type wsub_id);
...
===========================================================================*/
boolean demod_assign_finger(fing_assign_parms_struct_type *parms, wsub_id_e_type wsub_id);
...
===========================================================================*/
boolean demod_disable_finger(uint8 fing, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
==========================================================================*/
void demod_set_tpc_threshold(boolean efdpch_enable, wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern int16 get_fing_ecio( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern int16 get_fing_ecio_for_rscp( wsub_id_e_type wsub_id);
...
extern void mcalwcdma_demod_cfg_cmd_done(
  ...
  mcal_status_type ret_status, wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern void demoddrv_commit_pending_demod_config( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern int32 demoddrv_retrieve_tcxoaccum( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void demod_status_dump_cmd_done_handler( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint32 demod_syncup_finger_cell_info(srch_cell_struct_type *cell_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint32 demod_get_comb_fing_rssi(wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 demod_check_fing_rssi_diff_for_txd_det(uint8 cell_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    The finger config record shadow and the finger status
                database are updated
===========================================================================*/
extern boolean demod_revert_finger_cfg(uint8 fing, wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern void demod_enter_hs_only_tpc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern void demod_exit_hs_only_tpc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern void demod_hs_tpc_imbalance_stat(boolean imbalance_detected, wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern void demod_hs_decoded_stat(hs_dec_stat_enum_type hs_dec_stat, wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern boolean demod_hs_throughput_loss_detected( wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern void demod_init_hs_tpc_db( wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern void demod_check_hs_only_tpc( wsub_id_e_type wsub_id);
...
SIDE EFFECTS        None
===========================================================================*/
extern uint8 demod_get_hs_serving_fing_tpc_idx( wsub_id_e_type wsub_id);
...
DESCRIPTION        To collect minidump parameter for dump
...
SIDE EFFECTS        None
===========================================================================*/
QSH_MDUMP_FN_ATTR void demod_qsh_mdump_collect(void);

QSH_MDUMP_FN_ATTR void demod_qsh_mdump_collect_sub( wsub_id_e_type wsub_id);
#endif
