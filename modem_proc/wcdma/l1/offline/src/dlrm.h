...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlrm.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  int32 dl_rm_delta_n_tti[MCALWCDMA_DEC_TOTAL_TRCHT_PER_CCTRCH][DEC_TOTAL_TFT_PER_CCTRCH];
  /* This variable stores the structure for the rate matching parameters */
  dec_rm_param_struct_type *dl_rm_rm_params[MCALWCDMA_DEC_TOTAL_TRCHT_PER_CCTRCH];
  uint8 *dl_rm_db_tfi[DEC_TOTAL_CTFC_ENTRIES_PER_TABLE];
}dlrm_ext_cntrl_params_type;

extern dlrm_ext_cntrl_params_type dlrm_ext_cntrl_params;
...
extern void dl_rm_calc_rm_param(
  ...
  dec_cctrch_table_info_struct_type *cctrch_table_info, wsub_id_e_type wsub_id);
...
extern void dl_rm_set_value_no_rm(
  /* CCTrCh setup information. */
  mcalwcdma_dec_cctrch_info_struct_type *cctrch_info, wsub_id_e_type wsub_id);
