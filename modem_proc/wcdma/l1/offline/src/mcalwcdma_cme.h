...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/mcalwcdma_cme.h#4 $
...
10/23/15   svh    Update FW when in multicell QICE mode with strong interferers 
                  within 10db of HS cell ecio.
09/01/15   ac     Remove empty structure definition
08/04/15   br     Not sending SCHIC disable for a carrier when it is already disabled. 
07/17/15   svh    Not sending cme disable for an already disabled cell.
07/09/15   svh    IRPM + MCVS for TA 2.0.
07/08/15   rsr    IRPM + MCVS for TH 2.0.
...
** ======================================================================= */
extern void mcalwcdma_cme_int_cntrl_params_init(void);
extern void mcalwcdma_cme_ext_cntrl_params_init(void);
/*============================================================================*/
/**
...
void mcalwcdma_cme_update_cme_window(
  uint8 carrier,
  mcalwcdma_cme_cfg_params_struct_type* cme_cfg_params_ptr, wsub_id_e_type wsub_id);
...
/**
  ...
  */
/*============================================================================*/
extern void mcalwcdma_cme_update_irpm_params(uint8 carrier, uint8 Tm, uint8 Ts, uint8 Td, uint32 delta, wsub_id_e_type wsub_id);
...
void mcalwcdma_cme_send_cfg_cmd(
  uint16 eq_cfg_update_bmsk,
  uint16 cmn_cfg_update_bmsk, wsub_id_e_type wsub_id);
...
/**
  ...
  */
/*============================================================================*/
void mcalwcdma_cme_demod_cfg_cmd_done_cb(uint16 status, wsub_id_e_type wsub_id);
...
/**
  ...
  */
/*============================================================================*/
void mcalwcdma_cme_oride_qice_cfg_cmd_done_cb(uint16 status, wsub_id_e_type wsub_id);
...
/**
  ...
  */
/*============================================================================*/
void mcalwcdma_cme_demod_cfg_proc_done_cb( wsub_id_e_type wsub_id);
...
/**
  ...
  */
/*============================================================================*/
void mcalwcdma_cme_mcvs_req_cb(wsub_id_e_type wsub_id);

/*============================================================================*/
/**
  * IRPM MCVS Update to FW.
  */
/*============================================================================*/
void mcalwcdma_cme_update_irpm_mcvs_state(
  boolean irpmMcvsEnable,
  boolean ackToggle,
  uint32 iterSched,
...
/**
  * This function is called when Signal is Raised by FW indicating that
  * CME Clock bump up is required.
  */
/*============================================================================*/
void mcalwcdma_cme_demod_mcvs_bump_up_cb(wsub_id_e_type wsub_id);

/*============================================================================*/
/**
  * This function is called when Signal is Raised by FW indicating that
  * CME Clock bump down is required.
  */
/*============================================================================*/
void mcalwcdma_cme_demod_mcvs_bump_down_cb(wsub_id_e_type wsub_id);
...
/**
  ...
  */
/*============================================================================*/
uint16 mcalwcdma_cme_get_qset_cell_configured_pn_pos(uint16 carrier, uint16 qset_idx, wsub_id_e_type wsub_id);
...
#ifdef FEATURE_WCDMA_PCOV
/*============================================================================*/
/**
  * Updates FW interface buffer PCOV enable state.
  */
/*============================================================================*/
void mcalwcdma_cme_update_cov_state(
  boolean pcovEnable,
  boolean covSSEnable, 
  wsub_id_e_type wsub_id);
#endif
...
/*============================================================================*/
/**
  * Updates FW interface buffer reg QICE CBA offset.
  */
/*============================================================================*/
void mcalwcdma_cme_update_cba_qice_offset(
  boolean high_intf,
  uint8 carrier,
  wsub_id_e_type wsub_id);
#endif
