...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/wl1cpcdrxedlentity.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $  

when       who      what, where, why
--------   ---      --------------------------------------------------------  
03/23/16   raj      Ensure that second TTI of EDL is monitored after CPC DRX is started
06/29/15   cjz      Use last-logged SFN instead of first subFN to decide EDCH counter logging in 0x423A
...
#define WL1_EDLDRX_GET_HICH_RESULT_OFFSET()  (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.wl1_edldrx_hich_ctrl_info.hich_result_offset)
#define WL1_EDLDRX_SET_HICH_RESULT_OFFSET(x) (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.wl1_edldrx_hich_ctrl_info.hich_result_offset = (x))  
...
#define WL1_EDLDRX_SET_SCHED_TX_HICH_RSLT_FN_FLAG(subfn, val) \
        (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.wl1_edldrx_hich_ctrl_info.is_sched_tx_hich_rslt_fn[(subfn)%WL1_EDLDRX_NUM_EDL_FNS]= (val))
#define WL1_EDLDRX_IS_SCHED_TX_HICH_RSLT_FN(subfn) \
        (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.wl1_edldrx_hich_ctrl_info.is_sched_tx_hich_rslt_fn[(subfn)%WL1_EDLDRX_NUM_EDL_FNS])
...
typedef struct
{
  ...
  ** EDL channels will be monitiored till the below value becomes 0*/
  ...
  /* Number of frames since CPC_DRX started */
  boolean cpc_drx_first_two_tti_after_start;
  /*Current TTI*/
...
typedef struct
{
  wl1_edldrx_hs_timing_info_struct_type wl1_edldrx_hs_timing_info;
  wl1_edldrx_eul_tx_info_struct_type    wl1_edldrx_eul_tx_info;
  wl1_edldrx_ctrl_struct_type           wl1_edldrx_entity_ctrl_info;
  wl1_edldrx_entity_db_struct_type      wl1_edldrx_entity_db;
  
  /* buffer to remember the last SFN UE did EDCH counter logging for 10ms DRX */
  uint16                                wl1_edldrx_last_logged_sfn;
} wl1cpcdrxedlentity_ext_cntrl_params_type;

extern wl1cpcdrxedlentity_ext_cntrl_params_type wl1cpcdrxedlentity_ext_cntrl_params;


typedef struct
{
  wl1_dl_drxctrl_entity_struct_type wl1_dl_drxctrl_input_entity_info;
  /* Flag to indicate the start of EDL inactivity countdown */
  boolean                           wl1_edldrx_start_inact_thresh;
} wl1cpcdrxedlentity_int_cntrl_params_type;
#endif
...
#define WL1_EDLDRX_GET_CURR_INACT_THRESH() \
        (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor)

#if defined(FEATURE_QTA) && defined(FEATURE_WCDMA_CPC_DRX)
#define WL1_EDLDRX_SET_CURR_INACT_THRESH(x) \
        (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor = (uint16)x)

#define WL1_EDLDRX_GET_CURR_INACT_THRES_SIG_VALUE() \
        ((uint16)wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.inact_thresh_cfg_grant_monitor)
#endif

        
#ifdef FEATURE_WL1_DL_DRX_CTRL_DEBUG_MSG_LEVEL1
#define WL1_EDLDRX_RESET_CURR_INACT_THRES_SIG_VALUE() \
        WL1_MSG3(HIGH,"WL1CPCEDLDRX: resetting inact threshold from %d to %d", wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor, wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.inact_thresh_cfg_grant_monitor, 0); \
        (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor = (uint16)wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.inact_thresh_cfg_grant_monitor)
#define WL1_EDLDRX_DECREMENT_CURR_INACT_THRES() \
        ((wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor > 0) ? wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor-- : 0);\
        WL1_MSG3(HIGH,"WL1CPCEDLDRX: decremented inact threshold to %d", (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor), 0, 0)
#else
#define WL1_EDLDRX_RESET_CURR_INACT_THRES_SIG_VALUE() \
        (wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor = (uint16)wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.inact_thresh_cfg_grant_monitor)
#define WL1_EDLDRX_DECREMENT_CURR_INACT_THRES() \
...
#define WL1_EDLDRX_IS_CURR_INACT_THRES_ZERO() \
        ((wl1cpcdrxedlentity_ext_cntrl_params.wl1_edldrx_entity_ctrl_info.curr_inact_thresh_grant_monitor == 0) ? TRUE : FALSE)
...
===========================================================================*/
extern void   wl1_edldrx_entity_init( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_cfg_drx_ctrl_params(l1_drx_info_struct_type *, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint8 wl1_edldrx_register_entity_entry(e_dl_chan_enum_type, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_release_entity_entry(uint8, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_release_all_entities( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern wl1_edldrx_entity_state_enum_type wl1_edldrx_check_entity_state(uint8, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_cpc_drx_status(boolean, wsub_id_e_type wsub_id);
...
===========================================================================*/
boolean wl1_edldrx_cpc_drx_active( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_smallest_agch_to_dpch_offset(uint8, e_tti_enum_type, uint8, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_smallest_s_rgch_to_dpch_offset(uint8 , e_tti_enum_type, uint8, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_smallest_ns_rgch_to_dpch_offset(uint8, uint8, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_smallest_hich_to_dpch_offset(uint8, uint8, e_tti_enum_type, uint8, uint8, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_eul_tti(e_tti_enum_type, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_ready_to_sleep(e_dl_chan_enum_type, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern wl1_edldrx_entity_state_enum_type wl1_edldrx_get_agch_entity_state( wsub_id_e_type wsub_id);
/*===========================================================================
...
extern wl1_edldrx_entity_state_enum_type wl1_edldrx_get_edl_entity_state(e_dl_chan_enum_type edl_chan, wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern boolean wl1_edldrx_validate_edldrx_params(uint8 drx_req_mask, l1_drx_info_struct_type *drx_ctrl_info, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_dlhs_sleep_cb(uint8, uint8, wsub_id_e_type wsub_id);
...
extern void wl1_edldrx_program_sleep_wakeup_times_for_edl_entities(
              uint16, e_tti_enum_type, boolean, boolean, boolean, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint8 wl1_edldrx_max_ag_s_rg_dpch_offset( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern uint8 wl1_edldrx_get_entity_id(e_dl_chan_enum_type, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern boolean wl1_edl_chan_results_to_be_ignored(e_dl_chan_enum_type e_dl_chan, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_update_max_ns_rgch_dpch_offset(uint8, wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern void wl1_edldrx_update_max_s_rgch_dpch_offset(uint8, wsub_id_e_type wsub_id);
/*===========================================================================
...
===========================================================================*/
extern void wl1_edldrx_update_max_hich_dpch_offset(uint8, wsub_id_e_type wsub_id);
...
extern void wl1_edldrx_reset_inact_thresh( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void wl1_edldrx_log_params_10ms_tti( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void e_dl_update_edl_drx_entities(wl1_ul_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
