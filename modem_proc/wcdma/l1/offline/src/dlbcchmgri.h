...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlbcchmgri.h#4 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     ---------------------------------------------------------
12/18/15    sr      Changes in next frame wanted cb to correctly return sleep type in case of call est pending
...
#define DL_BCCH_CRC_CMD_PRELIM_CHECK_FAILED(eng, sfn)    \
  ((eng < DOB_ENERGY_THRESHOLD) || (sfn == 0))    \
...
#define DL_BCCH_GET_WSUB_ID_FROM_CFG_DB_IDX(cfg_db_idx)  \
  (dl_bcch_cfg_db[cfg_db_idx].dyn_db.wsub_id)
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dl_bcch_prep_db(uint8 cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL uint8 dl_bcch_get_cfg_db_idx(uint8 cctrch_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dl_bcch_crc_state_mc_post_process(uint8 cfg_db_idx, boolean pass, dl_bch_crc_status_type *cmd, wsub_id_e_type wsub_id);
...
/*===========================================================================
FUNCTION dl_bcch_debug_decode_prints

DESCRIPTION
Prints variables to help debug possible corruption
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void dl_bcch_debug_decode_prints(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
LOCAL dl_bcch_static_db_idx_enum_type dl_bcch_find_stat_db_idx
  (dlchmgr_cfg_db_idx_type chmgr_dyn_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
LOCAL void dl_bcch_reset_sib_mask( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dl_bcch_vote_on_rf_for_bch_decode(uint8 cfg_db_idx, boolean vote, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION DL_BCCH_SEND_FAKE_SIB_SCHED_CHANGE_IND_LOCAL_CMD

DESCRIPTION 
This will send a fake sib sched change ind to update the SIB mask.
...
===========================================================================*/
LOCAL void dl_bcch_send_fake_sib_sched_change_ind_local_cmd( wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION        dl_bcch_get_cfg_db_idx_from_psc_freq

DESCRIPTION     This function finds the ch-spec manager cfg db index 
                associated with the channel identified by the PSC and FREQ.
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL dl_ch_spec_cfg_db_idx_type dl_bcch_get_cfg_db_idx_from_psc_freq(uint16 psc, uint16 freq, wsub_id_e_type wsub_id);
