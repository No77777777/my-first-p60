...
$PVCSPath:$
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/srchsetutil.h#4 $
$DateTime: 2020/07/15 00:02:21 $
$Author: pwbldsvc $
...
02/26/18   rn      Log Packet 0x41DE for logging set movement related info during MCM 
...
05/17/16   vn      Searcher F3 reduction
12/02/15   mk      Removal of delta_multiframe from GSM  cell structure
...
12/17/14   jk      Dynamic cell structure memory allocation at the time of additional 
                   carrier configured.
...
#define SRCHSETUTIL_LOCK()    srchsetutil_get_intlock(wsub_id)
#define SRCHSETUTIL_UNLOCK()  srchsetutil_get_intfree(wsub_id)
...
#define SRCH_SET_MVMT_CRASH_DEBUG_LOG_PKT_CNT 5
...
((wsrch_ext_cntrl_params[wsub_id].wsrch_ext_cntrl_params_mdump.search_state == SRCH_FACH_STATE) ? (cell_ptr->filt_ecio) : (cell_ptr->filtered_parms[filt_idx].filt_ecio))
...
typedef enum
{
  ...
  /* Serving cells in use by QICE service */
  COMP_SET_QICE_A,
  
  /* Intra-frequency neighbor cells in use by QICE service */
  COMP_SET_QICE_N,
...
{
  uint8 current_cfn;
  uint8 num_intraf_rows;
  uint8 num_interf_rows;
  uint8 num_gsm_rows;
  uint8 num_lte_rows;
  srchlog_intraf_set_movement_struct_type intraf_set_mvmt[SRCH_SET_MVMT_LOG_PKT_INTRAF_MAX_ROWS];
  srchlog_interf_set_movement_struct_type interf_set_mvmt[SRCH_SET_MVMT_LOG_PKT_INTERF_MAX_ROWS];
  srchlog_gsm_set_movement_struct_type gsm_set_mvmt[SRCH_SET_MVMT_LOG_PKT_GSM_MAX_ROWS];
  srchlog_lte_set_struct_type lte_cell_info[SRCH_SET_MVMT_LOG_PKT_GSM_MAX_ROWS];
}srchsetutil_set_mvmt_log_type;
...
typedef struct
{
  int64 timeticks;
  uint16 pkt_len;
  WSRCH_SET_MOVEMENT_LOG_PACKET_type *log_pkt;
}srchsetutil_set_mvmt_log_buf_type;

typedef struct
{
  uint8 index;
  srchsetutil_set_mvmt_log_buf_type log_buf[5];
}srchsetutil_set_mvmt_buffer_type;

typedef struct
{
  /* indexes to cells for pull-in operation */
  uint8 srch_pullin_set_cnt;
  uint8 srch_triage_cnt[NUM_CARR];
  srch_cell_struct_type *srch_pullin_set_ptr[SRCH_PULLIN_SET_MAX];
  srch_cell_struct_type *srch_triage_ptr[NUM_CARR][SRCH_TRIAGE_SET_MAX];
}srchsetutil_ext_cntrl_params_mdump_type;

typedef struct
{
  uint8 srch_sleep_set_cnt;
  srch_cell_struct_type *srch_cr_cleanup_cell_ptr;
  /* Set protector mutex */
  rex_crit_sect_type srchsetutil_crit_sect;
  srch_cell_struct_type *srch_sleep_set[SRCH_TRIAGE_SET_MAX];
  srchsetutil_ext_cntrl_params_mdump_type srchsetutil_ext_cntrl_params_mdump;
}srchsetutil_ext_cntrl_params_type;

extern srchsetutil_ext_cntrl_params_type srchsetutil_ext_cntrl_params[WCDMA_NUM_SUBS];


typedef struct
{
  /* Instantaneous state of all cells in all sets */
  srchset_state_struct_type srchset_db;
  boolean srchsetutil_allocated[NUM_CARR];
  boolean meas_req_processing_in_prog;
  srchsetutil_set_mvmt_log_type *set_mvmt_logging;
  srchsetutil_set_mvmt_buffer_type set_mvmt_buffer;
}srchsetutil_int_cntrl_params_type;
...
typedef enum
{
  SRCHSETUTIL_INTRAF_MVMT,
  SRCHSETUTIL_INTRAF_VARS,
  SRCHSETUTIL_INTERF_MVMT,
  SRCHSETUTIL_INTERF_VARS,
  SRCHSETUTIL_GSM_MVMT,
  SRCHSETUTIL_GSM_VARS,
  SRCHSETUTIL_LTE_VARS,
  SRCHSETUTIL_SET_MVMT_MAX
}srchsetutil_set_mvmt_type;
...
/*===========================================================================
FUNCTION SRCHSETUTIL_EXT_CNTRL_PARAMS_INIT
...
SIDE EFFECTS
    None.
===========================================================================*/
extern void srchsetutil_ext_cntrl_params_init(wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_init(uint8, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_destroy(uint8, wsub_id_e_type wsub_id);
...
=========================================================================*/
void srchsetutil_get_intlock( wsub_id_e_type wsub_id);
...
/*========================================================================= 
  ...
  SIDE EFFECTS
    None 
=========================================================================*/
void srchsetutil_get_intfree( wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_ALLOC
...
srch_cell_struct_type* srchsetutil_alloc(uint8 carr_idx, 
                                         srch_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_interf_cell_struct_type* srchsetutil_alloc_interf(uint8 carr_idx,srch_interf_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_gsm_cell_struct_type* srchsetutil_alloc_gsm(srch_gsm_set_enum_type set, wsub_id_e_type wsub_id);  
...
boolean srchsetutil_move_comp(srch_cell_struct_type* cell_ptr,
                              srch_comp_set_enum_type set, wsub_id_e_type wsub_id);
...
boolean srchsetutil_move_interf(srch_interf_cell_struct_type* cell_ptr,
                                srch_interf_set_enum_type set, wsub_id_e_type wsub_id);                              
...
boolean srchsetutil_move_gsm(srch_gsm_cell_struct_type* cell_ptr,
                             srch_gsm_set_enum_type set, wsub_id_e_type wsub_id);  
...
boolean srchsetutil_move_all(uint8 carr_idx, 
                             ...
                             srch_set_enum_type to_set, wsub_id_e_type wsub_id);
...
boolean srchsetutil_move_all_interf(uint8 carr_idx,srch_interf_set_enum_type from_set, 
                                    srch_interf_set_enum_type to_set, wsub_id_e_type wsub_id);
/*=============================================================================
  FUNCTION
    SRCHSETUTIL_REMOVE
  ...
  SIDE EFFECTS
    None
=============================================================================*/
boolean srchsetutil_remove(srch_cell_struct_type* cell_ptr, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
boolean srchsetutil_remove_interf(srch_interf_cell_struct_type* cell_ptr, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
boolean srchsetutil_remove_gsm(srch_gsm_cell_struct_type* cell_ptr, wsub_id_e_type wsub_id);                                
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_remove_all(uint8 carr_idx, srch_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_remove_all_other_freq(uint8 carr_idx, uint16 freq, uint16 bmsk, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_remove_all_comp(uint8 carr_idx, srch_comp_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_remove_all_interf(uint8 carr_idx, srch_interf_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_remove_all_gsm(srch_gsm_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_set_count(uint8 carr_idx, srch_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_composite_count(uint8 carr_idx, srch_comp_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_interf_count(uint8 carr_idx, srch_interf_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_gsm_count(srch_gsm_set_enum_type set, wsub_id_e_type wsub_id);
...
srch_cell_struct_type* srchsetutil_search(uint8  carr_idx,
                                          uint16 freq, 
                                          uint16 scr_code,
                                          uint16 bmsk, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_gsm_cell_struct_type* srchsetutil_search_gsm(uint16 cell_id, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_cell_struct_type* srchsetutil_get_serving_cell(uint8 carr_idx, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_print(uint8 carr_idx, srch_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_print_comp(uint8 carr_idx, srch_comp_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_print_interf(srch_interf_set_enum_type set, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_print_gsm(srch_gsm_set_enum_type set, wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_interf_cell_struct_type** srchsetutil_get_interf_base_ptr(uint8 carr_idx,srch_interf_set_enum_type set, wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_gsm_cell_struct_type * srchsetutil_get_gsm_cell_from_set(uint16 idx, srch_gsm_set_enum_type  set, wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_gsm_cell_struct_type** srchsetutil_get_gsm_base_ptr(srch_gsm_set_enum_type set, wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint16 srchsetutil_get_set_max(uint8 carr_idx, srch_set_enum_type set, wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint16 srchsetutil_get_comp_set_max(uint8 carr_idx,srch_comp_set_enum_type set, wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_aset_count_c0( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_sync_nset_count_c0( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_uset_count_c0( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_cell_struct_type** srchsetutil_get_base_aset_ptr_c0( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_cell_struct_type** srchsetutil_get_base_sync_nset_ptr_c0( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_cell_struct_type** srchsetutil_get_base_uset_ptr_c0( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_gsm_nset_count( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_interf_sync_nset_count( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
uint8 srchsetutil_get_interf_async_nset_count( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_interf_cell_struct_type** srchsetutil_get_base_interf_sync_nset_ptr( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_interf_cell_struct_type** srchsetutil_get_base_interf_async_nset_ptr( wsub_id_e_type wsub_id);

void srchsetutil_reset_interf_db( wsub_id_e_type wsub_id);
...
/*============================================================================= 
  ...
  SIDE EFFECTS
    None
=============================================================================*/
srch_gsm_cell_struct_type** srchsetutil_get_gsm_pool_ptr( wsub_id_e_type wsub_id);
...
=========================================================================*/
srch_gsm_cell_struct_type*  srchsetutil_find_gsm_cell_by_cell_id(uint16 cell_id , wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
boolean srchsetutil_get_serving_cell_sttd(uint8 carr_idx, wsub_id_e_type wsub_id);
#endif
/*=========================================================================
...
=========================================================================*/
extern void srchsetutil_manage_cell_allocation( wsub_id_e_type wsub_id);
...
=========================================================================*/
extern void srchsetutil_manage_cell_deallocation( wsub_id_e_type wsub_id);
/*=========================================================================
...
=========================================================================*/
extern void srchsetutil_crash_debug( wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
extern uint8 srchsetutil_get_total_cells_in_carr(uint8 carr_idx, wsub_id_e_type wsub_id);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
extern uint8 srchsetutil_find_next_best_set_idx(uint8 set_idx);
...
/*=============================================================================
  ...
  SIDE EFFECTS
    None
=============================================================================*/
extern void srchsetutil_qsh_dump_cb(wl1_srcher_mini_debug_info_struct_type *addr_ptr_t, wsub_id_e_type wsub_id);
#endif
...
boolean srchsetutil_basic_sanity_check(uint8 carr_idx, srch_set_enum_type basic_set,
                                      ...
                                      uint8 bmsk,wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_SET_MEAS_REQ_PROCESSING
_IN_PROG
  
  DESCRIPTION
    This function sets whether meas_req processing is in progress or not
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_set_meas_req_processing_in_prog(boolean meas_req_in_prog,wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_GET_MEAS_REQ_PROCESSING
_IN_PROG
  
  DESCRIPTION
    This function gets whether meas_req processing is in progress or not
  ...
  SIDE EFFECTS
    None
=============================================================================*/
boolean srchsetutil_get_meas_req_processing_in_prog(wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_SAVE_SET_MVMT_VARS
  
  DESCRIPTION
    This function stores the set movment related F3s during MCM processing, which
    will be flushed to log pakcet at the end of MCM processing
...
void srchsetutil_save_set_mvmt_vars(srchsetutil_set_mvmt_type set_mvmt, uint32 *cell_ptr, uint8 set, wsub_id_e_type wsub_id);


/*=============================================================================
  FUNCTION
    SRCHSETUTIL_ALLOC_SET_MVMT_LOG
  
  DESCRIPTION
    This function allocates the memory for log packet buffer
...
void srchsetutil_alloc_set_mvmt_log(wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_DEALLOC_SET_MVMT_LOG
  
  DESCRIPTION
    This function de-allocates the memory for log packet buffer
...
void srchsetutil_dealloc_set_mvmt_log(wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_SAVE_SET_MVMT_LOG_PKT
  
  DESCRIPTION
    This function saves the set_movement log pkt
...
void srchsetutil_save_set_mvmt_log_pkt(uint32 pkt_len, uint8 *log_pkt,wsub_id_e_type wsub_id);

/*=============================================================================
  FUNCTION
    SRCHSETUTIL_FLUSH_SET_MVMT_LOG_PKT
  
  DESCRIPTION
    This function flushes the set_movement log pkt
  ...
  SIDE EFFECTS
    None
=============================================================================*/
void srchsetutil_flush_set_mvmt_log_pkt(wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
  FUNCTION     srchsetutil_qsh_mdump_collect

  DESCRIPTION
  This function dumps all the required parameters from srchsetutil internal and 
  ...
  None
  ===========================================================================*/
extern QSH_MDUMP_FN_ATTR void srchsetutil_qsh_mdump_collect(wsub_id_e_type wsub_id);
