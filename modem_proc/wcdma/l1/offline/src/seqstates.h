...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/seqstates.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
===========================================================================*/
extern void seq_idle_init( wsub_id_e_type wsub_id);

extern boolean seq_idle_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);

/*===========================================================================
         Sequencer Acq State Init and Cleanup Procedures
===========================================================================*/
extern void seq_acq_init( wsub_id_e_type wsub_id);

extern boolean seq_acq_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);
...
extern boolean seq_bch_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);
...
extern boolean seq_pch_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);
...
extern boolean seq_fach_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);
...
extern boolean seq_dch_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);

#ifdef FEATURE_WCDMA_FS_FALSE_PEAK_ELIM_OPT
/*===========================================================================
         Sequencer FS State Init and Cleanup Procedures
===========================================================================*/
extern void seq_fs_init( wsub_id_e_type wsub_id);

extern boolean seq_fs_cleanup( l1m_state_enum_type next_state , wsub_id_e_type wsub_id);
#endif

extern boolean seq_conn_state_cleanup(l1m_state_enum_type next_state, wsub_id_e_type wsub_id);
