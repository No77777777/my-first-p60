...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlpichmgri.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
#define DL_PICH_GET_WSUB_ID_FROM_CFG_DB_IDX(cfg_db_idx)  \
  (dl_pich_cfg_db[cfg_db_idx].wsub_id)
