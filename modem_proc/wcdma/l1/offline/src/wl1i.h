...
/*===========================================================================
  ...
  $PVCSPath:$
  $Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/wl1i.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
===========================================================================*/
void mdsp_disable_and_reset ( wsub_id_e_type wsub_id);
