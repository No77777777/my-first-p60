...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlsccpchmgr.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     ---------------------------------------------------------
01/10/20   ac      Mini dump framework checkin
12/26/16    ta      Added macro to check sccpch channel index valid
...
/*The maximum number of sccpch that has to be managed per sub by sccpch manager at a 
time is 2.*/
#define DL_SCCPCH_CFG_DB_SIZE 4

/* This is the value we use to return an invalid sfn */
#define DL_BMC_INVALID_SFN (-1)

#define DLCHMGR_IS_SCCPCH_CH_SPEC_IDX_INVALID(ch_spec_idx)  \
  ((ch_spec_idx == DLCHMGR_INVALID_CH_SPEC_IDX) || \
   (ch_spec_idx >= DL_SCCPCH_CFG_DB_SIZE))
...
typedef struct {
  ...
  const channel_cb_struct_type *drx_cb_functions;
...
/* Run-time debug flag for extra F3 messages on CTCH block set reception. */
  boolean  dl_bmc_extra_ctch_debug;
  rex_crit_sect_type dl_sccpch_bmc_crit_sect;
}dlsccpchmgr_ext_cntrl_params_type;

extern dlsccpchmgr_ext_cntrl_params_type dlsccpchmgr_ext_cntrl_params[WCDMA_NUM_SUBS];
#endif  /* #ifdef FEATURE_UMTS_BMC */

/*callback functions to be registered with DRX for PCH*/
extern const channel_cb_struct_type  dl_sccpch_pch_drx_cb_functions;

/*callback functions to be registered with DRX for non-CTCH FACH*/
extern const channel_cb_struct_type  dl_sccpch_non_ctch_r99_fach_drx_cb_functions;

/*callback functions to be registered with DRX for CTCH FACH*/
extern const channel_cb_struct_type  dl_sccpch_ctch_r99_fach_drx_cb_functions;
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_sccpch_dealloc_cfg_db_idx(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_post_add_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_pre_drop_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_post_drop_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern mcalwcdma_dec_cctrch_id dl_sccpch_get_cctrch_for_pich( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_sccpch_drx_cmd_rcvd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_pre_resume_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_post_resume_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_pre_suspend_cb(drx_entity_handle_type entity_handle, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern boolean dl_sccpch_post_suspend_cb(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
extern boolean dl_sccpch_is_ok_for_setup(l1_dl_phychan_enum_type phch_type,
  l1_dl_phychan_enum_type drop_dl_phychan, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern drx_entity_handle_type dl_sccpch_get_pcch_drx_hdle( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern dlshmgr_svr_type_enum_type dl_sccpch_get_svr_type(dl_ch_spec_cfg_db_idx_type cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_sccpch_reset_assoc_pich_flag( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
extern void dl_sccpch_set_assoc_pich_flag( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern uint32 dl_bmc_ctch_sccpch_offset( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_is_sccpch_for_ctch_active( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_is_ctch_scheduling_active( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_is_current_ctch_mode_drx_scheduling( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void dl_bmc_teardown_sccpch( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void l1m_cphy_bmc_scheduling_req(l1_ext_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void l1m_cphy_bmc_skip_req(l1_ext_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
...
===========================================================================*/
/* ARGSUSED (lint) */
extern void l1m_cphy_bmc_deactivate_req(l1_ext_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None.
===========================================================================*/
extern int32 dl_bmc_get_extended_sfn_from_sfn(uint16 sfn, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None.
===========================================================================*/
extern uint16 dl_bmc_get_scheduled_sfn_index_between_pich(int32 sfn, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None.
===========================================================================*/
extern uint32 dl_bmc_get_scheduled_sfn_between_pich(uint32 input_extended_sfn, wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION      dl_bmc_is_sfn_priority_sfn

DESCRIPTION
  Function tells whether the particulr extended sfn is Critical/SM/DM
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_is_sfn_priority_sfn(uint32 extended_sfn, wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_sccpch_cphy_setup_has_ctch_drop(l1_setup_cmd_type* setup, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern boolean dl_sccpch_cphy_setup_has_ctch_add(l1_setup_cmd_type* setup, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_keep_ctch_awake( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern uint16 dl_bmc_get_ctch_tti( wsub_id_e_type wsub_id);
/*===========================================================================
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_frame_is_wanted(int32 sfn, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean dl_bmc_is_ctch_schedule_suspended( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void dl_bmc_backup_ctch_sched( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void dl_bmc_restore_ctch_sched( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void dl_bmc_skip_ctch_sfns(l1_ext_cmd_type *cmd_ptr, wsub_id_e_type wsub_id);
#endif  /* #ifdef FEATURE_UMTS_BMC */
...
SIDE EFFECTS
  None.
===========================================================================*/
void dl_bmc_get_ctch_info_for_log_pkt(WCDMA_DRX_CTCH_ENH_LOG_PKT_type *dl_bmc_ctch_enh_log_pkt_ptr, wsub_id_e_type wsub_id);

#ifdef FEATURE_UMTS_BMC_MSIM
/*===========================================================================
FUNCTION     dl_bmc_get_priority

DESCRIPTION
  This function tells whether the current sfn (to be decoded) in NON DRX mode is critical/Schedule/Data
...
SIDE EFFECTS
  None.
===========================================================================*/
extern wcdma_priority_type dl_bmc_get_priority(wsub_id_e_type wsub_id);
#endif

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION        dl_sccpch_qsh_mdump_collect_sub
...
SIDE EFFECTS    None.
===========================================================================*/
QSH_MDUMP_FN_ATTR void  dl_sccpch_qsh_mdump_collect_sub( wsub_id_e_type wsub_id);
#endif
