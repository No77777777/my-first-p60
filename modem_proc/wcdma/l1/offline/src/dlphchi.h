...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlphchi.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     -------------------------------------------------------- 
06/30/15   tsk     FR 26237: DSDS with Rel.8 E-FACH HSRACH + MSIM Changes.
06/23/15   pr      Maintain Sub specific Fast PICH RL Param when DUAL WCDMA is enabled.
...
typedef struct
{
  /* Variable to allow cell cfg one extra frame cfg time */
  uint8 l1_dl_cell_cfg_holdoff;
  dl_phch_stmr_ctr_info_struct_type dl_phch_stmr_ctr_info[DL_PHCH_NUM_STMR_CTRS];
  /* ==========================================================================
** DL PHCH database Variable Definitions
** ========================================================================*/
  stmr_counter_source_enum_type new_stmr_cntr_idx;
  boolean dl_phch_demod_cfg_pending_during_pich_setup;
  mcalwcdma_dl_rl_phychan_parms_struct_type dl_phch_fast_pich_rl_params;
}dlphch_int_cntrl_params_type;
...
extern void dl_phch_recfg_notify(
  ...
  dl_phch_comb_ch_db_handle_type comb_ch_idx, boolean status, wsub_id_e_type wsub_id);
...
void dl_phch_notify(
  ...
  DL_PHCH_CFG_DONE_CB_FUNC_TYPE *cfg_done_cb, wsub_id_e_type wsub_id);
...
boolean dl_phch_update_pend_cfg(
  ...
  boolean fast_cfg, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
boolean dl_phch_copy_pccpch_info(dl_phch_cfg_handle_type phch_cfg_db_idx, uint8 cctrch_idx, wsub_id_e_type wsub_id);
...
dl_phch_cfg_handle_type dl_phch_allocate_cfg_db( wsub_id_e_type wsub_id);
...
dl_phch_rl_handle_type dl_phch_allocate_rl_db( wsub_id_e_type wsub_id);
/*===========================================================================
...
dl_phch_cfg_handle_type dl_phch_allocated_and_add_cfg_db(uint8 num_rl, wsub_id_e_type wsub_id);
/*===========================================================================
...
void dl_phch_deallocate_cfg_db(dl_phch_cfg_handle_type phch_cfg_db_idx, wsub_id_e_type wsub_id);
...
void dl_phch_free_cfg_db(dl_phch_cfg_handle_type phch_cfg_db_idx, wsub_id_e_type wsub_id);
...
void dl_phch_deallocate_rl_db(dl_phch_rl_handle_type rl_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_phch_copy_dpch_rl_info(dl_phch_cfg_handle_type phch_cfg_db_idx, l1_dl_phychan_db_struct_type *phychan_db, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
boolean dl_phch_configure(dl_phch_cfg_handle_type phch_cfg_db_idx,
                                      dl_phch_notify_enum_type operation,
                                      dl_phch_state_enum_type phch_next_state,
                                      DL_PHCH_CFG_DONE_CB_FUNC_TYPE *phch_done_cb_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
void dl_phch_configure_undo(uint32 bmsk, dl_phch_cfg_handle_type phch_cfg_db_idx, wsub_id_e_type wsub_id);
...
extern uint32 dl_phch_update_actions_mask( dl_phch_notify_enum_type operation,
                                            ...
                                            dl_phch_state_enum_type phch_next_state, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_phch_hho_save_phch_params_info( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_phch_suspend_triage_for_phychan_config(dl_phch_cfg_handle_type phch_cfg_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    
===========================================================================*/
extern void dl_phch_handle_cell_status_update(dl_phch_cfg_handle_type phch_cfg_db_idx, boolean status, wsub_id_e_type wsub_id);
...
FUNCTION        dlphch_restart_syncAA_hsrach_qta

FILE NAME       dlphch.c

DESCRIPTION    This function resets the sync state machine for HSRACH after QTA
...
SIDE EFFECTS    None
===========================================================================*/
void dlphch_restart_syncAA_hsrach_qta(wsub_id_e_type wsub_id);
