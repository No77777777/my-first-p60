...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlcellcfg.h#4 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     --------------------------------------------------------- 
01/10/20   ac      Mini dump framework checkin
12/19/19    ss      added an api to check if any cell config is in progress
12/29/17    sl      Wait for ASET cell cfg to complete before proceeding with channel setup- New fix.
02/19/16    sr      Changes to add sub_id in resume database
10/12/15    sr      Changes to double carr_cell_resource_info in dl_cell_info database
09/28/15    sr      Do not post LC for to issue pending cell disable to handle pending call setup
09/09/15    kcm     Enable QXT only during cell configuration after UE wakeup
...
#define DL_CELL_GET_ALLOCATED_CELL_IDX_BMASK(carr_idx) \
    dl_cell_info.carr_cell_resource_info[wsub_id][carr_idx].alloc_cell_idx_bmask

#define DL_CELL_GET_DECFG_DONE_SIG_ENABLED() \
    dlcellcfg_int_cntrl_params[wsub_id].set_signal_after_decfg
...
typedef void (*DL_CELL_CFG_CLIENT_FUNC_CB_PTR)(
  ...
  boolean status, wsub_id_e_type wsub_id);

typedef struct
{
  boolean set_signal_after_decfg;
}dlcellcfg_int_cntrl_params_type;
...
typedef struct
{
  ...
  /*Sub_id that the cell is part of*/
  wsub_id_e_type cell_sub_id;
...
typedef struct
{
  /** struct containing the per carrier cell idx information */
   dl_cell_per_carr_cell_resource_struct_type carr_cell_resource_info[WCDMA_NUM_SUBS][WL1_MAX_NUM_CARRIER_IDX];
  ...
  /*Bmsk of active cells on each sub*/
  uint16 active_cell_bmsk_per_sub[WCDMA_NUM_SUBS];
...
#define DL_TRIAGE_SET_LOCK()    srchsetutil_get_intlock(wsub_id)
#define DL_TRIAGE_SET_UNLOCK()  srchsetutil_get_intfree(wsub_id)
...
SIDE EFFECTS
  cell db is changed
===========================================================================*/
extern uint16 dl_get_psc_for_cell_db_idx(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  cell db is changed
===========================================================================*/
extern uint16 dl_get_freq_for_cell_db_idx(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_init_cell_info( wsub_id_e_type wsub_id);
...
extern void dl_clear_cell_info(
  /** cell db index */
  uint8 cell_db_index, wsub_id_e_type wsub_id);
...
extern uint8 dl_get_cell_db_index(
  ...
  uint16 psc,
  /**frequency   */
  uint16 frequency, wsub_id_e_type wsub_id);
...
extern boolean dl_cell_configure_cells(
  ...
  dl_cell_cfg_client_input_struct_type *cell_cfg_client_input, wsub_id_e_type wsub_id);
...
extern boolean dl_cell_configure(
  ...
  uint16 cell_db_idx,
  /** srch set struct ptr */
  srch_cell_struct_type *srch_cell_ptr, wsub_id_e_type wsub_id);
...
extern boolean dl_cell_update_cell_config(
  ...
  uint16 cell_db_idx, 
	/** fing idx */
	uint16 ref_fing_idx, wsub_id_e_type wsub_id);
...
extern boolean dl_cell_handle_ref_finger_change(
  ...
  uint8 *new_ref_finger, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 dl_cell_get_active_cell_mask( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_get_cell_config_on_prog_status(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_get_cell_config_on_prog_for_triage(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 dl_cell_get_cell_configured_status(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 dl_cell_get_cell_config_status(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_is_any_cell_under_config(uint16 cell_idx_bmsk, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_cell_notify_clients_of_cell_cfg(uint16 cell_bmsk, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_cell_handle_tddet_complete(uint16 detected_td_bmsk, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 dl_cell_get_detected_td_val(uint8 cell_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_is_cell_going_inactive(uint8 cell_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_is_cell_under_decfg(uint8 cell_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint32 dl_cell_check_for_ongoing_td_detection(uint16 cell_bmsk, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern srch_cell_struct_type* dl_get_cell_ptr_for_cell_db_idx(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint32 dl_cell_get_ssc_status(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
extern uint32 dl_cell_get_scpich_status(
  ...
  uint8 cell_db_idx, 
  /** mimo mode */
  dl_cell_scpich_mimo_mode mode, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
    ...
    cells exist.
===========================================================================*/
extern void dl_cell_add_to_triage_set(srch_cell_struct_type *cell_ptr, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_cell_remove_from_triage_set(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
   None
===========================================================================*/
extern void dl_cell_clear_triage_set( dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
   None
===========================================================================*/
extern void dl_cell_restore_triage_set(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
   None
===========================================================================*/
extern void dl_cell_print_cells_in_triage_set(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void dl_cell_update_triage_set_with_interf_cell(srch_cell_struct_type *cell_ptr, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_is_any_available_non_primary_empty_cell( wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void dl_cell_control_cell_config_concurrency(boolean grab_mutex, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern uint8 dl_cell_get_ref_fing_from_cell_dbase(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern dl_cell_update_reason_enum_type dl_cell_get_cell_update_reason(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_get_cellcfgd_cellrecfg_with_ref_fing_change_status(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
extern boolean dl_cell_check_fast_decfg_in_progress(uint16 cell_cfg_done_bmsk, wsub_id_e_type wsub_id);
...
extern boolean dl_cell_get_fast_cell_decfg_status(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
extern void dl_cell_fast_cell_decfg_post_ops(uint16 cell_done_bmsk, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_fast_cell_disable(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
extern void dl_cell_process_fast_cell_fing_deconfig_ops(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
extern void dl_cell_sanity_check_bef_sleep( wsub_id_e_type wsub_id);
...
extern void dl_cell_enable_dbg_msgs(boolean enable, wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
 ===========================================================================*/
extern void dl_set_dl_cell_cfg_nv_values( wsub_id_e_type wsub_id);
...
/*=========================================================================
 ...
 SIDE EFFECTS : 
==========================================================================*/
extern boolean dl_cell_get_combined_txd_status(uint8 carr_idx, wsub_id_e_type wsub_id);
...
/*=========================================================================
 ...
 SIDE EFFECTS : 
==========================================================================*/
extern void dl_cell_check_tddet_status_interrupt_handler( wsub_id_e_type wsub_id);
...
extern void dl_cell_update_shadow_cell_interrupt_handler( wsub_id_e_type wsub_id);
...
extern uint8 dl_cell_get_aset_cell_cnt(uint8 car_cnt, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern uint8 dl_cell_get_carr_idx_from_fing(uint8 fing_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern dl_tri_carr_id_enum_type dl_cell_get_carr_idx_from_cell_db_idx(uint8 cell_db_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_cell_cfg_perform_dsd_for_txd_det( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_cell_handle_status_dump_done_for_ongoing_txd_det( wsub_id_e_type wsub_id);
...
===========================================================================*/
extern void  dl_cell_fast_deconfigure_all_cells( wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION dl_cell_get_alloc_cell_id_bmsk

DESCRIPTION
  This function will return allocated cell id bmask for a specific carrier

DEPENDENCIES


RETURN VALUE  cell id bmask

SIDE EFFECTS

===========================================================================*/
extern uint16 dl_cell_get_alloc_cell_id_bmsk(dl_tri_carr_id_enum_type carr_idx, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION dl_cell_get_sch_tstd_status

DESCRIPTION
  This function will return cell SCH TSTD enabled status
...
===========================================================================*/
extern boolean dl_cell_get_sch_tstd_status(uint8 cell_idx, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void dl_cell_update_shadow_cell_info( wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION dl_init_cell_sub_info

DESCRIPTION
  This function will perform a sub specific init of dl cell databases.
...
===========================================================================*/
extern void dl_init_cell_sub_info(uint16 dl_init_mask, wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION dl_cell_get_cell_mask_for_sub

DESCRIPTION
  This function will return the active cell bitmask for the specific sub

DEPENDENCIES


RETURN VALUE  sub specific cell bmsk

SIDE EFFECTS

===========================================================================*/
extern uint16 dl_cell_get_cell_mask_for_sub(wsub_id_e_type wsub_id);
/*===========================================================================
FUNCTION dl_init_one_time_cell_info

DESCRIPTION
  This function will perform the one time init of the dl cell info params
...
===========================================================================*/
extern void dl_init_one_time_cell_info(void);

/*===========================================================================
FUNCTION dl_cell_get_subid_from_cell_idx

DESCRIPTION
  This function returns subid for the cell id passed.
  
DEPENDENCIES
  None
RETURN VALUE
  wsub_id_e_type subid
  
SIDE EFFECTS
  None
===========================================================================*/
extern wsub_id_e_type dl_cell_get_subid_from_cell_idx(uint8 cell_db_idx, wsub_id_e_type wsub_id);

/*=========================================================================
 FUNCTION     : dl_cell_get_total_cell_cnt
 
 DESCRIPTION  : This function returns the total cell count which will be the total number of cells that are not inactive for the requested carrier
 DEPENDENCIES : 
 ...
 SIDE EFFECTS : 
==========================================================================*/
extern uint8 dl_cell_get_total_cell_cnt(uint8 carr_idx ,wsub_id_e_type wsub_id);

/*=========================================================================
 FUNCTION     : dl_cell_get_total_cell_cnt
 
 DESCRIPTION  : This function will trigger cell deconfig and waits for a signal which will be set after cell cfg done isr is received.
 ...
 SIDE EFFECTS : 
==========================================================================*/
extern void dl_cell_decfg_cells_during_sleep(wsub_id_e_type wsub_id);

/*=========================================================================
 FUNCTION     : dl_cell_get_decfg_done_signal_enabled_status
 
 DESCRIPTION  : This function retuns TRUE if handle pending call setup is 
                waiting for cell decfg done.
 ...
 SIDE EFFECTS : None
==========================================================================*/
extern boolean dl_cell_get_decfg_done_signal_enabled_status(wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION dl_cell_get_cell_enabled_status_from_fw

DESCRIPTION
  This function returns checks the FW/SW interface and returns 
  TRUE or FALSE based on the cell enabled status
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_get_cell_enabled_status_from_fw(uint16 cell_db_idx, wsub_id_e_type wsub_id);
...
/*===========================================================================
FUNCTION dl_cell_is_waiting_on_fing_for_config
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_is_waiting_on_fing_for_config(uint16 cell_bmsk, wsub_id_e_type wsub_id);

/*===========================================================================
FUNCTION dl_cell_is_cell_cfg_in_prog

DESCRIPTION
  This function returns true if any active cell is in progress.
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean dl_cell_is_cell_cfg_in_prog(wsub_id_e_type wsub_id);

#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION        dl_cell_qsh_mdump_collect_sub
...
SIDE EFFECTS    None.
===========================================================================*/
QSH_MDUMP_FN_ATTR void  dl_cell_qsh_mdump_collect(void);

QSH_MDUMP_FN_ATTR void  dl_cell_qsh_mdump_collect_sub(wsub_id_e_type wsub_id);
