...
$Header: //components/rel/wcdma.mpss/8.4.0/l1/offline/src/dlnschmgri.h#3 $ $DateTime: 2020/01/22 08:56:27 $ $Author: pwbldsvc $
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dl_nsch_aich_copy_misc_info(l1_aich_parms_struct_type *aich_db, wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None
===========================================================================*/
LOCAL void dl_nsch_write_aich_info_to_mdsp( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
LOCAL void dl_nsch_resume_ch_setup_after_dsd( wsub_id_e_type wsub_id);
...
SIDE EFFECTS    None.
===========================================================================*/
LOCAL dl_ch_spec_cfg_db_idx_type dl_nsch_get_cfg_db_idx(dlchmgr_cfg_db_idx_type chmgr_cfg_db_idx, wsub_id_e_type wsub_id);
