...
$Header: //components/rel/wcdma.mpss/8.4.0/l2/inc/l2ultask.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
#define   L2_UL_CMD_Q_SIG                           0x00000001

/* This segnal is set to request UL MAC HFN */
#define   CMAC_UL_HFN_REQ_SIG                       0x00000002

/*This signal is set to indicate RACH Tx Status */
#define   MAC_UL_TX_STATUS_IND_SIG                  0x00000004

/* RLC AM RESET REQUEST.  */
#define   RLC_AM_RESET_REQUEST_SIG                  0x00000010

/* RLC AM UL RESET DONE.  */
#define   RLC_AM_UL_RESET_DONE_SIG                  0x00000020

/* RLC AM UL SDU tx Confirmation */
#define   RLC_AM_UL_SDU_TX_CNF_SIG                  0x00000040
#define   RLC_UL_FC_SIG                             0x00000080
#define   RLC_UL_FC_TIMER_SIG                       0x00000100

#ifdef FEATURE_DOG
/* L2 UL watchdog report timer timed out sig. */
#define   L2_UL_DOG_RPT_TIMER_SIG                   0x00000200
#endif

/* Report RLC RESET to RRC  */
#define   RLC_UL_RESET_REPORT_SIG                   0x00000400

/* RLC UL posts RESET messages to RLC DL  */
#define   RLC_UL_POST_DL_RESET_SIG                  0x00000800

/* Called when the qxdm timer expires. Time to report the statistics to qxdm*/
#ifdef FEATURE_RLC_QXDM_LOGGING
#define   RLC_UL_AM_LOG_TIMER_EXP_SIG               0x00001000
#endif

/* This signal is set when the 10ms timer expires */
#define   MAC_UL_TVM_EVENT_TMR_EXP_SIG              0x00002000

/* Thi signal is set by L1 to indicate to MAC to start using the new config parameters*/
/* received from RRC */
#define   MAC_PHY_UL_CONFIG_IND                     0x00004000
#define   MAC_UL_TFCS_CONTROL_TMR_EXP_SIG           0x00008000

/* This signal is set when l2_get_nv function returns with nv release flag */
#define   L2_NV_CMD_SIG                             0x00010000

#ifdef FEATURE_RLC_QXDM_LOGGING
#define   RLC_UL_START_LOGGING_SIG                  0x00020000
#endif
...
#define   MAC_HS_UL_SI_NO_GRANT_TMR_EXP_SIG         0x00040000

/* RLC AM RESET STATUS TIMER REQUEST.  */
#define   MAC_HS_UL_SI_GRANT_TMR_EXP_SIG            0x00800000

#define   RLC_UL_AM_BASE_TIMER_SIG                  0x02000000
#endif
...
#define MAC_UL_TVM_PERIODIC_TMR_EXP_SIG             0x04000000

#ifdef FEATURE_WCDMA_NEW_L2_INTERFACE
/* This signal is set when an item is placed on wcdma_l2_ul_cmd_q */
#define   WCDMA_L2_UL_CMD_Q_SIG                     0x08000000
#endif

#ifdef FEATURE_WCDMA_DC_HSUPA
#define  MAC_HS_UL_SECONDARY_SI_NO_GRANT_TMR_EXPIRED_SIG  0x10000000
#define  MAC_HS_UL_SECONDARY_SI_GRANT_TMR_EXPIRED_SIG   0x20000000
#endif

#ifdef FEATURE_DATA_RAVE_SUPPORT 
#define   MAC_HS_UL_RAVE_TMR_EXPIRED_SIG            0x40000000
#endif
...
#define WL2_FEATURE_FLAG_NV_EVT_6D_OPT_MASK   3
#define WL2_ENABLE_IGNORE_RESET_FAIL 0x8
/*===========================================================================
...
typedef struct
{
  ...
  l2_nv_rel_indicator_e_type  l2_nv_rel_indicator;

  uint32 wl2_feature_flg;
...
FUNCTION l2_get_feature_flag_nv

DESCRIPTION
  This  function returns the L2 feature flag.
...
/*===========================================================================
 ...
 SIDE EFFECTS
   An assertion will fail if the lookup fails.
===========================================================================*/
rex_tcb_type* wcdma_l2_ul_get_tcb(sys_modem_as_id_e_type as_id);
