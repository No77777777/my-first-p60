...
$Header: //components/rel/wcdma.mpss/8.4.0/common/inc/wnv.h#10 $
...
05/25/15    sp      NV changes to control l2 ack wait timer during reselection
...
typedef enum 
{
  ...
  WNV_CONF_ID_SRCH_NEG_FREQ_HYPO = 10,  /* WL1 searcher */
  ...
  WNV_CONF_ID_L2                = 23,     /* WL2 NV */
  /* !!! END OF CONF_ID AUTOGEN !!! */
...
typedef enum
{
  ...
  WNV_ID_SRCH_NEG_FREQ_HYPO                              = 34,  /* NV 74097*/
  /* L1 MULTISIM */
  WNV_ID_L1_MULTISIM_W2G_TUNEAWAY                        = 35,  /* NV 67244 */
  WNV_ID_L1_QTA_ROTA                                     = 36,  /* NV 72562 */

  /* L1 DSR */
  WNV_ID_L1_DSR                                          = 37,  /* NV 67250 */

  /* L1 ATUNER */
  WNV_ID_L1_ATUNER                                       = 38,  /* NV 71551 */

  /* L1 DC W2L */
  WNV_ID_L1_DC_W2L                                       = 39,  /* NV 69690 */

  /* L1 IDLE MODE */
  WNV_ID_L1_IDLE_MODE_OPT                                = 40,  /* NV 69733 */
  WNV_ID_L1_IDLE_DEBUG                                   = 41,  /* NV 72595 */

  /* L1 MDSP RECOVERY */
  WNV_ID_L1_MDSP_RECOVERY                                = 42, /* NV 73560 */
  ...
  WNV_ID_RRC_DISABLE_CRASH_DEBUG_INFO                    = 48,  /* NV 72515 */
  ...
  WNV_ID_RRC_FREQ_SKIP_RANGE_NV                          = 85,  /* NV 73617 */
  WNV_ID_ENABLE_TA_FOR_CS_DATACALL_NV                    = 86,  /* NV 73641 */
  WNV_ID_RRC_NV_ENABLE_READ_SIBS_FOR_RESEL               = 87,  /* NV 73649 */
  WNV_ID_RRC_HALF_DRX_LEN                                = 88,  /* NV 73619 */
  WNV_ID_L2_FEATURE_FLAG_NV                              = 89,  /* NV 73667 */
  WNV_ID_SRP_CQI_BOOSTING_CONTROL                        = 90,  /* NV 73647 For FR23414 CQI enhancement */
  WNV_ID_L1_UL_FEATURE_BITMASK                           = 91,  /* NV 73726 */
  WNV_ID_RRC_CHANGE_TRM_PRIORITY_TMR_NV                  = 92,  /* NV 73730 */
  WNV_ID_L1_WCDMA_TA_CONFIG                              = 93,  /* NV 73733 */
  WNV_ID_RRC_NV_DEFER_RESEL_TIMER_FOR_L2_ACK             = 94,  /* NV 73687 */
  WNV_ID_L1_ANT_SWITCH_UL_DL_IMBALANCE                   = 95,  /* NV 73757 */
  WNV_ID_RRC_MSIM_DB_DC_BAND_COMB_NV_CONTROL             = 96,  /* NV 73767 */
  WNV_ID_RRC_PSUEDO_SIB19                                = 97,  /* NV 73818 */
  WNV_ID_RRC_MSIM_OPTIMIZATIONS                          = 98,  /* NV 73858 */
  WNV_ID_RRC_BAND66_PLMN_SUPPORT                         = 99,  /* NV 73911 */
  WNV_ID_RRC_GSM_FALLBACK_INFO                           = 100,  /* NV 73949 */
  WNV_ID_MODEM_LOG_UTIL_NV                               = 101, /* NV 73993 */
  WNV_ID_ALLOW_LTA_TIME_NV                               = 102, /* NV 73891 */
  WNV_ID_RRC_CELL_BAR_UPON_RACH_FAILURE_NV               = 103, /* NV 74056 */
  WNV_ID_RRC_CELL_BAR_DURATION_SECS_NV                   = 104, /* NV 74057 */
  WNV_ID_RRC_SUPPORT_LTA                                 = 105, /* NV 73774*/
  WNV_ID_RRC_BUFFER_SMC_SUPPORT                           = 106,  /* NV 73892 */
  WNV_ID_RRC_NV_ENABLE_READ_SIBS                         = 107,  /* NV 74109*/
  WNV_ID_L1_FORCE_SC_CAPABILITY                          = 108,  /* NV 74092 */
  WNV_ID_RRC_NV_REQ_LTE_FOR_TRUNCATED_CA                 = 109, /* NV 73936 */
  WNV_ID_RRC_NV_REQ_LTE_FOR_TRUNCATED_CA_ON_MCC_LIST     = 110, /* NV 73937 */
  WNV_ID_RRC_REDIRECT_TO_LTE_AFTER_SRVCC_NV              = 111, /*NV 74181*/
  WNV_ID_RRC_PSEUDO_MEAS_INFO_NV                         = 112, /*NV 74197*/
  WNV_ID_RRC_PSEUDO_MEAS_RXAGC_NV                        = 113, /*NV 74198*/
  WNV_ID_RRC_PSEUDO_MEAS_TRIGGERS_NV                     = 114, /*NV 74199*/
  WNV_ID_RRC_PSEUDO_MEAS_RSRP_RSRQ_NV                    = 115, /**/
  WNV_ID_RRC_PSEUDO_MEAS_FORBIDDEN_EARFCN_TIMER_NV       = 116, /*NV 74273*/
  WNV_ID_WCDMA_RRC_DELAY_RETURN_TO_LTE_NV                = 117,  /*NV 74319*/
  WNV_ID_WCDMA_RRC_FAST_RETURN_TO_LTE_AFTER_CSFB_SS      = 118,/*NV 74254*/
  WNV_ID_RRC_NV_BLOCK_FRLTE_ON_PLMN_LIST                 = 119,
  WNV_ID_RRC_PSEUDO_MEAS_DEFER_TMR_VALUE_FIRST_TIME_IN_DCH_NV   = 120,  /*NV 74371*/
  WNV_ID_L1_IDLE_WCDMA_PLMN_LIST_NV                      = 121, /*NV 74569*/
  WNV_ID_RRC_ENABLE_HI_ACCESS_CLASS_NV                   = 122, /*NV 74393*/
  /* !!! END OF NV_ID AUTOGEN !!! */
  WNV_ID_EFS_COUNT,
...
/*************************************************************************** 
                          Exported macros
****************************************************************************/
/* Default value of Modem log util task NV */
#define MODEM_LOG_UTIL_NV_STATUS 1
