...
Copyright (c) 2002-2003, 2005-2006, 2008-2009 Qualcomm Technologies, Incorporated.  
All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/wcdma.mpss/8.4.0/mac/src/macdllog.c#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
)
{
 ...
 uint8 no_Logical_fach=0;
  ...
  dl_cfg_ptr = (WCDMA_DL_MAC_CFG_LOG_PACKET_type *)wcdma_log_alloc(WCDMA_DL_MAC_CFG_LOG_PACKET,
                              MAC_DL_CFG_PACKET_LEN(num_trch, num_logchan), dl_table_ptr->as_id );
  ...
  {
    WL2_MSG_2(LOW, dl_table_ptr, "Dropped 0x%x, code enabled: %d\n",
