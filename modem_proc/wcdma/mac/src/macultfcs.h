...
Copyright (c) 2004-2005, 2008-2009 by Qualcomm Technologies Incorporated.  All Rights Reserved.
...
$Header: //components/rel/wcdma.mpss/8.4.0/mac/src/macultfcs.h#2 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
(
    ...
    mac_ul_tfcs_type        *tfcs_ptr, mac_ul_table_type *ul_table_ptr
);
...
(
  const boolean *tfc_excess_pwr_state_ptr, mac_ul_table_type *ul_table_ptr
);
...
================================================================================================*/
void mac_ul_assign_pdu_size(mac_ul_table_type *ul_table_ptr);
...
(
  amr_trch_mapping_info_type *amr_trch_mapping, mac_ul_table_type *ul_table_ptr
);
#endif
...
================================================================================================*/
uint8 mac_calculate_constant_delay(l1_tti_enum_type tti_type, mac_ul_table_type *ul_table_ptr);
#endif
...
void eliminate_tfc_based_on_ue_tx_pwr(mac_ul_table_type *ul_table_ptr);
#endif
...
====================================================================================================*/
void eliminate_tfc_based_on_cm(mac_ul_table_type *ul_table_ptr);
#endif
...
(
/* Pointer to UL RLC Frame Format information */
rlc_ul_frame_format_type   *rlc_frame_fmt_ptr, mac_ul_table_type *ul_table_ptr
);
...
================================================================================================*/
boolean     pick_tfc_with_highest_bo (mac_ul_table_type *ul_table_ptr);
...
================================================================================================*/
uint8 eliminate_tfc_based_on_active_trchs (mac_ul_table_type *ul_table_ptr);
