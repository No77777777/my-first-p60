...
$Header: //components/rel/wcdma.mpss/8.4.0/mac/inc/macrrcif_v.h#2 $  $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
--------------------------------------------------------------------*/
boolean
mac_get_additional_traffic_vol_msmt_results(sys_modem_as_id_e_type as_id, uint16 meas_id, mac_ul_traffic_meas_ind_type *);
...
uint32
rrc_get_start_value_to_transmit(sys_modem_as_id_e_type as_id);
...
boolean rrc_get_gcf_flag_status(sys_modem_as_id_e_type as_id);
...
SIDE EFFECTS
  None
--------------------------------------------------------------------*/
boolean mac_is_hs_cfg_active(sys_modem_as_id_e_type as_id);
