...
$Header: //components/rel/wcdma.mpss/8.4.0/api/log_codes_wcdma_int.h#3 $
...
04/06/16   nr      Adding log packet for hanging RB 
03/31/16   zt      Support for new log pkt 0x41CF
03/29/16   ac      Add 0x41DF log packet for DL rate estimation
...
05/30/15   jk      Added new log packet for Traffic-to-Pilot Ratio 
...
03/03/15   cc      New energy to EcIo formula for interF step1 0x41C6 and PN 0x417A
...
#define L1_WCDMA_X2W_STEP1_0x41D7_LOG_PKT                (LOG_WCDMA_BASE_C + 0x1D7)
#define L1_WCDMA_X2W_NASTT_0x41D8_LOG_PKT                (LOG_WCDMA_BASE_C + 0x1D8)
#define L1_WCDMA_X2W_LIST_0x41D9_LOG_PKT                 (LOG_WCDMA_BASE_C + 0x1D9)
#define L1_WCDMA_W2G_GAP_0x41DC_LOG_PKT                  (LOG_WCDMA_BASE_C + 0x1DC)
#define L1_WCDMA_W2G_MEAS_0x41DD_LOG_PKT                 (LOG_WCDMA_BASE_C + 0x1DD)
...
#define HS_SRP_CQI_BOOSTING_0x41CD_LOG_PKT               (LOG_WCDMA_BASE_C + 0x1CD)
#define HS_SRP_CQI_BOOSTING_0x41D2_LOG_PKT               (LOG_WCDMA_BASE_C + 0x1D2)
#define HS_AOL_0x41D6_LOG_PKT                            (LOG_WCDMA_BASE_C + 0x1D6)
#define WL1_DPCH_DEMOD_ENH_LOG_PKT                       (LOG_WCDMA_BASE_C + 0x1D0)
#define WCDMA_DL_TPR_LOG_PACKET                          (LOG_WCDMA_BASE_C + 0x1D1)
#define WCDMA_TIMELINE_CHECKS_LOG_PACKET                 (LOG_WCDMA_BASE_C + 0x1C4)
#define WCDMA_IDLE_MEAS_LOG_PACKET                       (LOG_WCDMA_BASE_C + 0x1CF)
#define WSRCH_SET_MOVEMENT_LOG_PACKET                    (LOG_WCDMA_BASE_C + 0x1DE)
#define WCDMA_DL_RATE_ESTIMATION_LOG_PKT                 (LOG_WCDMA_BASE_C + 0x1DF)
#define SRCH_FACH_FRM_LOG_PKT                            (LOG_WCDMA_BASE_C + 0x1DB)

#define WCDMA_PHY_LAYER_POWER_LOG_PACKET                   (LOG_1X_BASE_C + 0x87B)
...
#define WCDMA_DL_RLC_AM_USR_PLANE_PDU_LOG_PACKET         (LOG_WCDMA_BASE_C + 0x134)
...
#define WCDMA_UL_RLC_AM_STATUS_PDU_LOG_PACKET            (LOG_WCDMA_BASE_C + 0x145)   
...
#define WCDMA_DL_FLEXIBLE_RLC_PDU_LOG_PACKET_V1          (LOG_WCDMA_BASE_C + 0x18B)
...
#define WCDMA_UL_FIXED_AM_SIG_PDU_LOG_PACKET_V1          (LOG_WCDMA_BASE_C + 0x1D3) 
#define WCDMA_UL_FIXED_AM_USR_PDU_LOG_PACKET_V1          (LOG_WCDMA_BASE_C + 0x1D4)
#define WCMDA_UL_FIXED_UM_PDU_LOG_PACKET_V1              (LOG_WCDMA_BASE_C + 0x1D5)
...
#define WCDMA_BCH_SIGNALLING_MESSAGE                     (LOG_WCDMA_BASE_C + 0x12f)   /*Same log id for BCH messages*/
...
#define WCDMA_SRCH_REQ_INFO                              (LOG_WCDMA_BASE_C + 0x800)
#define WCDMA_BAND_SCAN_INFO                             (LOG_WCDMA_BASE_C + 0x801)
#define WCDMA_ACQDB_NEW_INFO                             (LOG_WCDMA_BASE_C + 0x802)
#define WCDMA_SRCH_CNF_INFO                              (LOG_WCDMA_BASE_C + 0x803)
