...
$Header: //components/rel/wcdma.mpss/8.4.0/api/wcdma_common_api.h#5 $
...
typedef enum
{
  ...
  WCDMA_RELEASE_11,
  WCDMA_RELEASE_12
}wcdma_rrc_release_version_e_type;
...
typedef enum
{  
  WL1_W2W_GAP_DATA_Q6 =1,                                    
  WL1_W2W_GAP_VOICE_Q6,                                 
  WL1_W2W_IDLE_Q6,                                      
  WL1_W2G_GAP_DATA_Q6,                                  
  WL1_W2G_GAP_VOICE_Q6,                                 
  WL1_W2G_IDLE_Q6,                                     
  WL1_W2L_GAP_DATA_Q6,                                  
  WL1_W2L_GAP_VOICE_Q6,                                 
  WL1_W2L_IDLE_Q6,                                      
  WL1_DC_ASET_CELLS_OR_QSET_CELLS_GREATER_1_Q6,         
  WL1_DC_ASET_CELLS_OR_QSET_CELLS_GREATER_2_Q6,         
  WL1_IRAT_IHO_Q6,                                      
  WL1_RESUME_DS_TA_WITH_LTA_OPTS_Q6,                    
  WL1_QICE_Q6,                                          
  WL1_CONNECTED_TO_IDLE_Q6,
  WL1_FBRX_HS_OFFSET_1_9_Q6,
  WMCVS_Q6BCLK_REL_0,                                   
  WMCVS_Q6BCLK_LOW_SVS_0,                               
  WMCVS_Q6BCLK_LOW_SVS_1,                               
  WMCVS_Q6BCLK_LOW_SVS_2,                               
  WMCVS_Q6BCLK_LOW_SVS_3,                               
  WMCVS_Q6BCLK_LOW_SVS_4,                              
  WMCVS_Q6BCLK_LOW_SVS_5,                               
  WMCVS_Q6BCLK_LOW_SVS_6,                               
  WMCVS_Q6BCLK_SVS_2,                                   
  WMCVS_Q6BCLK_SVS_4,                                   
  WMCVS_Q6BCLK_SVS_3,                                   
  WMCVS_Q6BCLK_SVS_5,                                   
  ...
  WMCVS_Q6BCLK_SVS_10,                                  
  WMCVS_Q6BCLK_SVS_12,                                  
  WMCVS_Q6BCLK_SVS_PLUS_9,                              
  WMCVS_Q6BCLK_SVS_PLUS_10,                             
  WMCVS_Q6BCLK_SVS_PLUS_11,                             
  WMCVS_Q6BCLK_SVS_PLUS_12,                             
  WMCVS_Q6BCLK_SVS_PLUS_13,                             
  WMCVS_Q6BCLK_NOM_12,                                  
  WMCVS_Q6BCLK_NOM_13,                                  
  WMCVS_Q6BCLK_NOM_14,                                  
  WMCVS_Q6BCLK_NOM_15,                                  
  WMCVS_Q6BCLK_NOM_16,                                  
  WMCVS_Q6BCLK_NOM_19,                                  
  WMCVS_Q6BCLK_NOM_PLUS_16,                             
  WMCVS_Q6BCLK_NOM_PLUS_17,                             
  WMCVS_Q6BCLK_NOM_PLUS_21,                             
  WMCVS_Q6BCLK_TURBO_23,                                
  WL1_END_Q6                                          
}wl1_q6_q6B_scenarios;
...
===========================================================================*/
extern wcdma_signal_info_struct_type* wcdma_get_signal_info( wsub_id_e_type wsub_id );
...
SIDE EFFECTS
  None
===========================================================================*/
void rxd_wcdma_oride_rxdiversity_for_ps_data(boolean disable, wsub_id_e_type wsub_id );
...
===========================================================================*/
void wcdma_get_rat_meas_info(cmapi_wcdma_signal_info_struct_type* wcdma_signal_info , wsub_id_e_type wsub_id);
