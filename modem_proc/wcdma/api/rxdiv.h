...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rxdiv.h#3 $
...
===========================================================================*/
extern void rxd_rscp_meas_thresh_update(uint8 rscp_value, wsub_id_e_type wsub_id );
...
SIDE EFFECTS
  None
===========================================================================*/
void rxd_qual_meas_thresh_update(uint16 bler_percentage, wsub_id_e_type wsub_id );
...
SIDE EFFECTS
  None
===========================================================================*/
void rxd_update_fullload_cpich_ior_ratio(int8 min_cpich_to_ior_ratio_db4, wsub_id_e_type wsub_id );
...
===========================================================================*/
extern void rxd_temporary_disable(uint8 time_in_sec, wsub_id_e_type wsub_id );
#endif /* ifdef RXDIV_H */
