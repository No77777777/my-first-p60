...
$Header: //components/rel/wcdma.mpss/8.4.0/api/wcdma_rrc_api.h#3 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
FUNCTION          WCDMA_RRC_GET_BAND_FROM_DL_ARFCN_SUB
...
===========================================================================*/
uint8 wcdma_rrc_get_wcsg_lfp_info_sub
(
  sys_modem_as_id_e_type wrrc_as_id,
  const source_cell_info_type *l_macro_ptr, 
  source_cell_info_type *w_csg_cells_ptr
...
FUNCTION          WCDMA_MFBI_IS_SUPPORTED_SUB
...
===========================================================================*/
boolean wcdma_mfbi_is_supported_sub(sys_modem_as_id_e_type wrrc_as_id);
