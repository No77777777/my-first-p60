...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rrc_rr_types.h#4 $   

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/13/17   ha      FR42544 MPLMN periodic scan search
09/08/15   sas     New flag is added in the RRC-RR interface to indicate if the redirected call from W is MO/MT CS.
...
#define rrc_rr_cmd_e_type_value0x15 RRC_INTERRAT_REDIRECT_REJ,
#define rrc_rr_cmd_e_type_value0x16 RRC_INTERRAT_REDIRECT_ABORT_CNF,
#define rrc_rr_cmd_e_type_value0x17 RRC_RR_STOP_WCDMA_CNF,
#define rrc_rr_cmd_e_type_value0x18 RR_RRC_STOP_GSM_REQ,
#define rrc_rr_cmd_e_type_value0x19 RR_DEDICATED_PRIORITIES_REQ,
#define rrc_rr_cmd_e_type_value0x1a RRC_DEDICATED_PRIORITIES_RSP,
#define rrc_rr_cmd_e_type_value0x1b RR_CLEAR_DEDICATED_PRIORITIES_IND,
#define rrc_rr_cmd_e_type_value0x1c RRC_CIPHER_SYNC_IND,
...
#define rrc_rr_cmd_e_type_value0x7000016 RRC_INTERRAT_REDIRECT_REQ
#define rrc_rr_cmd_e_type_value0x7000017 RRC_INTERRAT_REDIRECT_ABORT_REQ
#define rrc_rr_cmd_e_type_value0x7000018 RRC_RR_STOP_WCDMA_REQ
#define rrc_rr_cmd_e_type_value0x7000019 RR_RRC_STOP_GSM_CNF
#define rrc_rr_cmd_e_type_value0x700001a RRC_DEDICATED_PRIORITIES_REQ
#define rrc_rr_cmd_e_type_value0x700001b RR_DEDICATED_PRIORITIES_RSP
#define rrc_rr_cmd_e_type_value0x700001c RRC_CLEAR_DEDICATED_PRIORITIES_IND
...
typedef struct
{
  ...
  /*GTOW arfcn list for periodic frequency search */
  sys_arfcn_list_s_type  gtow_arfcn_list;

  /*priority for periodic frequency search*/
  sys_srch_priority_e_type  search_priority;

  /*preferred plmn list for periodic scan search*/
...
typedef struct
{
  ...
  boolean hplmn_found;
  /*TRUE if preferred PLMN found else otherwise*/
...
{
  RRC_RR_CAUSE_NONE,
  RRC_RR_CAUSE_MO_CS_CALL,
  RRC_RR_CAUSE_MT_CS_CALL
} rrc_rr_est_cause_e_type;
...
typedef struct
{
  ...
  /* Establishment cause – MO CS or MT CS Call */
  rrc_rr_est_cause_e_type           call_est_cause;
  ...
  /* CSFB call status indication to RR */
  boolean csfb_call_status_ind; 
