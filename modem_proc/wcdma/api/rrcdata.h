...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rrcdata.h#6 $   

when       who     what, where, why
--------   ---     --------------------------------------------------------- 
07/14/20   ak      Made changes for FR 61612
11/20/18   ak      Made changes for FR 53313
01/29/16   nr      Made changes to expose rrc_find_rab_for_rb_in_est_rabs_sub API
07/13/15   sa      Made changes to move the rrc_is_dl_ps_zero_tb_size_configured() to rrcdata_v.h
...
/*Disabling DC HSUPA feature by default HI onwards*/
#define MAX_DC_HSUPA_CATEGORY  6
#endif
...
typedef enum
{
  ...
  RRC_PROCEDURE_PSEUDO_MEAS,
  RRC_PROCEDURE_PSEUDO_MEAS_RXAGC,
  RRC_PROCEDURE_CELL_DEPRI,
...
#define RRC_DEBUG_CLEAR_ALL_STATS(wrrc_as_id)    rrc_debug_clear_stats(wrrc_as_id)
...
typedef struct
{
  ...
  uint32 nas_Synchronisation_Indicator;  /* the codec type requested in OTA msg*/ 
...
SIDE EFFECTS:
====================================================================*/
extern uint32 rrc_get_uplink_rb_rate(sys_modem_as_id_e_type wrrc_as_id, uint8 lc_id);
...
SIDE EFFECTS:
====================================================================*/
extern uint32 rrc_get_downlink_rb_rate(sys_modem_as_id_e_type wrrc_as_id,uint8 lc_id);
/*===========================================================================
...
SIDE EFFECTS:
====================================================================*/
extern boolean rrc_is_wcdma_active_sub(sys_modem_as_id_e_type wrrc_as_id);
...
extern rrc_hsdpa_status_enum_type rrc_get_hsdpa_status_sub
(
  sys_modem_as_id_e_type wrrc_as_id
);
/*===========================================================================
...
extern rrc_data_rate_info_type rrc_get_data_rate_for_ds_sub
(
  sys_modem_as_id_e_type wrrc_as_id
);
