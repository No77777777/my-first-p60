...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rrcmmif.h#6 $ $DateTime: 2020/05/04 06:23:12 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/29/20   gcs     Made changes for FR 57593
04/20/20   gcs      Made changes to reset est cause as part of STOP.
...
11/02/17   sp      Made changes to save the DDS sub id indicated by NAS
...
/*-------------------------------------------------------------------
MM to RRC Request: RRC_PROCEDURE_IND
Indicates the highest priority procedure going on in NAS 
NAS will set proc_type to None once all the procedures have ended .
--------------------------------------------------------------------*/
typedef struct
{
  sys_proc_type_e_type      proc_type;
  sys_modem_as_id_e_type    as_id;
}rrc_procedure_ind_type;

/*-------------------------------------------------------------------
MM to RRC Request: RRC_DDS_SUB_IND
Indicates the DDS sub ID 
--------------------------------------------------------------------*/
typedef struct
{
  sys_modem_as_id_e_type dds_sub_id;
}rrc_dds_sub_ind_type;

/*-------------------------------------------------------------------
MM to RRC Ind: RRC_G_MEAS_STOP_IND
Indicates whether to measure G cells 
--------------------------------------------------------------------*/
...
FUNCTION RRCC_REGISTER_SERVING_CELL_CHANGE_IND_CB_SUB
...
===========================================================================*/
extern boolean rrc_register_serving_cell_change_ind_cb_sub
(
  sys_modem_as_id_e_type wrrc_as_id,
...
FUNCTION RRC_DEREGISTER_SERCING_CELL_CHANGE_IND_CB_SUB
...
===========================================================================*/
extern boolean rrc_deregister_serving_cell_change_ind_cb_sub 
(
  sys_modem_as_id_e_type wrrc_as_id,
  RRC_SERVING_CELL_CHANGE_IND_CB_FUNC_TYPE *cb_ptr
);
...
===========================================================================*/
extern void rrc_set_ue_in_deep_sleep_sub(sys_modem_as_id_e_type wrrc_as_id, boolean value);
...
FUNCTION MM_PER_SUBS_IS_SS_IN_PROGRESS

DESCRIPTION
  This function returns Supplementary Service status when EST_REQ or DATA_REQ for SS
...
SIDE EFFECTS
  This function shall be called only if CSFB for Supplementary Service Started

===========================================================================*/

boolean mm_per_subs_is_ss_in_progress (sys_modem_as_id_e_type as_id);

/*===========================================================================

FUNCTION GMM_PER_SUBS_IS_RAU_IN_PROGRESS

DESCRIPTION
  This function returns RAU Status for PS Domian
...
boolean gmm_per_subs_is_rau_in_progress (sys_modem_as_id_e_type as_id);
...
extern boolean rrc_is_delay_return_to_lte_nv_enabled(sys_modem_as_id_e_type wrrc_as_id);
/*=============================================================================

FUNCTION MM_IS_CALL_IN_PROGRESS

DESCRIPTION
  This function returns CALL Status for CS Domian
  
DEPENDENCIES
  None

RETURN VALUE
  TRUE : Call is in progress
  FALSE: call is not in progress


SIDE EFFECTS
  This function shall be called only if Normal or CSFB CS call on W Initiated 
