...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rrclsmif.h#3 $
...
FUNCTION rrcmeas_get_cell_plmn_info_sub
...
boolean rrcmeas_get_cell_plmn_info_sub
(
...
FUNCTION rrcscr_get_signalling_connection_status_sub
