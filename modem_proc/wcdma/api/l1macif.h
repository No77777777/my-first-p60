...
$Header: //components/rel/wcdma.mpss/8.4.0/api/l1macif.h#3 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
07/14/15    as      Add sub_id parameter to hs_perform_mac_ehs_reset()
...
01/29/14    pr      Exported l1 global variable to api for mac usage.
...
extern boolean l1_phy_hs_rach_check_rach_trigger(uint32 * asc_num, boolean *srb_data_present,sys_modem_as_id_e_type as_id);
...
SIDE EFFECTS
  None
=========================================================================*/
boolean l1_mac_rach_enable_trigger_needed(wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
=========================================================================*/
boolean l1_mac_rach_disable_trigger_needed(wsub_id_e_type wsub_id);
/*=========================================================================
...
===============================================================================================*/
extern void hs_perform_mac_ehs_reset(sys_modem_as_id_e_type as_id);
...
SIDE EFFECTS    None
===========================================================================*/
extern void wl1_get_profile_point(int32* frame_qty, int32* cx8_qty,   wsub_id_e_type wsub_id);
...
/*===========================================================================
 ...
 extern boolean l1_l2_get_latest_pdu_ciph_status(void); 
...
extern void eulenc_print_pdu_ctrl_words(wsub_id_e_type wsub_id);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void l1internalmeas_srch_6d_trg_check(mac_eul_evt_6d_common_info_type *mac_eul_etfci_evt_6d_common_info, wsub_id_e_type wsub_id );
...
SIDE EFFECTS  None
===========================================================================*/
extern  l1_eul_pwr_offset_sec_ul_non_sg_struct_type l1_edch_query_mac_non_sg_info(uint8  harq_id, sys_modem_as_id_e_type as_id);
...
/*===========================================================================
FUNCTION wl1_ds_block_qta_for_ul_ccch_msg

DESCRIPTION
  This function sets the timer when AICH is received to block QTA till WL1_QTA_ABORT_FOR_RACH_TIMER_IN_MS
  or RACH is done which ever happens earlier
...
SIDE EFFECTS
  None
===========================================================================*/
extern void wl1_ds_block_qta_for_ul_ccch_msg(wsub_id_e_type wsub_id);
#endif /* FEATURE_DUAL_SIM*/
/*===========================================================================
FUNCTION     WL1_MSIM_GET_CON_MODE_SUB
...
SIDE EFFECTS
  None.
===========================================================================*/
wsub_id_e_type wl1_msim_get_conn_subid(void);
