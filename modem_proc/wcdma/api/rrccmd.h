...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rrccmd.h#9 $    $DateTime: 2020/07/14 01:35:01 $ $Author: pwbldsvc $
...
31/08/18   gv      MAde cahnges for W-pref FR50563
...
/* Command used to initiate RLC_UL_DATA_IND procedure */
  ...
  RRC_GET_SIBDB_ENTRY_FOR_CELL,

  RRC_GET_SIBDB_ENTRY_FOR_CELL_CNF,

  RRC_ADD_ACQ_ENTRY,
  RRC_OUT_OF_SERVICE_INTERNAL_IND,
  RRC_TRM_PRIORITY_CHANGE_IND,
  RRC_ACQ_DUTY_CYCLE_CHANGE_IND,
  RRC_CLEAR_SIBDB_INDEX_IND,
  RRC_LTA_BLOCK_TMR_EXPIRY_IND,

  /* Posted when fallback is Activated or Deactivated by TRM based on Persistent collision detection algorithm
        Implementation is similar to Sib19 change ind. Uses same structure as of RRC_SIB_CHANGE_IND*/
  RRC_FALLBACK_IND,

  RRC_START_G_MEAS_IND,

  RRC_MAX_TA_DURATION_TIMER_EXPIRED_IND,
  RRC_POST_BUFFER_OTA_IND,
  RRC_ACTIVATION_TIMER_EXPIRY_FOR_BUFFER_OTA,
  RRC_WT_FOR_L2_ACK_PCH_TRANSITION_OR_SMC_COMPLETE_TMR_EXP_IND,
  RRC_PSEUDO_MEAS_IND,

  RRC_PSEUDO_MEAS_TIMER_EXPIRED_IND,

  RRC_PSEUDO_MEAS_CONN_ABORT_REQ,

  RRC_PSEUDO_MEAS_RXAGC_TIMER_EXPIRED_IND,

  RRCTMR_ALLOW_EARFCN_FOR_PSEUDO_MEAS_EXPIRED_IND,

  RRCTMR_DELAY_WTOL_RESEL_TIMER_EXPIRED_IND,

  RRCTMR_CELL_DEPRI_TIMER_EXPIRED_IND,

  RRCTMR_CELL_DEPRI_NBR_TIMER_EXPIRED_IND,
...
/*--------------------------------------------------------*/
  ...
  *on RACH in uplink by transitioning to eFACH state*/
  ...
  RRC_PSEUDO_MEAS_RESULTS,/* To be updated */
...
#define  rrc_cmd_e_type_value_0x1000091  RRC_PSEUDO_MEAS_IND

#define  rrc_cmd_e_type_value_0x1000092  RRC_PSEUDO_MEAS_TIMER_EXPIRED_IND

#define  rrc_cmd_e_type_value_0x1000093  RRC_PSEUDO_MEAS_CONN_ABORT_REQ

#define rrc_cmd_e_type_value_0x1000094  RRC_PSEUDO_MEAS_RXAGC_TIMER_EXPIRED_IND

#define  rrc_cmd_e_type_value_0x1000095 RRCTMR_ALLOW_EARFCN_FOR_PSEUDO_MEAS_EXPIRED_IND

#define  rrc_cmd_e_type_value_0x1000096  RRCTMR_DELAY_WTOL_RESEL_TIMER_EXPIRED_IND
...
#define rrc_cmd_e_type_value_0x2000027 RRC_PSEUDO_MEAS_RESULTS
...
/*--------------------------------------------------------*/
  ...
  #define rrc_cmd_e_type_value_0x5000022 RRC_PROCEDURE_IND

  /* 0x05000023*/
  #define rrc_cmd_e_type_value_0x5000023 RRC_PSEUDO_LTE_LIST_UPDATE_IND

  #define rrc_cmd_e_type_value_0x5000024 RRC_DDS_SUB_IND

  #define rrc_cmd_e_type_value_0x5000025 RRC_G_MEAS_STOP_IND

  #define rrc_cmd_e_type_value_0x5000026 RRC_ABNORMAL_CALL_END_IND
...
/* L1 enums commands*/
  ...
  #define l1_cmd_enum_type_value0x3A CPHY_CELL_DEPRI_REQ

  /* Number of External Commands. Should be the last element.*/
  #define l1_cmd_enum_type_value0x3B CPHY_NUM_EXT_REQ_CMDS           
...
typedef union
{
  ...
  lte_rrc_eutra_capabilities_rsp_s lte_rrc_nw_req_eutra_capabilities_rsp;
...
typedef union
{
  msgr_hdr_s msg_hdr;
  /*QMI TO W requests*/
  wcdma_rrc_qmi_idle_drx_info_req_type wcdma_rrc_qmi_drx_info_req;
  wcdma_rrc_qmi_prioritize_lte_req_type wcdma_rrc_qmi_prioritize_lte_req;
  wcdma_rrc_qmi_current_freqs_info_req_type wcdma_rrc_qmi_current_freqs_info_req;
...
typedef union
{
  ...
  qsh_client_cb_params_s          rrc_qsh_cmd;
  rrc_sib_get_sibdb_entry_type    rrc_get_sibdb_entry;
  rrc_sib_get_sibdb_entry_cnf_type rrc_get_sibdb_entry_cnf;
  rrc_acq_db_entry_type           rrc_acq_db_entry;
  rrc_clear_sibdb_index_type      rrc_clear_sibdb_index;
  rrc_no_resource_type            rrc_no_resource;
  ...
  l1_pseudo_meas_results_type       pseudo_meas_results;
  /*--------------------------------------------------------*/
  ...
  rrc_procedure_ind_type                   rrc_procedure_ind;
  rrc_pseudo_lte_list_update_ind_type rrc_psuedo_lte_list_update_ind;
  rrc_dds_sub_ind_type                     rrc_dds_sub_ind;
  rrc_g_meas_stop_ind_type                 rrc_g_meas_stop_ind; 
  /*--------------------------------------------------------*/
