...
$Header: //components/rel/wcdma.mpss/8.4.0/api/seq.h#3 $ $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 wl1_seq_get_cfn( wsub_id_e_type wsub_id);
