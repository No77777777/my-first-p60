...
$Header: //components/rel/wcdma.mpss/8.4.0/api/macrrcif.h#3 $  $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
===========================================================================*/
extern  boolean rrcrcr_is_proc_active( sys_modem_as_id_e_type wrrc_as_id );
...
SIDE EFFECTS
  None.
===========================================================================*/
extern mac_rab_status_e_type rrc_query_mac_rab_status( sys_modem_as_id_e_type as_id );
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean rrc_query_mrab_status( sys_modem_as_id_e_type as_id );

#ifdef FEATURE_WCDMA_DC_HSUPA
boolean mac_hs_ul_is_sec_carrier_active(sys_modem_as_id_e_type as_id);
#endif
/*API to check if EUL is active at MAC in DCH state */
boolean mac_is_eul_active(sys_modem_as_id_e_type as_id);
#endif
