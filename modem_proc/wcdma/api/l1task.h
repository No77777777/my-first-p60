...
$Header: //components/rel/wcdma.mpss/8.4.0/api/l1task.h#4 $ $DateTime: 2020/07/14 01:35:01 $ $Author: pwbldsvc $
...
===========================================================================*/
extern void wl1_put_cmd(l1_ext_cmd_type* cmd_ptr, sys_modem_as_id_e_type wsub_id);
