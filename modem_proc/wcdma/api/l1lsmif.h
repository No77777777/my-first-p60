...
/*===========================================================================
  ...
  $Header: //components/rel/wcdma.mpss/8.4.0/api/l1lsmif.h#3 $
...
/* For GTS, the structures have been defined in gts_api.h */
#include "gts_api.h"
#endif
...
/*===========================================================================
FUNCTION     WL1_CGPS_REGISTER_EVENT_CB
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean wl1_cgps_register_event_cb(l1_cgps_event_cb_type event_cb_fp, sys_modem_as_id_e_type wsub_id);
