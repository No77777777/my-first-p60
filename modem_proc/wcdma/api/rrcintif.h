...
$Header: //components/rel/wcdma.mpss/8.4.0/api/rrcintif.h#4 $    $DateTime: 2020/01/24 03:56:36 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  RRC_SIB_SIB19_READ_IN_DCH_SCAN,
...
typedef enum
{
  ...
  RRCLLC_CHAN_CFG_FAILURE_NO_LOCK,
...
{
  /* This is set to TRUE if RRC is waiting for L1 to release lock*/
  l1_setup_cnf_status_enum_type status;
}rrc_no_resource_type;
...
typedef struct
{
  ...
  rrc_sib_ptr_dummy_type sibs;           /* Points to all SIBs for this cell */

  uint8  six_hr_count ;

  uint8 ten_min_count;

}rrc_sibdb_cell_header_dummy_type;

typedef struct
{
  rrc_plmn_identity_type plmn_id;  /* PLMN Id of the cell */
  rrc_int_cell_id_type  cell_id;   /* CELL Id of the cell */
}rrc_sib_get_sibdb_entry_type;

typedef struct
{
  rrc_sibdb_cell_header_dummy_type *cell;
  boolean cell_found;
}rrc_sib_get_sibdb_entry_cnf_type;
...
}rrc_acq_db_entry_type;

typedef struct
{
  rrc_plmn_identity_type plmn_id;
  rrc_int_cell_id_type cell_id;
}rrc_clear_sibdb_index_type;
...
FUNCTION  rrclbt_translate_l1_loop_back_mode

DESCRIPTION
  This function translates internal loop back mode type to l1 loop back mode type
...
===========================================================================*/
mcalwcdma_dec_loop_back_mode_type_enum_type rrclbt_translate_l1_loop_back_mode(sys_modem_as_id_e_type wrrc_as_id,rrc_lb_test_mode_e_type lb_mode);

/*===========================================================================

FUNCTION  rrclbt_translate_rlc_loop_back_mode

DESCRIPTION
This function translates internal loop back mode type to RLC loop back mode type
...
===========================================================================*/
rlc_loop_back_mode_e_type rrclbt_translate_rlc_loop_back_mode(sys_modem_as_id_e_type wrrc_as_id, rrc_lb_test_mode_e_type lb_mode);
