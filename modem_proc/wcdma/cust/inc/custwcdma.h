...
$Header: //components/rel/wcdma.mpss/8.4.0/cust/inc/custwcdma.h#4 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------------------------------------------------- 
09/03/19   th      Commented FEATURE_WCDMA_HS_RACH featurization
11/20/18   ak      Made changes for FR 53313.
02/27/18   nr      Enabled FEATURE_WCDMA_ALLOW_LTA_DURING_ACT_TIME
02/19/18   yrk     Enabled FEATURE_WCDMA_ENH_SRCH_LOGGING To Reduce the size of the .isf files 
03/22/17   om      Rename target feature as FEATURE_CRAT_MSIM_TEST_FRAMEWORK
14/04/16   YRK     Enabled FEATURE_WCDMA_DS_WEB_BOOST 
11/05/15   svh     Enabled FEATURE_WCDMA_MDSP_RECOVERY
10/20/15   geg     Enabled FEATURE_WCDMA_EFACH_MSIM under FEATURE_DUAL_SIM for MPSS.AT.1.x  
10/20/15   geg     Enabled FEATURE_WCDMA_RFM_PATH_SUPPORTED under FEATURE_RF_USES_RFM_PATH_ARCH for MPSS.AT.1.x
10/13/15   ac      Enabled FEATURE_WCDMA_DL_QUAL_MEAS_REPORTING for TH
08/17/15   rkmk    Enabled FEATURE_WCDMA_EFACH_MSIM only for TH
08/17/15   rkmk    Enabled FEATURE_DUAL_WCDMA_ACQDB_SHARING and FEATURE_DUAL_WCDMA_SIBDB_SHARING only for TH and TA
08/13/15   pvr     Updated CXM featurization logic
07/28/15   rkmk    Added condition to enable FEATURE_WCDMA_STEP1_PEAK_PRUNER only for TH/AT/TA
06/22/15   om      Added FEATURE_WCDMA_SRP_CQI_BOOSTING for TA 
07/09/15   hdk     AOL log packet support
06/30/15   cc      Enabled L2W MSGR feature
06/29/15   rkmk    Enabled FEATURE_WCDMA_QSH_EVENT_METRIC and FEATURE_WCDMA_QSH_DUMP for TH.2.0, TH.2.1, TA.2.0, AT.1.0  
06/26/15   aa      Mainlined FEATURE_DSM_WM_CB
06/26/10   om      Enabled FEATURE_WCDMA_L1_ASYNC_NASTT_ENABLED 
06/22/15   ac      Added FEATURE_WCDMA_SRP_CQI_BOOSTING for TH/AT
06/22/15   ac      Added FEATURE_WCDMA_ATLAS_MODEM to THOR_MODEM featurization 
06/20/15   ac      Moved QICE+CM, CIRE, RX-TX Split featurization under TH/TA
06/16/15   rkmk    Enabled FEATURE_FULL_SRCH_FRAME_RESERVATION_ENABLED for only BOLT
06/15/15   ac      Added FEATURE_WCDMA_BOLT_MODEM/FEATURE_WCDMA_THOR_MODEM
06/09/15   rkmk    Enabled FEATURE_WCDMA_STEP1_PEAK_PRUNER for TH.2.0, TH.2.1, TA.2.0, AT.1.0 
06/09/15   rkmk    Moved FEATURE_WCDMA_EVT6D_ENH under FEATURE_WCDMA_DC_HSUPA for TH.2.0, TH.2.1, TA.2.0, AT.1.0 
06/09/15   rkmk    Enabled FEATURE_WCDMA_EVT6D_ENH for TH.2.0, TH.2.1, TA.2.0, AT.1.0
06/04/15   mk      Put FEATURE_WCDMA_TPR_BASED_MEASUREMENTS limited to Thor
06/03/15   nsb     Clean up of BOLT RUMI flags for AT.1.0
06/03/15   svh     TA featurisation.
06/01/15   rkmk    Enabled FEATURE_WCDMA_TPR_BASED_MEASUREMENTS for TH and AT
05/29/15   rkmk    Enabled FEATURE_WCDMA_RRC_HEAP_TO_BSS for TH and AT
05/20/15   svh     Enabled FEATURE_WCDMA_CIR_ENHANCEMENT for all targets
05/12/15   rkmk    Enabled FEATURE_WCDMA_RX_TX_SPLIT for only TH.2.X
04/22/15   ac      Added FEATURE_WCDMA_CUST_DEFAULT_DPCH_ENHANCEMENT
02/19/15   qj      Enabled FEATURE_WCDMA_ENABLING_QICE_WITH_CM for thor
02/19/15   sa      Made changes to enabled the FREE FLOATING Feature for QTF
02/09/15   sa      Made changes for QTF with CRM
12/23/14   sks     Enabling FEATURE RLP.
12/5/15    stk     Enable PSO by default for THOR. 
12/01/14   rkmk	   Enabled FEATURE_WCDMA_CSFB_CALL_OPT under FEATURE_WCDMA_TO_LTE
...
/* Jolokia and Tabasco Specific W flag */
  ...
  #define FEATURE_WCDMA_VLC
  #define FEATURE_WCDMA_PCOV
  #define FEATURE_WCDMA_CFCM
  #define FEATURE_WCDMA_L1_ASYNC_NASTT_ENABLED
#endif

#ifdef FEATURE_BOLT_MODEM
#define FEATURE_WCDMA_BOLT_MODEM
#endif

#ifdef FEATURE_THOR_MODEM
#define FEATURE_WCDMA_THOR_MODEM
#endif

/* Features to enable QSH metric collection for WCDMA  */

#define FEATURE_WCDMA_QSH_EVENT_METRIC
#define FEATURE_WCDMA_QSH_DUMP

#define ELEVATOR_TRIGGER
#define FEATURE_WCDMA_W2L_PSEUDO_MEAS
/*---------------------------------------------------------------------------
                              WCDMA L1 FLAGS
---------------------------------------------------------------------------*/
// --- WCDMA ---
...
#define FEATURE_CELL_RESELECT_INTER_F
...
#define FEATURE_CELL_RESELECT_INTER_S
...
#define FEATURE_WCDMA_L1_TM_DECIPHER_SUPPORTED
...
#define FEATURE_FREQ_ERROR_AVERAGING
...
#define FEATURE_WCDMA_LAST_UL_SRB_DATA_REC

/* Rx Diversity features for Phase 1*/
#define FEATURE_WCDMA_RX_DIVERSITY_PHASE_1

/* Rx Diversity features for Phase 2 */
#define FEATURE_WCDMA_RX_DIVERSITY_PHASE_2
#ifdef FEATURE_WCDMA_RX_DIVERSITY_PHASE_2
...
#undef FEATURE_WCDMA_EQ_CONTROLLER
#ifdef FEATURE_WCDMA_EQ_CONTROLLER
  /* EQ+CLTD support */
  #define FEATURE_WCDMA_EQ_PLUS_CLTD
  /* EQ Phase 2 - Speed adaptation */
  #define FEATURE_WCDMA_EQ_SPD_ADAPT
  /* This feature enables firmware to associate the HS-PDSCH with diversity pilot and 
     to also compute the CQI when diversity pilot is being used on the HS radio link. */
  #define FEATURE_WCDMA_EQ_DIV_PILOT
  /* Type 3 receiver features (EQ + RxD) */
  #ifdef FEATURE_WCDMA_RX_DIVERSITY_PHASE_1
    #define FEATURE_WCDMA_EQ_PLUS_RXD
  #endif
#endif
...
#define FEATURE_WCDMA_NIKEL_ERAMA_ACCESS_FIX
...
#define FEATURE_WCDMA_RXD_SUPPORT_SRB_NON_TRAFFIC

/* DSR Support*/
#define FEATURE_WCDMA_DSR_SUPPORT

#define FEATURE_WCDMA_EARLY_RF_SLEEP

#define FEATURE_WCDMA_FATPATH_IN_DCH

#define FEATURE_WCDMA_RXD_PCH 

#define FEATURE_IDLEMODE_FILTER

#define FEATURE_WCDMA_CPC_DTX
#define FEATURE_WCDMA_CPC_DTX_LOW_GRANT_OPT
...
#define FEATURE_WCDMA_W2L_FORCED_DET_ON_RESEL_FAIL
  ...
  #define FEATURE_WCDMA_CUST_DEFAULT_DPCH_ENHANCEMENT
#else
  /* Idle mode Feature */
  #define FEATURE_WCDMA_ENH_OOS_RXD_PWC
  /* Uplink Features */
  #define FEATURE_WCDMA_NPA_THERMAL
...
/* Support for 6 seconds Panic Srch Opt and All Cell Measurements between two Panic Full searches */
...
#if defined(FEATURE_WCDMA_TABASCO_MODEM) || defined(FEATURE_WCDMA_THOR_MODEM) || defined(FEATURE_WCDMA_ATLAS_MODEM)
#define FEATURE_WCDMA_CIR_ENHANCEMENT
#define FEATURE_WCDMA_ENABLING_QICE_WITH_CM 
#define FEATURE_WCDMA_RX_TX_SPLIT
#define FEATURE_WCDMA_LTOW_DRIVER_USE_MSGR
#define FEATURE_WCDMA_SRP_CQI_BOOSTING
#endif

/* Re-Acqless PICH (RLP) reception model for 640 ms DRX configuration. 
The main aim of these proposals is to enable shorter wake-up periods and reduce over-all power consumption. 
*/

#define FEATURE_WCDMA_REACQLESS_PICH

#if defined(FEATURE_WCDMA_THOR_MODEM) || defined(FEATURE_WCDMA_ATLAS_MODEM)
#define FEATURE_WCDMA_TPR_BASED_MEASUREMENTS
#endif

#if defined (FEATURE_WCDMA_BOLT_MODEM) && !defined(FEATURE_WCDMA_THOR_MODEM)
  #define FEATURE_FULL_SRCH_FRAME_RESERVATION_ENABLED
#endif
...
#if defined(FEATURE_WCDMA_THOR_MODEM) && !defined(FEATURE_WCDMA_ATLAS_MODEM)
#define FEATURE_WCDMA_UE_AOL
#endif

#if (defined(FEATURE_WCDMA_THOR_MODEM) || defined(FEATURE_WCDMA_ATLAS_MODEM)) && defined(FEATURE_DUAL_SIM)
#define FEATURE_WCDMA_EFACH_MSIM
#endif

#if defined(FEATURE_WCDMA_TABASCO_MODEM) && defined(FEATURE_WCDMA_DUAL_SYNC_INTERFACE)
#define FEATURE_WCDMA_EFACH_MSIM
#endif

#if defined(FEATURE_WCDMA_THOR_MODEM) && !defined(FEATURE_WCDMA_ATLAS_MODEM)
#define FEATURE_WCDMA_DL_QUAL_MEAS_REPORTING
#endif

#if defined(FEATURE_RF_USES_RFM_PATH_ARCH) && defined(FEATURE_WCDMA_ATLAS_MODEM)
#define FEATURE_WCDMA_RFM_PATH_SUPPORTED
#endif

#define FEATURE_WCDMA_MDSP_RECOVERY

#ifdef FEATURE_CRAT_MSIM_TEST_FRAMEWORK
#define FEATURE_WCDMA_MSIM_TEST_FRAMEWORK
#endif

#define FEATURE_WCDMA_ENH_SRCH_LOGGING
...
#define FEATURE_WCDMA_BUILD_PDU_DSM_OPT

#ifdef FEATURE_MODEM_HEAP
  #define FEATURE_WCDMA_RLC_ZI_REDUCTION
  #define FEATURE_WCDMA_RLC_DL_ZI_REDUCTION
#endif
...
/* When Evt6D TTT is enabled, UE would autonomously limit the ETFCI in DC-HSUPA call so that we can operate below MTPL and delay reporting Evt6D for Xmsec */
#ifdef FEATURE_WCDMA_DC_HSUPA
  #define FEATURE_WCDMA_EVT6D_ENH
#endif

#define FEATURE_WCDMA_DS_WEB_BOOST
...
*/
#ifndef WIN32
  #define FEATURE_RRC_LED
#endif

/* Define the OSS_USE_FULL_SOED_ONLY when not linking with LED
*/
#ifdef FEATURE_RRC_LED
  #undef OSS_USE_FULL_SOED_ONLY
#else
  #define OSS_USE_FULL_SOED_ONLY
#endif /* FEATURE_RRC_LED */
...
#define FEATURE_PRIORITIZE_850_BAND_FOR_FULL_SCAN
...
#define FEATURE_WCDMA_FDPCH_STTD
...
/* Allowing LTA during activation time */
...
/* WCDMA RRC HEAP to HSS */

#define FEATURE_WCDMA_RRC_HEAP_TO_BSS

#if !defined(FEATURE_WCDMA_ATLAS_MODEM) && defined(FEATURE_DUAL_WCDMA)
#define FEATURE_DUAL_WCDMA_ACQDB_SHARING
#define FEATURE_DUAL_WCDMA_SIBDB_SHARING 
#endif
...
#define FEATURE_HSDPA_ASU_REPOINTING
