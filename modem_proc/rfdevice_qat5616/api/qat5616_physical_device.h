#ifndef QAT5616_PHYSICAL_DEVICE_H
#define QAT5616_PHYSICAL_DEVICE_H
...
$Header: //source/qcom/qct/modem/rfdevice/qat/main/1.0/qat5616/protected/qat5616_physical_device.cpp#1 : andrewy : 2017/07/24 17:27:35

when       who    what, where, why
--------   ---   ---------------------------------------------------------------
04/28/24   pm    Initial file
...
#include "qat5616_tuner_config_ag.h"


class qat5616_physical_device : public rfdevice_physical_device
{
public:

  virtual rfdevice_logical_component* get_component( rfc_logical_device_info_type *logical_device_cfg);

  qat5616_physical_device* qat5616_physical_device_p;

  rfc_phy_device_info_type* phy_device_cfg;

  qat5616_physical_device( rfc_phy_device_info_type* cfg_req,
  	                      boolean ext_cmd = TRUE );

  ~qat5616_physical_device();
...
private:
  ...
  rfdevice_antenna_tuner* qat5616_qtuner_obj_ptr;
