...
$Header: //source/qcom/qct/modem/fw/components/fw_tdscdma.mpss/rel/17.0/api/tfw_sw_intf_cell.h#1 $
...
typedef struct
{
  ...
  */
   ...
   */
   ...
   /*! \brief mcjd -ic logic control flag
   */
    uint16                    mcjdIcEnable: 1;
    uint16                                : 2;
