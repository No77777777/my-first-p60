...
$Header: //source/qcom/qct/modem/fw/components/fw_tdscdma.mpss/rel/17.0/api/tfw_diag_log_codes.h#1 $
...
#define TFW_DIAG_LOG_BASE_EXTEND_C                      (0x100 + LOG_TDSCDMA_BASE_C + 0x40)
...
#define TFW_DIAG_LOG_ECE_C                              (0x3E + TFW_DIAG_LOG_BASE_C)
#define TFW_DIAG_LOG_MCJD_IC_INFO_C                     (0x40 + TFW_DIAG_LOG_BASE_C)
