/* File off the internet. Some slight modifications for types by Matthias */
...
typedef uint8    u08b; /* an 8 bit unsigned character type */
typedef uint16   u16b; /* a 16 bit unsigned integer type   */
typedef uint32   u32b; /* a 32 bit unsigned integer type   */
