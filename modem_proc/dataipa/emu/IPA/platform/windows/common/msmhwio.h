...
#ifndef VI_TODO
    #define __VI_STR2__(x)  #x
    #define __VI_STR1__(x)  __VI_STR2__(x)
    #define __VI_LOC__      __FILE__ "("__VI_STR1__(__LINE__)") : TODO: "

    #define VI_TODO(msg)    message(__VI_LOC__ __FUNCTION__ ": " msg) 
#endif
...
#define __msmhwio_inx(base, hwiosym)                                  HWIO_##hwiosym##_IN
 ...
 */
  ...
  #define __outpw(port, val)  bus_write (port, val)
  #define __outpdw(port, val) bus_write (port, val)
#endif
