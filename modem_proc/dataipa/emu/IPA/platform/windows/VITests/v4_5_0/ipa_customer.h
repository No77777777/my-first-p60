...
#define IPA_PIPE_CONSUMER_MAX_ID          12
...
#define IPA_PIPE_CONSUMER_DEAGGR_MAX_ID   3
/* producers : */
#define IPA_PIPE_PRODUCER_MIN_ID          13
#define IPA_PIPE_PRODUCER_MAX_ID          30
...
*/
#define IPA_SECURITY_APPS_VMID_0 /* TODO IPA4.0.0: to be checked with Arch */
