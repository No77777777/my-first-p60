...
$Header: //components/rel/dataipa.mpss/3.2/emu/IPA/platform/windows/VITests/v3_5/HALhwio_ipa.h#1 $
...
/* support for tracing register access */
#ifdef IPA_DBG_TRACE_REG_WRITE
    extern void bus_write(void* port, uint32 val);
    #undef out_dword
    #define out_dword(port, v)  bus_write((void*)(port), v)
#endif
...
#ifndef IPAH_SYM	/* allow redefinition in platform level */
#define IPAH_SYM(hwiosym)			IPA_##hwiosym  
#endif

#define IPA_BASE_ADDRESS                        IPAH_SYM(REG_BASE_PHYS)
...
#define HAL_IPA_GEN_EMU_BAM_XPU_BASE            (GSI_TOP_XPU2_REG_BASE_PHYS      - HAL_IPA_GEN_EMU_AXI_BASE)
#define HAL_IPA_GEN_EMU_GSI_XPU_BASE            (GSI_TOP_XPU2_REG_BASE_PHYS      - HAL_IPA_GEN_EMU_AXI_BASE)
...
#define XPUH_SYM(hwiosym)           GSI_TOP_XPU_##hwiosym
#endif

#ifndef IPA_XPU_REG_BASE_ADDRESS     /* allow redefinition in platform level */
#define IPA_XPU_REG_BASE_ADDRESS     GSI_TOP_XPU2_REG_BASE_PHYS
#endif
