...
#define IPA_PIPE_CONSUMER_MAX_ID          8
...
/* producers : */
#define IPA_PIPE_PRODUCER_MIN_ID          9
#define IPA_PIPE_PRODUCER_MAX_ID          19
 ...
 */
#define IPA_MAX_ALLOC_PIPE_NUM            20

/**
 *  @brief The number of GSI channels available per EE.
 */
#define IPA_MAX_NUM_OF_GSI_CHANNELS_PER_EE 20

/**
 *  @brief The number of GSI event channels available per EE.
 */
#define IPA_MAX_NUM_OF_GSI_EVENT_CHANNELS_PER_EE 8
...
*/
#define IPA_SECURITY_APPS_VMID_CHANGEABLE
