 ...
 *
 * @brief    IPA definitions per specific IPA core flavor (version 4.5.0).
 * 
...
*/
#define IPA_GSI_OVERALL_TLV_FIFO_SIZE 320

/**
 * @brief   AOS FIFO size when working with GSI. 
*/
#define IPA_GSI_OVERALL_AOS_FIFO_SIZE 500
 ...
 */
#define IPA_SRC_RSRC_GRP_NUMBER  5
#define IPA_DST_RSRC_GRP_NUMBER  5
#define IPA_UC_RSRC_GRP_NUMBER   4
...
*/
#define IPA_MAX_USEFUL_SRC_RSRC_GRP_INDEX  3
#define IPA_MAX_USEFUL_DST_RSRC_GRP_INDEX  4
...
*/
#define IPA_MAX_PACKET_CONTEXT_ID               10
 ...
 * 
 * @note    This Register was removed in this target
 *          so the value was set to zero
*/
#define IPA_DEFAULT_BCR_CONFIGURATION (0)
...
*/
#define IPA_NUM_OF_MBIM_AGGREGATION_PIPES 3

/**
* @brief   the maximal number of generic aggregation pipes.
*/
#define IPA_NUM_OF_GENERIC_AGGREGATION_PIPES 18
