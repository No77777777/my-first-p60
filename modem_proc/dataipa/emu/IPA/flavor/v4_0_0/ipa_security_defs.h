...
/*
  The following configuration is based on this document:
   https://sharepoint.qualcomm.com/qct/DHW/Cores/WiredPeripherals/FG/Architecture/Documents/IPA/IPA4.0/IPAv4_0_XPU_Config.xlsx
*/
#define IPA_GSI_XPU_RG_0_PTAG          ( IPA_RG_PTAG_RD_AP | IPA_RG_PTAG_RDWR_MSA | IPA_RG_PTAG_RDWR_TZ                                                         )
#define IPA_GSI_XPU_RG_1_PTAG          ( IPA_RG_PTAG_RD_AP | IPA_RG_PTAG_RDWR_MSA | IPA_RG_PTAG_RDWR_TZ                                                         )
#define IPA_GSI_XPU_RG_2_PTAG          ( IPA_RG_PTAG_RD_MSA | IPA_RG_PTAG_RDWR_TZ                                                                               )
#define IPA_GSI_XPU_RG_3_PTAG          ( IPA_RG_PTAG_RDWR_AP | IPA_RG_PTAG_RDWR_IPA_AP |  IPA_RG_PTAG_RDWR_MSA | IPA_RG_PTAG_RD_TZ                              )
...
#define IPA_GSI_XPU_RG_9_PTAG          ( IPA_RG_PTAG_RDWR_MSA | IPA_RG_PTAG_RDWR_AP                                                                             )
...
#define IPA_GSI_XPU_RG_15_PTAG         ( IPA_RG_PTAG_RDWR_MSA | IPA_RG_PTAG_RDWR_IPA_AP /* in accordance to comment */                                          )
#define IPA_GSI_XPU_RG_16_PTAG         ( IPA_RG_PTAG_RD_MSA | IPA_RG_PTAG_WR_NONE                                                                               )
#define IPA_GSI_XPU_RG_17_PTAG         ( IPA_RG_PTAG_RDWR_MSA                                                                                                   )
