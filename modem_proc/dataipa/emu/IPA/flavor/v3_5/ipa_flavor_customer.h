...
DESCRIPTION:  
IPA customizations per specific IPA core flavor (version).
...
/* Workaround for -------------------------------------------------------- CR QCTDD03061809
   https://tardis.qualcomm.com/cqweb/#/QCTDD/QCTDD/RECORD/QCTDD03061809 -  HW-State: Opened
                                                                           VI-State: Pass w WA (Test 602)
   Issue Description:
   IPA does not perform HOLB drop for notification statuses
*/
#define IPA_HOLB_DROP_TIMER_ON_STATUS_QUEUE_WORKAROUND
