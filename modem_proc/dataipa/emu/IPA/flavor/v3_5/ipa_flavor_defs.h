 ...
 *
 * @brief    IPA definitions per specific IPA core flavor (version 3.5).
 * 
...
*/
#define IPA_GSI_OVERALL_TLV_FIFO_SIZE 200

/**
 * @brief   AOS FIFO size when working with GSI. 
*/
#define IPA_GSI_OVERALL_AOS_FIFO_SIZE 308

/**
 * @brief   The required latency of one cmp/dcmp packet in uSec units.
*/
#define IPA_DCMP_LATENCY_USEC         10
...
#define IPA_DST_RSRC_GRP_NUMBER  3
...
*/
#define IPA_MAX_USEFUL_SRC_RSRC_GRP_INDEX  2
#define IPA_MAX_USEFUL_DST_RSRC_GRP_INDEX  2
...
*/
#define IPA_PACKET_CONTEXT_SIZE_IN_BYTES        0x80  /* IPA3.5 TODO: Q to HW */

/**
 * @brief   Maximal ID of a Packet CONTEXT (there is 8 Packet Contexts [0:7] )
*/
#define IPA_MAX_PACKET_CONTEXT_ID               7

/**
 * @brief   Offset (in RAM_HW) of the first Packet CONTEXT (offset from IPA_RAM_HW_FIRST)
*/
#define IPA_PACKET_CONTEXT_OFFSET_IN_RAM_HW     0x2A00   /* IPA3.5 TODO: Defined in SWI, see IPA_CTXH_CTRL and IPA_CTX_ID_m_CTX_NUM_n. 
                                                            New HAL fn is needed */

/**
* @brief   Offset for getting decmp sector list
*/
#define IPA_DCMP_SECTOR_LIST_OFFSET 0x30
...
*/
#define IPA_UC_IRAM_SIZE 0x4000

/*
 * @brief   Size of uc DRAM size.
*/
#define IPA_UC_DRAM_SIZE 0x2000
...
*/
#define IPA_NUM_OF_MBIM_AGGREGATION_PIPES 5

/**
* @brief   the maximal number of generic aggregation pipes.
*/
#define IPA_NUM_OF_GENERIC_AGGREGATION_PIPES 9
...
typedef enum VIDRV_ipa_HwSniffClients
{
    ...
    IPA_HWSNIFF_CLIENT_TX_1_VRTL   = 8, /**< */
