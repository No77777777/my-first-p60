 ...
 *           Configuration from:
 *           https://sharepoint.qualcomm.com/qct/DHW/Cores/WiredPeripherals/FG/Architecture/Documents/IPA/IPAv3/3.5/IPA_9x65_XPU_Config.xlsx
 * 
...
/**
 * @brief   The SID that represents in VMIDMT GSI EE_0
*/
#define VIDRV_IPA_VMIDMT_GSI_EE_0_SID     21 /* = 21, pipe ID for GSI */
...
#define IPA_GSI_XPU_RG_14_PTAG         ( IPA_RG_PTAG_RDWR_AP | IPA_RG_PTAG_RDWR_IPA_AP | IPA_RG_PTAG_RDWR_MSA | IPA_RG_PTAG_RDWR_TZ | IPA_RG_PTAG_SRAM          )
