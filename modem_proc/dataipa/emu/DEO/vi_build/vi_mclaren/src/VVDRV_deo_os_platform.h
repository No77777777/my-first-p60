...
/** msmhwioreg.h file alias for the time OS layer */
#define DEO_TIME_OS_HWIO_FILE        "msmhwioreg.h"
 ...
 */
#if defined(RUMI)
/* McLaren RUMI Sleep_timeTick works at 0.32Khz */
#define DEO_TIME_OS_VI_BUILD_SLEEP_TIMETICK_FREQ          328
#endif  /* RUMI */
