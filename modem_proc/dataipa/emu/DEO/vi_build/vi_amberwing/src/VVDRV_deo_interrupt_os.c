...
/* DEO_IC_QGIC (APPS IC) */
#if (defined (COMPILING_APPS_PROC) || defined(COMPILING_IMC_PROC))
#ifndef DEO_IC_QGIC
#define DEO_IC_QGIC
#endif /* DEO_IC_QGIC */
#endif /* COMPILING_APPS_PROC || COMPILING_IMC_PROC */
...
/* Amberwing specific - check for processor definition */
#if (!defined(COMPILING_APPS_PROC) && !defined(COMPILING_IMC_PROC))
#error No valid dragonfly processor type defined
#endif /* !COMPILING_APPS_PROC && !COMPILING_IMC_PROC */

/* Amberwing specific - check for duplicate processor */
#if (defined(COMPILING_APPS_PROC) && defined(COMPILING_IMC_PROC))
#error Duplicate dragonfly processor types definitions
#endif /* COMPILING_APPS_PROC && COMPILING_IMC_PROC */

/* Now get the needed IC driver header file */
#if defined(DEO_IC_QGIC)
#include "qgic_spi.h"                   /* Amberwing specific */
...
/* Amberwing specific - map IMC GIC driver APIs to QGIC driver APIs */
#if defined(COMPILING_IMC_PROC)
#define VVDRV_qgic_isPending     VVDRV_imc_gic2_isPendingIntr
#define VVDRV_qgic_clearPending  VVDRV_imc_gic2_clearPendingIntr
#define VVDRV_qgic_disable       VVDRV_imc_gic2_DisableIntr
#define VVDRV_qgic_enable        VVDRV_imc_gic2_EnableIntr
#define VVDRV_qgic_isActive      VVDRV_imc_gic2_isActiveIntr
#define VVDRV_qgic_isEnabled     VVDRV_imc_gic2_isEnabledIntr
#define VVDRV_qgic_isPending     VVDRV_imc_gic2_isPendingIntr
#endif /* COMPILING_IMC_PROC */
