#ifndef __VVDRV_DEO_LISTS_H__
#define __VVDRV_DEO_LISTS_H__
/**---------------------------------------------------------------------------
 * @file  VVDRV_deo_lists.h
 *
 * @brief Declares the DEO lists macros
 *
...
/******************************************************************************/
/*    Doubly-linked tail queue declarations                                   */
/******************************************************************************/
...
#define STAILQ_HEAD(name, type)                                                 \
    struct name {                                                               \
        ...
        struct type **stqh_last; /**< address of last next element */           \
    }
