...
$Header: //components/rel/rfa.mpss/4.11/rfc/rf_card/rfc_efs_card/common/src/rfc_efs_card_cmn_data.cpp#1 $
...
const rfm_devices_configuration_type* rfc_efs_card_cmn_data::get_logical_device_properties( void )
{
  return rfc_efs_card_cmn_logical_device_properties;
}
