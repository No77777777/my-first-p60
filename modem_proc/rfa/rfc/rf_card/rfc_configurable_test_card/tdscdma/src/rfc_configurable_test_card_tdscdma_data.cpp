...
$Header: //components/rel/rfa.mpss/4.11/rfc/rf_card/rfc_configurable_test_card/tdscdma/src/rfc_configurable_test_card_tdscdma_data.cpp#1 $

when       who     what, where, why
------------------------------------------------------------------------------- 
10/20/20   akm     Add featurizations FEATURE_TDSCDMA
