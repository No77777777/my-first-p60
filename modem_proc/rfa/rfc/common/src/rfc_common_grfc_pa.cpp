...
$Header: //components/rel/rfa.mpss/4.11/rfc/common/src/rfc_common_grfc_pa.cpp#1 $

when       who    what, where, why
--------   ---   ---------------------------------------------------------------
07/23/15   pv/qzh LTE Only Hard-coding for GRFC PA with 40Mhz.
...
/*----------------------------------------------------------------------------*/
boolean grfc_pa::get_max_bw_supported
(
...
{
  *max_bw_khz = 40000;
  RF_MSG_3( RF_HIGH, "grfc_pa::get_max_bw_supported: Dev:%d, band:%d, Max BW:%d",
           rfm_device, rf_band, *max_bw_khz);
  return TRUE;
}
#endif
