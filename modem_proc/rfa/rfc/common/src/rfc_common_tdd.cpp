...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rfc/common/src/rfc_common_tdd.cpp#1 $
...
/*!
  @brief
  This function configures the specified RF signals to the specified state(HIGH/LOW).

  @details
  This function configures the specified RF signals to the specified state(HIGH/LOW). It also setup
...
*/
uint32
rfc_common_tdd_update_grfc_script
(
  rfc_sig_cfg_type *rf_signals, 
  void *start_script_ptr, 
  void *stop_script_ptr,
