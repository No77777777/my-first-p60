...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rfc/common/inc/rfc_tdscdma_transceiver_hdet_adapter.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
12/20/16   ry     Add HDET Disable API
...
public:
  ...
  virtual boolean tx_hdet_fbrx_adc_disable(void);
