...
$Header: //components/rel/rfa.mpss/4.11/rfc/vreg_mgr/wtr1605_sv/inc/rfc_vreg_mgr_wtr1605_sv.h#1 $
...
private:
  ...
  void send_npa_rf_id(rfcom_mode_enum_type mode, uint8 npa_id, rfc_vreg_param &vreg_param);
  ...
  uint16               rfc_state_info[RFM_NUM_MODES]; 
