...
$Header: //components/rel/rfa.mpss/4.11/rfc/vreg_mgr/rfc_configurable_test_vreg_mgr/src/rfc_configurable_test_vreg_mgr.cpp#1 $
...
void rfc_configurable_test_vreg_mgr::manage_power(rfc_vreg_param &vreg_param)
{
  ...
  MSG_5(MSG_SSID_RF, MSG_LEGACY_MED,"Enter manage_power: mode=%d, band=%d, device=%d,path=%d, rf state=%d", 
...
void rfc_configurable_test_vreg_mgr::manage_sv_power(rfc_vreg_param &vreg_param)
{
  ...
  MSG_5(MSG_SSID_RF, MSG_LEGACY_MED,"Enter manage_sv_power: mode=%d, band=%d, device_num=%d,path=%d, rf state=%d", 
        vreg_param.get_mode(), vreg_param.get_band(), vreg_param.get_device(),
        vreg_param.get_path(), vreg_param.get_rf_state());
