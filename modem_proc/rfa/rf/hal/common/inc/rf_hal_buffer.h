...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/hal/common/inc/rf_hal_buffer.h#1 $
...
public:
  ...
  /*! Append CTrig ID bit to script */
  boolean append_rffe_ctrig_bit
  (
    uint8 slave_id,
    uint8 channel,
    uint16 address,
  ...
  boolean apply_data_fixup_with_token
  (
    uint16 fixup_id,
    uint16 size_in_uint16,
    uint16* fixup_vals
  );
  ...
  boolean get_script_execution_time
  (
