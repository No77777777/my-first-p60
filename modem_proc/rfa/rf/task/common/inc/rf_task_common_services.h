...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/task/common/inc/rf_task_common_services.h#1 $
...
#define RFLTE_MCPM_CCS_SIG_ONE          0x0020   /*!< Signal for MCPM -> RFSW CMDs for sub0 */

#define RFLTE_MCPM_CCS_SIG_TWO          0x0040   /*!< Signal for MCPM -> RFSW CMDs for sub1 */
