...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/task/common/inc/rf_task.h#1 $
...
typedef enum
{
  RF_TASK_RFM_INIT_STATE_NOT_RAN = 0,
  RF_TASK_RFM_INIT_STATE_STARTED = 1,
  RF_TASK_RFM_INIT_STATE_COMPLETE = 2
} rf_task_rfm_init_state_type;

extern rf_task_rfm_init_state_type rf_task_rfm_init_state;
