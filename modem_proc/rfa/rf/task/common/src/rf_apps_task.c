...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/task/common/src/rf_apps_task.c#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
02/20/15   px      Hooked up with RF dispatch
...
)
{
  ...
  /* Use the generic dispatcher for MSGR mechanism */
  if(RF_APPS_MSGR_ID == rf_tech_id)
  {
