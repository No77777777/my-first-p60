...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/task/common/src/rf_task_3.c#1 $
...
//
 rex_msgr_interworking_sucess = rf_rex_msgr_interface_init(RF_TASK_3, TASK_HANDLE(rf_3),RF_CMD_Q_SIG);
  ...
  /* RF task 3 is not currently being used */
  MSG( MSG_SSID_RF, MSG_LEGACY_ERROR, 
       "rf_task_3() no dispatcher initialisation for rf task 3" );

  /* RF task 3 is not currently being used for FTM */
  MSG( MSG_SSID_RF, MSG_LEGACY_ERROR, 
       "rf_task_3() no FTM dispatcher initialisation for rf task 3" );
