...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/src/ftm_common_data.c#1 $
...
/*!
  @brief
  Get the address of the data container for the FBRx Agc table

  @details
  This function is used by the FBRx Agc table handlers to get the FBRx Agc table
  structure.

  @return
  Address of the FBRx Agc table structure.
*/
ftm_cal_data_fbrx_agc_map_type*
ftm_common_data_get_fbrx_agc_table_ptr
(
  void
)
{
  return &(ftm_common_data.cal_data.fbrx_agc_map);
}
