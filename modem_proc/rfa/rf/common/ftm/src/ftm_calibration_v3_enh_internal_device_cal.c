...
$Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/src/ftm_calibration_v3_enh_internal_device_cal.c#1 $
...
02/22/15    xs     add short wait before calling ftm rsb api to make sure async mode lna gain state set is done.
