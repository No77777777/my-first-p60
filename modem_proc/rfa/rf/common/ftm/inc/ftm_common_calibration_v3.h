...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/inc/ftm_common_calibration_v3.h#1 $
...
typedef enum
{
  ...
  FTM_CALIBRATION_COMPRESSION_BUFFER_FAILURE = 31,
  /*!< Error code indicating that the compression process failed */

  FTM_CALIBRATION_COMPRESSION_DATA_FAILURE = 32,
  /*!< Error code indicating that the compression process failed*/
