...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/inc/rf_test_task_v.h#1 $
   
when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
07/21/15   sb      created new FTM LTE logging signal 
...
#define FTM_LTE_LOGGING_CMD_Q_SIG 0x0310000
#endif
