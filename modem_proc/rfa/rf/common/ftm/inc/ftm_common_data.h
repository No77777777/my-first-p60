...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/inc/ftm_common_data.h#1 $
...
typedef struct
{
  ...
  ftm_cal_data_fbrx_agc_map_type fbrx_agc_map;
  /*!< This member stores FBRx Agc data for up to 16 channel x 4 FBRx Modes x 4 FBRx Gain States. */
