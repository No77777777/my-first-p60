...
--------------------------------------------------------------------------------
10/09/15   npi     FTM concurrency manager changes for handling device allocation
                   with Rx/Tx split
...
/*!
  @brief
  Concurrency Manager drds reconfig_enable pkt contents
*/
typedef PACK(struct)
{
  uint16 tech1;
...
ftm_drds_reconfig_enable_pkt_type;
