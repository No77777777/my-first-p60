...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/inc/ftm_calibration_v3_radio.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
11/18/15   sk      Move ULCA xcorr peak for RB allocation issue
...
typedef enum 
{
  FTM_CAL_RADIO_LTE_BW_1P4MHz = 0,
  FTM_CAL_RADIO_LTE_BW_3MHz,
  FTM_CAL_RADIO_LTE_BW_5MHz,
  FTM_CAL_RADIO_LTE_BW_10MHz,
  FTM_CAL_RADIO_LTE_BW_15MHz,
  FTM_CAL_RADIO_LTE_BW_20MHz,
  FTM_CAL_RADIO_LTE_BW_40MHz,               /*This is the last standalone LTE BW. Please add CA BW enums after this.*/
  FTM_CAL_RADIO_LTE_BW_20MHz_plus_20MHz,   /*BW type for intra-band ULCA*/
  FTM_CAL_RADIO_NUM_LTE_BWS,
  FTM_CAL_RADIO_LTE_BW_20MHz_plus_20MHz_EDGE_CHANNEL = 128,   /*BW type for intra_band ULCA with edge channel included for calibraion*/
  FTM_CAL_RADIO_BW_LTE_INVALID
} ftm_cal_radio_lte_bw_type;
