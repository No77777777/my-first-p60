...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/ftm/inc/ftm_common_enh_internal_device_cal.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
09/21/15  xsh     Support for LTE simutenuously IQ capture
10/11/15  xsh     Add Error Code for rsb device api return invalid rsb data
09/21/15  xsh     Add Error Code for the case of EFS RSB cal Data not Support
07/20/15  xsh     Support for logical device 6,7
...
typedef enum
{
  ENH_DO_RSB_WITHOUT_EFS_WRITE = 0,
  ENH_DO_RSB_WITH_EFS_WRITE_WITHOT_VALIDATION = 1,
  ENH_DO_RSB_WITH_EFS_WRITE_AND_VALIDATION = 2,
  ENH_DO_EFS_WRITE_ONLY_WITHOUT_RSB_CAL = 3,
} ftm_enh_internal_device_rsb_cal_efswrite_flag_type;
...
typedef enum
{
  ...
  FTM_ENH_INTERNAL_DEVICE_CAL_CARRIER_NOT_SUPPORTED = -31,
  /*! <Error code indicating when requested carrier id not supported */ 

  FTM_ENH_INTERNAL_DEVICE_CAL_RXRSB_EFS_CAL_DATA_NOT_SUPPORTED = -32,
  /*! <Error code indicating rxRSB cal data need to go to NV and no longer on efs */
  FTM_ENH_INTERNAL_DEVICE_CAL_RXRSB_DEVICE_COMPENSATION_FAIL = -33,
  /*! <Error code indicating rxRSB cal is wrongful compensated, the result cal data is invalid */
...
typedef enum
{
  ...
  FTM_ENH_INTERNAL_DEVICE_CAL_RXRSB_RES_PRX4 = 6,
  FTM_ENH_INTERNAL_DEVICE_CAL_RXRSB_RES_DRX4 = 7,
