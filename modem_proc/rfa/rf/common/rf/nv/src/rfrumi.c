...
--------   ---     ----------------------------------------------------------
01/06/20   akm     rf rumi featurization
03/02/15   tws     Fix off target
02/06/15   cpm     added GSM rx/tx_cal_nv_data
01/20/15   cpm     added GSM band support to C2 and C3
12/05/14   ec      Addition of C2\C3 NV items for RxD\DSDA capability on RUMI
...
#include "rfgsm_nv_cmn.h"
   ...
   boolean rfrumi_set_item_list_gsm_tx_cal_data(rfnv_item_type *rumi_item_ptr,
                                                rfnv_item_size_type *rumi_item_sz_ptr,
   ...
   void rfrumi_set_item_list(void)
   {
      ...
      rfrumi_item_list[1].val.rf_bc_config = 562952216790407
            | SYS_BM_64BIT(SYS_BAND_GSM_850) | SYS_BM_64BIT(SYS_BAND_GSM_EGSM_900)
            | SYS_BM_64BIT(SYS_BAND_GSM_DCS_1800) | SYS_BM_64BIT(SYS_BAND_GSM_PCS_1900)
            ;
      ...
      rfrumi_item_list[5].item_id = RFNV_RF_BC_CONFIG_C3_I;
      rfrumi_item_list[5].val.rf_bc_config = (uint64)0
            | SYS_BM_64BIT(SYS_BAND_GSM_850) | SYS_BM_64BIT(SYS_BAND_GSM_EGSM_900)
            | SYS_BM_64BIT(SYS_BAND_GSM_DCS_1800) | SYS_BM_64BIT(SYS_BAND_GSM_PCS_1900)
            ;
      /*End common*/
   ...
   */
                              ...
                              nv_item_type *rumi_item_ptr)
   {
      ...
      case RFNV_RF_BC_CONFIG_C3_I:
         rumi_item_ptr->rf_bc_config = rfrumi_item_list[5].val.rf_bc_config;
         break;
      ...
      case RFNV_LTE_B7_CA_BC_CONFIG_I:
         ...
         /* minimal GSM Rx calibration data taken from DPM.2.0 */
      case RFNV_GSM_C0_GSM850_RX_CAL_DATA_I:
      case RFNV_GSM_C1_GSM850_RX_CAL_DATA_I:
      case RFNV_GSM_C2_GSM850_RX_CAL_DATA_I:
      case RFNV_GSM_C3_GSM850_RX_CAL_DATA_I:
      case RFNV_GSM_C0_GSM900_RX_CAL_DATA_I:
      case RFNV_GSM_C1_GSM900_RX_CAL_DATA_I:
      case RFNV_GSM_C2_GSM900_RX_CAL_DATA_I:
      case RFNV_GSM_C3_GSM900_RX_CAL_DATA_I:
         {
            gsm_rx_cal_data_nv_type rx_cal_nv_data = { 0 };
            rx_cal_nv_data.rx_cal_chan_size = 1;
            rx_cal_nv_data.rx_cal_chan_list[0] = 111;
            rx_cal_nv_data.rx_freq_comp_data[0].freq_comp_data[0] = 2261;
            rx_cal_nv_data.rx_freq_comp_data[1].freq_comp_data[0] = 2073;
            rx_cal_nv_data.rx_freq_comp_data[2].freq_comp_data[0] = 2072;
            rx_cal_nv_data.rx_freq_comp_data[3].freq_comp_data[0] = 1979;
            memscpy(rumi_item_ptr, sizeof(nv_item_type),
                  &rx_cal_nv_data, sizeof(rx_cal_nv_data));
         }
         break;

      case RFNV_GSM_C0_GSM1800_RX_CAL_DATA_I:
      case RFNV_GSM_C0_GSM1900_RX_CAL_DATA_I:
      case RFNV_GSM_C1_GSM1800_RX_CAL_DATA_I:
      case RFNV_GSM_C1_GSM1900_RX_CAL_DATA_I:
      case RFNV_GSM_C2_GSM1800_RX_CAL_DATA_I:
      case RFNV_GSM_C2_GSM1900_RX_CAL_DATA_I:
      case RFNV_GSM_C3_GSM1800_RX_CAL_DATA_I:
      case RFNV_GSM_C3_GSM1900_RX_CAL_DATA_I:
         {
            gsm_rx_cal_data_nv_type rx_cal_nv_data = { 0 };
            rx_cal_nv_data.rx_cal_chan_size = 1;
            rx_cal_nv_data.rx_cal_chan_list[0] = 666;
            rx_cal_nv_data.rx_freq_comp_data[0].freq_comp_data[0] = 2261;
            rx_cal_nv_data.rx_freq_comp_data[1].freq_comp_data[0] = 2073;
            rx_cal_nv_data.rx_freq_comp_data[2].freq_comp_data[0] = 2072;
            rx_cal_nv_data.rx_freq_comp_data[3].freq_comp_data[0] = 1979;
      ...
      case RFNV_GSM_C2_GSM850_LNA_SWPT_I:
      case RFNV_GSM_C2_GSM900_LNA_SWPT_I:
      case RFNV_GSM_C2_GSM1800_LNA_SWPT_I:
      case RFNV_GSM_C2_GSM1900_LNA_SWPT_I:
      case RFNV_GSM_C3_GSM850_LNA_SWPT_I:
      case RFNV_GSM_C3_GSM900_LNA_SWPT_I:
      case RFNV_GSM_C3_GSM1800_LNA_SWPT_I:
      case RFNV_GSM_C3_GSM1900_LNA_SWPT_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_ENV_GAIN_I:
      case RFNV_GSM_C2_GSM900_ENV_GAIN_I:
      case RFNV_GSM_C2_GSM1800_ENV_GAIN_I:
      case RFNV_GSM_C2_GSM1900_ENV_GAIN_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_VBATT_I:
      case RFNV_GSM_C2_GSM900_VBATT_I:
      case RFNV_GSM_C2_GSM1800_VBATT_I:
      case RFNV_GSM_C2_GSM1900_VBATT_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_LINEAR_TX_GAIN_PARAM_I:
      case RFNV_GSM_C2_GSM900_LINEAR_TX_GAIN_PARAM_I:
      case RFNV_GSM_C2_GSM1800_LINEAR_TX_GAIN_PARAM_I:
      case RFNV_GSM_C2_GSM1900_LINEAR_TX_GAIN_PARAM_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_POLAR_PATH_DELAY_I:
      case RFNV_GSM_C2_GSM900_POLAR_PATH_DELAY_I:
      case RFNV_GSM_C2_GSM1800_POLAR_PATH_DELAY_I:
      case RFNV_GSM_C2_GSM1900_POLAR_PATH_DELAY_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_POWER_LEVELS_I:
      case RFNV_GSM_C2_GSM900_POWER_LEVELS_I:
      case RFNV_GSM_C2_GSM1800_POWER_LEVELS_I:
      case RFNV_GSM_C2_GSM1900_POWER_LEVELS_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_TX_TIMING_I:
      case RFNV_GSM_C2_GSM900_TX_TIMING_I:
      case RFNV_GSM_C2_GSM1800_TX_TIMING_I:
      case RFNV_GSM_C2_GSM1900_TX_TIMING_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_PA_RANGE_MAP_I:
      case RFNV_GSM_C2_GSM900_PA_RANGE_MAP_I:
      case RFNV_GSM_C2_GSM1800_PA_RANGE_MAP_I:
      case RFNV_GSM_C2_GSM1900_PA_RANGE_MAP_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_EXTENDED_PA_SWPT_I:
      case RFNV_GSM_C2_GSM900_EXTENDED_PA_SWPT_I:
      case RFNV_GSM_C2_GSM1800_EXTENDED_PA_SWPT_I:
      case RFNV_GSM_C2_GSM1900_EXTENDED_PA_SWPT_I:
         { 
      ...
      case RFNV_GSM_C2_GSM850_TEMP_COMP_I:
      case RFNV_GSM_C2_GSM900_TEMP_COMP_I:
      case RFNV_GSM_C2_GSM1800_TEMP_COMP_I:
      case RFNV_GSM_C2_GSM1900_TEMP_COMP_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_EXTENDED_SMPS_PDM_TBL_I:
      case RFNV_GSM_C2_GSM900_EXTENDED_SMPS_PDM_TBL_I:
      case RFNV_GSM_C2_GSM1800_EXTENDED_SMPS_PDM_TBL_I:
      case RFNV_GSM_C2_GSM1900_EXTENDED_SMPS_PDM_TBL_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_POLAR_RAMP_PROFILE_I:
      case RFNV_GSM_C2_GSM900_POLAR_RAMP_PROFILE_I:
      case RFNV_GSM_C2_GSM1800_POLAR_RAMP_PROFILE_I:
      case RFNV_GSM_C2_GSM1900_POLAR_RAMP_PROFILE_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_AMAM_TEMP_COMP_I:
      case RFNV_GSM_C2_GSM900_AMAM_TEMP_COMP_I:
      case RFNV_GSM_C2_GSM1800_AMAM_TEMP_COMP_I:
      case RFNV_GSM_C2_GSM1900_AMAM_TEMP_COMP_I:
         {
      ...
      case RFNV_GSM_C2_GSM850_ENH_APT_I:
      case RFNV_GSM_C2_GSM900_ENH_APT_I:
      case RFNV_GSM_C2_GSM1800_ENH_APT_I:
      case RFNV_GSM_C2_GSM1900_ENH_APT_I:
         {
   ...
   /*!
   @brief
   This function copies multiple RF NV data items, as specified by 
   "item_code/identifier" into the pointer passed.

   @description
   this function will wrap first to  "rfrumi_nv_get_item()"
   upon a FALSE return if will carry and handle composite RF NV items.

   @param  rfnv_item_id_enum_type item_code
   "item_code/identifier"

   @param rfnv_item_type *rumi_item_ptr
   pointer to the RF NV items recieving buffer.

   @param rfnv_item_size_type *rumi_item_sz_ptr
   pointer to the variable of the size allocated for this RF NV items buffer.
   the dereferenced variable is updated with the actual byte lenght of the 
   RF NV items recieving buffer.

   @return boolean
   TRUE when completed a copy of RFNV items
   FALSE otherwise
   */

   boolean
   rfrumi_rfnv_get_item
   (
   rfnv_item_id_enum_type item_code,
   rfnv_item_type *rumi_item_ptr,
   rfnv_item_size_type *rumi_item_sz_ptr
   )
   {
   boolean status = rfrumi_nv_get_item(item_code, (nv_item_type *)rumi_item_ptr);

   if (status == FALSE)
   {
      switch (item_code)
      {
         case RFNV_GSM_C0_GSM850_TX_CAL_DATA_I:
         case RFNV_GSM_C0_GSM900_TX_CAL_DATA_I:
         case RFNV_GSM_C0_GSM1800_TX_CAL_DATA_I:
         case RFNV_GSM_C0_GSM1900_TX_CAL_DATA_I:
            status = rfrumi_set_item_list_gsm_tx_cal_data(rumi_item_ptr,
                                                         rumi_item_sz_ptr,
                                                         item_code - RFNV_GSM_C0_GSM850_TX_CAL_DATA_I);
            break;
            
         case RFNV_GSM_C2_GSM850_TX_CAL_DATA_I:
         case RFNV_GSM_C2_GSM900_TX_CAL_DATA_I:
         case RFNV_GSM_C2_GSM1800_TX_CAL_DATA_I:
         case RFNV_GSM_C2_GSM1900_TX_CAL_DATA_I:
            status = rfrumi_set_item_list_gsm_tx_cal_data(rumi_item_ptr,
                                                         rumi_item_sz_ptr,
                                                         item_code - RFNV_GSM_C2_GSM850_TX_CAL_DATA_I);
            break;
   ...
   /*! @brief
   * This is a function preparing some simple calibration data for GSM TX all modulations and all bands,
   * 
   * @description
   * The same RGI,PMEAS,AMAM,AMPM tables will be reused for 3 channels, 2 PA states and 2 modulations.
   *
   * The calibration data values are taken from a typical DPM.2.0 hardware and
   * have been approximated to a 1st order polynomial.
   * 
   * After building an heading from "gsm_tx_cal_data_nv_type",
   * each of the RFNV items are stacked reusing the an ad-hoc "rfnv_item" structure.
   * the amount of memory used is always monitored with "num_bytes_stored" variable.
   *
   * @param rfnv_item_type *rumi_item_ptr
   * pointer to allocated receiver buffer where the RFNV items will directly be constructed.
   *
   * @param rfnv_item_size_type *rumi_item_sz
   * pointer to the size value of this RFNV items receiver buffer.
   * the actual byte length "num_bytes_stored" of the constructed RFNV items will be written back.
   *
   * @param rfcom_gsm_band_type band
   * the band number 0=GSM850 1=GSM900 2=DCS 3=PCS, which is used to defines LMH ARFCNs
   *
   * @return 
   * TRUE when managed to store at least the RFNV header.
   * FALSE otherwise
   *
   * @todo: 
   * create a macro to calculate the offset to end of marker type.
   * or use the size of a partial structure definition.
   * as this Size of Fixed part (10 bytes) and variant header (4 bytes), total 14 bytes 
   * is found hard-coded in rfgsm_nv_cmn.c, and do provide space for 3 channels !
   */
   #define RFRUMI_GSM_TX_CAL_NV_FIXED_SIZE        (0x0A + sizeof(rfnv_data_variant_marker_type))
   #define RFRUMI_GSM_TX_CAL_CHAN_SIZE            MIN(3, RFCOM_GSM_NUM_TX_CAL_CHAN)
   #define RFRUMI_GSM_NUM_PA_STATE                MIN(2, RFCOM_GSM_NUM_PA_STATE)
   #define RFRUMI_LINEAR_RGI_INDEX_PER_GAIN_STATE MIN(27, RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE)

   boolean
   rfrumi_set_item_list_gsm_tx_cal_data
   (
   rfnv_item_type *rumi_item_ptr,
   rfnv_item_size_type *rumi_item_sz,
   rfcom_gsm_band_type band
   )
   {
   int i;
   ...
   PACK(struct) {
      /*!@todo could have been rfnv_item_id_enum_type but need to be sure is of size 16 bits. */
      uint16 item_id;
      union {
         rfnv_data_rgi_list_type rgi;
         rfnv_data_pmeas_list_type pmeas;
         rfnv_data_amam_list_type amam;
         rfnv_data_ampm_list_type ampm;
      };
   } rfnv_item;

   size_t num_bytes_stored = RFRUMI_GSM_TX_CAL_NV_FIXED_SIZE;  
   gsm_tx_cal_data_nv_type *tx_cal_nv_data_ptr = (gsm_tx_cal_data_nv_type *)rumi_item_ptr;

   if(num_bytes_stored >= (*rumi_item_sz))
   {
      return FALSE;
   }

   /* L M H channels are calculated here:
      555 to 777 for DCS and PCS,
      then 975 to 124 for GSM850  and GSM900.     
   */
   for ( i = 0; i < RFRUMI_GSM_TX_CAL_CHAN_SIZE; i++)
   {
      int a = (band > 1 ? 555 : 975);
      int b = (band > 1 ? 777 - 555 : 1024 + 124 - 975);
      tx_cal_nv_data_ptr->tx_cal_chan[i] = a + b * i / RFRUMI_GSM_TX_CAL_CHAN_SIZE;
      tx_cal_nv_data_ptr->tx_cal_chan[i] %= 1024;
   }
   
   tx_cal_nv_data_ptr->tx_cal_chan_size = RFRUMI_GSM_TX_CAL_CHAN_SIZE;  
   tx_cal_nv_data_ptr->amam_max_dbm = 2987;
   tx_cal_nv_data_ptr->rgi_for_pred = 20;
   tx_cal_nv_data_ptr->rfnv_data_variant_marker.version = 0;
   tx_cal_nv_data_ptr->rfnv_data_variant_marker.num_elements = 0;
   
   /* store rgi elements */
   rfnv_item.item_id = RFNV_DATA_TYPE_ID_RGI_LIST;
   rfnv_item.rgi.valid_rgi_num = RFRUMI_LINEAR_RGI_INDEX_PER_GAIN_STATE;

   for ( i = 0; i < RFRUMI_LINEAR_RGI_INDEX_PER_GAIN_STATE; i++)  
   {
      rfnv_item.rgi.rgi_list[i] = i;
   }

   for (rfnv_item.rgi.pa_state = 0;
         rfnv_item.rgi.pa_state < RFRUMI_GSM_NUM_PA_STATE;
         rfnv_item.rgi.pa_state++)
   {
      for (rfnv_item.rgi.mod = 0;  /*0 = GMSK 1 = 8PSK*/
            rfnv_item.rgi.mod < 2;
            rfnv_item.rgi.mod++)
      {
         num_bytes_stored += memscpy(((uint8 *)rumi_item_ptr) + num_bytes_stored,
                                    (*rumi_item_sz) - num_bytes_stored,
                                    &rfnv_item,
                                    sizeof(uint16) + sizeof(rfnv_data_rgi_list_type));
         
         if (num_bytes_stored < (*rumi_item_sz))
         {
         tx_cal_nv_data_ptr->rfnv_data_variant_marker.num_elements++;
         }
      }
   }

   /* store pmeas elements */
   rfnv_item.item_id = RFNV_DATA_TYPE_ID_PMEAS_LIST;
   
   for ( i = 0; i < RFRUMI_LINEAR_RGI_INDEX_PER_GAIN_STATE; i++ )
   {
      int a = (band > 1 ? 3000 : 3300); /* roughthly max available power */
      rfnv_item.pmeas.pmeas_list[i] = 100 + a * (i + 1) / RFRUMI_LINEAR_RGI_INDEX_PER_GAIN_STATE;
   }

   for (rfnv_item.pmeas.channel_index = 0;
         rfnv_item.pmeas.channel_index < RFRUMI_GSM_TX_CAL_CHAN_SIZE;
         rfnv_item.pmeas.channel_index++)
   {
      for (rfnv_item.pmeas.pa_state = 0;
            rfnv_item.pmeas.pa_state < RFRUMI_GSM_NUM_PA_STATE;
            rfnv_item.pmeas.pa_state++)
      {
         for (rfnv_item.pmeas.mod = 0;  /*0 = GMSK 1 = 8PSK*/
            rfnv_item.pmeas.mod < 2;
            rfnv_item.pmeas.mod++)
         {
         num_bytes_stored += memscpy(((uint8 *)rumi_item_ptr) + num_bytes_stored,
                                       (*rumi_item_sz) - num_bytes_stored,
                                       &rfnv_item,
                                       sizeof(uint16) + sizeof(rfnv_data_pmeas_list_type));        
   ...
   /* store AMAM  tables */
   rfnv_item.item_id = RFNV_DATA_TYPE_ID_AMAM_LIST;
   rfnv_item.amam.amam_ampm_identifier = 0;  /* 0 = AMAM, 1= AMPM */

   for ( i = 0; i < GSM_AMAM_TBL_SIZE; i++ )
   {
      rfnv_item.amam.data_list[i] = 188 + 43072 * i / GSM_AMAM_TBL_SIZE;
   }

   for (rfnv_item.amam.channel_index = 0;
         rfnv_item.amam.channel_index < RFRUMI_GSM_TX_CAL_CHAN_SIZE;
         rfnv_item.amam.channel_index++)
   {
      num_bytes_stored += memscpy(((uint8 *)rumi_item_ptr) + num_bytes_stored,
                                 (*rumi_item_sz) - num_bytes_stored,
                                 &rfnv_item,
                                 sizeof(uint16) + sizeof(rfnv_data_amam_list_type));
   ...
   /* store the AMPM tables */
   rfnv_item.item_id = RFNV_DATA_TYPE_ID_AMPM_LIST;
   rfnv_item.amam.amam_ampm_identifier = 1;  /* 0 = AMAM, 1= AMPM */

   for ( i = 0; i < GSM_AMPM_TBL_SIZE; i++ )
   {
      rfnv_item.ampm.data_list[i] = -159 + 2735 * i / (GSM_AMPM_TBL_SIZE - 0x50);

      /* crops data in ampm table */
      if (rfnv_item.ampm.data_list[i] > 2747)
      {
         rfnv_item.ampm.data_list[i] = 2747;
      }
   }
   
   for (rfnv_item.ampm.channel_index = 0;
         rfnv_item.ampm.channel_index < RFRUMI_GSM_TX_CAL_CHAN_SIZE;
         rfnv_item.ampm.channel_index++)
   {
      num_bytes_stored += memscpy(((uint8 *)rumi_item_ptr) + num_bytes_stored, 
                                 (*rumi_item_sz) - num_bytes_stored,
                                 &rfnv_item,
                                 sizeof(uint16) + sizeof(rfnv_data_ampm_list_type));
