...
02/12/14   cpm     added a more robust API to fetch RUMI RFNV items 
...
boolean rfrumi_rfnv_get_item(rfnv_item_id_enum_type item_code, rfnv_item_type *rumi_item_ptr, rfnv_item_size_type *rumi_item_sz);
