...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/nv/inc/rfcommon_nv_mm.h#1 $
...
06/30/15   sb     support for NV container 4,5 for LTE
05/27/15   zhw    Map BC COnfig to logical device for CDMA
04/24/15   tsr    Add support for the C4/C5 RF BC Config 
...
typedef struct
{
  ...
  rfcommon_spur_table_type rf_lte_c4_spurious_table;
  rfcommon_spur_table_type rf_lte_c5_spurious_table;
  ...
  rfcommon_spur_thresh_table_type rf_lte_c4_spurs_thresh_table;
  rfcommon_spur_thresh_table_type rf_lte_c5_spurs_thresh_table;

  /*! Flag for identifying whether BC Config for a given chain has been loaded 
    Needed for backward compatibility use */
  boolean rf_bc_config_loaded[6];

  /* WCDMA SAR AsDiv backoff all band NV*/
  rfwcdma_nv_sar_asdiv_type rfwcdma_nv_sar_asdiv_table[RFCOM_NUM_WCDMA_BANDS];

  /* GNSS Blanking Control */
  rfnv_gnss_blanking_control_type gnss_blanking_control;
