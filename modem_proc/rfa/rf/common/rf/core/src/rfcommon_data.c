...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/rf/core/src/rfcommon_data.c#1 $
...
#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
void* get_rfcommon_data(uint32* size)
{
  *size = sizeof(rfcommon_data);
  return (void*) &rfcommon_data;
}
#endif
/*============================================================================*/
/*!
