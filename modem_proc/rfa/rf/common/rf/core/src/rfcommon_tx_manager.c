...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/rf/core/src/rfcommon_tx_manager.c#1 $
...
;
    ...
    if ((copy_to->res_config.cb_data.data_ptr=modem_mem_alloc( copy_to->res_config.cb_data.data_size,MODEM_MEM_CLIENT_RFA)))
    {
