...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/core/inc/rfcommon_core_utils.h#1 $
...
/*----------------------------------------------------------------------------*/
uint32 rfcommon_core_get_tx_handle_from_device
( 
  rfm_device_enum_type device
);
/*----------------------------------------------------------------------------*/
rfm_device_enum_type rfcommon_core_get_tx_default_device( rfm_device_enum_type device , rfm_mode_enum_type rf_tech );
