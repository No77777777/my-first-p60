...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/core/inc/rfcommon_core_xpt.h#1 $

when       who     what, where, why
--------------------------------------------------------------------------------
01/18/17   sk      Send Tx handle to XPT api's for LTE
05/11/16   wxl     Add definition for Autopin NV bitmask
08/07/15   ck      Support GSM fbrx power meas
06/23/15    pv     Intra-band ULCA LUT hook up.
03/25/15   jmf     [selftest] Add enum entry for Spectrum Flatness Capture
03/23/15    JJ      Latch DTR chain0 after chain1 to bypass DTR1 latch HW limitation
03/15/14   dw      Added ref Pin in DPD config for DCHSUPA
...
/* Index 12 & 15 are currently unused */
...
#define XPT_CFG_WCDMA_DC_REF_ET_PIN_OFFSET    28
#define XPT_CFG_WCDMA_DC_REF_EPT_PIN_OFFSET   29
#define DPD_CFG_THIRTY_ITEM             30
#define XPT_CFG_AUTOPIN_DISABLE_BITMASK 0x01
...
typedef enum
{
  ...
  XPT_CAPTURE_SELF_TEST_SPEC_FLAT = 9, /*!< Self Test Spectral Flatness */

  XPT_CAPTURE_GSM_PWR_MES = 10,
