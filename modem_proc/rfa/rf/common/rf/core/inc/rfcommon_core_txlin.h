...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/core/inc/rfcommon_core_txlin.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/23/16   zhh    Added delta gain Pin Pout support
02/16/15    dw     Added NV type for delta gain Pin Pout 
...
/*----------------------------------------------------------------------------*/
/*! @brief Tx delta gain pin pout LUT NV Type */
typedef PACK(struct)
{
...
} tx_delta_gain_pin_pout_nv_type;
...
#define RFCOM_TXLIN_NV_V3_SIZE_MAX  ( 0                              \
           ...
           + (96 *  ( RFNV_DATA_TYPE_ID_SIZE                        \
            ...
            + (4 *  (RFNV_DATA_TYPE_ID_SIZE                          \
                      + (sizeof(tx_delta_gain_pin_pout_nv_type)))))
