...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/mc/inc/rfcommon_mc.h#2 $
...
03/10/16   kg      Adding support for enabling/disabling band capability from bc config
...
extern boolean rflm_ccs_wakeup_flag;
...
extern rfm_init_status_type_e_type rfcommon_mc_init(rfcom_device_enum_type device, 
...
/*----------------------------------------------------------------------------*/
rfm_bands_bitmask
rfommon_mc_get_aggregated_rfm_bands_bitmask
( 
  void
);
