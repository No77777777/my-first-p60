...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/rf/mc/inc/rfcommon_asdiv_manager.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
01/24/20   moh     RF MDUMP Changes
02/02/16   dyc     Support ASDiv callbacks on set antenna IMM
...
/*! Type definition for call back return handle */
typedef uint32 rfcommon_asdiv_cb_handler_type;

/*!
  @brief
  Enum for ASDiv general call back mode

  @detail
  ASDiv general purpose call back can support 2 modes.
     Once   - will de-register itself after call back is called.
     Repeat - will have call back remain in effect and must be de-register via the deregister API
*/
typedef enum
{
  ASDIV_CB_ONCE,
...
/*----------------------------------------------------------------------------*/
/*! Type defintion for general ASDiv Call back function */
typedef void(*asdiv_cb_func_type)
(
...
(
   ...
   rfm_mode_enum_type cb_tech_type,
   rfcommon_asdiv_cb_type cb_type
);
