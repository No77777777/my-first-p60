...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/mc/src/rfcommon_cmd_processing.c#1 $
...
02/18/16   zhh    Add support to RFA_RF_COMMON_MSG_ID_CALC_AUTO_PIN_POUT
============================================================================*/
#include "rfcom.h"
...
boolean rfcommon_rf_apps_task_register(void)
{
  ...
  ret_val &= rf_dispatch_register_command(rf_apps_task_get_dispatch_handle(),       // dispatch handle
                                          MSGR_RFA_RF_COMMON,                       // module self
                                          RFA_RF_COMMON_MSG_ID_CALC_AUTO_PIN_POUT,  // cid
                                          ftm_calibration_data_calc_delta_pin_pout, // cid handler
                                          NULL,                                     // cb data
                                          0);                                       // reg action
 #ifdef FEATURE_RFA_ACL
ret_val &= rf_dispatch_register_command( rf_apps_task_get_dispatch_handle(),       
                                         MSGR_RFA_RF_COMMON,                       
                                         RFA_RF_COMMON_MSG_ID_MAAT_UPDATE_IND,    
                                         rfcmn_core_maat_update_handler,                                
                                         NULL,                                     
...
boolean rfcommon_rf_apps_task_deregister(void)
{
  ...
  /* Deregister calc_auto_pin_pout */
  ret_val &= rf_dispatch_deregister_command( rf_apps_task_get_dispatch_handle(),
                                            MSGR_RFA_RF_COMMON,                       
                                            RFA_RF_COMMON_MSG_ID_CALC_AUTO_PIN_POUT);
