...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/rf/mc/src/rfcommon_tuner.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/29/15   ndb     Update to new tuner interface
...
)
{
  ...
  if ( event_aborted == FALSE )
  {
         ...
         num_tuner_device++  )
    {
      ...
      {
        api_status &= rfcommon_atuner_acknowledge_script( tuner_cb_data->tuner_data[num_tuner_device].ant_tuner, 
