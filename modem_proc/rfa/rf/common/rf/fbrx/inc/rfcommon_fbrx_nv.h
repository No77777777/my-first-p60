...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/rf/fbrx/inc/rfcommon_fbrx_nv.h#1 $
...
02/11/15    jmf    [selftest] Add function to read Undroop filter coeffs from NV for spec. flatness meas. 
...
typedef struct
{
  ...
  rfcommon_fbrx_nv_lte_data_type lte_cal_data[RFCOMMON_FBRX_NV_CONTAINER_MAX];
...
typedef struct
{
  ...
  boolean cal_data;
  boolean droop_data;
}rfcommon_fbrx_nv_mem_alloc_cal_type;

typedef struct
{
  rfcommon_fbrx_nv_mem_alloc_cal_type cdma_init[RFM_CDMA_MAX_BAND];
  rfcommon_fbrx_nv_mem_alloc_cal_type wcdma_init[RFCOM_NUM_WCDMA_BANDS];
  rfcommon_fbrx_nv_mem_alloc_cal_type lte_init[RFCOMMON_FBRX_NV_CONTAINER_MAX][RFCOM_NUM_LTE_BANDS];
  rfcommon_fbrx_nv_mem_alloc_cal_type tds_init[RFCOM_NUM_TDSCDMA_BANDS];
}rfcommon_fbrx_nv_mem_alloc_init_type;
...
rfcommon_fbrx_error_type
rfcommon_fbrx_nv_update_dc_droop_to_dm
( 
  rflm_fbrx_dm_template_t* fbrx_dm_ptr, 
  rfm_mode_enum_type tech,
  rfcom_band_type_u band,
...
uint32 
rfcommon_fbrx_get_tx_freq_from_ul_arfcn
( 
  rfm_mode_enum_type tech,
  rfcom_band_type_u band,
  uint32 chan_array[],                                       
...
void* get_rfcommon_fbrx_nv_tech_cal_data
(
  uint32* size
);
