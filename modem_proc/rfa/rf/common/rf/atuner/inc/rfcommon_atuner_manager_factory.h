...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/common/rf/atuner/inc/rfcommon_atuner_manager_factory.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
08/25/15   aak     Support for TP Tuner manager
04/21/15   ndb     Removal of CA_PORT (dyanmic RFM device requirement)
                   Deprecate the un-used API 
...
typedef enum
{
  ...
  ATUNER_ACL_MANAGER = 3,
#endif /* FEATURE_RFA_ACL */
  ATUNER_TP_MANAGER = 4,
  ATUNER_MANAGER_MAX =0xFF
