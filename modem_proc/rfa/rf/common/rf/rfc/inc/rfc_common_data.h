...
$Header: //components/rel/rfa.mpss/4.11/rf/common/rf/rfc/inc/rfc_common_data.h#1 $
...
public:
  ...
  virtual const rfm_devices_configuration_type* get_logical_device_properties( void );
