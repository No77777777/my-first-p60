...
$Header: //components/rel/rfa.mpss/4.11/rf/mdsp/qdsp6_common/inc/rfcommon_mdsp_event_intf.h#1 $
...
#define RFCOMMON_MDSP_EVENT_ID_BASE_GSM     RFLM_CCS_RF_EVENT_ID_BASE_GSM    
#define RFCOMMON_MDSP_EVENT_ID_BASE_WCDMA   RFLM_CCS_RF_EVENT_ID_BASE_WCDMA  
#define RFCOMMON_MDSP_EVENT_ID_BASE_CDMA    RFLM_CCS_RF_EVENT_ID_BASE_CDMA   
#define RFCOMMON_MDSP_EVENT_ID_BASE_LTE     RFLM_CCS_RF_EVENT_ID_BASE_LTE    
#define RFCOMMON_MDSP_EVENT_ID_BASE_TDSCDMA RFLM_CCS_RF_EVENT_ID_BASE_TDSCDMA
#define RFCOMMON_MDSP_EVENT_ID_BASE_IRAT    RFLM_CCS_RF_EVENT_ID_BASE_IRAT  
#define RFCOMMON_MDSP_EVENT_ID_BASE_RFCMD   RFLM_CCS_RF_EVENT_ID_BASE_RFCMD
                                                                    
#define RFCOMMON_MDSP_EVENT_MAX_TECH_ID     RFLM_CCS_RF_EVENT_MAX_TECH_ID    
