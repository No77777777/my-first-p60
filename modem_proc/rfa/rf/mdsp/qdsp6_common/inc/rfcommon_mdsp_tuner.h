...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/mdsp/qdsp6_common/inc/rfcommon_mdsp_tuner.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
02/03/15   yb      Added API for TxAGC update
11/20/14   ndb     Added FBRx CL support
...
/**********************FBRx CL API's *************************************/
boolean 
rfcommon_mdsp_tuner_schedule_fbrx_vswr_measurement
(
  void* tuner_closed_loop_buffer,
  uint32 tuner_closed_loop_event_id,
  rf_dispatch_snum_handler_fp_type fwrsp_callback,
...
boolean
rfcommon_mdsp_tuner_closed_loop_fbrx_get_meas_results 
(
  void* tuner_update_buffer_ptr,
...
boolean
rfcommon_mdsp_tuner_closed_loop_fbrx_reset_status
(
  void* tuner_update_buffer_ptr
);
/*----------------------------------------------------------------------------*/
...
boolean
rfcommon_mdsp_tuner_closed_loop_fbrx_check_timeout_event
(
  void* tuner_update_buffer_ptr
);
...
/*----------------------------------------------------------------------------*/
int32
rfcommon_mdsp_tuner_closed_loop_fbrx_get_txagc_level
(
  void* tuner_update_buffer_ptr
);
/*----------------------------------------------------------------------------*/
