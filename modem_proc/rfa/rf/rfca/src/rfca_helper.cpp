...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/rfca/src/rfca_helper.cpp#1 $
   
when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
03/09/15   aki     Reduce log message buffer size and add missing 'break'
...
{
  if(HAL_RF_PROTOCOL_SYSTEM_MAX == StateCache.RF_TECHNOLOGY)
  {
    return false;
  }
