...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/rf/rfca/inc/rfca_defs.h#1 $
   
when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
03/05/18    rp     Phone Mode definition upgrade.
...
typedef enum
{
   ...
   PHONE_MODE_LTE_B250 = 94,
   PHONE_MODE_LTE_B47 = 95,
   PHONE_MODE_LTE_B48 = 96,
   PHONE_MODE_LTE_B71 = 97,
   PHONE_MODE_LTE_B38_K = 98,
   PHONE_MODE_LTE_B67 = 99,

   /* Connectivity (WLAN, NFC, FM Radio and WIGIG RF Modes are used for QDART NPT tool purposes only) */
   /* Reserves RF Mode 100 -120 */
