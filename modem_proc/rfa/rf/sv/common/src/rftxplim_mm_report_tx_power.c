...
$Header: //components/rel/rfa.mpss/4.11/rf/sv/common/src/rftxplim_mm_report_tx_power.c#1 $
...
/* Get the GPS status */
      ...
      switch (rflte_state_get_curr_band_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx))
      {
      case RFCOM_BAND_LTE_B3:
        ...
        case RF_BC14_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B3);
            ...
            cur_lte_bw = rflte_core_get_bw_in_khz(rflte_state_get_bw_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx));
      ...
      case RFCOM_BAND_LTE_B9:
        ...
        case RF_BC14_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B9);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
      ...
      case RFCOM_BAND_LTE_B10:
        ...
        case RF_BC14_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B10);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
      ...
      case RFCOM_BAND_LTE_B2:
        ...
        case RF_BC1_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B2);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);

            /* convert to uint32 to prevent overflow and simplify comparisons */
            cur_lte_tx_num_rb = (18 * (uint32)rflte_core_get_num_rb_from_bandwidth(rflte_state_get_bw_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx))) + 123;
            cur_lte_tx_chan = 10 * ((uint32)rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx) - 18600);
        ...
        case RF_BC8_BAND:
          {
            RF_MSG_2(RF_MED, "GPSdesense:Back-off Initiated For LTE Band %d 1x Band %d ", rflte_state_get_curr_band_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), rfsv_voice_tech_tx_status.rf_band);
        ...
        case RF_BC15_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B2);
            cur_lte_rx_freq = rflte_core_get_rx_freq_from_uarfcn(rflte_mc_state[sub_id].rf_path_state[0].curr_chan_rx, RFCOM_BAND_LTE_B2);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
            ...
            {
              RF_MSG_2(RF_MED, "LTE_rx_desense:Back-off Initiated For LTE Band %d 1x Band %d ", rflte_state_get_curr_band_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), rfsv_voice_tech_tx_status.rf_band);
        ...
        case RF_BC0_BAND:
          {
            ...
            RF_MSG_2(RF_MED, "IM2backoff",rflte_state_get_curr_band_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), rfsv_voice_tech_tx_status.rf_band);

            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B4);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC15_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B1);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC8_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B25);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC15_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_from_uarfcn(rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), RFCOM_BAND_LTE_B25);
            cur_lte_rx_freq = rflte_core_get_rx_freq_from_uarfcn(rflte_mc_state[sub_id].rf_path_state[0].curr_chan_rx, RFCOM_BAND_LTE_B25);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
            cdma1x_rx_freq = rf_cdma_get_rx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
            ...
            {
              RF_MSG_2(RF_MED, "CDMA1x_rx_desense:Back-off Initiated For LTE Band %d 1x Band %d ", rflte_state_get_curr_band_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx), rfsv_voice_tech_tx_status.rf_band);
        ...
        case RF_BC1_BAND:
          {
            ...
            /* convert to uint32 to prevent overflow and simplify comparisons */
            cur_lte_tx_num_rb = (18 * (uint32)rflte_core_get_num_rb_from_bandwidth(rflte_state_get_bw_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx))) + 123;
            cur_lte_tx_chan = 10 * ((uint32)rflte_state_get_curr_chan_tx(RFLTE_MC_PCELL_IDX,txlm_buffer_idx) - 26040);
      ...
      if (current_limit < rflte_core_txpl_get_pcmax(sub_id))
      {
    ...
    case RFM_LTE_MODE:
      {
        ...
        (void)rflte_mc_tx_update_sar_backoff(sub_id,RFCOM_TRANSCEIVER_0);
