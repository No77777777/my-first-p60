...
08/16/16   dbc     Added rffe_program_assigned_usid_burst() API 
04/15/15   sn      Added extended product id programming function
...
typedef struct
{
  ...
  uint8 rd_delay;                 /* read delay         */
  uint8 half_rate;                /* half rate mode     */
