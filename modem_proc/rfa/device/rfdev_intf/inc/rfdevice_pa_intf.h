...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_pa_intf.h#1 $

when       who   what, where, why
--------   ---   ---------------------------------------------------------------
05/22/18   dh   Added interface for PA modulation type
03/29/16   kr   FR 32798: LTE 40M separated calibration for QPA4340
06/23/15   dbc   Add rfdevice_set_pa_output_cap() API
06/03/15   dbc   Add pa_output_cap_offset field to rfdevice_pa_config_type
...
extern "C" {
   ...
   (
    ...
    /*----------------------------------------------------------------------------*/
    boolean rfdevice_set_pa_output_cap
    (
      rfdevice_pa_config_type *pa_config_p,
      void *device_ptr
    );
    ...
    /*----------------------------------------------------------------------------*/
    rfdevice_pa_bw_enum_type rfdevice_pa_convert_to_pa_bw(rfm_mode_enum_type rfm_mode, rfcom_bw_type_u bw);
