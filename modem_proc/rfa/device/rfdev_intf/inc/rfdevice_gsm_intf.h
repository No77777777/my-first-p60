...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_gsm_intf.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/28/15   sma     Added GSM VSWR measurement support
09/03/15   sma     Added APIs for FBRx self-cal support 
07/07/15   sc      Further Rx burst optimisations (~20% @ 144MHz)
07/01/15   hoh     Changes to support eLNA programming for GSM
04/09/15   sd      Device driver updates for RFC re-design for Split Rx/Tx
...
/* Invalid Frequency error value used to override the freq error update */
#define RFDEVICE_GSM_FREQ_ERR_OVERRIDE (0x7FFFFFFF)
...
boolean rfdevice_gsm_configure_rx
(
  rfm_device_enum_type rfm_dev, 
...
boolean rfdevice_gsm_rx_set_start_script(rfm_device_enum_type rfm_dev, 
                                         rfdevice_operation_mode oper_mode, 
...
boolean rfdevice_gsm_tx_set_start_script(rfm_device_enum_type rfm_dev,
                                         rfdevice_operation_mode oper_mode,
                                         rfgsmlib_sbi_burst_struct *script_infor,
                                         rf_buffer_intf *buffer,
                                         uint16 *buffer_mask,
...
boolean rfdevice_gsm_init_once(rfm_device_enum_type rfm_dev, rfm_device_enum_type paired_dev,rfdevice_rx_mode_type rx_mode);
...
boolean rfdevice_gsm_lna_trigger
(
  rfm_device_enum_type rfm_dev, 
...
boolean rfdevice_gsm_lna_wakeup
(
  rfm_device_enum_type rfm_dev, 
  rfcom_gsm_band_type rf_band,
  rf_buffer_intf *script_buffer,
...
boolean rfdevice_gsm_lna_sleep
(
  rfm_device_enum_type rfm_dev, 
  rfcom_gsm_band_type rf_band,
  rf_buffer_intf *script_buffer,
...
boolean rfdevice_gsm_lna_set_gain
(
  rfm_device_enum_type rfm_dev, 
  rfcom_gsm_band_type rf_band,
  rf_buffer_intf *script_buffer,
...
boolean rfdevice_gsm_get_lna_gain_index
(
  rfm_device_enum_type rfm_dev, 
  rfcom_gsm_band_type rf_band,
  int8 system_gain,
...
boolean rfdevice_gsm_fbrx_self_test_on
(
  rfm_device_enum_type rfm_dev,
  rfcom_gsm_band_type band,
  uint8 gain_state
...
boolean rfdevice_gsm_fbrx_self_test_off
(
  rfm_device_enum_type rfm_dev
);

boolean rfdevice_gsm_fbrx_vswr_meas_enable
(
  rfm_device_enum_type rfm_dev,
  rfcom_gsm_band_type band,
  uint8 gain_state,
...
boolean rfdevice_gsm_fbrx_vswr_meas_disable
(
  rfm_device_enum_type rfm_dev,
  rf_device_execution_type execution_type,
  int8* disable_timing,
