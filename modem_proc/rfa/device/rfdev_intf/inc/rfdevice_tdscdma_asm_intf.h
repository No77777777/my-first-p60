...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_tdscdma_asm_intf.h#1 $

when       who    what, where, why
--------   ---    -------------------------------------------------------------- 
03/19/15   al     KW error fix - Add array length as an input parameter to get ASM info  
01/08/15   jyu    Added support for eLNA
...
typedef enum
{
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_tdscdma_elna_sleep
  (
    rfm_device_enum_type device,
    rfcom_tdscdma_band_type rf_band,
    rf_buffer_intf *script,
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_tdscdma_elna_wakeup
  (
    rfm_device_enum_type device,
    rfcom_tdscdma_band_type rf_band,
    rf_buffer_intf *script,
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_tdscdma_elna_set_gain
  (
    rfm_device_enum_type device,
    rfcom_tdscdma_band_type rf_band,
    rf_buffer_intf *script,
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_tdscdma_elna_trigger
  (
    rfm_device_enum_type device,
    rfcom_tdscdma_band_type rf_band,
    rf_buffer_intf *script,
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_tdscdma_elna_get_gain_index
  (
    rfm_device_enum_type device,
    rfcom_tdscdma_band_type rf_band,
    int8 system_gain,
