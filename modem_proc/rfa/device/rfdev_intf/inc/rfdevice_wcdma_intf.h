...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_wcdma_intf.h#1 $
...
04/27/15   rmb     Remove unused paramter autob_size from meas_script API
04/10/15   vbh     [Rx/Tx split] Add parameters for Rx_Disable 
...
/*----------------------------------------------------------------------------*/
boolean rfdevice_wcdma_rx_get_agc_reload_script
(
  rfm_device_enum_type rfm_dev, 
  rfcom_mode_enum_type rf_mode, 
  rfcom_wcdma_band_type rf_band,
