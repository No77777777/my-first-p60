...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_hdet_tdscdma_intf.h#1 $

when       who   what, where, why
--------   ---   ------------------------------------------------------------------- 
12/20/16   ry    Adding HDET disabling API
...
boolean rfdevice_hdet_tdscdma_tx_hdet_disable
(
  rfm_device_enum_type rfm_dev,
  rfcom_tdscdma_band_type rf_band
);
