...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_cdma_interface.h#1 $
...
/*----------------------------------------------------------------------------*/
boolean
rfdevice_cdma_create_rx_meas_disable_script
(
   rfdevice_trx_cdma_rx* rx_device,
   rf_buffer_intf* buf_obj_ptr,  
   rfm_cdma_band_class_type band,
...
/*----------------------------------------------------------------------------*/
boolean
rfdevice_cdma_rx_get_lna_state
(
  uint8* lna_rd,
  rfm_cdma_band_class_type band,
  rfdevice_rx_mode_type rx_mode,
