...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_cmn_intf.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
07/21/20   up      Added api to clear sub ID specific state info.
11/30/15   ry      RFA common support changes for FR25072 
...
07/24/15   zg      Added new API of rfdevice_cmn_power
...
boolean
rfdevice_cmn_get_selftest_rsb_coeff
(
  rfdevice_rxtx_common_class* cmn_device,
  rfm_mode_enum_type tech,
  rfcom_band_type_u band,
...
/*----------------------------------------------------------------------------*/
boolean rfdevice_cmn_get_rxtx_simultaneous_rat_support
(
  rfdevice_rxtx_common_class* cmn_device,
  boolean* is_rxtx_separate_rat
);
...
/*----------------------------------------------------------------------------*/
boolean rfdevice_cmn_clear_sub_id_info
(
  rfdevice_rxtx_common_class* cmn_device,
