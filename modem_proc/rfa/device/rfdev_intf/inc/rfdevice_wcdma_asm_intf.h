...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_wcdma_asm_intf.h#1 $

when       who    what, where, why
--------   ---    -------------------------------------------------------------- 
08/12/15   hm    asm grfc changes
...
#define RF_WCDMA_MAX_SSBI_SCRIPT_SIZE                                         0
/*----------------------------------------------------------------------------*/
/*! RFFE script size*/
#define RF_WCDMA_MAX_RFFE_SCRIPT_SIZE                                         100
/*----------------------------------------------------------------------------*/
/*! GRFC script size, maximum GRFC writes supported is 32*/
#define RF_WCDMA_MAX_GRFC_SCRIPT_SIZE                                          30
/*----------------------------------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_wcdma_asm_enable_rx_grfc
(
  ...
  /*----------------------------------------------------------------------------*/
 boolean rfdevice_wcdma_asm_update_state
(
  rfm_device_enum_type rfm_device,
  rfcom_wcdma_band_type rf_band,
  rf_buffer_intf *script,
