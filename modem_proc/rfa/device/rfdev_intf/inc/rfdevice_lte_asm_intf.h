...
$Header: //components/rel/rfa.mpss/4.11/device/rfdev_intf/inc/rfdevice_lte_asm_intf.h#1 $

when         who   what, where, why
--------   ---   ------------------------------------------------------------------- 
09/24/15   sb    pass carrier index to ASM driver 
...
extern "C" {
  ...
  boolean rfdevice_lte_asm_update_state
 (
   rfm_device_enum_type rfm_device,
   rfcom_lte_band_type rf_band,
   uint32 carrier_idx,
