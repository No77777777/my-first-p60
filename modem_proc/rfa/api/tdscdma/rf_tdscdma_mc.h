...
$Header: //components/rel/rfa.mpss/4.11/api/tdscdma/rf_tdscdma_mc.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/21/20   hal     QSH minidump changes for RFTECH TDSCDMA
...
03/04/15   jyu     Add Tx device into rf_tdscdma_mc_state variable
...
/*Put RxD timeline optimization feature here*/
#ifndef RF_TDSCDMA_RXD_TIMELINE_OPT
#define RF_TDSCDMA_RXD_TIMELINE_OPT
#endif
#endif

#ifdef FEATURE_RF_ASDIV
  /*TDS local control feature which could be mainlined later*/
...
#define RF_TDSCDMA_DEVICE_STATUS_READ_REG_LIST_LENGTH 8
#define RF_TDSCDMA_DEVICE_STATUS_READ_DEVICE_SUPPORT  3
...
typedef enum
{
  RF_TDSCDMA_DEVICE_STATUS_DEFAULT,
  RF_TDSCDMA_DEVICE_STATUS_RX,
  RF_TDSCDMA_DEVICE_STATUS_TX,
  RF_TDSCDMA_DEVICE_STATUS_MAX
} rf_tdscdma_device_status_rx_tx_enum_type;
...
typedef struct 
{
  ...
  rf_tdscdma_device_status_rx_tx_enum_type	rx_tx_type;   /*!< rx_tx type*/
} rf_tdscdma_mc_device_status_reg_list_type;

typedef struct 
{
  boolean device_enabled[RF_TDSCDMA_DEVICE_STATUS_READ_DEVICE_SUPPORT];
  uint8 reg_length[RF_TDSCDMA_DEVICE_STATUS_READ_DEVICE_SUPPORT];
  rf_tdscdma_mc_device_status_reg_list_type 
  reg_list[RF_TDSCDMA_DEVICE_STATUS_READ_DEVICE_SUPPORT][RF_TDSCDMA_DEVICE_STATUS_READ_REG_LIST_LENGTH];
} rf_tdscdma_mc_device_status_read_type;
...
typedef struct
{
  ...
  /*! @brief Current associated paired device info according to pri device. Default is RFM_INVALID_DEVICE */
  rfm_device_enum_type    curr_pri_paired_device;  

  /*! @brief Current secondary chain device info. Default is RFM_INVALID_DEVICE */
  rfm_device_enum_type    curr_sec_device;
  
  /*! @brief Current Tx chain device info. Default is RFM_INVALID_DEVICE */
  rfm_device_enum_type    curr_tx_device;  
  ...
  /*! @brief dynamic rxd indication from L1 */
  rfa_tdscdma_wakeup_rxd_ind_t rxd_wakeup_state;
#endif

  rf_tdscdma_mc_device_status_read_type device_status_read;
...
void rf_tdscdma_mc_asdiv_sleep_script(uint32 ant_position,rfm_device_enum_type pri_device,rfcom_tdscdma_band_type band);
