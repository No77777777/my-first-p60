...
$Header: //components/rel/rfa.mpss/4.11/api/meas/rfmeas_types.h#1 $
$DateTime: 2021/03/09 05:11:02 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/02/17   pv      Added SubID for source and target
...
typedef enum
{
   ...
   RFM_MEAS_SCENARIO_DO2L_CONNECTED,
...
typedef struct rfm_meas_header_struct
{
   rfcom_mode_enum_type   source_tech;
   rfcom_mode_enum_type   target_tech;
   sys_modem_as_id_e_type source_sub_id; /*!< Source Subscriber ID */
   sys_modem_as_id_e_type target_sub_id; /*!< Target Subscriber ID */
