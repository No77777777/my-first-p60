...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/api/gsm/ftm_gsm_ber.h#1 $ 
  $DateTime: 2021/03/09 05:11:02 $ 
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
11/15/17   vb      [CR2006577] Added FTM_GSM_NS_CHAIN_SELECT feature
...
enum
{
    FTM_GSM_BER_TRM_NO_CLIENT = 0xFF,
...
typedef PACK(struct)
{
    diagpkt_subsys_header_type        header;
    ftm_cmd_header_type               ftm_cmd_header;
    RxChainType                       ftm_ns_rx_chain_param;
}ftm_gsm_ber_ns_chain_header_type;
...
void ftm_gsm_ber_set_dev_state( uint8 gsm_curr_chain, ftm_gsm_ber_state_type new_state );
