...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/api/cdma/rfm_hdr.h#1 $
...
08/03/15   wwl     Add API header file for ASDiv SAR limits programmable
                   per RAT/band
03/26/15   wwl     Update wakeup TX V2 version to include PRX device instead of
                   passing band and channel parameters
