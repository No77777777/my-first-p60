...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/4.11/api/common/rfm_mode_types.h#1 $
...
06/04/15   ag      Removing Featurizing W+W mode addition for Tabasco2.0
04/15/15   ag      Featurizing W+W mode addition for Tabasco1.0
04/15/15   aak     Add mode for second WCDMA for W+W
...
typedef enum
{
  ...
  RFM_LTE_MODE_2,    /*!< Second LTE in L+L mode*/
