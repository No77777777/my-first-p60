...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/lte_LL1_log_ul.h#1 $
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_UL_PUSCH_TX_REPORT_VERSION 103
#define LTE_LL1_LOG_UL_NUMBER_OF_PUSCH_RECORDS_FIXED 20
#define LTE_LL1_LOG_UL_NUMBER_OF_PUSCH_SF_RECORDS_FIXED 10
...
typedef struct
{
  ...
  uint32 is_psdch	                      : 1;  //!< @internal TRUE for PSDCH channel
  uint32 reserved0                        : 10;
 ...
 *  100ms, whichever occurs first.
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_UL_PUCCH_TX_REPORT_VERSION 101
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_UL_SRS_TX_REPORT_VERSION 3
#define LTE_LL1_LOG_UL_NUMBER_OF_SRS_RECORDS_FIXED 20
#define LTE_LL1_LOG_UL_NUMBER_OF_SRS_SF_RECORDS_FIXED 10
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_UL_RACH_TX_REPORT_VERSION 6
