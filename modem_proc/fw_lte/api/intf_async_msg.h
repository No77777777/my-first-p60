...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_async_msg.h#1 $
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, PHYCHAN_SCHEDULE_CA, 0x9, lte_LL1_ul_phychan_schedule_ca_req_msg_struct),
  ...
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, VIRTUAL_TICK, 0xc, lte_LL1_virtual_tick_req_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, SCELL_STAT_CONFIG, 0xd, lte_LL1_sys_scell_stat_config_req_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, SCELL_STAT_DECONFIG, 0xe, lte_LL1_sys_scell_stat_deconfig_req_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, DL_CH_CONFIG, 0xf, lte_LL1_dl_ch_config_req_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, STACK_INFO_N_DDS, 0x10, lte_LL1_sys_stack_info_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, WAKEUP_N_DDS, 0x11, lte_LL1_async_config_app_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, SCELL_STAT_CONFIG_N_DDS, 0x12, lte_LL1_sys_scell_stat_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, SCELL_SEMI_STAT_CONFIG_N_DDS,0x13, lte_LL1_sys_scell_semi_stat_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, DL_CH_CONFIG_N_DDS, 0x14, lte_LL1_dl_ch_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, RUN_RXLM_RF_SCRIPT_N_DDS,0x15, lte_LL1_sys_run_rxlm_rf_script_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, FTL_SCELL_CONFIG_N_DDS, 0x16, lte_LL1_ftl_scell_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, MEAS_SCELL_N_DDS, 0x17, lte_LL1_meas_scell_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, NEIGHBOR_CELL_SRCH_N_DDS, 0x18, lte_LL1_srch_neighbor_cell_srch_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, MEAS_TTL_FTL_NCELL_DRX_N_DDS, 0x19, lte_LL1_meas_ttl_ftl_ncell_drx_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, PDCCH_RNTI_CHANGE_N_DDS, 0x20, lte_LL1_dl_pdcch_rnti_change_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, RXLM_DDS, 0x21, lte_LL1_async_rxlm_dds_req_msg_struct),
  LTE_LL1_ASYNC_REQ_COUNT=28,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, VIRTUAL_TICK,    0x9, lte_LL1_virtual_tick_cnf_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, SCELL_STAT_CONFIG,   0xa, lte_LL1_sys_scell_stat_config_cnf_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, SCELL_STAT_DECONFIG, 0xb, lte_LL1_sys_scell_stat_deconfig_cnf_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, DL_CH_CONFIG,        0xc, lte_LL1_dl_ch_config_cnf_msg_struct), 
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, RXLM_DDS, 0xd, lte_LL1_async_rxlm_dds_cnf_msg_struct),
  // will remove the following 3  
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, STOP, 0x4, lte_LL1_async_stop_cnf_msg_struct),
  LTE_LL1_ASYNC_CNF_COUNT=14,
