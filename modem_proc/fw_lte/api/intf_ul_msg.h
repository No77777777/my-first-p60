...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_ul_msg.h#1 $
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_UL, REQ, PHYCHAN_SCHEDULE_CA, 0xD, lte_LL1_ul_phychan_schedule_ca_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_UL, REQ, TX_LM_CONFIG_CA, 0xE, lte_LL1_ul_tx_lm_config_ca_req_msg_struct),
  LTE_LL1_UL_REQ_COUNT=15,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_UL, CNF, TX_LM_CONFIG_CA, 0x8, lte_LL1_ul_tx_lm_config_ca_cnf_msg_struct),
  LTE_LL1_UL_CNF_COUNT=9,
