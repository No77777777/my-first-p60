...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_async.h#1 $
...
}lte_LL1_async_rxlm_dds_req_struct;
LTE_LL1_INTF_MSG ( async_rxlm_dds_req );
...
} lte_LL1_async_rxlm_dds_cnf_struct;
LTE_LL1_INTF_MSG( async_rxlm_dds_cnf );
