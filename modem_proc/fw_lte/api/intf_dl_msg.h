...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_dl_msg.h#1 $
...
// End Odyssey only
  ...
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PMCH_DECODE, 0x2C, lte_LL1_dl_pmch_decode_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PMCH_DECODE_STOP, 0x2D, lte_LL1_dl_pmch_decode_stop_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, IQ_SAMPLE_CAPTURE, 0x2E, lte_LL1_dl_iq_sample_capture_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, CRSIC_LQICE, 0x2F, lte_LL1_dl_crsic_lqice_req_msg_struct),
  ...
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, HARQ_THROTTLING_ENABLE_DISABLE, 0x33, lte_LL1_harq_throttling_enable_disable_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PREDOMINANT_COLLIDING_INTERF_UPDATE, 0x34, lte_LL1_dl_predominant_colliding_interf_update_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, CLOCK_RATE_INFO , 0x35, lte_LL1_dl_clock_rate_info_req_msg_struct), ///< aperiodic CSF request, deququq in a separate q
  LTE_LL1_DL_REQ_COUNT=54,
...
// End Odyssey only
  ...
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, PMCH_DECODE_STOP, 0x18, lte_LL1_dl_pmch_decode_stop_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, IQ_SAMPLE_CAPTURE, 0x19, lte_LL1_dl_iq_sample_capture_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, CRSIC_LQICE, 0x1A, lte_LL1_dl_crsic_lqice_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, HARQ_THROTTLING_ENABLE_DISABLE, 0x1B, lte_LL1_harq_throttling_enable_disable_cnf_msg_struct),
  LTE_LL1_DL_CNF_COUNT=28,
