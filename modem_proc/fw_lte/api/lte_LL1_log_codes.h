...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/lte_LL1_log_codes.h#2 $
...
/*! @brief LTE LL1 log code base (extended into reserved range)
    LOG_LTE_BASE_C = 0xB010
    LOG_LTE_LL1_BASE_C_EXT = 0x0300 + (0xB010 - 0x0010) = 0xB300
*/
#define LOG_LTE_LL1_BASE_C_EXT                  (0x300 + (LOG_LTE_BASE_C - 0x0010))
...
#define LOG_LTE_LL1_RX_DBG_LOG_C     (0x8 + LOG_LTE_LL1_BASE_C)
...
// ----------------------------------------------------------------------------
// LTE IC Cell FTL log packet 0xB13D
// ----------------------------------------------------------------------------
#define LOG_LTE_LL1_SRCH_IC_CELL_FTL_RESULT_INT_LOG_C (0x2D + LOG_LTE_LL1_BASE_C)
...
// ----------------------------------------------------------------------------
// Rx toggle log packet 0xB136
// ----------------------------------------------------------------------------
/*! @brief LTE LL1 unformated debug packet */
#define LOG_LTE_LL1_RX_ON_TOGGLE_INFO_LOG_C    (0x26 + LOG_LTE_LL1_BASE_C)

// ----------------------------------------------------------------------------
//  uSleep info log packet 0xB13E
// ----------------------------------------------------------------------------
/*! @brief LTE LL1 unformated debug packet */
#define LOG_LTE_LL1_USLEEP_INFO_LOG_C         (0x2E + LOG_LTE_LL1_BASE_C)
...
/*! @brief LTE LL1 Serving Cell FTL CORR log code */
#define LOG_LTE_LL1_SERVING_CELL_FTL_CORR_LOG_C   (0x33 + LOG_LTE_LL1_BASE_C)
...
#define LOG_LTE_LL1_CSF_ADAPTATION_LOG_C               (0x37 + LOG_LTE_LL1_BASE_C)
...
#define LOG_LTE_LL1_UERS_RESULTS_LOG_C      (0x0D + LOG_LTE_LL1_BASE_C_EXT)

// ----------------------------------------------------------------------------
// LTE-D
// ----------------------------------------------------------------------------
#define LOG_LTE_LL1_RXAGC_LTED_LOG_C          (0x44 + LOG_LTE_LL1_BASE_C)
#define LOG_LTE_LL1_LTED_VECTOR_SF_LOG_C      (0x45 + LOG_LTE_LL1_BASE_C)
#define LOG_LTE_LL1_LTED_VECTOR_DEBUG_LOG_C   (0x46 + LOG_LTE_LL1_BASE_C)
#define LOG_LTE_LL1_PSDCH_DECODE_RESULT_LOG_C (0x47 + LOG_LTE_LL1_BASE_C)

// ----------------------------------------------------------------------------
// Transmit front end
// ----------------------------------------------------------------------------

// The last valid LTE_LL1_LOG ID.
// ML1 needs to forward log masks to LL1, and this macro contains the last valid 
// log code ID. It must be kept up to date as new codes are added.
#define LOG_LTE_LL1_MAX_LOG_ID                      (0x48 + LOG_LTE_LL1_BASE_C)

// ----------------------------------------------------------------------------
// RX ANT INFO
// ----------------------------------------------------------------------------
#define LOG_LTE_LL1_RX_ANT_INFO_LOG_C                (0x4B + LOG_LTE_LL1_BASE_C)
