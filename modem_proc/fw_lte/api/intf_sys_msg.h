...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_sys_msg.h#2 $
 ...
 *   <tr><td>LTE_LL1_SYS_REQ_FED_BASED_RF_TUNE</td><td> lte_LL1_sys_fed_based_rf_tune_req_struct</td></tr>
 *   <tr><td>LTE_LL1_SYS_REQ_LTED_SCHED</td><td> lte_LL1_sys_lted_sched_req_struct</td></tr>
 *   <tr><td>LTE_LL1_SYS_REQ_FBRX</td><td> lte_LL1_sys_fbrx_req_struct</td></tr>
 * </table>
 ...
 *   <tr><td>LTE_LL1_SYS_CNF_FED_BASED_RF_TUNE</td><td> lte_LL1_sys_sys_fed_based_rf_tune_cnf_struct</td></tr>
 *   <tr><td>LTE_LL1_SYS_CNF_LTED_SCHED</td><td> lte_LL1_sys_lted_sched_cnf_struct</td></tr>
 *   <tr><td>LTE_LL1_SYS_CNF_FBRX</td><td> lte_LL1_sys_fbrx_cnf_struct</td></tr>
 * </table>
 * @section Indications
 * <table border>
 *   <tr><td><b>UMID</b></td><td><b>Structure</b></td></tr>
 ...
 *   <tr><td>LTE_LL1_SYS_IND_TRAFFIC_MODE_SAMPLE_REC_DONE</td><td>lte_LL1_sys_traffic_mode_sample_rec_done_ind_msg_struct</td></tr> 
 * </table>
 * @}
 */
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, MACROSLEEP_CANCEL,        0x24, lte_LL1_sys_macrosleep_cancel_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, FED_BASED_RF_TUNE,        0x25, lte_LL1_sys_fed_based_rf_tune_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, LTED_SCHED,               0x26, lte_LL1_sys_lted_sched_req_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, FBRX,                     0x27, lte_LL1_sys_fbrx_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, ONE_RX,                   0x28, lte_LL1_sys_one_rx_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, USLEEP_DISABLE,           0x29, lte_LL1_sys_usleep_disable_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, VIRTUAL_TICK,             0x2A, lte_LL1_virtual_tick_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, STACK_INFO,               0x2B, lte_LL1_sys_stack_info_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, DL_CH_CONFIG,             0x2C, lte_LL1_dl_ch_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, USLEEP_MODE_SWITCH,       0x2D, lte_LL1_sys_usleep_mode_switch_req_msg_struct),
#ifdef FEATURE_MODEM_ANTENNA_SWITCH_DIVERSITY
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, ANT_SWITCH,               0x2E, lte_LL1_sys_ant_switch_req_msg_struct),
  LTE_LL1_SYS_REQ_COUNT=0x2F,
#else
  LTE_LL1_SYS_REQ_COUNT=0x2E,
#endif
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, MACROSLEEP_CANCEL,        0x1e, lte_LL1_sys_macrosleep_cancel_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, FED_BASED_RF_TUNE,        0x1f, lte_LL1_sys_fed_based_rf_tune_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, LTED_SCHED,               0x20, lte_LL1_sys_lted_sched_cnf_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, FBRX,                     0x21, lte_LL1_sys_fbrx_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, ONE_RX,                   0x22, lte_LL1_sys_one_rx_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, USLEEP_DISABLE,           0x23, lte_LL1_sys_usleep_disable_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, VIRTUAL_TICK,             0x24, lte_LL1_virtual_tick_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, DL_CH_CONFIG,             0x25, lte_LL1_dl_ch_config_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, USLEEP_MODE_SWITCH,       0x26, lte_LL1_sys_usleep_mode_switch_cnf_msg_struct),
#ifdef FEATURE_MODEM_ANTENNA_SWITCH_DIVERSITY
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, ANT_SWITCH,               0x27, lte_LL1_sys_ant_switch_cnf_msg_struct),
  LTE_LL1_SYS_CNF_COUNT=0x28,
#else
  LTE_LL1_SYS_CNF_COUNT=0x27,
#endif
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, TRAFFIC_MODE_SAMPLE_REC_DONE, 0x29, lte_LL1_sys_traffic_mode_sample_rec_done_ind_msg_struct),  
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_RXAGC_LTED_LOG_C, 0x2A, lte_LL1_log_rxagc_lted_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_LTED_VECTOR_SF_LOG_C, 0x2B, lte_LL1_log_lted_vector_sf_ind_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_PSDCH_DECODE_RESULT_LOG_C, 0x2C, lte_LL1_log_demback_psdch_decoding_results_ind_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, FWQTA_START, 0x2D, lte_LL1_sys_fwqta_start_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, FWQTA_END, 0x2E, lte_LL1_sys_fwqta_end_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, DOPPLER, 0x2F, lte_LL1_sys_doppler_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, ARD_C1RX, 0x30, lte_LL1_sys_ard_c1rx_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, ARD_CSF_RESULTS, 0x31, lte_LL1_sys_ard_csf_results_ind_msg_struct),
  LTE_LL1_SYS_IND_COUNT=0x32
