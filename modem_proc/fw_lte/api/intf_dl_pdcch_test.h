...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_dl_pdcch_test.h#1 $
...
}  lte_LL1_dl_pdcch_test_req_carrier_payload_struct;

typedef struct {
  lte_LL1_req_header_struct   req_hdr; ///< Common request parameters
  uint8 num_UL_carriers;
  uint8 num_DL_carriers;
  lte_LL1_dl_pdcch_test_req_carrier_payload_struct carrier_cfg[LTE_LL1_CARRIER_COUNT];
