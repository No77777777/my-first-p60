...
$Header: //components/rel/fw_lte.mpss/17.0.c4/api/intf_srch_msg.h#1 $
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SRCH, REQ, MEAS_PATTERN_UPDATE, 0x14, lte_LL1_meas_pattern_update_req_msg_struct),
  LTE_LL1_SRCH_REQ_COUNT=21,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SRCH, CNF, MEAS_PATTERN_UPDATE, 0xE, lte_LL1_meas_pattern_update_cnf_msg_struct),
  LTE_LL1_SRCH_CNF_COUNT=15,
