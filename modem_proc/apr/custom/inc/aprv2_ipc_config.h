...
/*=============================================================================
  ...
  $Header: //components/rel/apr.common/3.0/custom/inc/aprv2_ipc_config.h#9 $
  $Author: svutukur $
...
#define APRV2_REMOTE_SS_SDSP      ("dsps")
...
{
  {APR_QSOC_MODEM_CLIENT,QSOCKET_APR_ADSP_MDSP_ID, 2, 0, 1}
};
...
static apr_port_info_t glink_port_data[ GLINK_PORTS ] = {  
    ...
    //{APRV2_REMOTE_SS_APPS, APRV2_IPC_APPS2_PORT_NAME, APR_GLINK_APPS_REMOTE_SS_ID, 2},
    {APRV2_REMOTE_SS_CDSP, APRV2_IPC_CDSP_PORT_NAME, APR_GLINK_CDSP_REMOTE_SS_ID, 2},
    {APRV2_REMOTE_SS_SDSP, APRV2_IPC_SDSP_PORT_NAME, APR_GLINK_SDSP_REMOTE_SS_ID, 3},
};
...
static apr_qsocket_port_info_t apr_qsocket_port_info_table[]= 
{
   {APR_QSOC_ADSP_SERVICE,QSOCKET_APR_ADSP_MDSP_ID, 2, 1, 1}
};
...
#ifdef slpi_proc //sdsp starts here...

#ifdef APR_RPD
#define APRV2_PL_DEFAULT_DOMAIN_ID_V ( APRV2_IDS_DOMAIN_ID_SDSP_V )
#define APRV2_PL_DEFAULT2_DOMAIN_ID_V ( APRV2_IDS_DOMAIN_ID_SDSP_V )
...
static aprv2_ipc_send_t aprv2_ipc_glink_send_dispatch_table[ ] = {
 ...
 {APRV2_IDS_DOMAIN_ID_SIM_V,aprv2_ipc_local,NULL},
 {APRV2_IDS_DOMAIN_ID_PC_V,aprv2_ipc_unsupport_domain,NULL},
 {APRV2_IDS_DOMAIN_ID_MODEM_V,aprv2_ipc_unsupport_domain,NULL},
 {APRV2_IDS_DOMAIN_ID_ADSP_V,aprv2_ipc_mpd_send,NULL},
 {APRV2_IDS_DOMAIN_ID_APPS_V,aprv2_ipc_unsupport_domain, NULL},
 {APRV2_IDS_DOMAIN_ID_MODEM2_V,aprv2_ipc_unsupport_domain,NULL},
 {APRV2_IDS_DOMAIN_ID_APPS2_V,aprv2_ipc_unsupport_domain,NULL},
 {APRV2_IDS_DOMAIN_ID_SDSP_V,aprv2_ipc_local,NULL},
 {APRV2_IDS_DOMAIN_ID_CDSP_V,aprv2_ipc_unsupport_domain,NULL},
};

static apr_port_info_t glink_port_data[ GLINK_PORTS ] = {};

#endif  //slpi_proc APR_UPD
