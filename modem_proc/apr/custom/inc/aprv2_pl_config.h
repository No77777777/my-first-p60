...
/*
  ...
  $Header: //components/rel/apr.common/3.0/custom/inc/aprv2_pl_config.h#2 $
  $Author: pwbldsvc $
*/
...
#define APRV2_PL_LOCAL_DNS_ARRAY_V \
  ...
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_MODEM_V, APRV2_IDS_SERVICE_ID_MODEM_AMS_V ),       "qcom.audio.ams" }, \
  /* Deprecated entries. */ \
