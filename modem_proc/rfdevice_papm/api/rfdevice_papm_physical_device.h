...
$Header: //components/rel/rfdevice_papm.mpss/1.32/api/rfdevice_papm_physical_device.h#1 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---    -------------------------------------------------------------
05/08/15   sn     Added ASM logical instance
...
private:
  ...
  void create_papm_asm_object(rfc_logical_device_info_type* device_cfg);

  rfdevice_papm_common* papm_obj_ptr;

  rfdevice_papm_asm* papm_asm_obj_ptr;
  
  uint8 sleep_wakeup_vote;
 };
