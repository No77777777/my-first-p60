...
$Header: //components/rel/rfdevice_papm.mpss/1.32/api/rfdevice_papm_types.h#1 $

when       who     what, where, why
------------------------------------------------------------------------------- 
12/27/19   smi     Add support to get RFFE device register address list
06/29/17   dh      Updated papm data enum with RFDEVICE_PAPM_LDO_DATA
...
typedef enum
{
  ...
  RFDEVICE_PAPM_REQ_ENUM_SIZE = RFDEVICE_PAPM_INVALID_DATA
