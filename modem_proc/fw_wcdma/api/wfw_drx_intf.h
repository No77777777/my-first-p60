...
$Header: //source/qcom/qct/modem/fw/components/fw_wcdma.mpss/rel/17.0/api/wfw_drx_intf.h#1 $
...
typedef struct
{
  ...
  UWord8 mosFetEnable;
  /*! If true, detect non-spec compliant NodeBs (e.g. certain test boxes) and 
      implement workarounds to allow FET gaps to be opened. This may also
      result in DCCH messages sometimes being lost.
   
      If false, the FET power benefit will not be observed with non-spec
      compliant NodeBs. */
  UWord8 enableNonSpecNodeBDet;
