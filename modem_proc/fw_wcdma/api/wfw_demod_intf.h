...
$Header: //source/qcom/qct/modem/fw/components/fw_wcdma.mpss/rel/17.0/api/wfw_demod_intf.h#1 $
$DateTime: 2019/06/16 13:38:34 $ $Author: deepemm $
...
#define WFW_DEMOD_NUM_MIMO_STREAMS              1
...
#define WFW_DEMOD_NUM_MAX_CELLS 13

/*! @brief Number of fingers  */
#define WFW_DEMOD_NUM_MAX_FINGERS 30
...
#define WFW_NUM_MAX_UPLINK_CARRIERS 2
...
/*! @brief Decode buffer memory size
   ...
   For MIMO/3C it increases to 23040. Even though the demfront changes
   are not present, change the size since the HW supports it.
*/
#define WFW_DEMOD_TD_DOB_MEM_SIZE              13184
...
*/
#define WFW_DEMOD_NON_HS_TD_DOB_MEM_START      0

/*! @brief Start address of DOB for HS */
#define WFW_DEMOD_HS_DOB_MEM_START             WFW_DEMOD_NON_HS_TD_DOB_MEM_SIZE
...
/*! @brief Total number of CCTrCh Tables
  (1 DPCH or 2 R99 SCCPCH ) * 2 subs */
  // for 2 subs increase size by 2 in W idle idle, since SW needs extra cctrch to prepare for switch 
#define WFW_DBACK_NUM_CCTRCH_TABLES 4   
...
#define WFW_DBACK_PCCPCH_CCTRCH_ID_FIRST 4  //push the start index to 4
#define WFW_DBACK_PCCPCH_CCTRCH_ID_LAST 7  //push the end index to 7
...
/* TTI 1 */
#define WFW_HS_DECOB_T0_C0_S0           WFW_DEMOD_HS_DOB_MEM_START + 0
//#define WFW_HS_DECOB_T0_C0_S1           WFW_DEMOD_HS_DOB_MEM_START + 1328
#define WFW_HS_DECOB_T0_C1_S0           WFW_DEMOD_HS_DOB_MEM_START + 1328
//#define WFW_HS_DECOB_T0_C1_S1           WFW_DEMOD_HS_DOB_MEM_START + 3984

#if WFW_DEMOD_NUM_MAX_CARRIERS == 3
#define WFW_HS_DECOB_T0_C2_S0           WFW_DEMOD_HS_DOB_MEM_START + 3984
#define WFW_HS_DECOB_T0_C2_S1           WFW_DEMOD_HS_DOB_MEM_START + WFW_DBACK_INVALID_DOB_ADDR
#endif /* WFW_DEMOD_NUM_MAX_CARRIERS == 3 */

 /* TTI 2 */
#define WFW_HS_DECOB_T1_C0_S0           WFW_DEMOD_HS_DOB_MEM_START + 2656
//#define WFW_HS_DECOB_T1_C0_S1           WFW_DEMOD_HS_DOB_MEM_START + 6640
#define WFW_HS_DECOB_T1_C1_S0           WFW_DEMOD_HS_DOB_MEM_START + 3984
//#define WFW_HS_DECOB_T1_C1_S1           WFW_DEMOD_HS_DOB_MEM_START + 9296

#if WFW_DEMOD_NUM_MAX_CARRIERS == 3
#define WFW_HS_DECOB_T1_C2_S0           WFW_DEMOD_HS_DOB_MEM_START + 9296
#define WFW_HS_DECOB_T1_C2_S1           WFW_DEMOD_HS_DOB_MEM_START + WFW_DBACK_INVALID_DOB_ADDR
#endif /* WFW_DEMOD_NUM_MAX_CARRIERS == 3 */

/* TTI 3 */
#define WFW_HS_DECOB_T2_C0_S0           WFW_DEMOD_HS_DOB_MEM_START + 5312
//#define WFW_HS_DECOB_T2_C0_S1           WFW_DEMOD_HS_DOB_MEM_START + 11952
#define WFW_HS_DECOB_T2_C1_S0           WFW_DEMOD_HS_DOB_MEM_START + 6640
//#define WFW_HS_DECOB_T2_C1_S1           WFW_DEMOD_HS_DOB_MEM_START + 14608

#if WFW_DEMOD_NUM_MAX_CARRIERS == 3
#define WFW_HS_DECOB_T2_C2_S0           WFW_DEMOD_HS_DOB_MEM_START + 14608
#define WFW_HS_DECOB_T2_C2_S1           WFW_DEMOD_HS_DOB_MEM_START + WFW_DBACK_INVALID_DOB_ADDR
#endif /* WFW_DEMOD_NUM_MAX_CARRIERS == 3 */

/* TTI 4 */
#if WFW_DBACK_HS_DECOB_NUM_TTI >= 4

#define WFW_HS_DECOB_T3_C0_S0           WFW_DEMOD_HS_DOB_MEM_START + 7968
//#define WFW_HS_DECOB_T3_C0_S1           WFW_DEMOD_HS_DOB_MEM_START + 17264
#define WFW_HS_DECOB_T3_C1_S0           WFW_DEMOD_HS_DOB_MEM_START + 9296
//#define WFW_HS_DECOB_T3_C1_S1           WFW_DEMOD_HS_DOB_MEM_START + 19920

#if WFW_DEMOD_NUM_MAX_CARRIERS == 3
#define WFW_HS_DECOB_T3_C2_S0           WFW_DEMOD_HS_DOB_MEM_START + 19920
#define WFW_HS_DECOB_T3_C2_S1           WFW_DEMOD_HS_DOB_MEM_START + WFW_DBACK_INVALID_DOB_ADDR
#endif /* WFW_DEMOD_NUM_MAX_CARRIERS == 3 */
...
#define WFW_VPE_HW_MAX_CELLS    13
#define WFW_VPE_HW_MAX_FINGERS  30
...
typedef enum
{
  ...
  WFW_DEMOD_PICH_ASYNC_READ_SS_WNW_RLP_POS_IDX,
...
typedef struct
{
  ...
  /*! PICH demod info */
  WfwDemodIndInfoStruct pichDemodInfo[WFW_NUM_SYNC_INTERFACES ];
  ...
  WfwDemodQxtInfoStruct qxtInfo[WFW_NUM_SYNC_INTERFACES];
  ...
  Word16 refCntAdj[WFW_NUM_SYNC_INTERFACES][WFW_RXAGC_MAX_ANTENNAS];
  ...
  WfwDemodPichAsyncReadStruct pichAsyncReadInfo[WFW_NUM_SYNC_INTERFACES];
...
typedef struct
{
  ...
  UWord32 refCnt[WFW_NUM_SYNC_INTERFACES];

  /*! Tx system time and frame number up to 4096 frames
      BIT(0:18) = Cx8 Cnt in frame, BIT(19:31) = frame count */
  UWord32 txCnt[WFW_NUM_SYNC_INTERFACES];
...
typedef struct
{
  ...
  UWord32 ctchIndicator:1;           /* Bit 31 */
...
typedef struct
{
  ...
  UWord8 fwDecobEn;
  /*! Disable multiple traceback */
  UWord8 disableMultiTraceback;
  /*! Disable nonCrc TrCh LVA */
  UWord8 disableNonCrcTrChLva;
...
typedef struct
{
  ...
  UWord16 lvaAtt:1;                    /* Bit 15 */

  /* Word4 */
  UWord16 qtaGap:1;                    /* Bit 0 */
  UWord16 desenseGap:1;                /* Bit 1 */
  UWord16 lvaTraceback:4;              /* Bit 2-5 */
  UWord16 :14;                         /* Bits 15:6*/
...
typedef struct
{
  ! NonHS DOB base addr for SVD
  UWord32 vdDobBaseAddrPtr;
  ! NonHS/HS DOB base addr for TDEC
  UWord32 tdDobBaseAddrPtr;
  ! NonHS/HS DOB base addr for TDEC
  UWord32 tdNonHsDobBaseAddrPtr;
  ! NonHS/HS DOB base start line for TDEC
  UWord32 tdDobBaseStartLine;
  ! HS DOB size in words
  UWord32 hsTdDobLengthWords;
  To provide the cluster ID for A2 driver
  UWord8 clusterId;

  // W2L- nQTA

  ! NonHS TDec Decob base addr for offload during W2LNQTA
  UWord32 nonhsTdecDobOffloadAddrPtr;
   HS TDec Decob base addr for offload during W2LNQTA
  UWord32 hsTdecDobOffloadAddrPtr;
  ! NonHS SVD Decob base addr for offload during W2LNQTA
  UWord32 vdDobOffloadAddrPtr;
} WfwDembackDecobBaseAddrStruct;
*/
...
#if 1
/*! @brief SRPlog structure */
typedef struct
{
   /* Word 0 */
   UWord32 srpState :1;
   UWord32 selFiltCoeff :4;
   UWord32 srpFifoState :4;
   UWord32 srpGapCnt  :6;
   UWord32 srpBoostOffset :3;
   UWord32 hsSnrEst :8;
   UWord32 demodPath :2;
   UWord32 :4;
   ...
   /* Word 8 */
   Word32 srpMse9 :16;
   Word32 cbaOffsetRake :8;
   Word32 cbaOffsetQice :8;


   /* Word 9 */
   UWord32 cbaUnfiltCqiRake :10;
   UWord32 cbaUnfiltCqiQice :10;
   UWord32 cbaFiltCqiRake :10;
   Word32 :2;

   /* Word 10 */
   UWord32 cbaFiltCqiQice :10;
   UWord32 srpCqiQ4 :10;
   UWord32 speedFiltAlph :12;

   /* Word 11 */
   Word32 srpCbaOffset  :8;
   Word32 srpSchedRate :11;
   Word32 srpEnableFlag :8;
   Word32 :5;
...
typedef struct
{
   Word32 srpMmseThres :16;
   Word32 :16;

   wfwSrpLoggingStruct wfwSrpLogging;
}wfwSrpLoggingHeaderStruct;
#endif
...
typedef struct
{
  ...
  wfwSrpLoggingHeaderStruct wfwSrpLoggingHeader;
...
typedef struct {
  ...
  UWord16 pcovCondVal:3;     /*Bits 12:14 PCOV Cond value */
  UWord16 pcovEnabled:1;     /*Bits 15 PCOV enable status in fw */

  /*HWord47*/
  UWord8 cov0_rxx;           /* COV0 Rxx value */
  UWord8 cov0_ryy;           /* COV0 Ryy value */
  Word8 cov0_rxy_re;         /* COV0 Rxy RE value */
  Word8 cov0_rxy_im;         /* COV0 Rxy IM value */

  /*HWord48*/
  UWord8 ioc_x;              /* Ioc_x value */
  UWord8 ioc_y;              /* Ioc_y value */
  Word8 ioc_xy_re;           /* Ioc_xy RE value */
  Word8 ioc_xy_im;           /* Ioc_xy IM value */
  ...
  /*HWord50*/
  UWord16 covSkipBmsk:8;      /* COV skipped per block */
  UWord16 :8;
...
/*!@brief Demod IRPM MCVS request parameters from L1 */
typedef struct
{
  UWord8  en:1;
  UWord8  ackToggle;
  UWord32 iterSched;
} WfwDemodIrpmMCVSAsyncWriteStruct __attribute__((aligned(32)));

/*!@brief Demod IRPM MCVS control parameters to L1 */
typedef struct
{
  UWord32 iterSched;
} WfwDemodIrpmMCVSAsyncReadStruct  __attribute__((aligned(32)));
...
/*!@brief Demod PCOV control paraemeters */
typedef struct
{
  UWord16 pcovEn;     /* PCOV enable (1) Disable (0) */
  UWord16 covSubSamplingEn;
} WfwDemodPcovAsyncWriteStruct;
...
typedef struct
{
  ...
  */
  ...
  /*! This flag would be set by WL1, once in a QSET : 
      servingCell ECIO - (except serving cell) MaxCellECIO < 10*/
  UWord32 qsetECIODiffFlag: 4;                       /* Bits 31:30 */
  ...
  */
  ...
  /* SRP SNR AND CQI boost indicator */
  UWord8 srpSnrBoostInd;
