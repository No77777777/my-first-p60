...
$Header: //source/qcom/qct/modem/fw/components/fw_wcdma.mpss/rel/17.0/api/wfw_misc_intf.h#1 $ $DateTime: 2019/06/16 13:38:34 $ $Author: deepemm $
...
/*! Number of carriers accounts for W+W */
#define WFW_AGC_POWER_NUM_CARRIERS              (4)
...
typedef struct
{
  ...
  WfwMiscXoAsyncWriteStruct xo[WFW_NUM_SYNC_INTERFACES];
  ...
  UWord32 rfPllSettlingTimeCx8[WFW_NUM_SYNC_INTERFACES];
  ...
  UWord32 rfMeasPreloadOffsetTimeCx8[WFW_NUM_SYNC_INTERFACES];

  /*!RF preload_offset in cx8: tune back, home; must be less than num Cx8's in a frame */
  UWord32 rfHomePreloadOffsetTimeCx8[WFW_NUM_SYNC_INTERFACES];

  /*! Flag to bypass undoAGC in RxAGC */
  UWord16 disableUndoAGC;
  /*! Flag to bypass forced RLF in ERR_FATAL scenario */
  UWord16 disableRlfRecovery;
...
typedef struct
{
  ...
  WfwMiscXoAsyncReadStruct xo[WFW_NUM_SYNC_INTERFACES];
...
typedef struct
{
    ...
    WfwCoexFreqChanIDTableStruct asyncFreqTable; 
