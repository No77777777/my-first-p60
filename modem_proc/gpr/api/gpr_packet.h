 ...
 *
 *  Copyright (c) 2018-2020 Qualcomm Technologies, Inc. and/or its subsidiaries.
 *  All Rights Reserved.
 *  Qualcomm Technologies Proprietary and Confidential.
 */
// clang-format off
/*
$Header: //commercial/MPSS.HA.1.1/Main/modem_proc/gpr/api/gpr_packet.h#2 $
*/
// clang-format on
...
/** Max Packet which can be allocated by GPR **/
#define GPR_MAX_ALLOC_PKT_SIZE 4096
