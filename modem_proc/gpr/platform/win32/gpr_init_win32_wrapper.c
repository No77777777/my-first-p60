...
struct ipc_dl_t gpr_win32_ipc_dl_table[GPR_PL_NUM_TOTAL_DOMAINS_V]= {
   //{GPR_IDS_DOMAIN_ID_MODEM_V,ipc_dl_csmd_init, ipc_dl_csmd_deinit},
   { GPR_IDS_DOMAIN_ID_ADSP_V, ipc_dl_csmd_init, ipc_dl_csmd_deinit },
...
GPR_INTERNAL uint32_t gpr_drv_init(void)
{
   ...
   uint32_t  rc;
   uint32_t num_domains = sizeof(gpr_win32_ipc_dl_table)/sizeof(ipc_dl_t);
   rc = gpr_drv_internal_init(gpr_win32_ipc_dl_table,
                              num_domains,
