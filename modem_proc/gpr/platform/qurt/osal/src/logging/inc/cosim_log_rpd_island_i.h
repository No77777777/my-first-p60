...
#ifndef _COSIM_LOG_RPD_ISLAND_I_H_
#define _COSIM_LOG_RPD_ISLAND_I_H_
...
typedef union ar_rpd_dbg_log_header_word_t ar_rpd_dbg_log_header_word_t;
union ar_rpd_dbg_log_header_word_t
{
   uint32_t w;
   struct {
...
typedef struct ar_rpd_dbg_log_msg_t
{
   ar_rpd_dbg_log_header_word_t msg_header;
   const char* msg_format_ptr;
   const char* msg_filename_ptr;
}
ar_rpd_dbg_log_msg_t;
...
#endif // #ifndef _COSIM_LOG_RPD_ISLAND_I_H_
