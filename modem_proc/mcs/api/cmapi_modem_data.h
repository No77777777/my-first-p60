...
===========================================================================*/
/* Cause to be filled in by the metrics when Cell Update is not the cause      
 * for call end */
#define CMAPI_MODEM_DATA_CELL_UPDATE_CAUSE_NONE (0xFF)
...
/*===========================================================================
  FUNCTION:  cmapi_modem_data_volte_call_start_ind
===========================================================================*/
/** @ingroup cmapi_modem_data_volte_call_start_ind 
  API invoked by CMAPI client when a VoLTE call is started. CMAPI logs the
  current valid QSH metric index for LRRC and compares it to the call end
  metric index

  @datatypes 
  #sys_modem_as_id_e_type \n
  
  @params[in] AS_ID on which the call is started.
  
  @return
  cmapi_err_e_type: Enum for error 

  @dependencies
  cmapi_modem_data_cfg() should be called prior to this API.

*/
cmapi_err_e_type cmapi_modem_data_volte_call_start_ind
(
  sys_modem_as_id_e_type subs_id
);
