...
$Header: //components/rel/mcs.mpss/5.2/api/vstmr_1x.h#6 $
...
/*! @brief Nominal 1X FCW value in Q-VSTMR_FCW_FRAC_BITS.
           (1.2288 MHz * 8) / 19.2e6 = 0.512 * 2^VSTMR_FCW_FRAC_BITS
           = 36893488147419103.232
           = 0x83126E978D4FDF (floored)
*/
#define VSTMR_1X_FCW_EXT           (0x83126E978D4FDFuLL)

/*! @brief Nominal 1X FCW inverse value in Q-VSTMR_FCW_INV_FRAC_BITS.
           1 / ((1.2288 MHz * 8) / 19.2e6)
           = 1/(0.512) * 2^VSTMR_FCW_INV_FRAC_BITS
           = 0x1F4000000000000
*/
#define VSTMR_1X_FCW_INV_EXT       (0x1F4000000000000uLL)
...
#define VSTMR_1X_FCW_ERR_RANGE     (0xFFFFF)
#define VSTMR_1X_FCW_EXT_ERR_RANGE (((uint64)VSTMR_1X_FCW_ERR_RANGE)<<VSTMR_FCW_FRAC_BITS_EXT)

/*! @brief Min/Max FCW in Q30.
*/
#define VSTMR_1X_FCW_MIN           (VSTMR_1X_FCW - VSTMR_1X_FCW_ERR_RANGE)
#define VSTMR_1X_FCW_MAX           (VSTMR_1X_FCW + VSTMR_1X_FCW_ERR_RANGE)

/*! @brief Min/Max FCW in Q-VSTMR_FCW_FRAC_BITS.
*/
#define VSTMR_1X_FCW_EXT_MIN       (VSTMR_1X_FCW_EXT - VSTMR_1X_FCW_EXT_ERR_RANGE)
#define VSTMR_1X_FCW_EXT_MAX       (VSTMR_1X_FCW_EXT + VSTMR_1X_FCW_EXT_ERR_RANGE)
...
/*! @brief Defines RTC modulo inverse in Q64.
           Formula: floor((2^64)/VSTMR_1X_RTC_MODULO))
*/
#define VSTMR_1X_RTC_MODULO_INV    (0x2AAAAAAAAAuLL)
