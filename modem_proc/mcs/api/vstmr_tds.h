...
$Header: //components/rel/mcs.mpss/5.2/api/vstmr_tds.h#6 $
...
/*! @brief Nominal TDS FCW value in Q-VSTMR_FCW_FRAC_BITS.
           (10.24 MHz) / 19.2e6 = (0.533..) * 2^VSTMR_FCW_FRAC_BITS
           = 38430716820228232.533..
           = 0x88888888888888 (floored)
*/
#define VSTMR_TDS_FCW_EXT               (0x88888888888888uLL)

/*! @brief Nominal TDS FCW inverse value in Q-VSTMR_FCW_INV_FRAC_BITS.
           1 / ((10.24 MHz) / 19.2e6)
           = 1.875 * 2^VSTMR_FCW_INV_FRAC_BITS
           = 0x1E0000000000000
*/
#define VSTMR_TDS_FCW_INV_EXT           (0x1E0000000000000uLL)
...
#define VSTMR_TDS_FCW_ERR_RANGE         (0xFFFFF)
#define VSTMR_TDS_FCW_EXT_ERR_RANGE     (((uint64)VSTMR_TDS_FCW_ERR_RANGE)<<VSTMR_FCW_FRAC_BITS_EXT)

/*! @brief Min/Max FCW in Q30.
*/
#define VSTMR_TDS_FCW_MIN               (VSTMR_TDS_FCW - VSTMR_TDS_FCW_ERR_RANGE)
#define VSTMR_TDS_FCW_MAX               (VSTMR_TDS_FCW + VSTMR_TDS_FCW_ERR_RANGE)

/*! @brief Min/Max FCW in Q-VSTMR_FCW_FRAC_BITS.
*/
#define VSTMR_TDS_FCW_EXT_MIN           (VSTMR_TDS_FCW_EXT - VSTMR_TDS_FCW_EXT_ERR_RANGE)
#define VSTMR_TDS_FCW_EXT_MAX           (VSTMR_TDS_FCW_EXT + VSTMR_TDS_FCW_EXT_ERR_RANGE)
...
/*! @brief Defines RTC modulo inverse in Q64.
           Formula: floor((2^64)/VSTMR_TDS_RTC_MODULO))
*/
#define VSTMR_TDS_RTC_MODULO_INV        (0xA3D70A3D7uLL)
