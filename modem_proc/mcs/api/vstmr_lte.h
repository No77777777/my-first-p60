...
$Header: //components/rel/mcs.mpss/5.2/api/vstmr_lte.h#6 $
...
/*! @brief Nominal LTE FCW value in Q-VSTMR_FCW_FRAC_BITS.
           = (30.72 MHz) / 19.2e6 = 1.6 * 2^VSTMR_FCW_FRAC_BITS
           = 115292150460684697.6
           = 0x199999999999999 (floored)
*/
#define VSTMR_LTE_FCW_EXT           (0x199999999999999uLL)

/*! @brief Nominal LTE FCW inverse value in Q-VSTMR_FCW_INV_FRAC_BITS.
           = 1/((30.72 MHz)/19.2e6) = 1/1.6 * 2^VSTMR_FCW_INV_FRAC_BITS
           = 0xA0000000000000
*/
#define VSTMR_LTE_FCW_INV_EXT       (0xA0000000000000uLL)
...
#define VSTMR_LTE_FCW_ERR_RANGE     (0xFFFFF)
#define VSTMR_LTE_FCW_EXT_ERR_RANGE (((uint64)VSTMR_LTE_FCW_ERR_RANGE)<<VSTMR_FCW_FRAC_BITS_EXT)

/*! @brief Min/Max FCW in Q30.
*/
#define VSTMR_LTE_FCW_MIN           (VSTMR_LTE_FCW - VSTMR_LTE_FCW_ERR_RANGE)
#define VSTMR_LTE_FCW_MAX           (VSTMR_LTE_FCW + VSTMR_LTE_FCW_ERR_RANGE)

/*! @brief Min/Max FCW in Q-VSTMR_FCW_FRAC_BITS.
*/
#define VSTMR_LTE_FCW_EXT_MIN       (VSTMR_LTE_FCW_EXT - VSTMR_LTE_FCW_EXT_ERR_RANGE)
#define VSTMR_LTE_FCW_EXT_MAX       (VSTMR_LTE_FCW_EXT + VSTMR_LTE_FCW_EXT_ERR_RANGE)
...
/*! @brief Defines RTC modulo inverse in Q64.
           Formula: floor((2^64)/VSTMR_LTE_RTC_MODULO))
*/
#define VSTMR_LTE_RTC_MODULO_INV    (0x400000000uLL)
...
void vstmr_lte_update_fcw_from_err_ratio
(
  vstmr_lte_view_s  *l_view,
  int32              err_ratio_q45
);
