...
$Header: //components/rel/mcs.mpss/5.2/api/hwio_cap.h#3 $
...
typedef enum {
  ...
  /* LTE_DL_256QAM Feature Capability */ 
  MCS_MODEM_CAPABILITY_FEATURE_LTE_DL_256QAM,

  /* LTE_DL_CA Feature Capability */ 
  MCS_MODEM_CAPABILITY_FEATURE_LTE_DL_CA,
