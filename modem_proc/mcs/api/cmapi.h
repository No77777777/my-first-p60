...
/*=============================================================================
  ...
  $Header: //components/rel/mcs.mpss/5.2/api/cmapi.h#2 $
...
/* Per 1X team, this should not change */
 ...
 *  This must be set to the same value as LTE_ML1_MAX_SCC */
...
/** Narrowband (NB) parameter used to specify the number of paging groups. 
    Refer to @xhyperref{3G36331, 3GPP TS 36.331}, Section 6.3.2.
*/
typedef enum
{
...
/** Builds the bitmask for the cmapi_efs_read() function. Each bit corresponds
    to a file in EFS that is reread if set. 
*/
typedef enum 
{
...
/** LTE modulation information for uplink and downlink types.
*/
typedef struct
{
...
/** General LTE modulation information.
*/
typedef struct
{
  cmapi_lte_modulation_info_s lte_modulation;
  /**<  LTE modulation information. @newpagetable */
...
typedef struct
{
  ...
  /**< Absolute power level of the common pilot channel as received by the UE 
       in dBm x10. Refer to @xhyperref{3G25304, 3GPP TS 25.304}. */
  ...
  /**< Ratio of the received energy per PN chip for the common pilot channel to 
       ...
       dB x10. Refer to @xhyperref{3G25304, 3GPP TS 25.304}. */
...
typedef struct
{
  ...
  /** Contains the suitable receive level. */
  struct
  {
    int16                            srxlev;
    /**< Suitable receive level. */
...
typedef struct
{
  ...
  /**< Logarithmic value of SINR
       Values are in 1/5th of a dB. Range: 0 to 250 which translates to -20dB to +30dB  */
...
typedef struct
{
  ...
  boolean stale_measurements;
  /**< Flag to indicate if the serving cell measurements are stale.
...
typedef enum
{
  CMAPI_LTE_CPHY_POWER_CLASS3_DEFAULT = 0,
  CMAPI_LTE_CPHY_POWER_CLASS1 = 1,            
  CMAPI_LTE_CPHY_POWER_CLASS2 = 2,
  CMAPI_LTE_CPHY_POWER_CLASS3 = 3,
  CMAPI_LTE_CPHY_POWER_CLASS4 = 4,
}cmapi_lte_cphy_power_class_e;
...
/** GERAN frequency group.
  ...
  Defines a group of GERAN frequencies with associated priority and
  reselection parameters. This GERAN frequency group is analogous to
  a frequency in another RAT. Refer to @xhyperref{3G36331, 3GPP TS 36.331}.
*/
typedef struct
{
  uint8 cell_resel_priority;
...
/** Connected mode DRX-dedicated information. 
    Refer to @xhyperref{3G36321, 3GPP TS 36.321}.
*/
typedef struct
{
  boolean drx_enable;
...
/** LTE physical multicast channel (PMCH) block error rate (BLER) information. */
typedef struct  
{
  uint32   pmch_id;
  /**< PMCH ID. */
...
/**< Current signal strength information for a multimedia broadcast 
     multicast service single frequency network (MBSFN) area. */
typedef struct
{
  uint8 area_id;
  /**< MBSFN area ID: 0 to 255 */

  int16 snr;
  /**< The average signal-to-noise ratio (SNR) of the serving cell over the last 
       measurement period in decibels Q3[2 ^3] format.
       SNR result in CNF = raw SNR value * 2^3.
       Range: -10 to 30 */

  int16 excess_snr;
  /**< The excess SNR of the serving cell over the last 
       measurement period in decibels Q3[2 ^3] format.
       Range: -10 to 30. */

  int8 signal_level;
  /**< The signal level of the serving cell over the last 
       measurement period. 
       Range: 0 to 5. */
 
} cmapi_lte_cphy_mbsfn_area_signal_strength_s;

/** Contains the current signal quality at L1 for each MBSFN area. */
typedef struct
{  
  uint8                                         num_mbsfn_areas;
  /**< Number of MBSFN areas with SNR values are populated in the mbsfn_area_signal_strength array. */
  
  cmapi_lte_cphy_mbsfn_area_signal_strength_s   mbsfn_area_signal_strength[CMAPI_LTE_EMBMS_MAX_MBSFN_AREA];
  /**< SNR information per MBSFN area. @newpagetable */
...
typedef struct 
{
  ...
  /**< Information of each PMCH. */

} cmapi_lte_ml1_pmch_bler_per_area_info_s;

/** LTE PMCH BLER information for all areas. */
typedef struct 
{
  uint32                                   num_area;
  /**< Number of areas in PMCH BLER information specified in the below array */
...
/** LTE PMCH information. */
typedef struct 
{
  boolean                              is_valid;
  /**< Indicates if there is an activated  
...
/** PMCH data-MCS for all configured PMCHs in an MBSFN area. */
typedef struct
{
  uint8 mbsfn_area_id;
  /**< MBSFN area ID (0..255) from system information
      block 13 (SIB13). */
  ...
  uint8 datamcs;
  /**< Data modulation and coding scheme (MCS) for the PMCH. */

} cmapi_lte_rrc_pmch_datamcs_info_s;

/** PMCH data-MCS information for all PMCHs actively being monitored. */
typedef struct
{
  uint8 num_pmch_datamcs_info;
  /**< Number of PMCHs for which data-MCS information has been included. */
...
typedef struct
{
  ...
  /**< Number of active area_id and pmch_id combinations. */

  cmapi_mtch_info_s mtch_info_arr[CMAPI_LTE_EMBMS_MAX_ACTIVE_SESSIONS];
  /**< MTCH information array.  */
...
typedef struct
{
  ...
  /**< PUCCH CQI feedback type. Refer to @xhyperref{3G36321, 3GPP TS 36.321}, Table 7.2.2-1. 
...
/** Antenna information dedicated configuration parameters. Refer to 
    @xhyperref{3G36331, 3GPP TS 36.331}, Section 6.3.2.
*/
typedef struct {
...
typedef struct
{
  ...
  /**< Timing advance is valid only if the LTE is in Connected mode. */

  uint16  doppler_measurement;
  /**< Doppler measurement. */

  boolean trm_available;
  /**< Indicates trm availability (tune away) */
...
typedef struct cmapi_rx_chain_info_s{
  ...
  uint32              phase;
    /**< Current phase in 1/100 degrees. Range: 0.00 to 360.00. Available for 
         LTE only. */ 
}/** @cond */cmapi_rx_chain_info_s_type/** @endcond */;
...
typedef struct cmapi_rx_pwr_info_s{
  ...
  boolean valid;
    /**< Flag identifying if the contents of the message are valid.
         Set to TRUE when the measurements are valid. If FALSE, the contents
         of the rest of the message is invalid and must not be used. */
...
}/** @cond */cmapi_rx_pwr_info_s_type/** @endcond */;
...
}/** @cond */cmapi_tx_pwr_info_s_type/** @endcond */;
...
/** Support LTE Bandwidth
*/
typedef enum
{
  CMAPI_LTE_BW_NRB_6   = 6,
  /**< 1.4MHz bandwidth */
  CMAPI_LTE_BW_MIN     = CMAPI_LTE_BW_NRB_6,
  /**< Minimum supported bandwidth */
  CMAPI_LTE_BW_NRB_15  = 15,
  /**< 3MHz bandwidth */
  CMAPI_LTE_BW_NRB_25  = 25,
  /**< 5MHz bandwidth */
  CMAPI_LTE_BW_NRB_50  = 50,
  /**< 10MHz bandwidth */
  CMAPI_LTE_BW_NRB_75  = 75,
  /**< 15MHz bandwidth */
  CMAPI_LTE_BW_NRB_100 = 100,
  /**< 20MHz bandwidth */
  CMAPI_LTE_BW_MAX     = CMAPI_LTE_BW_NRB_100,
  /**< Maximum supported bandwidth */
  CMAPI_LTE_BW_UNKNOWN
  /**< Unknown Bandwidth */
} cmapi_lte_bandwidth_e;
...
{
  int32                band;
    /**< EARFCN/Active band of the secondary cell for LTE. */
  ...
  /**< Rx power information of the secondary cell for LTE. */

  cmapi_serv_cell_sinr_info_s  log_sinr10xdb;
  /**< SINR information of the secondary cell for LTE. */
  
  uint8 state;
  /**< State of the secondary cell. 0 - Init, 1 - Configured, 2 - Active */

  cmapi_lte_bandwidth_e dl_bandwidth;
  /**< Transmission bandwidth configuration of the secondary cell 
       on the downlink. Range: CMAPI_LTE_BW_MIN to CMAPI_LTE_BW_MAX. */

  boolean ul_configured;
  /**< Indicated whether UL CA is enabled on this cell or not */
  ...
  uint8 ul_bandwidth;
  /**< Transmission bandwidth configuration of the secondary cell 
    on the uplink. Range: 0 to 5. */
  
  cmapi_tx_pwr_info_s_type tx_power;
  /**< Tx power information for the secondary cell; see 
    cmapi_tx_pwr_info_s for details. */
  cmapi_modulation_info_s     modulation;
    /**< Modulation information for secondary carrier.*/
...
typedef struct cmapi_signal_info_s{
  ...
  cmapi_lte_bandwidth_e       dl_bandwidth;
  /**< Transmission bandwidth configuration of the serving cell on the 
       downlink. Range: CMAPI_LTE_BW_MIN to CMAPI_LTE_BW_MAX. */
  cmapi_rx_pwr_info_s_type    rx_power;
...
}/** @cond */cmapi_signal_info_s_type/** @endcond */;
...
typedef struct cmapi_1X_signal_info_s{
  ...
  int32               tx_pwr;
    /**< Transmit power. */
}/** @cond */cmapi_1X_signal_info_s_type/** @endcond */;

/** Provides LTE radio link failure information.
*/
typedef struct cmapi_lte_rlf_info_s{

  uint8      rlf_count_since_lte_active;
  /**< Number of radio link failures seen since LTE has been Active. */

  uint8      rlf_count_since_rrc_connected;
  /**< Number of radio link failures seen since LTE has been in Connected state. */
}/** @cond */cmapi_lte_rlf_info_s_type/** @endcond */;
...
/** @ingroup cmapi_get_signal_info
  Calls the cmapi_get_signal_info_ext() function.
...
/*===========================================================================
  FUNCTION:  cmapi_get_signal_info_ext
===========================================================================*/

/** @ingroup cmapi_get_signal_info_ext
  Gets the signal information for one technology subscription : 
  CDMA, HDR, GSM, WCDMA, LTE or TD-SCDMA.
  ...
  @param[out] signal_info_ptr  Pointer to the output buffer for the returning 
                               signal information.
  @param[in]  as_id            Subscription ID.
  ...
  - The function is implemented inside the CM to provide an interface to the 
    customer.
  - The CM directly calls functions from each technology to get the intended signal 
 ...
 Phase      N/A         N/A         N/A                N/A          1/100 degree           
    ...
    support. 
*/
cmapi_err_e_type         cmapi_get_signal_info_ext
(
       cmapi_sys_mode_e_type         sys_mode, 
       cmapi_signal_info_s_type      *signal_info_ptr,
...
/** @ingroup cmapi_change_rx_diversity
  Calls the cmapi_change_rx_diversity_ext() function.
...
/*===========================================================================
  FUNCTION:  cmapi_change_rx_diversity_ext
===========================================================================*/
/** @ingroup cmapi_change_rx_diversity_ext
  ...
  - If the service is available on the input system mode or the device is in 
    FTM mode: \n
    -# Call %cmapi_change_rx_diversity_ext() from the lower layers.
    -# Return CMAPI_NO_SERVICE. @newpage

  @par Function called during traffic 
  If %cmapi_change_rx_diversity_ext() is called during a call: 
...
*/
cmapi_err_e_type cmapi_change_rx_diversity_ext
(
  cmapi_sys_mode_e_type               sys_mode, 
  cmapi_rx_diversity_bit_mask_e_type  enable_rx_chain_bit_mask,
  sys_modem_as_id_e_type              as_id  
...
/** @ingroup cmapi_set_lte_signal_reporting_config 
  Calls the cmapi_set_lte_signal_reporting_config_ext() function.
...
/*===========================================================================
  FUNCTION:  cmapi_set_lte_signal_reporting_config_ext
===========================================================================*/
/** @ingroup cmapi_set_lte_signal_reporting_config_ext
  ...
  None.
*/
boolean cmapi_set_lte_signal_reporting_config_ext
(
  cmapi_lte_signal_reporting_rate_e       reporting_rate,
  cmapi_lte_signal_averaging_period_e     averaging_period,
  sys_modem_as_id_e_type                  as_id 
...
/** @ingroup cmapi_get_rat_meas_info    
  Calls the cmapi_get_rat_meas_info_ext() function.
...
/*===========================================================================
  FUNCTION:  cmapi_get_rat_meas_info_ext
===========================================================================*/
/** @ingroup cmapi_get_rat_meas_info_ext    
  ...
  None.
*/
cmapi_err_e_type cmapi_get_rat_meas_info_ext
(
  cmapi_sys_mode_e_type                sys_mode, 
  cmapi_rat_meas_info_s_type*          meas_info_ptr,
  sys_modem_as_id_e_type               as_id       
...
/** @ingroup cmapi_start_capture_scan_data
  Calls the function cmapi_start_capture_scan_data_ext ( )
...
/*===========================================================================
  FUNCTION:  cmapi_start_capture_scan_data_ext
===========================================================================*/
/** @ingroup cmapi_start_capture_scan_data
...
*/
cmapi_err_e_type  cmapi_start_capture_scan_data_ext 
(	
  uint16			rat_bitmap, 
  uint32* 			scan_data_ptr, 
  uint16 			max_no_of_LTE_result,
...
/** @ingroup cmapi_stop_capture_scan_info
  Calls the cmapi_stop_capture_scan_info_ext() function.
...
/*===========================================================================
  FUNCTION:  cmapi_stop_capture_scan_info_ext 
===========================================================================*/
/** @ingroup cmapi_stop_capture_scan_info_ext
  ...
  None.
*/
cmapi_err_e_type    cmapi_stop_capture_scan_info_ext 
(	
  uint16                        rat_bitmap,
  sys_modem_as_id_e_type        as_id  
);
...
FUNCTION cmapi_get_decoded_sib_string_ext

===========================================================================*/
/**	@ingroup cmapi_get_decoded_sib_string_ext
  ...
  2 -- Decoding failed. CMAPI_NOT_SUPPORTED -- LTE is not supported.

  @dependencies
  None.
*/
int cmapi_get_decoded_sib_string_ext
(
  void                   *encoded_si_ptr, 
...
/** @ingroup cmapi_set_lte_fgi
  Calls cmapi_set_lte_fgi_ext () function.
*/
...
FUNCTION cmapi_set_lte_fgi_ext

===========================================================================*/

/** @ingroup cmapi_set_lte_fgi_ext
  ...
  @dependencies
  RRC only accepts an FGI change if the client for this function triggers Airplane
  mode ON, makes the function call, and turns OFF the Airplane mode.
*/
boolean cmapi_set_lte_fgi_ext
(
  cmapi_lte_fgi_rel_type_e  fgi_rel_type, 
  uint32                    fgi_word,
  sys_modem_as_id_e_type    as_id                   
...
/** @ingroup cmapi_set_lte_tdd_fgi
  Calls cmapi_set_lte_tdd_fgi_ext() function.
*/
...
FUNCTION cmapi_set_lte_tdd_fgi_ext

===========================================================================*/

/** @ingroup cmapi_set_lte_tdd_fgi_ext
  ...
  @dependencies
  RRC only accepts an FGI change if the client for this function triggers Airplane
  mode ON, makes the function call, and subsequently turns OFF the Airplane mode.
*/
boolean cmapi_set_lte_tdd_fgi_ext
(
  cmapi_lte_fgi_rel_type_e  fgi_rel_type, 
  uint32                    fgi_word,
  sys_modem_as_id_e_type    as_id                  
...
/** @ingroup cmapi_lte_set_pci_lock_req
  Calls cmapi_lte_set_pci_lock_req_ext() function.
*/
...
FUNCTION cmapi_lte_set_pci_lock_req_ext

===========================================================================*/

/** @ingroup cmapi_lte_set_pci_lock_req_ext
  ...
  None.
*/
boolean cmapi_lte_set_pci_lock_req_ext
(
  uint32  dl_earfcn, 
  uint16  pci, 
  sys_modem_as_id_e_type   as_id 
...
/** @ingroup cmapi_lte_set_earfcn_lock_req
  Calls cmapi_lte_set_earfcn_lock_req_ext function.
*/
...
FUNCTION cmapi_lte_set_earfcn_lock_req_ext

===========================================================================*/

/** @ingroup cmapi_lte_set_earfcn_lock_req_ext
  ...
  None.
*/
boolean cmapi_lte_set_earfcn_lock_req_ext
(
  uint32  dl_earfcn1, 
  uint32  dl_earfcn2,
  sys_modem_as_id_e_type   as_id  
...
/** @ingroup cmapi_lte_get_eMBMS_info
   Calls the cmapi_lte_get_eMBMS_info_ext() function.

    @datatypes
    #cmapi_lte_eMBPS_info_s
 
    @param[in] eMBMS_info_ptr Pointer to the eMBMS information.
...
FUNCTION cmapi_lte_get_eMBMS_info_ext

===========================================================================*/
/** @ingroup cmapi_lte_get_eMBMS_info_ext
   Gets the LTE enhanced multimedia broadcast/multicast service
   (eMBMS) information.
...
*/
/*===========================================================================*/
void cmapi_lte_get_eMBMS_info_ext
(
  cmapi_lte_eMBPS_info_s   *eMBMS_info_ptr,
  sys_modem_as_id_e_type   as_id   
);
...
===========================================================================*/
/** @ingroup cmapi_change_scc_rx_diversity 
    Calls the cmapi_change_scc_rx_diversity_ext() function.

    @param[in]  scc_id     SCC index starting at 0.

    @param[in]  enable_rx0 TRUE to enable RX0; FALSE to disable RX0.
 
    @param[in]  enable_rx1 TRUE to enable RX1; FALSE to disable RX1.
    
    @return
    TRUE if LTE RX diversity successfully changes, FALSE otherwise.
*/
/*=========================================================================*/
...
/*===========================================================================
                     ...
                     cmapi_change_scc_rx_diversity_ext

===========================================================================*/
/** @ingroup cmapi_change_scc_rx_diversity_ext  
    Changes the LTE RX diversity on a SCC. 
    ...
    - RF software is busy and cannot take care of RX diversity change request
    - RF software returns error when it performs the diversity changing
    - LTE is busy and cannot take the request
    
    @dependencies
    LTE RX diversity can only be changed if LTE RX is tuned and the RF
    software is not performing any other RF activities.
*/
/*=========================================================================*/
boolean cmapi_change_scc_rx_diversity_ext
(
  uint8   scc_id,     
  boolean enable_rx0, 
  boolean enable_rx1 ,
...
===========================================================================*/
/** @ingroup cmapi_efs_read
    Calls cmapi_efs_read_ext() function.
*/
/*=========================================================================*/
...
===========================================================================*/
/** @ingroup cmapi_efs_read_ext
    Calls the lte_rrc_cmapi_efs_reread_req() function to reread
    the files from EFS as specified in the 64-bit bitmask.

    @datatypes
    #cmapi_sys_mode_e_type

    @param[in] sys_mode System mode type.

    @param[in] bitmask  Bitmask denoting the files to be reread
                        from EFS. 

    @return
    cmapi_err_e_type -- CMAPI_SUCCESS if the lte_rrc_cmapi_efs_reread_req()
    function returns success, failure otherwise.
*/
/*=========================================================================*/
cmapi_err_e_type cmapi_efs_read_ext
(
  cmapi_sys_mode_e_type       sys_mode,
  uint64                      bitmask,
  sys_modem_as_id_e_type      as_id 
...
/*===========================================================================
                     ...
                     cmapi_lte_get_num_rlf

===========================================================================*/
/** @ingroup cmapi_lte_get_num_rlf
    Calls cmapi_lte_get_num_rlf_ext() function.
*/
/*=========================================================================*/
cmapi_err_e_type cmapi_lte_get_num_rlf
(
  cmapi_lte_rlf_info_s_type * rlf_info_ptr
);

/*===========================================================================

                     cmapi_lte_get_num_rlf_ext

===========================================================================*/
/** @ingroup cmapi_lte_get_num_rlf_ext
    Calls the lte_rrc_cmapi_get_num_rlf() function to get the number of radio link failures
    between LTE reached connected state and since LTE became active.

    @datatypes
    cmapi_lte_rlf_info_s_type

    @param[out] rlf_info_ptr Pointer to the radio link failure information.

    @return
    cmapi_err_e_type -- CMAPI_SUCCESS if the lte_rrc_cmapi_get_num_rlf() function
    returns success; failure otherwise.
*/
/*=========================================================================*/
cmapi_err_e_type cmapi_lte_get_num_rlf_ext
(
  cmapi_lte_rlf_info_s_type * rlf_info_ptr,
  sys_modem_as_id_e_type      as_id
);
...
/** @ingroup cmapi_set_lte_deep_sleep
    Calls the cmapi_set_lte_deep_sleep_ext() function.
...
/*===========================================================================
                     ...
                     cmapi_set_lte_deep_sleep_ext

============================================================================*/
/** @ingroup cmapi_set_lte_deep_sleep_ext
    Calls the lte_ml1_sleepmgr_enable_disable_deep_sleep_ext() function to 
...
void cmapi_set_lte_deep_sleep_ext
(
  boolean                  setval,
  sys_modem_as_id_e_type   as_id  
);
...
/*===========================================================================
                     ...
                     cmapi_set_lte_ue_cap_band_pref

============================================================================*/
/** @ingroup cmapi_set_lte_ue_cap_band_pref
    Calls cmapi_set_lte_ue_cap_band_pref_ext() function.
*/
/*==========================================================================*/

cmapi_err_e_type cmapi_set_lte_ue_cap_band_pref
(
  cmapi_bit_mask_256_t  lte_band_pref,
...
/*===========================================================================
                     ...
                     cmapi_set_lte_ue_cap_band_pref_ext

============================================================================*/
/** @ingroup cmapi_set_lte_ue_cap_band_pref_ext
    Calls the lte_rrc_cmapi_set_ue_cap_band_preferences() function to set
    the LTE UE capability band preference.
    ...
    @param[in] wcdma_band_pref WCDMA band preference. 

    @param[in] gsm_band_pref   GSM band preference. 

    @return
    cmapi_err_e_type -- CMAPI_SUCCESS
    if the lte_rrc_cmapi_set_ue_cap_band_preferences() function
    returns success; failure otherwise.
*/
/*==========================================================================*/

cmapi_err_e_type cmapi_set_lte_ue_cap_band_pref_ext
(
  cmapi_bit_mask_256_t  lte_band_pref,
  uint64                wcdma_band_pref,
  uint64                   gsm_band_pref,
...
/*===========================================================================
                     ...
                     cmapi_lte_rrc_get_serv_cell_power_class

============================================================================*/
/** @ingroup cmapi_lte_rrc_get_serv_cell_power_class
    Calls the lte_rrc_get_serv_cell_power_class() function to 
    to get serv cell power class.
    
    @datatypes
    cmapi_lte_cphy_power_class_e
    
    @param[in]  as_id         INSTANCE.
    @param[out] power_class   LTE serv cell power_class.

    @return
*/
/*==========================================================================*/
cmapi_lte_cphy_power_class_e cmapi_lte_rrc_get_serv_cell_power_class
(
  sys_modem_as_id_e_type as_id
);
...
FUNCTION cmapi_trm_asdiv_switch_set

DESCRIPTION
  This function calls TRM API to set asdiv_switch

Parameters
  Boolean asdiv_switch_state
...
===========================================================================*/
void cmapi_trm_asdiv_switch_set
(
  boolean asdiv_switch_state
);
...
FUNCTION cmapi_trm_asdiv_switch_get

DESCRIPTION
  This function calls TRM API to get asdiv_switch
...
===========================================================================*/
boolean cmapi_trm_asdiv_switch_get
(
  void
);
