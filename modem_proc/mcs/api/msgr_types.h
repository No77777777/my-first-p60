...
$Header: //components/rel/mcs.mpss/5.2/api/msgr_types.h#3 $
...
/* Number of variants supported in this build. Maximum value for MSGR_NUM_VARIANT is 8 */
#ifdef FEATURE_MSGR_VARIANTS
#define MSGR_NUM_VARIANT 2
#else
