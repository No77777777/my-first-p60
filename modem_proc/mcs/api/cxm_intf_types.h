...
$Header: //components/rel/mcs.mpss/5.2/api/cxm_intf_types.h#3 $
...
#define CXM_POLICY_LTE_U_CHANNEL_AVOIDANCE         0x00002000 /* TODO: Add to QMI IDL */
#define CXM_POLICY_UNSUPPORTED                     0xFFFFC000
...
#define CXM_SYS_BHVR_WLAN_INFO_FROM_DS         0x00400000 /* WLAN state information comes in through data services */
#define CXM_SYS_BHVR_PROCESS_SAWLESS_CONFLICTS 0x00800000 /* Don't skip victim table conflicts caused by SAWless RF filter */
#define CXM_SYS_BHVR_NV_ONLY_VICT_TBL          0x01000000 /* Victim table entries come from NV EFS item file only */
#define CXM_SYS_BHVR_NO_NEIGHBOR_CELL_REP      0x02000000 /* Turn off neighbor cell measurement high prio message reporting */
#define CXM_SYS_BHVR_NO_CONNECTED_PAG_REP      0x04000000 /* Turn off connected paging high prio message reporting */
#define CXM_SYS_BHVR_UART_ON_OFF               0x08000000 /* Turn UART ON/OFF based System operting mode */
#define CXM_SYS_BHVR_QSOCKETS                  0x20000000 /* Use qsockets */
#define CXM_SYS_BHVR_LTEU_ANT_SOCK             0x40000000 /* LTE-U Antenna sharing using Qsockets */
#define CXM_SYS_BHVR_ENABLE_RATID              0x80000000 /* Enable RAT ID feature in hardware */
#define CXM_SYS_BHVR_UNSUPPORTED               0x00000000 /* Mask indicating unsupported control bits */
...
typedef enum
{
  ...
  CXM_TECH_LTE2,            /*!< LTE on Subscription_2 */
...
/*! @brief CXM signals that we should send to us as MSGR message for processing */
typedef enum
{
  CXM_COEX_INVALID_SIG       = -1, /*!< Default/Invalid signal ID */
  CXM_COEX_QSOCK_LTEU_GRANT_SIG,   /*!< we rcvd a grant and need to send WLAN a qsock */
  CXM_COEX_ANT_STATE_UPDATE_SIG,   /*!< signal that we have rcvd Ant usage from TRM */
  CXM_COEX_ANT_PAUSE_SIG,          /*!< signal to pause legacy AS */
  CXM_COEX_ANT_RESUME_SIG,         /*!< signal to resume legacy AS */
  CXM_COEX_LTEU_REQUEST_SIG,       /*!< signal to request 5G Antenna */
  CXM_COEX_LTEU_RELEASE_SIG,       /*!< signal to release 5G Antenna */
  CXM_COEX_ANT_RELEASE_SIG,        /*!< signal to release 2.4G Antenna */
  CXM_COEX_MAX_SIG                 /*!< Max supported signal ID */
}cxm_coex_signal_handler_e;
