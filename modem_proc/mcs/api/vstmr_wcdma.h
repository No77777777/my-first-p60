...
$Header: //components/rel/mcs.mpss/5.2/api/vstmr_wcdma.h#7 $
...
/*! @brief Nominal FCW value in Q-VSTMR_FCW_FRAC_BITS.
           (30.72 MHz) / 19.2e6 = 1.6 * 2^VSTMR_FCW_FRAC_BITS
           = 115292150460684697.6
           = 0x199999999999999 (floored)
*/
#define VSTMR_WCDMA_FCW_EXT               (0x199999999999999uLL)

/*! @brief Nominal FCW inverse value in Q-VSTMR_FCW_INV_FRAC_BITS.
           1 / ((30.72 MHz) / 19.2e6) = 1/1.6 * 2^VSTMR_FCW_INV_FRAC_BITS
           = 0xA0000000000000
*/
#define VSTMR_WCDMA_FCW_INV_EXT           (0xA0000000000000uLL)
...
#define VSTMR_WCDMA_FCW_ERR_RANGE         (0xFFFFF)
#define VSTMR_WCDMA_FCW_EXT_ERR_RANGE     (((uint64)VSTMR_WCDMA_FCW_ERR_RANGE)<<VSTMR_FCW_FRAC_BITS_EXT)

/*! @brief Min/Max FCW values in Q30.
*/
#define VSTMR_WCDMA_FCW_MIN               (VSTMR_WCDMA_FCW - VSTMR_WCDMA_FCW_ERR_RANGE)
#define VSTMR_WCDMA_FCW_MAX               (VSTMR_WCDMA_FCW + VSTMR_WCDMA_FCW_ERR_RANGE)

/*! @brief Min/Max FCW in Q-VSTMR_FCW_FRAC_BITS.
*/
#define VSTMR_WCDMA_FCW_EXT_MIN           (VSTMR_WCDMA_FCW_EXT - VSTMR_WCDMA_FCW_EXT_ERR_RANGE)
#define VSTMR_WCDMA_FCW_EXT_MAX           (VSTMR_WCDMA_FCW_EXT + VSTMR_WCDMA_FCW_EXT_ERR_RANGE)
...
/*! @brief Defines RTC modulo inverse in Q64.
           Formula: floor((2^64)/VSTMR_WCDMA_RTC_MODULO))
*/
#define VSTMR_WCDMA_RTC_MODULO_INV        (0x369D0369DuLL)
...
void vstmr_wcdma_update_fcw_ext
(
  vstmr_wcdma_view_s  *w_view,
  uint64               fcw_ext
);
...
void vstmr_wcdma_event_cancel_ext
(
  vstmr_wcdma_event_tbl_s  *id,        
  uint32                    event_idx  
);
