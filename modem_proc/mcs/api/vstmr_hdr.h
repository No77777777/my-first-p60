...
$Header: //components/rel/mcs.mpss/5.2/api/vstmr_hdr.h#6 $
...
/*! @brief Nominal HDR FCW value in Q-VSTMR_FCW_FRAC_BITS.
           (1.2288 MHz * 8) / 19.2e6 = 0.512 * 2^VSTMR_FCW_FRAC_BITS
           = 36893488147419103.232
           = 0x83126E978D4FDF (floored)
*/
#define VSTMR_HDR_FCW_EXT           (0x83126E978D4FDFuLL)

/*! @brief Nominal HDR FCW inverse value in Q-VSTMR_FCW_INV_FRAC_BITS.
           1 / ((1.2288 MHz * 8) / 19.2e6)
           = 1/(0.512) * 2^VSTMR_FCW_INV_FRAC_BITS
           = 0x1F4000000000000
*/
#define VSTMR_HDR_FCW_INV_EXT       (0x1F4000000000000uLL)
...
#define VSTMR_HDR_FCW_ERR_RANGE     (0xFFFFF)
#define VSTMR_HDR_FCW_EXT_ERR_RANGE (((uint64)VSTMR_HDR_FCW_ERR_RANGE)<<VSTMR_FCW_FRAC_BITS_EXT)

/*! @brief Min/Max FCW in Q30.
*/
#define VSTMR_HDR_FCW_MIN           (VSTMR_HDR_FCW - VSTMR_HDR_FCW_ERR_RANGE)
#define VSTMR_HDR_FCW_MAX           (VSTMR_HDR_FCW + VSTMR_HDR_FCW_ERR_RANGE)

/*! @brief Min/Max FCW in Q-VSTMR_FCW_FRAC_BITS.
*/
#define VSTMR_HDR_FCW_EXT_MIN       (VSTMR_HDR_FCW_EXT - VSTMR_HDR_FCW_EXT_ERR_RANGE)
#define VSTMR_HDR_FCW_EXT_MAX       (VSTMR_HDR_FCW_EXT + VSTMR_HDR_FCW_EXT_ERR_RANGE)
...
/*! @brief Defines RTC modulo inverse in Q64.
           Formula: floor((2^64)/VSTMR_HDR_RTC_MODULO))
*/
#define VSTMR_HDR_RTC_MODULO_INV    (0x400000000uLL)
