...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/src/rf_cdma_utils_freq.c#1 $
...
extern const rf_carrier_freq_type rf_rx_freq_tbl[];
extern const uint16 rf_rx_freq_tbl_size;
extern const rf_carrier_freq_type rf_tx_freq_tbl[];
extern const uint16 rf_tx_freq_tbl_size;
...
)
{
  uint16 chan=0;
  int32  delta = 0;
  int16 max_entries= rf_tx_freq_tbl_size;
  int16 i = 0;
