...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/src/rf_cdma_nv_bc10.c#1 $
...
rf_cdma_nv_bc10_static_items_map[RF_CDMA_NV_PATH_NUM] =
{
  /* RF_PATH_0 Static NV items */
  {
    ...
    RFNV_CDMA_C0_BC10_RX_STATIC_DATA_I,
  },
  ...
  /* RF_PATH_1 Static NV items */
  {
    ...
    RF_CDMA_NV_INVALID_NV_ITEM,
    /* Rx unified static NVs */
    RFNV_CDMA_C1_BC10_RX_STATIC_DATA_I,
  },
  ...
  /* RF_PATH_2 Static NV items */
  {
    ...
    /* Rx unified static NVs */
    RFNV_CDMA_C2_BC10_RX_STATIC_DATA_I,
  },
  ...
  /* RF_PATH_3 Static NV items */
  {
    ...
    RF_CDMA_NV_INVALID_NV_ITEM,
    /* Rx unified static NVs */
    RFNV_CDMA_C3_BC10_RX_STATIC_DATA_I,
  }
  ,
  /* RF_PATH_4 Static NV items */
  {
    ...
    RF_CDMA_NV_INVALID_NV_ITEM,
    /* Rx unified static NVs */
    RFNV_CDMA_C4_BC10_RX_STATIC_DATA_I,
  }
  ,
  /* RF_PATH_5 Static NV items */
  {
    ...
    RF_CDMA_NV_INVALID_NV_ITEM,
    /* Rx unified static NVs */
    RFNV_CDMA_C5_BC10_RX_STATIC_DATA_I,
  }
