...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_intelliceiver.h#1 $
...
typedef struct
{
  ...
  */
  ...
  boolean is_primary_rfm_device ;
  /*!< With RxTx split any device can be primary or diversity. 
    Odd number diversity and even number primary devices are not
    the case any more. We choose primary and seconday devices on
    the go now. This flag keeps that track. */
