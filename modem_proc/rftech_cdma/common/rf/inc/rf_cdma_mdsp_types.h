...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_mdsp_types.h#1 $
...
typedef struct
{
  ...
  uint32 meas_reset_script_id;
  /*!< Script ID for reset script during measurement. ID is only used during 
    measurement such as irat or QTA */
