...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_fwrsp.h#1 $
...
/*----------------------------------------------------------------------------*/
/*! Structure to store housekeeping data for cdma FL DRX Override 
Response message  */
typedef struct
{
  rfm_device_enum_type device;
  ...
  boolean blocking_call;
  /*!< Flag indicating, if the FL DRX Override message was sent as blocking call 
  or not. If it were a blocking call, the handler function will post 
  the semaphore. */ 

} rf_cdma_fl_drx_override_rsp_data_type; 
...
typedef struct
{
  ...
  rf_cdma_fl_drx_override_rsp_data_type fl_drx_override_rsp;
  /*!< Housekeeping data for Discontinuous FL DRx override Response  */
