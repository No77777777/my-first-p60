...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_mdsp.h#1 $
...
12/09/14   spa     Added API rf_cdma_mdsp_abort_asd_events
...
/*----------------------------------------------------------------------------*/
void 
rf_cdma_mdsp_set_pa_addtl_offset
(
  rfm_mode_enum_type rf_mode,
