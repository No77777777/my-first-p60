...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rfc_cdma_device_wrapper.h#1 $
 ...
 */
  ...
  */
  ...
  /*! 
    @brief
    Returns the Rx device Ptr for the device_idx passed
    ...
    */
  virtual rfdevice_trx_cdma_rx* get_rx_dev_ptr( uint8 device_idx );
