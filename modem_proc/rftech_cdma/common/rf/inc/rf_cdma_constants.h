...
/*==============================================================================
 ...
 $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_constants.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
07/21/16   rs      Added support to take care of additional PA RFFE writes in 
                   txagc
05/30/16   rs      Added support to adjust the pa txagc offset for third party 
                   PAs in customer devices
...
/*! PA txagc additional offset to handle extra rffe writes in customer PAs 
RF_CDMA_PA_TXAGC_ADDTL_OFFSET is in us */
#define  RF_CDMA_PA_TXAGC_ADDTL_OFFSET                                        0
