...
$Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_asm.h#1 $
...
public:
  ...
  bool device_reset_switch_state( rfm_device_enum_type device,
                                  rfm_mode_enum_type mode,
                                  rfm_cdma_band_class_type band );

  bool update_asm_state( rfm_device_enum_type device,
                         rfm_mode_enum_type mode,
                         rfm_cdma_band_class_type band );
