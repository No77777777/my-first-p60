...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rfc_card_cdma.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
02/28/18   am      QAT3522 xsw tech side changes
11/11/15   ugs     Updated the CDMA Driver max supported paths to 5
11/02/15   dbc     Added configure_asm_xsw_port declaration
...
03/02/14   zhw     Refactor RFC for splittingTx from Rx devices
12/17/14   wwl     add get_fb_device_modem_chain function prototype
...
/*----------------------------------------------------------------------------*/
/*! @brief 
    Define the default path used to get device configuration info
  */
#define RFC_CDMA_DEFAULT_PATH 0
...
/*! @brief 
    ...
    CDMA Driver supports Paths 0 through 5 currently */
const rf_path_enum_type RF_CDMA_MAX_PATH_SUPPORTED = RF_PATH_5 ;
...
public:
  ...
  boolean configure_asm_xsw_port ( 
                                   rfm_device_enum_type device,
                                   rfm_cdma_band_class_type band
                                  );
  
  /*! method to retrieve XSW sleep Script */
  boolean generate_xsw_sleep_script(
                                   rfcommon_asdiv_position_type position,
                                   rf_buffer_intf *asdiv_script_ptr,
                                   void *cb_data
                                   );
...
protected:
  ...
  rfc_cdma_logical_device_params_type* logical_dev_param_ptr[RFM_MAX_WAN_DEVICES];
...
private:
  ...
  */
  rfc_cdma_card_intf()
  {
    ...
    memset(this->valid_nv_path_array, 0, sizeof( this->valid_nv_path_array ));
  };
  ...
  /*! Max Number of RFM device listed in RFC */
  ...
  /*! Populates tx transceiver */ 
  boolean populate_tx_transceiver(
  ...
  /*! Populates rx transceiver */ 
  boolean populate_rx_transceiver (
                            rfc_cdma_logical_device_params_type* logical_dev_ptr,
                            rfm_cdma_band_class_type rf_band,
                            rfc_device_info_type *device_info_ptr, 
                            int16 device_index,
  ...
  /*! Populates tx asm */ 
  boolean populate_tx_asm( rfc_cdma_logical_device_params_type* logical_dev_ptr,
                           rfm_cdma_band_class_type rf_band,
                           rfc_device_info_type *device_info_ptr, 
                           int16 device_index,
                           rfm_device_enum_type device );
  ...
  /*! Populates rx asm */ 
  boolean populate_rx_asm( rfc_cdma_logical_device_params_type* logical_dev_ptr,
                           rfm_cdma_band_class_type rf_band,
                           rfc_device_info_type *device_info_ptr, 
                           int16 device_index,
                           rfm_device_enum_type device );
  ...
  /*! Populates PA */ 
  boolean populate_pa (  rfc_cdma_logical_device_params_type* logical_dev_ptr,
                         rfm_cdma_band_class_type rf_band,
                         rfc_device_info_type *device_info_ptr, 
                         int16 device_index,
                         rfm_device_enum_type device,
  ...
  /*! Populates PAPM */ 
  boolean populate_papm (rfc_cdma_logical_device_params_type* logical_dev_ptr,
                         rfm_cdma_band_class_type rf_band,
                         rfc_device_info_type *device_info_ptr, 
                         int16 device_index,
                         rfm_device_enum_type device );
  ...
  /*! Populates HDET */ 
  boolean populate_hdet (rfc_cdma_logical_device_params_type* logical_dev_ptr,
                         rfm_cdma_band_class_type rf_band,
                         rfc_device_info_type *device_info_ptr, 
                         int16 device_index );

  /*! Populates Coupler */ 
  boolean populate_coupler(rfc_cdma_logical_device_params_type* logical_dev_ptr,
                           rfm_cdma_band_class_type rf_band,
                           rfc_device_info_type *device_info_ptr, 
                           int16 device_index );

  /*! Populates Tuner manager */ 
  boolean populate_tuner_manager (
                       void** qtuner_obj_ptr,
...
#ifdef FEATURE_RF_ASDIV
  /*! Populates AsDiv object */ 
  boolean populate_asdiv(rfm_cdma_band_class_type rf_band,
                         rfc_device_info_type *device_info_ptr, 
                         rfm_device_enum_type device );
  ...
  /*! Populates ELNA */ 
  boolean populate_elna (rfc_cdma_logical_device_params_type* logical_dev_ptr,
                         rfm_cdma_band_class_type rf_band,
                         rfc_device_info_type *device_info_ptr, 
                         int16 device_index,
                         rfm_device_enum_type device );

  /*! Populates all Tx devices */ 
  boolean populate_tx_devices ( rfm_device_enum_type device );

  /*! Populates all Rx devices */ 
  boolean populate_rx_devices ( rfm_device_enum_type device );
  ...
  boolean valid_nv_path_array[RF_CDMA_NV_PATH_NUM][RFM_CDMA_MAX_BAND];
