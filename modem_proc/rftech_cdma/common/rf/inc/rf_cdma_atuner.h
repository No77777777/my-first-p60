...
$Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_atuner.h#1 $
...
class rf_cdma_atuner
{
  protected:
    ...
    void*  default_tuner_device_list[RFC_MAX_DEVICE_INSTANCES_PER_BAND];
  ...
  public:
    ...
    boolean add_default_tuner_instance( rfcommon_atuner_intf* new_tuner_mgr_device ,
                                        void* tuner_device_obj);
    /* Interface to clear the existing tuner devices\managers */
    boolean clear_default_tuner_instance( void );

    /* Interface to set the default antenna number */
    boolean set_default_ant_num ( uint32 ant_num );

    /* Interface for atuner device init */
    boolean init( rfcommon_atuner_config_req_type* tuner_config,
    ...
    boolean disable( rfcommon_atuner_config_req_type* tuner_config,
                     rf_device_execution_type dev_action, 
                     rf_buffer_intf *script_buffer, 
                     int16 script_timing, 
                     ant_tuner_device_tokens_type *script_token ) ;
    ...
    boolean tx_disable( rfcommon_atuner_config_req_type* tuner_config,
                        rf_device_execution_type dev_action,
                        rf_buffer_intf *script_buffer,
                        int16 script_timing,
                        ant_tuner_device_tokens_type *script_token ); 
    ...
    boolean configure_for_rx(  rfcommon_atuner_config_req_type* tuner_config,
                               rf_device_execution_type dev_action, 
                               rf_buffer_intf *script_buffer, 
                               int16 script_timing, 
                               ant_tuner_device_tokens_type *script_token );
    ...
    boolean update_tune_code( rfcommon_atuner_config_req_type* tuner_config,
                              void* tuner_cb_data,
    ...
    boolean update_ftm_tune_code( rfcommon_atuner_config_req_type* tuner_config );
    ...
    /* Interface for atuner device tune-away configuration */
    boolean configure_for_tune_away(  rfcommon_atuner_config_req_type* tuner_config,
                                      rf_device_execution_type dev_action, 
                                      rf_buffer_intf *script_buffer, 
                                      int16 script_timing, 
                                      ant_tuner_device_tokens_type *script_token );

    /* Interface for atuner device tune-back configuration */
    boolean configure_for_tune_back(  rfcommon_atuner_config_req_type* tuner_config,
                                      rf_device_execution_type dev_action, 
                                      rf_buffer_intf *script_buffer, 
                                      int16 script_timing, 
                                      ant_tuner_device_tokens_type *script_token );
    ...
    get_tuner_mgr_object( uint16 tuner_id);

    void**
    get_tuner_device_object_list(void);
  private:
...
/*----------------------------------------------------------------------------*/
boolean rf_cdma_atuner_configure_for_tune_away
(
  rf_cdma_atuner *atuner_ptr,
  rfcommon_atuner_config_req_type* tuner_config,
  rf_device_execution_type dev_action,
...
/*----------------------------------------------------------------------------*/
boolean rf_cdma_atuner_configure_for_tune_back
(
  rf_cdma_atuner *atuner_ptr,
  rfcommon_atuner_config_req_type* tuner_config,
  rf_device_execution_type dev_action,
