...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/rf/inc/rf_cdma_state_types.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
03/23/15   wwl     Add new RF_CDMA_STATE_TX state
...
typedef enum
{
  ...
  RF_CDMA_STATE_TX = 7,
  /*!< This state is entered after Tx is woken up and TX RX are not on the
  same device. At the state, the phone should be able to perform receive as
  well as transmit on given band and channel. */

  RF_CDMA_STATE_INVALID = 8
