...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/common/ftm/src/ftm_cdma_control.c#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
05/02/18   rs      Memory cleanup during 1X deinit
08/11/15   zhw     Added support for Tx Control Command
08/03/15   zhw     Added support for 1x/HDR RF Test
06/18/15   wwl     Add support for RF test, radio_config handler call back func
...
)
{
  ...
  ftm_rf_test_radio_config_register_tech_cb(RFM_1X_MODE,ftm_1x_rf_test_radio_config);
  ftm_rf_test_radio_config_register_tech_cb(RFM_1XEVDO_MODE,ftm_hdr_rf_test_radio_config);
  ftm_rf_test_rx_measure_register_tech_cb(RFM_1X_MODE,ftm_1x_rf_test_rx_measure);
  ftm_rf_test_rx_measure_register_tech_cb(RFM_1XEVDO_MODE,ftm_hdr_rf_test_rx_measure);
  ftm_rf_test_tx_control_register_default_tech_cb(RFM_1X_MODE,ftm_1x_rf_test_tx_control);
  ftm_rf_test_tx_control_register_default_tech_cb(RFM_1XEVDO_MODE,ftm_hdr_rf_test_tx_control);
...
/*!
  @brief
  Common FTM Driver Deinitialization

  @details
  This function will deconfigure FTM driver state.
 
  @return
  Flag indicating whether FTM Deinitialization is successful
*/
void
ftm_cdma_deinit
(
...
{
  /* Deinitialize FTM CDMA Data Structure */
  ftm_cdma_cleanup_device_status();

  FTM_MSG( FTM_LOW, "CDMA Control : Deinitialized" );
