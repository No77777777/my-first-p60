...
/*==============================================================================
  ...
  Copyright (c) 2011, 2012, 2013, 2014 Qualcomm Technologies, Inc.. All Rights Reserved
...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/1x/ftm/inc/ftm_1x_control.h#1 $
...
05/10/15   dbc     Add ftm_1x_set_pa_tunable_cap() API
...
void 
ftm_1x_iq_capture_analyze_samples
(
  rfcom_device_enum_type device, 
...
void 
ftm_1x_create_iq_capture_analyze_samples_rsp_diag_pkt
(
  diagpkt_subsys_cmd_code_type ftm_chain,
  ftm_rsp_pkt_type *rsp_pkt
);
