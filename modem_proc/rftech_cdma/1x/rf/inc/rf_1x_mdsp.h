...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/1x/rf/inc/rf_1x_mdsp.h#1 $
...
/*----------------------------------------------------------------------------*/
boolean
rf_cdma_mdsp_lna_state_override
(
  lm_handle_type rxlm_handle ,
  rfm_lna_gain_state_type lna_state ,
  const rf_cdma_mdsp_cb_param_type *cb_param ,
...
/*----------------------------------------------------------------------------*/
void
rf_1x_mdsp_handle_iq_capture_rsp
(
  void* cmd_ptr,
  rf_dispatch_cid_info_type *cid_info,
  void *cb_data 
...
/*----------------------------------------------------------------------------*/
void
rf_1x_mdsp_fl_drx_override_rsp
(
  void* cmd_ptr,
  rf_dispatch_cid_info_type *cid_info,
  void *cb_data 
