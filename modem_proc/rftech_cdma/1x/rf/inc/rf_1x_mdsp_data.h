...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/1x/rf/inc/rf_1x_mdsp_data.h#1 $
...
typedef struct
{
  ...
  cfw_rx_exercise_milli_micro_sleep_msg_t millisleep_ctrl ;

  cfw_iq_capture_msg_t iq_capture;
  /*!< Message to Start IQ Capture */

  cdmafw_fl_drx_override_msg_t fl_drx_override;
  /*!< Message to override FL DRX activity in FW */
