...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_cdma.mpss/3.11/1x/rf/inc/rf_1x_mc.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
11/11/19   mk      Added clear histogram  wrapper API
03/03/16   rs      Added support for 1x2G QTA
11/26/15   rs      Added FL DRX override support
11/25/15   rs      IQ capture support
10/14/15   rs      Modified sleep API to fix the DO2L iRAT crash after 
                   FR25072
...
03/23/15   wwl     Add rf_1x_mc_wakeup_tx_v2 function prototype
