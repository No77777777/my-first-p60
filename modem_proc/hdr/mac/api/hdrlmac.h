...
$Header: //components/rel/hdr.mpss/6.0/mac/api/hdrlmac.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
DESCRIPTION
  This function is called to update the searcher with LTE nset while DO is
  in connected state.
