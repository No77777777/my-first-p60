...
$Header: //components/rel/hdr.mpss/6.0/srch/api/hdrsrchi.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
01/14/2016   wsh     Added NV to disable idle ASDiv
12/31/2015   wsh     Added support for ASDiv in TAP call
...
#define HDRSRCH_BUF_FOR_MMODE_HO_CNF_MS    20
  /* Buffer to compensate for time taken to receive HO CNF from MMode during RTT */
...
enum
{
  ...
  HDRSRCHTC_ASDIV_CFG_IDX
    /* Bit 0: Enable/Disable(default) ASDiv in TAP call */
};
...
#define HDRSRCH_DBG_NV_TAP_ASDIV_M    0x1
#define HDRSRCH_DBG_NV_TAP_ASDIV_S    0

#define HDRSRCH_DBG_TAP_WITH_ASDIV    \
   ( ( ( hdrsrch_dbg_array[HDRSRCHTC_ASDIV_CFG_IDX] & \
         HDRSRCH_DBG_NV_TAP_ASDIV_M ) >>  \
       HDRSRCH_DBG_NV_TAP_ASDIV_S ) == 1 )

#define HDRSRCH_DBG_NV_DIS_IDLE_ASDIV_M    0x2
#define HDRSRCH_DBG_NV_DIS_IDLE_ASDIV_S    1

#define HDRSRCH_DBG_DIS_IDLE_ASDIV  \
   ( ( ( hdrsrch_dbg_array[HDRSRCHTC_ASDIV_CFG_IDX] & \
         HDRSRCH_DBG_NV_DIS_IDLE_ASDIV_M ) >>  \
       HDRSRCH_DBG_NV_DIS_IDLE_ASDIV_S ) == 1 )
...
typedef struct
{
  ...
  boolean                          sysloss_pending;
    /* Whether system loss is pending */
