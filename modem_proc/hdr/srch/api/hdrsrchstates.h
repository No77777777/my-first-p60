...
$Header: //components/rel/hdr.mpss/6.0/srch/api/hdrsrchstates.h#3 $ $DateTime: 2021/08/21 11:46:50 $ $Author: pwbldsvc $
...
----------   ---     ------------------------------------------------------- 
08/19/2021   vaa     Fix for compiler warnings
12/04/2019   vaa     Changes to support clk plan V2.0 FR changes
09/11/2018   vlc     Added hdrsrchtc_is_connection_close_in_progress().
01/24/2018   vke     Added hdrsrchtc_is_connection_close_in_progress().
01/24/2017   vke     Skip ASDiv switch when OFS is about to start 
