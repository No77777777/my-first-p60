...
$Header: //components/rel/hdr.mpss/6.0/srch/api/hdrsrchset.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
----------   ---     ------------------------------------------------------- 
05/25/2015   vko     Fixed race condition in system loss and access attempt
...
FUNCTION hdrsrchset_get_aset_channel_list

DESCRIPTION
  Retrieves the list of aset channels
...
==========================================================================*/
uint8 hdrsrchset_get_aset_channel_list
(
  sys_channel_type* aset_chan
);
