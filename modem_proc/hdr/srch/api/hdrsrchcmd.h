...
$Header: //components/rel/hdr.mpss/6.0/srch/api/hdrsrchcmd.h#1 $
...
----------   ---     ------------------------------------------------------- 
06/18/2015   vke     Removed handling HDRSRCH_BAND_GRANT_RCVD_CMD
...
typedef enum
{
  ...
  HDRSRCH_UNUSED40_CMD, /* 40 */
    /* Can be used for new command enumeration */
  ...
  HDRSRCH_LTE_NSET_UPDATE_REDIR_CMD, /* 44 */
...
#ifdef FEATURE_HDR_TO_LTE_REDIRECTION
  hdrsrch_lte_nset_update_redir_params_type          lte_nset_update_redir;
