...
$Header: //components/rel/hdr.mpss/6.0/drivers/api/hdrmdspmcr.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
----------   ---     ------------------------------------------------------- 
03/24/2015   ljl     Updated fw interface.
...
/*========================================================================
 MACRO          : HDRMDSP_GET_DECOB_ADDR_VALID
 ...
 ========================================================================*/
#define HDRMDSP_GET_DECOB_ADDR_VALID( )  \
  (hdrmdsp_shared_mem_interface->read.flInterface.decobAddrValid)
#else
