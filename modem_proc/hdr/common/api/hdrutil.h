...
$Header: //components/rel/hdr.mpss/6.0/common/api/hdrutil.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
===========================================================================*/
/* Defines related to mcfg_fs API */
#define HDR_FS_TYPE           0 /* EFS */
#define HDR_FS_SUB_ID         0 /* SUB 0 */
#define HDR_FS_FLAG           ( MCFG_FS_O_CREAT | MCFG_FS_O_AUTODIR )
#define HDR_FS_PERM           MCFG_FS_ALLPERMS
