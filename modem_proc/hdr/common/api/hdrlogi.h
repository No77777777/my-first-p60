...
$Header: //components/rel/hdr.mpss/6.0/common/api/hdrlogi.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
04/01/15   vlc     Added HDRLOG_PHYSICAL_LAYER_POWER_INFO_PAD_LEN constant. 
...
#define HDRLOG_PHYSICAL_LAYER_POWER_INFO_PAD_LEN  7

LOG_RECORD_DEFINE(LOG_EVDO_PHYSICAL_LAYER_POWER_INFO_C)
  uint8      log_pkt_version;
  uint8      padding[ HDRLOG_PHYSICAL_LAYER_POWER_INFO_PAD_LEN ]; /* Ensure byte alignment of ustmr */
