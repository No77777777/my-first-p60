...
$Header: //components/rel/hdr.mpss/6.0/common/api/hdrlog.h#2 $ $DateTime: 2019/08/29 22:50:51 $ $Author: pwbldsvc $
...
--------   ---     -------------------------------------------------------- 
08/30/19   svu     Fixed Compiler error
...
typedef enum
{
  ...
  HDRLOG_MCS_CLR_PKT_RATE_METRICS_MASK = HDRCOM_BITMASK(0),

  /* Reset Physical Channel Metrics */
  HDRLOG_MCS_CLR_PHY_CHAN_METRICS_MASK = HDRCOM_BITMASK(1),

  /* Reset Logical Channel Metrics */
  HDRLOG_MCS_CLR_LOGI_CHAN_METRICS_MASK = HDRCOM_BITMASK(2)
