...
$Header: //components/rel/hdr.mpss/6.0/common/api/hdrmultirat.h#2 $ $DateTime: 2019/12/05 01:53:14 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/04/19   vaa     Changes to use different Q6 clk values for Habenaro
...
/*------------------------------------------------------------------------
  HDR Multirat EFS NV Item related defines
------------------------------------------------------------------------*/
#define HDRMULTIRAT_EFS_NV_CONF_FILE_PATH  "/nv/item_files/conf/hdrmultirat_config_info.conf"

#define HDRMULTIRAT_EFS_NV_BAND_AVOID_ENABLE  "/nv/item_files/modem/hdr/common/hdr_multirat_nv"

#if defined FEATURE_HDR_CLK_BOOST_QTA_GAP || defined FEATURE_HDR_L_QTA
#define HDRMULTIRAT_DEFAULT_QTA_Q6_CLK_KHZ             768000
  /* Q6 Clk boost for QTA */

#define HDRMULTIRAT_DEFAULT_QTA_VPE_CLK_KHZ            518400
  /* VPE Clk boost for QTA */
#endif /* FEATURE_HDR_CLK_BOOST_QTA_GAP || FEATURE_HDR_L_QTA */
...
/* Structure to store all hdrmultirat NV info */
typedef struct
{
   uint16                              manage_hdr_multirat;
     /* Place holder for any future multirat NVs*/

   uint16                              band_avoidance;
     /* Is band avoidance enabled or disabled?
        Band_avoidance == 1 means enabled */

}hdrmultirat_config_nv_type;
...
typedef struct
{
  ...
  boolean                              rx_reg;
    /* Flag to indicate whether we've send out freq update to FW with non-0
       rx carriers */
  ...
  hdrmultirat_config_nv_type           nv_config;
    /* HDR multirat NV structure */
