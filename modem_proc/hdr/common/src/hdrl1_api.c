...
--------   ---     ---------------------------------------------------------- 
02/20/18   svu     Added API to query the subscriber id
09/23/15   rmv     Added API to query second chain test mode status 
...
{
  return hdrsrchrfdiv_is_second_chain_only();
}
/*==========================================================================
...
{
   return hdrsrch_get_subscriber_id();
}