...
$Header: //components/rel/hdr.mpss/6.0/api/hdrl1_api.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $

when         who     what, where, why
----------   ---     -------------------------------------------------------- 
02/20/2018   svu     Added API to query the subscriber id
09/23/2015   rmv     Added API to query second chain test mode status 
07/23/2015   vko     FR 29379 : Disable tuneaway during Qchat call
06/12/2015   bb/vlc  Added hdrl1_srch_is_in_suspend_state(). 
06/05/2015   vko     Added support for D2L redirection
...
/* hdrsrchtype.h */
#define hdrsrchtclte_rpt_cell_struct_type    hdrl1_srchtclte_rpt_cell_struct_type
#define hdrsrchtclte_rpt_struct_type         hdrl1_srchtclte_rpt_struct_type
...
hdrl1_srchtclte_rpt_cell_struct_type;
...
typedef struct
{
  ...
  hdrl1_srchtclte_rpt_cell_struct_type  cell[ HDRCOM_SRCH_LTE_CELL_ARR_SIZE * HDRCOM_SRCH_LTE_FREQ_ARR_SIZE ];
    /* Array of LTE cell to report  */

}
hdrl1_srchtclte_rpt_struct_type;
...
/*===========================================================================
FUNCTION HDRL1_SRCH_GET_SECOND_CHAIN_TESTMODE_STATUS

DESCRIPTION
  This function gets whether second chain only test mode is enabled or not
...
RETURN VALUE
  TRUE -  second chain only test mode is enabled
  FALSE - not enabled

SIDE EFFECTS
  None
 ===========================================================================*/
boolean hdrl1_srch_get_second_chain_testmode_status(void);
/*==========================================================================

FUNCTION HDRL1_SRCH_GET_SUBSCRIBER_ID
...
==========================================================================*/
sys_modem_as_id_e_type hdrl1_srch_get_subscriber_id ( void );
#endif /* HDRL1_API_H */
