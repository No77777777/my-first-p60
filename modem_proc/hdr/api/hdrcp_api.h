...
$Header: //components/rel/hdr.mpss/6.0/api/hdrcp_api.h#1 $

when         who     what, where, why
----------   ---     -------------------------------------------------------- 
12/05/2017   pga     API to get the EVDO release version
10/13/2015   vko     API to check if reselection is given to LTE and is in progress
...
/* Defines the EVDO release version */
typedef enum
{
 EVDO_REL_0 = 1,
 EVDO_REL_A = 3,
 EVDO_REL_B = 6,
 EVDO_REL_C = 9
}hdrcp_mc_evdo_release_version_enum_type;
...
RETURN VALUE
  TRUE - if reselection is in progress
  FALSE - if reselection is NOT in progress
