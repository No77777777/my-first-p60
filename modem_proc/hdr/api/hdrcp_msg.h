...
$Header: //components/rel/hdr.mpss/6.0/api/hdrcp_msg.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
enum
{
  ...
  MSGR_DEFINE_UMID(HDR, CP, REQ, UE_MODE_CHANGE, 0x2a, hdrcp_ue_mode_pref_chgd_req_msg_t),
...
typedef struct
{
  ...
  sys_sys_mode_e_type            subs_capability;
 /*! <sub capability */
...
typedef union {
  ...
  sd_lte_mode_change_ind_s_type            sd_mode_pref;
