...
$Header: //components/rel/hdr.mpss/6.0/cp/api/hdrscp.h#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/10/18   svu     Fixed restoring session to the corresponding subid
