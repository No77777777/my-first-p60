...
$Header: //components/rel/hdr.mpss/6.0/cp/src/hdrsap.c#1 $ $DateTime: 2019/06/19 22:12:26 $ $Author: pwbldsvc $
...
void hdrsap_powerup_init ( void )
{
  ...
  if ( hdrutil_fs_get( HDRSAP_BACKOFF_TIME_TABLE_L2_FAILED,
  ...
  if ( hdrutil_fs_get( HDRSAP_SET_PREREG_STATUS, &hdrsap.set_prereg_status, 1 ) == MCFG_FS_STATUS_OK )
  {
    HDR_MSG_PROT( MSG_LEGACY_MED, 
