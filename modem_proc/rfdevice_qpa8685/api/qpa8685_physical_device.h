#ifndef QPA8685_PHYSICAL_DEVICE_AG_H
#define QPA8685_PHYSICAL_DEVICE_AG_H
/*!
   @file
   qpa8685_physical_device_ag.h

   @brief
   qpa8685 physical device driver
...
$Header: //components/rel/rfdevice_qpa8685.mpss/1.11/api/qpa8685_physical_device.h#1 $ 
...
#include "qpa8685_pa_config_main_ag.h"

class qpa8685_physical_device : public rfdevice_physical_device
{
public:
  qpa8685_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qpa8685_physical_device* qpa8685_physical_device_p;
...
private:
  ...
  rfdevice_qpa_4g* qpa8685_pa_obj_ptr;
