...
#ifndef QPA6560_PA_CONFIG_AG_H
#define QPA6560_PA_CONFIG_AG_H/*
...
boolean rfdevice_qpa_qpa6560_construct_driver_ag
(
  rfdevice_qpa_4g_settings_type* qpa_settings,
  rfdevice_qpa_4g_func_tbl_type* pa_fn_ptrs
);

uint8 rfdevice_qpa_qpa6560_get_efs_data_column
(
  uint8 port_index, 
  rfdevice_qpa_4g_tx_bw_data_type lcl_bw
);

boolean rfdevice_qpa_qpa6560_is_dpd_port
(
  uint8 port_index
);
