...
#ifndef QPA6560_PHYSICAL_DEVICE_AG_H
#define QPA6560_PHYSICAL_DEVICE_AG_H
/*!
   @file
   qpa6560_physical_device_ag.h

   @brief
   qpa6560 physical device driver
...
$Header: //components/rel/rfdevice_qpa6560.mpss/1.11/api/qpa6560_physical_device.h#1 $ 
...
#include "qpa6560_pa_config_main_ag.h"
#include "qpa6560_asm_config_main_ag.h"
#include "qpa6560_gsm_pa_config_main_ag.h"

/* Bitmask for bits reserved for logical PAs */
#define QPA6560_PA_VOTE_MASK 0xFF
/* Number of bits to reserve for logical PAs */
#define QPA6560_PA_VOTE_RESERVED_BITS 8


class qpa6560_physical_device : public rfdevice_physical_device
{
public:
  qpa6560_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qpa6560_physical_device* qpa6560_physical_device_p;
...
private:
  ...
  rfdevice_qpa_4g* qpa6560_pa_obj_ptr;
  rfdevice_qpa_4g* qpa6560_pa_gsm_obj_ptr;

  /* ASM */
  rfdevice_qasm_2g* qpa6560_asm_obj_ptr;
