...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/elite/vsd/vs/src/vs_vocevrcnw.c#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
)
{
  ...
  session_obj->cmd_ctrl.last_cmd = vs_adsp_last_cmd_sent = VSS_ISTREAM_CMD_VOC_4GVNW_SET_RATE;
