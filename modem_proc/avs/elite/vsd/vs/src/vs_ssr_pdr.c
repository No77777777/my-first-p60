...
/* 
   ...
   $Header: //components/rel/avs.mpss/9.0.c51/elite/vsd/vs/src/vs_ssr_pdr.c#1 $
   $Author: pwbldsvc $
*/
...
/*when early pd down is received and pd down is not yet received then only we will make it TRUE*/
