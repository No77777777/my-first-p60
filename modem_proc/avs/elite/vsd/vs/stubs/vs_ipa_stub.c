...
/*
  ============================================================================
   ...
   Copyright (C) 2018-21 QUALCOMM Technologies, Inc.
   All Rights Reserved.
   Confidential and Proprietary - Qualcomm Technologies, Inc.

   $Header: //components/dev/avs.mpss/9.1/dgoud.avs.mpss.9.1.kuno_changes_reverting_mpss_91_may_22/vsd/vs/stubs/vs_ipa_stub.c#1 $
   $Author: dgoud $
