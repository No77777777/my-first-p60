...
/*
  ============================================================================
   ...
   $Header: //components/rel/avs.mpss/9.0.c51/elite/vsd/vs/stubs/vs_servreg_stub.h#1 $
   $Author: sduddell 
*/
...
typedef enum
{
   ...
   SERVREG_SERVICE_STATE_EARLY_DOWN   = 0x2FFFFFFF,           /* Logically exists right at this instance but not expected to respond */
