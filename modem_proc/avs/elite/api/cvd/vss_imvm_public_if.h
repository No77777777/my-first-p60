...
=============================================================================*/
/*===========================================================================
Copyright (c) 2011, 2012, 2015, 2019 Qualcomm Technologies, Inc.  All rights reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/avs.mpss/9.0.c51/elite/api/cvd/vss_imvm_public_if.h#1 $
  $Author: pwbldsvc $
...
/** @ingroup cvd_mvm_cmd_create_full_ctrl
  ...
  @par
  If a name is supplied, it must be NULL terminated. A name of size zero is
...
/** 
  Sent by mvm to modem to indicate the start of HLOS voice session.
...
#define VSS_IMVM_EVT_APPS_START ( 0x0001337C )

/** 
  Sent by mvm to modem to indicate that HLOS has destroyed voice session.
...
#define VSS_IMVM_EVT_APPS_STOP ( 0x0001339F )
