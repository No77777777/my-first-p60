...
/*===========================================================================
  ...
  $Header: //components/rel/avs.mpss/9.0.c51/elite/api/cvd/vss_params_public_if.h#1 $
  $Author: pwbldsvc $
...
/** @ingroup cvd_common_module_generic
  ...
  @tablens{weak__vss__param__port__endpoint__media__info__t} @newpage
*/
...
/** The CVD takes channel mapping information for only eight channels, even
    though the HLOS sends channel mapping information for 32 channels.
...
struct vss_param_port_endpoint_media_info_t
{
   ...
   /**< ID of the AFE port to which this media format corresponds.
        ...
        @values
       - Refer to @xrefcond{Q6,80-NF775-3,80-NA611-3}
...
/** @ingroup cvd_common_module_generic
  ...
  @tablens{weak__vss__param__vocproc__dev__channel__info__t} @newpage
*/
...
/** @addtogroup cvd_common_voice_params
@{ */
/** @weakgroup weakb_vss_param_stream_loopback
@{ */
/** Sets the stream loopback mode to OFF. */
#define VSS_PARAM_STREAM_LOOPBACK_OFF ( 0 )

/** Sets the stream loopback mode to ON. */
#define VSS_PARAM_STREAM_LOOPBACK_ON ( 1 )
/** @} *//* end_weakgroup weakb_vss_param_stream_loopback */

/**
  ID of the parameter used by the VOICESTREAM_MODULE_TX module to enable or
  disable CVD loopback.

  Set this parameter using in-band or out-of-band memory in
  #VSS_ICOMMON_CMD_SET_PARAM_V3.

  @msgpayload{vss_param_stream_loopback_t}
  @table{weak__vss__param__stream__loopback__t}

  @inputfile{group__weakb__vss__param__stream__loopback.tex}
 */
#define VSS_PARAM_STREAM_LOOPBACK ( 0x00010E18 )

typedef struct vss_param_stream_loopback_t vss_param_stream_loopback_t;

#include "apr_pack_begin.h"
/** @weakgroup weak_vss_param_stream_loopback_t
@{ */
struct vss_param_stream_loopback_t
{
  uint32_t enable_mode;
  /**< Enables CVD Loopback mode.

       @values
        - #VSS_PARAM_STREAM_LOOPBACK_ON
        - #VSS_PARAM_STREAM_LOOPBACK_OFF @tablebulletend */
}
#include "apr_pack_end.h"
;
/** @} *//* end_weakgroup weak_vss_param_stream_loopback_t */
/** @} *//* end_addtogroup cvd_common_voice_params */
