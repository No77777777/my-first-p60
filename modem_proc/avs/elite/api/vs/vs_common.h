...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/elite/api/vs/vs_common.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/* Cellular IWLAN - In roaming, internet PDN will be used to make volte/vonr
   calls instead of IMS PDN */
#define VS_COMMON_NETWORK_ID_CIWLAN    ( 0x000133CF )
