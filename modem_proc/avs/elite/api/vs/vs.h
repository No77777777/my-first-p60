...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/elite/api/vs/vs.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
 ...
 * Major version 1  indicates that Timeline Resync FR is not supported.  */
#define VS_API_VERSION    0x00010000
