...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/elite/api/vs/vs_pktexg.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** 
 *  Event generated by voice services to notify the client that frame type of the
 *  uplink packet is NO_DATA.
 *
 *  For VFR 40ms, where two encoder packets are available, this event is sent
 *  only if frame type of both packets is NO_DATA. If either of them has SID/speech
 *  data, this event will not be sent.
 *
 *  In the scenario of 40ms with encoder miss, this event will be sent based on the 
 *  frame type of other packet in the same cycle.
 *
 * The client shall
 *   - Get the encoder buffer via VS_PKTEXG_CMD_GET_ENCODER_BUFFER.
 *   - Return the encoder buffer via VS_PKTEXG_CMD_RETURN_ENCODER_BUFFER after consumption.
 */
#define VS_PKTEXG_EVENT_NO_DATA_PACKET ( 0x000133BD )
