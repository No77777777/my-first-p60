#ifndef __VS_OBJMGR_H__
#define __VS_OBJMGR_H__
...
/*
  ...
  $Header: //components/rel/avs.mpss/9.0.c51/vsd/utils/inc/protected/vs_objmgr.h#1 $
  $Author: pwbldsvc $
*/
...
#include "gpr_list.h"   /* For the link-list implementation. */
 ...
 */
typedef struct vs_objmgr_object_t
{
...
typedef void ( *vs_objmgr_lock_fn_type )( void );
typedef void ( *vs_objmgr_unlock_fn_type )( void );

typedef struct vs_objmgr_t
{
  gpr_list_t free_q;
    /**< The free object queue. */
  vs_objmgr_object_t* table;
  ...
  uint32_t overflow_mask;
     ...
     * bits.
     */
  vs_objmgr_lock_fn_type lock_fn;
  vs_objmgr_unlock_fn_type unlock_fn;
}
  vs_objmgr_t;

typedef struct vs_objmgr_setup_params_t
{
  vs_objmgr_object_t* table;
    /**< The object storage table. */
  uint32_t total_bits;
