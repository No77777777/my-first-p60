...
/*
  ...
  ============================================================================
   $Header: //components/rel/avs.mpss/9.0.c51/vsd/vs/src/vs_vocamrwb.c#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
)
{
  ...
  session_obj->vocoder.enc_module_id = VS_VOCAMRWB_ENC_MODULE_ID;
  session_obj->vocoder.dec_module_id = VS_VOCAMRWB_DEC_MODULE_ID;
