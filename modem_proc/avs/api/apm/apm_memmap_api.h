...
@brief This file contains the structure definitions for the memory map commands
*/
/*===========================================================================
...
$Header: //components/rel/avs.mpss/9.0.c51/api/apm/apm_memmap_api.h#1 $

when       who     what, where, why
--------   ---      -------------------------------------------------------
04/18/18   SJ      Created file.
03/15/19   AKR     MDF APIs
========================================================================== */
