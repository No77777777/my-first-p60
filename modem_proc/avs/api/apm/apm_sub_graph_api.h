...
/*========================================================================*/
/**
@file aom_sub_graph_api.h

This file contains APM sub-graph related commands and events 
...
$Header: //components/rel/avs.mpss/9.0.c51/api/apm/apm_sub_graph_api.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------
04/18/18    sj    Created File
...
#define APM_SUB_GRAPH_VSID_SUB1                   MM_NON_GUID(0x11C05000)

/**< Enumeration for VSID Voice call with Subscription 2 and VSID 0x11DC5000 */
#define APM_SUB_GRAPH_VSID_SUB2                   MM_NON_GUID(0x11DC5000)

/** Apps only mode with vocoder loopback on SUB1 */
#define APM_SUB_GRAPH_VSID_VOC_LB_SUB1            MM_NON_GUID(0x12006000)

/** Apps only mode with vocoder loopback on SUB2 */
#define APM_SUB_GRAPH_VSID_VOC_LB_SUB2            MM_NON_GUID(0x121C6000)

/**< Dont care value for VSID, which shall be enumerated by HLOS client at a later time. */
#define APM_SUB_GRAPH_VSID_DONT_CARE              MM_NON_GUID(0xFFFFFFFF)
