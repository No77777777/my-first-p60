/*==============================================================================
  @file mailbox_api.h
  @brief This file contains CAPI_v2 Mailbox rx and tx module APIs
==============================================================================*/
...
#define MAILBOX_RX_DTMF_GEN_STATIC_CONTROL_PORT_ID    0xC0000001
...
/**
 * Param ID for DTMF tone and the payload. Param data will be same as 
 * payload for MEDIA_FMT_ID_DTMF.
 */
#define PARAM_ID_DTMF_CFG                             0x08001385
...
struct payload_media_fmt_dtmf_tone_t
{
   ...
   uint16_t generate_mixed_output;
   /**< @h2xmle_description { Flag to inidicate if the generated DTMF tone needs to be mixed or not.
                                ...
                                1 -  Indicates tone needs to be mixed with primary path. }
        @h2xmle_default     {0}
        @h2xmle_range       {0,1}
        @h2xmle_policy      {Basic} */
}
...
struct mailbox_config_t
{
  ...
  /**< @h2xmle_description {Unique identifier for the shared memory address of the mailbox vocoder
                             ...
                             The Gecko returns this handle through #APM_CMD_RSP_SHARED_MEM_MAP_REGIONS.} 
        @h2xmle_default     {0} 
        @h2xmle_range       { 0..0xFFFFFFFF }
        @h2xmle_policy      {Basic} */             
 ...
 * 
 * Required container capabilities: APM_CONTAINER_CAP_ID_CD, APM_CONTAINER_CAP_ID_EP
 *
...
/**
    ...
    @h2xmlm_displayName    {"Mailbox Rx End Point"}
    @h2xmlm_description    {
                            This module is used to write data to
                            Gecko from the client through
    ...
    @h2xmlm_reqContCapabilities  {APM_CONTAINER_CAP_CD, APM_CONTAINER_CAP_EP}
...
/**
    ...
    @h2xmlm_displayName    {"Mailbox Tx End Point"}
    @h2xmlm_description    {
                            This module is used to read data
                            from Gecko to the Client through
