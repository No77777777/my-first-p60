...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocfr.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** Module IDs of FR encoder and decoder */
#define VS_VOCFR_ENC_MODULE_ID ( 0x07001077 )
#define VS_VOCFR_DEC_MODULE_ID ( 0x07001076 )
