...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocevs.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** Module IDs of EVS encoder and decoder */
#define VS_VOCEVS_ENC_MODULE_ID ( 0x0700104A )
#define VS_VOCEVS_DEC_MODULE_ID ( 0x07001049 )
