...
/*
 ...
 ============================================================================
 $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocamrwb.h#1 $
 $Author: pwbldsvc $
 ============================================================================
*/
...
/** Module ID of AMR WB encoder and decoder. */
#define VS_VOCAMRWB_ENC_MODULE_ID ( 0x07001079 )
#define VS_VOCAMRWB_DEC_MODULE_ID ( 0x07001078 )
