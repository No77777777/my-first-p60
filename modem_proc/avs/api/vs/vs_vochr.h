...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vochr.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** Module IDs of HR encoder and decoder. */
#define VS_VOCHR_ENC_MODULE_ID ( 0x07001075 )
#define VS_VOCHR_DEC_MODULE_ID ( 0x0700108E )
