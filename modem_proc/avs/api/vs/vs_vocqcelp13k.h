...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocqcelp13k.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** Module IDs of QCELP-13K encoder and decoder. */
#define VS_VOCQCELP13K_ENC_MODULE_ID ( 0x0700108B )
#define VS_VOCQCELP13K_DEC_MODULE_ID ( 0x0700108A )
