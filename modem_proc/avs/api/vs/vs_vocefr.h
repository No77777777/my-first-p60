...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocefr.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** Module IDs of EFR encoder and decoder. */
#define VS_VOCEFR_ENC_MODULE_ID ( 0x0700108D )
#define VS_VOCEFR_DEC_MODULE_ID ( 0x0700108C )
