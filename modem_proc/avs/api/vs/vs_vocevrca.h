...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocevrca.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/** Module IDs of EVRC-A encoder and decoder. */
#define VS_VOCEVRCA_ENC_MODULE_ID ( 0x700105F )
#define VS_VOCEVRCA_DEC_MODULE_ID ( 0x700105E )
