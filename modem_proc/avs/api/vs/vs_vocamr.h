...
/*
  ...
  ============================================================================
  $Header: //components/rel/avs.mpss/9.0.c51/api/vs/vs_vocamr.h#1 $
  $Author: pwbldsvc $
  ============================================================================
*/
...
/*Module ID of EAMR/AMR Encoder and Decoder*/
#define VS_VOCAMR_ENC_MODULE_ID ( 0x0700104B )
#define VS_VOCAMR_DEC_MODULE_ID ( 0x07001047 )
