...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_rrc_ext_msg.h#3 $

when       who       what, where, why
--------   ---       ---------------------------------------------------------- 
02/25/16   sunita    FR 28315 Added LTED interface changes NAS-RRC. 
...
/* Maximum FPLMN list size, discussed with NAS folks*/
#define LTE_RRC_MAX_FPLMN_LIST_SIZE  128  

/* Invalid value for Q-RxLevMin, used when LTE is deactivated */
#define LTE_RRC_Q_RXLEVMIN_INVALID_VALUE 0
...
typedef enum
{
  LTE_RRC_POWER_RANGE_SHORT,
  LTE_RRC_POWER_RANGE_MEDIUM,
  LTE_RRC_POWER_RANGE_LARGE,
  LTE_RRC_POWER_RANGE_MAX
}lte_rrc_power_range_e;
...
typedef enum
{
  ...
  /*Failure as a result of ELS CONN ABORT req  */
  LTE_RRC_CONN_EST_FAILURE_ELS_ABORTED, /*!< 15*/
...
typedef enum
{
  ...
  LTE_RRC_CONN_REL_OOS_RF_UNAVAILABLE_DURING_CRE, /*!< 13 */
  LTE_RRC_CONN_REL_LOCAL, /*!< 14 -only for RRC local release after hold timer expiration. */
 LTE_RRC_CONN_REL_SSGCCS_CELL_BAR, /*!16- Local release for SSGCCS cell bar in connected state*/
...
typedef enum
{
  ...
  LTE_RRC_UL_DATA_CNF_FAILURE_CONN_REL_RLF_NONDDS_SPV_TMR_EXPIRY, /*!< 6 */
...
typedef enum
{
  ...
  LTE_RRC_TUNNEL_UL_MSG_CNF_FAILURE_RLF_SPV_TIMER_EXPIRY_ON_NONDDS, /*!< 8 */
...
typedef enum
{
  ...
  LTE_RRC_PLMN_SEARCH_ABORTED_ON_TRM_FAILURE, /*!<6*/
...
typedef enum
{
  ...
  LTE_RRC_SERVICE_REQ_TYPE_FULL_RAT_MODE, /*!< 3*/
...
*/
/* @brief Enumeration for LTE RRC states meant for external modules */
typedef enum
{
  LTE_RRC_STATE__INACTIVE,
  LTE_RRC_STATE__IDLE_NOT_CAMPED,
  LTE_RRC_STATE__IDLE_CAMPED,
  LTE_RRC_STATE__CONNECTING,
  LTE_RRC_STATE__CONNECTED,
  LTE_RRC_STATE__SUSPENDED,
  LTE_RRC_STATE__IRAT_TO_LTE_STARTED,
  LTE_RRC_STATE__CLOSING,
} lte_rrc_state_e;
...
/*! @brief Data structure for SYS PLMN list type
*/
typedef struct
{
  uint32 num_plmns; /*!< Number of PLMNs */
  sys_plmn_id_s_type plmn[LTE_RRC_MAX_PLMN_LIST_SIZE]; /*!< List of PLMNs */
} sys_sib1_plmn_list_s;
...
/*! @brief Data structure for FPLMN list type
*/
typedef struct
{
  uint32 num_plmns; /*!< Number of PLMNs */
  lte_rrc_plmn_s plmn[LTE_RRC_MAX_FPLMN_LIST_SIZE]; /*!< List of FPLMNs */
} lte_rrc_fplmn_list_s;
...
typedef enum
{
  LTE_RRC_TAI_LIST_NONE,            /*!< 0 */
  LTE_RRC_TAI_LIST_ADD,              /*!< 1 */
  LTE_RRC_TAI_LIST_REMOVE,      /*!< 2 */
} lte_rrc_tai_list_action_type_e;
typedef struct
{
    lte_rrc_tai_list_action_type_e             tai_list_action;
...
typedef enum
{
  LTE_RRC_CELL_BARRING_TYPE_NONE   = 0,      /*!< 0 */
  LTE_RRC_CELL_BARRING_TYPE_CONDITIONAL    = 1,      /*!< 1 */
  LTE_RRC_CELL_BARRING_TYPE_UNCONDITIONAL   = 2,      /*!< 2 */

  LTE_RRC_CELL_BARRING_TYPE_MAX     = 3 

} lte_rrc_ac_barring_type_e;

typedef enum
{
  LTE_RRC_CALL_TYPE_MO_SIGNALLING = 0,      /*!< 0 */
  LTE_RRC_CALL_TYPE_MO_DATA   = 1,      /*!< 1 */
  LTE_RRC_CALL_TYPE_VOICE  = 2,      /*!< 2 */

  LTE_RRC_CALL_TYPE_VIDEO     = 3,
  LTE_RRC_CALL_TYPE_EMERG  = 4,
  LTE_RRC_CALL_TYPE_SMS = 5,
  LTE_RRC_CALL_TYPE_CSFB = 6,

  LTE_RRC_CALL_TYPE_MAX = 7
...
typedef struct
{
  ...
  lte_rrc_call_type_e call_type;
  
  boolean barring_status;	 /*!< Current Barring status for MO Signalling
                                  TRUE ---> Barred
                                  FALSE---> Not barred */
...
typedef struct
{
  ...
  boolean sib2_special_AC_mmtel_voice_present; /*!< Special AC parameter present for MMTEL voice in SIB */ 
  uint8 sib2_special_AC_mmtel_voice; /*!< Access barring factor for special AC*/ 
  lte_rrc_ac_barring_type_e barring_type_voice;
  ...
  boolean sib2_special_AC_mmtel_video_present; /*!< Special AC parameter for MMTEL video present in SIB */ 
  uint8 sib2_special_AC_mmtel_video; /*!< Access barring factor for special AC*/ 
  lte_rrc_ac_barring_type_e barring_type_video;
...
typedef struct
{
  ...
  lte_rrc_ac_barring_type_e ac_barring_type_emergency;
  ...
  lte_rrc_ac_barring_type_e ac_barring_type_mo_signalling;
  ...
  lte_rrc_ac_barring_type_e ac_barring_type_mo_data;

  /*!< Indicates Access Barring info for CSFB*/
  boolean ac_barring_csfb_present;
  lte_rrc_ac_barring_params_s ac_barring_csfb;	  /*!< Access Barring info for CSFB*/

  lte_rrc_ac_barring_type_e ac_barring_type_csfb;
...
/*! @brief Enumeration for LTE cell direction
*/
typedef enum
{
  LTE_RRC_CELL_DIRECTION_DL_ONLY, /*!< 0 */

  LTE_RRC_CELL_DIRECTION_DL_UL, /*!< 1 */

} lte_cell_direction_e;

/*! @brief Data Structure for Cell information
 */
typedef struct
{
	lte_cell_direction_e ul_dl_direction;	/*!< DL Only or DL/UL */

	lte_earfcn_t dl_earfcn;	/*!< DL EARFCN */

	lte_earfcn_t ul_earfcn;	/*!< UL EARFCN; Will be 0 when cell direction is DL only */

	lte_bandwidth_e bandwidth;/*! Cell Bandwidth in NRB */

} lte_rrc_ext_cell_info_s;

#define LTE_RRC_MAX_LTE_NEIGH_FREQ 32

/*! @brief Data Structure for Current Cells information
 */
typedef struct
{
    lte_rrc_state_e lte_rrc_state;

	uint8 num_serv_cell;	/*!< Number of valid serving cells;
														Will be 0 during OOS, 
														1 when camped or connected to a PCell without Scells
														> 1 when configured with CA (PCell and SCell(s) */
							
	lte_rrc_ext_cell_info_s serving_cell_list[LTE_CPHY_MAX_SERVING_CELL];

	uint8 num_lte_neigh_freq;	/*!< Number of valid LTE neighbor freqs;
                                0 means there are no neighbor freqs */
	lte_rrc_ext_cell_info_s lte_neigh_freq_list[LTE_RRC_MAX_LTE_NEIGH_FREQ]; 

} lte_rrc_current_cells_s;

/*! @brief Data Structure for Current Cells information request
 */
typedef struct
{
	msgr_hdr_struct_type msg_hdr;

} lte_rrc_current_cells_info_req_s;
...
typedef enum
{
  ...
  LTE_TRM_PRIORITY_REQ_FROM_IMS /*!< 4 */
} lte_trm_client_id_e;
...
{
  msgr_hdr_s msg_hdr; /*!< Message router header */
 /*TODO: Remove this once CM/DS changes for TRM-U are checked in*/
  lte_trm_priority_e trm_priority; /*Indicates TRM priority(HIGH/LOW) for RRC connection establishment*/
  sys_proc_type_e_type proc_type; /* Indicates the client highest priority procedure*/
...
/*! @brief Message to get negotiated drx request
 */
typedef struct
{
  msgr_hdr_struct_type msg_hdr;

} lte_rrc_idle_drx_info_req_s;

/*! @brief Message to get IMS AUTO REJECT REQ
 */
typedef struct
{
  msgr_hdr_s  msg_hdr;
  boolean     is_auto_reject_enabled;
}lte_rrc_ims_auto_reject_req_s;
...
enum
{
  ...
  */
  ...
  MSGR_DEFINE_UMID(LTE, RRC, REQ, CAP_EFS_REREAD, 0x2B, lte_rrc_cap_efs_reread_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, EMBMS_SERVICE_INTEREST_INFO, 0x2C, lte_rrc_embms_service_interest_info_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, IDLE_DRX_INFO,       0x2D, lte_rrc_idle_drx_info_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, UE_CAP_CFG, 0x2E, lte_rrc_ue_cap_cfg_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, PROSE_CFG,0x2F, lte_rrc_prose_cfg_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, PROSE_SL_DED_CFG,0x30, lte_rrc_prose_sl_ded_cfg_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, REFRESH_SYSTEM_TIME_INFO, 0x31, lte_rrc_refresh_system_time_info_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, PLMN_SWITCH,       0x32, lte_rrc_plmn_switch_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, ELS_CONN_ABORT,    0x33, 
                                                    lte_rrc_els_conn_abort_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, CELL_LOCK, 0x34, lte_rrc_cell_lock_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, IMS_AUTO_REJECT, 0x35, lte_rrc_ims_auto_reject_req_s),
  MSGR_DEFINE_UMID(LTE, RRC, REQ, CURRENT_CELLS_INFO, 0x36, lte_rrc_current_cells_info_req_s),
};
...
typedef struct
{
  ...
  /*TODO: Remove once CM/DS changes for TRM-U are checked in*/
  lte_trm_priority_e trm_priority; /*Indicates TRM priority(HIGH/LOW) for RRC connection establishment*/

  sys_proc_type_e_type proc_type; /* Indicates the client highest priority procedure*/

  sys_lte_reestab_calltype_e est_calltype; /*!< Call type used for determining ACB skip, need not necessarily mean the purpose of the call */
  ...
  boolean is_tau_due_to_ta_change;
} lte_rrc_conn_est_req_s;
...
/*! @brief Enumeration for cell bar cause
*/
typedef enum
{ 
  /* Cell was barred for unknow reason */
  LTE_RRC_CELL_BAR_UNKNOWN, /*!< 0 */

  /* Cell was barred due to fake cell */
  LTE_RRC_CELL_BAR_FAKE_CELL /*!< 1 */
  
} lte_rrc_cell_bar_cause_e;
typedef enum
{
  LTE_RRC_ELS_CONN_ABORT_CAUSE_MME_SUSPEND, /*!< 0 */

  LTE_RRC_ELS_CONN_ABORT_CAUSE_MME_NOT_SUSPEND, /*!< 1 */

  LTE_RRC_ELS_CONN_ABORT_CAUSE_MAX
} lte_rrc_els_conn_abort_cause_e;

/*! @brief Message for ELS Connection Release Request,if UE is connected.
*/
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */

  /*! ELS connection release cause */
  lte_rrc_els_conn_abort_cause_e cause;
} lte_rrc_els_conn_abort_req_s;
...
typedef struct
{
 ...
 lte_rrc_cell_bar_cause_e cause;  /*!< Barred Cause */
...
typedef struct
{
  ...
  lte_rrc_tai_list_s   forbidden_tai_list;

  lte_rrc_fplmn_list_s fplmn_list; /*!< FHPLMN list */
} lte_rrc_system_update_req_s;
...
typedef struct
{
  ...
  ** in bplmn search by lower layers*/
  sys_rat_pri_list_info_s_type    mcc_mode_band_filter;
   ...
   /* MPLMN Periodic frequency scan list */
  sys_arfcn_list_s_type  frequency_list;
    
 /*priority for periodic frequency search*/ 
  sys_srch_priority_e_type priority; 
...
typedef struct
{
  ...
  /*! @brief Message for eMBMS service interest from Service layer that contains the list
  of eMBMS services that service layer (user) is interested in receiving. Service layer
  can indicate interest for upto 128 services. However out of that UE will send Counting
  response for atmost 16 services.
 */
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */
  ...
  /*!< Format represented below.
       -------------------------------------------------------------------------------------------
       |num_interested_services|  TMGI1 PLMN Octet 1  | PLMN Octet 2 |  PLMN Octet 3 | Service ID Octet 1 | Service ID Octet 2 | Service ID Octet 3 | Session ID present | TMGI 1 Session ID |... | TMGI n PLMN Octet 1  |...|TMGI n Session ID|
                  n                                                                                                                                       (boolean)
       |        1 byte         |        1 byte        |   1 byte     |      1 byte   |        1 byte1     |       1 byte       |        1 byte      |       1 byte       |        1 byte     | ...|       1 byte         |...|     1 byte      |
       -------------------------------------------------------------------------------------------*/
  msgr_attach_s dsm_attach; /*!< dsm attachment containing the List of interested services,
                             upto a maximum of LTE_EMBMS_MAX_SESSIONS_IN_COUNTING_RSP */
 
  int16 debug_trace_id; /*!< Debug trace id range 0 to 32767, -1 if not used, should match
                            what came in LTE_RRC_EMBMS_SERVICE_INTEREST_IND */
 
} lte_rrc_embms_service_interest_info_req_s;
...
/*! @brief Message for negotiated drx cnf
*/
typedef struct
{
  ...
  /*! @brief Gives execution status of LTE_RRC_IDLE_DRX_INFO_REQ. */
  sys_get_drx_status_e_type         status;

  /*! @brief Gives current DRX level */
 lte_rrc_paging_cycle_e                drx_level;

} lte_rrc_idle_drx_info_cnf_s;

/*! @brief Data Structure for Current Cells information confirmation
 */
typedef struct
{
	msgr_hdr_struct_type msg_hdr;

	lte_rrc_current_cells_s current_cells;	/*!< Current cells information */

} lte_rrc_current_cells_info_cnf_s;
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE, RRC, CNF, COMMON_MSIM_CRAT_FEATURE, 0x14, lte_common_msim_crat_feature_cnf_s),
  MSGR_DEFINE_UMID(LTE, RRC, CNF, CAP_EFS_REREAD, 0x15, lte_rrc_cap_efs_reread_cnf_s),
  MSGR_DEFINE_UMID(LTE, RRC, CNF, IDLE_DRX_INFO, 0x16, lte_rrc_idle_drx_info_cnf_s),
  MSGR_DEFINE_UMID(LTE, RRC, CNF, UE_CAP_CFG, 0x17, lte_rrc_ue_cap_cfg_cnf_s),
  MSGR_DEFINE_UMID(LTE, RRC, CNF, CURRENT_CELLS_INFO, 0x18, lte_rrc_current_cells_info_cnf_s),
};
...
typedef struct
{
  ...
  sys_detailed_plmn_list_s_type found_plmn_rat_list; /*!< Found PLMN List */
...
typedef struct
{
  ...
  /*!< Boolean to indicate if SUB is active */
  boolean is_active;

  /*!< Bitmask of RAT mask of type sys_sys_mode_mask_e_type */
  uint32 mode_pref_mask;

}lte_rrc_mode_pref_info_s;

/*! @brief Message for RAT priority list change indication
IND will be sent to L-RRC whenever mode preference change happens from GW to G, G to GW etc.
*/
...
typedef struct
{
  ...
  /*!< Indicates the number of SUB info passed in this message */
  uint8 num_subs; 
  
  /*!< SUB info list */
  lte_rrc_mode_pref_info_s sub_info[MAX_AS_IDS]; 

} lte_rrc_mode_pref_update_ind_s;

/*! @brief Enum for forced ESR status type.
*/
typedef enum
{
  LTE_RRC_FORCE_ESR_RESET   = 0,
  LTE_RRC_FORCE_ESR_STARTED = 1,
  LTE_RRC_FORCE_ESR_ENDED   = 2
}lte_rrc_force_esr_status_type_e;

/*! @brief Message for indicating forced ESR status.
*/
typedef struct 
{
   msgr_hdr_s msg_hdr; /*!< Message router header */
   lte_rrc_force_esr_status_type_e status;       
}lte_rrc_force_esr_ind_s;

/*! @brief Indication NAS sends indicating to stop G measurements in IDLE mode 
*/
typedef struct 
{
  msgr_hdr_s                     msg_hdr;
  boolean                        stop_g_meas;
}lte_rrc_g_meas_stop_ind_s;

/*! @brief Message for indicating tech capabilities on each sub. This is different from RAT priority list
IND will be sent to L-RRC on power up AND whenever the max capability changes. 
IND can only be sent when LTE stack is not active 
*/
...
}lte_rrc_multimode_subs_chgd_ind_s;

/*! @brief Message for indicating which SUB is the DDS sub. This is applicable only for MSIM cases
IND will be sent to L-RRC on power up AND whenever the DDS sub info changes which can be when LTE stack is active.
*/
...
typedef struct 
{
  ...
  sys_modem_as_id_e_type  dds_sub;

}lte_rrc_dds_sub_info_ind_s;

/*@ brief msg received in dds sub, indicating lte status on the non DDS sub*/

typedef struct {
msgr_hdr_s msg_hdr; /*!< Message router header */
sys_rat_activation_status status;
}lte_rrc_other_sub_lte_status_ind_s;
...
/*NAS add new data struct to indication RRC current call direction and call status */
typedef enum
{
  LTE_RRC_CSFB_CALL_DIR_NULL = 0,
  LTE_RRC_CSFB_CALL_DIR_MO   = 1,
  LTE_RRC_CSFB_CALL_DIR_MT   = 2
}lte_rrc_csfb_call_dir_type_e;

typedef enum
{
  LTE_RRC_CSFB_CALL_SECURE_STATUS_NULL     = 0,
  LTE_RRC_CSFB_CALL_SECURE_STATUS_ENABLED  = 1,
  LTE_RRC_CSFB_CALL_SECURE_STATUS_DISABLED = 2
}lte_rrc_csfb_call_secure_status_type_e;

typedef struct 
{
   msgr_hdr_s msg_hdr; /*!< Message router header */
   lte_rrc_csfb_call_status_type_e call_status_e;         /*!< Status */
   lte_rrc_csfb_call_dir_type_e           call_direction; /*!< Call direction */
   lte_rrc_csfb_call_secure_status_type_e secure_call_status;/*!< Secure call or not > */
...
/* eMBMS plus XRAT mask values that indicate the RATs that can coexist on subY
  when eMBMS is active on subX */
#define LTE_RRC_EMBMS_PLUS_W_MASK 1 /*!< eMBMS supported with W */ 
#define LTE_RRC_EMBMS_PLUS_L_MASK 2 /*!< eMBMS supported with L */ 
#define LTE_RRC_EMBMS_PLUS_1X_MASK 3 /*!< eMBMS supported with 1X */


typedef uint32 lte_rrc_embms_plus_xrat_mask_t;

/*! @brief Message for EMBMS active status ind
*/
typedef struct
{
  msgr_hdr_s     msg_hdr;   /*!< Message router header */

  boolean embms_is_active; /*!< Boolean to indicate if eMBMS is active */

  lte_rrc_embms_plus_xrat_mask_t embms_plus_xrat_mask;  /*!< Indicates the RATs that can coexist 
                                                      on subY when eMBMS is active on subX */

} lte_rrc_embms_active_sts_ind_s;

/*! @brief Message for Q-RxLevMin update indication to upper layers */ 
typedef struct
{
  msgr_hdr_s msgr_hdr; /*!< Message router header */ 
 
  int32 q_rxlevmin; /*!< Valid Value range: (-140,-44), it is the actual value; 
                          Invalid Value: 0, indicates Q-RxLevMin is currently unavailable */ 
}lte_rrc_q_rxlevmin_update_ind_s;
 

/* Structure of lte_rrc_all_trm_prio_lowered_ind_s */
/*! @brief External indications that RRC throws to NAS layer
    Sent after first tick of the TRM HOLD timer expiries 
*/
typedef struct
{
  msgr_hdr_s     msg_hdr;               /* !< Message router header */

}lte_rrc_all_trm_prio_lowered_ind_s;

/*! @brief Enum for CDRX Status
*/
typedef enum
{
  LTE_RRC_CDRX_RESET = 0,
  LTE_RRC_CDRX_USABLE = 1,
  LTE_RRC_CDRX_UNUSABLE = 2
}lte_rrc_cdrx_status_type_e;

/*! @brief Message for CDRX Status Ind
*/
typedef struct 
{
  msgr_hdr_s msg_hdr; /*!< Message router header */
  lte_rrc_cdrx_status_type_e status;       
}lte_rrc_cdrx_status_ind_s;

/* Structure of lte_rrc_radio_cap_tau_ind_s */
/*! @brief External indications that NAS throws to RRC layer when
  TAU starts.
*/
typedef struct
{
  msgr_hdr_s            msg_hdr;            /*!< Message router header */
}lte_rrc_radio_cap_tau_ind_s;
...
typedef enum
{
  ...
  LTE_RRC_CAPABILITIES_RAT_NR5G, /*!< 6 */
  LTE_RRC_CAPABILITIES_RAT_EUTRA_NR5G /*!< 7 */
} lte_rrc_cap_rats_e;

typedef uint8 lte_rrc_cap_rats_mask_t;  //bit 1 for eutra, bit 2 for geran_cs as above

typedef struct 
{
   msgr_hdr_s msg_hdr; /*!< Message router header */
   lte_rrc_cap_rats_mask_t rat_mask; //indicating which rat is being requested;
}lte_rrc_radio_cap_enquiry_ind_s;

/*! Same payload is used for LTE_RRC_CURRENT_CELLS_INFO_CNF and LTE_RRC_CURRENT_CELLS_INFO_IND */
typedef lte_rrc_current_cells_info_cnf_s lte_rrc_current_cells_info_ind_s;

/*! @brief Message for HST info update Ind
*/
typedef struct 
{
  msgr_hdr_s   msg_hdr;  /*!< Message router header */
  
  boolean      high_speed_flag; /*!< Boolean to indicate if high_speed_flag is TRUE or not */
}lte_rrc_hst_mode_ind_s;
...
enum
{
  ...
  #if defined (FEATURE_ELS_PDCP_AGGR) || defined (FEATURE_ELS_WIFIMEAS_LTE_U_PH1)
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_MEAS_CFG, 0x27, lte_rrc_wifi_meas_cfg_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, ELS_NW_CAP, 0x2a, lte_rrc_els_nw_cap_ind_s),
  #else
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_MEAS_CFG, 0x27, lte_rrc_wifi_reserved_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, ELS_NW_CAP, 0x2a, lte_rrc_wifi_reserved_s),
  #endif
  #ifdef FEATURE_ELS_PDCP_AGGR
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_CONN_RECFG, 0x2b, lte_rrc_wifi_conn_recfg_ind_s),  
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_UE_MAC_ADDR_INFO, 0x2c, lte_wifi_ue_mac_addr_info_ind_s),
  #else
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_CONN_RECFG, 0x2b, lte_rrc_wifi_reserved_s),  
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_UE_MAC_ADDR_INFO, 0x2c, lte_rrc_wifi_reserved_s),
  #endif

  MSGR_DEFINE_UMID(LTE, RRC, IND, MANUAL_BST_UPDATE, 0x30, lte_rrc_barring_update_ind_s),    
  MSGR_DEFINE_UMID(LTE, RRC, IND, EMBMS_ACTIVE_STS, 0x31, lte_rrc_embms_active_sts_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, HO_PRE_START, 0x32, lte_rrc_ho_pre_start_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, HO_PRE_START_CANCEL, 0x33, lte_rrc_ho_pre_start_cancel_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, LTED_AVAILABLE, 0x34, lte_rrc_lted_available_ind_s),    
  MSGR_DEFINE_UMID(LTE, RRC, IND, LTED_NOT_AVAILABLE, 0x35, lte_rrc_lted_not_available_ind_s),  
  MSGR_DEFINE_UMID(LTE, RRC, IND, LTED_PLMN_EARFCN, 0x36, lte_rrc_lted_plmn_earfcn_ind_s),    
  /* Pesudo reselection low priority indication */
  MSGR_DEFINE_UMID(LTE, RRC, IND, PESUDO_RESEL_LOW_PRIORITY, 0x37, lte_rrc_pseudo_resel_low_priority_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, CELL_DEPRIOR_STATUS, 0x38, lte_rrc_cell_deprior_status_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, MOBILITY, 0x39, lte_rrc_mobility_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, ALL_TRM_PRIO_LOWERED, 0x3A, lte_rrc_all_trm_prio_lowered_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, Q_RXLEVMIN_UPDATE, 0x3F, lte_rrc_q_rxlevmin_update_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, CDRX_STATUS, 0x40, lte_rrc_cdrx_status_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, PAGE_SHARE_STATUS, 0x42, lte_rrc_page_share_status_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, HST_MODE, 0x43, lte_rrc_hst_mode_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, RADIO_CAP_TAU, 0x48, lte_rrc_radio_cap_tau_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, RADIO_CAP_ENQUIRY, 0x49, lte_rrc_radio_cap_enquiry_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, DATA_INACTIVITY_INFO, 0x4a, lte_rrc_data_inactivity_info_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, CURRENT_CELLS_INFO, 0x4b, lte_rrc_current_cells_info_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, BARRING_STATUS, 0x4c, lte_rrc_barring_status_ind_s),
};
...
enum
{
  ...
  */
  ...
  MSGR_DEFINE_UMID(LTE, RRC, IND, EMBMS_SERVICE_INTEREST, 0x29, lte_rrc_embms_service_interest_ind_s),

  #if defined (FEATURE_ELS_PDCP_AGGR) || defined (FEATURE_ELS_WIFIMEAS_LTE_U_PH1)
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_MEAS_RPT, 0x2d, lte_rrc_wifi_meas_rpt_ind_s),
  #else
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_MEAS_RPT, 0x2d, lte_rrc_wifi_reserved_s),
  #endif
  #ifdef FEATURE_ELS_PDCP_AGGR
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_STATUS, 0x2e, lte_wifi_status_ind_s),
  #else
  MSGR_DEFINE_UMID(LTE, RRC, IND, WIFI_STATUS, 0x2e, lte_rrc_wifi_reserved_s),
  #endif

  MSGR_DEFINE_UMID(LTE, RRC, IND, MODE_PREF_UPDATE, 0x2F, lte_rrc_mode_pref_update_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, MULTIMODE_SUBS_CHGD, 0x3B, lte_rrc_multimode_subs_chgd_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, DDS_SUB_INFO, 0x3C, lte_rrc_dds_sub_info_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, OTHER_SUB_LTE_STATUS, 0x3D, lte_rrc_other_sub_lte_status_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, FORCE_ESR, 0x3E, lte_rrc_force_esr_ind_s),
  MSGR_DEFINE_UMID(LTE, RRC, IND, G_MEAS_STOP, 0x41, lte_rrc_g_meas_stop_ind_s),
};
...
typedef struct
{
  ...
  /* Boolean indicates if LTE capabilities need to be updated to the network */
  boolean radio_cap_update_req;

  /* Boolean indicates if FR after csfb with autonomous redirection.
     For non-network-redirected FR, NAS will perform TA/LA update with 
     IMSI attach according to CMCC's enterprise specs. */
  boolean blind_redir_after_csfb;

  /* default paging cycle in SIB2. */
  lte_rrc_paging_cycle_e default_paging_cycle;
  
} lte_rrc_service_ind_s;

/*! @brief enumeration to identify the Mobility type initiated by L RRC
*/
typedef enum
{
  LTE_MOBILITY_NONE = 0,      /*!< None*/
  LTE_MOBILITY_HO,            /*!< Handover initiated by L RRC*/
  LTE_MOBILITY_HO_IRAT,      /*!< HO initiated by LRRC to other RAT*/
  LTE_MOBILITY_RESEL,        /*!< Reselection initiated by L RRC*/
  LTE_MOBILITY_REDIR,         /*!< Redirection initiated by L RRC*/
  LTE_MOBILITY_RESEL_IRAT,
  LTE_MOBILITY_REDIR_IRAT
}lte_rrc_mobility_type_e;


/*! @brief Message for Mobility Indication
*/
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */

  lte_rrc_mobility_type_e mobility_type; /*!< Mobility type*/

  /*!< Boolean to indicate if Mobility was started or not*/
  boolean mobility_started; 

  /*!< Boolean to indicate if Mobility was stopped or not*/
  boolean mobility_stopped;

  /*!< Boolean to indicate if Mobility was successful or not
            This boolean is to be referred only if mobility_stopped = TRUE
            if mobility_stopped = TRUE, and mobility_success_status = TRUE 
                then mobility was successful
            if mobility_stopped = TRUE, and mobility_success_status = FALSE 
                then mobility was a failure*/
  boolean mobility_success_status;

  /*Source RAT of the mobility procedure*/
  sys_sys_mode_e_type source_rat;

  /*Target RAT of the mobility procedure*/
  sys_sys_mode_e_type target_rat;
} lte_rrc_mobility_ind_s;
...
/*! @brief Message for Manual BST update Indication
*/
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */

  sys_sib1_plmn_list_s plmn_list;  /*!List of PLMNs available in SIB-1*/
  sys_sband_lte_e_type band;      /*! Band present in SIB-1*/
  sys_modem_as_id_e_type as_id;
} lte_rrc_csp_manual_bst_update_ind_s;
...
/*! @brief Message for Data inactivity info ind Indication sent from 
  RRC to CM.
*/
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */ 
  /* for RRC connection ind case, it is TRUE,
  for data inactivity timer expiration case, it is FALSE
  */
  boolean is_rrc_conn_rel;
  /* when is_rrc_conn_rel is TRUE, rel_reason is a valid value.
  */
  lte_rrc_conn_rel_reason_e rel_reason;
  /* when is_rrc_conn_rel is FALSE, long_cdrx_length is a valid value.
  */
  uint32 long_cdrx_length;
} lte_rrc_data_inactivity_info_ind_s;
...
typedef struct
{
  ...
  boolean non_nas_procedure_performed; /* < indicate if any client(IMS/DS/CM) is setting the TRM priority other than NAS during connection establishment or when connected */
} lte_rrc_conn_rel_ind_s;
...
typedef struct
{
 ...
 msgr_attach_s dsm_attach_warn_msg_coordinates; /*!< dsm attachment containing the warning message co-ordinates */
...
/*LTED related commands*/
/*! @brief Message for Prose cfg req:This msg is sent from
    Prose layer to indicate the PLMN that are provisioned
    for Tx and Rx.
 */
...
typedef struct
{
  ...
  lte_rrc_plmn_list_s lted_tx_plmn;/*!< List of PLMN for Tx */

  lte_rrc_plmn_list_s lted_rx_plmn;/*!< List of PLMN for Rx */

  lte_rrc_power_range_e lted_power_range;
  
}lte_rrc_prose_cfg_req_s;

/*! @brief Message for lte d available:This msg is sent from
    RRC to Prose to indicate if the lower layers are configured
    for Tx/Rx.
 */
...
typedef struct
{
 ...
 boolean tx_enabled;/*!< Tx configured at lower layer */

 boolean rx_enabled;/*!< Rx configured at lower layer */

 boolean tx_on_serving;/*!< Tx configured on serving cell */

lte_rrc_plmn_s camped_plmn;/*!< camped serving PLMN  */

} lte_rrc_lted_available_ind_s;

/*! @brief Message for lte d not available:This msg is sent from
    RRC to Prose to indicate LTE D is not available
 */
typedef struct
{
 msgr_hdr_s msg_hdr; /*!< Message router header */

 boolean non_oos_reason; /*!< LTED is not available for a non OOS cause 
                             like deprovisioned/timing info not avail/misconfiguration*/

}lte_rrc_lted_not_available_ind_s;

/*! @brief Message for lte d plmn earfcn ind:This msg is sent from
    RRC to Prose to indicate the selected PLMN for the Rx earfcn from
    SIB1
 */
...
typedef struct
{
 ...
 lte_earfcn_t rx_earfcn;  /*!< DL Frequency */

 lte_rrc_plmn_s rx_plmn;/*!< selected PLMN from SIb1*/

} lte_rrc_lted_plmn_earfcn_ind_s;


/*! @brief Message :This msg is sent from
    Prose to RRC to indicate num of Tx/Rx tranmssion
    in connected mode
 */
typedef struct
{
 ...
 boolean rx_interest; /* Prose interested in Rx*/

 uint8 num_tx_interest;/*Prose interested in Tx*/

}lte_rrc_prose_sl_ded_cfg_req_s;
...
/*! @brief Message for eMBMS services interest indication from RRC that should trigger
  service layer to send list of interested eMBMS services to RRC
 */
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */
  ...
  int16 debug_trace_id; /*!< Debug trace id for the req, range 0 to 32767,
                            -1 when not used; should be echoed back in
                            LTE_RRC_EMBMS_SERVICE_INTEREST_INFO_REQ */
 
} lte_rrc_embms_service_interest_ind_s;
...
enum
{
    ...
    #ifdef FEATURE_ELS_PDCP_AGGR
    MSGR_DEFINE_UMID(LTE, RRC, RSP, WIFI_UE_MAC_ADDR_INFO, 0x04, lte_wifi_ue_mac_addr_info_rsp_s),
    #else
    MSGR_DEFINE_UMID(LTE, RRC, RSP, WIFI_UE_MAC_ADDR_INFO, 0x04, lte_rrc_wifi_reserved_s),
    #endif
	MSGR_DEFINE_UMID(LTE, RRC, RSP, CELL_LOCK, 0x05, lte_rrc_cell_lock_rsp_s),
};
...
/*! @brief Enumeration for LTE UE Category
*/
typedef enum
{
  ...
  LTE_UE_CATEGORY_12,
  LTE_UE_CATEGORY_13,
  LTE_UE_CATEGORY_INVALID
} lte_ue_category_e;

/*! @brief Enumeration for LTE UE CAP cfg
*/
typedef enum
{
  LTE_RRC_UE_CAP_CFG_MASK_BIT_UE_CAT = 0x1, 
  LTE_RRC_UE_CAP_CFG_MASK_BIT_CA_DISABLE = 0x2, 
  LTE_RRC_UE_CAP_CFG_MASK_BIT_ALL = 0xF
} lte_rrc_ue_cap_cfg_mask_bit_e;

typedef uint16 lte_rrc_ue_cap_cfg_mask_t;

/*! @brief Message for LTE UE Cap Cfg Req
*/
typedef struct
{
  /*!< Message router header */
  ...
  /*!< Bit mask to denote which configuration is modified */ 
  lte_rrc_ue_cap_cfg_mask_t ue_cap_cfg_mask;

  /*!< LTE UE Category; can only be downgraded */ 
  lte_ue_category_e ue_cat;

  /*!< To be set to TRUE when CA is to be disabled */
  boolean ca_disable;

} lte_rrc_ue_cap_cfg_req_s;

/*! @brief Message for LTE UE Cap Cfg Cnf
*/
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */
  errno_enum_type status; /*!< E_SUCCESS if cfg req passed, E_FAILURE otherwise */
} lte_rrc_ue_cap_cfg_cnf_s;

#if defined (FEATURE_ELS_PDCP_AGGR) || defined(FEATURE_ELS_WIFIMEAS_LTE_U_PH1)

/*! @brief
  Maximum number of WiFi measurement objects
*/
#define LTE_WIFI_MEAS_MAX_MEAS_OBJ 8

/*! @brief
  Maximum number of WiFi measurement ids
*/
#define LTE_WIFI_MEAS_MAX_MEAS_IDS 8

/*! @brief
  Maximum number of WiFi measurement reporting configs
*/
#define LTE_WIFI_MEAS_MAX_REPORT_CFG 8

/*! @brief
  Maximum number of WiFi Channel List
*/
#define LTE_WIFI_MEAS_MAX_CHANNEL_LIST 16

/*! @brief
  Maximum number of WiFi WLANs
*/
#define LTE_WIFI_MEAS_MAX_WLANS 16

/*! @brief
  Maximum number of WiFi Identities
*/
#define LTE_WIFI_MEAS_MAX_BLACKLIST_SIZE 15

/*! @brief
  Maximum number of bytes for SSID
*/
#define LTE_WIFI_MAX_SSID_STR_LEN 32

/*! @brief
  Maximum number of bytes for BSSID
*/
#define LTE_WIFI_MAX_BSSID_STR_LEN 6


/* Type for BSSID */
typedef struct
{
  uint8 bssid_str[LTE_WIFI_MAX_BSSID_STR_LEN];
}lte_wifi_bssid_s;
...
{
  uint8 num_octets;
  uint8 ssid_str[LTE_WIFI_MAX_SSID_STR_LEN];
}lte_wifi_ssid_s;

/*! @brief Enumeration of WiFi Channel numbers
*/
typedef enum
{
  LTE_WIFI_NW_MODE_R11_A = 0,
  LTE_WIFI_NW_MODE_R11_N,
  LTE_WIFI_NW_MODE_R11_AC_W1,
  LTE_WIFI_NW_MODE_R11_AC_W2,
  LTE_WIFI_NW_MODE_MAX,
} lte_wifi_nw_mode_e;

/*! @brief WiFi Measurement ID config (links meas object to report config)
*/
typedef struct
{
  /*! Measurement object ID. Range 1000..1007 */
  uint16 meas_obj_id;

  /*! Reporting config ID. Range 1000..1007 */
  uint16 report_cfg_id;
} lte_wifi_meas_id_s;

/*! @brief Enumeration of different trigger types of WiFi report configs
*/
typedef enum
{
  /*! WA1 */
  LTE_WIFI_MEAS_REPORT_CFG_TRIG_TYPE_WA1,

  /*! WA2 */
  LTE_WIFI_MEAS_REPORT_CFG_TRIG_TYPE_WA2,

  /*! WN */
  LTE_WIFI_MEAS_REPORT_CFG_TRIG_TYPE_WN,

  /*! WS */
  LTE_WIFI_MEAS_REPORT_CFG_TRIG_TYPE_WS,

  /*! Periodic */
  LTE_WIFI_MEAS_REPORT_CFG_TRIG_TYPE_PERIODIC,

} lte_wifi_meas_report_type_e;


/*! @brief Enumeration of different meas cfg types
*/
typedef enum
{
  /*! PDCP meas */
  LTE_WIFI_MEAS_CFG_TYPE_PDCP,

  /*! LTEU meas */
  LTE_WIFI_MEAS_CFG_TYPE_LTEU,

} lte_wifi_meas_cfg_type_e;


/*! @brief Union of WiFi report types
*/
typedef union
{
  /*! WA1 (in dBM) */
  ...
  /*! WN/WS has hardcoded implementation specific thresholds */

} lte_wifi_meas_report_u;


/*! @brief WiFi Measurement report Config
*/
typedef struct
{
  /*! Cfg type PDCP or LTE U */
  lte_wifi_meas_cfg_type_e cfg_type;
  
  /*! Report type */
  lte_wifi_meas_report_type_e report_type;

  /*! Trigger parameters based on trigger type 
  Trigger parameters not provided for WN/WS */
  lte_wifi_meas_report_u data;

  /*! Hysteresis (in dBM), applicable for WA1 and WA2 */
  int16 hys;

  /*! Time to trigger (in ms), applicable for WA1 and WA2 */
  uint16 time_to_trig;
  
  /*! Report Interval in seconds (1s to 60mins)*/
  uint32 report_interval;
  
  /*! Report amount (1 to 64)
  255 denotes infinity */
  uint8 report_amt;

} lte_wifi_meas_report_cfg_s;

/*! @brief Enumeration of WiFi BW
*/
typedef enum
{
  LTE_WIFI_BW_20 = 0,
...
typedef enum
{
  LTE_WIFI_CHANNEL_NUM_BAND_2_DOT_4 = 0,
  LTE_WIFI_CHANNEL_NUM_BAND_5,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH1,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH2,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH3,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH4,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH5,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH6,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH7,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH8,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH9,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH10,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH11,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH12,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH13,
  LTE_WIFI_CHANNEL_NUM_2_DOT_4_GHZ_CH14,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH7,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH8,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH9,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH11,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH12,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH16,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH34,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH36,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH38,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH40,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH42,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH44,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH46,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH48,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH52,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH56,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH60,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH64,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH100,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH104,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH108,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH112,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH116,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH120,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH124,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH128,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH132,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH136,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH140,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH149,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH153,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH157,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH161,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH165,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH169,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH172,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH173,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH174,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH175,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH176,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH177,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH178,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH179,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH180,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH181,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH182,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH183,
  LTE_WIFI_CHANNEL_NUM_5_GHZ_CH184,
  LTE_WIFI_CHANNEL_NUM_MAX,
} lte_wifi_channel_num_e;

/*! @brief WiFi Measurement object
*/
typedef struct
{
  /*! Measure Any SSID*/
  ...
  /*! SSID: To be used only if any_ssid is FALSE*/
  lte_wifi_ssid_s ssid;

  /*! Boolean to indicate if the SSID is hidden*/
  boolean is_hidden;

  /*! Measure Any BSSID*/
  boolean any_bssid;
  
  /*! BSSID: To be used only if any_bssid is FALSE*/
  lte_wifi_bssid_s bssid;

} lte_wifi_identity_info_s;
...
typedef struct
{
  ...
  /*! Number of WiFi channels
          If num channels = 0 scan everything*/
  uint8 num_channel;

  /*! Channel list*/
  lte_wifi_channel_num_e channel_type_list[LTE_WIFI_MEAS_MAX_CHANNEL_LIST];

  /*! Number of SSIDs */
  uint8 num_id;
  
  /*! SSID info list*/
  lte_wifi_identity_info_s id_list[LTE_WIFI_MEAS_MAX_WLANS];
  
} lte_wifi_meas_obj_s;

/*! @brief
  WiFi Measurement Blacklist info
  To be used only for WN/WS event measurements
*/
typedef struct
{
  /*! Number of BSSID*/
  ...
  /*! BSSID list */
  lte_wifi_bssid_s bssid_list[LTE_WIFI_MEAS_MAX_BLACKLIST_SIZE];

} lte_rrc_wifi_meas_blacklist_info_s;

/*! @brief
  WiFi Measurement Config info
*/
typedef struct
{
  /*! Measurement ID list. Index 0 corresponds to meas ID 1000, ..., index 7
      corresponds to meas ID 1007. */
  lte_wifi_meas_id_s meas_id_list[LTE_WIFI_MEAS_MAX_MEAS_IDS];

  /*! Measurement object list. Index 0 corresponds to meas object 1000, ...,
      index 7 corresponds to meas object 1007. */
  lte_wifi_meas_obj_s meas_obj_list[LTE_WIFI_MEAS_MAX_MEAS_OBJ];

  /*! Reporting configuration list. Index 0 corresponds to report config 1000, ...,
      index 7 corresponds to report config 1007. */
  lte_wifi_meas_report_cfg_s report_cfg_list[LTE_WIFI_MEAS_MAX_REPORT_CFG];

} lte_rrc_wifi_meas_cfg_info_s;


/*! @brief
  This message is used for configuring WiFi measurement parameters.
*/
typedef struct
{
  /*! Message header */
  ...
  /*! Bitmask which indicates which measurement ids are valid. Bit 0
      corresponds to meas ID 1000, ..., bit 7 corresponds to meas ID 1007. */
  uint8 meas_id_valid_bitmask;

  /*! Bitmask which indicates which meas ids have been touched
      (add/modify/delete). Bit 0 corresponds to meas ID 1000, ..., bit 7
      corresponds to meas ID 1007. */
  uint8 meas_id_mod_bitmask;

  /*! WiFi measurement config information */
  lte_rrc_wifi_meas_cfg_info_s meas_cfg;

  /*! WiFi blacklist info, applicable only for event WN and WS */
  lte_rrc_wifi_meas_blacklist_info_s blacklist_info;
} lte_rrc_wifi_meas_cfg_ind_s;

/*! @brief Enumeration of WiFi Meas Info (Serv/Neigh)
*/
typedef enum
{
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_RSSI         = 0x1,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_BSS_LOAD     = 0x2,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_ULPHY_RATE   = 0x4,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_DLPHY_RATE   = 0x8,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_ULPER        = 0x10,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_DLPER        = 0x20,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_PRIM_CHNL    = 0x40,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_NW_MODE      = 0x80,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_PRIM_FREQ_BW = 0x100,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_SECD_CHNL    = 0x200,
  LTE_RRC_WIFI_MEAS_INFO_MASK_BIT_ALL          = 0x3FF,
} lte_rrc_wifi_meas_info_mask_bit_e;

typedef uint16 lte_rrc_wifi_meas_info_bitmask_t;

/*! @brief
  WiFi Serving cell Measurement results
*/
typedef struct
{
  /*! Bitmask to indicate the fields that are populated*/
  lte_rrc_wifi_meas_info_bitmask_t serv_meas_info_bitmask;
  
  /*! RSSI (in dBM) */
  int16 rssi;

  /*! bssLoadChannelUtilizationResult */
  uint8 bss_load;
  ...
  /*! DL PER*/
  uint8 dl_per;
} lte_rrc_wifi_serv_cell_meas_info_s;

/*! @brief
  WiFi Neighbor cell BSSID Meas Info
*/
typedef struct
{
  /*!BSSID*/
  ...
  /*! Boolean to indicate if it's serving AP (LTE-U) */
  boolean is_serving;

  /*! Bitmask to indicate the fields that are populated*/
  lte_rrc_wifi_meas_info_bitmask_t neigh_meas_info_bitmask;
  
  /*! Channel Type*/
  lte_wifi_channel_num_e prim_channel;
  ...
  /*!NW mode.  Same as supportedStandard in MR*/
  lte_wifi_nw_mode_e nw_mode;

  /*! Secondary Channel Type*/
  lte_wifi_channel_num_e secd_channel;

  /*! Primary freq BW*/
  lte_wifi_bandwidth_e prim_freq_bw;
  
} lte_rrc_wifi_neigh_cell_bssid_info_s;

/*! @brief
  WiFi Neighbor cell SSID Meas Info
*/
typedef struct
{
  /*! SSID: Always provided */
  lte_wifi_ssid_s ssid;
  ...
  /*!BSSID list*/
  lte_rrc_wifi_neigh_cell_bssid_info_s bssid_list[LTE_WIFI_MEAS_MAX_WLANS];

} lte_rrc_wifi_neigh_cell_ssid_info_s;


/*! @brief
  WiFi Neighbor cell Measurement results
*/
typedef struct
{
  /*! Number of SSID*/
  ...
  /*! SSID list*/
  lte_rrc_wifi_neigh_cell_ssid_info_s ssid_list[LTE_WIFI_MEAS_MAX_WLANS];
  
} lte_rrc_wifi_neigh_cell_meas_info_s;


/*! @brief
  This message is used for WiFi Measurement reporting
*/
typedef struct
{
  /*! Message header */
  ...
  /*Report Count to be used for Periodic measurements*/
  uint8 report_cnt;

  /* Boolean to indicate if full scan was performed for this meas rpt*/
  boolean full_scan_performed;

  /*! Serving Cell Meas results*/
  lte_rrc_wifi_serv_cell_meas_info_s serv_cell_info;

  /*! Neighbor Cell Meas results*/
  lte_rrc_wifi_neigh_cell_meas_info_s neigh_cell_info;
  
} lte_rrc_wifi_meas_rpt_ind_s;

/*! @brief Enumeration of ELS NW CAP
*/
typedef enum
{
  LTE_RRC_ELS_NW_CAP_MASK_BIT_PDCPAGGR = 0x1,
  LTE_RRC_ELS_NW_CAP_MASK_BIT_UDC      = 0x2,
  LTE_RRC_ELS_NW_CAP_MASK_BIT_LTEUPH1  = 0x4,
} lte_rrc_els_nw_cap_mask_bit_e;

typedef uint16 lte_rrc_els_nw_cap_mask_t;

/*! @brief This message is used for ELS NW CAP advertizing
*/
typedef struct
{
  /*! Message header */
  ...
  /*! Mask to indicate the ELS features supported by the NW */
  lte_rrc_els_nw_cap_mask_t cap_mask;

} lte_rrc_els_nw_cap_ind_s;
#endif

#ifdef FEATURE_ELS_PDCP_AGGR
/*! @brief Enumeration of WLAN Association type for PDCP Aggr 
*/
typedef enum
{
  /*! Associate with AP provided in the config */
  LTE_RRC_WIFI_ASSOC_CFG_TYPE_WLAN_ID,
  /*! Associate with AP that triggered WS */
  LTE_RRC_WIFI_ASSOC_CFG_TYPE_WS,
  /*! Associate with AP that triggered WN */
  LTE_RRC_WIFI_ASSOC_CFG_TYPE_WN,
} lte_rrc_wifi_assoc_cfg_type_e;

/*! @brief
  WLAN Identity params for association
*/
typedef struct
{
  /*! WLAN ID */
  lte_wifi_identity_info_s id;

  /*! To indicate if channel is specified */
  boolean channel_present;

  /*! channel_num: To be used only if channel_present is TRUE*/
  lte_wifi_channel_num_e channel_num;

} lte_wifi_assoc_cfg_wlan_id_s;

/*! @brief Enumeration for WLAN Association Config Action
*/
typedef enum
{
  /*! None */
  LTE_RRC_WIFI_ASSOC_CFG_ACTION_NONE,
  /*! To dissociate the serving AP */
  LTE_RRC_WIFI_ASSOC_CFG_ACTION_DISSOC,
  /*! To associate an AP based Assoc cfg_type */
  LTE_RRC_WIFI_ASSOC_CFG_ACTION_ASSOC,
} lte_rrc_wifi_assoc_cfg_action_e;

/*! @brief WLAN Association cfg params
*/
typedef struct
{
  /*! boolean to dissociate the previous associated wlan if any*/
  lte_rrc_wifi_assoc_cfg_action_e cfg_action;

  /*! cfg_type: To be used only if cfg_action is  
  LTE_RRC_WIFI_ASSOC_CFG_ACTION_ASSOC */
  lte_rrc_wifi_assoc_cfg_type_e cfg_type;

  /*! wlan_id: To be used only if cfg_type is 
  LTE_RRC_WIFI_ASSOC_CFG_TYPE_WLAN_ID*/
  lte_wifi_assoc_cfg_wlan_id_s wlan_id;
  
} lte_rrc_wifi_assoc_cfg_param_s;

/*! @brief Enumeration for Wifi Conn Recfg mask bits
*/
typedef enum
{
  LTE_RRC_WIFI_CONN_RECFG_MASK_BIT_ASSOC_CFG = 0x1,
  LTE_RRC_WIFI_CONN_RECFG_MASK_VALID_BITS = 0xF,
} lte_rrc_wifi_conn_recfg_mask_bit_e;

typedef lte_rrc_wifi_conn_recfg_mask_t uint16;

/*! @brief This message is used for WLAN Conn Recfg
*/
typedef struct
{
  /*! Message header */
  ...
  /*! Mask of the param to be cfged (setup/release)*/
  lte_rrc_wifi_conn_recfg_mask_t cfg_mask;

  /*! Mask of the param to be cfged (setup/release)*/
  lte_rrc_wifi_assoc_cfg_param_s assoc_cfg_param;

} lte_rrc_wifi_conn_recfg_ind_s;

/*! @brief Enumeration for Wifi Status
*/
typedef enum
{
  LTE_WIFI_STATUS_ASSOC_SUCCESS,
  LTE_WIFI_STATUS_ASSOC_FAILURE,
  LTE_WIFI_STATUS_ASSOC_LOSS,
  LTE_WIFI_STATUS_IMMINENT_LOSS,
  LTE_WIFI_STATUS_ASSOC_SUSP,
  LTE_WIFI_STATUS_ASSOC_RSME,
  LTE_WIFI_STATUS_MAX
} lte_wifi_status_e;
...
typedef enum
{
  LTE_WIFI_FAILURE_CAUSE_NONE,
  LTE_WIFI_FAILURE_CAUSE_DEAUTH,
  LTE_WIFI_FAILURE_CAUSE_AUTH_FAILURE,
  LTE_WIFI_FAILURE_CAUSE_MAX
} lte_wifi_failure_cause_e;
...
typedef struct
{
  ...
  /*! WLAN status */
  lte_wifi_status_e status;

  /*! Failure Cause is applicable if status is LTE_WIFI_STATUS_ASSOC_FAILURE */
  lte_wifi_failure_cause_e failure_cause;
...
} lte_wifi_status_ind_s;

/*! @brief This message is used to request for UE WLAN MAC Addr
*/
typedef struct
{
  /*! Message header */
...
} lte_wifi_ue_mac_addr_info_ind_s;

/*! @brief This message is used to report the UE WLAN MAC Addr
*/
typedef struct
{
  /*! Message header */
...
} lte_wifi_ue_mac_addr_info_rsp_s;
#endif

/*! @brief Reserved Message
*/
typedef struct
{
  /*! Message header */
...
} lte_rrc_wifi_reserved_s;

/*! @brief HO PRE START IND that is sent on sensing a HO message
*/
typedef msgr_hdr_struct_type lte_rrc_ho_pre_start_ind_s;

/*! @brief HO PRE START CANCEL IND that is sent on a HO getting cancelled 
    but no rlf done after sending a HO PRE START IND
*/
typedef msgr_hdr_struct_type lte_rrc_ho_pre_start_cancel_ind_s;
...
/*! @brief Message for PLMN Switch Request
*/
typedef struct
{
  msgr_hdr_s msg_hdr; /*!< Message router header */

  lte_rrc_plmn_s switch_plmn; /* < Switch PLMN information */
} lte_rrc_plmn_switch_req_s;

/*! @brief message for page share status ind. It is sent to DS module.
*/
typedef struct
{
  msgr_hdr_s msgr_hdr; /*!< Message router header */

  boolean is_page_shared; /*!< indicates whether page is shared on both SUBs. */

} lte_rrc_page_share_status_ind_s;
