...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_tlb_msg.h#1 $
...
/*! @define diag F3 macros for MAC TLB task in multi-sim cases */
#define LTE_TLB_MSG_SPRINTF_0_EXT(sub_id, xx_ss_mask, xx_fmt)   \
  MSG_1(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1))

#define   LTE_TLB_MSG_SPRINTF_1_EXT(sub_id, xx_ss_mask, xx_fmt, xx_arg1) \
  MSG_2(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1), xx_arg1)

#define   LTE_TLB_MSG_SPRINTF_2_EXT(sub_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2) \
  MSG_3(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1), xx_arg1, xx_arg2)

#define   LTE_TLB_MSG_SPRINTF_3_EXT(sub_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3) \
  MSG_4(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1), xx_arg1, xx_arg2, xx_arg3)

#define   LTE_TLB_MSG_SPRINTF_4_EXT(sub_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4) \
  MSG_5(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1), xx_arg1, xx_arg2, xx_arg3, xx_arg4)

#define   LTE_TLB_MSG_SPRINTF_5_EXT(sub_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4, xx_arg5) \
  MSG_6(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1), xx_arg1, xx_arg2, xx_arg3, xx_arg4, xx_arg5)

#define   LTE_TLB_MSG_SPRINTF_6_EXT(sub_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4, xx_arg5, xx_arg6) \
  MSG_7(MSG_SSID_LTE, xx_ss_mask, "Sub-ID:%u " xx_fmt, (sub_id + 1), xx_arg1, xx_arg2, xx_arg3, xx_arg4, xx_arg5, xx_arg6)
...
enum
{
  ...
  /* Indication to PROSE to inform about MODE D configuration Ind*/
  MSGR_DEFINE_UMID(LTE,TLB,IND,PROSE_MODE_D_CFG,0x07,lte_tlb_mode_d_cfg_ind_s),
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE,TLB,REQ,PROSE_MODE_D_PKT_COUNT,0x02,none),
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE,TLB,CNF,PROSE_MODE_D_PKT_COUNT,0x01,lte_tlb_mode_d_pkt_count_cnf_s),
