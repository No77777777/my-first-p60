...
$Header: //components/rel/lte.mpss/6.6.1/api/lte.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
04/15/15   trc     Updated TA UE category
...
#ifdef FEATURE_HABANERO_MODEM 

/*! @brief UE Category
*/
#define LTE_UE_CATEGORY                                      13

/*! @brief MAX UE Category allowed via NV
*/
#define LTE_UE_CATEGORY_MAX                                  13


#elif defined(FEATURE_TABASCO_MODEM)
/*! @brief UE Category
*/
#define LTE_UE_CATEGORY                                      7

/*! @brief MAX UE Category allowed via NV
*/
#define LTE_UE_CATEGORY_MAX                                  7

#else
/*! @brief UE Category
*/
 
 #define LTE_UE_CATEGORY                                      11
 

/*! @brief MAX UE Category allowed via NV
*/
#define LTE_UE_CATEGORY_MAX                                    11
#endif
...
/*! @brief Maximum number of interested eMBMS services across all MBSFN areas
*/
#define LTE_EMBMS_MAX_SESSIONS_IN_COUNTING_RSP 128
...
typedef enum
{
  ...
  LTE_3GPP_REL11_MAR14 = 0x82,
  LTE_3GPP_REL11_MAX,
  /*Rel 12 versions*/
  LTE_3GPP_REL12 = 0x91,
  LTE_3GPP_REL12_MAX,
  LTE_3GPP_REL_MAX = 0xFF, /*Do not change max value*/
} lte_3gpp_release_ver_e;

/* for L PLUS L */
/*! @brief the max supported LTE stack, the value is used globablly, if the as_id value changed, the
     value below need to be updated accordingly*/
typedef enum
{
  LTE_L2_COMMON_AS_ID_0 = SYS_MODEM_AS_ID_1,
  LTE_L2_COMMON_AS_ID_1 = SYS_MODEM_AS_ID_2
}lte_l2_common_as_id_e;

/*! @brief the max supported LTE stack*/
typedef enum
{
  LTE_L2_COMMON_STACK_ID_0 = 0,
  LTE_L2_COMMON_STACK_ID_1 = 1
}lte_l2_common_stack_id_e;
...
typedef uint8 lte_rrc_mem_instance_type;
