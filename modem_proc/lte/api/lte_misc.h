...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_misc.h#2 $
...
*/
/*=========================================================================*/
extern void lte_allow_efs_refresh(int8 sub_id, uint8 efs_refresh_bitmask);
...
/*===========================================================================
  ...
  FUNCTION:  lte_common_msim_crat_detect_transient_configuration

===========================================================================*/
/*!
    @brief
    Returns TRUE if transient configuration [ old --> new ] is detected,
    FALSE otherwise
...
boolean lte_common_msim_crat_detect_transient_configuration
(
      /* Configuration A */
      lte_cphy_ue_mode_type_e             ue_mode_old, 
      sys_modem_device_mode_e_type        device_mode_old, 
      sys_modem_dual_standby_pref_e_type  standby_mode_old,

      /* Configuration B */
      lte_cphy_ue_mode_type_e             ue_mode_new, 
      sys_modem_device_mode_e_type        device_mode_new,
      sys_modem_dual_standby_pref_e_type  standby_mode_new
);
