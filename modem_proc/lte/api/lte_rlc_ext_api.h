...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_rlc_ext_api.h#2 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
02/19/21   ve      CR2879876: Exposed L2 init API to A2
...
04/08/15   el      CR818421: Radar 20371684 LTE Delay Metric Changes
...
typedef struct
{
  ...
  uint8                      sub_id;    /*!< sub_id for each element */
...
typedef struct
{
  uint32 max;          /*!< Maximal average value */
  uint32 min;          /*!< Minimal average value */
  uint32 avg;          /*!< current average value */
...
/*==============================================================================
  ...
  FUNCTION:  lte_rlcdl_test_init

==============================================================================*/
/*!
    @brief
    This function will be called by A2 to initialize LTE L2 for test only mode
...
*/
/*============================================================================*/
EXTERN void lte_rlcdl_test_init(void);
