...
$Header: //components/rel/lte.mpss/6.6.1/api/msgr_lte.h#1 $
...
#define MSGR_LTE_ML1_SM_FSCAN  MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x42)
#define MSGR_LTE_ML1_STLM      MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x43)
#define MSGR_LTE_PDCPCOMP      MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x44)
#define MSGR_LTE_ML1_TUNEMGR   MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x45)
#define MSGR_LTE_L2            MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x46)
#define MSGR_LTE_QMI           MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x47)
#define MSGR_LTE_PROSE         MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x48)
#define MSGR_LTE_ML1_LTED      MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x49)
#define MSGR_LTE_ML1_CSWITCH   MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x4A)
