...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_irat_types.h#1 $
...
typedef enum
{
  ...
  LTE_IRAT_1XCSFB_HO_FAILURE_SRCH_TT_FAIL,/*!< Time transfer failure from 1x search */
  LTE_IRAT_1XCSFB_HO_FAILURE_TCH_INIT_FAIL,/*!< TCH init fail from 1xCP */
  LTE_IRAT_1XCSFB_HO_FAILURE_USER_CALL_END,/*!< User ended the call */
  LTE_IRAT_1XCSFB_HO_FAILURE_RETRY_EXHAUST,/*!< call retry attempts exhausted from 1xCP*/
  LTE_IRAT_1XCSFB_HO_FAILURE_CALL_REL_REG_REJ,/*!< Registration reject from n/w*/
  LTE_IRAT_1XCSFB_HO_FAILURE_CALL_REL_NW_REL_ODR,/*!< Release order from n/w*/
...
typedef struct 
{
  /*! Antenna 0 rxlm buffer */
  uint32 lte_rxlm_rx_buffer_ant0;

  /*! Antenna 1 rxlm buffer */
