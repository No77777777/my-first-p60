...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_dsm_util_ext_api.h#1 $
...
=============================================================================*/
/*! @brief the number of sl items stored in one block
*/
#define LTE_DSM_UTIL_RECYCLE_SL_PRODUCER_BLOCK_SIZE                           32
