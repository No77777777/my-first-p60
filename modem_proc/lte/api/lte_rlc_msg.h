...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_rlc_msg.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/01/19   vke     FR 37207: LTE downlink data path optimization
04/19/16   sb      CR962879: FR 33263 LTE RLC UM mode memory optimization
...
03/02/15   el      CR790064: Provide LTE RLC queue metric query API
...
/*! @brief Delay Metric Reset request for RLCUL */
typedef struct
{
  msgr_hdr_struct_type      hdr;       /*!< common message router header */
  /*! EPS ID for delay queue */
  uint8 eps_id;
} lte_rlcul_delay_metric_reset_req_msg_s;

/*! @brief QSH callback process request message for RLCUL
*/
typedef struct
{
  msgr_hdr_struct_type      hdr;       /*!< common message router header */
  qsh_client_cb_params_s    cb_params; /*!< cb params */
} lte_rlcul_qsh_cb_req_msg_s;
...
typedef struct
{
  msgr_hdr_struct_type      hdr;       /*!< common message router header */
  qsh_client_cb_params_s    cb_params; /*!< cb params */
} lte_rlcdl_qsh_cb_req_msg_s;

/*! @brief EFS refresh indication message for RLCUL
*/
typedef struct
{
  msgr_hdr_struct_type      hdr;       /*!< common message router header */
  uint32                    reference_id; /*!< Reference id */
} lte_rlcul_efs_refresh_ind_s;
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE, RLCUL, REQ, DELAY_METRIC_RESET, 0x6, lte_rlcul_delay_metirc_reset_req_msg_s),
  MSGR_DEFINE_UMID(LTE, RLCUL, REQ, QSH_CB, 0x7, lte_rlcul_qsh_cb_req_msg_s),
  LTE_RLCUL_MAX_REQ,
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE, RLCUL, IND, FREE_TXED_PDUS, 0x7,
                   lte_rlcul_free_txed_pdu_ind_s),
  MSGR_DEFINE_UMID(LTE, RLCUL, IND, EFS_REFRESH, 0x8,
                   lte_rlcul_efs_refresh_ind_s),
  LTE_RLCUL_MAX_IND,
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE, RLCDL, REQ, QSH_CB, 0x9, lte_rlcdl_qsh_cb_req_msg_s),
  LTE_RLCDL_MAX_REQ,
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE, RLCDL, IND, DISABLE_FC, 0x3, msgr_hdr_s),
  MSGR_DEFINE_UMID(LTE, RLCDL, IND, IPA_CONFIG_RB, 0x4, msgr_hdr_s),
  MSGR_DEFINE_UMID(LTE, RLCDL, IND, FLUSH_RECYCLE_POOL, 0x5, msgr_hdr_s),
  MSGR_DEFINE_UMID(LTE, RLCDL, IND, DUP_ACK_STATUS, 0x6, lte_rlcdl_dup_ack_status_ind_s),
  LTE_RLCDL_MAX_IND,
