...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_log_codes.h#3 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
03/06/16   ymu     Feature LTED Ml1 Check in
03/03/16   el      FR 28315 - MAC layer implementation
07/22/15   pvs	   CR 877971: CSF Tx Report log code added
...
/*! @brief LTE MAC PAC match report code */
#define LOG_LTE_MAC_PAC_MATCH_RPT_LOG_C          (0x9 + LOG_LTE_MAC_BASE_C)

/*! @brief LTE MAC ELS UL MCE TRIGGER log code */
#define LOG_LTE_MAC_ELS_UL_MCE_TRIGGER_LOG_C     (0xA + LOG_LTE_MAC_BASE_C)

/*! @brief LTE MAC ELS UL TB log code */
#define LOG_LTE_MAC_ELS_UL_TB_LOG_C              (0xB + LOG_LTE_MAC_BASE_C)
...
/*! @brief LTE RRC Supported CA combos log code */
#define LOG_LTE_RRC_SUPPORTED_CA_COMBOS_LOG_C       (0xD + LOG_LTE_RRC_BASE_C)

/*! @brief LTE RRC debug CA combos log code */
#define LOG_LTE_RRC_CA_COMBOS_DEBUG_LOG_C        (0xF + LOG_LTE_RRC_BASE_C) 

/*! @brief LTE RRC COMBINE acq DB log code */
#define LOG_LTE_RRC_COMBINE_ACQ_DB_LOG_C       (0x10 + LOG_LTE_RRC_BASE_C)

/*! @brief last log code of RRC */
#define LOG_LTE_RRC_LAST_C                       (0x20 + LOG_LTE_RRC_BASE_C)
...
/*! @brief LTE ML1 CA Metrics log code */
#define LOG_LTE_ML1_CA_METRICS_LOG_C             (0x24 + LOG_LTE_ML1_BASE_C)
...
/*! @brief LTE ML1 MCLT log code*/
#define LOG_LTE_ML1_SRCH_IDLE_MCLT_LOG_C            (0x4A + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 CDB log code*/
#define LOG_LTE_ML1_SRCH_CDB_LOG_C                  (0x4B + LOG_LTE_ML1_BASE_C)
...
/*! @brief LTE ML1 Scheduler profile log code */
#define LOG_LTE_ML1_GM_CSF_TX_REPORT_LOG_C	        (0x66 + LOG_LTE_ML1_BASE_C)
...
/*! @brief LTE ML1 X2L IRAT log code*/
#define LOG_LTE_ML1_X2L_IRAT_LOG_C                  (0x6D + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 DLM HO Rxd Status log code*/
#define LOG_LTE_ML1_DLM_HO_RXD_STATUS_LOG_C    (0x6E + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 DLM HO Rxd ARD Statistics log code*/
#define LOG_LTE_ML1_DLM_HO_RXD_ARD_STATS_LOG_C    (0x6F + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 DLM Measurements log code*/
#define LOG_LTE_ML1_DLM_MEAS_LOG_C    (0x70 + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 DLM HO Rxd SPEF Parameters log code*/
#define LOG_LTE_ML1_DLM_HO_RXD_SPEF_PARAMS_LOG_C    (0x71 + LOG_LTE_ML1_BASE_C)

#ifdef FEATURE_LTE_DISCOVERY
/*! @brief LTE ML1 GM LTED Tx report log code, 0xB1D2*/
#define LOG_LTE_ML1_GM_LTED_TX_REPORT_LOG_C    (0x72 + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 GM LTED Rx report log code, 0xB1D3*/
#define LOG_LTE_ML1_GM_LTED_RX_REPORT_LOG_C    (0x73 + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 GM POOL INFO log code, 0xB1D6*/
#define LOG_LTE_ML1_GM_POOL_INFO_LOG_C    (0x76 + LOG_LTE_ML1_BASE_C)

#endif /*FEATURE_LTE_DISCOVERY*/

#define LOG_LTE_ML1_GM_SRX_STATS_LOG_C                   (0x74 + LOG_LTE_ML1_BASE_C)

#define LOG_LTE_ML1_GM_CLOCK_SCALING_STATS_LOG_C         (0x75 + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 COMMON FC2 log code 0xB1E5*/
#define LOG_LTE_ML1_COMMON_FC2_ACTION_LOG_C       (0x85 + LOG_LTE_ML1_BASE_C)

/*! @brief LOG_LTE_ML1_TAM_TIMELINE_LOG_C log code 0xB1ED */
#define LOG_LTE_ML1_TAM_TIMELINE_LOG_C          (0x8D + LOG_LTE_ML1_BASE_C)

/*! @brief LTE ML1 ANT SWITCH log code */
#define LOG_LTE_ML1_COMMON_ANT_SWITCH_DIV_LOG_C       (0x7A + LOG_LTE_ML1_BASE_C)

/*! @brief LOG_LTE_ML1_QC_ARD_STATUS_LOG_C log code 0xB1EA */
#define LOG_LTE_ML1_QC_ARD_STATUS_LOG_C         (0x8A + LOG_LTE_ML1_BASE_C)

/*! @brief LOG_LTE_ML1_ARD_EVAL_RESULTS_LOG_C log code 0xB1F2 */
#define LOG_LTE_ML1_ARD_EVAL_RESULTS_LOG_C      (0x92 + LOG_LTE_ML1_BASE_C)

/*! @brief LOG_LTE_ML1_TRAFFIC_EXT_LOG_C log code 0xB1F3 */
#define LOG_LTE_ML1_TRAFFIC_EXT_LOG_C                 (0x93 + LOG_LTE_ML1_BASE_C)

/*! @brief LOG_LTE_ML1_PAGE_SHARE_LOG_C log code 0xB1F8 */
#define LOG_LTE_ML1_PAGE_SHARE_LOG_C                  (0x98 + LOG_LTE_ML1_BASE_C)

/*! @brief Total number of LTE ML1 log codes. This macro needs to be updated if more log codes are added  */
#define LOG_LTE_ML1_TOTAL_LOG_CODES                 (0xFF + LOG_LTE_ML1_BASE_C)
...
/*! @brief LTE NAS EMM SERVICE REQUEST  */
#define LOG_LTE_NAS_EMM_LTE_RRC_SERVICE_REQUEST_LOG_C    (0x17 + LOG_LTE_NAS_BASE_C)
