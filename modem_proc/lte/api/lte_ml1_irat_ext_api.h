...
typedef enum
{
  ...
  /*Used for L2L idle inter-freq only*/
  LTE_ML1_IRAT_GAP_SCHEDULE_HINT_SRCH_ONLY 
...
/*===========================================================================
  ...
  FUNCTION:  lte_ml1_irat_gap_abort_handling

===========================================================================*/
/*!
    @brief
    Function to be called when TRM is not available for the X2L meas freq
...
void lte_ml1_irat_gap_abort_handling
(
  sys_modem_as_id_e_type as_id,
  /* Gap state struct which will get updated by this function. This shall 
     not be used by the caller.
...
/*===========================================================================
  ...
  FUNCTION:  lte_ml1_irat_geran_qbta_enabled

===========================================================================*/
/*!
    @brief
    Function to be called to check QBTA support.
...
boolean lte_ml1_irat_geran_qbta_enabled
(
  sys_modem_as_id_e_type as_id
);
...
/*===========================================================================
  ...
  FUNCTION:  lte_ml1_irat_x2l_meas_enter

===========================================================================*/
/*!
    @brief Initializes the target fields of the rf_params->common structure
           and triggers the RF enter procedure.

    @param [in,out] rf_param
*/
/*=========================================================================*/
void lte_ml1_irat_x2l_meas_enter
(
  sys_modem_as_id_e_type as_id,
...
/*===========================================================================
  ...
  FUNCTION:  lte_ml1_irat_x2l_meas_exit

===========================================================================*/
/*!
    @brief Triggers the RF exit procedure
 
    @param [in] rf_param
*/
/*=========================================================================*/
void lte_ml1_irat_x2l_meas_exit
(
  sys_modem_as_id_e_type as_id,
  lte_cphy_irat_meas_rf_param_s *rf_param
);
