...
$Header: //components/rel/lte.mpss/6.6.1/api/lte_as.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------ 
08/19/15   cjb     CR 886339: LTE ULM API to update ULCA info for NLIC
...
/*! @brief used to indicate that OTA IE has infinity value.  used for uint
*/
#define LTE_OTA_IE_INFINITY_UINT8  0xFF
...
/*! Default value for p_max  for PC2*/
#define LTE_DEFAULT_PMAX_PC2           (26)
...
/* bit 103 */
#define LTE_PDSCH_TM9_MAX_4_ANT                                  TRUE

/* bit 104 */
#define LTE_PDSCH_TM9_MAX_8_ANT                                  TRUE

/* bit 105 */
#define LTE_PERIODIC_CQI_PMI_TM9_4_ANT                         TRUE

/* bit 106 */
#define LTE_PERIODIC_CQI_PMI_TM9_8_ANT                         TRUE

/* bit 107 */
#define LTE_APERIODIC_CQI_PMI_TM9_4_ANT                        TRUE

/* bit 108 */
#define LTE_APERIODIC_CQI_PMI_TM9_8_ANT                        TRUE

/* bit 109 */
#define LTE_PERIODIC_CQI_PMI_TM9_8_ANT_MODE_1_1                    TRUE

/* bit 110 */
#define LTE_PERIODIC_CQI_PMI_TM9_8_ANT_MODE_1_2                    TRUE
...
#define LTE_SIMULTANEOUSACKNACKANDCQI_FORMAT3_R11 TRUE
...
typedef enum
{
  ...
  LTE_MBMS_RNTI_TYPE,
  /*! RNTI with Side link DCH TB */
  LTE_SL_DCH_RNTI_TYPE,
  /*! RNTI with Side link SCH TB */
  LTE_SL_SCH_RNTI_TYPE,
...
/*! @brief MAC send this indication to ML1 to notify ML1 that MAC
  does not have enough grant to include PHR (value_tag == 0xff),
  or, PHR failed sent out due to Phy layer HARQ NACKed (value_tag != 0xff)
*/
typedef struct
{
  msgr_hdr_struct_type   hdr;     /*!< Message header */
  uint8                  phr_value_tag; /* Message payload to tag the failed phr*/
...
typedef uint32 lte_mem_instance_type;
...
*/
/*=========================================================================*/
extern lte_sfn_s lte_ml1_get_curr_sfn( lte_mem_instance_type instance );
#endif /* LTE_AS_H */
