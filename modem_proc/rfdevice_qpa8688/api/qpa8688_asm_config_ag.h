...
#ifndef QPA8688_ASM_CONFIG_AG_H
#define QPA8688_ASM_CONFIG_AG_H/*
...
$Header: //components/rel/rfdevice_qpa8688.mpss/1.11/api/qpa8688_asm_config_ag.h#1 $
$Author: pwbldsvc $
...
boolean rfdevice_qasm_2g_qpa8688_construct_driver_ag
(
