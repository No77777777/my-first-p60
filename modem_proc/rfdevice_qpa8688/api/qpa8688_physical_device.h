#ifndef QPA8688_PHYSICAL_DEVICE_AG_H
#define QPA8688_PHYSICAL_DEVICE_AG_H
/*!
   @file
   qpa8688_physical_device_ag.h

   @brief
   qpa8688 physical device driver
...
$Header: //components/rel/rfdevice_qpa8688.mpss/1.11/api/qpa8688_physical_device.h#1 $ 
...
#include "qpa8688_pa_config_main_ag.h"
#include "qpa8688_asm_config_main_ag.h"

class qpa8688_physical_device : public rfdevice_physical_device
{
public:
  qpa8688_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qpa8688_physical_device* qpa8688_physical_device_p;
...
private:
  ...
  rfdevice_qpa_4g* qpa8688_pa_obj_ptr;

  /* ASM */
  rfdevice_qasm_2g* qpa8688_asm_obj_ptr;
