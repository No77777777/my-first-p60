...
#ifndef QPA8688_PA_CONFIG_AG_H
#define QPA8688_PA_CONFIG_AG_H/*
...
Generated from-  
	...
	Author: jose
	Revision: 1.02 ()
	Change Note: AddedextendedPID
	Tab: qpa8688_pa_settings
...
GENERAL DESCRIPTION
  This file is auto-generated and it captures the configuration of the QPA8688 PA.
...
boolean rfdevice_qpa_qpa8688_construct_driver_ag
(
  rfdevice_qpa_4g_settings_type* qpa_settings,
  rfdevice_qpa_4g_func_tbl_type* pa_fn_ptrs
);

uint8 rfdevice_qpa_qpa8688_get_efs_data_column
(
  uint8 port_index, 
  rfdevice_qpa_4g_tx_bw_data_type lcl_bw
);

boolean rfdevice_qpa_qpa8688_is_dpd_port
(
  uint8 port_index
);
