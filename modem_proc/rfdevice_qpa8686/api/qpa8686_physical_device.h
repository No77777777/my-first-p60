#ifndef QPA8686_PHYSICAL_DEVICE_AG_H
#define QPA8686_PHYSICAL_DEVICE_AG_H
/*!
   @file
   qpa8686_physical_device_ag.h

   @brief
   qpa8686 physical device driver
...
$Header: //components/rel/rfdevice_qpa8686.mpss/1.11/api/qpa8686_physical_device.h#1 $ 
...
#include "qpa8686_pa_config_main_ag.h"
#include "qpa8686_asm_config_main_ag.h"

class qpa8686_physical_device : public rfdevice_physical_device
{
public:
  qpa8686_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qpa8686_physical_device* qpa8686_physical_device_p;
...
private:
  ...
  rfdevice_qpa_4g* qpa8686_pa_obj_ptr;

  /* ASM */
  rfdevice_qasm_2g* qpa8686_asm_obj_ptr;
