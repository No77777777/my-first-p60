...
#ifndef QSW2630A_COUPLER_CONFIG_AG_H
#define QSW2630A_COUPLER_CONFIG_AG_H/*
...
boolean rfdevice_qcoupler_qsw2630a_construct_driver_ag
(
  rfdevice_qcoupler_settings_type* qcoupler_settings,
  rfdevice_qcoupler_func_tbl_type* qcoupler_fn_ptrs
);

boolean rfdevice_qcoupler_qsw2630a_get_config_data_ag
(
