...
#ifndef RFDEVICE_ASM_RSW2330_QDM2330_DATA_AG
#define RFDEVICE_ASM_RSW2330_QDM2330_DATA_AG
...
class rfdevice_asm_rsw2330_qdm2330_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_rsw2330_qdm2330_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_rsw2330_qdm2330_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_rsw2330_qdm2330_data_ptr;
