...
#ifndef RFDEVICE_XSW_CXA4482GC_DATA_AG
#define RFDEVICE_XSW_CXA4482GC_DATA_AG
...
class rfdevice_xsw_cxa4482gc_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_xsw_cxa4482gc_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_xsw_cxa4482gc_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_xsw_cxa4482gc_data_ptr;
