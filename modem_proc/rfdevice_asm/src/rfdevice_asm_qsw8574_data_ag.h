...
#ifndef RFDEVICE_ASM_QSW8574_DATA_AG
#define RFDEVICE_ASM_QSW8574_DATA_AG
...
class rfdevice_asm_qsw8574_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_qsw8574_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_qsw8574_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_qsw8574_data_ptr;
