...
#ifndef RFDEVICE_ASM_LMDSM_QDM2307_0X93_0X12_DATA_AG
#define RFDEVICE_ASM_LMDSM_QDM2307_0X93_0X12_DATA_AG
...
class rfdevice_asm_lmdsm_qdm2307_0x93_0x12_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_lmdsm_qdm2307_0x93_0x12_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_lmdsm_qdm2307_0x93_0x12_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_lmdsm_qdm2307_0x93_0x12_data_ptr;
