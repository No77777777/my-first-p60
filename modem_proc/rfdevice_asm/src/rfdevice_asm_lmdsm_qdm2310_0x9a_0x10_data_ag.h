...
#ifndef RFDEVICE_ASM_LMDSM_QDM2310_0X9A_0X10_DATA_AG
#define RFDEVICE_ASM_LMDSM_QDM2310_0X9A_0X10_DATA_AG
...
class rfdevice_asm_lmdsm_qdm2310_0x9a_0x10_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_lmdsm_qdm2310_0x9a_0x10_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_lmdsm_qdm2310_0x9a_0x10_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_lmdsm_qdm2310_0x9a_0x10_data_ptr;
