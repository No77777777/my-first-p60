...
#ifndef RFDEVICE_ASM_LMDSM_QDM2308_0X93_0X11_DATA_AG
#define RFDEVICE_ASM_LMDSM_QDM2308_0X93_0X11_DATA_AG
...
class rfdevice_asm_lmdsm_qdm2308_0x93_0x11_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_lmdsm_qdm2308_0x93_0x11_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_lmdsm_qdm2308_0x93_0x11_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_lmdsm_qdm2308_0x93_0x11_data_ptr;
