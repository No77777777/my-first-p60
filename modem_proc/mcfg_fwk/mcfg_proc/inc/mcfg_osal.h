...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_proc/inc/mcfg_osal.h#2 $ $DateTime: 2021/04/22 00:54:54 $ $Author: pwbldsvc $
...
#else
  #define mcfg_malloc(size)                     modem_mem_alloc(size, MODEM_MEM_CLIENT_UNCOMPRESSED_HEAP);\
                                                mcfg_heap_blocks++; \
                                                MCFG_MSG_LOW_1("mcfg_malloc, mcfg_heap_blocks %d", mcfg_heap_blocks)

  #define mcfg_free(ptr)                        modem_mem_free(ptr, MODEM_MEM_CLIENT_UNCOMPRESSED_HEAP); \
                                                ptr = NULL;\
                                                mcfg_heap_blocks--;\
                                                MCFG_MSG_LOW_1("mcfg_free, mcfg_heap_blocks %d", mcfg_heap_blocks)
#endif
