/*===========================================================================
                        M O D E M C F G    INTERNAL   (mcfg_int.h)

DESCRIPTION

  MCFG src file for logging
...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_proc/inc/mcfg_int.h#1 $ $DateTime: 2021/04/08 00:04:19 $ $Author: pwbldsvc $
...
#define MCFG_MSG_HIGH_6(fmt, a1, a2, a3, a4, a5, a6) \
  MSG_6(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3, a4, a5, a6)
