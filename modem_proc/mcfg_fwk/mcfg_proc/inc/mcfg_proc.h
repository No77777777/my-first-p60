...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_proc/inc/mcfg_proc.h#1 $ $DateTime: 2021/04/08 00:04:19 $ $Author: pwbldsvc $
...
#define MCFG_FORMAT_NUM_FEATAGGED       0x05
...
#define U_ITEM_OPS_ATTRIB_EXCLUDE       0x01   /* E */
...
#define MCFG_INT_FEATURE_ITEM                  0x11
#define MCFG_INT_LARGE_EFS_FILE                0x12
#define MCFG_INT_DELETE_LARGE_EFS_FILE         0x13
#define MCFG_INT_STATIC_WO_LARGE_EFS_FILE      0x14
#define MCFG_INT_MUXD_LARGE_EFS_FILE           0x15
#define MCFG_INT_MUXD_SW_ONLY_LARGE_EFS_FILE   0x16
...
{ 
  uint16	mcfg_nv_item_type;
  uint32	mcfg_nv_item_length;
}mcfg_large_nv_item_hdr_type;

typedef PACKED struct 
{ 
  mcfg_large_nv_item_hdr_type hdr;
  uint8* value;
} mcfg_large_tlv;
/*===========================================================================
