...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_proc/src/mcfg_proc_i.h#1 $ $DateTime: 2021/04/08 00:04:19 $ $Author: pwbldsvc $
...
boolean mcfg_update_nvefs(uint8 cfg_type, uint32 num_mcfg_items, uint8* ram_cust_data_ptr, uint8 subs_id,
                          mcfg_refresh_type_e_type refresh_type, boolean skip_storage_items);
