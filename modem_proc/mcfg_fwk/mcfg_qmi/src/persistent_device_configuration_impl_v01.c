...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_qmi/src/persistent_device_configuration_impl_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/* This file was generated with Tool version 6.14.7
   It was generated on: Tue Jun  6 2017 (Spin 0)
...
static const uint32_t pdc_list_configs_req_msg_impl_array_v01[] =
{
    ...
    QMI_SI_TLV_SET(0x12)      /* multi_support */
};
...
static const uint32_t pdc_get_feature_ind_msg_impl_array_v01[] =
{
    ...
    QMI_SI_TLV_SET(0x15)   |  /* multisim */
    QMI_SI_TLV_SET(0x16)   |  /* os */
    QMI_SI_TLV_SET(0x17)   |  /* market */
    QMI_SI_TLV_SET(0x18)   |  /* deployment */
    QMI_SI_TLV_SET(0x19)   |  /* ims_feature */
    QMI_SI_TLV_SET(0x1A)   |  /* variant */
    QMI_SI_TLV_SET(0x1B)      /* country */
};
