...
$Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_sel/src/mcfg_trl.c#1 $
...
#define MCFG_TRL_TLV_SIZE_MCFG_HEADER     (16)
...
static boolean mcfg_trl_decode_mcfg_header
(
  const mcfg_config_info_s_type *config_info,
  uint32                         offset,
  void                          *decode_buffer
...
static const mcfg_trl_tlv_info_s_type mcfg_trl_tlv_info[] =
{
  ...
  /* MCFG_TRL_TLV_ID_MCFG_HEADER */
  {
    MCFG_TRL_TLV_INFO_FLAG_SIZE_FIXED,
    MCFG_TRL_TLV_SIZE_MCFG_HEADER,
    sizeof(mcfg_trl_mcfg_header_s_type),
    mcfg_trl_decode_mcfg_header
  },
...
/*===========================================================================
  ...
  FUNCTION mcfg_trl_decode_mcfg_header

  DESCRIPTION
    Decodes the mcfg header TLV data.
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  memscpy(decode_buffer, sizeof(mcfg_trl_mcfg_header_s_type),
          (const uint8 *)(&config_info->description[offset] + sizeof(mcfg_trl_tlv_header_s_type)),
          sizeof(mcfg_trl_mcfg_header_s_type));
