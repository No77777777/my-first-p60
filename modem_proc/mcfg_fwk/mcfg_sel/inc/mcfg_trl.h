...
$Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_sel/inc/mcfg_trl.h#1 $
...
#define MCFG_TRL_TLV_ID_MCFG_HEADER       (0x0B)
...
#define MCFG_TRL_IIN_LIST_MAX_COUNT (64)
#define MCFG_TRL_PLMN_LIST_MAX_COUNT (64)
...
typedef enum
{
  ...
  MCFG_CATEGORY_BITMASK_CARRIER = 0xFF << MCFG_CATEGORY_BIT_CARRIER,
