...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/mcfg_dynrec/src/mcfg_dynrec.c#1 $
...
int mcfg_dynrec_reclaim_RFC(void)
{
  ...
  //update the MMU table with new added
  if(mcfg_mmu_update() != MCFG_MMU_UPDATE_SUCCESS)
  {
    mcfg_dynrec_last_error = MCFG_DYNREC_MMU_ERROR;
  }
  return 0;
}
