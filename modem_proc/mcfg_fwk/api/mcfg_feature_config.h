...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/api/mcfg_feature_config.h#2 $ $DateTime: 2022/05/24 21:04:19 $ $Author: pwbldsvc $
...
/* For FeatureTag Support */
#define FEATURE_MCFG_FEATURETAG
#define FEATURE_MCFG_SEL_DB
