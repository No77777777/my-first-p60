...
$Header: //components/rel/mcfg_fwk.mpss/7.8.1.1/api/mcfg_common.h#1 $ 
...
==============================================================================*/
/* Maximum size of each config file 300k */
#define MCFG_CONFIG_SIZE_MAX              (300*1024)
...
typedef enum mcfg_error_e{
  ...
  MODEM_CFG_INVALID_FEATURE_TAGS,
