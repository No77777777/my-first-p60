...
$Header: //components/rel/rfdevice_qfe1040.mpss/1.32/api/qfe1040_physical_device_ag.h#1 $
$Author: pwbldsvc $
$DateTime: 2021/03/09 04:49:29 $ 

when       who   what, where, why
--------   ---   --------------------------------------------------------------- 
01/06/16   dbc   Add support for enable/disable physical device voting
...
*/
  ...
  /* 
    One bit per logical component to track the enables votes 
    Enable vote resets the bit
    Disable vote sets the bit
  */
  uint64 enable_disable_vote;
