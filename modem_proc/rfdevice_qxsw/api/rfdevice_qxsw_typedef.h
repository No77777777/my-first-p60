...
Qualcomm Proprietary
  ...
  $Header: //components/rel/rfdevice_qxsw.mpss/1.32/api/rfdevice_qxsw_typedef.h#1 $
  $DateTime: 2021/03/09 04:51:44 $
  $Author: pwbldsvc $
...
typedef struct
{
  ...
  /* Sleep */
  uint8                           xsw_sleep_script_size;
  rfdevice_qxsw_ag_settings_type  xsw_sleep;

  /* Wake Up */
  uint8                           xsw_wake_up_script_size;
  rfdevice_qxsw_ag_settings_type  xsw_wake_up;
