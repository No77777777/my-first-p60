...
$Header: //components/rel/gnss8.mpss/11.1/api/gnss_api.h#4 $
...
typedef enum
{
  ...
  ,GNSS_RF_TWO_SAW_WCN3950_GLNA   // 7 Two-SAW gLNA on Comanche(WCN) HW config
  ,GNSS_RF_SINGLE_SAW_WCN3950_GLNA // 8 Single-SAW gLNA on Comanche (WCN) HW config	  
#endif
 ...
 *
 * Parameters:
 *  uint8 - GPIO number that is used to control the L1-eLNA
 *  uint8 - GPIO number that is used to control the L5-eLNA
 *  boolean - TRUE for enable, FALSE for disable
 *
 * Return value: 
 *  boolean - TRUE for success, FALSE for failure
 * -----------------------------------------------------------------------*/
typedef boolean(*gnss_ExternalLnaFuncPtrType)(uint8, uint8, boolean);

typedef struct
{
  gnss_LnaConfigEnumType e_L1ExtElnaCtrl; /* External ELNA control to specify if non-eLNA/ieLNA/eLNA is present*/
  uint8                  u_L1ElnaGpioNumber;  /* GPIO number on which L1-eLNA needs to be configured */
  uint8                  u_L5ElnaGpioNumber;  /* GPIO number on which L5-eLNA needs to be configured */
...
/* NR5G specific band enum */
typedef enum 
{
  GNSS_RFCOM_BAND_NR5G_N1,
  GNSS_RFCOM_BAND_NR5G_N2,
  GNSS_RFCOM_BAND_NR5G_N3,
  GNSS_RFCOM_BAND_NR5G_N5,
  GNSS_RFCOM_BAND_NR5G_N7,
  GNSS_RFCOM_BAND_NR5G_N8,
  GNSS_RFCOM_BAND_NR5G_N20,
  GNSS_RFCOM_BAND_NR5G_N28,
  GNSS_RFCOM_BAND_NR5G_N38,
  GNSS_RFCOM_BAND_NR5G_N41,
  GNSS_RFCOM_BAND_NR5G_N50,
  GNSS_RFCOM_BAND_NR5G_N51,
  GNSS_RFCOM_BAND_NR5G_N66,
  GNSS_RFCOM_BAND_NR5G_N70,
  GNSS_RFCOM_BAND_NR5G_N71,
  GNSS_RFCOM_BAND_NR5G_N74,
  GNSS_RFCOM_BAND_NR5G_N75,
  GNSS_RFCOM_BAND_NR5G_N76,
  GNSS_RFCOM_BAND_NR5G_N77,
  GNSS_RFCOM_BAND_NR5G_N78,
  GNSS_RFCOM_BAND_NR5G_N79,
  GNSS_RFCOM_BAND_NR5G_N80,
  GNSS_RFCOM_BAND_NR5G_N81,
  GNSS_RFCOM_BAND_NR5G_N82,
  GNSS_RFCOM_BAND_NR5G_N83,
  GNSS_RFCOM_BAND_NR5G_N84,
  GNSS_RFCOM_BAND_NR5G_N85,
  GNSS_RFCOM_BAND_NR5G_N257,
  GNSS_RFCOM_BAND_NR5G_N258,
  GNSS_RFCOM_BAND_NR5G_N259,
  GNSS_RFCOM_BAND_NR5G_N260,
  GNSS_RFCOM_BAND_NR5G_N261,
  GNSS_RFCOM_NUM_NG5G_BANDS,
  GNSS_RFCOM_BAND_NR5G_INVALID
} gnss_RfcomNR5GBandEnum;
...
typedef union 
{
  ...
  gnss_RfcomNR5GBandEnum e_NR5GBand;   /* For NR5G Band */
  gnss_RfCardBandEnum e_RfBand;        /* For other than WCDMA, LTE, NR5G, or TDSCDMA Band */
} gnss_RfBandType;
 ...
 * 7) GNSS L5 peak antenna gain in tenth of dB-Hz ( -20 .. + 50 ) 
 * 8) NAVIC system processing loss in  tenth of dB-Hz 
 * -----------------------------------------------------------------------*/
...
#define GNSS_RF_CONFIG_PEAK_ANTENNA_GAIN_L5  0x20
#define GNSS_RF_CONFIG_NAVIC_SPL             0x40

typedef struct
{
  uint8   u_GnssRfConfigBitMask; /* Available data */
  int16   x_GnssPeakAntennaGain;  /* GNSS Antenna peak gain in tenth of dB-Hz */
  int16   x_GnssPeakAntennaGainL5;  /* GNSS L5 Antenna peak gain in tenth of dB-Hz */
  ...
  uint16  w_NavicSpl;               /* Navic System processing loss in tenth of dB-Hz */
...
#define GNSS_RF_CONFIG_PEAK_ANTENNA_GAIN_MIN   (-70)
/* Minimum is -7 to keep the CAN'T_BE_ACI_GLO to be non negative 
   CAN'T_BE_ACI_GLO (dB-Hz) = 17 dB-Hz - SPL_GLO dB + Lant dB
   where max SPL_GLO is 10dB */
#define GNSS_RF_CONFIG_PEAK_ANTENNA_GAIN_MAX   50

/* TBD - RF team to refine below numbers */
/* Max and min L5 antenna peak gains */
#define GNSS_RF_CONFIG_L5_PEAK_ANTENNA_GAIN_MIN   (-70)
#define GNSS_RF_CONFIG_L5_PEAK_ANTENNA_GAIN_MAX   50
...
/*Common time format for GPS, BDS, GAL and Navic */
typedef struct
{
  uint16   w_Week;          /*!< GNSS week number at reference tick [weeks] */
  uint32   q_Msec;          /*!<  msec at reference tick [msecs] */
  uint8    u_FourYear;     /*!< GLO 4 year number from 1996 at the reference tick*/
  uint16   w_Days;         /*!< GLO day number in 4 years at the reference tick*/  
  float    f_ClkTimeBias;   /*!< Clock bias [msecs]. Constrait to >-0.5 and <0.5 */
  float    f_ClkTimeUncMs;  /*!< 1 sided max time bias uncertainty [msecs] */
