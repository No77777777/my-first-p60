...
$Header: //components/rel/gnss8.mpss/11.1/cust/inc/custcgps.h#4 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
12/07/18   ap      Added flags to enable DTF and QSH code
...
/* Compress EFS files in PE to save space */
#define FEATURE_CGPS_EFS_COMPRESS
...
//#define FEATURE_GNSS_LTE_CATM_COEX
  ...
  #define FEATURE_GNSS_FULL_MEAS_LOG_ENABLED
...
/* Enable GPS Automotive Features based on the target level modem flag */
  ...
  #define FEATURE_GNSS_FULL_MEAS_REPORTING
  #define FEATURE_GNSS_FULL_MEAS_LOG_NV_ENABLED
#endif /* FEATURE_AUTOMOTIVE_SP */

#ifndef FEATURE_GNSS_MULTIBAND
  /*Disable NAVIC if MB feature is not enabled*/
  #define GNSS_DISABLE_NAVIC_CONSTELLATION
#endif

#if !(defined(FEATURE_GNSS_SM6150_HW)) && \
    !(defined(FEATURE_GNSS_SM7150_HW)) && \
    !(defined(FEATURE_GNSS_KAMORTA_HW)) && \
    !(defined(FEATURE_GNSS_RENNELL_HW))
#ifndef T_WINNT
/* Dont need feature for SMART */
#define FEATURE_USE_GNSS_DIAG_BUF
  #endif  /* ! T_WINNT */
#endif /* !(defined(FEATURE_GNSS_SM6150_HW)) && !(defined(FEATURE_GNSS_SM7150_HW)) && !(defined(FEATURE_GNSS_RENNELL_HW))  !(defined(FEATURE_GNSS_KAMORTA_HW))*/
#endif /* FEATURE_CGPS */
#endif /* CUSTCGPS_H */
