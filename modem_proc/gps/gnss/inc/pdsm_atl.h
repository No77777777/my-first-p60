...
typedef enum
{
  PDSM_ATL_BEARER_TYPE_WWAN = 1, /**<  Request if for WWAN based connection */
  PDSM_ATL_BEARER_TYPE_WLAN = 2, /**<  Request if for WLAN based connection */
  PDSM_ATL_BEARER_TYPE_ANY  = 3, /**<  Request for Any available Bearer WLAN/WWAN based connection */
} pdsm_atl_bearer_e_type;

typedef uint64_t pdsm_atl_apn_type_mask;
#define PDSM_ATL_APN_TYPE_MASK_UNSPECIFIED 0x0000000000000000ull /**<  Denotes APN type Unspecified  */
#define PDSM_ATL_APN_TYPE_MASK_DEFAULT     0x0000000000000001ull /**<  Denotes APN type for Default/Internet traffic  */
#define PDSM_ATL_APN_TYPE_MASK_IMS         0x0000000000000002ull /**<  Denotes APN type for IP Multimedia Subsystem  */
#define PDSM_ATL_APN_TYPE_MASK_MMS         0x0000000000000004ull /**<  Denotes APN type for Multimedia Messaging Service  */
#define PDSM_ATL_APN_TYPE_MASK_DUN         0x0000000000000008ull /**<  Denotes APN type for Dial Up Network  */
#define PDSM_ATL_APN_TYPE_MASK_SUPL        0x0000000000000010ull /**<  Denotes APN type for Secure User Plane Location  */
#define PDSM_ATL_APN_TYPE_MASK_HIPRI       0x0000000000000020ull /**<  Denotes APN type for High Priority Mobile Data  */
#define PDSM_ATL_APN_TYPE_MASK_FOTA        0x0000000000000040ull /**<  Denotes APN type for over the air administration  */
#define PDSM_ATL_APN_TYPE_MASK_CBS         0x0000000000000080ull /**<  Denotes APN type for Carrier Branded Services  */
#define PDSM_ATL_APN_TYPE_MASK_IA          0x0000000000000100ull /**<  Denotes APN type for Initial Attach  */
#define PDSM_ATL_APN_TYPE_MASK_EMERGENCY   0x0000000000000200ull /**<  Denotes APN type for emergency  */
...
typedef struct
{
  ...
  pdsm_atl_apn_type_mask       apn_type;      /* APN Type mask*/
  pdsm_atl_bearer_e_type       bearer_type;   /* Bearer type WWAN/WLAN*/
  char                         apn_name[PDSM_ATL_MAX_APN_STRING_LEN+1];  /* APN Name */
  sys_modem_as_id_e_type       as_id; /* SUB ID on which supl init */
