...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/inc/pd_comms_api.h#1 $$DateTime: 2019/10/24 01:30:36 $$Author: pwbldsvc $ 

 when      who   what, where, why
 ----      ----  --- ---------------------------------------------------
 09/30/19   skm  Support for 911 nDDS on DSDS targets
 04/17/18   py  Updated pd_comms_app_srv_sys_change_notification parameter
...
typedef enum
{
  ...
  SSL_VER_TLS_1_2  /*use security TLS 1.2 if set in NV*/
...
} pd_comms_sys_info_change_params_type;
...
typedef struct
{
  uint32 q_transaction_id;
  pd_comms_handle_type z_handle;
  sys_modem_as_id_e_type as_id; /* To inform about the sub on which SUPL is on*/  
  uint16 w_data_len; 
