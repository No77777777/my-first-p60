...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/diag/src/aries_gpsdiag.h#2 $
...
03/19/19    sum    Deletion mask missing for GNSS data.
11/28/18    sum    Overfow observed with PA delete params flags.
...
#define CGPS_DIAG_BUF_TEST_CMD                208
...
typedef PACKED struct PACKED_POST
{
  ...
  uint8              u_PowerMode;      /* GNSS Power Mode (M1-M5) */
  uint8              u_Reserved[6];    /* Reserved bytes */ 
...
typedef PACKED struct PACKED_POST
{
  uint64             q_DelParamsFlags; /* See ENUM gpsdiag_eDelParamsType */
  uint64             q_GnssDelParamsFlags; /* extended flag for gnss systems */
  uint32             q_GnssDelParamsFlagsReserved; /* reserved for future use */
  uint32             q_TimeUnc;        /* Time Uncertainty */
  uint32             q_PosUnc;         /* Position Uncertainty */
  uint32             q_TimeOffset;     /* Time Offset */
...
typedef PACKED struct PACKED_POST
{
  ...
  PACKED union PACKED_POST {
    ...
    gpsdiag_PaDelParamsTypeExV2 z_DelParams_exV2;
    gpsdiag_PaDelParamsTypeV2 z_DelParamsV2;
  } z_ParamVal;
...
typedef enum
{
   ...
   GNSSDIAG_PA_DELETE_HEALTH_QZSS   = GPSDIAG_SET_U64BITMASK_BIT(15),
   ...
   GNSSDIAG_PA_DELETE_EPH_NAV         = GPSDIAG_SET_U64BITMASK_BIT(47),
   GNSSDIAG_PA_DELETE_SVDIR_NAV       = GPSDIAG_SET_U64BITMASK_BIT(48),
   GNSSDIAG_PA_DELETE_SVSTEER_NAV     = GPSDIAG_SET_U64BITMASK_BIT(49),
   GNSSDIAG_PA_DELETE_ALM_CORR_NAV    = GPSDIAG_SET_U64BITMASK_BIT(50),
   GNSSDIAG_PA_DELETE_GNSS_SV_BLACKLIST_NAV  = GPSDIAG_SET_U64BITMASK_BIT(51),
   GNSSDIAG_PA_DELETE_HEALTH_NAV      = GPSDIAG_SET_U64BITMASK_BIT(52),
   GNSSDIAG_PA_DELETE_TGD_DATA_NAV    = GPSDIAG_SET_U64BITMASK_BIT(53),
   GNSSDIAG_PA_DELETE_IONO_NAV        = GPSDIAG_SET_U64BITMASK_BIT(54),
   GNSSDIAG_PA_DELETE_ALM_NAV         = GPSDIAG_SET_U64BITMASK_BIT(55),
   GNSSDIAG_PA_DELETE_TIME_NAV         = GPSDIAG_SET_U64BITMASK_BIT(56),
   GNSSDIAG_PA_DELETE_XTRA_INTEGRITY_NAV  = GPSDIAG_SET_U64BITMASK_BIT(57)
...
/*****************************/
/* Diag buffer test commands */
/*****************************/
#define GPSDIAG_DIAG_BUFFER_FLUSH_CMD           1


/* Diag buffer test command  Req/Rsp packets
 *
 * This msg is used to issue test commands for diag buffers in modem.
 * No diag buffer command response is needed
 */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType z_DiagCmdHdr;            /* diagpkt_subsys_header_type */
...
} gpsdiag_DiagBufferTestCmdReqType;

typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType      z_DiagCmdHdr;  /* diagpkt_subsys_header_type */
  uint32                  q_Status;
} gpsdiag_DiagBufferTestCmdRespType;
