...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/diag/src/aries_gpsdiag.c#2 $
  $DateTime: 2019/12/24 02:33:50 $
  $Author: pwbldsvc $
...
03/27/19   sum     Fixed clockwork issue
...
static const char *c_sm_query_file_description = "$Id: //components/rel/gnss8.mpss/11.1/gnss/diag/src/aries_gpsdiag.c#2 $";
...
static char u_Efs_FileName[C_GPSDIAG_EFS_MAX_FILESIZE];
static unsigned char u_Efs_Data[C_GPSDIAG_EFS_MAX_PAYLOAD];
...
static PACKED void* gpsdiag_GNSSDiagBufferTest(gpsdiag_DiagBufferTestCmdReqType* p_Req, uint16 w_PktLength);
...
static uint32 gpsdiag_TranslateGpsDiagToPdsmDeleteParams(pdsm_delete_parms_type *pDest,
                                                         const gpsdiag_PaDelParamsTypeV2 *pSrc);
static void gpsdiag_TranslatePaDeleteParamasToV2(gpsdiag_PaDelParamsTypeV2 *pDest, gpsdiag_PaDelParamsType *pSrc);
                          ...
                          const pdsm_pd_info_s_type* p_PdInfo)
{
  ...
  os_AppTrackType z_AppTrack;
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_DoneEventCb: PDSM_PD_EVENT_DLOAD_DONE", 0, 0, 0);
   }
   else if(u_PdEvent & PDSM_PD_EVENT_COMM_DONE)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_DoneEventCb: PDSM_PD_EVENT_COMM_DONE", 0, 0, 0);
   }
                         ...
                         const pdsm_pd_info_s_type* p_PdInfo)
{
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_EndEventCb: PDSM_PD_DLOAD_EVENT_END", 0, 0, 0);

      /* Report an unsuccessful PDSM session back to QXDM */
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"GPSDIAG Data Download Unsuccessful", 0, 0, 0);
   }
   else
   {
                           ...
                           const pdsm_pd_info_s_type* p_PdInfo)
{
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_StartEventCb: PDSM_PD_EVENT_DLOAD_BEGIN", 0, 0, 0);
   }
   else if(u_PdEvent & PDSM_PD_EVENT_COMM_BEGIN)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_StartEventCb: PDSM_PD_EVENT_COMM_BEGIN", 0, 0, 0);
   }
                             ...
                             const pdsm_pd_info_s_type* p_PdInfo)
{
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_FailureEventCb: PDSM_PD_EVENT_COMM_FAILURE", 0, 0, 0);
   }
                               ...
                               const pdsm_pd_info_s_type* p_PdInfo)
{
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_ConnectedEventCb: PDSM_PD_EVENT_COMM_CONNECTED", 0, 0, 0);
   }
                                   ...
                                   const pdsm_pd_info_s_type* p_PdInfo)
{
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_DloadOccurredEventCb: PDSM_PD_EVENT_DLOAD", 0, 0, 0);
   }
...
//      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Duplicate event for Client ID %d", e_ClientType, 0, 0);
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_APP_INFO received", 0, 0, 0);
   }
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_KEEP_WARM received", 0, 0, 0);
   }
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_POSITION_MODE received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_MT_LR_SUPPORT)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_MT_LR_SUPPORT received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_MO_METHOD)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_MO_METHOD received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_NMEA_SENTENCE_TYPE)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_NMEA_SENTENCE_TYPE received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_1X_PDE_NETWORK_ADDRESS)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_1X_PDE_NETWORK_ADDRESS received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_1X_MPC_NETWORK_ADDRESS)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_1X_MPC_NETWORK_ADDRESS received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_UMTS_PDE_NETWORK_ADDRESS)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_UMTS_PDE_NETWORK_ADDRESS received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_NMEA_CONFIG_INFO)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_NMEA_CONFIG_INFO received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_SBAS_STATUS)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_SBAS_STATUS received", 0, 0, 0);
   }
   else if(u_PaEvent & PDSM_PA_EVENT_SBAS_USER_PREFERENCE)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_SBAS_USER_PREFERENCE received", 0, 0, 0);
   }
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_EXTERNAL_SPI received", 0, 0, 0);
   }
   else if (u_PaEvent & PDSM_PA_EVENT_EFS_DATA)
   {
     MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_EFS_DATA received", 0, 0, 0);
   }
   else if (u_PaEvent & PDSM_PA_EVENT_SUPL_VERSION)
   {
     MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_SUPL_VERSION received", 0, 0, 0);
   }
   else if (u_PaEvent & PDSM_PA_EVENT_SUPL_SECURITY)
   {
     MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_PaEventsDispatchCb: PDSM_PA_EVENT_SUPL_SECURITY received", 0, 0, 0);
   }
                                      ...
                                      const pdsm_ext_status_info_s_type* p_ExtStatInfo)
{
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"gpsdiag_ExtStatEventsDispatchCb: No Valid Information", 0, 0, 0);
      return;
   }
   ...
   if(e_ClientType >= PDSM_CLIENT_TYPE_MAX ||
      e_ClientType == PDSM_CLIENT_TYPE_NONE)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"gpsdiag_ExtStatEventsDispatchCb: Client Type Error %d", e_ClientType, 0, 0);
      return;
   }
...
//      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Duplicate event for Client ID %d", e_ClientType, 0, 0);
      ...
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"gpsdiag_ExtStatEventsDispatchCb: Unknown Client ID %d", e_ClientType, 0, 0);
      }
      return;
   }
   ...
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_ExtStatEventsDispatchCb: PDSM_EXT_STATUS_EVENT_NMEA_POS_REPORT received", 0, 0, 0);
   }
   else if(u_ExtStatEvent & PDSM_EXT_STATUS_EVENT_POS_REPORT)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_ExtStatEventsDispatchCb: PDSM_EXT_STATUS_EVENT_POS_REPORT received", 0, 0, 0);
   }
   else if(u_ExtStatEvent & PDSM_EXT_STATUS_EVENT_MEASUREMENT)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"gpsdiag_ExtStatEventsDispatchCb: PDSM_EXT_STATUS_EVENT_MEASUREMENT received", 0, 0, 0);
   }
...
PACKED void* gpsdiag_RegCmdsDispatch (PACKED void* p_PktReq, uint16 w_PktLength)
{
   ...
   case CGPS_REGISTER_PD_CMD:
      ...
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"RegCmd: CGPS_REGISTER_PD_CMD: Register: %d, %u", e_ClientType, gpsdiag_ClientTable[e_ClientType].l_ClientId, 0);
      ...
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"RegCmd: CGPS_REGISTER_PD_CMD: Deregister", 0, 0, 0);
         e_Result = pdsm_client_pd_reg(p_Req->l_ClientId,
                                       NULL,
...
FUNCTION diag_GetPowerModeEnumT

DESCRIPTION
  This function converts the integer power mode input from user to the pdapi
  compatible enum type
...
===========================================================================*/
static pdsm_pd_session_power_e_type diag_GetPowerModeEnumT(uint8 u_PdapiPowerMode)
{
  switch (u_PdapiPowerMode)
  {
    case 1:
      return PDSM_SESSION_POWER_MODE_IMPROVED_ACCURACY;
    case 2:
      return PDSM_SESSION_POWER_MODE_NORMAL;
    case 3:
      return PDSM_SESSION_POWER_MODE_BACKGROUND_DEFINED_POWER;
    case 4:
      return PDSM_SESSION_POWER_MODE_BACKGROUND_DEFINED_TIME;
    case 5:
      return PDSM_SESSION_POWER_MODE_BACKGROUND_KEEP_WARM;
    default:
      MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Invalid Power Mode %d. Default to M2", u_PdapiPowerMode);
	  return PDSM_SESSION_POWER_MODE_NORMAL;
  }
} /* diag_GetPowerModeEnumT */


/*===========================================================================

FUNCTION diag_PopulatePdOptionsFromStartCmd

DESCRIPTION
  This function populates the PD Options structure that is passed to pdsm_get_position() API
  From the Start Command, this function uses the GNSS power mode to figure out what
  should be the TBF and TBM. 
  The time between measurements for pdsm_get_position() is in msec.
  M1/M2: TBF - User Input; TBM - 0 (Don't care)
  M3/M5: TBM = User supplied TBF; TBF reprogrammed to 1 sec
  M4: TBF - User Input; TBM = TBF

  Also maps all other PD Options parameters
...
===========================================================================*/
static void diag_PopulatePdOptionsFromStartCmd(pdsm_pd_option_s_type* pz_PdsmPdOptions, gpsdiag_StartCmdReqType* p_Req)
{
  ...
  if ((NULL == pz_PdsmPdOptions) || (NULL == p_Req))
  {
    MSG_1(MSG_SSID_GPS, MSG_LEGACY_ERROR, "pz_PdsmPdOptions 0x%p OR p_Req is NULL", pz_PdsmPdOptions);
    return;
  }
  ...
  pz_PdsmPdOptions->session = (pdsm_pd_session_e_type)p_Req->u_SessionType;

  /* Operation Mode Type */
  pz_PdsmPdOptions->operation_mode = (pdsm_pd_session_operation_e_type)p_Req->u_OperatingType;

  /* Fix rate for tracking sessions (pdsm_pd_fix_rate_s_type) */
  pz_PdsmPdOptions->fix_rate.num_fixes = p_Req->q_NumFixes;
  pz_PdsmPdOptions->fix_rate.time_between_fixes_ms = p_Req->q_TimeBwFixes * 1000;

  /* AGPM 1.0 - GNSS Power Modes */
  /* This should always be called after populating TBF, as this function can override the user TBF in certain cases */
  pz_PdsmPdOptions->power_mode.powerMode = diag_GetPowerModeEnumT(p_Req->u_PowerMode);
  switch (pz_PdsmPdOptions->power_mode.powerMode)
  {
    case PDSM_SESSION_POWER_MODE_IMPROVED_ACCURACY:
    case PDSM_SESSION_POWER_MODE_NORMAL:
      pz_PdsmPdOptions->power_mode.tbm_msecs = 0;
      break;

    case PDSM_SESSION_POWER_MODE_BACKGROUND_DEFINED_POWER:
    case PDSM_SESSION_POWER_MODE_BACKGROUND_KEEP_WARM:
      pz_PdsmPdOptions->power_mode.tbm_msecs = pz_PdsmPdOptions->fix_rate.time_between_fixes_ms;
      pz_PdsmPdOptions->fix_rate.time_between_fixes_ms = 1000;
      break;
    ...
    default:
      MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Invalid Power Mode %d. Default to M2 TBF 1, TBM 0", pz_PdsmPdOptions->power_mode.powerMode);
      pz_PdsmPdOptions->power_mode.tbm_msecs = 0;
      pz_PdsmPdOptions->fix_rate.time_between_fixes_ms = 1000;
      pz_PdsmPdOptions->power_mode.powerMode = PDSM_SESSION_POWER_MODE_NORMAL;
      break;
  }

  /* Location server information (pdsm_pd_server_info_s_type) */
  pz_PdsmPdOptions->lsinfo.server_option = (pdsm_server_option_e_type)p_Req->u_ServerOption;
  pz_PdsmPdOptions->lsinfo.server_adrs = z_ServerAddr; //pdsm_server_address_s_type

  /* Class Id in case of multiple apps */
  pz_PdsmPdOptions->class_id = (uint32)p_Req->q_ClassId;
} /* diag_PopulatePdOptionsFromStartCmd */
...
PACKED void* gpsdiag_StartCmd (PACKED void* p_PktReq, uint16 w_PktLength)
{
   ...
   /* PD option type */
   diag_PopulatePdOptionsFromStartCmd(&gpsdiag_ClientTable[e_ClientType].z_PdsmGetPosParams.z_PdOptions, p_Req);
...
PACKED void* gpsdiag_SetParamCmd (PACKED void* p_PktReq, uint16 w_PktLength)
{
   ...
   uint16                        i=0;
   gpsdiag_PaDelParamsTypeV2     z_delParams;
   ...
   memset(&z_PaDelParams, 0, sizeof(z_PaDelParams));
   ...
   case GPSDIAG_PA_UMTS_PDE_NETWORK_ADRS:
      ...
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_[]_NETWORK_ADRS (IPV4)", 0, 0, 0);
      ...
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_[]_NETWORK_ADRS (IPV6)", 0, 0, 0);
      ...
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_[]_NETWORK_ADRS (URL)", 0, 0, 0);
   ...
   case GPSDIAG_PA_KEEP_WARM:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_KEEP_WARM", 0, 0, 0);
   ...
   case GPSDIAG_PA_DELETE_PARAMS_EX:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_DELETE_PARAMS_EX Pkt Size  %d Param Size %d Ext Param Size %d ", 
           (p_Req->w_Length), 
           sizeof(gpsdiag_PaDelParamsTypeEx), 
           sizeof(gpsdiag_PaDelParamsTypeExV2));

      if(p_Req->w_Length == sizeof(gpsdiag_PaDelParamsTypeEx))
      {
        gpsdiag_TranslatePaDeleteParamasToV2(&z_delParams, &(p_Req->z_ParamVal.z_DelParams_ex.z_DelParams));
      ...
      else if(p_Req->w_Length == sizeof(gpsdiag_PaDelParamsTypeExV2))
      {
        z_delParams = p_Req->z_ParamVal.z_DelParams_exV2.z_DelParams;
        z_PaDelParams.f_time_unc = p_Req->z_ParamVal.z_DelParams_exV2.f_TimeUnc;
        z_PaDelParams.f_time_offset = p_Req->z_ParamVal.z_DelParams_exV2.f_TimeOffset;
      }
      else
      {
        MSG_1(MSG_SSID_GPS, MSG_LEGACY_ERROR,"Incorrect packate size rcvd %d",(p_Req->w_Length));
         return(diagpkt_err_rsp(DIAG_BAD_PARM_F, p_PktReq, w_PktLength));
      }

      (void) gpsdiag_TranslateGpsDiagToPdsmDeleteParams(&z_PaDelParams, &z_delParams);
   ...
   case GPSDIAG_PA_DELETE_PARAMS:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_DELETE_PARAMS Pkt Size  %d Param Size %d Ext Param Size %d ", 
           (p_Req->w_Length), 
           sizeof(gpsdiag_PaDelParamsType), 
           sizeof(gpsdiag_PaDelParamsTypeV2));
      
      if(p_Req->w_Length == sizeof(gpsdiag_PaDelParamsType))
      {
        gpsdiag_TranslatePaDeleteParamasToV2(&z_delParams, &(p_Req->z_ParamVal.z_DelParams));
      }
      else if(p_Req->w_Length == sizeof(gpsdiag_PaDelParamsTypeV2))
      {
        z_delParams = p_Req->z_ParamVal.z_DelParamsV2;
      }
      else
      {
         /* Return a diag error packet indicating bad parameters were passed */
   ...
   case GPSDIAG_PA_POSITION_MODE:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_POSITION_MODE", 0, 0, 0);
   ...
   case GPSDIAG_PA_MT_LR_SUPPORT:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_MT_LR_SUPPORT", 0, 0, 0);
   ...
   case GPSDIAG_PA_MO_METHOD:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_MO_METHOD", 0, 0, 0);
   ...
   case GPSDIAG_PA_NMEA_SENTENCE_TYPE:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_NMEA_SENTENCE_TYPE", 0, 0, 0);
   ...
   case GPSDIAG_PA_EFS_DATA:
      {
         MSG(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_EFS_DATA");

         /* u_FullPathAndFileNameLength does not include '\0', hence >= check below */
         if ((p_Req->z_ParamVal.z_EfsData.u_FullPathAndFileNameLength >= C_GPSDIAG_EFS_MAX_FILESIZE) ||
             (p_Req->z_ParamVal.z_EfsData.q_FileSize > C_GPSDIAG_EFS_MAX_PAYLOAD))
         {
           /* Return a diag error packet indicating bad parameters were passed */
           return(diagpkt_err_rsp(DIAG_BAD_PARM_F, p_PktReq, w_PktLength));
         }
         ...
         z_EfsData.efs_data_filename_len =  p_Req->z_ParamVal.z_EfsData.u_FullPathAndFileNameLength + 1;
   ...
   case GPSDIAG_PA_SBAS_USER_PREFERENCE:
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"Param: GPSDIAG_PA_SBAS_USER_PREFERENCE", 0, 0, 0);
...
PACKED void* gpsdiag_GetLastKnownPosCmd (PACKED void* p_PktReq, uint16 w_PktLength)
{
   ...
   else
   {
      ...
      p_Rsp->x_VelHorizU      = (uint16) gpsdiag_pPdData.ext_pos_data.f_velHorU;
      p_Rsp->x_VelHoriz       = (int32)  gpsdiag_pPdData.ext_pos_data.f_velHor;
      p_Rsp->x_VelVert        = (int32)  gpsdiag_pPdData.ext_pos_data.f_velVert;
   ...
   if(w_SubsysCmdCode == (uint16)CGPS_DIAG_PDAPI_CMD)
   {
      ...
      else
      {
         ...
         case CGPS_NTFY_VRFY_SND_USR_ACTN_CMD:
            MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"CgpsCmdCode: CGPS_NTFY_VRFY_SND_USR_ACTN_CMD", 0, 0, 0);
         ...
         case CGPS_INJECT_EXTERNAL_SPI:
            MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED,"CgpsCmdCode: CGPS_INJECT_EXTERNAL_SPI", 0, 0, 0);
         ...
         case CGPS_DIAG_BUF_TEST_CMD:
            MSG(MSG_SSID_GPS, MSG_LEGACY_MED,"CgpsCmdCode: CGPS_DIAG_BUF_TEST_CMD");
            return gpsdiag_GNSSDiagBufferTest(p_PktReq, w_PktLength);
...
/**
 * Translates gpsdiag delete parameters from version to version 2
...
static void gpsdiag_TranslatePaDeleteParamasToV2(gpsdiag_PaDelParamsTypeV2 *pDest, gpsdiag_PaDelParamsType *pSrc)
{
  pDest->q_DelParamsFlags                                = (uint64)pSrc->q_DelParamsFlags;
  pDest->q_GnssDelParamsFlags                            = (uint64)pSrc->q_GnssDelParamsFlags;
  pDest->q_GnssDelParamsFlagsReserved                    = pSrc->q_GnssDelParamsFlagsReserved;
  pDest->q_TimeUnc                                       = pSrc->q_TimeUnc;
  pDest->q_PosUnc                                        = pSrc->q_PosUnc;
  pDest->q_TimeOffset                                    = pSrc->q_TimeOffset;
  pDest->q_PosOffset                                     = pSrc->q_PosOffset;
  pDest->q_EphSvMask                                     = pSrc->q_EphSvMask;
  pDest->q_AlmSvMask                                     = pSrc->q_AlmSvMask;
  pDest->q_GloEphSvMask                                  = pSrc->q_GloEphSvMask;
  pDest->q_GloAlmSvMask                                  = pSrc->q_GloAlmSvMask;
  pDest->q_SBASEphSvMask                                 = pSrc->q_SBASEphSvMask;
  pDest->q_SBASAlmSvMask                                 = pSrc->q_SBASAlmSvMask;
  pDest->q_DelCellDBMask                                 = pSrc->q_DelCellDBMask;
  pDest->q_DeleteClockInfoMask                           = pSrc->q_DeleteClockInfoMask;
  pDest->q_Reserved                                      = pSrc->q_Reserved;  
}
                                                         ...
                                                         const gpsdiag_PaDelParamsTypeV2 *pSrc)
{
   ...
   if(pDest && pSrc)
   {
      ...
      {
          char b_Buffer[250];
          (void)snprintf(b_Buffer, sizeof(b_Buffer), "Input GPS Params: %llx\r\n",
                pSrc->q_DelParamsFlags);
          MSG_SPRINTF_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "%s", b_Buffer);
          
      }
      {
          char b_Buffer[250];
          (void)snprintf(b_Buffer, sizeof(b_Buffer), "Input GNSS Params: %llx\r\n",
                pSrc->q_GnssDelParamsFlags);
          MSG_SPRINTF_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "%s", b_Buffer);
          
      }  

      /* reset all flags to prevent spurious bit setting */
      pDest->pdsm_delete_parms_flags = 0; 
      pDest->pdsm_delete_parms_flags_ext = 0;
      pDest->q_delete_xtra_int_mask = 0;
      ...
      if(GPSDIAG_PA_DELETE_MB_DATA    & pSrc->q_DelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_MB_DATA;
      } 
          
      if(GPSDIAG_PA_DELETE_TGD_DATA_GPS    & pSrc->q_DelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TGD_DATA_GPS;
      }  
      if(GPSDIAG_PA_DELETE_TIME_GPS    & pSrc->q_DelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_TIME_GPS;
      } 
      if(GPSDIAG_PA_DELETE_XTRA_INTEGRITY_GPS    & pSrc->q_DelParamsFlags)
      {
         pDest->q_delete_xtra_int_mask |= PDSM_PA_DELETE_XTRA_INTEGRITY_GPS;
      }
      if(GPSDIAG_PA_DELETE_GNSS_SV_BLACKLIST_GPS   & pSrc->q_DelParamsFlags)
      {
      ...
      if(GNSSDIAG_PA_DELETE_HEALTH_GLO & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_HEALTH_GLO;
      }
      ...
      if(GNSSDIAG_PA_DELETE_TGD_DATA_GLO   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TGD_DATA_GLO;
      }
      if(GNSSDIAG_PA_DELETE_TIME_GLO   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_TIME_GLO;
      }
      if(GNSSDIAG_PA_DELETE_XTRA_INTEGRITY_GLO    & pSrc->q_GnssDelParamsFlags)
      {
         pDest->q_delete_xtra_int_mask |= PDSM_PA_DELETE_XTRA_INTEGRITY_GLO;
      } 
      ...
      if(GNSSDIAG_PA_DELETE_HEALTH_BDS & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_HEALTH_BDS;
      }
      ...
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_IONO_BDS;
      } 
      if(GNSSDIAG_PA_DELETE_TGD_DATA_BDS   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TGD_DATA_BDS;
      }
      if(GNSSDIAG_PA_DELETE_TIME_BDS   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_TIME_BDS;
      }
      if(GNSSDIAG_PA_DELETE_XTRA_INTEGRITY_BDS    & pSrc->q_GnssDelParamsFlags)
      {
         pDest->q_delete_xtra_int_mask |= PDSM_PA_DELETE_XTRA_INTEGRITY_BDS;
      } 
      ...
      if(GNSSDIAG_PA_DELETE_HEALTH_GAL & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_HEALTH_GAL;
      }
      ...
      if(GNSSDIAG_PA_DELETE_TGD_DATA_GAL   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TGD_DATA_GAL;
      }
      if(GNSSDIAG_PA_DELETE_TIME_GAL   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_TIME_GAL;
      }
      if(GNSSDIAG_PA_DELETE_IONO_GAL   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_IONO_GAL;
      }
      if(GNSSDIAG_PA_DELETE_XTRA_INTEGRITY_GAL    & pSrc->q_GnssDelParamsFlags)
      {
         pDest->q_delete_xtra_int_mask |= PDSM_PA_DELETE_XTRA_INTEGRITY_GAL;
      }
      ...
      if(GNSSDIAG_PA_DELETE_TGD_DATA_QZSS   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TGD_DATA_QZSS;
      }
      if(GNSSDIAG_PA_DELETE_HEALTH_QZSS   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags |= PDSM_PA_DELETE_HEALTH_QZSS;
      }
      if(GNSSDIAG_PA_DELETE_XTRA_INTEGRITY_QZSS    & pSrc->q_GnssDelParamsFlags)
      {
         pDest->q_delete_xtra_int_mask |= PDSM_PA_DELETE_XTRA_INTEGRITY_QZSS;
      } 
      ...
      /*              NAVIC Deletion AD Support                   */
      if(GNSSDIAG_PA_DELETE_GNSS_SV_BLACKLIST_NAV   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_GNSS_SV_BLACKLIST_NAVIC;
         pDest->navic_gnss_sv_blacklist_mask = CGPS_MAX_UINT16;
      }

      if(GNSSDIAG_PA_DELETE_EPH_NAV       & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_EPH_NAVIC;
         pDest->navic_eph_sv_mask            = CGPS_MAX_UINT16;
      }

      if(GNSSDIAG_PA_DELETE_ALM_NAV        & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_ALM_NAVIC;
         pDest->navic_alm_sv_mask            = CGPS_MAX_UINT16; 
      }

      if(GNSSDIAG_PA_DELETE_SVDIR_NAV      & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_SVDIR_NAVIC;
      }

      if(GNSSDIAG_PA_DELETE_SVSTEER_NAV    & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_SVSTEER_NAVIC;
      }

      if(GNSSDIAG_PA_DELETE_ALM_CORR_NAV   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_ALM_CORR_NAVIC;
      }

      if(GNSSDIAG_PA_DELETE_IONO_NAV   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_IONO_NAVIC;
      }
      if(GNSSDIAG_PA_DELETE_TGD_DATA_NAV   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TGD_DATA_NAVIC;
      }
      if(GNSSDIAG_PA_DELETE_HEALTH_NAV   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_HEALTH_NAVIC;
      }
      if(GNSSDIAG_PA_DELETE_TIME_NAV   & pSrc->q_GnssDelParamsFlags)
      {
         pDest->pdsm_delete_parms_flags_ext |= PDSM_PA_EXT_DELETE_TIME_NAVIC;
      }
      if(GNSSDIAG_PA_DELETE_XTRA_INTEGRITY_NAV & pSrc->q_GnssDelParamsFlags)
      {
         pDest->q_delete_xtra_int_mask |= PDSM_PA_DELETE_XTRA_INTEGRITY_NAVIC;
      }      
      ...
      {
        char b_Buffer[250];
        (void)snprintf(b_Buffer, sizeof(b_Buffer), "Output Params pDest->pdsm_delete_parms_flags 0x%llx \r\n", 
              pDest->pdsm_delete_parms_flags);
        MSG_SPRINTF_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "%s", b_Buffer);    
      }
     {
       char b_Buffer[250];
       (void)snprintf(b_Buffer, sizeof(b_Buffer), "Output Params pDest->pdsm_delete_parms_flags_ext: 0x%llx \r\n",              
             pDest->pdsm_delete_parms_flags_ext);
       MSG_SPRINTF_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "%s", b_Buffer);    
     }
...
PACKED void* gpsdiag_HandleExternalSPIInjection(PACKED void* p_PktReq, uint16 w_PktLength)
{
   ...
   do
   {
      ...
      if(!pdsm_pd_inject_external_spi(
                                     ...
                                     &z_xspi))
      {
         MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"failed injecting spi", 0, 0, 0);
   ...
   if(p_Resp == NULL)
   {
      MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"gpsdiag_HandleExternalSPIInjection: Rsp packet is NULL!!", 0, 0, 0);
   }
   else
   {
      p_Resp->z_DiagCmdHdr    = p_Req->z_DiagCmdHdr;
...
static PACKED void* gpsdiag_GeraTestCmd(gpsdiag_GeraTestCmdReqType* p_Req, uint16 w_PktLength)
{
   ...
   switch (p_Req->q_GeraTestCmd)
   {
      case GPSDIAG_GERA_TEST_CMD_CLIENT_REG:
      {           
        b_Resp = pdsm_gera_cmd_client_register(p_Req->q_GeraClientId);
        break;
      }      
      case GPSDIAG_GERA_TEST_CMD_CLIENT_DEREG:
      {
        b_Resp = pdsm_gera_cmd_client_deregister(p_Req->q_GeraClientId);
        break;
      }
      case GPSDIAG_GERA_TEST_CMD_CLIENT_ENABLE_REQ:
      {                
        b_Resp = pdsm_gera_cmd_client_enable_request(p_Req->q_GeraClientId, p_Req->q_DepClientMask);
        break;
      }
      case GPSDIAG_GERA_TEST_CMD_CLIENT_DISABLE_REQ:
      {           
        b_Resp = pdsm_gera_cmd_client_disable_request(p_Req->q_GeraClientId);
        break;
      }
      case GPSDIAG_GERA_TEST_CMD_CLIENT_DISABLED_INFO:
      {           
        b_Resp = pdsm_gera_cmd_client_disabled(p_Req->q_GeraClientId);
        break;
      }
      case GPSDIAG_GERA_TEST_CMD_RESET:
      {           
        b_Resp = pdsm_gera_cmd_reset();
        break;
      }
      case GPSDIAG_GERA_TEST_CMD_QUERY_STATE:
      {           
        b_Resp = pdsm_gera_cmd_client_query_state();
        break;
      }
...
{
   PACKED void* p_RspPkt = NULL;
   gpsdiag_DiagBufferTestCmdRespType* p_Resp;
   boolean b_Resp = FALSE;

   if (NULL == p_Req)
   {
      MSG(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "gpsdiag_GNSSDiagBufferTest - p_Req is NULL");
      return  p_RspPkt; 
   }

   switch (p_Req->q_GNSSDiagBufferTestCmd)
   {
      case GPSDIAG_DIAG_BUFFER_FLUSH_CMD:
      {           
        b_Resp = gnss_diag_buffer_handle_diag_command(
                     GPSDIAG_DIAG_BUFFER_FLUSH_CMD, 
                     p_Req->q_GNSSDiagBufferId);	
        break;
      }      
      default:
      {           
        MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, 
              "gpsdiag_GNSSDiagBufferTest - Unknown command %d", 
              p_Req->q_GNSSDiagBufferTestCmd);
        break;
      }      
   }
  ...
  p_RspPkt = diagpkt_subsys_alloc( (diagpkt_subsys_id_type)DIAG_SUBSYS_GPS,
                                    CGPS_DIAG_PDAPI_CMD,
                                    sizeof(gpsdiag_DiagBufferTestCmdRespType) );
  if (NULL != p_RspPkt)
  {
    p_Resp = (gpsdiag_DiagBufferTestCmdRespType*) p_RspPkt;
    p_Resp->z_DiagCmdHdr = p_Req->z_DiagCmdHdr;
    p_Resp->q_Status     = (uint32) b_Resp;
  }
  else
  {
    MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"gpsdiag_GNSSDiagBufferTest - response packet not allocated!", 0, 0, 0);
  }
   return p_RspPkt;

} /* end gpsdiag_GNSSDiagBufferTest() */
