...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/pd_comms/src/qmi_bit.c#1 $
  ...
  do
  {
         ...
         (GPSONE_BIT_HOST_NAME_AND_IP_ADDR == pz_ConnectParam->adr_type ) )
    {
      ...
      else /* GPSONE_BIT_IP_V6 */
      {
        ...
        (void) gps_Memcpy((void *)z_HostInfo.ipv6_addr,
                           sizeof(z_HostInfo.ipv6_addr),
         ...
         (GPSONE_BIT_HOST_NAME_AND_IP_ADDR == pz_ConnectParam->adr_type ) )
    {
      ...
      (void) gps_Memcpy((void *)z_HostInfo.url,
                         sizeof(z_HostInfo.url),
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  do
  {
    ...
    if ( q_Length > gps_Memcpy((void *) pz_ReqItem->z_Req.z_SendReq.payload,
                               BIT_CONST_PAYLOAD_LEN_MAX_V01,
                               (void*) pb_SendBuf,
                               q_Length) )
    {
  ...
  do
  {
    ...
    if ( pz_IncomingMsg->local_host_info_valid )
    {
      ...
      else if ( pz_IncomingMsg->local_host_info.validity_mask & BIT_MASK_IPV6_ADDR_AND_PORT_V01 )
      {
        ...
        (void) gps_Memcpy((void*)z_GpsEventPayload.arg.ipaddr.addr.v6_addr,
                          sizeof(z_GpsEventPayload.arg.ipaddr.addr.v6_addr),
