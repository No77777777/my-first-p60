...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/pd_comms/src/pd_comms_client_api.c#1 $$DateTime: 2019/10/24 01:30:36 $$Author: pwbldsvc $ 
  ...
  const pd_comms_notification_params_type * const p_params )
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR,"PDCOMM_APP: Invalid state %d notified to client",
...
pd_comms_return_type pd_comms_senddata_to_client(
  ...
  const uint32 q_transaction_id,
  /*To inform sub id, on which message is coming*/
