...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/pd_comms/pd_comms_tcp/src/pd_comms_tcp_data.h#2 $$DateTime: 2020/02/03 01:02:15 $$Author: pwbldsvc $ 
...
/* PDCOMM_TCP ULog Circular Buffer Size */
#define PDCOMM_TCP_ULOG_SIZE (1024)      /* Size of ULOG Buffer */
...
typedef struct
{
  ...
  boolean                       is_ppp_down;         /*Flag to see if PPP is down or not, It will be false when an ATL connection is open*/
...
typedef union
{
  ds_sys_ps_data_avail_type           ps_data_avail_type;
}pd_comms_tcp_task_ds_event_data_type;
...
typedef struct
{
  ds_sys_event_enum_type ds_event_name;
  pd_comms_tcp_task_ds_event_data_type ds_event; 
} pd_comms_tcp_task_ds_event_cb_ipc_hdr_type;
#endif /* ! FEATURE_NO_PS_DATA_OFF_SUPPORT */


/*********************************Global variables****************************/

#ifdef PDCOMM_TCP_DATA_DECLARE
  #define extern
...
/* PDCOMM_TCP ULog Handle */
extern OS_ULOG_HANDLE pdcomm_tcp_ULogHandle _INITIALIZE(0);
