...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/pd_comms/pd_comms_tcp/src/pd_comms_tcp_task_ssl.c#1 $
  ...
  pd_comms_handle_type z_handle)
{
  ...
  MSG_3(MSG_SSID_GPS, MSG_LEGACY_HIGH,"TLS version being used is 0x%x", z_ssl_params.ssl_version_pdata,0,0);
