...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/pd_comms/pd_comms_wms/src/pd_comms_wms_data.h#1 $
...
#define PDCOMM_APP_MSG_LOW( str, a, b, c )       MSG_3(MSG_SSID_GPS, MSG_LEGACY_LOW, "=PDCOMM APPLICATION= " str, a, b, c )
#define PDCOMM_APP_MSG_MED( str, a, b, c )       MSG_3(MSG_SSID_GPS, MSG_LEGACY_MED, "=PDCOMM APPLICATION= " str, a, b, c )
#define PDCOMM_APP_MSG_ERROR( str, a, b, c )     MSG_3(MSG_SSID_GPS, MSG_LEGACY_ERROR, "=PDCOMM APPLICATION= " str, a, b, c )
#define PDCOMM_APP_MSG_HIGH( str, a, b, c )      MSG_3(MSG_SSID_GPS, MSG_LEGACY_HIGH, "=PDCOMM APPLICATION= " str, a, b, c )
