...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/mgp/inc/mgp_api.h#10 $ $DateTime: 2022/01/20 03:10:55 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/02/16   mk      deprecate & replace mgp_ReceiverOn/Off/Idle/ForcedOff/ForcedIdle by mgp_ReceiverUpdate
...
#define MGP_NAV_DATA_REQ_MASK_EPHEM  (0x00000001)
#define MGP_NAV_DATA_REQ_MASK_SVPOLY (0x00000002)
#define MGP_NAV_DATA_REQ_MASK_IONO   (MGP_NAV_DATA_REQ_MASK_EPHEM)
...
/* Enumeration for MGP TimeEstPut Source */
/* On HI.1.0 PL and onwards (VTV4), GTS supports all WWAN, PMIC, N/W, XTRA time source handling. And Slow_clock source is 
 * replaced with GTS USTMR time source. Hence, the MGP time sources have been modified to remove deprecated sources, and add new ones 
 * supported by GTS. 
 * On VTV1 targets, GTS supports all WWAN time sources but MC supports PMIC, N/W, Slow_clock time sources.
 * In order to support older targets (VTV1) on the same code branch, we have a need for different enum definitions based on the 
 * target being compiled */
#ifndef FEATURE_GNSS_NAVHW_GEN9_VTV1

typedef enum
{
  C_MGP_TIME_EST_PUT_INVALID = 0,

  /* Time sources maintained by GTS; Some of these sources are injected to MGP/ME */
  C_MGP_TIME_EST_PUT_TIME_TRANSFER = 1,             /* GTS - GPS time from 1x Time-transfer - ad-hoc request */
  //C_MGP_TIME_EST_PUT_WCDMA_TIMETAG =2,            /* GTS_UNUSED - deprecated */
  //C_MGP_TIME_EST_PUT_GSM_TIMETAG = 3,             /* GTS_UNUSED - deprecated */
  //C_MGP_TIME_EST_PUT_WCDMA_SLEEP_TIMETAG = 4,     /* GTS UNUSED - deprecated */
  //C_MGP_TIME_EST_PUT_GSM_SLEEP_TIMETAG = 5,       /* GTS UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_EXTERNAL = 6,                  /* GTS - GPS time from external injection - XTRA or Network/reference time */
  //C_MGP_TIME_EST_PUT_SLOW_CLOCK = 7,              /* GTS UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_TIME_ALIGN = 8,                /* MGP Time align */
  C_MGP_TIME_EST_PUT_PATTERN_MATCH = 9,             /* MGP Pattern match */
  //C_MGP_TIME_EST_PUT_LTE_TIMETAG = 10,            /* GTS UNUSED - deprecated */
  //C_MGP_TIME_EST_PUT_LTE_SLEEP_TIMETAG = 11,      /* GTS UNUSED - deprecated */   
  C_MGP_TIME_EST_PUT_GTS_USTMR_TIME_TRANSFER = 12,  /* GTS - GPS time from periodic 1x time transfer - based on USTMR */
  C_MGP_TIME_EST_PUT_LTE_TIME_TRANSFER_SIB8 = 13,   /* GTS - GPS time from LTE time transfer - based on SIB8 */
  //C_MGP_TIME_EST_PUT_LTE_TIME_TRANSFER_LPP_FTA = 14,  /* GTS UNUSED - deprecated */
  //C_MGP_TIME_EST_PUT_TDSCDMA_TIMETAG = 15,            /* GTS UNUSED - deprecated */
  //C_MGP_TIME_EST_PUT_TDSCDMA_SLEEP_TIMETAG = 16,      /* GTS UNUSED - deprecated */  
  C_MGP_TIME_EST_PUT_GTS_LTE = 17,            /* GTS - GPS time based on periodic LTE timetag updates */
  C_MGP_TIME_EST_PUT_GTS_FEST = 18,           /* GTS - GPS time based on periodic XO freq. error/FUNC updates */
  C_MGP_TIME_EST_PUT_GTS_OTHER = 19,          /* GTS - GPS time from misc. sources */
  C_MGP_TIME_EST_PUT_GPS = 20,                /* MGP GPS SFT check time used for logging */
  //C_MGP_TIME_EST_PUT_CLK_INIT_FROM_SLOW_CLK = 21,/* GTS UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_GTS_GSM = 22,            /* GTS - GPS time based on periodic GSM timetag updates */
  C_MGP_TIME_EST_PUT_GTS_WCDMA = 23,          /* GTS - GPS time based on periodic WCDMA timetag updates */
  C_MGP_TIME_EST_PUT_GTS_TDSCDMA = 24,        /* GTS - GPS time based on periodic TDSCDMA timetag updates */ 
  C_MGP_TIME_EST_PUT_GTS_QTIME_CALIB = 25,    /* GTS - GPS time based on Qtimer/USTMR calibration */
  C_MGP_TIME_EST_PUT_GTS_PMIC = 26,           /* GTS - GPS time based on PMIC RTC propogation */
  C_MGP_TIME_EST_PUT_GTS_ME_PE_FIX = 27,      /* GTS - GPS time based on PE/ME clockput */
  C_MGP_TIME_EST_PUT_GTS_SV_DECODE = 28,      /* GTS - GPS time based on SV decode */
  C_MGP_TIME_EST_PUT_GTS_NR5G = 29,           /* GTS - GPS time based on periodic NR5G timetag updates */

  /* Time sources internally generated within MGP (ME/PE) */
  C_MGP_ME_TIME_EST_FIRST = 100,
  C_MGP_ME_TIME_EST_GPS_TOW_CONFIRMED = C_MGP_ME_TIME_EST_FIRST,  /* GPS TimeOfWeek decoded OTA */
  C_MGP_ME_TIME_EST_GPS_TOW_WEEK_CONFIRMED = 101,                 /* GPS Week number decoded OTA */
  C_MGP_ME_TIME_EST_GPS_OTA = 102,                                /* GPS OTA decoded time */
  C_MGP_ME_TIME_EST_GLO_OTA = 103,                                /* GLONASS OTSA decoded time */
  C_MGP_ME_TIME_EST_PE_CLK_REPORT = 104,                          /* PE GNSS clock put */
  C_MGP_ME_TIME_EST_PE_SOLVE_FOR_TIME = 105,                      /* PE Solve for Time */
  C_MGP_ME_TIME_EST_TIME_TRANSFORM = 106,                         /* ME time-transform */
  C_MGP_ME_TIME_EST_BDS_TOW_CONFIRMED = 107,                      /* BDS TimeOfWeek decoded OTA */
  C_MGP_ME_TIME_EST_BDS_TOW_WEEK_CONFIRMED = 108,                 /* BDS Week Number decoded OTA */
  C_MGP_ME_TIME_EST_BDS_OTA = 109,                                /* BDS OTA */
  C_MGP_ME_TIME_EST_QZSS_OTA = 110,                               /* QZSS OTA */
  C_MGP_ME_TIME_EST_GAL_TOW_CONFIRMED = 111,                      /* GAL TimeOfWeek decoded OTA */
  C_MGP_ME_TIME_EST_GAL_TOW_WEEK_CONFIRMED = 112,                 /* GAL Week decoded OTA */
  C_MGP_ME_TIME_EST_GAL_OTA = 113,                                /* GAL OTA decoded time */
  C_MGP_ME_TIME_EST_NAVIC_TOW_CONFIRMED = 114,                    /* NAVIC TimeOFWeek Decoded OTA */
  C_MGP_ME_TIME_EST_NAVIC_TOW_WEEK_CONFIRMED = 115,               /* Navic Week decoded OTA */
  C_MGP_ME_TIME_EST_NAVIC_OTA = 116,                              /* Navic OTA decoded time */

  C_MGP_TIME_EST_PUT_UNKNOWN = 255,
  C_MGP_TIME_EST_PUT_MAX = C_MGP_TIME_EST_PUT_UNKNOWN
} mgp_TimeEstPutSourceIDEnum;

#else //#ifndef FEATURE_GNSS_NAVHW_GEN9_VTV1

typedef enum
{
  C_MGP_TIME_EST_PUT_INVALID,
  C_MGP_TIME_EST_PUT_TIME_TRANSFER,           /* GTS - GPS time from 1x Time-transfer - ad-hoc request */
  C_MGP_TIME_EST_PUT_WCDMA_TIMETAG,           /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_GSM_TIMETAG,             /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_WCDMA_SLEEP_TIMETAG,     /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_GSM_SLEEP_TIMETAG,       /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_EXTERNAL,                /* MC_SLOW_CLK - GPS time from external injection - XTRA or Network/reference time */
  C_MGP_TIME_EST_PUT_SLOW_CLOCK,              /* MC_SLOW_CLK - slow clock based time */
  C_MGP_TIME_EST_PUT_TIME_ALIGN,              /* MGP Time align */
  C_MGP_TIME_EST_PUT_PATTERN_MATCH,           /* MGP Pattern match */
  C_MGP_TIME_EST_PUT_LTE_TIMETAG,             /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_LTE_SLEEP_TIMETAG,       /* GTS_UNUSED - deprecated */  
  C_MGP_TIME_EST_PUT_SCLK_TIME_TRANSFER,      /* GTS - slow clock based 1x time transfer */
  C_MGP_TIME_EST_PUT_GTS_USTMR_TIME_TRANSFER =  C_MGP_TIME_EST_PUT_SCLK_TIME_TRANSFER, /* GTS - unused on VTV1 targets */
  C_MGP_TIME_EST_PUT_LTE_TIME_TRANSFER_SIB8,  /* GTS - GPS time from LTE time transfer - based on SIB8 */
  C_MGP_TIME_EST_PUT_LTE_TIME_TRANSFER_LPP_FTA, /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_TDSCDMA_TIMETAG,         /* GTS_UNUSED - deprecated */
  C_MGP_TIME_EST_PUT_TDSCDMA_SLEEP_TIMETAG,   /* GTS_UNUSED - deprecated */   
  C_MGP_TIME_EST_PUT_GTS_LTE,                 /* GTS - GPS time based on periodic LTE timetag updates */
  C_MGP_TIME_EST_PUT_GTS_FEST,                /* GTS - GPS time based on periodic XO freq. error/FUNC updates */
  C_MGP_TIME_EST_PUT_GTS_OTHER,               /* GTS - GPS time from misc. sources */
  C_MGP_TIME_EST_PUT_GPS,                     /* MGP GPS time */
  C_MGP_TIME_EST_PUT_CLK_INIT_FROM_SLOW_CLK,  /* MC_SLOW_CLK - clock INIT from slow clock */  
  C_MGP_TIME_EST_PUT_GTS_GSM,                 /* GTS - GPS time based on periodic GSM timetag updates */  
  C_MGP_TIME_EST_PUT_GTS_WCDMA,               /* GTS - GPS time based on periodic WCDMA timetag updates */
  C_MGP_TIME_EST_PUT_GTS_TDSCDMA,             /* GTS - GPS time based on periodic TDSCDMA timetag updates */ 
  C_MGP_TIME_EST_PUT_GTS_QTIME_CALIB,         /* GTS - GPS time based on Qtimer/USTMR calibration */
  C_MGP_TIME_EST_PUT_GTS_PMIC,           /* GTS - unused on VTV1 targets */
  C_MGP_TIME_EST_PUT_GTS_ME_PE_FIX,      /* GTS - unused on VTV1 targets */
  C_MGP_TIME_EST_PUT_GTS_SV_DECODE,      /* GTS - unused on VTV1 targets */
  C_MGP_TIME_EST_PUT_GTS_NR5G,           /* GTS - unused on VTV1 targets */
  C_MGP_TIME_EST_PUT_MAX
} mgp_TimeEstPutSourceIDEnum;

#endif //#ifndef FEATURE_GNSS_NAVHW_GEN9_VTV1

typedef uint8 mgp_TimeEstPutSourceIDEnumVal;
...
/* Set bit means DPO is not allowed. Auto DPO engage if 0 */
#define C_POWER_MODE_CONFIG_FORCE_DISABLE_DPO     (1<<0) 

/* Set bit means Force Engage L5. Auto Engage if 0 */
#define C_POWER_MODE_CONFIG_FORCE_ENGAGE_L5       (1<<1) 
/*************************************************************************/
...
typedef struct
{
  ...
  uint8                       u_MeasRptPeriod; /* Measurement report period in units of GPS_MEAS_TICK */
  ...
  uint32                      q_PowerModeConfig; /* Config for Power Mode Control */
  uint32                      q_FirstFixQoSThreshold; /* Accuracy threshold for first fix in meters */
  boolean                     v_DynamicHepeCheckDisabled; /* TRUE, if Dynamic HEPE check is disabled in SM */
...
typedef enum
{
  ...
  MGP_LPPM_SUBCONFIG_FOREGROUND_FIXED_TIME  = 2, /* M2: foreground fixed-time LPPM subconfig */
  MGP_LPPM_SUBCONFIG_BACKGROUND_FIXED_POWER = 3, /* M3: background defined power subconfig */
  MGP_LPPM_SUBCONFIG_BACKGROUND_FIXED_TIME  = 4, /* M4: background defined time subconfig */
  MGP_LPPM_SUBCONFIG_BACKGROUND_KEEP_WARM   = 5, /* M5: background keep warm subconfig */

  MGP_LPPM_SUBCONFIG_MAX = MGP_LPPM_SUBCONFIG_BACKGROUND_KEEP_WARM,
  MGP_LPPM_SUBCONFIG_FORCE_32BIT = 2147483647 /* Force 32bit */
} mgp_LppmSubConfigEnumType;

/* MGP bootup cal state*/
typedef enum
{
  C_MGP_BOOTUP_CAL_NOT_STARTED,
  C_MGP_BOOTUP_CAL_IN_PROG,
  C_MGP_BOOTUP_CAL_SUCCESS,
  C_MGP_BOOTUP_CAL_FAILURE,
  C_MGP_BOOTUP_CAL_NOT_ABLE_TO_RUN
} mgp_BootupCalStateEnumType;

/* MGP LPPM configuration structure */
typedef struct
{
  /* LPPM sub-config mode, see mgp_LppmSubConfigEnumType */
  uint32    e_LppmSubMode;

  union { /* union for future API extension */
    /* maximum time-between-measurements input for background power-modes */
    uint32  q_TbmMsec;
  } z_LppmParam;
...
typedef enum
{
  ...
  COLLECT_MODE_WBIQ_GAL_E5B,
  COLLECT_MODE_WBIQ_NAVIC,
  COLLECT_MODE_MBIQ_GPS_L1_GAL_E1, /* 32-bit mask boundary */
  COLLECT_MODE_MAX
...
/* Bit fields of u_CmdControlFlag (mgp_api.h). Part of Presc dwell DM cmd. */
#define C_PRESC_DWELL_CMD_FLAG_ENABLE_GPS           0x1
#define C_PRESC_DWELL_CMD_FLAG_ENABLE_GLO           0x2
#define C_PRESC_DWELL_CMD_FLAG_ENABLE_BDS           0x4
#define C_PRESC_DWELL_CMD_FLAG_ENABLE_GAL           0x8
#define C_PRESC_DWELL_CMD_FLAG_ENABLE_NAVIC         0x10
...
typedef struct
{
  ...
  uint8   u_NavicSv;                   /* NAVIC SV id */
  int32   l_NavicDoppMps;              /* Doppler in m/s */
  int32   l_NavicDoppWinHz;            /* Doppler window in Hertz */
  uint32  q_NavicCpCenterCx40;         /* Code phase center in chipx40 */
  uint32  q_NavicCodeWinSizeChipx1;    /* Code window size in chipx1 */
  uint8   u_NavicSrchMode;             /* Search mode */
  uint16  w_NavicNumPostD;             /* Number of PostD */
  uint8   u_NavicPfa;                  /* PFA number */
  uint32  q_NavicReserved;             /* Not really needed, but maintain it similar to GPS/GLO */

} mgp_PrescDwellCmd;

/**
* The scan mode usage for versions 1 to 4 is different from version 5. Please 
* see below and change jobs_enabled accordingly.
*
* For Versions 1 to 4:
* bit0 - Fast scan
* bit1 - Deep scan
...
typedef struct
{
  ...
  uint8   u_GpsJobsEnabled;  /* Bit mask for the GPS Scan types enabled. Varies depending on version - see above*/
  uint8   u_GloJobsEnabled;  /* Bit mask for the GLO Scan types enabled. Varies depending on version - see above*/
  ...
  uint8   u_BdsJobsEnabled;  /* Bit mask for the BDS Scan types enabled. Varies depending on version - see above*/
  uint8   u_GalJobsEnabled;  /* Bit mask for the GAL scan types enabled. Varies depending on version - see above*/ 
  uint8   u_GpsL5JobsEnabled;  /* Bit mask for the GPS L5 scan types enabled.*/ 
  uint8   u_NavicJobsEnabled;  /* Bit mask for the Navic scan types enabled. */ 
  uint8   u_GalE5bJobsEnabled;  /* Bit mask for the GAL E5B scan types enabled. */
...
/**RF stats version needs to be reved to version 6 for BP5 bp amp addition. 
  Until QXDM support is available hold onto version 5*/
//#define GNSS_RF_STATUS_LOG_VER 6 /**< 0x147E RF Status log version */
#ifdef FEATURE_GNSS_NAVHW_GEN9_VTV1
#define GNSS_RF_STATUS_LOG_VER 4 /**< 0x147E RF Status log version */
#else
...
typedef PACKED struct PACKED_POST
{
  ...
  uint32  q_Bp4AmpI; /**< BP4  amplitude I */
  uint32  q_Bp4AmpQ; /**< BP4 amplitude Q */
  int32   l_Bp4PwrDb; /**< BP4 power in units of dB */

  /**Version 6 addition */
  #if 0
  /* Baseband Processor 5 (BP5) status */
  char    u_Bp5Mode[GNSS_RF_BP_MODE_MAX_STR_LEN]; /**< BP5 Mode */
  uint32  q_Bp5AmpI; /**< BP5  amplitude I */
  uint32  q_Bp5AmpQ; /**< BP5  amplitude Q */
  int32   l_Bp5PwrDb; /**< BP5 power in units of dB */
  #endif
...
typedef struct
{
  uint32 q_GnssDesiredConfig;    /* flags containing constellations 
                                   desired, uses the 
                                   C_RCVR_GNSS_CONFIG_XXX defines */
  uint32 q_GnssSupportedConfig; /* flags containing constellations 
                                  supported by HW, uses the 
                                  C_RCVR_GNSS_CONFIG_XXX defines */
  uint32 q_GnssActualConfig;    /* flags containing constellations 
...
/* Structure returned to the caller of mgp_GetMECompleteActiveCfg API */
typedef struct
{
  boolean b_IsValid;             /* This flag is set to false when RCVR is off */
  uint32 q_MECompleteActiveCfg;  /* Complete active config bitmask in ME based on 
                         desired-config, HW support, memory, worldwide enablement */
} mgp_GetMECompleteActiveCfgType;

/* MGP ME Multiband configuration type returned to SM - this provides the 
   combined NV+external api multiband configuration maintained in ME. Since 
   new api setting can't take place during an active receiver session, api 
   settings will reflect in this only if receiver was turned off or next 
   receiver session was started */
typedef struct
{
  uint32 q_MEMultibandCfg;  /* Bit-mask of multiband GNSS enabled as defined in 
                               gnss_common.h. Example 
                               C_RCVR_GNSS_CONFIG_L5_ENABLED|
                               C_RCVR_GNSS_CONFIG_E5A_ENABLED */
} mgp_GetMEMultibandCfgType;
...
typedef enum
{
  MGP_GNSS_SV_HEALTH_COMBINED = 0, /* combined health */
  MGP_GNSS_SV_HEALTH_ALM, /* almanac health */
} mgp_GnssHealthTypeVal;
typedef uint8 mgp_GnssHealthType;
...
/* GNSS Constellation Control Parameters */
typedef struct
{
  gnss_ConstCmdType e_Cmd;
  boolean           v_success_state;
  uint32            q_GnssEnableMask;
...
} mgp_GnssConstelStatusType;


/* Structure for Multiband Configuration Parameters */ 
typedef struct 
{ 
  uint8 u_EnableMultiband;      /* True: Enables GNSS Multiband Mode; Multiband mode will engage under suitable conditions 
                                   False: Disables GNSS Multiband mode */ 
  uint8 u_ForceEnableMultiband; /* Valid only if u_EnableMultiband is set to TRUE; 
                                    TRUE: Force enables Multiband mode throughout GNSS operation, irrespective of signal conditions
                                    FALSE: Disables Forced Multiband mode */ 
}mgp_MultibandConfigApiType;
 ...
 * ******************************************************************************
*/
void mgp_ReceiverLPPMQuery(const mgp_LppmConfigStructType *pz_LppmConfig);
...
/*
 ******************************************************************************
 * mgp_PfaTestRequested
 *
 * Function description:
 *
 *  This function notifies MC Jobmanager that TM would like to receive
 *  presribed dwell results, for the PFA test.
 *
 * Parameters:
 *
 *  boolean - PFA test requested or no.
 *
 * Return value:
 *
 *  void
 ...
 ******************************************************************************
*/
void mgp_PfaTestRequested(boolean v_PfaTestRequested);
 ...
 *
 * Parameters: 
 *  e_BandType - GNSS band Type (L1, L2, G1, G2, etc.)
...
void mgp_GnssDisableBitEdgeDetection(mgp_GnssSigTypeEnumVal  e_BandType, uint8 u_CohPDI, uint8 u_Disable);
...
/*
 ******************************************************************************
 * Function mgp_MinGnssWeekNumberGet
 *
 * Description:
 *
 *  Retrieves the Minimum Week Number for GPS/BDS/NAVIC based on GPS Min Week setting
 *
 * Parameters:
 *
 *   Pointer to output variable
 ...
 ******************************************************************************
*/
void mgp_MinGnssWeekNumberGet(uint16 *p_MinGpsWeekNumber, mgp_GnssType e_GnssType);


/*
 ******************************************************************************
 * Function mgp_DpoNvControlGet
 *
 * Description:
 *
...
#ifdef FEATURE_GNSS_PDS
#error code not present
#endif /* FEATURE_GNSS_PDS */
...
typedef enum
{
  C_MGP_FIX_START_IND,
  C_MGP_FIX_END_IND,
  C_MGP_TRIGGER_TAUC_LEAPSEC_REPORT,
...
*  C_RCVR_GNSS_CONFIG_GAL_ENABLED_WORLDWIDE     (1<<5)  Deprecated
*  #define C_RCVR_GNSS_CONFIG_QZSS_ENABLED_WORLDWIDE     (1<<6)
...
******************************************************************************
*/
void mgp_GetActiveGnssRcvrConfiguration(uint32 *pq_CfgMask);

/*
******************************************************************************
* mgp_GetMECompleteActiveCfg
*
* Function description:
*  This API returns the current GNSS receiver active configuration, this accounts for
*  memory allocation, HW support, worldwide enablement.
*
*  Active Receiver GNSS configuration bit mask.
*  #define C_RCVR_GNSS_CONFIG_GPS_ENABLED                (1<<0)
*  #define C_RCVR_GNSS_CONFIG_GLO_ENABLED                (1<<1)
...
*
* Parameters:
*  p_GetMECompleteActiveCfg - [OUT] Pointer to structure that includes validity flag and
...
******************************************************************************
*/
void mgp_GetMECompleteActiveCfg(mgp_GetMECompleteActiveCfgType *p_GetMECompleteActiveCfg);

/*
******************************************************************************
* mgp_GetHwSupportedRcvrConfiguration
*
* Function description:
*
...
*  C_RCVR_GNSS_CONFIG_GAL_ENABLED_OUTSIDE_OF_US (1<<3)  Deprecated
*  #define C_RCVR_GNSS_CONFIG_BDS_ENABLED_WORLDWIDE      (1<<4)
*  C_RCVR_GNSS_CONFIG_GAL_ENABLED_WORLDWIDE     (1<<5)  Deprecated
*  #define C_RCVR_GNSS_CONFIG_QZSS_ENABLED_WORLDWIDE     (1<<6)
...
******************************************************************************
*/
void mgp_GetHwSupportedRcvrConfiguration(uint32 *pq_CfgMask);
...
/*
 ******************************************************************************
 * Function mgp_GetXOTimeTickDiffMs
 *
 * Description:
 *
...
/*
******************************************************************************
* mgp_RequestCalibrationState
*
* Function description:
*  Requests device's current calibration state
*
* Parameters:
*   None
*
* Return value: 
*   TRUE - IPC to request calibration state sent successfully to MC. FALSE otherwise
********************************************************************************
*/
boolean mgp_RequestCalibrationState(void);

/*
******************************************************************************
* mgp_SendOfflineCxmTestRequest
*
* Function description:
 ...
 ******************************************************************************
 * 
 *  mgp_ConfigExtTimeTransferMode
 *
 * Description:
 *  This function send message to MGP module to configures the GNSS state
 *  for external time sync. The message will be sent to PE which will
 *  suspend SAP-LPM operation, if ongoing, put ME in a known state, and then
 *  forward the message to ME module for time sync.
 *
 *
 * Parameters:
 *       u_EnableFlag - TRUE to enable. FALSE to disable.   
 *
 * Return value: 
...
/* 
 ******************************************************************************
 *  mgp_ApMpConfigDebugMode
 *
 * Description:
 *  This function configures debug mode of APMP time transfer  
 *
 * Parameters:
 *     Flag to enter/exit debug mode  
 *
 * Return value: 
 *     None
 ******************************************************************************
*/
void mgp_ApMpConfigDebugMode(const uint8 u_EnableFlag);
 ...
 *
 * Description:
 *  This function triggers debug ISR  
 *
 * Parameters:
 *     None
 *
 ...
 ******************************************************************************
*/
void mgp_ApMpDebugIsr(void);

/*
******************************************************************************
* mgp_UpdateUax3Config
*
* Function description:
...
FUNCTION
  mgp_CheckNavContinueDuringE911
...
/*
 ******************************************************************************
 * mgp_SensorLEGetRelDisplacement
 *
 * Function description:
 *
...
/*===========================================================================
FUNCTION mgp_IsGloEnabledInNv
DESCRIPTION
  This function reads NV item GNSS Config (70326) and returns TRUE if GLO is enabled

RETURN VALUE
  GNSS GLO enablement status

===========================================================================*/
boolean mgp_IsGloEnabledInNv(void);

/*
 ******************************************************************************
 * mgp_GpsMcFsTaskNotification
 *
 * Function description:
 *
...
/*
 ******************************************************************************
 * mgp_SetClearGnssPersistentBlacklist
 *
 * Function description:
 *
 * This function is used by SM to inject persistent blacklist mask to PE.
 *
 * Parameters: pz_dMask: pointer to SVs mask  
 *
 * Return value:  void
 *
 * ******************************************************************************
*/
void mgp_SetClearGnssPersistentBlacklist(const gnss_SvIdMaskStructType *pz_SetMask,
                                         const gnss_SvIdMaskStructType *pz_ClearMask);
 ...
 * Function description:
 *
 * This function is used by SM to Get persistent blacklist mask from PE for all
 * constellations.
 *
 * Parameters: none
 *
 ...
 * ******************************************************************************
*/
void mgp_GetGnssPersistentBlacklist(void);
...
/*
******************************************************************************
* mgp_GnssInfoReportControl
*
* Function description:
*  This function controls the enable/disablement of GNSS info report from PE and ME to SM.
*
* Parameters:
*  t_GnssInfoReportControl - Report control bitmask.
* 
* Return value:
*  None
*
******************************************************************************
*/
void mgp_GnssInfoReportControl(pdsm_GnssReportingConfig t_GnssInfoReportControl);
...
/*
 ******************************************************************************
 * mgp_ConstellationControlSet
 *
 * Function description:
 *
 *    This function sends constellation control Set to PE.
 *
 * Parameters:
 *
 *  pz_ConstelData - points to the requested constellations data
 *  (input)
 *
 * Return value:
 *
 ...
 * ******************************************************************************
*/
void mgp_ConstellationControlSet(const gnss_ConstellationConfigT *pz_ConstelData);
 ...
 * Function description:
 *
 *    This function sends constellation control get to PE.
 *
 * Parameters:
 *
 * Return value:
 ...
 * ******************************************************************************
*/
void mgp_ConstellationControlGet();
...
/*
 ******************************************************************************
 * mgp_ImmediateAssistReqStatusPut
 *
 * Function description:
 *
 * This function sends immediate assistance status from SM .
 *    
 * Parameters: 
 *    w_ImdAssistReqUpdateRate - immediate assistance request ephemeris update rate .
 *    see C_GNSS_IMMEDIATE_ASSISTANCE_REQ...
 *
 * Return value: 
 *
 *  void
 ...
 * ******************************************************************************
*/
void mgp_ImmediateAssistReqStatusPut( const uint16 w_ImdAssistReqUpdateRate );
...
DESCRIPTION
  This functions provides an interface to specify the Multiband Configuration
  for the GNSS engine by an external application.
  The configuration will override the NV settings of NVs 70455 and 74137 and
  other internal settings.
  The Api can be called at anytime and its value will be stored in the GNSS
  engine. The new configuration will take effect whenever a new GNSS receiver
  session is started after the configuration api has been called (Receiver
  needs to move from Off->On).
  The settings will remain in effect until modem shutdown unless new
  configuration is again set by this api prior to a GNSS receiver session.
  The settings will be written to the NV 70455 and 74137 at the graceful
  shutdown process of Modem.
 
  This api configures following Multiband GNSS : GPS L5, QZSS L5, GAL E5.
  GPS L5 is enabled by default if this api is used to enable Multiband
  QZSS L5 is enabled if QZSS L1 is enabled via GNSS configuration NV 70326 or HLOS
  GAL E5 is enabled if GAL E1 is enabled via GNSS configuration NV 70326 or HLOS

PARAMETERS
  *p_MultiBandConfig   -  [IN] Pointer to Multiband Configuration structure

RETURN VALUE
    returns TRUE: If new configuration was sent to MGP successfully
            FALSE: Otherwise
============================================================================*/
boolean mgp_MultibandConfig
( 
  const mgp_MultibandConfigApiType *p_MultiBandConfig
);


/*============================================================================
FUNCTION 
  mgp_MultibandTISTestConfig
   
DESCRIPTION
  This functions provides an interface to enable GNSS engine in Multiband TIS
  test mode.
  The Api can be called at anytime and its value will be stored in the GNSS
  engine. The new Configuration will take effect at the start of the next GNSS
  receiver session. The Receiver needs to move from OFF to ON after
  configuration api is called. The configuration sticks until Modem shutdown.
  The value of NV 74180 will be written back to NV memory at Modem graceful
  shutdown.
                 
PARAMETERS
  u_EnableTisTest Mode   -  [IN] TRUE: Enable TIS test mode
                            FALSE: Disable TIS test mode

RETURN VALUE
    returns TRUE: If new configuration was sent to MGP successfully
            FALSE: Otherwise
============================================================================*/
boolean mgp_MultibandTISTestConfig
( 
  uint8 u_EnableTISTestMode
);

/*============================================================================
FUNCTION 
  mgp_GetMEMultibandEnabledCfg
   
DESCRIPTION
  This function returns the ME Multiband Configuration that combines the NV
  and external api settings. 
  If a receiver session has already started, any new settings from an external api
  will be consolidated when receiver is off before next receiver session.
  So, SM needs to read this value before starting the next receiver session.
                 
PARAMETERS
  None

RETURN VALUE
  TRUE - Multiband enabled 
  FALSE - Multiband disabled
============================================================================*/
boolean mgp_GetMEMultibandEnabledCfg(void);

/*===========================================================================
  FUNCTION      mgp_NavDataReq()

  DESCRIPTION
    This API queries for Nav data (Ephemeris and SV polynomial
    from PE. This request will be honored during GNSS engine transition from
    IDLE to On onle when CaaS feature is enabled.
 

  DEPENDENCIES  

  PARAMETERS
    q_NavDataMask - mask for reuested data 
    (input)         MGP_NAV_DATA_REQ_MASK_EPHEM
                    MGP_NAV_DATA_REQ_MASK_SVPOLY
...
=============================================================================*/
void mgp_NavDataReq(uint32  q_NavDataMask);

/*============================================================================
  FUNCTION 
    mgp_GetMEMultibandCfg
  ...
  RETURN VALUE
    multibandconfig
============================================================================*/
uint32 mgp_GetMEMultibandCfg(void);

/*============================================================================
  FUNCTION 
    mgp_TimeScaleTransform
       
  DESCRIPTION
    This function does a time transform from one GNSS type to another
                     
  PARAMETERS
    p_SrcTime: Pointer to the source GNSS time info
	p_DestTime: Pointer to the destination GNSS time info
	e_SrcGnssType: GNSS type of the source time info
	e_DestGnssType: GNSS type to which the source time info needs to be converted to
    
  RETURN VALUE
    None
============================================================================*/
void mgp_TimeScaleTransform(gnss_TimeFormatType *p_SrcTime, 
                             gnss_TimeFormatType *p_DestTime, 
                             mgp_GnssType e_SrcGnssType, 
                             mgp_GnssType e_DestGnssType);

/*============================================================================
  FUNCTION 
    mgp_GetPrimaryConstellationForTime
    
  DESCRIPTION
    This function returns the primary constellation for time maintenance. 
    The decision is made based on the device type NV
  ...
  RETURN VALUE
    multibandconfig
============================================================================*/
mgp_GnssType mgp_GetPrimaryConstellationForTime();

/*===========================================================================
FUNCTION mgp_NvEfsReadGnssMultibandConfig
DESCRIPTION
  This function reads NV item GNSS Multiband Configuration

RETURN VALUE
  GNSS Config (bit-mask)

===========================================================================*/
uint32 mgp_NvEfsReadGnssMultibandConfig(void);

/* ============================================================================
**  Function : mgp_SetGnssMultibandActivate
** ============================================================================
*/
/*!
    @brief
    Sends the Gnss Multiband activate command to MGP
    
    @param  u_MultibandActivate - TRUE if Multiband has to be activated
                                 FALSE if Multiband has to be deactivated
    
    @retval returns TRUE if command was converted to IPC to ME/MC task; FALSE otherwise
*/
uint8 mgp_SetGnssMultibandActivate(uint8 u_MultibandActivate);

/* ============================================================================
**  Function : mgp_GetGnssMultibandActivate
** ============================================================================
*/
/*!
    @brief
    Reads the GNSS Multiband activate command status from MGP ME
    
   @param  None
    
    @retval returns TRUE if Multiband activate command status was set to TRUE in ME;
                    FALSE otherwise
*/
uint8 mgp_GetGnssMultibandActivate(void);

/*===========================================================================
FUNCTION mgp_GetBootupCalStatus 
 
 
DESCRIPTION
  This function is used to get bootup cal status

RETURN VALUE
  Bootup cal enum
 
===========================================================================*/
mgp_BootupCalStateEnumType mgp_GetBootupCalStatus(void);

/*
 ******************************************************************************
 * mgp_LocEngGetMagCalibrationState
 *
 * Function description:
 *
 * This function is called to send request to MGP to get the magnetometer
 * calibration status.
 *    
 * Parameters: 
 *
 ...
 * ******************************************************************************
*/
void mgp_LocEngGetMagCalibrationState(void);
