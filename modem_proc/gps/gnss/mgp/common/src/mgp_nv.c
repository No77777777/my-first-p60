...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/mgp/common/src/mgp_nv.c#2 $
  $DateTime: 2020/03/31 17:09:44 $
  $Author: pwbldsvc $
...
static boolean mgp_nv_read_default (nv_items_enum_type nv_item, const void *item_ptr)
{
  ...
  switch (nv_item)
  {
    ...
    case NV_GPS1_GPS_RF_LOSS_I:
      ((nv_item_type*)item_ptr)->gps1_gps_rf_loss = 0; //byte
      break;
...
//Ranjan_HACK_Aries5.0Merge
    ...
    case NV_GNSS_GLO_PATH_LOSS_CENTER_0_I:
      /* Default value: ENABLED */
      ((nv_item_type*)item_ptr)->gnss_glo_path_loss_center_0 = 0; 
      break;

    case NV_GNSS_GLO_PATH_LOSS_CENTER_MINUS7_I:
      /* Default value: ENABLED */
      ((nv_item_type*)item_ptr)->gnss_glo_path_loss_center_minus7 = 0; 
      break;

    case NV_GNSS_GLO_PATH_LOSS_CENTER_PLUS6_I:
      /* Default value: ENABLED */
      ((nv_item_type*)item_ptr)->gnss_glo_path_loss_center_plus6 = 0; 
      break;
