...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/samlite/inc/saml_api.h#1 $
...
@param e_PdrControlFlag: PDR control config   
...
/**
@brief  Send GNSS state change notification.

Called from SM/LM to indicate a change of GNSS state.
 - v_EngineOn: TRUE if GNSS engine On, FALSE otherwise 

@return eSAML_SUCCESS if request was sent successfully. Otherwise SAMLite error code.
*/
saml_ErrorEnumT saml_GnssStateChangeNotification(boolean v_EngineOn);

/**
@brief Sets the sensor streaming configuration according to the test mode.
       This function writes these settings into the NV .

@param pq_TestMode: The type of the test mode . 
@return TRUE on success. FALSE otherwise
*/
boolean saml_SetSensorStreamTestModeConfig(uint32 *pq_TestMode);
