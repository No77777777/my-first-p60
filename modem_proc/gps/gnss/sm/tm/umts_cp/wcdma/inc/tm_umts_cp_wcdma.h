...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/umts_cp/wcdma/inc/tm_umts_cp_wcdma.h#1 $
...
typedef struct
{
  ...
  sm_NavPositionStructType *pz_CacheLrNavPos; /* Store the full position information */
