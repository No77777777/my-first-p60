...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/umts_cp/gsm/src/tm_umts_cp_gsm.c#1 $
  ...
  03/15/18   py      Validate as_id by checking it is in valid range
  09/25/17   rk      Stop early GSM session when E911 call end received.
   ...
   )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: Unable to create timer", 0, 0, 0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: Unable to create E911 timer", 0, 0, 0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: Unable to AccuracyReset timer", 0, 0, 0);
  }
   ...
   )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "GSM-CP: session_init", 0, 0, 0);
   ...
   )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: Invalid PDAPI operation mode", 0, 0, 0);
    return FALSE;
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: inform_core_nt_assist_end", 0, 0, 0);
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Sv Alm/Eph Info for MGP; handle=%d, alm=0x%lx; eph=0x%lx",
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "GSM-CP: nt_assist_failure", 0, 0, 0);
...
void tm_umts_cp_gsm_cancel_cf_timer(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Cancel cf timer", 0, 0, 0);
}
...
void tm_umts_cp_gsm_start_max_mgp_on_timer(uint32  q_time_ms)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Start max. MGP_ON timer; t=%d", q_time_ms, 0, 0);
}
...
void tm_umts_cp_gsm_cancel_max_mgp_on_timer(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Cancel max. MGP_ON timer", 0, 0, 0);
}
...
void tm_umts_cp_gsm_start_acc_reset_timer(uint32  q_time_ms)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Start AccuracyReset timer; t=%d", q_time_ms, 0, 0);
}
...
void tm_umts_cp_gsm_cancel_acc_reset_timer(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Cancel AccuracyReset timer", 0, 0, 0);
}
   ...
   )
{
      ...
      (e_new_cf_state == C_UMTS_CP_GSM_CF_STATE_TIMER_RRLP_MEAS_RESP_TIME))
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: set_cf_state; cf state=%u, t=%d",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: set_cf_state; cf state=%u", (uint8)e_new_cf_state, 0, 0);
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: callflow_disrupt_handler()", 0, 0, 0);
   ...
   )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: lcs_molr_conf_proc", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,  "CP-GSM: lcs_molr_conf rejected; k=%d",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Received LCS_MOLR_INFO", 0, 0, 0);
    ...
    if (!p_session_status->u_pdapi_fix_reported)
    {
      ...
      if (p_data != NULL)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: MOLR_RES LocEst received", 0, 0, 0);
...
(
   sm_FixInfoStructType *lr_data_ptr
   )
{
  pdsm_pd_info_s_type                       *p_pd_info_buffer;
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: handle_lr_data() called", 0, 0, 0);

  if (z_umts_cp_gsm_session_status.u_pdapi_fix_reported)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: pdapi fix already reported", 0, 0, 0);
  ...
  if (p_lr_resp != NULL)
  {
    ...
    if (ok)
    {
      ...
      z_tm_ext_pd_data.t_dop = p_NavPos->f_TDOP;
      z_tm_ext_pd_data.g_dop = p_NavPos->f_GDOP;
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: send pos. to RRLP", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: NI LR Received", 0, 0, 0);
    ...
    if (lr_data_ptr->z_NavPos.z_PosFlags.b_Is3D)
    {
       ...
       */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Caching Position", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: UI LR Received", 0, 0, 0);
   ...
   )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: handle_sess_info_status; WL=0x%08X; Rcvd=0x%08X",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Override WL.  New WL=0x%08X; Old WL=0x%08X",
          q_WishListMask,
          q_OriginalWishListMask,
          0);
  }
  ...
  if (q_WishListMask)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Sending MOLR-Invoke; WL=0x%lx", q_WishListMask, 0, 0);
    ...
    else
    {
      ...
      if (p_assist->q_WishListMask != 0) /* if it still has something to request */
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Requesting additional WL=0x%lx", p_assist->q_WishListMask, 0, 0);
  ...
  if (q_WishListMask == 0)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Final wishlist empty", 0, 0, 0);
   ...
   )
{
  ...
  if ((stop_reason != TM_STOP_REASON_COMPLETED) &&
      (z_umts_cp_gsm_session_status.v_send_no_more_location_notifications) &&
      (C_UMTS_CP_GSM_SESSION_NI == z_umts_cp_gsm_session_status.e_callflow_kind))
  { 
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Stop TmCore session", 0, 0, 0);
   ...
   )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: handle_lcs_event() called; s=%d; ev=%d",
  ...
  switch (p_event->lcs_event)
  {
    ...
    case PRTL_LCS_EVENT_TYPE_CLINET_RELEASE:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Unhandled LCS Event", 0, 0, 0);
      break;

    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Invalid LCS Event", 0, 0, 0);
      break;
  }
}
   ...
   )
{
  ...
  if (NULL == p_event)
  {
    MSG(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "NULL Pointer in phone event");
    return;
  }

  MSG_2(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: handle_phone_event() called; s=%d; ev=%d",
        cf_state, p_event->event);
  ...
  switch (p_event->event)
  {
    case TM_PHONE_EVENT_E911_CALL_ORIG:
      ...
      if ((CGPS_SRV_SYS_GSM == p_event->payload.emerg_call_info.emerg_call_sys_mode) &&
          TM_CONFIG_POS_MODE_BIT_IS_SET(PDSM_POS_MODE_2G_CP_MS_BASED))
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Handle E911_CALL_ORIG", 0, 0, 0);
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Not in GSM mode. Ignore E911_CALL_ORIG", 0, 0, 0);
      }
      break;

    case TM_PHONE_EVENT_E911_CALL_END:
       MSG_1( MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Handle E911_CALL_END %d",
      ...
      if ((C_UMTS_CP_GSM_CF_STATE_TIMER_RRLP_MEAS_RESP_TIME == z_umts_cp_gsm_session_status.e_cf_state) &&
          (TRUE == z_umts_cp_gsm_session_status.u_network_session_on))
      {
        tm_umts_cp_gsm_tx_rrlp_mpr_err(rrlp_LocErrorReason_unDefined);
      }
      z_umts_cp_gsm_session_status.u_network_session_on = FALSE;
      tm_umts_cp_gsm_inform_core_stop_session(TM_STOP_REASON_USER_TERMINATED);
#else
      /* Stop the GSM session when RRLP procotol session has not started but E911 call end is
         received. */
      if ( C_UMTS_CP_GSM_CF_STATE_STARTED == z_umts_cp_gsm_session_status.e_cf_state )
      {
        tm_umts_cp_gsm_inform_core_stop_session( TM_STOP_REASON_USER_TERMINATED );
      }
    ...
    case TM_PHONE_EVENT_LCS_MOLR:
       ...
       *  is received.
       */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: CM confirms molr-invoke queued to NAS", 0, 0, 0);
    ...
    case TM_PHONE_EVENT_SS_SRV_STATUS:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: Unhandled Phone Event %d",
            (int)p_event->event, 0, 0);
      break;

#ifdef FEATURE_CGPS_UMTS_CP
    case TM_PHONE_EVENT_LCS_MTLR_NTFY_IND:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: CM delivers MTLR_NTFY_IND", 0, 0, 0);
      tm_umts_cp_ss_lcs_loc_notif_ind_proc(&p_event->payload.sups_data);
      break;
#endif /* FEATURE_CGPS_UMTS_CP */

    case TM_PHONE_EVENT_LCS_MTLR_NTFY_RES:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: CM confirms LCS-LocNotifResp queued to NAS", 0, 0, 0);
      break;

    case TM_PHONE_EVENT_LCS_MOLR_COMPLETED:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: CM confirms LCS_MOLR_COMPLETED", 0, 0, 0);
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: Invalid Phone Event %d",
            (int)p_event->event, 0, 0);
      break;
  }
}
   ...
   )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: APDU Segment Overrun", 0, 0, 0);
  ...
  if (!(p_apdu->flags & APDU_LAST_FLAG))
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: APDU_LAST; start=%d",
   ...
   )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: handle_apdu_data_seg", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: Invalid APDU ID", 0, 0, 0);
    return;
  }
    ...
    case APDU_STATE__IDLE:
      {
        ...
        if ((p_apdu->flags & APDU_FIRST_FLAG))
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: Invalid APDU_FIRST_FLAG", 0, 0, 0);
          break;
        }
        u_init_vars = TRUE;
        break;
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "RR session abort revd", 0, 0, 0);
   ...
   )
{
  ...
  if((SYS_MODEM_AS_ID_1 > p_rr_event->as_id ) || (SYS_MODEM_AS_ID_3 < p_rr_event->as_id))
  {
    MSG_1( MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Invalid Subs ID %d ", (uint32)p_rr_event->as_id);
    return FALSE;
  }
   ...
   )
{
  if (p_rr_event == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "NULL Pointer: p_rr_event", 0, 0, 0);
    return;
  }

  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: handle_rr_event() called with as_id %u ", (uint32)p_rr_event->as_id, 0, 0);
  ...
  switch (p_rr_event->event_id)
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: invalid RR Event", 0, 0, 0);
      return;
  }
}
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: handle_mm_event() called", 0, 0, 0);

#ifdef FEATURE_CGPS_UMTS_CP
  switch (p_mm_event->mm_event_data_ptr->e_event_type)
  {
    case MM_CGPS_MSG_EVENT_ABORT:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: got LCS abort from MM", 0, 0, 0);
      break;

    case MM_CGPS_MSG_EVENT_RESET_UE_POS_INFO:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: got OTA cold start from MM", 0, 0, 0);
      break;

    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: invalid MM Event", 0, 0, 0);
      break;
  }
#endif /* FEATURE_CGPS_UMTS_CP */
}
   ...
   )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: gsm_write_data called for as_id %d", (uint8)z_umts_cp_gsm_session_status.z_rr_as_id_info.e_cached_rr_as_id, 0, 0);

  if (NULL == p_data)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "NULL pointer passed to tm_umts_cp_gsm_write_data", 0, 0, 0);
    return 0;
  }

  if (length > MAX_APDU_DATA_LEN)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "RRLP Message exceeds maximum buffer length", 0, 0, 0);
    return 0;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "CP-GSM: gs_send_message(apdu) failed", 0, 0, 0);
    return 0;
  }
   ...
   )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: gsm_start_sess_req MTLR/NILR UE_ASSISTED", 0, 0, 0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-GSM: gsm_start_sess_req MTLR/NILR UE_BASED", 0, 0, 0);
  }
  ...
  if (accepted)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: tm_sess_req() STARTED", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: tm_sess_req() REJECTED", 0, 0, 0);
   ...
   )
{
  ...
  {
    u_accepted = TRUE;
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif ACCEPT", 0, 0, 0);
  }
  else if (p_user_resp->resp == PDSM_LCS_NOTIFY_VERIFY_DENY)
  {
        ...
        (notif_priv_type == PDSM_LCS_USER_NOTIFY_ONLY))
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif REJECT overiden as ACCEPT due to priv_type", 0, 0, 0);
    }
    else
    {
      u_accepted = FALSE;
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif REJECT", 0, 0, 0);
    }
  }
  else
  {
        ...
        (notif_priv_type == PDSM_LCS_USER_NOTIFY_VERIFY_ALLOW_NO_RESP))
    {
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif NORESP taken as ACCEPT due to priv_type",
              0, 0, 0);
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif invalid resp. taken as ACCEPT due to priv_type",
              0, 0, 0);
      }
    }
                ...
                PDSM_LCS_USER_NOTIFY_VERIFY_NOT_ALLOW_NO_RESP)
    {
      ...
      if (p_user_resp->resp == PDSM_LCS_NOTIFY_VERIFY_NORESP)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif NORESP taken as REJECT due to priv_type", 0, 0, 0);
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif invalid resp. taken as REJECT due to priv_type",
              0, 0, 0);
      }
    }
    else /* should never get here, only for completeness */
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Notif/Verif no-resp with unexpected priv_type taken as REJECT",
            0, 0, 0);
    }
  }
                                                ...
                                                boolean u_use_dynamic_qos)
{
  ...
  if (u_need_wishlist)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,  "CP-GSM: requesting wishlist continuation; qos=%u, acc=%lu",
          u_timeout_secs,
          u_acc_thresh,
          0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,  "CP-GSM: ntwk over; qos=%u, acc=%lu",
          u_timeout_secs,
          u_acc_thresh,
          0);
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-GSM: Requesting Wishlist", 0, 0, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: MaxMgpOn timer expired", 0, 0, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "GSM-CP: AccReset timer expired - %d, %d",
...
void tm_umts_cp_gsm_handle_cf_timer_cb(void)
{
   ...
   *  callflow state
   */
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: callflow timer expired", 0, 0, 0);
  ...
  switch (z_umts_cp_gsm_session_status.e_cf_state)
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: Timer Expiration Ignored", 0, 0, 0);
      break;
  }
}
...
boolean tm_umts_cp_gsm_stop_prm(void)
{
  ...
  if (tm_sess_req(TM_PRTL_TYPE_UMTS_CP,
                  ...
                  &req_param))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_umts_cp_gsm_stop_prm Succeeded", 0, 0, 0);
    return TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "tm_umts_cp_gsm_stop_prm Failed", 0, 0, 0);
    return FALSE;
  }
} /* tm_umts_cp_gsm_stop_prm */

/*===========================================================================
FUNCTION tm_umts_cp_gsm_gps_mode_to_tm_oper_mode

DESCRIPTION
  This function maps from SUPL agps mode type to TM operation mode

PARAMETERS: umts_cp_gsm_session_agps_mode_enum_type e_agps_mode
...
tm_sess_operation_mode_e_type tm_umts_cp_gsm_gps_mode_to_tm_oper_mode(umts_cp_gsm_session_agps_mode_enum_type e_agps_mode)
{
