...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/umts_cp/gsm/src/tm_umts_cp_gsm_api.c#1 $
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"CP-GSM: start_sess_req_handler() called; handle=%d", sess_handle, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CP-GSM: Session Start Request Rejected", 0, 0, 0);
  ...
  if( pdapi_mapping_success )
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CP-GSM: MO-MB starts", 0, 0, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CP-GSM: MO-MA starts", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CP-GSM: pdapi_mapping failure", 0, 0, 0);
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"CP-GSM: stop_sess_req_handler() called", 
          (int) stop_type, 
          (int) stop_reason, 
          0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CP-GSM: Session Stop Request Rejected", 0, 0, 0);
...
)
{
   ...
   */
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"CP-GSM: sess_req_data_handler() called", (int) session_handle, (int) req_data, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"CP-GSM: sess_info_handler() called", 0, 0, 0 );
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CP-GSM: Session Info Rejected", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CP-GSM: Invalid session handle", 0, 0, 0);
  ...
  switch ( sess_info_type )
  {
    ...
    case PRTL_SESS_INFO_PRM:
       ...
       */
      if(p_sess_info_param->prm_data.z_MeasBlk.z_GnssHeader.e_MeasBlkSrc == GNSS_MEAS_BLK_SRC_GPS)
      { 
        if ( z_umts_cp_gsm_session_status.e_agps_mode == 
                                        C_UMTS_CP_GSM_AGPS_MODE_UE_ASSISTED )
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CP-GSM: Handle PRM", 0, 0, 0);
    ...
    case PRTL_SESS_INFO_LR:
       ...
       */  
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CP-GSM: got LR", 0, 0, 0);
    ...
    case PRTL_SESS_INFO_STATUS:
       ...
       */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CP-GSM: got SessInfo", 0, 0, 0 );
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"CP-GSM: timer_cb_handler() called", 0, 0, 0);
  ...
  if( timer_param == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"CP-GSM: Invalid NULL Timer Data Pointer", 0, 0, 0);
    return;
  }
  ...
  else if( q_timer_id == TM_UMTS_CP_GSM_CF_TIMER_ID )
  {
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CP-GSM: Timer Expired with no session in progress", 0, 0, 0 );
      }
      else
      {
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"CP-GSM: Invalid Timer Data Pointer", 0, 0, 0);
  }
}
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CP-GSM: event_cb_handler(); ev=%d", (int)event_type, 0, 0);
  ...
  switch( event_type )
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-GSM: Invalid Event in event_cb_handler", 0, 0, 0 );
      return FALSE;
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"CP-GSM: init called", 0, 0, 0);
