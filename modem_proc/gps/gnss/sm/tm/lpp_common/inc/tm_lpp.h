...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/lpp_common/inc/tm_lpp.h#2 $ $DateTime: 2020/08/18 18:25:02 $ $Author: pwbldsvc $

  when       who     what, where, why
  --------   ---     ----------------------------------------------------------
  06/22/19   sj      Fix privacy error codes
  05/08/17   rn      Added LPP_CF_EARLY_AND_FINAL_RESP_BUFFER_SECS definition.
  06/06/16   skm     Updated SUPL LPP version to 12.4
...
#define LPP_CURRENT_VERSION_MAJOR 15 /* current ASN1's major */
#define LPP_CURRENT_VERSION_TECH 2  /* current ASN1's technical */
#define LPP_CURRENT_VERSION_EDIT 0  /* current ASN1's editorial */


#define LPPE_CURRENT_VERSION_MAJOR 1 /* current ASN1's major */
#define LPPE_CURRENT_VERSION_TECH 0 /* current ASN1's technical */
#define LPPE_CURRENT_VERSION_EDIT 0  /* current ASN1's editorial */
...
#define LPP_PROV_OTDOA_PROV_CAP OTDOA_ProvideCapabilities_otdoa_Mode_ue_assisted_1
...
#define LPP_REQ_LOC_CRIT_EXT_R9 T_RequestLocationInformation_criticalExtensions_c1_requestLocationInformation_r9
/* Time model IDs */
...
#define C_LPP_OTDOA_MUL_MEAS_MSEC 100   /* 50ms for 2 IPC delay + 50ms for LPP PLI msg processing time */

/* Early Response buffer time limit to Final response time*/
#define LPP_CF_EARLY_AND_FINAL_RESP_BUFFER_SECS (3)

#define C_LPP_PRM_GNSS_SV_ID_MAX  63    /* SV ID range 0 - 63 for PRMs */
...
/*Min Values for RSRP Result in legacy field*/
#define RSRP_RESULT_OTA_MIN (0)
/*Range Values for RSRQ Result in legacy field*/
#define RSRQ_RESULT_OTA_MIN (0)
#define RSRQ_RESULT_OTA_MAX (34)
...
/*Channel Frequency Map for WLAN Encoding*/
static const chan_num_map  z_wlan_freq_channel_map[] = 
{
    {   1, 2412 },
    {   2, 2417 },
    {   3, 2422 },
...
/*
******************************************************************************
* tm_umts_lte_get_cell_info
*
* Function description:
*    Get cell info.
*
* Parameters:
*    e_as_id : corresponding as_id
*    prtl_type: corresponding protocol type
*    p_lpp_tx_info :  pointer to transaction
*
* Return Value:
...
******************************************************************************
*/
extern boolean tm_umts_lte_get_cell_info(sys_modem_as_id_e_type e_as_id, tm_prtl_type prtl_type, tm_lpp_transaction_info_s_type *p_lpp_tx_info);
 ...
 ******************************************************************************
*/
void tm_lpp_proc_otdoa_stop_req
(
 ...
 ******************************************************************************
*/
boolean tm_lpp_gps_sv_least_available
( 
   const gnss_MeasBlkStructType *const pGnssMeasBlk 
);
 ...
 ******************************************************************************
*/
boolean tm_lpp_glo_sv_least_available
( 
  const gnss_MeasBlkStructType *const pGnssMeasBlk 
);
