...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/umts_common/inc/tm_umts_common_utils.h#2 $
...
typedef enum
{
  ...
  C_EMERGENCY_HANDLING                            /* in emergency call */
...
typedef struct
{
  ...
  uint32 aagps_sha_tls_support; /* copied from NV item gnss_sm_sha_tls_support (NV 74121)
  ...
  uint32 q_emergency_extension_window; /* NV 74234 Specifies time in seconds to extend E911 state */

  uint32 q_gnss_lock_ctrl_for_oem; /* NV 74235 Represents OEM controls to config GNSS session request and notification to HLOS
...
} tm_umts_common_pending_pos_to_network_s_type;

typedef struct
{
   boolean                                  u_valid;
   tm_umts_common_pending_pos_to_network_s_type  z_pos_info;
}tm_umts_common_pos_for_net_s_type;
...
//extern void void tm_umts_common_utils_read_from_hw_sub(sys_modem_as_id_e_type sub);
//extern void tm_umts_common_utils_read_nv_from_cache(void);
extern void tm_umts_common_utils_update_config_for_sub(sys_modem_as_id_e_type sub);

extern void tm_umts_common_utils_read_nv_at_bootup (void);
...
/*
******************************************************************************
* tm_umts_get_lte_band_info
*
* Function description:
*    Get band info.
*
* Parameters:
*    instance : corresponding as_id
*    dl_earfcn: corresponding frequency
*    band_is_valid_ptr :  pointer to band validity
*
* Return Value:
*    sys_sband_lte_e_type: band info
*
******************************************************************************
*/
extern sys_sband_lte_e_type tm_umts_get_lte_band_info (lte_rrc_mem_instance_type instance, 
                                                       lte_earfcn_t dl_earfcn,
                                                       boolean *band_is_valid_ptr);

/*
******************************************************************************
* tm_umts_get_lte_band_pref_info
*
* Function description:
*    Get band pref info.
*
...
*    
* Return Value:
*    sys_sband_lte_e_type: Band pref info
*
******************************************************************************
*/
extern sys_lte_band_mask_e_type tm_umts_get_lte_band_pref_info(lte_rrc_mem_instance_type instance);

/*
******************************************************************************
* tm_umts_lte_is_inter_freq_supported
*
* Function description:
*    Finds if inter_freq is supported
*
* Parameters:
*    instance : corresponding as_id
*    
...
******************************************************************************
*/
extern boolean tm_umts_lte_is_inter_freq_supported(lte_rrc_mem_instance_type instance);
 ...
 ******************************************************************************
*/
extern float tm_umts_common_utils_GADK_unc_to_meter( uint8 u_Horiz, uint8 u_UncMajorK, 
