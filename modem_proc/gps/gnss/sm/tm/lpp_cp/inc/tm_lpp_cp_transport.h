...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/lpp_cp/inc/tm_lpp_cp_transport.h#1 $
...
typedef struct
{
  ...
  sys_radio_access_tech_e_type e_rat;
  boolean v_no_ack_required;
...
PARAMETERS
  lpp_pkt - structure containing lpp packet
