...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/inc/tm_lm_iface.h#2 $ 
...
typedef enum {
  ...
  TM_INFO_UNPROPAGATED_FIX_REPORT
  /*Unpropagated fix report*/
...
typedef union {
  tm_measurement_report_s_type*     pz_measure_rpt;
...
typedef enum
{
  ...
  TM_INFO_TM_START_LDM_SECONDARY_CLIENT,
  /* Notify TM to start secondary session in LM during concurrent sessions */
  TM_INFO_TM_DISABLE_LDM_CLIENT,
  /* Notify TM to disable LDM client */
  TM_INFO_REPORT_SARF_STATUS,
  /* Notify TM with SARF enter/exit status */
  TM_INFO_GET_ENGINE_MONITOR_CONFIG,
  /* Notify TM to with engine monitor config value */
  TM_INFO_REPORT_ENGINE_MONITOR_STATUS,
  /* Notify TM to with engine monitor status */
  TM_INFO_REPORT_ME_METRICS,
  /* Notify TM with ME Metrics */
  TM_INFO_TDM_EN_UPDATE,
  /* Notify TM of TDM Enable/Disable for Predice XTRA */
} tm_info_e_type;
...
typedef union
{
  ...
  tm_ldm_client_disable_s_type   z_lm_ldm_client_disable;
  /* TM_INFO_SARF_STATUS */
  boolean                        v_sarf_status;
  boolean                        v_engine_monitor_config;
  uint64                         t_engine_monitor_status;
  gnss_MEMetricsStructType       z_ME_metrics;
  boolean                        b_isTdmEnabled;
} tm_info_u_type;
...
=============================================================================*/
extern boolean tm_info_mgp_event( const tm_info_mgp_event_s_type   *p_info );
...
===========================================================================*/
extern boolean tm_core_is_periodic_ppm_session_on(void);
