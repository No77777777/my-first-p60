...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/src/tm_lte_nas_msgr_iface.h#1 $
...
typedef union
{
    ...
    /*! ********* external Messages ************/
    /* E911 mode message from CM */
    cm_emerg_mode_status_ind_s_type     emergency_mode_status;
