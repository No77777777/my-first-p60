...
$Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/prot/tm_cm_iface.h#1 $
...
#define TM_CM_IFACE_E911_EXTEND_TIMER_ID                  (TM_CM_IFACE_TIMER_ID_RANGE+2)

#define TM_CM_IFACE_TIMER_DISPATCH_MASK      ((TM_CM_IFACE_INACTIIVITY_TIMER_ID)| \
                                              (TM_CM_IFACE_E911_EXTEND_TIMER_ID)) 
...
#define AS_ID(index) ((0 == index) ? SYS_MODEM_AS_ID_1 : ((1 == u_index) ? SYS_MODEM_AS_ID_2 : SYS_MODEM_AS_ID_3))
...
typedef enum
{
  ...
  /* Indicates concurrent E911 session*/
  TM_CM_E911_STATE_CONCURRENT,
...
typedef struct
{
  ...
  sys_modem_as_id_e_type emerg_asubs_id; /* Sub on which the E911 call got originated */
  cgps_SrvSystemType emerg_srv_system; /* RAT on which the E911 call got originated */
  cgps_SrvSystemType emerg_conn_srv_system; /*RAT on which E911 call is connected*/
  tm_cm_e911_state_e_type prev_e911_state;
...
typedef struct {
  ...
  boolean                    v_endc_qualified_device; /* Indicates its NSA_5G mode when RAT is LTE */
...
typedef struct
{
  ...
  sys_sys_mode_mask_e_type	sub_capability_info[TM_CM_MAX_NO_SUBS];
...
// Store DSDS params
  ...
  tm_cm_emerg_call_info_s_type emerg_phone_state_info;
  tm_cm_e911_state_e_type     prev_e911_state; /* Holds the previous e911 state. Used to revert to prev state when concurrency fails */
  cgps_nsa_5G_e_type          e_NSA_5G_mode; /* Indicates Non-StandAlone 5G mode (when RAT is LTE)*/
  os_TimerMsgType*            e911_extend_timer;
  boolean                     v_e911_extend_timer_active;
} tm_cm_info_s_type;
...
static tm_cm_stack_ss_info_s_type **tm_cm_multisim_ss_info;
...
===========================================================================*/
extern boolean tm_cm_iface_send_data(tm_prtl_type prtl_type, byte* data_ptr, uint8 length, sys_modem_as_id_e_type as_id);
...
===========================================================================*/
extern sys_sys_mode_e_type tm_cm_get_sys_mode_for_as_id(sys_modem_as_id_e_type sub_id);
...
===========================================================================*/
extern boolean tm_cm_request_wcdma_dch_cell_info_by_sub(sys_modem_as_id_e_type u_SubscrId);
...
extern void tm_cm_process_ext_emergency_enter(const tm_cm_lte_emergency_e_type call_state, 
...
===========================================================================*/
void tm_cm_handle_emergency_call_orig_event(sys_modem_as_id_e_type sub_id, cgps_SrvSystemType sys_mode);
...
===========================================================================*/
extern cgps_SrvSystemType tm_cm_iface_get_prev_srv_system(void);

/*===========================================================================

FUNCTION tm_cm_process_cell_update
...
void tm_cm_process_cell_update(const tm_cm_mm_msim_ss_stack_info_s_type *const cp_ss_info_ptr);
