...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/prot/tm_common.h#1 $ 
...
#define SM_MEAS_STATUS_VALID_FRESH   (MEAS_STATUS_SM_VALID | MEAS_STATUS_GNSS_FRESH_MEAS)
...
/*E911 Max Position uncertainity for GNSS+CPI feature*/
#define MAX_E911_ACCURACY_THRESHOLD 50
...
#define TM_SENSOR_ID_RANGE                    0x0B000000
#define TM_XSPI_ID_RANGE                      0x0C000000
#define TM_PERIODIC_PPM_TIMER_ID_RANGE        0x0D000000
#define TM_LPP_CP_TIMER_ID_RANGE              0x0E000000
#define TM_TECHSEL_TIMER_ID_RANGE             0x0F000000
#ifdef FEATURE_RD_SUPL_HSLP_N_CERTS_FRM_USIM
#error code not present
#endif /* FEATURE_RD_SUPL_HSLP_N_CERTS_FRM_USIM */
#define TM_LPC_TIMER_ID_RANGE                 0x20000000
#define TM_FUSION_CSM_TIMER_ID_RANGE          0x30000000
#define TM_DIAG_PFA_TEST_ID_RANGE             0x40000000
...
#define TM_PRTL_TYPE_CSM            0x0800
...
typedef enum
{
  ...
  TM_PHONE_EVENT_E911_CALL_CONNECT,
  TM_PHONE_EVENT_MAX
...
typedef struct
{
  ...
  sys_modem_as_id_e_type as_id; /* Sub ID on which the data was received. */
...
typedef struct
{
  cgps_SrvSystemType emerg_call_sys_mode;   /* RAT on which 911 call is camped*/
  cgps_SrvSystemType emerg_conn_srv_system; /* RAT on which E911 call is connected*/
  sys_modem_as_id_e_type emerg_call_asid;
} tm_cm_emerg_call_info_s_type;
...
#endif /* FEATURE_CGPS_UMTS_CP */
  tm_cm_emerg_call_info_s_type emerg_call_info;
...
typedef struct
{
  ...
  FLT ext_loc_uncrtnty_v;              /* Raw Standard deviation of vertical error for position uncertainty */
} tm_lr_resp_type;
...
typedef struct
{
  ...
  FLT t_dop;               /* [x10]   Range: 1.0 (highest accuracy) 50.0 (lowest accuracy) */
  FLT g_dop;               /* [x10]   Range: 1.0 (highest accuracy) 50.0 (lowest accuracy) */
...
typedef enum
{
  TM_NEGATIVE_LS_CORRECTION = -1,
  TM_ZERO_LS_CORRECTION = 0,
  TM_POSITIVE_LS_CORRECTION = 1
}tm_leap_second_correction_e_type;

/* Positive Leap Second correction defines */
#define TM_POSITIVE_LS_CORRECTION_SECONDS (60)
#define TM_POSITIVE_LS_CORRECTION_MINUTES (59)
#define TM_POSITIVE_LS_CORRECTION_HOURS (23)

/* Negative Leap Second correction defines */
#define TM_NEGATIVE_LS_CORRECTION_HOURS_MINS_SECS (0)
...
===========================================================================*/
extern float tm_util_get_pos_uncert(int16 un);
...
DESCRIPTION
  This function is used to translate sm_NavPositionStructType strucutre to 
...
DESCRIPTION
  This function is used to translate sm_NavPositionStructType structure to 
tm_ext_pos_data_s_type structure
...
/**
* @fn tm_xtra_check_for_time_inconsistency
* @brief Checks the GPS Week from Measkblk for inconsistencies against XTRA, ROM Alm and Build
*        compilation time
*
* @retval None
*/
void tm_xtra_check_for_time_inconsistency(const gnss_MeasBlkStructType *pz_Meas);
