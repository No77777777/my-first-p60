...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/1x_up/inc/tm_1x_up.h#1 $


when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/17/18    py    tm_1x_up_read_nv header written
...
DESCRIPTION
  This function is used to read NV values and update tm_1x_up_config params
