...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/1x_up/src/tm_1x_up_is801_driver_i.h#1 $
...
boolean tm_state_transition(const is801_operation ops[], const void *params[], tm_1x_up_session_state_e_type next_state);
