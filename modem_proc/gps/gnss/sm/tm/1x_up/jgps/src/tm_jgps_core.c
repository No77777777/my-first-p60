...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/1x_up/jgps/src/tm_jgps_core.c#1 $  
...
)
{
  ...
  switch (sess_info_type)
  {
    ...
    case PRTL_SESS_INFO_PRM:
      if ( sess_info_param->prm_data.z_MeasBlk.e_GnssMeasRptreason == GNSS_MEAS_RPT_MEAS_DONE_SM )
      {
