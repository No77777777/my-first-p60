/*======================================================================
 ...
 Technology Selector Rule 8

 GENERAL DESCRIPTION
  This file contains declaration of  Rule 8 Class
...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/tech_sel/src/rules/inc/tech_sel_rule_8.h#1 $
...
#ifndef TECH_SEL_RULE_8_H
#define TECH_SEL_RULE_8_H

#include "tech_sel_rules.h"
#include "tech_sel_rule_pdr.h"
#include "tech_sel_rules_engine.h"

/*Rule for disallowing Ped and SDP sensors*/
class TechSelRule8 :public TechSelRulePdr {
  public:      
