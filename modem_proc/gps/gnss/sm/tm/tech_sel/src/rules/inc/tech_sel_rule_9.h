/*======================================================================
 ...
 Technology Selector Rule 9

 GENERAL DESCRIPTION
  This file contains declaration of  Rule 9 Class
...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/tech_sel/src/rules/inc/tech_sel_rule_9.h#1 $
...
#ifndef TECH_SEL_RULE_9_H
#define TECH_SEL_RULE_9_H

#include "tech_sel_rules.h"
#include "tech_sel_rule_pdr.h"
#include "tech_sel_rules_engine.h"

/*Rule for handling 911 orig event*/
class TechSelRule9 :public TechSelRulePdr {
  public:      
