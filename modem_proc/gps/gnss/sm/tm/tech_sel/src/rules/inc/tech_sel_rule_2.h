/*======================================================================
 ...
 Technology Selector Rule 2

 GENERAL DESCRIPTION
  This file contains declaration of  Rule 2 Class
...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/tech_sel/src/rules/inc/tech_sel_rule_2.h#1 $
...
#ifndef TECH_SEL_RULE_2_H
#define TECH_SEL_RULE_2_H

#include "tech_sel_rules.h"
#include "tech_sel_rule_wifi_assist.h"
#include "tech_sel_rules_engine.h"

/*Wifi Fix Start for GNSS Weak*/
class TechSelRule2 :public TechSelRuleWifiAssist {
  public:      
