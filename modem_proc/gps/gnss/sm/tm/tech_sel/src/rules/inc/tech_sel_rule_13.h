/*======================================================================
 ...
 Technology Selector Rule 13

 GENERAL DESCRIPTION
  This file contains declaration of  Rule 13 Class
...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/tech_sel/src/rules/inc/tech_sel_rule_13.h#1 $
...
#ifndef TECH_SEL_RULE_13_H
#define TECH_SEL_RULE_13_H

#include "tech_sel_rules.h"
#include "tech_sel_rule_pdr.h"
#include "tech_sel_rules_engine.h"

/*Rule for Ped Exit Eval LPPM M2*/
class TechSelRule13 :public TechSelRulePdr {
  public:      
