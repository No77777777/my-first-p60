...
/*============================================================================
 ...
 $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/tm/ldm/api/ldm_api.h#1 $
...
typedef enum
{
  ...
  LDM_CLIENT_TYPE_LAST = LDM_CLIENT_TYPE_SECONDARY,
...
@param[in]   e_client_type            Indicates if the client will be the main or secondary client. Main client runs as an LM session
...
ldm_op_status_e_type ldm_client_enable_request(const ldm_client_id_e_type e_client_id, 
                                                   ...
                                                   const ldm_client_e_type e_client_type);
...
/* -----------------------------------------------------------------------*//**
@brief
  This function is used by the LDM to update the client type of an enabled client
@param[in]   e_client_id                The client ID which identifies the type of client.   
@param[in]   ldm_client_e_type     This indicates the type of client (main/secondary)     
@retval    ldm_op_status_e_type   The operation status of the LDM.

*//* ------------------------------------------------------------------------*/
ldm_op_status_e_type ldm_client_update_client_type(const ldm_client_id_e_type e_client_id, const ldm_client_e_type e_client_type);
