...
DESCRIPTION
  ...
  Copyright (c) 2015 - 2017,2020 Qualcomm Technologies, Inc. Qualcomm Technologies Confidential and
...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/sm/common/inc/pdapiclient.h#3 $ $DateTime: 2024/07/25 22:07:08 $ $Author: pwbldsvc $
...
typedef enum pdsm_cmd_type_e {
    ...
    PDSM_CMD_TYPE_SRN_INFO,             /* SRN scan information, BTLE RSSI scans*/
...
typedef struct pdsm_pd_cms_end_session_info_s
{
    /* Session type to end */
        ...
        /* End reason due to service interaction */
...
typedef struct pdsm_xtra_cmd_info_s {
  ...
  /* Navic assist download supported by xtra Client*/
  boolean                       navic_assist_supported;
  /* download interval (hours) */
  uint16                        download_interval;
  /* Precise Xtra supported by Xtra Client*/
  boolean                       precise_xtra_supported;
  /* Error in command request */
...
/* SRN Scan result message command type */
typedef struct {
   /**< id of caller */
   pdsm_client_id_type        client_id;
   ...
   /**< injected data:  srn scan result message */
   pdsm_srn_scan_info_list_s_type     srn_scan_info_list;

} pdsm_srn_scan_info_list_cmd_s_type;
...
typedef union pdsm_cmd_u {
    ...
    pdsm_srn_scan_info_list_cmd_s_type srn_scan_info_list_cmd;
} pdsm_cmd_u_type;
