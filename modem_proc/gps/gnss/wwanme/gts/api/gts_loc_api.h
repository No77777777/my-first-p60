...
$Header: //components/rel/gnss8.mpss/11.1/gnss/wwanme/gts/api/gts_loc_api.h#9 $
...
/* Slow clock freq is 19.2MHz/586 = 32764.505 Hz (refer to macro 'SCLK_DIV_FACTOR' in file
 * 'modem_proc\core\systemdrivers\timetick\src\timetickLegacy.c’) */
#define GTS_USTMR_TO_SLOW_CLK_TICK  ((DBL)586)

/* Additional uncertainty when converting USTMR to Slow clock - 1 slow clock tick which is
 * 1/32764.505 secs or 0.031ms */
#define GTS_USTMR_TO_SLOW_CLK_CONV_TUNC_MS ((FLT)0.031)
...
typedef struct
{
  ...
  U64 t_CurrQtime;    
  /* Freq Est based in 2^10 PPB */
  S32  l_FreqEst;      
  /* Time Uncertainty estimate in Ms/Second */
  FLT  f_FreqEstUncMs; 
...
/* CDMA Time Transfer Request Params */
typedef struct
{
  boolean b_HighPriority;
  boolean b_FTCalEnabled;
} gts_CdmaTtrReqType;
...
typedef struct
{
  int8  b_SubId;    
  U8 u_NumStacks;
  gts_SysStatusType z_SysStatus[TM_CM_MAX_NO_STACKS];
}gts_SSInfoType; 
...
typedef enum
{
  ...
  GTS_QTIME_CAL_APMP_ENTER,
  GTS_QTIME_CAL_CONS_FAIL
...
/* Modify min. WWAN TUNC */
typedef enum
{
  GTS_MODIFY_TUNC_LPPM_ENTRY = 0,
  GTS_MODIFY_TUNC_LPPM_EXIT
} gts_ModifyTuncReasonType;

typedef struct
{
  U8 e_Reason; //of enum type 'gts_ModifyTuncReasonType'
} gts_ModifyWwanTuncMsgType;
...
/* Data structure to get external time */
typedef struct
{
  /* Nmber of milliseconds since 00:00:00 Jan 6, 1980 */
  ...
  uint8 e_TimeSource; //of type 'gps_SlowClkExtTimeSourceType'

  /* Time format (constellation) type */
  uint8 e_ClkFormatSrc; //of type 'gnss_SlowClkSrcEnumTypeVal'

  /* If TRUE, then force use the injected time */
  boolean b_ForceFlag;
} gts_ExtTimeInjectionType;
...
typedef struct
{
  ...
  /* Qtimer Information corresponding to Pos/Vel epoch */
...
/*
 ******************************************************************************
 * Function gts_PutTimeEst
 *
 * Description:
 *
 *  This function creates a ME Time estimate message and sends it GTS 
 *  module
 *
 * Parameters:
 *
 *  pz_TimeEst - SV Time Estimate information
 *  e_MGPSrc - MGP Time source that provided this time
 ...
 ******************************************************************************
*/
void gts_PutTimeEst(const gnss_ClockStructType *pz_TimeEst, const mgp_GnssTypeVal e_MGPSrc,
                    const gts_QtimeType *pz_Qtime, const U32 q_FCount);
 ...
 * Description:
 *
 *  This function tags external time with current Qtime and sends it to GTS
 *  module
 *
 * Parameters:
 *
 *  gts_ExtTimeInjectionType - Exterenal source time information
 *
 *
 * Dependencies:
 *
 ...
 ******************************************************************************
*/
void gts_ExternalSourceInjection(const gts_ExtTimeInjectionType *p_ExtTimeInfo);
 ...
 * Description:
 *
 *  Freq Est module will use this function to inject Frequency Estimate based on XO temperature
 *  and XO FT curve to GTS
 *
 * Parameters:
 *
 ...
 ******************************************************************************
*/
void gts_PutGpsPosVelUpdate (const gts_PosEstMsgType* pz_PosVelType);
 ...
 ******************************************************************************
*/
mgp_TimeEstPutSourceIDEnum gts_MapGtsSrcToMESrc( const gts_TimeSrcType e_GtsSrc );
 ...
 ******************************************************************************
*/
void gts_CalcUstmrAtFCount( gts_QtimeType* pz_Qtime, const U32 q_FCount );
...
/*
 ******************************************************************************
 * Function gts_GetCalibratedGtsTime
 *
 * Description:
 *
 *  This function reads the current time from GTS module and computes offset
 *  from last sleep cycle (calibrated GTS time)
 *
 * Parameters:
 *
 *  pz_GtsTime - Pointer to the GTS Time Estimate
 ...
 ******************************************************************************
*/
boolean gts_GetCalibratedGtsTime( gts_TimeType* pz_GtsTime, DBL* p_Offset, DBL* p_GpsRtcDiffMs );
 ...
 *
 * Parameters:
 * p_PrevCalStateUpdMs - pointer to return the time-diff between current instance and previous
 *    CAL state update
 ...
 ******************************************************************************
*/
boolean gts_GetCalibState(int32 *p_PrevCalStateUpdMs);
...
/*
 ******************************************************************************
 * Function gts_LppFtaPut
 *
 * Description:
 *
 *  This function is used by SM to send the Fine Time Assistance (FTA) data
 *
 * Parameters:
 *
 *  FTA structure
 ...
 ******************************************************************************
*/
void gts_LppFtaPut( const gnss_FTA_Information *p_FtaData );
 ...
 ******************************************************************************
 */
void gts_TimeTickMsAtFCount( const U32 q_FCount, gts_TimeTickInfoType* pz_TimeTickInfo );
 ...
 * Description:
 *
 *  Processes periodic Trigger for PPS generation and V2X time updates. This will be invoked 
 *  from CC every 20 Ms.
 *
 * Parameters:
 *
 ...
 ******************************************************************************
*/
void gts_PeriodicTrigger(S16 x_TickCnt);
 ...
 * Description:
 *
 *  Return USTMR Unc in seconds per second
 *  
 * Parameters: 
 *
 *  None
 ...
 * Return value: 
 *
 *  Ustmr Unc in seconds per second
 *
 ******************************************************************************
*/
...
/*
 ******************************************************************************
 * Function gts_ModifyMinWwanTunc
 *
 * Description:
 *
 ...
 ******************************************************************************
*/
void gts_ModifyMinWwanTunc( const gts_ModifyWwanTuncMsgType *p_Msg );
/*
******************************************************************************
* Function:
*  gts_ConvGtsToMgpGnssConstType
*
* Description:
*  This function will convert GTS constellation type to MGP GNSS type
*
* Parameters:
*  e_GnssConst - GNSS constellation type
*
* Return value:
* mgp_GnssTypeVal  - GTS constellation type
*
******************************************************************************
*/
mgp_GnssTypeVal  gts_ConvGtsToMgpGnssConstType(const gts_TimeFormatType e_GnssConst);

/*
******************************************************************************
* Function:
*  gts_ConvMgpGnssToGtsConstType
*
* Description:
*  This function will convert MGP GNSS constellation type to GTS type
*
* Parameters:
*  e_GnssConst - GNSS constellation type
*
...
******************************************************************************
*/
gts_TimeFormatType gts_ConvMgpGnssToGtsConstType(const mgp_GnssTypeVal e_GnssConst);

/*
******************************************************************************
* Function gts_SendPrimaryConstInfo
*
* Description:
*
*  API to receive primary constellation info
*
* Parameters:
*
*  e_Format - MGP GNSS type
*
* Dependencies:
*
*  None
...
******************************************************************************
*/
void gts_SendPrimaryConstInfo(const mgp_GnssTypeVal e_Format);
 ...
 ******************************************************************************
*/
boolean gts_GetGtsTimeAtUstmr( gts_TimeType* pz_GtsTime, const uint32 q_Ustmr );
...
/*
 ******************************************************************************
 * Function gts_MapGtsTsrcToGpsCommon
 *
 * Description:
 *
 *  Function to map GTS time source enum ('gts_TimeSrcType' defined in 'gts_api.h') to
 *  GPS common (PDSM) type source (defined in 'gps_common.h')
 *
 * Parameters:
 *
 *  e_GtsSrc - GTS time source enum
 *
 * Dependencies:
 *
 *  None
 ...
 * Return value:
 *
 *  GPS Common type source
 *
 ******************************************************************************
*/
uint8 gts_MapGtsTsrcToGpsCommon(const uint8 e_GtsSrc);
