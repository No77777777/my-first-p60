...
$Header: //components/rel/gnss8.mpss/11.1/gnss/wwanme/common/inc/wwanme_common_defs.h#2 $
$DateTime: 2020/03/27 04:14:30 $
$Author: pwbldsvc $
...
#define GTS_V2X_PERIODIC_UPDATE_TIMER             66
...
#define WWANME_CONFIG_ENABLE_SIB8_PROCESS_TTR           (1 << 9)
...
typedef enum
{
  ...
  C_LOC_GTS_MSG_PERIODIC_TRIGGER,  
  C_LOC_GTS_MSG_DRSYNC_ARM,
  C_LOC_GTS_MSG_LEAP_SEC_UPDATE,
  C_LOC_GTS_MSG_MODIFY_MIN_WWAN_TUNC,
  C_LOC_GTS_MSG_DEL_TIME,
  C_LOC_GTS_MSG_INJECT_ABS_TIME,
  C_LOC_GTS_MSG_NR5G_TIME,
  C_LOC_GTS_MSG_PRIMARY_CONST_INFO,
  C_LOC_GTS_MSG_LAST,
