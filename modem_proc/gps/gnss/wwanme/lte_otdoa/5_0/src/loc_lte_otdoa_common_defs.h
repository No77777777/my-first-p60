...
$Header: //components/rel/gnss8.mpss/11.1/gnss/wwanme/lte_otdoa/5_0/src/loc_lte_otdoa_common_defs.h#1 $
 ...
 * For TDD cells, limit the max number of hypothesis to 2 (-1 and 0 symbol offsets) */
#define LOC_LTE_OTDOA_MAX_HYPO_PER_CELL            4
#define LOC_LTE_OTDOA_MAX_HYPO_PER_CELL_TDD        2
...
/* LTE carrier indexes */
#define LLOC_LTE_CARRIER_IDX_PCC    0
#define LLOC_LTE_CARRIER_IDX_SCC_0  1
#define LLOC_LTE_CARRIER_IDX_SCC_1  2
#define LLOC_LTE_CARRIER_IDX_SCC_2  3
#define LLOC_LTE_CARRIER_IDX_SCC_3  4

/* LTE constants needed for PRS collision check in TDD case */
#define LLOC_LTE_MAX_SUBFRAMES_PER_FRAME  10
#define LLOC_LTE_MAX_TDD_CONFIG           7
...
typedef struct
{
  ...
  /* Threshold Limit for S/S+N for weighting Rx0 and Rx1 used in Q31 Format */ 
