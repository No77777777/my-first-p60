...
/*=============================================================================
$Header: //components/rel/gnss8.mpss/11.1/gnss/loc_mw/src/loc_ni.c#1 $
   ...
   )
{
  ...
  do
  {
        ...
        (l_LcsEvent == PDSM_LCS_VX_EVENT_USER_NOTIFY_SERVICE_INTERACTION))
    {
      ...
      pz_NiNotifyVerifyReqIndMsg->isInEmergencySession_valid = TRUE;
      pz_NiNotifyVerifyReqIndMsg->isInEmergencySession = loc_middleware_data.v_E911Session;
