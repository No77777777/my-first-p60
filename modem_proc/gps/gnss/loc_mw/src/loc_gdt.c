...
$Header: //components/rel/gnss8.mpss/11.1/gnss/loc_mw/src/loc_gdt.c#1 $
                                   ...
                                   qmiLocGenRespMsgT_v02 *const pz_Resp)
{
  ...
  if ((NULL != cpz_Client) && (NULL != cpz_Req) && (NULL != pz_Resp))
  {
    ...
    LOC_MSG_MED("loc_gdt_UploadBeginStatusReq client:%d, serv ID:%lu, status:%d",
    ...
    switch (cpz_Req->serviceId)
    {
      ...
      case eQMI_LOC_GDT_SERVICE_CSM_UL_V02:
        z_StartResponse.z_SessionInfo.e_ServiceId = e_GDT_SERVICE_GTP_CSM_UL;
        break;
...
===========================================================================*/
int32 loc_gdt_DownloadReadyReq(const loc_client_info_s_type * cpz_Client,
                               ...
                               qmiLocGenRespMsgT_v02 *const pz_Resp)
{
      ...
      (cpz_Req->filePath_len < QMI_LOC_MAX_GDT_PATH_LEN_V02) )
  {
    ...
    int32  l_ClientHandle = cpz_Client->client_handle;

    z_ReadyArg.pz_ReadyResponse = &z_Response;

    LOC_MSG_MED("loc_gdt_DownloadReadyReq. client:%d, serv ID:%lu, status:%d",
                 cpz_Client->client_handle, cpz_Req->serviceId, (int) cpz_Req->status);
    ...
    z_Response.l_ClientHandle = cpz_Client->client_handle;
...
===========================================================================*/
int32 loc_gdt_RcvDoneStatusReq(const loc_client_info_s_type *cpz_Client,
                               ...
                               qmiLocGenRespMsgT_v02 *const pz_Resp)
{
  ...
  if ((NULL != cpz_Client) && (NULL != cpz_Req) && (NULL != pz_Resp))
  {
    ...
    memset(pz_Resp, 0, sizeof(*pz_Resp));
    z_CloseResponse.l_ClientHandle = cpz_Client->client_handle;
...
===========================================================================*/
int32 loc_gdt_DownlodEndStatusReq(const loc_client_info_s_type *cpz_Client,
