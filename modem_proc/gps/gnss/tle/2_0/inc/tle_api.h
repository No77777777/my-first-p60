...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/tle/2_0/inc/tle_api.h#1 $
...
typedef struct
{
  ...
  tle_api_gtp_DownldStartResponse_e_type e_StartStatus;
  int32           l_Client_handle;
  uint32          q_TransactionId;
  unsigned char   c_RespLocInfo[TLE_MAX_GTP_RLI_LEN];
  uint32          q_RespLocInfo_len;
  boolean         b_RespLocInfoValid;
  boolean         b_WwanDownloadFlag_valid;
  uint16          w_WwanDownloadFlag;
} tle_DownldStartResponseType_0;
...
typedef struct
{
  ...
  boolean         b_WwanDownloadFlag_valid;
  uint16          w_WwanDownloadFlag;
  boolean         b_ApRemainingThrottleTimeValid;
  uint32          q_ApRemainingThrottleTime;
} tle_DownldStartResponseType;

typedef struct
{
  qmiLocGtpApStatusReqMsgT_v02 z_ApStatusReq;
  int             l_Client_handle;
  uint32          q_TransactionId;
} tle_GtpApStatusReqType;
...
typedef PACKED struct PACKED_POST
{
  unsigned char c_Status; /* BYTE1 = RECORD STATUS
                             ...
                             Bit 1 - C_TLE_GDT_RECORD_STATUE_LITTLE_ENDIAN_DNLD */

  uint8 u_ServiceId;      /* BYTE2 = GDT SERVICE ID
                             0x00 Reserved
                             C_TLE_GDT_RECORD_SERVICE_ID_UPLD
                             C_TLE_GDT_RECORD_SERVICE_ID_DNLD
                             0x03 - 0xFF Reserved */

  uint16 w_MsgId;            /* BYTE3 and BYTE4 = Interpretation dependent on GDT SERVICE ID
                            C_TLE_GDT_RECORD_CLIENT_INFO_UPLD
                            C_TLE_GDT_RECORD_MOBILE_STATUS_UPLD
                            C_TLE_GDT_RECORD_CELL_ARRAY_UPLD
                            C_TLE_GDT_RECORD_PART_HEADER_DNLD
                            C_TLE_GDT_RECORD_SNA_PART_DNLD
                            C_TLE_GDT_RECORD_BSA_PART_DNLD
                            C_TLE_GDT_RECORD_PART_MGMT_DNLD
                            C_TLE_GDT_RECORD_CLIENT_DOWNLDED_DATA_DNLD */
   
  uint32 q_Length;
  uint8  u_Crc[4];
  uint8  u_Mask; /* C_LOG_GDT_PACKED_HEADER_MASK_CRC_INCLUDED 0x01*/
} tle_PackedGdtBlobHeaderType;
...
/*===========================================================================
FUNCTION tle_ProcReceiveReadyResponse

DESCRIPTION
  This API is used as a call back to process GDT Receive ready message 
   
PARAMETERS 
  z_RcvReadyParam - GDT receive ready 
  (input)
...
===========================================================================*/
boolean tle_ProcReceiveReadyResponse(gdt_ReceiveReadyArgumentType z_RcvReadyParam );

/*===========================================================================
FUNCTION tle_ProcReceiveOpenResponse

DESCRIPTION
  This API is used as a call back to process GDT response to a Open request message 
   
PARAMETERS 
  z_OpenResp - GDT open response
  (input)
...
===========================================================================*/
boolean tle_ProcReceiveOpenResponse(gdt_OpenArgumentType z_OpenResp);

/*===========================================================================
FUNCTION tle_ProcReceiveDataResponse

DESCRIPTION
  This API is used as a call back to process GDT receive data response
   
PARAMETERS 
  z_RcvData - GDT received data 
  (input)
...
===========================================================================*/
boolean tle_ProcReceiveDataResponse(gdt_ReceiveDataArgumentType z_RcvData);

/*===========================================================================
FUNCTION tle_ProcReceiveCloseResponse

DESCRIPTION
  This API is used as a call back to process GDT response to a prior close
  request.
   
PARAMETERS 
  z_CloseResp - GDT close response
  (input)
...
===========================================================================*/
boolean tle_ProcReceiveCloseResponse(gdt_CloseArgumentType z_CloseResp);

/*===========================================================================
FUNCTION tle_ProcReceiveEndResponse

DESCRIPTION
  This API is used as a call back to process GDT receive end response message.
   
PARAMETERS 
  z_EndResp - GDT end response
  (input)
...
===========================================================================*/
boolean tle_ProcReceiveEndResponse(gdt_ReceiveEndArgumentType z_EndResp);


/*===========================================================================
FUNCTION tle_ProcDownldBeginStatusReq

DESCRIPTION
  This API processes the status request message received from AP for a requested
  TDP download session.
   
PARAMETERS 
  cpz_DownldStartResp - the status request message to be processed
  (input)
   
DEPENDENCIES

RETURN VALUE 
  TRUE  - If IPc is sent to TLE
  FALSE - Otherwise

SIDE EFFECTS

===========================================================================*/
boolean tle_ProcDownldBeginStatusReq(const tle_DownldStartResponseType *cpz_DownldStartResp);

/*===========================================================================
FUNCTION tle_InjectApStatusReq

DESCRIPTION
  This API processes the status request message received from AP.
   
PARAMETERS 
  cpz_ApStatusReq - the status request message to be processed
  (input)
...
===========================================================================*/
boolean tle_InjectApStatusReq(const tle_GtpApStatusReqType * cpz_ApStatusReq);
...
DESCRIPTION
  Generates and logs the GDT BLOB header to be used in PE playback
  
PARAMETERS
  cpz_GdtHeader - Points to the GDT BLOB header to be logged
  (input)
...
==============================================================================*/
void tle_PbLogGdtHeader(const tle_PackedGdtBlobHeaderType * cpz_GdtHeader);
