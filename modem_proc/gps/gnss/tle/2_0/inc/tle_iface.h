...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/tle/2_0/inc/tle_iface.h#1 $
...
/*===========================================================================
  ...
  FUNCTION      tle_PbProcessQmiDownloadBeginAck
  ...
  PARAMETERS
    cpz_DownldStartResp - Points to the download response 
    (input)  
...
===========================================================================*/
void tle_PbProcessQmiDownloadBeginAck(const tle_DownldStartResponseType  *cpz_DownldStartResp);
