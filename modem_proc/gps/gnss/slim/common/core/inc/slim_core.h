...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/11.1/gnss/slim/common/core/inc/slim_core.h#1 $ */

/*----------------------------------------------------------------------------
 * Include Files
 * -------------------------------------------------------------------------*/
#include "slim_provider_data.h"
#include "slim_nv_efs.h"
...
/**
@brief Get SLIM Test Mode Config

@param none

@retval const pointer to SLIM Test Mode config

*/
const slim_EfsNvTestConfigType* slim_GetTestConfig(void);
