...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/11.1/gnss/slim/common/core/inc/slim_utils.h#1 $ */
...
/**
@brief Get the time offset of Qtimer on a remote processor

Function gets the qtimer time offset between modem and remote
processor

@param[out] pr_TimeOffsetOutMs Qtimer offset in ms. 

*/
boolean slim_GetRemoteQtimerOffset(int64 *pr_TimeOffsetOutMs);

/**
@brief Convert the get the local time (in ms) from remote time
using the qtimer offset 

@param[in] t_RemoteTimeMs Remote Qtimer in ms.
@param[in] r_TimeOffsetMs Qtimer offset in ms. 
@param[out] pt_LocalTimeMs Local Qtime in ms. 

*/
boolean slim_ConvertRemoteTimeToLocalTime(uint64 t_RemoteTimeMs, 
                                          int64 r_TimeOffsetMs,
                                          uint64 *pt_LocalTimeMs);
