...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/11.1/gnss/slim/mpss/inc/slim_client_msg_types.h#1 $ */
...
typedef struct
{
  ...
  slimTiltDataStructT   tiltData;
  /**< SLIM tilt data payload */
