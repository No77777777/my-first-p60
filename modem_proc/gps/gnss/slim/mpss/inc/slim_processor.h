...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/11.1/gnss/slim/mpss/inc/slim_processor.h#1 $ */
...
#define SLIM_MSG_PRINTF(LEVEL, str_ptr)  MSG_SPRINTF_1(MSG_SSID_SLIM, LEVEL, "%s", str_ptr)
...
#define SLIM_MSG_PRINTF(LEVEL, str_ptr)  MSG_SPRINTF_1(MSG_SSID_GNSS_LOCMW, LEVEL, "%s", str_ptr)
#else
...
#define SLIM_MSG_PRINTF(LEVEL, str_ptr)  MSG_SPRINTF_1(MSG_SSID_GPSSM, LEVEL, "%s", str_ptr)
#endif

#define SLIM_MSG_LOW0(str)              SLIM_MSG0(MSG_LEGACY_LOW, str)
#define SLIM_MSG_LOW1(str, a)           SLIM_MSG1(MSG_LEGACY_LOW, str, a)
#define SLIM_MSG_LOW2(str, a, b)        SLIM_MSG2(MSG_LEGACY_LOW, str, a, b)
#define SLIM_MSG_LOW(str, a, b, c)      SLIM_MSG(MSG_LEGACY_LOW, str, a, b, c)
...
#define SLIM_MSG_PRINTF_MED(NOP, str_ptr)    SLIM_MSG_PRINTF(MSG_LEGACY_MED, str_ptr)
/*!
...
typedef enum
{
  ...
  SLIM_CLIENT_TILT,             /**< Client id for TILT */
  SLIM_CLIENT_LAST = SLIM_CLIENT_TILT, /**< Last client handle enum
                                                value in use */
  //! @cond
