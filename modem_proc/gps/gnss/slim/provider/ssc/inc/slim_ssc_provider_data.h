...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/11.1/gnss/slim/provider/ssc/inc/slim_ssc_provider_data.h#1 $ */
...
typedef struct slim_SscClientStructType
{
  ...
  slim_SscSamConnectionDataStructType z_TiltData;           /*!< SSC connection data for Tilt service */
