...
/*==============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/src/gps_nv_loader.c#1 $
...
static const int32 gps_basic_nv_items_type_int[][NV_MAX_SIZE_TYPE_INT] =
{
  ...
  /* Internal builds automatically unlock GPS */
  { 452,           0 }, /* NV_GPS1_LOCK_I                                */
#else
  { 452,           1 }, /* NV_GPS1_LOCK_I                                */
...
#if defined(FEATURE_GNSS_GEN9_AUTOMOTIVE_ENABLED) || defined(FEATURE_GNSS_PPS_PULSE_EXTERNAL)
  { 6767,          1 }, /* NV_GNSS_TIMED_OUTPUT_MODE_SELECTION_I         */
#else
  { 6767,          0 }, /* NV_GNSS_TIMED_OUTPUT_MODE_SELECTION_I         */
#endif /* FEATURE_GNSS_GEN9_AUTOMOTIVE_ENABLED || FEATURE_GNSS_PPS_PULSE_EXTERNAL */
...
nv_stat_enum_type gps_NvReadItem (nv_items_enum_type e_NvItem,
                                         void*              p_NvItem);
...
DEPENDENCIES
  None
===========================================================================*/
nv_stat_enum_type gps_NvReadItem
(
  nv_items_enum_type e_NvItem,
  void* p_NvItem
)
