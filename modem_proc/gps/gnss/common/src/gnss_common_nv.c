...
$Header: //components/rel/gnss8.mpss/11.1/gnss/common/src/gnss_common_nv.c#1 $

when         who     what, where, why
----------   ---     ------------------------------------------------------
04/29/2019   sj      Add GNSS Diag Buffer feature
...
static const cgps_nv_efs_reg_item_struct commonNvRegItems[] =
{
  ...
  {
    CGPS_NV_EFS_REG_ST_ITEM_EXTERNAL, /* NV control is visible to external parties*/
    "common/gnss_diag_buffer_cfg", /* NV item file name*/
