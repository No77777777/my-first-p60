...
/*==============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/gps_fs_api.h#1 $ 
...
*/
#define GPS_FS_MAX_PATH_LEN (CGPS_MAX_NV_EFS_FILEPATH_SIZE) /* Maximum FS file path length. Make sure this matches 
