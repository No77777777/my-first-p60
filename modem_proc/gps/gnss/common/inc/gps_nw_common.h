...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/gps_nw_common.h#1 $ 
...
typedef struct
{
  ...
  lte_phy_cell_id_t cell_id; /* Physical cell id of cell */
  lte_rrc_global_cell_id_t cell_identity; /* Global cell id (from SIB1) of cell */
  sys_5g_tac_s_type tac; /* Tracking area code of cell */

} cgps_CellInfoNR5GGlobalStruct;
/* sudeep to check if further changes are needed here */
#endif
