...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/gps_consts.h#3 $ 
...
/* This needs to be aligned with N_ACTIVE_BDS_CHAN in gnss_consts.h */
#define N_ACTIVE_CHAN   24    /* Total number of active channels */
...
#define C_MAX_CLK_FREQ_UNC_FTM (3.0e-6*LIGHT_SEC)                   /* == 3 ppm. RUMI uses TSG so we know what the SV dopp is */
#define C_MAX_CLK_FREQ_UNC     (3.0e-6*LIGHT_SEC)                   /* == 3 ppm. RUMI uses TSG so we know what the SV dopp is */
#else
#define C_MAX_CLK_FREQ_UNC_FTM (20.0e-6*LIGHT_SEC)                  /* == 20 ppm */
#define C_MAX_CLK_FREQ_UNC     (20.0e-6*LIGHT_SEC)                  /* == 20 ppm */
#endif

#define C_GNSS_MAX_CLK_FREQ_UNC_EXTCLK (0.1e-6*LIGHT_SEC)           /* == 0.1 ppm (30ms/s) if external clock is used */
...
/* Meters/Sec to L1 Hz and vice versa */
#define GPS_L5_CHIPS_MSEC  10230
#define GPS_L5_PERIOD_MSEC 1

/* Below applies to GPS L5, BDS B2a, E5a */
#define C_MpsToL5Hz      ((FLT)(1.0/L5_WAVELENGTH))
#define C_L5HzToMps      ((FLT)(L5_WAVELENGTH))

#define GAL_E5A_CHIPS_MSEC   GPS_L5_CHIPS_MSEC
#define GAL_E5A_PERIOD_MSEC  GPS_L5_PERIOD_MSEC

#define NAVIC_N5_CHIPS_MSEC 1023
#define NAVIC_N5_PERIOD_MSEC  1
#define BDS_B2A_CHIPS_MSEC   10230
#define BDS_B2A_PERIOD_MSEC  1

/* NavIC number of chips per ms */
#define NAVIC_N5_CHIPS_MSEC 1023
/* NavIC CA code periodicity in ms */
#define NAVIC_N5_PERIOD_MSEC  1

#define PPM2MPS ((FLT)( 1.0E-6 * LIGHT_SEC ))      /* ppm to m/s conversion */
/* Convert from MPS to 2^-10 ppm ~ ppb */
#define CGPS_MPS_TO_PPB ((FLT)1e6*1024/LIGHT_SEC)
...
/* The range of QZSS L1S PRNs supported */
#define C_FIRST_QZSSL1S_SV_PRN  183
#define C_LAST_QZSSL1S_SV_PRN   191

/* The range of NAVIC PRNs supported */
#define C_FIRST_NAVIC_SV_PRN  (401)
#define C_LAST_NAVIC_SV_PRN   (414)
