...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/gps_rrc_common.h#1 $ 
...
#define C_CELLDB_MAX_CELL_INDEX 2
...
typedef union
{
  ...
  cgps_CellInfoNR5GGlobalStruct z_CellInfoNR5GGlobal;
#endif
  cgps_CellInfoTDSCDMAGlobalStruct z_CellInfoTDSCDMAGlobal;

  /*Wifi Cell Info ap_cell_info and ap_add_cell_info 
    to identify serving cell*/
  struct
  {
    locEngWifiApInfoStructT_v01 z_wifi_ap_cell_info;
    locEngWifiApAdditionalDataStructT_v01 z_wifi_ap_add_cell_info;
  }wifi;
