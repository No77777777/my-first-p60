/*==============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/gps_nv_efs.h#10 $
...
typedef enum
{
  ...
  GNSS_NV_EFS_SM_ALLOW_MO_SUPL_DURING_CONCURRENCY,  /* Configures if MO-SUPL is allowed during concurrency. Allowed only during early RCVR start */
  ...
  GNSS_NV_EFS_SM_LBS_CONFIG,   /* LBS debug purpose config */
  ...
  GNSS_NV_EFS_SM_TM_OTDOA_CONTROL, /*Dynamically enable/disable OTDOA for MSA mode*/
  ...
  GNSS_NV_EFS_SM_TM_LPPE_UP_CONFIG, /* To enable or disable LPPe UP protocol */
  GNSS_NV_EFS_SM_TM_EMERGENCY_SUPPORT_CONFIG, /* Bit 0 is used to enable/disable CPI injections during E911
                                                 Bit 1 is used to enable/disable Early exit for E911 */
  GNSS_NV_EFS_SM_TECH_SEL_LPPM_CONFIG, /*Tecnology Selector LPPM Configuration*/
  GNSS_NV_EFS_SM_TECH_SEL_WIFI_ASSIST_CONFIG, /*Tecnology Selector Wifi Assistance Configuration*/
#ifdef FEATURE_RD_SUPL_HSLP_N_CERTS_FRM_USIM
  #error code not present
#endif /* FEATURE_RD_SUPL_HSLP_N_CERTS_FRM_USIM */
  GNSS_NV_EFS_SM_TM_LPPE_CP_CONFIG, /* To enable or disable LPPe CP protocol */
  GNSS_NV_EFS_SM_TM_UAX3_CONFIG,                  /* UAX3 config */
  GNSS_NV_EFS_SM_LPP_2TIMER_SUPPORT, /*AlwaysOff 2Timer LPP rel12 feature config*/
  GNSS_NV_EFS_SM_CONCURRENT_SESSION_SUPPORT_CONFIG, /*To enable or disable Concurrency feature */
  GNSS_NV_EFS_SM_NHZ_CONFIG, /* Configuration for NHz mode of operation */
  GNSS_NV_EFS_SM_FUSION_CSM_DATA_UPLOAD_THRESHOLD, /* Fusion CSM data upload threshold */
  GNSS_NV_EFS_SM_FUSION_CSM_SB_BUFFER_SIZE, /* Fusion CSM SB buffer size */
  GNSS_NV_EFS_SM_FUSION_CSM_MAX_SSID_SUPPORTED, /* Fusion CSM max num of SSID supported */
  GNSS_NV_EFS_SM_FUSION_CSM_VENUE_TRACKING_RESP_SEC, /* Fusion CSM venue tracking resp */
  GNSS_NV_EFS_SM_FUSION_CSM_OPERATION_MODE,          /* Fusion CSM operation mode */
  GNSS_NV_EFS_SM_FUSION_BARO_WEIGHT,
  GNSS_NV_EFS_SM_FUSION_BARO_SAMPLE_RATE_HZ,
  GNSS_NV_EFS_SM_TEST_CONTROL,
  GNSS_NV_EFS_SM_ASSISTED_BDS_PROTOCOL_ENABLE_MASK, /*AlwaysOff BDS protocol enable mask */
  GNSS_NV_EFS_SM_GM_DRIVE_TO_PED_PREDICTOR_ENABLE, /*Enable predictor in Drive to Ped ctxt detector*/
  GNSS_NV_EFS_SM_LM_HEPE_THRESHOLD_FOR_DR, /*HEPE threshold to be used for DR/INS fixes*/
  GNSS_NV_EFS_SM_TECH_SEL_LPPM_TBM_PROFILE,   /** Tech sel LPPM Tbm profile **/ //sai
  GNSS_NV_EFS_SM_TM_SHA_TLS_SUPPORT,        /* New NV to configure later version of TLS1.1 and SHA256*/
  GNSS_NV_EFS_SM_TM_AGPS_FEATURE_SUPPORT,   /* New NV to congfigure AGPS features.(NV 74140)*/
  GNSS_NV_EFS_SM_TM_CONTROL_DATUM_NMEA_SENTENCE,   /*New NV to control DTM NMEA sentence */
  GNSS_NV_EFS_DISABLE_DYN_HEPE_FOR_BETTER_TTFF, /* control dynamic HEPE usage */
  GNSS_NV_EFS_SM_EMERGENCY_EXTENSION_WINDOW, /* Specifies time in seconds to extend E911 state */
  GNSS_NV_EFS_SM_GNSS_LOCK_CTRL_FOR_OEM, /* Represents OEM controls to config GNSS session request and notification to HLOS
                                            bit0 = CP_NILR_OEM_CTRL
                                            bit1 = SUPL_NI_OEM_CTRL
                                            bit2 = NFW_OEM_CTRL 
                                            bit3 = CP_NILR_NOTIFY_OEM_CTRL
                                            bit4 = NFW_NOTIFY_OEM_CTRL */
  GNSS_NV_EFS_SM_TM_EXTENDED_NMEA_SENTENCE_MASK_V02, /* Enable extended nmea sentences. NV 74264 */
  GNSS_NV_EFS_INTEGER_SECOND_BOUNDARY_ALIGNED_NMEA_REPORT, /*New NV to control second boundary aligned NMEA sentences */
  GNSS_NV_EFS_SM_XTRA_TRACK_XC_CONFIG_INFO_HANDSHAKE, /* New Nv to keep track of XC<->TM config info handshake*/
  GNSS_NV_EFS_SM_TECH_SEL_ODCPI_TIMERS,   /* NV to configure tech sel ODCPI related timers*/  
  /*add new SM NV items above this line. Make sure to update CGPS_NV_EFS_SM_MAX_ITEM*/
  CGPS_NV_EFS_SM_MAX_ITEM = GNSS_NV_EFS_SM_TECH_SEL_ODCPI_TIMERS,
...
#ifdef FEATURE_GNSS_NON_STANDARD_SUPPORT
  GNSS_NV_EFS_ME_EXT_TIME_SYNC_OFFSET_NS,
#endif /* FEATURE_GNSS_NON_STANDARD_SUPPORT */
  ...
  GNSS_NV_EFS_ME_DEBUG_MULTIBAND_CONFIG,
  GNSS_NV_EFS_ME_MULTIBAND_CONFIG,
  GNSS_NV_EFS_ME_VOTE_TO_DISABLE_LTE_MICROSLEEP,
  GNSS_NV_EFS_ME_BDS_SV_BLACKLIST,
  GNSS_NV_EFS_ME_DPO_IQSUM_LOGGING_ENABLE,
  GNSS_NV_EFS_ME_RFGD_GPS_L1_TO_L5_NS,
  GNSS_NV_EFS_ME_RFGD_GPS_L1_TO_L5_UNC_NS,
  GNSS_NV_EFS_ME_RFGD_GAL_E1_TO_E5A_NS,
  GNSS_NV_EFS_ME_RFGD_GAL_E1_TO_E5A_UNC_NS,
  GNSS_NV_EFS_ME_GNSS_GPS_L5_PATH_LOSS,
  GNSS_NV_EFS_ME_GNSS_GAL_E5A_PATH_LOSS,
  GNSS_NV_EFS_ME_SW_BLANK_CP_THRESHOLDS,
  GNSS_NV_EFS_ME_SW_BLANK_DP_THRESHOLDS,
  GNSS_NV_EFS_ME_RFGD_GPS2GLO_NS,
  GNSS_NV_EFS_ME_FORCED_MULTIBAND_ENGAGEMENT_CONFIG,
  GNSS_NV_EFS_ME_ACQ_POWER_MODE_CONFIG,
  GNSS_NV_EFS_ME_TIS_BAND5_CONTROLS,
  GNSS_NV_EFS_ME_E911_CONSTELLATION_DISABLEMENT,
  GNSS_NV_EFS_ME_GTS_GPSRF_PATH_DELAY,
  GNSS_NV_EFS_ME_HW_CAPABILITY_CONFIG,
  GNSS_NV_EFS_ME_GNSS_BDS_B2A_PATH_LOSS,
  GNSS_NV_EFS_ME_B1I_TO_B2A_RFGD,
  GNSS_NV_EFS_ME_B1I_TO_B2A_RFGD_UNC,
  GNSS_NV_EFS_ME_GNSS_MULTIBAND_CONFIG,
  GNSS_NV_EFS_ME_RFGD_GPS2NAVIC_NS,
  GNSS_NV_EFS_ME_RFGD_GPS2NAVIC_UNCERTAINTY_NS,
  GNSS_NV_EFS_ME_RFGD_GLO2NAVIC_NS,
  GNSS_NV_EFS_ME_RFGD_GLO2NAVIC_UNCERTAINTY_NS,
  GNSS_NV_EFS_ME_RFGD_BDS2NAVIC_NS,
  GNSS_NV_EFS_ME_RFGD_BDS2NAVIC_UNCERTAINTY_NS,
  GNSS_NV_EFS_ME_RFGD_GAL2NAVIC_NS,
  GNSS_NV_EFS_ME_RFGD_GAL2NAVIC_UNCERTAINTY_NS,
  GNSS_NV_EFS_ME_OTFSA_SCAN_TIMERS,
  GNSS_NV_EFS_ME_PEAK_ANTENNA_GAIN_L5,
  GNSS_NV_EFS_ME_GNSS_NAVIC_PATH_LOSS,
  GNSS_NV_EFS_ME_GNSS_BAND5_SUPPORT_CFG,
  GNSS_NV_EFS_ME_NHZ_CFG,
  GNSS_NV_EFS_ME_GPM_CM_FEATURE_CONFIG,
  GNSS_NV_EFS_ME_GNSS_NAV_DATA_NMEA_CONTROL,

  /* add other ME items here. Make sure to update GNSS_NV_EFS_ME_MAX_ITEM */
  GNSS_NV_EFS_ME_MAX_ITEM = GNSS_NV_EFS_ME_GNSS_NAV_DATA_NMEA_CONTROL,
...
#ifdef FEATURE_GNSS_NON_STANDARD_SUPPORT
  GNSS_NV_EFS_PE_POSITION_CROSSCHECK_DISTANCE,
#endif /* FEATURE_GNSS_NON_STANDARD_SUPPORT */
  ...
  GNSS_NV_EFS_PE_MB_TEST_CONTROL,
  GNSS_NV_EFS_PE_RTI_HEALTH_EXPIRATION_PERIOD,
  GNSS_NV_EFS_PE_DATA_REPORT_MASK,
  GNSS_NV_EFS_PE_NF_GILE_MAX_DEAD_RECKONING_HEVE,
  GNSS_NV_EFS_PE_NF_FFAE_CONFIG,
  GNSS_NV_EFS_PE_IMMEDIATE_ASSISTANCE_REQ_CONFIG,
  GNSS_NV_EFS_PE_BDS_EXPERIMENTAL_SV_MASK,
  GNSS_NV_EFS_PE_LOG_QOS_REPORT_MASK,
  GNSS_NV_EFS_PE_ENHANCED_XTRA_CONFIG,

  /* add other PE items here. Make sure to update GNSS_NV_EFS_PE_MAX_ITEM */
  GNSS_NV_EFS_PE_MAX_ITEM = GNSS_NV_EFS_PE_ENHANCED_XTRA_CONFIG,
  ...
  CGPS_NV_EFS_TLE_TLM_MAX_ITEM = GNSS_NV_EFS_TLE_EXTERNAL_PROVIDER_UPLOAD_CELL_THRESHOLD,
  ...
  GNSS_NV_EFS_SDP_DELAYED_SNSOFF_TIME_SEC,
  /* add other SDP items here. Make sure to update GNSS_NV_EFS_SDP_MAX_ITEM */
  GNSS_NV_EFS_SDP_MAX_ITEM = GNSS_NV_EFS_SDP_DELAYED_SNSOFF_TIME_SEC,
  ...
  GNSS_NV_EFS_COMMON_DIAG_BUFFER_CFG_MASK,
  GNSS_NV_EFS_COMMON_MAX_ITEM =  GNSS_NV_EFS_COMMON_DIAG_BUFFER_CFG_MASK,
  ...
  GNSS_NV_EFS_SAML_SENSOR_STREAM_TEST_MODE_CFG,
  GNSS_NV_EFS_SAML_TILT_MAG_CAL_BUDGET_CFG,
  GNSS_NV_EFS_SAML_MAX_ITEM = GNSS_NV_EFS_SAML_TILT_MAG_CAL_BUDGET_CFG,
  ...
  GNSS_NV_EFS_LOC_ACCURACY_THRESHOLD_FOR_HIGH_ACCURACY,
  GNSS_NV_EFS_LOC_MAX_ITEM =  GNSS_NV_EFS_LOC_ACCURACY_THRESHOLD_FOR_HIGH_ACCURACY,

  /* ------------------------------------------------------------------
  SLIM items
  ------------------------------------------------------------------ */
  GNSS_NV_EFS_SLIM_MIN_ITEM,
  GNSS_NV_EFS_SLIM_TEST_CFG = GNSS_NV_EFS_SLIM_MIN_ITEM,
  GNSS_NV_EFS_SLIM_MAX_ITEM = GNSS_NV_EFS_SLIM_TEST_CFG,


  /* This should be the last item. Add all entries above this line */
  CGPS_NV_EFS_MAX_NUM_ITEMS
...
/*==============================================================================
  FUNCTION
    cgps_nv_efs_reg_item_async_write_subsid

  DESCRIPTION
    Write the specified item value to EFS2 special items file asynchronously. The
    function logs the write activity. This is a generic write function.
  ...
  RETURN VALUE
    ...
    CGPS_NV_EFS_REG_RW_STAT_INVALID - Invalid paramters
==============================================================================*/
cgps_nv_efs_reg_rw_stat_enum_type cgps_nv_efs_reg_item_async_write_subsid
(
