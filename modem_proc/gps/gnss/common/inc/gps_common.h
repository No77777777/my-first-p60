...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/gps_common.h#6 $ 
...
#define MEAS_STATUS_TDM_MEAS  (1<<14) /* TRUE -> TDM type measurement (50% duty cycled, like DPO) */
...
#define C_TIME_SRC_NAVIC_TOW_CONFIRMED          PDSM_GNSS_TIME_SRC_TOW_CONFIRMED
#define C_TIME_SRC_NAVIC_TOW_WEEK_CONFIRMED     PDSM_GNSS_TIME_SRC_TOW_WEEK_CONFIRMED
#define C_TIME_SRC_NAVIC_OTA                    PDSM_GNSS_TIME_SRC_NAVIC_TOW_DECODE
...
#define C_TIME_SRC_GTS_SV_DECODE              PDSM_GNSS_TIME_SRC_GPS_TOW_DECODE
#define C_TIME_SRC_GTS_PMIC                   PDSM_GNSS_TIME_SRC_RESERVED
...
#define C_TIME_SRC_GTS_PE_FIX                 PDSM_GNSS_TIME_SRC_NAV_SOLUTION

/* Deprecated enum mapping for VTV4 targets. They are used only on VTV1 targets */
...
#define GPS_REGIONAL_IONO_SIZE (10) /* Max number of Regional Iono Models */
...
typedef enum
{
  ...
  C_GPS_RCVR_STATE_WAIT_FOR_XO_TEMP_READ, /* Receiver is waiting for XO temperature read at start of session*/
  C_GPS_RCVR_STATE_WAIT_FOR_IMEM_EXIT,    /* Receiver is waiting for IMEM exit */
  C_GPS_RCVR_STATE_IMEM_EXIT_COMPLETED,   /* Receiver has completed IMEM exit */
...
/*=============================================================================
   GPS ME error State Indicator enumeration
=============================================================================*/
typedef enum
{
  C_GPS_ME_STATE_NO_ERROR,
  C_GPS_ME_STATE_ERROR_NAVRX_NOT_OK_TO_TURN_ON,
  C_GPS_ME_STATE_MAX
}gps_MEStateErrIndicationEnumTypeVal;
typedef uint8 gps_MEStateErrIndicationEnumType;
...
/*************************************************************************/
/* Regional Klobuchar Ionospheric Corrections                                               */
/*************************************************************************/
typedef struct
{
  uint16 w_Alpha0;                 /* Coefficients for regional Klobuchar Iono Model. */
  uint16 w_Alpha1;
  uint16 w_Alpha2;
  uint16 w_Alpha3;
  uint16 w_Beta0;
  ...
  uint16 w_Beta2;
  uint16 w_Beta3;
  uint16 w_MaxLongDeg;               /*Maximum Longitude Limit in Deg*/
  uint16 w_MinLongDeg;               /*Minimum Longitude Limit in Deg*/
  uint16 w_MaxLatDeg;                /*Maximum Latitude Limit in Deg*/
  uint16 w_MinLatDeg;                /*Minimum Latitude Limit in Deg*/

} gps_RegionalIonoStructType;

/*************************************************************************/
/* Regional Ionospheric Info                                               */
/*************************************************************************/
typedef struct
{
  uint32 q_EarthRadiusInDecimeters;      /* Radius of earth in units of 0.1m */
  uint16 w_IonoShellHeightIn100Meters;   /* Height of ionospheric shell in units of 0.1 km */
  uint8 u_NumIonoModels;                 /* Number of regional Iono Models. */
  gps_RegionalIonoStructType z_RegionIono[GPS_REGIONAL_IONO_SIZE];/*Regional Iono Model Info */

} gps_RegionalIonoInfo;
...
#define C_GPS_SVID_FULL_MASK     (0x00000000FFFFFFFFULL)
#define C_GLO_SVID_FULL_MASK     (0x0000000000FFFFFFULL)
#define C_BDS_SVID_FULL_MASK     (0x0000001FFFFFFFFFULL)
#define C_GAL_SVID_FULL_MASK     (0x0000000FFFFFFFFFULL)
#define C_QZSS_SVID_FULL_MASK     (0xFFFFFFFF)
#define C_NAVIC_SVID_FULL_MASK   (uint64)((1<<N_NAVIC_SV) - 1)
...
#define C_DELETE_INFO_NAVIC_SV_INFO         C_NAVIC_SVID_FULL_MASK
#define C_DELETE_INFO_NAVIC_EPH_INFO        C_NAVIC_SVID_FULL_MASK
#define C_DELETE_INFO_NAVIC_ALM_INFO        C_NAVIC_SVID_FULL_MASK
#define C_DELETE_INFO_NAVIC_SV_DIR_INFO     C_NAVIC_SVID_FULL_MASK
#define C_DELETE_INFO_NAVIC_SV_STEER_INFO   C_NAVIC_SVID_FULL_MASK
#define C_DELETE_INFO_NAVIC_SV_HEALTH_INFO  C_NAVIC_SVID_FULL_MASK
...
#define C_DELETE_INFO_CLOCK_NAVICTIME_EST      (1U << 24)
#define C_DELETE_INFO_CLOCK_GPSNAVIC_TB        (1U << 25) /* GPS to Navic time bias-related */
#define C_DELETE_INFO_CLOCK_GLONAVIC_TB        (1U << 26) /* GLO to Navic time bias-related */
#define C_DELETE_INFO_CLOCK_BDSNAVIC_TB        (1U << 27) /* BDS to Navic time bias-related */
#define C_DELETE_INFO_CLOCK_GALNAVIC_TB        (1U << 28) /* GAL to Navic time bias-related */
#define C_DELETE_INFO_CLOCK_NAVICWEEK_NUMBER   (1U << 29) /* Navic week number*/
#define C_DELETE_INFO_CLOCK_NAVIC_RF_GRP_DELAY (1U << 30) /* Navic RF group delay*/
...
#define FIXEVENT_NAVIC_GCF_ON           (1U << 8)

/*bits 8 - 15 reserved for future use */

/*Delete TGD constellation Mask */
typedef enum
{
  C_DELETE_INFO_TGD_GPS,
  C_DELETE_INFO_TGD_QZSS,
  C_DELETE_INFO_TGD_GLO,
  C_DELETE_INFO_TGD_BDS,
  C_DELETE_INFO_TGD_GAL,
  C_DELETE_INFO_TGD_NAVIC
} gps_DeleteTGDdata;
...
typedef enum
{
  TM_CM_NSA_5G_NOT_APPLICABLE = 0, /* 5G NSA Not applicable (Eg. If RAT is 1X, GSM, WCDMA) */
  TM_CM_NSA_5G_ENABLED = 1,        /* 5G NSA Enabled when RAT is LTE */
  TM_CM_NSA_5G_DISABLED = 2,       /* 5G NSA Disabled when RAT is LTE */
  TM_CM_NSA_5G_MAX = 0xFFFFFFFF
} cgps_nsa_5G_e_type;
...
typedef enum
{
  ...
  CGPS_SRV_SYS_WLAN   = 0x80,        /* WLAN mode*/
  CGPS_SRV_SYS_NR5G   = 0x100,       /* NR5G mode */
 ...
 */
  ...
  */
  ...
  cgps_nsa_5G_e_type        e_NSA_5G_mode; /* Indicates Non-StandAlone 5G mode (when RAT is LTE)*/
...
typedef enum
{
  ...
  C_GNSS_NPA_DPO_SLEEP,                /* To be used by MC only. Future cleanup should remove 'CPU' in the name. It's a legacy hangover */
