...
/*==============================================================================
  ...
  use ISO format for dates.
   ...
   $Header: //components/rel/gnss8.mpss/11.1/gnss/common/inc/vec_mat_math.h#1 $ 
 ...
 *  pe_InsertIdentityMatrix() sets the input matrix to an identity matrix
 ...
 *             u_Row - Row number from which the identity matrix needs to be inserted
 *             u_Col - Col number from which the identity matrix needs to be inserted
 *             u_IdentitySize - Size of the indentity matrix to be inserted
 *             u_MatSize  - The full size of the matrix e.g. 3 for 3 x 3
 *
 * Returns:  (none)
 *
 ******************************************************************************
*/
void pe_InsertIdentityMatrix(DBL * d_SquareMatrix, uint8 u_Row, uint8 u_Col, 
                             uint8 u_IdentitySize, uint8 u_MatSize);
...
/******************************************************************************
* Function description:
*  pe_VectorSum() - computes the sum of of an arbitrary
*                              length vector
* Parameters:
*    DBL d_V, q_Rows
*
* Return value:  sum of d_V, where the length of d_V is q_Rows
******************************************************************************/
DBL pe_VectorSum(const DBL *d_V, uint32 q_Rows);

/******************************************************************************
 * pe_ComputeVariance
 *
 * Function description:
 *   pe_ComputeVariance() Computes the biased variance of an array
 * 
 * Parameters: 		
 *   p_Num      : Pointer to the array
 *   u_nObs     : Number of elemnets in the array
 *
 * Return value:	
 *    The variance
 *
 ******************************************************************************
*/
DBL pe_ComputeVariance( const DBL *p_Num ,uint8 u_nObs );
