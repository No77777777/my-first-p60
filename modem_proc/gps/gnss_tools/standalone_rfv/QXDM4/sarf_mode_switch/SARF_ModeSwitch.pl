# 
#$Header: //components/rel/gnss8.mpss/11.1/gnss_tools/standalone_rfv/QXDM4/sarf_mode_switch/SARF_ModeSwitch.pl#1 $ $DateTime: 2019/10/24 01:30:36 $ $Author: pwbldsvc $
#*****************************************************************************
