##########################################################################
# $Header: //components/rel/gnss8.mpss/11.1/gnss_tools/pdapi_scripts/QXDM4/XTRA_Injection/pd_DelAll_GPS_And_GLO.pl#1 $
...
if (!$IQXDM)
{
  ...
  die;
		...
		my	$qxdm_app = $IQXDM->GetAutomationWindow();
		my	$qxdm_app2 = $qxdm_app;
