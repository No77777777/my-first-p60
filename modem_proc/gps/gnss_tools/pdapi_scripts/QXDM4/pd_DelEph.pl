##########################################################################
# $Header: //components/rel/gnss8.mpss/11.1/gnss_tools/pdapi_scripts/QXDM4/pd_DelEph.pl#1 $
...
######################################################################
  ...
  $req_coldstart->{"param_length"}    = 72; # 16 x (4 byte fields)
  #$req_coldstart->{"delete_bitmap"}   = 0x0001; # Delete Eph#New:0x000001
  $req_coldstart->{"delete_bitmap"}    = 0x000001;
  ...
  #$req_coldstart->{"gnss_delete_bitmap"} = 0x2080403;#New:0x00002080403
  $req_coldstart->{"gnss_delete_bitmap"} = 0x000002080403;
