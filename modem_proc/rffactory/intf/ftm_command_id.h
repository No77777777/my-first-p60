...
/*==============================================================================
  ...
  $Header: //components/rel/rffactory.mpss/1.0/intf/ftm_command_id.h#329 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
02/08/24   anis    RF FACTORY FR93403 CHANGES
...
typedef enum
{
  ...
  FTM_COMMON_RF_MEMORY_TEST                  = 47, /*!< 47: To test RF memory allocations & deallocations */
  ...
  FTM_NR5G_MMW_CRASH_ON_DEMAND                    = 32841, /*!< 32841: Crash On demand*/

  FTM_NR5G_RADIO_DMAC_TEMPLATE_VALIDATION         = 32842, /*!< 32842: Validate DMAC template from NR5G side*/
...
//GSM spur notch
  ...
  FTM_CHANGE_EXTRACTOR_MODE = 1087, /*!< ftm cmd to inform RFLM to change the extractor mode. Deprecate this one after DE70 */
  FTM_TRIGGER_RFLM_COMMON_DA_BLANK = 1087, /*!< ftm cmd to trigger Extractor/UWB DA blanking/unblanking. Internal Use Only */
  ...
  FTM_OVERRIDE_MTPL_PWR_UNIFIED = 1090, /*!< ftm cmd to perform unified MPTL adjust API test */

  /* Note: 1091 to 1097 are free to use */
  FTM_TRIGGER_LTE_DTR_CONTROL_COMMANDS = 1098,  
...
//NR5G commands 1100 above
  ...
  FTM_RFCAL_DEBUG_MMW_PROTOBUFFER   = 1205,
  FTM_RFCAL_DEBUG_SUB6_PROTOBUFFER  = 1206,
  ...
  FTM_GET_UNIFIED_ENH_THERM_V4 = 1275,
