...
/*======================================================================================================================
  ...
  Copyright (c) 2021-2024 Qualcomm Technologies Incorporated. All Rights Reserved
...
/*======================================================================================================================
  ...
  $Header: //components/rel/rffactory.mpss/1.0/intf/ftm_rf_ant_tuner_interface.h#10 $

when       who     what, where, why
--------   ---     -----------------------------------------------------------------------------------------------------
03/21/24   sm      Added debug msg enablement support
...
typedef enum
{
  ...
  FTM_RF_ANT_TUNER_CMD_ENABLE_DEBUG_MSGS = 4,  /*!< 4: Enable debug messages*/
...
/*--------------------------------------------------------------------------------------------------------------------*/
/*! Enumeration to indicate the debug level */
typedef enum
{
  FTM_DISABLE_DEBUG_MSGS     = 0, /*!< 0 : Disable debug F3s */

  FTM_ENABLE_ALL_DEBUG_MSGS  = 1, /*!< 1 : Enable all debug F3s */

  FTM_ENABLE_LOW_DEBUG_MSGS  = 2, /*!< 2 : Enable only low debug F3s */

  FTM_ENABLE_MED_DEBUG_MSGS  = 3, /*!< 3 : Enable all debug F3s */

  FTM_DEBUG_MSG_TYPE_NUM          /*!< Max : Invalid type */
}ftm_rf_ant_tuner_debug_msg_type;
...
/*====================================================================================================================*/
/*!
          FTM_RF_ANT_TUNER_CMD_ENABLE_DEBUG_MSGS
*/     
/*====================================================================================================================*/

/*! Defintion of structure for FTM RF Ant Tuner Enable Debug Msgs Request Data*/
typedef PACK(struct)
{
  ftm_rf_ant_tuner_field_version_type version;
  /*!< Version of Req packet */

  ftm_rf_ant_tuner_debug_msg_type     debug_level;
  /*!< Indicates the debug level of log to be enabled */

}ftm_rf_ant_tuner_enable_debug_msgs_req_data_type;


/*! Defintion of structure for FTM RF Ant Tuner Enable Debug Msgs Request Packet*/
typedef PACK(struct)
{
  ftm_rf_ant_tuner_header_req_type header;
  /*!<  Header for FTM RF Ant Tuner Enable Debug Msgs request packet */

  ftm_rf_ant_tuner_enable_debug_msgs_req_data_type req_data;
  /*!<  Request data */

}ftm_rf_ant_tuner_enable_debug_msgs_req_pkt_type;

/*! Defintion of structure for FTM RF Ant Tuner Enable Debug Msgs Response Packet*/
typedef PACK(struct)
{
  ftm_rf_ant_tuner_header_rsp_type header;
  /*!<  Header for FTM RF Ant Tuner Enable Debug Msgs response packet */

  ftm_rf_ant_tuner_enable_debug_msgs_req_data_type req_data;
  /*!<  Request data */

  ftm_rf_ant_tuner_field_version_type version;
  /*!< Version of Resp packet */

}ftm_rf_ant_tuner_enable_debug_msgs_rsp_pkt_type;
