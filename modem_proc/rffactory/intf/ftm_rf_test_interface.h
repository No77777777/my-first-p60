...
/*======================================================================================================================
  ...
  $Header: //components/rel/rffactory.mpss/1.0/intf/ftm_rf_test_interface.h#182 $
...
typedef enum
{
  ...
  FTM_RF_TEST_RADIO_CFG_PROP_SLOT_CONFIG = 65,	/*!< 65 : Slot Config (FSM) */

  FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_TYPE = 66,	/*!< 66 : Tx Droop Calibration Type (FSM) */

  FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_LUT_INDEX = 67,  /*!< 67 : Tx Droop Calibration LUT Index (FSM) */

  FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_PDET_TOTAL_POWER_DBM100 = 68,  /*!< 68 : Tx Droop Calibration PDET Total Power (dbm100) (FSM) */

  FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_PDET_DELTA_POWER_DBM100 = 69,  /*!< 69 : Tx Droop Calibration  PDET Delta Power (dbm100) (FSM) */

  FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_FREQUENCY_OFFSET_KHZ = 70,	/*!< 70 : Tx Droop Calibration Frequency Offset (kHz) (FSM) */

  FTM_RF_TEST_RADIO_CFG_PROP_DETUNE_TYPE = 71,  /*!< 71 : Detune Type */

  FTM_RF_TEST_RADIO_CFG_PROP_DETUNE_ANTENNA = 72,  /*!< 72 : Detune Antenna */

  FTM_RF_TEST_RADIO_CFG_PROP_TX_MODE = 73,  /*!< 73 : TX_MODE */
...
typedef enum
{
  ...
  FTM_RX_MEASURE_PROP_SPUR_NUM = 77, /*!< 77 : Num of spurs */

  FTM_RX_MEASURE_PROP_SPUR_FREQ = 78, /*!< 78 : Spur frequency */

  FTM_RX_MEASURE_PROP_ANT_ISO_MEAS_GAIN_DELTA = 79,

  FTM_RX_MEASURE_PROP_EIRP = 80, /*!< 80 : Action Measure EIRP */

  FTM_RX_MEASURE_PROP_EIRP_NUM_PAIRS = 81, /*!< 81 : Input Measure-EIRP Number of interpolation pairs */

  FTM_RX_MEASURE_PROP_EIRP_PAIRS = 82, /*!< 82 : Input Measure-EIRP interpolation pairs */
...
typedef enum
{
  ...
  FTM_RF_TEST_IQ_CAPTURE_TYPE_VSWR          = 12, /*!< 12: VSWR*/
  FTM_RF_TEST_IQ_CAPTURE_TYPE_IBE           = 13, /*!< 13 : IBE*/
...
typedef enum
{
  ...
  FTM_TX_CONTROL_PROP_SCS = 39,

  FTM_TX_CONTROL_PROP_NUM_OF_TONES = 40,

  FTM_TX_CONTROL_PROP_START_TONE_INDEX = 41,

  FTM_TX_CONTROL_PROP_TXD_MODE = 42, /*!< 42 : Tx diversity mode indicator */
...
typedef enum
{
  ...
  FTM_TX_MEASURE_ACTION_IBE = 226, /*!< 226 : Action - Measure In-band Emission */

  FTM_TX_MEASURE_IBE_GENERAL_POWER = 227, /*!< 227 : Response - Measure worst general power of IBE */

  FTM_TX_MEASURE_IBE_IMAGE_POWER = 228, /*!< 228 : Response - Measure image power of IBE */

  FTM_TX_MEASURE_IBE_CARRIER_LEAKAGE_POWER = 229, /*!< 229 : Response - Measure carrier leakage of IBE */

  FTM_TX_MEASURE_IBE_GENREAL_RB = 230, /*!< 230 : Response - worst general RB of IBE */

  FTM_TX_MEASURE_IBE_IMAGE_RB = 231, /*!< 231 : Response - image RB of IBE */

  FTM_TX_MEASURE_IBE_GENERAL_MARGIN = 232, /*!< 232 : Response - Measure worst general power margin of IBE */

  FTM_TX_MEASURE_IBE_IMAGE_MARGIN = 233, /*!< 233 : Response - Measure image power margin of IBE */

  FTM_TX_MEASURE_IBE_CARRIER_LEAKAGE_MARGIN = 234, /*!< 234 : Response - Measure carrier leakage margin of IBE */
...
typedef enum
{
  ...
  FTM_RF_TEST_MCS_CONFIG_PROP_BANDWIDTH = 13,  /*!< 13 : Bandwidth */

  FTM_RF_TEST_MCS_CONFIG_PROP_FREQUENCY = 14,  /*!< 14 : Center Frequency */
