...
/*======================================================================================================================
  ...
  $Header: //components/rel/rffactory.mpss/1.0/intf/ftm_unified_query_interface.h#67 $

when       who     what, where, why
--------   ---     -----------------------------------------------------------------------------------------------------
03/12/24   pwj     Add valid flag to tx rx cal path query
...
typedef enum
{
  ...
  FTM_UNIFIED_TX_INFO_PROP_MMW_RFIC_MAJOR_VER = 34, /*MMW specific*/
  FTM_UNIFIED_TX_INFO_PROP_MMW_RFIC_MINOR_VER1 = 35, /*MMW specific*/
  FTM_UNIFIED_TX_INFO_PROP_MMW_RFIC_MINOR_VER2 = 36, /*MMW specific*/
...
typedef enum
{
    ...
    FTM_RF_PATH_INFO_LNA_INFO_TYPE_MULT_GAINS_PROP     = 31, /*!< LNA info Type mult gains property */
    FTM_RF_PATH_INFO_LNA_INFO_DATA_MULT_GAINS_PROP     = 32, /*!< LNA info Data mult gains property */
    FTM_RF_PATH_INFO_VALID_FLAG_PROP                   = 33, /*!< Valid Flag for RF Test. Valid - 1; Invalid - 0; */
