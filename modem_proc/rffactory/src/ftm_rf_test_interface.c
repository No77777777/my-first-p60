...
/*======================================================================================================================
  ...
  $Header: //components/rel/rffactory.mpss/1.0/src/ftm_rf_test_interface.c#145 $
...
const char *radio_config_property_names[] =
{
  ...
  "SLOT_CONFIG",                  /* FTM_RF_TEST_RADIO_CFG_PROP_SLOT_CONFIG */
  "TX_DROOP_CAL_TYPE",            /* FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_TYPE*/
  "TX_DROOP_CAL_LUT_INDEX",       /* FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_LUT_INDEX*/
  "TX_DROOP_CAL_PDET_TOTAL_POWER",/* FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_PDET_TOTAL_POWER_DBM100*/
  "TX_DROOP_CAL_PDET_DELTA_POWER",/* FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_PDET_DELTA_POWER_DBM100*/
  "TX_DROOP_CAL_FREQUENCY_OFFSET",/* FTM_RF_TEST_RADIO_CFG_PROP_TX_DROOP_CAL_FREQUENCY_OFFSET_KHZ*/
  "DETUNE_TYPE",                  /* FTM_RF_TEST_RADIO_CFG_PROP_DETUNE_TYPE */
  "DETUNE_ANTENNA",                /* FTM_RF_TEST_RADIO_CFG_PROP_DETUNE_ANTENNA */
  "TX_MODE"                      /* FTM_RF_TEST_RADIO_CFG_PROP_TX_MODE */
};
...
const char *rx_measure_property_names[] =
{
  ...
  "SPUR_NUM",                  /*FTM_RX_MEASURE_PROP_SPUR_NUM*/
  "SPUR_FREQ",                 /*FTM_RX_MEASURE_PROP_SPUR_FREQ*/
  "ANT_ISO_MEAS_GAIN_DELTA",   /*FTM_RX_MEASURE_PROP_ANT_ISO_MEAS_GAIN_DELTA*/
  "EIRP",                      /*FTM_RX_MEASURE_PROP_EIRP*/
  "EIRP_NUM_PAIRS",            /*FTM_RX_MEASURE_PROP_EIRP_NUM_PAIRS*/
  "EIRP_PAIRS"                 /*FTM_RX_MEASURE_PROP_EIRP_PAIRS*/
};
...
const ftm_rf_test_rx_meas_property_info_t ftm_rftest_rx_meas_prop_info_list[] =
{
  ...
  { 0, FALSE },            /*FTM_RX_MEASURE_PROP_SPUR_NUM*/
  { 0, FALSE },            /*FTM_RX_MEASURE_PROP_SPUR_FREQ*/
  { 0, FALSE },            /*FTM_RX_MEASURE_PROP_ANT_ISO_MEAS_GAIN_DELTA*/
  { 0, FALSE },            /*FTM_RX_MEASURE_PROP_EIRP*/
  { 0, FALSE },            /*FTM_RX_MEASURE_PROP_EIRP_NUM_PAIRS*/
  { 0, FALSE }             /*FTM_RX_MEASURE_PROP_EIRP_PAIRS*/
};
...
const char *tx_control_property_names[] =
{
  ...
  "SCS",                  /* FTM_TX_CONTROL_PROP_SCS */
  "NUM_OF_TONES",         /* FTM_TX_CONTROL_PROP_NUM_OF_TONES */
  "START_TONE_INDEX",     /* FTM_TX_CONTROL_PROP_START_TONE_INDEX */
  "TXD_MODE"              /* FTM_TX_CONTROL_PROP_TXD_MODE */
};
...
const char *tx_measure_property_names[] =
{
  ...
  "IBE_GENERAL_POWER",
  "IBE_IMAGE_POWER",
  "IBE_CARRIER_LEAKAGE_POWER",
  "IBE_WORST_GENERAL_RB",
  "IBE_IMAGE_RB",
  "IBE_GENERAL_MARGIN",
  "IBE_IMAGE_MARGIN",
  "IBE_CARRIER_LEAKAGE_MARGIN"
};
...
const char *mcs_config_property_names[] =
{
  ...
  "BANDWIDTH",             /* FTM_RF_TEST_MCS_CONFIG_PROP_BANDWIDTH */
  "FREQUENCY"              /* FTM_RF_TEST_MCS_CONFIG_PROP_FREQUENCY */
};
