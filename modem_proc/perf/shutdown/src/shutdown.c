...
/*==========================================================================
  ...
  $Header: //components/rel/perf.mpss/4.4.2/shutdown/src/shutdown.c#1 $
...
#define PERF_N_BUSY_WAIT_THREADS (3) //RUMI has only 4 HW threads, QURT_MAX_HTHREADS is defined as 6
#else
...
static void perf_shutdown_cb(void)
{
    ...
    ps_is_safe = PERF_SHUTDOWN_YES;
    PS_DEBUG("ps_is_safe set to PERF_SHUTDOWN_YES\n");
} 
