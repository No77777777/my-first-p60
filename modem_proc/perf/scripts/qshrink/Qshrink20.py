...
$Header: //components/rel/perf.mpss/4.4.2/scripts/qshrink/Qshrink20.py#1 $
$Date: 2022/10/12 $
...
def main():
  ...
  if (update_linker_script_opt ==0) and len(args) == 0:
          ...
          print '\t --iuHashDir="IU Msg_hash.qsr4 directory"'
          exit()
  ...
  iuHashDir = ""
  if len(optDict['--iuHashDir']) == 1 :
    iuHashDir = optDict['--iuHashDir'][0]
