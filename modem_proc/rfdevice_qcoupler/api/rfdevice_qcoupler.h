...
Copyright (c) 2015-21 by QUALCOMM Technologies, Inc.  All Rights Reserved.
...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/rfdevice_qcoupler.mpss/1.32/api/rfdevice_qcoupler.h#2 $
  $DateTime: 2021/09/30 02:07:26 $
  $Author: mplcsds1 $

when       who   what, where, why
--------   ---   --------------------------------------------------------------- 
09/22/21   ks    Added APIS to update rffe register address list
10/20/15   hzh   Added default port_num/direction importing from RFC
...
#define RFDEVICE_QCOUPLER_RFC_PORT_NUM_INDEX  1
#define RFDEVICE_QCOUPLER_RFC_FWD_ATTN_INDEX  2
#define RFDEVICE_QCOUPLER_RFC_REV_ATTN_INDEX  3
#define RFDEVICE_QCOUPLER_RFC_DEFAULT_FWD_DIRECTION_INDEX  4
...
protected:
  ...
  boolean update_config_script_reg_addr(const uint16 ** script_tbl, uint8 size);
