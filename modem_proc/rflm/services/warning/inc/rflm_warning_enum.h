...
$Header: //components/rel/rflm.mpss/2.11/services/warning/inc/rflm_warning_enum.h#1 $
$Date: 2021/03/09 $ 
when         who     what, where, why
--------   ---     ----------------------------------------------------------- 
02/16/16   sbo     RFLM CCSMMU Changes
06/04/15   whz     Added enum for AutoPin
...
#define RFLM_CONFIG_WARNING_TABLE( entry ) \
  ...
  entry( RFLM_WARNING_THREAD_CFG_MISMATCH,                            			TRACE_EN|ASSERT_DIS|MSG_EN   ) \
