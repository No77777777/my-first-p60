...
$Header: //components/rel/rflm.mpss/2.11/services/math/inc/rflm_approx_uinv.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
===========================================================================*/
#ifndef RFLM_APPROX_UINV_H
#define RFLM_APPROX_UINV_H
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_uinv_linlut8
...
/*!
    ...
    rflm_approx_uinv_linlut8() specific details:-
...
*/
/*=========================================================================*/
extern uint32_result_scale_t rflm_approx_uinv_linlut8
(
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_uinv_cubelut8
...
/*!
    ...
    the output from the rflm_approx_uinv_linlut8() prototype details.

    rflm_approx_uinv_cubelut8() specific details:-
...
*/
/*=========================================================================*/
uint32_result_scale_t rflm_approx_uinv_cubelut8
(
  uint32 input  /*!< Input value */
);
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_uinv_newt
...
/*!
    ...
    rflm_approx_uinv_newt() specific details:-
...
*/
/*=========================================================================*/
extern uint32_result_scale_t rflm_approx_uinv_newt
(
  uint32 input,/*!< Input value */
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_uinv_tylr
...
/*!
    ...
    Please refer the common explanations for the input normalization and 
    the output from the rflm_approx_uinv_linlut8() prototype details. The only 
    difference here is that scale is in [1,32] & the result is a 32U number.

    rflm_approx_uinv_tylr() specific details:-
...
*/
/*=========================================================================*/
extern uint32_result_scale_t rflm_approx_uinv_tylr
(
  uint32 input,/*!< Input value */
