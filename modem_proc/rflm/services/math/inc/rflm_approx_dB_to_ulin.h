...
--------   ---     ----------------------------------------------------------
===========================================================================*/
#ifndef RFLM_APPROX_DB_TO_ULIN_H
#define RFLM_APPROX_DB_TO_ULIN_H
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_dB_to_ulin_linlut8
...
/*!
    ...
    Details specific to rflm_approx_dB_to_ulin_linlut8():
...
*/
/*=========================================================================*/
extern uint32_result_scale_t rflm_approx_dB_to_ulin_linlut8
(
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_dB_to_ulin_cubefit
...
/*!
    ...
    rflm_approx_dB_to_ulin_linlut8() prototype.
...
*/
/*=========================================================================*/
extern uint32_result_scale_t rflm_approx_dB_to_ulin_cubefit
(
  int32 input /*!< Input value */
);
...
/*===========================================================================
  ...
  FUNCTION:  rflm_approx_dB_to_ulin_quadlut8
...
*/
/*=========================================================================*/
extern uint32_result_scale_t rflm_approx_dB_to_ulin_quadlut8
(
  int32 input /*!< Input value */
);
...
#endif /* RFLM_APPROX_DB_TO_ULIN_H */
