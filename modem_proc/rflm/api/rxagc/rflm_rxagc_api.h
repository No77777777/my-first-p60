...
/*===========================================================================
    ...
    $Header: //components/rel/rflm.mpss/2.11/api/rxagc/rflm_rxagc_api.h#1 $

when       who    what, where, why
--------   ---    -------------------------------------------------------------
03/18/15   spa    Moved rflm_rxagc_lna_state_e to rflm_api_cmn.h
01/30/15   zhw     Optimization. Disable logging. Support cell_info_ptr.
...
typedef enum
{
  ...
  RFLM_CMN_RXAGC_GET_CELL_CONST_PTR ///< cmd to return ptr of static info
...
typedef struct
{
  ...
  __rx_static_info_t* cell_static_ptr; ///< Output: holds config info for cell 

} rflm_cmn_rxagc_static_data_ptr_t;
