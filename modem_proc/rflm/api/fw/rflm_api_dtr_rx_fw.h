...
/*==============================================================================
  ...
  $Header: //components/rel/rflm.mpss/2.11/api/fw/rflm_api_dtr_rx_fw.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
09/16/15   dej     New enter ADC hibernation mode API
09/11/15   dej     Add support for updating left shift value for notches
05/20/15   dej     Add support to free up Common Decimator8 filters
...
FUNCTION:  rflm_dtr_rx_adc_hibernation_enter

==============================================================================*/
extern rflm_err_t rflm_dtr_rx_adc_hibernation_enter (rflm_handle_rx_t rxlm_handle);
...
FUNCTION:  rflm_dtr_rx_free_dec8

==============================================================================*/
/*!
  @brief
  Free Decimator 8 filters

  @detail
  Mark Common Decimator 8 filters that need to be freed in the next configure chain
 
  @return
  rflm error code
*/
/*============================================================================*/
extern rflm_err_t rflm_dtr_rx_free_dec8( rflm_dtr_rx_indices_struct *rx_indices );
