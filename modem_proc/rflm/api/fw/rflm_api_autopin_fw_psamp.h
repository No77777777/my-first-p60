...
$Header: //components/rel/rflm.mpss/2.11/api/fw/rflm_api_autopin_fw_psamp.h#1 $
...
extern void rflm_autopin_update_fw_volterra_proc_result(fw_psamp_volterra_job_s * pout);
