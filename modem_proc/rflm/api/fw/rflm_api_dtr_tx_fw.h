...
$Header: //components/rel/rflm.mpss/2.11/api/fw/rflm_api_dtr_tx_fw.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/22/15   dej     Add Mutex Locking for Shared registers
...
FUNCTION:  rflm_dtr_down_sample_update

==============================================================================*/
/*!
  @brief
  Configure down sample rate
...
*/
/*============================================================================*/
rflm_err_t rflm_dtr_down_sample_update( rflm_handle_tx_t handle );
...
FUNCTION:  rflm_dtr_rx_shared_reg_lock

==============================================================================*/
/*!
  @brief
  Lock mutex for regs with chain specific fields
...
FUNCTION:  rflm_dtr_rx_shared_reg_unlock

==============================================================================*/
/*!
  @brief
  Unlock mutex for regs with chain specific fields
