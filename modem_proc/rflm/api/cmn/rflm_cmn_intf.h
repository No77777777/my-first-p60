...
$Header: //components/rel/rflm.mpss/2.11/api/cmn/rflm_cmn_intf.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/30/15   ac      w plus w bring up related changes
...
#define RFLM_CMN_TUNER_SCRIPT_DATA_BUF_SIZE_WORDS                             40
