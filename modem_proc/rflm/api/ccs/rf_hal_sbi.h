...
$DateTime: 2024/03/11 23:41:50 $ $Author: mplcsds1 $
$Header: //components/rel/rflm.mpss/2.11/api/ccs/rf_hal_sbi.h#2 $ 
...
(
  rfhal_ssbi_write_type* sbi_script, //!< Pointer to SSBI script from rf device
