...
$Header: //components/rel/rflm.mpss/2.11/api/ccs/rflm_ccs_irat_intf.h#1 $
$DateTime: 2021/03/09 05:37:22 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
10/21/15   vkm     Increase number of Cleanup RFFE transactions from 80 to 100 for setup.
06/15/15   ra     Consolidate RFLM CCS EVENT data sctructure
03/16/17   zhw    Increase number of Cleanup RFFE transactions from 60 to 80 for setup.
...
/* There is no SBI on this target */
#define RFLM_CCS_IRAT_MAX_NUM_OF_SBI 0

/* Increased from 80 to 140 to accomodate W->W QTA PRx+DRx Tune on RF cards
which has eLNA and Tuners that take more transactions than usual
Doesn't need to match RFLM_MEAS_MAX_NON_TRNSCVR_TRANS */
#define RFLM_CCS_IRAT_MAX_NUM_OF_RFFE 160

/* Increased from 100 to 160 to accomodate W->W QTA PRx+DRx Tune on RF cards
which has eLNA and Tuners that take more transactions than usual.
Should match with RFLM_MEAS_MAX_TB_NON_TRNSCVR_TRANS in rflm_meas.h */
#define RFLM_CCS_IRAT_MAX_NUM_OF_RFFE_CLEANUP 160
