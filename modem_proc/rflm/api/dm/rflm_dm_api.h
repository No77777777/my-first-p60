...
$Header: //components/rel/rflm.mpss/2.11/api/dm/rflm_dm_api.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/24/20   ssl     FR 56206: FW Recovery Changes
06/04/15   whz     Added AutoPin buffer per Tx handle
...
/*===========================================================================
  ...
  FUNCTION: rflm_dm_set_config_status

===========================================================================*/

extern rflm_err_t rflm_dm_set_config_status
(
  /*!< RFLM handle ID */
  rflm_dm_handle_id_t handle_id, 
...
/*===========================================================================
  ...
  FUNCTION: rflm_dm_get_config_status

===========================================================================*/

extern rflm_err_t rflm_dm_get_config_status
(
  /*!< Handle ID */
  rflm_dm_handle_id_t handle_id, 
...
rflm_dm_handle_meta_s * rflm_dm_get_handle_meta_ptr
(
  /*!< Handle ID */
  rflm_dm_handle_id_t handle_id
);
