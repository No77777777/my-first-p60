...
$Header: //components/rel/rflm.mpss/2.11/api/dtr/rxlm_intf.h#1 $ 
...
#define RXLM_MAX_BUFFERS RFLM_HANDLE_COUNTS
...
typedef enum  /* Bolt, Bolt+, Thor */
{
  ...
  RXLM_CHAIN_3,
  RXLM_CHAIN_FBRX,
#if defined(FEATURE_BOLT_PLUS_MODEM) || defined(T_MDM9X45) || defined(T_MSM8996)
  RXLM_CHAIN_5,
  RXLM_CHAIN_6,
#endif
  RXLM_CHAIN_MAX,
