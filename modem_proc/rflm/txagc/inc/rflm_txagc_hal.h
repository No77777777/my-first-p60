...
Copyright (c) 2013-2016  by Qualcomm Technologies, Inc. (QTI).  All Rights Reserved.
===========================================================================*/
...
--------   ---     ------------------------------------------------------------- 
02/02/16   nv      Changing ccs fixup API prototype for early fixup
11/24/15   sub     Adding rflm_txagc_remove_fbrx_fixup prototype
09/26/15   bn      CMN fixup API change
08/05/15   ac      reset api before both fixups
...
/*---------------------------------------------------------------------------*/
void rflm_txagc_w_reset_trigger_addr
(
  uint32 chain_idx,
  uint32 *ccs_addr
);
