...
$Header: //components/rel/rflm.mpss/2.11/autopin/inc/rflm_autopin.h#1 $

when       who    what, where, why
--------   ---    ------------------------------------------------------------- 
03/28/20   pvsr   Increase Apin buffers to align with Tx handles
