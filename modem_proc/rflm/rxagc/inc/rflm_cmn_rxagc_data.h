...
Notice that changes are listed in reverse chronological order.
    ...
    $Header: //components/rel/rflm.mpss/2.11/rxagc/inc/rflm_cmn_rxagc_data.h#1 $
...
/*----------------------------------------------------------------------------*/
rflm_err_t
rflm_cmn_rxagc_i_get_cell_data_ptr
(
  __wb_buffer_info_t* wb_ptr,
  rflm_cmn_rxagc_static_data_ptr_t* cell_data
);
...
void* get_rflm_cmn_rxagc_master_data(uint32* size);
#endif
