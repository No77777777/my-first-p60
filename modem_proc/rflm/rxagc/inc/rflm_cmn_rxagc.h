...
$Header: //components/rel/rflm.mpss/2.11/rxagc/inc/rflm_cmn_rxagc.h#1 $

when       who    what, where, why
--------   ---    -------------------------------------------------------------- 
08/23/15   sty    reverted previous chnage - need to ensure that RxAGC module
                  and DTR module are in sync. So need to use 
                  RFLM_DM_DTR_RX_BUF_COUNTS
08/22/15   sty    temp change - increase buffer number - RFLM_HANDLE_COUNTS
