...
/*==============================================================================
  ...
  Copyright (c) 2013,  2014-2015 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/rflm.mpss/2.11/rftech/tdscdma/inc/rflm_tds_dm_intf.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/19/16   nsh     Expand HDET reading MAX transaction
12/10/15   jr      Phase 1 device status read
10/06/15   whz     Add support to AutoPin script for TA
08/14/15   al      Increase the max payload in TDS off_to_rx scripts
06/15/15   ych     Increase max # of home restore script buf
05/31/15   lwu     Increase RFLM_TDS_RF_EVT_IFREQ_STARTUP_EVENT_RX_ACTIVATE_ISSUE_SEQ_SCRIPT_BUF_X_TYPE_MAX_TASKS from 7 to 10
05/21/15   al      Increase TX-related event size
05/01/15   jak     Optimize JDET & IP2 cal script size allocated in DM buffer
04/30/15   jak     Fix JDET reading registers pair for consecutive DL condition
04/13/15   jr      Increase RFLM_TDS_RF_EVT_BUILD_WAKEUP_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS from 150 to 185
03/24/15   lwu     Increase RFLM_TDS_RFC_MAX_DEVICE_INSTANCES_PER_BAND from 5 to 7 to
				   fix KW error due to RFC_MAX_DEVICE_INSTANCES_PER_BAND increased  
03/03/15   al      Increase TX-related events size to support high number of ASMs
...
#define RFLM_TDS_RFC_MAX_DEVICE_INSTANCES_PER_BAND  7
...
#define RFLM_TDS_MAX_NUM_HOME_RESTORE_SCRIPT_BUFFER 3
#define RFLM_TDS_MAX_NUM_DEVICE_STATUS_READ_SCRIPT_BUFFER 2
...
typedef tfw_do_vswr_event_vswr_coupler_fwd_script_t rflm_tds_vswr_coupler_fwd_script_t;                                
typedef tfw_do_vswr_event_vswr_coupler_rev_script_t rflm_tds_vswr_coupler_rev_script_t;                            
...
#define RFLM_TDS_RF_EVT_OFF_TO_RX_EVENT_RX_ACTIVATE_ISSUE_SEQ_SCRIPT_BUF_X_TYPE_MAX_RFFE_TRANSACTIONS 14
/* SSBI: 2 address/data pairs per 32 bit word; ext-RFFE needs 2*32 bit word */
...
*/ 
#define RFLM_TDS_RF_EVT_TX_TO_OFF_EVENT_TX_DEACTIVATE_ISSUE_SEQ_SCRIPT_BUF_X_TYPE_MAX_TASKS             17
...
*/ 
#define RFLM_TDS_RF_EVT_TX_TO_OFF_EVENT_TXRX_DEACTIVATE_ISSUE_SEQ_SCRIPT_BUF_X_TYPE_MAX_TASKS             24
...
*/ 
#define RFLM_TDS_RF_EVT_TX_TO_RX_EVENT_RX_ACTIVATE_TX_DEACTIVATE_ISSUE_SEQ_SCRIPT_BUF_X_TYPE_MAX_TASKS             20
...
#else
#define RFLM_TDS_RF_EVT_IFREQ_STARTUP_EVENT_RX_ACTIVATE_ISSUE_SEQ_SCRIPT_BUF_X_TYPE_MAX_TASKS             7
#endif 
...
#else
#define RFLM_TDS_RF_EVT_BUILD_WAKEUP_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS 150
#endif
/* SSBI: 2 address/data pairs per 32 bit word; ext-RFFE needs 2*32 bit word */
...
#define RFLM_TDS_RF_EVT_DO_HDET_EVENT_HDET_READ_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS 20
/* SSBI: 2 address/data pairs per 32 bit word; ext-RFFE needs 2*32 bit word */
...
/** VSWR_COUPLER_FWD_SCRIPT Type 
*/ 
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_MAX_TASKS             2
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_MAX_SSBI_TRANSACTIONS 0
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS 6
/* SSBI: 2 address/data pairs per 32 bit word; ext-RFFE needs 2*32 bit word */
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_PAYLOAD \
      ((RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_MAX_SSBI_TRANSACTIONS + 1)/2 \
      + RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS *2)

RFLM_TDS_GENERIC_CCS_EVENT_TYPEDEF( rflm_tds_vswr_coupler_fwd_script_t, \
                               RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_MAX_TASKS, \
                               RFLM_TDS_RF_EVT_VSWR_COUPLER_FWD_SCRIPT_TYPE_PAYLOAD);


/** VSWR_COUPLER_REV_SCRIPT Type 
*/ 
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_MAX_TASKS             2
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_MAX_SSBI_TRANSACTIONS 0
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS 6
/* SSBI: 2 address/data pairs per 32 bit word; ext-RFFE needs 2*32 bit word */
#define RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_PAYLOAD \
      ((RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_MAX_SSBI_TRANSACTIONS + 1)/2 \
      + RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS *2)

RFLM_TDS_GENERIC_CCS_EVENT_TYPEDEF( rflm_tds_vswr_coupler_rev_script_t, \
                               RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_MAX_TASKS, \
                               RFLM_TDS_RF_EVT_VSWR_COUPLER_REV_SCRIPT_TYPE_PAYLOAD);
...
/*---------------------------------------------------------------------------*/
/*                        Device Status Read Scripts Definitions                  */
/*---------------------------------------------------------------------------*/

/* 
** DEVICE_STATUS_READ_SCRIPT Type 
*/ 
#define RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_MAX_TASKS             2
#define RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_MAX_SSBI_TRANSACTIONS 0
#define RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS 20
/* SSBI: 2 address/data pairs per 32 bit word; ext-RFFE needs 2*32 bit word */
#define RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_PAYLOAD \
      ((RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_MAX_SSBI_TRANSACTIONS + 1)/2 \
      + RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_MAX_RFFE_TRANSACTIONS *2)

RFLM_TDS_GENERIC_CCS_EVENT_TYPEDEF( rflm_tds_device_status_read_script_t, \
                               RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_MAX_TASKS, \
                               RFLM_TDS_RF_EVT_DEVICE_STATUS_READ_SCRIPT_TYPE_PAYLOAD);
...
typedef struct 
{
  ...
  //VSWR coupler fwd and rev
  rflm_tds_vswr_coupler_fwd_script_t                                                vswrCouplerFWDScript;
  rflm_tds_vswr_coupler_rev_script_t                                                vswrCouplerREVScript;

  //AutoPin
  rflm_tds_autopin_write_script_t                                                   autopinWriteScript[2];

  rflm_tds_device_status_read_script_t                                              deviceStatusReadScript[2];
