...
$Header: //components/rel/rflm.mpss/2.11/rftech/tdscdma/inc/rflm_tds_msg_proc.h#1 $
...
06/05/15   whz     Add AutoPin suppport
...
void rflm_tds_msgr_send_device_read_trigger (void *arg);
