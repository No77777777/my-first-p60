...
$Header: //components/rel/rflm.mpss/2.11/rftech/gsm/inc/rflm_gsm_ccs.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/10/15   tws     Add FBRX VSWR support
10/07/15   tws     Add new API to set a new task priority
...
rflm_ustmr_t rflm_gsm_ccs_convert_trigger_time_to_ustmr( rflm_ustmr_t trig_time );
