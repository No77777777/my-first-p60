...
from sectools.common.utils.c_platform import bin_names, is_windows_on_arm, packaged_bin_folder
        ...
        for filename in filenames:
            ...
            # Searching in prepacked dir, current dir and system paths
                ...
                if is_windows_on_arm():
                    module = c_path.join(os.path.dirname(os.path.abspath(__file__)),
                                         "..", "..", "..", "..", "bin", "WoS", "openssl.exe")
