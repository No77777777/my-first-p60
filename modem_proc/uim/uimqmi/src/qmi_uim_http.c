...
Copyright (c) 2016, 2022 QUALCOMM Technologies, Incorporated and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/uimqmi/src/qmi_uim_http.c#3 $ $DateTime: 2022/05/05 04:38:11 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/04/22   rps     Fix buffer flow while copying data
10/07/16   ks      Fix to support bigger profile (> 65535) download
05/27/16   ks      MACRO for memory freeing
05/16/16   bcho    Deregister qmi uim https service on task stop
05/16/16   ks      APPS to register with QMI HTTP service using reset request
