...
$Header: //components/rel/uim.mpss/6.1.0/uimqmi/src/uimqmi_task.h#2 $ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
...
extern rex_tcb_type         * uimqmi_tcb_ptr;
#define UIM_UIMQMI_TASK_TCB   uimqmi_tcb_ptr
