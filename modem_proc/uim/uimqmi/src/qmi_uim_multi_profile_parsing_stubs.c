/*==============================================================================
         ...
         Q M I _ U I M _ M U L T I _ P R O F I L E _ P A R S I N G _ S T U B S _ C
...
$Header: //components/rel/uim.mpss/6.1.0/uimqmi/src/qmi_uim_multi_profile_parsing_stubs.c#1 $
...
)
{
  (void)sdu_in;
  (void)len;
  (void)euicc_profile_name_data_ptr;
  return QMI_ERR_NOT_SUPPORTED;
...
)
{
  (void)sdu_in;
  (void)len;
  (void)euicc_default_address_ptr;
