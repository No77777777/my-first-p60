...
$Header: //components/rel/uim.mpss/6.1.0/uimqmi/src/qmi_uim_cat_common.c#2 $$ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
...
10/22/15   tkl     Set cmd_type when process framework cmd
09/04/15   at      Include qmi_uim_offtarget.h to use offtarget APIs
...
/*===========================================================================
  ...
  PARAMETERS
    ...
    max_slots           : Tell sthe maximum number of slots available
...
)
{
  ...
  ASSERT (msg_ptr && cmd_buf_p && cmd_buf_p->x_p && cmd_buf_p->x_p->cl_sp);
...
)
{
  ...
  cmd_buf_p->cmd_type = ps_ntohs(temp);
