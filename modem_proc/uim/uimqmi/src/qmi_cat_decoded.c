...
Copyright (c) 2009-2017 QUALCOMM Technologies, Inc(QTI).
All Rights Reserved.
QUALCOMM Technologies Confidential and Proprietary

$Header: //components/rel/uim.mpss/6.1.0/uimqmi/src/qmi_cat_decoded.c#2 $$ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     -----------------------------------------------------------
09/12/17   av      Fix potential compilation error
08/24/17   vr      Send raw envelope response to all raw envelope requests
...
09/10/15   tkl     Fixed max len for USSD string
...
01/16/15   hh      Added Class R support
...
#define CATI_PRM_TYPE_CONTACTLESS_FUNCTIONALITY_STATE (0x6C)
...
#define CATI_DECODED_TR_BATTERY_STATUS_TLV            (0x16)
...
#define CATI_ENV_TYPE_CONTACTLESS_STATE_REQUEST       (0x25)
#define CATI_ENV_TYPE_INDICATION_TOKEN                (0x26)
#define CATI_ENV_TYPE_IMS_REQUEST_URI_TRUNCATED       (0x28)
...
)
{
  ...
  *qmi_dcs = (uint8)CAT_DCS_7BIT_GSM_V02;
...
)
{
  PACKED struct PACKED_POST
  {
    ...
    uint8                    text[QMI_CAT_ITEM_TEXT_MAX_LENGTH_V02];
  } text_string_tlv;
  ...
  /* No need to check max size... length_of_string is uint8 and
     QMI_CAT_ITEM_TEXT_MAX_LENGTH_V02 is 255 */
...
)
{
  ...
  {
    high_priority_tlv = CAT_HIGH_PRIORITY_CLEAR_SCREEN_V02;
  }
  else
  {
    high_priority_tlv = CAT_HIGH_PRIORITY_DONT_CLEAR_SCREEN_V02;
  }
...
)
{
  ...
  {
    user_control_tlv = CAT_USER_CONTROL_ALLOW_SCREEN_CLEARING_V02;
  }
  else
  {
    user_control_tlv = CAT_USER_CONTROL_DONT_ALLOW_SCREEN_CLEARING_V02;
  }
...
)
{
  PACKED struct PACKED_POST
  {
    ...
    uint8       rec_num;
    uint16      data_size;
    uint8       data[QMI_CAT_ICON_DATA_SIZE_MAX_V02];
  } icon_tlv;
  ...
  switch(gstk_icon->image_coding_scheme)
  {
    case GSTK_UNKNOWN_IMAGE_CODE_SCHEME:
      icon_tlv.ics = CAT_ICON_ICS_UNKNOWN_V02;
      break;
    case GSTK_BASIC_IMAGE_CODE_SCHEME:
      icon_tlv.ics = CAT_ICON_ICS_BASIC_V02;
      break;
    case GSTK_COLOUR_IMAGE_CODE_SCHEME:
      icon_tlv.ics = CAT_ICON_ICS_COLOR_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
  ...
  /* Data */
  if (gstk_icon->size > QMI_CAT_ICON_DATA_SIZE_MAX_V02)
  {
    return QMI_ERR_INTERNAL;
  }
  if (gstk_icon->size > 0 &&
...
)
{
  ...
  switch(gstk_response_format)
  {
    case GSTK_SMS_DEF_ALPHABET:
      response_format_tlv = CAT_RESPONSE_FORMAT_SMS_DEFAULT_ALPHA_V02;
      break;

    case GSTK_YES_NO:
      response_format_tlv = CAT_RESPONSE_FORMAT_YES_OR_NO_V02;
      break;

    case GSTK_NUMERICAL_ONLY:
      response_format_tlv = CAT_RESPONSE_FORMAT_NUMERICAL_ONLY_V02;
      break;

    case GSTK_UCS2_ALPHABET:
      response_format_tlv = CAT_RESPONSE_FORMAT_UCS2_V02;
      break;

    case GSTK_IMMEDIATE_DIGIT_RSP:
      response_format_tlv = CAT_RESPONSE_FORMAT_IMMEDIATE_DIGIT_RESP_V02;
      break;

    case GSTK_YES_NO_AND_IMM_DGT_RSP:
      response_format_tlv = CAT_RESPONSE_FORMAT_YES_OR_NO_AND_IMMEDIATE_DIGIT_RESP_V02;
      break;
...
)
{
  ...
  switch(gstk_response_packing_format)
  {
    case GSTK_UNPACK_FORMAT:
      response_packing_format_tlv = CAT_RESPONSE_PACKING_FORMAT_UNPACKED_V02;
      break;
    case GSTK_PACK_FORMAT:
      response_packing_format_tlv = CAT_RESPONSE_PACKING_FORMAT_PACKED_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  {
    show_user_input_tlv = CAT_SHOW_USER_INPUT_CLEAR_V02;
  }
  else
  {
    show_user_input_tlv = CAT_SHOW_USER_INPUT_MASKED_V02;
  }
...
)
{
  ...
  switch(gstk_launch_mode)
  {
    case GSTK_LAUNCH_IF_NOT_ALREADY_LAUNCH:
      launch_mode_tlv = CAT_LAUNCH_MODE_NOT_ALREADY_LAUNCHED_V02;
      break;
    case GSTK_USE_EXISTING_BROWSER:
      launch_mode_tlv = CAT_LAUNCH_MODE_USE_EXISTING_BROWSER_V02;
      break;
    case GSTK_CLOSE_EXISTING_BROWSER:
      launch_mode_tlv = CAT_LAUNCH_MODE_CLOSE_EXISTING_BROWSER_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  {
    uint8 length;
    uint8 url[QMI_CAT_URL_MAX_LENGTH_V02];
  } url_tlv;
...
)
{
  ...
  {
    uint16 length;
    uint8  bearer_list[QMI_CAT_BEARER_LIST_MAX_V02];
  } bearer_type_tlv;
  ...
  if (gstk_bearer->length > 0)
  {
    ...
    for (i = 0; i < gstk_bearer->length; i++)
    {
      ...
      {
        case GSTK_SMS:
          bearer_type_tlv.bearer_list[i] = CAT_BEARER_LIST_SMS_V02;
          break;
        case GSTK_CSD:
          bearer_type_tlv.bearer_list[i] = CAT_BEARER_LIST_CSD_V02;
          break;
        case GSTK_USSD_BEARER_CODE:
          bearer_type_tlv.bearer_list[i] = CAT_BEARER_LIST_USSD_V02;
          break;
        case GSTK_GPRS:
          bearer_type_tlv.bearer_list[i] = CAT_BEARER_LIST_GPRS_V02;
          break;
        case GSTK_BEARER_DEFAULT:
          bearer_type_tlv.bearer_list[i] = CAT_BEARER_LIST_DEFAULT_V02;
          break;
        default:
          return QMI_ERR_INTERNAL;
      }
...
)
{
  ...
  {
    case GSTK_DIAL_TONE:
      tone_tlv = CAT_TONE_DIAL_TONE_V02;
      break;
    case GSTK_CALLED_SUBSCRIBER_BUSY:
      tone_tlv = CAT_TONE_CALLED_SUBSCRIBER_BUSY_V02;
      break;
    case GSTK_CONGESTION:
      tone_tlv = CAT_TONE_CONGESTION_V02;
      break;
    case GSTK_RADIO_PATH_ACK:
      tone_tlv = CAT_TONE_RADIO_PATH_ACK_V02;
      break;
    case GSTK_RADIO_PATH_NOT_AVAIL_CALL_DROP:
      tone_tlv = CAT_TONE_RADIO_PATH_NOT_AVAILABLE_CALL_DROP_V02;
      break;
    case GSTK_ERROR_TONE:
      tone_tlv = CAT_TONE_ERROR_TONE_V02;
      break;
    case GSTK_CALL_WAITING_TONE:
      tone_tlv = CAT_TONE_CALL_WAITING_TONE_V02;
      break;
    case GSTK_RINGING_TONE:
      tone_tlv = CAT_TONE_RINGING_TONE_V02;
      break;
    case GSTK_GENERAL_BEEP:
      tone_tlv = CAT_TONE_GENERAL_BEEP_V02;
      break;
    case GSTK_POSITIVE_ACK_TONE:
      tone_tlv = CAT_TONE_POSITIVE_ACK_TONE_V02;
      break;
    case GSTK_NEGATIVE_ACK_TONE:
      tone_tlv = CAT_TONE_NEGATIVE_ACK_TONE_V02;
      break;
    case GSTK_RINGING_TONE_SELECTED_BY_USER:
      tone_tlv = CAT_TONE_RINGING_TONE_SELECT_BY_USER_V02;
      break;
    case GSTK_SMS_ALERT_TONE_SELECTED_BY_USER:
      tone_tlv = CAT_TONE_SMS_ALERT_TONE_SELECT_BY_USER_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  switch(gstk_presentation)
  {
    case GSTK_PRESENTATION_NOT_SPECIFIED:
      presentation_tlv = CAT_PRESENTATION_NOT_SPECIFIED_V02;
      break;
    case GSTK_DATA_VALUE_PRESENTATION:
      presentation_tlv = CAT_PRESENTATION_DATA_VALUE_V02;
      break;
    case GSTK_NAVIGATION_PRESENTATION:
      presentation_tlv = CAT_PRESENTATION_NAVIGATION_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  {
    soft_key_selection_tlv = CAT_SK_SELECTION_SELECTED_V02;
  }
  else
  {
    soft_key_selection_tlv = CAT_SK_SELECTION_NOT_SELECTED_V02;
  }
...
)
{
  ...
  {
    uint8  num_of_items;
    uint8  next_action_list[QMI_CAT_ACTION_LIST_MAX_V02];
  ...
  for (i = 0; i < gstk_next_action_indicator->num_items; i++)
  {
    switch(gstk_next_action_indicator->next_action_list[i])
    {
      case GSTK_CMD_STK_SET_UP_CALL:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SETUP_CALL_V02;
        break;
      case GSTK_CMD_STK_SEND_SS:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SEND_SS_V02;
        break;
      case GSTK_CMD_STK_USSD:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SEND_USSD_V02;
        break;
      case GSTK_CMD_STK_SEND_SHORT_MESSAGE:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SEND_SHORT_MESSAGE_V02;
        break;
      case GSTK_CMD_STK_LAUNCH_BROWSER:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_LAUNCH_BROWSER_V02;
        break;
      case GSTK_CMD_STK_PLAY_TONE:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_PLAY_TONE_V02;
        break;
      case GSTK_CMD_STK_DISPLAY_TEXT:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_DISPLAY_TEXT_V02;
        break;
      case GSTK_CMD_STK_GET_INKEY:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_GET_INKEY_V02;
        break;
      case GSTK_CMD_STK_GET_INPUT:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_GET_INPUT_V02;
        break;
      case GSTK_CMD_STK_SELECT_ITEM:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SELECT_ITEM_V02;
        break;
      case GSTK_CMD_STK_SET_UP_MENU:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SETUP_MENU_V02;
        break;
      case GSTK_CMD_STK_SET_UP_IDLE_MODE_TEXT:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_SETUP_IDLE_MODE_TEXT_V02;
        break;
      case GSTK_CMD_STK_END_OF_PROACTIVE_SES:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_END_OF_PROACTIVE_SESSION_V02;
        break;
      case GSTK_CMD_STK_PROVIDE_LOCAL_INFO:
        next_action_indicator_tlv.next_action_list[j++] = CAT_NEXT_ACTION_LIST_PROVIDE_LOCAL_INFORMATION_V02;
        break;
      default:
...
)
{
  ...
  for (i = 0; i < gstk_icon_id_list->num_items; i++)
  {
    ...
    /* Data */
    if (gstk_icon_id_list->icon_list[i]->size > QMI_CAT_ICON_DATA_SIZE_MAX_V02)
    {
      uimqmi_free(tlv_data);
      return QMI_ERR_INTERNAL;
    }
...
)
{
  ...
  {
    uint8  length;
    uint8  sms_tpdu[QMI_CAT_SMS_TPDU_MAX_LENGTH_V02];
  } sms_tpdu_tlv;
...
)
{
  PACKED struct PACKED_POST
  {
    ...
    uint8 npi;
    uint8 length;
    uint8 address[QMI_CAT_ADDRESS_MAX_LENGTH_V02];
  } address_tlv;
  ...
  switch(gstk_address->TON)
  {
    ...
    case GSTK_RFU_TON:
      address_tlv.ton = CAT_TON_UNKNOWN_V02;
      break;
    case GSTK_INTERNATIONAL_NUM:
      address_tlv.ton = CAT_TON_INTERNATIONAL_NUMBER_V02;
      break;
    case GSTK_NATIONAL_NUM:
      address_tlv.ton = CAT_TON_NATIONAL_NUMBER_V02;
      break;
    case GSTK_NETWORK_SPECIFIC_NUM:
      address_tlv.ton = CAT_TON_NETWORK_SPECIFIC_NUMBER_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
  ...
  switch(gstk_address->NPI)
  {
    ...
    case GSTK_RFU_NPI:
      address_tlv.npi = CAT_NPI_UNKNOWN_V02;
      break;
    case GSTK_ISDN_TELEPHONY_NPI:
      address_tlv.npi = CAT_NPI_ISDN_TELE_V02;
      break;
    case GSTK_DATA_NPI:
      address_tlv.npi = CAT_NPI_DATA_V02;
      break;
    case GSTK_TELEX_NPI:
      address_tlv.npi = CAT_NPI_TELEX_V02;
      break;
    case GSTK_PRIVATE_NPI:
      address_tlv.npi = CAT_NPI_PRIVATE_V02;
      break;
    case GSTK_EXT_RESERVED_NPI:
      address_tlv.npi = CAT_NPI_EXTENSION_RESERVED_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
  ...
  if (gstk_address->length > QMI_CAT_ADDRESS_MAX_LENGTH_V02)
  {
    return QMI_ERR_INTERNAL;
  }
...
)
{
  PACKED struct PACKED_POST
  {
    ...
    uint8 dcs;
    uint8 length;
    uint8 text[QMI_CAT_USSD_STRING_MAX_LENGTH_V02];
  } ussd_string_tlv;
  ...
  /* No need to check max size... length is uint8 and
     QMI_CAT_SUBADDRESS_MAX_LENGTH_V02 is 255 */
...
)
{
  ...
  switch(gstk_call_setup_req)
  {
    case GSTK_NO_OTHER_CALLS:
      call_setup_req_tlv = CAT_CALL_SETUP_REQ_NO_OTHER_CALLS_V02;
      break;
    case GSTK_HOLD_ACTIVE_CALLS:
      call_setup_req_tlv = CAT_CALL_SETUP_REQ_HOLD_ACTIVE_CALLS_V02;
      break;
    case GSTK_DISCONNECT_ACTIVE_CALLS:
      call_setup_req_tlv = CAT_CALL_SETUP_REQ_DISCONNECT_ACTIVE_CALLS_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  {
    uint8  length;
    uint8 subaddress[QMI_CAT_SUBADDRESS_MAX_LENGTH_V02];
  } subaddress_tlv;
  ...
  if (gstk_subaddress->length > QMI_CAT_SUBADDRESS_MAX_LENGTH_V02)
  {
    return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  {
    uint8  length;
    uint8  dtmf_data[QMI_CAT_DTMF_MAX_LENGTH_V02];
  } dtmf_tlv;
  ...
  /* No need to check max size... length is uint8 and
     QMI_CAT_DTMF_MAX_LENGTH_V02 is 255 */
...
)
{
     ...
     gstk_network_access_name->alphabet != NULL)
  {
    ...
    {
      if(gstk_network_access_name->length > QMI_CAT_ITEM_TEXT_MAX_LENGTH_V02)
      {
...
)
{
  ...
  switch(gstk_data_transport_level.transport_protocol)
  {
    case GSTK_PKT_DATA_NOT_PRESENT:
      data_transport_level_tlv.transport_protocol = CAT_TRANSPORT_PROTOCOL_NOT_PRESENT_V02;
      break;
    case GSTK_PKT_DATA_UDP:
      data_transport_level_tlv.transport_protocol = CAT_TRANSPORT_PROTOCOL_UDP_V02;
      break;
    case GSTK_PKT_DATA_TCP:
      data_transport_level_tlv.transport_protocol = CAT_TRANSPORT_PROTOCOL_TCP_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  switch (bip_status)
  {
     case CAT_BIP_STATUS_IN_PROGRESS_V02:
       bip_status_tlv.bip_status = CAT_BIP_STATUS_IN_PROGRESS_V02;
       break;
     case CAT_BIP_STATUS_END_V02:
       bip_status_tlv.bip_status = CAT_BIP_STATUS_END_V02;
       break;
     default:
...
)
{
  ...
  switch(gstk_activate_target)
  {
    case GSTK_TARGET_UICC_CLF:
      activate_target_tlv.activate_target = CAT_TARGET_UICC_CLF_V02;
      break;
...
)
{
  ...
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_DISPLAY_TEXT_V02, gstk_hdr, resp);
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_GET_INKEY_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_GET_INPUT_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_LAUNCH_BROWSER_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_PLAY_TONE_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SELECT_ITEM_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SEND_SMS_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SEND_SS_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SEND_USSD_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  switch(gstk_hdr.tag)
  {
    case GSTK_TAG_DISPLAY_ALPHA:
    case GSTK_TAG_ORIGINAL_CMD:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_CALL_ALPHA_DISPLAY_V02, gstk_hdr, resp);
      break;
    case GSTK_TAG_USER_CONF_ALPHA:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_CALL_USER_CONFIRMATION_V02, gstk_hdr, resp);
      break;
    default:
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_MENU_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_IDLE_TEXT_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SEND_DTMF_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_LANG_NOTIFICATION_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  switch(gstk_hdr.command_id)
  {
    case GSTK_SETUP_EVT_USER_ACT_NOTIFY:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_EVENT_USER_ACTIVITY_V02, gstk_hdr, resp);
      break;
    case GSTK_SETUP_EVT_IDLE_SCREEN_NOTIFY:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_EVENT_IDLE_SCREEN_NOTIFY_V02, gstk_hdr, resp);
      break;
    case GSTK_SETUP_EVT_LANG_SEL_NOTIFY:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_EVENT_LANGUAGE_SEL_NOTIFY_V02, gstk_hdr, resp);
      break;
    case GSTK_SETUP_EVT_HCI_CONNECT_NOTIFY:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_EVENT_HCI_CONNECTIVITY_V02, gstk_hdr, resp);
      break;
    case GSTK_SETUP_EVT_BROWSER_TERM_NOTIFY:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_EVENT_BROWSER_TERMINATION_V02, gstk_hdr, resp);
      break;
    case GSTK_SETUP_EVT_CONTACTLESS_STATE_REQ_NOTIFY:
      errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SETUP_EVENT_CONTACTLESS_STATE_REQ_V02, gstk_hdr, resp);
      break;
    default:
      errval = QMI_ERR_INTERNAL;
      break;
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv( CAT_COMMAND_ID_PROVIDE_LOCAL_LANG_INFO_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_OPEN_CHANNEL_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_CLOSE_CHANNEL_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_RECEIVE_DATA_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_SEND_DATA_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_ACTIVATE_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv( CAT_COMMAND_ID_REFRESH_ALPHA_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
/*===========================================================================
  FUNCTION QMI_CATI_POPULATE_GEOGRAPHICAL_LOCATION_COMMAND()

  DESCRIPTION
    To populate the tlvs from the geographical location proactive command
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static qmi_error_e_type qmi_cati_populate_geographical_location_command
(
  const gstk_geo_loc_req_type  * geo_loc_cmd,
  const gstk_exp_hdr_type        gstk_hdr,
  dsm_item_type               ** resp
)
{
  ...
  ASSERT(geo_loc_cmd != NULL);

  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_GEOGRAPHICAL_LOCATION_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
  ...
  /* Send the alpha TLV */
  if(geo_loc_cmd->alpha.length != 0)
  {
    errval = qmi_cati_alphabet_tlv(&geo_loc_cmd->alpha, resp, CATI_PRM_TYPE_ALPHA);
    if (errval != QMI_ERR_NONE)
    {
      goto send_result;
    }
  ...
  /* Check if the icon is present */
  if (geo_loc_cmd->icon.present)
  {
    errval = qmi_cati_icon_tlv(&geo_loc_cmd->icon, resp, CATI_PRM_TYPE_ICON);
    if (errval != QMI_ERR_NONE)
    {
      goto send_result;
    }
...
send_result:
  return errval;
} /* qmi_cati_populate_geographical_location_command */


/*===========================================================================
  FUNCTION QMI_CATI_POPULATE_CONTACTLESS_STATE_CHANGED_COMMAND()

  DESCRIPTION
    to populate the tlvs from the contactless state changed proactive command

  PARAMETERS
    contactless_state_changed_cmd : Decoded contactless state changed cmd
    gstk_hdr                  : Header of the proactive command
    resp                      : pointer to tlv
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static qmi_error_e_type qmi_cati_populate_contactless_state_changed_command
(
  const gstk_contactless_state_changed_req_type  *contactless_state_changed_cmd,
  const gstk_exp_hdr_type                         gstk_hdr,
  dsm_item_type                                 **resp
)
{
  ...
  PACKED struct PACKED_POST
  {
    uint32  contactless_state;
  } contactless_state_tlv;

  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_CONTACTLESS_STATE_CHANGED_V02,
                                       gstk_hdr,
                                       resp);
  if (errval != QMI_ERR_NONE)
  {
  ...
  switch (contactless_state_changed_cmd->state)
  {
    case GSTK_CONTACTLESS_FUNC_STATE_DISABLED:
      contactless_state_tlv.contactless_state = CAT_CONTACTLESS_FUNCTIONALITY_DISABLED_V02;
      break;
    case GSTK_CONTACTLESS_FUNC_STATE_ENABLED:
      contactless_state_tlv.contactless_state = CAT_CONTACTLESS_FUNCTIONALITY_ENABLED_V02;
      break;
    default:
      return QMI_ERR_INTERNAL;
  }

  if( FALSE == qmi_svc_put_param_tlv(resp,
                                     CATI_PRM_TYPE_CONTACTLESS_FUNCTIONALITY_STATE,
                                     sizeof(contactless_state_tlv),
                                     (void *)&contactless_state_tlv) )
  {
    UIM_MSG_MED_0("Unable to send CONTACTLESS FUNCTIONALITY STATE TLV!");
    errval = QMI_ERR_NO_MEMORY;
  }

  return errval;
} /* qmi_cati_populate_contactless_state_changed_command */


/*===========================================================================
  FUNCTION QMI_CATI_POPULATE_PROVIDE_BATTERY_STATUS_COMMAND()

  DESCRIPTION
    to populate the tlvs from the provide battery status proactive command
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static qmi_error_e_type qmi_cati_populate_provide_battery_status_command
(
  const gstk_exp_hdr_type               gstk_hdr,
  dsm_item_type                         ** resp
)
{
  ...
  /* Send the command header TLV */
  errval = qmi_cati_pro_cmd_header_tlv(CAT_COMMAND_ID_PROVIDE_LOCAL_INFO_BATTERY_V02, gstk_hdr, resp);
  if (errval != QMI_ERR_NONE)
  {
    goto send_result;
  }
...
send_result:
  return errval;
} /* qmi_cati_populate_provide_battery_status_command */
...
)
{
  ...
  {
    case GSTK_SLOT_1:
      tlv_data.slot_id = CAT_SLOT1_V02;
      break;
    case GSTK_SLOT_2:
      tlv_data.slot_id = CAT_SLOT2_V02;
      break;
    case GSTK_SLOT_3:
      tlv_data.slot_id = CAT_SLOT3_V02;
      break;
    default:
...
)
{
  ...
  /* find dcs value of items */
  /* set default to 8 bit SMS default DCS */
  alphabet_tlv.dcs = CAT_DCS_8BIT_GSM_V02;
     ...
     gstk_alphabet->alphabet != NULL)
  {
    ...
    {
      /* unicode */
      alphabet_tlv.dcs = CAT_DCS_8BIT_UCS2_V02;
      if(gstk_alphabet->length > (QMI_CAT_ITEM_TEXT_MAX_LENGTH_V02 / 2))
      {
    ...
    {
      alphabet_tlv.dcs = CAT_DCS_8BIT_GSM_V02;
      if(gstk_alphabet->length > QMI_CAT_ITEM_TEXT_MAX_LENGTH_V02)
      {
        UIM_MSG_MED_0("Invalid GSTK alphabet length");
        return QMI_ERR_NO_MEMORY;
      }
  ...
  if(alphabet_tlv.length_of_string > 0)
  {
    ...
    {
      if(alphabet_tlv.dcs == CAT_DCS_8BIT_GSM_V02)
      {
      ...
      else if (alphabet_tlv.dcs == CAT_DCS_8BIT_UCS2_V02)
      {
        for(i = 0; i < alphabet_tlv.length_of_string; i++)
        {
...
)
{
  ...
  switch (decoded_cmd->hdr_cmd.command_id)
  {
    ...
    case GSTK_CONTACTLESS_STATE_CHANGED_REQ:
      errval = qmi_cati_populate_contactless_state_changed_command(
                    &decoded_cmd->cmd.contactless_state_changed_cmd_req,
                    decoded_cmd->hdr_cmd,
                    ind);
      break;

    case GSTK_GEO_LOC_REQ:
      errval = qmi_cati_populate_geographical_location_command(
                    &decoded_cmd->cmd.geo_loc_pro_cmd_req,
                    decoded_cmd->hdr_cmd,
                    ind);
      break;

    case GSTK_PROVIDE_BATTERY_STATUS_REQ:
      errval = qmi_cati_populate_provide_battery_status_command(
                    decoded_cmd->hdr_cmd,
                    ind);
      break;
...
)
{
  ...
  /* Check length */
  if (raw_data_len > QMI_CAT_RAW_PROACTIVE_CMD_MAX_LENGTH_V02)
  {
    return QMI_ERR_NO_MEMORY;
  }
...
)
{
  ...
  {
    uint8   custom_tp_len;
    uint8   custom_tp[QMI_CAT_TERMINAL_PROFILE_MAX_LENGTH_V02];
  } tlv_custom_tp;

    /* Check length */
  if (custom_tp_len > QMI_CAT_TERMINAL_PROFILE_MAX_LENGTH_V02)
  {
    return QMI_ERR_NO_MEMORY;
  }
...
)
{
  ...
  ASSERT(sdu_in != NULL && tlv_present_ptr != NULL && buffer_ptr != NULL);
...
)
{
  ...
  while (*sdu_in)
  {
    ...
    switch(type)
    {
      ...
      case CATI_DECODED_TR_BATTERY_STATUS_TLV:
        result = qmi_cat_extract_packed_tlv(sdu_in, len,
                                            &parsed_data_ptr->battery_status_present,
                                            sizeof(parsed_data_ptr->battery_status),
                                            sizeof(parsed_data_ptr->battery_status),
                                            &parsed_data_ptr->battery_status);
        break;
  ...
  if (result == QMI_ERR_NONE)
  {
    ...
    /* Check on value of battery status */
    if (parsed_data_ptr->battery_status_present &&
        parsed_data_ptr->battery_status.status > 6)
    {
      result = QMI_ERR_MALFORMED_MSG;
    }
  }
...
)
{
  ...
  while (*sdu_in)
  {
    ...
    switch(type)
    {
      ...
      case CATI_ENV_TYPE_CONTACTLESS_STATE_REQUEST:
        result = qmi_cat_extract_packed_tlv(sdu_in, len,
                                            &parsed_data_ptr->contactless_state_request_present,
                                            sizeof(parsed_data_ptr->contactless_state_request),
                                            sizeof(parsed_data_ptr->contactless_state_request),
                                            &parsed_data_ptr->contactless_state_request);
        break;
      ...
      case CATI_ENV_TYPE_INDICATION_TOKEN:
       ...
       case CATI_ENV_TYPE_IMS_REQUEST_URI_TRUNCATED:
        result = qmi_cat_extract_packed_tlv(sdu_in, len,
                                            &parsed_data_ptr->ims_uri_truncated_present,
                                            sizeof(parsed_data_ptr->ims_uri_truncated),
                                            sizeof(parsed_data_ptr->ims_uri_truncated),
                                            &parsed_data_ptr->ims_uri_truncated);
        break;
...
)
{
  ...
  switch (cc_result)
  {
    case GSTK_ALLOWED_NO_MOD:
      cc_result_tlv_data.call_control_result = CAT_ENVELOPE_CALL_CONTROL_RESULT_ALLOWED_NO_MOD_V02;
      break;
    case GSTK_NOT_ALLOWED:
      cc_result_tlv_data.call_control_result = CAT_ENVELOPE_CALL_CONTROL_RESULT_NOT_ALLOWED_V02;
      break;
    case GSTK_ALLOWED_BUT_MOD:
      cc_result_tlv_data.call_control_result = CAT_ENVELOPE_CALL_CONTROL_RESULT_ALLOWED_WITH_MOD_V02;
      break;
    default:
...
)
{
  ...
  if (src_act_len > 0)
  {
    ...
    {
      uint8 length;
      uint8 act_param[QMI_CAT_PDP_CONTEXT_ACT_MAX_LENGTH_V02];
    } act_tlv_data;
...
{
  if (req_ptr->gstk_address_string.ims_call.length > QMI_CAT_IMS_URI_MAX_LENGTH_V02)
  {
    return QMI_ERR_NO_MEMORY;
  }
  ...
  if (req_ptr->gstk_address_string.ims_call.length > 0)
  {
    ...
    {
      uint8 length;
      uint8 ims_request_uri[QMI_CAT_IMS_URI_MAX_LENGTH_V02];
    } ims_call_tlv_data;
...
)
{
  ...
  switch (req_ptr->bc_repeat_ind)
  {
    case GSTK_ALTERNATE_MODE:
      bc_rep_ind_tlv.ind = CAT_BC_REPEAT_INDICATOR_ALTERNATE_MODE_V02;
      break;
    case GSTK_SEQUENTIAL_MODE:
      bc_rep_ind_tlv.ind = CAT_BC_REPEAT_INDICATOR_SEQUENTIAL_MODE_V02;
      break;
    default:
      return QMI_ERR_NONE;
  }
