#ifndef __SIMLOCK_HWIO_MACROS_SDM630_H__
#define __SIMLOCK_HWIO_MACROS_SDM630_H__
/*
===========================================================================
*/
/**
  @file simlock_hwio_macros_sdm630.h
  @brief Auto-generated HWIO interface include file.

  Reference chip release:
    SDM630 (Starhawk) [starhawk_v1.0_p3q2r70_F0]
...
/*
  ...
  $Header: //components/rel/uim.mpss/6.1.0/simlock/src/hw/simlock_hwio_macros_sdm630.h#1 $
...
#define HWIO_QFPROM_RAW_QC_SPARE_REGIONn_PHYS(n)                                                 (SECURITY_CONTROL_CORE_REG_BASE_PHYS + 0x00000120 + 0x4 * (n))
...
#define HWIO_QFPROM_CORR_QC_SPARE_REGIONn_PHYS(n)                                                (SECURITY_CONTROL_CORE_REG_BASE_PHYS + 0x00004120 + 0x4 * (n))
...
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_ADDR                                                (TCSR_TCSR_MUTEX_REG_BASE      + 0x00022010)
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_PHYS                                                (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00022010)
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_RMSK                                                       0x1
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_IN          \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_PWR_ON_ADDR, HWIO_TCSR_LPASS_Q6SS_PWR_ON_RMSK)
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_INM(m)      \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_PWR_ON_ADDR, m)
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_LPASS_Q6SS_PWR_ON_BMSK                                     0x1
#define HWIO_TCSR_LPASS_Q6SS_PWR_ON_LPASS_Q6SS_PWR_ON_SHFT                                     0x0
...
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_ADDR                                           (TCSR_TCSR_MUTEX_REG_BASE      + 0x00026000)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_PHYS                                           (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00026000)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_RMSK                                                  0x1
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_IN          \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_ADDR, HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_RMSK)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_INM(m)      \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_ADDR, m)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_OUT(v)      \
        out_dword(HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_ADDR,v)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_OUTM(m,v) \
        out_dword_masked_ns(HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_ADDR,m,v,HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_IN)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_LPASS_Q6SS_AXI_HALTREQ_BMSK                           0x1
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTREQ_LPASS_Q6SS_AXI_HALTREQ_SHFT                           0x0

#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_ADDR                                           (TCSR_TCSR_MUTEX_REG_BASE      + 0x00026004)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_PHYS                                           (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00026004)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_RMSK                                                  0x1
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_IN          \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_ADDR, HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_RMSK)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_INM(m)      \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_ADDR, m)
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_LPASS_Q6SS_AXI_HALTACK_BMSK                           0x1
#define HWIO_TCSR_LPASS_Q6SS_AXI_HALTACK_LPASS_Q6SS_AXI_HALTACK_SHFT                           0x0

#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_ADDR                                       (TCSR_TCSR_MUTEX_REG_BASE      + 0x00026008)
#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_PHYS                                       (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00026008)
#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_RMSK                                              0x1
#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_IN          \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_ADDR, HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_RMSK)
#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_INM(m)      \
        in_dword_masked(HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_ADDR, m)
#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_LPASS_Q6SS_AXI_MASTER_IDLE_BMSK                   0x1
#define HWIO_TCSR_LPASS_Q6SS_AXI_MASTER_IDLE_LPASS_Q6SS_AXI_MASTER_IDLE_SHFT                   0x0

#define HWIO_TCSR_TURING_Q6SS_PWR_ON_ADDR                                               (TCSR_TCSR_MUTEX_REG_BASE      + 0x00026010)
#define HWIO_TCSR_TURING_Q6SS_PWR_ON_PHYS                                               (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00026010)
#define HWIO_TCSR_TURING_Q6SS_PWR_ON_RMSK                                                      0x1
#define HWIO_TCSR_TURING_Q6SS_PWR_ON_IN          \
        in_dword_masked(HWIO_TCSR_TURING_Q6SS_PWR_ON_ADDR, HWIO_TCSR_TURING_Q6SS_PWR_ON_RMSK)
#define HWIO_TCSR_TURING_Q6SS_PWR_ON_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_Q6SS_PWR_ON_ADDR, m)
#define HWIO_TCSR_TURING_Q6SS_PWR_ON_TURING_Q6SS_PWR_ON_BMSK                                   0x1
#define HWIO_TCSR_TURING_Q6SS_PWR_ON_TURING_Q6SS_PWR_ON_SHFT                                   0x0
...
#define HWIO_TCSR_TURING_AXIM_HALTREQ_ADDR                                              (TCSR_TCSR_MUTEX_REG_BASE      + 0x00034000)
#define HWIO_TCSR_TURING_AXIM_HALTREQ_PHYS                                              (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00034000)
#define HWIO_TCSR_TURING_AXIM_HALTREQ_RMSK                                                     0x1
#define HWIO_TCSR_TURING_AXIM_HALTREQ_IN          \
        in_dword_masked(HWIO_TCSR_TURING_AXIM_HALTREQ_ADDR, HWIO_TCSR_TURING_AXIM_HALTREQ_RMSK)
#define HWIO_TCSR_TURING_AXIM_HALTREQ_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_AXIM_HALTREQ_ADDR, m)
#define HWIO_TCSR_TURING_AXIM_HALTREQ_OUT(v)      \
        out_dword(HWIO_TCSR_TURING_AXIM_HALTREQ_ADDR,v)
#define HWIO_TCSR_TURING_AXIM_HALTREQ_OUTM(m,v) \
        out_dword_masked_ns(HWIO_TCSR_TURING_AXIM_HALTREQ_ADDR,m,v,HWIO_TCSR_TURING_AXIM_HALTREQ_IN)
#define HWIO_TCSR_TURING_AXIM_HALTREQ_TURING_AXIM_HALTREQ_BMSK                                 0x1
#define HWIO_TCSR_TURING_AXIM_HALTREQ_TURING_AXIM_HALTREQ_SHFT                                 0x0

#define HWIO_TCSR_TURING_AXIM_HALTACK_ADDR                                              (TCSR_TCSR_MUTEX_REG_BASE      + 0x00034004)
#define HWIO_TCSR_TURING_AXIM_HALTACK_PHYS                                              (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00034004)
#define HWIO_TCSR_TURING_AXIM_HALTACK_RMSK                                                     0x1
#define HWIO_TCSR_TURING_AXIM_HALTACK_IN          \
        in_dword_masked(HWIO_TCSR_TURING_AXIM_HALTACK_ADDR, HWIO_TCSR_TURING_AXIM_HALTACK_RMSK)
#define HWIO_TCSR_TURING_AXIM_HALTACK_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_AXIM_HALTACK_ADDR, m)
#define HWIO_TCSR_TURING_AXIM_HALTACK_TURING_AXIM_HALTACK_BMSK                                 0x1
#define HWIO_TCSR_TURING_AXIM_HALTACK_TURING_AXIM_HALTACK_SHFT                                 0x0

#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_ADDR                                          (TCSR_TCSR_MUTEX_REG_BASE      + 0x00034008)
#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_PHYS                                          (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00034008)
#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_RMSK                                                 0x1
#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_IN          \
        in_dword_masked(HWIO_TCSR_TURING_AXIM_MASTER_IDLE_ADDR, HWIO_TCSR_TURING_AXIM_MASTER_IDLE_RMSK)
#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_AXIM_MASTER_IDLE_ADDR, m)
#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_TURING_AXIM_MASTER_IDLE_BMSK                         0x1
#define HWIO_TCSR_TURING_AXIM_MASTER_IDLE_TURING_AXIM_MASTER_IDLE_SHFT                         0x0
...
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_ADDR                                           (TCSR_TCSR_MUTEX_REG_BASE      + 0x00035000)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_PHYS                                           (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00035000)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_RMSK                                                  0x1
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_IN          \
        in_dword_masked(HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_ADDR, HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_RMSK)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_ADDR, m)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_OUT(v)      \
        out_dword(HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_ADDR,v)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_OUTM(m,v) \
        out_dword_masked_ns(HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_ADDR,m,v,HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_IN)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_TURING_Q6_SMMU_HALTREQ_BMSK                           0x1
#define HWIO_TCSR_TURING_Q6_SMMU_HALTREQ_TURING_Q6_SMMU_HALTREQ_SHFT                           0x0

#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_ADDR                                           (TCSR_TCSR_MUTEX_REG_BASE      + 0x00035004)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_PHYS                                           (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00035004)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_RMSK                                                  0x1
#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_IN          \
        in_dword_masked(HWIO_TCSR_TURING_Q6_SMMU_HALTACK_ADDR, HWIO_TCSR_TURING_Q6_SMMU_HALTACK_RMSK)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_Q6_SMMU_HALTACK_ADDR, m)
#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_TURING_Q6_SMMU_HALTACK_BMSK                           0x1
#define HWIO_TCSR_TURING_Q6_SMMU_HALTACK_TURING_Q6_SMMU_HALTACK_SHFT                           0x0

#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_ADDR                                       (TCSR_TCSR_MUTEX_REG_BASE      + 0x00035008)
#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_PHYS                                       (TCSR_TCSR_MUTEX_REG_BASE_PHYS + 0x00035008)
#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_RMSK                                              0x1
#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_IN          \
        in_dword_masked(HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_ADDR, HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_RMSK)
#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_INM(m)      \
        in_dword_masked(HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_ADDR, m)
#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_TURING_Q6_SMMU_MASTER_IDLE_BMSK                   0x1
#define HWIO_TCSR_TURING_Q6_SMMU_MASTER_IDLE_TURING_Q6_SMMU_MASTER_IDLE_SHFT                   0x0


#endif /* __SIMLOCK_HWIO_MACROS_SDM630_H__ */
