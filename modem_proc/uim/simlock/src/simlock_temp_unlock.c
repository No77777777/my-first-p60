...
$Header: //components/rel/uim.mpss/6.1.0/simlock/src/simlock_temp_unlock.c#2 $$ $DateTime: 2019/10/30 06:56:05 $
...
08/12/15   stv     Remove temporary unlock end condition where an end is not sent
...
06/09/15   stv     Success for temp unlock req when no time is available
