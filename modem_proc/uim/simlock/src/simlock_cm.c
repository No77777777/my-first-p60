...
$Header: //components/rel/uim.mpss/6.1.0/simlock/src/simlock_cm.c#2 $$ $DateTime: 2019/10/30 06:56:05 $
...
)
{
  ...
  ret_val = simlock_util_is_device_in_emergency_mode(config_file_data_ptr);
