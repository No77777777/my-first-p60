...
07/15/15   lm      Changes to route all rcinit API's through stub code for offtarget
...
extern rex_tcb_type            * simlock_tcb_ptr;
#define UIM_SIMLOCK_TCB          simlock_tcb_ptr
...
#define SIMLOCK_MMGSDI_EVT_SIG               0x00040000
...
typedef enum {
  ...
  SIMLOCK_DELAY_TIMER_EXPIRY_CMD
