...
DESCRIPTION
 ...
 Copyright (c) 2002 - 2018 by QUALCOMM Technologies, Inc(QTI)
 All Rights Reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmgsdi.h#2 $
...
extern q_type pbm_notify_evt_q;    /* Queue to manage notify events */
