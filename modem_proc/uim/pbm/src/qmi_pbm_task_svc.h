...
Copyright (c) 2011,2014 - 2015, 2018 QUALCOMM Technologies, Inc(QTI).
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/uim.mpss/6.1.0/pbm/src/qmi_pbm_task_svc.h#2 $
  $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
...
---------------------------------------------------------------------------*/
  ...
  QMI_PBM_SERVICE_PBM_SIGNAL     = 17,  /* PBM service signal          */
  QMI_PBM_TIMED_SLEEP_SIGNAL     = 18,  /* PBM timed sleep signal         */
