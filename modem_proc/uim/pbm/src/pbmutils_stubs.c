...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmutils_stubs.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/19/17    bcho   Moving QCRIL ECC DB to PBM
07/21/16    sp     ECC optimizations for IoE device
...
/*===========================================================================
FUNCTION pbm_clear_globals

DESCRIPTION

This function is called when task exit signal is received to clear all the
caches and free memory allocated for globals
