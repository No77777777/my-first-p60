...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmtask_i.h#2 $
...
typedef enum
{
   ...
   PBM_CMD_DEPRECATED_1,                 /* PBM write lock -- Deprecated */
   PBM_CMD_DEPRECATED_2,                 /* PBM write unlock -- -- Deprecated */
