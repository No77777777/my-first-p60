...
Copyright (c) 2002 - 2017, 2025 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmutils.h#4 $
...
#define PBM_ECC_MAX_LEN                          15
#define PBM_ECC_MIN_LEN                          3
#define PBM_AAS_GAS_KNOWN_REC_LEN                1
#define PBM_MAX_ECC_NUMBERS                      50
#define PBM_MAX_RECS_IN_LINEAR_FIXED_CYCLIC_EF   254
#define PBM_MAX_REC_LEN_IN_CYCLIC_EF             254
#define PBM_MAX_REC_LEN_IN_LINEAR_FIXED_EF       255
#define PBM_EF_PHONEBOOK_MANDATORY_REC_LEN       14
#define PBM_PSC_LENGTH                           4
#define PBM_PUID_LENGTH                          2
#define PBM_CC_LENGTH                            2
...
#define PBM_SS_SYS_ID_CHANGED(x)          ((x) & CM_SS_SYS_ID_MASK) 
...
#define PBM_MAX_G_SIM_FIELD   4

//represent efs
extern pbm_g_efs_field_info_s_type g_efs_field_info;
//represent adn & fdn & grpname for all sessions
extern pbm_g_other_field_info_s_type *g_sim_field_info_ptr[MAX_UIM_APPS][PBM_MAX_G_SIM_FIELD];
extern pbm_g_other_field_info_s_type  g_sim_field_info_default[PBM_MAX_G_SIM_FIELD];
...
DESCRIPTION
  ...
  g_rest_field_info, g_sim_field_info_ptr, g_efs_field_info
...
SIDE EFFECTS
===========================================================================*/
pbm_return_type pbm_check_pb_ready(pbm_phonebook_type pb_id);
...
SIDE EFFECTS
===========================================================================*/
boolean pbm_match_found(pbm_cat_e_type category,
...
===========================================================================*/
extern boolean pbm_util_is_valid_sups_string(
  char   *sups_str,
  uint8   sups_str_len,
  int    *pos, 
  boolean find_pos
...
===========================================================================*/
extern boolean pbm_util_get_ss_ton_status_of_queried_number(
