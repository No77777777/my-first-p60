...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmgsdi_refresh.c#1 $
...
{
  uint8         num_file_devices                          = 0;
  int           refresh_file                              = 0;
  int           file_group_index                          = 0;
  int           file_device_index                         = 0;
  int           i                                         = 0;
  pbm_file_type pbm_file_group                            = PBM_FILE_NONE;
  pbm_file_type affected_groups[PBM_FILE_MAX_REQUESTS]    = {PBM_FILE_NONE,};
  int           num_affected_groups                       = 0;
  uint32        file_set                                  = 0;
  ...
  pbm_refresh_info[session_type].pbm_refresh_num_files = (uint8)pbm_refresh_file_list_p->num_files;
...
)
{
  ...
  pbm_file_type              pbm_file_iterator  = PBM_FILE_NONE;
  pbm_file_type              pbm_file           = PBM_FILE_NONE;
  ...
  {
    local = (uint8)pbm_util_return_fileset_for_session(session_type);
