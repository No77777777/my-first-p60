...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmuim.h#2 $
...
#define PBM_NUM_EXTN_FILES        5
#define PBM_SIZE_INITIALIZE_LIST  48/*PBM_SIZE_INITIALIZE_LIST is the number of pbm file ids that will be in*/
...
extern pbm_file_type pbm_extn_files[PBM_NUM_EXTN_FILES];
...
extern pbm_usim_path_lookup_table_element_T  pbm_usim_path_lookup_table_default[PBM_NUM_FILES_IN_LOOKUP_TABLE];
extern pbm_usim_path_lookup_table_element_T *pbm_usim_path_lookup_table_ptr[PBM_SESSION_MAX][PBM_NUM_FILES_IN_LOOKUP_TABLE];

extern mmgsdi_get_file_attr_cnf_type  *pbr_file_attr_ptr[MAX_UIM_APPS];
