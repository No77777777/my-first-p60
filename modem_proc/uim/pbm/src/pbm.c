...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2002 - 2016, 2020 by QUALCOMM Technologies, Inc(QTI).
  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbm.c#3 $
...
uint8  pbm_features_total_till_version[] =
  {PBM_FEATURES_STATUS_LIST_VERSION0_COUNT,
   ...
   PBM_FEATURES_STATUS_LIST_VERSION2_COUNT};
  ...
  pbm_nv_features_enum_type  nv_feature)
{
  ...
  switch(nv_feature)
  {
    ...
    case PBM_FEATURE_ECC_HARDCODE_SIM_ABSENT_LIST_TILL_PIN_LOCK :
	  ...
	  break;
    case PBM_FEATURE_DISABLE_PBM_SYNCHRONIZATION:
	  ret_value = pbm_features_status_list.disable_pbm_synchronization;
      break;      
    default:
      return ret_value;
  }
  ...
  pbm_nv_features_enum_type nv_feature)
{
  switch(nv_feature)
  {
    ...
    break;
    case PBM_FEATURE_DISABLE_PBM_SYNCHRONIZATION:
      pbm_features_status_list.disable_pbm_synchronization = PBM_FEATURE_DISABLED;
      break;
