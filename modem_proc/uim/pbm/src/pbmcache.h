...
DESCRIPTION
  ...
  Copyright (c) 2002 - 2010, 2014 - 2016 by QUALCOMM Technologies, Inc(QTI)  
  All Rights Reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmcache.h#2 $
...
#define PBM_CACHE_ALLOCATE_AND_INIT(cache_ptr, pbm_file, pb_session_type)                   \
{                                                                                           \
  if(cache_ptr[pb_session_type] == NULL)                                                    \
  {                                                                                         \
    PBM_MEM_ALLOC(cache_ptr[pb_session_type], sizeof(PB_CACHE));                            \
  }                                                                                         \
  else                                                                                      \
  {                                                                                         \
    memset(cache_ptr[pb_session_type], 0, sizeof(PB_CACHE));                                \
  }                                                                                         \
  if(cache_ptr[pb_session_type] == NULL)                                                    \
  {                                                                                         \
    return PBM_ERROR;                                                                       \
  }                                                                                         \
  cache_ptr[pb_session_type]->pb_id =  pbm_file_id_to_pb_id(pb_session_type, (pbm_file));   \
}


#define PBM_CACHE_INIT(cache_ptr, pbm_file, pb_session_type, err_code)                      \
{                                                                                           \
  if(cache_ptr == NULL)                                                                     \
  {                                                                                         \
  ...
  {                                                                                         \
    (cache_ptr)->pb_id =  pbm_file_id_to_pb_id(pb_session_type, (pbm_file));                \
  }                                                                                         \
}
...
in the build.
===========================================================================*/
extern PB_CACHE                 *adn_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *sdn_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *fdn_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *lnd_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *grpname_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *aas_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *oci_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *ici_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *mbdn_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *hidden_cache_ptr[MAX_UIM_APPS];

extern PB_CACHE                 *msisdn_cache_ptr[MAX_UIM_APPS];
extern PB_CACHE                 *mbn_cache_ptr[MAX_UIM_APPS];
...
===========================================================================*/
extern pbm_ext_cache_s_type     *ext1_cache_ptr[MAX_UIM_APPS];
extern pbm_ext_cache_s_type     *ext2_cache_ptr[MAX_UIM_APPS];
extern pbm_ext_cache_s_type     *ext3_cache_ptr[MAX_UIM_APPS];
extern pbm_ext_cache_s_type     *ext5_cache_ptr[MAX_UIM_APPS];
extern pbm_ext_cache_s_type     *ext6_cache_ptr[MAX_UIM_APPS];

extern PB_MASTER_USIM_CACHE     *adn_m_usim_cache_ptr[MAX_UIM_APPS][PBM_MAX_NUM_PB_SETS];

extern PB_USIM_CACHE            *sne_cache_ptr[MAX_UIM_APPS][PBM_MAX_NUM_PB_SETS];
extern PB_USIM_CACHE            *anr_cache_ptr[MAX_UIM_APPS][PBM_MAX_NUM_SAME_USIM_FILES*PBM_MAX_NUM_PB_SETS];
extern PB_USIM_CACHE            *email_cache_ptr[MAX_UIM_APPS][PBM_MAX_NUM_PB_SETS];
extern PB_USIM_CACHE            *grp_cache_ptr[MAX_UIM_APPS][PBM_MAX_NUM_PB_SETS];

extern PB_MASTER_SYNC_CACHE     *adn_m_sync_cache_ptr[MAX_UIM_APPS];

extern PB_SYNC1_CACHE           *psc_cache_ptr[MAX_UIM_APPS];
extern PB_SYNC1_CACHE           *cc_cache_ptr[MAX_UIM_APPS];
extern PB_SYNC1_CACHE           *puid_cache_ptr[MAX_UIM_APPS];
extern PB_SYNC2_CACHE           *uid_cache_ptr[MAX_UIM_APPS];
extern PB_SYNC2_CACHE           *pbc_cache_ptr[MAX_UIM_APPS];
