...
DESCRIPTION
 ...
 Copyright (c) 2002 - 2021 by QUALCOMM Technologies, Inc(QTI) 
 All Rights Reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbm.h#4 $
...
06/05/18   nr      Update MCC source correctly in case limited roam
...
#define PBM_FEATURES_STATUS_LIST_CURRENT_COUNT    4
#define PBM_FEATURES_STATUS_LIST_CURRENT_VERSION  2
...
#define PBM_FEATURES_STATUS_LIST_VERSION2_COUNT   4
...
typedef struct {
  ...
  /* Phonebook synchronization feature enabled or diabled decided according to below feature */
  pbm_feature_status_enum_type disable_pbm_synchronization;
  /* RFU should calculated based on the the actual number of bytes 
     used for defining a new feature.*/
...
typedef enum {
  ...
  PBM_FEATURE_DISABLE_PBM_SYNCHRONIZATION
...
typedef enum
{
  PBM_ECC_MCC_SOURCE_IMSI = 0x00,
  PBM_ECC_MCC_SOURCE_IMSI_M,
  PBM_ECC_MCC_SOURCE_ICCID,
  PBM_ECC_MCC_SOURCE_LIMITED_HOME_NW,
  PBM_ECC_MCC_SOURCE_LIMITED_ROAM_NW,
  PBM_ECC_MCC_SOURCE_EFS,
  PBM_ECC_MCC_SOURCE_MAX
}pbm_ecc_mcc_soruce_type;
...
===========================================================================*/
void pbm_nv_init_features_status_nv_lookup(
  void
);
...
SIDE EFFECTS
===========================================================================*/
void pbm_nv_hardcoded_ecc_config_read(
  void
);
