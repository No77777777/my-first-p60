...
$Header: //components/rel/uim.mpss/6.1.0/pbm/src/pbmlibutils.c#2 $
...
01/07/16   sp      Fix possible integer overflow
                            ...
                            const uint32 *sizes)
{
   ...
   /* Definately, an unusual pointer cast. */
...
SIDE EFFECTS
  None.
===========================================================================*/
uint32 pbmutils_wstrlen(
  const uint16 *ucs2_str
)
{
