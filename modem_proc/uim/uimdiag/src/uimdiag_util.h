...
Copyright (c) 2009, 2011 - 2020 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
12/23/16   dt    Support for QXDM sim data collection logs
12/02/16   vdc   Added support to check RSA public key for remote lock
11/03/16   me    Updated uimdiag_generic_req_type structure 
...
#define UIMDIAG_MAX_CLIENT_REQ_TBL_SIZE         0x28
...
/*===========================================================================
   ...
   DESCRIPTION:
     ...
     MMGSDI - 64000 - 65000 -  some of the Commands are deprecated. for the list
                               refer below this enum table
=============================================================================*/
typedef enum
{
  UIMDIAG_NONE_CMD,
  ...
  UIMDIAG_SIMLOCK_HCK_LOCK_CMD                                    = 60001,
  UIMDIAG_SIMLOCK_CK_LOCK_CMD                                     = 60002,
  UIMDIAG_SIMLOCK_UNLOCK_CMD                                      = 60003,
  UIMDIAG_SIMLOCK_GET_STATUS_CMD                                  = 60004,
  DEPRECATED_0                                                    = 60005,
  UIMDIAG_SIMLOCK_ADD_LOCK_CODES_HCK_CMD                          = 60006,
  UIMDIAG_SIMLOCK_ADD_LOCK_CODES_CK_CMD                           = 60007,
  UIMDIAG_SIMLOCK_GET_CATEGORY_DATA_EXT_CMD                       = 60008,
  UIMDIAG_SIMLOCK_REMOTE_LOCK_CHECK_PUBLIC_KEY_CMD                = 60009,
  UIMDIAG_SIMLOCK_PROBE_CK_CMD                                    = 60010,
  UIMDIAG_SIMLOCK_SET_RSU_MODE_CMD                                = 60011,
  UIMDIAG_SIMLOCK_SET_RSU_KEY_CMD                                 = 60018,
  UIMDIAG_SIMLOCK_SET_CONFIGURATION_CMD                           = 60019,
  UIMDIAG_SIMLOCK_GET_RSU_MODE_CMD                                = 60020,
  ...
  UIMDIAG_MMGSDI_SESSION_ACT_OR_SW_PROV_CMD                       = 64004,
  UIMDIAG_MMGSDI_SESSION_GET_INFO_CMD                             = 64005,
  UIMDIAG_MMGSDI_SESSION_GET_ALL_PIN_STATUS_CMD                   = 64006,
  UIMDIAG_MMGSDI_SESSION_VERIFY_PIN_CMD                           = 64007,
  UIMDIAG_MMGSDI_SESSION_DISABLE_PIN_CMD                          = 64008,
  UIMDIAG_MMGSDI_SESSION_ENABLE_PIN_CMD                           = 64009,
  UIMDIAG_MMGSDI_SESSION_CHANGE_PIN_CMD                           = 64010,
  UIMDIAG_MMGSDI_SESSION_UNBLOCK_PIN_CMD                          = 64011,
  UIMDIAG_MMGSDI_SESSION_GET_FILE_ATTR_CMD                        = 64012,
  UIMDIAG_MMGSDI_SESSION_READ_RECORD_CMD                          = 64013,
  UIMDIAG_MMGSDI_SESSION_READ_TRANSPARENT_CMD                     = 64014,
  UIMDIAG_MMGSDI_SESSION_WRITE_RECORD_CMD                         = 64015,
  UIMDIAG_MMGSDI_SESSION_WRITE_TRANSPARENT_CMD                    = 64016,
  UIMDIAG_MMGSDI_SESSION_REG_FOR_REFRESH_CMD                      = 64017,
  UIMDIAG_MMGSDI_SESSION_DEREG_FOR_REFRESH_CMD                    = 64018,
  UIMDIAG_MMGSDI_SESSION_OK_TO_REFRESH_CMD                        = 64019,
  UIMDIAG_MMGSDI_SESSION_REFRESH_COMPLETE_CMD                     = 64020,
  DEPRECATED_1                                                    = 64021,
  DEPRECATED_2                                                    = 64022,
  DEPRECATED_3                                                    = 64023,
  DEPRECATED_4                                                    = 64024,
  DEPRECATED_5                                                    = 64025,
  UIMDIAG_MMGSDI_SESSION_DEACT_PROV_CMD                           = 64026,
  DEPRECATED_6                                                    = 64027,
  UIMDIAG_MMGSDI_SESSION_GET_APP_CAP_CMD                          = 64028,
  DEPRECATED_7                                                    = 64029,
  DEPRECATED_8                                                    = 64030,
  DEPRECATED_9                                                    = 64031,
  DEPRECATED_10                                                   = 64032,
  DEPRECATED_11                                                   = 64033,
  DEPRECATED_12                                                   = 64034,
  UIMDIAG_MMGSDI_SESSION_DISABLE_SERVICE_CMD                      = 64035,
  UIMDIAG_MMGSDI_SESSION_ENABLE_SERVICE_CMD                       = 64036,
  UIMDIAG_MMGSDI_SESSION_IS_SERVICE_AVAIL_CMD                     = 64037,
  DEPRECATED_13                                                   = 64038,
  DEPRECATED_14                                                   = 64039,
  DEPRECATED_15                                                   = 64040,
  DEPRECATED_16                                                   = 64041,
  UIMDIAG_MMGSDI_SESSION_PROV_APP_INIT_COMPLETE_CMD               = 64042,
  DEPRECATED_17                                                   = 64043,
  DEPRECATED_18                                                   = 64044,
  DEPRECATED_19                                                   = 64045,
  DEPRECATED_20                                                   = 64046,
  UIMDIAG_MMGSDI_SESSION_READ_PRL_CMD                             = 64047,
  DEPRECATED_21                                                   = 64048,
  UIMDIAG_MMGSDI_SESSION_GET_INFO_SYNC_CMD                        = 64049,
  DEPRECATED_22                                                   = 64050,
  DEPRECATED_23                                                   = 64051,
  DEPRECATED_24                                                   = 64052,
  DEPRECATED_25                                                   = 64053,
  DEPRECATED_26                                                   = 64054,
  UIMDIAG_MMGSDI_SESSION_GET_APP_CAPABILITIES_SYNC_CMD            = 64055,
  DEPRECATED_27                                                   = 64056,
  DEPRECATED_28                                                   = 64057,
  DEPRECATED_29                                                   = 64058,
  DEPRECATED_30                                                   = 64059,
  ...
  DEPRECATED_33                                                   = 64062,
  DEPRECATED_34                                                   = 64063,
  UIMDIAG_MMGDDI_SESSION_REGISTER_FOR_REFRESH_PROCEED_VOTING_CMD  = 64064,
  UIMDIAG_MMGSDI_SESSION_OK_TO_PROCEED_WITH_REFRESH_CMD           = 64065,
  UIMDIAG_MMGSDI_CARD_PUP_CMD                                     = 64066,
  UIMDIAG_MMGSDI_CARD_PDOWN_CMD                                   = 64067,
  UIMDIAG_MMGSDI_ACTIVATE_ONCHIP_SIM_CMD                          = 64068,
  UIMDIAG_MMGSDI_ACTIVATE_ONCHIP_USIM_CMD                         = 64069,
  UIMDIAG_MMGSDI_SEND_APDU_CMD                                    = 64070,
  DEPRECATED_35                                                   = 64071,
  UIMDIAG_MMGSDI_GET_ALL_AVAILABLE_APPS_CMD                       = 64072,
  DEPRECATED_36                                                   = 64073,
  DEPRECATED_37                                                   = 64074,
  DEPRECATED_38                                                   = 64075,
  UIMDIAG_MMGSDI_SESSION_GET_OPERATOR_NAME_CMD                    = 64076,
  DEPRECATED_39                                                   = 64077,
  DEPRECATED_40                                                   = 64078,
  DEPRECATED_41                                                   = 64079,
  DEPRECATED_42                                                   = 64080,
  DEPRECATED_43                                                   = 64081,
  UIMDIAG_MMGSDI_HIDE_CSIM_CMD                                    = 64082,
  UIMDIAG_MMGSDI_MAP_SESSIONS_TO_SLOTS_CMD                        = 64083,
  UIMDIAG_MMGSDI_NAA_REFRESH_EXT_CMD                              = 64084,
  UIMDIAG_MMGSDI_GET_ATR_CMD                                      = 64085,
  UIMDIAG_MMGSDI_GET_ALL_AVAIL_APPS_SYNC_EXT_CMD                  = 64086,
  UIMDIAG_MMGSDI_SESSION_READ_FROM_CACHE_CMD                      = 64087,

  UIMDIAG_MAX_CMD = 0x7FFFFFFF
}uimdiag_subsystem_cmd_enum_type;
/* Deprecated UIMDIAG Commands
...
typedef enum
{
  ...
  UIMDIAG_USIM_NASCONFIG,            /**<USIM NAS CONFIGURATION>*/
...
/* ----------------------------------------------------------------------------
   ...
   session_read_from_cache: Command Req for Session read from cache
...
typedef struct
{
  ...
  union 
  {
    uimdiag_mmgsdi_clientid_type                       client_id_and_evt_dereg;
    uimdiag_mmgsdi_session_open_cmd_type                      session_open;
    uimdiag_mmgsdi_sessionid_type                             session_close;
    uimdiag_mmgsdi_session_act_or_sw_prov_cmd_type            session_act_or_sw_prov;
    ...
    uimdiag_mmgsdi_session_read_from_cache_cmd_type    session_read_from_cache;
    ...
    uimdiag_mmgsdi_clientid_type                       get_all_available_apps_ext;
    uimdiag_mmgsdi_get_atr_cmd_type                    get_atr;
    ...
    uimdiag_mmgsdi_session_refresh_proceed_voting_cmd_type    
                                                       session_refresh_proceed_voting; 
    uimdiag_mmgsdi_session_proceed_refresh_cmd_type    session_refresh_ok_to_proceed;
    uimdiag_mmgsdi_clientid_type                       get_all_available_apps;
    uimdiag_mmgsdi_session_get_operator_name_cmd_type         session_get_operator_name;
    uimdiag_mmgsdi_hide_csim_cmd_type                         hide_csim;
    uimdiag_mmgsdi_map_sessions_to_slots_cmd_type             map_sessions_to_slots;
    uimdiag_mmgsdi_naa_refresh_ext_cmd_type                   session_trigger_refresh_ext;
#endif /* FEATURE_UIMDIAG_INTERNAL_API */
  }request;
}uimdiag_generic_req_type;

/* ----------------------------------------------------------------------------
   STRUCTURE:        uimdiag_set_configuration_msg_req_type

   DESCRIPTION:      set simlock configuration message request type
   uint8:                         Config id for inactive profile
   simlock_nickname_type:         config nickname for inactive profile
-------------------------------------------------------------------------------*/
typedef struct
{
  uint8                        config_id;
  simlock_nickname_type        config_nickname;
}uimdiag_set_configuration_msg_req_type;
...
typedef struct
{
  ...
  union
  {
    ...
    simlock_remote_lock_public_key_type                remote_lock_public_key;
    simlock_set_rsu_mode_msg_req_type                  rsu_mode;
    simlock_set_rsu_device_key_msg_req_type            rsu_device_key;
    uimdiag_set_configuration_msg_req_type             set_configuration;
  } data;
...
typedef PACKED struct PACKED_POST
{
  ...
  PACKED union PACKED_POST 
  {
    ...
    uimdiag_mmgsdi_rsp_session_read_record_pyld_type
                                                    session_read_record;
    uimdiag_mmgsdi_rsp_session_read_from_cache_pyld_type
                                                    session_read_from_cache;
    ...
    uimdiag_mmgsdi_get_all_available_apps_ext_rsp_type  
                                                    get_all_available_apps_ext_rsp;
    uimdiag_mmgsdi_get_atr_rsp_type                 get_atr_rsp; 
    ...
    uimdiag_simlock_token_rsp_type                         token_rsp;
    uimdiag_simlock_get_rsu_mode_rsp_type                  get_rsu_mode;
...
DESCRIPTION
  The uimdiag_malloc calls modem calloc with different heap_size based the size
...
DESCRIPTION
  The uimdiag_free frees the memory pointer
