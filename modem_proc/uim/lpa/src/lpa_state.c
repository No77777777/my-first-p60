...
$Header: //components/rel/uim.mpss/6.1.0/lpa/src/lpa_state.c#2 $ $DateTime: 2019/10/30 06:56:05 $
...
)
{
  ...
  LPA_MSG_MED_3(
    ...
    lpa_state[slot_id], current_state, next_state);

  if(current_state != lpa_state[slot_id])
  {
    return LPA_GENERIC_ERROR;
  }
