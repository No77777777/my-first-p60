...
$Header: //components/rel/uim.mpss/6.1.0/lpa/src/lpa_efs.h#2 $ $DateTime: 2019/10/30 06:56:05 $
...
#define LPA_FILE_AUTHENTICATE_SERVER_RESP_FROM_CARD "/lpa/authenticate_server_from_card"
#define LPA_FILE_CANCEL_SESSION_EUICC_FROM_CARD     "/lpa/cancel_session_from_card"
#define LPA_FILE_ASN1_ENCODED_AUTHENTICATE_SERVER   "/lpa/asn1_authenticate_server"
#define LPA_FILE_JSON_ENCODED_CANCEL_SESSION_SERVER "/lpa/json_enc_cancel_session_server"
#define LPA_FILE_JSON_ENCODED_AUTH_CLIENT           "/lpa/json_enc_auth_client"
#define LPA_FILE_JSON_ENCODED_HANDLE_NOTIFICATION   "/lpa/json_enc_handle_notification"
#define LPA_FILE_JSON_AUTHENTICATE_CLIENT_FROM_DS   "/lpa/authenticate_client_from_ds"
#define LPA_FILE_ASN1_DECODED_ISDR_RSP              "/lpa/asn1_dec_isdr_rsp"
#define LPA_FILE_ASN1_DECODED_ISDR_RSP1             "/lpa/asn1_dec_isdr_rsp1"
#define LPA_FILE_GET_PROFILES_INFO_PH1_FROM_CARD    "/lpa/get_prof_info_ph1_from_card"
#define LPA_FILE_GET_PROFILES_INFO_PH2_FROM_CARD    "/lpa/get_prof_info_ph2_from_card"
#define LPA_FILE_ASN1_ENCODED_GET_DEFAULT_ADDRESS   "lpa/asn1_enc_get_default_address"
#define LPA_FILE_ASN1_ENCODED_SET_DEFAULT_ADDRESS   "lpa/asn1_enc_set_default_address"
/*===========================================================================
