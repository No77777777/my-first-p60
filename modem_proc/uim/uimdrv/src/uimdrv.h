...
DESCRIPTION
   ...
   Copyright (c) 2001 - 2017 by QUALCOMM Technologies, Inc (QTI) and its licensors. All Rights Reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/uimdrv.h#2 $
...
08/07/15   lm      Remove unused callback functions
06/18/15   sam     Add end state to uim_atr_pps_rx_mode_type
...
/* ---------------------------------------------------------------
ENUM:      UIM_CLOCK_STOP_CONTROL_TYPE

DESCRIPTION:
  Enum to depict the action to be taken by uim after 
  processing the specific mode info from ATR
   ----------------------------------------------------------------*/
typedef enum {
...
#else
  #define UIM_MINIMUM_GUARD_TIME	UIM_MINIMUM_T_0_GUARDTIME
#endif /* FEATURE_UIM_T_1_SUPPORT */
...
/* Functions in CLA not supported */
  ...
  UIM_LAST_CMD_OF_CHAIN_EXP,     /* Last command of chaining expected       */
...
FUNCTION UIM_INTERMEDIATE_APDU                          EXTERNALIZED FUNCTION

DESCRIPTION
  This function is used for sending intermediate APDU in case of intermediate status
  word
...
/**
 *  UIMDRV uimdrv_set_card_cmd_data function .
 ...
 */
extern void uimdrv_set_card_cmd_data
(
...
/**
 *  UIMDRV uim_rx_isr_process_sw2_byte function .
 * This function process sw1 and sw2 byte accordingly.
 *  
 *  Side effect: If the command was successful, reponse buffer
 *  in UIM global is updated
 *   
 ...
 *  @sw2 Status word 2  
 */
extern void uim_rx_isr_process_sw2_byte
(
  uim_instance_global_type *uim_ptr,
  byte                      sw1,
  byte                      sw2
