...
Copyright (c) 2001 - 2016 QUALCOMM Technologies, Inc (QTI) and its licensors. All Rights Reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/uimusim.c#2 $
...
)
{
  ...
  UIMDRV_PUP_MSG_HIGH_1(UIMLOG_MSG_136,uim_ptr->id, "Reporting error for USIM command 0x%x ",
                    cmd_ptr->hdr.command );
