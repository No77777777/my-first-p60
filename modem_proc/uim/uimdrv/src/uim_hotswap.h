...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/uim_hotswap.h#2 $
...
#define UIM_HOTSWAP_MAXTIME_HW_INTERRUPT                      10  /* ms */
#define UIM_HOTSWAP_MINTIME_HW_INTERRUPT                      3   /* ms */

#define UIM_HOTSWAP_CARD_REMVOVAL_SAMPLE_INTERVAL             .5  /* in ms = 15 SCLKS */
...
#define UIM_DETECT_CARD_STATUS(uim_ptr) \
  UIMDRV_PUP_MSG_HIGH_0(UIMLOG_MSG_150,(uim_ptr->id), "Uim internal hotswap detection");\
