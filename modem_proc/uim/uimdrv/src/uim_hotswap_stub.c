...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/uim_hotswap_stub.c#1 $
...
06/19/17    ku         Compilation error fix for USES_UIM_IOE feature flag
06/17/16    gm         Stub out Hotswap related functionality
06/10/16    gm         F3 message optimization\
03/22/16    ssr        Disable Hotswap functionality for IoE flavor
==============================================================================*/
