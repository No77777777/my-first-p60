...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/hw/gpio_tlmm/uimdrv_gpio_logging.c#1 $
$DateTime: 2019/10/30 06:56:05 $
$Author: pwbldsvc $

 when       who        what, where, why
------      ----       -----------------------------------------------------------
10/24/16    ks         Not accessing GPIOs for non-iso interfaces
...
static void UIM_CONFIGURE_ALL_UIM_AS_INPUT_PULLUP_GPIOS(uim_instance_enum_type uim_instance)
{
  ...
  if(UIM_INSTANCE_1 == uim_instance)
  {
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (DALGpioSignalType)UIM_RESET_GPIO_PU,
                             DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                            (DALGpioSignalType)UIM_CLK_GPIO_PU,
                             DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                            (DALGpioSignalType)UIM_DATA_GPIO_PU,
                             DAL_TLMM_GPIO_ENABLE );
  }
  else
  {
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (DALGpioSignalType)UIM2_RESET_GPIO_PU,
                             DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                            (DALGpioSignalType)UIM2_CLK_GPIO_PU,
                             DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                            (DALGpioSignalType)UIM2_DATA_GPIO_PU,
                             DAL_TLMM_GPIO_ENABLE );
  }
#endif
  if(TRUE == uim_hw_if.intctrl[uim_instance].m_hs_enable)
  {
    ...
    {
      (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                               (DALGpioSignalType)UIM_HOTSWAP_GPIO_PU,
                               DAL_TLMM_GPIO_ENABLE );
    }
    else
    {
      (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                               (DALGpioSignalType)UIM2_HOTSWAP_GPIO_PU,
                               DAL_TLMM_GPIO_ENABLE );
    }
#endif
  }
...
static void UIM_RESTORE_ALL_UIM_GPIOS(uim_instance_enum_type uim_instance)
{
  ...
  {
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM_RESET_DEFAULT_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                            (uint32)UIM_DATA_DEFAULT_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM_CLK_DEFAULT_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
  }
  else
  {
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM2_RESET_DEFAULT_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM2_DATA_DEFAULT_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM2_CLK_DEFAULT_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
  }
#endif
  if(TRUE == uim_hw_if.intctrl[uim_instance].m_hs_enable)
  ...
  {
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM_HOTSWAP_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
  }
  else
  {
    (void)DalTlmm_ConfigGpio(uim_hw_if.gpio[uim_instance].m_TlmmHandle_ptr,
                             (uint32)UIM2_HOTSWAP_GPIO,
                             (uint32)DAL_TLMM_GPIO_ENABLE );
  }
#endif
  }
