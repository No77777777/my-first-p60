...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/hw/uartdm/uimdrv_uartdm.h#2 $
$DateTime: 2019/10/30 06:56:05 $
$Author: pwbldsvc $

when        who        what, where, why
------      ----       -----------------------------------------------------------
06/08/16    ks         Reduce UART_DM_LOGGING buffer size
...
#define MSMU_ISR_NO_FINISH_CMD_VIOL  0x20000      /* IRQ indicating that CR write has 
                                                     overwritten the previous write   */
...
#define MSMU_ISR_CLR_NO_FINISH_CMD_VIOL_INT  0x20000      /* Clear NO_FINISH_CMD_VIOL INT       */
