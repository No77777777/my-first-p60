...
Copyright (c) 2001,2002,2008-2017, 2019-2020 QUALCOMM Technologies, Inc (QTI) and its licensors. All Rights Reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/uimgen.h#4 $
...
12/22/14   ll      Remove unused #define UIM_5V_UIM_UICC
...
#define UIM_ATR_CLOCK_STOP_NOT_SUPPORTED 0x00
#define UIM_ATR_CLOCK_STOP_LOW           0x01
#define UIM_ATR_CLOCK_STOP_HIGH          0x02
#define UIM_ATR_CLOCK_STOP_NO_PREF       0x03
#define UIM_ATR_CLOCK_STOP_FIELD_SHFT    0x06

/* This is the ICCID EF file ID */
#define UIM_ICCID_EF_ID          0x2FE2
#define UIM_DIR_EF_ID            0x2F00
...
#define UIM_FCI_TEMPLATE_TAG       0x6F
#define UIM_FCM_TEMPLATE_TAG       0x64
...
typedef enum {
  ...
  UIM_RESELECT_CUR_DIR_ST,               /*Select current direcotry*/
  ...
  UIM_RECOVERY_WRITE_EF_TST_ST,             /* write EF-tst during recovery*/
  ...
  UIM_SET_APDU_BEHAVIOR_ST,                 /* Set APDU Behavior */
  UIM_SELECT_EF_DIR_ST,                     /* Select the EF-DIR during power-up */
  UIM_READ_EF_DIR_ST,                       /* Read the EF-DIR during power-up */
  UIM_INIT_MC_ISDR_SEL_ST,                  /* Prepare Manage Channel command to select ISD-R */
  UIM_SELECT_ISDR_ST,                       /* Select ISD-R */
  UIM_GET_EID_ST,                           /* Send GET EID cmd to eUICC */
  UIM_NOT_PUP_IF_ALREADY_ST,                /* Not power up the card if already */
