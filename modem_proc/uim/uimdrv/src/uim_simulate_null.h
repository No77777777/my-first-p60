...
$Header: //components/rel/uim.mpss/6.1.0/uimdrv/src/uim_simulate_null.h#1 $
...
/**
 *  This function calls a handler to start
 *  uim_simulation_null_timer
 * 
