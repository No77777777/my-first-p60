...
#define GBA_KEY_VALIDITY_TIMER_EXPIRE_SIG   0x00008000
...
#define GBA_MAX_SESSIONS                 4
#define GBA_MAX_NUM_BSF                  2
...
/* ----------------------------------------------------------------------------
   ...
   DESCRIPTION:
     This enum specifies GBA Slot id.
-------------------------------------------------------------------------------*/
typedef enum {
  GBA_SLOT_NONE,
  GBA_SLOT_1,
...
/* ----------------------------------------------------------------------------
   ENUM:      GBA_BSF_ENUM_TYPE

   DESCRIPTION:
     Indices for BSFs. DEFAULT BSF type is the one derived from the IMPI
-------------------------------------------------------------------------------*/
typedef enum {
  GBA_BSF_DEFAULT,
  GBA_BSF_NON_DEFAULT
