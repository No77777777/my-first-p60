...
$Header: //components/rel/uim.mpss/6.1.0/estk/inc/estk.h#4 $
...
09/20/16   vr      Add ESTK CM incoming call event
...
#define ESTK_INVALID_CM_CALL_ID         0xFF
...
typedef enum
{
  ...
  ESTK_LOC_EVENT_NMEA_IND,                 /* Indication for NMEA sentence */
  ESTK_LOC_EVENT_POSITION_REPORT_IND,      /* Indication for position report */
  ESTK_GEO_LOC_RSP_TIMER_EXP_CMD,          /* Geo loc envelope timeout */
  ESTK_GEO_LOC_REQUEST_RSP,                /* Geo loc request response */
  ESTK_WMS_MSG_EVENT_ACK_REPORT,           /* WMS ack report */
  ESTK_LOC_EVENT_ENGINE_LOCK_STATE_IND,    /* Indication for engine lock state */
  ESTK_LOC_GET_ENGINE_LOCK_IND,            /* Indication for get engine lock request */
...
/*===========================================================================
  ...
  PARAMETERS:
    ...
    ESTK_CM_CALL_INCOM_EVT   : Incoming call event
...
typedef enum
{
  ESTK_GEO_LOC_SESS_STATUS_SUCCESS,
  ESTK_GEO_LOC_SESS_STATUS_IN_PROGRESS,
  ESTK_GEO_LOC_SESS_STATUS_GENERAL_FAILURE
}estk_geo_loc_status_type;

typedef enum
{
  ESTK_GEO_LOC_ENGINE_LOCK_STATE_ENABLED,
  ESTK_GEO_LOC_ENGINE_LOCK_STATE_DISABLED
}estk_geo_loc_engine_lock_state_type;
/*--------------------------------------------------------------------------
...
/*===========================================================================
  ...
  PARAMETERS:
    ...
    ready_status  - WMS Full/Limited/None
...
/*===========================================================================
  ...
  PARAMETERS:
    ...
    delivery_failure_permanent - Indicates SMS failure
                                 TRUE indicates permanent
                                 FALSE indicates Temporary
...
/*===========================================================================
  ...
  STRUCT: ESTK_GPS_DATA_TYPE

  PARAMETERS:
    geo_loc_status            - session status success/in_progress/failure
    geo_loc_engine_lock_state - location engine enabled/disabled
    nmea                      - nmea data
    nmea_len                  - nmea length
    request_rsp_status        - response status for QMI_LOC start request
...
typedef struct
{
  estk_geo_loc_status_type            geo_loc_status;
  estk_geo_loc_engine_lock_state_type geo_loc_engine_lock_state;
  uint8                               nmea[GSTK_NMEA_LEN];
  uint8                               nmea_len;
  boolean                             request_rsp_status;
}
estk_gps_data_type;

/*===========================================================================

  STRUCT: ESTK_WMS_MSG_TRANSPORT_TYPE

  PARAMETERS:
    reg_status    - Registration Status
    trans_type    - Transport Type
    trans_cap     - Transport Capability

  PURPOSE:
    The structure contains the data pertaining to
    the WMS Transport information
==========================================================================*/
typedef struct
{
  boolean                        reg_status;
  wms_msg_transport_type_e_type  trans_type; /**< Transport type. */
}
estk_wms_msg_transport_type;
...
typedef struct
{
  ...
  union
  {
    ...
    estk_gps_data_type                             gps_data;
    estk_wms_msg_transport_type                    wms_msg_transport_type;
  }cmd_data;
} estk_cmd_type;
...
DESCRIPTION :
  This function is used to check for Policy man capability for max active data
