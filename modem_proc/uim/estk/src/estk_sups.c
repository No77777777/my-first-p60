...
$Header: //components/rel/uim.mpss/6.1.0/estk/src/estk_sups.c#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/05/18   dt      clean up sups data correctly
...
)
{
  ...
  UIM_MSG_HIGH_3("estk_process_cm_sups_event_cmd(): "
                 "estk_curr_inst_ptr=0x%x, "
                 "cmd_ptr=0x%x, "
                 "estk_shared_info.sups_info_ptr=0x%x",
                 estk_curr_inst_ptr, cmd_ptr, estk_shared_info.sups_info_ptr);
