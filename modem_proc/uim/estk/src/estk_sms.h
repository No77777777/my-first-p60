...
Copyright (c) 2008-2009 2014-2016 QUALCOMM Technologies, Inc (QTI) and 
...
$Header: //components/rel/uim.mpss/6.1.0/estk/src/estk_sms.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/02/17   gs      Cache WMS transport type
12/06/16   gs      Register for SMS Transport Type
...
/*===========================================================================
                             MACRO DEFINTIONS
=============================================================================*/
#define ESTK_DEFAULT_SMS_LINK_CTRL_TIMER    5
