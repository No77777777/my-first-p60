...
$Header: //components/rel/uim.mpss/6.1.0/estk/src/estk_refresh.c#2 $
...
05/11/15   vr      Print refresh alpha as byte array
...
)
{
  ...
  GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY("Refresh Alpha",
