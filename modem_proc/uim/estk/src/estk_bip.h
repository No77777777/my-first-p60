...
$Header: //components/rel/uim.mpss/6.1.0/estk/src/estk_bip.h#2 $
...
02/04/15   vr      Check for EPC profiles when APN profile is set
...
/* Macro value are as per the corner conditions for 
   quality of service as defined in TS 24.301 */
#define ESTK_EPS_1KB_BITRATE_MINIMUM_VALUE      01
#define ESTK_EPS_1KB_BITRATE_START_RANGE        01
#define ESTK_EPS_1KB_BITRATE_END_RANGE          63

#define ESTK_EPS_8KB_BITRATE_MINIMUM_VALUE      64
#define ESTK_EPS_8KB_BITRATE_START_RANGE        64
#define ESTK_EPS_8KB_BITRATE_END_RANGE          127
#define ESTK_EPS_8KB_BITRATE_MULTIPLE           8 

#define ESTK_EPS_64KB_BITRATE_MINIMUM_VALUE     576
#define ESTK_EPS_64KB_BITRATE_START_RANGE       128
#define ESTK_EPS_64KB_BITRATE_END_RANGE         254
#define ESTK_EPS_64KB_BITRATE_MULTIPLE          64 

#define ESTK_EPS_100KB_BITRATE_MINIMUM_VALUE    8700
#define ESTK_EPS_100KB_BITRATE_BASE_RATE        8600
#define ESTK_EPS_100KB_BITRATE_START_RANGE      01
#define ESTK_EPS_100KB_BITRATE_END_RANGE        74
#define ESTK_EPS_100KB_BITRATE_MULTIPLE         100 

#define ESTK_EPS_1MB_BITRATE_MINIMUM_VALUE      17000
#define ESTK_EPS_1MB_BITRATE_START_RANGE        75
#define ESTK_EPS_1MB_BITRATE_END_RANGE          186
#define ESTK_EPS_1MB_BITRATE_MULTIPLE           1000 

#define ESTK_EPS_2MB_BITRATE_MINIMUM_VALUE      130000
#define ESTK_EPS_2MB_BITRATE_START_RANGE        187
#define ESTK_EPS_2MB_BITRATE_END_RANGE          250
#define ESTK_EPS_2MB_BITRATE_MULTIPLE           2000

#define ESTK_EPS_MAX_1_OCTET_BIT_VALUE          254
#define ESTK_EPS_0KB_BITRATE_VALUE              255
#define ESTK_EPS_MAX_1_OCTET_BITRATE            8640
#define ESTK_EPS_EXT_BITRATE_MAXIMUM_VALUE      256000

#define ESTK_EPS_PDP_ERR_RATE_EXP_1             1
#define ESTK_EPS_PDP_ERR_RATE_EXP_2             2
#define ESTK_EPS_PDP_ERR_RATE_EXP_3             3
#define ESTK_EPS_PDP_ERR_RATE_EXP_4             4
#define ESTK_EPS_PDP_ERR_RATE_EXP_5             5
#define ESTK_EPS_PDP_ERR_RATE_EXP_6             6
#define ESTK_EPS_PDP_ERR_RATE_MULT_7            7
...
#define ESTK_BIP_GET_EPC_PROFILE_PARAM(api_ret_status, profile_hndl, profile_itr, \
                                       profile_info, tech, profile_param, as_id)  \
  api_ret_status = ds_profile_get_param_in_use_per_sub(profile_hndl,              \
                                               profile_param,                     \
                                               &profile_info,                     \
                                               tech,                              \
                                               as_id);                            \
  if(api_ret_status != DS_PROFILE_REG_RESULT_SUCCESS)                             \
  {                                                                               \
    UIM_MSG_ERR_1("ds_profile_get_param_in_use failed %d", api_ret_status);       \
    ESTK_BIP_ITERATOR_ITERATE(api_ret_status, profile_itr, profile_hndl);         \
    continue;                                                                     \
  }                                                                               \
...
typedef enum
{
  ...
  /* APN from Always ON PDN used */
  ESTK_BIP_APN_ALWAYS_ON              = 0x03,
  /* APN corresponding to default DS profile used */
  ESTK_BIP_APN_DEFAULT_PROFILE        = 0x04,
  /* Profile 0xFE passed to DS -DS choses profile */
  ESTK_BIP_APN_DS_SHARING             = 0x05,
