...
gstk_util_is_env_cmd_ref_table_full
  ...
  gstk_packer_csg_cell_plmn_info_tlv
    This function populates the passed in CSG Cell PLMN info
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstkutil.h#5 $
...
02/07/19   dt      Featurize processing mm or mode change events under FEATURE_CDMA
...
SEE ALSO
  None
===========================================================================*/
extern boolean gstk_util_is_env_cmd_ref_table_full();
...
PARAMETERS
  ...
  transaction_id_tlv: [Input/Output] Pointers to which the
                                     ...
                                     info to be populated
  call_evt          : [Input]        Call Event Download corresponding
                                     to the Transaction ID TLV
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_parser_contactless_func_state_tlv(
    uint8                                  *orig_cmd_data,
    int32                                   cmd_data_len,
    int32                                   orig_offset,
    tags_enum_type                          tag,
...
/*===========================================================================
FUNCTION gstk_packer_contactless_state_req_tlv

DESCRIPTION

  This function populates the passed in contactless state req tlv pointer

PARAMETERS
  request                    : [Input] Indicates request type
  contactless_state_req_tlv  : [Input/Output] Pointers to which the contactless state req
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_packer_contactless_state_req_tlv(
  gstk_contactless_state_req_enum_type  request,
  gstk_contactless_state_req_tlv_type  *contactless_state_req_tlv
);
...
PARAMETERS
  ...
  pdp_context_act_param_new_value_ptr [Input/Output] data pointer to which the
                                      information is to be populated
  dest_size:                          [Input] Size of the new buffer where
...
PARAMETERS
  cmd_info:                  [Input] data from which the information
                             is to be copied
  cmd_details_new_value_ptr: [Input/Output] Pointer to which the command details
                             is to be populated
  dest_size:                 [Input] Size of the new buffer where the data
                             will be copied into
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_util_retry_envelope_cmd(gstk_slot_id_enum_type slot);
...
/*===========================================================================
FUNCTION gstk_packer_csg_cell_plmn_info_tlv

DESCRIPTION
  This function populates CSG cell PLMN info in to required
  structure

PARAMETERS
  csg_cell_plmn_info      [INPUT] Data pointer from which information
                                 to be copied
  csg_cell_plmn_info_tlv  [INPUT/OUTPUT] Data pointer to which information
                                 to be copied
...
SEE ALSO
  None
===========================================================================*/
gstk_status_enum_type gstk_packer_csg_cell_plmn_info_tlv(
  const byte*      csg_cell_plmn_info,
  gstk_csg_cell_plmn_info_tlv_type*    csg_cell_plmn_info_tlv
);
...
/*===========================================================================
FUNCTION gstk_packer_nmea_sentence_tlv

DESCRIPTION

  This function populates the passed in the nmea sentence tlv pointer

PARAMETERS
  data:     [Input] Indicates the nmea sentence
  tpdu_tlv: [Input/Output] Pointers to which the
                              gstk_nmea_tlv_type info to be
                              populated
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_packer_nmea_sentence_tlv(
  const gstk_nmea_sentence_type     *data,
  gstk_nmea_tlv_type                *nmea_tlv
);
...
SEE ALSO
  None
===========================================================================*/
extern void gstk_util_clean_up_ti_value_table(
  gstk_slot_id_enum_type slot_id);
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_util_update_transaction_identifier_list(
...
DESCRIPTION
  Checks if 1X is the only RAT present for OTASP
...
DESCRIPTION
  This function is to find and copy the attach control command in the queue.
