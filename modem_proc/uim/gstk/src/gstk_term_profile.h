...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstk_term_profile.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/22/17   dt      Add psm status to TP from MMGSDI
11/14/16   shr     Add support for rejecting Proactive cmds based on TP support
...
SEE ALSO
  None
===========================================================================*/
boolean gstk_update_class_r_tp (
    void
);
