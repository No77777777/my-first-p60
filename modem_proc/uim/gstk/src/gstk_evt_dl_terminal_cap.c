...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstk_evt_dl_terminal_cap.c#1 $

when         who     what, where, why
--------   ---     --------------------------------------------------------------------
10/07/16   shr     GSTK/ESTK F3 reduction
09/23/16   gs       F3 reduction / cleanup
09/16/16   gs       Move Voice Capabilities to different files
   ...
   */
   ...
   if (uim_cmd_ptr != NULL ) {
     ...
     if ((gstk_status == GSTK_SUCCESS) && (uim_cmd_ptr != NULL)) {
       ...
       if (gstk_status == GSTK_SUCCESS)
       {
         GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY("Idle Screen Env",
   ...
   */
   ...
   if (uim_cmd_ptr != NULL ) {
     ...
     if ((gstk_status == GSTK_SUCCESS) && (uim_cmd_ptr != NULL)) {
       ...
       if (gstk_status == GSTK_SUCCESS)
       {
         GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY("User Activity Env",
                                             &uim_cmd_ptr->envelope.data[uim_cmd_ptr->envelope.offset],
                                             uim_cmd_ptr->envelope.num_bytes);
   ...
   */
   ...
   if (uim_cmd_ptr != NULL ) {
     ...
     if ((gstk_status == GSTK_SUCCESS) && (uim_cmd_ptr != NULL)) {
       ...
       if (gstk_status == GSTK_SUCCESS)
       {
         GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY("Browser Term Env",
                                             &uim_cmd_ptr->envelope.data[uim_cmd_ptr->envelope.offset],
                                             uim_cmd_ptr->envelope.num_bytes);
   ...
   */
   ...
   if (uim_cmd_ptr != NULL ) {
     ...
     if ((gstk_status == GSTK_SUCCESS) && (uim_cmd_ptr != NULL)) {
       ...
       if (gstk_status == GSTK_SUCCESS)
       {
         GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY("Lang select Env",
                                             &uim_cmd_ptr->envelope.data[uim_cmd_ptr->envelope.offset],
                                             uim_cmd_ptr->envelope.num_bytes);
