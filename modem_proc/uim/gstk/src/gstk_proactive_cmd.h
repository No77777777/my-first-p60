...
FUNCTIONS
  ...
  gstk_geo_loc_req
    This function parses the Geographical location report command from 
    the card and sends it to the client.
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstk_proactive_cmd.h#2 $
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_contactless_state_changed_req  (
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_geo_loc_req (
  gstk_proactive_cmd_type* command_ptr
);
