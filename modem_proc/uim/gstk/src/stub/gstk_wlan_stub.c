...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/stub/gstk_wlan_stub.c#1 $ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
...
DESCRIPTION
  Dummy function for having GSTK register with DS for WLAN IP address changes.
...
DESCRIPTION
  Dummy function for processes WLAN IP address change indication from DS
