...
GENERAL DESCRIPTION
    This source file contains dummy implementation of functions handled in gstk_setup_menu.c
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/stub/gstk_setup_menu_stub.c#1 $
