...
GENERAL DESCRIPTION
  This source file contains the dummy function implementation of 
  gstk_process_tr.c
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/stub/gstk_process_tr_stub.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/06/16   gs      Initial Version
