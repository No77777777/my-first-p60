...
Copyright (c) 2003,2008 - 2017 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstk_terminal_rsp.h#2 $
...
04/23/16   gs      Common out the code in gstk_populate_terminal_response_cnf 
                   for IoE devices
02/20/16   gs      Updated the result parameter for Unknown Proactive command
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_contactless_state_changed_cnf (
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_geo_loc_cnf (
