...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstklib_scws.c#1 $ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
...
)
{
  ...
  task_cmd_ptr->cmd_data.scws_data_avail_req.data_payload.len = data.data_len;
  task_cmd_ptr->cmd_data.scws_data_avail_req.data_payload.data_ptr = (uint8*)GSTK_CALLOC(data.data_len);
