...
Copyright (c) 2006, 2012, 2016 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstk_envelope_cmd.h#2 $
...
03/16/16   gs      Envelope commands moved to corresponding new file
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_contactless_state_req_evt_ind(
