...
$Header: //components/rel/uim.mpss/6.1.0/gstk/src/gstk_envelope_cbs.c#1 $
          ...
          gstk_envelope_cell_broadcast_download_ind_type * cb_dl_cmd)
{
   ...
   if (uim_cmd_ptr != NULL ) {
     ...
     if ((gstk_status == GSTK_SUCCESS) && (uim_cmd_ptr != NULL)) {
         ...
         GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY("Env: Cell Broadcast DL",
