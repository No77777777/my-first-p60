...
$Header: //components/rel/uim.mpss/6.1.0/gstk/inc/gstk_nv_p.h#6 $ $DateTime: 2024/04/15 00:23:49 $ $Author: pwbldsvc $
...
11/30/15   vr      Added GSTK_CFG_FEATURE_2_SLOT_DISABLE_ENH_RAT_AND_LOC_EVT
...
==========================================================================*/
  ...
  GSTK_NV_ME_TOOLKIT_ENV_RETRY_FLAG_I            = 0x1,
  ...
  GSTK_NV_ME_REDIAL_CFG                          = 0x101,
  /* 0x102 - /nv/item_files/modem/uim/gstk/qmi_cat_svc_init */
  GSTK_NV_ME_QMI_CAT_SVC_INIT                    = 0x102,
  ...
  GSTK_NV_EXT_ME_QMI_CAT_MODE                    = 0x1002,
  ...
  GSTK_NV_EXT_ME_ESN_ME_I                        = 0x1101,
  /* 0x1102 - NV_MEID_ME_I (NV 5598) */
  GSTK_NV_EXT_ME_MEID_I                          = 0x1102,
  /* 0x1103 - /nv/item_files/modem/qmi/cat/qmi_cat_default_lang (NV 69729) */
  GSTK_NV_EXT_ME_QMI_CAT_DEFAULT_LANG            = 0x1103,
  ...
  GSTK_NV_SLOT_CAT_VERSION                       = 0x2001,
  ...
  GSTK_NV_SLOT_FEATURE_BMASK                     = 0x2002,
  /* 0x2003 - /nv/item_files/modem/uim/gstk/feature_bmsk_2 (NV 73623),
     Can be used to read the entire NV for the slot (instead of reading
     individual sub-features using gstk_nv_get_feature_2_status())
     Note that only slot sub-features will have valid values returned*/
  GSTK_NV_SLOT_FEATURE_BMASK_2                   = 0x2003,
  ...
  GSTK_NV_SLOT_TOOLKIT_CS_PS_PARALLEL_I          = 0x2301,
  /* 0x2302 - /nv/item_files/modem/uim/gstk/rat_priority_config (NV 72585) */
  GSTK_NV_SLOT_RAT_PRIORITY_CONFIG               = 0x2302,
  /* 0x2303 - /nv/item_files/modem/uim/gstk/bip_apn_mapping_tbl (NV 70314) */
  GSTK_NV_SLOT_BIP_APN_MAPPING_TABLE             = 0x2303,
  /* 0x2304 - /nv/item_files/modem/uim/gstk/default_apn (NV 73530) */
  GSTK_NV_SLOT_DEFAULT_APN                       = 0x2304,
  /* 0x2305 - /nv/item_files/modem/uim/gstk/sms_link_ctrl_timer (NV 73694) */
  GSTK_NV_SLOT_SMS_LINK_CTRL_TIMER               = 0x2305,
  /* 0x2306 - //nv/item_files/modem/uim/gstk/envelope_retry (NV 73618) */
  GSTK_NV_SLOT_TOOLKIT_ENV_RETRY_EXT_DATA        = 0x2306,
  ...
  GSTK_NV_EXT_SLOT_UE_IMEI_I                     = 0x3301,
  /* 0x3302 - NV_UE_IMEISV_SVN_I (NV 5153) */
  GSTK_NV_EXT_SLOT_UE_IMEISVN_I                  = 0x3302,
  /* 0x3303 - /nv/item_files/modem/uim/mmgsdi/csim_present */
  GSTK_NV_EXT_SLOT_CSIM_PRESENT                  = 0x3303,
  ...
  GSTK_NV_SUB_BIP_OTASP_CONCURRENCY              = 0x4001,
  /* 0x4002 - /nv/item_files/modem/uim/gstk/attach_ctrl_timer (NV 70299) */
  GSTK_NV_SUB_ATTACH_CTRL_TIMER                  = 0x4002,
  ...
  GSTK_NV_EXT_SUB_DTM_FEATURE_SUPPORT_I          = 0x5301,
...
/*===========================================================================
  ...
  STEPS ADD A NEW SUB-FEATURE:
    ...
    5. Inform MCFG team of any new carrier specific default NV value
==========================================================================*/
typedef enum {
  ...
  /* Removed, DO NOT  reuse the mask, enum deprecated with
...
/*===========================================================================
  ...
  DESCRIPTION:
    This enum lists all the slot specific sub-features within
    /nv/item_files/modem/uim/gstk/feature_bmsk_2 (NV 73623) whose values
  ...
  STEPS ADD A NEW SUB-FEATURE:
    1. Create a new enumeration for the sub-feature and place it below
       ...
       Note: Always define feature such that the default value is disabled
    2. Add logic to access the NV item in function gstk_nv_get_feature_2_status
    3. Update GSTK NV Wiki with the new NV item info
    4. Inform MCFG team of any new carrier specific default NV value
==========================================================================*/
typedef enum {
  ...
  /* When set, shall enable use of always ON APN (if available), while
     setting BIP DS profile (when OPEN CHANNEL does not contain an APN) */
  GSTK_CFG_FEATURE_2_SLOT_ENABLE_BIP_ALWAYS_ON_APN_USE             = (SYS_BM_64BIT(1)),
  ...
  /* When set, Disables the handling of 3GPP2 location status changes and
     to disable the sending of 3GPP2 location info and access technology to the card */
  GSTK_CFG_FEATURE_2_SLOT_DISABLE_CDMA_LOCATION_INFO               = (SYS_BM_64BIT(5)),
  /* When set, Disables the sending of 3GPP2 location info and access technology
     to the card when outside the United States */
  GSTK_CFG_FEATURE_2_SLOT_DISABLE_NON_US_CDMA_LOCATION_INFO        = (SYS_BM_64BIT(6)),
  /* When set, disables holding of SEND SMS till ack for SMS 
     PP is received from network */
  GSTK_CFG_FEATURE_2_SLOT_DISABLE_HOLDING_SEND_SMS_TILL_SMS_PP_ACK = (SYS_BM_64BIT(8)),
  /* When set, enables the IMS registration event bit in the terminal profile
     if ME supports IMS (which is determined by
     GSTK_CFG_FEATURE_ME_TP_IMS_ENABLE) */
  GSTK_CFG_FEATURE_2_SLOT_ENABLE_TP_IMS_REG_EVENT                  = (SYS_BM_64BIT(9)),
  /* When set, disables the CSG capability bits in the terminal profile */
  GSTK_CFG_FEATURE_2_SLOT_DISABLE_TP_CSG                           = (SYS_BM_64BIT(10)),
  /* When set, blocks 3GPP2 SMS from card when transport type is IMS */
  GSTK_CFG_FEATURE_2_SLOT_BLOCK_3GPP2_SMS_OVER_IMS                 = (SYS_BM_64BIT(12)),
  /* When set, treat file list tag optional for buggy cards */
  GSTK_CFG_FEATURE_2_SLOT_REFRESH_FILE_LIST_OPTIONAL               = (SYS_BM_64BIT(13)),
 /* When enabled, disables the GSTK response timer */
  GSTK_CFG_FEATURE_2_SLOT_GSTK_CUST_ENH0                           = (SYS_BM_64BIT(15)),
  /* To guarantee int64 */
...
/*===========================================================================
  ...
  DESCRIPTION:
    This enum lists all the ME specific sub-features within
...
typedef enum {
  ...
  /* When enabled, indicates that IMS is supported by the ME, and is used as
     an input to turn-on the supported IMS related bits in the
     terminal profile */
  ...
  /* When enabled, ESTK allows the BIP only on default data subscription */
  GSTK_CFG_FEATURE_ME_DISABLE_DUAL_DATA                                 = (SYS_BM_64BIT(15)),
  /* When enabled, the notification to Andoird about the QMI_LOC request
     from STK is sent */
  GSTK_CFG_FEATURE_ME_ENABLE_QMI_LOC_NOTIFY_SUPPORT                     = (SYS_BM_64BIT(20)),
  /* To guarantee int64 */
...
typedef union
{
  ...
  /* GSTK_NV_EXT_SLOT_CSIM_PRESENT */
  boolean                           csim_present;
  ...
  /* GSTK_NV_SLOT_SMS_LINK_CTRL_TIMER */
  uint8                             sms_link_ctrl_timer;
