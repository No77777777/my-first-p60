...
Copyright (c) 2010 - 2020 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/gstk/inc/gstk_p.h#4 $ $DateTime: 2020/01/28 02:49:39 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/24/20   ks      Add function gstk_mem_alloc
...
/* using same signal value as both the signal is mutual exclusive */
#define ESTK_NOTIFY_QMI_LOC_SIG               0x00000004
#define ESTK_WAIT_QMI_LOC_MSG_SIG             0x00000004
...
extern rex_tcb_type       * gstk_tcb_ptr;
#define UIM_GSTK_TCB        gstk_tcb_ptr
...
/* ===========================================================================
   MACRO:       GSTK_UTIL_DUMP_BYTE_ARRAY
   DESCRIPTION: This is used to dump a GSTK buffer
   ===========================================================================*/
#define GSTK_UTIL_DUMP_BYTE_ARRAY(array_name_ptr, byte_array_ptr, array_size)            \
        UIM_MSG_HIGH_1("Dumping array " array_name_ptr " array size 0x%x", (array_size));  \
        gstk_util_dump_byte_array(1, byte_array_ptr, array_size)

/* ===========================================================================
   MACRO:       GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY
   DESCRIPTION: This is used to selectively dump a GSTK buffer
   ===========================================================================*/
#define GSTK_UTIL_SELECTIVE_DUMP_BYTE_ARRAY(array_name_ptr, byte_array_ptr, array_size)            \
        UIM_SELECTIVE_MSG_HIGH_1(UIM_LOG_TOOLKIT, "Dumping array " array_name_ptr " array size 0x%x", (array_size));  \
        gstk_util_dump_byte_array(UIM_LOG_TOOLKIT, byte_array_ptr, array_size)
...
typedef struct
{
    ...
    /* user_data_updated is used only in use-cases when 
       original user_data is over-written */
    boolean                           user_data_updated;
    uint32                            user_data;
...
DESCRIPTION
  This function parses a proactive command and masks the APDU
  depending on the command tag.
...
DESCRIPTION
  This function is used to dump globals from GSTK.
