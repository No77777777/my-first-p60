#ifndef MMGSDI_IOT_CAPABILITIES_CE_H
#define MMGSDI_IOT_CAPABILITIES_CE_H
...
/*
  ...
  $Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_iot_capabilities_ce.h#2 $
...
#endif /* MMGSDI_IOT_CAPABILITIES_CE_H */
