...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_simlock_refresh.c#2 $$ $DateTime: 2019/10/30 06:56:05 $
...
)
{
  ...
  mmgsdi_status = mmgsdi_uim_common_write_transparent(write_req_ptr, TRUE, &write_cnf_ptr, protocol);
