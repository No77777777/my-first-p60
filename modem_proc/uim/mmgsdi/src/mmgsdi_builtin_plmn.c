...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_builtin_plmn.c#2 $$ $DateTime: 2019/10/30 06:56:05 $
  ...
  uint8 ** file_buffer_pptr)
{
  ...
  char * file_handle_ptr                = UIM_COMMON_EFS_PATH_MMGSDI_BUILTIN_PLMN_LIST_FILE;
...
)
{
  mmgsdi_return_enum_type mmgsdi_status = MMGSDI_ERROR;
  char  * file_handle_ptr               = UIM_COMMON_EFS_PATH_MMGSDI_BUILTIN_PLMN_LIST_FILE;
  char  * file_path_handle_ptr          = UIM_COMMON_EFS_PATH_MODEM_UIM_MMGSDI_CONFIG_DIR;
  ...
  /* Return if feature is not set for any slot */
  if((mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OPLMN_LIST_CONFIGURABLE_OTA,
        MMGSDI_NV_CONTEXT_PRIMARY))   == MMGSDI_FEATURE_DISABLED &&
     (mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OPLMN_LIST_CONFIGURABLE_OTA,
        MMGSDI_NV_CONTEXT_SECONDARY)) == MMGSDI_FEATURE_DISABLED &&
     (mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OPLMN_LIST_CONFIGURABLE_OTA,
        MMGSDI_NV_CONTEXT_TERTIARY))  == MMGSDI_FEATURE_DISABLED)
  {
    return MMGSDI_ERROR;
  }
  ...
  {
    if((mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OPLMN_LIST_CONFIGURABLE_OTA,
        MMGSDI_NV_CONTEXT_PRIMARY)) == MMGSDI_FEATURE_ENABLED)
    {
      (void)mmgsdi_builtin_plmn_trigger_refresh(MMGSDI_SLOT_1);
    }

    if((mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OPLMN_LIST_CONFIGURABLE_OTA,
        MMGSDI_NV_CONTEXT_SECONDARY)) == MMGSDI_FEATURE_ENABLED)
    {
      (void)mmgsdi_builtin_plmn_trigger_refresh(MMGSDI_SLOT_2);
    }

    if((mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OPLMN_LIST_CONFIGURABLE_OTA,
        MMGSDI_NV_CONTEXT_TERTIARY)) == MMGSDI_FEATURE_ENABLED)
    {
