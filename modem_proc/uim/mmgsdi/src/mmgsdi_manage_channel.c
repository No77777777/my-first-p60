...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_manage_channel.c#2 $
...
06/25/15   hh      Convert MANAGE CHANNEL APDU to higher level API for ICC card 
06/14/15   hh      Initial version
===========================================================================*/
...
)
{
  ...
  channel_id               = mmgsdi_util_get_channel_id_from_cla(
