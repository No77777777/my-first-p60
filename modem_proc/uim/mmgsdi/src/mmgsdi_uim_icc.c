...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_uim_icc.c#2 $$ $DateTime: 2019/10/30 06:56:05 $
...
/* ----------------------------------------------------------------------------
   ...
   LIMITATIONS:
     For UICC protocol access, mmgsdi_uim_uicc_write_record should be used
...
/* ----------------------------------------------------------------------------
   ...
   LIMITATIONS:
     For UICC protocol access, mmgsdi_uim_uicc_read_transparent should be used
    ...
    if (sync_process)
    {
          ...
          mmgsdi_internal_synch_uim_rpt_rsp[mmgsdi_task] != NULL)
      {
        ...
        mmgsdi_status = mmgsdi_common_rsp_read(
          mmgsdi_internal_synch_uim_rpt_rsp[mmgsdi_task], cnf_pptr, sync_process, MMGSDI_ICC);
...
/* ----------------------------------------------------------------------------
   ...
   LIMITATIONS:
     For UICC protocol access, mmgsdi_uim_uicc_read_record should be used
