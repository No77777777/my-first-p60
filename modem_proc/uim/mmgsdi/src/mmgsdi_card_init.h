...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_card_init.h#2 $$ $DateTime: 2019/10/30 06:56:05 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------- 
09/16/19   sg      Fallback to file system/cache for missing files
10/25/16   me      Removed all the function under FEATURE_GSTK   
10/24/16   vdc     Added support for auto reg SMS when ESN is changed
08/10/16   bcho    Handle read failures for AUTH related EFs
