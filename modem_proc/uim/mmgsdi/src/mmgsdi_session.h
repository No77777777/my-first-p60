...
Copyright (c) 2004 - 2013 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_session.h#2 $$ $DateTime: 2019/10/30 06:56:05 $
...
12/04/14   stv     Add function for pre prov app start
