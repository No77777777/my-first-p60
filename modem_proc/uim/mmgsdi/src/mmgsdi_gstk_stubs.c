/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
            ...
            M M G S D I   G S T K  S T U B S  F U N C T I O N S


GENERAL DESCRIPTION

  This file contains stubs for GSTK functions.
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_gstk_stubs.c#1 $$ $DateTime: 2019/10/30 06:56:05 $
