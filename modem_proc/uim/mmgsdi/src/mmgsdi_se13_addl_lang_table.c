...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_se13_addl_lang_table.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/17/17   tq      Added feature flags
...
===========================================================================*/
#if !(defined (FEATURE_MMGSDI_SE13_FROM_EFS_ONLY) && defined(FEATURE_MMGSDI_SE13_FROM_HARDCODED_ONLY))
...
static mmgsdi_se13_addl_lang_network_table_data_type mmgsdi_addl_lang_network_table[] = {
  ...
  { "zh_hant", 455, 07, MMGSDI_PLMN_NETWK_TYPE_LTE_MASK,
  ...
  { "zh_hant", 460, 01, MMGSDI_PLMN_NETWK_TYPE_GSM_900_MASK|MMGSDI_PLMN_NETWK_TYPE_DCS_1800_MASK|MMGSDI_PLMN_NETWK_TYPE_UMTS_MASK,
  ...
  { "zh_hant", 460, 07, 0xFF,
    8, {0x4E, 0x2D, 0x57, 0x0B, 0x79, 0xFB, 0x52, 0xD5}, 8, {0x4E, 0x2D, 0x57, 0x0B, 0x79, 0xFB, 0x52, 0xD5}},
  { "zh_hant", 460, 9, MMGSDI_PLMN_NETWK_TYPE_GSM_900_MASK|MMGSDI_PLMN_NETWK_TYPE_DCS_1800_MASK|MMGSDI_PLMN_NETWK_TYPE_UMTS_MASK|MMGSDI_PLMN_NETWK_TYPE_LTE_MASK,
    8, {0x4E, 0x2D, 0x57, 0x0B, 0x80, 0x6F, 0x90, 0x1A}, 8, {0x4E, 0x2D, 0x57, 0x0B, 0x80, 0x6F, 0x90, 0x1A}},
  { "zh_hant", 460, 20, 0xFF,
  ...
  { "zh_hans", 455, 07, MMGSDI_PLMN_NETWK_TYPE_LTE_MASK,
    8, {0x4E, 0x2D, 0x56, 0xFD, 0x75, 0x35, 0x4F, 0xE1}, 8, {0x4E, 0x2D, 0x56, 0xFD, 0x75, 0x35, 0x4F, 0xE1}},
  ...
  { "zh_hans", 460, 01, MMGSDI_PLMN_NETWK_TYPE_GSM_900_MASK|MMGSDI_PLMN_NETWK_TYPE_DCS_1800_MASK|MMGSDI_PLMN_NETWK_TYPE_UMTS_MASK,
  ...
  { "zh_hans", 460, 07, 0xFF,
    8, {0x4E, 0x2D, 0x56, 0xFD, 0x79, 0xFB, 0x52, 0xA8}, 8, {0x4E, 0x2D, 0x56, 0xFD, 0x79, 0xFB, 0x52, 0xA8}},
  { "zh_hans", 460, 9, MMGSDI_PLMN_NETWK_TYPE_GSM_900_MASK|MMGSDI_PLMN_NETWK_TYPE_DCS_1800_MASK|MMGSDI_PLMN_NETWK_TYPE_UMTS_MASK|MMGSDI_PLMN_NETWK_TYPE_LTE_MASK,
    8, {0x4E, 0x2D, 0x56, 0xFD, 0x80, 0x54, 0x90, 0x1A}, 8, {0x4E, 0x2D, 0x56, 0xFD, 0x80, 0x54, 0x90, 0x1A}},
  { "zh_hans", 460, 20, 0xFF,
...
#endif/* !(FEATURE_MMGSDI_SE13_FROM_EFS_ONLY && FEATURE_MMGSDI_SE13_FROM_HARDCODED_ONLY) */
...
)
{
  ...
  UIM_MSG_HIGH_0("Get ONS from additional SE13 table");
