...
Copyright (c) 2004 - 2016, 2024 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_uicc.h#3 $$ $DateTime: 2024/04/24 21:49:05 $
