...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdiutil_3gpp2.c#1 $
...
{
  sys_modem_as_id_e_type cm_sub_id = SYS_MODEM_AS_ID_1;

  switch (nv_efs_index)
  {
    case MMGSDI_NV_CONTEXT_PRIMARY:
       cm_sub_id = SYS_MODEM_AS_ID_1;
      break;
    case MMGSDI_NV_CONTEXT_SECONDARY:
      cm_sub_id = SYS_MODEM_AS_ID_2;
      break;
    case MMGSDI_NV_CONTEXT_TERTIARY:
      cm_sub_id = SYS_MODEM_AS_ID_3;
      break;
    default:
      break;
  }
  return cm_sub_id;
}/* mmgsdi_util_convert_efs_context_to_cm_subid */
...
} /* mmgsdi_util_map_mmgsdi_session_to_nvruim_session */
...
)
{
  ...
  mmgsdi_nv_cmd_ext.context = mmgsdi_nv_convert_mmgsdi_nv_context(nv_efs_index);
