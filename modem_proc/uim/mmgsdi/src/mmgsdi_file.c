...
Copyright (c) 2014 - 2019, 2021, 2022 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_file.c#5 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/03/22   shp     Add new NV item to override USE_SFI in device_features_status_list
...
11/16/17   rps     Don't send select again for EF if select failed due to timeout
04/19/17   tq      Added support for ACDC,ProSe,Launch Pad,MCPTT,ePDG files
03/23/17   nr      SFI is not setting corrrectly for files with access by_path
12/27/16   me      Added support for more ISIM files
...
/* Max. possible Transparent File size that can be accessed
   via READY BINARY without ODD INS:
   Max. length = Max. offset (2^15 -1 : 15 bits in READY BINARY P1/P2) +
   Max. length per APDU (Le = 00 i.e. 256 bytes) */
#define MMGSDI_MAX_TRANSPARENT_FILE_SIZE               0x80FF
...
/* EFs at the DF MCPTT under DF Telecom */
const mmgsdi_file_enum_table_type mmgsdi_file_telecom_mcptt_enum_table[] =
{
  {MMGSDI_TELECOM_MCPTT_MST,                0x4F01, MMGSDI_USIM_SRV_MCPTT}
}; /* mmgsdi_file_telecom_mcptt_enum_table */
...
const mmgsdi_file_enum_table_type mmgsdi_file_usim_enum_table[] =
{
  ...
  {MMGSDI_USIM_IPS,                         0x6FF1, MMGSDI_USIM_SRV_USAT_APP_PAIRING},
  {MMGSDI_USIM_EPDG_ID,                     0x6FF3, MMGSDI_USIM_SRV_EPDG_CONFIG_SUPPORT},
  /* Need to additionally check  MMGSDI_USIM_SRV_EPDG_CONFIG_CONFIG in mmgsdi_util_is_file_ok_in_svc_table */
  {MMGSDI_USIM_EPDG_SELECTION,              0x6FF4, MMGSDI_USIM_SRV_EPDG_CONFIG_SUPPORT},  
  /* Need to additionally check  MMGSDI_USIM_SRV_EPDG_CONFIG_CONFIG in mmgsdi_util_is_file_ok_in_svc_table */
  {MMGSDI_USIM_EPDG_IDEM,                   0x6FF5, MMGSDI_USIM_SRV_EM_EPDG_CONFIG_SUPPORT},
  /* Need to additionally check  MMGSDI_USIM_SRV_EM_EPDG_CONFIG_CONFIG in mmgsdi_util_is_file_ok_in_svc_table */
  {MMGSDI_USIM_EPDG_SELECTION_EM,           0x6FF6, MMGSDI_USIM_SRV_EM_EPDG_CONFIG_SUPPORT},		
  /* Need to additionally check  MMGSDI_USIM_SRV_EM_EPDG_CONFIG_CONFIG in mmgsdi_util_is_file_ok_in_svc_table */
...
const mmgsdi_file_enum_table_type mmgsdi_file_isim_enum_table[] =
{
  ...
  {MMGSDI_ISIM_IST,                         0x6F07, MMGSDI_NONE},
  {MMGSDI_ISIM_PCSCF,                       0x6F09, MMGSDI_NONE},
  {MMGSDI_ISIM_GBANL,                       0x6FD7, MMGSDI_NONE},
  {MMGSDI_ISIM_NAFKCA,                      0x6FDD, MMGSDI_NONE},
  {MMGSDI_ISIM_SMS,                         0x6F3C, MMGSDI_NONE},
  {MMGSDI_ISIM_SMSS,                        0x6F43, MMGSDI_NONE},
  {MMGSDI_ISIM_SMSR,                        0x6F47, MMGSDI_NONE},
  {MMGSDI_ISIM_SMSP,                        0x6F42, MMGSDI_NONE},
  {MMGSDI_ISIM_UICCIARI,                    0x6FE7, MMGSDI_NONE}
...
/*EFs at DF ProSe under USIM ADF */
const mmgsdi_file_enum_table_type mmgsdi_file_usim_prose_enum_table[] =
{
  {MMGSDI_USIM_PROSE_MON,                   0x4F01, MMGSDI_USIM_PROSE_SRV_PARAMS},
  {MMGSDI_USIM_PROSE_ANN,                   0x4F02, MMGSDI_USIM_PROSE_SRV_PARAMS},
  {MMGSDI_USIM_PROSE_FUNC,                  0x4F03, MMGSDI_USIM_PROSE_SRV_FUNC},
  {MMGSDI_USIM_PROSE_RADIO_COM,             0x4F04, MMGSDI_USIM_PROSE_SRV_RADIO_COM},
  {MMGSDI_USIM_PROSE_RADIO_MON,             0x4F05, MMGSDI_USIM_PROSE_SRV_RADIO_MON},
  {MMGSDI_USIM_PROSE_RADIO_ANN,             0x4F06, MMGSDI_USIM_PROSE_SRV_RADIO_ANN},
  {MMGSDI_USIM_PROSE_POLICY,                0x4F07, MMGSDI_USIM_PROSE_SRV_POLICY},
  {MMGSDI_USIM_PROSE_PLMN,                  0x4F08, MMGSDI_USIM_PROSE_SRV_RADIO_COM},
  {MMGSDI_USIM_PROSE_GC,                    0x4F09, MMGSDI_USIM_PROSE_SRV_GC},
  {MMGSDI_USIM_PROSE_PST,                   0x4F10, MMGSDI_USIM_SRV_PROSE},
  {MMGSDI_USIM_PROSE_UIRC,                  0x4F11, MMGSDI_USIM_PROSE_SRV_UIRC},
  {MMGSDI_USIM_PROSE_GM_DICOVERY,           0x4F12, MMGSDI_USIM_PROSE_SRV_GM_DISCOVERY},
  {MMGSDI_USIM_PROSE_RELAY,                 0x4F13, MMGSDI_USIM_PROSE_SRV_RELAY},
  {MMGSDI_USIM_PROSE_RELAY_DISCOVERY,       0x4F14, MMGSDI_USIM_PROSE_SRV_RELAY}
}; /* mmgsdi_file_usim_prose_enum_table */

/*EFs at DF ACDC under USIM ADF */
const mmgsdi_file_enum_table_type mmgsdi_file_usim_acdc_enum_table[] =
{
  {MMGSDI_USIM_ACDC_LIST,                   0x4F01, MMGSDI_USIM_SRV_ACDC}
}; /* mmgsdi_file_usim_acdc_enum_table */

/*EFs at Configuration Data DF*/
const mmgsdi_file_enum_table_type mmgsdi_file_cd_enum_table[] =
{
  {MMGSDI_CD_LAUNCH_PAD,                   0x6F01, MMGSDI_NONE}
}; /* mmgsdi_file_cd_enum_table */
...
/* SFI values for files under USIM ProSe DF */
static const mmgsdi_file_sfi_table_type mmgsdi_usim_prose_file_sfi_table[] =
{
  /* ProSe */
  { MMGSDI_USIM_PROSE_MON,         0x01, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* ProSe Monitoring Parameters. */
  { MMGSDI_USIM_PROSE_ANN,         0x02, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* ProSe Announcing Parameters. */
  { MMGSDI_USIM_PROSE_FUNC,        0x03, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* HPLMN ProSe Function. */
  { MMGSDI_USIM_PROSE_RADIO_COM,   0x04, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE},    /* ProSe Direct Communication Radio Parameters */
  { MMGSDI_USIM_PROSE_RADIO_MON,   0x05, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE},    /* ProSe Direct Discovery Monitoring Radio Parameters */
  { MMGSDI_USIM_PROSE_RADIO_ANN,   0x06, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE},    /* ProSe Direct Discovery Announcing Radio Parameters */
  { MMGSDI_USIM_PROSE_POLICY,      0x07, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* ProSe Policy Parameters */
  { MMGSDI_USIM_PROSE_PLMN,        0x08, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* ProSe PLMN Parameters */
  { MMGSDI_USIM_PROSE_GC,          0x09, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE},    /* ProSe Group Counter */
  { MMGSDI_USIM_PROSE_PST,         0x0A, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE},    /* ProSe Service Table */
  { MMGSDI_USIM_PROSE_UIRC,            0x0B, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE},    /* ProSe Usage Information Reporting Configuration */
  { MMGSDI_USIM_PROSE_GM_DICOVERY,     0x0C, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* ProSe Group Member Discovery Parameters */
  { MMGSDI_USIM_PROSE_RELAY,           0x0D, MMGSDI_INVALID_REC_LEN,    MMGSDI_LINEAR_FIXED_FILE},   /* ProSe Relay Parameters */
  { MMGSDI_USIM_PROSE_RELAY_DISCOVERY, 0x0E, MMGSDI_INVALID_FILE_SIZE,	MMGSDI_TRANSPARENT_FILE}     /* ProSe Relay Discovery Parameters */ 
}; /* mmgsdi_usim_prose_file_sfi_table */

/* SFI values for files under USIM ACDC DF */
static const mmgsdi_file_sfi_table_type mmgsdi_usim_acdc_file_sfi_table[] =
{
  /* ACDC */
  { MMGSDI_USIM_ACDC_LIST,             0x01, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE}     /* ACDC List Parameters */
}; /* mmgsdi_usim_acdc_file_sfi_table */

/* SFI values for files under Telecom Mcptt DF */
static const mmgsdi_file_sfi_table_type mmgsdi_telecom_mcptt_file_sfi_table[] =
{
  /* MCPTT */
  { MMGSDI_TELECOM_MCPTT_MST,          0x01, MMGSDI_INVALID_FILE_SIZE,  MMGSDI_TRANSPARENT_FILE}     /* MCPTT Service Table Parameters */
}; /* mmgsdi_telecom_mcptt_file_sfi_table */
...
const mmgsdi_file_index_table_type mmgsdi_file_index_table[] =
{
  ...
  { MMGSDI_USIM_PROSE_DF_START,
    { 3, {0x3F00,0X7FFF,0X5F90,0xFFFF,0xFFFF}},
    sizeof(mmgsdi_file_usim_prose_enum_table)/sizeof(mmgsdi_file_enum_table_type),
    mmgsdi_file_usim_prose_enum_table,
    sizeof(mmgsdi_usim_prose_file_sfi_table)/sizeof(mmgsdi_file_sfi_table_type),
    mmgsdi_usim_prose_file_sfi_table },
  ...
  { MMGSDI_USIM_ACDC_DF_START,
    { 3, {0x3F00,0X7FFF,0x5FA0,0XFFFF,0xFFFF}},
    sizeof(mmgsdi_file_usim_acdc_enum_table)/sizeof(mmgsdi_file_enum_table_type),
    mmgsdi_file_usim_acdc_enum_table,
    sizeof(mmgsdi_usim_acdc_file_sfi_table)/sizeof(mmgsdi_file_sfi_table_type),
    mmgsdi_usim_acdc_file_sfi_table },

  { MMGSDI_TELECOM_MCPTT_DF_START,
    { 3, {0x3F00,0X7F10,0x5F3D,0XFFFF,0xFFFF}},
    sizeof(mmgsdi_file_telecom_mcptt_enum_table)/sizeof(mmgsdi_file_enum_table_type),
    mmgsdi_file_telecom_mcptt_enum_table,
    sizeof(mmgsdi_telecom_mcptt_file_sfi_table)/sizeof(mmgsdi_file_sfi_table_type),
    mmgsdi_telecom_mcptt_file_sfi_table },

  { MMGSDI_CD_DF_START,
    { 2, {0x3F00,0X7F11,0xFFFF,0xFFFF,0xFFFF}},
    sizeof(mmgsdi_file_cd_enum_table)/sizeof(mmgsdi_file_enum_table_type),
    mmgsdi_file_cd_enum_table,
    0, NULL }
  ...
  mmgsdi_slot_id_enum_type         slot_id)
{
  ...
  /* Do not use sfi if override_use_sfi is enabled in EFS.
     This is done to overcome scenerio where for some buggy cards if sfi
     is used for reading of EF, incorrect data was returned. As the existing
     USE_SFI config is a device specific feature, disabling it will cause 
     sfi not being used for all the cards. To overcome this, a new software based
     NV is added so that, it be operator specific. */
  if(mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_OVERRIDE_USE_SFI_TO_FALSE,
                                       nv_context) == MMGSDI_FEATURE_ENABLED)
  {
    return FALSE;
  }

  if(mmgsdi_nv_get_device_feature_status(MMGSDI_FEATURE_USE_SFI) == MMGSDI_FEATURE_ENABLED)
  {
  ...
  mmgsdi_file_enum_type *mmgsdi_file_ptr)
{
  ...
  if (mmgsdi_file_ptr == NULL || path_to_df.path_len == 0)
  {
    return MMGSDI_INCORRECT_PARAMS;
  }

  /* Initialize to no file enum */
  *mmgsdi_file_ptr = MMGSDI_MAX_FILE_ENUM;
  ...
  for ( i = 0; i < index_count; i++ )
  {
    if ((app_type == MMGSDI_APP_USIM &&
         (mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_USIM_EF_START) &&
         (mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_USIM_MEXE_DF_START) &&
         (mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_USIM_GSM_ACCESS_DF_START) &&
         (mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_USIM_HNB_DF_START) &&
         (mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_USIM_PROSE_DF_START)) ||
        (app_type == MMGSDI_APP_CSIM &&
         (mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_CSIM_EF_START &&
          mmgsdi_file_index_table[i].mmgsdi_file_index != MMGSDI_CSIM_PHONEBOOK_DF_START)))
    {
      continue;
    }
    if (path_to_df.path_len != (mmgsdi_len_type)mmgsdi_file_index_table[i].path_to_df.len ||
        (memcmp((void *)path_to_df.path_buf,
               (void *)mmgsdi_file_index_table[i].path_to_df.path, path_to_df.path_len) != 0))
    {
      continue;
    }
    ...
    if (sfi_table_ptr != NULL)
    {
      for (j = 0; j < sfi_count; j++)
      {
        if (sfi == sfi_table_ptr[j].sfi)
        {
          *mmgsdi_file_ptr = sfi_table_ptr[j].mmgsdi_file;
          return MMGSDI_SUCCESS;
        }
      }
    }
...
)
{
  ...
  {
    security_access_ptr->read.num_protection_pin = 0;
    MMGSDIUTIL_TMC_MEM_FREE(security_access_ptr->read.protection_pin_ptr);
    security_access_ptr->write.num_protection_pin = 0;
    MMGSDIUTIL_TMC_MEM_FREE(security_access_ptr->write.protection_pin_ptr);
    security_access_ptr->increase.num_protection_pin = 0;
    MMGSDIUTIL_TMC_MEM_FREE(security_access_ptr->increase.protection_pin_ptr);
    security_access_ptr->invalidate_deactivate.num_protection_pin = 0;
    MMGSDIUTIL_TMC_MEM_FREE(security_access_ptr->invalidate_deactivate.protection_pin_ptr);
    security_access_ptr->rehabilitate_activate.num_protection_pin = 0;
    MMGSDIUTIL_TMC_MEM_FREE(security_access_ptr->rehabilitate_activate.protection_pin_ptr);
  }
}/* mmgsdi_file_free_security_info */
  ...
  mmgsdi_file_attributes_type * attr_ptr)
{
  ...
  mmgsdi_file_free_security_info(operation_ptr);
  ...
  mmgsdi_file_enum_type                  mmgsdi_file)
{
  ...
  attr_ptr->cyclic_file.increase_allowed       = FALSE;
  ...
  /* Set the default security attributes from the mmgsdi file info table */ 
  if (MMGSDI_NOT_FOUND == mmgsdi_file_fallback_set_default_sec_attr_from_file_info_table(
                                                       mmgsdi_file, operation_ptr))
  {
    /* If an entry is not found in the MMGSDI File Info Table, update the
       default security attribute for the file from the default security attributes table */
    ...
    if(mmgsdi_file_type == MMGSDI_CYCLIC_FILE &&
       operation_ptr->increase.protection_method == MMGSDI_ALWAYS_ALLOWED)
    {
      attr_ptr->cyclic_file.increase_allowed = TRUE;
    }
  }
  return MMGSDI_SUCCESS;
...
)
{
  ...
  if(file_path_ptr->path_len > 2 &&
     (file_path_ptr->path_buf[0] == MMGSDI_MF_LEVEL &&
      file_path_ptr->path_buf[1] == MMGSDI_TELECOM_LEVEL))
  {
    return TRUE;
  }

  return FALSE;
} /* mmgsdi_file_is_ef_under_global_telecom_df */
...
)
{
  ...
  switch(session_type)
  {
    ...
    case MMGSDI_GW_PROV_TER_SESSION:
      if((EF_category == MMGSDI_EF_CATRGORY_CDMA) || (EF_category == MMGSDI_EF_CATRGORY_CSIM))
      {
        return FALSE;
      }
      else
    ...
    case MMGSDI_1X_PROV_TER_SESSION:
      if((EF_category == MMGSDI_EF_CATRGORY_GSM) || (EF_category == MMGSDI_EF_CATRGORY_USIM))
      {
        return FALSE;
      }
      else
...
/*===========================================================================
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static mmgsdi_cache_sec_attr_operation_enum_type mmgsdi_file_is_skip_uicc_arr (
...
)
{
  ...
  if (MMGSDI_EF_ENUM_ACCESS  == access.access_method &&
      MMGSDI_FEATURE_ENABLED ==
        mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_CSIM_UPP_UPDATE_AFTER_OTASP,
                                     nv_context)
      )
  {
    for (i = 0;
         ...
         i++)
    {
      ...
      {
        return MMGSDI_DECODE_ACTUAL_ATTRIBUTES;
      }
    }
  }

  return MMGSDI_DECODE_DEFAULT_ATTRIBUTES;
  ...
  mmgsdi_file_size_type             *orig_file_size_ptr)
{
     ...
     attr_cache_ptr != NULL)
  {
    ...
    {
      case MMGSDI_TRANSPARENT_FILE:
        if (orig_file_size_ptr)
        {
          *orig_file_size_ptr = attr_cache_ptr->file_size;
        }
      ...
      case MMGSDI_CYCLIC_FILE:
        if (orig_file_size_ptr)
        {
          *orig_file_size_ptr = attr_cache_ptr->rec_len;
        }
       ...
       file_info.size != MMGSDI_INVALID_FILE_SIZE)
    {
      switch(file_info.file_type)
      {
        case MMGSDI_TRANSPARENT_FILE:
          if (orig_file_size_ptr)
          {
            *orig_file_size_ptr = file_info.size;
          }
          ...
          else if (file_info.size >= *data_len_ptr + offset)
          {
            if (*data_len_ptr == 0)
            {  
              /* If offset is greater than or equal to file size then return 
                 MMGSDI_INCORRECT_PARAMS as there is no data to read/write with
                 this offset */
  ...
  switch(select_cnf_ptr->file_attrib.file_type)
  {
    case MMGSDI_TRANSPARENT_FILE:
      if (orig_file_size_ptr)
      {
        *orig_file_size_ptr = select_cnf_ptr->file_attrib.file_size;
      }
      ...
      else if (select_cnf_ptr->file_attrib.file_size >= *data_len_ptr + offset)
      {
        if (*data_len_ptr == 0)
        {
          /* If offset is greater than or equal to file size then return 
             MMGSDI_INCORRECT_PARAMS as there is no data to read/write with
             this offset */
          if(select_cnf_ptr->file_attrib.file_size > offset)
          {
    ...
    case MMGSDI_LINEAR_FIXED_FILE:
      if (orig_file_size_ptr)
      {
        *orig_file_size_ptr = select_cnf_ptr->file_attrib.file_info.linear_fixed_file.rec_len;
      }
    ...
    case MMGSDI_CYCLIC_FILE:
      if (orig_file_size_ptr)
      {
        *orig_file_size_ptr = select_cnf_ptr->file_attrib.file_info.cyclic_file.rec_len;
      }
    ...
    case MMGSDI_BY_PATH_ACCESS:
      ...
      if(access_1_ptr->file.path_type.path_len == access_2_ptr->file.path_type.path_len &&
         memcmp(access_1_ptr->file.path_type.path_buf,
                ...
                (sizeof(uint16) * access_1_ptr->file.path_type.path_len)) == 0)
      {
        are_equal = TRUE;
      }
      break;
...
{
  boolean access_valid = TRUE;
  
  if(request_length == 0)
  {
    if(offset >= MMGSDI_MAX_TRANSPARENT_FILE_SIZE)
    {
      access_valid = FALSE;
    }
  }
  ...
  {
    if((offset + request_length) > MMGSDI_MAX_TRANSPARENT_FILE_SIZE)
    {
      access_valid = FALSE;
    }
  }
  if(!access_valid)
  {
    MMGSDIUTIL_DEBUG_MSG_ERROR_2("Invalid Access Data Len: 0x%x or Offset: 0x%x ",
                                 request_length, offset);
  }
  return access_valid;
} /* mmgsdi_file_transparent_is_access_range_valid */


/* ==========================================================================
FUNCTION:      MMGSDI_FILE_CHECK_ACCESS_SECURITY_CONDITION
...
==========================================================================*/
static mmgsdi_return_enum_type mmgsdi_file_check_access_security_condition(
  ...
  const mmgsdi_file_security_type * security_status_ptr)
{
  ...
  switch(security_status_ptr->protection_method)
  {
    ...
    case MMGSDI_NEVER_ALLOWED:
      UIM_MSG_HIGH_0("Security Access set to NEVER");
    ...
    {
      if (security_status_ptr->protection_pin_ptr != NULL)
      {
  ...
  return MMGSDI_ACCESS_DENIED;
} /* mmgsdi_file_check_access_security_condition */


/* ==========================================================================
FUNCTION:      MMGSDI_FILE_SKIP_ACCESS_CHECK

DESCRIPTION:
  This function checks if the file's access check needs to be skipped.
...
SIDE EFFECTS:
  None
==========================================================================*/
static boolean mmgsdi_file_skip_access_check
(
  mmgsdi_slot_id_enum_type         slot_id,
  const mmgsdi_int_app_info_type  *prov_app_info_ptr,
  const mmgsdi_access_type        *access_ptr,
...
{
  mmgsdi_return_enum_type    mmgsdi_status     = MMGSDI_SUCCESS;
  mmgsdi_nv_context_type     slot_efs_context  = MMGSDI_NV_CONTEXT_INVALID;

  if(access_ptr == NULL || prov_app_info_ptr == NULL ||
     !mmgsdi_util_is_slot_valid(slot_id))
  {
    return FALSE;
  }

  slot_efs_context = mmgsdi_util_get_efs_item_index_for_slot(slot_id);

  /* override access for EF with configuration issue in commercial card
     with special permissions to update Kc and KcGPRS */
  if((cmd_type == MMGSDI_READ_REQ || cmd_type == MMGSDI_WRITE_REQ) &&
     (access_ptr->file.file_enum == MMGSDI_USIM_KC ||
      access_ptr->file.file_enum == MMGSDI_USIM_KCGPRS ||
      access_ptr->file.file_enum == MMGSDI_GSM_KC ||
      access_ptr->file.file_enum == MMGSDI_GSM_KCGPRS) &&
      (mmgsdi_nv_get_device_feature_status(MMGSDI_FEATURE_SPECIAL_USIM_ARR) == MMGSDI_FEATURE_ENABLED) &&
      (prov_app_info_ptr->pin1_ptr->status == MMGSDI_PIN_DISABLED ||
       prov_app_info_ptr->pin1_ptr->status == MMGSDI_PIN_ENABLED_VERIFIED))
  {
    return TRUE;
  }
  else if(cmd_type == MMGSDI_READ_REQ &&
          access_ptr->file.file_enum == MMGSDI_USIM_AD &&
          mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_IGNORE_READ_SEC_ATTRIBUTES_FOR_EF_USIM_AD, 
                                            slot_efs_context) == MMGSDI_FEATURE_ENABLED)
  {
    return TRUE;
  }
  else if(cmd_type == MMGSDI_READ_REQ &&
          ...
          mmgsdi_nv_get_slot_feature_status(MMGSDI_FEATURE_IGNORE_READ_SEC_ATTRIBUTES, 
                                            slot_efs_context) == MMGSDI_FEATURE_ENABLED)
  {
    return TRUE;
  }
...
{
  const mmgsdi_file_security_type  *security_status_ptr  = NULL;
  mmgsdi_return_enum_type           mmgsdi_status        = MMGSDI_SUCCESS;
  mmgsdi_slot_id_enum_type          slot_id              = MMGSDI_MAX_SLOT_ID_ENUM;

  MMGSDIUTIL_RETURN_IF_NULL_2(prov_app_info_ptr, attr_cache_ptr);

  mmgsdi_status = mmgsdi_util_get_session_app_info(session_id, &slot_id, NULL, NULL, NULL, NULL, NULL);
  if(mmgsdi_status != MMGSDI_SUCCESS ||
  ...
  switch(cmd_type)
  {
    ...
    case MMGSDI_SEARCH_REQ:
      security_status_ptr = &security_access_ptr->read;
      break;

    case MMGSDI_WRITE_REQ:
      security_status_ptr = &security_access_ptr->write;
      break;

    case MMGSDI_INCREASE_REQ:
      security_status_ptr = &security_access_ptr->increase;
      if (attr_cache_ptr->cyclic_increase_allowed == FALSE)
      {
  ...
  mmgsdi_status = mmgsdi_file_check_access_security_condition(prov_app_info_ptr,
                                                              security_status_ptr);

  /* override access for EF with configuration issue in commercial card
     with special permissions to update Kc and KcGPRs and with permission to
     read EF AD. */
  if (mmgsdi_status != MMGSDI_SUCCESS &&
      mmgsdi_file_skip_access_check(slot_id,
                                    prov_app_info_ptr,
                                    &attr_cache_ptr->access,
                                    cmd_type))
  {
  ...
  return mmgsdi_status;
} /* mmgsdi_file_ef_access_conditions_check */
...
{
  MMGSDIUTIL_RETURN_IF_NULL_2(sec_oper_ptr, out_sec_oper_pptr);

  *out_sec_oper_pptr = NULL;
  switch(mmgsdi_file_type)
  {
    case MMGSDI_TRANSPARENT_FILE:
      *out_sec_oper_pptr = &sec_oper_ptr->transparent_file.file_security;
      break;

    case MMGSDI_LINEAR_FIXED_FILE:
      *out_sec_oper_pptr = &sec_oper_ptr->linear_fixed_file.file_security;
      break;

    case MMGSDI_CYCLIC_FILE:
      *out_sec_oper_pptr = &sec_oper_ptr->cyclic_file.file_security;
      break;
  ...
  return MMGSDI_SUCCESS;
}/* mmgsdi_file_get_security_attributes */