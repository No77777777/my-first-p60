...
Copyright (c) 2014 - 2017 QUALCOMM Techologies, Inc (QTI) and its licensors.  All Rights
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_silent_pin.c#2 $
...
05/28/15   tl      Remove unnecessary traces
