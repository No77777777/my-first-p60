...
Copyright (c) 2012 - 2013, 2015 - 2016 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_csg.h#2 $$ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
