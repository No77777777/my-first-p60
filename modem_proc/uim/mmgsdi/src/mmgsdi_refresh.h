...
Copyright (c) 2007, 2009 - 2015, 2017, 2019 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_refresh.h#2 $$ $DateTime: 2019/10/30 06:56:05 $
