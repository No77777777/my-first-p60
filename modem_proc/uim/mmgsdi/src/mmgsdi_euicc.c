...
Copyright (c) 2016 - 2018 QUALCOMM Technologies, Inc (QTI) and
...
$Header: //components/rel/uim.mpss/6.1.0/mmgsdi/src/mmgsdi_euicc.c#2 $$ $DateTime: 2019/10/30 06:56:05 $
...
)
{
  ...
  do
  {
    ...
    req_header.client_id         = mmgsdi_get_global_client_id();
    ...
    if(mmgsdi_status == MMGSDI_SUCCESS)
    {
      ...
      select_ptr->request_header.client_id         = mmgsdi_get_global_client_id();
