...
=============================================================================*/
/*=============================================================================
   Copyright (c) 2003-2019 QUALCOMM Technologies, Inc(QTI).
   All rights reserved.
...
$Header: //components/rel/uim.mpss/6.1.0/api/gstk_exp.h#2 $

when       who     what, where, why
--------   ---     --------------------------------------------------------------------
02/12/19   gs      Send error TR when the Local Address is present
10/24/18   ks      Removing incorrect entries in default app specific TP
...
09/23/16   gs      Clean-up of unused function
...
10/29/15   gm      Converting to unsigned variables.
...
#define GSTK_REG_CATEGORY_R_CMD                 0x00000007
  /**<  Category R commands; Contactless state changed cmd/req. */
#define GSTK_REG_CATEGORY_N_CMD                 0x00000008
  /**<  Category R commands; Contactless state changed cmd/req. */
...
*/
/* Class R commands */
#define GSTK_REG_CONTACTLESS_STATE_CHANGED_EVT  0x0000004000000000LL
  /**< Registers for Contactless State Changed Command */
#define GSTK_REG_CONTACTLESS_STATE_REQ_EVT      0x0000008000000000LL
  /**< Registers for Contactless State Request Command */
/** @} */ /* end_name Category R */
...
*/
/* Class N commands */
#define GSTK_REG_GEO_LOC_REQ_EVT                0x0000010000000000LL
  /**< Registers for Geographical location Request Command */
/** @} */ /* end_name Category N */
...
#define GSTK_REG_PROACTIVE_CMD_EVT             \
  ...
  GSTK_REG_CONTACTLESS_STATE_REQ_EVT     |     \
  GSTK_REG_GEO_LOC_REQ_EVT)
...
#define GSTK_CMD_STK_GEO_LOC_REQ                0x16
  /**< Geographical Location Request proactive command tag. */
...
#define GSTK_CMD_STK_CONTACTLESS_STATE_CHANGED  0x71
  /**< Contactless state changed proactive command tag. */
...
#define GSTK_GEO_LOC_REPORT_SUPPORT                   0x1710
  /**< Gegraphical location report envelope command support */
...
#define GSTK_GEO_LOC_REQUEST_SUPPORT                  0x1E20
  /**< Geographical lcoation request Proactive command support */
/** @} */ /* end_name 30th Byte - Upper Layer Information */

/** @name 31st Byte - Upper Layer Information
  @{ */
#define GSTK_CONTACTLESS_STATE_CHANGED_SUPPORT        0x1F01
  /**< Contactless State Changed Proactive command support. */
#define GSTK_PROVIDE_LOCAL_INFO_CSG_SUPPORT           0x1F02
  /**< Provide local information (CSG) support. */
/** @} */ /* end_name 31st Byte - Upper Layer Information */
...
#define GSTK_PROVIDE_LOCAL_INFO_ACCESS_TECH_SUPPORT   0x0980
  /**< Provide local information (access tech) support. Supported values: 1 (Default) and 0. */ /* value = (1,0) */  /* default = 1 */
...
#define GSTK_CSG_CELL_SELECTION_SUPPORT               0x1A01
  /**< CSG Cell Selection. */
#define GSTK_CONTACTLESS_STATE_REQ_EVT_SUPPORT        0x1A02
  /**< Contactless State request event support. */
/** @} */ /* end_name 26th Byte - Predefined API Support Values */
...
typedef enum {
  ...
  GSTK_CONTACTLESS_STATE_CHANGED_REQ  = 0x22, /**< Proactive command: Contactless State Changed. */
  GSTK_GEO_LOC_REQ                    = 0x23, /**< Proactive command: Geographical location report. */
  ...
  GSTK_CONTACTLESS_STATE_REQ_EVT_IND_RSP  = 0x9A, /**< Envelope response: Contactless State Req. */
  GSTK_GEO_LOC_REPORT_RSP                 = 0x9B, /**< Envelope response: Geographical location report. */
  ...
  GSTK_CONTACTLESS_STATE_CHANGED_CNF = 0x61, /**< Terminal response: Contactless State Changed. */
  GSTK_PROVIDE_CSG_INFO_CNF          = 0x306,/**< Terminal response: Provide Local Information (CSG information). */
  GSTK_GEO_LOC_CNF                   = 0x307, /**< Terminal response: Geographical Location Request. */
  ...
  GSTK_CONTACTLESS_STATE_REQ_EVT_IND  = 0x79, /**< Envelope command: Contactless State Req. */
  GSTK_GEO_LOC_REPORT_IND             = 0x80, /**< Envelope command: Contactless State Req. */
  ...
  */
  ...
  GSTK_SETUP_EVT_CONTACTLESS_STATE_REQ_NOTIFY  = 0x107,/**< Envelope command: Set Up Event List (Contactless State Req). */
  ...
  */
  ...
  GSTK_DS_WLAN_IP_ADDR_CHANGE_IND    = 0x306,/**< DS Indication: WLAN IP address change */
...
/*===========================================================================
--  Enum: gstk_contactless_state_req_enum_type
===========================================================================*/
/**
  Contactless State envelope request type.
*/
typedef enum
{
  GSTK_CONTACTLESS_STATE_ENABLE   = 0x00,  /**< Enable contactless; indicates that
                                            the handset requests to enable the
                                            contactless functionality in the
                                            UICC. */
  GSTK_CONTACTLESS_STATE_DISABLE  = 0x01,  /**< Disable contactless; indicates that
                                            the handset requests to disable the
                                            contactless functionality in the
                                            UICC. */
  GSTK_CONTACTLESS_STATE_REQUEST  = 0x02,  /**< Get contactless state; indicates that
                                            the handset requests the current state
                                            of the contactless functionality
                                            in the UICC. */
  GSTK_CONTACTLESS_STATE_MAX      = 0xFF
}
gstk_contactless_state_req_enum_type;
...
/*===========================================================================
  Enum - gstk_contactless_func_state_enum_type
===========================================================================*/
/**
  GSTK Contactless funcationality state data
  Values based on 102 223 Rel 12 8.92
*/
typedef enum
{
  GSTK_CONTACTLESS_FUNC_STATE_ENABLED                  = 0x00,
  GSTK_CONTACTLESS_FUNC_STATE_DISABLED                 = 0x01,
  GSTK_CONTACTLESS_FUNC_STATE_INVALID                  = 0xFF
}
gstk_contactless_func_state_enum_type;

/*===========================================================================
  Enum - gstk_data_rate_format_type - Data rate format information
===========================================================================*/
/**
  GSTK data rate format.
*/
typedef enum
{
  GSTK_DATA_RATE_FORMAT_INVALID_TYPE        = 0x00,
  GSTK_DATA_RATE_FORMAT_EMPTY_TYPE          = 0x01,  
  GSTK_DATA_RATE_FORMAT_MIN_MAX_TYPE        = 0x02,
  GSTK_DATA_RATE_FORMAT_MIN_MAX_EX_TYPE     = 0x03,
  GSTK_DATA_RATE_FORMAT_MAX_TYPE            = 0xFF
} gstk_data_rate_format_type;
...
/*===========================================================================
--  Struct: gstk_nmea_sentence_type
===========================================================================*/
/**
  @brief Nmea sentece information.
*/
typedef struct {
  uint8                        length;
    /**< Length of the NMEA sentence. */
  uint8                       *nmea_ptr;
    /**< Includes the NMEA sentence. */
}
gstk_nmea_sentence_type;
...
typedef struct {
  ...
  gstk_data_rate_format_type           data_rate_format;
    /**< Data rate format (extended or normal). */    
}
...
*/
typedef struct {
  boolean                             is_tlv_present;
    /**< Set to True if the structure has valid info present */
...
typedef struct
{
    uint32               data_len; /**< Length of the data pointer. */
    uint8              * data;     /**< Pointer to the data. */
}
gstk_ch_data_type;

/*===========================================================================
--  Struct: gstk_geo_loc_para_type
===========================================================================*/
/**
  @brief Geo Location parameter.
*/
typedef struct
{
  uint8 horizontal_accuracy;
  uint8 vertical_coordinate;
  uint8 velocity;
  uint8 pref_GAD_shapes;
  uint8 pref_NMEA_sentences;
  uint8 pref_max_rsp_time;
}
gstk_geo_loc_para_type;
...
typedef struct {
  ...
  uint8                ims_uri[GSTK_MAX_IMS_CALL_PARAM_SIZE];
    /**< IMS call SIP invite message parameter. Fill the truncated value if the IMS
         URI length is greater than GSTK_MAX_IMS_CALL_PARAM_SIZE */
  boolean              ims_uri_truncated;
   /**<Set this Flag if IMS URI actual length is greater than GSTK_MAX_IMS_CALL_PARAM_SIZE */
...
/*===========================================================================
--  Struct: gstk_contactless_state_changed_req_type
===========================================================================*/
/**
  @brief GSTK parses the Contactless State changed proactive command into this
  structure.
*/
typedef struct {
...
gstk_contactless_state_changed_req_type;
/** @} */ /* end_proactCmdStructs */

/*===========================================================================
--  Struct: gstk_geo_loc_req_type
===========================================================================*/
/**
  @brief GSTK parses the Geographical location request proactive command into this structure.
*/
typedef struct {
  gstk_alphabet_type                 alpha;
    /**< Alpha to be displayed. */
  ...
  gstk_geo_loc_para_type             geo_loc_para;
    /**< geographical location parameter. */
}
gstk_geo_loc_req_type;
...
typedef struct {
  ...
  union {
    ...
    gstk_contactless_state_req_enum_type    contactless_state_req_evt_ind;
      /**< Contactless State Req event data*/     
...
typedef struct {
  ...
  union {
      ...
      */
      ...
      gstk_contactless_state_changed_req_type  contactless_state_changed_cmd_req;
        /**< Contactless State Changed response data. */
      gstk_geo_loc_req_type                    geo_loc_pro_cmd_req;
        /**< Geographical location request data. */
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_slot_send_envelope_geo_loc_report_cmd
(
  gstk_slot_id_enum_type          slot,
  uint32                          user_data,
