...
Copyright (c) 2000 - 2010, 2012 - 2014, 2016 by QUALCOMM Technologies, Inc(QTI).
All Rights Reserved.
===========================================================================*/
/*===========================================================================
...
$Header: //components/rel/uim.mpss/6.1.0/api/nvruimi.h#2 $ $DateTime: 2019/10/30 06:56:05 $ $Author: pwbldsvc $
...
/* NVRUIM session ID types */
typedef enum {
  NVRUIM_1X_PROV_PRI_SESSION    = 0,    /* mapped to MMGSDI_1X_PROV_PRI_SESSION */
  NVRUIM_1X_PROV_SEC_SESSION    = 1,    /* mapped to MMGSDI_1X_PROV_SEC_SESSION */
  NVRUIM_1X_PROV_TER_SESSION    = 2     /* mapped to MMGSDI_1X_PROV_TER_SESSION */
...
DESCRIPTION
  This function checks whether 3GPD data and processing should come from the
  RUIM or from NV for the given sub.
