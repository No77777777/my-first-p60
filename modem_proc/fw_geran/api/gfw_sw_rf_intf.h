...
$Header: //source/qcom/qct/modem/fw/components/fw_geran.mpss/rel/17.0/api/gfw_sw_rf_intf.h#2 $
...
// --------------------------------------------------------------------------
typedef struct tag_GfwRfInitEvent
{
   union
   {
