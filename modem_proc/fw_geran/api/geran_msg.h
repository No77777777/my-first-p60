...
$Header: //source/qcom/qct/modem/fw/components/fw_geran.mpss/rel/17.0/api/geran_msg.h#3 $
...
#define GFW_CCS_TX_ERROR (1 << 0)
#define GFW_CCS_ACQ_LATE_ERROR (1 << 1)
#define GFW_CCS_X2G_ACQ_CANCELLED_ERROR (1 << 2)
/*-----------------------------------------------------------------------*/
/*                                                                       */
/*-----------------------------------------------------------------------*/
...
typedef struct
{
  ...
  uint8 deviceID;
  uint8 enterMode;          // Primary / Secondary
...
/*! @brief Asynchronous cleanup done command message*/
typedef struct
{
  msgr_hdr_s   hdr;        //!< MSGR header
  GfwCleanupType cleanup;  //!< indicate clean up scenario
} GfwHostCleanupDoneCmd;
...
enum
{
  ...
  MSGR_DEFINE_UMID( GERAN, FW, CMD, CCS_STATUS,  0x18, GfwAsyncCcsStatusCmd),
  MSGR_DEFINE_UMID( GERAN, FW, CMD, TX_EXIT,  0x19, GfwHostTxExitCmd),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, TX_EXIT,  0x1A, GfwHostTxExitRsp),
  MSGR_DEFINE_UMID( GERAN, FW, CMD, CLEANUP_DONE,  0x1B, GfwHostCleanupDoneCmd),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, INVALID_RFLM_TX_INDEX,  0x1C, GfwHostInvalidTxRflmIndexRsp),
  ...
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, CCS_STATUS,  0x18, GfwAsyncCcsStatusCmd),
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, TX_EXIT,  0x19, GfwHostTxExitCmd),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, TX_EXIT,  0x1A, GfwHostTxExitRsp),
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, CLEANUP_DONE,  0x1B, GfwHostCleanupDoneCmd),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, INVALID_RFLM_TX_INDEX,  0x1C, GfwHostInvalidTxRflmIndexRsp),
  ...
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, CCS_STATUS,  0x18, GfwAsyncCcsStatusCmd),
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, TX_EXIT,  0x19, GfwHostTxExitCmd),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, TX_EXIT,  0x1A, GfwHostTxExitRsp),
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, CLEANUP_DONE,  0x1B, GfwHostCleanupDoneCmd),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, INVALID_RFLM_TX_INDEX,  0x1C, GfwHostInvalidTxRflmIndexRsp),
