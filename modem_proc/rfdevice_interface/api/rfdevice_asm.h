...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_asm.h#1 $

when       who    what, where, why
--------   ---   -------------------------------------------------------------------
09/23/15   hzh    Added QFE script logging
08/31/15   dbc    Add wlan_port_override member
...
{
public:
  static boolean RFFE_REG_DUMP_DEBUG_ASM;
  rfdevice_asm();
