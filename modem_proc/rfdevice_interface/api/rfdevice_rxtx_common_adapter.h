...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_rxtx_common_adapter.h#1 $
...
public:
 ...
 /*! Returns FBRX RSB coefficients for a tech/band */
  ...
  boolean get_rxtx_simultaneous_rat_support(boolean* is_rxtx_separate_rat);
