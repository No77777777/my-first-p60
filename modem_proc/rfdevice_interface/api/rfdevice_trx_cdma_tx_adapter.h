...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_trx_cdma_tx_adapter.h#1 $
...
public:
  ...
  virtual boolean tx_pwr_wakeup(void);
  
  virtual boolean tx_pwr_sleep(void);
