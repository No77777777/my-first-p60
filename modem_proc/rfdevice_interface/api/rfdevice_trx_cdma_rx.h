...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_trx_cdma_rx.h#1 $
...
08/17/15   shb   Fixed AT compiler error
...
public:
  ...
  */
  ...
  /*!
    ...
    This function will not perform any RFFE transaction or any actions on hardware
    ...
    Success/Failure flag
  */
  virtual boolean get_rxagc_reload_script(rfm_mode_enum_type mode,
                                          rfm_cdma_band_class_type band,
                                          rfm_cdma_chan_type chan,
                                          uint32 rx_bw_khz,
                                          rf_buffer_intf *buf_obj_ptr,
 ...
 */
  ...
  */
  ...
  /*! 
    ...
    */
  virtual boolean get_lna_state( uint8* lna_rd,
                                 rfm_cdma_band_class_type band,
                                 rfdevice_rx_mode_type rx_mode,
                                 rfdevice_trx_cdma_rx* paired_device)=0;
  ...
  */
  ...
  /*----------------------------------------------------------------------------*/
  virtual 
  boolean create_meas_disable_script
  (
    rf_buffer_intf* buf_obj_ptr,  
    rfm_cdma_band_class_type band,
    rfdevice_meas_scenario_type meas_type,
  ...
  {
    RF_MSG( RF_ERROR, "create_meas_disable_script: Derived class does not support this API!" );
    return FALSE;
  }
