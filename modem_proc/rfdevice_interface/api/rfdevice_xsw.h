...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_xsw.h#1 $
$Author: pwbldsvc $
...
09/24/15   sr     Added Support for 3rd party XSW. 
...
typedef struct 
{
   ...
   rfdevice_xsw_trigger_enum_type trigger;
...
{
public:
 static boolean RFFE_REG_DUMP_DEBUG_XSW;
 rfdevice_xsw();
...
/*!
  ...
  boolean indicating pass or fail  
*/	
  virtual boolean get_cross_switch_config(rfdevice_xsw_config_type* xsconfig);
...
/*!
  ...
  boolean indicating pass or fail   
*/
  virtual boolean init (int32* rfc_data) { return TRUE;}

  /*----------------------------------------------------------------------------*/
  /*!
    @brief
    interface function for xsw sleep
  ...
  */
  ...
  /*!
    @brief
    interface function for xsw wakeup
