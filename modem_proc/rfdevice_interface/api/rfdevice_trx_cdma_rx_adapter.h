...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_trx_cdma_rx_adapter.h#1 $
...
public:
  ...
  virtual boolean rx_pwr_wakeup(void);
  
  virtual boolean rx_pwr_sleep(void);
