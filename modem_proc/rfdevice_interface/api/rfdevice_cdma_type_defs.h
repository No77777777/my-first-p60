...
/*==============================================================================
  ...
  $Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_cdma_type_defs.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
12/03/15   rs      Added interface for WTR rx\tx power wakeup to support test devices (RUMI)
05/01/15   spa     Add Gain state as input in rfdevice_1x_jd_thresh_type
...
/*!
  ...
  Success/Failure status of API
*/
typedef boolean (*rf1x_rx_rx_pwr_wakeup_func_ptr_type) 
(
  void
);
...
/*!
  ...
  Success/Failure status of API
*/
typedef boolean (*rf1x_rx_rx_pwr_sleep_func_ptr_type) 
(
  void
);
...
/*!
  ...
  Success/Failure status of API
*/
typedef boolean (*rf1x_tx_tx_pwr_wakeup_func_ptr_type) 
(
  void
);
...
/*!
  ...
  Success/Failure status of API
*/
typedef boolean (*rf1x_tx_tx_pwr_sleep_func_ptr_type) 
(
  void
);
...
typedef struct
{
  ...
  rf1x_rx_rx_pwr_wakeup_func_ptr_type rx_pwr_wakeup;
  /*!< Function to create rx_pwr_wakeup script */

  rf1x_rx_rx_pwr_sleep_func_ptr_type rx_pwr_sleep;
  /*!< Function to create rx_pwr_sleep script */
...
typedef struct
{
  ...
  rf1x_tx_tx_pwr_wakeup_func_ptr_type tx_pwr_wakeup;
  /*!< Function to create tx_pwr_wakeup script */

  rf1x_tx_tx_pwr_sleep_func_ptr_type tx_pwr_sleep;
  /*!< Function to create tx_pwr_sleep script */
