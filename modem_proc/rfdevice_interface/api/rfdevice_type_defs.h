...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_type_defs.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
06/17/15   aks     Expanded rfdevice_trx_phy_path_enum_type upto 8 chains
05/13/15   dps     Added support for power logging using rfdevice_wtr_config_bitmask
05/05/15   aks     Expanded rfdevice_rx_mode_type enum list to include DRx2 and DRx3
04/07/15   aks     Added enum to distinguish between PRx and Drx operation modes 
...
typedef enum
{
  ...
  /*! First order receiver diversity */
  RFDEVICE_DRX_OPER_MODE,

  /*! Second-order receiver diversity  */
  RFDEVICE_DRX2_OPER_MODE,

  /*! Third-order receiver diversity  */
