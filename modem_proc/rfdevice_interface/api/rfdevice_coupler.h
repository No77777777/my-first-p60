...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_coupler.h#1 $
$Author: pwbldsvc $
$DateTime: 2021/03/09 05:01:20 $

when       who    what, where, why
--------   ---   ------------------------------------------------------------------- 
09/23/15   hzh   Added QFE script logging
...
typedef enum
{
  RFDEVICE_COUPLER_GAIN_0,
  RFDEVICE_COUPLER_GAIN_1,
  RFDEVICE_COUPLER_GAIN_2,
  RFDEVICE_COUPLER_GAIN_3,
  RFDEVICE_COUPLER_GAIN_MAX = RFDEVICE_COUPLER_GAIN_3,
  RFDEVICE_COUPLER_GAIN_DEFAULT,
  RFDEVICE_COUPLER_GAIN_INVALID = 0xFF
} rfdevice_coupling_gain_type;
...
typedef enum
{
RFDEVICE_COUPLER_OUTPUT_TYPE_0,
RFDEVICE_COUPLER_OUTPUT_TYPE_1,
RFDEVICE_COUPLER_OUTPUT_TYPE_MAX = RFDEVICE_COUPLER_OUTPUT_TYPE_1,
RFDEVICE_COUPLER_OUTPUT_TYPE_DEFAULT,
RFDEVICE_COUPLER_OUTPUT_TYPE_INVALID = 0xFF
}rfdevice_coupler_output_type;
...
typedef struct
{
  ...
  /* coupler port for corresponding antenna and filter*/
  uint8 port;
...
{
public:
 static boolean RFFE_REG_DUMP_DEBUG_COUPLER;
 rfdevice_coupler();
