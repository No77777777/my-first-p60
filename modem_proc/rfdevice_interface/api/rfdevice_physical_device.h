...
/*===========================================================================
  ...
  $Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_physical_device.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
12/27/19   smi   Add support to get RFFE device register address list
12/18/17   dbc     Added support for DPD capable flag
05/09/16   dbc     Add support supports_efs_dat() API
01/06/16   dbc     Add support for Enable\Disable voting in physical device.
...
public:
 ...
 /*To support physical device based sleep/wakeup voting*/
  ...
  /* To support physical device based enable/disable based voting*/
  virtual bool vote_enable_disable(rfc_logical_device_info_type *logical_device_cfg, bool enable_disable);
  
  virtual bool has_common_tab();

  virtual bool supports_efs_dat();

  virtual void set_dpd_capable(boolean);

  virtual boolean get_dpd_capable(void);
