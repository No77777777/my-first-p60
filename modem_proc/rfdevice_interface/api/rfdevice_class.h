...
$Header: //components/rel/rfdevice_interface.mpss/2.11/api/rfdevice_class.h#1 $
...
class rfdevice_class: public rfa
{
  ...
  public: 
    ...
    rfdevice_id_enum_type rfdevice_id_get(void) const;
    rfdevice_type_enum_type rfdevice_type_get(void) const;
    uint32 rfdevice_instance_num_get(void) const;
    uint16 rfdevice_rev_id_get(void) const;
