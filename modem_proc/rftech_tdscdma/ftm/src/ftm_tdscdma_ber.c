...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_tdscdma.mpss/3.11/ftm/src/ftm_tdscdma_ber.c#1 $ 
  $DateTime: 2021/03/09 05:09:33 $ 
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
05/10/15   jps     Set Q6 clocks to max speed in Non Signaling mode
...
extern void ftm_tdscdma_ns_enter(void);
extern void ftm_tdscdma_ns_exit(void);
