...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_tdscdma.mpss/3.11/api/rf_tdscdma_mdsp.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------- 
06/27/15   jak     Use rx chain for ftm_tdscdma_get_rx_level_dbm
03/17/15   whz     Add support for TempComp
...
*/
boolean rf_tdscdma_mdsp_get_raw_rx_agc(ftm_receive_chain_handle_type rx_chain, int16 *rxlvldBm, int16* rxlvlagc);
