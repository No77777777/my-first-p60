...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_tdscdma.mpss/3.11/api/rf_tdscdma_mdsp_rf_event.h#1 $
...
06/19/15   ych     Added extra home restore buffer
05/16/15   nsh     Support IP2 Cal
...
typedef struct
{
  ...
  rfm_device_enum_type pri_paired_device;
...
typedef enum
{
  ...
  RF_TDS_EVT_COUPLER_FWD,
  RF_TDS_EVT_COUPLER_REV,
...
typedef enum
{
  ...
  RF_TDS_EVT_HOME_RESTORE_EVENT_SCRIPT_BUF_2,
  
  // To add more event scripts
  RF_TDS_EVT_DO_IP2_CAL_CODE_WRITE_SCRIPT,

  /* VSWR coupler FWD and REV */ 
  RF_TDS_EVT_VSWR_COUPLER_FWD_SCRIPT,
  RF_TDS_EVT_VSWR_COUPLER_REV_SCRIPT,

  /* AutoPin */
  RF_TDS_EVT_AUTOPIN_WRITE_SCRIPT_BUF_0,
  RF_TDS_EVT_AUTOPIN_WRITE_SCRIPT_BUF_1,

  /* DO_DEVICE_STATUS event: RF_DEVICE_STATUS */ 
  RF_TDS_EVT_DEVICE_STATUSS_READ_SCRIPT,
...
void rf_tdscdma_rf_event_device_status_trigger_read(void* ccs_arg);
