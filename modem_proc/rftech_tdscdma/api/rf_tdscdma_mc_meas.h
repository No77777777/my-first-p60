...
$Header: //components/rel/rftech_tdscdma.mpss/3.11/api/rf_tdscdma_mc_meas.h#1 $
...
/*!
  ...
  correctly or not.
*/
rfm_meas_result_type rf_tdscdma_mc_meas_enter( rfm_meas_enter_param_type *meas_enter_param, boolean is_source);
...
/*!
  ...
  correctly or not.
*/
rfm_meas_result_type rf_tdscdma_mc_meas_exit( rfm_meas_exit_param_type *meas_exit_param, boolean is_source);
...
/*!
  ...
  correctly or not.
*/
rfm_meas_result_type rf_tdscdma_mc_meas_build_scripts( rfm_meas_setup_param_type *meas_scripts_param, boolean is_source);
...
rfm_meas_result_type rf_tdscdma_mc_meas_reset_scripts( rfm_meas_setup_param_type *meas_scripts_param, boolean is_source);
...
rfm_meas_result_type rf_tdscdma_mc_meas_pre_config( rfm_meas_setup_param_type *meas_scripts_param, boolean is_source);
