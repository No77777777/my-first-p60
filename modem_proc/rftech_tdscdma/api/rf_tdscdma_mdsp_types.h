...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_tdscdma.mpss/3.11/api/rf_tdscdma_mdsp_types.h#1 $
...
typedef enum {
  RF_TDSCDMA_MDSP_TFW_STATE_INACTIVE,
  RF_TDSCDMA_MDSP_TFW_STATE_STANDBY,
  RF_TDSCDMA_MDSP_TFW_STATE_ACQUISITION,
  RF_TDSCDMA_MDSP_TFW_STATE_TRACKING,
  RF_TDSCDMA_MDSP_TFW_STATE_FTM_CAL,
  RF_TDSCDMA_MDSP_TFW_STATE_FTM,
  RF_TDSCDMA_MDSP_TFW_STATE_FTM_ACQ,
  RF_TDSCDMA_MDSP_TFW_STATE_FTM_TRK,
  RF_TDSCDMA_MDSP_TFW_STATE_FTM_CX8,
  RF_TDSCDMA_MDSP_TFW_STATE_INVALID,
} rf_tdscdma_mdsp_tfw_state_t;
