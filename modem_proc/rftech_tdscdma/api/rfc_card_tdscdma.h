...
$Header: //components/rel/rftech_tdscdma.mpss/3.11/api/rfc_card_tdscdma.h#1 $
...
03/30/15   nsh     Smarly handling TxRx and RxTx scenario for GRFC ANT_SEL
...
uint32 rfc_tdscdma_get_fb_chain(rfm_device_enum_type tx_device, rfcom_tdscdma_band_type band);
