...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_tdscdma.mpss/3.11/api/ftm_tdscdma_ctl.h#1 $ 
...
06/23/15   dbc     Add ftm_tdscdma_set_pa_tunable_cap() API
...
extern rfm_device_enum_type ftm_tdscdma_pri_device_for_ftm_rfmode_enter;
...
/*!
  @brief
  Configure FTM TDSCDMA Device status emable Request Packet
*/
typedef PACK(struct)
{
  uint8   cmd;                /*!< Command Identification */
  uint8   sub_sys;            /*!< Sub-system Identification. For instance - 10 for FTM HWTC */
  uint16  mode;               /*!< RF Mode Identification. For Instance - 42 for FTM_TDSCDMA_C */
  uint16  ftm_cmd_id;         /*!< FTM Sub Command. Example-  FTM_TDSCDMA_CONFIGURE_DEBUG_MODE */
  uint8   device_id;          /*!< Device_id */ 
  uint8   debug_en;           /*!< Debug Enable */ 
  
}
ftm_tdscdma_device_status_enable_request_packet_type;

/*!
  @brief
  Configure FTM TDSCDMA Device status Request Packet
*/
...
typedef PACK(struct)
{
  ...
  uint8   sub_sys;            /*!< Sub-system Identification. For instance - 10 for FTM HWTC */
  uint16  mode;               /*!< RF Mode Identification. For Instance - 42 for FTM_TDSCDMA_C */
  uint16  ftm_cmd_id;         /*!< FTM Sub Command. Example-  FTM_TDSCDMA_DEVICE_STATUS_READ */
  uint8   device_id;          /*!< device_id */
  uint8   channel;            /*!< channel */
  uint8   slave_id;           /*!< slave_id*/
  uint16  reg;                /*!< register*/
  uint8   extended_type;      /*!< extended type*/
  uint8   rx_tx_type;         /*!< rx_tx type*/
  
}
ftm_tdscdma_device_status_read_request_packet_type;
...
===========================================================================*/
void ftm_tdscdma_set_mode(ftm_mode_id_type mode, rfm_device_enum_type device);
