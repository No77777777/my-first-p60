...
/*===========================================================================
/f
Copyright (c) 2009, 2010, 2011, 2012-2015 by Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/rftech_tdscdma.mpss/3.11/rf/nv/src/rfnv_tdscdma_b39.c#1 $
...
extern boolean rf_tds_AsDiv_eLNA_gain_offset_B39_NV_present;
extern boolean rf_tds_AsDiv_tx_offset_B39_NV_present;
#endif
...
const rfcommon_rfnv_items_list_type rfnv_tdscdma_b39_tx_items_list[ ] =
{
  ...
  //ET delay NV
  {RFNV_TDSCDMA_B39_TX_XPT_DELAY_I, NV_ITEM_ATTRIB_NON_CRTCL_BMSK},
  {RFNV_TDSCDMA_B39_TX_ET_DELAY_OFFSETS_VS_FREQ_VS_TEMP_I, NV_ITEM_ATTRIB_NON_CRTCL_BMSK},
  {RFNV_TDSCDMA_B39_TX_STATIC_DATA_I, NV_ITEM_ATTRIB_NON_CRTCL_BMSK},
...
#ifdef FEATURE_RF_TDS_ASDIV_ELNA_GAIN
  case RFNV_TDSCDMA_B39_RX_STATIC_DATA_I: 
      rf_tds_AsDiv_eLNA_gain_offset_B39_NV_present = 
          rf_tdscdma_populate_rx_static_data_I(&(rfnv_tdscdma_b39_rx_tbl.rx_elna_gain_offset_swpt),
                                               rfnv_item_ptr); 
  break;
#endif
...
)
{
  ...
  case RFNV_TDSCDMA_B39_TX_XPT_DELAY_I:
   memscpy((void*)&rfnv_tdscdma_b39_tx_tbl.xpt_path_delay,sizeof(rfnv_tdscdma_b39_tx_tbl.xpt_path_delay),
           (void*)rfnv_item_ptr,sizeof(rfnv_item_type));
   break;

  case RFNV_TDSCDMA_B39_TX_ET_DELAY_OFFSETS_VS_FREQ_VS_TEMP_I:
   memscpy((void*)&rfnv_tdscdma_b39_tx_tbl.tx_delay_offsets,sizeof(rfnv_tdscdma_b39_tx_tbl.tx_delay_offsets),
           (void*)rfnv_item_ptr,sizeof(rfnv_item_type));
   break;


#ifdef FEATURE_RF_TDS_ASDIV_ELNA_GAIN
  case RFNV_TDSCDMA_B39_TX_STATIC_DATA_I:
      rf_tds_AsDiv_tx_offset_B39_NV_present = 
          rf_tdscdma_populate_tx_static_data_I(&(rfnv_tdscdma_b39_tx_tbl.tx_elna_offset),
                                               rfnv_item_ptr); 
  break;
#endif
