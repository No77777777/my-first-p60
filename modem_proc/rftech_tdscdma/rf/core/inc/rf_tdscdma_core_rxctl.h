...
$Header: //components/rel/rftech_tdscdma.mpss/3.11/rf/core/inc/rf_tdscdma_core_rxctl.h#1 $ 
...
/*LL/HH is a place holder and only LL is supported in the NV reading structure*/
  int32 rx_elna_asdiv_offset[RF_PATHS_TABLE_SIZ][RF_TDSCDMA_MAX_LNA_GAIN_STATES][RF_TDSCDMA_NUM_RX_LIN_STATES];
#endif
