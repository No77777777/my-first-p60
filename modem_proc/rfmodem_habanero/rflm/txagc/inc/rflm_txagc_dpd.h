...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/rflm/txagc/inc/rflm_txagc_dpd.h#1 $

when         who    what, where, why
---------    ---    -----------------------------------------------------------
07/15/16     ndb    EPT selectivity feature 
...
/*----------------------------------------------------------------------------*/
void
rflm_txagc_dpd_save_unity_data
(
 uint8 chain,
 rflm_dpd_tbl_type tbl_type
);
/*----------------------------------------------------------------------------*/

void 
rflm_txagc_dpd_save_commit_unity_data
(
  uint32 txlm_handle
);
