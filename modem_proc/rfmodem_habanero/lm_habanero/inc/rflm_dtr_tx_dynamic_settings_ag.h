...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/lm_habanero/inc/rflm_dtr_tx_dynamic_settings_ag.h#1 $
...
extern rflm_dtr_tx_tx_top_group_struct tx_lte_interband_ca_tx_top[RFLM_DTR_TX_LTE_INTERBAND_CA_SW_DYNAMIC_SETTINGS_NUM];

extern void update_tx_lte_interband_ca_tx_top (
 			rflm_dtr_tx_tx_top_group_struct *target_struct ,
 			uint32 table_index 
			);
