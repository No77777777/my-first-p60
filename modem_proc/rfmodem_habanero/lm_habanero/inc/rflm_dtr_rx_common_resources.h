...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/lm_habanero/inc/rflm_dtr_rx_common_resources.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
05/20/15   dej     Add mutexing for Common Dec8 filter allocation
...
extern void rflm_dtr_rx_mutex_init(void);
#ifdef __cplusplus
}
#endif
