...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/lm_divar/inc/rflm_dtr_rx_typedef_ag.h#3 $
...
typedef enum
{
  ...
  RFLM_DTR_RX_STATE_UMTS_3C_NONET_WTR4905,
  ...
  RFLM_DTR_RX_STATE_XPT_RXFB_LTE40MHZ_WTR3925,
  RFLM_DTR_RX_STATE_ILPC_RXFB_UMTS_1C_WTR4905,
  RFLM_DTR_RX_STATE_ILPC_RXFB_CDMA_1X_WTR4905,
  RFLM_DTR_RX_STATE_ILPC_RXFB_LTE10MHZ_WTR4905,
  RFLM_DTR_RX_STATE_ILPC_RXFB_LTE20MHZ_WTR4905,
  RFLM_DTR_RX_STATE_ILPC_RXFB_TDS_WTR4905,
...
typedef enum
{
  ...
  RFLM_DTR_RX_MODE_ILPC_LTE20_LTE40, 
...
typedef enum
{
  ...
  RXLM_GROUP_COMMON_DEC8_FILT0,	/* Use Struct: rflm_dtr_rx_common_dec8_filt_group_struct */
  RXLM_GROUP_COMMON_DEC8_FILT1,	/* Use Struct: rflm_dtr_rx_common_dec8_filt1_group_struct */
  ...
  RXLM_GROUP_WB_DEC,	/* Use Struct: rflm_dtr_rx_wb_dec_group_struct */
...
typedef enum
{
  ...
  RFLM_DTR_RX_TDS_WTR3925,
  RFLM_DTR_RX_UMTS_1C_WTR3925,
  RFLM_DTR_RX_UMTS_1C_ACQ_WTR3925,
  RFLM_DTR_RX_UMTS_1C_WTR2955,
  RFLM_DTR_RX_UMTS_1C_ACQ_WTR2955,
  RFLM_DTR_RX_UMTS_1C_WTR4905,
  RFLM_DTR_RX_UMTS_1C_ACQ_WTR4905,
