...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/lm_divar/inc/rflm_dtr_rx_dynamic_settings_ag.h#3 $
...
extern rflm_dtr_rx_icifir_nb_group_struct rx_icifir_icifir_nb1[RFLM_DTR_RX_ICIFIR_SW_DYNAMIC_SETTINGS_NUM];

extern void update_rx_icifir_icifir_nb1 (
 			rflm_dtr_rx_icifir_nb_group_struct *target_struct ,
 			uint32 table_index 
			);
...
extern rflm_dtr_rx_icifir_nb_group_struct rx_single_rx_ca_icifir_nb3[RFLM_DTR_RX_SINGLE_RX_CA_SW_DYNAMIC_SETTINGS_NUM];

extern void update_rx_single_rx_ca_icifir_nb3 (
 			rflm_dtr_rx_icifir_nb_group_struct *target_struct ,
 			uint32 table_index 
			);
