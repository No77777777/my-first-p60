...
Generated at:    Tue Sep  7 15:47:06 2021
Generated using: lm_autogen.pl v5.1.36
Generated from:  v7.3.43 of Tabasco_RxFE_Register_settings.xlsx
*/
...
$DateTime: 2021/09/20 02:19:52 $
$Header: //components/rel/rfmodem_habanero.mpss/1.11/lm_divar/inc/rflm_dtr_rx_struct_ag.h#3 $
...
Habanero 7.3.43   vinuk   9/3/2021   
         Propogated BBRx AAF Settings Changes from HSR Rev 5.2 to 'bbrx_config_Divar_RxFE.xlsx - Sheet ('TABASCO_bbrx_config)      chandruk@qti.qualcomm.com            
Habanero 7.3.42   vinuk   8/18/2021   
         Propogated BBRx HSR Changes for  Rev 5 & 5.1 in 'bbrx_config_Divar_RxFE.xlsx - Sheet ('TABASCO_bbrx_config)      chandruk@qti.qualcomm.com            
Habanero 7.3.41   vinuk   6/29/2021   
         Updated Divar BBRX  Test/Config registers in 'bbrx_config_Divar_RxFE.xlsx - Sheet ('TABASCO_bbrx_config)      chandruk@qti.qualcomm.com            
Habanero 7.3.40   speshwe   9/1/2020   
         Update TEST3_ADC register according to HSR BBRx settings to fix the high DC post ADC hibernation. Overload detect is disabled for 4th order ADCs with this change. UMTS_Voice_DSR Test 3 register made same as WCDMA_SC. (https://projects.qualcomm.com/sites/IPCatalog/_layouts/15/WopiFrame.aspx?sourcedoc=/sites/IPCatalog/HSRs/Analog/Kamorta_BBRx_HSR_Settings.xlsx&action=default)      dsarma@qti.qualcomm.com            
Habanero 7.3.39   speshwe   9/1/2020   
         Revert back ADC settings for xPT_FBRx column to Jacala settings for Kamorta. Note : The AAF pole is slightly lower than LTE 40 in Jacala      dsarma@qti.qualcomm.com            
Habanero 7.3.38   speshwe   8/10/2020   
         Update ADC settings for Kamorta xPT_FBRX column. Reference document - https://projects.qualcomm.com/sites/IPCatalog/HSRs/Analog/Kamorta_BBRx_HSR_Settings.xlsx      yitankar@qti.qualcomm.com            
Habanero 7.3.37   speshwe   7/2/2020   
         Update ADC Insertion Loss for 20 and 40 MHz      dsarma@qti.qualcomm.com            
Habanero 7.3.36   speshwe   6/10/2020   
         Update NB_IMM_TRIG = 0 for NB 1 and NB 3 for LTE techs      yitankar@qti.qualcomm.com            
Habanero 7.3.35   yitankar   3/13/2020   
         Changed to Hibernation mode 1 for LTE 10MHz B7                  
Habanero 7.3.34   yitankar   2/24/2020   
         `                  
Habanero 7.3.33   yitankar   11/10/2019   
         Update offline clk in msm_reg, based on Kamorta IPCAT clock numbers.       dsarma@qti.qualcomm.com            
Habanero 7.3.32   yitankar   11/4/2019   
         Update mission mode ADC settings for Kamorta. Reference document - https://projects.qualcomm.com/sites/IPCatalog/HSRs/Analog/Kamorta_BBRx_HSR_Settings.xlsx      dsarma@qti.qualcomm.com            
Habanero 7.3.31   yitankar   10/15/2019   
         1. Enabled PCFL 10 format for NB1 at RxFE output for LTE techs      dsarma@qti.qualcomm.com            
Habanero 7.3.30   yitankar   8/27/2019   
         1. RXFE_PBS_CFG – Enable 24 bit PBS data for LTE techs. 2. Enabled PCFL 24 format for NB0 at RxFE output for LTE techs      dsarma@qti.qualcomm.com            
Jolokia 6.4.21; Tabasco 7.3.29   leonm   6/1/2016   
         1. Disabled DEC3 for ILPC_RxFB_CDMA_1x state to increase capture rate by 2x to 19.6608 MHz.        ckwong@qti.qualcomm.com            
Jolokia 6.4.21; Tabasco 7.3.28   leonm   4/25/2016   
         1. Update FeeroC RXFE_ADC_CONFIG1_REG_ADCa setting for LTE40 per Yan Wang.   2. Apply same update for Lykan/Feero LTE40 column for consistency (though not supported).        wangyan@qti.qualcomm.com            
Jolokia 6.4.20; Tabasco 7.3.27   leonm   4/25/2016   
         1. Update FeeroC Vcm cal setting per Yan Wang.        wangyan@qti.qualcomm.com            
Jolokia 6.4.20; Tabasco 7.3.26   gatesj   4/25/2016   
         1. LTE 1p4 and LTE3 BBRx modes split in Jolokia spreadsheet branch to match Tabasco branch (should have no impact to AG code) 2. Lykan and Feero Vcm cal settings updated.       jhap@qti.qualcomm.com, smanchir@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.26   gatesj   4/20/2016   
         1. BBRx settings updated for Jacala      wangyan@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.25   leonm   4/15/2016   
         1. Set PACK4_EN to 0x1 for GSM_ONLINE_POWER state to enable DEC0.        gatesj@qti.qualcomm.com,  ckwong@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.24   leonm   4/6/2016   
         1. Default value for ADC_CONTROL set to 0x5 for all techs on Tabasco.       wangyan@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.23   leonm   4/4/2016   
         1. Set ADC_CFG/a_INDEX:a for state GSM_ONLINE_POWER to 3.        gatesj@qti.qualcomm.com,  sunilk@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.22   gatesj   3/30/2016   
         1. TDS default behavior for ADC_CONTROL set to 0x5.      mliu@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.21   leonm   3/29/2016   
         1. Change GSM_ONLINE_POWER BBRx0/BBRx1 state to XPT_FBRX.        ckwong@qti.qualcomm.com,  sunilk@qti.qualcomm.com,  jhap@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.20   leonm   3/28/2016   
         1.  ADC settings updated for Tabasco derivatives. FeeroC chipset-specific settings added to the TABASCO_bbrx_config tab, to match Feero chipset-specific settings, per the ADC team.        gatesj@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.19   leonm   3/23/2016   
         1. Changed GSM_ONLINE_POWER WB/NB assignment to WB3+NB5 to align with other ILPC states.        ckwong@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.18   sunilk   3/14/2016   
         1. copying formulas instead of values for some ILPC_FBRX states      sunilk@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.17   leonm   2/25/2016   
         1. updates for TA2.3 (with WTR3925); adding new ICIFIR coefficients to ICIFIR_SW_Dynamic tab for UMTS_1C (NB0 and NB1) and UMTS_1C_ACQ (NB0) for Jacala/FeeroC/Eldarion to improve ICI 2. added UMTS_1C and UMTS_1C_ACQ columns to ICIFIR_SW_Dynamic tab for WTR2955 and WTR4905 per Pradeep/Joe      ckwong@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.16   sunilk   2/23/2016   
         1. making WB/NB decimator registers as SW dynamic; making the ILPC_LTE20_40 state as FBRx_ILPC mode      sunilk@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.15   sunilk   2/19/2016   
         1. updating ILPC_FBRX states for C2K/UMTS/TDS to have lower VSRC output rates      sunilk@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.14   sunilk   2/17/2016   
         1. updating ADC_CLK settings for 288MHz ADC rate; adding GSM_ONLINE_POWER state; adding ILPC_FBRX states and modifying LTE-10 state to use offline clock of 72MHz.      sunilk@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.13   gatesj   2/17/2016   
         1. Jacala BBRx settings updated for Vcm calibration      wangyan@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.12   sunilk   2/2/2016   
         1. Updates for TA2.3 (with WTR3925); adding new XPT_FBRX_LTE40 state, adding WTR3925 specific ICIFIR coeffs for TDS; adding ADC_CFG_index       sunilk@qti.qualcomm.com            
Jolokia 6.4.19; Tabasco 7.3.12   sunilk   2/1/2016   
         1. Updates for TA2.3 (with WTR3925) for FBRX states; adding new NB/WB_index and ADC/WB_SEL rows for TA_2955/TA_3925      sunilk@qti.qualcomm.com            
...
Jolokia 6.4.17; Tabasco 7.3.10   gatesj   9/21/2015   
         1. New SW Dynamic tab to hold ADC hibernation settings for each BBRx. 2. New ADC_HIBERNATION_MODE SW varible       djoffe@qti.qualcomm.com            
...
Jolokia 6.4.16; Tabasco 7.3.8   gatesj   8/17/2015   
         1. LTE_CA modes set to use sinc3      mmenon@qti.qualcomm.com         https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/6.4.16/ https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/7.3.8/   
Jolokia 6.4.15; Tabasco 7.3.7   gatesj   8/12/2015   
         1. Modified IQMC settings for xPT states. Enabled by default and CFG values set to unity.       ankitm@qti.qualcomm.com         https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/6.4.15/ https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/7.3.7/   
Jolokia 6.4.14; Tabasco 7.3.6   gatesj   7/27/2015   
         1. ADC settings updated for 28LP pairing (Atlas SE) for FBRx and LTE40 modes per BBRx team's recommendation    CR880082   wangyan@qti.qualcomm.com         https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/6.4.14/ https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/7.3.6/   
Jolokia 6.4.13; Tabasco 7.3.5   gatesj   7/8/2015   
         1. ADC insertion loss deltas updated for LTE40 modes, corrected for some single-rx modes      wangyan@qti.qualcomm.com         https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/6.4.13/ https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/7.3.5/   
Jolokia 6.4.13; Tabasco 7.3.4   gatesj   6/24/2015   
         1. WTR2955 ICIFIR updated for TDS, LTE15, LTE20 on ICIFIR_SW_Dynamic tab based on lates WTR2955 objective spec.      tzuhanc@qti.qualcomm.com, mlane@qti.qualcomm.com, mmenon@qti.qualcomm.com         https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/6.4.13/ https://sharepoint.qualcomm.com/qct/Modem-Tech/Projects/Jolokia/Systems/Common/RF%20Interfaces/RxFE_AG_Archive/7.3.4/   
...
typedef struct
{
  ...
  boolean common_dec8_filt0_flag;/* This flag enables programming of the URxFE registers to program the common notches.*/
  boolean common_dec8_filt1_flag;/* This flag enables programming of the URxFE registers to program the common notches.*/
  ...
  boolean urxfe_nb3_flag;/* This flag enables programming of the URxFE registers to program the second NB chain*/
...
typedef struct
{
  uint32 mss_cc_mss_bbrxa_mux_sel;
  uint32 mss_cc_mss_bbrxa_misc;
...
typedef struct
{
  ...
  uint32 rxfe_adc_config3_reg_adca;
...
typedef struct
{
  ...
  uint32 rxfe_cmnnotch_filtn_start_action_sample[2];
  uint32 rxfe_cmnnotch_filtn_stop_action_sample[2];
  uint32 rxfe_cmnnotch_filtn_update_action_sample[2];
  uint32 rxfe_cmnnotch_filt01_cmd;
...
typedef struct
{
  ...
  uint32 rxfe_cmnnotch_filtn_stop_action_sample[2];
  uint32 rxfe_cmnnotch_filtn_update_action_sample[2];
  uint32 rxfe_cmnnotch_filt23_cmd;
}rflm_dtr_rx_common_notch_23_group_struct;



 /* Group COMMON_DEC8_FILT: */ 
/* This block consist of the URxFE registers to program the common notches.*/
typedef struct
{
  uint32 rxfe_dec8_filt0_cfg;
}rflm_dtr_rx_common_dec8_filt_group_struct;



 /* Group COMMON_DEC8_FILT1: */ 
/* This block consist of the URxFE registers to program the common notches.*/
typedef struct
{
  uint32 rxfe_dec8_filt1_cfg;
}rflm_dtr_rx_common_dec8_filt1_group_struct;
...
typedef struct
{
  uint32 rxfe_wb_notch_filtn_cfg0_wbw[4];
  uint32 rxfe_wb_notch_filtn_cfg1_wbw[4];
  uint32 rxfe_wb_notch_filtn_start_action_sample_wbw[4];
  uint32 rxfe_wb_notch_filtn_stop_action_sample_wbw[4];
  uint32 rxfe_wb_notch_filtn_update_action_sample_wbw[4];
  uint32 rxfe_wb_notch_filt01_cmd_wbw;
  uint32 rxfe_wb_notch_filt23_cmd_wbw;
...
typedef struct ALIGN(32)
{
  ...
  rflm_dtr_rx_common_dec8_filt_group_struct common_dec8_filt0_params;
  rflm_dtr_rx_common_dec8_filt1_group_struct common_dec8_filt1_params;
  ...
  rflm_dtr_rx_nb_wbmux_nb_group_struct nb_wbmux_nb3_params;
  rflm_dtr_rx_aa_nb_group_struct aa_nb3_params;
  rflm_dtr_rx_top_nb_v0_group_struct top_nb3_v0_params;
  rflm_dtr_rx_top_nb_v0_group_struct top_nb3_v1_params;
  rflm_dtr_rx_top_nb_v0_group_struct top_nb3_v2_params;
  rflm_dtr_rx_top_nb_v0_group_struct top_nb3_v3_params;
  rflm_dtr_rx_nb_gate_nb_group_struct nb_gate_nb3_params;
  rflm_dtr_rx_nb_dec_nb_group_struct nb_dec_nb3_params;
  rflm_dtr_rx_nb_dec_nb_group_struct eq_nb3_params;
  rflm_dtr_rx_icifir_nb_group_struct icifir_nb3_params;
  rflm_dtr_rx_nb_dc_nb_group_struct nb_dc_nb3_params;
  rflm_dtr_rx_nb_gda_nb_group_struct nb_gda_nb3_params;
  rflm_dtr_rx_nb_pwr_nb_group_struct nb_pwr_nb3_params;
  rflm_dtr_rx_dvga_nb_group_struct dvga_nb3_params;
  rflm_dtr_rx_final_bitwidths_nb_group_struct final_bitwidths_nb3_params;
  rflm_dtr_rx_writer_nb_group_struct writer_nb3_params;
  rflm_dtr_rx_dbg_nb_group_struct dbg_nb3_params;
  rflm_dtr_rx_csr_nb_group_struct csr_nb3_params;
  rflm_dtr_rx_csr_ph_offset_nb_group_struct csr_ph_offset_nb3_params;
  rflm_dtr_rx_wtr_func_cfg_nb_group_struct wtr_func_cfg_nb3_params;
  rflm_dtr_rx_csr_freq_offset_nb_group_struct csr_freq_offset_nb3_params;
