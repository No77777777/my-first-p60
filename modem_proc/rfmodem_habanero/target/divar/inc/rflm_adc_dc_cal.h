...
--------   ---     -------------------------------------------------------------
05/13/15   lm     Updates for msm8952
...
#define MAX_ADC_DC_CAL_ENTRIES          28
...
#define BBRX_ADC_CAL_CONFIG2_REG_MASK   0xFFFF83FF
...
boolean rftarget_msm_adc_cal_do_interations(uint32 adc_index, lm_handle_type rflm_rx_handle, int32 *adc_dc_cal_val);
void rftarget_msm_apply_adc_dc_cal(uint32 adc_index, lm_handle_type rflm_rx_handle, rflm_dtr_rx_adc_config_group_struct *adc_cfg);
void rftarget_init_efs_adc_cal_data();
boolean rftarget_msm_get_adc_cal_reg_setting(int32 adc_dc_cal_val,
