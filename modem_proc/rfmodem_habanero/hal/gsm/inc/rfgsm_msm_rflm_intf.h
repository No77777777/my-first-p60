...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/hal/gsm/inc/rfgsm_msm_rflm_intf.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/14/15   ec      Add definitions for Tx Cal Step durations
...
/* These definitions are for TxC based targets */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_25_PER_FRAME 600  /* 25 cal steps per frame */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_10_PER_FRAME 1500  /* 10 cal steps per frame */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_8_PER_FRAME  1875  /* 8 cal steps per frame (Used for DPD cal only) */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_5_PER_FRAME  3000 /* 5 cal steps per frame */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_4_PER_FRAME  5000 /* 4 cal steps per frame (Used for DCOC cal only) */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_2_PER_FRAME  7500 /* 2 cal steps per frame */
#define RFLM_MSM_GSM_TX_CAL_STEP_SIZE_1_PER_FRAME  15000 /* 1 cal step per frame */
