...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/hal/gsm/inc/rfgsm_msm.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
06/28/16   hkm     Calculate the RX RSB COEFFA
...
uint16 rfgsm_msm_vbatt_read(void);
...
int32 rfgsm_msm_get_coefa_bbrx_iqmc_compensated(int32 coefA);
