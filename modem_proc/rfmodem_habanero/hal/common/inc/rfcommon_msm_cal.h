...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/hal/common/inc/rfcommon_msm_cal.h#1 $ 
   
when       who     what, where, why 
--------   ---     ------------------------------------------------------------- 
04/06/20   pvsr    Use FEATURE_HABANERO_MODEM in parallel to JACALA_MODEM_FEATURE flag
17/03/17   vg      Added API to check DAC cal machine status
...
#if defined(JACALA_MODEM_FEATURE) || defined(FEATURE_HABANERO_MODEM) /* Featurization for msm8953 the macro is defined in scons*/
...
#define TXDAC_NUMBER_OF_FOUNDRIES 1
/*----------------------------------------------------------------------------*/
...
#else /*ifdef JACALA_MODEM_FEATURE*/
...
boolean rflm_check_dac_cal_machine_status(void);

#endif/*ifdef JACALA_MODEM_FEATURE*/
