...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/hal/common/inc/rfcommon_autopin_msm.h#1 $ 
   
when       who     what, where, why 
--------   ---     -------------------------------------------------------------
12/09/16   am      New par capture API for LTE to get BW specific params
06/01/16   ag       Populate autopin timing offsets
11/24/15   kma     Added Macro for timing alignment
...
#define AUTOPIN_PAR_CDMA_CAPTURE_TIME_OFFSET        ((uint32)(19200000/1000000.0*30))
...
void rfcommon_msm_get_par_capture_params_lte(rfcom_lte_bw_type bw,
                                         uint32 *reflog_capture_length,
                                         uint32 *downsample_rate, 
                                         uint32 *capture_delay,
                                         uint16 *wtr_capture_length);
