...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/hal/lte/inc/rflte_msm_iq_capture.h#1 $
...
typedef enum
{
  ...
  LTE_RX0RX1_WIDEBAND_IQ_16_SC_SAMPLES = 0xC,
		...
		LTE_SCELL_RX0RX1_WIDEBAND_IQ_16_SC_SAMPLES,
                ...
                LTE_SCELL2_RX0_WIDEBAND_IQ_16_SC_SAMPLES=0x18,
                LTE_SCELL2_RX1_WIDEBAND_IQ_16_SC_SAMPLES,
                LTE_SCELL2_RX0RX1_WIDEBAND_IQ_16_SC_SAMPLES,
#endif /* #ifdef FEATURE_FTM_HWTC */
...
boolean rflte_msm_prx_drx_iq_capture_config ( uint32 carrier_idx, uint16 rx_chain, uint32 size );

ftm_iq_capture_error_code_type rflte_msm_iq_capture_extract_data(uint32 size,uint32 offset,int16* iq_buf_ptr);

ftm_iq_capture_error_code_type rflte_msm_iq_capture_extract_prx_drx_data ( uint32 sample_data_size,
                                                                           uint32 sample_data_offset,
                                                                           int16 *prx_iq_buf_ptr,
                                                                           int16 *drx_iq_buf_ptr );
