...
Generated from:  v7.4.XX of Jacala_TxFE_Register_Settings.xlsx
*/
...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/api/fw/rflm_dtr_tx_fw_intf_ag.h#2 $
...
#define RFLM_DTR_TX_FW_INTF_REV 4
...
#define RFLM_DTR_TX_LTE_CA_MIXER_MASK 0x4 /* This Control Word triggers programming of the DAC IREF registers to program both the IREF gain value for both chains*/ 
#define RFLM_DTR_TX_TXFE_DELAYMATCH_MASK 0x8 /* This Control Word triggers programming of the delay matching registers to program the Tx chain n*/ 
#define RFLM_DTR_TX_TXC_DP_IQ_GAIN_MASK 0x10 /* This Control Word triggers programming of the DP_IQ_GAIN registers to program the Tx chain 0*/ 
#define RFLM_DTR_TX_TXC_TIMESTAMP_MASK 0x20 /* This Control Word triggers programming of the TIMESTAMP registers to program the Tx chain n*/ 
#define RFLM_DTR_TX_TXR_IQ_DAC_MASK 0x40 /* This Control Word triggers programming of the TXR_IQ_DAC registers to program the Tx chain n*/ 
#define RFLM_DTR_TX_ENABLE_DAC 0x80

#define RFLM_DTR_TX_CHAIN_0_FULL_CFG_MASK ( RFLM_DTR_TX_STATIC_MASK | RFLM_DTR_TX_IREF_UPDATE_MASK | RFLM_DTR_TX_LTE_CA_MIXER_MASK | RFLM_DTR_TX_TXFE_DELAYMATCH_MASK | RFLM_DTR_TX_TXC_DP_IQ_GAIN_MASK | RFLM_DTR_TX_TXC_TIMESTAMP_MASK | RFLM_DTR_TX_TXR_IQ_DAC_MASK | RFLM_DTR_TX_ENABLE_DAC )	/* This control word triggers programming all Tx Chain 0 static and dynamic regsiters in the buffer */
#define RFLM_DTR_TX_CHAIN_1_FULL_CFG_MASK ( RFLM_DTR_TX_STATIC_MASK | RFLM_DTR_TX_IREF_UPDATE_MASK | RFLM_DTR_TX_LTE_CA_MIXER_MASK | RFLM_DTR_TX_TXFE_DELAYMATCH_MASK | RFLM_DTR_TX_TXC_DP_IQ_GAIN_MASK | RFLM_DTR_TX_TXC_TIMESTAMP_MASK | RFLM_DTR_TX_TXR_IQ_DAC_MASK | RFLM_DTR_TX_ENABLE_DAC )	/* This control word triggers programming all  Tx Chain 1 static and dynamic regsiters in the buffer */
