...
/*==============================================================================
  ...
  $Header: //components/rel/rfmodem_habanero.mpss/1.11/api/fw/rflm_api_dtr_rx_hal.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
09/05/15   stw     Notch Filter Control Added
...
extern void rflte_msm_rxfe_notch_filter_control(lm_handle_type rxlm_handle,
