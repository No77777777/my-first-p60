...
/*==============================================================================
  ...
  Copyright (c) 2013-21 Qualcomm Technologies, Inc. (QTI). All Rights Reserved
...
$Header: //components/rel/rfmodem_habanero.mpss/1.11/api/lte/rflm_lte_ccs_intf.h#2 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
09/07/21   ag      [CR3030175] - Adjusting PLL backoff time to 180us for WTR2965
07/08/20   ssl     RX_EN Back off time form 200 to 150 us
06/12/20   ssl     [CR2709265]RX_EN Back off time for DMS FR on Agatti FR54823
09/13/16   vc      Rx_ON backoff time change from 150 to 80 us
07/04/16   vc      Pll en/disable during DLS for TDD bands
01/11/15   am       Adjust the autopin event memory as per the requirement
12/24/15   am      Create separate TQ segment to schedule autopin events
12/14/15   am      Changes to enable Autopin feature in online mode
08/11/15   vkm     Updated CCS mem usage for customer use cases, improves the stability.
08/11/15   vkm     Updated all memory usages to muliples of 4Bytes
07/20/15   sml      Fix for LTE drops call sometime after start to make call
03/23/15   kab     Protective check to ensure Issue Seqs are completed before new enqueue
...
#define RFLM_LTE_CCS_TX_MEM_TXAGC_MEM_SIZE           848
...
#define RFLM_LTE_CCS_TX_MEM_TXPLL_MEM_SIZE           252
...
#define RFLM_LTE_CCS_RX_MEM_SIZE                     536
#define RFLM_LTE_CCS_TDD_RX_EN_PLL_TIME              300 * 19.2 /*This should come from rf systems; 19.2 ticks per us*/
#define RFLM_LTE_CCS_RX_EN_PLL_TIME                  150 * 19.2 /*This should come from rf systems; 19.2 ticks per us*/
#define RFLM_LTE_CCS_WTR2965_RX_EN_PLL_TIME          180 * 19.2 /*This should come from rf systems; 19.2 ticks per us*/
#define RFLM_LTE_CCS_RX_ON_PLL_TIME                  80 * 19.2 /*This should come from rf systems; 19.2 ticks per us*/
#define RFLM_LTE_CCS_RX_PATH_ON_TIME                 40 * 19.2 /*This should come from rf systems; 19.2 ticks per us*/
