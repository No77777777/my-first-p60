...
/*==============================================================================
  ...
  $Header: //components/rel/rfmodem_habanero.mpss/1.11/nlic/inc/rflm_nlic_core.h#1 $
...
08/17/14   br     Removed NLIC feature flag to Disable NLIC 
...
void rflm_nlic_update_dynamic_settings(uint8 sub_id,nlic_input_params_per_sf *nlic_input_info, nlic_return_params_per_sf *nlic_return_info);
...
void rflm_nlic_update_static_settings(uint8 sub_id,
