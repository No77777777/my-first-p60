...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/dsmgr_api.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*===========================================================================
FUNCTION DS3G_IS_OTASN_FEATURE_SUPPORTED
...
RETURN VALUE
  TRUE, if feature is suported Enabled
  FALSE, Otherwise

SIDE EFFECTS
  None
===========================================================================*/
boolean ds3g_is_otasn_feature_supported
(
  sys_modem_as_id_e_type    subs_id
);
#endif /* DSMGR_API_H */
