...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/ps_rohc.h#2 $
  $Author: pwbldsvc $
  $DateTime: 2019/10/22 02:53:17 $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
02/07/18    ds     FR 40153 -- ROHC support for TCP Profile.
12/15/15    ds     optimization of UE defense mechanism in ROHC and indicate 
                   ROHC clients using callback only when received packet 
                   is IR based on its length.
...
typedef enum rohc_profiles_mask_e_type
{
  ...
  ROHC_PROFILE_TCP_MASK            = (1 << ROHC_PROFILE_TCP),
...
typedef enum rohc_ioctl_e_type
{
  ...
  ROHC_IOCTL_SET_COMP_CHANNEL_PROFILES      = 14,
  ROHC_IOCTL_MAX
} rohc_ioctl_e_type;
...
/*===========================================================================
FUNCTION ROHC_COMP_SINK_TCP_FEEDBACK

DESCRIPTION
  This api is used by the client whenever there is any feedback for the UL
  compressed packets using ROHC_TCP profile. 
...
SIDE EFFECTS
  None
===========================================================================*/
int rohc_comp_sink_tcp_feedback
(
  rohc_handle_type                     handle,/* ROHC compressor instance  */
  dsm_item_type                      **pkt,   /* Feedback Packet to sink */
  errno_enum_type                     *err    /* Error code in case of failure */
