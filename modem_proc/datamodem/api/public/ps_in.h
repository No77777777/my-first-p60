...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_in.h#2 $
  $Author: pwbldsvc $ $DateTime: 2019/10/22 02:53:17 $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
07/11/18    gbk    Handling of translation in valid iface and SM states
...
#define PS_LL_ADDR_LEN_MAX 6
/**
  @brief Common link layer address structure.
*/
typedef struct
{
  byte   ll_addr[PS_LL_ADDR_LEN_MAX];   /**< Link layer address.*/
