...
/*=============================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/pstimer.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
===========================================================================*/
/* same as ps_timer_start but time given is in micro seconds */

extern ps_timer_error_type ps_timeri_start
(
...
===========================================================================*/
/* same as ps_timer_remaining but time given is in micro seconds */

extern int64 ps_timeri_remaining
(
  ps_timer_handle_type timer_handle
);

/*===========================================================================
FUNCTION PS_TIMER_GET_TIMER_LIST()
===========================================================================*/
/** @ingroup ps_timer_get_timer_list
  Return timer list those are running

  This function return requested timer or node expire timer values from the list.

  @datatypes
  #ps_timer_handle_type

  @vertspace
  @param[out] list   return timer requested value list.
 ...
 None
  ...
  @newpage
 */
 uint32  ps_timer_get_timer_list
(
  uint64   *list,
  uint32    size,
  uint32    type
