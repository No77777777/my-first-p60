...
/*===========================================================================
   ...
   $Header: //components/rel/data.mpss/3.5..2.1/api/public/qmi_framework.h#2 $ 
...
typedef struct _qmi_framework_svc_callbacks
{
  ...
  void     (* cmd_hdlr)      ( qmi_framework_msg_hdr_type * msg_hdr, dsm_item_type ** sdu );
                              /* cb for querying service info */
  void     (* get_svc_info) ( uint8 clid, qmi_svc_info_type * svc_info );
...
/*===========================================================================
FUNCTION QMI_FRAMEWORK_GET_SVC_INFO_PER_CLID()
