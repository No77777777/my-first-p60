...
Derived from Jeff Dyck's original Ethernet implementation
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_lan_llc.h#2 $ 
...
typedef enum
{
  ...
  LAN_LLE_RMNET9    =  19,    /**< OSIF WWAN RM instance 9 for IPv4. */
  LAN_LLE_RMNET9_2  =  20,    /**< OSIF WWAN RM instance 9 for IPv6. */
  LAN_LLE_RMNET10   =  21,    /**< OSIF WWAN RM instance 10 for IPv4. */
  LAN_LLE_RMNET10_2 =  22,    /**< OSIF WWAN RM instance 10 for IPv6. */
