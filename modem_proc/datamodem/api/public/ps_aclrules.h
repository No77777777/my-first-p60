...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_aclrules.h#3 $
  $Author: pwbldsvc $ $DateTime: 2021/02/05 03:34:20 $

when        who    what, where, why
--------    ---    ---------------------------------------------------------- 
04/17/19    rk     Added ACL_CLAT_UP_PREF_CLASS
11/09/14    yl     IP data path re-architecture
11/04/14    sd     Added new ACL deny reason for subs_id mismatch.
10/29/14    niv    Added new ACL Deny reason for MIP on v6 calls
...
#define ACL_DENY_REASON_IMS_SETTINGS_DISABLED         -19
...
#define ACL_DENY_REASON_IP_V4_ONLY_ALLOWED            -39
#define ACL_DENY_REASON_IP_V6_ONLY_ALLOWED            -40
