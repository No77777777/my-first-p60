...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_qos_defs.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  IPFLOW_MASK_TRANSFER_DELAY            = 0x00100000,
  IPFLOW_MASK_DELIVERY_ERR_SDU          = 0x00200000,
  IPFLOW_MASK_DELIVERY_ORDER            = 0x00400000,
  IPFLOW_MASK_ALL                       = 0x00FFFFFF
...
typedef struct
{
  ...
  struct
  {
    ...
    {
      boolean                          is_valid;
      ds_umts_qos_dorder_enum_type     dlvry_order;     /* delivery order */
      ds_umts_qos_sdu_dlvr_enum_type   deliver_err_sdu; /* SDU error ratio list index */ 	  	    
