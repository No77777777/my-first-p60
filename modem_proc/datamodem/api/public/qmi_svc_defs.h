...
typedef enum
{
  ...
  QMI_ERR_IMS_NOT_READY_FOR_SUPS          = 99,
  /* QMI PBM Errors */
...
/*===========================================================================
TYPEDEF QMI_SVC_INFO_TYPE

DESCRIPTION
  This type shall be used by framework to retrieve service info
===========================================================================*/
typedef struct
{
  uint8   subscription_id;
} qmi_svc_info_type;
...
typedef struct _qmux_svc_callbacks
{
  ...
  void    (* get_svc_info)   ( byte clid, qmi_svc_info_type * svc_info );
} qmux_svc_cbs_type;
...
typedef struct
{
  ...
  uint64                svc_reg_ts;   /* Service reg timestamp        */
} qmux_svc_info_type;
