...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ds_profile.h#3 $ $DateTime: 2023/01/31 00:56:07 $ $Author: pwbldsvc $
...
/**Maximum buffer size needed for get a parameter from profile. 
   This needs to be updated if any new parameter needs buffer
   more than 128 bytes
*/
#define DS_PROFILE_MAX_PARAMETER_SIZE    128
...
typedef enum
{
  DS_PROFILE_GENERAL_PROFILE_PARAM_INVALID   = 0x0,
    /**< Invalid profile parameter. */
  DS_PROFILE_GENERAL_PROFILE_PARAM_MAX        = 0xDF,
  /**< Max value for general profile param*/
  DS_PROFILE_GENERAL_PROFILE_PARAM_IPV6_PREFIX_DELEGATION_FLAG  = 
    DS_PROFILE_GENERAL_PROFILE_PARAM_MAX,  
    /**< IPV6 prefix delegation. */
  DS_PROFILE_GENERAL_PROFILE_PARAM_CLAT_ENABLE_FLAG = 0XDE,
   /**< XLAT enable flag. */

  DS_PROFILE_GENERAL_PROFILE_PARAM_APN_TYPE = 0XDD,
   /**< APN Type. */

  /**< Add new General parameters starting from 0XDC. 
       and decrement the value of subs_id.*/

  DS_PROFILE_GENERAL_PROFILE_PARAM_SUBS_ID  = 0XDC,  
    /**< Subs ID. This value has to be the minimum always */
  /** @cond  */
  DS_PROFILE_GENERAL_PROFILE_PARAM_MIN       = 
    DS_PROFILE_GENERAL_PROFILE_PARAM_SUBS_ID
...
DS_PROFILE_REG_RESULT_ERR_OUT_OF_MEMORY,
  ...
  DS_PROFILE_REG_RESULT_ERR_INVAL_LST,
  /**< Invalid list*/ 
...
typedef enum 
{
  ...
  DS_PROFILE_SUBSCRIPTION_READY_EVENT = 7,
    /**< Profiles ready on a subscription */
...
typedef enum
{
  ...
  DS_PROFILE_CONFIG_MASK_ATTACH_PROFILE = 0x08, /**< Attach Profile. */
  DS_PROFILE_CONFIG_MASK_AP_CLIENT = 0x10, /**< AP created Profile. */
  DS_PROFILE_CONFIG_MASK_ALL            = 0x1F  /**< All mask. */
...
typedef enum
{
  DS_APN_TYPE_MASK_UNSPECIFIED     = 0x00,
  DS_APN_TYPE_MASK_DEFAULT         = 0x01,
  /**< APN type for Default/Internet traffic */
  DS_APN_TYPE_MASK_IMS             = 0x02,
  /**< APN type for IP Multimedia Subsystem */
  DS_APN_TYPE_MASK_MMS             = 0x04,
  /**< APN type for Multimedia Messaging Service */
  DS_APN_TYPE_MASK_DUN             = 0x08,
  /**< APN type for Dial Up Network */
  DS_APN_TYPE_MASK_SUPL            = 0x10,
  /**< APN type for Secure User Plane Location */
  DS_APN_TYPE_MASK_HIPRI           = 0x20,
  /**< APN type for High Priority Mobile Data */
  DS_APN_TYPE_MASK_FOTA            = 0x40,
  /**< APN type for over the air administration */
  DS_APN_TYPE_MASK_CBS             = 0x80,
  /**< APN type for Carrier Branded Services */
  DS_APN_TYPE_MASK_IA              = 0x100,
  /**< APN type for Initial Attach */
  DS_APN_TYPE_MASK_EMERGENCY       = 0x200
  /**< APN type for emergency */
} ds_apn_type_mask_enum_type;

typedef uint64 apn_type_mask_type;
/*---------------------------------------------------------------------------
                       PUBLIC ROUTINES
---------------------------------------------------------------------------*/
/*===========================================================================
...
/*===========================================================================
FUNCTION DS_PROFILE_DELETE_ATTACH
============================================================================*/
/** @ingroup DS_PROFILE_DELETE_PER_SUB
  Resets a profile to undefined and return to free pool. 
  Default profiles can be deleted only if the flag is explicitly set to true
