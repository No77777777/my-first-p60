...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_acl.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define ACL_HANDOFF_CONFIG_NONE             0x00
#define ACL_HANDOFF_CONFIG_DNS_PCSCF        0x01
#define ACL_HANDOFF_CONFIG_V4_ADDR          0x02
#define ACL_HANDOFF_CONFIG_V6_PRI_IID       0x04
#define ACL_HANDOFF_CONFIG_V6_PREFIX        0x08
#define ACL_HANDOFF_CONFIG_ALL              0x0F
...
}acl_handoff_context_config_type;
...
struct acl_policy_info_s
{
  ...
  boolean bring_up_using_apn_name;       /* Bring up using specified APN name*/
  ...
  boolean bring_up_using_apn_type;       /* Bring up using specified APN type */
  boolean               tlb_mode;        /*Is Test Loop Back mode set*/                                    
  boolean               exclude_clat_routing; /*Do not perform CLAT interface Routing*/  
};
