...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_iface_ipfltr.h#3 $
...
typedef enum
{
  PS_IFACE_IPFLTR_RESULT_UL_STATIC_LOCAL   = 201,
  PS_IFACE_IPFLTR_RESULT_UL_STATIC_WWAN    = 202,
  PS_IFACE_IPFLTR_RESULT_UL_CLAT           = 203,
  PS_IFACE_IPFLTR_RESULT_UL_IPV6           = 204,
  PS_IFACE_IPFLTR_RESULT_UL_UPLINK_MONITOR = 205,
  PS_IFACE_IPFLTR_RESULT_UL_UPLINK_MONITOR_MAX = 220,
  PS_IFACE_IPFLTR_RESULT_UL_MAX            = 300,

  PS_IFACE_IPFLTR_RESULT_DL_POWERSAVE      = 301,
  PS_IFACE_IPFLTR_RESULT_DL_MBIM           = 302,
  PS_IFACE_IPFLTR_RESULT_DL_PROTOCOL       = 303,
  PS_IFACE_IPFLTR_RESULT_DL_HW_UNKNOWN     = 304,
  PS_IFACE_IPFLTR_RESULT_DL_MAX            = 400,

  PS_IFACE_IPFLTR_RESULT_UNKNOWN           = 0xFFFF,
...
/*---------------------------------------------------------------------------
  Definition of various Filtering result.
  Note, DSM item app field has only one bit for filter source which represent
  either HW or NONE as source. Once pkt enters framework
  souce can be either DPM, HW or iface and can be set direcly
  in pkt meta info
---------------------------------------------------------------------------*/
typedef enum
{
  PS_IFACE_IPFLTR_DL_SOCKET_RESULT_SOURCE_NONE       = 0,
  PS_IFACE_IPFLTR_DL_SOCKET_RESULT_SOURCE_HW         = 1,
  PS_IFACE_IPFLTR_DL_SOCKET_RESULT_SOURCE_DPM        = 2,
  PS_IFACE_IPFLTR_DL_SOCKET_RESULT_SOURCE_IFACE      = 3,
  PS_IFACE_IPFLTR_DL_SOCKET_RESULT_SOURCE_MAX
} ps_iface_ipfltr_dl_socket_result_source_enum_type;
...
/*===========================================================================
FUNCTION PS_IFACE_IPFLTR_ADD_CLAT_V6_DST_ADDR_FLTR()
