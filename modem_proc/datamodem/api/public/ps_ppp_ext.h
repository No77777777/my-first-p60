...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_ppp_ext.h#2 $
...
/** Defines the PPP SUBS ID.
 */
typedef enum
{
  PPP_MIN_SUBS_ID               = 0,   /**< Lower bound value. */
  PPP_SUBS_ID_1                 = PPP_MIN_SUBS_ID,   /**< SUBS ID 1. */
  PPP_SUBS_ID_2                 = 1,   /**< SUBS ID 2. */
  PPP_MAX_SUBS_ID,                     /**< Maximum value for array sizing. */
  PPP_INVALID_SUBS_ID           = 255  /**< Invalid device. */
} ppp_subs_id_enum_type;
/** @} */ /* end_addtogroup datatypes */
