...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_rx_meta_info.h#2 $
...
typedef struct
{
  ...
  ps_iface_ipfltr_dl_socket_result_source_enum_type  socket_fi_source;
    /**< Filter result set by DPM/HARDWARE/IFACE. */
  void                            * routing_cache;
...
*/
/*===========================================================================
MACRO PS_RX_META_INFO_GET_REF_CNT()
===========================================================================*/
/**
  This function returns ref count for buffer.
  ...
  None.
*/
#define PS_RX_META_INFO_GET_REF_CNT ps_rx_meta_info_get_ref_cnt
#ifdef __cplusplus
extern "C" {
#endif
/** @} */ /* end_addtogroup macros_ipUtilities */
...
/*===========================================================================
PS_RX_META_INFO_GET_REF_CNT()
===========================================================================*/
/** @ingroup ps_rx_meta_info_get_ref_cnt
  Retrieves the reference count for ps_rx_meta_info buffere.
  ...
  None.
*/
INLINE int16 ps_rx_meta_info_get_ref_cnt
(
...
)
{
  ...
  {
    return ps_mem_get_ref_cnt(*rx_mi_ptr_ptr);
  }
...
/*===========================================================================
MACRO PS_RX_META_SET_SOCKET_FI_SOURCE()
===========================================================================*/
/**
  Sets the routing for the given Rx meta information.

  @param[in] rx_mi_ptr         Pointer to ps_rx_meta_info_type.
  @param[in] socket_fi_source_val  Source of socket fitler result
  ...
  The meta information pointer must be valid.
*/
#define PS_RX_META_SET_SOCKET_FI_SOURCE(rx_mi_ptr, socket_fi_source_val)   \
  (rx_mi_ptr)->socket_fi_source = (socket_fi_source_val);

/*===========================================================================
MACRO PS_RX_META_GET_SOCKET_FI_SOURCE()
===========================================================================*/
/**
  Sets the routing for the given Rx meta information.
  ...
  @param[in] rx_mi_ptr         Pointer to ps_rx_meta_info_type.
  @return
  Source of socket fitler result

  @dependencies
  The meta information pointer must be valid.
*/
#define PS_RX_META_GET_SOCKET_FI_SOURCE(rx_mi_ptr) (rx_mi_ptr)->socket_fi_source
