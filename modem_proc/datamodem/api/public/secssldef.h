...
/*=============================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/secssldef.h#1 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/**< Supported by SecSSL client session only. */
#define TLS_PSK_WITH_AES_128_CBC_SHA              ps_htons( 0x008C )
/**< Supported by SecSSL client session only. */
#define TLS_PSK_WITH_3DES_CBC_SHA                 ps_htons( 0x008b )
/**< Supported by SecSSL client session only. */
#define TLS_PSK_WITH_AES_256_CBC_SHA              ps_htons( 0x008d )
/**< Supported by SecSSL client session only. */
...
// TLS events/Errors for DS indendent flow
#define TLS_WRITE_EVENT  0x01         /* TLS write event */
#define TLS_READ_EVENT   0x02         /* TLS read event */
#define TLS_CLOSE_EVENT  0x04         /* TLS close event */

#define TLS_WOULDBLOCK 1     /* TLS WouldBlock  */
#define TLS_SOCK_CLOSE 2     /* TLS socket close  */

#define TLS_FPTRS_ERROR     -1   /* unsuccessful operation from ClientApp function ptr call */
