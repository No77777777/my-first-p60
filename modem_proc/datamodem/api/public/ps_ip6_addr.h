...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_ip6_addr.h#2 $
...
extern boolean dhcp6_client_rapid_commit;
...
SIDE EFFECTS
  None
===========================================================================*/
#define PS_IP_ADDR_GET_IP6_DEFAULT_MTU ps_ip_addr_get_ip6_default_mtu 
INLINE uint16 ps_ip_addr_get_ip6_default_mtu
(
  void
)
{
