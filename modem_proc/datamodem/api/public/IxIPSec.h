...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/IxIPSec.h#1 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $


  when       who     what, where, why
  --------   ---     ----------------------------------------------------------
  04/22/19   ds      Code chagnes to translate filter parameters form 
                     IPSecSlctrType to ip_filter_type before installing filters.
  03/04/19   ds      IPSec re-architecture for IMS-IPSEC interface optimization      
...
/** 
  To Update/Creat the IPSecSA based on parameters passed by client .
...
static IxErrnoType IPSecFltr2IPFltr
(
   ip_filter_type filter_arr[],
   IPSecSlctrType *PIPSecSlctr,
   uint8 num_filters
);
