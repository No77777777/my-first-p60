...
Copyright (c) 1998-2020 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/dssocket.h#6 $ $DateTime: 2022/04/07 02:54:26 $ $Author: pwbldsvc $
...
/*---------------------------------------------------------------------------
  Request and Release call back declarations for port preference.
---------------------------------------------------------------------------*/
typedef void (*dss_port_req_cb_fcn)
(
  int8    request_status,       /* Port Request status  */
  int32   dss_request_handle,  /* Port Request handle  */
  void *  cb_user_data         /* User data specified during registration */
);

typedef void (*dss_port_rel_cb_fcn)
(
  int8    release_status,      /* Port Release status  */
  void *  cb_user_data        /* User data specified during release */
);
...
typedef enum
{
  ...
  DSS_IP_RECVTTL                = 43, /* Enable receive time to live       */
  DSS_IP_RECVECN                = 44, /* Enable receive explicit congestion notification    */  
  DSS_UDP_ENCAPS                = 45, /* Enable UDP encapsulation */
  DSS_PORT_PREF_HANDLE          = 46, /* Port preference handle */
  DSS_PORT_IWLAN_CAPABLE        = 47, /* Port is IWLAN capable */
  DSS_TCP_ACCESS_PRIORITY       = 48, /* Enable/Disable TCP access priority */
  DSS_IP_RECVSUBID              = 49, /* Enable receive subs id */
...
/*---------------------------------------------------------------------------
  Port property can be used by the Application to specify the manner in which ports to be allocated. 
---------------------------------------------------------------------------*/
typedef enum 
{
  DSS_PORT_PROP_MIN = 0x00,                 /*  Default property  */
  DSS_PORT_PROP_ADJACENT_START_EVEN = 0x01, /*  Adjacent ports start with even port (e.g {4,5}� {8,9} ) */
  DSS_PORT_PROP_SYMMETRIC = 0x02            /* Symmetric ports (Same port number for V4-TCP, V4-UDP, V6-TCP and V46-UDP) */
} dss_port_property_enum;

/*---------------------------------------------------------------------------
  Ports will be allocated based on port preferences information.
---------------------------------------------------------------------------*/
typedef struct
{
  dss_port_property_enum  port_property;  /*  Port property  */ 
  uint8                   pref_count;     /*  Minimum number of port pair to be cached */
  uint16                  base_port_range;/*  Base port value */
  uint16                  max_port_range; /*  MAX port value */
}dss_port_preference_info;
/*---------------------------------------------------------------------------
...
/*---------------------------------------------------------------------------
  Structures defined for the IP_RECVECN
---------------------------------------------------------------------------*/
typedef struct
{
  uint8             ecn;                       /* Received Explicit Congestion Notification*/
}dss_in_ecninfo_type;

/*---------------------------------------------------------------------------
  Structures defined for the IP_RECVTTL
---------------------------------------------------------------------------*/
typedef struct 
{
  uint8             ttl;                       /* Received Time to live */
}dss_in_ttlinfo_type;
...
/*---------------------------------------------------------------------------
  Structures defined for the IP_RECVSUBID
---------------------------------------------------------------------------*/
typedef struct 
{
  uint32             subs_id;                       /* Subscription id */
}dss_in_recv_subs_id_type;
...
typedef enum
{
  ...
  DSS_NET_DOWN_REASON_PTI_MISMATCH = PS_NET_DOWN_REASON_PTI_MISMATCH,
  DSS_NET_DOWN_REASON_ACTIVATION_REJECTED_BCM_VIOLATION = 
  						PS_NET_DOWN_REASON_ACTIVATION_REJECTED_BCM_VIOLATION,
  DSS_NET_DOWN_REASON_LAST_PDN_DISCONN_NOT_ALLOWED =
                              PS_NET_DOWN_REASON_LAST_PDN_DISCONN_NOT_ALLOWED,
  ...
  DSS_NET_DOWN_REASON_CALL_PREEMPT_BY_EMERGENCY_APN = 
    PS_NET_DOWN_REASON_CALL_PREEMPT_BY_EMERGENCY_APN,
DSS_NET_DOWN_REASON_UE_INIT_DETACH_OR_DISCONNECT =
    PS_NET_DOWN_REASON_UE_INIT_DETACH_OR_DISCONNECT,
  DSS_NET_DOWN_REASON_UNKNOWN_CAUSE_CODE  = 0x000200CC,
  DSS_NET_DOWN_REASON_NAS_SIGNALLING_ERROR  = 
                      PS_NET_DOWN_REASON_NAS_SIGNALLING_ERROR,

  DSS_NET_DOWN_REASON_INTERNAL_MIN = 0x000200C8,
  ...
  DSS_NET_DOWN_REASON_INTERNAL_UNKNOWN_CAUSE_CODE = 0x000200CB,
  ...
  DSS_NET_DOWN_REASON_DDS_SWITCH_IN_PROGRESS
                        = PS_NET_DOWN_REASON_DDS_SWITCH_IN_PROGRESS,
  ...
  DSS_NET_DOWN_REASON_NAS_LAYER_FAILURE = PS_NET_DOWN_REASON_NAS_LAYER_FAILURE,
  DSS_NET_DOWN_REASON_MULTI_PDN_NOT_ALLOWED = 
    PS_NET_DOWN_REASON_MULTI_PDN_NOT_ALLOWED,
  DSS_NET_DOWN_REASON_EMBMS_NOT_ENABLED = PS_NET_DOWN_REASON_EMBMS_NOT_ENABLED,
  DSS_NET_DOWN_REASON_PENDING_REDIAL_CALL_CLEANUP = 
    PS_NET_DOWN_REASON_PENDING_REDIAL_CALL_CLEANUP,
  DSS_NET_DOWN_REASON_EMBMS_REGULAR_DEACTIVATION = 
    PS_NET_DOWN_REASON_EMBMS_REGULAR_DEACTIVATION,
  DSS_NET_DOWN_REASON_TLB_REGULAR_DEACTIVATION = 
    PS_NET_DOWN_REASON_TLB_REGULAR_DEACTIVATION,
  DSS_NET_DOWN_REASON_LOWER_LAYER_REGISTRATION_FAILURE = 
    PS_NET_DOWN_REASON_LOWER_LAYER_REGISTRATION_FAILURE,
  ...
  DSS_NET_DOWN_REASON_IRAT_ABORT = 
                                   PS_NET_DOWN_REASON_IRAT_ABORT,
  ...
  DSS_NET_DOWN_REASON_UNSUPPORTED_1X_PREV = PS_NET_DOWN_REASON_UNSUPPORTED_1X_PREV,            
  ...
  DSS_NET_DOWN_REASON_CM_UNKNOWN_ERROR = PS_NET_DOWN_REASON_CM_UNKNOWN_ERROR,
  ...
  DSS_NET_DOWN_REASON_INVALID_CLASS3_APN    = PS_NET_DOWN_REASON_INVALID_CLASS3_APN,
  DSS_NET_DOWN_REASON_DUAL_SWITCH           = PS_NET_DOWN_REASON_DUAL_SWITCH,
  DSS_NET_DOWN_REASON_REJECTED_BY_CALL_MANAGER = 
    PS_NET_DOWN_REASON_REJECTED_BY_CALL_MANAGER,
  DSS_NET_DOWN_REASON_NO_TRM =   PS_NET_DOWN_REASON_NO_TRM,
  DSS_NET_DOWN_REASON_MPLMN_IN_PROGRESS     = PS_NET_DOWN_REASON_MPLMN_IN_PROGRESS,
  ...
  DSS_NET_DOWN_REASON_APN_PRM_CHG  = PS_NET_DOWN_REASON_APN_PARAM_CHANGE,
  DSS_NET_DOWN_REASON_APN_PARAM_CHANGE = PS_NET_DOWN_REASON_APN_PARAM_CHANGE, 
  ...
  DSS_NET_DOWN_REASON_DDS_CALL_ABORT = PS_NET_DOWN_REASON_DDS_CALL_ABORT,
  DSS_NET_DOWN_REASON_VALIDATION_FAILURE = PS_NET_DOWN_REASON_VALIDATION_FAILURE,
  DSS_NET_DOWN_REASON_IMS_SETTINGS_DISABLED = PS_NET_DOWN_REASON_IMS_SETTINGS_DISABLED,
  /* EAP Error codes. */
  ...
  /* IPSEC Error Codes. */
  DSS_NET_DOWN_REASON_IPSEC_MIN = 0x000513EC,
  ...
  DSS_NET_DOWN_REASON_IPSEC_CERT_EXPIRY = 
    PS_NET_DOWN_REASON_IPSEC_CERT_EXPIRY,
  DSS_NET_DOWN_REASON_IPSEC_MAX,

  /* MIP Error codes. */
  DSS_NET_DOWN_REASON_MIP_FA_ERR_REASON_UNSPECIFIED = 0x00010040,
  ...
  DSS_NET_DOWN_REASON_MIP_HA_ERR_REASON_UNSPECIFIED = 0x00010080,
  ...
  DSS_NET_DOWN_REASON_MIP_ERR_REASON_UNKNOWN = 0x0001FFFF,
  ...
  DSS_NET_DOWN_REASON_PPP_ERR_REASON_UNKNOWN = 0x0007FFFF,
  ...
  DSS_NET_DOWN_REASON_IPV6_ERR_MAX,
  ...
  DSS_NET_DOWN_REASON_IWLAN_S2B_IKEV2_CERT_INVALID =
    PS_NET_DOWN_REASON_IWLAN_S2B_IKEV2_CERT_INVALID,
  DSS_NET_DOWN_REASON_IWLAN_S2B_IKEV2_CERT_EXPIRY =
    PS_NET_DOWN_REASON_IWLAN_S2B_IKEV2_CERT_EXPIRY,
 ...
 DSS_NET_DOWN_REASON_IWLAN_S2B_IKEV2_EAP_AUTH_FAILURE = 
  PS_NET_DOWN_REASON_IWLAN_S2B_IKEV2_EAP_AUTH_FAILURE,
  DSS_NET_DOWN_REASON_IWLAN_S2B_PGW_OVERLOAD =
    PS_NET_DOWN_REASON_IWLAN_S2B_PGW_OVERLOAD,
  DSS_NET_DOWN_REASON_IWLAN_S2B_PERMANENT_FAILURE=
    PS_NET_DOWN_REASON_IWLAN_S2B_PERMANENT_FAILURE,  
  DSS_NET_DOWN_REASON_IWLAN_S2B_REQUEST_REJECTED_IF_S2B =
    PS_NET_DOWN_REASON_IWLAN_S2B_REQUEST_REJECTED_IF_S2B,
  DSS_NET_DOWN_REASON_IWLAN_S2B_PROTOCOL_ERROR_IF_S2B=
    PS_NET_DOWN_REASON_IWLAN_S2B_PROTOCOL_ERROR_IF_S2B,
  DSS_NET_DOWN_REASON_IWLAN_S2B_NO_SUBSCRIPTION_IF_S2B=
    PS_NET_DOWN_REASON_IWLAN_S2B_NO_SUBSCRIPTION_IF_S2B,
  DSS_NET_DOWN_REASON_IWLAN_S2B_MISSING_OR_UNKNOWN_APN_IF_S2B=
    PS_NET_DOWN_REASON_IWLAN_S2B_MISSING_OR_UNKNOWN_APN_IF_S2B, 
  DSS_NET_DOWN_REASON_IWLAN_S2B_UNSUPPORTED_PDN_TYPE_IF_S2B=
    PS_NET_DOWN_REASON_IWLAN_S2B_UNSUPPORTED_PDN_TYPE_IF_S2B,
  DSS_NET_DOWN_REASON_IWLAN_S2B_RAT_DISALLOWED_IF_S2B=
    PS_NET_DOWN_REASON_IWLAN_S2B_RAT_DISALLOWED_IF_S2B,
  DSS_NET_DOWN_REASON_IWLAN_S2B_EPDG_ADDR_UNREACHABLE=
    PS_NET_DOWN_REASON_IWLAN_S2B_EPDG_ADDR_UNREACHABLE,
  DSS_NET_DOWN_REASON_IWLAN_S2B_REACTIVATION_REQ =
    PS_NET_DOWN_REASON_IWLAN_S2B_REACTIVATION_REQ,
  DSS_NET_DOWN_REASON_IWLAN_S2B_CALL_PREEMPT_BY_ANOTHER_APN =
    PS_NET_DOWN_REASON_IWLAN_S2B_CALL_PREEMPT_BY_ANOTHER_APN,
  DSS_NET_DOWN_REASON_IWLAN_S2B_UNAUTHENTICATED_EMERGENCY_UNSUPPORTED =
    PS_NET_DOWN_REASON_IWLAN_S2B_UNAUTHENTICATED_EMERGENCY_UNSUPPORTED,
  DSS_NET_DOWN_REASON_IWLAN_S2B_IMEI_NOT_ACCEPTED =
    PS_NET_DOWN_REASON_IWLAN_S2B_IMEI_NOT_ACCEPTED,
  DSS_NET_DOWN_REASON_IWLAN_S2B_REDIRECT_NOT_ALLOWED = 
    PS_NET_DOWN_REASON_IWLAN_S2B_REDIRECT_NOT_ALLOWED,
  DSS_NET_DOWN_REASON_IWLAN_S2B_NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED =
    PS_NET_DOWN_REASON_IWLAN_S2B_NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED,
  DSS_NET_DOWN_REASON_IWLAN_S2B_USER_UNKNOWN = 
    PS_NET_DOWN_REASON_IWLAN_S2B_USER_UNKNOWN,
  DSS_NET_DOWN_REASON_IWLAN_S2B_AUTHORIZATION_REJECTED = 
    PS_NET_DOWN_REASON_IWLAN_S2B_AUTHORIZATION_REJECTED,
  DSS_NET_DOWN_REASON_IWLAN_S2B_ILLEGAL_ME = 
    PS_NET_DOWN_REASON_IWLAN_S2B_ILLEGAL_ME,
...
/*===========================================================================
FUNCTION DSS_INIT_PORT_PREFERENCE_INFO

DESCRIPTION
  This function is used to initialize port preference.

DEPENDENCIES
  None.

PARAMETERS
  port_pref (OUT)  - - Pointer to the port preference  
...
===========================================================================*/
void dss_init_port_preference_info
(
  dss_port_preference_info *port_pref
);

/*===========================================================================
FUNCTION DSS_REQUEST_PORT_PREF

DESCRIPTION
   This function is used to request desired port preference 

DEPENDENCIES
  None.

PARAMETERS
  port_pref (IN)   - Pointer to the port preference  
  cb_fn (IN)       - DS will notify port availability to the application  
  userdata (IN)    - User data  


RETURN VALUE
   Handle                : Valid handle if pref arleady requested. Call back will  not be invoked
    0                    : Request accepted. Handle will be notified via call back.
   -1                    : On Failure.
...
===========================================================================*/
int32 dss_request_port_pref
(
  dss_port_preference_info  port_pref,
  dss_port_req_cb_fcn       cb_fn,
  void                    * userdata
);

/*===========================================================================
FUNCTION DSS_RELEASE_PORT_PERF_HANDLE

DESCRIPTION
   This function is used to release acquired/received  port preference handle

DEPENDENCIES
  None.

PARAMETERS
  dss_request_handle (IN)  - Port preference handle  
  cb_fn (IN)               - DS will notify port release to the application 
  userdata (IN)            - User data  
...
===========================================================================*/
sint15 dss_release_port_pref_handle
(
  int32               dss_request_handle,
  dss_port_rel_cb_fcn cb_fn,
  void              * userdata
);
