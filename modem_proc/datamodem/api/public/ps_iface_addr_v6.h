...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/public/ps_iface_addr_v6.h#2 $
  $DateTime: 2019/10/22 02:53:17 $

01/28/15    ash    Added PS_IFACE_SET_V6_IID_EX api
...

/*---------------------------------------------------------------------------
TYPEDEF PS_IFACEI_SEC_V6_ADDR_CACHE_TYPE

DESCRIPTION
  The cache for secondery ipv6 addresses
---------------------------------------------------------------------------*/
typedef struct ps_ifacei_sec_v6_addr_cache_type
{          
  q_type  sec_v6_addr_q;
    /**< The pointer points to the secondary ipv6 addresses */
  uint8   ref_cnt; 
    /**< the number of Iface that use the cache */
}ps_ifacei_sec_v6_addr_cache_type;
...
/*===========================================================================
MACRO PS_IFACE_GET_V6_PRIMARY_ADDR_PTR()
===========================================================================*/
/**
  Get the public address from the V6 adddress cache

  @param[in] iface_ptr   Pointer to the interface.

  @return
  v6 address -- The pointer points to the public address.\n
  NULL  -- No public address is present in the cache.
  
  @dependencies 
  None.
*/
#define PS_IFACE_GET_V6_PRIMARY_ADDR_PTR(iface_ptr)                         \
  ((iface_ptr)->iface_private.primary_v6_addr_ptr)

/*===========================================================================
MACRO PS_IFACE_SET_V6_PRIMARY_ADDR_PTR()
===========================================================================*/
/**
  Reset the public address pointer to NULL
  ...
  None.
*/
#define PS_IFACE_SET_V6_PRIMARY_ADDR_PTR(iface_ptr, v6_addr_ptr)            \
  ((iface_ptr)->iface_private.primary_v6_addr_ptr = v6_addr_ptr)
...
/*===========================================================================
FUNCTION PS_IFACE_DELETE_ALL_V6_SEC_ADDRESS()
===========================================================================*/
/** @ingroup ps_iface_delete_all_v6_sec_address
  This function will decrement ref count or remove all Secondary addresses
  from the interface.
  ...
  @vertspace
  @param[in] this_iface_ptr   Pointer to the interface control block on
                              which all secondary addresses  are to be
                              removed.
  ...
  @newpage
*/
int ps_iface_delete_all_v6_sec_address
(
  ps_iface_type *this_iface_ptr
);
