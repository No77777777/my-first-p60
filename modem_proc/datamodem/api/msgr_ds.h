...
$Header: //components/rel/data.mpss/3.5..2.1/api/msgr_ds.h#2 $
...
#define MSGR_MODULE_APPSRV            0x07
...
#define MSGR_DS_APPSRV              MSGR_TECH_MODULE( MSGR_TECH_DS, MSGR_MODULE_APPSRV )
