...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/comptask_api.h#2 $DateTime: 2009/03/05 10:53:13 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  PDCP_RRC_DATA_RATE_IND       = 6, /* Data rate indication from RRC to PDCP */
  COMP_MAX_CMDS
} comp_cmd_enum_type;
...
typedef struct
{
  ...
  void                    (*reg_wm_func_ptr)(void *, boolean);
  void                    *reg_wm_func_parm;
  void                    (*dereg_wm_func_ptr)(void *, boolean);
  void                    *dereg_wm_func_parm;
...
typedef struct
{
  ...
  union
  {
    ...
    pdcp_reg_data_rate_ind_req_type   pdcp_reg_data_rate_ind_req;
    pdcp_rrc_rb_data_rate_info_type   pdcp_rrc_data_rate_info;
  } cmd;
