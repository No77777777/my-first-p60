...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/api/ds707_ccm.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*-------------------------------------------------------------------------
 Enum of Thremal PA states received from CFCM
 *-----------------------------------------------------------------------*/
typedef enum
{
  DS707_CCM_THERM_PA_OK    = 0,
  DS707_CCM_THERM_PA_WARN  = 1,
  DS707_CCM_THERM_PA_WARN2 = 2,
  DS707_CCM_THERM_PA_WARN3 = 3,
  DS707_CCM_THERM_PA_MAX   = 4
} ds707_ccm_cpu_state_enum_type;
