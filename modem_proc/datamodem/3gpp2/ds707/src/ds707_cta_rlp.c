...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_cta_rlp.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (start_stop == DS707_CTA_START_TIMER)
  {
    ...
    ds3g_timer_start( DS3G_TIMER_CTA, (cta_val * 1000));
  ...
  else
  {
    ...
    ds3g_timer_stop( DS3G_TIMER_CTA);
  }
} /* ds707_reset_timer() */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("Could not reg TUN_PHYS_LINK_DOWN_EV cback");
  }
  ...
  {
    DS_3GPP2_ERROR_FATAL("Could not reg TUN_PHYS_LINK_UP_EV cback");
  }
#endif /* FEATURE_DATA_OPTHO */
