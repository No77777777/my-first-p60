...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_chs.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $

when       who        what, where, why
--------   ---        -------------------------------------------------------
04/01/16   sd         ATCoP decoupling changes
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -- - - -*/
  ...
  if ((ds707_chs_inactivity_timer == 0) && (ds707_chs_retry_timer == 0))
  {
    ...
    -----------------------------------------------------------------------*/
    queue_status = mc_queue_cmd(ds707_curr_subs_id(), MC_RES_REL_F);
    ...
    {
      DS_3GPP2_ERROR_FATAL( "Unknow status return from mc_queue_cmd()");
    }
