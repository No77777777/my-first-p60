...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/rohc_parser.c#2 $
...
void get_default_comp_channel(rohc_params_comp_channel_s_type * mychannel)
{
  if (NULL == mychannel)
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Functions argument, mychannel, is NULL");
    return;
  }
...
void get_default_comp_flow(rohc_params_comp_flow_s_type * myflow)
{
  if (NULL == myflow)
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Functions argument, myflow, is NULL");
    return;
  }
