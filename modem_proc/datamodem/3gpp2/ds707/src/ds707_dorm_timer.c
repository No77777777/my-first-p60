...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_dorm_timer.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
05/13/15   ms      Reset the dorm_timer_running flag after HOLD DOWN Timer expiry
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (dorm_timeri_is_running == FALSE)
  {
       ...
       )
    {
      ...
      ds3g_timer_start(DS3G_TIMER_HOLDDOWN, dorm_timeri_val);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (dorm_timeri_is_running == TRUE)
  {
    ...
    ds3g_timer_stop(DS3G_TIMER_HOLDDOWN);
...
)
{
  ...
  {
    DS_3GPP2_ERROR_FATAL("dorm_socm_msg is NULL");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("Could not reg SID_CHNG_EV cback");
  }
  ...
  {
    DS_3GPP2_ERROR_FATAL("Could not reg ABORT_SESSION_EV cback");
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  if (NULL == dorm_socm_msg )
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "DORM_TIMER SOCM - invalid socm msg ptr");
    return(SNM_UNSPEC);
  }
