...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/dsrsp.c#2 $
...
#include "dsrsp.h"
#if (defined(FEATURE_HDR_EMPA) || defined(FEATURE_DS_HDR_REVB))
#include "hdrrsp.h"
#include "hdrcom_api.h"
#include "ds707_sec_pkt_mgr_handoff.h"
#endif /* (defined(FEATURE_HDR_EMPA) || defined(FEATURE_DS_HDR_REVB)) */
...
#endif /* FEATURE_HDR_EMPA || FEATURE_DS_HDR_REVB */
  {
...
#ifdef FEATURE_DATA_FLOW_MGMT    
    /*-----------------------------------------------------------------------
       Compute latency in getting the 1st packet after enabling flow
    -----------------------------------------------------------------------*/
    if ( is_pri_wmk_buf )
    {
      ds3g_burst_flow_compute_avg_latency(
         &ds707_wmk_get_burst_params_ptr()->burst_params);
    }
#endif /* FEATURE_DATA_FLOW_MGMT */
