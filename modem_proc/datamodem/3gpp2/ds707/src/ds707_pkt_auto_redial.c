...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_pkt_auto_redial.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (ds707_pkt_auto_redial_timer_started == TRUE)
  {
    ...
    ds3g_timer_stop(DS3G_TIMER_PKT_AUTO_REDIAL);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
 ...
 if( (ds707_pkt_auto_redial_timer_started == FALSE) &&
     ...
     ((auto_redial_retry_attempts--) > 0))
  {
    ...
    ds3g_timer_start( DS3G_TIMER_PKT_AUTO_REDIAL,  auto_redial_timeri_val );
