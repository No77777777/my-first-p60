...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_epzid_util.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
04/01/16   sb      Fixed KW Errors
...
/*-------------------------------------------------------------------------*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("NULL pointer passed for dst_ptr or src_ptr");
    return;
  }
...
/*-------------------------------------------------------------------------*/
  ...
  {
    DS_IS707_ERROR_LOG_3(MSG_LEGACY_ERROR, "Out of Range EPZID Index: %d, list_len: %d, max_list_len: %d",
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("NULL pointer passed");
    return epzid_change;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if(epzid_ptr == NULL)
  {
    DS_3GPP2_ERROR_FATAL("epzid_ptr is NULL");
    return FALSE;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Invalid ds707_epzid_list_len: = %d", 
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if(new_list_len >= ds707_epzid_list_len)
  {
    DS_IS707_ERROR_LOG_2(MSG_LEGACY_ERROR, "List already smaller "
...
)
{
  ...
  {
     DS_IS707_ERROR_LOG_2(MSG_LEGACY_ERROR, "MAX Len Exceeded. "
