...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds_ehrpd_pdn_mgr.c#2 $
$Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "free_pdn_id(): Invalid Parameters");
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "is_pdn_id_valid(): Invalid Parameters");
  }
