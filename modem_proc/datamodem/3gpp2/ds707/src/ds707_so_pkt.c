...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_so_pkt.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("Bad init - mem overwritten");
  }
  else
  {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for( i = 0; i < DS707_SO_PKT_NUM; i++ )
  {
    ...
    else
    {
      ...
      ---------------------------------------------------------------------*/
      DS_3GPP2_ERROR_FATAL("Couldn't add SO to SNM");
    }
  }
  }
