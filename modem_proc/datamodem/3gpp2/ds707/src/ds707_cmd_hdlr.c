...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_cmd_hdlr.c#3 $ $DateTime: 2020/04/13 04:07:09 $ $Author: pwbldsvc $
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  {
    DS_3GPP2_ERROR_FATAL("3GPP2 MH cmd reg failed");
    return;
  }
} /* ds707_cmd_hdlr_init() */
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  DATA_IS707_C_MSG1(DS707_F3_MASK, "Processing command %d", 
                  cmd_ptr->hdr.cmd_id);
