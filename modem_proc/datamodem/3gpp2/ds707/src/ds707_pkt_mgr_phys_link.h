...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_pkt_mgr_phys_link.h#2 $ 
...
#if 0  
  ps_phys_link_ioctl_flow_ctl_type        flow_ctl_info;
#endif
}ds707_pkt_phys_link_flow_ctl_s_type;
