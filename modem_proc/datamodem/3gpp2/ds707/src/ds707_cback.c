...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_cback.c#2 $
...
/*-------------------------------------------------------------------------*/
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR,"Bad event passed %d",event);
    DS3GPP2_ASSERT(0);
    return(FALSE);
  }
...
/*-------------------------------------------------------------------------*/
  ...
  if (IS_IN_DS_TASK() == FALSE)
  {
    DS_3GPP2_ERROR_FATAL("must be in DS task to post event");
  }
  ...
  {
    DS_3GPP2_ERROR_FATAL("too many events");
  }
  ...
  do
  {
    ...
    {
      DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Bad Event Value: %d", loc_event);
      continue;
    }
