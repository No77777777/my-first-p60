...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_pkt_mgr_iface.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  {
    DS_3GPP2_ERROR_FATAL("Could not create ps iface");
  }
  /*-------------------------------------------------------------------------
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  case DS_CMD_707_PKT_DELAY_CONNECTION_CLOSE_TIMER:
    ...
    {
      DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "iface_tbl_ptr invalid, return" );
      return;
    }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/ 
  ...
  DS3GPP2_ASSERT(conn_delay_timer != NULL);
