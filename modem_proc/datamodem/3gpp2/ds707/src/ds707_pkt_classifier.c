...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_pkt_classifier.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (ds707_is_pkt_classifier_enabled())
  {
    ...
    {
      DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "NULL detected");
      return;
    }
  ...
  if ( ds707_is_pkt_classifier_enabled() )
  {
    ...
    else
    {
                ...
                (*(char *)((*pkt_head_ptr).data_ptr + 3) == 0x01) ) 
      {
        ...
        {
          DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Reached max allowed PDNs, reject");
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if( NV_MODE_HDR_ONLY == ds707_get_curr_mode_pref() )
  {
    ...
    event_info.subs_id = ds3gsubsmgr_subs_id_cm_to_ds3g(ds707_curr_subs_id());
