...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/dsrdud.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("Can register for phys link up event");
  }
  ...
  {
    DS_3GPP2_ERROR_FATAL("Can register for phys link down event");
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  /*-------------------------------------------------------------------------
    Register  ds3g timers for RDUD module.
  -------------------------------------------------------------------------*/
  ds3g_timer_register(&dsrdud.rdud_active_timer,
                       dsrdud_timer_cb,
                       DS3G_TIMER_RDUD);
} /* dsrdudi_timer_init() */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  switch ((ds3g_timer_enum_type)timer_id)
  {
    ...
    default:
      DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Bad timer id in dsrdud callback %d",
                      timer_id);
      DS3GPP2_ASSERT(0);
      return;
  }/* end of swicth */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  ds3g_timer_start(DS3G_TIMER_RDUD, duration);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  ds3g_timer_stop( DS3G_TIMER_RDUD);
