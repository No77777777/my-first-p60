...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_diag.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (rsp_ptr == NULL)
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Response buffer allocation failed.");
    return NULL;
  }
  ...
  else
  {
    ...
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Could not retrieve RLP 3 stats");
  }
