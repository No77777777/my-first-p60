...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/src/ds707_hi_spd_clk.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  if( impulse_cpu_hdl == NULL )
  {
    ...
    if ( impulse_cpu_hdl == NULL ) 
    {
      DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Unable to create impulse client!" );
    }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_3GPP2_ERROR_FATAL("Cant register for phys link down cback");
  }
  ...
  {
    DS_3GPP2_ERROR_FATAL("Cant register for phys link up cback");
  }
#endif/* #if 0*/
