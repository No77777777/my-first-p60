...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/inc/ds707_nv_util.h#4 $ $DateTime: 2021/02/08 22:33:06 $ $Author: pwbldsvc $
...
RETURN VALUE  None
===========================================================================*/
void ds707_nv_util_hdrpac_disable_1x_handdown_mode(void);
