...
Copyright (c) 2002-2017 Qualcomm Technologies Incorporated. 
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/inc/ds707_pkt_mgr.h#5 $ 
...
{
  sys_modem_as_id_e_type   subs_id;
}ds707_pkt_subs_notify_cmd_type;
...
/*-------------------------------------------------------------------------
  Types of refresh supported by 3GPP2
-------------------------------------------------------------------------*/
typedef enum 
{
  DS707_REFRESH_TYPE_NONE = 0,
  DS707_REFRESH_TYPE_NV,
  DS707_REFRESH_TYPE_SUBS,
  DS707_REFRESH_TYPE_MCFG,
  DS707_REFRESH_TYPE_MAX = 0XFF

}ds707_refresh_type;

/*-------------------------------------------------------------------------
  Structure to store the current 1x subs_id and also the type of
  refresh if initiated
-------------------------------------------------------------------------*/
typedef struct
{
  sys_modem_as_id_e_type curr_subs_id;  /* Subs ID for 1x/DO */
  sys_modem_as_id_e_type nv_refresh_subs_id;  /* Subs ID on which NV refresh has happened */
  ds707_refresh_type    refresh_type;
  
}ds707_refresh_info_type;
...
===========================================================================*/
void ds707_pkt_mgr_subs_refresh
(
  sys_modem_as_id_e_type
);
...
=====================================================================================*/
sys_modem_as_id_e_type ds707_curr_subs_id(void);
...
=====================================================================================*/
sys_modem_as_id_e_type ds707_get_nv_refresh_subs_id(void);
...
=====================================================================================*/
ds707_refresh_type ds707_get_refresh_type(void);
...
DESCRIPTION
  ...
  data path manager. This function is called after posting Iface UP indication
  to PS.
...
SIDE EFFECTS  None
===========================================================================*/
void ds707_pkt_mgr_read_internal_auth_nv
( 
  void 
);
...
SIDE EFFECTS  None
===========================================================================*/
boolean ds707_pkt_mgr_get_auth_internal_nv
(
  void 
);
