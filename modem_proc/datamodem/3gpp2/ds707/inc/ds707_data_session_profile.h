...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/inc/ds707_data_session_profile.h#3 $ $DateTime: 2021/02/08 22:33:06 $ $Author: pwbldsvc $
...
extern ds707_data_session_profile_id 
  ds707_data_session_max_profiles[DS707_DATA_SESS_MAX_SUPPORTED_SUBS] ;
/*---------------------------------------------------------------------------
...
SIDE EFFECTS  None
===========================================================================*/
void ds707_data_session_disallow_call_nv_init(void);
