...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/inc/ds707_p_rev.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef struct
{
 byte     msg_type;
 byte     p_rev;
}ds707_p_rev_sync_espm_cback_info_type;
