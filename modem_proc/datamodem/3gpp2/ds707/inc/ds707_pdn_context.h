...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/inc/ds707_pdn_context.h#4 $
$Author: pwbldsvc $
$DateTime: 2021/02/08 22:33:06 $
...
PARAMETERS  iface_ptr          - IFACE pointer
            ...
            is_iface_crit_sect - Has it entered critcal section for iface hdlr
...
===========================================================================*/
void ds707_pdnctx_reset_throttle_on_sim_swap(void);
