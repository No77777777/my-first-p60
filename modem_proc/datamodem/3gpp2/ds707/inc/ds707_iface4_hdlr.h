...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/ds707/inc/ds707_iface4_hdlr.h#2 $
...
struct __dssnet4_sm_cb_s
{
  ...
  void                       *iface_event_buf;      /*iface event buf*/
  void                       *phys_link_event_buf;  /* phys link buffer*/
