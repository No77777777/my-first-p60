...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/doqos/inc/ds_dqos_mgr.h#2 $
...
typedef struct
{
  uint8                                  tft_cb_instance;
  ds_dqos_mgr_pending_resv_msg_info_type resv_msg_info_arr[DS_DQOS_MGR_RESV_MSG_MAX_PENDING];
}ds_dqos_mgr_tft_resv_msg_info_type;
