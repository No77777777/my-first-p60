...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/doqos/inc/ds707_nw_init_qos_mgr.h#3 $ 
...
RETURN VALUE  None.
===========================================================================*/
void ds707_nw_init_qos_mgr_notify_conn_open(void);
...
RETURN VALUE  None.
===========================================================================*/
void ds707_nw_init_qos_mgr_notify_handoff_to_qos_aware_sys(void);
