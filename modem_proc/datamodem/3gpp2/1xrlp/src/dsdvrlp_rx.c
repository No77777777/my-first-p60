...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/1xrlp/src/dsdvrlp_rx.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  if(curr_list_elem_ptr == NULL)
  {
    DS_RLP_ERROR_LOG_0(MSG_LEGACY_ERROR, "curr_list_elem_ptr is NULL in dsdvrlp_alloc_fwd_frames");
  }
  else
  { 
        ...
        )
  {
    ...
    if ( fr_info_ptr->fr_det_enum != DSRLPI_DONE )
    {
      ...
      switch ( fr_info_ptr->fr_det_enum )
      {
        ...
        default:
          /*lint -save -e506, -e774 */
          DS_RLP_ERROR_LOG_1(MSG_LEGACY_ERROR, "Invalid RLP Frame type %d",
