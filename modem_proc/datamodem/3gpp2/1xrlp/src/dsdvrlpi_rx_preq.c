...
Copyright (c) 1999-2015 by Qualcomm Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/1xrlp/src/dsdvrlpi_rx_preq.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  while ( ( curr_list_elem_ptr != NULL ) && ( keep_going == TRUE ) )
  {
    ...
    if ( curr_seq == need_seq )
    {
      ...
      {
        DS_RLP_ERROR_LOG_1(MSG_LEGACY_ERROR, "Got fr_det_enum %d from preq",
                      fr_info_ptr->fr_det_enum);
      }
      /*lint -restore */
