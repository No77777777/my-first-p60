...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/hdrdata/src/hdrrlpnak.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
  ...
  if (nak_entry_ptr == NULL)
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Ran out of nak items in free q" );
    return FALSE;
  }
...
#else
  DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "hdrrlpnak_age_lists() is not supported." );
#endif
