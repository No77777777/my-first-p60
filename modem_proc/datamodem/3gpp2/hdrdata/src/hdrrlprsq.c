...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/hdrdata/src/hdrrlprsq.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
                            ...
                            rrcb_ptr->cfg_ptr->seq_modulus))
  {
    ...
    {
      DS_IS707_ERROR_LOG_4(MSG_LEGACY_ERROR, "RLP Rx[%d,%d] V[%d,%d] Could not insert into NAK list.",
                      rrcb_ptr->cfg_ptr->sr_id,
                      "AB"[(rrcb_ptr->route)],
                      rrcb_ptr->cfg_ptr->ver,
                      rrcb_ptr->cfg_ptr->enhanced);
  ...
  while (tmp_item_ptr != NULL)
  {
    ...
    else 
    {
          ...
          rrcb_ptr->cfg_ptr->out_of_order_allowed) 
      {
        ...
        {
          DS_3GPP2_ERROR_FATAL("Dup did not succeed!");
        }
