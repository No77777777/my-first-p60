...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/jcdma/src/ds707_jcdma_apprate.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "invalid application rate");
    return;
  }
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "SO Doesn't Exist for rate %d", rate);
  }
