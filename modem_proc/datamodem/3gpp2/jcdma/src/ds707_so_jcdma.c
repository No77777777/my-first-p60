...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/jcdma/src/ds707_so_jcdma.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "invalid jcdma parameters");
    return;
  }
  /*lint -restore 641*/
  /*-------------------------------------------------------------------------
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for( i = 0; i < DS707_SO_PKT_NUM; i++ )
  {
    ...
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "SO %d not found in SNP", pkt_so);
  } /* for i = 0 to DS707_SO_PKT_NUM */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Unknown pkt so %d", inc_so);
    return(FALSE);
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "callback could not be inserted");
  }
