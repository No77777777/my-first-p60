...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/jcdma/src/ds707_jcdma_m51.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  switch(ds707_jcdma_m513_val)
  {
   ...
   bitrate = SIO_BITRATE_19200;
    ...
    default:
      DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Unknown M513 val %d",
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
   DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR,"JCDMA NV not enabled");
   return;
  }
  do
  {
  ...
  {
    DS_IS707_ERROR_LOG_0(MSG_LEGACY_ERROR, "Feature FEATURE_JCDMA_1X is undefined");
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Invalid mode for M511 %d", new_mode);
  }
  else
  {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Invalid mode for M512 %d", new_mode);
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Invalid mode for M513 %d", new_mode);
  }
  else
  {
  ...
  switch (new_ipr_val)
  {
   ...
   case SIO_BITRATE_19200:
    ...
    case SIO_BITRATE_230400:
      ...
      break;
    default:
      DS_IS707_ERROR_LOG_1(MSG_LEGACY_ERROR, "Unknown SIO bitrate %d", new_ipr_val);
      DS3GPP2_ASSERT(0);
      return(FALSE);
  }
