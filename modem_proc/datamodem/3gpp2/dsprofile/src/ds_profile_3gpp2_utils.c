...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp2/dsprofile/src/ds_profile_3gpp2_utils.c#2 $
...
)
{
  ...
  if(gen_params != NULL)
  {
    ...
    data_sess_profile->apn_type_mask = gen_params->apn_type_mask;
...
)
{
  ...
  if(gen_params != NULL)
  {
    ...
    gen_params->apn_type_mask = data_sess_profile->apn_type_mask;
