...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/ps_icmp6_nd.h#2 $
...
#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION ps_icmp_nd_qsh_mdump_collect
  
DESCRIPTION
  This function collects the mdump for nd_config_items variable
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void ps_icmp_nd_qsh_mdump_collect
(
  void
);
#endif/* FEATURE_QSH_MDUMP */
