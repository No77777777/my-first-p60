...
$Id: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/dhcp6_clienti.h#2 $
...
/*=========================================================================
FUNCTION DHCP6_CLIENTI_CORE_TIMER_EXPIRE_CMD

DESCRIPTION
  This function post the command to PS task to process timer expire event.
...
=========================================================================*/
void
dhcp6_clienti_core_timer_expire_cmd
(
