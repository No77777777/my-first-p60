...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/ps_dns_proxy.h#2 $ 
  $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
12/19/17    gbk    dns proxy enhancements 
...
#define PS_DNS_PROXY_SOCKETS_MAX 10
...
typedef struct ps_dns_proxy_info_s 
{
  ...
  sint15 client_sockfd[PS_DNS_PROXY_SOCKETS_MAX];
