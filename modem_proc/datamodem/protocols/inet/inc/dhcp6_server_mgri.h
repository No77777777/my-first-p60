...
$Id: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/dhcp6_server_mgri.h#2 $
...
/*===========================================================================
FUNCTION DHCP6I_SERVER_MGR_MEM_FREE()
...
SIDE EFFECTS
  Returns the memory to the dhcp6_mem_buffer via mem_heap.
===========================================================================*/
void 
dhcp6i_server_mgr_mem_free
(
  void * buf
);
