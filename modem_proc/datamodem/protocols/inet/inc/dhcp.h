...
$Id: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/dhcp.h#2 $ 
...
#ifdef FEATURE_QSH_MDUMP 
/*===========================================================================
FUNCTION dhcp6_server_ps_iface_qsh_mdump_collect
...
===========================================================================*/
QSH_MDUMP_FN_ATTR 
void dhcp6_server_ps_iface_qsh_mdump_collect
(
  void
);
#endif/* FEATURE_QSH_MDUMP */
