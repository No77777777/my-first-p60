...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/ps_tcp.h#3 $ $DateTime: 2020/03/02 04:57:11 $ $Author: pwbldsvc $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
03/02/20    sg     Added new parameters in total_keepalive_probes in TCB 
...
struct tcb
{
  ...
  uint32 		 ticks_passed;	 /* No of ticks passed for geniss timer	   */
  boolean 		 flag;			 /* Flag for geniss timer				   */
  ...
  ps_timer_handle_type     geniss_timer;   /* timer for generation of random ISS */
  ...
  uint32  access_priority;/* TCP Access priority TCP_ACCESS_PRIORITY*/
