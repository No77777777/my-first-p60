...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/ps_tcp_config.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define TCP_ACCESS_PRIORITY_ENABLE 1
#define TCP_ACCESS_PRIORITY_DISABLE 0
