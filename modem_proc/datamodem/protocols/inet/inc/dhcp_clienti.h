...
$Id: //components/rel/data.mpss/3.5..2.1/protocols/inet/inc/dhcp_clienti.h#2 $
...
typedef struct dhcp_client_dns {
  uint32 dns_addr;
  struct dhcp_client_dns * next_ptr;
} dhcp_client_dns;
...
typedef struct dhcp_client_sip_addr {
  uint32 addr;
  struct dhcp_client_sip_addr * next_ptr;
...
typedef struct dhcp_client_sip_domain_name {
  ...
  struct dhcp_client_sip_domain_name * next_ptr;
