...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/src/ps_tcphdr.c#3 $ $DateTime: 2021/01/05 04:26:43 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/09/19   gbk     TCP window scale option max allowed value of 14 
