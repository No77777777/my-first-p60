...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/src/ps_tcpout.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
{
  if( tcp_seq_lt(tcb->high_seq_rexmit, tcb->high_seq_lost))
  {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  /*-----------------------------------------------------------------------
   ...
   -----------------------------------------------------------------------*/
    ...
    -----------------------------------------------------------------------*/
    if ((TCP_ACCESS_PRIORITY_ENABLE == tcb->access_priority)&&(NULL != ps_iface_ptr))
    {
