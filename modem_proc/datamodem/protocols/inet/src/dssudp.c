...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/src/dssudp.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...

#define DSSUDP_ASSERT(expression)  \
          dssudp_assert_wrapper(__LINE__, expression)
...
FUNCTION dssucp_assert_wrapper

DESCRIPTION
  Wrapper function for DSSUDP ASSERT
...
=============================================================================*/
static void dssudp_assert_wrapper
(
...
)
{
  if ( !expression )
  {
    ERR_FATAL("DSSUDP_ERR_FATAL at line:%d ",  
                                   line_num,0,0);  
  }
  
}/* dssudp_assert_wrapper */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  -------------------------------------------------------------------------*/
  DSSUDP_ASSERT(0 != ucb_ptr->conn.local.port);
