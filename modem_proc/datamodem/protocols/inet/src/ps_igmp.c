...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/inet/src/ps_igmp.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
            ...
            ip_pkt_info_ptr) ==   FALSE)
  {
    ...
    DPL_LOG_NETWORK_RX_DROPPED_PACKET(iface_ptr, igmp_data_ptr, DPL_IID_NETPROT_IP);
...
)
{
 ...
 /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (!PS_IFACE_IS_VALID(this_iface_ptr))
  {
    DATA_PROTO_ERROR_LOG_1(PS_BAD_ARG_OR_NULL_PTR, this_iface_ptr);
        return NULL;
  }
