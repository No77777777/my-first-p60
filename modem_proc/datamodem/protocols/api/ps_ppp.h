...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/api/ps_ppp.h#2 $
...
typedef enum
{
  ...
  LCP_CCP_CONFIG             = 2,/* LCP CCP Config  */
  IPCP_ACK_TIMEOUT           = 3,/* IPCP acknowledgement timeout     */
  IPCP_REQUEST_TRY           = 4,/* IPCP Request Retry count     */
  AUTH_TIMEOUT               = 5,/* AUTH acknowledgement timeout      */
  AUTH_RETRY                 = 6,/* AUTH Request Retry count          */
  AUTH_REQUIRE_ENCRYPTED_PASSWORD = 7,/* AUTH Request Retry count          */
  IPV6CP_ACK_TIMEOUT         = 8,/* IPV6CP acknowledgement timeout   */
  IPV6CP_REQUEST_TRY         = 9,/* IPV6CP Request Retry count   */
  DEFAULT_LCP_ACK_TIMEOUT    = 10,/* Default LCP ACK timeout          */
  DEFAULT_LCP_REQUEST_TRY    = 11,/* Default LCP Request Retry count  */
  DEFAULT_IPCP_ACK_TIMEOUT   = 12,/* Default IPCP acknowledgement timeout */
  DEFAULT_IPCP_REQUEST_TRY   = 13,/* Default IPCP Request Retry count*/
  DEFAULT_AUTH_TIMEOUT       = 14, /* Default LCP acknowledgement timeout */
  DEFAULT_AUTH_RETRY         = 15,/* Default LCP Request Retry count */
  DEFAULT_IPV6CP_ACK_TIMEOUT = 16,/* Def. IPV6CP acknowledgement timeout  */
  DEFAULT_IPV6CP_REQUEST_TRY = 17,/* Def. IPV6CP Request Retry count */

  VSNCP_3GPP2_REQ_TRY           = 18,  /* vsncp-3gpp2, same for all dev    */
  VSNCP_3GPP2_TERM_TRY          = 19,  /* vsncp-3gpp2, same for all dev    */
  VSNCP_3GPP2_VSNCP_ACK_TIMEOUT = 20,  /* vsncp-3gpp2, same for all dev    */
  VSNCP_3GPP2_TERM_TIMEOUT      = 21,  /* vsncp-3gpp2, same for all dev    */
