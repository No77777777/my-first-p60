...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/api/ps_ip6_sm.h#2 $
  $Author: pwbldsvc $ $DateTime: 2019/10/22 02:53:17 $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
02/09/15    cx     Fix incorrect event order in IPv6 EVENTS
11/04/14    kc     Added FR21288 changes in ip6_sm_cb_s 
                   and ip6_sm_destroy()
...
struct __ip6_sm_cb_s
{
  ...
  void                       *ip6_sm_phys_link_flow_event_handle;
  void                       *ip6_sm_iface_prefix_event_handle;
  void                       *ip6_sm_iface_ra_event_handle;
  void                       *ip6_sm_phys_link_event_handle;
  ps_iface_event_enum_type    phys_link_flow_event_reg_array[1];
  ps_iface_event_enum_type    iface_prefix_event_reg_array[1];
  ps_iface_event_enum_type    iface_ra_event_reg_array[1];
  ps_iface_event_enum_type    phys_link_event_reg_array[3];
