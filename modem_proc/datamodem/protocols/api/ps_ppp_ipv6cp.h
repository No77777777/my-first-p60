...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/api/ps_ppp_ipv6cp.h#2 $ 
...
/*===========================================================================
FUNCTION IPV6CP_GET_DEVICE_CONSTANTS()
...
RETURN VALUE
  Configurable protocol constants for IPV6CP.
...
SIDE EFFECTS
  None
===========================================================================*/
struct fsm_constant_s *ipv6cp_get_device_constants
(
