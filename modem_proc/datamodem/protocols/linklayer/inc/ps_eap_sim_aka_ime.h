...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/inc/ps_eap_sim_aka_ime.h#2 $ 
...
/*The Encrypted IMSI must be prefixed with \0 = 0x00 */
#define EAP_SIM_AKA_IME_ENCR_IMSI_PREFIX  0x00

/*Used to separate Encrypted IMSI and the optional Key Identifier*/
#define EAP_SIM_AKA_IME_ENCR_IMSI_KEY_ID_SEPARATOR ','

/*Invalid Public Key value*/
#define EAP_SIM_AKA_IME_INVALID_PUB_KEY -1
...
typedef struct
{
   ...
   /* Needed for IMSI encryption */
   boolean                          use_encrypted_imsi;
   uint32                           session_type;
