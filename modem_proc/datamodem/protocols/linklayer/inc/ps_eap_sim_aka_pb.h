...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/inc/ps_eap_sim_aka_pb.h#2 $ 
...
/*---------------------------------------------------------------------------
 Maximum Len of msg specific data used to compute Checkcode
---------------------------------------------------------------------------*/
#define EAP_SIM_AKA_MAX_CHECKCODE_DATA_LEN       600
...
typedef struct eap_sim_aka_pb_ctx_S
{
  ...
  dsm_item_type*                       identity_req_rsp_packets;
...
/*===========================================================================
FUNCTION EAP_SIM_AKA_PB_SET_LAST_TX_PKT

DESCRIPTION
  Updates the cached transmitted packet. It is needed by the 
  SIM or AKA Core for MAC computation.
...
===========================================================================*/
void 
eap_sim_aka_pb_set_last_tx_pkt
(  
  eap_sim_aka_pb_ctx*  pb_ctx,
  dsm_item_type**      msg
);
...
/*===========================================================================
FUNCTION eap_sim_aka_pb_get_identity_req_rsp_pkt

DESCRIPTION
  Retrieves to the caller the cached identity request response packets.
  It is needed by the AKA Core for checkcode validation.
...
===========================================================================*/
void
eap_sim_aka_pb_get_identity_req_rsp_pkt
(  
  eap_sim_aka_pb_ctx*  pb_ctx,
  dsm_item_type**      msg
);
...
/*===========================================================================
FUNCTION eap_sim_aka_pb_copy_packet_to_identity_packets

DESCRIPTION
  Copies the last_tx_pkt or last_rx_pkt if it is identity packet to 
  cache. This is used in checkcode computation
DEPENDENCIES
  None
...
===========================================================================*/
void
eap_sim_aka_pb_copy_packet_to_identity_packets
(  
  eap_sim_aka_pb_ctx*  pb_ctx,
  dsm_item_type**       msg
);
...
typedef enum
{
  ...
  EAP_SIM_AKA_FAIL_INVALID_CHECKCODE = 7
