...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/inc/ps_eap_sim_pb.h#3 $ 
  $DateTime: 2021/05/19 10:31:33 $ 
  $Author: pwbldsvc $


when        who    what, where, why
--------    ---    ----------------------------------------------------------
09/08/20    ak     Increased version arr-length to parse multiple version list
