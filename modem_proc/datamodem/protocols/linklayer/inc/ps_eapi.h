...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/inc/ps_eapi.h#3 $ $DateTime: 2020/01/17 00:02:41 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  eap_trp_tx_cback_buf_type      trp_tx_buf_f_ptr;    /* Transport tx fn ptr for buffers */
...
typedef enum{
 ...
 EAP_CLIENT_REAUTH_REALM_SETTING = 0x1,
 EAP_CLIENT_CHECKCODE_VERIFICATION_SETTING = 0x2,
 EAP_CLIENT_SEND_CHECKCODE_SETTING = 0x4,
 EAP_CLIENT_USE_ENCR_PERM_ID_SETTING = 0x8,
 EAP_CLIENT_IGNORE_UNSKIPP_IN_AT_ENCR_SETTING = 0x10,
 EAP_CLIENT_MAX_SETTING  /*Limited by size of uint32*/
