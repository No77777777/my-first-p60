...
DESCRIPTION
  ...
  Copyright (c) 2006-2019 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/inc/ps_eap_sim_aka_ume.h#2 $ 
...
/*===========================================================================
FUNCTION UMEI_GET_SESSION_TYPE_FROM_SUBSCRIPTION_MH

DESCRIPTION
  Helper function to obtain the session info from algo and MH subs
...
===========================================================================*/
uint32 eap_ume_get_session_type_from_subscription_mh
(
  uint8                      subscription,
  eap_sim_aka_algo_enum_type sim_aka_algo 
);
