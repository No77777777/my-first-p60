...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/src/ps_ppp_ncpi.h#2 $
  $Author: pwbldsvc $
...
)
{
  ...
  {
    /*Invalid parameter to ncpi_report_event_to_diag*/
