...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/src/ps_ppp_netmodel.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
===========================================================================*/
#define PS_PPP_NETMODEL_ASSERT(expression)  \
               ps_ppp_netmodel_assert_wrapper(__LINE__, expression)
...
= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =*/
 ...
 FUNCTION ps_ppp_netmodel_assert_wrapper
 
 DESCRIPTION
   Wrapper function for PS_PPP_NETMODEL_ASSERT
 ...
 ===========================================================================*/
 static void ps_ppp_netmodel_assert_wrapper
 (
 ...
 )
 {
   if ( !expression )
   {
     ERR_FATAL("PS_PPP_NETMODEL_ERR_FATAL at line:%d ",  
                                    line_num,0,0);  
   }
 }/* ps_ppp_netmodel_assert_wrapper */
...
)
{
  ...
  PS_PPP_NETMODEL_ASSERT( snoop_id_array_entries < MAX_SNOOPED_MESSAGES );
...
)
{
  ...
  PS_PPP_NETMODEL_ASSERT( snoop_id_array_entries == 0 );
