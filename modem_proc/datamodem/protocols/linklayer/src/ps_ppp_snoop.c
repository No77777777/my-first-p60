...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/linklayer/src/ps_ppp_snoop.c#2 $
...
)
{
  ...
  -------------------------------------------------------------------------*/
  LOG_MSG_DATA_PROTO_INFO_3("Reg %d protocol cb code: %d iface %d", protocol, msg_type, iface);
  switch(protocol)
  {
  ...
  LOG_MSG_DATA_PROTO_INFO_3 ("Registered iface %d prot %d msg %d",
...
)
{
  ...
  {
    LOG_MSG_DATA_PROTO_INFO_3 ("Unregister iface %d prot %d msg %d",
  ...
  {
    LOG_MSG_DATA_PROTO_INFO_0("Unregistering non-existent function!");
  }
} /* snoop_unreg_event() */

...
)
{
  ...
  if( item_ptr->used == PPP_PROTO_SIZ)
  {
    ...
    if( *curr_byte_ptr == HDLC_ALL_ADDR)
    {
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_0("Got FF03, snoop next two bytes.");
        return SNOOP_NEXT_TWO_BYTES;
      }
      else
      {
        LOG_MSG_DATA_PROTO_INFO_1("Got FF%02X, ignoring.", *(curr_byte_ptr+1));
        return SNOOP_IGNORE_PKT;
      }
    } /* if FF */
  ...
  switch(*curr_byte_ptr)
  {
    case LINK_PROTO_BYTE1:
      ...
      if( (*(curr_byte_ptr+1)) == LCP_BYTE2)
      {
        ...
        {
          LOG_MSG_DATA_PROTO_INFO_0("Found LCP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got LCP, no callback");
      }
      ...
      else if( (*(curr_byte_ptr+1)) == PAP_BYTE2)
      {
        ...
        {
          LOG_MSG_DATA_PROTO_INFO_0("Found PAP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got PAP, no callback");
      }
      break;
  ...
  case  CHAP_BYTE1:
      ...
      if( (*(curr_byte_ptr+1)) == CHAP_BYTE2)
      {
        ...
        {
          LOG_MSG_DATA_PROTO_INFO_0("Found CHAP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got CHAP, no callback");
      }
      break;
    ...
    case IPCP_BYTE1:
      ...
      if( (*(curr_byte_ptr+1)) == IPCP_BYTE2)
      {
        ...
        { 
          LOG_MSG_DATA_PROTO_INFO_0("Found IPCP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got IPCP, no callback");
      }
      /*---------------------------------------------------------------------
      ...
      if( (*(curr_byte_ptr+1)) == CCP_BYTE2)
      {
        ...
        { 
          LOG_MSG_DATA_PROTO_INFO_0("Found CCP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got CCP, no callback");
      }
      /*---------------------------------------------------------------------
      ...
      if( (*(curr_byte_ptr+1)) == ILCCP_BYTE2)
      {
        ...
        { 
          LOG_MSG_DATA_PROTO_INFO_0("Found ILCCP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got ILCCP, no callback");
      }
#ifdef FEATURE_DATA_PS_IPV6
      /*---------------------------------------------------------------------
      ...
      if( (*(curr_byte_ptr+1)) == IPV6CP_BYTE2)
      {
        ...
        { 
          LOG_MSG_DATA_PROTO_INFO_0("Found IPV6CP callback, unframe");
          return SNOOP_DO_UNFRAMING;
        }
        LOG_MSG_DATA_PROTO_INFO_0("Got IPV6CP, no callback");
      }
#endif /*FEATURE_DATA_PS_IPV6*/
      break;
    ...
    case  NO_COMPRESS:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_0("Found IP protocol callback, unframe");
        return SNOOP_DO_UNFRAMING;
      }
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_0("Found VJ compressed callback, unframe");
        return SNOOP_DO_UNFRAMING;
      }
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_0("Found VJ uncompressed callback, unframe");
        return SNOOP_DO_UNFRAMING;
      }
      break;
    ...
    default:
      ...
      ---------------------------------------------------------------------*/
      LOG_MSG_DATA_PROTO_INFO_0("Found unknown protocol");
  } /* switch(protocol) */
  ...
  --------------------------------------------------------------------------*/
  LOG_MSG_DATA_PROTO_INFO_0("Ignoring packet.");
  return SNOOP_IGNORE_PKT;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_DATA_PROTO_INFO_3("snooping device %d, prot %x, msg %d",
  ...
  switch(protocol)
  {
    case PPP_LCP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default LCP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: LCP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: LCP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
    ...
    case PPP_PAP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default PAP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: PAP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: PAP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
    ...
    case PPP_CHAP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default CHAP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: CHAP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: CHAP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
    ...
    case PPP_IPCP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default IPCP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: IPCP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: IPCP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
    ...
    case PPP_IPV6CP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default IPV6CP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: IPV6CP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: IPV6CP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
#endif /* FEATURE_DATA_PS_IPV6 */
    ...
    case PPP_CCP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default CCP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: CCP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: CCP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
    ...
    case PPP_ILCCP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default ILCCP callback", device);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: ILCCP msg %d, calling callback",
                        device, *msg_byte_ptr);
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_2("device %d: ILCCP msg %d, no callbacks registered",
                        device, *msg_byte_ptr);
      }
      break;
    ...
    case PPP_IP_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default IP callback", device);
      ...
      else
      {
        /*-------------------------------------------------------------------
          Send packet to TX framer or up the stack based upon the mode
        -------------------------------------------------------------------*/
        LOG_MSG_DATA_PROTO_INFO_1("device %d: IP packet, no callbacks registered",
                        device);
    ...
    case PPP_VJCH_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default VJCH callback", device);
      ...
      else
      {
        /*-------------------------------------------------------------------
          Send packet to TX framer or up the stack based upon the mode
        -------------------------------------------------------------------*/
        LOG_MSG_DATA_PROTO_INFO_1("device %d: VJCH packet, no callbacks registered",
                        device);
    ...
    case PPP_VJUCH_PROTOCOL:
      ...
      {
        LOG_MSG_DATA_PROTO_INFO_1("device %d: Calling default VJUCH callback", device);
      ...
      else
      {
        /*-------------------------------------------------------------------
          Send packet to TX framer or up the stack based upon the mode
        -------------------------------------------------------------------*/
        LOG_MSG_DATA_PROTO_INFO_1("device %d: VJUCH packet, no callbacks registered",
                        device);
    ...
    default:
      /*---------------------------------------------------------------------
        Send packet to TX framer or up the stack based upon the mode
      ---------------------------------------------------------------------*/
      LOG_MSG_DATA_PROTO_INFO_2("Unknown protocol %x on device %d -- forwarding",
                      protocol, device);
  } /* switch protocol */
