...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
           ...
           P S _ I P D C _ U T I L S _ E X  . H
...
#else 
#define MSG_IPDC_ERROR(s,x,y,z)    MSG_3(MSG_SSID_DS_PS, MSG_LEGACY_HIGH, s,x,y,z)
#define MSG_IPDC_HIGH(s,x,y,z)     MSG_3(MSG_SSID_DS_PS, MSG_LEGACY_HIGH, s,x,y,z)
#define MSG_IPDC_HIGH_8(s,a,b,c,d,e,f,g,h) MSG_8(MSG_SSID_DS_PS, MSG_LEGACY_HIGH, s,a,b,c,d,e,f,g,h)
#define MSG_IPDC_MED(s,x,y,z)      
#define MSG_IPDC_S_HIGH(s,x,y,z)   MSG_SPRINTF_3(MSG_SSID_DS_PS, MSG_LEGACY_HIGH, s,x,y,z)   
...
#define MSG_IPDC_DEBUG(s,x,y,z)    
#define MSG_IPDC_BUFFER(s,x,y,z)  
#endif /* defined IPDC_DEBUG */
#endif /* defined(IPDC_ON_Q6SIM)||defined(IPDC_ON_OFFTARGET_TOOL) */


#if defined (IPDC_ON_OFFTARGET_TOOL) || defined (IPDC_ON_TBS)
#define IPDC_DECOMP_DEBUG
#endif

#ifdef IPDC_DECOMP_DEBUG
#define MSG_IPDC_DECOMP_ERROR(s,x,y,z)    MSG_3(MSG_SSID_DS_UMTS, MSG_LEGACY_ERROR, s,x,y,z)
#define MSG_IPDC_DECOMP_HIGH(s,x,y,z)     MSG_3(MSG_SSID_DS_UMTS, MSG_LEGACY_HIGH, s,x,y,z)
#define MSG_IPDC_DECOMP_MED(s,x,y,z)      MSG_3(MSG_SSID_DS_UMTS, MSG_LEGACY_MED, s,x,y,z)
#define MSG_IPDC_DECOMP_LOW(s,x,y,z)      MSG_3(MSG_SSID_DS_UMTS, MSG_LEGACY_LOW, s,x,y,z)
#define MSG_IPDC_DECOMP_DEBUG(s,x,y,z)    MSG_IPDC_HIGH(s,x,y,z)
#define MSG_IPDC_DECOMP_BUFFER(s,x,y,z)   MSG_IPDC_MED(s,x,y,z)

#else
#define MSG_IPDC_DECOMP_ERROR(s,x,y,z)
#define MSG_IPDC_DECOMP_HIGH(s,x,y,z)     
#define MSG_IPDC_DECOMP_MED(s,x,y,z)      
#define MSG_IPDC_DECOMP_LOW(s,x,y,z)
#define MSG_IPDC_DECOMP_DEBUG(s,x,y,z)
#define MSG_IPDC_DECOMP_BUFFER(s,x,y,z)
#endif
...
===========================================================================*/
#if defined(IPDC_ON_OFFTARGET_TOOL) || defined(IPDC_ON_Q6SIM) || defined(IPDC_ON_MOB)
...
/*===========================================================================
FUNCTION ps_ipdcu_calculate_ipdc_sh_checksum_ex

DESCRIPTION
  Calculates the 4 bit IPDC Header checksum for the current packet if SH is 
  present

  This function computes the checksum of the given data buffer across 
  PS_IPDC_MIN_MATCH_IN_BYTES bytes
...
RETURN VALUE
  uint8 checksum value (lower 4 bits contain checksum)
===========================================================================*/
uint8 ps_ipdcu_calculate_ipdc_sh_checksum_ex
(
