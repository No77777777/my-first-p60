...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/dc/ipdc/v1/inc/ps_ipdc_logging_ex.h#2 $
  $Author: pwbldsvc $
...
/* Structure for logging metrics and stats */
typedef struct ps_ipdc_compressor_logging_s_type
{
   /* Cookie Pointer Value : address of self instance */
  void*             cookie_ptr;
   
  ipdc_handle_type  ipdc_handle_ptr;
  
  /* These fields are used to track the currently active index of above log 
     packets. */
  uint8 active_metrics_log_index;
  uint8 active_stats_log_index;

  LOG_IPDC_COMPRESSOR_METRICS_C_type  *comp_metrics_log_pkt;
  LOG_IPDC_COMPRESSOR_STATS_C_type    *comp_stats_log_pkt;  
}ps_ipdc_compressor_logging;
...
SIDE EFFECTS
  None
===========================================================================*/
boolean ipdc_alloc_comp_metrics_stats_log_pkts_ex
(
  ipdc_handle_type               handle
);

/*===========================================================================
FUNCTION ps_ipdc_logging_get_free_instance

DESCRIPTION
  Fetches the free istance for logging structure
...
SIDE EFFECTS
  None
===========================================================================*/
ps_ipdc_compressor_logging* ps_ipdc_logging_get_free_instance
(
  void
);

/*===========================================================================
FUNCTION ps_ipdc_logging_fetch_instance

DESCRIPTION
  Fetches the logging instance for a particular handle
...
SIDE EFFECTS
  None
===========================================================================*/
ps_ipdc_compressor_logging* ps_ipdc_logging_fetch_instance
(
  ipdc_handle_type handle
);
