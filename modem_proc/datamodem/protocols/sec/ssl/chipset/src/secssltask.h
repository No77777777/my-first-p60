...
$Header: //components/rel/data.mpss/3.5..2.1/protocols/sec/ssl/chipset/src/secssltask.h#1 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define SECSSL_DYNAMIC_CERT_LOOKUP_RESPONSE_SIG    0x1000    /* signal that dynamic fetch from AP is complete and SSL needs to be process it */
