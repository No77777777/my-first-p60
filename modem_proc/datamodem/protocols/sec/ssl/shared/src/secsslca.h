...
/*==========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/sec/ssl/shared/src/secsslca.h#1 $
  $Date: 2019/10/22 $ $Author: pwbldsvc $
...
typedef struct 
{
  ...
  uint16              cert_len;      /**< Length of the data array for the
                                          certificate. */
  secx509_cert_type*  x509cert_ptr;  /**< x509Cert Pointer */
}secsslca_root_cert;
