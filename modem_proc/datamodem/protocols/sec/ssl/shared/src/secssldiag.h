...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/sec/ssl/shared/src/secssldiag.h#1 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/29/18   shrvn   Enabling SSL Log Packets.
...
#define LOG_SEC_SSL_C_BASE                  0x10A9
...
FUNCTION SECSSL_ALLOC

DESCRIPTION
  This function allocates memory for log packet.

DEPENDENCIES
  None.

PARAMETERS
  number  - a value which determines what type of packet (and size) to allocate.

RETURN VALUE
  Void pointer to allocated log packet.
...
FUNCTION SECSSL_COMMIT

DESCRIPTION
  This function commits the log packet.

DEPENDENCIES
  None.
PARAMETERS
  secssl_log_info_ptr  - Pointer to the log packet.
