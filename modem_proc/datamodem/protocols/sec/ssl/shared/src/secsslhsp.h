...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/sec/ssl/shared/src/secsslhsp.h#1 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
FUNCTION SECSSLHSP_CONTINUE_TLS_WITH_PSK
...
SIDE EFFECTS
  None
===========================================================================*/
void secsslhsp_continue_tls_with_psk
( 
  secssl_session_type*  session_ptr
);
