...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/protocols/sec/ssl/shared/src/secsslconf.h#1 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/25/17   nm      Duel IMS call support(FR36476 L+L)
...
#define SECSSLCONF_MAX_CONC_SESSIONS     4
