...
namespace ds
{
   namespace Sock
   {
      ...
      namespace AncData
      {
        ...
        /**
          * Ancillary Data ID for RECVTTL information (used in RecvMsg)
          */
        const ::ds::Sock::AncDataIDType RECV_TTL_INFO = 3;

        /**
          * Ancillary Data ID for RECVECN information (used in RecvMsg)
          */
        const ::ds::Sock::AncDataIDType RECV_ECN_INFO = 4;
         
        /**
          * Ancillary Data ID for RECVSUBID information (used in RecvMsg)
          */
        const ::ds::Sock::AncDataIDType RECV_SUBID_INFO = 5;
