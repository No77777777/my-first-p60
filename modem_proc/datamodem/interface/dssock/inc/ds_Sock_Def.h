...
/** @memberof ds_Sock_OptName
  *
  * Option name: QDS_IP_RECVTTL
  * Level: IP
  * Value type: Boolean
  * Description: Enable retrieving of recevied time to live info.
  */
#define ds_Sock_OptName_QDS_IP_RECVTTL   24

/** @memberof ds_Sock_OptName
  *
  * Option name: QDS_IP_RECVECN
  * Level: IP
  * Value type: Boolean
  * Description: Enable retrieving of recevied explicit congestion notification info.
  */
#define ds_Sock_OptName_QDS_IP_RECVECN   25

/** @memberof ds_Sock_OptName
  *
  * Option name: QDS_TCP_ACCESS_PRIORITY
  * Level: TCP
  * Value type: Boolean
  * Description: Enable/Disable TCP Access Priority.
  */
#define ds_Sock_OptName_QDS_TCP_ACCESS_PRIORITY  29

/** @memberof ds_Sock_OptName
  *
  * Option name: QDS_IP_RECVSUBID
  * Level: IP
  * Value type: Boolean
  * Description: Enable retrieving of received subscription ID info.
  */
#define ds_Sock_OptName_QDS_IP_RECVSUBID   30
   ...
   namespace Sock
   {
      ...
      namespace OptName
      {
         ...
         /**
           ...
           * Level: IP
           * Value type: Boolean
           * Description: Enable retrieving of time to live info.
           */
         const ::ds::Sock::OptNameType QDS_IP_RECVTTL  = 24;
         /**
           * Option name: QDS_IP_RECVECN
           * Level: IP
           * Value type: Boolean
           * Description: Enable retrieving of explicit congestion notification info.
           */
         const ::ds::Sock::OptNameType QDS_IP_RECVECN  = 25;
         ...
         /**
           ...
           */
         const ::ds::Sock::OptNameType QDS_UDP_ENCAPS  = 26;

      /**
        * Option name: QDS_SO_PORT_PREF_HANDLE
        * Level: Socket
        * Value type: int
        * Description: Get and Set port preference handle.
        */
      const ::ds::Sock::OptNameType QDS_SO_PORT_PREF_HANDLE  = 27;

      /**
        * Option name: QDS_SO_PORT_IWLAN_CAPABLE
        * Level: Socket
        * Value type: int
        * Description: Get and Set port iwlan capability.
        */
      const ::ds::Sock::OptNameType QDS_SO_PORT_IWLAN_CAPABLE  = 28;
      ...
      /**
        ...
        * Description: Enable/Disable TCP Access Priority.
        */
      const ::ds::Sock::OptNameType QDS_TCP_ACCESS_PRIORITY    = 29;

         /**
          * Option name: QDS_IP_RECVSUBID
          * Level: IP
          * Value type: Boolean
          * Description: Enable retrieving of explicit subscription ID info.
          */
         const ::ds::Sock::OptNameType QDS_IP_RECVSUBID  = 30;
      ...
      /**
        * Received Subscription ID info type.
        * This structure represents information embedded in the msg_control 
        * parameter when the IP_RECVSUBID socket option is set.
        * The cmsg header level is set to QDS_LEVEL_IP and the type to 
        * QDS_IP_RECVSUBID to indicate this payload.
        * See the RecvMsg API documentation for how to extract 
        * this info from msg_control parameter using utility macros.
        */
      struct RecvSubidInfoType {
         unsigned int subs_id; /**< Subscription ID */
      };
   };
};
