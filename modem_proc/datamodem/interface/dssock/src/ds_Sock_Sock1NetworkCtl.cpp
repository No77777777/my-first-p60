...
$Header: //components/rel/data.mpss/3.5..2.1/interface/dssock/src/ds_Sock_Sock1NetworkCtl.cpp#2 $
...
#define DS_SOCK1_ASSERT(expression) \
         ds_sock1_assert_wrapper(__LINE__, expression)
...
===========================================================================*/
static void ds_sock1_assert_wrapper
(
