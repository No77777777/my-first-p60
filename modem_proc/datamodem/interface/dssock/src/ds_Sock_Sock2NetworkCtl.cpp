...
$Header: //components/rel/data.mpss/3.5..2.1/interface/dssock/src/ds_Sock_Sock2NetworkCtl.cpp#2 $
...
#define DS_SOCK2_ASSERT(expression) \
         ds_sock2_assert_wrapper(__LINE__, expression)
...
===========================================================================*/
static void ds_sock2_assert_wrapper
(
