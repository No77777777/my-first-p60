...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dssock/src/ds_Sock_SocketIPSec.cpp#2 $
...
#define DS_SOCK_IPSEC_ASSERT(expression) \
         ds_sock_ipsec_assert_wrapper(__LINE__, expression)
...
===========================================================================*/
static void ds_sock_ipsec_assert_wrapper
(
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_SOCK_IPSEC_ASSERT( 2 >= ipsecInfoPtr->iface_cnt);
