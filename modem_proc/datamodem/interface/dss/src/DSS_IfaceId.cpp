...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_IfaceId.cpp#2 $
  ...
  dss_iface_id_type* pIfaceId)
{
  ...
  DS_INTERFACE_LOG_MSG_INFO1_2(PS_LOGGING_CAT_DSNET,
	                        "DSSIfaceId::BuildIfaceId: "
                            "iface id 0x%p, ids network 0x%p",
                            pIfaceId, pIDSNetwork);
  ...
  dss_iface_id_type* pIfaceId)
{
  ...
  LOG_MSG_FUNCTION_ENTRY_2 ("DSSIfaceId::BuildIfaceId: "
                            "iface id 0x%p, network ptiv policy 0x%p",
                            pIfaceId, pIDSNetworkPolicyPriv);
