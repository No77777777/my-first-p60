...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_Conversion.h#2 $
...
namespace DSSConversion
{
   ...
   // Translate a dss_iface_ioctl_dpd_ping_config_type into a dpdPingConfigType.
   AEEResult DS2IDSDpdPingConfig(dss_iface_ioctl_dpd_ping_config_type* pDpdConfig, ds::Net::dpdPingConfigType* pIDSDpdConfig);
   ...
   // Translate a dss_iface_ioctl_set_silent_redial_type into a _3GPPSetSilentRedialStruct
   ...
   // Translate a MSISDNType into a dss_iface_msisdn_info_type.
   AEEResult IDS2DSMSISDN(ds::Net::MSISDNType* pMSISDN, dss_iface_msisdn_info_type* pGetMSISDN);
   // Translate a NetworkOpReservedPcoListType into a dss_iface_op_reserved_pco_list_type.
   AEEResult IDS2DSOpResPcoList(ds::Net::NetworkOpReservedPcoListType* popReservedPcoList, dss_iface_op_reserved_pco_list_type* pGetOpResPcoList);
