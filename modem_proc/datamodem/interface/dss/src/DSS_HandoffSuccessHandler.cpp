...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_HandoffSuccessHandler.cpp#3 $
...
void DSSHandoffSuccessHandler::EventOccurred()
{
   ...
   if (mpHandlerDataClone->mpEventData->bReg) {
      ...
      eventInfo.handoff_info.ancillary_info.ancillary_info_mask =
        (ps_iface_handoff_ancillary_info_mask_enum_type)handoffinfo.ancillary_info.mask;
