...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_MemoryManagement.cpp#3 $
  $DateTime: 2020/01/16 03:14:12 $$Author: pwbldsvc $
...
#define EVENT_HANDLER_NUM_BUF                                           96 
