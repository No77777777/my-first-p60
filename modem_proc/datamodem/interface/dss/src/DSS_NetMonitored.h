...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_NetMonitored.h#3 $
...
class DSSDpdPingStatHandler;
class DSSPhysLinkPacketDiscardHandler;
...
//-------------------------------------------------------------------
    ...
    AEEResult GetPathMtu(dss_iface_ioctl_mtu_type* pMtu);
   ...
   AEEResult StartDpdPing(dss_iface_ioctl_dpd_ping_config_type* pDpdPingConfig);
//   AEEResult GetDpdPingStat(dss_iface_dpd_ping_stat_info_type * pDpdPingStat);
   ...
   AEEResult GetMSISDN(dss_iface_msisdn_info_type* pGetMSISDN);
   AEEResult GetOpResPcoList(dss_iface_op_reserved_pco_list_type* pGetOpResPcoList);
   AEEResult InitDPDcheck(void);
   AEEResult IsDefaultPhysLink(int32 physLinkHandle, boolean *isDefaultPhysLink);
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------
  protected:
      ...
      DSSDpdPingStatHandler     *mpDpdPingStatHandler;
      DSSPhysLinkPacketDiscardHandler *mpPhysLinkPacketDiscardHandler;
      boolean mPPPIsOpen;
