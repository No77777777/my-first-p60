...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_Globals.cpp#2 $
...
#define DSS_GLOBALS_ASSERT(expression) \
         dss_globals_assert_wrapper(__LINE__, expression)

/*===========================================================================

FUNCTION dss_globals_assert_wrapper()
...
===========================================================================*/
static void dss_globals_assert_wrapper
(
...
bail:
    LOG_MSG_ERROR_2("DSSGlobals::CreateTempDSSNetMonitored(): "
...
bail:
   LOG_MSG_INFO1_2("DSSGlobals::InsertNetApp(): "
                   "NetApp 0x%p NetApp handle %d", pNetApp, netAppDescriptor);
...
bail:
   LOG_MSG_ERROR_2("DSSGlobals::InsertSocket(): "
                   "socket 0x%p, socket descriptor %d",
...
AEEResult DSSGlobals::AddFilterRegObjectToList(IIPFilterRegPriv* filterReg, dss_iface_id_type iface_id, sint15 sockfd)
{
   ...
   newFilterRegInfo->next_ptr = mFilterRegInfoList;
