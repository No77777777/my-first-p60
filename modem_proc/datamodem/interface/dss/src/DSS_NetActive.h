...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_NetActive.h#2 $
...
//-------------------------------------------------------------------
   ...
   AEEResult GetNetRanAsstManager(ds::Net::IRanAsstMediaAdaptManager** ppNetRanAsstManager);
   AEEResult SetNetRanAsstManager(ds::Net::IRanAsstMediaAdaptManager* pNetRanAsstManager);
   ...
   AEEResult AddRanAsstMediaAdaptReq(
   ...
   AEEResult GetNetRanAsstMediaAdaptReq(
    ds::Net::IRanAsstMediaAdaptReqType**  pRanAsstReq,
    sint15                                handle
    );

   AEEResult RemoveRanAsstMediaAdaptReq
    (
      sint15                                handle
    );
   /*

   AEEResult CheckRanAsstSpecMatch(
     ds::Net::IRanAsstManager*     pRanAsstManager,
     uint32                        ranAsstMaHandle,
     dss_iface_ioctl_event_cb      cback_fn,
     void*                         user_data,
     dss_iface_id_type             ifaceId);
   */
   ...
   AEEResult AddQoSNetInitiated(
      ...
      dss_iface_ioctl_fltr_match_dir_type* pFltrMatchDir);
...
//-------------------------------------------------------------------
  protected:
      ...
      ds::Net::IRanAsstMediaAdaptManager*    mpDSRanAsstManager; 
      DSSRanAsstMediaAdaptReq*               mpDSSRanAsstReqList;
   ...
   private:
      DSSQoSNetInitiated* GetDSSQoSNetInitiated(ds::Net::IQoSNetInitiated* pQoSNetInitiated, 
                                                DSSQoSNetInitiatedReq* pDSSQoSNetInitiatedReq);
