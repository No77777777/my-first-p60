...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_QoSModifyHandler.cpp#2 $
...
void DSSQoSModifyHandler::EventOccurred()
{
   ...
   if (mpHandlerDataClone->mpEventData->bReg)
   {
      ...
      LOG_MSG_INFO1_4("DSSQoSModifyHandler::EventOccurred(): "
      ...
      bail:
      LOG_MSG_ERROR_2("DSSQoSModifyHandler::EventOccurred(): "
