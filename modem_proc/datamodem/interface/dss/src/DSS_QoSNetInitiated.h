...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_QoSNetInitiated.h#2 $
...
//-------------------------------------------------------------------
    ...
    inline dss_iface_ioctl_fltr_match_dir_type GetFltrMatchDir()
    {
       return mFltrMatchDir;
    }

    void SetFltrMatchDir(dss_iface_ioctl_fltr_match_dir_type fltrMatchDir)
    {
...
//-------------------------------------------------------------------
  protected:
     ...
     // Store matched filter direction
     dss_iface_ioctl_fltr_match_dir_type mFltrMatchDir;
  public :
