...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_EventHandler.h#3 $
...
protected:
   ...
   typedef enum {
      ...
      EVENT_HANDLER_PHYS_LINK_RAN_ASST_MEDIA_ADAPT = 34,
      EVENT_HANDLER_DPD_PING_STAT                  = 35,
      EVENT_HANDLER_PHYS_LINK_PACKET_DISCARD       = 36
   }EventType;
