...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_HandoffFailureHandler.cpp#3 $
  $DateTime: 2019/12/23 22:43:04 $
  $Author: pwbldsvc $
...
void DSSHandoffFailureHandler::EventOccurred()
{
   ...
   if (mpHandlerDataClone->mpEventData->bReg) {
      ...
      eventInfo.handoff_info.ancillary_info.ancillary_info_mask =
        (ps_iface_handoff_ancillary_info_mask_enum_type)handofffailureinfo.ancillary_info.mask;
