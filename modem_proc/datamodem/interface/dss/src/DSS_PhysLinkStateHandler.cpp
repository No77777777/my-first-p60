...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_PhysLinkStateHandler.cpp#2 $
...
void DSSPhysLinkStateHandler::EventOccurred()
{
  ...
  if (mpHandlerDataClone->mpEventData->bReg)
  {
    ...
    if (AEE_SUCCESS != res)
    {
      dss_error_code = DSS_ERROR_GET_PHYSLINK_FAILED;
      goto bail;
    }
    ...
    bail:
    LOG_MSG_ERROR_2("DSSPhysLinkStateHandler::EventOccurred(): "
