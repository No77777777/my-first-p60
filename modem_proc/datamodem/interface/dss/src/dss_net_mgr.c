...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/dss_net_mgr.c#2 $
...
#define DSS_NET_MGR_CB_BUF_NUM        DSS_PING_MAX_PING_SESSIONS + DSS_DNS_MAX_SESSIONS
#define DSS_NET_MGR_CB_BUF_HIGH_WM    DSS_PING_MAX_PING_SESSIONS + DSS_DNS_MAX_SESSIONS - 2
...
#define DSS_NETMGR_ASSERT(expression) \
         dss_netmgr_assert_wrapper(__LINE__, expression)
...
===========================================================================*/
static void dss_netmgr_assert_wrapper
(
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  ps_handle_mgr_init_client( PS_HANDLE_MGR_CLIENT_RAN_ASST_DSS,
                             10,
                             0,
                             0);
