...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/DSS_IPv6PrefixChangedStateHandler.cpp#2 $
  $DateTime: 2019/10/22 02:53:17 $$Author: pwbldsvc $

  when       who what, where, why
  ---------- --- ------------------------------------------------------------
  2015-06-22 pg  Fixed Prefix kind issue.
...
AEEResult DSSIPv6PrefixChangedStateHandler::RegisterIDL()
{
   ...
   LOG_MSG_INFO1_1("DSSIPv6PrefixChangedStateHandler::RegisterIDL(): "
                   ...
                   piNetworkIPv6Priv);
   AEEResult nRet = piNetworkIPv6Priv->OnStateChange(mpSignal, IPv6PrivEvent::QDS_EV_PREFIX_CHANGED, &pRegObj);
