...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/dss_stubs.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define DSS_STUBS_PERROR_NO_FEAT(api, feat)                         \
  LOG_MSG_ERROR_0(#api": "#feat"+DATA_PS feature turned off."       \
                  "Returning error.")
