...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/src/ps_sock_mem_pool.cpp#2 $
...
#define PS_META_INFO_TX_BUF_NUM    125
...
----------------------------------------------------------------------------*/
static ps_mem_buf_hdr_type   * ps_tx_meta_info_buf_hdr[PS_META_INFO_TX_BUF_NUM];
static ps_tx_meta_info_type  * ps_tx_meta_info_buf_ptr[PS_META_INFO_TX_BUF_NUM];
