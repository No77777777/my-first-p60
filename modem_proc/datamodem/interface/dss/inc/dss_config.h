...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dss/inc/dss_config.h#2 $
...
/* 6 simultaneous ping sessions on single sim can be a requirement
   and so increasing it to 12 for dual sim  scenario */
#define DSS_PING_MAX_PING_SESSIONS (12)
