...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsprofile/src/ds_util.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
  ...
  /*DS_PROFILE_LOGD("Debug: New Node created 0x%x", node);*/
  ...
  /*DS_PROFILE_LOGD("Debug: New Node->data created 0x%x", node->data);*/
...
)
{
  ...
  if (node_ptr) 
  {
    DS_PROFILE_LOGD("Debug: Removing Node_Ptr 0x%x", node_ptr);
    if (node_ptr->data)
    {
