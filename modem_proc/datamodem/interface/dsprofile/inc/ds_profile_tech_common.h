...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsprofile/inc/ds_profile_tech_common.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  */
  ...
  /* 
	 Delete a attach Profile
         tech - technology
   	 num - profile number to be deleted
  */
  ds_profile_status_etype (*del_attach)(
    ds_profile_tech_etype tech,
    ds_profile_num_type  num, 
    ds_profile_subs_etype subs
  );
