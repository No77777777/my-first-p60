...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/qmicore/inc/ds_qmuxi.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef struct qmi_port_request_s
{
  ...
  struct qmi_port_request_s * next_ptr;
...
typedef struct
{
  ...
  uint64                port_open_ts;    /* Port open timestamp */
  uint32                rx_pkt_cnt;
  uint32                tx_pkt_cnt;
} qmux_state_type;
...
/*===========================================================================
  FUNCTION QMUXI_IS_SERVICE_REGISTERED()
...
/*===========================================================================
  FUNCTION QMUXI_GET_SVC_INFO_PER_CLID()
  ...
  PARAMETERS
    ...
    svc_type : Service type
    clid : client id
    svc_info : Out Parameter, service info
