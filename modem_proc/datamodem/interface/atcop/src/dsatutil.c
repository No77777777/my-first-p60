...
$Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/src/dsatutil.c#4 $ $DateTime: 2020/08/25 05:57:04 $ $Author: pwbldsvc $
...
)
{
  ...
  else
  {
    ...
    fs_status = mcfg_fs_write(file_path,
                              (byte*)buf,
                              sizeof(char),
                              MCFG_FS_O_CREAT,
                              MCFG_FS_ALLPERMS,
  ...
  DS_AT_MSG1_HIGH("File operation result code: %d",result_code.result_code);
}
