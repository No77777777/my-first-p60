...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/src/dsatcmdp_ex.c#6 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/25/20   ks      Resolving MT SMS always getting routed to SIM memory by 
                   providing EFS based fix.
08/25/20   ks      Fix to align with the spec requirements for at command CGEV.
...
-------------------------------------------------------------------------*/
  ...
  for (apps_id = DSAT_APPS_ID_GW_PRIMARY; apps_id < DSAT_APPS_ID_GW_MAX; apps_id++)
  {
