...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  ...
  Copyright (c) 2004 - 2021 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/src/dsatme_ex.c#4 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/13/21   asa     Fixed +CPOL query when preferred PLMNs exceed 102
      ...
      break;
        ...
        if (IS_VALID_GW_APPS_ID(apps_id))
        {
          ...
          switch (perso_event)
          {
            ...
            if ( dsatme_pending_mmgsdi_command[apps_id].is_pending )
            {
