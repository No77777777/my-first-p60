...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/src/dsatctab_ex.c#5 $ $DateTime: 2020/08/24 10:46:49 $ $Author: pwbldsvc $
...
dsat_pending_cmd_s_type dsatme_pending_mmgsdi_command[DSAT_APPS_ID_MAX - 1];
