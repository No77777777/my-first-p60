...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/inc/dsati.h#7 $ $DateTime: 2021/12/07 00:10:50 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/13/21   asa     Increased size of MMGSDI buffer to accomodate increased 
                   no. of PLMN's
...
#define MAX_MMGSDI_BUFFER_LEN  1024
...
/*===========================================================================
 FUNCTION DSATUTIL_EFS_EXIST_FILE_WRITE
 
 DESCRIPTION
   Write to the EFS file if it already exists. File won't be created if it's
   not present.
 ...
 SIDE EFFECTS
   None.
 ===========================================================================*/
void dsatutil_efs_exist_file_write
(
...
void *dsatutil_get_base_addr_current_slot(void);
...
void *dsatutil_get_base_addr_current_session(void);
