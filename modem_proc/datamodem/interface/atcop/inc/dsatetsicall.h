...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/inc/dsatetsicall.h#3 $ $DateTime: 2020/01/09 01:30:00 $ $Author: pwbldsvc $
...
/* This flag is added to handle scenario for waiting call and AT+CHLD is issued */
  boolean was_waiting_call_connected;
