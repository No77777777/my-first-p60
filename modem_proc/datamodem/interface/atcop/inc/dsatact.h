...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/atcop/inc/dsatact.h#3 $ $DateTime: 2021/02/12 10:11:56 $ $Author: pwbldsvc $
...
boolean dsatact_is_sequence_number_available(void);
