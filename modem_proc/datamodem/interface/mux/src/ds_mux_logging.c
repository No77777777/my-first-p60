...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/mux/src/ds_mux_logging.c#2 $ 
...
"SSR SHUT DOWN",/*Index : DS_MUX_LOGGING_SSR_SHUT_DWN_RECV*/
"SSR POWER UP",/*Index : DS_MUX_LOGGING_SSR_PWR_UP_RECV*/
};
