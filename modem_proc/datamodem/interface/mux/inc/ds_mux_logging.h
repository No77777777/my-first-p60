...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/mux/inc/ds_mux_logging.h#2 $
...
typedef enum
{
  ...
  DS_MUX_LOGGING_SSR_SHUT_DWN_RECV  = 17,
  DS_MUX_LOGGING_SSR_PWR_UP_RECV    = 18,

  //This should be last
  DS_MUX_LOGGING_STATE_MAX          = 19
