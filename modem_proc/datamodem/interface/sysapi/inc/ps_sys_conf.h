...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/sysapi/inc/ps_sys_conf.h#3 $ $DateTime: 2024/05/06 04:25:26 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  */
  ...
  PS_SYS_CONF_3GPP_LTE_CELL_INFO  = DS_SYS_CONF_3GPP_LTE_CELL_INFO,
  /**< 
       @see DS_SYS_CONF_3GPP_LTE_CELL_INFO
  */
  
  PS_SYS_CONF_3GPP_PS_DATA_AVAIL_APPL_SERVICE_INFO = DS_SYS_CONF_3GPP_PS_DATA_AVAIL_APPL_SERVICE_INFO,
  /**<       
       @see DS_SYS_CONF_3GPP_PS_DATA_AVAIL_APPL_SERVICE_INFO.
  */
  ...
  */
  ...
  PS_SYS_CONF_MODEM_ASST_KEEP_ALIVE_CONFIG = PS_SYS_CONF_3GPP_INTERNAL_MIN + 1,
  /**< 
        Configuration is set by QMI for Appsrv to start/stop the modem assisted 
        keep alive timer. It will result in generation of 
  */
  
  PS_SYS_CONF_3GPP_BACKGROUND_TRAFFIC_INFO = PS_SYS_CONF_3GPP_INTERNAL_MIN + 2,
  /**< 
        Configuration is set by 3GPP mode handler whenever the background traffic            status changes.
  */
  ...
  */
   ...
   */
   ...
   PS_SYS_CONF_DL_THROUGHPUT_INTERVAL_STATUS_CHANGE    = DS_SYS_CONF_DL_THROUGHPUT_INTERVAL_STATUS_CHANGE,
   /**<
  ...
  */
  ...
  PS_SYS_CONF_APN_INFO                    = DS_SYS_CONF_APN_INFO,
  /**< 
        @see DS_SYS_CONF_APN_INFO
  ...
  */
  ...
  PS_SYS_CONF_RAT_PREFERENCE              = DS_SYS_CONF_RAT_PREFERENCE,
  /**< 
        This configuration is set by the tethered application once on boot up
        and when there is a change in the UI settings. This conveys the rat
        preference related information.
  */

   PS_SYS_CONF_UL_THROUGHPUT_CONFIG  = DS_SYS_CONF_UL_THROUGHPUT_CONFIG,
   /**<
       @see DS_SYS_CONF_UL_THROUGHPUT_CONFIG
   */

   PS_SYS_CONF_UL_THROUGHPUT_INTERVAL_STATUS_CHANGE   = DS_SYS_CONF_UL_THROUGHPUT_INTERVAL_STATUS_CHANGE,
   /**<
       @see DS_SYS_CONF_UL_THROUGHPUT_INTERVAL_STATUS_CHANGE
   */

   PS_SYS_CONF_UL_THROUGHPUT_INFO   = DS_SYS_CONF_UL_THROUGHPUT_INFO,
   /**<
  ...
  */  
  ...
  PS_SYS_CONF_DATA_SERVICE_SETTING   = DS_SYS_CONF_DATA_SERVICE_SETTING,
  /**<
      @see DS_SYS_CONF_DATA_SERVICE_SETTING
  */ 

  PS_SYS_CONF_DATA_SERVICE_ROAMING_SETTING = DS_SYS_CONF_DATA_SERVICE_ROAMING_SETTING,
  /**<
      @see DS_SYS_CONF_DATA_SERVICE_ROAMING_SETTING
  */

  PS_SYS_CONF_EMERGENCY_CALL_APN_TYPE = DS_SYS_CONF_EMERGENCY_CALL_APN_TYPE,
 /**
      @see DS_SYS_CONF_EMERGENCY_CALL_APN_TYPE
  */  
  ...
  */
  ...
  PS_SYS_CONF_UL_DL_THROUGHPUT_INFO_FREQ      = PS_SYS_CONF_COMMON_INTERNAL_MIN + 2,
  /**< 
        This configuration is set by the external applications and used to request
        the rate at which uplink/downlink throughput info is generated.
  */

  PS_SYS_CONF_UL_DL_THROUGHPUT_INFO      = PS_SYS_CONF_COMMON_INTERNAL_MIN + 3,
  /**< 
        This configuration is set by the MH to generate uplink/downlink
        throughput information
  */

  PS_SYS_CONF_CONFIGURED_UL_DL_THROUGHPUT_INFO  = PS_SYS_CONF_COMMON_INTERNAL_MIN + 4,
  /**< 
        This configuration is set by the MH to generate configured
        throughput information
  */

  PS_SYS_CONF_MODEM_POWER_STATS_CONFIGURATION  = PS_SYS_CONF_COMMON_INTERNAL_MIN + 5,
  /**<       
  ...
  */
  ...
  PS_SYS_CONF_QUERY_MODEM_POWER_STATS  = PS_SYS_CONF_COMMON_INTERNAL_MIN + 6,
  /**<       
  ...
  */
  ...
  PS_SYS_CONF_MODEM_POWER_STATISTICS   = PS_SYS_CONF_COMMON_INTERNAL_MIN + 7,
  /**<       
       Configuration is set by Ds3g to specify the current power statistics of the
       modem. This is ready by QMI.
  */

  PS_SYS_CONF_REMOTE_SOCKET_SERVICE_AVAIL  = PS_SYS_CONF_COMMON_INTERNAL_MIN + 8,
  /**< 
  ...
  */
  ...
  PS_SYS_CONF_THROUGHPUT_REPORTING_INTERVAL = PS_SYS_CONF_COMMON_INTERNAL_MIN + 9,
  /**< 
       Configure the throughout reporting interval value. Set by the AP to request
       the lower layers to send UL and DL throughput reporting. Range needs to be
       between 100 ms and 1000 ms.
  */
  
  PS_SYS_CONF_IMSI_PUBLIC_KEY_INFO = PS_SYS_CONF_COMMON_INTERNAL_MIN + 10,
  /**< 
       Configure the IMSI public key information sent from AP. It will result in
       generation of PS_SYS_EVENT_UPDATED_IMSI_PUBLIC_KEY.
  */

  PS_SYS_CONF_APN_INFO_RESET = PS_SYS_CONF_COMMON_INTERNAL_MIN + 11,
  /**< 
       This configuration is internal to the framework. Other entities should NOT use it.
       It clears all APN info and update EFS file when NV refresh event is received.
  */
  
  PS_SYS_CONF_UL_THRPUT_ACTUAL_THRES_CRITERIA   = PS_SYS_CONF_COMMON_INTERNAL_MIN + 12,
  /**< 
        Configuration is set by MH for actual uplink throughput threshold criteria of 
        the preferred/current RAT. PS_SYS_EVENT_UL_THRPUT_ACTUAL_THRES_CRITERIA will be 
        triggered to clients when this configuration is set.
  */
  PS_SYS_CONF_DL_THRPUT_ACTUAL_THRES_CRITERIA   = PS_SYS_CONF_COMMON_INTERNAL_MIN + 13,
  /**< 
        Configuration is set by MH for actual downlink throughput threshold criteria of 
        the preferred/current RAT. PS_SYS_EVENT_DL_THRPUT_ACTUAL_THRES_CRITERIA will be 
        triggered to clients when this configuration is set.
  */

  PS_SYS_CONF_AP_ASST_APN_PREF_SYS = PS_SYS_CONF_COMMON_INTERNAL_MIN + 14,
  /**< 
       This configuration is set by AP to enable APN Preferred RAT handshake mode 
       with MPPM module. MPPM module shall confirm with AP every time there
       is change in APN Preferred RAT.
  */

#ifdef QWES_FEATURE_ENABLE 
  PS_SYS_CONF_CAAS_FEATURE_ID_LIST = PS_SYS_CONF_COMMON_INTERNAL_MIN + 17,
  /**< This configuration is set by modem CAAS manager to specify the feature ID list for 
       which the status needs to be retrieved from license service. It will result in 
       generation of PS_SYS_EVENT_CAAS_FEATURE_STATUS.   */
  ...
  */
  ...
  PS_SYS_CONF_GET_WLAN_IP_ADDR        = DS_SYS_CONF_GET_WLAN_IP_ADDR,
  /**<       
       @see DS_SYS_CONF_GET_WLAN_IP_ADDR.
  */  

  PS_SYS_CONF_GET_WLAN_HESSID          = DS_SYS_CONF_GET_WLAN_HESSID,
  /**<       
  ...
  */
  ...
  PS_SYS_CONF_WIFI_SERVICE_CAP         = PS_SYS_CONF_WLAN_INTERNAL_MIN + 3,
  /**<       
...
/**
  @brief Reporting Interval timer for throughput information
   
  @see   PS_SYS_CONF_THROUGHPUT_REPORTING_INTERVAL
  @see   PS_SYS_EVENT_THROUGHPUT_REPORTING_INTERVAL_CHANGE
*/
typedef uint32  ps_sys_conf_throughput_reporting_interval_type;

/**
  @brief APN type for emergency call
   
  @see   PS_SYS_CONF_EMERGENCY_CALL_APN_TYPE
*/
typedef ds_sys_conf_emer_call_apn_type ps_sys_conf_emer_call_apn_type;
...
#ifdef QWES_FEATURE_ENABLE 
/**
  @brief  This function resets the  configuration cache
  ...
  @return None
*/
void ps_sys_confi_reset_configuration
(
  ps_sys_conf_enum_type              conf_name,
  ps_sys_subscription_enum_type      subscription_id
);
