...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/sysapi/inc/ps_sys_conf_parser.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define PS_SYS_CONF_PARSER_MAX_FILE_BUFFER_SIZE  1100 //Increase as per needed  //Increase as per needed
...
typedef enum
{
   ...
   PS_SYS_CONF_PARSER_EFS_RAT_PREFERENCE,
