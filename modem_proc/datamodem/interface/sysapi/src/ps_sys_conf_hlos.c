...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/sysapi/src/ps_sys_conf_hlos.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $ 
...
bail:
  DS_UTILS_ERROR_FATAL("ps_sys_confi_alloc_temp_data() : Mem alloc failed");
  return;
