...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/sysapi/src/ps_sys_eventi.h#3 $ $DateTime: 2024/05/06 04:25:26 $ $Author: pwbldsvc $
...
typedef union
{
  ...
  ps_sys_event_3gpp_lte_attach_params_ex_type  lte_attach_params_ex;

  ps_sys_pco_info_per_apn_type                 apn_pco_info;

  ps_sys_msisdn_info_per_apn_type              apn_msisdn_info;

  ps_sys_wwan_conn_state_type                  wwan_conn_state;

  ps_sys_remote_socket_request_type            remote_socket_request;

  ps_sys_event_switch_dds_type                 switch_dds;

  ps_sys_current_dds_type                      dds;

  ps_sys_policyman_msg_info_type               policyman_msg;

  ps_sys_3gpp_rab_reject_info_type             rab_reject_info;

  ps_sys_event_modem_asst_ka_status_info_type  modem_keepalive_info;

  ps_sys_imsi_public_key_info_type             imsi_public_key_info;

  ps_sys_event_imsi_public_key_retrieve_info   imsi_public_key_retrieve_info;

  ps_sys_event_3gpp_lte_attach_pdn_list_action_result  attach_pdn_list_action_result;

  ps_sys_ul_thrput_actual_thres_criteria_type  ul_thrput_actual_thres_criteria;

  ps_sys_dl_thrput_actual_thres_criteria_type  dl_thrput_actual_thres_criteria;

  ps_sys_event_ca_cert_retrieval_support       ca_cert_retrieval_support_info;

  ps_sys_event_get_ca_certificate              get_ca_cert_info;
  
  ps_sys_ps_data_avail_type                      data_off_info;

  ps_sys_ap_asst_apn_pref_sys_type ap_asst_mode_info;
  
  ps_sys_event_ap_asst_apn_pref_sys_change_req_type    apn_pref_sys_change_info;
  
  ps_sys_event_ap_asst_apn_pref_sys_result_type ap_asst_apn_pref_sys_result_info;
  #ifdef QWES_FEATURE_ENABLE
  ps_sys_caas_feature_status_list_type       feature_status_list;
  
  ps_sys_event_qteels_avail_info_type        qteels_avail_info; 

  ps_sys_event_sync_complete_broadcast_type  sync_complete_broadcast_info;

  ps_sys_event_qwes_nack_info_type           qwes_nack_info;
