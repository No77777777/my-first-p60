...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/sysapi/src/ps_sys_fast_dormancy.c#3 $ $DateTime: 2021/02/09 01:09:33 $ $Author: pwbldsvc $
...
{  
  ...
  timer_type = (ps_sys_fast_dormancy_enum_timer_type)(uint32) cb_data;
