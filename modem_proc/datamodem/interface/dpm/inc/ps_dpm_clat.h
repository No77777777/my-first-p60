...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dpm/inc/ps_dpm_clat.h#2 $
...
typedef uint32 ps_dpm_clat_hw_handle_type;
...
typedef enum
{
  ...
  PS_DPM_CLAT_EV_PDN_CONTEXT_DEREGISTERED = 4,
  PS_DPM_CLAT_EV_PDN_CONTEXT_DEREGISTRATION_FAILED = 5,
  PS_DPM_CLAT_EV_MAX
...
/**
  @brief PDN specific clat dereg info
*/
typedef struct
{
  ps_iface_type                    * iface_ptr;
  void                             * client_pdn_handle;
} ps_dpm_clat_dereg_pdn_cntxt_info_type;
...
typedef struct
{
  ...
  uint8                               v6_dev_addr_prefix_len;
  void                              * client_pdn_handle;
  ps_dpm_clat_hw_handle_type          hw_pdn_handle;
  void                              * hw_v6_addr_handle;
  boolean                             is_stream_id_associated;
...
/** @ps_dpm_clat_dereg_pdn_context
  ...
  This function deregisters CLAT PDN context

  @datatypes
  dereg_info_ptr : clat dereg info ptr
