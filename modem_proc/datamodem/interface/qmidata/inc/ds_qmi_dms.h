...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/qmidata/inc/ds_qmi_dms.h#3 $ $DateTime: 2022/09/13 23:09:36 $ $Author: pwbldsvc $
...
/*===========================================================================
  ...
  SIDE EFFECTS
    None
===========================================================================*/
boolean qmi_dms_is_inited( void );
...
/*===========================================================================
  FUNCTION QMI_DMS_GENERATE_DEVICE_STATUS_IND()

  DESCRIPTION
    Called when CM notifies us that the device initialization status
    has changed.
  ...
  PARAMETERS
    ...
    is_gps_init_completed: whether or not GPS is initialized
