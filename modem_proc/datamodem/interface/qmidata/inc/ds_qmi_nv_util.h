...
$Header: //components/rel/data.mpss/3.5..2.1/interface/qmidata/inc/ds_qmi_nv_util.h#2 $
...
typedef enum qmi_nv_item_e {
  ...
  **  consistency with the legacy NV API.                                   **
  ...
  QMI_NV_ITEM_RMNET_RX_WMK_THRESHOLD,      /* pending | rmnet_rx_wmk_limitst_s_type */
