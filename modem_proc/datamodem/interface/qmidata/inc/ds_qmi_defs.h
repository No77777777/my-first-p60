...
Copyright (c) 2005-2014, 2017 Qualcomm Technologies Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/qmidata/inc/ds_qmi_defs.h#3 $ $DateTime: 2023/03/20 00:18:48 $ $Author: pwbldsvc $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
04/04/17    rg     Added support for reporting throttled pdn info event.
...
typedef enum
{
  ...
  /* 73 was used for QMI-WDS and can be re-used */
  ...
  QMI_CMD_WDS_POLICY_REFRESH_STATUS_EVT = 150,
  QMI_CMD_WDS_POLICY_READY_EVT          = 151,
  QMI_CMD_WDS_UL_DL_THRPT_INFO_EVT     = 152,
  QMI_CMD_WDS_CONFIGURED_THRPT_INFO_EVT = 153,
  QMI_CMD_DMS_POWER_STATISTICS_EVT    = 154,
  QMI_CMD_WDS_DL_THRPT_REPORTING_STATUS_EVT  = 155,
  QMI_CMD_SET_UI_STATUS_RESP   = 156,
  QMI_CMD_WDS_LTE_ATTACH_PARAMS_EVT   = 157,
  QMI_CMD_WDS_APN_PCO_LIST_EVT   = 158,
  QMI_CMD_WDS_APN_MSISDN_EVT     = 159,
  QMI_CMD_WDS_3GPP_RAB_REJECT_EVT = 160,
  QMI_CMD_WDS_PDN_THROTTLE_INFO_EVT   = 161,
  QMI_CMD_WDS_MODEM_KEEP_ALIVE_STATUS_EVT = 162,
  QMI_CMD_AUTH_RETRIEVE_IMSI_PUBLIC_KEY = 163,
  QMI_CMD_AUTH_IMSI_PUBLIC_KEY_RESP    = 164,
  QMI_CMD_WDS_LTE_ATTACH_PDN_LIST_ACTION_RESULT_EVT = 165,
  QMI_CMD_AUTH_RETR_CA_CERT_EVT       = 166,
  QMI_CMD_AUTH_CA_CERT_PROCESS_INTERNAL    = 167,
  QMI_CMD_WDS_RAN_ASST_INFO_REG_EVT    = 168,
  QMI_CMD_QOS_GENERATE_QOS_FLOW_IND       = 169,
  QMI_CMD_MAX
} qmi_cmd_id_e_type;
