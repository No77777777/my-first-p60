...
Copyright (c) 2004-2015 by Qualcomm Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/qmidata/inc/ds_qmi_wds.h#3 $ $DateTime: 2023/01/31 01:40:24 $ $Author: pwbldsvc $
...
/*---------------------------------------------------------------------------
  Array index for call status callback
---------------------------------------------------------------------------*/
typedef enum
{
  QMI_WDS_CALL_STATUS_TYPE_MIN = -1,
  QMI_WDS_CALL_STATUS_TYPE_QOS = 0,
  QMI_WDS_CALL_STATUS_TYPE_DFC = 1,
  QMI_WDS_CALL_STATUS_TYPE_MAX
} qmi_wds_call_status_e_type;
...
#define QMI_WDS_MASK_OP_RES_PCO_LIST  (0x80000)
#define QMI_WDS_MASK_MSISDN_INFO      (0x100000)
...
(
  ...
  qmi_wds_call_status_e_type     call_status_type
);
...
/*===========================================================================
  FUNCTION QMI_WDS_IS_PROFILE_READY ()
 
  DESCRIPTION
    Query for profile ready status based on subscription.
  ...
  SIDE EFFECTS
    None
 ==========================================================================*/
boolean qmi_wds_is_profile_ready
(
  uint32              subs_id
);
