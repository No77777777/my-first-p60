...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/qmidata/inc/ds_qmi_if.h#3 $
...
typedef struct
{
  ...
  boolean inited;
  boolean                 otksl_valid;
  boolean                 prl_info_valid[QMI_IF_AS_ID_MAX];
...
/*===========================================================================
FUNCTION  qmi_if_mmgsdi_reg

DESCRIPTION
  To register for MMGSDI events

DEPENDENCIES
  DMS service should be initalized
...
/*===========================================================================
FUNCTION  QMI_IF_GET_CURRENT_MODE_PER_SUBS
DESCRIPTION
  to get the current mode per subscription id.

DEPENDENCIES
  None

RETURNS
 Returns the mode per subscription id.

SIDE EFFECTS
  None
===========================================================================*/
qmi_if_mode_e_type qmi_if_get_current_mode_per_subs
(
...
/*===========================================================================
FUNCTION  QMI_IF_GET_CURRENT_CDMA_SUB_ID

DESCRIPTION
  to get the current cdma subscription id.

DEPENDENCIES
  None

RETURNS
 Returns the cdma subscription id.

SIDE EFFECTS
  None

===========================================================================*/
qmi_if_asubs_id_type qmi_if_get_current_cdma_sub_id
(
  void
);
