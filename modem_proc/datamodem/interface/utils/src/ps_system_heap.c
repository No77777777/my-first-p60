...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ps_system_heap.c#2 $
...
#error code not present
  ...
  DS_UTILS_ERROR_FATAL("ps_system_heap_deinit(): Not supported!");
...
#error code not present
  ...
  DS_UTILS_ERROR_FATAL("ps_system_heap_get_alloc_buf_count(): Not supported!");
  return 0;
