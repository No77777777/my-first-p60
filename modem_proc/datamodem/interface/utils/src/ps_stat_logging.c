...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ps_stat_logging.c#3 $
  $Author: pwbldsvc $
  $DateTime: 2021/02/26 14:44:01 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  *desc_ptr = hget64(request_ptr);
  ...
  DS_UTILS_ASSERT(NULL != return_ptr);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    if ((inst_info_ptr->type <= PS_STAT_MODULE_MAX) && 
	(NULL != reset_stat_cback_arr[inst_info_ptr->type]))
    {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO4_3("ps_stat_logging_inst_update_desc(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  switch (log_pkt_type)
  {
    ...
    default:
      DS_UTILS_ERROR_FATAL("ps_stat_logging_get_log_pkt(): Invalid log type passed in to GET_LOG_PKT");
      break;
  }
