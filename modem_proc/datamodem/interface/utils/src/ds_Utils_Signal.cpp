...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ds_Utils_Signal.cpp#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO3_1 ("Signal::Destructor(): Obj 0x%p", this);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO3_2 ("Signal::Set(): signal 0x%p, state %d", this, mSigState);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO3_2 ("Signal::Enable(): signal 0x%p, state %d", this, mSigState);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO3_2 ("Signal::Detach(): signal 0x%p, state %d", this, mSigState);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (NULL == pUserData)
  {
    DS_UTILS_ERROR_FATAL("Signal::SignalDispatcher(): NULL user data");
    return;
  }
