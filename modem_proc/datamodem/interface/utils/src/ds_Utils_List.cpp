...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ds_Utils_List.cpp#2 $
...
/*-------------------------------------------------------------------------*/
  ...
  if (0 == pListInternal)
  {
    DS_UTILS_ERROR_FATAL("List::List(): No mem for List");
  }
  ...
  if (AEE_SUCCESS != DS_Utils_CreateInstance (NULL,
                                              ...
                                              (void **) &pCritSect))
  {
    DS_UTILS_ERROR_FATAL("List::List(): Cannot create crit sect");
  }
} /* List() */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == listPtr)
  {
    DS_UTILS_ERROR_FATAL("List::CloneList(): NULL list");
    return FALSE;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == newListPtr)
  {
    DS_UTILS_ERROR_FATAL("List::Traverse(): No mem for list");
    return FALSE;
  }
