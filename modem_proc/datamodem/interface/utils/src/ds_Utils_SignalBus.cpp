...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ds_Utils_SignalBus.cpp#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO3_2 ("SignalBus::AddItem(): "
...
/*-------------------------------------------------------------------------*/
  ...
  LOG_MSG_INFO3_2 ("SignalBus::Remove(): "
