...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ps_utils_init.cpp#3 $
...
ULogHandle                   ps_fwk_ulog_hable = 0;
/*!
 * Ulog handle.
 */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_UTILS_ERROR_FATAL("Failed to create global signal crit sect");
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  /*------------------------------------------------------------------------
    Alloc ULOG handle for PS framework logging
  -------------------------------------------------------------------------*/
  if(0 == ps_fwk_ulog_hable )
  {
     ULogFront_RealTimeInit(&ps_fwk_ulog_hable,
                             "DataInterface",
                             16384,
                             ULOG_MEMORY_LOCAL,
                             ULOG_LOCK_OS);
