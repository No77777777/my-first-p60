...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ps_stat_common.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
  ...
  if (access_ptr == NULL)
  {
    DS_UTILS_ERROR_FATAL("ps_stat_get_common(): ps_stat_get:variable access_ptr should not be NULL");
    return E_NOT_ALLOWED ;
  }

  if ( stat_ptr == NULL)
  {
    DS_UTILS_ERROR_FATAL("ps_stat_get_common(): ps_stat_get:variable stat_ptr should not be NULL");
    return E_NOT_ALLOWED ;
  }
