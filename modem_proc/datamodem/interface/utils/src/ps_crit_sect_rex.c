...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/src/ps_crit_sect_rex.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_UTILS_ERROR_FATAL("ps_init_crit_section(): critical section pointer is NULL");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_UTILS_ERROR_FATAL("ps_enter_crit_section(): critical section or handle is NULL");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (NULL == crit_sect_ptr || NULL == crit_sect_ptr->handle)
  {
    DS_UTILS_ERROR_FATAL("ps_leave_crit_section(): critical section or handle is NULL");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (NULL == crit_sect_ptr || NULL == crit_sect_ptr->handle)
  {
    DS_UTILS_ERROR_FATAL("ps_destroy_crit_section(): critical section or handle is NULL");
    return;
  }
