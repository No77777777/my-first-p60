/*!
  ...
  @brief
  QSH definitions for Data Interfaces.
*/
...
#ifndef PS_UTILS_QSH_H
#define PS_UTILS_QSH_H
...
#endif /* (FEATURE_QSH_EVENT_NOTIFY_HANDLER) || (FEATURE_QSH_MDUMP) */
