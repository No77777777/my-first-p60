...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/inc/ps_handle_mgr.h#2 $
...
===========================================================================*/
#define DSS_NET_MGR_MAX_SESSIONS  (DSS_PING_MAX_PING_SESSIONS + DSS_DNS_MAX_SESSIONS)
...
typedef enum
{
  ...
  PS_HANDLE_MGR_CLIENT_DNS_RESULT       = 3,
  ...
  PS_HANDLE_MGR_CLIENT_3GPP          = 19,
  PS_HANDLE_MGR_CLIENT_3GPP_RMSM     = 20,
  PS_HANDLE_MGR_CLIENT_SOCKET_EPHEMERAL_CACHE   = 21,
  PS_HANDLE_MGR_CLIENT_MODEM_ASST_KA = 22,
  PS_HANDLE_MGR_CLIENT_RAN_ASST_MEDIA_ADAPT_TE   = 23,
  PS_HANDLE_MGR_CLIENT_RAN_ASST_DSS  = 24,
