...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/inc/ps_mem.h#2 $
...
typedef enum
{
  ...
  PS_MEM_RAN_ASST_MEDIA_ADAPT_MANAGER_TYPE   = 166,
  PS_MEM_RAN_ASST_MEDIA_ADAPT_REQUEST_TYPE   = 167,
