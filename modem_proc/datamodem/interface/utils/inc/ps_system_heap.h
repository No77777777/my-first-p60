...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/utils/inc/ps_system_heap.h#3 $
...
#define PS_SYSTEM_HEAP_MEM_ALLOC_EXT(buf_ptr,size,typecast_type) \
  buf_ptr = (typecast_type)modem_mem_alloc(size, MODEM_MEM_CLIENT_DATACOMMON); \
  ps_system_heap_validate_mem_alloc(buf_ptr, size, TRUE)

#else
#define PS_SYSTEM_HEAP_MEM_ALLOC_EXT(buf_ptr,size,typecast_type) \
  buf_ptr = (typecast_type)modem_mem_alloc(size, MODEM_MEM_CLIENT_UNCOMPRESSED_HEAP); \
  ps_system_heap_validate_mem_alloc(buf_ptr, size, TRUE)
