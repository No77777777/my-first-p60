...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/api/ps_utils_defs.h#4 $ $DateTime: 2021/10/29 00:54:48 $ $Author: pwbldsvc $

when      who     what, where, why
-------   ---     ----------------------------------------------------------
10/29/21  rj      Configure CLAT DNS64 query via NV
12/19/19  rk      Added support for NV 74313
07/07/17  gk     DHCP Class based subnet calculation
03/28/17  vls     Added support to enable/disable checkcode verification
...
static const char *ps_nv_conf_efs_path_array[] = 
{
  ...
  "/nv/item_files/datamodem/protocols/dhcp6_client_rapid_commit",
  ...
  "/nv/item_files/datamodem/protocols/cksum_offload_enable",
  "/nv/item_files/datamodem/protocols/eap_disable_alternate_identities",
  "/nv/item_files/datamodem/protocols/eap_checkcode_enable",
  "/nv/item_files/datamodem/interface/ephemeral_port_config",
  "/nv/item_files/datamodem/interface/ds_mux_config",
  "/nv/item_files/datamodem/interface/dss_ping_config",
  "/nv/item_files/modem/data/protocols/dhcp_subnetmask_calc",
  "/nv/item_files/datamodem/protocols/secssl_alert_config",  
  "/nv/item_files/datamodem/protocols/clat_dns64_query_config"
};
...
typedef enum 
{
  ...
  ,PS_NV_CONF_DHCP6_RAPID_COMMIT
  ,PS_NV_CONF_DHCP6_CLIENT_CONFIG
  ,PS_NV_CONF_ICMP6_MDM_IID_FLTR_ENABLE
  ,PS_NV_CONF_CLAT_CONFIG_INFO
  ,PS_NV_CONF_CKSUM_OFFLOAD_ENABLE
  ,PS_NV_CONF_EAP_DISABLE_ALT_ID
  ,PS_NV_CONF_EAP_CHECKCODE_ENABLE_IND
  ,PS_NV_CONF_EPHEMERAL_PORT_CONFIG
  ,PS_NV_CONF_DS_MUX_INIT_CONFIG
  ,PS_NV_CONF_DSS_MULTI_PING
  ,PS_NV_CONF_DHCP_SUBNET_MASKING_CALC
  ,PS_NV_CONF_SECSSL_ALERT_CONFIG
  ,PS_NV_CONF_CLAT_DNS64_QUERY_CONFIG
