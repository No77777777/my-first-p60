...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/api/ps_utils.h#3 $ $DateTime: 2021/10/05 03:31:51 $ $Author: pwbldsvc $
...
---------------------------------------------------------------------------*/
#define PS_EFS_READ_BUFFER_SZ 1100

/*------------------------------------------------------------------------
   Allowed internal registration for NV refresh
-------------------------------------------------------------------------*/
#define PS_UTILS_MAX_ALLOWED_NV_REFRESH_REG  4
...
/*------------------------------------------------------------------------
  PS utils local error
-------------------------------------------------------------------------*/
typedef enum
{
  PS_UTILS_SUCCESS                 = 0,
  PS_UTILS_V4_IP_SRC_ADDR_MISMATCH = 1,
  PS_UTILS_V4_IP_DST_ADDR_MISMATCH = 2,
  PS_UTILS_V4_HDR_PORT_INVALID     = 3,
  PS_UTILS_V4_HDR_PORT_MISMATCH    = 4,
  PS_UTILS_V4_TOS_MISMATCH         = 5,
  PS_UTILS_V4_PARAM_UNKNOWN        = 6,
  PS_UTILS_V6_SRC_PREFIX_MISMATCH  = 7,
  PS_UTILS_V6_DST_PREFIX_MISMATCH  = 8,
  PS_UTILS_V6_HDR_PROT_INVALID     = 9,
  PS_UTILS_V6_HDR_PROT_MISMATCH    = 10,
  PS_UTILS_V6_TRF_MISMISMATCH      = 11,
  PS_UTILS_V6_FLOW_MISMATCH        = 12,
  PS_UTILS_V6_PARAM_UNKNOWN        = 13,
  PS_UTILS_TCP_SRC_PORT_MISMATCH   = 14,
  PS_UTILS_TCP_DST_PORT_MISMATCH   = 15,
  PS_UTILS_UDP_SRC_PORT_MISMATCH   = 16,
  PS_UTILS_UDP_DST_PORT_MISMATCH   = 17,
  PS_UTILS_ICMP_MSG_MISMATCH       = 18,
  PS_UTILS_ICMP_MSG_CODE_MISMATCH  = 19,
  PS_UTILS_ESP_SPI_MISMATCH        = 20,
  PS_UTILS_AH_SPI_MISMATCH         = 21,
  PS_UTILS_TCP_UDP_SRC_PORT_RANGE_MISMATCH   = 22,
  PS_UTILS_TCP_UDP_DST_PORT_RANGE_MISMATCH   = 23
}ps_utils_local_error_enum;
...
PARAMETERS
  ...
  filter_spec_of_flow  : pointer to one filter spec to be matched to
...
DESCRIPTION
  This function checks if specified port and range of one filter matches
  a specified port and range of another set of filter.
...
/*===========================================================================
MACRO PS_UTILS_GET_THRPT_INDENT_FROM_TYPE()

DESCRIPTION
  This macro returns the identifier from throughput type.

PARAMETERS
  type: throughput report type

RETURN VALUE
  identifier.
===========================================================================*/
#define PS_UTILS_GET_THRPT_INDENT_FROM_TYPE(type)                         \
  ((uint16) ((type) << 4))
