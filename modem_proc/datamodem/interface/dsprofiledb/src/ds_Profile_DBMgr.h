...
#define DS_PROFILE_NUM_MODE_HANDLERS 2
/*===========================================================================
...
namespace ds
{
  namespace Profile
  {
	...
	ds_profile_db_result_type DeleteProfileAttach(
	  ds_profile_db_profile_num_type  profile_num,
          ds_profile_db_supported_tech_mask tech_mask,
          ds_profile_db_subs_type subs);
	...
	ds_profile_db_result_type GetProfileclient(
            ds_profile_db_profile_num_type num,
            ds_profile_db_subs_type subs,
      ...
      private:
        ...
        ds_profile_db_result_type DeleteProfileInternal(
          ds_profile_db_profile_num_type  profile_num,
          ds_profile_db_supported_tech_mask tech_mask,
          ds_profile_db_subs_type subs,
          boolean enable_deleting_default_profile = false);
        ...
        powerup_Mh_Cb_Id ids[DS_PROFILE_NUM_MODE_HANDLERS];

        bool  subsProfilesReady[DB_PROFILE_ACTIVE_SUBSCRIPTION_MAX];
