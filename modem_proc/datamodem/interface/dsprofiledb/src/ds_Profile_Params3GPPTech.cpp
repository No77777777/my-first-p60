...
===========================================================================*/
validate_fn_type Params3GPPTech::validate_fn = &ds_3gpp_profile_validation_func;
/*===========================================================================
...
static void SpecialSetMsisdn(
  const ds_profile_db_info_type* info,
  void*                          params) 
{

  ds_profile_db_3gpp_tech_params_type* prf_3gpp;
  prf_3gpp = (ds_profile_db_3gpp_tech_params_type*)params;
}

static void SpecialSetPcolist(
  const ds_profile_db_info_type* info,
  void*                          params) 
{
...
static void SpecialSetPdnLabel3gpp(
  const ds_profile_db_info_type* info,
  void*                          params)
{
  ds_profile_db_3gpp_tech_params_type* prf_3gpp;
  ...
  PROFILE_DB_LOG_ERROR("DEBUG: SpecialSetPdnLabel3gpp");
  ...
  ) 
{
  ...
  switch (ident)
  {
    ...
    case(TECH_3GPP_PROFILE_PARAM_OP_RESERVED_PCO_ID_LIST):
      return SpecialSetPcolist(info, params);
    case(TECH_3GPP_PROFILE_PARAM_MSISDN_REQ_FLAG):
      return SpecialSetMsisdn(info, params);
    case(TECH_3GPP_PROFILE_PARAM_PDN_LABEL):
      return SpecialSetPdnLabel3gpp(info, params);
...
static ds_profile_db_result_type SpecialGetPcolist(
  ds_profile_db_info_type*       info,
  const void*                    params)
{
  ds_profile_db_3gpp_tech_params_type* prf_3gpp;
...
static ds_profile_db_result_type SpecialGetMsisdn(
  ds_profile_db_info_type*       info,
  const void*                    params)
{
  ds_profile_db_3gpp_tech_params_type* prf_3gpp;
...
static ds_profile_db_result_type SpecialGetPdnLabel3gpp(
  ds_profile_db_info_type*       info,
  const void*                    params)
{
  ds_profile_db_3gpp_tech_params_type* prf_3gpp = 
  ...
  info->len = strnlen(prf_3gpp->pdn_label_3gpp, sizeof(prf_3gpp->pdn_label_3gpp));
  ...
  const void*              params) 
{
  ...
  switch (ident)
  {
    ...
    case(TECH_3GPP_PROFILE_PARAM_OP_RESERVED_PCO_ID_LIST):
      return SpecialGetPcolist(info, params);
    case(TECH_3GPP_PROFILE_PARAM_MSISDN_REQ_FLAG):
      return SpecialGetMsisdn(info, params);
    case(TECH_3GPP_PROFILE_PARAM_PDN_LABEL):
      return SpecialGetPdnLabel3gpp(info, params);
...
ds_profile_db_result_type Params3GPPTech::Init(Params::ParamInfo* mapParamsInfo)
{
  ...
  DB_FILL_PARAM_MAP(TECH_3GPP_PROFILE_PARAM_OP_RESERVED_PCO_ID_LIST,
                    pco_id_list);  

  DB_FILL_PARAM_MAP(TECH_3GPP_PROFILE_PARAM_MSISDN_REQ_FLAG,
                    request_msisdn_flag);

  DB_FILL_PARAM_MAP(TECH_3GPP_PROFILE_PARAM_PDN_LABEL,
                    pdn_label_3gpp);
  return DB_RESULT_SUCCESS;
}
...
void Params3GPPTech::GetDefaultCParams(void* params)
{
  ...
  ds_3gpp_profile_get_default_values((ds_profile_db_3gpp_tech_params_type*)params);
}
