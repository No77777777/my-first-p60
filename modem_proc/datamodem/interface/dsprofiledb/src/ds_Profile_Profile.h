...
namespace ds
{
  namespace Profile
  {
	...
	uint8 GetProfileclient(void) const;
...
ds_profile_db_result_type SetProfileclient(uint8 profile_client, bool track = true);
		
        ds_profile_db_result_type SetAttachProfileFlag(boolean is_attach, bool track = true);
