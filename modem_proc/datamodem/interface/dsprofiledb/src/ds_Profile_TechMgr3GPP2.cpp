...
===========================================================================*/
static bool is_KDDI_or_OMH(ds_profile_db_profile_num_type num)
{
...
void TechMgr3GPP2::InitNumber(ds_profile_db_subs_type subs)
{
  ...
  {
    non_pers_profile_count[DB_PROFILE_ACTIVE_SUBSCRIPTION_1] -= DS_PROFILE_DB_3GPP2_MAX_KDDI_PROFILE_MAX;
...
{
#ifdef FEATURE_DATA_IS707 
  return ds_profile_3gpp2_mgr_get_profile(num, (ds_profile_db_3gpp2_tech_params_type *)tech_params, gen_params, subs);
#else
...
{
#ifdef FEATURE_DATA_IS707 
  return ds_profile_3gpp2_mgr_get_default_profile_num_per_subs(num, family, subs);
#else
  return DB_RESULT_ERR_INVAL_PROFILE_FAMILY;
#endif
}
...
{
#ifdef FEATURE_DATA_IS707 
  return ds_profile_3gpp2_mgr_set_default_profile_num_per_subs(num, family, subs);
#else
  return DB_RESULT_ERR_INVAL_PROFILE_FAMILY;
#endif
}
...
{
#ifdef FEATURE_DATA_IS707
  return ds_profile_3gpp2_mgr_get_default_profile_num(num, family);
#else
  return DB_RESULT_ERR_INVAL_PROFILE_FAMILY;
#endif
}
...
{
#ifdef FEATURE_DATA_IS707
  return ds_profile_3gpp2_mgr_set_default_profile_num(num, family);
#else
  return DB_RESULT_ERR_INVAL_PROFILE_FAMILY;
#endif
}
...
{
#ifdef FEATURE_DATA_IS707
  ds_profile_3gpp2_mgr_get_is_tech_param_set(num, ident, is_tech_param_set);
