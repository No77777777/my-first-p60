...
static const int DB_3GPP_CREATE_RANGE_MAX = 42;
static const int DB_3GPP2_DEFAULT_PROFILE = 0;
static const int DB_3GPP_DEFAULT_PROFILE = 1;

void LogSubscriptionError(ds_profile_db_subs_type subs);
/*===========================================================================
      ...
      public:
          ...
          tech(_tech)
        {
          for (int i = 0; i < DB_PROFILE_ACTIVE_SUBSCRIPTION_MAX; i++)
          {
            ...
            memset(&number_pool_3gpp[i], 0, sizeof(uint8)*(DS_PROFILE_3GPP_PROFILE_COUNT + 1));
          }
        }
