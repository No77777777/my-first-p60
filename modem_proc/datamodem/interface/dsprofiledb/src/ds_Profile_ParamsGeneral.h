...
namespace ds
{
  namespace Profile
  {
	...
	ds_profile_db_result_type SetProfileclient( uint8 profile_client, bool track );
        ds_profile_db_result_type SetIPV6Delegation( boolean ipv6_delegation, bool track);
        ds_profile_db_result_type SetAttachProfileFlag( boolean is_attach, bool track);
        ds_profile_db_result_type SetCLATEnable( boolean clat_enabled, bool track);
        ds_profile_db_result_type SetApnTypeMask( uint64 apn_type_mask, bool track);
	...
	uint8 GetProfileclient();
        boolean GetIPV6Delegation();
        boolean GetAttachProfileFlag();
