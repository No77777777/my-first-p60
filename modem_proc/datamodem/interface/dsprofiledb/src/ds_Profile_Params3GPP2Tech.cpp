...
validate_fn_type Params3GPP2Tech::validate_fn = &ds_profile_3gpp2_mgr_validation_func;
#else
...
{
#ifdef FEATURE_DATA_IS707 
  return ds_profile_3gpp2_mgr_profile_validation_general(profile);
#else
...
#ifdef FEATURE_DATA_IS707
  ds_profile_3gpp2_mgr_get_default_profile((ds_profile_db_3gpp2_tech_params_type*)params);
#else
  return;
#endif
}
