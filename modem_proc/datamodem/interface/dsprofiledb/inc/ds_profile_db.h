...
#define DS_PROFILE_DB_MAX_PERS_PROFILE_COUNT  (26)
...
#define DS_PROFILE_DB_3GPP_OP_RESERVED_PCO_ID_LIST_MAX  10
...
typedef uint16   
  ds_profile_db_3gpp_op_reserved_pco_id_list[DS_PROFILE_DB_3GPP_OP_RESERVED_PCO_ID_LIST_MAX];
  
typedef boolean ds_profile_db_3gpp_request_msisdn_flag_type;
...
typedef enum
{
  ...
  DB_PROFILES_READY_ON_SUBS_EVENT = 7,
  DB_MAX_EVENT              =   0xff
...
typedef enum {
  ...
  TECH_3GPP_PROFILE_PARAM_OP_RESERVED_PCO_ID_LIST      = 0x37 + TECH_3GPP_PROFILE_PARAM_MIN,
  /**< List of operator reserved PCO IDs*/  
  TECH_3GPP_PROFILE_PARAM_MSISDN_REQ_FLAG              = 0x38 + TECH_3GPP_PROFILE_PARAM_MIN,
  /**< List of operator reserved PCO IDs*/  
  /**< RESERVE PROFILE PARAM */
  TECH_3GPP_PROFILE_PARAM_PDN_LABEL                    = 0x3A + TECH_3GPP_PROFILE_PARAM_MIN,
  /**< 3GPP PDN Label */
  TECH_3GPP_PROFILE_PARAM_MAX                          = TECH_3GPP_PROFILE_PARAM_PDN_LABEL,
  /* Make sure ranges do not overlap ! */
  ...
  GENERAL_PROFILE_PARAM_IPV6_DELEGATION                = 0x03 + GENERAL_PROFILE_PARAM_MIN,
    /** IPV6 Delegation */
  GENERAL_PROFILE_PARAM_ATTACH_PROFILE_FLAG            = 0x04 + GENERAL_PROFILE_PARAM_MIN,
    /** Attach Profile Flag */
  GENERAL_PROFILE_PARAM_CLAT_ENABLE_FLAG               = 0x05 + GENERAL_PROFILE_PARAM_MIN,
   /** XLAT Enabled Flag */
  GENERAL_PROFILE_PARAM_PROFILE_CLIENT                 = 0x06 + GENERAL_PROFILE_PARAM_MIN,
    /** PROFILE CLIENT */
  GENERAL_PROFILE_PARAM_APN_TYPE                       = 0x07 + GENERAL_PROFILE_PARAM_MIN,
    /** APN Type */
  GENERAL_PROFILE_PARAM_MAX                            = GENERAL_PROFILE_PARAM_APN_TYPE
...
typedef PACKED struct PACKED_POST 
{
  ...
  ds_profile_db_3gpp_op_reserved_pco_id_list pco_id_list;
                                        /* List of PCO IDs.*/   
                                        
  ds_profile_db_3gpp_request_msisdn_flag_type request_msisdn_flag;   
                                       /* MSISDN Request flag.*/     

  char                              pdn_label_3gpp[DS_PROFILE_DB_MAX_APN_NAME_LEN + 1];
                                       /* 3GPP PDN Label */
...
struct ds_profile_db_delete_entry{
  ...
  ds_profile_db_profile_num_type num;
  char apn_name[DS_PROFILE_DB_MAX_APN_NAME_LEN+1];
  struct ds_profile_db_delete_entry* next_ptr;
}; 
...
ds_profile_db_result_type ds_profile_db_delete_attach(
  ds_profile_db_profile_num_type  num,
  ds_profile_db_supported_tech_mask tech_mask,
  ds_profile_db_subs_type subs
);
...
boolean ds_profile_db_profiles_ready_on_subs(
  ds_profile_db_subs_type subs
);
...
ds_profile_db_result_type ds_profile_db_get_profile_client(
  ds_profile_db_profile_num_type profile_num,
  ds_profile_db_subs_type subs,
  uint8 *profile_client
);
...
ds_sys_subscription_enum_type ds_profile_db_convert_dbsubs_to_dssys_subs(ds_profile_db_subs_type subs);
