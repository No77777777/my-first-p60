...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/tasks/inc/ps_rm_defs.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  PS_RM_RMNET_RX_DATA_Q_SIGNAL_17   = 32,   /* RMNET --> PS_RM data sig   */
  PS_RM_RMNET_RX_DATA_Q_SIGNAL_18   = 33,   /* RMNET --> PS_RM data sig   */
  PS_RM_RMNET_RX_DATA_Q_SIGNAL_19   = 34,   /* RMNET --> PS_RM data sig   */
  PS_RM_RMNET_RX_DATA_Q_SIGNAL_20   = 35,   /* RMNET --> PS_RM data sig   */
