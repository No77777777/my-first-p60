...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/tasks/inc/psi.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
(((uint32)(PS_MAX_SIGNALS + 1) / (sizeof(rex_sigs_type)*8)) + \
(((uint32)(PS_MAX_SIGNALS + 1) % (sizeof(rex_sigs_type)*8))? 1:0))
