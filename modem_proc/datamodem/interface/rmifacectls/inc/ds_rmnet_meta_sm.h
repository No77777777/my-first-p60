...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/rmifacectls/inc/ds_rmnet_meta_sm.h#2 $
...
typedef enum
{
  ...
  RMNET_ENABLE_DATA_AGG_QMAP_V4    = 8,
...
#define RMNET_GLOBAL_EFS_DATA_FORMAT_QMAP_V4_MASK    (0x00000080)
...
typedef PACKED struct PACKED_POST
{
  uint32 rmnet_rx_wm_low;
  uint32 rmnet_rx_wm_hi;
  uint32 rmnet_rx_wm_dne;
}rmnet_rx_wmk_threshold_s_type;

typedef PACKED struct PACKED_POST
{
  rmnet_rx_wmk_threshold_s_type rx_wmk_levels;
  uint32                        rx_wmk_q_cnt_dne;
}rmnet_rx_wmk_threshold_s_ex_type;
...
/*===========================================================================
  FUNCTION RMNET_HAS_UL_DIRECT_TRAFFIC

  DESCRIPTION
    This function checks if rmnet has direct (non-offloaded) UL data traffic

  PARAMETERS
    rmnet_inst: RmNet instance

  RETURN VALUE
    TRUE  - RmNet has direct (non-offloaded) UL data traffic
    FALSE - Rmnet has no direct (non-offloaded) UL data traffic
  ...
  SIDE EFFECTS
    None
===========================================================================*/
boolean rmnet_has_ul_direct_traffic
(
  rmnet_instance_e_type  rmnet_inst
);

/*===========================================================================
  FUNCTION RMNET_SET_OFFLOAD_FC

  DESCRIPTION
    This function notifies transport to do flow control on the offloaded
    tethered traffic (RNDIS or WLAN)

  PARAMETERS
    rmnet_inst:   RmNet instance
    flow_disable: Is flow disable
    force:        Force to perform flow control 
...
/*===========================================================================
FUNCTION rmnet_meta_sm_generate_fc_config_log_pkt 

DESCRIPTION
  This function generates log packet for flow control configuration

PARAMETERS
  ep_id             : End point id
  mux_id            : Mux id
  addr_family       : Address family of the call
...
SIDE EFFECTS
  None.
===========================================================================*/
void rmnet_meta_sm_generate_fc_config_log_pkt
(
  uint32                      ep_id,
  uint8                       mux_id,
...
/* ===========================================================================
FUNCTION rmnet_meta_sm_set_pc_loopback_wmk

DESCRIPTION
  This function sets q_cnt_dne parameter of RM Rx Watermark
...
===========================================================================*/
void rmnet_meta_sm_set_pc_loopback_wmk
(
  void
);
