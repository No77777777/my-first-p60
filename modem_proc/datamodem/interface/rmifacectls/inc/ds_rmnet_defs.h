...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/rmifacectls/inc/ds_rmnet_defs.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
---------------------------------------------------------------------------*/
#define RMNET_DUAL_IP_MAX (QMI_INSTANCE_MAX + 24) // 8 emb + 8 teth
...
#define RMNET_DATA_FORMAT_MASK_UL_DATA_AGG_NUM    (0x00000400)
#define RMNET_DATA_FORMAT_MASK_UL_DATA_AGG_SIZE   (0x00000800)
...
#define RMNET_DATA_FORMAT_MINIMUM_UL_DATA_AGG_SIZE   (2048)
