...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/rmifacectls/inc/ds_rev_ip_transport_hdlr.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*===========================================================================
  FUNCTION REV_IP_TRANSPORT_ADD_V6_PREFIX

  DESCRIPTION
    Adds prefix to hardware
  ...
  SIDE EFFECTS
    None
===========================================================================*/
void rev_ip_transport_add_v6_prefix
(
  ps_iface_type *    iface_ptr
);

/*===========================================================================
  FUNCTION REV_IP_TRANSPORT_FREE_MUX_ID

  DESCRIPTION
    Free the Mux id on receiving QMI_WDS_REVERSE_IP_TRANSPORT_CONFIG_COMPLETE
    for diconnected indication. 
...
void rev_ip_transport_free_mux_id
(
  uint32          ep_id,
  uint8           mux_id
);
