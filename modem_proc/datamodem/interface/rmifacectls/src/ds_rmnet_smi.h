...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/rmifacectls/src/ds_rmnet_smi.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define RMNET_PC_LOOPBACK_RX_WMK_Q_CNT_DNE 20000
...
#define RMNET_UL_DATA_AGG_MAX_NUM(info) RMNET_XPORT_UL_DATA_AGG_MAX_NUM((info)->xport_info)
...
#define RMNET_DATA_AGG_IS_QMAP(data_agg) \
       ((data_agg) == RMNET_ENABLE_DATA_AGG_QMAP || \
        ...
        (data_agg) == RMNET_ENABLE_DATA_AGG_QMAP_V4)
...
typedef enum
{
  ...
  RMNET_SM_CMD_SET_OFFLOAD_FC  = 14,   /* Offload flow control           */
  RMNET_SM_CMD_MAX
} rmnet_sm_cmd_e_type;
...
#define RMNET_FC_MASK_V4          0x10
#define RMNET_FC_MASK_V6          0x20
...
typedef struct
{
  ...
  -----------------------------------------------------------------------------*/
    ...
    -----------------------------------------------------------------------*/
    void *um_iface_ev_buf_ptr;
    void *um_flow_ev_buf_ptr;
