...
/**===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/inc/ps_qos_net_initiated_req.h#2 $
...
/**
  ...
  @param [in] direction                    direction to match filter
...
/**
  ...
  @return
  < PS_QOS_FILTR_DIR_MAX : Filters specifications of provided Application
    Request match the provided filters specifications of the Network Initiated
    QoS.
  PS_QOS_FILTR_DIR_MAX : Filters specifications of provided Application
    Request do not match the provided filters specifications of the Network
    Initiated QoS.
*/
