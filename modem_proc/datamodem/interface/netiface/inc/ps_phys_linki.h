...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/inc/ps_phys_linki.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  boolean                                  is_enabled;
  uint64                                   reported_mask;
  boolean                                  report_legacy_flag;
  boolean                                  report_ulb_flag;
  uint32                                   suppress_logging_cnt;
}ps_phys_linki_prev_log_info;
