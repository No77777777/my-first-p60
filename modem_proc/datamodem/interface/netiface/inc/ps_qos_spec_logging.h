...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/inc/ps_qos_spec_logging.h#2 $
...
DESCRIPTION
  Writes the given ip_fltr's fields in to given buffer byte by byte
