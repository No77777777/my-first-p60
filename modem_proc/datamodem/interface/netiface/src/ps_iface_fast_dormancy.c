...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/src/ps_iface_fast_dormancy.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
         ...
         ++loop)
  {
    ...
    {
      LOG_MSG_ERROR_INT_0("ps_iface_init_all_iface_stats(): memory alloc failed");
      return DS_NOMEMORY;
    }
