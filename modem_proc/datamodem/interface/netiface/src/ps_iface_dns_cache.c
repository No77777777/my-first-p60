...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/src/ps_iface_dns_cache.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    LOG_MSG_ERROR_INT_1("ps_iface_dns_cachei_mem_alloc(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_UTILS_ASSERT( NULL != dup_rr_q && NULL != ps_errno );
  ...
  while( rr_node != NULL )
  {
    ...
    if( 0 < rr_node->rdata_len )
    {
      ...
      if( NULL == dup_rr_node->rdata )
      {
        ...
        LOG_MSG_ERROR_INT_0("ps_iface_dns_cachei_dup_rr_q(): "
    ...
    LOG_MSG_INFO2_4("ps_iface_dns_cachei_dup_rr_q(): "
                    " New dup rr node %p dup rr data %p data len %d type %d",
                    dup_rr_node,  dup_rr_node->rdata, 
                    rr_node->rdata_len, dup_rr_node->rr_type);
...
)
{
  ...
  {
    LOG_MSG_ERROR_INT_0 ("ps_iface_dns_cachei_flush_cache_cmd_handler()"
                         "NULL user data");
    return;
  }
...
)
{
  ...
  {
    LOG_MSG_ERROR_INT_0 ("ps_iface_dns_cachei_flush_cache_entry_cmd_handler()"
                       "NULL user data");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    LOG_MSG_ERROR_INT_0("ps_iface_dns_cache_init(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (TRUE == in_cache)
  {
    ...
    {
      LOG_MSG_ERROR_INT_1("ps_iface_dns_cache_add_rr_q(): "
  ...
  {
    LOG_MSG_ERROR_INT_0("ps_iface_dns_cache_add_rr_q(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  while( NULL != cache_entry )
  {
                             ...
                             PS_DNSI_MAX_DOMAIN_NAME_LEN ))) )
    {
      ...
      {
        LOG_MSG_ERROR_INT_1("ps_iface_dns_cache_find_rr_q(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == strlen(cmd_entry_ptr->hostname))
  {
    LOG_MSG_ERROR_INT_0("ps_iface_dns_cache_flush_entry(): "
