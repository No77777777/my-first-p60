/*===========================================================================
  ...
  Copyright (c) 2010-15 Qualcomm Technologies Incorporated.
  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/src/ps_iface_logical_flowi.c#2 $
...
#ifdef FEATURE_DATA_REFLECTIVE_QOS
         && 
        PS_FLOWI_GET_TX_FLTR_HANDLE( assoc_flow_ptr) != PS_IFACE_IPFLTR_INVALID_HANDLE
#endif /* FEATURE_DATA_REFLECTIVE_QOS */
       )
    {
