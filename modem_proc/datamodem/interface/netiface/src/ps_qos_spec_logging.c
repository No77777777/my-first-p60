...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/netiface/src/ps_qos_spec_logging.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (log_status(LOG_QOS_STATE_EX_C))
  {
    ...
    DS_UTILS_ASSERT((log_ptr - resp_ptr) == (int32)QOS_STATE_LOG_PKT_LEN);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (log_status(LOG_QOS_INFO_CODE_UPDATE_C))
  {
    ...
    DS_UTILS_ASSERT((log_ptr - resp_ptr) == (int32)QOS_INFO_CODE_UPDATE_LOG_PKT_LEN);
