...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/pssock/src/PS_Sock_IO_SocketIO.cpp#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_UTILS_ASSERT( 0 != itemHeadPtrPtr && 0 != itemTailPtrPtr && 0 != psErrnoPtr);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == psErrnoPtr)
  {
    DS_UTILS_ERROR_FATAL("Read(): NULL errno");
    return -1;
  }

  if (0 == readerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("Read(): NULL reader");
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == psErrnoPtr)
  {
    DS_UTILS_ERROR_FATAL("Peek(): NULL errno");
    return -1;
  }

  if (0 == readerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("Peek(): NULL reader");
    *psErrnoPtr = DS_EFAULT;
    return -1;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == readerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("FreeBytes(): NULL reader");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == readerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("ReleaseReader(): NULL reader");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == readerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("SetRcvBufSize(): NULL reader");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == readerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("GetPktCnt(): NULL reader");
    return 0;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == psErrnoPtr)
  {
    DS_UTILS_ERROR_FATAL("Write(): NULL errno");
    return -1;
  }

  if (0 == writerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("Write(): NULL writer");
    *psErrnoPtr = DS_EFAULT;
    return -1;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == writerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("ReleaseWriter(): NULL writer");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == writerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("SetSndBufSize(): NULL writer");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == writerHandlePtr)
  {
    DS_UTILS_ERROR_FATAL("GetSndCnt(): NULL writer");
    return -1;
  }
