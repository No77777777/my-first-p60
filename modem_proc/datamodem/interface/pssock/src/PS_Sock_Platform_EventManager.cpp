...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/pssock/src/PS_Sock_Platform_EventManager.cpp#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == eventInfoPtr)
  {
    DS_UTILS_ERROR_FATAL("ProtocolStackEventCback(): NULL arg");
    return;
  }
  ...
  else
  {
    ...
    {
      DS_UTILS_ERROR_FATAL("ProtocolStackEventCback(): NULL IEventListener");
      return;
    }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_UTILS_ERROR_FATAL("Platform::EventManager::Init(): NULL sock factory");
    return;
  }
