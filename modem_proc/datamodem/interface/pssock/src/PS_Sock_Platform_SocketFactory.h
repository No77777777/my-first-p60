...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/pssock/src/PS_Sock_Platform_SocketFactory.h#2 $
    ...
    namespace Platform
    {
                           ...
                           public PS::Sock::ProtocolStack::IGlobalEventListener
      {
        private:
          ...
          uint32                defaultEphemeralCacheHandle;
          SocketFactory() throw();
        ...
        public:
          ...
          */
          ...
          void SetDefaultEphemeralCacheHandle
          (
            uint32  handle
          );               
          
          uint32 GetDefaultEphemeralCacheHandle
          (
            void
          ); 
          void ReserveDefaultEphemeralPorts
          (
            void
          ); 
          static void ReserveDefaultEphemeralPortsCB
          (
            int8   requestStatus,      
            int32   cacheHandle,  
            void *  userData     
