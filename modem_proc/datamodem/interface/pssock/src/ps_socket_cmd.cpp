...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/pssock/src/ps_socket_cmd.cpp#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
===========================================================================*/
/*===========================================================================
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_UTILS_ERROR_FATAL("ps_socket_cmd_send(): NULL buf");
    return;
  }
  ...
  LOG_MSG_QTRACE_HFT_MED(PS_TAG_PSSOCK, PS_SYS_DEFAULT_SUBS, 
                         "ps_socket_cmd_send(): Posting cmd %d sock %d",
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (0 == ps_cmd_buf_ptr_ptr || 0 == *ps_cmd_buf_ptr_ptr)
  {
    DS_UTILS_ERROR_FATAL("ps_socket_cmd_free(): NULL buf");
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_UTILS_ERROR_FATAL("ps_socket_cmd_reg_out_of_mem_cback(): NULL f_ptr");
    return;
  }
