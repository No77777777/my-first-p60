...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/pssock/src/PS_Sock_IO_DgramQueue.cpp#2 $
        ...
        if (0 != metaDataPtr)
        {
                                           ...
                                           DSM_DS_SMALL_ITEM_POOL))
          {
            *psErrnoPtr = DS_EWOULDBLOCK;
            ps_sock_error_code = DSS_ERROR_COULD_NOT_PUSH_META_DATA;
            goto bail;
          }
        }
...
bail:
  critSectPtr->Leave();
  dsm_free_packet( &dsmItemHeadPtr);
  LOG_MSG_FUNCTION_EXIT_3("DgramQueue::Write(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  *dsmItemPtrPtr = dsm_dequeue( &dgramWM);
  DS_UTILS_ASSERT( 0 != *dsmItemPtrPtr);
  ...
  if (0 != metaDataPtr)
  {
    ...
    {
      *psErrnoPtr = DS_EFAULT;
      ps_sock_error_code = DSS_ERROR_NULL_ARGVAL;
      byteCount   = -1;
      goto bail;
    }
    ...
    {
      *psErrnoPtr = DS_EINVAL;
      ps_sock_error_code = DSS_ERROR_COULD_NOT_PULL_UP_META_DATA;
      byteCount   = -1;
      goto bail;
    }
  }
...
bail:
  ...
  LOG_MSG_FUNCTION_EXIT_4("DgramQueue::Read(): "
