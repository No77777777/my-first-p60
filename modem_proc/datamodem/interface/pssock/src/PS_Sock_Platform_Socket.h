...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/pssock/src/PS_Sock_Platform_Socket.h#2 $
                     ...
                     public PS::Sock::ProtocolStack::IEventListener
      {
        public:
          ...
          */
          ...
          virtual void SetRemoteSockHandle
          (
            uint32  handle
          );              

           virtual void SetEphemeralCacheHandle
          (
            uint32  handle
          );               
          
           virtual uint32 GetEphemeralCacheHandle
          (
            void
          );            
