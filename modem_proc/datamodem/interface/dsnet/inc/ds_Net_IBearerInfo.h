...
namespace ds
{
   namespace Net
   {
      ...
      enum BearerTechRateEnumType {
        RATE_TYPE_BPS,
        RATE_TYPE_KBPS
      };
      
      /** Data bearer rate definitions */
      struct BearerTechRateTypeEx {
         BearerTechRateEnumType rate_type; /**< Unit type */
         int maxTxDataRateEx; /**< Max Tx bearer data rate */
         int maxRxDataRateEx; /**< Max Rx bearer data rate */
         int avgTxDataRateEx; /**< Average Tx bearer data rate */
         int avgRxDataRateEx; /**< Average Rx bearer data rate */
         int currentTxDataRateEx; /**< Current Tx bearer data rate */
         int currentRxDataRateEx; /**< Current Rx bearer data rate */
      };      
