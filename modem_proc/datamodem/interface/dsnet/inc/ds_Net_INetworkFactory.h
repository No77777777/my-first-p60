   ...
   namespace Net
   {
      ...
      struct INetworkFactory : public ::IQI
      {
         ...
         /**
           ...
           */
         virtual ::AEEResult AEEINTERFACE_CDECL CreateNetwork(::ds::Net::NetworkModeType networkMode, ::ds::Net::IPolicy* policy, ::ds::Net::INetwork** newNetwork, int* netdownreason) = 0;
