...
namespace ds
{
   namespace Net
   {
      ...
      struct IQoSManagerPriv : public ::IQI
      {
          ...
          * @see ds_Errors_Def.idl.
          */
         virtual ::AEEResult AEEINTERFACE_CDECL RequestNetInitiatedReq(const ::ds::Net::QoSSpecNetInitiatedType* requestedQoSSpec, ::ds::Net::IQoSNetInitiatedReq** session, ::ds::Net::QoSFltrMatchDirType direction) = 0;
          ...
          * @see ds_Errors_Def.idl.
          */
         virtual ::AEEResult AEEINTERFACE_CDECL CreateQoSNetInitiated(::ds::Net::IQoSNetInitiatedReq* qoSNetInitiatedReq, ::ds::Net::IQoSNetInitiated** qoSNetInitiated, ::ds::Net::QoSFltrMatchDirType* fltr_match_dir_ptr) = 0;
      };
   };
};
