   ...
   namespace Net
   {
	 ...
	 const ::ds::Net::IfaceGroupType GRP_NET_EPC = 0x40;
      ...
      namespace ApnInfo
      {
         ...
         const ::ds::Net::ApnInfoType INTERNET_APN      = 0x01;
         const ::ds::Net::ApnInfoType IMS_APN           = 0x02;
         const ::ds::Net::ApnInfoType VSIM_APN          = 0x03;
         const ::ds::Net::ApnInfoType MMS_APN           = 0x04;
         const ::ds::Net::ApnInfoType DUN_APN           = 0x05;
         const ::ds::Net::ApnInfoType SUPL_APN          = 0x06;
         const ::ds::Net::ApnInfoType HIPRI_APN         = 0x07;
         const ::ds::Net::ApnInfoType FOTA_APN          = 0x08;
         const ::ds::Net::ApnInfoType CBS_APN           = 0x09;
         const ::ds::Net::ApnInfoType IA_APN            = 0x10;
         const ::ds::Net::ApnInfoType EMERGENCY_APN     = 0x11;
      };

      typedef boolean BringUpUsingApnType;
      typedef boolean BringUpUsingApnName;
   };
};
