...
namespace ds
{
   namespace Net
   {
      ...
      struct IPolicyPriv : public ::ds::Net::IPolicy
      {
         ...
         /**
           * This attribute indicates the bring up using apn type flag as part of the network
           * policy. 
           * @param value Attribute value
           */
         virtual ::AEEResult AEEINTERFACE_CDECL GetBringUpApnTypeFlag(::ds::Net::BringUpUsingApnType* apn_type_flag) = 0;
         ...
         /**
           ...
           * @param value Attribute value
           */
         virtual ::AEEResult AEEINTERFACE_CDECL SetBringUpApnTypeFlag(::ds::Net::BringUpUsingApnType apn_type_flag) = 0;
         
         /**
           * This attribute indicates the bring up using apn name flag as part of the network
           * policy. 
           * @param value Attribute value
           */
         virtual ::AEEResult AEEINTERFACE_CDECL GetBringUpApnNameFlag(::ds::Net::BringUpUsingApnName* apn_name_flag) = 0;
         ...
         /**
           ...
           * @param value Attribute value
           */
         virtual ::AEEResult AEEINTERFACE_CDECL SetBringUpApnNameFlag(::ds::Net::BringUpUsingApnName apn_name_flag) = 0;
      };
   };
};
