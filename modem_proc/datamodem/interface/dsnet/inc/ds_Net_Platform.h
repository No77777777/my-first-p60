...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/inc/ds_Net_Platform.h#2 $
...
namespace NetPlatform
{
  ...
  typedef enum
  {
    ...
    IFACE_IOCTL_GET_MSISDN_INFO
      = PS_IFACE_IOCTL_GET_MSISDN_INFO,
  ...
  typedef enum
  {
    ...
    PHYS_LINK_IOCTL_RAN_ASST_MEDIA_ADAPT_REG                    
      = PS_PHYS_LINK_IOCTL_RAN_ASST_MEDIA_ADAPT_REG,
    PHYS_LINK_IOCTL_RAN_ASST_MEDIA_ADAPT_DEREG                    
      = PS_PHYS_LINK_IOCTL_RAN_ASST_MEDIA_ADAPT_DEREG,
    PHYS_LINK_IOCTL_GET_RAN_ASST_MEDIA_ADAPT                    
      = PS_PHYS_LINK_IOCTL_GET_RAN_ASSIT_MEDIA_ADAPT_INFO,

    PHYS_LINK_IOCTL_RAN_ASST_MEDIA_ADAPT_UPDATE                    
      = PS_PHYS_LINK_IOCTL_RAN_ASST_MEDIA_ADAPT_UPDATE,
  ...
  typedef enum
  {
    SYS_TECH_MIN     = PS_SYS_TECH_MIN,
    SYS_TECH_3GPP    = PS_SYS_TECH_3GPP,  /**< Tech type 3gpp */
    SYS_TECH_3GPP2   = PS_SYS_TECH_3GPP2, /**< Tech type 3gpp2 */
    SYS_TECH_WLAN    = PS_SYS_TECH_WLAN,  /**< Tech type WLAN */
    SYS_TECH_ALL     = PS_SYS_TECH_ALL,   /**< All the tech types */
    SYS_TECH_MAX     = PS_SYS_TECH_MAX,
    SYS_TECH_INVALID = PS_SYS_TECH_INVALID
  }PSSysTechEnumType;

  typedef enum 
  {
    SYS_DEFAULT_SUBS      = PS_SYS_DEFAULT_SUBS, /**< Default data subscription */
    SYS_PRIMARY_SUBS      = PS_SYS_PRIMARY_SUBS, /**< Primary */
    SYS_SECONDARY_SUBS    = PS_SYS_SECONDARY_SUBS, /**< Secondary */
    SYS_TERTIARY_SUBS     = PS_SYS_TERTIARY_SUBS,  /**< Tertiary */  
    SYS_SUBS_MAX          = PS_SYS_SUBS_MAX
  } PSSysSubEnumType;

  /*-------------------------------------------------------------------------
                                  SYS IOCTL arguments
  -------------------------------------------------------------------------*/
  typedef ps_sys_ioctl_3gpp_ran_asst_support_config_type Sys3GPPRanAsstSupportConfType;
  ...
  typedef ps_phys_link_ran_asst_media_adapt_info_type           PhysLinkRanAsstInfoType;
  typedef ps_iface_ioctl_fltr_check_type                        RAMAPhyLinkReqIOCTLType;
  typedef ps_iface_dpd_ping_stat_info_type                      DpdPingStatEvType;
...
----------------------------------------------------------------------------*/
  typedef ip_filter_spec_type  PSRAMAFilterSpecType;

  typedef ps_phys_link_ran_asst_media_adapt_info_type PSRAMAInfoType;

  typedef ps_phys_link_bit_rate_info_type PSRAMABitRateInfoType;
  ...
  PSSysSubEnumType IfaceGetSubsID
  (
    int32                              ifaceHandle 
  );
