...
namespace ds
{
   namespace Net
   {
      namespace PhysLinkEvent
      {
         ...
         const ::ds::Net::EventType QDS_EV_RAN_ASST_MEDIA_ADAPT_EV = 1;
         const ::ds::Net::EventType QDS_EV_PACKET_DISCARD_EV = 2;
      };
      ...
      typedef struct
      {
        ...
        int32                                direction;
        uint8                                bitRate;
        boolean                              isRohcEnabled;
      }RanAsstMediaAdaptEventinfoType;

      typedef struct
      {
        int32                                physLinkHandle;
      }PacketDiscardInfoType;
      ...
      struct IPhysLink : public ::ds::Net::IEventManager
      {
         ...
         virtual ::AEEResult AEEINTERFACE_CDECL GetRAMAEventInfo(::ds::Net::RanAsstMediaAdaptEventinfoType* ramaEventInfo) = 0;

         virtual ::AEEResult AEEINTERFACE_CDECL GetPacketDiscardInfo(::ds::Net::PacketDiscardInfoType *packetDiscardInfo) = 0;
