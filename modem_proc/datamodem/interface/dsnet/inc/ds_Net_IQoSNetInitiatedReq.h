...
namespace ds
{
   namespace Net
   {
      ...
      struct IQoSNetInitiatedReq : public ::ds::Net::IEventManager
      {
          ...
          */
         virtual int AEEINTERFACE_CDECL GetLastMatchingFlowHandle(::int32* value,
                                                                  ::ds::Net::QoSFltrMatchDirType* pFltrMatchDir) = 0;
         ...
         */
          ...
          * @see ds_Errors_Def.idl.
          */
         virtual ::AEEResult AEEINTERFACE_CDECL RealTimeCheck(const ::ds::Net::QoSSpecNetInitiatedType* pQoSNetInitiatedSpec,
                                                              ::ds::Net::QoSFltrMatchDirType direction) = 0;
      };
   };
};
