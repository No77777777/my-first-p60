...
namespace ds
{
   namespace Net
   {
      ...
      typedef int QoSFltrMatchDirType;
      namespace QoSFltrMatchDir
      {
         const ::ds::Net::QoSFltrMatchDirType QDS_DIR_BIDIR    = PS_QOS_FILTR_DIR_BIDIR;
         const ::ds::Net::QoSFltrMatchDirType QDS_DIR_DL       = PS_QOS_FILTR_DIR_DL;
         const ::ds::Net::QoSFltrMatchDirType QDS_DIR_UL       = PS_QOS_FILTR_DIR_UL;
         const ::ds::Net::QoSFltrMatchDirType QDS_DIR_UL_OR_DL = PS_QOS_FILTR_DIR_UL_OR_DL;
         const ::ds::Net::QoSFltrMatchDirType QDS_DIR_MAX      = PS_QOS_FILTR_DIR_MAX;
      };
   };
};
