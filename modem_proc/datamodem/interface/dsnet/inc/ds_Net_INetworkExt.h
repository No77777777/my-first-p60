...
namespace ds
{
   namespace Net
   {
      namespace NetworkExtEvent
      {
         ...
         const ::ds::Net::EventType QDS_EV_DPD_PING_STAT_EV = 0x106e62A;
      };
      ...
      {
        uint32 mask;
      }HandoffAncillaryInfoType;

      typedef struct
      {
        uint16 srat;
        uint16 trat;
        HandoffAncillaryInfoType ancillary_info;
      }HandoffinfoType;
      ...
      struct INetworkExt : public ::ds::Net::IEventManager
      {
         ...
         virtual ::AEEResult AEEINTERFACE_CDECL GetDpdPingStat(::ds::Net::DpdPingStatInfoType* value) = 0;
       ...
       virtual ::AEEResult AEEINTERFACE_CDECL CreateNetRanAsstManager(::ds::Net::IRanAsstMediaAdaptManager** newRAMAManager) = 0;
