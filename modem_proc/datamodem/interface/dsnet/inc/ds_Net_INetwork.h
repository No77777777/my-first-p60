...
namespace ds
{
   namespace Net
   {
      ...
      struct NetworkOpReservedPcoListType {
        NetworkOpReservedPcoType pco_info[10];
      };
      ...
      struct INetwork : public ::ds::Net::IEventManager
      {
         ...
         /**
           * This attribute returns the Data Path Maximum Transmission Unit
           * associated with this network.          
           * @param value Attribute value
           */
         virtual ::AEEResult AEEINTERFACE_CDECL GetNetPathMTU(int* value) = 0;
         ...
         */
         ...
         /**
         * This function configures DPD ping settings.
         */
         virtual ::AEEResult AEEINTERFACE_CDECL StartDpdPing(
           dpdPingConfigType pDpdPingConfig) = 0;
         ...
         /**
           * This function returns pGetOpResPcoList.
           * @param value pGetOpResPcoList.
           */
         virtual ::AEEResult AEEINTERFACE_CDECL GetOpResPcoList(
           NetworkOpReservedPcoListType* pGetOpResPcoList) = 0;

         /**
           * This function returns pGetMSISDN.
           * @param value pGetMSISDN.
           */
         virtual ::AEEResult AEEINTERFACE_CDECL GetMSISDN(
           MSISDNType* pGetMSISDN) = 0;

         /**
         * This function initiates a DPD check.
         */
         virtual ::AEEResult AEEINTERFACE_CDECL InitDPDcheck(void) = 0;

         /**
         * This function check if phys link handle is defautl or not.
         */
         virtual ::AEEResult AEEINTERFACE_CDECL IsDefaultPhysLink(int32, boolean*) = 0;
      };
   };
};
