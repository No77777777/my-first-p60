...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_PhysLink.h#3 $
...
private:
  ...
  ISignalBus *               mpSigBusRanAsstMediaAdapt;
  ISignalBus *               mpSigBusPacketDiscard;
  NetworkModeType            mNetworkMode;
  ds::Net::PhysLinkStateType mCachedPreviousState;
  ds::Net::RanAsstMediaAdaptEventinfoType  mRanAsstInfo;
  ds::Net::PacketDiscardInfoType           mPacketDiscardInfo;
...
public:
  ...
  */
  ...
  virtual ds::ErrorType CDECL GetRAMAEventInfo
  (
    RanAsstMediaAdaptEventinfoType* ramaEventInfo
  );

  virtual ds::ErrorType CDECL GetPacketDiscardInfo
  (
