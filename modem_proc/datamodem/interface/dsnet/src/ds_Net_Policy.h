...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_Policy.h#2 $
...
private:
  ...
  boolean                    bringUpUsingApnType;
  boolean                    bringUpUsingApnName;
...
public:
  ...
  */
  ...
  virtual ds::ErrorType CDECL GetBringUpApnTypeFlag (/*rout*/::ds::Net::BringUpUsingApnType* apn_type_flag);
  virtual ds::ErrorType CDECL SetBringUpApnTypeFlag (/*in*/::ds::Net::BringUpUsingApnType apn_type_flag);
  virtual ds::ErrorType CDECL GetBringUpApnNameFlag (/*rout*/::ds::Net::BringUpUsingApnName* apn_name_flag);
  virtual ds::ErrorType CDECL SetBringUpApnNameFlag (/*in*/::ds::Net::BringUpUsingApnName apn_name_flag);
