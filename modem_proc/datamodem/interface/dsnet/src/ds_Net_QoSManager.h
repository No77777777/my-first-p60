...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_QoSManager.h#2 $
...
public:
  ...
  */
  ...
  (
    ...
    ds::Net::QoSFltrMatchDirType direction
  );
  ...
  (    
    ...
    ds::Net::QoSFltrMatchDirType* fltr_match_dir_ptr
  );
