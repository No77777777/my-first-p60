...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_Network.h#3 $
...
protected:
  ...
  DpdPingStatInfoType       mcachedDpdPingStatInfo;
...
/*
  ...
  */
  ...
  @brief
  This function gets the Path MTU of the network subsystem.
  ...
  @return     QDS_EFAULT - Invalid arguments
  */
  virtual ds::ErrorType CDECL GetNetPathMTU
  (
    int    *pMTU
  );
  ...
  */
  ...
  /*!
  @function
  CreateNetRanAsstManager()

  @brief
  Creates a Ran Asst  Manager associated with this network object.


  @details
  Ran Asst Media Adapt Manager is needed to manager Ran Asst requests 

  @param[out] ppIRanAsstManager - Returned Ran Asst Media Adapt Manager

  @return     SUCCESS - on success
  @return     DSS_EFAULT - Invalid arguments
  @return     DSS_ENOMEM - No memory to create Ran Asst Media Adapt Manager.

  @see        Interface: IRanAsstMediaAdaptManager
  */
  virtual ds::ErrorType CDECL CreateNetRanAsstManager
  (
  ...
  */
  ...
  @brief
  Gets OpResPcoList underlying interface.

  @details
  This function gets the OpResPcoList of the network object's underlying
  interface.

  @param[out] pGetOpResPcoList - Out param for OpResPcoList.
  ...
  @see        None.
  */
  virtual ds::ErrorType CDECL GetOpResPcoList
  (
  ...
  @brief
  Gets MSISDN info underlying interface.

  @details
  This function gets the MSISDN of the network object's underlying
  interface.

  @param[out] pGetMSISDN - Out param for MSISDN.
  ...
  @see        None.
  */
  virtual ds::ErrorType CDECL GetMSISDN
  (
  ...
  @param[out]  value - None

  @return     AEE_SUCCESS - on success
  @return     Error code on error.
  */
  virtual ds::ErrorType CDECL InitDPDcheck
  (
    void
  );
...
/*!
   ...
   @brief
   Get DPD ping statistics.
  
   @details
   This function starts DPD with the requested configuration of 
   the network object's underlying interface.
  ...
  virtual ds::ErrorType CDECL GetDpdPingStat
  (
  ...
  /*!
   ...
   @brief
   Starts DPD ping with the configuration for the underlying interface.
   ...
   @see        None.
   */
   virtual ds::ErrorType CDECL StartDpdPing
   (
     dpdPingConfigType pDpdPingConfig
   );  
   ...
   @brief
   Check if provided phys link is default or not.
  
   @details
   This function checks if provided phys link is default or no. 
  
   @param[in] physLinkHandle - Phys link handle to check if it is default or not.
   @param[in] isDefaultPhysLink- Out param to determine default phys link or not.
   ...
   @see        None.
   */
   virtual ds::ErrorType CDECL IsDefaultPhysLink
   (
