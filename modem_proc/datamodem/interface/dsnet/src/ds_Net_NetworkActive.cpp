...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_NetworkActive.cpp#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  do
  {
    ...
    LOG_MSG_INFO3_4 ("NetworkActive::Stop(): "
                     "obj 0x%p, ifaceHandle %d, bringupFirst %d, mTearDown %d",
                     this, ifaceHandle, mBringupFirst, mTeardown);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  do
  {
        ...
        AEE_SUCCESS != result)
    {
      ...
      *lastnet_down_reason = (int)net_down_reason;
      break;
    }
...
)
{
  ...
  LOG_MSG_INFO3_3 ("NetworkActive::GetSignalBus(): "
                   "Obj 0x%p, event 0x%x, sig bus 0x%p",
