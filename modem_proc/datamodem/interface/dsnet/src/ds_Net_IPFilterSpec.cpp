...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_IPFilterSpec.cpp#2 $
...
ds::ErrorType CDECL IPFilterSpec::SetICMPId
( 
  uint16 ICMPId
)
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  return mpPSQoSSpecWrapper->SetICMPId(ICMPId);
