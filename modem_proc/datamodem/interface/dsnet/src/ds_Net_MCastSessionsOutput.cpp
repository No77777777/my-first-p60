...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_FUNCTION_ENTRY_3 ("MCastSessionsOutput::GetNth(): "
                            "obj 0x%p, mcastSession 0x%p, inex %d",
                            this, mcastSession, index);
  ...
  *mcastSession = static_cast <MCastSession *> (mMCastSessionsList.Get(index));
  ...
  LOG_MSG_FUNCTION_EXIT_2 ("MCastSessionsOutput::GetNth(): "
                           "Nth session 0x%p, item is null: %d at index %d "
                           "obj 0x%p", *mcastSession, isNull, index, this);
