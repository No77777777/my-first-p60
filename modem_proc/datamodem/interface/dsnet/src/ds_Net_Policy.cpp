...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_Policy.cpp#2 $
...
#define DS_NET_POLICY_ASSERT(expression) \
         dsnet_policy_assert_wrapper(__LINE__, expression)
...
===========================================================================*/
static void dsnet_policy_assert_wrapper
(
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  subsId = 0;
  apnType = 0;
  bringUpUsingApnName = FALSE;
  bringUpUsingApnType = FALSE;

  if (AEE_SUCCESS != DS_Utils_CreateInstance (NULL,
                                              AEECLSID_CCritSect,
                                              (void **) &mpICritSect))
  {
    DS_NET_POLICY_ASSERT(0);
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (ds::Net::ApnInfo:: EMERGENCY_APN  < argApnType)
  {
...
int Policy::GetBringUpApnTypeFlag
(
  BringUpUsingApnType* argApnTypeFlag
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  mpICritSect->Enter();
  *argApnTypeFlag = bringUpUsingApnType;
  mpICritSect->Leave();


  return AEE_SUCCESS;
} /* GetBringUpApnTypeFlag() */

int Policy::SetBringUpApnTypeFlag
(
  BringUpUsingApnType argApnTypeFlag
)
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_FUNCTION_ENTRY_2("Policy::SetBringUpApnTypeFlag(): "
                           "Obj 0x%p, apn type flag %d", this, argApnTypeFlag);
  ...
  return AEE_SUCCESS;
}/* SetBringUpApnTypeFlag() */

int Policy::GetBringUpApnNameFlag
(
  BringUpUsingApnName* argApnNameFlag
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  mpICritSect->Enter();
  *argApnNameFlag = bringUpUsingApnName;
  mpICritSect->Leave();


  return AEE_SUCCESS;
} /* GetBringUpApnNameFlag() */

int Policy::SetBringUpApnNameFlag
(
  BringUpUsingApnName argApnNameFlag
)
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_FUNCTION_ENTRY_2("Policy::SetBringUpApnNameFlag(): "
                           "Obj 0x%p, apn name flag %d", this, argApnNameFlag);
