...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_Handle.cpp#2 $$DateTime: 2019/10/22 02:53:17 $$Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_FUNCTION_EXIT_4 ("Handle::RegEvent(): Result 0x%x, obj 0x%p, event 0x%x, sig 0x%p",
                           result, this, eventName, pISignal);
  mpICritSect->Leave();
