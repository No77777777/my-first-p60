...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_QoSSecondary.cpp#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    LOG_MSG_ERROR_5 ("QoSSecondary::GetState(): "
                     "result 0x%x, obj 0x%p, NULL handle %d, "
                     "FLOW_IOCTL_QOS_GET_STATUS failed %d, "
                     "FLOW_IOCTL_GET_FLOW_UPDATED_INFO_CODE failed %d",
                     result, this, nullHandle, getStatusFailed, getInfoFailed);
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_FUNCTION_ENTRY_3 ("QoSSecondary::GetSignalBus(): "
  ...
  LOG_MSG_FUNCTION_EXIT_4 ("QoSSecondary::GetSignalBus(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_FUNCTION_ENTRY_3 ("QoSSecondary::QueryInterface(): "
  ...
  LOG_MSG_FUNCTION_EXIT_4 ("QoSSecondary::QueryInterface(): "
