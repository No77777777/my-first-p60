...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_QoSFlowSpec.cpp#2 $
...
#define DS_NET_QOSFLOW_ASSERT(expression) \
         dsnet_qosflow_assert_wrapper(__LINE__, expression)
...
===========================================================================*/
static void dsnet_qosflow_assert_wrapper
(
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO2_5 ("QoSFlowSpec::GetParams(): "
                   "obj 0x%p, param 0x%x, dst 0x%p, dst len %d, mask %d",
                   this, paramName, pDst, dstLen, fieldMask);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO2_5 ("QoSFlowSpec::SetParams(): "
                   "obj 0x%p, param 0x%x, dst 0x%p, dst len %d, mask 0x%p",
