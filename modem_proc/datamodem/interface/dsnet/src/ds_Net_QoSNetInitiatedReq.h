...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_QoSNetInitiatedReq.h#2 $
...
{
public:
  FlowHandle(int32 flowHandle, QoSFltrMatchDirType fltrMatchDir): 
    refCnt(1),
    weakRefCnt(1), 
  ...
  inline QoSFltrMatchDirType GetFltrMatchDir()
  {
    return mFltrMatchDir;
  }

  inline void SetFltrMatchDir(QoSFltrMatchDirType fltrMatchDir)
  {
    mFltrMatchDir = fltrMatchDir;
  }
...
private:
  int32 mFlowHandle;
  QoSFltrMatchDirType mFltrMatchDir;
};
...
public:
  ...
  */
  ...
  @param[in]   pFltrMatchDir - matched filter direction
  ...
  */
  ...
  @param      direction - Network direction to be checked
...
/*-------------------------------------------------------------------------
    ...
    @param      flow.
    @return     FlowHandle pointer if present otherwise NULL
    @see        None.
  -------------------------------------------------------------------------*/
  FlowHandle* CheckDup
  (
