...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/interface/dsnet/src/ds_Net_MemManager.cpp#2 $
...
#define RAMA_NET_MANAGER_SIZE ((sizeof(RanAsstMediaAdaptManager) + 3) & ~3)
#define RAMA_NET_REQUEST_SIZE ((sizeof(RanAsstMediaAdaptReqType) + 3) & ~3)
...
#define RAMA_NET_MANAGER_HIGH_WM   (7)
#define QOS_NET_REQUEST_HIGH_WM   (7)
...
#define RAMA_NET_MANAGER_REQ_LOW_WM (0)
#define RAMA_NET_REQUEST_REQ_LOW_WM (0)


#define RAMA_NET_REQUEST_NUM_BUFS   (8)
#define RAMA_NET_MANAGER_NUM_BUFS   (8)
...
static int rama_net_request_buf [PS_MEM_GET_TOT_SIZE_OPT(RAMA_NET_REQUEST_NUM_BUFS,
                                                          RAMA_NET_REQUEST_SIZE)];

static int rama_net_manager_buf [PS_MEM_GET_TOT_SIZE_OPT(RAMA_NET_MANAGER_NUM_BUFS,
                                                           RAMA_NET_MANAGER_SIZE)];
...
static ps_mem_buf_hdr_type      * rama_net_request_buf_hdr_ptr[RAMA_NET_REQUEST_NUM_BUFS];
static RanAsstMediaAdaptReqType * rama_net_request_buf_ptr[RAMA_NET_REQUEST_NUM_BUFS];

static ps_mem_buf_hdr_type       * rama_manager_buf_hdr_ptr[RAMA_NET_MANAGER_NUM_BUFS];
static RanAsstMediaAdaptManager  * rama_manager_buf_ptr[RAMA_NET_MANAGER_NUM_BUFS];
...
/*-------------------------------------------------------------------------*/
  ...
  if (PS_MEM_POOL_INIT_OPT(PS_MEM_RAN_ASST_MEDIA_ADAPT_MANAGER_TYPE,
       rama_net_manager_buf,
       RAMA_NET_MANAGER_SIZE,
       RAMA_NET_MANAGER_NUM_BUFS,
       RAMA_NET_MANAGER_HIGH_WM,
       RAMA_NET_MANAGER_REQ_LOW_WM,
       NULL,
#ifdef FEATURE_DATA_PS_MEM_DEBUG
       (int *) rama_manager_buf_hdr_ptr,
       (int *) rama_manager_buf_ptr
#else
       NULL,
       NULL
#endif /* FEATURE_DATA_PS_MEM_DEBUG */
  ...
  if (PS_MEM_POOL_INIT_OPT(PS_MEM_RAN_ASST_MEDIA_ADAPT_REQUEST_TYPE,
       rama_net_request_buf,
       RAMA_NET_REQUEST_SIZE,
       RAMA_NET_REQUEST_NUM_BUFS,
       QOS_NET_REQUEST_HIGH_WM,
       RAMA_NET_REQUEST_REQ_LOW_WM,
       NULL,
#ifdef FEATURE_DATA_PS_MEM_DEBUG
       (int *) rama_net_request_buf_hdr_ptr,
       (int *) rama_net_request_buf_ptr
#else
       NULL,
       NULL
#endif /* FEATURE_DATA_PS_MEM_DEBUG */
...
bail:
  DS_UTILS_ERROR_FATAL("MemoryManager::MemPoolInit(): Can't init DSNET pools");
  return;
