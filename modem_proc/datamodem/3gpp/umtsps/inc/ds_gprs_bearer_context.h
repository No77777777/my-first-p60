...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/umtsps/inc/ds_gprs_bearer_context.h#3 $
...
FUNCTION DS_GPRS_BEARER_CNTXT_PROCESS_DEREG_WM_HDLR
...
PARAMETERS
  bearer_context_p
  cnf_status    -- status of dereg event
