...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/umtsps/inc/ds_umts_flow_manager.h#2 $
...
PARAMETERS
  ...
  ds_proto_config_option_p -  Pointer to the PCO container to be used in
                              the modification req message.
