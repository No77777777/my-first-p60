...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/epchandoff/inc/ds_epc_bearer.h#2 $
...
/*===========================================================================
FUNCTION ds_epc_convert_rat_mask_type_from_tech_ex

DESCRIPTION
  This function is used to check convert rat mask from ds sys status
  to ps bearer tech type
...
===========================================================================*/
void ds_epc_convert_rat_mask_type_from_tech_ex
(
  ds_sys_system_status_info_type      *bearer_tech_ex_type,
  ps_iface_bearer_technology_type     *bearer_tech
);
