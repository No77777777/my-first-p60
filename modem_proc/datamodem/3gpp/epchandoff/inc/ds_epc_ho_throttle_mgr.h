...
#define DS_EPC_THROTTLE_ADD_RANDOM_EMC_TIMER_CNT 3
/*-------------------------------------------------------------------------
...
struct thrtl_queue_s
{
  ...
  boolean                                   is_emc_call; /** < EMC call */
  uint32                                    subs_id;  /** <subscriber id, 1 based */
...
{
  ds_profile_info_type     *apn_name; /** < APN name */
  uint32                    subs_id;  /** <subscriber id */
}ds_epc_ho_thrtl_mgr_apn_per_sub_type;
