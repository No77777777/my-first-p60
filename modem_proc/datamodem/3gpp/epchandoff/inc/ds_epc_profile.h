...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/epchandoff/inc/ds_epc_profile.h#2 $
  $Author: pwbldsvc $ 
...
/*===========================================================================
FUNCTION      DS_EPC_GET_COMPATIBLE_PROFILE_ID

DESCRIPTION   This function gets compatible profile from 3GPP2 if profile1_tech 
              is 3GPP and vice versa.

DEPENDENCIES  None

RETURN VALUE
              FALSE: No compatible profile found
              TRUE : Compatible profile found

SIDE EFFECTS  None
===========================================================================*/
boolean ds_epc_get_compatible_profile_id
(
  ds_profile_tech_etype     profile1_tech,
  ds_profile_info_type      profile1_apn_info,
  ps_iface_bearer_ip_type   profile1_pdn_bearer,
  uint16                  * compatible_profile_id,
  uint32                    subs_id
);

void ds_epc_get_emc_flag_from_profile
(
  ds_profile_tech_etype     profile_tech,
  uint32                    profile_id,
  boolean                  *is_emc_call,
