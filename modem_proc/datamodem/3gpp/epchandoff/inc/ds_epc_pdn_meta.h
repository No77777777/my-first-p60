...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/epchandoff/inc/ds_epc_pdn_meta.h#2 $
...
/*===========================================================================
FUNCTION      DS_EPC_PDN_META_EPC_IFACE_EVENT_HANDLER_CB

DESCRIPTION   This callback function is called for logical iface registered 
              event. For now, registered event is EPC up and EPC down. 
...
SIDE EFFECTS  None
===========================================================================*/
void ds_epc_pdn_meta_epc_iface_event_handler_cb
(
