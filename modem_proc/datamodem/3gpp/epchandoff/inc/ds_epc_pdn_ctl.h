...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/epchandoff/inc/ds_epc_pdn_ctl.h#2 $
  $Author: pwbldsvc $ 
...
#define DS_EPC_CTXT_BLK_CAUSE_NONE_MASK                      0x0000
#define DS_EPC_CTXT_BLK_CAUSE_HANDOFF_ABORT_MASK             0x0001
#define DS_EPC_CTXT_BLK_CAUSE_TRAT_NON_RCVRBL_MASK           0x0002
#define DS_EPC_CTXT_BLK_CAUSE_IP_ADDR_MASK                   0x0004

#define DS_EPC_CTXT_UNBLK_PREREG_MASK                        0x0006
//DS_EPC_CTXT_BLK_CAUSE_TRAT_NON_RCVRBL_MASK | DS_EPC_CTXT_BLK_CAUSE_IP_ADDR_MASK //0x06

#define DS_EPC_CTXT_SRAT_TIMER_EXP_MASK                      0x0008

#define DS_EPC_CTXT_TRAT_GOING_DOWN_MASK                     0x0010

#define DS_EPC_CTXT_ATTACH_PDN_HO_MASK                       0x0020

#ifdef FEATURE_DATA_WLAN_MAPCON
#define DS_EPC_CTXT_HO_GIVEUP_TIMER_EXP_MASK                 0x0040
#define DS_EPC_CTXT_HO_PENDING_HO_THROTTLE_MASK              0x0080
#endif /*FEATURE_DATA_WLAN_MAPCON*/

#define DS_EPC_CTXT_TRAT_DOWN_PENDING_MASK                   0x0100
#define DS_EPC_CTXT_UNBLK_ALL_MASK                           0xFFFF
#define DS_EPC_CTXT_BLK_CAUSE_MAX_MASK                       0xFFFF
...
typedef enum
{
  ...
  DS_EPC_PDN_RAT_1X =         4,
  DS_EPC_PDN_RAT_OTHER =      5,
  DS_EPC_PDN_RAT_IWLAN =      6,
  DS_EPC_PDN_RAT_GSM =        7,
  DS_EPC_PDN_RAT_WCDMA =      8,
  DS_EPC_PDN_RAT_TDSCDMA =    9,
#ifdef FEATURE_LAPP
  DS_EPC_PDN_RAT_NR5G    =    10,
  DS_EPC_PDN_RAT_MAX =        DS_EPC_PDN_RAT_NR5G
#else
  DS_EPC_PDN_RAT_MAX =        DS_EPC_PDN_RAT_TDSCDMA
#endif /* FEATURE_LAPP */
} ds_epc_pdn_rat_type;
...
#ifdef FEATURE_LAPP
  DS_EPC_PDN_SYS_NR5G =             13,
  DS_EPC_PDN_SYS_MAX =              DS_EPC_PDN_SYS_NR5G
#else
...
typedef enum
{
  ...
  DS_EPC_DS_CMD_IFACE_EV_ID_PENDING_SRAT_DOWN,
...
struct __ds_epc_cb_s
{
  ...
  void                    * trat_iface_ev_buf;
  void                    * trat_iface_config_ev_buf;
  /*Note: Didn't combine this TRAT config buffer since dereg for TRAT DOWN/UP 
    timing is different for TRAT config; If combined, it could holding the
    free of the buffer since we don't know if all events have been dereg
    for TRAT iface*/
  ...
  -------------------------------------------------------------------------*/
  void                    * srat_iface_ev_buf;
  ps_iface_type           * waiting_on_reg_srat_iface_ptr;
  void                    * epc_iface_ev_buf;
  ...
  /*-------------------------------------------------------------------------
   Registers the Pending SRAT iface down event
  -------------------------------------------------------------------------*/

  void                    * pending_srat_iface_ev_buf;
  ps_iface_type           * pending_srat_iface_ptr;

  /*-------------------------------------------------------------------------
    Timer which is started after SRAT to TRAT handover. Upon timer expiry
    SRAT iface would be brought down.
  -------------------------------------------------------------------------*/
  ds_epc_timer_type         epc_pending_teardown_timer;
...
#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
FUNCTION ds_epc_pdn_ctl_qsh_mdump_collect
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void ds_epc_pdn_ctl_qsh_mdump_collect
(
  void
);
#endif
...
SIDE EFFECTS  None
===========================================================================*/
ds_epc_pdn_rat_type ds_epc_ctl_get_curr_rat
(
  uint32 subs_id
);
...
/*===========================================================================
FUNCTION      DS_CMD_EPC_PENDING_TEARDOWN_TIMER_EXP_CMD

DESCRIPTION:  Process DS_CMD_EPC_PENDING_TEARDOWN_TIMER_EXP_PROC from ds_task
...
SIDE EFFECTS  None
===========================================================================*/
void ds_epc_process_pending_teardown_timer_expire_cmd
(
  ds_epc_cb_type *instance_ptr
);
...
/*===========================================================================
FUNCTION      DS_EPC_PDN_CTL_EMC_UNTHROTTLE_DS3G_CB

DESCRIPTION   Callback function for DS3G event
              DS3GEVENTMGR_IWLAN_S2B_EMC_UNTHROTTLE_EV
...
SIDE EFFECTS  None.
===========================================================================*/
void ds_epc_pdn_ctl_emc_unthrottle_ds3g_cb
(
  void      *event_info_ptr
);

/*===========================================================================
FUNCTION      DS_EPC_CTL_GET_PDN_TECH_BY_RAT_TYPE

DESCRIPTION:  Get the PDN tech info from PDN rat

PARAMETERS    ds_sys_rat_ex_enum_type

DEPENDENCIES  None

RETURN VALUE  ds_epc_pdn_tech_type

SIDE EFFECTS  None
===========================================================================*/
ds_epc_pdn_tech_type ds_epc_pdn_ctl_get_pdn_tech_by_rat_type
(
  ds_sys_rat_ex_enum_type rat_type
);
