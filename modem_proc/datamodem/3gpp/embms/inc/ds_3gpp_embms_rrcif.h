...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/embms/inc/ds_3gpp_embms_rrcif.h#2 $ 
...
FUNCTION      DS_3GPP_EMBMS_RRCIF_SVC_INTEREST_REQ

DESCRIPTION
  This function is used to send LTE_RRC_EMBMS_TMGI_LIST_REQ message to RRC with
  the availalbe tmgi list from the service layer

PARAMETERS
  *svc_interest_req_ptr - pointer to the PS payload to be sent
...
SIDE EFFECTS  
  None
==============================================================================*/
boolean ds_3gpp_embms_rrcif_svc_interest_req
(
  ps_iface_embms_svc_interest_req_type *svc_interest_req_ptr,
  sys_modem_as_id_e_type                subs_id
);
