...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/embms/inc/ds_3gpp_embms_hdlr.h#2 $
-----------------------------------------------------------------------------  
...
#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
FUNCTION ds_3gpp_embms_qsh_mdump_collect
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void ds_3gpp_embms_qsh_mdump_collect
(
  void
);
#endif
...
PARAMETERS
  ...
  net_down_reason - Ps iface net down reason
