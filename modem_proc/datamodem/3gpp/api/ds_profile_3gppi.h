...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/api/ds_profile_3gppi.h#3 $ $DateTime: 2021/02/07 23:04:07 $ $Author: pwbldsvc $
...
#define DS_PROFILE_3GPP_MAX_PROFILE_LABEL_LEN 100
...
typedef PACKED struct PACKED_POST
{
  ...
  uint16                                max_pdn_conn_time;   
                                        /* Specifies the time duration 
                                           ...
                                           already made. */ 
  char                                  pdn_label[DS_PROFILE_3GPP_MAX_PROFILE_LABEL_LEN+1];     
