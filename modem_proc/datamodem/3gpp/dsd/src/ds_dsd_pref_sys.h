...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsd/src/ds_dsd_pref_sys.h#2 $
...
typedef struct
{
  ...
  boolean                   subs_capability_force_notify;
...
/*===========================================================================
FUNCTION      DS_DSD_PREF_SYS_GET_DISABLED_RADIO_MASK

DESCRIPTION   This function returns the radio mask to disable 
                specific radios during preference order update
 
DEPENDENCIES  None.

RETURN VALUE  Radio Disable mask.

SIDE EFFECTS  None.
===========================================================================*/
uint16 ds_dsd_pref_sys_get_disabled_radio_mask
(
  ds3gsubsmgr_subs_id_e_type  subs_id
);
...
/*===========================================================================
FUNCTION      DS_DSD_PREF_SYS_SUBS_CAPABILITY_CHG

DESCRIPTION   This function handles the subs capability change.
 
DEPENDENCIES  None.

RETURN VALUE  None.

SIDE EFFECTS  Updates the preferred order list based on new subs capability.
===========================================================================*/
void ds_dsd_pref_sys_subs_capability_chg
(
...
(
  ds3gsubsmgr_subs_id_e_type  def_subs_id
);
...
#ifdef FEATURE_LAPP
/*===========================================================================
FUNCTION      DS_DSD_PREF_SYS_NR5G_RE_ORDER_PREF_LIST

DESCRIPTION   This function handles the NR5G Acquisition Loss command.
...
SIDE EFFECTS  None.
===========================================================================*/
void ds_dsd_pref_sys_nr5g_re_order_pref_list
(
  ds3gsubsmgr_subs_id_e_type  subs_id
);
#endif /* FEATURE_LAPP */
