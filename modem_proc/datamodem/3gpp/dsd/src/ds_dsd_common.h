...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsd/src/ds_dsd_common.h#2 $
...
-------------------------------------------------------------------------*/
#ifdef FEATURE_LAPP
#define DS_DSD_MAX_RADIO  8 /* MAX num of radios supported by DSD */
#else
...
#define DS_DSD_RAT_EXP_THROTTLE                   0x07
#define DS_DSD_RETRY_DELAY_THROTTLE               0x08
...
/*-------------------------------------------------------------------------
  Macro to validate DSD RADIO INDEX
-------------------------------------------------------------------------*/
#define VALIDATE_DSD_RADIO_INDEX(index)             \
((index >= 0) && (index < DS_DSD_MAX_RADIO))
...
typedef enum
{
  ...
  DS_DSD_RADIO_INFO_ROAM_TYPE,
  DS_DSD_RADIO_INFO_ROAM_STATUS,
  DS_DSD_RADIO_INFO_NULL_BEARER_REASON,
  DS_DSD_RADIO_INFO_MAX = DS_DSD_RADIO_INFO_NULL_BEARER_REASON
...
SIDE EFFECTS  None.
===========================================================================*/
uint64 ds_dsd_common_get_radio_so_mask
(
  dsd_radio_type              radio,
  boolean                     previous,
  ds3gsubsmgr_subs_id_e_type  subs_id
...
/*===========================================================================
FUNCTION      DS_DSD_COMMON_GET_RADIO_ROAM_TYPE
...
RETURN VALUE  roaming type.

SIDE EFFECTS  None.
===========================================================================*/
ds_sys_roaming_type_enum_type ds_dsd_common_get_radio_roam_type
(
  dsd_radio_type              radio,
  boolean                     previous,
  ds3gsubsmgr_subs_id_e_type  subs_id
