...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsd/src/ds_dsd_timer.h#2 $
...
#define DS_RatExpHystTimerID_T13        13
#define DS_NR5GOOSHystTimerID_T14       14
#define DS_NullBearerHystTimerID_T15    15
#define DS_MaxTimerID                   DS_NullBearerHystTimerID_T15
...
typedef struct
{
  ...
  ds_dsd_timer_info_type    rat_expansion_hyst_timer;     /* T13 */
  ds_dsd_timer_info_type    nr5g_oos_hyst_timer;           /* T14 */
  ds_dsd_timer_info_type    null_bearer_hyst_timer;       /* T15 */
