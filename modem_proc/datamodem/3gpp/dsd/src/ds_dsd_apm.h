...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsd/src/ds_dsd_apm.h#3 $
...
extern rex_crit_sect_type  ds_dsd_apm_critical_section ;
...
/*----------------------------------------------------------------------- 
  ...
  -----------------------------------------------------------------------*/
extern void *ds_dsd_apm_qmi_user_data_ptr ;
...
typedef struct
{
  ...
  /*--------------------------------------------------------- 
    Boolean flag to be set when AP sends a new attach list
    with a valid action. It is unset when MH has acted
    upon the action and PS has been notified
    --------------------------------------------------------*/
  boolean                       dsd_apm_is_action_conf_pending;
  attach_action_info_type       dsd_apm_ap_action_pending;
...
to be sub id based.
------------------------------------------------------------------------*/
extern ds_dsd_apm_subs_info_type  subs_info[DS3GSUBSMGR_SUBS_ID_COUNT] ;
