...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/lteps/inc/ds_eps_flow_manager.h#2 $
...
{ 
  ...
  #ifdef FEATURE_LAPP
  ext_apn_ambr_T  eps_pdn_ext_ambr; /* PDN ext AMBR */
  #endif /*  FEATURE_LAPP */
  int             index;
...
PARAMETERS
  bearer_context_p -  Pointer to bearer context to be modified.
  ...
  PCO container       PCO container to be sent in bearer mod req
