...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/lteps/inc/ds_eps_bearer_flow_manager.h#2 $
...
#define DS_EPS_EXT_QOS_BITRATE_MAXIMUM_VALUE  20000000
#define DS_EPS_APP_BITRATE_MAXIMUM_VALUE      DS_EPS_EXT_QOS_BITRATE_MAXIMUM_VALUE
...
#define DS_EPS_EXT2_MAX_BIT_VALUE             246
...
PARAMETERS
  ...
  ext_nw_flow     -  Extended EPS FLow that needs to be converted
  app_flow        -  App flow to store the converted info.
  cause_code_p    -  Pointer to internal cause code
...
PARAMETERS
  ...
  nw_rate          - nw rate corresponding to octet 4 through 7
  nw_rate_ex       - Extended nw rate corresponding to octet 8 through 11
  nw_rate_ex2      - Extended 2 nw rate corresponding to octet 12 through 15
