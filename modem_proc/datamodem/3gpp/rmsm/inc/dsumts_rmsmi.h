...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/rmsm/inc/dsumts_rmsmi.h#2 $ 
...
typedef struct dsumts_rmsmi_sm_info_s
{
  ...
  boolean                             recd_um_down;
                                      /* flag used to indicate iface down recd for this instance*/
...
typedef struct dsumts_rmsmi_info_s
{
  ...
  rex_timer_type                      stop_ppp_delay_timer;  

  rex_timer_type                      ppp_up_delay_timer;  
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void dsumts_rmsmi_qsh_mdump_collect
(
  void
);
