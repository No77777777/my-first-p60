...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/rmsm/inc/dsumts_rmsm_ipi.h#2 $ 
...
typedef enum
{
  ...
  DSUMTS_RMSM_IP_WAITING_FULL_SRV_CNF_STATE,         /* Full srv confimation is needed*/
  DSUMTS_RMSM_IP_FULL_SRV_CNF_STATE,                 /* Full srv cnf received*/
