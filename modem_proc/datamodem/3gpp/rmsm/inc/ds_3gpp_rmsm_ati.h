...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/rmsm/inc/ds_3gpp_rmsm_ati.h#2 $ 
...
/*---------------------------------------------------------------------------
    This defines the min and max handle range for RMSM instances. When an
    ...
    called.
---------------------------------------------------------------------------*/
#define DS_3GPP_RMSM_AT_INVALID_HANDLE       0xFFFF
#define DS_3GPP_RMSM_AT_MIN_HANDLE           0x0
#define DS_3GPP_RMSM_AT_MAX_HANDLE           0x7FFF
...
typedef struct 
{
  ...
  void*                                 user_info_ptr;        /*user data */
                /* handle to determine if MH should process the PS signal
                   callback */
  int32                                 ps_handle;
