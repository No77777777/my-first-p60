...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/rmsm/inc/dsumts_rmsm_pppi.h#2 $ 
...
typedef enum
{
  ...
  DSUMTS_RMSM_PPP_WAITING_FULL_SRV_CNF_STATE = 1,     /* Waiting for full srv confirmaiton*/
  DSUMTS_RMSM_PPP_FULL_SRV_CNF_STATE = 2,             /* Full srv cnf has been received */
  DSUMTS_RMSM_PPP_WAITING_FOR_UM_UP_STATE = 3,        /* Um coming up     */
  DSUMTS_RMSM_PPP_UM_RM_UP_STATE = 4,                 /* Rm and Um up     */
  DSUMTS_RMSM_PPP_WAITING_FOR_UM_DOWN_STATE = 5,      /* Um going down    */
#ifdef FEATURE_DATA_TE_MT_PDP
  DSUMTS_RMSM_PPP_RINGING_TE = 6,                     /* Um wants MT pkt call */
#endif /*FEATURE_DATA_TE_MT_PDP*/
  DSUMTS_RMSM_PPP_WAITING_FOR_ENTITLEMENT_CHECK_STATE = 7,
