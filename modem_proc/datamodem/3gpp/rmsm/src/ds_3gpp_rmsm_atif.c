...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/rmsm/src/ds_3gpp_rmsm_atif.c#2 $ 
...
{
  DS_3GPP_MSG2_LOW("In ds_3gpp_rmsm_atif_qcdgen_handler for profile %d and data len %d",
...
{
  DS_3GPP_MSG1_LOW("In ds_3gpp_rmsm_atif_get_pdp_addr for profile num %d",
    profile_number);
...
{
  DS_3GPP_MSG1_LOW("In ds_3gpp_rmsm_atif_cgcmod_handler for profile %d",
            profile_number);
