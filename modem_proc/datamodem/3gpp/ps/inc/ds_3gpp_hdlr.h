...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps/inc/ds_3gpp_hdlr.h#3 $
...
#define DS_3GPP_MAX_PDN_CONTEXT (DS_3GPP_MAX_AVAIL_PDNS +1)

#ifdef FEATURE_DATA_LTE
  #ifdef FEATURE_EMERGENCY_PDN
    #define DS_3GPP_NUM_EMERG_PDN_CONTEXT  2
  #else
...
*/
    ...
    #define DS_3GPP_MAX_DPL_IFACE_SUPPORTED (DS_3GPP_MAX_NORMAL_PDN_CONTEXT*2) + \
                                            (DS_3GPP_NUM_EMERG_PDN_CONTEXT*1)
  #define DS_3GPP_EMERGENCY_PDN_V4_PS_IFACE_SUB1_IDX       (DS_3GPP_MAX_NORMAL_PDN_CONTEXT*2)
  #define DS_3GPP_EMERGENCY_PDN_V4_PS_IFACE_SUB2_IDX       (DS_3GPP_EMERGENCY_PDN_V4_PS_IFACE1_IDX+1)  
    ...
    #undef DS_3GPP_MAX_DPL_IFACE_SUPPORTED
      ...
      #define DS_3GPP_MAX_DPL_IFACE_SUPPORTED (DS_3GPP_MAX_NORMAL_PDN_CONTEXT*2) + \
      	                                      (DS_3GPP_NUM_EMERG_PDN_CONTEXT*2)
    #undef  DS_3GPP_EMERGENCY_PDN_V4_PS_IFACE_SUB2_IDX
    #define DS_3GPP_EMERGENCY_PDN_V6_PS_IFACE_SUB1_IDX    (DS_3GPP_MAX_NORMAL_PDN_CONTEXT*2)+1
    #define DS_3GPP_EMERGENCY_PDN_V6_PS_IFACE_SUB2_IDX    (DS_3GPP_EMERGENCY_PDN_V6_PS_IFACE_SUB1_IDX+2)
    #define DS_3GPP_EMERGENCY_PDN_V4_PS_IFACE_SUB2_IDX    (DS_3GPP_EMERGENCY_PDN_V4_PS_IFACE_SUB1_IDX+2)
...
typedef struct
{
  ...
  /*-------------------------------------------------------------------------- 
  This is to indicate if LTE_CPHY_RF_UNAVAILABLE_IND received from ML1
  --------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  3GPP APM's APN preferred system command structure.
---------------------------------------------------------------------------*/
typedef struct
{
  ps_sys_apn_pref_sys_type       apn_pref_sys;
  ps_sys_subscription_enum_type  dsd_subs_id;
} ds_3gpp_apm_apn_pref_sys_cmd_type;
...
===========================================================================*/
void ds_3gpp_hdlr_event_reg(void);
...
DESCRIPTION
 ...
 This function sends an indication to ps framework to inform the configured
 data rates.
...
DESCRIPTION    This utility function is invoked via PS_SYS IOCTL when AP
               invokes the QMI API to get query bit rate configuration

PARAMETERS     arg_val_ptr: struct to store query bit rate configuration
