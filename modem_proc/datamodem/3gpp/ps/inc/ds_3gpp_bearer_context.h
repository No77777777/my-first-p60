...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps/inc/ds_3gpp_bearer_context.h#3 $
...
#define DS_BEARER_CTXT_VFR_CALL_PER_MODE(rval, func, mode, ...)  \
          DS_3GPPI_VFR_CALL_PER_MODE(ds_bearer_context_ftbl, rval, func, mode, \
                   __VA_ARGS__)

  /* Critical section for UL MH datapath*/
extern rex_crit_sect_type   ds_3gpp_ul_crit_sect;

/* Critical section for DL MH Datapath */
extern rex_crit_sect_type   ds_3gpp_dl_crit_sect;


#define  RAB_REESTAB_RETRY_CNT_INVALID  0x7fffffff
#define  RAB_REESTAB_RETRY_CNT_DEFAULT  3
#define  MAX_UL_DL_FREQUENCY            1000000


/*--------------------------------------------------------------------------
  5G UIM Data Statistics Activity Sampling Timer Value
----------------------------------------------------------------------------*/
#define DATA_ACTIVITY_SAMPLING_TIMER_DURATION 1000

/*---------------------------------------------------------------------------
  WCDMA DL data rates
---------------------------------------------------------------------------*/
#define DSWPSD_DL_RATE_NON_HS  1258291
#define DSWPSD_DL_RATE_1_8M    1800000
#define DSWPSD_DL_RATE_3_6M    3600000
#define DSWPSD_DL_RATE_7_2M    7200000
#define DSWPSD_DL_RATE_42M     42000000

/*---------------------------------------------------------------------------
  Default UL Watermark Levels for WCDMA
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default UL Watermark Levels for DC_HSUPA
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default UL Watermark Levels for HSPA+/Release7  
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default UL Watermark Levels for EUL
...
/*---------------------------------------------------------------------------
  Default UL Watermark Levels for EUL with 2ms TTI
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default DL Watermark Levels for WCDMA
---------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------
  Default DL Watermark levels for 3C HSDPA
--------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default DL Watermark Levels for HSDPA Phase 2
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default DL Watermark Levels for HSDPA Phase 1
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default DL Watermark Levels for HSDPA 
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  WCDMA PS<->PDCP Watermark Levels based on Feature definitions
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  WCDMA PS<->PDCP UL Watermark Levels based on UL data rate
---------------------------------------------------------------------------*/
/* UL data rates in Mbps*/
#define DSWPSD_UL_RATE_0_7M          711000
#define DSWPSD_UL_RATE_1_44M         1448400
#define DSWPSD_UL_RATE_2_88M         2886000
#define DSWPSD_UL_RATE_5_74M         5742000
#define DSWPSD_UL_RATE_11_4M         11498000

/* UL WM Levels 0.7Mbps */
#define DSWPSD_UL_WM_LO_0_7M                4500
#define DSWPSD_UL_WM_HI_0_7M                7500
#define DSWPSD_UL_WM_DNE_0_7M              350000
#define DSWPSD_UL_WM_0_7M_BIDIR_BUFFER     25000 

#define DSWPSD_UL_WM_DNE_QCNT_0_7M           700

/* UL WM Levels 1.44Mbps */
#define DSWPSD_UL_WM_LO_1_44M        38000
#define DSWPSD_UL_WM_HI_1_44M        40000
#define DSWPSD_UL_WM_DNE_1_44M       350000
#define DSWPSD_UL_WM_DNE_QCNT_1_44M     700

/* UL WM Levels 2.88Mbps */
#define DSWPSD_UL_WM_LO_2_88M        45000
#define DSWPSD_UL_WM_HI_2_88M        65000
#define DSWPSD_UL_WM_DNE_2_88M       350000
#define DSWPSD_UL_WM_DNE_QCNT_2_88M  700

/* UL WM Levels 5.74Mbps */
#define DSWPSD_UL_WM_LO_5_74M        45000
#define DSWPSD_UL_WM_HI_5_74M        65000
#define DSWPSD_UL_WM_DNE_5_74M       350000
#define DSWPSD_UL_WM_DNE_QCNT_5_74M  700

/* UL WM Levels 11.4Mbps */
#define DSWPSD_UL_WM_LO_11_4M        48000
#define DSWPSD_UL_WM_HI_11_4M        120000
#define DSWPSD_UL_WM_DNE_11_4M       350000
#define DSWPSD_UL_WM_DNE_QCNT_11_4M  700

/*---------------------------------------------------------------------------
  Default UL Watermark Levels for LTE
---------------------------------------------------------------------------*/
#define DSLTEPS_UL_WM_DEFAULT_LO        160000
#define DSLTEPS_UL_WM_DEFAULT_HI        265000
#define DSLTEPS_UL_WM_DEFAULT_DNE       380000
#define DSLTEPS_UL_WM_DEFAULT_DNE_QCNT    3003 


/* UL WM Levels 50Mbps */
#define DSLTEPS_UL_WM_LO_50M            160000
#define DSLTEPS_UL_WM_HI_50M            265000
#define DSLTEPS_UL_WM_DNE_50M           380000
#define DSLTEPS_UL_WM_DNE_QCNT_50M        3003

#define DSLTEPS_UL_WM_DNE_50_MSIM_BIDIR  330000

/* UL WM Levels 75Mbps */
#define DSLTEPS_UL_WM_LO_75M            190000
#define DSLTEPS_UL_WM_HI_75M            295000
#define DSLTEPS_UL_WM_DNE_75M           400000
#define DSLTEPS_UL_WM_DNE_QCNT_75M        3003 

/* UL WM Levels 100Mbps */
#define DSLTEPS_UL_WM_LO_100M           220000
#define DSLTEPS_UL_WM_HI_100M           325000
#define DSLTEPS_UL_WM_DNE_100M          430000
#define DSLTEPS_UL_WM_DNE_QCNT_100M       3003 

/* UL WM Levels 150Mbps */
#define DSLTEPS_UL_WM_LO_150M           250000
#define DSLTEPS_UL_WM_HI_150M           355000
#define DSLTEPS_UL_WM_DNE_150M          460000
#define DSLTEPS_UL_WM_DNE_QCNT_150M       3003

/* UL WM Levels 150Mbps Bidirectional dne */
#define DSLTEPS_UL_WM_150UL_450DL_DNE   650000 
#define DSLTEPS_UL_WM_150UL_600DL_DNE   650000 
#define DSLTEPS_UL_WM_150UL_DL_DNE      650000

#define DSLTEPS_TLB_WM_DEFAULT_DNE      2000000  
#define DSLTEPS_TLB_WM_DEFAULT_DNE_QCNT    3003


/*---------------------------------------------------------------------------
  Default DL Watermark Levels for LTE
---------------------------------------------------------------------------*/
#define DSLTEPS_DL_WM_DEFAULT_LO        900000   
#define DSLTEPS_DL_WM_DEFAULT_HI       1200000   
#define DSLTEPS_DL_WM_DEFAULT_DNE      2000000   
#define DSLTEPS_DL_WM_DEFAULT_DNE_QCNT    3003   

/* DL WM Levels 150Mbps */
#define DSLTEPS_DL_WM_LO_150M           225000
#define DSLTEPS_DL_WM_HI_150M           300000
#define DSLTEPS_DL_WM_DNE_150M         2000000
#define DSLTEPS_DL_WM_DNE_QCNT_150M       3003


/* DL WM Levels 300Mbps */
#define DSLTEPS_DL_WM_LO_300M            450000
#define DSLTEPS_DL_WM_HI_300M            600000
#define DSLTEPS_DL_WM_DNE_300M          2000000
#define DSLTEPS_DL_WM_DNE_QCNT_300M        3003

/* DL WM Levels 450Mbps */
#define DSLTEPS_DL_WM_LO_450M            675000
#define DSLTEPS_DL_WM_HI_450M            900000
#define DSLTEPS_DL_WM_DNE_450M          2000000
#define DSLTEPS_DL_WM_DNE_QCNT_450M        3003

/* DL WM Levels 600Mbps */
#define DSLTEPS_DL_WM_LO_600M             900000
#define DSLTEPS_DL_WM_HI_600M            1200000  
#define DSLTEPS_DL_WM_DNE_600M           2000000
#define DSLTEPS_DL_WM_DNE_QCNT_600M         3003

/* DL WM Levels 1000Mbps */
#define DSLTEPS_DL_WM_LO_1000M           1500000
#define DSLTEPS_DL_WM_HI_1000M           2000000
#define DSLTEPS_DL_WM_DNE_1000M          3333330
#define DSLTEPS_DL_WM_DNE_QCNT_1000M        5005

#define DSLTEPS_UL_WM_150UL_450DL_DNE   650000 
#define DSLTEPS_UL_WM_150UL_600DL_DNE   650000 
#define DSLTEPS_UL_WM_150UL_DL_DNE      650000

#define DSLTEPS_DL_WM_PC_LB_LO          3600000 
#define DSLTEPS_DL_WM_PC_LB_HI          4800000 
#define DSLTEPS_DL_WM_PC_LB_DNE         8000000
#define DSLTEPS_DL_WM_PC_LB_DNE_QCNT    5005  
/*---------------------------------------------------------------------------
  Default UL Watermark Levels for GPRS
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  Default DL Watermark Levels for GPRS
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  This defines the min and max handle range for bearer instances. When an
  instance is created, it will be assigned a unique handle. When it is
  deallocated, the handle will be invalidated. This helps ensure that
  only valid instances can transfer data when the PS signal callback is
  called.
-----------------------------------------------------------------------------*/
#define DS_3GPP_BEARER_CTXT_INVALID_HANDLE       0xFFFF
#define DS_3GPP_BEARER_CTXT_MIN_HANDLE           0x0
#define DS_3GPP_BEARER_CTXT_MAX_HANDLE           0x7FFF
...
/*---------------------------------------------------------------------------
  Struct to read FCF parameters in EFS
---------------------------------------------------------------------------*/
...
/* structure to hold UL/DL wmk stats */
typedef struct
{
  /*------------------------------------------------
  Sum total of the WM cnt for all UL and DL per sub
  -------------------------------------------------*/
  uint64     total_uldl_wmk_cnt;
  /*------------------------------------------------
  Boolean to be set to TRUE whenever the first
  bearer in the sub is in UP state.
  This will be set to FALSE when the last bearer for
  that sub is down
  ------------------------------------------------- */
  boolean    is_bearer_up;
}ds_3gpp_uldl_wm_cnt_s;
/*-----------------------------------------------------------------------
...
typedef struct
{
  ...
  uint64          prev_tx_wm_cnt_for_bidir;
  /** cached Total prev received TX WM cnt (in bytes) for bearers of PDN type as INTERNET. 
   * This is required to calculate the UL throughput in 2s to indicate Bi-Dir session*/
...
#define DS_3GPP_PS_IFACE_NET_DOWN_REASON(x)                                            \
      ...
      ((x.reason_T == DS_3GPP_EXTENDED_NET_DOWN_REASON_T) && \
      (x.reason.internal_reason == UE_GW_L_RAT_CHANGE) ? \
      PS_NET_DOWN_REASON_PENDING_REDIAL_CALL_CLEANUP : PS_NET_DOWN_REASON_NOT_SPECIFIED)))
...
{
  void*  bearer_context_p;
}ds_bearer_context_nonempty_cmd_type;
...
typedef struct ds_bearer_context_dyn_type
{
  ...
  /*!< Flag to indicate that a command to reorig has been enqueued.
   * This prevents multiple commands from being posted to DS */
  boolean                          gone_empty_cmd_enqueued;
  ...
  /*!< indicator for TCP Bi-Direction use case */
  boolean                          tcp_bi_direction;

  /*!< PS timer handle for disabling flow control framework */
  ps_timer_handle_type             tmr_hndl_fcf;

  /*!< indicate if disabling FC framework is pending beause 
      WM level is not lower than threshold yet*/
  ...
  /*!Used to calculate ul dl bearer throughput statistics when required*/
  ds_3gpp_report_bearer_throughput_stats_s bearer_throughput_stats_uldl;
  ...
  /*!handle to determine if MH should process the PS signal callback */
  int32                             ps_handle;

  boolean                           waiting_for_gone_empty;
  /* This flag indicates whether we are waiting for Rx Wmk on Src RAT to 
     get empty */
  ...
  /*--------------------------------------------------------------------------
  This timer starts whenever a flow disabled is kicked in 
  for a bearer and resets when flow is enabled
  ----------------------------------------------------------------------------*/
  rex_timer_type                   flow_disable_timer;
  ...
  -----------------------------------------------------------------------------*/
  boolean                          flow_disable_timer_running;
#ifdef FEATURE_DATA_FLOW_MGMT

  /*--------------------------------------------------------------------------
  This timer starts whenever ack is required from ap for flow disable/enable
  ----------------------------------------------------------------------------*/
  rex_timer_type                   flow_ack_timer;

  boolean                          flow_ack_timer_running;
#endif /*FEATURE_DATA_FLOW_MGMT */
...
{
  /*---------------------------------------------------------------------------
    Moving WM ptrs to static memory as WM ptrs are used by lower layers and 
    cleanup at DS and L2 are not synchronized
  ---------------------------------------------------------------------------*/
...
#ifdef FEATURE_DATA_FLOW_MGMT
  ds3g_burst_based_flow_control_s    flow_control_info; 
#endif /*FEATURE_DATA_FLOW_MGMT */
...
typedef struct
{
...
#ifdef FEATURE_DATA_FLOW_MGMT
  /*-----------------------------------------------------------------------------
    Hysteresis Timer for sending flow control messages periodically.
  -----------------------------------------------------------------------------*/
  rex_timer_type              periodic_timer;

  boolean                     periodic_timer_running; 
#endif /*FEATURE_DATA_FLOW_MGMT */
   
  sys_wcdma_rrc_state_e_type  rrc_state; 

  ds_3gpp_pch_event_e_type    pch_state;

  sys_modem_as_id_e_type      subs_id;

  uint32                      cookie;

  ps_sys_3gpp_rab_reject_cause_code_type_enum 	rab_reject_reason;

  /*-----------------------------------------------------------------------------
    Timer per sub maintained for sampling timer when MH gets
    DATA_ACTIVITY_INDICATION_REGISTRATION from PS inidcating that they would like
    3gpp to start a sampling timer and indicate them with the data activity
    status if it has changed in the timer duration.
  -----------------------------------------------------------------------------*/
  rex_timer_type         data_activity_sampling_tmr;

  /*---------------------------------------------------------------------------- 
    Boolean to indicate the current status of slient registration. i,e if
    client is still registered or not for data activity status indications
    --------------------------------------------------------------------------*/
  boolean                is_client_reg;
  ...
  /*-----------------------------------------------------------------------------
    ...
    that handles the timer_expired command
  -----------------------------------------------------------------------------*/
  boolean                is_sampling_timer_running;

  /* --------------------------------------------------------------------------
     structure to store global stats counter for UL/DL per sub
     -------------------------------------------------------------------------*/
  ds_3gpp_uldl_wm_cnt_s  ds_3gpp_uldl_wm_cnt ;
...
typedef struct
{
...
#ifdef FEATURE_LAPP 
  /*--------------------------------------------------------------------------
    Called to indicate berarer reactivation request indication.
  ---------------------------------------------------------------------------*/
  boolean (*DS_BEARER_CTXT_VF_FPN(bearerreActivateInd))(
                               cm_call_id_type                  call_id,
                               const cm_call_mode_info_s_type   *mode_info_ptr_i
                                );
#endif /* FEATURE_LAPP  */
 ...
 /*-------------------------------------------------------------------------
  ...
  /*---------------------------------------------------------------------------
    ...
    of DRB
  ---------------------------------------------------------------------------*/
  void  (*DS_BEARER_CTXT_VF_FPN(examine_if_throt_needed))(
...
/*--------------------------------------------------------------------------
    This function will call the mode specific function to query UL Packet
    Metrics, returned in the pointer passed are the metrics
---------------------------------------------------------------------------*/
  boolean (*DS_BEARER_CTXT_VF_FPN(get_ul_packet_metrics))(
     ds_bearer_context_s*        bearer_context_ptr,
     ps_iface_ioctl_per_bearer_ul_packet_delay_metrics_type *delay_metric_ptr);

/*--------------------------------------------------------------------------
    This function will call the mode specific function to reset UL Packet
    Metrics
---------------------------------------------------------------------------*/
  boolean (*DS_BEARER_CTXT_VF_FPN(reset_ul_packet_metrics))(
     ds_bearer_context_s*        bearer_context_ptr);

  int (*DS_BEARER_CTXT_VF_FPN(setup_rm_data_path))(
     ps_iface_type  *this_iface_ptr,
     ps_iface_type  *bridge_iface_ptr,
     sys_modem_as_id_e_type subs_id);

  int (*DS_BEARER_CTXT_VF_FPN(receive_data_from_network))(
     void				   *tlb_hndl,
     ps_iface_type		   *this_iface_ptr,
   ...
   void (*DS_BEARER_CTXT_VF_FPN(process_rx_data))(
...
/*----------------------------------------------------------------------------
  Structure used for DPM to MH confirmations
----------------------------------------------------------------------------*/
typedef struct
{
  ps_dpm_um_ev_enum_type            dpm_event;
  ps_dpm_um_ev_cback_info_type      dpm_info;
}ds_bearer_dpm_cb_info_s_type;


#ifdef FEATURE_DATA_FLOW_MGMT
/*----------------------------------------------------------------------------
  Structure used for Flow control command
----------------------------------------------------------------------------*/
typedef struct
{
  ds_bearer_context_s     *bearer_context_p;
  boolean                 flow_enable;
  uint64                  flow_mask;
} ds_bearer_wm_flow_control_info_type;

typedef struct
{
  ds_bearer_context_s     *bearer_context_p;
  uint8                   ack;
} ds_bearer_wm_flow_control_ack_type;
...
#define DS_3GPPI_VFR_CALL_NO_ARG_PER_BEARER(ftbl, rval, func, bearer_context_p) \
        {                                                                     \
          sys_sys_mode_e_type mode;                                           \
          int index;                                                          \
                                                                              \
...
#define DS_BEARER_CNTXT_SET_TIMER(hndl, time_value)\
  {\
    DS_3GPP_MSG1_HIGH("Started back off timer for %d msec",time_value);\
...
/*-----------------------------------------------------------------------------
  ...
  is_sampling_timer_running flag
-----------------------------------------------------------------------------*/
#define DS_BEARER_CNTXT_SET_SAMPLING_TIMER(hndl, time_value)\
  {\
    (void)rex_set_timer(&(hndl->data_activity_sampling_tmr), time_value);\
    hndl->is_sampling_timer_running = TRUE;\
  }

/*-----------------------------------------------------------------------------
  Macro to stop the timer. It also resets the is_sampling_timer_running flag
-----------------------------------------------------------------------------*/
#define DS_BEARER_CNTXT_CLR_SAMPLING_TIMER(hndl)\
  {\
    (void)rex_clr_timer(&(hndl->data_activity_sampling_tmr));\
     hndl->is_sampling_timer_running = FALSE;\
  }


#ifdef FEATURE_DATA_FLOW_MGMT
/*-----------------------------------------------------------------------------
  Macro to start the hysteresis timer with a given value. It also sets the timer_
  running flag
-----------------------------------------------------------------------------*/
#define DS_BEARER_CNTXT_SET_PERIODIC_TIMER(hndl, time_value)\
  {\
    (void)rex_set_timer(&(hndl->periodic_timer), time_value);\
    hndl->periodic_timer_running= TRUE;\
  }

/*-----------------------------------------------------------------------------
  Macro to stop the hysteresis timer. It also resets the timer_running flag
-----------------------------------------------------------------------------*/
#define DS_BEARER_CNTXT_CLR_PERIODIC_TIMER(hndl)\
  {\
    (void)rex_clr_timer(&(hndl->periodic_timer));\
     hndl->periodic_timer_running = FALSE;\
  }
...
/*---------------------------------------------------------------------------
  Buffer size is used when current watermark count is higher than hi wm,
  enable flow control through dsm API.
---------------------------------------------------------------------------*/
...
#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
FUNCTION ds_3gpp_rpm_qsh_mdump_collect
...
DESCRIPTION
  ...
  if data activity has occured. If data acivity has nt occured, we restart the
...
#ifdef FEATURE_DATA_FLOW_MGMT
/*===========================================================================
FUNCTION DS_BEARER_CNTXT_PS_TO_L2_FLOW_DNE_DISABLE_CB
...
/*===========================================================================
FUNCTION DS_3GPP_BEARER_CNTXT_REPORT_ACTUALULDL_THROUGHPUT

DESCRIPTION
  This function refreshes the actual uldl throughput numbers for all the
  active bearers
...
/*===========================================================================
FUNCTION DS_3GPP_BEARER_CNTXT_INITIATE_ACTUALULDL_THROUGHPUT
...
/*=============================================================================
FUNCTION DS_3GPP_BEARER_CNTXT_FILL_DATA_ACTIVITY_STATUS
...
PARAMETERS 
  bearer_context_p -- Tells the current bearer being deactivated
DEPENDENCIES 
  None.
...
DESCRIPTION
  ...
  the bearer. This is just a wrapper API
...
DESCRIPTION
  This function returns the downlink wm level value for LTE
...
PARAMETERS
  IN
    dpm_event       - The event that happened. This is used to differentiate
                      ...
                      reregistration
    cback_info_ptr  - Gives us the event details 
...
PARAMETERS
  is_client_registered : boolean flag to indicate if any client is registered for
                         data ctivity status info for this sub
