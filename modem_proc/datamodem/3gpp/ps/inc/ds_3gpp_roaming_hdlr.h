...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps/inc/ds_3gpp_roaming_hdlr.h#2 $
...
typedef struct
{
  ...
  */
  ...
  sys_plmn_id_s_type                        plmn[SYS_PLMN_LIST_MAX_LENGTH + 1];
} ds_sys_plmn_list_s_type;
...
/*===========================================================================
  FUNCTION DS_3GPP_ROAMING_HDLR_GET_STATUS
...
/*===========================================================================
  ...
  if the UE is roaming. If the UE is in home, the type would be unknown.
...
/*===========================================================================
  ...
  DESCRIPTION
  This function sets the roaming status and roaming type
