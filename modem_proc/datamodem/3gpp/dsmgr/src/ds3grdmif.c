...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsmgr/src/ds3grdmif.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DATA_3GMGR_MSG1(MSG_LEGACY_HIGH, 
                     "Rx'ed OPEN cmd for sio port id: %d", 
                     sio_port_id);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
       ...
       ds3g_siolib_get_ds3g_siolib_pending_close_port() != DS3G_SIOLIB_PORT_NONE )
  {
    ...
    -----------------------------------------------------------------------*/
    DS_3GMGR_ERROR_LOG_0(MSG_LEGACY_ERROR, "RDM_CLOSE_CMD ignored, DS is busy");
    rdm_notify( RDM_DATA_SRVC, RDM_APP_BUSY_S );
  }
  else
  {
