...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsmgr/inc/dsgen_iface6_hdlr.h#2 $
...
struct __dssnet6_sm_cb_s
{
  ...
  boolean       rs_start_sent;        /* Flag to indicate if the rs was sent */
};
