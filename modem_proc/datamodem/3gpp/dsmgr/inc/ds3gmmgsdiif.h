...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsmgr/inc/ds3gmmgsdiif.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  DS3G_MMGSDI_ICCID_INFO_EVENT = 20,
  /* this event is received when receiving the callback of */
  /* iccid info */
  DS3G_MMGSDI_IMSI_M_INFO_EVENT = 21,
  /* this event is received when receiving the callback of
     imsi_m info */
  DS3G_MMGSDI_USIM_EFPSDATAOFF_READ_CNF_EVENT = 22
  /* this event is received when receiving the callback of
     EF PS Data Off Exempt services info */
...
DESCRIPTION
  This function is the handler function for DS3G_MMGSDI_ICCID_INFO_EVENTS
...
/*===========================================================================
FUNCTION DS3G_MMGSDI_3GPP_REGISTER_FOR_REFRESH
