...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsmgr/inc/ds3gdsdif.h#3 $ $DateTime: 2020/01/20 02:26:13 $ $Author: pwbldsvc $
...
/*---------------------------------------
  Mask for NULL Bearer reason
 ----------------------------------------*/
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_NONE                  PS_SYS_NULL_BEARER_REASON_NONE
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_CSFB                  PS_SYS_NULL_BEARER_REASON_CSFB
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_SRVCC                 PS_SYS_NULL_BEARER_REASON_SRVCC
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_OOS                   PS_SYS_NULL_BEARER_REASON_OOS
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_LIMITED_SRVC          PS_SYS_NULL_BEARER_REASON_LIMITED_SRVC
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_CS_ONLY               PS_SYS_NULL_BEARER_REASON_CS_ONLY
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_VOICE_ON_SAME_SUB     PS_SYS_NULL_BEARER_REASON_VOICE_ON_SAME_SUB
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_VOICE_ON_OTHER_SUB    PS_SYS_NULL_BEARER_REASON_VOICE_ON_OTHER_SUB
#define DS3GDSDIF_SYS_NULL_BEARER_REASON_ATTACH_PENDING        PS_SYS_NULL_BEARER_REASON_ATTACH_PENDING

/*-----------------------------------------------------------------
 Set/clean null bearer reason bit
-----------------------------------------------------------------*/
typedef enum
{
  DS3GDSDIF_CLEAN_NULL_BEARER_REASON = 0,
  DS3GDSDIF_SET_NULL_BEARER_REASON = 1
}ds3gdsdif_null_bearer_reason_action_type;
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void ds3gdsdif_qsh_mdump_collect
(
  void
);
#endif
...
DESCRIPTION    This function returns the null bearer reason info bit.

DEPENDENCIES   None.

RETURN VALUE   NULL Bearer Reason
