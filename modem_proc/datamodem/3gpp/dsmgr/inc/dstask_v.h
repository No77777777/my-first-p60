...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsmgr/inc/dstask_v.h#8 $ $DateTime: 2021/05/28 00:27:43 $ $Author: pwbldsvc $
...
typedef enum
{
 ...
 /* Cmd for deleting attach profiles */
  ...
  DS_CMD_PROCESS_REPORTING_INTERVAL_CMD        = 179,
...
#endif /* FEATURE_LAPP */
  DS_CMD_DS3G_MO_DATA_PROTECT_TIMER_EXPIRED    = 188,
  ...
  DS_CMD_DSSNET6_RS_RA_START_EV                = 212,
  ...
  DS_CMD_3GPP_APPLY_V6_PREFIX_IND                   = 1195,
  /* CMD for appluing v6 prefix in HO case */

  DS_CMD_3GPP_PROFILE_DB_APN_TYPE_CHANGE             = 1196,
   /*Cmd for apn type chg*/
  ...
  DS_CMD_3GPP_DL_TPUT_INIT_TIMER                   = 1370,
  /* Cmd for Initial downlink timer expiry */
...
#error code not present
  ...
  DS_CMD_3GPP_GRANT_BYTES_RECEIVED                  = 1384,
  /* Cmd for grant bytes received */

  DS_CMD_3GPP_FLOW_CTL_CMD                          = 1385,
  /* Cmd for wm flow enable and disable */

  DS_CMD_3GPP_FLOW_ACK_TMR_EXP                      = 1386,
  /* Cmd for flow ack timer expiry */

  DS_CMD_3GPP_FLOW_QMAP_ACK_CNF                     = 1387,
   /* Cmd for flow ack qmap ack cnf */

  DS_CMD_3GPP_LB_UL_RAB_DEREG_CNF                   = 1388,

  DS_CMD_3GPP_DPM_INFO_CNF                          = 1389, 
  
  DS_CMD_3GPP_PDN_TCP_RETRANS_PROTECT_TMR_EXP       = 1390,

  DS_CMD_3GPP_IFACE_TCP_LEVEL_TRM_REQ_INFO          = 1391,

  DS_CMD_3GPP_OMADM_SET_PSDATAOFF_INFO              = 1392,

  DS_CMD_3GPP_OTASN_PDN_TMR_EXP                     = 1393,
  /* Cmd for notifying OTASN PDN timer expired */

  DS_CMD_3GPP_GONE_EMPTY_CB                         = 1394,
   ...
   * information 
  */ 
  DS_CMD_3GPP_LOG_FLOW_CTRL_LATENCY                 = 1395,

  /*
   * Cmd used for processing the phys link event callback
   * called from the PS task
   */
  DS_CMD_3GPP_PHYS_LINK_EV_CB                       = 1396,

  /* Cmd for notifying Prohibit timer expired */
  DS_CMD_3GPP_PROH_TIMER_CMD                        = 1397,

  /*cmd to process back  pressure*/
  DS_CMD_3GPP_BEARER_CNTXT_TMR_DYN_BACK_PRESSURE     =1398,

  DS_CMD_3GPP_APN_SWITCH_DETACH_OR_DISCONNECT       = 1402,
...
/*-------------------------------------------------------------------------
 ...
 /* DS_CMD_MPPM_NULL_APN_RESOLVED_INFO callback cmd */
  ...
  DS_CMD_MPPM_PROFILE_UPDATE_EVENT_CB           = 5015,
  /* DS Profile update Event callback cmd*/

  DS_CMD_MPPM_EMERGENCY_PROFILE_UPDATE_EVENT_CB = 5016,
  /* DS Profile update Event callback cmd*/
 ...
 /* DS_CMD_MPPM_RAT_PREFERENCE callback cmd */
  ...
  DS_CMD_MPPM_AP_ASSIST_INTENT_RESP_TIMER_CB             = 5035,
 ...
 /*-------------------------------------------------------------------------
  ...
  DS_CMD_IWLAN_S2B_TUNNEL_DOWN_CMD                   = 7073,
  DS_CMD_IWLAN_S2B_UNTHROTTLE_IWLAN_WWAN_LOSS_EV     = 7074,
  /*-------------------------------------------------------------------------
