...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsmgr/inc/ds3gmgrint.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
---------------------------------------------------------------------------*/
#define DS3GI_MAX_NUM_CALLS  CMCALL_MAX_CALL_ID
...
typedef struct
{
  ...
  boolean                    call_end_recd; /* Set if a call_end is received */
  uint32                     call_time_orig; /* Time the call was originated */
