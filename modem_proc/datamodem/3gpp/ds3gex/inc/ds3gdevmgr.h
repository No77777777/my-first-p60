...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ds3gex/inc/ds3gdevmgr.h#3 $
...
(
  ps_sys_apn_info_type       *apn_info_p,
  sys_modem_as_id_e_type      subs_id
);
...
/*===========================================================================
FUNCTION DS3GDEVMGR_GET_INTERNET_PROF_FROM_APN_INFO

DESCRIPTION
  This function gets the configured internet APN profile number from
  APN settings if available

PARAMETERS
  internet_apn_ptr   -- Pointer to APN name
...
RETURN VALUE
  TRUE   -- If internet APN is configured in APN info
  FALSE  -- Otherwise

SIDE EFFECTS

===========================================================================*/
boolean ds3gdevmgr_get_internet_prof_from_apn_info
(  
  byte                            *profile_number, 
  sys_modem_as_id_e_type           subs_id
);
