...
/*===========================================================================
  ...
  $PVCSPath: $
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/ds3gex/inc/ds3gsubsmgr.h#4 $ 
  $DateTime: 2024/05/06 04:25:26 $ 
  $Author: pwbldsvc $
...
#define DS3GSUBSMGR_ARRSIZE(a) (sizeof(a)/sizeof(a[0]))
...
/*---------------------------------------------------------------------------
  Array to store info about IMS capability for each sub
---------------------------------------------------------------------------*/
extern boolean ds3gsubsmgr_ims_capability[DS3GSUBSMGR_SUBS_ID_MAX];
...
#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
FUNCTION ds3gsubsmgr_qsh_mdump_collect
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void ds3gsubsmgr_qsh_mdump_collect
(
  void
);
#endif
...
/*===========================================================================
FUNCTION      DS3GSUBSMGR_SET_DEF_DATA_SUBS_ID_EX

DESCRIPTION   This function updates the default data subscription id in 
              ds3g subs mgr state info along with the DDS switch type.
...
SIDE EFFECTS  None.
===========================================================================*/
void ds3gsubsmgr_set_def_data_subs_id_ex
(
  sys_modem_as_id_e_type  subs_id,
  cm_dds_cause_e_type     dds_switch_type
);
...
/*===========================================================================
FUNCTION      DS3GSUBSMGR_IS_DEVICE_SINGLE_SIM_MODE

DESCRIPTION   This function returns TRUE if the device is single sim mode.

DEPENDENCIES  None.

RETURN VALUE  TRUE:     the device mode is single sim mode 
              FALSE:    the device mode is not single sim mode

SIDE EFFECTS  None.
===========================================================================*/
boolean ds3gsubsmgr_is_device_single_sim_mode(void);

/*===========================================================================
FUNCTION      DS3GSUBSMGR_IS_DEVICE_MULTI_SIM_MODE

DESCRIPTION   This function returns TRUE if the device is DSDS or TSTS mode.

DEPENDENCIES  None.

RETURN VALUE  TRUE:     device mode is multi sim mode 
              FALSE:    device mode is not multi sim mode

SIDE EFFECTS  None.
===========================================================================*/
boolean ds3gsubsmgr_is_device_multi_sim_mode(void);
...
/*===========================================================================
FUNCTION      DS3GSUBSMGR_SUBS_ID_DSPROFILE_TO_CM
...
SIDE EFFECTS  None.
===========================================================================*/
sys_modem_as_id_e_type ds3gsubsmgr_subs_id_dsprofile_to_cm
(
...
/*===========================================================================
FUNCTION      DS3GSUBSMGR_IS_PS_SUBS_ID_VALID
...
SIDE EFFECTS  None.
===========================================================================*/
boolean ds3gsubsmgr_is_ps_subs_id_valid
(
...
/*===========================================================================
FUNCTION      DS3GSUBSMGR_GET_DDS_SWITCH_TYPE

DESCRIPTION   This function returns DDS switch type

DEPENDENCIES  None.

RETURN VALUE  DDS switch type

SIDE EFFECTS  None.
===========================================================================*/
cm_dds_cause_e_type ds3gsubsmgr_get_dds_switch_type( void );

/*===========================================================================
FUNCTION       DS3GSUBSMGR_CHECK_AND_NOTIFY_CDMA_CAPABILITY

DESCRIPTION    This function checks if the subs capability is CDMA capable
               and notifes it to the clients
...
void ds3gsubsmgr_check_and_notify_cdma_capability
(
  sys_modem_as_id_e_type    cm_subs_id,
  sys_sys_mode_mask_e_type  subs_capability
);
...
/*===========================================================================
FUNCTION       DS3GSUBSMGR_READ_POLICYMAN_CFG

DESCRIPTION     This function reads policymanager config
...
===========================================================================*/
void ds3gsubmgr_read_policyman_cfg(void);

/*===========================================================================
FUNCTION      DS3GSUBSMGR_SET_TEMP_DDS_SUBS_ID

DESCRIPTION   This function updates the temp dds subscription id 
...
SIDE EFFECTS  None.
===========================================================================*/
void ds3gsubsmgr_set_temp_dds_subs_id
(
  sys_modem_as_id_e_type        local_temp_dds_sub,
  ps_sys_subscription_enum_type inform_qmi_dds_sub
);
/*===========================================================================
FUNCTION      DS3GSUBSMGR_GET_TEMP_DDS_SUBS_ID

DESCRIPTION   This function get the temp dds subscription id 
...
SIDE EFFECTS  None.
===========================================================================*/
sys_modem_as_id_e_type ds3gsubsmgr_get_temp_dds_subs_id(void);

/*===========================================================================
FUNCTION      DS3GSUBSMGR_SET_DEVICE_SIM_MODE

DESCRIPTION   This function updates the current device sim mode.
              and if it changed from ssim to msim or vice versa,trigger
              event DS3GEVENTMGR_DEVICE_SIM_MODE_CHANGE_EV
...
SIDE EFFECTS  None.
===========================================================================*/
void ds3gsubsmgr_set_device_sim_mode(void);
