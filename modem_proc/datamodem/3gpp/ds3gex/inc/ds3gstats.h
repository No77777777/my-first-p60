...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/ds3gex/inc/ds3gstats.h#3 $ $DateTime: 2021/02/08 22:33:06 $ $Author: pwbldsvc $
...
#ifdef FEATURE_DATA_POWER_STATS
...
SIDE EFFECTS  None
===========================================================================*/
void ds3g_stats_init_complete_cmd(void);
