...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/ds3gex/inc/ds3gstkproc.h#2 $
...
/*===========================================================================
FUNCTION      DS3GSTKPROC_PROCESS_GET_PREVIOUS_RAT_INFO

DESCRIPTION   Processes the PS_SYS_IOCTL_3GPP_GET_PREV_RAT_INFO IOCTL
...
int ds3gstkproc_process_get_previous_rat_info
(
  void                    *arg_val_ptr,
...
/*===========================================================================
FUNCTION      DS3GSTKPROC_PROCESS_HANDLE_CDMA_CONDITION_FOR_DDS_SWITCH

DESCRIPTION   This function parses the cached SS event stacks for the 
              special case when 1x is camped on the main stack for non DDS
              and DDS switches to the non DDS.
...
SIDE EFFECTS  None.
===========================================================================*/
boolean ds3gstkproc_handle_cached_cdma_condition_for_dds_switch
(
  ds3gsubsmgr_subs_id_e_type  subs_id
);

/*===========================================================================
FUNCTION      DS3GSTKPROC_POST_TAC_LAC_CHG_CMD

DESCRIPTION 
  This function post ds cmd for TAC/LAC CHG
...
SIDE EFFECTS 
  None.
===========================================================================*/
void  ds3gstkproc_post_tac_lac_chg_cmd
(
  sys_modem_as_id_e_type  subs_id,
...
/*===========================================================================
FUNCTION      DS3GSTKPROC_PROCESS_TAC_LAC_INFO

DESCRIPTION 
  This function is used to process TAC/LAC info

DEPENDENCIES 
  None
 
PARAMETERS 
  ss_info_ptr- CM ss event pointer
...
SIDE EFFECTS 
  None
===========================================================================*/
void ds3gstkproc_process_tac_lac_info
(
  const cm_mm_msim_ss_info_s_type  *ss_info_ptr
);

/*===========================================================================
FUNCTION      DS3GSTKPROC_CHECK_NULL_BEARER_REASON

DESCRIPTION 
  This function is used to check the specific reason for null bearer using the srv_domain
  and srv_status info
...
PARAMETERS 
  mode         - sys mode. For CDMA/HDR, there is no CS or PS domain concept
  srv_domain   - specifically check for CS_ONLY for LTE
  srv_status   - specifically check for NO_SRV and LIMITED_SRV
  subs_id      - subscription ID
...
SIDE EFFECTS 
  None
===========================================================================*/
void ds3gstkpro_check_null_bearer_reason
(
