...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_bearer_flow_manager.h#2 $
...
#define DS_FLOW_EXT_QOS_MULTIPLIER_ENTRIES              21

#define DS_FLOW_EXT_QOS_200KB_MULTIPLIER_RANGE_KBPS     13107000           
#define DS_FLOW_EXT_QOS_200KB_MULTIPLIER_KBPS           200
#define DS_FLOW_EXT_QOS_200KB_MULTIPLIER_OCTET_VAL      1

#define DS_FLOW_EXT_QOS_1MB_MULTIPLIER_RANGE_KBPS       65535000
#define DS_FLOW_EXT_QOS_1MB_MULTIPLIER_KBPS             1000
#define DS_FLOW_EXT_QOS_1MB_MULTIPLIER_OCTET_VAL        2

#define DS_FLOW_EXT_QOS_MAX_BIT_VALUE                   20000
#define DS_FLOW_EXT_QOS_MIN_BIT_VALUE                   0
#define DS_FLOW_EXT_QOS_UNUSED_MULTIPLIER_OCTET_VAL     0

#define DS_FLOW_UMTS_BASE_OCTET_MAX_BITRATE_KBPS        8640
#define DS_FLOW_UMTS_EXT_OCTET_MAX_BITRATE_KBPS         256000
#define DS_FLOW_UMTS_EXT2_OCTET_MAX_BITRATE_KBPS        10000000

#define DS_FLOW_EXT_QOS_MAX_MULTIPLIER_RANGE_KBPS       20000000
...
#define DS_3GPPI_FLOW_VFR_CALL_PER_BEARER(ftbl, rval, func, bearer_context_p, ...) \
        {                                                                     \
...
{
  byte      ext_qos_unit;
  uint64    multiplier_val_kbps;
}ds_flow_manager_ext_qos_unit_map_s_type;
...
#ifdef FEATURE_LAPP
  ext_qos_T             ext_qos; /* ext QoS in WCDMA */ 
#endif /* FEATURE_LAPP */
...
PARAMETERS
 ...
 extended_nw_qos   - Extended network QoS to be filled
...
PARAMETERS 
  ...
  ext_nw_qos      -  Ext QOS to be converted
  app_qos         -  Application qos structure
  cause_code_p    - Internal cause code type
...
PARAMETERS
  app_flow_spec -  App Qos
  nw_qos        -  network Qos
  extended_qos  - Extended network QoS
  subs_id       -  Subscription Id
...
PARAMETERS
  bflow_manager_p  -  Pointer to bearer flow context
  nw_qos           -  Network QoS to be converted
  nw_extended_qos  -  Extended network QoS to be converted
  app_qos          -  Application qos structure 
  cause_code_p     -  Internal error cause code ptr
  subs_id          -  Subscription ID
...
/*===========================================================================
FUNCTION ds_bearer_flow_manager_copy_qos_params

DESCRIPTION
  This function copies Transfer delay, delivery order 
  and erroneous sdus from network granted QoS.

PARAMETERS
  *req_flow  ptr to flow
  neg_qos   network QoS
...
void ds_bearer_flow_manager_copy_qos_params
(
  ip_flow_type *req_flow,
  qos_T        *neg_qos
);

/*===========================================================================
FUNCTION ds_bearer_flow_manager_get_bearer_from_bearer_id

DESCRIPTION
  This function is used to find the bearer context, given a EPS/NSAPI bearer id
...
RETURN VALUE
  Pointer to the bearer context if there is a EPS/NSAPI bearer ID match
...
===========================================================================*/
ds_bearer_context_s* ds_bearer_flow_manager_get_bearer_from_bearer_id
(
  uint8                  bearer_id,
  sys_modem_as_id_e_type subs_id
);
...
#ifdef FEATURE_LAPP
/*===========================================================================
FUNCTION DS_BEARER_FLOW_CONVERT_EXT_QOS_NW_BIT_RATE

DESCRIPTION
  Converts the NW passed extended QoS bit rate to an uint64 value.

PARAMETERS
  input         -  network octet to be converted
  unit          -  Octet 3 or 8 which specifies the unit for mbr or gbr
                   conversion
...
RETURN VALUE
  uint64          - return converted bit rate in bps
  
SIDE EFFECTS
  None.

===========================================================================*/
uint64 ds_bearer_flow_convert_ext_qos_nw_bit_rate
(
  uint16                input,
  byte                  unit
);
...
/*==========================================================================
FUNCTION DS_3GPP_UMTS_BEARER_FLOW_CONVERT_DATA_RATE_TO_R7_EXT2_DECODE_VAL

DESCRIPTION
  Converts Netw encoded data rate to UMTS data rate if extended2 bit is set
...
LIMITATIONS
  none
===========================================================================*/
uint32 ds_3gpp_umts_bearer_flow_convert_data_rate_to_r7_ext2_decode_val
(
  uint8  encoded_data_rate
);
