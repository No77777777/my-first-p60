...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_flow_context.h#2 $
...
DESCRIPTION
  This function gets the Subscription id from flow context pointer.

PARAMETERS
  flow_context_p - flow context ptr
...
RETURN VALUE
 TRUE- if successfull
 FALSE- invalid flow ptr/invalid SUBS_ID
  
SIDE EFFECTS
  None.

===========================================================================*/
boolean ds_flow_context_get_subs_id_from_flow
(
  ds_flow_context_s      *flow_context_p,
...
/*===========================================================================
FUNCTION ds_flow_context_get_flow_filters_from_bearer_id

DESCRIPTION
  This function gets the flow filter information from the bearer id
...
===========================================================================*/
boolean ds_flow_context_get_flow_filters_from_bearer_id
( 
  uint8                               bearer_id,
