...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_flow_manager.h#3 $
...
{  
  uint32              cookie; 
    /* Cookie to ensure dynamic allocation is successful*/
  ds_pdn_context_s   *pdn_ptr;
    /* PDN associated with the flow manager */
  uint32              fi_preced[DS_FI_PRECED_ARR_SIZE];
    /*bitmask of the Filter precedence in use*/
  uint32              req_fi_preced[DS_FI_PRECED_ARR_SIZE];
    /*bitmask of the requested Filter prece*/
  list_type           bearer_flow_mgr;
    /*bearers associated with this PDN*/
  void *              vobj_data_ptr_tbl[DS_3GPPI_SYS_MODE_MAX];
    /* Mode specific data*/
  list_type           pending_flow_cntx;
    /*Pending UE initiated requests*/
  ds_3gpp_bcm_info_e  bcm_info;
...
typedef enum
{
  DS_3GPP_FILTER_IP_NONE                  = 0x0,
  DS_3GPP_FILTER_IP_V4                    = 0x1,
  DS_3GPP_FILTER_IP_V6                    = 0x2,
} ds_3gpp_tft_iptype_mask;
...
typedef struct 
{
  ...
  /*---------------------------------------------------------------------------
    ...
    Make 3rd param Void * to remove the dependency
  ---------------------------------------------------------------------------*/
...
(
  ...
  boolean              preced_conflict_on_same_bearer
  /*lint -esym(715,argval_ptr) */
);
...
/*===========================================================================
FUNCTION DS_FLOW_MANAGER_VALIDATE_FLOW_MANAGER_INTERNAL

DESCRIPTION
  This function checks if the flow manager tbl has been allocated dynamic
  memory.  It will not print the F3 message out.
...
===========================================================================*/
boolean ds_flow_manager_validate_flow_manager_internal
(
