...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_rpm.h#2 $
...
typedef struct
{
  rex_timer_type                     rpm_sampling_tmr;
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void ds_3gpp_rpm_qsh_mdump_collect
(
  void
);
#endif
...
DESCRIPTION
  ...
  plmn_id when the DS3G plmn cache is well defined (not in a transient state)
...
SIDE EFFECTS
  None.
===========================================================================*/
boolean ds_3gpp_rpm_write_throttle_params_for_current_plmn
(
  byte *apn,
  sys_modem_as_id_e_type  subs_id
);
...
/*===========================================================================
FUNCTION DS_3GPP_RPM_START_SAMPLING_TIMER

DESCRIPTION
  This function calculates the minimum of backoff/lr3/hourly timers for all
  valid apns in the apn throttle table and starts sampling for the shortest
  timer val (if its > EFS_FLUSH_TIME, then sampling timer duration is kept at
  90s).
 
  If sampling timer is already running , then a fresh calculation is made
  and timer restarted
 
  After timer expiry, the remainder timer values for all the timers are
  persistently stored into the EFS and sampling timer is restarted again
...
SIDE EFFECTS
  None.
===========================================================================*/
void ds_3gpp_rpm_start_sampling_timer
(
  sys_modem_as_id_e_type   subs_id
);
/*===========================================================================
...
/*===========================================================================
FUNCTION DS_3GPP_RPM_WRITE_REMAINING_LR3_TMR_VAL_INTO_EFS

DESCRIPTION
  This function fetches the remaining LR3 timer value and writes to EFS.
  If LR3 timer is not running, it will write 0 as remaining timer val
...
SIDE EFFECTS
  None.
===========================================================================*/
void ds_3gpp_rpm_write_remaining_lr3_tmr_val_into_efs
(
  sys_modem_as_id_e_type subs_id
);
/*===========================================================================
FUNCTION DS_3GPP_RPM_LR3_GET_REMAINING_LR3_TIME

DESCRIPTION
  This function returns the remaining LR3 time in milliseconds, if running
...
RETURN VALUE 
  uint32 - remaining LR3 time.  

SIDE EFFECTS 
  None.
  
===========================================================================*/
uint32 ds_3gpp_rpm_get_remaining_lr3_timer_val
(
  sys_modem_as_id_e_type  subs_id
);
/*===========================================================================
...
/*===========================================================================
FUNCTION DS_3GPP_RPM_INFO_TBL_PER_SUBS_INIT
...
SIDE EFFECTS
  None.
===========================================================================*/
void ds_3gpp_rpm_info_tbl_per_subs_init
(
   sys_modem_as_id_e_type subs_id
);
