...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_cc_sp_throt_config.h#2 $
...
/*===========================================================================
FUNCTION      DS_3GPP_CC_SP_THROT_GET_ADDITIONAL_PDN_UNBLOCK_TIMER_VAL

DESCRIPTION   This function provides the additional pdn unblock timer value
              configured in EFS

PARAMETERS    

RETURN VALUE  additional pdn unblock timer value in msecs

SIDE EFFECTS  None
===========================================================================*/
uint32 ds_3gpp_cc_sp_throt_get_additional_pdn_unblock_timer_val
(
   void
);
