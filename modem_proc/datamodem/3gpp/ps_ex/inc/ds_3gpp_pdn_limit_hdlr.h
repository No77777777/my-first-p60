...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_pdn_limit_hdlr.h#2 $
...
#ifdef FEATURE_QSH_MDUMP
/*===========================================================================
FUNCTION ds_3gpp_pdn_limit_qsh_mdump_collect
...
===========================================================================*/ 
QSH_MDUMP_FN_ATTR 
void ds_3gpp_pdn_limit_qsh_mdump_collect
(
  void
);
#endif
