#ifndef DS_3GPP_PDN_THROTTLE_CONFIG_H
#define DS_3GPP_PDN_THROTTLE_CONFIG_H
...
$Header: //components/rel/data.mpss/3.5..2.1/3gpp/ps_ex/inc/ds_3gpp_pdn_throt_config.h#2 $
...
/* max number of pdn failure timers */
#define DS_3GPP_PDN_THROTTLE_MAX_FAILURE_TIMERS    10  
/* min number of failure timers */
#define DS_3GPP_PDN_THROTTLE_MIN_FAILURE_TIMERS    1   
/* ref cnt to fill from 6-10 failure timers */
#define DS_3GPP_PDN_THROTTLE_REF_FAILURE_TIMERS    6   
/* Min number for IOT failures before throttling
   can kick in */
#define DS_3GPP_PDN_THROTTLE_MIN_IOT_FAILURE_COUNT 3  
...
#endif/*DS_3GPP_PDN_THROTTLE_CONFIG_H*/
