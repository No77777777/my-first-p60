...
ds_3gpp_profile_cache_update_enum_type ds_3gpp_profile_cache_write_lte_roaming_pdp_type
(
   ds_profile_db_profile_num_type  profile_number,
   const ds_profile_db_3gpp_tech_params_type *ds_3gpp_tech_params_ptr,
   const ds_profile_db_gen_params_type       *gen_params,
...
ds_3gpp_profile_cache_update_enum_type ds_3gpp_profile_cache_write_umts_roaming_pdp_type
(
   ds_profile_db_profile_num_type  profile_number,
   const ds_profile_db_3gpp_tech_params_type *ds_3gpp_tech_params_ptr,
   const ds_profile_db_gen_params_type       *gen_params,
