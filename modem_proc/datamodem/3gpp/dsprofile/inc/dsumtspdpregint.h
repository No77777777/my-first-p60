...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsprofile/inc/dsumtspdpregint.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
/*------------------------------------------------------------------------
  Profile Name/ Signature for modem created AP default profile.
  Note: profile name len <= 15
-------------------------------------------------------------------------*/
#define DS_3GPP_PROFILE_MODEM_AP_DEF_PROF_SIG  "modem_def_prof"
...
#define DS_3GPP_PROFILE_AP_EMBD_PROF_NUM "/pdp_profiles/ap_embd_call_prof_num"
#define DS_3GPP_PROFILE_AP_TETH_PROF_NUM "/pdp_profiles/ap_teth_call_prof_num"

/*--------------------------------------------------------------------------
  Enum to indicate if profile parameter was written properly
-------------------------------------------------------------------------*/
typedef enum
{
  DS_3GPP_PROFILE_CACHE_UPDATE_SUCCESS = 0,
...
DESCRIPTION
  This function retrieves "profile label" for a profile
...
RETURN VALUE
  TRUE       : if profile number is the modem default profile
  FALSE      : Otherwise
...
/*===========================================================================
FUNCTION DS_UMTS_PDP_CONTEXT_GET_APN_NAME

DESCRIPTION
  This function retrieves the Internet/IMS APN Name

PARAMETERS
  internet_apn_p: Pointer to the Internet APN which will
                  be filled in this Function
  subs_id:        Subscription Id
  apn_type:       IMS or Internet
