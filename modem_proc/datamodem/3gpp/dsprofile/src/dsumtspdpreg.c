...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/dsprofile/src/dsumtspdpreg.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
  ...
  DS3GPP_ASSERT(status == DS_UMTS_PDP_SUCCESS);
  return status;
#else
