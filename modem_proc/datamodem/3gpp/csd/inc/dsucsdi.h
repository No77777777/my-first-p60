...
/*===========================================================================
  ...
  $PVCSPath: $
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/inc/dsucsdi.h#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
#define DSM_ENQUEUE(wm_ptr,item)                                    \
   if(wm_ptr) {                                                     \
     ...
     DATA_MSG0_ERROR("Attempt to dsm_enqueue on NULL watermark");   \
   } 
...
#define EMPTY_WATERMARK(wm_ptr)                                     \
  if(wm_ptr) {                                                      \
     ...
     DATA_MSG0_LOW("Attempt to dsm_empty_queue on NULL watermark"); \
   } 
