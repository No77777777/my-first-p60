...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/src/dswcsdmshif.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
  ...
  DATA_CSD_MSG3_MED("dswcsd_init_call_info(): bytes_per_sdu %d  sdus_per_tti %d  CM callID=%d",
...
/*-------------------------------------------------------------------------*/
  ...
  DATA_CSD_MSG1_LOW("SYNC_TEST_APP_ENABLED_I is %d",
