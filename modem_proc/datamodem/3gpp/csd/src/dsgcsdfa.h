...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/src/dsgcsdfa.h#2 $
...
#define FA_MSG_STATE(old_state, new_state,in_sync)    \
  DATA_CSD_MSG3_HIGH("State change: S%d -> S%d sync=%d",     \
...
#define DSGCSDFA_TIMER_CLR(_timer_ptr, _signal) \
  ...
  { \
    DATA_CSD_MSG0_ERROR("Attempt to clear NULL FA timer"); \
  }
