...
/*=============================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/src/dst31sop.c#2 $
...
)
{
  ...
  */
  DATA_CSD_MSG0_LOW("dst31i_sop_idle_state() erroneously accessed!");
} /* dst31i_sop_idle_state */
...
)
{
  ...
  DATA_CSD_MSG0_LOW("WFO start state initialization");
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("WFO state initialized");
} /* dst31i_sop_wait_for_order_state */
...
)
{
  ...
  DATA_CSD_MSG0_LOW("+FTH start state initialization");
  ...
  */
  ...
  DATA_CSD_MSG1_LOW("+FTH: preamble active, size=%d",
    DST31_FTH_MAX_PREAMBLE_SIZE);
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FTH state initialized");
} /* dst31i_sop_fth_state */
...
)
{
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FRH start state initialization");
  ...
  */
  DATA_CSD_MSG1_LOW( "+FRH::Setting +CD timer=%dms", DST31_CD_TIMEOUT);

  DST31_TIMER_SET("+CD", t31_ctrl_blk->timer_ptr,
    DST31_CD_TIMEOUT, DST31_CD_TIMER_TYPE);  /*lint !e506 !e774*/

  DATA_CSD_MSG0_LOW("+FRH state initialized");
} /* dst31i_sop_frh_state */
...
)
{
  ...
  DATA_CSD_MSG0_LOW("+FTM start state initialization");
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FTM state initialized");
} /* dst31i_sop_ftm_state */
...
)
{
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FRM start state initialization");
  ...
  ** continue to wait for data.
  */
  DATA_CSD_MSG1_LOW("+FRM::Setting +CD timer=%dms", DST31_CD_TIMEOUT);

  DST31_TIMER_SET("+CD", t31_ctrl_blk->timer_ptr,
    DST31_CD_TIMEOUT, DST31_CD_TIMER_TYPE);  /*lint !e506 !e774*/

  DATA_CSD_MSG0_LOW("+FRM state initialized");
} /* dst31i_sop_frm_state */
...
)
{
  ...
  DATA_CSD_MSG0_LOW("+FTS start state initialization");
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FTS state initialized");
} /* dst31i_sop_fts_state */
...
)
{
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FRS start state initialization");
  ...
  */
  ...
  DATA_CSD_MSG0_LOW("+FRS state initialized");
} /* dst31i_sop_frs_state */
