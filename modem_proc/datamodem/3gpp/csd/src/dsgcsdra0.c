...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/src/dsgcsdra0.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
   ...
   switch (data_rate)
   {
      ...
      default:
         DS_3GPP_MSG1_LOW("Unsupported user rate=%d",(int)data_rate);
         break;
   }
