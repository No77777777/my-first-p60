...
/*=============================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/src/dst31i.h#2 $
...
#define DST31_SIO_FLOWCTL_ASSERT() \
  ...
  { \
    DATA_CSD_MSG0_HIGH("SIO-UL:Manual flowctl ASSERTED"); \
...
#define DST31_SIO_FLOWCTL_DEASSERT() \
  ...
  { \
    DATA_CSD_MSG0_HIGH("SIO-UL:Manual flowctl DEASSERTED"); \
...
#define DST31_T30_SET_TRAINING_PHASE_ACTIVE() \
  ...
  { \
    DATA_CSD_MSG0_HIGH("Training Phase started"); \
...
#define DST31_T30_SET_TRAINING_PHASE_INACTIVE() \
  ...
  { \
    DATA_CSD_MSG0_HIGH("Training Phase completed"); \
...
#define DST31_TIMER_SET(_label, _timer_ptr, _timer_cnt, _timer_type) \
  ...
  { \
    ...
    { \
      DATA_CSD_MSG2_HIGH("Overriding timer, curr=%d next=%d", \
