...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/3gpp/csd/src/dsucsdbc.c#2 $ $DateTime: 2019/10/22 02:53:17 $ $Author: pwbldsvc $
...
)
{
   ...
   DATA_CSD_MSG6(MSG_LEGACY_LOW,"BC Valid=%d,RCR=%d,CodeSt=%d, BC XferMode=%d,ITC=%d,OITC=%d,",
                                   bc->present,
   ...
   DATA_CSD_MSG3_LOW("BC SpchVerPref#1=%d,#2=%d,#3=%d",bc->gsm_speech_ver_pref_1,
                                              bc->gsm_speech_ver_pref_2,
                                              bc->gsm_speech_ver_pref_3);
#endif

   DATA_CSD_MSG9(MSG_LEGACY_LOW,"BC Comp=%d,Struct=%d,DplxMode=%d, BC Config=%d,NIRR=%d,Establish=%d,"
   ...
   DATA_CSD_MSG9(MSG_LEGACY_LOW,"BC Lay1ID=%d,UIL1Proto=%d,SyncAsync=%d, BC StopBits=%d,Neg=%d,DataBits=%d,"
   ...
   DATA_CSD_MSG9(MSG_LEGACY_LOW,"BC Nic_Rx=%d,Parity=%d,CE=%d, BC MT=%d,OMT=%d,FNUR=%d,"
   ...
   DATA_CSD_MSG6(MSG_LEGACY_LOW,"BC WAIUR=%d,AsymInd=%d,Lay2ID=%d, BC UIL2Prot=%d,FallBackRate=%d,"
                              "BC OtherRateAdapt=%d ",
...
)
{
   ...
   DS3GPP_ASSERT( NULL != service_ptr );
...
{
   DS3GPP_ASSERT( NULL != bc );
   DS3GPP_ASSERT( NULL != chosen_capability );
   DS3GPP_ASSERT( NULL != service_ptr );  
...
)
{
  ...
  */
  ...
  else
  {
    ...
    {
       DATA_CSD_MSG1_LOW("Unsupported rate adaption %d, assuming V.110",
                  bc->rate_adaption);
       llc->user_information_layer_1_protocol  = CCITT_V110;
    }
  }
   ...
   */
               ...
               ( capability->fixed_network_user_rate == FNUR_64K) ) )
   {
      ...
      if ( capability->rate_adaption == V110_X30 )
      {
         ...
         DATA_CSD_MSG0_HIGH( "Negotiate RA to X.31FS");
      }
   }
   ...
   if ( network_mode == SYS_SYS_MODE_GSM ) 
   {
           ...
           (capability->fixed_network_user_rate != FNUR_NOT_APPLICABLE) )
      {
         ...
         if( capability->information_transfer_capability == ITC_FAX_G3)
         {
            ...
            DATA_CSD_MSG0_LOW("DS: Negotiating 14400 MT FAX to 9600");
         }
         ...
         else
         {
           ...
           {
             DATA_CSD_MSG0_LOW("MT FNUR not supported, negotiating to FNUR_14400\n");
             capability->fixed_network_user_rate = FNUR_14400;
             capability->wanted_air_interface_user_rate = WAIUR_14400;
           }
           else
           {
             DATA_CSD_MSG0_LOW("MT FNUR not supported, negotiating to FNUR_9600\n");
   ...
   if ( DS_UCSD_IS_WCDMA_TDS_MODE(network_mode) ) 
   {
      ...
      */
            ...
            ( capability->connection_element == TRANSPARENT_DATA ) )
       {
                ...
                sizeof(wcsd_supported_bc_fixed_network_user_rate) ) == FALSE )
         {
           ...
           /* capability->fixed_network_user_rate = FNUR_64K; */
           DATA_CSD_MSG1_LOW("FNUR not supported for sync/transparent: %d",
                      capability->fixed_network_user_rate);
           c_capability_ok = FALSE;        
         }
     ...
     */
     ...
     {        
         ...
         DATA_CSD_MSG1_LOW( "Negotiate WAIUR to %d",
...
)
{
   ...
   */
   ...
   {
      DATA_CSD_MSG2_LOW("UCSD BC reject ITC = %d (mode=%d)",
   ...
   */
   ...
   {
      DATA_CSD_MSG1_LOW("UCSD BC reject user_rate = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_structure)))
   {
      ...
      DATA_CSD_MSG1_LOW("UCSD BC reject structure = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_duplex_mode)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject duplex_mode = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_signalling_access_protocol)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject Signalling Access Protocol = %d",
   ...
   */
          ...
          )
   {
      ...
      DATA_CSD_MSG1_LOW("UCSD BC reject sync_async = %d",
   ...
   */
          ...
          )
   {
      ...
      DATA_CSD_MSG0_LOW("UCSD BC reject WCDMA FAX");
   ...
   */
            ...
            ) )
   {
      ...
      DATA_CSD_MSG0_LOW( "UCSD BC reject ASYNC/NT FAX");
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_coding_standard)))
   {
      ...
      DATA_CSD_MSG1_LOW("UCSD BC reject coding_standard = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_transfer_mode)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject transfer_mode = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_configuration)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject configuration = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_NIRR)))
   {
      ...
      DATA_CSD_MSG1_LOW("UCSD BC reject NIRR = %d",
                requested_bc->NIRR);
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_establishment)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject establishment = %d",
   ...
   */
                            ...
                            sizeof(ucsd_supported_bc_user_information_layer_1_protocol)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject user_information_layer_1_protocol = %d",
   ...
   */
   ...
   {
      DATA_CSD_MSG1_LOW( "UCSD BC reject negotiation = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_intermediate_rate)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject intermediate_rate = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_NIC_on_Tx)))
   {
     ...
     DATA_CSD_MSG1_LOW( "UCSD BC reject NIC_on_Tx = %d",
   ...
   */
                             ...
                             sizeof(ucsd_supported_bc_NIC_on_Rx)))
   {
      ...
      DATA_CSD_MSG1_LOW( "UCSD BC reject NIC_on_Rx = %d",
   ...
   if (capability_ok && check_all)
   {
      ...
      */
      ...
      {
         DATA_CSD_MSG2_LOW( "UCSD BC reject RCR = %d (ITC=%d)",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_rate_adaption)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject rate_adaption = %d",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_other_rate_adaption)))
      {
        ...
        DATA_CSD_MSG1_LOW( "UCSD BC reject other_rate_adaption = %d",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_number_of_data_bits)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject number_of_data_bits = %d",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_number_of_stop_bits)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject number_of_stop_bits = %d",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_parity)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject parity = %d",
                   requested_bc->parity );
      ...
      */
      ...
      {
         DATA_CSD_MSG2_LOW( "UCSD BC reject CE=%d (sync_async=%d)",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_user_information_layer_2_protocol)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject user_information_layer_2_protocol = %d",
                                ...
                                sizeof(ucsd_supported_bc_user_initiated_modification_indication)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject user_initiated_modification_indic=%d",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_acceptable_channel_codings)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject acceptable_channel_codings = %d",
      ...
      */
                                ...
                                sizeof(ucsd_supported_bc_maximum_number_of_trafic_channels)))
      {
         ...
         DATA_CSD_MSG1_LOW( "UCSD BC reject maximum_number_of_trafic_channels = %d",
      ...
      */
      ...
      {
         DATA_CSD_MSG2_LOW( "UCSD BC reject WAIUR = %d (mode=%d)",
   ...
   if( capability_ok )
   {
      ...
      {
         DATA_CSD_MSG0_LOW( "UCSD LLC not present");
      }
      else
      {
         DATA_CSD_MSG0_LOW( "UCSD LLC present" );
         ...
         {
            DATA_CSD_MSG1_LOW( "UCSD LLC coding_standard wrong = %x",
         ...
         {
            DATA_CSD_MSG1_LOW( "UCSD LLC itc wrong = %x",
                       requested_llc->information_transfer_capability );
         }
                                         ...
                                         sizeof(ucsd_supported_llc_transfer_mode)))
         {
            ...
            DATA_CSD_MSG1_LOW( "UCSD LLC transfer_mode wrong = %x",
         ...
         {
            DATA_CSD_MSG1_LOW( "UCSD LLC ucsd_supported_llc_information_transfer_rate wrong = %x",
                         requested_llc->information_transfer_rate);
         }
         ...
         {
            DATA_CSD_MSG1_LOW( "UCSD LLC user_information_layer_1_protocol wrong = %x",
                                        ...
                                        sizeof(ucsd_supported_llc_sync_async)))
         {
            ...
            DATA_CSD_MSG1_LOW( "UCSD LLC sync_async wrong = %x",
                                          ...
                                          sizeof(ucsd_supported_llc_negotiation)))
         {
            ...
            DATA_CSD_MSG1_LOW( "UCSD LLC negotiation wrong = %x",
         ...
         else if (requested_llc->user_information_layer_1_protocol == CCITT_V110)
         {
            ...
            {
               DATA_CSD_MSG1_LOW( "UCSD LLC intermediate_rate wrong = %x",
                            requested_llc->intermediate_rate);
                                           ...
                                           sizeof(ucsd_supported_llc_NIC_on_Rx)))
            {
               ...
               DATA_CSD_MSG1_LOW( "UCSD LLC NIC_on_Rx wrong = %x",
            ...
            {
               DATA_CSD_MSG1_LOW( "UCSD LLC flow_control_on_Tx wrong = %x",
                            requested_llc->flow_control_on_Tx);
            ...
            {
               DATA_CSD_MSG1_LOW( "UCSD LLC flow_control_on_Rx wrong = %x",
                            requested_llc->flow_control_on_Rx );
...
)
{
   ...
   */  
                                  ...
                                  DSAT_EXT_FCLASS_IDX,0,0,NUM_TYPE) == 1 )
   {
      ...
      {
         DATA_CSD_MSG1_LOW( "Originate fax call in wrong mode: mode=%d", 
                    network_mode);
      }
   }
...
#endif /* FEATURE_DUAL_SIM */
   {
     DATA_CSD_MSG0_LOW( "Failed to get calling party subaddress");
   }
#endif /* FEATURE_MMGSDI_SESSION_LIB */
...
)
{
   ...
   *sect 5.3.4.2.1 and Annex B3.1, Annex C*/
   ...
   if( req_bc_ptr->present == FALSE )
   {
      ...
      DATA_CSD_MSG0_LOW( "No Bearer Capability in SETUP message");
      ...
      {
         DATA_CSD_MSG0_LOW( "Cannot fill in Bearer Capability" );
...
)
{
  ...
  DS3GPP_ASSERT( NULL != bc1_ptr );
  DS3GPP_ASSERT( NULL != data_bc_pptr );
  ...
  if( TRUE == bc1_ptr->present )
  {
    ...
    case ITC_OTHER:
      *data_bc_pptr = bc1_ptr;
      ...
      {
        DATA_CSD_MSG1_LOW( "Unrecognized call connection_element: %d",
             (*data_bc_pptr)->sync_async);
      }

      DATA_CSD_MSG1_MED("CS Data Call Type: %d", result);
    ...
    default:
      DATA_CSD_MSG1_LOW( "Unsupported ITC: %d",
...
)
{
  ...
  if( TRUE == mode_info_ptr->info.gw_cs_call.bc_repeat_indicator.present )
  {
    ...
    DATA_CSD_MSG1_LOW( "Repeat indicator present - ri=%d", repeat_indication);
        ...
        (REPEAT_SUPPORTS_FALLBACK       == repeat_indication) )
    {
...
#endif /* FEATURE_MULTIMEDIA_FALLBACK */
      {
        ...
        DATA_CSD_MSG0_LOW( "CS Data call setup failed - conditional IE error" );
        result = FALSE;
      }
    }
    else
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  memset(allowed_flag, 0, (sizeof(uint32)*DS3G_MAX_SUBS));
  for( index = 0;index <DS3G_MAX_SUBS;index++)
  {
    ...
    if( TRUE == preferred)
    {
      ...
      *csd_mode = ds3g_get_current_network_mode_ex(subs_id);
      DATA_CSD_MSG2_LOW("Preferred mode(%d) and SUBS id (%d) VT call ; W/T only",
  ...
  if(any_allowed == FALSE)
  {
    ...
    *csd_mode     = ds3g_get_current_network_mode_ex(*csd_subs_id);
    DATA_CSD_MSG2_LOW("default voice as Preferred mode(%d) and SUBS id(%d) VT call",
          *csd_mode,*csd_subs_id);
    return;
  }
        ...
        (sys_mode_sub == SYS_SYS_MODE_TDS))
    {
           ...
           (allowed_flag[index]&DS_UCSD_TDS_ALLOWED) )
      {
        ...
        *csd_mode = sys_mode_sub;
        DATA_CSD_MSG2_LOW("Preferred mode(%d)and SUBS id(%d) VT call camped to W/T",
                 *csd_mode,*csd_subs_id);
        return;
      }
      if(0xFF == pref_index)
  ...
  if(0xFF != pref_index)
  {
    ...
    *csd_subs_id = subs_id;
    *csd_mode = ds3g_get_current_network_mode_ex(subs_id);
    DATA_CSD_MSG2_LOW("Preferred mode(%d) and SUBS id (%d) VT call ",
                 *csd_mode,*csd_subs_id);
    return;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if( ( csd_mode == NULL) || ( csd_subs_id == NULL) )
  {
    return FALSE;
  }
  ...
  *csd_mode = ds3g_get_current_network_mode_ex(*csd_subs_id);
  ...
  if( DS_UCSD_VIDEO_TELEPHONY_CALL == call_type )
  {
    ...
    {
      DATA_CSD_MSG0_HIGH( "Multi SIM Standby preference for VT call");
...
)
{
  ...
  if( ext_index != DS_UCSD_SIM_PADDING )
  {
    ...
    */
    ...
    {
      DATA_CSD_MSG1_LOW( "mmgsdi_read_record failes Status = %d", mmgsdi_status);
    }
  }
  else
  {
    ...
    if( ds_ucsd_sim_addr_info[array_index].sim_subaddress[0] != 0 )  
    {
      ...
      DATA_CSD_MSG1_LOW( "Sub Addreess Valid for Index[%d].", array_index);
    }
    else
    {
...
)
{
  ...
  else
  {
    ...
    {
      ds_ucsd_sim_addr_info[array_index].valid = TRUE;
      DATA_CSD_MSG1_LOW( "Sub Addr Data Valid for index [%d]", array_index);
    }
    else
    {
      ds_ucsd_sim_addr_info[array_index].valid = FALSE;
...
)
{
     ...
     )
  {
    ...
    if ( (mmgsdi_status = ds3g_mmgsdi_session_get_file_attr(
                                ...
                                (mmgsdi_client_data_type)client_ref)) != MMGSDI_SUCCESS )
    {
      DATA_CSD_MSG2_LOW("mmgsdi_session_get_file_attr fail."
...
)
{
  ...
  {
    DATA_CSD_MSG1_LOW("MMGSDI ERROR. Status = %d", 
              (int)status);
    return;
  }
...
)
{
  ...
  {
    DATA_CSD_MSG1_LOW( "Get file attr failed. status = %d", 
  ...
  if( (mmgsdi_status = ds3g_mmgsdi_session_read_record(
                            ...
                            (mmgsdi_client_data_type)client_ref)) != MMGSDI_SUCCESS )
  {
    DATA_CSD_MSG1_LOW( "mmgsdi_read_record failed status = %d", mmgsdi_status);
  }
...
)
{
  ...
  if( cnf_data->response_header.mmgsdi_status != MMGSDI_SUCCESS)
  {
    DATA_CSD_MSG1_LOW( "SIM read failed. status = %d", 
              cnf_data->response_header.mmgsdi_status);
    return;
  }
  client_ref = (ds_ucsd_client_ref_e_type)cnf_data->read_cnf.response_header.client_data;
  ...
  switch( client_ref )
  {
    ...
    case DS_UCSD_READ_EXT:
      ...
      {
        DATA_CSD_MSG1_LOW( "Neither SUBADDR/EXT BCD. Char = %d", 
                 (*(read_data->data_ptr + DS_UCSD_EXT1_TYPE_POS)));
      }
      break;

    default:
      DATA_CSD_MSG1_LOW( "Invalid client ref. Ignoring read cnf."
...
)
{
  ...
  DATA_CSD_MSG1_LOW( "ds_ucsd_process_mmgsdi_cmd"
...
)
{
       ...
       array_index++)
  {
    ...
    {
      DATA_CSD_MSG1_HIGH( "CARD ERROR. Session_type = %d",
               session_type);
      ds_ucsd_sim_addr_info[array_index].valid = FALSE;
      break;
    }
