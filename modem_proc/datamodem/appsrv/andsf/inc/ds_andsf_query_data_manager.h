...
void event_update_wlan_meas_info(uint32                                subs_idx,
                                 const ds_andsf_wlan_meas_info_s_type* wlan_meas_info);
...
void event_update_data_roaming_setting(uint32 subs_idx, bool data_roaming_setting);
