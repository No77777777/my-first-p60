...
typedef ds_appsrv_data_roaming_setting_s_type ds_andsf_data_roaming_setting_s_type ;
typedef ds_appsrv_iccid_info_s_type           ds_andsf_wqe_prof_iccid_info_s_type;
...
DESCRIPTION
  This is the external function called by external module, which notify
  ANDSF module the current wlan info.
...
DESCRIPTION
  This is the external function called by external module, which notify
  ANDSF module current wwan info.
...
SIDE EFFECTS
  None
===========================================================================*/
void ds_andsf_notify_wwan_ss_info(cm_ss_event_e_type ss_event, 
                                  const cm_mm_msim_ss_info_s_type *wwan_ss_info_ptr);

/*===========================================================================
FUNCTION DS_ANDSF_DATA_ROAMING_SETTING_CHG_HDLR

DESCRIPTION
  
 This function is called when ds3g get data roaming setting changes
 event
 
PARAMETERS
  data_roaming_setting_ptr[in] - pointer to data roaming setting.
                                 refer to ds_appsrv_data_roaming_setting_s_type
...
SIDE EFFECTS
  None
===========================================================================*/
void ds_andsf_data_roaming_setting_chg_hdlr
(
...
/*===========================================================================
FUNCTION DS_ANDSF_WQE_PROF_MGR_ICCID_INFO_CHG_HDLR

DESCRIPTION
  
 This function is called when ds3g get iccid info changes
 event
 
PARAMETERS
  iccid_info_ptr[in] - pointer to iccid info.
                       refer to ds_andsf_wqe_prof_iccid_info_s_type
...
SIDE EFFECTS
  None
===========================================================================*/
void ds_andsf_wqe_prof_mgr_iccid_info_chg_hdlr
(
...
void ds_andsf_notify_update_data_roaming_setting
(
  const ds_andsf_data_roaming_setting_s_type *data_roaming_setting_ptr
);
