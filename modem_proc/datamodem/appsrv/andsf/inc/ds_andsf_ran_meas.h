...
void ds_andsf_ran_meas_dsd_init(void);
...
PARAMETERS
  ...
  ds_subs_id [in] - ds subscrpition id
...
SIDE EFFECTS
  None
================================================================================*/
int ds_andsf_sys_ioctl_set_apn_call_type
(
  void                           *arg_val_ptr, 
...
SIDE EFFECTS
  None
=============================================================================*/
void ds_andsf_ran_meas_set_meas_required(uint32 subs_idx, uint8 meas_reqd_bitmask);

boolean ds_andsf_get_roaming_status(ds_sys_subscription_enum_type subs_id);
