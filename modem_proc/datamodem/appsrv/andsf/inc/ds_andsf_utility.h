...
boolean ds_andsf_is_cm_subs_id_valid(sys_modem_as_id_e_type subs_id);
...
ds_andsf_subs_idx_e_type cm_subs_id_to_andsf_index(sys_modem_as_id_e_type cm_subs_id);
sys_modem_as_id_e_type andsf_index_to_cm_subs_id(ds_andsf_subs_idx_e_type subs_idx);
