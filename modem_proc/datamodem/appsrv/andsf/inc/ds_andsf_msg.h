...
typedef enum
{
  ...
  DS_ANDSF_WQE_PROF_ACCUM_TIMER_EXPIRE,
  DS_ANDSF_WQE_PROF_POLICY_CHANGE_REQ,
  DS_ANDSF_WQE_PROF_UPDATE_WIFI_THRESHOLD_REQ,
  DS_ANDSF_WQE_MEAS_REPORT_WAIT_TIMER_EXPIRE,
...
typedef struct
{
  ...
  ps_sys_wlan_status_type       status_info;
}ds_andsf_wqe_prof_wlan_chg_event_type;
...
typedef struct
{
  ...
  union
  {
    ...
    ds_andsf_timer_expipre_event_type                 timer_expire_event;
    ...
    ds_andsf_wqe_prof_wifi_thres_ioctl_list_type      update_wqe_prof_threshold_ioctl;
    ds_andsf_policy_threshold_chg_type                policy_threshold_chg_event; 
    uint32                                            report_wait_timer_index;
    uint32                                            subs_idx;
    uint32                                            user_data;
  }msg_content;
}ds_andsf_msg_type;
