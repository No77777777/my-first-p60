...
public:
  ...
  /*UI roaming setting doesn't need clear, it's not nv_refresh based*/
  void update_data_roaming_setting(bool data_roaming_setting); 
  ...
  bool validate_apn_name(const ASString& prev_apn_name, const ASString& new_apn_name) const;
