...
--------    ---    ----------------------------------------------------------
11/02/15    youjunf  Add basic tech priority list and bitmask
...
#define DS_ANDSF_BASIC_APN_PRIORITY_MASK  0x04
...
PARAMETERS    apn_name            - APN name
              ...
              num_basic_tech            - basic_tech_priority_list size
              basic_tech_priority_list  - basic Technology priority list. This list is sorted in order of priority.
              num_tech            - tech_priority_list size
              tech_priority_list        - active Technology priority list, which exclude wwan while in roaming and data setting is disabled in roaming.
                                          This list is sorted in order of priority.
...
typedef struct
{
  ...
  uint32                            num_basic_tech;
  ds_andsf_access_tech_info_s_type  basic_tech_priority_list[DS_ANDSF_MAX_TECHS];
  uint32                            num_tech;
...
PARAMETERS    num_apn         - apn_list size
              apn_list        - apn_list, which includes basic_tech_list and active tech_list per apn
