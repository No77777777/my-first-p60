...
public:
  ...
  bool get_dual_ip_retry_status() const
  { return dual_ip_retry; }

  void set_dual_ip_retry_status(bool setval)
  { dual_ip_retry = setval; }
...
private:
  ...
  bool     dual_ip_retry; // For v4v6 iface; if v4/v6 fails, retry on v6/v4
