...
public:
  ...
  /* Handle info */
  sint15 get_dsnet_handle_id() const
  { return dsnet_handle_id; }

  bool check_dsnet_handle(sint15 dsnet_handle) const;
  bool check_dns_handle(dss_dns_session_mgr_handle_type dns_handle) const;
