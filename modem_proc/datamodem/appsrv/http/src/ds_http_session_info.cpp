...
ds_http_session_info::~ds_http_session_info()
{
  ...
  if(NULL != http_dsnet_secondary && 0 != http_dsnet_secondary->reference_counter)
  {
    --http_dsnet_secondary->reference_counter;
  }
}
...
ds_http_dsnet* ds_http_session_info::get_dsnet_secondary() const
{
  return http_dsnet_secondary;
}

void ds_http_session_info::set_dsnet_secondary(ds_http_dsnet* dsnet)
{
  http_dsnet_secondary = dsnet;
  if(NULL != http_dsnet_secondary)
  {
    ++http_dsnet_secondary->reference_counter;
  }
}
