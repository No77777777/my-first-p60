...
void ASUtils::ASTimer::start_ms(uint32 timeout_miliseconds)
{
  rex_set_timer(&timer, timeout_miliseconds);
}


bool ASUtils::ASTimer::is_active() const
{
  return ( 0 != rex_get_timer( const_cast<rex_timer_type*>(&timer) ) );
}
