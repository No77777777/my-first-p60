...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/wlan/iwlan_s2b/inc/ds_iwlan_s2b_pdn_sm.h#2 $
...
--------    ---    ----------------------------------------------------------
04/13/18    vls    Added support for IKEv2 redirect
...
typedef enum
{
  ...
  DS_IWLAN_S2B_PDN_SM_TUNNEL_REDIRECT_EV,
  ...
  DS_IWLAN_S2B_PDN_SM_WLAN_PROXY_CONFIG_EV,
  DS_IWLAN_S2B_PDN_SM_EM_CALL_DOWN_EV,
  DS_IWLAN_S2B_PDN_SM_ALL_NON_EM_CALLS_DOWN_EV,
  DS_IWLAN_S2B_PDN_SM_ALL_NON_REDIRECT_PDNS_DOWN_EV,
  DS_IWLAN_S2B_PDN_SM_MAX_EV = DS_IWLAN_S2B_PDN_SM_ALL_NON_REDIRECT_PDNS_DOWN_EV
...
/*===========================================================================
FUNCTION      ds_iwlan_s2b_pdn_sm_hdlr_is_epdg_ip_addr_in_use

DESCRIPTION   Check if any PDN bringup is currently using the EPDG IP address
...
===========================================================================*/
boolean ds_iwlan_s2b_pdn_sm_hdlr_is_epdg_ip_addr_in_use
(
  sys_modem_as_id_e_type      subs_id,
...
/*===========================================================================
FUNCTION      ds_iwlan_s2b_pdn_sm_hdlr_is_any_tunnel_session_ongoing

DESCRIPTION   Check if any ongoing tunnel establisment is happening
...
===========================================================================*/
boolean ds_iwlan_s2b_pdn_sm_hdlr_is_any_tunnel_session_ongoing
(
  void* redirect_pdn_cb_ptr,
  sys_modem_as_id_e_type      subs_id
);
