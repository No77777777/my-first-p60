...
/*===========================================================================
  ...
  $Header: //components/rel/data.mpss/3.5..2.1/wlan/wlan_proxy/inc/ds_wlan_proxy_mode_hdlr.h#2 $
  $Author: pwbldsvc $ 
...
--------    ---    ----------------------------------------------------------
02/17/18     pg     Added support HESSID to DSD info struct
06/15/16    fn     Added support for dsds capable subs
02/20/15    op     Changes to support RM resync state
01/13/14    vl     Added support for state based setup timer values
...
{
  WLAN_INFO_MIN_EV = 0,
  WLAN_INFO_NO_CHANGE_EV = WLAN_INFO_MIN_EV,
  WLAN_INFO_WLAN_AVAILABLE_EV,
  WLAN_INFO_WLAN_UNAVAILABLE_EV,
  WLAN_INFO_MAX = WLAN_INFO_WLAN_UNAVAILABLE_EV
}wlan_info_type;
...
struct __ds_wlan_proxy_cb_s
{
  ...
  /*-------------------------------------------------------------------------
  Enum to indicate WLAN available/unavailable event occurred. Currently set only in
  RM_CONFIG state
  -------------------------------------------------------------------------*/
  wlan_info_type             wlan_info;
};
...
/*===========================================================================
FUNCTION  ds_wlan_proxy_process_wlan_capable_event()

DESCRIPTION  Process wlan capable event
...
===========================================================================*/
void ds_wlan_proxy_process_wlan_capable_event
(
...
/*===========================================================================
FUNCTION      DS_WLAN_PROXY_PROCESS_WLAN_UNAVAILABLE

DESCRIPTION   This function processes WLAN unavailable
...
SIDE EFFECTS  None
===========================================================================*/
void ds_wlan_proxy_process_wlan_unavailable
(
  ds_wlan_proxy_cb_type *instance_ptr
);
...
/*===========================================================================
FUNCTION      DS_WLAN_PROXY_SET_HESSID

DESCRIPTION   This function stores the ssid in the cache using ps_sys 
              API 

PARAMETERS    void*                          hessid 
              int16*                         ps_error 
...
SIDE EFFECTS  None
===========================================================================*/
boolean ds_wlan_proxy_set_hessid
(
   void*   hessid,
   int16*  ps_error
);
...
/*===========================================================================
FUNCTION      DS_WLAN_PROXY_DSD_COMPARE_HESSID

DESCRIPTION  

PARAMETERS    char* old_hessid
              char* new_hessid
...
SIDE EFFECTS  None.
===========================================================================*/
boolean ds_wlan_proxy_dsd_compare_hessid
(
  uint8*   old_hessid,
  uint8*   new_hessid
);
...
/*===========================================================================
FUNCTION      DS_WLAN_PROXY_DSD_COMPARE_iso_cc

DESCRIPTION  

PARAMETERS    char* old_iso_cc
              char* new_iso_cc
...
SIDE EFFECTS  None.
===========================================================================*/
boolean ds_wlan_proxy_dsd_compare_iso_cc
(
  char *old_iso_cc,
  char *new_iso_cc
);
...
/*===========================================================================
FUNCTION      DS_WLAN_PROXY_MODE_HDLR_IS_OFFLOAD_ENABLE_ON_ANY_SUBS

DESCRIPTION   Check if wlan_proxy is enabled on any subs
...
SIDE EFFECTS  None.
===========================================================================*/
boolean ds_wlan_proxy_mode_hdlr_is_offload_enable_on_any_subs
(
  void
);
