...
$Header: //components/rel/data.mpss/3.5..2.1/wlan/wlan_utils/inc/ds_wlan_event_util.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/17/18   op      Added support for country code
...
#define WLAN_DNS_V4_ADDR_CHG_MASK       (0x00010000)
#define WLAN_DNS_V6_ADDR_CHG_MASK       (0x00100000)
#define WLAN_ISO_CC_CHG_MASK            (0x01000000)

#define WLAN_DNS_ADDR_CHG_MASK          (0x00110000)
#define WLAN_INFO_CHG_ALL_ATTRS_MASK ( WLAN_SSID_CHG_MASK | \
                                       ...
                                       WLAN_DNS_V4_ADDR_CHG_MASK | \
                                       WLAN_DNS_V6_ADDR_CHG_MASK | \
                                       WLAN_ISO_CC_CHG_MASK)
