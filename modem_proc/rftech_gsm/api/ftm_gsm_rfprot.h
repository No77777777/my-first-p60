...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_gsm.mpss/3.11/api/ftm_gsm_rfprot.h#1 $ 
...
04/24/15   tsr     Query and pass the remapped rx device in ftm_gsm_get_rssi_dbx16
03/10/15   mz	   Added support for FTM GSM Sensitivity Estimation
...
SIDE EFFECTS
===========================================================================*/
void ftm_gsm_set_tx(rfm_device_enum_type tx_device, boolean on_off);
...
SIDE EFFECTS
===========================================================================*/
void ftm_gsm_set_arfcn( ftm_gsm_chain_vars_s* chain_vars_ptr, uint16 arfcn);
...
DESCRIPTION
   This function will force the qpoet settings as required. 
...
===========================================================================*/
extern void ftm_gsm_set_qpoet_mode_bias( rfm_device_enum_type rfm_dev,
                                    const ftm_gsm_qpoet_mode_bias_type *, ftm_rsp_pkt_type *const res_pkt_ptr );
...
extern int16 ftm_gsm_get_rssi_dbx16( rfm_device_enum_type rx_device );
...
/*!
  ...
  @param
  ftm_chain : ftm chain passed by tool
  ...
  DEPENDENCIES
  The IQ Capture command should have been issued.
...
void ftm_gsm_iq_capture_analyze_samples(
  ...
  ftm_iq_capture_analyze_samples_type *data,
