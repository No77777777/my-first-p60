...
$Header: //components/rel/rftech_gsm.mpss/3.11/api/ftm_gsm_dispatch.h#1 $ $DateTime: 2021/03/09 05:10:17 $ $Author: pwbldsvc $
...
12/10/14   zbz     Added ftm_gsm_rssi_prx_drx_return_type 
...
/*---------------------------------------------------------------------------*/
/*! @struct ftm_gsm_enh_debug_generic_result_type                            */ 
/*! @brief structure defining the generic response packet data for the enh   */
/*!        debug dispatcher                                                  */
/*! @details generic usage where only the API success status needs to be     */
/*!          returned in the response packet                                 */
typedef PACK(struct) 
{
  uint16 generic_result;
  uint16 error_code;
}ftm_gsm_enh_debug_generic_result_type;
