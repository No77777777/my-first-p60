...
$Header: //components/rel/rftech_gsm.mpss/3.11/api/rfgsm_mdsp.h#1 $
...
10/07/15   tws     Add api to get TX stop priority for HMSC case
...
boolean rfgsm_mdsp_populate_rx_wakeup_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );

boolean rfgsm_mdsp_populate_tx_wakeup_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );
...
boolean rfgsm_mdsp_populate_rx_start_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx , uint32 rf_sequence_number);

boolean rfgsm_mdsp_populate_rx_stop_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );

boolean rfgsm_mdsp_populate_tx_start_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx , uint32 rf_sequence_number);
