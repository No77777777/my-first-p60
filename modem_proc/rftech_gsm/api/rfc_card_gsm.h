...
$Header: //components/rel/rftech_gsm.mpss/3.11/api/rfc_card_gsm.h#1 $
...
void * rfc_gsm_get_address(void);
	
void * rfc_gsm_ptr_get_address(void);
	
uint32 rfc_gsm_ptr_get_size(void);
