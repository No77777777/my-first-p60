...
$Header: //components/rel/rftech_gsm.mpss/3.11/api/rfgsm_core_util.h#1 $
...
07/30/15   zc      retrieve GSM sys band mask from RFGSM COM bands 
07/17/15   avi     Added rfgsm_band_map_struct to header
...
extern rfgsm_band_map_struct rfgsm_band_map[RFCOM_NUM_GSM_BANDS];
