...
DESCRIPTION
	 ...
	 Copyright (c) 2001, 2002, 2003, 2014 by Qualcomm Technologies Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_gsm.mpss/3.11/api/ftm_gsm_rfctl.h#1 $ 
...
05/29/15   cpm     made get_frame_sweep_cal_running accepting an rfm device as argument.
...
typedef struct
{
  ...
  boolean selftest_ready_to_issue_TxCmd;
  int16 selftest_tx_pwr_dbm;
  uint8 selftest_tx_mcs;
#endif
