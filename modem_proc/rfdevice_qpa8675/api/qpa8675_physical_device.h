#ifndef QPA8675_PHYSICAL_DEVICE_AG_H
#define QPA8675_PHYSICAL_DEVICE_AG_H
/*!
   @file
   qpa8675_physical_device_ag.h

   @brief
   qpa8675 physical device driver
...
$Header: //components/rel/rfdevice_qpa8675.mpss/1.11/api/qpa8675_physical_device.h#1 $ 
...
#define QPA8675_PA_VOTE_MASK 0xFF
/* Number of bits to reserve for logical PAs */
#define QPA8675_PA_VOTE_RESERVED_BITS 8


class qpa8675_physical_device : public rfdevice_physical_device
{
public:
  qpa8675_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qpa8675_physical_device* qpa8675_physical_device_p;
...
private:
  ...
  rfdevice_qpa_4g* qpa8675_pa_obj_ptr;

  /* ASM */
  rfdevice_qasm_2g* qpa8675_asm_obj_ptr;
