...
/*===========================================================================
  ...
  $Header: //components/rel/rfdevice_qfe2520.mpss/1.32/api/qfe2520_physical_device.h#1 $
...
private:
  ...
  /* HDET */
  void create_hdet_object(  rfc_logical_device_info_type *logical_device_info ); 

  rfdevice_antenna_tuner* qfe2520_qtuner_obj_ptr;

  rfdevice_coupler* qfe2520_qcoupler_obj_ptr;

  qfe2520_hdet_cmn* hdet_ptr;
