...
Generated from-  
	...
	Author: rspring
	Revision: 4.7
	Change Note: Added 40MHz APT support on EPT tab
...
$Header: //components/rel/rfdevice_qfe4373fc.mpss/1.32/api/qfe4373fc_asm_config_main_ag.h#1 $
$Author: pwbldsvc $
$DateTime: 2021/03/09 04:50:10 $ 
