#ifndef QAT3555_PHYSICAL_DEVICE_H
#define QAT3555_PHYSICAL_DEVICE_H
...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/rfdevice_qat3555.mpss/1.11/api/qat3555_physical_device.h#1 $
  $DateTime: 2021/03/09 04:58:11 $
  $Author: pwbldsvc $

when         who   what, where, why
--------   ---   --------------------------------------------------------------- 
10/18/16   dh    Initial version
============================================================================*/
...
#include "qat3555_tuner_config_ag.h"


class qat3555_physical_device : public rfdevice_physical_device
{
public:

  virtual rfdevice_logical_component* get_component(rfc_logical_device_info_type *logical_device_cfg);

  qat3555_physical_device* qat3555_physical_device_p;

  rfc_phy_device_info_type* phy_device_cfg;

  qat3555_physical_device(rfc_phy_device_info_type* cfg_req,
  	                      boolean ext_cmd = TRUE );

  ~qat3555_physical_device();
...
private:
  ...
  rfdevice_antenna_tuner* qat3555_qtuner_obj_ptr;
