...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/imsa/src/ip_multimedia_subsystem_application_v01.c#9 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Tue Feb  7 2023 (Spin 1)
...
static const uint8_t imsa_get_service_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_rat) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_rat_valid)),
  0x1D,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_rat),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, dc_service_status) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, dc_service_status_valid)),
  0x1E,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, dc_service_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, dc_service_rat) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, dc_service_rat_valid)),
  0x1F,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, dc_service_rat)
};
...
static const uint8_t imsa_ind_reg_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, token_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, token_config_valid)),
  0x22,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, token_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, scbm_mode_update_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, scbm_mode_update_config_valid)),
  0x23,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, scbm_mode_update_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, voice_capability_update_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, voice_capability_update_config_valid)),
  0x24,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, voice_capability_update_config),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, c_iwlan_status_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, c_iwlan_status_config_valid)),
  0x25,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, c_iwlan_status_config)
};
...
static const uint8_t imsa_service_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_rat) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_rat_valid)),
  0x1D,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_rat),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, dc_service_status) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, dc_service_status_valid)),
  0x1E,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, dc_service_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, dc_service_rat) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, dc_service_rat_valid)),
  0x1F,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, dc_service_rat)
};
...
static const uint8_t imsa_get_ims_block_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_ims_block_status_resp_msg_v01, ims_failure_on_wlan) - QMI_IDL_OFFSET8(imsa_get_ims_block_status_resp_msg_v01, ims_failure_on_wlan_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsa_get_ims_block_status_resp_msg_v01, ims_failure_on_wlan),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_ims_block_status_resp_msg_v01, ims_failure_on_c_iwlan) - QMI_IDL_OFFSET8(imsa_get_ims_block_status_resp_msg_v01, ims_failure_on_c_iwlan_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsa_get_ims_block_status_resp_msg_v01, ims_failure_on_c_iwlan),
  QMI_IDL_TYPE88(0, 3)
};
...
static const uint8_t imsa_ims_block_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ims_block_status_ind_msg_v01, ims_failure_on_wlan) - QMI_IDL_OFFSET8(imsa_ims_block_status_ind_msg_v01, ims_failure_on_wlan_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsa_ims_block_status_ind_msg_v01, ims_failure_on_wlan),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ims_block_status_ind_msg_v01, ims_failure_on_c_iwlan) - QMI_IDL_OFFSET8(imsa_ims_block_status_ind_msg_v01, ims_failure_on_c_iwlan_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsa_ims_block_status_ind_msg_v01, ims_failure_on_c_iwlan),
  QMI_IDL_TYPE88(0, 3)
};
...
static const uint8_t imsa_scbm_mode_update_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_scbm_mode_update_ind_msg_v01, scbm_mode_update_type)
};

static const uint8_t imsa_dual_sim_voice_capability_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(imsa_dual_sim_voice_capability_ind_msg_v01, voice_capability_type)
};

static const uint8_t imsa_c_iwlan_status_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_c_iwlan_status_ind_msg_v01, c_iwlan_feature_exit_needed) - QMI_IDL_OFFSET8(imsa_c_iwlan_status_ind_msg_v01, c_iwlan_feature_exit_needed_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_c_iwlan_status_ind_msg_v01, c_iwlan_feature_exit_needed)
};
...
static const qmi_idl_message_table_entry imsa_message_table_v01[] = {
  ...
  {sizeof(imsa_scbm_mode_update_ind_msg_v01), imsa_scbm_mode_update_ind_msg_data_v01},
  {sizeof(imsa_dual_sim_voice_capability_ind_msg_v01), imsa_dual_sim_voice_capability_ind_msg_data_v01},
  {sizeof(imsa_c_iwlan_status_ind_msg_v01), imsa_c_iwlan_status_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry imsa_service_command_messages_v01[] = {
  ...
  {QMI_IMSA_IND_REG_REQ_V01, QMI_IDL_TYPE16(0, 4), 88},
...
static const qmi_idl_service_message_table_entry imsa_service_response_messages_v01[] = {
  ...
  {QMI_IMSA_GET_SERVICE_STATUS_RSP_V01, QMI_IDL_TYPE16(0, 3), 119},
  ...
  {QMI_IMSA_GET_IMS_BLOCK_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 35), 82},
...
static const qmi_idl_service_message_table_entry imsa_service_indication_messages_v01[] = {
  ...
  {QMI_IMSA_SERVICE_STATUS_IND_V01, QMI_IDL_TYPE16(0, 7), 112},
  ...
  {QMI_IMSA_IMS_BLOCK_STATUS_IND_V01, QMI_IDL_TYPE16(0, 36), 75},
  ...
  {QMI_IMSA_SCBM_MODE_UPDATE_IND_V01, QMI_IDL_TYPE16(0, 49), 7},
  {QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01, QMI_IDL_TYPE16(0, 50), 4},
  {QMI_IMSA_C_IWLAN_STATUS_IND_V01, QMI_IDL_TYPE16(0, 51), 4}
};
