...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/imsa/api/ip_multimedia_subsystem_application_v01.h#9 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define IMSA_V01_IDL_MINOR_VERS 0x31
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSA_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSA_V01_MAX_MESSAGE_ID 0x0045
/**
    @}
  */
...
typedef enum {
  ...
  IMSA_C_IWLAN_V01 = 3, /**<  IMS service is registered on interworking C_IWLAN  */
...
/** @addtogroup imsa_qmi_enums
  ...
  */
typedef enum {
  IMSA_SCBM_MODE_UPDATE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMSA_SCBM_MODE_EXIT_V01 = 0, /**<  Scbm mode exit \n  */
  IMSA_SCBM_MODE_ENTER_V01 = 1, /**<  Scbm mode enter  */
  IMSA_SCBM_MODE_UPDATE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsa_scbm_mode_update_type_v01;
/**
    @}
  */
...
/** @addtogroup imsa_qmi_enums
  ...
  */
typedef enum {
  IMSA_DUAL_SIM_VOICE_CAPABILITY_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMSA_VOICE_CAPABILITY_NONE_MODE_V01 = 0, /**<  Dual SIM, but no voice capability (NONE) mode  */
  IMSA_VOICE_CAPABILITY_DSSS_MODE_V01 = 1, /**<  Dual SIM Single Subscription (DSSS) mode  */
  IMSA_VOICE_CAPABILITY_DSDS_MODE_V01 = 2, /**<  Dual SIM Dual Standby (DSDS) mode  */
  IMSA_VOICE_CAPABILITY_DSDA_MODE_V01 = 3, /**<  Dual SIM Dual Active (DSDA) mode  */
  IMSA_VOICE_CAPABILITY_PSEUDO_DSDA_MODE_V01 = 4, /**<  Dual SIM Dual Active (Pseudo DSDA) mode  */
  IMSA_DUAL_SIM_VOICE_CAPABILITY_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsa_dual_sim_voice_capability_type_v01;
/**
    @}
  */
...
Enumeration for a verbose call end reason (VCER) type. 
 ...
 IMS E911 SCBM mode update type
 
 IMS DUAL SIM VOICE CAPABILITY
 ...
 */
  ...
  /**<   Failure reason (verbose); see Specs 
       \hyperref[TS 24.008]{TS 24.008}, 
	   \hyperref[TS 24.007]{TS 24.007}, and 
	   \hyperref[C.S0017]{C.S0017}
...
typedef struct {
  ...
  /**<   Source RAT information; IWLAN/WWAN/C_IWLAN. */

  imsa_service_rat_enum_v01 target_rat;
  /**<   Target RAT information; IWLAN/WWAN/C_IWLAN. */
...
typedef struct {
  ...
  */
  ...
  /**<   Values: \n
      ...
      - IMSA_C_IWLAN (3) --  IMS service is registered on interworking C_IWLAN 
 */
 ...
 */
  ...
  /* Optional */
  /*  Data Channel Status */
  uint8_t dc_service_status_valid;  /**< Must be set to true if dc_service_status is being passed */
  imsa_service_status_enum_v01 dc_service_status;
  /**<   Values: \n
       - 0 -- IMS Data Channel service is not available \n
       - 1 -- IMS Data Channel service in limited mode is not supported \n
       - 2 -- IMS Data Channel is in full service
  */

  /* Optional */
  /*  Data Channel RAT */
  uint8_t dc_service_rat_valid;  /**< Must be set to true if dc_service_rat is being passed */
  imsa_service_rat_enum_v01 dc_service_rat;
  /**<   Values: \n
      - IMSA_WLAN (0) --  IMS service is registered on WLAN \n 
      - IMSA_WWAN (1) --  IMS service is registered on WWAN \n 
      - IMSA_IWLAN (2) --  IMS service is registered on interworking WLAN \n 
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  IMS E911 SCBM Update Feature */
  uint8_t scbm_mode_update_config_valid;  /**< Must be set to true if scbm_mode_update_config is being passed */
  uint8_t scbm_mode_update_config;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  IMS Voice Capability on Dual SIMs */
  uint8_t voice_capability_update_config_valid;  /**< Must be set to true if voice_capability_update_config is being passed */
  uint8_t voice_capability_update_config;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  IMS C_IWLAN Status */
  uint8_t c_iwlan_status_config_valid;  /**< Must be set to true if c_iwlan_status_config is being passed */
  uint8_t c_iwlan_status_config;
  /**<   Values: \n
       - 0x00 -- Disable \n
       - 0x01 -- Enable
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Blocking Reason of IMS over C_IWLAN */
  uint8_t ims_failure_on_c_iwlan_valid;  /**< Must be set to true if ims_failure_on_c_iwlan is being passed */
  imsa_ims_failure_reason_type_v01 ims_failure_on_c_iwlan;
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indication sent with a reason. */
typedef struct {
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indicates an SCBM mode update. */
typedef struct {

  /* Mandatory */
  /*  IMS SCBM Mode Update Indication */
  imsa_scbm_mode_update_type_v01 scbm_mode_update_type;
  /**<   Values:\n
      - IMSA_SCBM_MODE_EXIT (0) --  Scbm mode exit \n 
      - IMSA_SCBM_MODE_ENTER (1) --  Scbm mode enter 
 */
}imsa_scbm_mode_update_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indicates a voice capabiilty update on dual SIMs. */
typedef struct {

  /* Mandatory */
  /*  IMS Voice Capability Update on Dual SIMs */
  imsa_dual_sim_voice_capability_type_v01 voice_capability_type;
  /**<   Values:\n
      - IMSA_VOICE_CAPABILITY_NONE_MODE (0) --  Dual SIM, but no voice capability (NONE) mode 
      - IMSA_VOICE_CAPABILITY_DSSS_MODE (1) --  Dual SIM Single Subscription (DSSS) mode 
      - IMSA_VOICE_CAPABILITY_DSDS_MODE (2) --  Dual SIM Dual Standby (DSDS) mode 
      - IMSA_VOICE_CAPABILITY_DSDA_MODE (3) --  Dual SIM Dual Active (DSDA) mode 
      - IMSA_VOICE_CAPABILITY_PSEUDO_DSDA_MODE (4) --  Dual SIM Dual Active (Pseudo DSDA) mode 
 */
}imsa_dual_sim_voice_capability_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indicates C_IWLAN status change */
typedef struct {

  /* Optional */
  /*  IMS C_IWLAN Status Change */
  uint8_t c_iwlan_feature_exit_needed_valid;  /**< Must be set to true if c_iwlan_feature_exit_needed is being passed */
  uint8_t c_iwlan_feature_exit_needed;
  /**<   Values: \n
       - 0 -- Remove a popup message if shown (or remove the popup if reg_status 
	          indication says success with C_IWLAN) \n
       - 1 -- Show user a popup message
  */
}imsa_c_iwlan_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_IMSA_C_IWLAN_STATUS_IND_V01
//#define REMOVE_QMI_IMSA_DIGITS_INFO_PENDING_IND_V01
//#define REMOVE_QMI_IMSA_DIGITS_UPDATE_IND_V01
//#define REMOVE_QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01
...
//#define REMOVE_QMI_IMSA_SCBM_MODE_UPDATE_IND_V01
...
#define QMI_IMSA_SCBM_MODE_UPDATE_IND_V01 0x0043
#define QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01 0x0044
#define QMI_IMSA_C_IWLAN_STATUS_IND_V01 0x0045
/**
    @}
  */
