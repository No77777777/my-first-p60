...
GENERAL DESCRIPTION
  ...
  (c) 2011-2017 Qualcomm Technologies, Inc.
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.


  $Header: //components/rel/qmimsgs.mpss/4.6.9/auth/src/authentication_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t auth_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(auth_indication_register_req_msg_v01, report_imsi_public_key_request) - QMI_IDL_OFFSET8(auth_indication_register_req_msg_v01, report_imsi_public_key_request_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry auth_service_command_messages_v01[] = {
  ...
  {QMI_AUTH_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 18), 16},
