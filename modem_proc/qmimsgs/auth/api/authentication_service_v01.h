...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/auth/api/authentication_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define AUTH_V01_IDL_MINOR_VERS 0x0C
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define AUTH_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define AUTH_V01_MAX_MESSAGE_ID 0x002F
/**
    @}
  */
