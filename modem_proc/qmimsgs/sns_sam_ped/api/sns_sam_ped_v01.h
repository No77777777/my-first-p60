...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/sns_sam_ped/api/sns_sam_ped_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SNS_SAM_PED_SVC_V01_IDL_MINOR_VERS 0x04
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SNS_SAM_PED_SVC_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SNS_SAM_PED_SVC_V01_MAX_MESSAGE_ID 0x0022;
/** 
    @} 
  */
