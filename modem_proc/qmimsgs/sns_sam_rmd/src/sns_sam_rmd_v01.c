...
GENERAL DESCRIPTION
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/sns_sam_rmd/src/sns_sam_rmd_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
{&SNS_SAM_RMD_SVC_qmi_idl_type_table_object_v01, &sns_common_qmi_idl_type_table_object_v01, &sns_sam_qmd_qmi_idl_type_table_object_v01};
...
static const qmi_idl_service_message_table_entry SNS_SAM_RMD_SVC_service_command_messages_v01[] = {
  {SNS_SAM_RMD_CANCEL_REQ_V01, QMI_IDL_TYPE16(1, 0), 0},
  {SNS_SAM_RMD_VERSION_REQ_V01, QMI_IDL_TYPE16(1, 2), 0},
  {SNS_SAM_RMD_ENABLE_REQ_V01, QMI_IDL_TYPE16(2, 0), 26},
  {SNS_SAM_RMD_DISABLE_REQ_V01, QMI_IDL_TYPE16(2, 2), 4},
  {SNS_SAM_RMD_GET_REPORT_REQ_V01, QMI_IDL_TYPE16(2, 5), 4}
};

static const qmi_idl_service_message_table_entry SNS_SAM_RMD_SVC_service_response_messages_v01[] = {
  {SNS_SAM_RMD_CANCEL_RESP_V01, QMI_IDL_TYPE16(1, 1), 5},
  {SNS_SAM_RMD_VERSION_RESP_V01, QMI_IDL_TYPE16(1, 3), 17},
  {SNS_SAM_RMD_ENABLE_RESP_V01, QMI_IDL_TYPE16(2, 1), 9},
  {SNS_SAM_RMD_DISABLE_RESP_V01, QMI_IDL_TYPE16(2, 3), 9},
  {SNS_SAM_RMD_GET_REPORT_RESP_V01, QMI_IDL_TYPE16(2, 6), 23}
};

static const qmi_idl_service_message_table_entry SNS_SAM_RMD_SVC_service_indication_messages_v01[] = {
  {SNS_SAM_RMD_REPORT_IND_V01, QMI_IDL_TYPE16(2, 4), 18},
  {SNS_SAM_RMD_ERROR_IND_V01, QMI_IDL_TYPE16(2, 7), 8}
};
