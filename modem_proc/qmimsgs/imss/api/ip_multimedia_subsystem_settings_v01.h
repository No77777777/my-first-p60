...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/imss/api/ip_multimedia_subsystem_settings_v01.h#13 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 */
  ...
  /* Optional */
  /*  Handover Support for IWLAN and NR Roaming     */
  ...
  /**<   This value lets us know if a handover is supported between 
         IWLAN and NR in roaming scenario. \n
         Default value: 0
    */
...
typedef struct {
  ...
  /**<   Comma separated list of AppID values; each corresponding to an 
         application client supports. If not set, the default is ap2002.
    */
...
typedef struct {
  ...
  uint16_t msd_id;
  /**<   The MSD ID is unique identifier to notify the MSD 
         information request from the network. 
   */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Sends the passed MSD information and related headers to network. */
typedef struct {
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Sends the passed MSD information and related headers to network. */
typedef struct {
