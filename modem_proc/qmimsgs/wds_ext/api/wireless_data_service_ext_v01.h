...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/wds_ext/api/wireless_data_service_ext_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define WDS_EXT_V01_IDL_MINOR_VERS 0x02
...
typedef struct {
  ...
  /**<   Iface handle which best matches the policy provided in the request. 
       This must be specified in the Start Network Interface msg.
  */
...
typedef enum {
  ...
  WDS_RL_TYPE_BRINGUP_V01 = 0, 
  WDS_RL_TYPE_IFACE_V01 = 1, 
  WDS_RL_TYPE_DATAPATH_V01 = 2, 
...
/** @addtogroup wds_ext_qmi_messages
    @{
  */
/** Request Message; Determine the interface that will be used.  */
typedef struct {
  ...
  /**<   Route lookup type
      - WDS_RL_TYPE_BRINGUP (0) -- 
      - WDS_RL_TYPE_IFACE (1) -- 
      - WDS_RL_TYPE_DATAPATH (2) -- 
 */
...
/** @addtogroup wds_ext_qmi_messages
    @{
  */
/** Response Message; Determine the interface that will be used.  */
typedef struct {
  ...
  /**<   This TLV is returned only if a call is up on the Interface determined
       by the route look up operation. The QMI link which has a data call up
       on the Interface indicated by the Interface handle TLV above.
   */
  ...
  /**<   The peripheral end point of the RmNet instance where data call is
       already present. This TLV is returned only if a call is up on the
       Interface determined by the route look up operation.
  */
  ...
  uint8_t mux_id;
  /**<   The Mux ID of the RmNet instance where data call is already present.
       This TLV is returned only if a call is up on the Interface determined
       by the route look up operation.
  */
...
typedef struct {
  ...
  uint32_t max;
  /**<   Max queueing delay (in 3.4ms granularity)*/

  uint32_t min;
  /**<   Min queueing delay (in 3.4ms granularity)*/

  uint32_t avg;
  /**<   Average queueing delay (in 3.4ms granularity)*/
...
/** @addtogroup wds_ext_qmi_messages
    @{
  */
/** Request Message; Retrieve UL packet delay metrics */
typedef struct {
...
/** @addtogroup wds_ext_qmi_messages
    @{
  */
/** Response Message; Retrieve UL packet delay metrics */
typedef struct {
...
/** @addtogroup wds_ext_qmi_messages
    @{
  */
/** Request Message; Reset UL packet delay metrics */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wds_ext_qmi_messages
    @{
  */
/** Response Message; Reset UL packet delay metrics */
typedef struct {
...
typedef struct {
  ...
  /**<   Uplink achievable rate per UE in kbits per second.
  */

  /* Optional */
  /*  DL achievable throughput */
  ...
  /**<   Downlink achievable rate per UE in kbits per second.
  */

  /* Optional */
  /*  UL allowed throughput */
  ...
  /**<   Uplink actual rate per UE in kbits per second.
  */

  /* Optional */
  /*  DL allowed throughput */
  ...
  /**<   Downlink actual rate per UE in kbits per second.
  */
