...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/ipa/api/internet_protocol_accelerator_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define IPA_V01_IDL_MINOR_VERS 0x10
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IPA_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IPA_V01_MAX_MESSAGE_ID 0x0042
/**
    @}
  */
...
/** Indication Message; Modem driver sends this indication to the master driver when the data
           usage quota is reached. */
typedef struct {

  /* Mandatory */
  /*  APN Quota List */
  ipa_data_usage_quota_info_type_v01 apn;
  /**<   \n This message indicates which APN has reached the previously set quota. \n
         @note Currently, only one APN monitoring is supported on the modem driver.
    */
...
/** Request Message; Master driver requests the modem driver to terminate the current data
           usage quota monitoring session. */
typedef struct {
