...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/dsd/api/data_system_determination_v01.h#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Wed Nov 22 2023 (Spin 0)
...
#define DSD_V01_IDL_MINOR_VERS 0x57
...
#define QMI_DSD_3GPP_SO_MASK_NB_NTN_SRVC_V01 ((dsd_sys_so_mask_v01)0x0000000000200000ull) 
...
#define QMI_DSD_UI_MASK_3GPP_5G_SET_UP_MODE_V01 ((dsd_sys_ui_mask_v01)0x0000000000000080ull) /**<  Customer Premise Equipment (CPE) device setup mode display white signal    */
#define QMI_DSD_UI_MASK_3GPP_5G_REGULAR_MODE_V01 ((dsd_sys_ui_mask_v01)0x0000000000000100ull) /**<  CPE device regular mode display white signal  */
/** @addtogroup dsd_qmi_aggregates
    @{
  */
typedef struct {
 ...
 */
 ...
 Values: \n
      ...
      - QMI_DSD_3GPP_SO_MASK_NB_NTN_SRVC (0x0000000000200000) -- 
 ...
 Values: \n
      ...
      - QMI_DSD_UI_MASK_3GPP_5G_SET_UP_MODE (0x0000000000000080) --  Customer Premise Equipment (CPE) device setup mode display white signal   
      - QMI_DSD_UI_MASK_3GPP_5G_REGULAR_MODE (0x0000000000000100) --  CPE device regular mode display white signal  */
...
/** @addtogroup dsd_qmi_enums
  ...
  */
typedef enum {
  DSD_CIWLAN_SUBS_SUPPORT_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DSD_CIWLAN_SUBS_SUPPORT_DDS_ONLY_V01 = 0, /**<  CIWLAN support only on DDS sub \n  */
  DSD_CIWLAN_SUBS_SUPPORT_ALL_SUBS_V01 = 1, /**<  CIWLAN support on all the active subs \n  */
  DSD_CIWLAN_SUBS_SUPPORT_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dsd_ciwlan_subs_support_type_enum_v01;
/**
    @}
  */
...
#define QMI_DSD_TEMP_DDS_REASON_DDS_SIM_REMOVAL_V01 ((dsd_temp_dds_cause_code_mask_v01)0x0000000000001000ull) 
typedef uint64_t dsd_perm_dds_cause_code_mask_v01;
#define QMI_DSD_PERM_DDS_REASON_TEMP_CLEAN_UP_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000001ull) 
#define QMI_DSD_PERM_DDS_REASON_DATA_SETTING_OFF_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000002ull) 
#define QMI_DSD_PERM_DDS_REASON_PS_INVALID_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000004ull) 
#define QMI_DSD_PERM_DDS_REASON_INTERNET_NOT_AVAIL_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000008ull) 
#define QMI_DSD_PERM_DDS_REASON_DUAL_DATA_DSDS_SUBMODE_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000010ull) 
#define QMI_DSD_PERM_DDS_REASON_DUAL_DATA_IRAT_INIT_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000020ull) 
#define QMI_DSD_PERM_DDS_REASON_DUAL_DATA_TX_SHARING_V01 ((dsd_perm_dds_cause_code_mask_v01)0x0000000000000040ull) 
/** @addtogroup dsd_qmi_messages
    @{
  */
 ...
 */
 ...
 DSD_DDS_SWITCH_TEMPORARY. Values:\n
      ...
      - QMI_DSD_TEMP_DDS_REASON_DDS_SIM_REMOVAL (0x0000000000001000) -- 
 */

  /* Optional */
  /*  Permanent DDS Recommendation Reason */
  uint8_t perm_dds_cause_code_valid;  /**< Must be set to true if perm_dds_cause_code is being passed */
  dsd_perm_dds_cause_code_mask_v01 perm_dds_cause_code;
  /**<   This TLV is only applicable when DDS Switch Type is 
 DSD_DDS_SWITCH_PERMANENT. Values:\n
      - QMI_DSD_PERM_DDS_REASON_TEMP_CLEAN_UP (0x0000000000000001) -- 
      - QMI_DSD_PERM_DDS_REASON_DATA_SETTING_OFF (0x0000000000000002) -- 
      - QMI_DSD_PERM_DDS_REASON_PS_INVALID (0x0000000000000004) -- 
      - QMI_DSD_PERM_DDS_REASON_INTERNET_NOT_AVAIL (0x0000000000000008) -- 
      - QMI_DSD_PERM_DDS_REASON_DUAL_DATA_DSDS_SUBMODE (0x0000000000000010) -- 
      - QMI_DSD_PERM_DDS_REASON_DUAL_DATA_IRAT_INIT (0x0000000000000020) -- 
      - QMI_DSD_PERM_DDS_REASON_DUAL_DATA_TX_SHARING (0x0000000000000040) -- 
 */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  C iWLAN Subs Support */
  uint8_t ciwlan_subs_support_valid;  /**< Must be set to true if ciwlan_subs_support is being passed */
  dsd_ciwlan_subs_support_type_enum_v01 ciwlan_subs_support;
  /**<   Values: \n
      - DSD_CIWLAN_SUBS_SUPPORT_DDS_ONLY (0) --  CIWLAN support only on DDS sub \n 
      - DSD_CIWLAN_SUBS_SUPPORT_ALL_SUBS (1) --  CIWLAN support on all the active subs \n  */
