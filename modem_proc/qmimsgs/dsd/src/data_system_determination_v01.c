...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/dsd/src/data_system_determination_v01.c#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t dsd_dds_recommendation_ind_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_dds_cause_code) - QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_dds_cause_code_valid)),
  0x12,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_dds_cause_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, perm_dds_cause_code) - QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, perm_dds_cause_code_valid)),
  0x13,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, perm_dds_cause_code)
};
...
static const uint8_t dsd_get_dds_recommendation_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_dds_cause_code) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_dds_cause_code_valid)),
  0x14,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_dds_cause_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, perm_dds_cause_code) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, perm_dds_cause_code_valid)),
  0x15,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, perm_dds_cause_code)
};
...
static const uint8_t dsd_get_capability_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_capability) - QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_capability_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_capability),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_subs_support) - QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_subs_support_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_subs_support)
};
...
static const uint8_t dsd_ciwlan_capability_ind_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_ciwlan_capability_ind_v01, ciwlan_subs_support) - QMI_IDL_OFFSET8(dsd_ciwlan_capability_ind_v01, ciwlan_subs_support_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ciwlan_capability_ind_v01, ciwlan_subs_support)
};
...
static const qmi_idl_service_message_table_entry dsd_service_response_messages_v01[] = {
  ...
  {QMI_DSD_GET_DDS_RECOMMENDATION_RESP_V01, QMI_IDL_TYPE16(0, 152), 57},
  {QMI_DSD_GET_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 155), 22}
};
...
static const qmi_idl_service_message_table_entry dsd_service_indication_messages_v01[] = {
  ...
  {QMI_DSD_DDS_RECOMMENDATION_IND_V01, QMI_IDL_TYPE16(0, 150), 50},
  {QMI_DSD_TEMP_DDS_REC_CAPABILITY_IND_V01, QMI_IDL_TYPE16(0, 153), 4},
  {QMI_DSD_CIWLAN_CAPABILITY_IND_V01, QMI_IDL_TYPE16(0, 156), 11}
};
