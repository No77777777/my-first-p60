...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2024 Qualcomm Technologies, Inc.
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.



  $Header: //components/rel/qmimsgs.mpss/4.6.9/dms/api/device_management_service_v01.h#8 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Tue Apr  2 2024 (Spin 0)
...
#define DMS_V01_IDL_MINOR_VERS 0x60
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DMS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DMS_V01_MAX_MESSAGE_ID 0x0087
/**
    @}
  */
...
#define QMI_DMS_WHOLE_FACTORY_MAX_V01 127
/**
    @}
  */

typedef uint8_t dms_power_status_mask_v01;
#define QMI_DMS_MASK_POWER_SOURCE_V01 ((dms_power_status_mask_v01)0x01) /**<  Bit 0 \n
                                                 - 0 -- Powered by battery \n
                                                 - 1 -- Powered by external source \n */
#define QMI_DMS_MASK_BATTERY_CONNECTED_V01 ((dms_power_status_mask_v01)0x02) /**<  Bit 1 \n
                                                 - 0 -- Battery not connected \n
                                                 - 1 -- Battery connected \n    */
#define QMI_DMS_MASK_BATTERY_CHARGING_V01 ((dms_power_status_mask_v01)0x04) /**<  Bit 2 \n
                                                 - 0 -- Battery not charging \n
                                                 - 1 -- Battery charging \n */
#define QMI_DMS_MASK_POWER_FAULT_V01 ((dms_power_status_mask_v01)0x08) /**<   Bit 3 \n
                                                  - 0 -- No power fault \n
                                                  - 1 -- Recognized power fault, calls inhibited */
typedef uint16_t dms_offline_reason_mask_v01;
#define QMI_DMS_MASK_OFFLINE_REASON_HOST_IMAGE_V01 ((dms_offline_reason_mask_v01)0x0001) /**<  Host image misconfiguration \n   */
#define QMI_DMS_MASK_OFFLINE_REASON_PRI_IMAGE_V01 ((dms_offline_reason_mask_v01)0x0002) /**<  PRI image misconfiguration \n  */
#define QMI_DMS_MASK_OFFLINE_REASON_PRI_VERSION_V01 ((dms_offline_reason_mask_v01)0x0004) /**<  PRI version incompatible \n  */
#define QMI_DMS_MASK_OFFLINE_REASON_DEVICE_MEMORY_V01 ((dms_offline_reason_mask_v01)0x0008) /**<  Device memory is full, cannot copy PRI information */
...
typedef enum {
  ...
  DMS_PSM_VERSION_1_V01 = 1, /**<  Version 1: AP decides the time that the modem goes into PSM \n */
  DMS_PSM_VERSION_2_V01 = 2, /**<  Version 2: Modem calculates and decides the time that it goes into PSM \n */
  DMS_PSM_VERSION_UNSPEC_V01 = 0xFF, /**<  PSM version unspecified, for example, the modem either does not support the PSM feature or version 1 is 
...
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDA_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000001ull) /**<  TDS band A 1900 to 1920 MHz, 2010 to 2020 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDB_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000002ull) /**<  TDS band B 1850 to 1910 MHz, 1930 to 1990 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDC_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000004ull) /**<  TDS band C 1910 to 1930 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDD_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000008ull) /**<  TDS band D 2570 to 2620 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDE_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000010ull) /**<  TDS band E 2300 to 2400 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDF_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000020ull) /**<  TDS band F 1880 to 1920 MHz   */
/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
...
typedef enum {
  ...
  DMS_INIT_STATE_UNSPECIFIED_V01 = 0, /**<  State unspecified. \n   */
  DMS_INIT_STATE_IN_PROGRESS_V01 = 1, /**<  In progress. \n   */
  DMS_INIT_STATE_READY_V01 = 2, /**<  Device initialized. \n  */
  DMS_INIT_STATE_FAILED_V01 = 3, /**<  Failed.   */
...
typedef struct {
  ...
  /**<   Battery level is reported to the control point when the battery
...
typedef struct {
  ...
  /**<   Power status flags. Values: \n
      - QMI_DMS_MASK_POWER_SOURCE (0x01) --  Bit 0 \n
                                                 - 0 -- Powered by battery \n
                                                 - 1 -- Powered by external source \n
      - QMI_DMS_MASK_BATTERY_CONNECTED (0x02) --  Bit 1 \n
                                                 - 0 -- Battery not connected \n
                                                 - 1 -- Battery connected \n   
      - QMI_DMS_MASK_BATTERY_CHARGING (0x04) --  Bit 2 \n
                                                 - 0 -- Battery not charging \n
                                                 - 1 -- Battery charging \n
      - QMI_DMS_MASK_POWER_FAULT (0x08) --   Bit 3 \n
                                                  - 0 -- No power fault \n
                                                  - 1 -- Recognized power fault, calls inhibited
 */
...
typedef enum {
  ...
  DMS_ACTIVATION_CONNECTED_V01 = 0x03, /**<  Activation connected -- Network
...
#define DMS_SUBS_CAPABILITY_NB1_NTN_V01 ((dms_subs_capability_mask_type_v01)0x00000200ull) /**<  NB1_NTN  */
/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
  DMS_SENSOR_TYPE_ID_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_SENSOR_TYPE_ALS_V01 = 1, /**<  Ambient light sensor \n   */
  DMS_SENSOR_TYPE_PRESSURE_V01 = 2, /**<  Pressure \n   */
  DMS_SENSOR_TYPE_HUMIDITY_V01 = 3, /**<  Humidity \n   */
  DMS_SENSOR_TYPE_TEMPERATURE_V01 = 4, /**<  Temperature \n   */
  DMS_SENSOR_TYPE_AMD_V01 = 5, /**<  Any motion \n   */
  DMS_SENSOR_TYPE_SMD_V01 = 6, /**<  Significant motion \n   */
  DMS_SENSOR_TYPE_ALL_V01 = 255, /**<  Multiple sensors   */
...
typedef struct {
  ...
  /**<   Any value greater than this is treated as policy met.
       0XFFFFFFFF indicates that this field is not considered for policy matching.*/
  ...
  /**<   Minimum change in sensor values, which must be treated as policy 
      met. 0XFFFFFFFF indicates that this field is not considered for policy matching.*/
...
typedef struct {
  ...
  /**<   Sensor types: \n
      - DMS_SENSOR_TYPE_ALS (1) --  Ambient light sensor \n  
      - DMS_SENSOR_TYPE_PRESSURE (2) --  Pressure \n  
      - DMS_SENSOR_TYPE_HUMIDITY (3) --  Humidity \n  
      - DMS_SENSOR_TYPE_TEMPERATURE (4) --  Temperature \n  
      - DMS_SENSOR_TYPE_AMD (5) --  Any motion \n  
      - DMS_SENSOR_TYPE_SMD (6) --  Significant motion \n  
      - DMS_SENSOR_TYPE_ALL (255) --  Multiple sensors   */
...
typedef struct {
 ...
 The client ignores any bits in the mask that it does not recognize. Values: 
      ...
      - DMS_SUBS_CAPABILITY_NB1_NTN (0x00000200) --  NB1_NTN  */
...
typedef struct {
  ...
  /**<   Simultaneous voice and data capability type of a subscription. 
 Values: 
...
typedef struct {
  ...
  uint8_t max_active;
  /**<   Maximum number of subscriptions that can be simultaneously active. 
...
typedef struct {
  ...
  uint8_t max_active;
  /**<   Maximum number of subscriptions that can be simultaneously active out of 
  ...
  /**<   Current device configuration is pointed by the configuration at this
...
typedef struct {
  ...
  /**<   Service activation state. Values: \n
      ...
      - DMS_ACTIVATION_CONNECTING (0x02) --  Activation connecting -- Network
                connection is in progress for automatic activation of service \n 
      - DMS_ACTIVATION_CONNECTED (0x03) --  Activation connected -- Network
                connection is connected for automatic activation of service \n 
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Report NonEncrypt ImeiSvn  */
  uint8_t report_nonencrypt_imei_svn_valid;  /**< Must be set to true if report_nonencrypt_imei_svn is being passed */
  uint8_t report_nonencrypt_imei_svn;
  /**<   Values:\n
       -0 -- FALSE\n
       -1 -- TRUE 
  */
...
typedef enum {
  ...
  DMS_RADIO_IF_NB1_NTN_V01 = 0x0B, /**<  NB1_NTN  */
...
#define QMI_DMS_MASK_VOICE_SUPPORT_GW_CSFB_CAPABLE_V01 ((dms_voice_support_capability_mask_v01)0x0001ull) /**<   Bit 0 -- GW CSFB        \n
                                                                - 0 -- Not capable      \n
                                                                - 1 -- Capable          \n  */
#define QMI_DMS_MASK_VOICE_SUPPORT_1x_CSFB_CAPABLE_V01 ((dms_voice_support_capability_mask_v01)0x0002ull) /**<   Bit 1 -- 1x CSFB        \n
                                                                - 0 -- Not capable      \n
                                                                - 1 -- Capable          \n  */
#define QMI_DMS_MASK_VOICE_SUPPORT_VOLTE_CAPABLE_V01 ((dms_voice_support_capability_mask_v01)0x0004ull) /**<  Bit 2 -- VoLTE          \n
                                                               - 0 -- Not capable      \n
                                                               - 1 -- Capable            */
typedef uint64_t dms_simul_voice_and_data_capability_mask_v01;
#define QMI_DMS_MASK_SVLTE_CAPABLE_V01 ((dms_simul_voice_and_data_capability_mask_v01)0x0001ull) /**<  Bit 0 -- SVLTE capability \n  */
#define QMI_DMS_MASK_SVDO_CAPABLE_V01 ((dms_simul_voice_and_data_capability_mask_v01)0x0002ull) /**<  Bit 1 -- SVDO capability  \n */
#define QMI_DMS_MASK_SGLTE_CAPABLE_V01 ((dms_simul_voice_and_data_capability_mask_v01)0x0004ull) /**<  Bit 2 -- SGLTE capability  */
/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
...
typedef enum {
  ...
  DMS_REV_UNAVAILABLE_V01 = 0xFF, /**<  RAT not supported on the device 
...
typedef enum {
  ...
  DMS_WCDMA_REV_UNAVAILABLE_V01 = 0xFF, /**<  RAT not supported on the device 
                                                      or rel info is not available  */
...
typedef enum {
  ...
  DMS_LTE_3GPP_REL_16_V01 = 0x1F, 
  DMS_LTE_3GPP_REL_17_V01 = 0x20, 
...
typedef enum {
  ...
  DMS_HDR_EVDO_REL_0_V01 = 0x01, /**<  HDR REL 0  */
  DMS_HDR_EVDO_REL_A_V01 = 0x02, /**<  HDR REL A  */
  DMS_HDR_EVDO_REL_B_V01 = 0x03, /**<  HDR REL B   */
  DMS_HDR_EVDO_REL_C_V01 = 0x04, /**<  HDR REL C  */
  DMS_HDR_REV_UNAVAILABLE_V01 = 0xFF, /**<  RAT not supported on the device 
                                                   or rel info is not available   */
 ...
 */
 ...
 supported by the device. Values: \n
      ...
      - DMS_RADIO_IF_NB1_NTN (0x0B) --  NB1_NTN 
 */
 ...
 */
  ...
  /**<   Highest supported release information for the GERAN RAT 
       by the device.
  */

  dms_device_wcdma_rel_info_v01 wcdma_rel_info;
  /**<   Highest supported release information for the WCDMA RAT
       by the device.
  */

  dms_device_lte_rat_rel_info_v01 lte_rel_info;
  /**<   Highest supported release information for the LTE RAT
       by the device.
  */

  dms_device_hdr_rat_rel_info_v01 hdrcp_rel_info;
  /**<   Highest supported release information for the HDR RAT
       by the device.
  */

  dms_device_cdma_1x_rel_info_v01 cdma1x_rel_info;
  /**<   Highest supported release information for the CDMA2000 RAT
       by the device.
  */

  dms_device_tdscdma_rel_info_v01 tdscdma_rel_info;
  /**<   Highest supported release information for the TDSCDMA RAT
       by the device.
  */
 ...
 */
  ...
  /**<   Bitmask of voice support available on device. Values: \n
      - QMI_DMS_MASK_VOICE_SUPPORT_GW_CSFB_CAPABLE (0x0001) --   Bit 0 -- GW CSFB        \n
                                                                - 0 -- Not capable      \n
                                                                - 1 -- Capable          \n 
      - QMI_DMS_MASK_VOICE_SUPPORT_1x_CSFB_CAPABLE (0x0002) --   Bit 1 -- 1x CSFB        \n
                                                                - 0 -- Not capable      \n
                                                                - 1 -- Capable          \n 
      - QMI_DMS_MASK_VOICE_SUPPORT_VOLTE_CAPABLE (0x0004) --  Bit 2 -- VoLTE          \n
                                                               - 0 -- Not capable      \n
                                                               - 1 -- Capable           
 */
  ...
  /**<   Bitmask of simultaneous voice and data support available on the device. Values: \n
      - QMI_DMS_MASK_SVLTE_CAPABLE (0x0001) --  Bit 0 -- SVLTE capability \n 
      - QMI_DMS_MASK_SVDO_CAPABLE (0x0002) --  Bit 1 -- SVDO capability  \n
      - QMI_DMS_MASK_SGLTE_CAPABLE (0x0004) --  Bit 2 -- SGLTE capability  \n
 ...
 */
  ...
  uint8_t multisim_capability_valid;  /**< Must be set to true if multisim_capability is being passed */
  dms_multisim_capability_type_v01 multisim_capability;
  /**<   \n This TLV is deprecated. Use the Device Multisim Voice Data Capability TLV to support
        multiple simultaneously active radio interfaces.
   */
 ...
 */
 ...
 capability of the UE to operate in dual subscription with dual active based 
 ...
 */
  ...
  */
  ...
  /**<   Specifies the PIN value of the PIN to enable/disable. The
       protection setting is only changed when the SIM
       verifies this value.
  */
 ...
 */
  ...
  uint32_t pin_value_len;  /**< Must be set to # of elements in pin_value */
  uint8_t pin_value[QMI_DMS_PIN_VALUE_MAX_V01];
  /**<   Specifies the PIN value of the PIN to verify; the
       protection setting is only changed when the SIM verifies
       this value.
  */
...
typedef struct {
  ...
  /**<   Specifies the ID of the PIN to unblock. Values: \n
      - DMS_QMI_PIN_ID_PIN_1 (0x01) --  PIN1 (also called PIN) \n 
      - DMS_QMI_PIN_ID_PIN_2 (0x02) --  PIN2 
 */
  ...
  /**<   Specifies the PIN unlock key (PUK), or password, of the PIN to unblock. \n*/

  uint32_t new_pin_value_len;  /**< Must be set to # of elements in new_pin_value */
  uint8_t new_pin_value[QMI_DMS_PUK_VALUE_MAX_V01];
  /**<   Specifies the new PIN value (password) for the PIN to unblock. */
 ...
 */
 ...
 future use and are ignored. Values: \n
      - QMI_DMS_MASK_OFFLINE_REASON_HOST_IMAGE (0x0001) --  Host image misconfiguration \n  
      - QMI_DMS_MASK_OFFLINE_REASON_PRI_IMAGE (0x0002) --  PRI image misconfiguration \n 
      - QMI_DMS_MASK_OFFLINE_REASON_PRI_VERSION (0x0004) --  PRI version incompatible \n 
      - QMI_DMS_MASK_OFFLINE_REASON_DEVICE_MEMORY (0x0008) --  Device memory is full, cannot copy PRI information
...
typedef struct {
 ...
 Values: \n
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDA (0x0000000000000001) --  TDS band A 1900 to 1920 MHz, 2010 to 2020 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDB (0x0000000000000002) --  TDS band B 1850 to 1910 MHz, 1930 to 1990 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDC (0x0000000000000004) --  TDS band C 1910 to 1930 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDD (0x0000000000000008) --  TDS band D 2570 to 2620 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDE (0x0000000000000010) --  TDS band E 2300 to 2400 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDF (0x0000000000000020) --  TDS band F 1880 to 1920 MHz  
 */
...
typedef struct {
  ...
  */
  ...
  /**<    Notifies the TE whether the current set of activity information
  ...
  */
  ...
  /**<    Provides active status of the modem RAT/TECH based on NPA vote.
        TRUE indicates that the modem RAT/TECH is active as per vote.
  */
  ...
  /**<    Provides active status of WLAN based on NPA vote.
        TRUE indicates that WLAN is active as per vote.
  */
  ...
  /**<    Provides active status of GPS based on NPA vote.
        TRUE indicates that GPS is active as per vote.
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Duration in PSM in milliseconds */
  uint8_t duration_in_psm_in_ms_valid;  /**< Must be set to true if duration_in_psm_in_ms is being passed */
  uint32_t duration_in_psm_in_ms;
  /**<   Duration to stay in PSM (in milliseconds).
  */
...
typedef enum {
  ...
  DMS_PSM_STATUS_COMPLETED_V01 = 0, /**<  Entering PSM is complete. \n  */
...
typedef struct {
  ...
  /**<   PSM status. Values: \n
      - DMS_PSM_STATUS_COMPLETED (0) --  Entering PSM is complete. \n 
...
typedef struct {
  ...
  /**<   PSM version that the control point supports. Values: \n
      ...
      - DMS_PSM_VERSION_1 (1) --  Version 1: AP decides the time that the modem goes into PSM \n
      - DMS_PSM_VERSION_2 (2) --  Version 2: Modem calculates and decides the time that it goes into PSM \n
      - DMS_PSM_VERSION_UNSPEC (0xFF) --  PSM version unspecified, for example, the modem either does not support the PSM feature or version 1 is 
           supported on an older modem that does not support negotiating PSM version (default value).
 */
  ...
  */
  ...
  /**<   Retrieve ENDC throughput threshold. Values:\n
       - 0 -- Do not retrieve (default) \n
  ...
  /* Optional */
  /*  NRDC Mute Feature */
  uint8_t nrdc_mute_feature_valid;  /**< Must be set to true if nrdc_mute_feature is being passed */
  uint8_t nrdc_mute_feature;
  /**<   New Radio dual connectivity (NRDC) mute feature. Values:\n
       - 0 -- Do not retrieve (default) \n
       - 1 -- Retrieve NRDC mute feature status
   */

  /* Optional */
  /*  NRDC Interactive Configuration */
  uint8_t nrdc_interactive_config_valid;  /**< Must be set to true if nrdc_interactive_config is being passed */
  uint8_t nrdc_interactive_config;
  /**<   NRDC user interactive configuration. Values:\n
       - 0 -- Do not retrieve (default) \n
       - 1 -- Retrieve NRDC interactive configuration
  */

  /* Optional */
  /*  NRDC Throughput Threshold */
  uint8_t nrdc_throughput_threshold_valid;  /**< Must be set to true if nrdc_throughput_threshold is being passed */
  uint8_t nrdc_throughput_threshold;
  /**<   Retrieve NRDC throughput threshold. Values:\n
       - 0 -- Do not retrieve (default) \n
       - 1 -- Retrieve NRDC throughput threshold values
   */
 ...
 */
  ...
  uint8_t endc_interactive_config_valid;  /**< Must be set to true if endc_interactive_config is being passed */
  uint8_t endc_interactive_config;
  /**<   ENDC user interactive configuration. Only applicable when the
       ENDC Mute Feature TLV is enabled in the response.  Values:\n
       - 0 -- Modem does not consider the interactive state 
             in the ENDC feature. \n
       - 1 -- Modem considers the interactive state in the ENDC mute feature.
  */
  ...
  /**<   ENDC throughput threshold in kbps. Only applicable when the
       ENDC Mute Feature TLV is enabled in the response.
   */

  /* Optional */
  /*  NRDC Mute Feature */
  uint8_t nrdc_mute_feature_enable_valid;  /**< Must be set to true if nrdc_mute_feature_enable is being passed */
  uint8_t nrdc_mute_feature_enable;
  /**<   NRDC mute feature. Values:\n
       - 0 -- Disabled (default) \n
       - 1 -- Enabled
   */
  ...
  uint8_t nrdc_interactive_config_valid;  /**< Must be set to true if nrdc_interactive_config is being passed */
  uint8_t nrdc_interactive_config;
  /**<   NRDC user interactive configuration. Only applicable when the
       NRDC Mute Feature TLV is enabled in the response.  Values:\n
       - 0 -- Modem does not consider the interactive state 
             in the NRDC feature. \n
       - 1 -- Modem considers the interactive state in the NRDC mute feature.
  */

  /* Optional */
  /*  NRDC Throughput Threshold 1 */
  uint8_t nrdc_throughput_threshold_1_valid;  /**< Must be set to true if nrdc_throughput_threshold_1 is being passed */
  uint32_t nrdc_throughput_threshold_1;
  /**<   NRDC throughput threshold in kbps. Only applicable when
       NRDC Mute Feature TLV is enabled in the response.
   */

  /* Optional */
  /*  NRDC Throughput Threshold 2 */
  uint8_t nrdc_throughput_threshold_2_valid;  /**< Must be set to true if nrdc_throughput_threshold_2 is being passed */
  uint32_t nrdc_throughput_threshold_2;
  /**<   NRDC throughput threshold in kbps. Only applicable when the
       NRDC Mute Feature TLV is enabled in the response.
   */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Notifies the control point whenever the sensor policy is met or the batch is full. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<   List of threshold values (ranging from 0 to 100 percent) that 
       trigger battery reporting. Only applicable when the Report Power Status
       TLV is set to TRUE.
  */
 ...
 */
  ...
  /**<   Battery index, calculated based on the Battery Threshold List and 
       Battery Level Percentage TLVs; range starts from 0.
      */
...
typedef struct {
  ...
  dms_marb_client_group_type_v01 prioritized_app;
  /**<   Application to prioritize on the modem. 
      - DMS_MARB_CLI_GROUP_GNSS (0) --  For all GNSS clients to use. \n  
      - DMS_MARB_CLI_GROUP_WWAN (1) --  For all WWAN clients to use.  
 */
  ...
  /**<   Technology that is loaded on the modem. Values:\n
...
typedef struct {
  ...
  uint8_t endc_interactive_config;
  /**<   ENDC user interactive configuration. Only applicable when the
       ENDC Mute Feature TLV is enabled. If this TLV is not present,
       the modem uses the default modem configuration. Values: \n
       - 0 -- Modem does not consider the interactive state 
             in the ENDC feature. \n
       - 1 -- Modem considers the interactive state in the ENDC mute feature
  */
  ...
  uint32_t throughput_threshold_1;
  /**<   ENDC throughput threshold in kbps. Only applicable when
       the ENDC Mute Feature TLV is enabled. If this TLV is not present,
       the modem uses the default modem configuration.
   */
  ...
  uint8_t nrdc_interactive_config;
  /**<   NRDC user interactive configuration. Only applicable when the
       NRDC Mute Feature TLV is enabled. If this TLV is not present,
       the modem uses the default modem configuration. Values: \n
       - 0 -- Modem does not consider the interactive state 
             in the NRDC feature. \n
       - 1 -- Modem considers the interactive state in the NRDC mute feature
  */
  ...
  uint32_t nrdc_throughput_threshold_1;
  /**<   NRDC throughput threshold in kbps. Only applicable when
       the NRDC Mute Feature TLV is enabled. If this TLV is not present,
       the modem uses the default modem configuration.
   */
...
typedef struct {
  ...
  /**<   ENDC user interactive configuration. Only applicable when
       the ENDC Mute Feature TLV is enabled.  Values:\n
       - 0 -- Modem does not consider the interactive state 
              in the ENDC feature. \n
       - 1 -- Modem considers interactive state in the ENDC mute feature.
  */
  ...
  uint32_t throughput_threshold_1;
  /**<   ENDC throughput threshold in kbps. Only applicable when
       the ENDC Mute Feature TLV is enabled.
   */
  ...
  uint8_t nrdc_interactive_config_valid;  /**< Must be set to true if nrdc_interactive_config is being passed */
  uint8_t nrdc_interactive_config;
  /**<   NRDC user interactive configuration. Only applicable when
       the NRDC Mute Feature TLV is enabled.  Values:\n
       - 0 -- Modem does not consider the interactive state 
              in the NRDC feature. \n
       - 1 -- Modem considers interactive state in the NRDC mute feature.
  */
  ...
  uint32_t nrdc_throughput_threshold_1;
  /**<   NRDC throughput threshold in kbps. Only applicable when
       the NRDC Mute Feature TLV is enabled.
   */
...
typedef struct {
  ...
  */
  ...
  uint8_t tds_band_capability_valid;  /**< Must be set to true if tds_band_capability is being passed */
  dms_tds_band_capability_mask_v01 tds_band_capability;
  /**<   Bitmask of TDS bands supported by the device. This TLV 
 is present on devices that support TDS bands. 
 Values: \n
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDA (0x0000000000000001) --  TDS band A 1900 to 1920 MHz, 2010 to 2020 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDB (0x0000000000000002) --  TDS band B 1850 to 1910 MHz, 1930 to 1990 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDC (0x0000000000000004) --  TDS band C 1910 to 1930 MHz \n 
 ...
 */
  ...
  */
  ...
  /**<   Bitmask of low capability TDS bands supported by the device.
 This TLV is present on devices that support asymmetric TDS bands. 
 Values: \n
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDA (0x0000000000000001) --  TDS band A 1900 to 1920 MHz, 2010 to 2020 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDB (0x0000000000000002) --  TDS band B 1850 to 1910 MHz, 1930 to 1990 MHz \n 
      - QMI_DMS_MASK_BAND_PREF_TDS_BANDC (0x0000000000000004) --  TDS band C 1910 to 1930 MHz \n 
 ...
 */
  ...
  */
  ...
  /**<   Array of supported low capability NR5G bands where each entry is a 
       decimal representation of the supported NR5G band number.
       The bands are comprised of both SA and NSA bands.
  */
...
typedef struct {
  ...
  /**<   Reports the device activity state. Values:\n
       - 0 -- Do not report\n
...
typedef struct {
  ...
  /**<   Indicates the state of device initialization. Values:\n
      - DMS_INIT_STATE_UNSPECIFIED (0) --  State unspecified. \n  
      - DMS_INIT_STATE_IN_PROGRESS (1) --  In progress. \n  
      - DMS_INIT_STATE_READY (2) --  Device initialized. \n 
      - DMS_INIT_STATE_FAILED (3) --  Failed.  
 */
  ...
  /**<   This TLV is applicable when the Device Initialization State
 TLV value is DMS_INIT_STATE_FAILED. Values:\n
      - DMS_DEVICE_STATE_FAIL_RF_SW (1) --  RF software failure. \n 
      - DMS_DEVICE_STATE_FAIL_RF_HW (2) --  RF hardware failure. \n 
      - DMS_DEVICE_STATE_FAIL_GPS (3) --  GPS failure.  
 */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Queries the device state information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Queries the device state information. */
typedef struct {
 ...
 */
 ...
 is DMS_INIT_STATE_FAILED. Values:\n
      - DMS_DEVICE_STATE_FAIL_RF_SW (1) --  RF software failure. \n 
      - DMS_DEVICE_STATE_FAIL_RF_HW (2) --  RF hardware failure. \n 
      - DMS_DEVICE_STATE_FAIL_GPS (3) --  GPS failure.  
 */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Queries IMEI information. */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Queries IMEI information. */
typedef struct {
...
typedef enum {
  ...
  DMS_PRIMARY_IMEI_V01 = 0, /**<  Primary \n       */
  DMS_SECONDARY_IMEI_V01 = 1, /**<  Secondary   */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Notifies the control point about the IMEI information. */
typedef struct {
  ...
  */
  ...
  /**<   Type of IMEI. Values:\n
      - DMS_PRIMARY_IMEI (0) --  Primary \n      
      - DMS_SECONDARY_IMEI (1) --  Secondary  
 */
  ...
  /**<   Nonencrypted IMEI of the device.
  */
  ...
  */
  ...
  /* Optional */
  /*  Nonencrypted IMEI SVN */
  uint8_t imeisv_svn_nonencryt_valid;  /**< Must be set to true if imeisv_svn_nonencryt is being passed */
  char imeisv_svn_nonencryt[QMI_DMS_IMEISV_MAX_V01 + 1];
  /**<   Non Encrypted IMEI software version number
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Queries Non-Terrestrial Networks(NTN) Capability. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_ntn_capability_req_msg_v01;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Queries Non-Terrestrial Networks(NTN) Capability. */
typedef struct {
  ...
  /* Optional */
  /*  IS NB NTN AVAIL */
  uint8_t is_nb_ntn_supported_valid;  /**< Must be set to true if is_nb_ntn_supported is being passed */
  uint8_t is_nb_ntn_supported;
  /**<   Reports the Capability of NB NTN RAT. Values:\n
       - 0 -- Not Available\n
       - 1 -- Available 
  */
}dms_get_ntn_capability_resp_msg_v01;  /* Message */
/**
    @}
  */
 //for board SN
typedef struct {
  char __placeholder;
}dms_get_whole_2498_req_msg_v01;

typedef struct {
  qmi_response_type_v01 resp;
  char whole_2498[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_get_whole_2498_resp_msg_v01;  /* Message */

typedef struct {
  char whole_2498[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_set_whole_2498_req_msg_v01;  /* Message */

typedef struct {
  qmi_response_type_v01 resp;
}dms_set_whole_2498_resp_msg_v01;  /* Message */

//for Modelnumber
typedef struct {
  char __placeholder;
}dms_get_whole_2497_req_msg_v01;

typedef struct {
  qmi_response_type_v01 resp;
  char whole_2497[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_get_whole_2497_resp_msg_v01;  /* Message */

typedef struct {
  char whole_2497[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_set_whole_2497_req_msg_v01;  /* Message */

typedef struct {
  qmi_response_type_v01 resp;
}dms_set_whole_2497_resp_msg_v01;  /* Message */

//for HyteraSN
typedef struct {
  char __placeholder;
}dms_get_whole_2499_req_msg_v01;

typedef struct {
  qmi_response_type_v01 resp;
  char whole_2499[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_get_whole_2499_resp_msg_v01;  /* Message */

typedef struct {
  char whole_2499[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_set_whole_2499_req_msg_v01;  /* Message */

typedef struct {
  qmi_response_type_v01 resp;
}dms_set_whole_2499_resp_msg_v01;  /* Message */
//for Modelname
typedef struct {
  char __placeholder;
}dms_get_whole_2500_req_msg_v01;

typedef struct {
  qmi_response_type_v01 resp;
  char whole_2500[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_get_whole_2500_resp_msg_v01;  /* Message */
typedef struct {
  char whole_2500[QMI_DMS_WHOLE_FACTORY_MAX_V01 + 1];
}dms_set_whole_2500_req_msg_v01;  /* Message */

typedef struct {
  qmi_response_type_v01 resp;
}dms_set_whole_2500_resp_msg_v01;  /* Message */
...
//#define REMOVE_QMI_DMS_GET_NTN_CAPABILITY_V01
...
#define QMI_DMS_GET_NTN_CAPABILITY_REQ_V01 0x007F
#define QMI_DMS_GET_NTN_CAPABILITY_RESP_V01 0x007F
//for sn
#define QMI_DMS_GET_WHOLE_2498_REQ_V01 0x0080
#define QMI_DMS_GET_WHOLE_2498_RESP_V01 0x0080
#define QMI_DMS_SET_WHOLE_2498_REQ_V01 0x0081
#define QMI_DMS_SET_WHOLE_2498_RESP_V01 0x0081
//for product ID
#define QMI_DMS_GET_WHOLE_2497_REQ_V01 0x0082
#define QMI_DMS_GET_WHOLE_2497_RESP_V01 0x0082
#define QMI_DMS_SET_WHOLE_2497_REQ_V01 0x0083
#define QMI_DMS_SET_WHOLE_2497_RESP_V01 0x0083
//for module No
#define QMI_DMS_GET_WHOLE_2499_REQ_V01 0x0084
#define QMI_DMS_GET_WHOLE_2499_RESP_V01 0x0084
#define QMI_DMS_SET_WHOLE_2499_REQ_V01 0x0085
#define QMI_DMS_SET_WHOLE_2499_RESP_V01 0x0085

#define QMI_DMS_GET_WHOLE_2500_REQ_V01 0x0086
#define QMI_DMS_GET_WHOLE_2500_RESP_V01 0x0086
#define QMI_DMS_SET_WHOLE_2500_REQ_V01 0x0087
#define QMI_DMS_SET_WHOLE_2500_RESP_V01 0x0087
/**
    @}
  */
