...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2015-17,2020 Qualcomm Technologies, Inc. 
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.



  $Header: //components/rel/qmimsgs.mpss/4.6.9/servreg_notif/api/service_registry_notifier_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Fri Jun 12 2020 (Spin 0)
...
#define SERVREG_NOTIF_V01_IDL_MINOR_VERS 0x03
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Request Message; Queries the current state of the selected service.     */
typedef struct {
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Response Message; Queries the current state of the selected service.     */
typedef struct {
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Indication Message; Notifies clients when there is a state change in the
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Request Message; Acknowledges the service state change notification. */
typedef struct {
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Response Message; Acknowledges the service state change notification. */
typedef struct {
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Request Message; Requests to restart a PD present in a subsystem.            */
typedef struct {

  /* Mandatory */
  /*  Process Specifier  */
  char process_spc_name[QMI_SERVREG_NOTIF_PROCESS_SPECEFIER_NAME_LENGTH_V01 + 1];
  /**<   Name of the process specifier. */
...
/** @addtogroup servreg_notif_qmi_messages
    @{
  */
/** Response Message; Requests to restart a PD present in a subsystem.            */
typedef struct {
