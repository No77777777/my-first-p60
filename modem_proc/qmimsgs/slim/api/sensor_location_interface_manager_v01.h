...
Copyright (c) 2021-2022 Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/slim/api/sensor_location_interface_manager_v01.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SLIM_V01_IDL_MINOR_VERS 0x07
...
#define QMI_SLIM_MAX_VENDOR_NAME_SIZE_V01 100
/**
    @}
  */
 ...
 */
  ...
  /* Optional */
  /*  full-scale setting */
  uint8_t fullScaleSetting_valid;  /**< Must be set to true if fullScaleSetting is being passed */
  uint16_t fullScaleSetting;
  /**<   current full-scale setting of specified service 
     Values are specific to each service 
     ACC_RANGE(G) 2 4 8 16
     GYRO_RANGE(dps) 125 250 500 1000 2000 4000
    */

  /* Optional */
  /*  Sensor Vendor Name */
  uint8_t vendorName_valid;  /**< Must be set to true if vendorName is being passed */
  uint32_t vendorName_len;  /**< Must be set to # of elements in vendorName */
  uint8_t vendorName[QMI_SLIM_MAX_VENDOR_NAME_SIZE_V01];
  /**<   Vendor name of sensor
    */
