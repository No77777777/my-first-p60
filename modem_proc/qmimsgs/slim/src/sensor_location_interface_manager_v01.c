...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2014-2022 Qualcomm Atheros, Inc. 
  All rights reserved.
...
Copyright (c) 2021-2022 Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/slim/src/sensor_location_interface_manager_v01.c#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Thu Nov  3 2022 (Spin 0)
...
static const uint8_t qmiSlimServiceUpdateIndMsgT_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, fullScaleSetting) - QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, fullScaleSetting_valid)),
  0x10,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, fullScaleSetting),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, vendorName) - QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, vendorName_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, vendorName),
  QMI_SLIM_MAX_VENDOR_NAME_SIZE_V01,
  QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, vendorName) - QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, vendorName_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, samplingRate) - QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, samplingRate_valid)),
  0x12,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmiSlimServiceUpdateIndMsgT_v01, samplingRate)
};
...
static const uint8_t qmiSlimSensorDataIndMsgT_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimSensorDataIndMsgT_v01, samplesZ) - QMI_IDL_OFFSET16RELATIVE(qmiSlimSensorDataIndMsgT_v01, samplesZ_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimSensorDataIndMsgT_v01, sampleTimeOffsetsSubMilliNs) - QMI_IDL_OFFSET16RELATIVE(qmiSlimSensorDataIndMsgT_v01, sampleTimeOffsetsSubMilliNs_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimSensorDataIndMsgT_v01, sampleTimeOffsetsSubMilliNs),
  QMI_SLIM_SENSOR_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimSensorDataIndMsgT_v01, sampleTimeOffsetsSubMilliNs) - QMI_IDL_OFFSET16RELATIVE(qmiSlimSensorDataIndMsgT_v01, sampleTimeOffsetsSubMilliNs_len)
};
...
static const uint8_t qmiSlimVehicleMotionDataIndMsgT_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, gear) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, gear_valid)),
  0x15,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, steering_wheel) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, steering_wheel_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, steering_wheel),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, steering_wheel) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, steering_wheel_len)
};
...
static const qmi_idl_service_message_table_entry slim_service_indication_messages_v01[] = {
  {QMI_SLIM_SERVICE_UPDATE_IND_V01, QMI_IDL_TYPE16(0, 5), 132},
  {QMI_SLIM_SERVICE_ERROR_IND_V01, QMI_IDL_TYPE16(0, 1), 14},
  {QMI_SLIM_SENSOR_DATA_IND_V01, QMI_IDL_TYPE16(0, 12), 1051},
  ...
  {QMI_SLIM_VEHICLE_MOTION_DATA_IND_V01, QMI_IDL_TYPE16(0, 17), 1513}
};
