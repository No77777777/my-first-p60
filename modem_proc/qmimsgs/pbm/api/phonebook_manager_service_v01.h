...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/pbm/api/phonebook_manager_service_v01.h#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define PBM_V01_IDL_MINOR_VERS 0x18
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define PBM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define PBM_V01_MAX_MESSAGE_ID 0x0026
/**
    @}
  */
...
#define QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01 8
...
#define QMI_PBM_EMER_NUM_EXTENDED_MAX_LENGTH_V01 15
...
#define QMI_PBM_MAX_NUM_SUB_V01 3
...
#define PBM_REG_DISABLE_PB_ALL_INIT_DONE_EVENTS_V01 ((pbm_reg_mask_type_v01)0x40) /**<  Disable PB All init done indication  */
#define PBM_REG_EXT_EMERGENCY_NUMBER_LIST_EVENTS_V01 ((pbm_reg_mask_type_v01)0x80) /**<  Extended Emergency number list events  */
...
typedef struct {
  ...
  /**<   Bitmask of the events to be registered: \n
      ...
      - PBM_REG_DISABLE_PB_ALL_INIT_DONE_EVENTS (0x40) --  Disable PB All init done indication 
      - PBM_REG_EXT_EMERGENCY_NUMBER_LIST_EVENTS (0x80) --  Extended Emergency number list events 
 */
...
typedef enum {
  ...
  PBM_SESSION_TYPE_GLOBAL_PB_PRIMARY_V01 = 0x0B, /**<  Global phonebook based Primary SUB session   */
  PBM_SESSION_TYPE_GLOBAL_PB_SECONDARY_V01 = 0x0C, /**<  Global phonebook based Secondary SUB session   */
  PBM_SESSION_TYPE_GLOBAL_PB_TERTIARY_V01 = 0x0D, /**<  Global phonebook based Tertiary SUB session  */
...
typedef struct {
  ...
  /**<   Session type values: \n
      ...
      - PBM_SESSION_TYPE_GLOBAL_PB_PRIMARY (0x0B) --  Global phonebook based Primary SUB session  
      - PBM_SESSION_TYPE_GLOBAL_PB_SECONDARY (0x0C) --  Global phonebook based Secondary SUB session  
      - PBM_SESSION_TYPE_GLOBAL_PB_TERTIARY (0x0D) --  Global phonebook based Tertiary SUB session 
...
typedef struct {
  ...
  /* Optional */
  /*  Capability Basic Info Array */
  uint8_t extended_capability_basic_info_array_valid;  /**< Must be set to true if extended_capability_basic_info_array is being passed */
  uint32_t extended_capability_basic_info_array_len;  /**< Must be set to # of elements in extended_capability_basic_info_array */
  pbm_capability_basic_info_array_type_v01 extended_capability_basic_info_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Group Capability Array */
  uint8_t extended_group_capability_array_valid;  /**< Must be set to true if extended_group_capability_array is being passed */
  uint32_t extended_group_capability_array_len;  /**< Must be set to # of elements in extended_group_capability_array */
  pbm_group_capability_with_session_type_v01 extended_group_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Additional Number Capability Array */
  uint8_t extended_ad_num_capability_array_valid;  /**< Must be set to true if extended_ad_num_capability_array is being passed */
  uint32_t extended_ad_num_capability_array_len;  /**< Must be set to # of elements in extended_ad_num_capability_array */
  pbm_ad_num_capability_with_session_type_v01 extended_ad_num_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Email Capability Array */
  uint8_t extended_email_capability_array_valid;  /**< Must be set to true if extended_email_capability_array is being passed */
  uint32_t extended_email_capability_array_len;  /**< Must be set to # of elements in extended_email_capability_array */
  pbm_email_capability_with_session_type_v01 extended_email_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Second Name Capability Array */
  uint8_t extended_second_name_capability_array_valid;  /**< Must be set to true if extended_second_name_capability_array is being passed */
  uint32_t extended_second_name_capability_array_len;  /**< Must be set to # of elements in extended_second_name_capability_array */
  pbm_second_name_capability_with_session_type_v01 extended_second_name_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Hidden Records Capability Array */
  uint8_t extended_hidden_records_capability_array_valid;  /**< Must be set to true if extended_hidden_records_capability_array is being passed */
  uint32_t extended_hidden_records_capability_array_len;  /**< Must be set to # of elements in extended_hidden_records_capability_array */
  pbm_hidden_records_capability_with_session_type_v01 extended_hidden_records_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Grouping Information Alpha String Capability Array */
  uint8_t extended_gas_capability_array_valid;  /**< Must be set to true if extended_gas_capability_array is being passed */
  uint32_t extended_gas_capability_array_len;  /**< Must be set to # of elements in extended_gas_capability_array */
  pbm_gas_capability_with_session_type_v01 extended_gas_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Additional Number Alpha String Capability Array */
  uint8_t extended_aas_capability_array_valid;  /**< Must be set to true if extended_aas_capability_array is being passed */
  uint32_t extended_aas_capability_array_len;  /**< Must be set to # of elements in extended_aas_capability_array */
  pbm_aas_capability_with_session_type_v01 extended_aas_capability_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];

  /* Optional */
  /*  Phonebook Set Capability Information Array */
  uint8_t extended_pb_set_info_array_valid;  /**< Must be set to true if extended_pb_set_info_array is being passed */
  uint32_t extended_pb_set_info_array_len;  /**< Must be set to # of elements in extended_pb_set_info_array */
  pbm_pb_set_cap_info_with_session_type_v01 extended_pb_set_info_array[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];
...
typedef struct {
  ...
  uint32_t emer_num_len;  /**< Must be set to # of elements in emer_num */
  char emer_num[QMI_PBM_EMER_NUM_EXTENDED_MAX_LENGTH_V01];
  /**<   Emergency number.*/
}pbm_extended_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  char emer_num[QMI_PBM_EMER_NUM_EXTENDED_MAX_LENGTH_V01];
  /**<   Emergency number.*/
}pbm_extended_ecc_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t emer_nums_len;  /**< Must be set to # of elements in emer_nums */
  pbm_extended_ecc_emer_num_type_v01 emer_nums[QMI_PBM_MAX_NUM_CARD_ECC_EMER_NUM_V01];
}pbm_extended_card_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t emer_nums_len;  /**< Must be set to # of elements in emer_nums */
  pbm_extended_ecc_emer_num_type_v01 emer_nums[QMI_PBM_MAX_NUM_NETWORK_ECC_EMER_NUM_V01];
}pbm_extended_network_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t emer_nums_len;  /**< Must be set to # of elements in emer_nums */
  pbm_extended_emer_num_type_v01 emer_nums[QMI_PBM_MAX_NUM_MCC_EMER_NUM_V01];
}pbm_extended_mcc_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  char emer_num[QMI_PBM_EMER_NUM_EXTENDED_MAX_LENGTH_V01];
  /**<   Emergency number.*/
}pbm_extended_ecc_elenl_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t emer_nums_len;  /**< Must be set to # of elements in emer_nums */
  pbm_extended_ecc_elenl_emer_num_type_v01 emer_nums[QMI_PBM_MAX_NUM_ELENL_ECC_EMER_NUM_V01];
}pbm_extended_elenl_emer_num_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  MCC Based Emergency Numbers for Each SUB */
  uint8_t mcc_emer_nums_sub_valid;  /**< Must be set to true if mcc_emer_nums_sub is being passed */
  uint32_t mcc_emer_nums_sub_len;  /**< Must be set to # of elements in mcc_emer_nums_sub */
  pbm_mcc_emer_num_type_v01 mcc_emer_nums_sub[QMI_PBM_MAX_NUM_SUB_V01];

  /* Optional */
  /*  Serving MCC Based Emergency Numbers for Each SUB */
  uint8_t serving_mcc_emer_nums_sub_valid;  /**< Must be set to true if serving_mcc_emer_nums_sub is being passed */
  uint32_t serving_mcc_emer_nums_sub_len;  /**< Must be set to # of elements in serving_mcc_emer_nums_sub */
  pbm_mcc_emer_num_type_v01 serving_mcc_emer_nums_sub[QMI_PBM_MAX_NUM_SUB_V01];
...
/** @addtogroup pbm_qmi_messages
    @{
  */
/** Request Message; Indication with list of all emergency numbers. */
typedef struct {
  ...
  /* Optional */
  /*  Card Extended Emergency Numbers */
  uint8_t card_emer_nums_valid;  /**< Must be set to true if card_emer_nums is being passed */
  uint32_t card_emer_nums_len;  /**< Must be set to # of elements in card_emer_nums */
  pbm_extended_card_emer_num_type_v01 card_emer_nums[QMI_PBM_MAX_NUM_CARD_EMER_NUM_V01];

  /* Optional */
  /*  Network Extended Emergency Numbers */
  uint8_t network_emer_nums_valid;  /**< Must be set to true if network_emer_nums is being passed */
  uint32_t network_emer_nums_len;  /**< Must be set to # of elements in network_emer_nums */
  pbm_extended_network_emer_num_type_v01 network_emer_nums[QMI_PBM_MAX_NUM_NETWORK_EMER_NUM_V01];

  /* Optional */
  /*  Hard Coded Extended Emergency Numbers Extended */
  uint8_t emer_nums_extended_valid;  /**< Must be set to true if emer_nums_extended is being passed */
  uint32_t emer_nums_extended_len;  /**< Must be set to # of elements in emer_nums_extended */
  pbm_extended_emer_num_type_v01 emer_nums_extended[QMI_PBM_MAX_NUM_EMER_NUM_EXTENDED_V01];

  /* Optional */
  /*  NV Extended Emergency Numbers Extended */
  uint8_t nv_emer_nums_extended_valid;  /**< Must be set to true if nv_emer_nums_extended is being passed */
  uint32_t nv_emer_nums_extended_len;  /**< Must be set to # of elements in nv_emer_nums_extended */
  pbm_extended_emer_num_type_v01 nv_emer_nums_extended[QMI_PBM_MAX_NUM_NV_EMER_NUM_EXTENDED_V01];

  /* Optional */
  /*  Hardcoded Extended Emergency Numbers Extended with Category  */
  uint8_t emer_nums_extended_cat_valid;  /**< Must be set to true if emer_nums_extended_cat is being passed */
  uint32_t emer_nums_extended_cat_len;  /**< Must be set to # of elements in emer_nums_extended_cat */
  uint8_t emer_nums_extended_cat[QMI_PBM_MAX_NUM_EMER_NUM_EXTENDED_V01];
  /**<   Bitmask of Emergency number categories, which are provided in \n
  ...
  uint8_t mcc_emer_nums_valid;  /**< Must be set to true if mcc_emer_nums is being passed */
  uint32_t mcc_emer_nums_len;  /**< Must be set to # of elements in mcc_emer_nums */
  pbm_extended_mcc_emer_num_type_v01 mcc_emer_nums[QMI_PBM_MAX_NUM_SLOT_V01];

  /* Optional */
  /*  Extended Local Emergency Numbers  */
  uint8_t elenl_emer_nums_valid;  /**< Must be set to true if elenl_emer_nums is being passed */
  uint32_t elenl_emer_nums_len;  /**< Must be set to # of elements in elenl_emer_nums */
  pbm_extended_elenl_emer_num_type_v01 elenl_emer_nums[QMI_PBM_MAX_NUM_NETWORK_EMER_NUM_V01];

  /* Optional */
  /*  Serving MCC Based Emergency Numbers for Each Slot */
  uint8_t serving_mcc_emer_nums_valid;  /**< Must be set to true if serving_mcc_emer_nums is being passed */
  uint32_t serving_mcc_emer_nums_len;  /**< Must be set to # of elements in serving_mcc_emer_nums */
  pbm_extended_mcc_emer_num_type_v01 serving_mcc_emer_nums[QMI_PBM_MAX_NUM_SLOT_V01];

  /* Optional */
  /*  Extended MCC Based Emergency Numbers for Each SUB */
  uint8_t mcc_emer_nums_sub_valid;  /**< Must be set to true if mcc_emer_nums_sub is being passed */
  uint32_t mcc_emer_nums_sub_len;  /**< Must be set to # of elements in mcc_emer_nums_sub */
  pbm_extended_mcc_emer_num_type_v01 mcc_emer_nums_sub[QMI_PBM_MAX_NUM_SUB_V01];

  /* Optional */
  /*  Extended Serving MCC Based Emergency Numbers for Each SUB */
  uint8_t serving_mcc_emer_nums_sub_valid;  /**< Must be set to true if serving_mcc_emer_nums_sub is being passed */
  uint32_t serving_mcc_emer_nums_sub_len;  /**< Must be set to # of elements in serving_mcc_emer_nums_sub */
  pbm_extended_mcc_emer_num_type_v01 serving_mcc_emer_nums_sub[QMI_PBM_MAX_NUM_SUB_V01];
}pbm_emergency_list_ext_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}pbm_get_emergency_list_ext_req_msg_v01;
...
typedef struct {
  ...
  uint32_t serving_mcc_emer_nums_sub_len;  /**< Must be set to # of elements in serving_mcc_emer_nums_sub */
  pbm_extended_mcc_emer_num_type_v01 serving_mcc_emer_nums_sub[QMI_PBM_MAX_NUM_SUB_V01];
}pbm_get_emergency_list_ext_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  AAS Data */
  uint8_t extended_aas_data_valid;  /**< Must be set to true if extended_aas_data is being passed */
  uint32_t extended_aas_data_len;  /**< Must be set to # of elements in extended_aas_data */
  pbm_aas_data_type_v01 extended_aas_data[QMI_PBM_MAX_EXTENDED_NUM_SESSIONS_V01];
...
//#define REMOVE_QMI_PBM_EMERGENCY_LIST_EXT_IND_V01
...
//#define REMOVE_QMI_PBM_GET_EMERGENCY_LIST_EXT_V01
...
#define QMI_PBM_GET_EMERGENCY_LIST_EXT_REQ_V01 0x0025
#define QMI_PBM_GET_EMERGENCY_LIST_EXT_RESP_V01 0x0025
#define QMI_PBM_EMERGENCY_LIST_EXT_IND_V01 0x0026
/**
    @}
  */
