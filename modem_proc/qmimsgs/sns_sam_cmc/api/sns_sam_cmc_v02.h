...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/sns_sam_cmc/api/sns_sam_cmc_v02.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.5 
   It was generated on: Sat Jun 13 2015 (Spin 0)
...
/**  Maximum number of reports in a batch indication -
     set based on maximum payload size supported by transport framework */
#define SNS_SAM_CMC_MAX_ITEMS_IN_BATCH_V02 123

/**  Maximum number of supported motion states */
...
typedef struct {
  ...
  /**<   Variable length array containing the list of active motion states, i.e, algorithms
...
typedef struct {
  ...
  /**<   Field no longer supported in version 2 and later.  Functionality can be
       approximated using the notify_suspend flag in the ENABLE_REQ message.  Maximum
       ...
       2 – Use to get maximum buffer depth. Does not enable/disable batching.
