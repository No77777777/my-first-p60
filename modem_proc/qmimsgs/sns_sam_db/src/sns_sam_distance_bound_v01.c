...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/sns_sam_db/src/sns_sam_distance_bound_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const qmi_idl_service_message_table_entry SNS_SAM_DISTANCE_BOUND_SVC_service_response_messages_v01[] = {
  ...
  {SNS_SAM_DISTANCE_BOUND_GET_ATTRIBUTES_RESP_V01, QMI_IDL_TYPE16(1, 1), 79}
};
