...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/uim/api/user_identity_module_v01.h#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define UIM_V01_IDL_MINOR_VERS 0x72
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0080
/**
    @}
  */
...
#define QMI_UIM_IMSI_PREFIX_MAX_V01 15
...
#define QMI_UIM_PORT_MAX_V01 3
#define QMI_UIM_IMPI_DIGIT_MAX_V01 64
#define QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01 100
#define QMI_UIM_EUICC_PROFILES_COUNT_MAX_V01 8
...
typedef enum {
  ...
  UIM_PERSO_FEATURE_GW_CARRIER_V01 = 0x10, /**<  GW carrier personalization  */
...
typedef struct {
 ...
 Valid values:\n
      ...
      - UIM_PERSO_FEATURE_GW_CARRIER (0x10) --  GW carrier personalization 
 */
...
typedef enum {
  ...
  UIM_PERSO_FEATURE_STATUS_GW_CARRIER_V01 = 0x11, /**<  GW carrier personalization  */
 ...
 */
 ...
 personalization. Valid values:\n
      ...
      - UIM_PERSO_FEATURE_STATUS_GW_CARRIER (0x11) --  GW carrier personalization 
 */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_UNLOCK_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_UNLOCK_STATUS_UNKNOWN_V01 = 0x00, /**<  Unlock status unknown \n  */
  UIM_UNLOCK_STATUS_TEMPORARY_UNLOCKED_V01 = 0x01, /**<  Unlock status temporary unlocked \n  */
  UIM_UNLOCK_STATUS_PERMANENT_UNLOCKED_V01 = 0x02, /**<  Unlock status permanent unlocked \n  */
  UIM_UNLOCK_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_unlock_status_enum_v01;
/**
    @}
  */
 ...
 */
  ...
  uim_unlock_status_enum_v01 unlock_status;
  /**<   Indicates unlock status of the application. Valid valued:\n
      - UIM_UNLOCK_STATUS_UNKNOWN (0x00) --  Unlock status unknown \n 
      - UIM_UNLOCK_STATUS_TEMPORARY_UNLOCKED (0x01) --  Unlock status temporary unlocked \n 
      - UIM_UNLOCK_STATUS_PERMANENT_UNLOCKED (0x02) --  Unlock status permanent unlocked \n 
 \n
 Other values are reserved for the future and are to be handled as
 ``Unknown''.
 */
}unlock_app_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uim_session_type_enum_v01 session;
  /**<   Indicates the session type on which NTN is activated. Only GW provisioning sessions can be used.
       if NTN is not activated  the ntn_session shall have value 2147483647 otherwise  it will have 0 or 2.
       Valid values: 0x7FFFFFFF, 0 and 2. 
       See Table \ref{tbl:sessions} for the list of available session types
       with their values and descriptions.
       
  */

  uint8_t is_ntn_supported;
  /**<     Indicates whether this slot supports ntn or not \n
        - 1 -- Slot supports NTN \n
        - 0 -- Slot does not support NTN  
  */
}ntn_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_MEP_MODE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_MEP_MODE_NONE_V01 = 0x00, /**<  MEP MODE None \n  */
  UIM_MEP_MODE_A1_V01 = 0x01, /**<  MEP MODE-A1 \n  */
  UIM_MEP_MODE_A2_V01 = 0x02, /**<  MEP MODE-A2 \n  */
  UIM_MEP_MODE_B_V01 = 0x03, /**<  MEP MODE-B  */
  UIM_MEP_MODE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_mep_mode_enum_v01;
/**
    @}
  */
...
/** @addtogroup uim_qmi_aggregates
    @{
  */
/**  Tag ‘90’ as per GSMA SGP.22 v.3.0. Clause - 3.4.1.1
 */
typedef struct {

  /*  MEP INFO */
  uint8_t is_mep;
  /**<   Indicates whether MEP is enabled. Valid values:\n
        - 0 -- MEP is not enabled \n
        - 1 -- MEP is enabled
  */

  uint8_t port_id;
  /**<   Indicates the port_id of the logical slot.*/

  uim_mep_mode_enum_v01 negotiated_mep_mode;
  /**<   Indicates the MEP mode negotiated for logical slot. Valid values:\n
  @ENUM()
  */
}card_mep_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t card_mep_info_len;  /**< Must be set to # of elements in card_mep_info */
  card_mep_info_type_v01 card_mep_info[QMI_UIM_EXTENDED_CARDS_MAX_V01];
}uim_mep_information_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  uint8_t app_stuck;
  /**<   Indicates whether app initialization is stuck. Valid values:\n
        - 0 -- App initialization is not stuck \n
        - 1 -- App initialization is stuck
  */
}app_stuck_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t app_stuck_info_len;  /**< Must be set to # of elements in app_stuck_info */
  app_stuck_info_type_v01 app_stuck_info[QMI_UIM_EXTENDED_APPS_MAX_V01];
  /**<   Contains the application information.*/
}app_stuck_card_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t card_stuck_info_len;  /**< Must be set to # of elements in card_stuck_info */
  app_stuck_card_info_type_v01 card_stuck_info[QMI_UIM_EXTENDED_CARDS_MAX_V01];
}uim_is_app_intialization_stuck_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t app_info_len;  /**< Must be set to # of elements in app_info */
  unlock_app_info_type_v01 app_info[QMI_UIM_EXTENDED_APPS_MAX_V01];
  /**<   Contains the application information.*/
}unlock_card_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t card_info_len;  /**< Must be set to # of elements in card_info */
  unlock_card_info_type_v01 card_info[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Contains the card information.*/
}uim_unlock_status_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t ntn_card_info_len;  /**< Must be set to # of elements in ntn_card_info */
  ntn_info_type_v01 ntn_card_info[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Contains the ntn slot and sub info*/
}uim_ntn_status_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  App initialization stuck */
  uint8_t is_app_initialization_stuck_valid;  /**< Must be set to true if is_app_initialization_stuck is being passed */
  uim_is_app_intialization_stuck_type_v01 is_app_initialization_stuck;
  /**<   Indicates whether the app is stuck. Valid values: \n
        - 0 -- Not stuck\n
        - 1 -- Stuck
  */
  ...
  /* Optional */
  /*  MEP information */
  uint8_t mep_information_valid;  /**< Must be set to true if mep_information is being passed */
  uim_mep_information_type_v01 mep_information;
  /**<   Indicates the port_id for each logical slot along with negotiated MEP mode
  */

  /* Optional */
  /*  Applications unlock status */
  uint8_t unlock_info_valid;  /**< Must be set to true if unlock_info is being passed */
  uim_unlock_status_type_v01 unlock_info;

  /* Optional */
  /*  ntn status */
  uint8_t ntn_info_valid;  /**< Must be set to true if ntn_info is being passed */
  uim_ntn_status_type_v01 ntn_info;
...
typedef struct {
  ...
  /**<   Bitmask of the events to be received by the client. Additional
       bits are reserved for future use and must be set to zero by the caller.\n
        ...
        - Bit 14 -- Enable EUICC profile indication
        - Bit 15 -- Disable EUICC profile indication
        - Bit 16 -- Get all available EUICC profiles indication
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Is ES10 command */
  uint8_t is_es10_command_valid;  /**< Must be set to true if is_es10_command is being passed */
  uint8_t is_es10_command;
  /**<   Flag indicates whether streamed apdu is an ES10 command. 
       ES10 command refers to the APDU b/w LPAD and EUICC, as per 
       GSMA SGP.22 v.3.0 specification.
       Valid values:\n
       - 0 -- Not an ES10 command\n
       - 1 -- ES10 command
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Closing channel-id associated with ISDR-AID */
  uint8_t is_es10_valid;  /**< Must be set to true if is_es10 is being passed */
  uint8_t is_es10;
  /**<   AP based LPA shall set is_es10 flag = 1 while closing the channel 
       associated with ISD-R.
       Valid values:\n
         0 - Close channel is not for ISD-R channel.         
         1 - Close channel is for ISD-R channel.
   */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_PORT_STATE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_PORT_STATE_INACTIVE_V01 = 0x00, /**<  Inactive \n  */
  UIM_PORT_STATE_ACTIVE_V01 = 0x01, /**<  Active  */
  UIM_PORT_STATE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_port_state_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uim_port_state_enum_v01 port_state;
  /**<   State of the port. Valid values:\n
      - UIM_PORT_STATE_INACTIVE (0x00) --  Inactive \n 
      - UIM_PORT_STATE_ACTIVE (0x01) --  Active 
 */

  uim_card_protocol_enum_v01 lsi_protocol;
  /**<   Protocol of the LSI. Valid values:\n
 ...
 */
  ...
  uim_slot_enum_v01 logical_slot;
  /**<   Logical slot associated with the port. This is
 valid only if the port is active. Valid values:\n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n 
      - UIM_SLOT_2 (0x02) --  Slot 2 \n 
      - UIM_SLOT_3 (0x03) --  Slot 3 \n 
      - UIM_SLOT_4 (0x04) --  Slot 4 \n 
...
typedef struct {
  ...
  uint8_t is_mep;
  /**<   Indicates whether the card is an MEP card based on the ATR. Values: \n
        0 - Not an MEP card \n
        1 - MEP card
  */

  uim_mep_mode_enum_v01 negotiated_mep_mode;
  /**<   Indicates the MEP mode negotiated with SIM card. 
 Tag ‘90’ as per GSMA SGP.22 v.3.0. Clause - 3.4.1.1
 Valid values:\n
      - UIM_MEP_MODE_NONE (0x00) --  MEP MODE None \n 
      - UIM_MEP_MODE_A1 (0x01) --  MEP MODE-A1 \n 
      - UIM_MEP_MODE_A2 (0x02) --  MEP MODE-A2 \n 
      - UIM_MEP_MODE_B (0x03) --  MEP MODE-B 
 */

  uint8_t max_jointly_supported_lsi_for_enabled_profiles;
  /**<   Indicates the maximum number of LSIs available for enabled profiles 
       negotiated with SIM card. 
       Tag ‘91’ as per GSMA SGP.22 v.3.0.
       Clause - 3.4.1.1
  */

  uint32_t uim_port_status_len;  /**< Must be set to # of elements in uim_port_status */
  uim_port_status_type_v01 uim_port_status[QMI_UIM_PORT_MAX_V01];
  /**<   Contains the status of each port.*/
}uim_port_information_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Port Information */
  uint8_t port_information_valid;  /**< Must be set to true if port_information is being passed */
  uint32_t port_information_len;  /**< Must be set to # of elements in port_information */
  uim_port_information_type_v01 port_information[QMI_UIM_PHYSICAL_SLOTS_MAX_V01];
  /**<   \n Information of the ports on the physical slot.\n
       The number of elements corresponds with the number of physical slots
       on the device.
  */
...
typedef struct {
  ...
  */
  ...
  uim_port_information_type_v01 port_information[QMI_UIM_PHYSICAL_SLOTS_MAX_V01];
  /**<   \n Information of the ports on the physical slot.\n
       The number of elements corresponds to the number of physical slots
       on the device.
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_REMOTE_UNLOCK_ERR_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_REMOTE_UNLOCK_ERR_INVALID_SIGNATURE_V01 = 0x00, /**<  Error invalid signature \n  */
  UIM_REMOTE_UNLOCK_ERR_INVALID_IMEI_V01 = 0x01, /**<  Error invalid IMEI \n  */
  UIM_REMOTE_UNLOCK_ERR_INVALID_TIMESTAMP_V01 = 0x02, /**<  Error invalid timestamp \n  */
  UIM_REMOTE_UNLOCK_ERR_NETWORK_LIST_TOO_LARGE_V01 = 0x03, /**<  Error network list too large \n  */
  UIM_REMOTE_UNLOCK_ERR_SIGNATURE_ALGO_NOT_SUPPORTED_V01 = 0x04, /**<  Error signature algo not supported \n  */
  UIM_REMOTE_UNLOCK_ERR_FEATURE_NOT_SUPPORTED_V01 = 0x05, /**<  Error feature not supported \n  */
  UIM_REMOTE_UNLOCK_ERR_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_remote_unlock_err_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  UIM Remote Unlock error */
  uint8_t remote_unlock_error_valid;  /**< Must be set to true if remote_unlock_error is being passed */
  uim_remote_unlock_err_enum_v01 remote_unlock_error;
  /**<   UIM Remote Unlock error. Valid values:\n
      - UIM_REMOTE_UNLOCK_ERR_INVALID_SIGNATURE (0x00) --  Error invalid signature \n 
      - UIM_REMOTE_UNLOCK_ERR_INVALID_IMEI (0x01) --  Error invalid IMEI \n 
      - UIM_REMOTE_UNLOCK_ERR_INVALID_TIMESTAMP (0x02) --  Error invalid timestamp \n 
      - UIM_REMOTE_UNLOCK_ERR_NETWORK_LIST_TOO_LARGE (0x03) --  Error network list too large \n 
      - UIM_REMOTE_UNLOCK_ERR_SIGNATURE_ALGO_NOT_SUPPORTED (0x04) --  Error signature algo not supported \n 
      - UIM_REMOTE_UNLOCK_ERR_FEATURE_NOT_SUPPORTED (0x05) --  Error feature not supported \n 
 */
 ...
 */
  ...
  /* Optional */
  uint8_t logical_slot_port_valid;  /**< Must be set to true if logical_slot_port is being passed */
  uint32_t logical_slot_port_len;  /**< Must be set to # of elements in logical_slot_port */
  uint8_t logical_slot_port[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Index represents the logical slot, whereas the value provided represents 
       the port_id which needs to be mapped with logical slot. 
  */
 ...
 */
  ...
  /* Optional */
  /*  Port ID  */
  uint8_t logical_slot_port_id_valid;  /**< Must be set to true if logical_slot_port_id is being passed */
  uint32_t logical_slot_port_id_len;  /**< Must be set to # of elements in logical_slot_port_id */
  uint8_t logical_slot_port_id[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Port ID mapped to the Logical slot.*/
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Enabled on eSIM Port */
  uint8_t eSIM_Port_valid;  /**< Must be set to true if eSIM_Port is being passed */
  uint8_t eSIM_Port;
  /**<   Indicates the eSIM port_id or LSI number on which the profile is enabled
   */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_USER_CONSENT_REQUIRED_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_LPA_CONFIRMATION_NOT_REQUIRED_V01 = 0x00, /**<  No Confirmation \n  */
  UIM_LPA_SIMPLE_CONFIRMATION_REQUIRED_V01 = 0x01, /**<  Simple confirmation \n  */
  UIM_LPA_STRONG_CONFIRMATION_REQUIRED_V01 = 0x02, /**< Strong confirmation \n  */
  UIM_USER_CONSENT_REQUIRED_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_user_consent_required_enum_type_v01;
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  User Consent type
 VERSION_INTRODUCED 1.102 */
  uint8_t user_consent_type_valid;  /**< Must be set to true if user_consent_type is being passed */
  uim_user_consent_required_enum_type_v01 user_consent_type;
  /**<   Indicated the ype of user consent. Valid values:\n
      - UIM_LPA_CONFIRMATION_NOT_REQUIRED (0x00) --  No Confirmation \n 
      - UIM_LPA_SIMPLE_CONFIRMATION_REQUIRED (0x01) --  Simple confirmation \n 
      - UIM_LPA_STRONG_CONFIRMATION_REQUIRED (0x02) -- Strong confirmation \n 
 */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_SIM_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_SIM_TYPE_PHYSICAL_V01 = 0x01, /**<  For removable SIM  \n  */
  UIM_SIM_TYPE_INTEGRATED_V01 = 0x02, /**<  For integrated SIM \n  */
  UIM_SIM_TYPE_EMBEDDED_V01 = 0x03, /**<  For embedded SIM \n  */
  UIM_SIM_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_sim_type_enum_v01;
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; To set SIM type physical/integrated for a slot */
typedef struct {

  /* Mandatory */
  /*  Physical Slots */
  uint32_t sim_type_len;  /**< Must be set to # of elements in sim_type */
  uim_sim_type_enum_v01 sim_type[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Physical slots. Valid values:\n
      - UIM_SIM_TYPE_PHYSICAL (0x01) --  For removable SIM  \n 
      - UIM_SIM_TYPE_INTEGRATED (0x02) --  For integrated SIM \n 
      - UIM_SIM_TYPE_EMBEDDED (0x03) --  For embedded SIM \n 
 */
}uim_set_sim_type_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; To set SIM type physical/integrated for a slot */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}uim_set_sim_type_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Provides current SIM type configuration of all available slots  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}uim_get_sim_type_req_msg_v01;
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_SUPPORTED_SIM_TYPES_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_SUPPORTED_SIM_TYPES_PHYSICAL_V01 = 0, /**<  Slot supports only Physical SIM Type \n  */
  UIM_SUPPORTED_SIM_TYPES_INTEGRATED_V01 = 1, /**<  Slot supports only Intergrated SIM Type \n  */
  UIM_SUPPORTED_SIM_TYPES_PHYSICAL_INTEGRATED_V01 = 2, /**<  Slot supports both Physical and Integrated SIM Types \n  */
  UIM_SUPPORTED_SIM_TYPES_EMBEDDED_V01 = 3, /**<  Slot supports only Embedded SIM Type \n  */
  UIM_SUPPORTED_SIM_TYPES_PHYSICAL_EMBEDDED_V01 = 4, /**<  Slot supports both Physical and Embedded SIM Types \n  */
  UIM_SUPPORTED_SIM_TYPES_INTEGRATED_EMBEDDED_V01 = 5, /**<  Slot supports both Integrated and Embedded SIM Types \n  */
  UIM_SUPPORTED_SIM_TYPES_PHYSICAL_INTEGRATED_EMBEDDED_V01 = 6, /**<  Slot supports three Physical, Integrated and Embedded SIM Types \n  */
  UIM_SUPPORTED_SIM_TYPES_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_supported_sim_types_enum_v01;
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Provides current SIM type configuration of all available slots  */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Physical Slots */
  uint8_t sim_type_valid;  /**< Must be set to true if sim_type is being passed */
  uint32_t sim_type_len;  /**< Must be set to # of elements in sim_type */
  uim_sim_type_enum_v01 sim_type[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Physical slots. Valid values:\n
      - UIM_SIM_TYPE_PHYSICAL (0x01) --  For removable SIM  \n 
 ...
 */
  ...
  /* Optional */
  /*  SIM Types supported */
  uint8_t supported_sim_types_valid;  /**< Must be set to true if supported_sim_types is being passed */
  uint32_t supported_sim_types_len;  /**< Must be set to # of elements in supported_sim_types */
  uim_supported_sim_types_enum_v01 supported_sim_types[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Physical slots. Valid values:\n
      - UIM_SUPPORTED_SIM_TYPES_PHYSICAL (0) --  Slot supports only Physical SIM Type \n 
      - UIM_SUPPORTED_SIM_TYPES_INTEGRATED (1) --  Slot supports only Intergrated SIM Type \n 
      - UIM_SUPPORTED_SIM_TYPES_PHYSICAL_INTEGRATED (2) --  Slot supports both Physical and Integrated SIM Types \n 
      - UIM_SUPPORTED_SIM_TYPES_EMBEDDED (3) --  Slot supports only Embedded SIM Type \n 
      - UIM_SUPPORTED_SIM_TYPES_PHYSICAL_EMBEDDED (4) --  Slot supports both Physical and Embedded SIM Types \n 
      - UIM_SUPPORTED_SIM_TYPES_INTEGRATED_EMBEDDED (5) --  Slot supports both Integrated and Embedded SIM Types \n 
      - UIM_SUPPORTED_SIM_TYPES_PHYSICAL_INTEGRATED_EMBEDDED (6) --  Slot supports three Physical, Integrated and Embedded SIM Types \n 
 */
}uim_get_sim_type_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Indication Message; Indicates the user consent Indication for LPA requests */
typedef struct {

  /* Mandatory */
  /*  Slot */
  uim_slot_enum_v01 slot;
  /**<   Indicates the slot for user_consent indication. Valid values:\n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n 
      - UIM_SLOT_2 (0x02) --  Slot 2 \n 
      - UIM_SLOT_3 (0x03) --  Slot 3 \n 
      - UIM_SLOT_4 (0x04) --  Slot 4 \n 
 ...
 */
  ...
  /* Mandatory */
  /*  Profile Download Status */
  uim_user_consent_required_enum_type_v01 user_consent_indication;
  /**<   Indicates the type of user_consent required.
 Valid values:\n
      - UIM_LPA_CONFIRMATION_NOT_REQUIRED (0x00) --  No Confirmation \n 
      - UIM_LPA_SIMPLE_CONFIRMATION_REQUIRED (0x01) --  Simple confirmation \n 
      - UIM_LPA_STRONG_CONFIRMATION_REQUIRED (0x02) -- Strong confirmation \n 
 ...
 ignored by the control point.
 */
}uim_user_consent_required_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Retrieves the device personalization status. */
typedef struct {
  ...
  /**<   Indicates the slot to be used. Valid values:\n
      ...
      - UIM_SLOT_5 (0x05) --  Slot 5 
 */
}uim_get_personalization_status_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_DEVICE_PERSO_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_DEVICE_NOT_PERSONALIZED_V01 = 0x00, /**<  Device is not personalized.\n  */
  UIM_DEVICE_PERSONALIZED_V01 = 0x01, /**<  Device is personalized.  */
  UIM_DEVICE_PERSO_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_device_perso_status_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t gid1[QMI_UIM_GID_EXT_MAX_V01];
  /**<   Service provider code found in GID1. */
}uim_gw_nw_subset_sp_perso_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t impi_len;  /**< Must be set to # of elements in impi */
  char impi[QMI_UIM_IMPI_DIGIT_MAX_V01];
  /**<   IMPI digits in ASCII characters. */
}uim_gw_impi_perso_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t imsi_prefix_len;  /**< Must be set to # of elements in imsi_prefix */
  char imsi_prefix[QMI_UIM_IMSI_PREFIX_MAX_V01];
  /**<   IMSI prefix value stored on the card in ASCII characters. */

  uint8_t spn[QMI_UIM_GW_SPN_LEN_V01];
  /**<   Service provider name value stored with the same coding used for the EF-SPN in the card. */
}uim_gw_carrier_perso_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_SUB_POLICY_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_SUB_POLICY_INDEPENDENT_V01 = 0x00, /**<  SUB policy independent \n  */
  UIM_SUB_POLICY_VALID_3GPP_REQUIRED_V01 = 0x01, /**<  SUB policy valid 3GPP required \n  */
  UIM_SUB_POLICY_VALID_3GPP2_REQUIRED_V01 = 0x02, /**<  SUB plicy Valid 3GPP2 required \n  */
  UIM_SUB_POLICY_VALID_3GPP_AND_3GPP2_REQUIRED_V01 = 0x03, /**<  SUB policy Valid 3GPP and 3GPP2 required \n  */
  UIM_SUB_POLICY_VALID_3GPP_OR_3GPP2_REQUIRED_V01 = 0x04, /**<  SUB policy Valid 3GPP or 3GPP2 required.  */
  UIM_SUB_POLICY_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_sub_policy_enum_v01;
/**
    @}
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_SLOT_POLICY_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_SLOT_POLICY_SAME_ON_ALL_SLOTS_V01 = 0x00, /**<  Additional slots have same SimLock configuration as slot 1 \n  */
  UIM_SLOT_POLICY_UNIQUE_FOR_EACH_SLOT_V01 = 0x01, /**<  Each slot as independent SimLock configuration (enabled categories, codes, \n
     control keys) \n  */
  UIM_SLOT_POLICY_LOCK_ONLY_SLOT_1_V01 = 0x02, /**<  SimLock configuration is valid only for slot 1, while all other slots are always \n
     unlocked, regardless of card present in slot 1 \n  */
  UIM_SLOT_POLICY_VALID_CARD_MUST_ON_SLOT_1_V01 = 0x03, /**<  Additional slots are valid only if card on slot 1 is present and verified \n  */
  UIM_SLOT_POLICY_VALID_CARD_MUST_ON_ANY_SLOT_V01 = 0x04, /**<  All slots are free and take the configuration of slot 1 as long as there is a \n
     valid card is present in any slot \n  */
  UIM_SLOT_POLICY_MASTER_SLOT_1_V01 = 0x05, /**<  Each additional slot is valid if a valid card is present in that slot or if a \n
     valid card is present in slot 1 \n  */
  UIM_SLOT_POLICY_BLOCK_ALL_SLOTS_IF_SLOT_1_EXPIRED_V01 = 0x06, /**<  All slots will remain free until network expires on slot 1. \n
     If network expires on slot 1, then all slots will be blocked \n  */
  UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_SLOT_1_V01 = 0x07, /**<  All slots will remain blocked until full network service is \n
     acquired on slot 1 at which point all slots will be free. \n  */
  UIM_SLOT_POLICY_BLOCK_ALL_SLOTS_IF_ALL_VALID_SLOTS_EXPIRED_V01 = 0x08, /**<  All slots are free initially. If network expires on all valid slots which \n 
     satisfies all the enabled categories, then all invalid slots will be blocked \n  */
  UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_ANY_VALID_SLOT_V01 = 0x09, /**<  All slots will remain blocked until full network service is \n
     acquired on any slot which satisfies all the enabled categories \n
     at which point all slots will be free. \n  */
  UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_ANY_VALID_SLOT_OR_IMSI_MATCH_V01 = 0x0A, /**<  All slots will remain blocked until full network service is acquired \n
     on any slot or matches the previous IMSI for 3GPP which had acquired full \n
     service in the past \n  */
  UIM_SLOT_POLICY_VALID_CARD_MUST_ON_ALL_SLOTS_V01 = 0x0B, /**<  If at least one card is present and considered invalid, then all cards are \n
     marked as invalid \n  */
  UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_SLOT1_OR_IMSI_MATCH_V01 = 0x0C, /**<  All slots will remain blocked until full network service is acquired \n
     on slot 1 or matches the previous IMSI for 3GPP which had acquired full \n
     service in the past \n  */
  UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_OR_IMSI_MATCH_OR_NO_NW_REJECT_V01 = 0x0D, /**<  Dependent or non-subsidised slot remains blocked untill full service is \n
     acquired on independent slot/subsidised slot. It then stores the IMSI and \n
     ICCID of the independent slots. On recieving a NW reject with cause 8 on \n
     subsidized slot, given no subsidized card is present on any other slot, the \n
     all subsidized and non-subsidized card will be blocked at perso. \n
     If there is an IMSI switch of the subsidized card, then the stored IMSI \n
     of the given slot will updated with new one \n  */
  UIM_SLOT_POLICY_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_slot_policy_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_gw_network_perso_len;  /**< Must be set to # of elements in allowed_gw_network_perso */
  uim_network_perso_type_v01 allowed_gw_network_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_gw_network_perso_len;  /**< Must be set to # of elements in excluded_gw_network_perso */
  uim_network_perso_type_v01 excluded_gw_network_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_nw_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_gw_network_subset_perso_len;  /**< Must be set to # of elements in allowed_gw_network_subset_perso */
  uim_gw_network_subset_perso_type_v01 allowed_gw_network_subset_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_gw_network_subset_perso_len;  /**< Must be set to # of elements in excluded_gw_network_subset_perso */
  uim_gw_network_subset_perso_type_v01 excluded_gw_network_subset_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_nw_subset_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_gw_sp_perso_len;  /**< Must be set to # of elements in allowed_gw_sp_perso */
  uim_gw_sp_ext2_perso_type_v01 allowed_gw_sp_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_gw_sp_perso_len;  /**< Must be set to # of elements in excluded_gw_sp_perso */
  uim_gw_sp_ext2_perso_type_v01 excluded_gw_sp_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_sp_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_gw_cp_perso_len;  /**< Must be set to # of elements in allowed_gw_cp_perso */
  uim_gw_corporate_ext2_perso_type_v01 allowed_gw_cp_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_gw_cp_perso_len;  /**< Must be set to # of elements in excluded_gw_cp_perso */
  uim_gw_corporate_ext2_perso_type_v01 excluded_gw_cp_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_cp_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_gw_network_subset_sp_perso_len;  /**< Must be set to # of elements in allowed_gw_network_subset_sp_perso */
  uim_gw_nw_subset_sp_perso_type_v01 allowed_gw_network_subset_sp_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_gw_network_subset_sp_perso_len;  /**< Must be set to # of elements in excluded_gw_network_subset_sp_perso */
  uim_gw_nw_subset_sp_perso_type_v01 excluded_gw_network_subset_sp_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_nw_subset_sp_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_spn_perso_len;  /**< Must be set to # of elements in allowed_spn_perso */
  uim_gw_spn_perso_type_v01 allowed_spn_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_spn_perso_len;  /**< Must be set to # of elements in excluded_spn_perso */
  uim_gw_spn_perso_type_v01 excluded_spn_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_spn_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_sim_perso_len;  /**< Must be set to # of elements in allowed_sim_perso */
  uim_sim_perso_type_v01 allowed_sim_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_sim_perso_len;  /**< Must be set to # of elements in excluded_sim_perso */
  uim_sim_perso_type_v01 excluded_sim_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_sim_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_iccid_perso_len;  /**< Must be set to # of elements in allowed_iccid_perso */
  uim_gw_iccid_perso_type_v01 allowed_iccid_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_iccid_perso_len;  /**< Must be set to # of elements in excluded_iccid_perso */
  uim_gw_iccid_perso_type_v01 excluded_iccid_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_iccid_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_sp_ehplmn_perso_len;  /**< Must be set to # of elements in allowed_sp_ehplmn_perso */
  uim_gw_sp_ehplmn_perso_type_v01 allowed_sp_ehplmn_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_sp_ehplmn_perso_len;  /**< Must be set to # of elements in excluded_sp_ehplmn_perso */
  uim_gw_sp_ehplmn_perso_type_v01 excluded_sp_ehplmn_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_sp_ehplmn_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_impi_perso_len;  /**< Must be set to # of elements in allowed_impi_perso */
  uim_gw_impi_perso_type_v01 allowed_impi_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_impi_perso_len;  /**< Must be set to # of elements in excluded_impi_perso */
  uim_gw_impi_perso_type_v01 excluded_impi_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_impi_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_carrier_perso_len;  /**< Must be set to # of elements in allowed_carrier_perso */
  uim_gw_carrier_perso_type_v01 allowed_carrier_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_carrier_perso_len;  /**< Must be set to # of elements in excluded_carrier_perso */
  uim_gw_carrier_perso_type_v01 excluded_carrier_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_gw_carrier_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_1x_network1_perso_len;  /**< Must be set to # of elements in allowed_1x_network1_perso */
  uim_network_perso_type_v01 allowed_1x_network1_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_1x_network1_perso_len;  /**< Must be set to # of elements in excluded_1x_network1_perso */
  uim_network_perso_type_v01 excluded_1x_network1_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_1x_network1_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_1x_network2_perso_len;  /**< Must be set to # of elements in allowed_1x_network2_perso */
  uim_1x_network_type2_perso_type_v01 allowed_1x_network2_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_1x_network2_perso_len;  /**< Must be set to # of elements in excluded_1x_network2_perso */
  uim_1x_network_type2_perso_type_v01 excluded_1x_network2_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_1x_network2_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t allowed_1x_ruim_perso_len;  /**< Must be set to # of elements in allowed_1x_ruim_perso */
  uim_sim_perso_type_v01 allowed_1x_ruim_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];

  uint32_t excluded_1x_ruim_perso_len;  /**< Must be set to # of elements in excluded_1x_ruim_perso */
  uim_sim_perso_type_v01 excluded_1x_ruim_perso[QMI_UIM_PERSO_STATUS_NUM_LOCK_CODES_MAX_V01];
}uim_1x_ruim_perso_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Retrieves the device personalization status. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Device personalized status */
  uint8_t perso_status_valid;  /**< Must be set to true if perso_status is being passed */
  uim_device_perso_status_enum_v01 perso_status;
  /**<   Indicates if the device is personalized or not.
 Valid values:\n
      - UIM_DEVICE_NOT_PERSONALIZED (0x00) --  Device is not personalized.\n 
      - UIM_DEVICE_PERSONALIZED (0x01) --  Device is personalized. 
 */

  /* Optional */
  /*  Device slot policy */
  uint8_t slot_policy_valid;  /**< Must be set to true if slot_policy is being passed */
  uim_slot_policy_enum_v01 slot_policy;
  /**<   Indicates the slot policy activated. Valid values:\n
      - UIM_SLOT_POLICY_SAME_ON_ALL_SLOTS (0x00) --  Additional slots have same SimLock configuration as slot 1 \n 
      - UIM_SLOT_POLICY_UNIQUE_FOR_EACH_SLOT (0x01) --  Each slot as independent SimLock configuration (enabled categories, codes, \n
     control keys) \n 
      - UIM_SLOT_POLICY_LOCK_ONLY_SLOT_1 (0x02) --  SimLock configuration is valid only for slot 1, while all other slots are always \n
     unlocked, regardless of card present in slot 1 \n 
      - UIM_SLOT_POLICY_VALID_CARD_MUST_ON_SLOT_1 (0x03) --  Additional slots are valid only if card on slot 1 is present and verified \n 
      - UIM_SLOT_POLICY_VALID_CARD_MUST_ON_ANY_SLOT (0x04) --  All slots are free and take the configuration of slot 1 as long as there is a \n
     valid card is present in any slot \n 
      - UIM_SLOT_POLICY_MASTER_SLOT_1 (0x05) --  Each additional slot is valid if a valid card is present in that slot or if a \n
     valid card is present in slot 1 \n 
      - UIM_SLOT_POLICY_BLOCK_ALL_SLOTS_IF_SLOT_1_EXPIRED (0x06) --  All slots will remain free until network expires on slot 1. \n
     If network expires on slot 1, then all slots will be blocked \n 
      - UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_SLOT_1 (0x07) --  All slots will remain blocked until full network service is \n
     acquired on slot 1 at which point all slots will be free. \n 
      - UIM_SLOT_POLICY_BLOCK_ALL_SLOTS_IF_ALL_VALID_SLOTS_EXPIRED (0x08) --  All slots are free initially. If network expires on all valid slots which \n 
     satisfies all the enabled categories, then all invalid slots will be blocked \n 
      - UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_ANY_VALID_SLOT (0x09) --  All slots will remain blocked until full network service is \n
     acquired on any slot which satisfies all the enabled categories \n
     at which point all slots will be free. \n 
      - UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_ANY_VALID_SLOT_OR_IMSI_MATCH (0x0A) --  All slots will remain blocked until full network service is acquired \n
     on any slot or matches the previous IMSI for 3GPP which had acquired full \n
     service in the past \n 
      - UIM_SLOT_POLICY_VALID_CARD_MUST_ON_ALL_SLOTS (0x0B) --  If at least one card is present and considered invalid, then all cards are \n
     marked as invalid \n 
      - UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_ON_SLOT1_OR_IMSI_MATCH (0x0C) --  All slots will remain blocked until full network service is acquired \n
     on slot 1 or matches the previous IMSI for 3GPP which had acquired full \n
     service in the past \n 
      - UIM_SLOT_POLICY_WAIT_FOR_FULL_SERVICE_OR_IMSI_MATCH_OR_NO_NW_REJECT (0x0D) --  Dependent or non-subsidised slot remains blocked untill full service is \n
     acquired on independent slot/subsidised slot. It then stores the IMSI and \n
     ICCID of the independent slots. On recieving a NW reject with cause 8 on \n
     subsidized slot, given no subsidized card is present on any other slot, the \n
     all subsidized and non-subsidized card will be blocked at perso. \n
 ...
 */
  ...
  /* Optional */
  /*  Device sub policy */
  uint8_t sub_policy_valid;  /**< Must be set to true if sub_policy is being passed */
  uim_sub_policy_enum_v01 sub_policy;
  /**<   Indicates the sub policy activated. Valid values:\n
      - UIM_SUB_POLICY_INDEPENDENT (0x00) --  SUB policy independent \n 
      - UIM_SUB_POLICY_VALID_3GPP_REQUIRED (0x01) --  SUB policy valid 3GPP required \n 
      - UIM_SUB_POLICY_VALID_3GPP2_REQUIRED (0x02) --  SUB plicy Valid 3GPP2 required \n 
      - UIM_SUB_POLICY_VALID_3GPP_AND_3GPP2_REQUIRED (0x03) --  SUB policy Valid 3GPP and 3GPP2 required \n 
      - UIM_SUB_POLICY_VALID_3GPP_OR_3GPP2_REQUIRED (0x04) --  SUB policy Valid 3GPP or 3GPP2 required. 
 */

  /* Optional */
  /*  Allowed Carriers Prioritized */
  uint8_t allowedCarriersPrioritized_valid;  /**< Must be set to true if allowedCarriersPrioritized is being passed */
  uint8_t allowedCarriersPrioritized;
  /**<   Indicates if the allowed carriers are prioritized.
       Valid values: \n
       - 1 -- True means that only carriers included in the allowed list \n
              and not in the excluded list are permitted \n
	      Eg. allowedCarriers match mcc/mnc, excludedCarriers has same mcc/mnc and \n
              gid1 is ABCD. It means except the carrier whose gid1 is ABCD, all carriers \n
              with the same mcc/mnc are allowed. \n
       - 0 -- False means that all carriers are allowed except those included in the \n
	      excluded list and not in the allowed list \n
       If the TLV is missing, then consider the value as true. \n
  */

  /* Optional */
  /*  Number of GW categories enabled */
  uint8_t number_of_gw_categories_enabled_valid;  /**< Must be set to true if number_of_gw_categories_enabled is being passed */
  uint8_t number_of_gw_categories_enabled;
  /**<   Indicates the number of GW categories enabled.*/

  /* Optional */
  /*  Number of 1X categories enabled */
  uint8_t number_of_1x_categories_enabled_valid;  /**< Must be set to true if number_of_1x_categories_enabled is being passed */
  uint8_t number_of_1x_categories_enabled;
  /**<   Indicates the number of 1X categories enabled.*/

  /* Optional */
  /*  GW Network Personalization with support for 100 allowed and excluded lock codes */
  uint8_t gw_nw_perso_info_valid;  /**< Must be set to true if gw_nw_perso_info is being passed */
  uim_gw_nw_perso_info_type_v01 gw_nw_perso_info;

  /* Optional */
  /*  GW Network Subset Personalization with support for 100 allowed and excluded lock codes */
  uint8_t gw_nw_subset_perso_info_valid;  /**< Must be set to true if gw_nw_subset_perso_info is being passed */
  uim_gw_nw_subset_perso_info_type_v01 gw_nw_subset_perso_info;

  /* Optional */
  /*  GW Service Provider Personalization with 8 bytes GID and support for 100 allowed and excluded lock codes */
  uint8_t gw_sp_perso_info_valid;  /**< Must be set to true if gw_sp_perso_info is being passed */
  uim_gw_sp_perso_info_type_v01 gw_sp_perso_info;

  /* Optional */
  /*  GW Corporate Personalization with 8 bytes GID and support for 100 allowed and excluded lock codes */
  uint8_t gw_cp_perso_info_valid;  /**< Must be set to true if gw_cp_perso_info is being passed */
  uim_gw_cp_perso_info_type_v01 gw_cp_perso_info;

  /* Optional */
  /*  GW SIM Personalization with support for 100 allowed and excluded lock codes */
  uint8_t gw_sim_perso_info_valid;  /**< Must be set to true if gw_sim_perso_info is being passed */
  uim_gw_sim_perso_info_type_v01 gw_sim_perso_info;

  /* Optional */
  /*  GW Service Provider Name Personalization with support for 100 allowed and excluded lock codes */
  uint8_t gw_spn_perso_info_valid;  /**< Must be set to true if gw_spn_perso_info is being passed */
  uim_gw_spn_perso_info_type_v01 gw_spn_perso_info;

  /* Optional */
  /*  GW Service Provider with Equivalent HPLMN Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t gw_sp_ehplmn_perso_info_valid;  /**< Must be set to true if gw_sp_ehplmn_perso_info is being passed */
  uim_gw_sp_ehplmn_perso_info_type_v01 gw_sp_ehplmn_perso_info;

  /* Optional */
  /*  GW ICCID Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t gw_iccid_perso_info_valid;  /**< Must be set to true if gw_iccid_perso_info is being passed */
  uim_gw_iccid_perso_info_type_v01 gw_iccid_perso_info;

  /* Optional */
  /*  GW IMPI Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t gw_impi_perso_info_valid;  /**< Must be set to true if gw_impi_perso_info is being passed */
  uim_gw_impi_perso_info_type_v01 gw_impi_perso_info;

  /* Optional */
  /*  GW network subset service provider Personalization with 8 bytes GID and support for 100 allowed and excluded lock codes */
  uint8_t gw_nw_subset_sp_perso_info_valid;  /**< Must be set to true if gw_nw_subset_sp_perso_info is being passed */
  uim_gw_nw_subset_sp_perso_info_type_v01 gw_nw_subset_sp_perso_info;

  /* Optional */
  /*  GW Carrier Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t gw_carrier_perso_info_valid;  /**< Must be set to true if gw_carrier_perso_info is being passed */
  uim_gw_carrier_perso_info_type_v01 gw_carrier_perso_info;

  /* Optional */
  /*  1X Network-1 Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t network1_1x_perso_info_valid;  /**< Must be set to true if network1_1x_perso_info is being passed */
  uim_1x_network1_perso_info_type_v01 network1_1x_perso_info;

  /* Optional */
  /*  1X Network-2 Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t network2_1x_perso_info_valid;  /**< Must be set to true if network2_1x_perso_info is being passed */
  uim_1x_network2_perso_info_type_v01 network2_1x_perso_info;

  /* Optional */
  /*  1X RUIM Personalization with support for 100 allowed and excluded lock codes  */
  uint8_t ruim_1x_perso_info_valid;  /**< Must be set to true if ruim_1x_perso_info is being passed */
  uim_1x_ruim_perso_info_type_v01 ruim_1x_perso_info;
}uim_get_personalization_status_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Enables the EUICC profile. */
typedef struct {
  ...
  */
  ...
  /**<   Client need to pass the same reference id that is shared in indication message,
       which gives the information about, for which indication request the current
       response is.
  */
}uim_euicc_enable_profile_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Enables the EUICC profile. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}uim_euicc_enable_profile_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Indication Message; Indication with a enable profile request. */
typedef struct {
 ...
 */
  ...
  */
  ...
  /*  Reference ID */
  uint32_t reference_id;
  /**<   Acts as a token, and the client need to pass the same reference id
       in a subsequent QMI_UIM_EUICC_ENABLE_PROFILE_REQ response.
  */
}uim_euicc_enable_profile_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Disables the EUICC profile. */
typedef struct {
  ...
  */
  ...
  /**<   Client need to pass the same reference id that is shared in indication message,
       ...
       response is.
  */
}uim_euicc_disable_profile_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Disables the EUICC profile. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}uim_euicc_disable_profile_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Indication Message; Indication with a disable profile request. */
typedef struct {
 ...
 */
  ...
  */
  ...
  uint32_t reference_id;
  /**<   Acts as a token, and the client need to pass the same reference id
       in a subsequent QMI_UIM_EUICC_DISABLE_PROFILE_REQ response.
  */
}uim_euicc_disable_profile_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Indicates the profile ICCID coded as in EF-ICCID
  */
}uim_profile_iccid_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t iccid_data_len;  /**< Must be set to # of elements in iccid_data */
  uim_profile_iccid_type_v01 iccid_data[QMI_UIM_EUICC_PROFILES_COUNT_MAX_V01];
  /**<   List of euicc profiles ICCID's */
}uim_profile_iccid_list_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Gets all of the available EUICC profiles. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Available profiles ICCID's */
  uint8_t profiles_iccids_valid;  /**< Must be set to true if profiles_iccids is being passed */
  uim_profile_iccid_list_type_v01 profiles_iccids;
  /**<   \n List of available euicc profiles ICCID's.
  */
}uim_euicc_get_all_available_profiles_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Gets all of the available EUICC profiles. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}uim_euicc_get_all_available_profiles_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Indication Message; Indication with a request to get all the available euicc profiles. */
typedef struct {
 ...
 */
  ...
  uint32_t reference_id;
  /**<   Acts as a token, and the client need to pass the same reference id
       in a subsequent QMI_UIM_EUICC_GET_ALL_AVAILABLE_PROFILES_REQ response.
  */
}uim_euicc_get_all_available_profiles_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_UIM_EUICC_DISABLE_PROFILE_V01
//#define REMOVE_QMI_UIM_EUICC_DISABLE_PROFILE_IND_V01
//#define REMOVE_QMI_UIM_EUICC_ENABLE_PROFILE_V01
//#define REMOVE_QMI_UIM_EUICC_ENABLE_PROFILE_IND_V01
//#define REMOVE_QMI_UIM_EUICC_GET_ALL_AVAILABLE_PROFILES_V01
//#define REMOVE_QMI_UIM_EUICC_GET_ALL_AVAILABLE_PROFILES_IND_V01
...
//#define REMOVE_QMI_UIM_GET_PERSONALIZATION_STATUS_V01
...
//#define REMOVE_QMI_UIM_GET_SIM_TYPE_V01
...
//#define REMOVE_QMI_UIM_SET_SIM_TYPE_V01
...
//#define REMOVE_QMI_UIM_USER_CONSENT_IND_V01
...
#define QMI_UIM_SET_SIM_TYPE_REQ_V01 0x007A
#define QMI_UIM_SET_SIM_TYPE_RESP_V01 0x007A
#define QMI_UIM_GET_SIM_TYPE_REQ_V01 0x007B
#define QMI_UIM_GET_SIM_TYPE_RESP_V01 0x007B
#define QMI_UIM_USER_CONSENT_IND_V01 0x007C
#define QMI_UIM_GET_PERSONALIZATION_STATUS_REQ_V01 0x007D
#define QMI_UIM_GET_PERSONALIZATION_STATUS_RESP_V01 0x007D
#define QMI_UIM_EUICC_ENABLE_PROFILE_REQ_V01 0x007E
#define QMI_UIM_EUICC_ENABLE_PROFILE_RESP_V01 0x007E
#define QMI_UIM_EUICC_ENABLE_PROFILE_IND_V01 0x007E
#define QMI_UIM_EUICC_DISABLE_PROFILE_REQ_V01 0x007F
#define QMI_UIM_EUICC_DISABLE_PROFILE_RESP_V01 0x007F
#define QMI_UIM_EUICC_DISABLE_PROFILE_IND_V01 0x007F
#define QMI_UIM_EUICC_GET_ALL_AVAILABLE_PROFILES_REQ_V01 0x0080
#define QMI_UIM_EUICC_GET_ALL_AVAILABLE_PROFILES_RESP_V01 0x0080
#define QMI_UIM_EUICC_GET_ALL_AVAILABLE_PROFILES_IND_V01 0x0080
/**
    @}
  */
