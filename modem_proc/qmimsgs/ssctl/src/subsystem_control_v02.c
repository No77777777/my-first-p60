...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/ssctl/src/subsystem_control_v02.c#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const qmi_idl_service_message_table_entry ssctl_service_command_messages_v02[] = {
  ...
  {QMI_SSCTL_GET_FAILURE_REASON_REQ_V02, QMI_IDL_TYPE16(0, 9), 0},
  {QMI_SSCTL_SUBSYS_EVENT_REQ_V02, QMI_IDL_TYPE16(0, 11), 33},
  {QMI_SSCTL_HIBERNATION_REQ_V02, QMI_IDL_TYPE16(0, 17), 0},
  {QMI_SSCTL_SUBSYS_EVENT_WITH_TID_REQ_V02, QMI_IDL_TYPE16(0, 14), 40},
  {QMI_SSCTL_DS_ENTRY_REQ_V02, QMI_IDL_TYPE16(0, 6), 0}
};
...
static const qmi_idl_service_message_table_entry ssctl_service_response_messages_v02[] = {
  ...
  {QMI_SSCTL_GET_FAILURE_REASON_RESP_V02, QMI_IDL_TYPE16(0, 10), 362},
  {QMI_SSCTL_SUBSYS_EVENT_RESP_V02, QMI_IDL_TYPE16(0, 12), 7},
  {QMI_SSCTL_HIBERNATION_RESP_V02, QMI_IDL_TYPE16(0, 18), 7},
  {QMI_SSCTL_SUBSYS_EVENT_WITH_TID_RESP_V02, QMI_IDL_TYPE16(0, 15), 7},
  {QMI_SSCTL_DS_ENTRY_RESP_V02, QMI_IDL_TYPE16(0, 7), 7}
};
...
static const qmi_idl_service_message_table_entry ssctl_service_indication_messages_v02[] = {
  ...
  {QMI_SSCTL_SUBSYS_EVENT_COMP_IND_V02, QMI_IDL_TYPE16(0, 13), 0},
  {QMI_SSCTL_HIBERNATION_READY_IND_V02, QMI_IDL_TYPE16(0, 19), 0},
  {QMI_SSCTL_SUBSYS_EVENT_WITH_TID_COMP_IND_V02, QMI_IDL_TYPE16(0, 16), 0},
  {QMI_SSCTL_DS_ENTRY_READY_IND_V02, QMI_IDL_TYPE16(0, 8), 0}
};
