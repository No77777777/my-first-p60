...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.6.9/ssctl/api/subsystem_control_v02.h#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Thu Sep 30 2021 (Spin 1)
...
#define SSCTL_V02_IDL_MINOR_VERS 0x09
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SSCTL_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SSCTL_V02_MAX_MESSAGE_ID 0x0026
/**
    @}
  */
...
typedef enum {
  ...
  SSCTL_DS_EVENT_BEFORE_ENTRY_V02 = 4, /**<  Before deepsleep entry  */
  SSCTL_DS_EVENT_AFTER_ENTRY_V02 = 5, /**<  After deepsleep entry  */
  SSCTL_DS_EVENT_BEFORE_EXIT_V02 = 6, /**<  Before deepsleep exit  */
  SSCTL_DS_EVENT_AFTER_EXIT_V02 = 7, /**<  After deepsleep exit  */
...
typedef enum {
  ...
  SSCTL_DS_EVENT_FORCED_V02 = 2, /**<  Event is forced  */
  SSCTL_DS_EVENT_GRACEFUL_V02 = 3, /**<  Event is graceful  */
...
typedef struct {
  ...
  /**<   Event. Values: \n
      ...
      - SSCTL_DS_EVENT_BEFORE_ENTRY (4) --  Before deepsleep entry 
      - SSCTL_DS_EVENT_AFTER_ENTRY (5) --  After deepsleep entry 
      - SSCTL_DS_EVENT_BEFORE_EXIT (6) --  Before deepsleep exit 
      - SSCTL_DS_EVENT_AFTER_EXIT (7) --  After deepsleep exit 
 */
  ...
  /**<   How the event is driven. Values: \n
      ...
      - SSCTL_DS_EVENT_FORCED (2) --  Event is forced 
      - SSCTL_DS_EVENT_GRACEFUL (3) --  Event is graceful 
 */
