...
$Header: //components/rel/utils.mpss/5.4/api/mutils_dsm/mutils_dsm_anysize.h#1 $
...
*/
/*============================================================================*/
uint32 mutils_dsmi_util_anysize_pushdown_tail
(
...
#define mutils_dsm_anysize_pushdown_tail(dsm_ptr,buf,size)\
  mutils_dsmi_util_anysize_pushdown_tail((dsm_ptr),(buf),(size),dsm_file,__LINE__)
