...
$Header: //components/rel/utils.mpss/5.4/api/public/qsh_ext_types.h#2 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
10/11/18   mm      CR 2326454: Selectively synchronize metrics with timer pool
...
*/
typedef void * qsh_ext_metric_context_id_t;
...
/*!
  @brief
  Type to represent version 2 of top-level metric configuration.
*/
typedef struct
{
  /*! client id */
  ...
  /*! metric buffer start address */
  void*                              start_addr;

  /*! size of each element in bytes */
  qsh_metric_element_size_t          element_size_bytes;
  
  /*! total number of elements in the metric buffer */
  qsh_metric_element_count_t         element_count;  
  
  /*! period in ms */
  qsh_metric_sampling_period_ms_t    sampling_period_ms;

  /*! whether or not metric should be synchronized with timer pool */
  boolean                            sync;
