...
$Header: //components/rel/utils.mpss/5.4/api/a2/a2_ul_sec.h#1 $
...
07/11/13   ars     Add a2_ul_seci_commit_tag_and_irq
...
08/31/10   ar      added a2_ul_seci_register_dma_dsm_chain_cb() api
05/19/10   ar      changed a2_ul_sec_dest_info_s type to a2_iovec_t
04/29/10   ar      added a2_ul_seci_hspa_gather_and_decipher_with_intr_on_demand
...
10/12/09   sm      Added comment in a2_ul_seci_lte_compute_integrity()
...
/*!
  ...
  */
#define a2_ul_sec_hspa_register_gather_and_decipher_cb(cb_fn_ptr)  \
  a2_ul_seci_hspa_register_gather_and_decipher_cb(cb_fn_ptr)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_register_dma_dsm_chain_cb(cb_fn_ptr)  \
  a2_ul_seci_register_dma_dsm_chain_cb(cb_fn_ptr)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_lte_register_gather_decipher_and_integrity_cb(cb_fn_ptr) \
  a2_ul_seci_lte_register_gather_decipher_and_integrity_cb(cb_fn_ptr)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_lte_register_compute_integrity_cb(cb_fn_ptr)  \
  a2_ul_seci_lte_register_compute_integrity_cb(cb_fn_ptr)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_hspa_gather_and_decipher(cipher_info_ptr, num_src_iovec,  \
  src_iovec_list, dest_addr, dest_length_in_bytes, user_data)              \
  a2_ul_seci_hspa_gather_and_decipher(A2_SUB_ID_DEFAULT,cipher_info_ptr, \
  num_src_iovec,src_iovec_list, dest_addr, dest_length_in_bytes, user_data)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_hspa_gather_and_decipher_with_intr_on_demand(  \
  cipher_info_ptr, num_src_iovec, src_iovec_list, dest_info_ptr,user_data)  \
  a2_ul_seci_hspa_gather_and_decipher_with_intr_on_demand(A2_SUB_ID_DEFAULT,   \
  cipher_info_ptr, num_src_iovec, src_iovec_list, dest_info_ptr,user_data)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_commit_tag_and_irq(user_data) \
a2_ul_seci_commit_tag_and_irq(A2_SUB_ID_DEFAULT, user_data)  
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_dma_src_dsm_chain_to_dest_dsm_chain(src_dsm_chain_ptr,  \
  src_length_in_bytes, dest_dsm_chain_ptr, dest_length_in_bytes, user_data)  \
  a2_ul_seci_dma_src_dsm_chain_to_dest_dsm_chain(A2_SUB_ID_DEFAULT, \
  src_dsm_chain_ptr,src_length_in_bytes, dest_dsm_chain_ptr,     \
  dest_length_in_bytes, user_data) 
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_lte_gather_decipher_and_integrity(cipher_info_ptr, \
  integrity_info_ptr, src_pkt_ptr, src_length_in_bytes,pdcp_hdr_len,user_data) \
  a2_ul_seci_lte_gather_decipher_and_integrity(A2_SUB_ID_DEFAULT, cipher_info_ptr, \
  integrity_info_ptr, src_pkt_ptr, src_length_in_bytes,pdcp_hdr_len,user_data)
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_lte_compute_integrity(integrity_info_ptr, src_pkt_ptr, \
  src_length_in_bytes, pdcp_hdr_ptr, pdcp_hdr_len, user_data)  \
  a2_ul_seci_lte_compute_integrity(A2_SUB_ID_DEFAULT, integrity_info_ptr, \
  src_pkt_ptr,src_length_in_bytes, pdcp_hdr_ptr, pdcp_hdr_len, user_data) 
...
/*!
  ...
  this macro can take an extra argument as sub_id.
  */
#define a2_ul_sec_get_key_ptr(key_index) \
  a2_ul_seci_get_key_ptr(A2_SUB_ID_DEFAULT, key_index)
/*!
   @brief
...
/*!
   @brief
   callback function ptr type for a2_ul_seci_dma_src_dsm_chain_to_dest_dsm_chain
   task
*/
...
/*==============================================================================
  ...
  FUNCTION:  a2_ul_seci_hspa_register_gather_and_decipher_cb
...
*/
/*============================================================================*/
extern void a2_ul_seci_hspa_register_gather_and_decipher_cb
(
...
/* a2_ul_seci_hspa_register_gather_and_decipher_cb() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_register_dma_dsm_chain_cb
...
*/
/*============================================================================*/
EXTERN void a2_ul_seci_register_dma_dsm_chain_cb
(
...
/* a2_ul_seci_register_dma_dsm_chain_cb() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_lte_register_gather_decipher_and_integrity_cb
...
*/
/*============================================================================*/
extern void a2_ul_seci_lte_register_gather_decipher_and_integrity_cb
(
...
/* a2_ul_seci_lte_register_gather_decipher_and_integrity_cb() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_lte_register_compute_integrity_cb
...
*/
/*============================================================================*/
extern void a2_ul_seci_lte_register_compute_integrity_cb
(
  /*! callback to be called whenever A2_UL_SEC_TAG_LTE_COMPUTE_INTEGRITY tag
   * status is received */
  a2_ul_sec_lte_compute_integrity_cb cb_fn_ptr
);
/* a2_ul_seci_lte_register_compute_integrity_cb() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_hspa_gather_and_decipher
...
*/
/*============================================================================*/
extern void a2_ul_seci_hspa_gather_and_decipher
(
...
/* a2_ul_seci_hspa_gather_and_decipher() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_hspa_gather_and_decipher_with_intr_on_demand
...
*/
/*============================================================================*/
EXTERN void a2_ul_seci_hspa_gather_and_decipher_with_intr_on_demand
(
  a2_sub_id_t            sub_id,    /*!< System subscriber id */
  /*! pointer to ciphering info */
  a2_cipher_info_s      *cipher_info_ptr,
...
/*==============================================================================
  ...
  FUNCTION:  a2_ul_seci_commit_tag_and_irq
...
*/
/*============================================================================*/
EXTERN void a2_ul_seci_commit_tag_and_irq
(
  a2_sub_id_t   sub_id,    /*!< System subscriber id */
  /*! user data */
  uint32        user_data
...
/*==============================================================================
  ...
  FUNCTION:  a2_ul_seci_dma_src_dsm_chain_to_dest_dsm_chain
...
*/
/*============================================================================*/
EXTERN void a2_ul_seci_dma_src_dsm_chain_to_dest_dsm_chain
(
  a2_sub_id_t     sub_id,    /*!< System subscriber id */
...
/* a2_ul_seci_dma_src_dsm_chain_to_dest_dsm_chain() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_lte_gather_decipher_and_integrity
...
*/
/*============================================================================*/
extern void a2_ul_seci_lte_gather_decipher_and_integrity
(
  a2_sub_id_t           sub_id,    /*!< System subscriber id */
  ...
  uint32                 user_data            /*!< user data (rb_cfg_idx)*/
);
 /* a2_ul_seci_lte_gather_decipher_and_integrity() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_lte_compute_integrity
...
*/
/*============================================================================*/
extern void a2_ul_seci_lte_compute_integrity
(
  a2_sub_id_t           sub_id,    /*!< System subscriber id */
  a2_integrity_info_s  *integrity_info_ptr, /*!< ptr to integrity info*/
  dsm_item_type        *src_pkt_ptr,        /*!< src dsm item addr */
...
/* a2_ul_seci_lte_compute_integrity() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_write_keys
...
*/
/*============================================================================*/
extern void a2_ul_seci_write_keys
(
  a2_sub_id_t  sub_id,    /*!< System subscriber id */
...
/* a2_ul_seci_write_keys() */

/*==============================================================================

  FUNCTION:  a2_ul_seci_get_key_ptr

==============================================================================*/
/*!
  @brief
    returns a2 ul sec key ptr

    @return
    uint8*
*/
/*============================================================================*/
extern uint8* a2_ul_seci_get_key_ptr
(
  a2_sub_id_t  sub_id,    /*!< System subscriber id */
  uint8        key_index
);
...
/*!
  This INLINE funciton is exposed to other modules. This is used to support the 
  legacy code of other modules. Once other modules implement DSDA chanegs,
  this macro can take an extra argument as sub_id.
  NOTE: This is special case. RRC is declaring a stub for a2_ul_sec_write_keys
  in file modem_proc\lte\RRC\test\common\lte_rrc_test_common.cpp.
  Modify accordingly
  */
INLINE void a2_ul_sec_write_keys
(
  uint8  first_key_index,                /*!< first key index: range 0-15 */
  uint8  first_key[A2_UL_SEC_KEY_SIZE],  /*!< 16 byte key value > */
  uint8  second_key_index,               /*!< second key index: range 0-15 */
...
{
  a2_ul_seci_write_keys(A2_SUB_ID_DEFAULT,first_key_index, first_key,
  second_key_index, second_key, third_key_index, third_key);
