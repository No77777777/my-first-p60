...
$Header: //components/rel/core.mpss/10.0/mproc/ipc_router/src/ipc_router_qdi_driver.h#2 $ $DateTime: 2019/11/19 06:35:38 $ $Author: pwbldsvc $
...
#define IPC_ROUTER_QDI_GET_OBJREF        (QDI_PRIVATE + 17)
#define IPC_ROUTER_QDI_RX                (QDI_PRIVATE + 18)
...
} ipc_router_qdi_event_info_type;
