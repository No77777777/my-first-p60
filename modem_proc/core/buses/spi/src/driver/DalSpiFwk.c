...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/buses/spi/src/driver/DalSpiFwk.c#1 $$DateTime: 2019/04/24 00:03:26 $$Author: pwbldsvc $
...
static uint32 
Spi_DalSpi_Detach(uint32 ClientHandle,DalDeviceHandle* h)
{
...
static DALResult 
Spi_DalSpi_Init(uint32 ClientHandle,DalDeviceHandle *h)
{  
...
static DALResult 
Spi_DalSpi_DeInit(uint32 ClientHandle,DalDeviceHandle *h)
{
   return Spi_DeviceDeInit(h->pClientCtxt);
}

static DALResult 
Spi_DalSpi_PowerEvent(uint32 ClientHandle,DalDeviceHandle *h, DalPowerCmd PowerCmd, 
...
static DALResult 
Spi_DalSpi_Open(uint32 ClientHandle,DalDeviceHandle* h, uint32 mode)
{
    return Spi_Open(h->pClientCtxt,mode);
}

static DALResult 
Spi_DalSpi_Close(uint32 ClientHandle,DalDeviceHandle* h)
{
    return Spi_Close(h->pClientCtxt);
}

static DALResult 
Spi_DalSpi_Info(uint32 ClientHandle,DalDeviceHandle* h, DalDeviceInfo* info, uint32 infoSize)
{
...
static DALResult 
Spi_DalSpi_SysRequest(uint32 ClientHandle,DalDeviceHandle* h,DalSysReq ReqIdx,
...
static DALResult 
Spi_DalSpi_GetInputBlockSize(uint32 ClientHandle, DalDeviceHandle * h,  void*  inputBlockSize, uint32 olen1) 
{
	return Spi_GetInputBlockSize(((DalSpiHandle *)h)->pClientCtxt, (uint32 *)inputBlockSize, olen1);
}
static DALResult 
Spi_DalSpi_GetOutputBlockSize(uint32 ClientHandle, DalDeviceHandle * h,  void*  outputBlockSize, uint32 olen1) 
{
	return Spi_GetOutputBlockSize(((DalSpiHandle *)h)->pClientCtxt, (uint32 *)outputBlockSize, olen1);
}
static DALResult 
Spi_DalSpi_ConfigureDevice(uint32 ClientHandle, DalDeviceHandle * h,  const SpiDeviceInfoType *  deviceInfo) 
{
	return Spi_ConfigureDevice(((DalSpiHandle *)h)->pClientCtxt, deviceInfo);
}
static DALResult 
Spi_DalSpi_GetDeviceConfiguration(uint32 ClientHandle, DalDeviceHandle * h,  void * deviceInfo, uint32 olen1) 
{
	return Spi_GetDeviceConfiguration(((DalSpiHandle *)h)->pClientCtxt, (SpiDeviceInfoType *)deviceInfo, olen1);
}
static DALResult 
Spi_DalSpi_StartTransfer(uint32 ClientHandle, DalDeviceHandle * h,  SpiTransferType *  transfer,  SpiDataAddrType*  outputAddr,  int  outputDataLen,  SpiDataAddrType*  inputAddr,  int  inputDataLen,  int*  inputDataLenReq, uint32 olen6,  void*  transferId, uint32 olen7) 
{
...
static DALResult 
Spi_DalSpi_GetTransferStatus(uint32 ClientHandle, DalDeviceHandle * h,  uint32  transferId) 
{
	return Spi_GetTransferStatus(((DalSpiHandle *)h)->pClientCtxt, transferId);
}
static DALResult 
Spi_DalSpi_Send(uint32 ClientHandle, DalDeviceHandle * h,  SpiDataAddrType*  outputAddr,  int  outputDataLen) 
{
	return Spi_Send(((DalSpiHandle *)h)->pClientCtxt, outputAddr, outputDataLen);
}
static DALResult 
Spi_DalSpi_Receive(uint32 ClientHandle, DalDeviceHandle * h,  uint32  u32NumInputTransfers,  SpiDataAddrType*  inputAddr,  int  inputDataLen,  int*  inputDataLenReq, uint32 olen4) 
{
	return Spi_Receive(((DalSpiHandle *)h)->pClientCtxt, u32NumInputTransfers, inputAddr, inputDataLen, inputDataLenReq, olen4);
}
static DALResult 
Spi_DalSpi_SendAndReceive(uint32 ClientHandle, DalDeviceHandle * h,  SpiDataAddrType*  outputAddr,  int  outputDataLen,  uint32  u32NumInputTransfers,  SpiDataAddrType*  inputAddr,  int  inputDataLen,  int*  inputDataLenReq, uint32 olen6) 
{
...
static DALResult 
Spi_DalSpi_Reset(uint32 ClientHandle, DalDeviceHandle * h) 
{
