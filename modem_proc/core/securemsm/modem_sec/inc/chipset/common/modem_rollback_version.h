...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/securemsm/modem_sec/inc/chipset/common/modem_rollback_version.h#1 $
 ...
 */
#define HWIO_QFPROM_CORR_ANTI_ROLLBACK_FEATURE_EN_BMSK       0x8
...
static struct modem_version_rollback_img_set modem_sec_mba_img =
{
    ...
    (uint32 *)HWIO_QFPROM_CORR_OEM_CONFIG_ROW2_MSB_ADDR,
    
     /* version_mask*/
     HWIO_QFPROM_CORR_ANTI_ROLLBACK_4_LSB_MBA_BMSK,
    
     /* version_shift */
     HWIO_QFPROM_CORR_ANTI_ROLLBACK_4_LSB_MBA_SHFT,    
    
     /* version_lsb_base_addr */
     (uint32 *)HWIO_QFPROM_RAW_ANTI_ROLLBACK_4_LSB_PHYS,
    
     /* version_lsb_base_addr */
     (uint32 *)HWIO_QFPROM_RAW_ANTI_ROLLBACK_4_LSB_ADDR,
...
static struct modem_version_rollback_img_set modem_sec_modem_img =
{
    ...
    /* feature_enable_mask */
     ...
     /* version_mask*/
     HWIO_QFPROM_CORR_ANTI_ROLLBACK_4_LSB_MSS_BMSK,
    
     /* version_shift */
     HWIO_QFPROM_CORR_ANTI_ROLLBACK_4_LSB_MSS_SHFT,    
