...
/*
 * Similar to qrlbn_point_on_curve() but use qrlbn_ecc_affine_point.
 * For montgomery encoded affine curves.
 * Returns B_TRUE if the point is on the curve, B_FALSE otherwise.
 ...
 */
boolean_t
affine_point_on_curve(const qrlbn_ecc_affine_point_t *Q,
		     const qrlbn_ecc_domain_t *dp);                    
