...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/securemsm/secboot/inc/secboot_chipset_i.h#2 $
  $DateTime: 2020/08/17 01:36:44 $
  $Author: pwbldsvc $
...
#define secboot_read_qti_root_sig_format_sel() \
    HWIO_INF(FEATURE_CONFIG8, QTI_ROOT_SIG_FORMAT_SEL)
/**
