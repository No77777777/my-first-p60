...
$Header: //components/rel/core.mpss/10.0/securemsm/akaalgo/src/AKAAlgoBit.h#2 $ 
$DateTime: 2021/01/21 05:17:22 $ $Author: pwbldsvc $
...
#define AA_QW_ALIGNED(qw) ((((int)qw) << 30) == 0)
