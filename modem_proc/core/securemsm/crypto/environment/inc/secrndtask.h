...
Copyright (c) {2001-2010, 2016, 2019} Qualcomm Technologies, Inc.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/securemsm/crypto/environment/inc/secrndtask.h#2 $ 
...
#define SECRND_MUTEX_TRY_ENTER() rex_try_enter_crit_sect(&secrnd.mutex)
...
PARAMETERS
  ...
  secure_flag - Guranteed to read random number from HW PRNG if set, otherwise in case 
                if random local buffer exhausts, read random number from SW algorithm
...
SIDE EFFECTS  
  None
===========================================================================*/  
secerrno_enum_type secrnd_get_random_data(uint8* random_ptr, uint16 random_len, uint8 secure_flag); 
