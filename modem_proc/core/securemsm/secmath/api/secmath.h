...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/securemsm/secmath/api/secmath.h#2 $
  $DateTime: 2022/12/22 10:32:15 $
  $Author: pwbldsvc $
...
#else
  #define MAX_KEY_SIZE_IN_BITS 8192                  ///< Maximum key size in bits for Non-SP
#endif
