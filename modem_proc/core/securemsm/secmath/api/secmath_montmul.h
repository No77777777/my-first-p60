...
/*=========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/securemsm/secmath/api/secmath_montmul.h#1 $
...
int montmul_one_ref_no_reduce(uint32 * restrict z, const uint32 *a, const uint32 *m, size_t N, uint32 m0_1);
