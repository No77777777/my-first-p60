...
#define DALFW_GET_DEV_CTXT(pDrvCtxt,devIdx) \
   ((DALDevCtxt *)(((byte *)(pDrvCtxt->DALDeviceCtxt))+(pDrvCtxt->dwSizeDevCtxt*devIdx)))
...
static void DALFW_InitDrvCtxt(DALDrvCtxt *pdalDrvCtxt)
{
    if(!pdalDrvCtxt->bInit)
   {
      ...
      if(pdalDrvCtxt->DALDrvVtable.DAL_DriverInit)
      {
         pdalDrvCtxt->DALDrvVtable.DAL_DriverInit(pdalDrvCtxt);
      }
   }
}
static void DALFW_DeInitDrvCtxt(DALDrvCtxt *pdalDrvCtxt)
{
    if(pdalDrvCtxt->bInit)
   {
      ...
      if(pdalDrvCtxt->DALDrvVtable.DAL_DriverDeInit)
      {
         pdalDrvCtxt->DALDrvVtable.DAL_DriverDeInit(pdalDrvCtxt);
      }
   }
}
static void DALFW_InitDevCtxt(DALDevCtxt * pdalDevCtxt, DALDrvCtxt *pdalDrvCtxt,
