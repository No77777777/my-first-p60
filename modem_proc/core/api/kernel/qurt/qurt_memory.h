...
/**@ingroup func_qurt_system_l2tcm_get_info
  Returns the TCM base Physical address, TCM size and L2 size.

  @note1hang This operation can be called only by RootPD.

  @param[in] tcm_base  Pointer to save TCM base address to \n
  @param[in] tcm_size  Pointer to save TCM size to \n
  @param[in] l2_size   Pointer to save L2 size to \n
  ...
  None.
 */
void qurt_system_l2tcm_get_info(qurt_paddr_t *tcm_base, qurt_size_t* tcm_size, qurt_size_t* l2_size);
