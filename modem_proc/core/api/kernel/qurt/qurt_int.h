...
/**@ingroup func_qurt_interrupt_register
  ...
  Once the signal is used for registering an interrupt, its signal bits can only be set by Qurt
  when receiving the interrupt. The signal cannot be set with Qurt signal API from another
  software thread even for unused signal bits.
