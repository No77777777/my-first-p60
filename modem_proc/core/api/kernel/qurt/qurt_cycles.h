...
/**@ingroup func_qurt_get_hthread_pcycles
  ...
  Reads GCYCLE_nT register to allow performance measurement when N threads are in run mod.\n

  @note1hang If architecture is earlier than v67, a value of 0 will be returned
  
  @param[in] n threads in run mode. Valid values: \n
                     - 1-6 \n
...
/**@ingroup func_qurt_get_hthread_commits
  ...
  Reads GCOMMIT_nT register to allow performance measurement when N threads are in run mod.\n
  ...
  @return 
  Value read from GCOMMIT_nT register
