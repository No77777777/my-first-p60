...
$Header: //components/rel/core.mpss/10.0/api/kernel/rex/os/qurt/rex_os.h#1 $
...
#define REX_OS_TASK_MAX_PRIORITY                (255)
#define REX_OS_TASK_MAX_SW_PRIORITY             ((REX_OS_TASK_MAX_PRIORITY) - (MODEM_FW_NUM_PRIO))
...
#define REX_OS_DISABLE_PREEMPTION()             {\
                                                   ...
                                                   old_prio = rex_set_task_pri(_p_tcb, REX_OS_TASK_MAX_SW_PRIORITY)
