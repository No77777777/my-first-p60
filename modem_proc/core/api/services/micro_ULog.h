...
micro_ULog API
  ...
  Copyright (c) 2012, 2017-2018 Qualcomm Technologies Incorporated.
  All Rights Reserved.
...
05/25/17    rs    Fixed micro uLog macro APIs pass in wrong value for the number of arguments						
...
#define MICRO_ULOG_RT_PRINTF_0(h, formatStr) \
           micro_ULog_RealTimePrintf(h, 0, formatStr)
#define MICRO_ULOG_RT_PRINTF_1(h, formatStr, p1) \
           micro_ULog_RealTimePrintf(h, 1, formatStr, p1)
#define MICRO_ULOG_RT_PRINTF_2(h, formatStr, p1, p2) \
           micro_ULog_RealTimePrintf(h, 2, formatStr, p1, p2)
#define MICRO_ULOG_RT_PRINTF_3(h, formatStr, p1, p2, p3) \
           micro_ULog_RealTimePrintf(h, 3, formatStr, p1, p2, p3)
#define MICRO_ULOG_RT_PRINTF_4(h, formatStr, p1, p2, p3, p4) \
           micro_ULog_RealTimePrintf(h, 4, formatStr, p1, p2, p3, p4)
#define MICRO_ULOG_RT_PRINTF_5(h, formatStr, p1, p2, p3, p4, p5) \
           micro_ULog_RealTimePrintf(h, 5, formatStr, p1, p2, p3, p4, p5)
