...
$Header: //components/rel/core.mpss/10.0/api/services/ULog.h#1 $ 
============================================================================*/
#ifndef ULOG_H
#define ULOG_H
...
typedef enum
{
  ...
  ULOG_ERR_UINT16 = 0x7FFF    // force enum to 32-bits
 ...
 *
 * @deprecated  
 *    This API is deprecated. Migrate Code to use 'ULogCore_ReadEx' to read data from log buffer. 
 */
ULogResult ULogCore_Read(ULogHandle h,
                         uint32  outputSize,
                         char *  outputMem,
                          uint32 *outputCount ) CORE_WARN_DEPRECATED_MSG("This API is deprecated", 
                                        "Migrate Code to use 'ULogCore_ReadEx' to read data from log buffer. ");
 ...
 * 
 * @deprecated This API is deprecated and will be removed from code. 
 */
ULogResult ULogDiagAddPlugin(int(*new_pluginfcn)(uint32), uint32 new_plugin_id)  
                CORE_WARN_DEPRECATED_MSG("This API is deprecated, It will be removed from the code", "Please stop using this API");
