...
Copyright (c) 2009-2014, 2017-2018, 2020 Qualcomm Technologies Incorporated.
All Rights Reserved.
Qualcomm Confidential and Proprietary

$Header: //components/rel/core.mpss/10.0/api/services/ULogFront.h#2 $
============================================================================*/
#ifndef ULOGFRONT_H
#define ULOGFRONT_H
 ...
 * <!-- ULogFront_RawInit -->
 *
 * @brief Macro to create a new log in the RAW format.
 * 
...
*/
#define ULogFront_RawInit(h, name, logBufSize, logBufMemType, logLockType)  \
	    ULogCore_LogCreate(h, name, logBufSize, logBufMemType, logLockType, ULOG_INTERFACE_RAW);
...
#define ULOG64_LOWWORD(x) (uint32)(((uint64)(x)) & 0x00000000FFFFFFFF) /* To get Lower 32 bit value */
#define ULOG64_HIGHWORD(x) (uint32)(((uint64)(x) & 0xFFFFFFFF00000000) >> 32) /* To get higher 32 bit value */
 ...
 *
 * @brief Macro to Create a new log in the RealTime format.
 *
 ...
 *        Errors are defined in the ULOG_ERRORS enum.
 */
#define ULogFront_RealTimeInit(h, name, logBufSize, logBufMemType, logLockType)  \
	      ULogCore_LogCreate(h, name, logBufSize, logBufMemType, logLockType,ULOG_INTERFACE_REALTIME)
