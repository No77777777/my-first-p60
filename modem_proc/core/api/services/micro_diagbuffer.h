...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/api/services/micro_diagbuffer.h#1 $
...
typedef enum
{
  ...
  MICRO_DIAGBUFFER_ERR_INVALIDPARAMETER,      // A parameter provided is invalid.
 ...
 *
 * @brief Creates a new lockless/lockable micro diagbuffer in the given memory buffer.
