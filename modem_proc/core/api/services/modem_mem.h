...
$Header: //components/rel/core.mpss/10.0/api/services/modem_mem.h#1 $
...
02/26/14   mg      Added new api for modem clients for setting caller functions in heap
...
typedef void(*modem_mem_high_cb_type)(size_t usage);
...
/**
  ...
  Description :
     Returns the modem_mem_heap statistics for a thread with given memheap TLS index 
