...
$Header: //components/rel/core.mpss/10.0/api/services/micro_msg_diag_service.h#1 $
...
/*!
   ...
   @warning
   Do not call directly; use macro MICRO_MSG_EXT
   ...
   @sa
*/
  void _micro_msg_send_ext (const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter);
...
/*!
   ...
   @warning
   Do not call directly; use macro MICRO_MSG_1_EXT.
...
*/
  void _micro_msg_send_1_ext (const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter, uint32 xx_arg1);
...
/*!
   ...
   @warning
   Do not call directly; use macro MICRO_MSG_2_EXT.
...
*/  
  void _micro_msg_send_2_ext (const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter, uint32 xx_arg1,
    uint32 xx_arg2);
...
/*!
   ...
   @warning
   Do not call directly; use macro MICRO_MSG_3_EXT.
...
*/
  void _micro_msg_send_3_ext (const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter, uint32 xx_arg1,
...
@ingroup diag_message_service
   ...
   @warning
   Do not call directly; use macro MICRO_MSG_4_EXT ..MICRO_MSG_9_EXT.
...
*/
  void _micro_msg_send_var_ext (const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter, 
                                  uint32 num_args, ...);
...
*/
#define MICRO_MSG_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt) \
  do {\
    /*lint -e506 -e774*/ \
      ...
      /*lint +e506 +e774*/ \
        if (diag_island_mode_check()){\
          ...
          /*lint -e571 */ \
          _micro_msg_send_ext (&xx_msg_const, xx_version, xx_parameter); \
         /*lint +e571 */ \
        } \
	    else{\
...
*/
#define MICRO_MSG_1_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_1_ext (&xx_msg_const, xx_version, xx_parameter, (uint32) (xx_arg1)); \
      /*lint +e571 */ \
      } \
      else{\
        XX_MSG_V4_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_2_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
        /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_2_ext (&xx_msg_const, xx_version, xx_parameter,(uint32)(xx_arg1), (uint32)(xx_arg2)); \
      /*lint +e571 */ \
      } \
      else{\
        XX_MSG_V4_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_3_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3) \
  do { \
    /*lint -e506 -e774*/ \
      if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
      /*lint +e506 +e774*/ \
        if (diag_island_mode_check()){\
          XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
          /*lint -e571 */ \
          _micro_msg_send_3_ext (&xx_msg_const, xx_version, xx_parameter, (uint32) (xx_arg1), (uint32) (xx_arg2), \
                                 (uint32) (xx_arg3)); \
         /*lint +e571 */ \
        } \
        else{\
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_4_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
                                            xx_arg4)\
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_var_ext (&xx_msg_const, xx_version, xx_parameter,(uint32)(4), (uint32) (xx_arg1), \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_5_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
                                            xx_arg4, xx_arg5) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_var_ext(&xx_msg_const, xx_version, xx_parameter,(uint32)(5), (uint32)(xx_arg1), \
               (uint32)(xx_arg2), (uint32)(xx_arg3), (uint32)(xx_arg4), \
                                  (uint32)(xx_arg5)); \
      /*lint +e571 */ \
      } \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_6_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_var_ext (&xx_msg_const, xx_version, xx_parameter,(uint32)(6), (uint32)(xx_arg1), \
                (uint32)(xx_arg2), (uint32)(xx_arg3), (uint32)(xx_arg4), \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_7_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
                                            xx_arg4, xx_arg5, xx_arg6, \
                                            xx_arg7)\
  do { \
    /*lint -e506 -e774*/ \
    ...
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_var_ext (&xx_msg_const, xx_version, xx_parameter, (uint32)(7), (uint32)(xx_arg1), \
                (uint32)(xx_arg2), (uint32)(xx_arg3), (uint32)(xx_arg4), \
                                   (uint32)(xx_arg5), (uint32)(xx_arg6), \
                                   (uint32)(xx_arg7)); \
      /*lint +e571 */ \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_8_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
                                            xx_arg4, xx_arg5, xx_arg6, \
                                            xx_arg7, xx_arg8)\
  do { \
    /*lint -e506 -e774*/ \
    ...
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_var_ext (&xx_msg_const, xx_version, xx_parameter, (uint32)(8), (uint32)(xx_arg1), \
                (uint32)(xx_arg2), (uint32)(xx_arg3), (uint32)(xx_arg4), \
                                   (uint32)(xx_arg5), (uint32)(xx_arg6), \
...
/*!
  ...
  differentiate F3s coming from different instances of the processor
*/
#define MICRO_MSG_9_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
                                            xx_arg4, xx_arg5, xx_arg6, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      if (diag_island_mode_check()){\
        XX_MICRO_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
        /*lint -e571 */ \
        _micro_msg_send_var_ext (&xx_msg_const, xx_version, xx_parameter, (uint32)(9), (uint32)(xx_arg1), \
               (uint32)(xx_arg2),  (uint32)(xx_arg3), (uint32)(xx_arg4), \
                                   (uint32)(xx_arg5), (uint32)(xx_arg6), \
                                   (uint32)(xx_arg7), (uint32)(xx_arg8), \
                                   (uint32)(xx_arg9)); \
