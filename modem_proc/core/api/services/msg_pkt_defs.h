...
*/
/*
Copyright (c) 2002, 2007, 2010, 2016-2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/services/msg_pkt_defs.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/08/17   gn      Fixed compilation with T_WINNT flag enabled
