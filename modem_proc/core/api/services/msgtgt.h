...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/services/msgtgt.h#4 $
...
03/05/18   nk      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.112
...
11/14/16   sp      Updated SSID level for several clients
10/14/16   as      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.91
05/05/16   as      Updated levels of various SSIDs
02/16/16   as      Added new message SSIDs
01/20/16   as      Added new message SSIDs
11/11/15   as      Update levels of DS related SSIDs
