...
/*===========================================================================*/
/*
Copyright (c) 2013, 2017-18 QUALCOMM Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.mpss/10.0/api/services/amssheap.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
===========================================================================*/
void amssheap_get_sections_info(memheap_section_info *heap_info);
