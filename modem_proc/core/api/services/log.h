...
/*
Copyright (c) 1991-2010, 2013,2015-2016 by QUALCOMM Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.mpss/10.0/api/services/log.h#1 $
...
@ingroup log_service
  ...
  _diagbuffer_log_submit function:
    Users are NOT recommended to use this and instead use the macro
    DIAGBUFFER_LOG_SUBMIT to future-proof their code against diag buffer changes.
  */

boolean _diagbuffer_log_submit (diagbuffer_handle handle, PACK(void *) log_data, unsigned int version, void * param);

/*!
@ingroup log_service
@brief
This macro is called to log an accumlated log entry into the respective
...
None
*/
#define DIAGBUFFER_LOG_SUBMIT(h, log_data, version, param) \
    _diagbuffer_log_submit (h, log_data, version, param);

  /*!
     @ingroup log_service

  _diagbuffer_log_alloc function:
    Users are NOT recommended to use this and instead use DIAGBUFFER_LOG_ALLOC
    to future-proof their code against diag buffer changes.
  */

PACK(void*) _diagbuffer_log_alloc(diagbuffer_handle handle, log_code_type code, unsigned int length, unsigned int version, void * param);
...
#define DIAGBUFFER_LOG_ALLOC(h, code, length, version, param) \
    _diagbuffer_log_alloc (h, code, length, version, param);

/*!
  @ingroup log_service

  _diagbuffer_log_commit function:
    Users are NOT recommended to use this and instead use DIAGBUFFER_LOG_COMMIT
    macro to future-proof their code against diag buffer changes
*/
...
#define DIAGBUFFER_LOG_COMMIT(h, log_data) \
    _diagbuffer_log_commit (h, log_data);
