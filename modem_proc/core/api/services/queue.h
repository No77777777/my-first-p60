...
Copyright (c) 1992-2016,2018 Qualcomm Technologies, Inc.
All rights reserved.
...
$Header: //components/rel/core.mpss/10.0/api/services/queue.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
/**
  ...
  @param[in] q_ptr        Pointer to the queue.
  @param[in] q_insert_ptr Pointer to the item to be inserted.
  @param[in] q_item_ptr   Pointer to the queue item before which q_insert_ptr to be inserted.
