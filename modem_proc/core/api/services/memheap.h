...
$Header: //components/rel/core.mpss/10.0/api/services/memheap.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
//#define MEMHEAP_LOG_MULTIPLE_CALLERS /* Feature to log multiple callers in the block's header: Disabled by default*/

#ifdef MEMHEAP_LOG_MULTIPLE_CALLERS 
#ifndef MEMHEAP_MAX_CALLER_LEVEL_WITH_LIMIT_5
#define MEMHEAP_MAX_CALLER_LEVEL_WITH_LIMIT_5 4    /* Maximum crash free value that can be passed into __builtin_return_address api*/
#endif
#endif /*MEMHEAP_LOG_MULTIPLE_CALLERS */ 
...
#ifndef HEAP_NAME_SIZE
#define HEAP_NAME_SIZE 20
#endif
...
#ifdef FEATURE_MEM_DEBUG
#define MEMHEAP_MAX_THREADS 510 /*510 number derived after discussion with QuRT team ,
                                  check cust_config.xml for max threads supported by kernel*/
...
typedef struct __attribute__ ((aligned(8))) mem_heap_struct {
  ...
  /**< Amount of bytes (client) in use in the heap. */
  unsigned long                  heap_used_bytes;
  /**< Amount of actual bytes in use in the heap. */
...
===========================================================================*/
void memheap_get_section_info(mem_heap_type *heap_ptr, memheap_section_info *heap_info);
...
ARGUMENTS
  None
===========================================================================*/
unsigned long mem_heap_get_current_in_use_blocks_count(mem_heap_type *heap_ptr);
...
===========================================================================*/
int findLargestBlockSize(mem_heap_type *heap_ptr );
