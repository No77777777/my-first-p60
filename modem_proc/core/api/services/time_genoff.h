...
$Header: //components/rel/core.mpss/10.0/api/services/time_genoff.h#1 $
...
/**
Registers a callback function with the given base, which is 
called whenever there is any time updated to that base.

@param[in] base : The base for which the cb function is to be added.
@param[in] cb_func : Pointer to the callback function.
@param[in] data : Data which is passed to the callback function as arg.

@return
Appropriate error based on the operation.
