...
$Header: //components/rel/core.mpss/10.0/api/systemdrivers/DDISoftwareSwitches.h#1 $
...
{
   DalDevice DalDevice;
   DALResult (*SetSwitch)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  software_switch);
   DALResult (*ClearSwitch)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  software_switch);
   DALResult (*SetAll)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  software_switch);
   DALResult (*GetMask)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  software_switch,  void * state, uint32  size);
};
...
DalSoftwareSwitches_SetSwitch(DalDeviceHandle * _h, uint32  software_switch)
{
   ...
   return ((DalSoftwareSwitchesHandle *)_h)->pVtbl->SetSwitch(DALDEVICE_LOCAL_CLIENTID,  _h, software_switch);
}
static __inline DALResult
DalSoftwareSwitches_ClearSwitch(DalDeviceHandle * _h, uint32  software_switch)
{
   ...
   return ((DalSoftwareSwitchesHandle *)_h)->pVtbl->ClearSwitch(DALDEVICE_LOCAL_CLIENTID,  _h, software_switch);
}
static __inline DALResult
DalSoftwareSwitches_SetAll(DalDeviceHandle * _h, uint32  software_switch)
{
   ...
   return ((DalSoftwareSwitchesHandle *)_h)->pVtbl->SetAll(DALDEVICE_LOCAL_CLIENTID,  _h, software_switch);
}
static __inline DALResult
DalSoftwareSwitches_GetMask(DalDeviceHandle * _h, uint32  software_switch,  void * state)
{
   ...
   return ((DalSoftwareSwitchesHandle *)_h)->pVtbl->GetMask(DALDEVICE_LOCAL_CLIENTID,  _h, software_switch, state, 1);
}
#endif
