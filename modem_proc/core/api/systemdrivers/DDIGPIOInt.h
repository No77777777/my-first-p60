...
$Header: //components/rel/core.mpss/10.0/api/systemdrivers/DDIGPIOInt.h#1 $
 ...
 */
#define GPIOINT_SUMMARY_ID 0x7fffffff
/** @endcond */
/**
...
/**
  ...
  used.\n 
 */
#define GPIOINT_ISLAND_MODE 0x1
#define GPIOINT_NORMAL_MODE 0x0
...
struct GPIOInt
{
   ...
   DALResult (*SetTrigger)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, GPIOIntTriggerType  trigger);
   DALResult (*RegisterIsr)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio,GPIOIntTriggerType  trigger,
                            GPIOINTISR isr,GPIOINTISRCtx param);
   DALResult (*RegisterEvent)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio, GPIOIntTriggerType trigger,
                              DALSYSEventHandle event);
   DALResult (*DeRegisterEvent)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio,DALSYSEventHandle event);
   DALResult (*DeregisterIsr)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, GPIOINTISR  isr);
   DALResult (*IsInterruptEnabled)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, void *  state, uint32  size);
   DALResult (*IsInterruptPending)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, void *  state, uint32  size);
   DALResult (*Save)(uint32 ClientHandle, DalDeviceHandle * _h);
   DALResult (*Restore)(uint32 ClientHandle, DalDeviceHandle * _h);
   DALResult (*DisableInterrupt)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio);
   DALResult (*EnableInterrupt)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio);
   DALResult (*InterruptNotify)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio);
   DALResult (*MonitorInterrupts)(uint32 ClientHandle, DalDeviceHandle * _h,  GPIOINTISR isr,uint32 enable);
   DALResult (*MapMPMInterrupt)(uint32 ClientHandle, DalDeviceHandle * h, uint32 gpio, uint32 mpm_interrupt_id);
   DALResult (*AttachRemote)(uint32 ClientHandle, DalDeviceHandle * h, uint32 processor);
   DALResult (*TriggerInterrupt)(uint32 ClientHandle, DalDeviceHandle * h, uint32 gpio);
   DALResult (*ClearInterrupt)(uint32 ClientHandle, DalDeviceHandle * h, uint32 gpio);
   DALResult (*IsInterruptSet)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, void *  state, uint32  size);
   DALResult (*SetDirectConnectGPIOMapping)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, uint32 direct_connect_line);
   DALResult (*IsInterruptRegistered)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  gpio, void *  state, uint32  size);
   DALResult (*DisableGPIOInterrupt)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio);
   DALResult (*EnableGPIOInterrupt)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio);
   DALResult (*GPIOInt_RegisterIsrEx)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 gpio,GPIOIntTriggerType  trigger,
