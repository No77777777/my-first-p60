...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.mpss/10.0/api/systemdrivers/DDIHWIO.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
  ====================================================================
*/ 
...
struct DalHWIO
{
   ...
   DALResult (*MapRegion)(uint32 ClientHandle, DalDeviceHandle * _h, const char * szBase, uint8 **ppAddress);
   DALResult (*UnMapRegion)(uint32 ClientHandle, DalDeviceHandle * _h, uint8 *pVirtAddress);
   DALResult (*MapRegionByAddress)(uint32 ClientHandle, DalDeviceHandle * _h, uint8 *pPhysAddress, uint8 **ppAddress);
   DALResult (*MapAllRegions)(uint32 ClientHandle, DalDeviceHandle * _h);
};
