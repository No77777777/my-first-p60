...
===========================================================================
                             Edit History
$Header: //components/rel/core.mpss/10.0/api/systemdrivers/DDITimetick.h#1 $
...
struct DalTimetick {
  ...
  DALResult (*CvtToTimetick32)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type  time, DalTimetickUnitType  unit,  DalTimetickTime32Type * time_ret);
  DALResult (*CvtFromTimetick32)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type  time, DalTimetickUnitType  unit,  DalTimetickTime32Type * time_ret);
  DALResult (*GetElapsed)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type  start, DalTimetickUnitType  unit,  DalTimetickTime32Type * diff);
  DALResult (*Diff)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type  start, DalTimetickTime32Type  end, DalTimetickUnitType  unit,  DalTimetickTime32Type * diff);
  DALResult (*GetMs)(uint32 ClientHandle, DalDeviceHandle * _h,  DalTimetickTime32Type * ms);
  DALResult (*SetNextInterrupt)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type  match_count, DalTimetickTime32Type  ticks_now,  DalTimetickTime32Type * match_val);
  DALResult (*Enable)(uint32 ClientHandle, DalDeviceHandle * _h, boolean  enable);
  DALResult (*GetFreq)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 * nFreq);
  DALResult (*CvtToTimetick64)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type  time, DalTimetickUnitType  unit,  DalTimetickTime64Type * time_ret);
  DALResult (*CvtFromTimetick64)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type  time, DalTimetickUnitType  unit,  DalTimetickTime64Type * time_ret);
  DALResult (*CvtToUsec)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type time, DalTimetickUnitType   unit, DalTimetickTime64Type *time_ret);
  DALResult (*CvtFromUsec)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type time, DalTimetickUnitType   unit, DalTimetickTime32Type *time_ret);
  DALResult (*GetMatchValue)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime32Type * match_value);
  DALResult (*TicksToPrecUs)(uint32 ClientHandle, DalDeviceHandle * h, DalTimetickTime32Type  nTicks, uint64 *pus);
  DALResult (*SetNextInterrupt64)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type  match_count, DalTimetickTime64Type  ticks_now,  DalTimetickTime64Type * match_val);
  DALResult (*GetMatchValue64)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type * match_value);
  DALResult (*GetInterruptVectorNum)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 *num);
  DALResult (*GetElapsed64)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type  start, DalTimetickUnitType  unit,  DalTimetickTime64Type * diff);
  DALResult (*Diff64)(uint32 ClientHandle, DalDeviceHandle * _h, DalTimetickTime64Type  start, DalTimetickTime64Type  end, DalTimetickUnitType  unit,  DalTimetickTime64Type * diff);
  DALResult (*MaskInterrupt)(uint32 ClientHandle, DalDeviceHandle * _h, boolean bMask);
...
{
  return((DalTimetickHandle *)_h)->pVtbl->SetNextInterrupt(DALDEVICE_LOCAL_CLIENTID,  _h, 
...
/* ============================================================================
**  Function : DalTimetick_GetElapsed64
** ============================================================================
*/
/*!
    @brief
    Computes the time elapsed from a previous 64 bit timetick value
...
*/
static __inline DALResult
DalTimetick_GetElapsed64
(
  DalDeviceHandle * _h,
  DalTimetickTime64Type  start,
  DalTimetickUnitType  unit,
  DalTimetickTime64Type * diff
)
{
  return((DalTimetickHandle *)_h)->pVtbl->GetElapsed64(DALDEVICE_LOCAL_CLIENTID,  _h, start, unit, 
                                                      diff);
}

/* ============================================================================
**  Function : DalTimetick_Diff64
** ============================================================================
*/
/*!
    @brief
    Computes the difference between two 64 bit timetick counts
...
(
  DalDeviceHandle * _h,
  DalTimetickTime64Type  start,
  DalTimetickTime64Type  end,
  DalTimetickUnitType  unit,
  DalTimetickTime64Type * diff
)
{
  return((DalTimetickHandle *)_h)->pVtbl->Diff64(DALDEVICE_LOCAL_CLIENTID,  _h, start, end, unit, diff);
}
