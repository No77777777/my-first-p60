...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.mpss/10.0/api/systemdrivers/DDIIPCInt.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
  ====================================================================
*/ 
...
struct DalIPCInt
{
  ...
  DALResult (*Trigger)(uint32 ClientHandle, DalDeviceHandle * _h,  DalIPCIntProcessorType  eTarget,  DalIPCIntInterruptType  eInterrupt);
  DALResult (*TriggerBySource)(uint32 ClientHandle, DalDeviceHandle * _h,  DalIPCIntProcessorType  eSource,  DalIPCIntProcessorType  eTarget,  DalIPCIntInterruptType  eInterrupt);
  DALResult (*IsSupported)(uint32 ClientHandle, DalDeviceHandle * _h,  DalIPCIntProcessorType  eTarget,  DalIPCIntInterruptType  eInterrupt);
  DALResult (*IsSupportedBySource)(uint32 ClientHandle, DalDeviceHandle * _h,  DalIPCIntProcessorType  eSource,  DalIPCIntProcessorType  eTarget,  DalIPCIntInterruptType  eInterrupt);
};
