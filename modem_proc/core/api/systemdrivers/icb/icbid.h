 ...
 * 
 * $Header: //components/rel/core.mpss/10.0/api/systemdrivers/icb/icbid.h#2 $ 
 * $DateTime: 2020/04/01 03:35:24 $ 
 * $Author: pwbldsvc $ 
 * 
...
typedef enum {
  ...
  ICBID_MASTER_SNOC_BIMC_RT,
  ICBID_MASTER_SNOC_BIMC_NRT,
  ICBID_MASTER_GPU_CDSP_PROC,
  ICBID_MASTER_QUP_0,
  ICBID_MASTER_UFS_MEM,
  ICBID_MASTER_VIDEO_PROC,
  ICBID_MASTER_LPASS_DMA,
...
typedef enum {
  ...
  ICBID_SLAVE_SNOC_BIMC_NRT,
  ICBID_SLAVE_SNOC_BIMC_RT,
  ICBID_SLAVE_QUP_0,
  ICBID_SLAVE_UFS_MEM_CFG,
  ICBID_SLAVE_VSENSE_CTRL_CFG,
  ICBID_SLAVE_QUP_CORE_0,
  ICBID_SLAVE_QUP_CORE_1,
  ICBID_SLAVE_GPU_CDSP_BIMC,
  ICBID_SLAVE_AHB2PHY_CSI,
  ICBID_SLAVE_AHB2PHY_USB,
  ICBID_SLAVE_AHB2PHY_VREF,
  ICBID_SLAVE_APSS_THROTTLE_CFG,
  ICBID_SLAVE_CAMERA_NRT_THROTTLE_CFG,
  ICBID_SLAVE_CDSP_THROTTLE_CFG,
  ICBID_SLAVE_DDR_PHY_CFG,
  ICBID_SLAVE_DDR_SS_CFG,
  ICBID_SLAVE_GPU_CFG,
  ICBID_SLAVE_GPU_THROTTLE_CFG,
  ICBID_SLAVE_MAPSS,
  ICBID_SLAVE_MDSP_MPU_CFG,
  ICBID_SLAVE_CAMERA_RT_THROTTLE_CFG,
