...
/*
 ...
 ============================================================================
 $Header: //components/rel/core.mpss/10.0/api/systemdrivers/ChipInfo.h#2 $
 ...
 *
 * @return DAL_ERROR if pInfo is NULL
 *         DAL_ERROR_NOT_SUPPORTED if this target doesn't support
 *         SKU information.
 *         DAL_SUCCESS otherwise
 */
DALResult ChipInfo_GetSKU(ChipInfoSKUType *pInfo);
