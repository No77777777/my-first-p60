...
$Header: //components/rel/core.mpss/10.0/api/systemdrivers/DDITlmm.h#1 $
...
#define DALGpioLockType uint32
#define DalTlmm_IsGpioLocked(val1, val2, val3) (0)
#define DalTlmm_LockGpio(val1, val2, val3) (0)
#define DalTlmm_UnlockGpio(val1, val2, val3) (0)
#endif
