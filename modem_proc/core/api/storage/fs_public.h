 ...
 *
 * Copyright (C) 2002-2013,2016,2018 QUALCOMM Technologies, Inc.
 *
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/storage/fs_public.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
/**
 * @par Name:
 *  efs_golden_copy_set_files_list - Sets the files-list to be used while
 *  making the EFS-golden-copy based on files list.
 *
 * @par Description:
 *  Sets the files-list to be used while making the EFS-golden-copy based on
 *  files list. This API is not supported on all Page-Managers and currently
 *  is supported only for Remote-Storage Page-Manager.
 *
 *  This API is intended to be called exactly once before efs_initialize is
 *  called.
 *
 * @param files_count
 *  Number of files in the supplied file-list.
 *
 * @param files_list
 *  List of all file paths that are permitted in the EFS-golden-copy.
 *
 * @return
 *  Returns 0 on success or -1 on error.
 *
 * @par Errors:
 *  Upon error, the efs_errno will be set to one of the following:\n
 *  ::EPERM   - When this feature is not supported.
 *  ::EINVAL  - When any input argument to this API is not correct.
 *
 **********************************************************************/
int efs_golden_copy_set_files_list (uint32 files_count,
