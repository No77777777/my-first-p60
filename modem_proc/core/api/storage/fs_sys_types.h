 ...
 * fs_sys_types.h
 *
 * Copyright (C) 2002-2010,2012,2016 QUALCOMM Technologies, Inc.
 *
 ...
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/storage/fs_sys_types.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
/** List of assigned group IDs used for enforcing quota limit */
enum efs_group_id
{
  EFS_GROUP_ID_RESERVED_1    = 0, /**< Reserved for internal EFS module use */
  EFS_GROUP_ID_GPS           = 1, /**< GPS module */
  EFS_GROUP_ID_RF            = 2, /**< RF module*/
  EFS_GROUP_ID_MCFG          = 3, /**< Modem Configuration module */
  EFS_GROUP_ID_SFS           = 4, /**< Secure File System */
  EFS_GROUP_ID_NV            = 5, /**< NV module */
  EFS_GROUP_ID_RESERVED_2    = 6, /**< Reserved */
  EFS_GROUP_ID_RESERVED_3    = 7, /**< Reserved */
  EFS_GROUP_ID_MAX           = 8
};
