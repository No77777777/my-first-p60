...
*     }
* 
*    Copyright (c) 2012, 2019, 2020 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$PVCSPath:$
$Header: //components/rel/core.mpss/10.0/api/securemsm/secboot/secboot_util.h#6 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/23/2020 dpk      Deleted unused function.
