...
/*===========================================================================
Copyright (c) {2003-2010, 2017, 2019, 2023} Qualcomm Technologies, Inc.
All Rights Reserved.
...
typedef enum {
    ...
    SECPKX_ECIES_PROFILE_TYPE,
      /**< PKX-specific parameter: ECIES profile Info.  */ 
    SECPKX_ECIES_PARAM_TYPE,
      /**< PKX-specific parameter: ECIES param Info.  */ 
     SECPKX_ECC_COMPRESSED_PUBLIC_KEY,
      /**< PKX-specific parameter: ECC Public Key.  */
    SECPKX_MAX_PARAM,                         
...
typedef struct secpkx_rsa_oaep_info_s
{
   ...
   secapi_pkx_rsa_oaep_mgf1_hash_algo_type mgf1_hash_algo;  /** Hash algo used in oaep padding */
...
typedef enum 
{
    SECPKX_ECIES_PROFILE_X25519   = 0,
    SECPKX_ECIES_PROFILE_P256     = 1,
    SECPKX_ECIES_PROFILE_MAX ,
} secpkx_ecies_profile_type;

typedef enum {
    SECPKX_ECIES_AES_128 = 0,
    SECPKX_ECIES_CIPHER_MAX,
} secpkx_ecies_cipher_t;

/**
 * Supported EC curves, used in ECDSA/ECIES.
 */
typedef enum {
    SECPKX_ECIES_CURVE_X25519 = 0,
    SECPKX_ECIES_CURVE_P256 = 1,
    SECPKX_ECIES_CURVE_MAX,
} secpkx_ecies_curve_t;


typedef enum {
    SECPKX_ECIES_DIGEST_SHA_2_256 = 0,
    SECPKX_ECIES_DIGEST_MAX,
} secpkx_ecies_digest_t;
/*
 * Key derivation functions, mostly used in ECIES.
 */
typedef enum {
    /* HKDF defined in RFC 5869 with SHA256 */
    SECPKX_ECIES_KDF_X69 = 0,
    SECPKX_ECIES_KDF_MAX,
} secpkx_ecies_kdf_t;

typedef struct secpkx_ecies_params {
    secpkx_ecies_curve_t     ecies_curve;    /* ECC curve */
    secpkx_ecies_kdf_t       kdf;            /* kdf */
    secpkx_ecies_digest_t    digest;         /* digest hash function */
    secpkx_ecies_cipher_t    cipher;         /* symetric algorithm (AES) scheme */
} secpkx_ecies_params_type;
...
typedef union {
    ...
    secpkx_ecies_profile_type      profile;
      /** ecies profile type as per 3GPP spec */
    secpkx_ecies_params_type       ecies_param;
     /** ecies parameter for cipher mac and kdf*/
