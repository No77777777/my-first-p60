...
===========================================================================*/
/*===========================================================================
  Copyright (c) 2003 - 2021 Qualcomm Technologies Incorporated.
  All rights reserved.
...
/*==========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/securemsm/x509/secasn1.h#4 $
  $DateTime: 2022/10/07 04:54:19 $
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/27/20   my      FR 61548 Added support to get RID from subject alt name
10/11/21   ak      Avoid invalid mem access while parsing ASN.1 data.
...
#define SECASN1_ENUMERATED_TYPE       (0x0A) /**< ASN.1 tag emumerated type. */
...
#define RID_MAX                        100
#define SECASN1_GEN_TIME_TYPE         (0x18) /**< ASN.1 tag General time type. */
#define SECASN1_SEQ_TYPE              (0x30) /**< ASN.1 tag sequence  */
...
typedef struct
{
  uint8 data[RID_MAX]; /**< ASN.1 data. */
  uint16 len;  /**< ASN.1 data length. */
} secasn1_data_arr_type;
