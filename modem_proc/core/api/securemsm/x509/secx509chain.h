...
/*=============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/securemsm/x509/secx509chain.h#2 $ 
  $DateTime: 2024/07/09 05:32:44 $ $Author: pwbldsvc $
...
/**
  Maximum chain depth.
*/
#define SECX509CHAIN_MAX_CHAIN_LEN    5
