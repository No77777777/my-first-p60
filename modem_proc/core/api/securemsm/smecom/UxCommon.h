...
$Header: //components/rel/core.mpss/10.0/api/securemsm/smecom/UxCommon.h#2 $
$DateTime: 2020/05/12 02:21:12 $
$Author: pwbldsvc $  
...
UxMallocDebug ((size), (memType), __FILENAME__, __LINE__)

/**
   Debug version of UxRealloc. Outputs the file name and line number.
*/
#define UxRealloc(ptr, size) \
UxReallocDebug ((ptr), (size), __FILENAME__, __LINE__)
