...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/api/debugtools/rcevt.h#1 $
...
*/
DLL_API_WARN_UNUSED_RESULT
DLL_API_GLOBAL RCEVT_HANDLE rcevt_register_sigex_name(RCEVT_NAME const name, RCEVT_SIGEX_TYPE const type, RCEVT_SIGEX const signal);
