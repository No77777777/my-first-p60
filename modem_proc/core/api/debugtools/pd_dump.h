...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/api/debugtools/pd_dump.h#1 $
...
/* PD Dumps TCB Data Dump method */
typedef enum{
  PDDUMP_TCB_DATA_UNMAPPED_REGION = 0,
  PDDUMP_TCB_DATA_NOTE_SECTION = 1,
  PDDUMP_TCB_DATA_UNMAPPED_REGION_NOTE_SECTION = 2,
  PDDUMP_TCB_DATA_MAX = 0xFFFFFFFF,
}pd_dump_tcb_data_dump_method_t;
