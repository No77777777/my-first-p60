...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/api/debugtools/rcevt_rex.h#1 $
...
CORE_WARN_DEPRECATED_MSG("Deprecated REX API","Migrate to new QuRT API rcevt_register_handle_qurt")
...
*/
DLL_API_WARN_UNUSED_RESULT
CORE_WARN_DEPRECATED_MSG("Deprecated REX API","Migrate to new QuRT API rcevt_register_name_qurt")
...
*/
DLL_API_WARN_UNUSED_RESULT
CORE_WARN_DEPRECATED_MSG("Deprecated REX API","Migrate to new QuRT API rcevt_unregister_handle_qurt")
...
*/
DLL_API_WARN_UNUSED_RESULT
CORE_WARN_DEPRECATED_MSG("Deprecated REX API","Migrate to new QuRT API rcevt_unregister_name_qurt")
