...
===============================================================================*/
/*=============================================================================
Copyright (c) 2015,16,18 Qualcomm Technologies, Inc.
All Rights Reserved.
Confidential and Proprietary - Qualcomm Technologies, Inc.
===============================================================================*/
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/api/debugtools/dll_api.h#1 $
...
/**
Compiler to Warn on Deprecated API Use with messages

DLL_API_WARN_DEPRECATED_MSG(x,y) [...]
int function_signature(void*, void*, int);

*/
#define DLL_API_WARN_DEPRECATED_MSG_ATTR(x,y)    __attribute__((deprecated(x,y)))
#if !defined(DLL_API_EXCLUDE_WARN_DEPRECATED)
  #if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__)
    DLL_API_GCC_HELPER_PRAGMA_IW(-Wdeprecated-declarations)
    #define DLL_API_WARN_DEPRECATED_MSG(x,y)     DLL_API_WARN_DEPRECATED_MSG_ATTR(x,y)
  #elif defined(__ARMCC_VERSION)
    #pragma diag_warning 1361
    #define DLL_API_WARN_DEPRECATED_MSG(x,y)     DLL_API_WARN_DEPRECATED_MSG_ATTR(x,y)
  #else
    #define DLL_API_WARN_DEPRECATED_MSG          /*NULL*/
  #endif
#else
  #define DLL_API_WARN_DEPRECATED_MSG            /*NULL*/
#endif
...
/**
Compiler to Instruct NonNull Return
...
*/
  ...
  #if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION)
...
/**
Compiler to Instruct Alignment

int foo DLL_API_ALIGNED(x) ... = 0;

*/
#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION)
  #define DLL_API_ALIGNED(x)                     __attribute__((aligned(x)))
#else
  #define DLL_API_ALIGNED(x)                     /*NULL*/
#endif

/**
Compiler to Instruct Section type

int foo DLL_API_SECTION(x) ... = 0;
*/

#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION)
  #define DLL_API_SECTION(x)                      __attribute__((section(x)))
#else
  #define DLL_API_SECTION(x)                      /*NULL*/
#endif

/**
Compiler to Instruct Used
...
/**
Compiler to Instruct Unused

DLL_API_UNUSED [...]
void function_signature(void*, void*, int);

*/
#if !defined(DLL_API_EXCLUDE_UNUSED)
  #if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION)
    #define DLL_API_UNUSED                         __attribute__((unused))
  #else
    #define DLL_API_UNUSED                         /*NULL*/
  #endif
#else
  #define DLL_API_UNUSED                           /*NULL*/
#endif
...
/**
Compiler to Instruct ARM and HARD FLOAT
...
/**
Compiler to Instruct HEXAGON and MSGABI
...
*/
  ...
  #if defined(__HEXMSGABI_SUPPORTED__) || defined(__HEXMSGABI_2_SUPPORTED__)
    #if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__)
...
/**
Compiler to Instruct a weak linking for symbol

[...]
DLL_API_WEAK void function_signature(void*, void*, int)
{
   ...
}

DLL_API_WEAK int foo;

*/
#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION)
  #define DLL_API_WEAK                           __attribute__((weak))
#else /* if defined(_WIN32) */
  #define DLL_API_WEAK                          /*NULL*/
#endif
...
*/
#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION) || defined(__CYGWIN__)
...
/**
Compiler to Instruct a Packed Struct

DLL_API_STRUCT_PACKED [...]
*/
#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__) || defined(__ARMCC_VERSION)
  #define DLL_API_STRUCT_PACKED                  __attribute__((packed))
#else 
  #define DLL_API_STRUCT_PACKED                  /*NULL*/
#endif

/**
Compiler to Instruct a Printf format for x & y arguments

DLL_API_FORMAT_PRINTF(3,4)
void function_signature(void*, void*, char* , ...)
*/
#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__)
  #define DLL_API_FORMAT_PRINTF(x,y)             __attribute__((format(printf, x, y)))
#else 
  #define DLL_API_FORMAT_PRINTF(x,y)             /*NULL*/
#endif

/**
Compiler to Instruct variable to be found in BSS section

DLL_API_BSS_SECTION
extern int foo;
*/
#if (defined(__GNUC__) && __GNUC__ >= 4) || defined(__clang__)
  #define DLL_API_BSS_SECTION                    __attribute__((section(".bss")))
#else 
  #define DLL_API_BSS_SECTION                    /*NULL*/
#endif
...
#define DLL_API_CTOR_ATTRIB_WEIGHT(x)            __attribute__((constructor(x)))
#define DLL_API_DTOR_ATTRIB_WEIGHT(x)            __attribute__((destructor(x)))
