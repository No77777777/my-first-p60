 ...
 * =====================================================================  */
//TODO: CORE_WARN_DEPRECATED_MSG("Deprecated API","Migrate to new API")
 ...
 *     sr_mon_handle : Handle to an existing service state which is mapped by domain + service 
 *                     or just domain name
 *     transaction_id : Pointer to an int32_t which will be populated with the Tx ID
 *
 * Returns:
 *     Refer to the enum SERVREG_RESULT for list of possible results
 * =====================================================================  */
//TODO: Implement
//SERVREG_RESULT servreg_get_transaction_id(SERVREG_MON_HANDLE sr_mon_handle, int32_t* transaction_id);
