 ...
 * =====================================================================  */
SERVREG_NAME static inline servreg_get_local_domain(void)
{
   return (SERVREG_NAME)servreg_get_local_info(LOCAL_PROCESS);
}
 ...
 *     "soc" string
 * =====================================================================  */
SERVREG_NAME static inline servreg_get_local_soc_scope(void)
{
   return (SERVREG_NAME)servreg_get_local_info(LOCAL_SOC);
}
 ...
 *     "domain" string
 * =====================================================================  */
SERVREG_NAME static inline servreg_get_local_domain_scope(void)
{
   return (SERVREG_NAME)servreg_get_local_info(LOCAL_DOMAIN);
}
/** =====================================================================
 * Function:
 ...
 *     "subdomain" string
 * =====================================================================  */
SERVREG_NAME static inline servreg_get_local_subdomain_scope(void)
{
   return (SERVREG_NAME)servreg_get_local_info(LOCAL_SUBDOMAIN);
}
