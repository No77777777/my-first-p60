...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/api/debugtools/rcinit.h#1 $
...
void rcinit_func_ctor_##x##(void) DLL_API_CTOR_ATTRIB_WEIGHT(RCINIT_WEIGHT_ORDER); \
...
void rcinit_task_ctor_##x##(void) DLL_API_CTOR_ATTRIB_WEIGHT(RCINIT_WEIGHT_ORDER); \
...
INTERNAL, CLIENT USE NOT SUPPORTED, MUTABLE DEFINITIONS
*/
#define RCINIT_WEIGHT_ORDER         128                                                /**< Constructor/Destructor Ordering Hint for Linker */
...
typedef struct rcinit_autogen_internal_s
{
  rcinit_internal_name_map_t*    name_map;
  int                            name_map_size;
  rcinit_internal_policy_map_t*  policy_map;
  int                            policy_map_size;
  RCINIT_NAME*                   policy_list;
  rcinit_info_t****              group_map;
} rcinit_autogen_internal_t;
