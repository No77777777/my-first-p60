 ...
 * =====================================================================  */
CORE_WARN_DEPRECATED_MSG("Deprecated REX API","Migrate to new API servreg_register_listener_qurt")
 ...
 * =====================================================================  */
CORE_WARN_DEPRECATED_MSG("Deprecated REX API","Migrate to new API servreg_deregister_listener_qurt")
