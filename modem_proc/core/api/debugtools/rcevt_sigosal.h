...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/api/debugtools/rcevt_sigosal.h#1 $
...
typedef RCEVT_SIGEX_SIGREX RCEVT_SIGEX_SIGOSAL CORE_WARN_DEPRECATED; /**< OBSOLETE; CLIENTS USE RCEVT_REX.H */
