...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/memory/dsm_pool.h#2 $
...
typedef void(*pool_trigger_free_cb_type)(dsm_mempool_id_type);
...
typedef enum
{
  ...
  DSM_MEM_LEVEL_LTE_ML1_CPU_DNE   = 33,   
  DSM_MEM_LEVEL_LTE_ML1_CPU_FEW  = 34,
  DSM_MEM_LEVEL_LTE_ML1_CPU_MANY = 35,
  DSM_MEM_LEVEL_POOL_EMPTY = 36,
  DSM_MEM_LEVEL_POOL_NON_EMPTY =37,
  DSM_MEM_LEVEL_MAX 
...
typedef struct dsm_pool_mgmt_table_s
{
  ...
  dsm_item_type *aug_top_free_item; /* Pointer to the free item list for
                                                              augment pool       */
...
#endif /* FEATURE_DSM_LOCKLESS */
  void *dynamic_pool;           /* Pool allocation is dynamic */
...
SIDE EFFECTS
  None
===========================================================================*/
#define dsm_init_pool_dynamic(pool_id,item_size,item_count,pool_trigger_free_cb)          \
dsmi_init_pool_dynamic(pool_id,item_size,item_count,pool_trigger_free_cb,dsm_file,__LINE__)
...
===========================================================================*/
extern boolean dsm_dynamic_pool_alloc_memory
(
  dsm_mempool_id_type pool_id
);
...
The pool is locked when the above mentioned API's are called
===========================================================================*/
extern boolean dsm_dynamic_pool_free_memory
(
	dsm_mempool_id_type pool_id
);
