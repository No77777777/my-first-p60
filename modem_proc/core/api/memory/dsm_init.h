...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/memory/dsm_init.h#1 $
...
/*---------------------------------------------------------------------------
  Size, Count for SUPER LARGE items 
---------------------------------------------------------------------------*/

#define DSM_DS_SL_ITEM_SIZ                                                    \
    (DSM_POOL_ITEM_SIZE(DSM_DS_SL_ITEM_POOL)) 
#define DSM_DS_SL_ITEM_CNT                                                    \
    (DSM_POOL_ITEM_CNT(DSM_DS_SL_ITEM_POOL))
...
/*---------------------------------------------------------------------------
  ...
  Legacy MACROs - Chcks only SMALL and LARGE item pools
---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
  ...
  Legacy MACROs - Checks only SMALL and LARGE item pools
---------------------------------------------------------------------------*/
