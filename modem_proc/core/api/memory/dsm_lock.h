...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/memory/dsm_lock.h#1 $
...
===========================================================================*/
#ifdef FEATURE_DSM_QUBE
  typedef qurt_mutex_t dsm_lock_type;
#else
  typedef dword dsm_lock_type;
#endif


#define DSM_LOCK(lock) dsm_lock((dsm_lock_type*)(lock))
#define DSM_UNLOCK(lock) dsm_unlock((dsm_lock_type*)(lock))
#define DSM_LOCK_CREATE(lock) dsm_lock_create((dsm_lock_type*)(lock))
#define DSM_LOCK_DESTROY(lock) dsm_lock_destroy((dsm_lock_type*)(lock))
