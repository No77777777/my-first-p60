...
============================================================================*/
/* $Header: //components/rel/core.mpss/10.0/api/hwengines/DDIAdc.h#1 $ */
...
struct DalAdc
{
   ...
   DALResult (*RequestConversion)(uint32 ClientHandle, DalDeviceHandle *_h, const AdcRequestParametersType *pAdcParams, AdcRequestStatusType *pAdcRequestStatus);
   DALResult (*RequestRecalibration)(uint32 ClientHandle, DalDeviceHandle *_h, const AdcRequestParametersType *pAdcParams);
   DALResult (*GetAdcInputProperties)(uint32 ClientHandle, DalDeviceHandle *_h, const char *pInputName, uint32 nInputNameLen, AdcInputPropertiesType *pAdcInputProps);
   DALResult (*TMGetInputProperties)(uint32 ClientHandle, DalDeviceHandle *_h, const char *pInputName, uint32 nInputNameLen, AdcTMInputPropertiesType *pAdcTMInputProps);
   DALResult (*TMGetRange)(uint32 ClientHandle, DalDeviceHandle *_h, const AdcTMInputPropertiesType *pAdcTMInputProps, AdcTMRangeType *pAdcTMRange);
   DALResult (*TMSetThreshold)(uint32 ClientHandle, DalDeviceHandle *_h, const AdcTMRequestParametersType *pAdcTMParams, AdcTMThresholdType eThreshold, const int32 *pnThresholdDesired, int32 *pnThresholdSet);
   DALResult (*TMSetEnableThresholds)(uint32 ClientHandle, DalDeviceHandle *_h, DALBOOL bEnable);
   DALResult (*Read)(uint32 ClientHandle, DalDeviceHandle *_h, const AdcInputPropertiesType *pAdcInputProps, AdcResultType *pAdcResult);
   DALResult (*TMSetTolerance)(uint32 ClientHandle, DalDeviceHandle *_h, const AdcTMRequestParametersType *pAdcTMParams, int32 nPhysicalCurrent, const int32 *pnLowerTolerance, const int32 *pnHigherTolerance);
};
...
{
   return ((DalAdcHandle *)_h)->pVtbl->GetAdcInputProperties(DALDEVICE_LOCAL_CLIENTID, _h, pInputName, nInputNameSize, pAdcInputProps);
}
...
{
   return ((DalAdcHandle *)_h)->pVtbl->Read(DALDEVICE_LOCAL_CLIENTID, _h, pAdcInputProps, pAdcResult);
}
