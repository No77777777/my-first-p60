...
============================================================================*/
/* $Header: //components/rel/core.mpss/10.0/api/hwengines/AdcInputs.h#1 $ */
...
/** PMIC_TEMP2 (Secondary PMIC temp) - nPhysical units are in 0.001 degrees C*/
#define ADC_INPUT_PMIC_TEMP2       "PMIC_THERM2"
