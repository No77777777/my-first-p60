...
$Header: //components/rel/core.mpss/10.0/api/buses/spi/ddispi.h#1 $$DateTime: 2020/02/14 03:31:44 $$Author: pwbldsvc $
...
{
   DalDevice DalDevice;
   DALResult (*GetInputBlockSize)(uint32 ClientHandle, DalDeviceHandle * _h, void * inputBlockSize, uint32 olen1);
   DALResult (*GetOutputBlockSize)(uint32 ClientHandle, DalDeviceHandle * _h, void * outputBlockSize, uint32 olen1);
   DALResult (*ConfigureDevice)(uint32 ClientHandle, DalDeviceHandle * _h,  const SpiDeviceInfoType *  deviceInfo);
   DALResult (*GetDeviceConfiguration)(uint32 ClientHandle, DalDeviceHandle * _h, void * deviceInfo, uint32 olen1);
   DALResult (*StartTransfer)(uint32 ClientHandle, DalDeviceHandle * _h,  SpiTransferType *  transfer, SpiDataAddrType * outputAddr,  int  outputDataLen, SpiDataAddrType * inputAddr,  int  inputDataLen, int * inputDataLenReq, uint32 olen6, void * transferId, uint32 olen7);
   DALResult (*GetTransferStatus)(uint32 ClientHandle, DalDeviceHandle * _h,  uint32  transferId);
   DALResult (*Send)(uint32 ClientHandle, DalDeviceHandle * _h, SpiDataAddrType * outputAddr,  int  outputDataLen);
   DALResult (*Receive)(uint32 ClientHandle, DalDeviceHandle * _h,  uint32  u32NumInputTransfers, SpiDataAddrType * inputAddr,  int  inputDataLen, int* inputDataLenReq, uint32 olen4);
   DALResult (*SendAndReceive)(uint32 ClientHandle, DalDeviceHandle * _h, SpiDataAddrType * outputAddr,  int  outputDataLen,  uint32  u32NumInputTransfers, SpiDataAddrType * inputAddr,  int  inputDataLen, int * inputDataLenReq, uint32 olen6);
   DALResult (*Reset)(uint32 ClientHandle, DalDeviceHandle * _h);
};
...
{
   return ((DalSpiHandle *)_h)->pVtbl->GetInputBlockSize(DALDEVICE_LOCAL_CLIENTID, _h, (void * )inputBlockSize,sizeof( uint32  ));
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->GetOutputBlockSize(DALDEVICE_LOCAL_CLIENTID, _h, (void * )outputBlockSize,sizeof( uint32  ));
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->ConfigureDevice(DALDEVICE_LOCAL_CLIENTID, _h, deviceInfo);
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->GetDeviceConfiguration(DALDEVICE_LOCAL_CLIENTID, _h, (void * )deviceInfo,sizeof( SpiDeviceInfoType  ));
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->StartTransfer(DALDEVICE_LOCAL_CLIENTID, _h, transfer, outputAddr, outputDataLen, inputAddr, inputDataLen, inputDataLenReq,sizeof( int ), (void * )transferId,sizeof( uint32 ));
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->GetTransferStatus(DALDEVICE_LOCAL_CLIENTID, _h, transferId);
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->Send(DALDEVICE_LOCAL_CLIENTID, _h, outputAddr, outputDataLen);
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->Receive(DALDEVICE_LOCAL_CLIENTID, _h, u32NumInputTransfers, inputAddr, inputDataLen, inputDataLenReq,sizeof( int ));
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->SendAndReceive(DALDEVICE_LOCAL_CLIENTID, _h, outputAddr, outputDataLen, u32NumInputTransfers, inputAddr, inputDataLen, inputDataLenReq,sizeof( int ));
}
/** 
@} 
*/
...
{
   return ((DalSpiHandle *)_h)->pVtbl->Reset(DALDEVICE_LOCAL_CLIENTID, _h);
}
/** 
@} 
*/
