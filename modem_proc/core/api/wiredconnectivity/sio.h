...
/*
Copyright (c) 1990-1993, 1997-2012 Qualcomm Technologies Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/wiredconnectivity/sio.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
12/05/13   vv      Added additional types to sio_status_type
...
typedef enum
{
  ...
  SIO_BITRATE_2500000,              /**<-- 2500000 bit-rate  */
...
#define SIO_MAJOR_IPA           26      /**< SIO Major for IPA driver */
#define SIO_NULL_DRIVER         27      /**< SIO Major for NULL driver */
