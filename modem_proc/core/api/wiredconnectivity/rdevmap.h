...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/api/wiredconnectivity/rdevmap.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  RDM_DATA_MUX_SRVC,
  RDM_DATA_MUX_LOGICAL_1_SRVC,
  RDM_DATA_MUX_LOGICAL_2_SRVC,
  RDM_DATA_MUX_LOGICAL_3_SRVC,
  RDM_DATA_MUX_LOGICAL_4_SRVC,
  RDM_DATA_MUX_LOGICAL_5_SRVC,
  RDM_DATA_MUX_LOGICAL_6_SRVC,
  RDM_DATA_MUX_LOGICAL_7_SRVC,
  RDM_DATA_MUX_LOGICAL_8_SRVC,
  RDM_LAST_KNOWN_SRVC = RDM_DATA_MUX_LOGICAL_8_SRVC,
  RDM_BREW_SRVC,
