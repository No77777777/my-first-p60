 ...
 * $Header: //components/rel/core.mpss/10.0/api/power/cpr.h#1 $
 * $Change: 18983508 $
 */
#ifndef CPR_H
#define CPR_H
...
/**
 * @brief API to reset cprf and cprc communication.
 */
void cpr_reset_controller(void);

/**
 * @brief API to get cprf values4 OL count.
 */
uint32 cpr_get_hw_ol_count(uint32 mode);
