...
$Header: //components/rel/core.mpss/10.0/api/power/mmpm.h#1 $
...
/** @endcond */
    ...
    MMPM_CORE_ID_LPASS_LPM      = 102,   /**< Low-power memory in the LPASS. */
    MMPM_CORE_ID_LPASS_DML      = 103,   /**< Data Mover Lite hardware in the
                                              LPASS. */
    MMPM_CORE_ID_LPASS_AIF      = 104,   /**< Audio interface hardware in the 
                                              LPASS. */
    MMPM_CORE_ID_LPASS_SLIMBUS  =105,   /**< SLIMbus@regns hardware in the 
                                              LPASS. */
    MMPM_CORE_ID_LPASS_MIDI     = 106,   /**< MIDI hardware in the LPASS. */
    MMPM_CORE_ID_LPASS_AVSYNC   = 107,   /**< Audio-video timer/ProntoSync
                                              hardware in the LPASS. */
    MMPM_CORE_ID_LPASS_HWRSMP   = 108,   /**< Hardware Resampler hardware in 
                                              the LPASS. */
    MMPM_CORE_ID_LPASS_SRAM     = 109,   /**< Sensors RAM used by the LPASS. */
    MMPM_CORE_ID_LPASS_DCODEC   = 110,   /**< Digital codec in the LPASS. */
    MMPM_CORE_ID_LPASS_SPDIF    = 111,   /** < SPDIF in the LPASS */
...
/*======================================================================
   FUNCTION: MMPM_Deinit
======================================================================*/
/** @ingroup mmpm_func_Deinit
  DeInitializes all MMPM components and Deregisters all MMPM nodes. 
  currently only implemented in MPD for MPD reset

  This function is to be called at system close time or MPD reset time. It is typically 
  called by the MPD during system close or reset time.

  @dependencies
  %MMPM_Deinit() has multiple dependencies. Among them are clock driver, NPA, 
