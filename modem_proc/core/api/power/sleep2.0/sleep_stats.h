...
================================================================================
$Header: //components/rel/core.mpss/10.0/api/power/sleep2.0/sleep_stats.h#1 $
 ...
 *  
 * @param stats: Pointer to a data structure that will be populated with the statistics.
