...
================================================================================
$Header: //components/rel/core.mpss/10.0/api/power/sleep2.0/sleep_npa.h#1 $
 ...
 * TCM LPR
 *------------*/
/* Name of the TCM LPR node */
#define SLEEP_TCM_LPR_NODE_NAME             "/core/cpu/tcm"

/* Valid LPRM state requests */
#define SLEEP_TCM_LPR_NONRET_ONLY           0 /* Allow only TCM non-retention modes */
#define SLEEP_TCM_LPR_RETENTION_ONLY        1 /* Allow only TCM retention modes */

/* Maximum valid state */
#define SLEEP_TCM_LPR_MAX_STATE             SLEEP_TCM_LPR_RETENTION_ONLY
