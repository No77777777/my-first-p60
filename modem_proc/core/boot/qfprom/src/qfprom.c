...
$Header: //components/rel/core.mpss/10.0/boot/qfprom/src/qfprom.c#1 $

when           who        what, where, why
--------     --------     ----------------------------------------------------
06/27/17     aus          Fixed memscpy parameters
10/15/15     jz           Ported updates to support different fusemaps at runtime
    ...
    do
    {
        ...
        */
        ...
        /*If read is allowed for the region, then perform the verification. Some regions
          ...
          certain debug fuses. */
        qfprom_verify_write(region_type, raw_data_to_write, read_row_data);
