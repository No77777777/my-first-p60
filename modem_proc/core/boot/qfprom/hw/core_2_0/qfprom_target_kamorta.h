...
/* Blow timer clock frequency in Mhz for 14nm LPe technology */
...
/*
* Configure QFPROM_ACCEL[QFPROM_GATELAST] SW field to a default value of 0x1 for 14LPE SOC technology.
* Configure QFPROM_ACCEL[QFPROM_TRIPPT_SEL] SW field to a value of 0x4 (100) to blow at a high resistance setting
...
** in the memory map.
*/
#define QFPROM_RAW_LOWEST_ADDRESS_OFFSET           (0x00000170 )
#define QFPROM_RAW_HIGHEST_ADDRESS_OFFSET          (0x000006DC )
