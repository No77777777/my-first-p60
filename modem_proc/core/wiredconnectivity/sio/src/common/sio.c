...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/wiredconnectivity/sio/src/common/sio.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
{
#ifdef SIO_SMD_EXIST   // API supported only if SMD is supported. Not on GLINK
