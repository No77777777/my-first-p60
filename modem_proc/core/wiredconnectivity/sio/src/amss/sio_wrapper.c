...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/wiredconnectivity/sio/src/amss/sio_wrapper.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
===========================================================================*/
#if defined(FEATURE_SMD_PORT_MGR)
...
#endif /* if defined(FEATURE_SMD_PORT_MGR) */
