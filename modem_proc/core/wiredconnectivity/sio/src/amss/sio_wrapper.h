...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/wiredconnectivity/sio/src/amss/sio_wrapper.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
#if defined(FEATURE_DATA_MM) || defined(FEATURE_GSM_PLT) || defined (FEATURE_CORE_SERVICE_ONLY) || defined(FEATURE_LTE_PLT)
