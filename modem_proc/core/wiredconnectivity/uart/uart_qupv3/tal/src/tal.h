...
$Header: //components/rel/core.mpss/10.0/wiredconnectivity/uart/uart_qupv3/tal/src/tal.h#1 $
...
typedef struct
{
   void *handle;     // opaque handle that may be needed when deallocating/unmapping
