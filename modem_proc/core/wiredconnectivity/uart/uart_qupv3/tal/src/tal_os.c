...
$Header: //components/rel/core.mpss/10.0/wiredconnectivity/uart/uart_qupv3/tal/src/tal_os.c#1 $
...
static DALDEVICEID device_array[] = { DALDEVICEID_UART_DEVICE_0,
                                      DALDEVICEID_UART_DEVICE_1,
                                      DALDEVICEID_UART_DEVICE_2,
                                      DALDEVICEID_UART_DEVICE_3,
                                      DALDEVICEID_UART_DEVICE_4,
                                      DALDEVICEID_UART_DEVICE_5,
                                      DALDEVICEID_UART_DEVICE_6,
                                      DALDEVICEID_UART_DEVICE_7,
                                      DALDEVICEID_UART_DEVICE_8,
                                      DALDEVICEID_UART_DEVICE_9,
                                      DALDEVICEID_UART_DEVICE_10,
                                      DALDEVICEID_UART_DEVICE_11,
                                      DALDEVICEID_UART_DEVICE_12,
                                      DALDEVICEID_UART_DEVICE_13,
                                      DALDEVICEID_UART_DEVICE_14,
                                      DALDEVICEID_UART_DEVICE_15,
                                      DALDEVICEID_UARTCXM,
                                    };
