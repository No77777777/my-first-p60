...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/wiredconnectivity/uart/uart_qupv3/mdd/src/siors232_mdd.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
uart_dal_logger( DALDEVICEID dalDeviceId, uint32 level, const char* msg )
{
  ...
  switch( dalDeviceId )
  {
    case DALDEVICEID_UART_DEVICE_0:
    case DALDEVICEID_UART_DEVICE_1:
    case DALDEVICEID_UART_DEVICE_2:
    case DALDEVICEID_UART_DEVICE_3:
    case DALDEVICEID_UART_DEVICE_4:
    case DALDEVICEID_UART_DEVICE_5:
    case DALDEVICEID_UART_DEVICE_6:
    case DALDEVICEID_UART_DEVICE_7:
    case DALDEVICEID_UART_DEVICE_8:
    case DALDEVICEID_UART_DEVICE_9:
    case DALDEVICEID_UART_DEVICE_10:
    case DALDEVICEID_UART_DEVICE_11:
    case DALDEVICEID_UART_DEVICE_12:
    case DALDEVICEID_UART_DEVICE_13:
    case DALDEVICEID_UART_DEVICE_14:
    case DALDEVICEID_UART_DEVICE_15:
...
initialize_workloop( uart_device_id_type device_id )
{
  ...
  dal_result = DALSYS_RegisterWorkLoopEx( "uart_mdd_workloop",
                                          0x1000,
                                          UART_WORKLOOP_PRIORITY,
...
initialize_device( uart_device_id_type device_id )
{
  ...
  if (device_info.dal_device_id == DALDEVICEID_UARTCXM)
  {
     initConfig.uart_type          = UART_BAM;
  }
  else
  {
     initConfig.uart_type          = UART_QUPV3;
  }
...
siors_mdd_api_dev_init( void )
{
  ...
  if ( DALSYS_GetPropertyValue( handle, "UART_DAL_LOG_LEVEL", 0, &prop ) != DAL_SUCCESS )
  {
     uart_dal_log_level = DALSYS_LOGEVENT_INFO;
  }
  else
  {
     uart_dal_log_level = prop.Val.dwVal;
  }
