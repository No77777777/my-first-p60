...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/wiredconnectivity/uart/uart_qupv3/mdd/src/siors232_mdd_ioctl.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
                     ...
                     sio_ioctl_param_type* param )
{
  ...
  switch( cmd )
  {
    ...
    case SIO_IOCTL_CXM_TX_DIRECT_CHAR:
      UART_LOG_2( TRACE, "[%d] CXM Direct TX. Char : 0x%x", device_id, param->cxm_tx_direct_char.character );
