...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/wiredconnectivity/rdevmap/src/rdevmap.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
/*------------------------------------------------------------------*/
      ...
      dev_index < RDM_DEV_MAX; dev_index++)
  {
    ...
    if(srv != RDM_NULL_SRVC)
    {
	  ...
	  {
		  ERR("incorrect srv index : %d for device type: %d", srv, dev_index, 0);
		  continue;
	  }
...
/*------------------------------------------------------------------*/
  ...
  if (rex_is_in_irq_mode())
  {
    ERR("rdm_lock_state called in ISR",0,0,0);
    return rdm_locked;
  }
...
static void rdm_enum_to_string(void)
{
  ...
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_1_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_2_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_3_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_4_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_5_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_6_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_7_SRVC);
  RDM_SVC_NAME(RDM_DATA_MUX_LOGICAL_8_SRVC);
