...
$Header: //components/rel/core.mpss/10.0/pmic/pm/comm/src/pm_comm.h#1 $ 
...
pm_err_flag_type  
pm_comm_register_isr ( uint32 slave_id, 
                       uint16 addr, 
                       uint8 irq_mask, 
                       void* isr_ptr, 
                       uint32 isr_ctx);
...
pm_err_flag_type  
pm_comm_write_byte_array_dbg( uint32 slave_id ,
                              uint16 addr , 
                              uint32 numBytes , 
                              uint8* data, 
                              uint8 priority );
...
pm_err_flag_type  
pm_comm_read_byte_array_dbg( uint32 slave_id,
                              uint16 addr, 
                              uint32 numBytes, 
                              uint8* data, 
                              uint8 priority );
