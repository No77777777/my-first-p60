...
$Header: //components/rel/core.mpss/10.0/pmic/pm/application/uicc/src/pm_uicc_app.c#1 $
...
void pm_uicc_app_init()
{
	...
	/* UICC Specific Info - Obtaining Data through dal config */
        pm_uicc_data.uicc_specific = (pm_uicc_specific_info_type*)target_ptr->uicc_specific;
