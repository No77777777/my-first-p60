#ifndef __PM_RTC_APPLICATION_H__
#define __PM_RTC_APPLICATION_H__
...
$Header: //components/rel/core.mpss/10.0/pmic/pm/application/rtc/common/src/pm_rtc_application.h#1 $
...
#endif //__PM_RTC_APPLICATION_H__
