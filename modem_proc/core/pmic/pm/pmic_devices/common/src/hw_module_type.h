...
$Header: //components/rel/core.mpss/10.0/pmic/pm/pmic_devices/common/src/hw_module_type.h#3 $
$Author: pwbldsvc $
...
typedef enum
{
    ...
    PM_HW_MODULE_LDO_510_N1200_160_FT   = 104,
    PM_HW_MODULE_LDO_510_N1800_160_FT   = 105,
    ...
    PM_HW_MODULE_LDO_520_NCP900_500  = 155,   
...
typedef enum
{
    ...
    PM_HW_MODULE_VADC_HM9_BTM_2=0x68,
...
typedef enum
{
    ...
    PM_HW_MODULE_FTS__FTS512_CTL = 15,
...
typedef enum
{
    ...
    PM_HW_MODULE_BUCK_CMN_IDSS_CLK = 27,
...
typedef enum
{
    PM_HW_MODULE_SDAM1 = 1,
    PM_HW_MODULE_SDAM_CORE = 2,
    PM_HW_MODULE_SDAM_INVALID
}pm_hw_module_sdam_subtype;
