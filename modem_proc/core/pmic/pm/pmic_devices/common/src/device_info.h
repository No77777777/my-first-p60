...
$Header: //components/rel/core.mpss/10.0/pmic/pm/pmic_devices/common/src/device_info.h#2 $
$Author: pwbldsvc $
...
/** 
 *  To Make the PMIC uninitialize if there is no use case for it in modem SW.  
 *  
 * @param[in] pmic_index 	Index of the PMIC which we want to Uninitialize
 *
 *  @return Success if PMIC index is with in the MAX PMIC limit
 *  
 */
