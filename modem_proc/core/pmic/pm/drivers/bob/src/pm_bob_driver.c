...
$Header: //components/rel/core.mpss/10.0/pmic/pm/drivers/bob/src/pm_bob_driver.c#1 $
...
{
   0xA000, 0x100, 0x008, 0x00B, 0x068, 0x00, 0x040, 0x041, 0x042, 0x043, 
    0x045, 0x046, 0x048, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
    0x000, 0x04A, 0x000
};
  ...
  void pm_bob_driver_init(pm_comm_info_type * comm_ptr, peripheral_info_type * peripheral_info, uint8 pmic_index)
{
    ...
    if (bob_ptr == NULL)
    {
        ...
        bob_ptr->pm_pwr_data.num_of_peripherals = target_ptr->num_of_bob[pmic_index];
