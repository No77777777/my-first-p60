...
$Header: //components/rel/core.mpss/10.0/pmic/pm/drivers/smps/src/pm_smps_driver.c#2 $
...
void pm_smps_driver_init(pm_comm_info_type *comm_ptr, peripheral_info_type *peripheral_info, uint8 pmic_index)
{
    ...
    case PM_HW_MODULE_FTS:
        ...
        case PM_HW_MODULE_FTS__FTS512_CTL:
           break;
        default:
           return;
        }
    ...
    if (smps_ptr == NULL)
    {
        ...
        smps_ptr->pm_pwr_data.num_of_peripherals = target_ptr->num_of_smps[pmic_index];
