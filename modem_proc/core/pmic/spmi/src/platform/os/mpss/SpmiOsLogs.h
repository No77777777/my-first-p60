 ...
 * $Header: //components/rel/core.mpss/10.0/pmic/spmi/src/platform/os/mpss/SpmiOsLogs.h#1 $
 * $Change: 18983508 $ 
 * 
 *                              Edit History
 * Date     Description
...
#define SPMI_OS_LOG_TRACE(msg, args...) DO_ULOG("SPMI Trace: "msg, ##args)
#define SPMI_OS_LOG_TRACE_RAW(msg, args...) DO_ULOG("SPMI Trace Raw: "msg, ##args)
#endif
