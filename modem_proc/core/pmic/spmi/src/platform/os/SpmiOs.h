 ...
 * $Header: //components/rel/core.mpss/10.0/pmic/spmi/src/platform/os/SpmiOs.h#1 $
 * $Change: 18983508 $ 
 * 
 *                              Edit History
 * Date     Description
...
/**
 * Return TRUE is debug channel is to be used
 */
boolean SpmiOs_UseHwInterface(PmicArbCmd cmd);


/**
 * Execute write commands if hw channel is to be used
 */
