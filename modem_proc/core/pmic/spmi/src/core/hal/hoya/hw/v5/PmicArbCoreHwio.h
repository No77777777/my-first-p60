...
/**
  ...
  Reference chip release:
    SDM855 (Hana) [hana_v1.0_p3q1r24_F04_partitioned_rtl]
  ...
  { u'explicit-addressing': True,
    ...
    u'modules': [ u'PMIC_ARB_CORE',
                  ...
                  u'PMIC_ARB_MGPI',
                  u'QDSS_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG'],
...
/*
  ...
  $Header: //components/rel/core.mpss/10.0/pmic/spmi/src/core/hal/hoya/hw/v5/PmicArbCoreHwio.h#1 $
