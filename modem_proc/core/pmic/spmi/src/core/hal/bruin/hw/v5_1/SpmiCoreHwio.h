...
/*
  ...
  $Header: //components/rel/core.mpss/10.0/pmic/spmi/src/core/hal/bruin/hw/v5_1/SpmiCoreHwio.h#1 $
...
#define HWIO_SPMI_CFG_REG_RMSK                                                          0x1fffff
...
#define HWIO_SPMI_CFG_REG_WDT_CFG_SHFT                                                      0x11
...
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_ADDR(base,n)                                       ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00000858 + 0x8 * (n))
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_OFFS(base,n)                                       (0x00000858 + 0x8 * (n))
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_RMSK                                               0xff8fffff
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_INI(base,n)        \
        in_dword_masked(HWIO_SPMI_PIC_RCS_VIOCTL_n_ADDR(base,n), HWIO_SPMI_PIC_RCS_VIOCTL_n_RMSK)
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_INMI(base,n,mask)    \
        in_dword_masked(HWIO_SPMI_PIC_RCS_VIOCTL_n_ADDR(base,n), mask)
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_OUTI(base,n,val)    \
        out_dword(HWIO_SPMI_PIC_RCS_VIOCTL_n_ADDR(base,n),val)
#define HWIO_SPMI_PIC_RCS_VIOCTL_n_OUTMI(base,n,mask,val) \
        out_dword_masked_ns(HWIO_SPMI_PIC_RCS_VIOCTL_n_ADDR(base,n),mask,val,HWIO_SPMI_PIC_RCS_VIOCTL_n_INI(base,n))
...
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_ADDR(base,n)                                     ((base) + SPMI_CFG_REG_BASE_OFFS + 0x0000085c + 0x8 * (n))
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_OFFS(base,n)                                     (0x0000085c + 0x8 * (n))
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_RMSK                                             0xff8fffff
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_INI(base,n)        \
        in_dword_masked(HWIO_SPMI_PIC_RCS_VIOCTL_N_n_ADDR(base,n), HWIO_SPMI_PIC_RCS_VIOCTL_N_n_RMSK)
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_INMI(base,n,mask)    \
        in_dword_masked(HWIO_SPMI_PIC_RCS_VIOCTL_N_n_ADDR(base,n), mask)
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_OUTI(base,n,val)    \
        out_dword(HWIO_SPMI_PIC_RCS_VIOCTL_N_n_ADDR(base,n),val)
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_OUTMI(base,n,mask,val) \
        out_dword_masked_ns(HWIO_SPMI_PIC_RCS_VIOCTL_N_n_ADDR(base,n),mask,val,HWIO_SPMI_PIC_RCS_VIOCTL_N_n_INI(base,n))
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_MSG_MASK_BMSK                                    0xff000000
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_MSG_MASK_SHFT                                          0x18
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_VIOCTL_EN_BMSK                                     0x800000
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_VIOCTL_EN_SHFT                                         0x17
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_SID_BMSK                                            0xf0000
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_SID_SHFT                                               0x10
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_PID_BMSK                                             0xff00
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_PID_SHFT                                                0x8
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_RCS_MSG_BMSK                                           0xff
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_n_RCS_MSG_SHFT                                            0x0
...
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_WDT_RST_COMPLETION_SHFT                                0xd
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_WDT_EXPIRY_BMSK                                     0x1000
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_WDT_EXPIRY_SHFT                                        0xc
...
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_WDT_RST_COMPLETION_SHFT                                0xd
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_WDT_EXPIRY_BMSK                                     0x1000
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_WDT_EXPIRY_SHFT                                        0xc
...
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_WDT_RST_COMPLETION_SHFT                                 0xd
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_WDT_EXPIRY_BMSK                                      0x1000
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_WDT_EXPIRY_SHFT                                         0xc
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_WDT_RST_COMPLETION_SHFT                                0xd
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_WDT_EXPIRY_BMSK                                     0x1000
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_WDT_EXPIRY_SHFT                                        0xc
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_WDT_RST_COMPLETION_SHFT                              0xd
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_WDT_EXPIRY_BMSK                                   0x1000
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_WDT_EXPIRY_SHFT                                      0xc
...
#define HWIO_SPMI_WDT_CTRL_REG_0_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001900)
#define HWIO_SPMI_WDT_CTRL_REG_0_OFFS                                                 (0x00001900)
#define HWIO_SPMI_WDT_CTRL_REG_0_RMSK                                                    0x3ffff
#define HWIO_SPMI_WDT_CTRL_REG_0_IN(x)      \
        in_dword_masked(HWIO_SPMI_WDT_CTRL_REG_0_ADDR(x), HWIO_SPMI_WDT_CTRL_REG_0_RMSK)
#define HWIO_SPMI_WDT_CTRL_REG_0_INM(x, m)      \
        in_dword_masked(HWIO_SPMI_WDT_CTRL_REG_0_ADDR(x), m)
#define HWIO_SPMI_WDT_CTRL_REG_0_OUT(x, v)      \
        out_dword(HWIO_SPMI_WDT_CTRL_REG_0_ADDR(x),v)
#define HWIO_SPMI_WDT_CTRL_REG_0_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPMI_WDT_CTRL_REG_0_ADDR(x),m,v,HWIO_SPMI_WDT_CTRL_REG_0_IN(x))
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_ARB_EN_CRTL_BMSK                                    0x20000
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_ARB_EN_CRTL_SHFT                                       0x11
#define HWIO_SPMI_WDT_CTRL_REG_0_PMIC_ARB_ARST_EN_BMSK                                   0x10000
#define HWIO_SPMI_WDT_CTRL_REG_0_PMIC_ARB_ARST_EN_SHFT                                      0x10
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_M_ARB_ARST_EN_BMSK                                  0x8000
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_M_ARB_ARST_EN_SHFT                                     0xf
#define HWIO_SPMI_WDT_CTRL_REG_0_GENI_ARST_EN_BMSK                                        0x4000
#define HWIO_SPMI_WDT_CTRL_REG_0_GENI_ARST_EN_SHFT                                           0xe
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AHB_CLK_ARST_ASSERT_BMSK                            0x2000
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AHB_CLK_ARST_ASSERT_SHFT                               0xd
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_SER_CLK_ARST_ASSERT_BMSK                            0x1000
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_SER_CLK_ARST_ASSERT_SHFT                               0xc
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_SCLK_ARES_ASSERT_BMSK                                0x800
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_SCLK_ARES_ASSERT_SHFT                                  0xb
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AOD_SER_CLK_ARST_ASSERT_BMSK                         0x400
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AOD_SER_CLK_ARST_ASSERT_SHFT                           0xa
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_BUS_CLK_GATE_EN_BMSK                                 0x200
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_BUS_CLK_GATE_EN_SHFT                                   0x9
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AHB_CLK_GATE_EN_BMSK                                 0x100
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AHB_CLK_GATE_EN_SHFT                                   0x8
#define HWIO_SPMI_WDT_CTRL_REG_0_PMIC_ARB_CLK_GATE_EN_BMSK                                  0x80
#define HWIO_SPMI_WDT_CTRL_REG_0_PMIC_ARB_CLK_GATE_EN_SHFT                                   0x7
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_SER_CLK_GATE_EN_BMSK                                  0x40
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_SER_CLK_GATE_EN_SHFT                                   0x6
#define HWIO_SPMI_WDT_CTRL_REG_0_SLEEP_CLK_GATE_EN_BMSK                                     0x20
#define HWIO_SPMI_WDT_CTRL_REG_0_SLEEP_CLK_GATE_EN_SHFT                                      0x5
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AOD_SER_CLK_GATE_EN_BMSK                              0x10
#define HWIO_SPMI_WDT_CTRL_REG_0_SPMI_AOD_SER_CLK_GATE_EN_SHFT                               0x4
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_DEBUG_CNT_EN_BMSK                                       0x8
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_DEBUG_CNT_EN_SHFT                                       0x3
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_DEBUG_CNT_CLR_BMSK                                      0x4
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_DEBUG_CNT_CLR_SHFT                                      0x2
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_AUTO_HW_EN_BMSK                                         0x2
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_AUTO_HW_EN_SHFT                                         0x1
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_CNT_EN_BMSK                                             0x1
#define HWIO_SPMI_WDT_CTRL_REG_0_WDT_CNT_EN_SHFT                                             0x0

#define HWIO_SPMI_WDT_CTRL_REG_1_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001904)
#define HWIO_SPMI_WDT_CTRL_REG_1_OFFS                                                 (0x00001904)
#define HWIO_SPMI_WDT_CTRL_REG_1_RMSK                                                   0xfff00f
#define HWIO_SPMI_WDT_CTRL_REG_1_IN(x)      \
        in_dword_masked(HWIO_SPMI_WDT_CTRL_REG_1_ADDR(x), HWIO_SPMI_WDT_CTRL_REG_1_RMSK)
#define HWIO_SPMI_WDT_CTRL_REG_1_INM(x, m)      \
        in_dword_masked(HWIO_SPMI_WDT_CTRL_REG_1_ADDR(x), m)
#define HWIO_SPMI_WDT_CTRL_REG_1_OUT(x, v)      \
        out_dword(HWIO_SPMI_WDT_CTRL_REG_1_ADDR(x),v)
#define HWIO_SPMI_WDT_CTRL_REG_1_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPMI_WDT_CTRL_REG_1_ADDR(x),m,v,HWIO_SPMI_WDT_CTRL_REG_1_IN(x))
#define HWIO_SPMI_WDT_CTRL_REG_1_RESET_ASSERT_INTERVAL_BMSK                             0xf00000
#define HWIO_SPMI_WDT_CTRL_REG_1_RESET_ASSERT_INTERVAL_SHFT                                 0x14
#define HWIO_SPMI_WDT_CTRL_REG_1_CLK_GATE_EN_TO_RST_ASSERT_INTERVAL_BMSK                 0xf0000
#define HWIO_SPMI_WDT_CTRL_REG_1_CLK_GATE_EN_TO_RST_ASSERT_INTERVAL_SHFT                    0x10
#define HWIO_SPMI_WDT_CTRL_REG_1_ARB_EN_TO_CLK_GATE_EN_INTERVAL_BMSK                      0xf000
#define HWIO_SPMI_WDT_CTRL_REG_1_ARB_EN_TO_CLK_GATE_EN_INTERVAL_SHFT                         0xc
#define HWIO_SPMI_WDT_CTRL_REG_1_WDT_CTR_EXPIRY_VALUE_BMSK                                   0xf
#define HWIO_SPMI_WDT_CTRL_REG_1_WDT_CTR_EXPIRY_VALUE_SHFT                                   0x0

#define HWIO_SPMI_WDT_CTRL_REG_2_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001908)
#define HWIO_SPMI_WDT_CTRL_REG_2_OFFS                                                 (0x00001908)
#define HWIO_SPMI_WDT_CTRL_REG_2_RMSK                                                        0x3
#define HWIO_SPMI_WDT_CTRL_REG_2_IN(x)      \
        in_dword_masked(HWIO_SPMI_WDT_CTRL_REG_2_ADDR(x), HWIO_SPMI_WDT_CTRL_REG_2_RMSK)
#define HWIO_SPMI_WDT_CTRL_REG_2_INM(x, m)      \
        in_dword_masked(HWIO_SPMI_WDT_CTRL_REG_2_ADDR(x), m)
#define HWIO_SPMI_WDT_CTRL_REG_2_OUT(x, v)      \
        out_dword(HWIO_SPMI_WDT_CTRL_REG_2_ADDR(x),v)
#define HWIO_SPMI_WDT_CTRL_REG_2_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPMI_WDT_CTRL_REG_2_ADDR(x),m,v,HWIO_SPMI_WDT_CTRL_REG_2_IN(x))
#define HWIO_SPMI_WDT_CTRL_REG_2_WDT_SCLK_RST_MODE_BMSK                                      0x2
#define HWIO_SPMI_WDT_CTRL_REG_2_WDT_SCLK_RST_MODE_SHFT                                      0x1
#define HWIO_SPMI_WDT_CTRL_REG_2_WDT_SW_RST_BMSK                                             0x1
#define HWIO_SPMI_WDT_CTRL_REG_2_WDT_SW_RST_SHFT                                             0x0

#define HWIO_SPMI_WDT_STATUS_REG_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000190c)
#define HWIO_SPMI_WDT_STATUS_REG_OFFS                                                 (0x0000190c)
#define HWIO_SPMI_WDT_STATUS_REG_RMSK                                                        0x1
#define HWIO_SPMI_WDT_STATUS_REG_IN(x)      \
        in_dword_masked(HWIO_SPMI_WDT_STATUS_REG_ADDR(x), HWIO_SPMI_WDT_STATUS_REG_RMSK)
#define HWIO_SPMI_WDT_STATUS_REG_INM(x, m)      \
        in_dword_masked(HWIO_SPMI_WDT_STATUS_REG_ADDR(x), m)
#define HWIO_SPMI_WDT_STATUS_REG_WDT_DONE_BMSK                                               0x1
#define HWIO_SPMI_WDT_STATUS_REG_WDT_DONE_SHFT                                               0x0

#define HWIO_SPMI_WDT_DEBUG_CNT_REG_ADDR(x)                                           ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001910)
#define HWIO_SPMI_WDT_DEBUG_CNT_REG_OFFS                                              (0x00001910)
#define HWIO_SPMI_WDT_DEBUG_CNT_REG_RMSK                                                  0xffff
#define HWIO_SPMI_WDT_DEBUG_CNT_REG_IN(x)      \
        in_dword_masked(HWIO_SPMI_WDT_DEBUG_CNT_REG_ADDR(x), HWIO_SPMI_WDT_DEBUG_CNT_REG_RMSK)
#define HWIO_SPMI_WDT_DEBUG_CNT_REG_INM(x, m)      \
        in_dword_masked(HWIO_SPMI_WDT_DEBUG_CNT_REG_ADDR(x), m)
#define HWIO_SPMI_WDT_DEBUG_CNT_REG_WDT_DEBUG_CNT_BMSK                                    0xffff
#define HWIO_SPMI_WDT_DEBUG_CNT_REG_WDT_DEBUG_CNT_SHFT                                       0x0
