...
/**
  ...
  This file contains HWIO register definitions for the following modules:
    ...
    PMIC_ARB_MGPI
    QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG
  ...
  { u'explicit-addressing': True,
    ...
    u'modules': [ u'PMIC_ARB_CORE',
                  ...
                  u'PMIC_ARB_MGPI',
                  u'QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG'],
...
/*
  ...
  $Header: //components/rel/core.mpss/10.0/pmic/spmi/src/core/hal/bruin/hw/v5_1/PmicArbCoreHwio.h#1 $
...
#define HWIO_PMIC_ARB_MISC_CONFIG_RMSK                                                          0x3fff
...
#define HWIO_PMIC_ARB_MISC_CONFIG_ECO_EE_FWD_PATH_FIX_CHKN_BIT0_SHFT                               0xd
#define HWIO_PMIC_ARB_MISC_CONFIG_SPMI_SNOOPER_SLAVE_SSC_DET_CFG_BMSK                           0x1800
#define HWIO_PMIC_ARB_MISC_CONFIG_SPMI_SNOOPER_SLAVE_SSC_DET_CFG_SHFT                              0xb
#define HWIO_PMIC_ARB_MISC_CONFIG_SW_CHNL_CONC_ACC_ECO_FIX_CHICKEN_BIT_BMSK                      0x400
#define HWIO_PMIC_ARB_MISC_CONFIG_SW_CHNL_CONC_ACC_ECO_FIX_CHICKEN_BIT_SHFT                        0xa
#define HWIO_PMIC_ARB_MISC_CONFIG_SPMI_SNOOPER_MODE_BMSK                                         0x200
#define HWIO_PMIC_ARB_MISC_CONFIG_SPMI_SNOOPER_MODE_SHFT                                           0x9
#define HWIO_PMIC_ARB_MISC_CONFIG_MISC_CONFIG_SPARE_BMSK                                         0x100
#define HWIO_PMIC_ARB_MISC_CONFIG_MISC_CONFIG_SPARE_SHFT                                           0x8
#define HWIO_PMIC_ARB_MISC_CONFIG_ECO_EE_FWD_PATH_FIX_CHKN_BIT1_BMSK                              0x80
#define HWIO_PMIC_ARB_MISC_CONFIG_ECO_EE_FWD_PATH_FIX_CHKN_BIT1_SHFT                               0x7
#define HWIO_PMIC_ARB_MISC_CONFIG_PMIC_ARB_TEST_BUS_SELECT_BMSK                                   0x40
#define HWIO_PMIC_ARB_MISC_CONFIG_PMIC_ARB_TEST_BUS_SELECT_SHFT                                    0x6
#define HWIO_PMIC_ARB_MISC_CONFIG_SPMI_SNOOPER_SLAVE_TEST_BUS_SELECT_BMSK                         0x38
#define HWIO_PMIC_ARB_MISC_CONFIG_SPMI_SNOOPER_SLAVE_TEST_BUS_SELECT_SHFT                          0x3
...
#define HWIO_PMIC_ARB_XBL_STATUS_ADDR(x)                                                    ((x) + PMIC_ARB_CORE_REG_BASE_OFFS + 0x00000014)
#define HWIO_PMIC_ARB_XBL_STATUS_OFFS                                                       (0x00000014)
#define HWIO_PMIC_ARB_XBL_STATUS_RMSK                                                             0x1f
#define HWIO_PMIC_ARB_XBL_STATUS_IN(x)      \
        in_dword_masked(HWIO_PMIC_ARB_XBL_STATUS_ADDR(x), HWIO_PMIC_ARB_XBL_STATUS_RMSK)
#define HWIO_PMIC_ARB_XBL_STATUS_INM(x, m)      \
        in_dword_masked(HWIO_PMIC_ARB_XBL_STATUS_ADDR(x), m)
#define HWIO_PMIC_ARB_XBL_STATUS_DEBUG_CNT_BMSK                                                   0x1f
#define HWIO_PMIC_ARB_XBL_STATUS_DEBUG_CNT_SHFT                                                    0x0

#define HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_ADDR(x)                                             ((x) + PMIC_ARB_CORE_REG_BASE_OFFS + 0x00000018)
#define HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_OFFS                                                (0x00000018)
#define HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_RMSK                                                       0x1
#define HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_OUT(x, v)      \
        out_dword(HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_ADDR(x),v)
#define HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_SPMI_SNOOPER_SW_RST_BMSK                                   0x1
#define HWIO_PMIC_ARB_SPMI_SNOOPER_CTRL_SPMI_SNOOPER_SW_RST_SHFT                                   0x0

#define HWIO_PMIC_ARB_SW_RST_CTRL_ADDR(x)                                                   ((x) + PMIC_ARB_CORE_REG_BASE_OFFS + 0x0000001c)
#define HWIO_PMIC_ARB_SW_RST_CTRL_OFFS                                                      (0x0000001c)
#define HWIO_PMIC_ARB_SW_RST_CTRL_RMSK                                                             0x7
#define HWIO_PMIC_ARB_SW_RST_CTRL_IN(x)      \
        in_dword_masked(HWIO_PMIC_ARB_SW_RST_CTRL_ADDR(x), HWIO_PMIC_ARB_SW_RST_CTRL_RMSK)
#define HWIO_PMIC_ARB_SW_RST_CTRL_INM(x, m)      \
        in_dword_masked(HWIO_PMIC_ARB_SW_RST_CTRL_ADDR(x), m)
#define HWIO_PMIC_ARB_SW_RST_CTRL_OUT(x, v)      \
        out_dword(HWIO_PMIC_ARB_SW_RST_CTRL_ADDR(x),v)
#define HWIO_PMIC_ARB_SW_RST_CTRL_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_PMIC_ARB_SW_RST_CTRL_ADDR(x),m,v,HWIO_PMIC_ARB_SW_RST_CTRL_IN(x))
#define HWIO_PMIC_ARB_SW_RST_CTRL_SPMI_SNOOPER_SW_RST_FROM_SPMI_M_EN_BMSK                          0x4
#define HWIO_PMIC_ARB_SW_RST_CTRL_SPMI_SNOOPER_SW_RST_FROM_SPMI_M_EN_SHFT                          0x2
#define HWIO_PMIC_ARB_SW_RST_CTRL_SPMI_SNOOPER_SW_RST_SINGLE_MULT_MASTER_MODE_BMSK                 0x2
#define HWIO_PMIC_ARB_SW_RST_CTRL_SPMI_SNOOPER_SW_RST_SINGLE_MULT_MASTER_MODE_SHFT                 0x1
#define HWIO_PMIC_ARB_SW_RST_CTRL_SW_RST_ENABLE_BMSK                                               0x1
#define HWIO_PMIC_ARB_SW_RST_CTRL_SW_RST_ENABLE_SHFT                                               0x0
...
#define HWIO_PMIC_ARB_CHNLn_STATUS_SW_WDT_RST_SHFT                                            0x4
...
#define HWIO_PMIC_ARB_OBSq_CHNLn_STATUS_SW_WDT_RST_SHFT                                         0x4
...
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_ADDR(x)                        ((x) + PMIC_ARB_MGPI_REG_BASE_OFFS + 0x00002024)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_OFFS                           (0x00002024)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_RMSK                               0x1f33
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_IN(x)      \
        in_dword_masked(HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_ADDR(x), HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_RMSK)
...
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_NEXT_TRIGGER_SHFT                     0x8
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_INTERRUPT_EN_BMSK                    0x20
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_INTERRUPT_EN_SHFT                     0x5
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_DUAL_EDGE_ERR_EN_BMSK                0x10
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_DUAL_EDGE_ERR_EN_SHFT                 0x4
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_MGPI_NEG_EN_BMSK                      0x2
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_MGPI_NEG_EN_SHFT                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_MGPI_POS_EN_BMSK                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN4_MGPI_POS_EN_SHFT                      0x0

#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_ADDR(x)                        ((x) + PMIC_ARB_MGPI_REG_BASE_OFFS + 0x0000202c)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_OFFS                           (0x0000202c)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_RMSK                               0x1f33
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_IN(x)      \
        in_dword_masked(HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_ADDR(x), HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_RMSK)
...
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_NEXT_TRIGGER_SHFT                     0x8
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_INTERRUPT_EN_BMSK                    0x20
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_INTERRUPT_EN_SHFT                     0x5
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_DUAL_EDGE_ERR_EN_BMSK                0x10
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_DUAL_EDGE_ERR_EN_SHFT                 0x4
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_MGPI_NEG_EN_BMSK                      0x2
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_MGPI_NEG_EN_SHFT                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_MGPI_POS_EN_BMSK                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN5_MGPI_POS_EN_SHFT                      0x0

#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_ADDR(x)                        ((x) + PMIC_ARB_MGPI_REG_BASE_OFFS + 0x00002034)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_OFFS                           (0x00002034)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_RMSK                               0x1f33
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_IN(x)      \
        in_dword_masked(HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_ADDR(x), HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_RMSK)
...
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_NEXT_TRIGGER_SHFT                     0x8
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_INTERRUPT_EN_BMSK                    0x20
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_INTERRUPT_EN_SHFT                     0x5
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_DUAL_EDGE_ERR_EN_BMSK                0x10
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_DUAL_EDGE_ERR_EN_SHFT                 0x4
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_MGPI_NEG_EN_BMSK                      0x2
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_MGPI_NEG_EN_SHFT                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_MGPI_POS_EN_BMSK                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN6_MGPI_POS_EN_SHFT                      0x0

#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_ADDR(x)                        ((x) + PMIC_ARB_MGPI_REG_BASE_OFFS + 0x0000203c)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_OFFS                           (0x0000203c)
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_RMSK                               0x1f33
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_IN(x)      \
        in_dword_masked(HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_ADDR(x), HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_RMSK)
...
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_NEXT_TRIGGER_SHFT                     0x8
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_INTERRUPT_EN_BMSK                    0x20
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_INTERRUPT_EN_SHFT                     0x5
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_DUAL_EDGE_ERR_EN_BMSK                0x10
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_DUAL_EDGE_ERR_EN_SHFT                 0x4
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_MGPI_NEG_EN_BMSK                      0x2
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_MGPI_NEG_EN_SHFT                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_MGPI_POS_EN_BMSK                      0x1
#define HWIO_PMIC_MGPI_TRIG_CONFIG_EN7_MGPI_POS_EN_SHFT                      0x0
...
#define HWIO_PMIC_MGPI_MUX_SELn_ADDR(base,n)                          ((base) + PMIC_ARB_MGPI_REG_BASE_OFFS + 0x00010004 + 0x10000 * (n))
#define HWIO_PMIC_MGPI_MUX_SELn_OFFS(base,n)                          (0x00010004 + 0x10000 * (n))
#define HWIO_PMIC_MGPI_MUX_SELn_RMSK                                         0x3
...
#define HWIO_PMIC_MGPI_MUX_SELn_MUX_SEL_BMSK                                 0x3
#define HWIO_PMIC_MGPI_MUX_SELn_MUX_SEL_SHFT                                 0x0

/*----------------------------------------------------------------------------
 * MODULE: QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG
 *--------------------------------------------------------------------------*/

#define QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS                      0x00008000

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_ADDR(x)                 ((x) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000000)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OFFS                    (0x00000000)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_RMSK                          0x3f
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_IN(x)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_ADDR(x), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_INM(x, m)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_ADDR(x), m)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OUT(x, v)      \
        out_dword(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_ADDR(x),v)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_ADDR(x),m,v,HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_IN(x))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OPCODE_BMSK                   0x3e
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OPCODE_SHFT                    0x1
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_PRIORITY_BMSK                  0x1
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_PRIORITY_SHFT                  0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_ADDR(x)                 ((x) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000004)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_OFFS                    (0x00000004)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_RMSK                          0x7f
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_IN(x)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_ADDR(x), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_INM(x, m)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_ADDR(x), m)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_OUT(x, v)      \
        out_dword(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_ADDR(x),v)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_ADDR(x),m,v,HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_IN(x))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_BYTE_CNT_BMSK                 0x70
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_BYTE_CNT_SHFT                  0x4
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_SID_BMSK                       0xf
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_SID_SHFT                       0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_ADDR(x)                 ((x) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000008)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_OFFS                    (0x00000008)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_RMSK                          0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_IN(x)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_ADDR(x), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_INM(x, m)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_ADDR(x), m)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_OUT(x, v)      \
        out_dword(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_ADDR(x),v)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_ADDR(x),m,v,HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_IN(x))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_PPID_BMSK                     0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_PPID_SHFT                      0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDR(x)                 ((x) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x0000000c)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_OFFS                    (0x0000000c)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_RMSK                          0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_IN(x)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDR(x), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_INM(x, m)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDR(x), m)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_OUT(x, v)      \
        out_dword(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDR(x),v)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDR(x),m,v,HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_IN(x))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDRESS_BMSK                  0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDRESS_SHFT                   0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_ADDR(x)               ((x) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000010)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_OFFS                  (0x00000010)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_RMSK                         0x1
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_IN(x)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_ADDR(x), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_INM(x, m)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_ADDR(x), m)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_OUT(x, v)      \
        out_dword(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_ADDR(x),v)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_ADDR(x),m,v,HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_IN(x))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_IRQ_EN_BMSK                  0x1
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_IRQ_EN_SHFT                  0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_ADDR(x)               ((x) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000014)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_OFFS                  (0x00000014)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_RMSK                         0xf
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_IN(x)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_ADDR(x), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_INM(x, m)      \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_ADDR(x), m)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DROPPED_BMSK                 0x8
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DROPPED_SHFT                 0x3
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DENIED_BMSK                  0x4
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DENIED_SHFT                  0x2
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_FAILURE_BMSK                 0x2
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_FAILURE_SHFT                 0x1
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DONE_BMSK                    0x1
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DONE_SHFT                    0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_ADDR(base,g)          ((base) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000018 + 0x4 * (g))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_OFFS(base,g)          (0x00000018 + 0x4 * (g))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_RMSK                        0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_INI(base,g)        \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_ADDR(base,g), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_INMI(base,g,mask)    \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_ADDR(base,g), mask)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_OUTI(base,g,val)    \
        out_dword(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_ADDR(base,g),val)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_OUTMI(base,g,mask,val) \
        out_dword_masked_ns(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_ADDR(base,g),mask,val,HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_INI(base,g))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_DATA_BMSK                   0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_DATA_SHFT                    0x0

#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_ADDR(base,h)          ((base) + QDSS_AODBG_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000038 + 0x4 * (h))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_OFFS(base,h)          (0x00000038 + 0x4 * (h))
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_RMSK                        0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_INI(base,h)        \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_ADDR(base,h), HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_RMSK)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_INMI(base,h,mask)    \
        in_dword_masked(HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_ADDR(base,h), mask)
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_DATA_BMSK                   0xff
#define HWIO_QDSS_AODBG_PMIC_ARB_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_DATA_SHFT                    0x0

/*----------------------------------------------------------------------------
 * MODULE: MGPIx
 *--------------------------------------------------------------------------*/

#define MGPI1_REG_BASE                   0x01C70004 

#define HWIO_MGPI1_ADDR(x)               (MGPI1_REG_BASE + ((x) * 0x1000))
#define HWIO_MGPI1_RMSK                  0xffffffff
#define HWIO_MGPI1_IN(x)      \
        in_dword_masked(HWIO_MGPI1_ADDR(x), HWIO_MGPI1_RMSK)
#define HWIO_MGPI1_INM(x, m)      \
        in_dword_masked(HWIO_MGPI1_ADDR(x), m)
#define HWIO_MGPI1_OUT(x, v)      \
        out_dword(HWIO_MGPI1_ADDR(x),v)
#define HWIO_MGPI1_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_MGPI1_ADDR(x),m,v,HWIO_MGPI1_IN(x))
#define HWIO_MGPI1_SPARE_BMSK            0xfffffff8
#define HWIO_MGPI1_SPARE_SHFT                   0x3
#define HWIO_MGPI1_MUX_SEL_BMSK                 0x3
#define HWIO_MGPI1_MUX_SEL_SHFT                 0x0
