#ifndef __PM_GPIO_P_H__
#define __PM_GPIO_P_H__
...
$Header: //components/rel/core.mpss/10.0/pmic/inc/pm_gpio_p.h#1 $
...
//This API is deprecated, check with RF folks if they are using it. If used add PMIC_CHIP variable for the API 
