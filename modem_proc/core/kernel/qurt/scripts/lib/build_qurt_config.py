...
def get_sections(secure=False):
    ...
    S.add_section('.tcm.ukernel.island', ISLAND=True, KERNEL=True, TCM=True)
    S.add_section('.tcm.ukernel.main', ISLAND=False, KERNEL=True, TCM=True)
    S.add_section('.tcm.qurtos.island', ISLAND=True, QURTOS=True, TCM=True)
    S.add_section('.tcm.qurtos.main', ISLAND=False, QURTOS=True, TCM=True)
    S.add_section('.rodata.eip.build', NAME='eip_*', EXACT=True)
    S.add_section('.qurtos.island', ISLAND=True, QURTOS=True)
    S.add_section('.qurtos.coldboot', COLDBOOT=True, QURTOS=True)
    S.add_section('.export.main', EXPORT=True, KERNEL=True)
