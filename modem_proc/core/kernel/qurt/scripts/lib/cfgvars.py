...
qurtos_objcache_config                  COLDBOOT QURTOS
QURTOS_HEAP_SIZE                        COLDBOOT QURTOS
qurtos_max_threads_in_tcm               COLDBOOT QURTOS
QDSP6_QURT_TIMER_BASE                   ISLAND
...
QURTK_chicken_bits_rgdr_pigeon          KERNEL
QURTK_chicken_bits_rgdr_goose           KERNEL
...
QURTK_int_max                           ISLAND KERNEL TCM
QURTK_int_nest_allow
QURTK_int_privilege                     ISLAND KERNEL TCM
...
QURTK_l2cache_size
QURTK_l2cache_size_kb                   KERNEL
QURTK_l2cache_wb
QURTK_l2cfg_tab                         KERNEL
QURTK_l2cfg_tab_len                     KERNEL
QURTK_l2_enable                         ISLAND
QURTK_l2_interrupt_table
QURTK_l2_int_idx_table                  ISLAND KERNEL TCM
QURTK_l2_island_interrupt_table         ISLAND
QURTK_l2_tcm_interrupt_table            KERNEL TCM
QURTK_L2_partition
QURTK_l2_type
QURTK_livelock_data
QURTK_mailbox_data
...
QURTK_VTLB_DATA                         KERNEL
QURTK_vtlb_reaper_queue_sz              KERNEL
QURTK_vtlb_reaper_queue                 KERNEL
QURTK_page_table_v2
QURTK_page_table_v2_0x15
QURTK_pcb_data                          ISLAND KERNEL TCM
QURTK_phys_relocs
QURTK_program_names
QURTK_ramfs_scan
QURTK_root_prog_no
...
qurtos_heap
qurtos_island_stack_size                QURTOS
qurtos_island_handle_count              QURTOS
qurtos_qdi_handle_count                 QURTOS
qurtos_ssr_default                      QURTOS
qurtos_ccr_default                      QURTOS
qurtos_usr_default                      QURTOS
qurtos_island_heap_size                 QURTOS
qurtos_max_user_processes               QURTOS
qurtos_trace_buffer_size                QURTOS
qurtos_fastint_stack_size
qurtos_fastint_stack_addr
qurtos_timer_freq_init
qurtos_fastint_stack_island             ISLAND QURTOS TCM
qurtos_fastint_stack_main               QURTOS TCM
qurtos_main_bitmask
...
QURTK_syscfg_static_mask                KERNEL
QURTK_syscfg_static                     KERNEL
QURTK_timer_freq_init                   KERNEL
QURTK_vtlb_client_bitmask               KERNEL
QURTK_max_island_int                    EXPORT KERNEL
QURTK_MAX_USER_PROCESSES                ISLAND KERNEL
qurtos_int_privilege                    QURTOS
qurt_itcm_err_dump
QURT_timer_intno                        ISLAND KERNEL TCM
QURT_timerIST_priority
QURT_timerIST_tcb_partition
qurt_tlb_idx
trace_space
QURTK_crash_reset_addr
QURTK_uncached_content                  KERNEL
QURTK_L1Dcache_dump                     KERNEL
QURTK_process_classes                   ISLAND KERNEL
