...
$Header: //components/rel/core.mpss/10.0/kernel/systemcache/src/systemcacheHAL.h#1 $
...
void   SysCacheHALActDeactSCID(uint32 SysCacheBaseAddress, uint32 SysCacheBroadcastTRPOffset, uint32 scid, boolean activate);
