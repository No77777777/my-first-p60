...
$Header: //components/rel/core.mpss/10.0/systemdrivers/icb/src/common/ABT_qurt_interrupt.c#1 $
...
)
{
  ...
  nInterruptVector = *((uint32_t *)ISTParam);
...
{
  uint32_t nDetectType,nPolarity;
