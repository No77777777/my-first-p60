...
$Header: //components/rel/core.mpss/10.0/systemdrivers/icb/src/common/ABT_platform.h#1 $
...
*/ 
/*==============================================================================*/
ABT_error_type ABT_Platform_Register_Interrupt_OS( uint32_t  nInterruptVector, 
                                                   const     DALISR isr,
                                                   const     DALISRCtx ctx, 
                                                   uint32_t  nTrigger);
...
/**
@brief 
      Set platfrom specific HWIO unmapping.
