...
$Header: //components/rel/core.mpss/10.0/systemdrivers/icb/src/common/HALnoc4.c#1 $
...
#include "HALnoc.h"
#include "HALnoc4.h"
#include "HALnoc4Hwio.h"
#include "HALnoc4HwioGeneric.h"
...
)
{
  ...
  if( NULL != info &&
      master_port < info->uNumQosMasters )
  {
    NOC_OUTFI(info->pBaseAddr, info->uQosOffset, info->uQosSize,
...
)
{
  ...
  {
    *priority = 
      NOC_INFI(info->pBaseAddr, info->uQosOffset, info->uQosSize,
