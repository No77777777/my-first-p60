...
$Header: //components/rel/core.mpss/10.0/systemdrivers/GPIOInt/src/user/uimage/uGPIOIntUser.h#1 $
...
//void uGPIOInt_ReconfigureDualEdgeDirConnInterrupt(uint32 nGpio);
