...
$Header: //components/rel/core.mpss/10.0/systemdrivers/GPIOInt/src/kernel/GPIOIntLog.c#1 $
...
void GPIOIntLog_Init( ULogHandle* hL )
{
  ...
  #ifdef GPIOINTLOG_INIT_ENABLE
  nGPIOIntLogMask |= GPIOINTLOG_INIT;
  #endif /* GPIOINTLOG_REG_INIT */
