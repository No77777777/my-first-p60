#ifndef __UGPIOIntInternal_H
#define __UGPIOIntInternal_H
/*===========================================================================
...
$Header: //components/rel/core.mpss/10.0/systemdrivers/GPIOInt/src/kernel/uGPIOIntInternal.h#1 $
