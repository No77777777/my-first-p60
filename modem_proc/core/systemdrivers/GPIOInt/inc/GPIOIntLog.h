...
$Header: //components/rel/core.mpss/10.0/systemdrivers/GPIOInt/inc/GPIOIntLog.h#1 $
...
#define GPIOINTLOG_INIT          0x1
#define GPIOINTLOG_REG           0x2
#define GPIOINTLOG_MPM           0x4
#define GPIOINTLOG_NPAREQ        0x8
#define GPIOINTLOG_SETTRIGGER   0x10
#define GPIOINTLOG_ENABLE       0x20
#define GPIOINTLOG_CLEAR        0x40
#define GPIOINTLOG_TRIGGER      0x80
#define GPIOINTLOG_SUMMARYISR  0x100         
