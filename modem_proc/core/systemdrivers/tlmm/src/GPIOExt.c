...
/*========================================================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/systemdrivers/tlmm/src/GPIOExt.c#1 $
 ...
 */
static boolean gTLMMIsInitialized = FALSE;
