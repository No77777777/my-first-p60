...
static uint32 
SoftwareSwitches_DalSoftwareSwitches_Detach(uint32 ClientHandle, DalDeviceHandle* h)
{
  return DALFW_Release((DALClientCtxt *)(h->pClientCtxt));
}

static DALResult 
SoftwareSwitches_DalSoftwareSwitches_Init(uint32 ClientHandle, DalDeviceHandle *h)
{  
...
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_DeInit(uint32 ClientHandle, DalDeviceHandle *h)
{
   return SoftwareSwitches_DeviceDeInit(h->pClientCtxt);
}

static DALResult 
SoftwareSwitches_DalSoftwareSwitches_PowerEvent(uint32 ClientHandle, DalDeviceHandle *h, DalPowerCmd PowerCmd, 
...
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_Open(uint32 ClientHandle, DalDeviceHandle* h, uint32 mode)
{
    return SoftwareSwitches_Open(h->pClientCtxt,mode);
}

static DALResult 
SoftwareSwitches_DalSoftwareSwitches_Close(uint32 ClientHandle, DalDeviceHandle* h)
{
    return SoftwareSwitches_Close(h->pClientCtxt);
}

static DALResult 
SoftwareSwitches_DalSoftwareSwitches_Info(uint32 ClientHandle, DalDeviceHandle* h, DalDeviceInfo* info, uint32 infoSize)
{
...
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_SysRequest(uint32 ClientHandle, DalDeviceHandle* h,DalSysReq ReqIdx,
...
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_SetSwitch(uint32 ClientHandle,  DalDeviceHandle * h, uint32  software_switch) 
{
	return SoftwareSwitches_SetSwitch(((DalSoftwareSwitchesHandle *)h)->pClientCtxt, software_switch);
}
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_ClearSwitch(uint32 ClientHandle,  DalDeviceHandle * h, uint32  software_switch) 
{
	return SoftwareSwitches_ClearSwitch(((DalSoftwareSwitchesHandle *)h)->pClientCtxt, software_switch);
}
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_SetAll(uint32 ClientHandle,  DalDeviceHandle * h, uint32  software_switch) 
{
	return SoftwareSwitches_SetAll(((DalSoftwareSwitchesHandle *)h)->pClientCtxt, software_switch);
}
static DALResult 
SoftwareSwitches_DalSoftwareSwitches_GetMask(uint32 ClientHandle,  DalDeviceHandle * h, uint32  software_switch,  void * state, uint32  size) 
{
