...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.mpss/10.0/systemdrivers/vcs/src/VCSRails.c#1 $
...
)
{
  ...
  *pRail = (VCSRailNodeType *)NULL;
  ...
  {
    if (strcmp(szName, VCS_RAIL_NAME(&VCSBSP.pRails[i])) == 0 && VCS_IsBSPSupported(VCS_HW_VERSION(&VCSBSP.pRails[i])) == TRUE)
    {
