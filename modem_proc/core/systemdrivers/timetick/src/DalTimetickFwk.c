...
static DALResult 
Timetick_DalTimetick_SetNextInterrupt(uint32 ClientHandle,  DalDeviceHandle * h, DalTimetickTime32Type  match_count, DalTimetickTime32Type  ticks_now,  DalTimetickTime32Type * match_val) 
{
  if (ClientHandle == DALDEVICE_LOCAL_CLIENTID)
  {
...
static DALResult 
Timetick_DalTimetick_GetElapsed64(uint32 ClientHandle,  DalDeviceHandle * h, DalTimetickTime64Type  start, DalTimetickUnitType  unit, DalTimetickTime64Type *  diff) 
{
  DALResult nResult;
  DalTimetickTime64Type nTick;

  nResult = Timetick_GetElapsed64(((DalTimetickHandle *)h)->pClientCtxt, start, unit, &nTick);
...
static DALResult 
Timetick_DalTimetick_Diff64(uint32 ClientHandle,  DalDeviceHandle * h, DalTimetickTime64Type  start, DalTimetickTime64Type  end, DalTimetickUnitType  unit, DalTimetickTime64Type *  diff) 
{
  DALResult nResult;
  DalTimetickTime64Type nTick;

  nResult = Timetick_Diff64(((DalTimetickHandle *)h)->pClientCtxt, start, end, unit, &nTick);
    ...
    static const DalTimetick vtbl = {
       {
        ...
        Timetick_DalTimetick_GetElapsed64,
        Timetick_DalTimetick_Diff64,
