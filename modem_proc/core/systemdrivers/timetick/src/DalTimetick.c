...
============================================================================
                              EDIT HISTORY
  $Header: //components/rel/core.mpss/10.0/systemdrivers/timetick/src/DalTimetick.c#1 $
...
/*==========================================================================
  ...
  FUNCTION      Timetick_GetElapsed64

  DESCRIPTION   See DDITimetick.h

==========================================================================*/

DALResult Timetick_GetElapsed64
(
  TimetickClientCtxt      *pCtxt,
...
{
  /* Time Tick count */
  DalTimetickTime64Type                   utimer = 0;
  ...
  /* Compute and return the difference between the timestamps */
  Timetick_Diff64(pCtxt, start, utimer, unit, pDiff);

  return DAL_SUCCESS;
}/* END Timetick_GetElapsed64 */

/*==========================================================================

  FUNCTION      Timetick_Diff64

  DESCRIPTION   See DDITimetick.h

==========================================================================*/
DALResult Timetick_Diff64
(
  TimetickClientCtxt          *pCtxt,
  DalTimetickTime64Type       start,
  DalTimetickTime64Type       end,
  DalTimetickUnitType         unit,
  DalTimetickTime64Type       *pDiff
)
{
     /* Time Tick count */
  DalTimetickTime64Type                   delta;
  ...
  /* Compute and return the difference between the timestamps */
  Timetick_CvtFromTimetick64( pCtxt, delta, unit, pDiff);
