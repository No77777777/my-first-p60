...
$Header: //components/rel/core.mpss/10.0/systemdrivers/hal/tlmmtile/inc/HALtlmmtile.h#1 $
...
typedef enum
{
  ...
  HAL_TLMMTILE_FIELD_CFG_EGPIO_PRESENT,
  HAL_TLMMTILE_FIELD_CFG_EGPIO_ENABLE,
...
uint32 HAL_tlmmtile_SetDirConn ( uint32 nDirConn, HAL_tlmmtile_FieldType nField, uint32 nVal, uint32  nDirectConnectBaseType );
