...
$Header: //components/rel/core.mpss/10.0/systemdrivers/ipcint/image/stub/DalIPCInt_ConfigData.c#1 $
...
#define IPC_BASE            0x04100000
#define IPC_BASE_OFFSET         0x8000
#define IPC_BASE_OFFSET_R1      0x8004
#define IPC_SEC_BASE        0x01880000
#define IPC_SEC_BASE_OFFSET     0x901C
