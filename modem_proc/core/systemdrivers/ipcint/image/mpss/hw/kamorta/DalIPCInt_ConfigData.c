...
$Header: //components/rel/core.mpss/10.0/systemdrivers/ipcint/image/mpss/hw/kamorta/DalIPCInt_ConfigData.c#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/12/18   shm     First version for SM6150.
===========================================================================*/

#include "DalIPCInt.h"
#include "DDIHWIO.h"

#define IPC_BASE            0x06100000
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      8,  3 }, //DALIPCINT_PROC_ADSP
  { IPC_NULL_BASE, IPC_NULL_BASE_OFFSET, 0,  0 }, //DALIPCINT_PROC_SPS
  { IPC_BASE,      IPC_BASE_OFFSET,      0,  3 }, //DALIPCINT_PROC_RPM
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      8,  3 }, //DALIPCINT_PROC_LPASS
  { IPC_BASE,      IPC_BASE_OFFSET,      28, 4 }, //DALIPCINT_PROC_TZ 
  { IPC_NULL_BASE, IPC_NULL_BASE_OFFSET, 0,  0 }, //DALIPCINT_PROC_SPSS
  { IPC_BASE,      IPC_BASE_OFFSET,      12, 3 }, //DALIPCINT_PROC_CDSP
