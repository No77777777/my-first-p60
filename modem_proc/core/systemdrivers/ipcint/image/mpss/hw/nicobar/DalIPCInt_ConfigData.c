...
$Header: //components/rel/core.mpss/10.0/systemdrivers/ipcint/image/mpss/hw/nicobar/DalIPCInt_ConfigData.c#1 $
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      20, 3 }, //DALIPCINT_PROC_TZ 
