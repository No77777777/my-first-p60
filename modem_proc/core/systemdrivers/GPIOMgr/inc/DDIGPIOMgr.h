...
$Header: //components/rel/core.mpss/10.0/systemdrivers/GPIOMgr/inc/DDIGPIOMgr.h#1 $
...
struct GPIOMgrIF
{
   ...
   DALResult (*GPIOMgr_GetDirectConnectGPIO)(uint32 ClientHandle, DalDeviceHandle *_h , uint32 nGPIO, uint32* pDirConnID, uint32 *pDirectConnectBaseType);
   DALResult (*GPIOMgr_ReleaseDirectConnectGPIO)(uint32 ClientHandle, DalDeviceHandle *_h , uint32 nGPIO, uint32 nInterruptID);
...
static __inline DALResult
DalGPIOMgr_GetDirectConnectGPIO(DalDeviceHandle * _h, uint32 nGPIO, uint32* pDirConnID, uint32 *pDirectConnectBaseType)
{
   if(DALISREMOTEHANDLE(_h))
   {
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
   ...
   return ((GPIOMgrIFHandle *)_h)->pVtbl->GPIOMgr_GetDirectConnectGPIO(DALDEVICE_LOCAL_CLIENTID, _h, nGPIO, pDirConnID, pDirectConnectBaseType);
}
...
static __inline DALResult
DalGPIOMgr_ReleaseDirectConnectGPIO(DalDeviceHandle * _h, uint32 nGPIO, uint32 nInterruptID)
{
   if(DALISREMOTEHANDLE(_h))
   {
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_1(DALVTBLIDX(((GPIOMgrIFHandle *)_h)->pVtbl, GPIOMgr_ReleaseDirectConnectGPIO ), _h, nGPIO, nInterruptID);
   }
   return ((GPIOMgrIFHandle *)_h)->pVtbl->GPIOMgr_ReleaseDirectConnectGPIO(DALDEVICE_LOCAL_CLIENTID, _h, nGPIO, nInterruptID);
}
