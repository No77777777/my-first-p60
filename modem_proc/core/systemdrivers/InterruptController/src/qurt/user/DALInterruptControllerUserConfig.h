...
$Header: //components/rel/core.mpss/10.0/systemdrivers/InterruptController/src/qurt/user/DALInterruptControllerUserConfig.h#1 $ 

when       who     what, where, why
--------   ---     ---------------------------------------------------------
03/29/16   shm    Added trigger type to BSP config data type
...
#include "InterruptControllerUserInterface.h"
...
typedef struct
{
  ...
  * *hDalMpmHandle         - Client handle to the MPM dal.
