...
$Header: //components/rel/core.mpss/10.0/systemdrivers/InterruptController/src/qurt/DALInterruptController.c#1 $ 
...
) 
{
  ...
  { 
    SetWakeupInterruptTrigger(nInterruptVector,nTrigger,TRUE);  
  }
...
)
{
  ...
  SetWakeupInterruptTrigger(nInterruptVector,nTrigger,FALSE);  
