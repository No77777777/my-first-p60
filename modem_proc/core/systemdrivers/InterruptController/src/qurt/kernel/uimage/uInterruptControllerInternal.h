...
$Header: //components/rel/core.mpss/10.0/systemdrivers/InterruptController/src/qurt/kernel/uimage/uInterruptControllerInternal.h#1 $
...
/*
 * As an Upper limit we keep the maximum number of Interrupts as 200.
 * This number needs to be updated if the Interrupt number exceeds 200.
...
typedef struct
{
  ...
  uint32                         auIntLUT[MAX_NUMBER_OF_INTS];
