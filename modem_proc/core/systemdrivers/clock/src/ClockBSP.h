...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/src/ClockBSP.h#1 $
...
typedef struct ClockBSP
{
  ...
  ClockRemoteNodeType        *aRemoteNodes;      /**< Array of Remote Nodes. */
  uint32                      nNumRemoteNodes;   /**< Number of Remote Nodes. */
} ClockBSPType;
