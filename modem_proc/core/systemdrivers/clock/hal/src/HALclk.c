...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/src/HALclk.c#1 $
...
boolean HAL_clk_WaitForPowerDomainOff
(
  HAL_clk_PowerDomainDescType *pmPowerDomainDesc
)
{
...
boolean HAL_clk_IsSourceCalibrated
(
  HAL_clk_SourceDescType *pSource
)
{
...
)
{
  ...
  {
    return pSource->pmControl->SetRegSettings(pSource, pmSettings);
  }
}
