...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/inc/HALclk.h#3 $
...
Return:
  boolean - TRUE if the source is calibrated; FALSE otherwise.
...
Return:
  boolean - TRUE if calibration successful; FALSE otherwise.
