...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/hw/v1/HALclkSparkModemPLL.c#2 $
 ...
 */
static boolean HAL_clk_SparkModemPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static void    HAL_clk_SparkModemPLLDisable          ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static boolean HAL_clk_SparkModemPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_SparkModemPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static boolean HAL_clk_SparkModemPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode);
static void    HAL_clk_SparkModemPLLDetectPLLConfig  ( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pmConfig );
static boolean HAL_clk_SparkModemPLLEnableVote       ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_SparkModemPLLDisableVote      ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_SparkModemPLLIsVoteEnabled    ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_SparkModemPLLIsPLLConfigEqual ( const HAL_clk_PLLConfigType *pConfigA, const HAL_clk_PLLConfigType *pConfigB);
static boolean HAL_clk_SparkModemPLLIsCalibrated     ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_SparkModemPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
static void    HAL_clk_SparkModemPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_SparkModemPLLControl
 *
 * Control function array for the Spark PLLs.
 */
HAL_clk_SourceControlType HAL_clk_SparkModemPLLControl =
{
  .Enable          =  HAL_clk_SparkModemPLLEnable,
  .Disable         =  HAL_clk_SparkModemPLLDisable,
  .IsEnabled       =  HAL_clk_SparkModemPLLIsEnabled,
  .Config          =  HAL_clk_SparkModemPLLConfig,
  .ConfigPLL       =  HAL_clk_SparkModemPLLConfigPLL,
  .DetectPLLConfig =  HAL_clk_SparkModemPLLDetectPLLConfig,
  .EnableVote      =  HAL_clk_SparkModemPLLEnableVote,
  .DisableVote     =  HAL_clk_SparkModemPLLDisableVote,
  .IsVoteEnabled   =  HAL_clk_SparkModemPLLIsVoteEnabled,
  .IsPLLConfigEqual = HAL_clk_SparkModemPLLIsPLLConfigEqual,
  .IsCalibrated     = HAL_clk_SparkModemPLLIsCalibrated,
  .SetCalConfig     = HAL_clk_SparkModemPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_SparkModemPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_SparkModemPLLEnableVote
**
** ======================================================================== */
static boolean HAL_clk_SparkModemPLLEnableVote
(
...
)
{
  ...
  bResult =
    HAL_clk_ValidateRegSetTimeout(
      HAL_CLK_PLL_HWIO_ADDR(PLL_MODE_STATUS, pSource),
      HWIO_FMSK(PLL_MODE_STATUS, PLL_ACTIVE_FLAG),
      HAL_CLK_LOCK_TIMEOUT_US);

  return bResult;

} /* END HAL_clk_SparkModemPLLEnableVote */


/* ===========================================================================
**  HAL_clk_SparkModemPLLDisableVote
**
** ======================================================================== */

static void HAL_clk_SparkModemPLLDisableVote
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkModemPLLDisableVote */


/* ===========================================================================
**  HAL_clk_SparkModemPLLIsVoteEnabled
**
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLIsVoteEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkModemPLLIsVoteEnabled */


/* ===========================================================================
**  HAL_clk_SparkModemPLLEnableFromStandby
**
...
**  when the HAL_clk_SparkModemPLLDisableToStandby function was executed:
**  - PLL_L_VAL
**  - PLL_ALPHA_VAL
**  - PLL_ALPHA_VAL_U
...
static boolean HAL_clk_SparkModemPLLEnableFromStandby
(
  HAL_clk_SourceDescType *pSource
)
{
  ...
  bResult =
    HAL_clk_ValidateRegSetTimeout(
      HAL_CLK_PLL_HWIO_ADDR(PLL_MODE_STATUS, pSource),
      HWIO_FMSK(PLL_MODE_STATUS, PLL_LOCK_DET),
      HAL_CLK_LOCK_TIMEOUT_US);
...
} /* END HAL_clk_SparkModemPLLEnableFromStandby */


/* ===========================================================================
**  HAL_clk_SparkModemPLLEnableFromSaved
**
...
**
**  The following fields must have remained unchanged from the values present
**  when the HAL_clk_SparkModemPLLDisableToSaved function was executed:
**  - PLL_L_VAL
**  - PLL_ALPHA_VAL
**  - PLL_ALPHA_VAL_U
**  - PLL_USER_CTL[ALPHA_EN]
...
static boolean HAL_clk_SparkModemPLLEnableFromSaved
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
{
  uint32                  nModeVal, nUserCtlUVal,nUpdateVal;
  boolean                 bResult;
   ...
   */
  nUpdateVal = HWIO_FMSK(PLL_CMD, PLL_UPDATE);
  HAL_CLK_PLL_HWIO_OUT(PLL_CMD, pSource, nUpdateVal);
  ...
  bResult =
    HAL_clk_ValidateRegClearTimeout(
      HAL_CLK_PLL_HWIO_ADDR(PLL_CMD_STATUS, pSource),
      HWIO_FMSK(PLL_CMD_STATUS, PLL_UPDATE_STATUS),
      HAL_CLK_UPDATE_TIMEOUT_US);
...
} /* END HAL_clk_SparkModemPLLEnableFromSaved */


/* ===========================================================================
**  HAL_clk_SparkModemPLLEnableNormal
**
**  PLL initial bringup.
...
static boolean HAL_clk_SparkModemPLLEnableNormal
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkModemPLLEnableNormal */


/* ===========================================================================
**  HAL_clk_SparkModemPLLEnableFromFreeze
**
...
**  when the HAL_clk_SparkModemPLLEnableFromFreeze function was executed:
...
static boolean HAL_clk_SparkModemPLLEnableFromFreeze
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
{
  ...
  if (pnCalibration)
  {
     ...
     */
    nUpdateVal = HWIO_FMSK(PLL_CMD, PLL_UPDATE);
    HAL_CLK_PLL_HWIO_OUT(PLL_MODE, pSource, nUpdateVal);
...
} /* END HAL_clk_SparkModemPLLEnableFromFreeze */


/* ===========================================================================
**  HAL_clk_SparkModemPLLEnable
**
...
static boolean HAL_clk_SparkModemPLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
)
{
   ...
   */
  if (HAL_clk_SparkModemPLLIsEnabled(pSource))
  {
    return TRUE;
  }
  ...
  switch (eMode)
  {
    case HAL_CLK_SOURCE_DISABLE_MODE_STANDBY:
      bResult = HAL_clk_SparkModemPLLEnableFromStandby(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_SAVE:
      bResult = HAL_clk_SparkModemPLLEnableFromSaved(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_FREEZE:
      bResult = HAL_clk_SparkModemPLLEnableFromFreeze(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_NORMAL:
      bResult = HAL_clk_SparkModemPLLEnableNormal(pSource);
      break;
    default:
      bResult = FALSE;
      break;
...
} /* END HAL_clk_SparkModemPLLEnable */


/* ===========================================================================
**  HAL_clk_SparkModemPLLDisableToStandby
**
**  PLL shutdown to standby state.
**  This procedure leaves the bias on:
**    skips calibration when enabling via HAL_clk_SparkModemPLLEnableFromStandby.
...
static void HAL_clk_SparkModemPLLDisableToStandby
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkModemPLLDisableToStandby */


/* ===========================================================================
**  HAL_clk_SparkModemPLLDisableToSaved
**
**  PLL shutdown with save state.
**  When in the saved state, the bias is off and draws no power.
**  The calibration data is saved in *pData to be used later when
**  calling HAL_clk_SparkModemPLLEnableFromSaved.
**
**  This procedure applies only to Spark PLL type.
**
...
static void HAL_clk_SparkModemPLLDisableToSaved
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_SparkModemPLLDisableToSaved */


/* ===========================================================================
**  HAL_clk_SparkModemPLLDisableNormal
**
**  PLL shutdown.
**  When in the off state, the bias is off and draws no power.
...
static void HAL_clk_SparkModemPLLDisableNormal
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkModemPLLDisableNormal */


/* ===========================================================================
**  HAL_clk_SparkModemPLLDisableToFreeze
**
...
static void HAL_clk_SparkModemPLLDisableToFreeze
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_SparkModemPLLDisableToFreeze */


/* ===========================================================================
**  HAL_clk_SparkModemPLLDisable
**
**  The appropriate disable mode is executed based on the eMode argument.
**
** ======================================================================== */

static void HAL_clk_SparkModemPLLDisable
(
  HAL_clk_SourceDescType        *pSource,
  HAL_clk_SourceDisableModeType  eMode,
  void                          *pData
)
{
  ...
  {
    case HAL_CLK_SOURCE_DISABLE_MODE_STANDBY:
      HAL_clk_SparkModemPLLDisableToStandby(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_SAVE:
      HAL_clk_SparkModemPLLDisableToSaved(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_FREEZE:
      HAL_clk_SparkModemPLLDisableToFreeze(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_NORMAL:
      HAL_clk_SparkModemPLLDisableNormal(pSource);
      break;
    default:
      break;
  }

} /* END HAL_clk_SparkModemPLLDisable */


/* ===========================================================================
**  HAL_clk_SparkModemPLLIsEnabled
**
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkModemPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_SparkModemPLLConfig
**
** ======================================================================== */

static void HAL_clk_SparkModemPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
} /* END HAL_clk_SparkModemPLLConfig */


/* ===========================================================================
**  HAL_clk_SparkModemPLLConfigPLLSlew
**
**  Returns:
...
static boolean HAL_clk_SparkModemPLLConfigPLLSlew
(
  HAL_clk_SourceDescType      *pSource,
...
} /* END HAL_clk_SparkModemPLLConfigPLLSlew */



/* ===========================================================================
**  HAL_clk_SparkModemPLLConfigPLLNormal
**
**  Returns:
**    boolean - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
{
  ...
  bPLLEnabled = HAL_clk_SparkModemPLLIsEnabled(pSource);
  ...
  {
    HAL_clk_SparkModemPLLEnableNormal(pSource);
  }

  return TRUE;

} /* END HAL_clk_SparkModemPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_SparkModemPLLConfigPLL
**
**  Returns:
**    boolean - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  ...
  {
    bResult = HAL_clk_SparkModemPLLConfigPLLNormal(pSource, pConfig);
  }
  else if(eMode == HAL_CLK_SOURCE_CONFIG_MODE_SLEW)
  {
    bResult = HAL_clk_SparkModemPLLConfigPLLSlew(pSource, pConfig, TRUE);
  }
  else if (eMode == HAL_CLK_SOURCE_CONFIG_MODE_PENDING)
  {
    bResult = HAL_clk_SparkModemPLLConfigPLLSlew(pSource, pConfig, FALSE);
  }

  return bResult;

} /* END HAL_clk_SparkModemPLLConfigPLL */



/* ===========================================================================
**  HAL_clk_SparkModemPLLDetectPLLConfig
**
** ======================================================================== */

static void HAL_clk_SparkModemPLLDetectPLLConfig
(
  HAL_clk_SourceDescType *pSource,
...
} /* END HAL_clk_SparkModemPLLDetectPLLConfig */


/* ===========================================================================
**  HAL_clk_SparkModemPLLIsPLLConfigEqual
**
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLIsPLLConfigEqual
(
...
} /* END HAL_clk_SparkModemPLLIsPLLConfigEqual */


/* ===========================================================================
**  HAL_clk_SparkModemPLLIsCalibrated
**
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLIsCalibrated
(
  HAL_clk_SourceDescType *pSource
)
{
...
/* ===========================================================================
**  HAL_clk_SparkModemPLLSetCalConfig
**
** ======================================================================== */

static boolean HAL_clk_SparkModemPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_SparkModemPLLSetRegSettings
**
** ======================================================================== */

static void HAL_clk_SparkModemPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
...
} /* END HAL_clk_SparkModemPLLSetRegSettings */
