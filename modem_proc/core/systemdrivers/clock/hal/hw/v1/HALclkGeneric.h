...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/hw/v1/HALclkGeneric.h#1 $

when       who     what, where, why
--------   ---     -----------------------------------------------------------
10/04/18   shm     Added CLKREF_EN register field macros
...
/*
 * Common CLKREF register fields/masks (*_CLKREF_EN register)
 */
#define HAL_CLKREF_EN_REG_RX_QLINK_STATUS_FMSK                        0x80000000
#define HAL_CLKREF_EN_REG_RX_QLINK_STATUS_SHFT                        31
#define HAL_CLKREF_EN_REG_RXTAP_ENABLE_FMSK                           0x00000002
#define HAL_CLKREF_EN_REG_RXTAP_ENABLE_SHFT                           1
#define HAL_CLKREF_EN_REG_RX_QLINK_ENABLE_FMSK                        0x00000001
#define HAL_CLKREF_EN_REG_RX_QLINK_ENABLE_SHFT                        0
#define HAL_CLKREF_EN_REG_RXTAP_ENABLE_V2_FMSK                        0x00000004
#define HAL_CLKREF_EN_REG_RXTAP_ENABLE_V2_SHFT                        2
#define HAL_CLKREF_EN_REG_RX_QLINK_ENABLE_V2_FMSK                     0x00000002
#define HAL_CLKREF_EN_REG_RX_QLINK_ENABLE_V2_SHFT                     1
