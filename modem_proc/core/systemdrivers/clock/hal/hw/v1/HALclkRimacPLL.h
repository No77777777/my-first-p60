#ifndef __HALCLKRIMACPLL_H__
#define __HALCLKRIMACPLL_H__
/*
===========================================================================
*/
/**
  @file HALclkRimacPLL.h
...
/*
  ...
  $Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/hw/v1/HALclkRimacPLL.h#1 $
 ...
 */
static boolean HAL_clk_RimacPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static void    HAL_clk_RimacPLLDisable          ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static boolean HAL_clk_RimacPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_RimacPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static boolean HAL_clk_RimacPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode);
static void    HAL_clk_RimacPLLDetectPLLConfig  ( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pmConfig );
static boolean HAL_clk_RimacPLLIsPLLConfigEqual ( const HAL_clk_PLLConfigType *pConfigA, const HAL_clk_PLLConfigType *pConfigB);
static boolean HAL_clk_RimacPLLIsCalibrated     ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_RimacPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
static void    HAL_clk_RimacPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );

#endif  /* __HALCLKRIMACPLL_H__ */
