...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/hw/v1/HALclkSparkSilverPLL.h#1 $
...
#define HWIO_PLL_TEST_CTL_OFFS                              0x00000010
#define HWIO_PLL_TEST_CTL_U_OFFS                            0x00000014
