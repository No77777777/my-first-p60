...
FILE:         HALclkSparkSilverPLL.c

DESCRIPTION:
  This file contains the clock HAL code for the Spark PLL (11 LPP) control.
  These PLLs are of the Spark PLL (11 LPP) variety.

==============================================================================

                             Edit History

$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/hal/hw/v1/HALclkSparkSilverPLL.c#2 $

when       who     what, where, why
--------   ---     -----------------------------------------------------------
05/25/18   shm     First version for SM6150 codebase
...
#include "HALhwio.h"
#include "HALclkSparkSilverPLL.h"
 ...
 */
static boolean HAL_clk_SparkSilverPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static void    HAL_clk_SparkSilverPLLDisable          ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static boolean HAL_clk_SparkSilverPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_SparkSilverPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static boolean HAL_clk_SparkSilverPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode);
static boolean HAL_clk_MSSSilverConfigPLL             ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode);
static void    HAL_clk_SparkSilverPLLDetectPLLConfig  ( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pmConfig );
static boolean HAL_clk_SparkSilverPLLEnableVote       ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_SparkSilverPLLDisableVote      ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_SparkSilverPLLIsVoteEnabled    ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_SparkSilverPLLIsPLLConfigEqual ( const HAL_clk_PLLConfigType *pConfigA, const HAL_clk_PLLConfigType *pConfigB);
static boolean HAL_clk_SparkSilverPLLIsCalibrated     ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_SparkSilverPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
static void    HAL_clk_SparkSilverPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_SparkSilverPLLControl
 *
 * Control function array for the Spark PLLs.
 */
HAL_clk_SourceControlType HAL_clk_SparkSilverPLLControl =
{
  .Enable          =  HAL_clk_SparkSilverPLLEnable,
  .Disable         =  HAL_clk_SparkSilverPLLDisable,
  .IsEnabled       =  HAL_clk_SparkSilverPLLIsEnabled,
  .Config          =  HAL_clk_SparkSilverPLLConfig,
  .ConfigPLL       =  HAL_clk_SparkSilverPLLConfigPLL,
  .DetectPLLConfig =  HAL_clk_SparkSilverPLLDetectPLLConfig,
  .EnableVote      =  HAL_clk_SparkSilverPLLEnableVote,
  .DisableVote     =  HAL_clk_SparkSilverPLLDisableVote,
  .IsVoteEnabled   =  HAL_clk_SparkSilverPLLIsVoteEnabled,
  .IsPLLConfigEqual = HAL_clk_SparkSilverPLLIsPLLConfigEqual,
  .IsCalibrated     = HAL_clk_SparkSilverPLLIsCalibrated,
  .SetCalConfig     = HAL_clk_SparkSilverPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_SparkSilverPLLSetRegSettings,
};
 ...
 * Control function array for the Spark PLLs.
 */
HAL_clk_SourceControlType HAL_clk_MSSSilverPLLControl =
{
  .Enable          =  HAL_clk_SparkSilverPLLEnable,
  .Disable         =  HAL_clk_SparkSilverPLLDisable,
  .IsEnabled       =  HAL_clk_SparkSilverPLLIsEnabled,
  .Config          =  HAL_clk_SparkSilverPLLConfig,
  .ConfigPLL       =  HAL_clk_MSSSilverConfigPLL,
  .DetectPLLConfig =  HAL_clk_SparkSilverPLLDetectPLLConfig,
  .EnableVote      =  HAL_clk_SparkSilverPLLEnableVote,
  .DisableVote     =  HAL_clk_SparkSilverPLLDisableVote,
  .IsVoteEnabled   =  HAL_clk_SparkSilverPLLIsVoteEnabled,
...
/* ===========================================================================
**  HAL_clk_SparkSilverPLLEnableVote
**
** ======================================================================== */
static boolean HAL_clk_SparkSilverPLLEnableVote
(
...
} /* END HAL_clk_SparkSilverPLLEnableVote */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLDisableVote
**
** ======================================================================== */

static void HAL_clk_SparkSilverPLLDisableVote
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLDisableVote */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLIsVoteEnabled
**
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLIsVoteEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLIsVoteEnabled */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLEnableFromStandby
**
...
**  when the HAL_clk_SparkSilverPLLDisableToStandby function was executed:
**  - PLL_L_VAL
**  - PLL_ALPHA_VAL
**  - PLL_ALPHA_VAL_U
...
static boolean HAL_clk_SparkSilverPLLEnableFromStandby
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLEnableFromStandby */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLEnableFromSaved
**
...
**
**  The following fields must have remained unchanged from the values present
**  when the HAL_clk_SparkSilverPLLDisableToSaved function was executed:
**  - PLL_L_VAL
**  - PLL_ALPHA_VAL
**  - PLL_ALPHA_VAL_U
**  - PLL_USER_CTL[ALPHA_EN]
...
static boolean HAL_clk_SparkSilverPLLEnableFromSaved
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_SparkSilverPLLEnableFromSaved */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLEnableNormal
**
**  PLL initial bringup.
...
static boolean HAL_clk_SparkSilverPLLEnableNormal
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLEnableNormal */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLEnableFromFreeze
**
...
**  when the HAL_clk_SparkSilverPLLEnableFromFreeze function was executed:
...
static boolean HAL_clk_SparkSilverPLLEnableFromFreeze
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_SparkSilverPLLEnableFromFreeze */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLEnable
**
...
static boolean HAL_clk_SparkSilverPLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
)
{
   ...
   */
  if (HAL_clk_SparkSilverPLLIsEnabled(pSource))
  {
    return TRUE;
  }
  ...
  switch (eMode)
  {
    case HAL_CLK_SOURCE_DISABLE_MODE_STANDBY:
      bResult = HAL_clk_SparkSilverPLLEnableFromStandby(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_SAVE:
      bResult = HAL_clk_SparkSilverPLLEnableFromSaved(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_FREEZE:
      bResult = HAL_clk_SparkSilverPLLEnableFromFreeze(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_NORMAL:
      bResult = HAL_clk_SparkSilverPLLEnableNormal(pSource);
      break;
    default:
      bResult = FALSE;
      break;
...
} /* END HAL_clk_SparkSilverPLLEnable */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLDisableToStandby
**
**  PLL shutdown to standby state.
**  This procedure leaves the bias on:
**    skips calibration when enabling via HAL_clk_SparkSilverPLLEnableFromStandby.
...
static void HAL_clk_SparkSilverPLLDisableToStandby
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLDisableToStandby */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLDisableToSaved
**
**  PLL shutdown with save state.
**  When in the saved state, the bias is off and draws no power.
**  The calibration data is saved in *pData to be used later when
**  calling HAL_clk_SparkSilverPLLEnableFromSaved.
**
**  This procedure applies only to Spark PLL type.
**
...
static void HAL_clk_SparkSilverPLLDisableToSaved
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_SparkSilverPLLDisableToSaved */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLDisableNormal
**
**  PLL shutdown.
**  When in the off state, the bias is off and draws no power.
...
static void HAL_clk_SparkSilverPLLDisableNormal
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLDisableNormal */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLDisableToFreeze
**
...
static void HAL_clk_SparkSilverPLLDisableToFreeze
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_SparkSilverPLLDisableToFreeze */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLDisable
**
**  The appropriate disable mode is executed based on the eMode argument.
**
** ======================================================================== */

static void HAL_clk_SparkSilverPLLDisable
(
  HAL_clk_SourceDescType        *pSource,
  HAL_clk_SourceDisableModeType  eMode,
  void                          *pData
)
{
  ...
  {
    case HAL_CLK_SOURCE_DISABLE_MODE_STANDBY:
      HAL_clk_SparkSilverPLLDisableToStandby(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_SAVE:
      HAL_clk_SparkSilverPLLDisableToSaved(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_FREEZE:
      HAL_clk_SparkSilverPLLDisableToFreeze(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_NORMAL:
      HAL_clk_SparkSilverPLLDisableNormal(pSource);
      break;
    default:
      break;
  }

} /* END HAL_clk_SparkSilverPLLDisable */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLIsEnabled
**
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_SparkSilverPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLConfig
**
** ======================================================================== */

static void HAL_clk_SparkSilverPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
} /* END HAL_clk_SparkSilverPLLConfig */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLConfigPLLSlew
**
**  Returns:
...
static boolean HAL_clk_SparkSilverPLLConfigPLLSlew
(
  HAL_clk_SourceDescType      *pSource,
...
} /* END HAL_clk_SparkSilverPLLConfigPLLSlew */

/* ===========================================================================
**  HAL_clk_MSSSilverConfigPLLSlew
**
**  Returns:
**    boolean - TRUE if successfully configured.
**              FALSE if unable to detect that the PLL successfully locked.
...
static boolean HAL_clk_MSSSilverConfigPLLSlew
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
  boolean                      bTriggerUpdate
)
{
   ...
   */
  if ((nPrevPostDiv > 2) || (pConfig->PostDivs.Spark.nMain > 2))
  {
    return FALSE;
  }
  else
  {
	...
	if(pConfig->PostDivs.Spark.nMain == 2)
  {
      nUserVal |=
        ((pConfig->PostDivs.Spark.nMain - 1) << HWIO_SHFT(PLL_USER_CTL, POST_DIV_RATIO));
    }
  }
   ...
   */
  if ((nPrevPostDiv == 1) && (pConfig->PostDivs.Spark.nMain == 2))
  {
   ...
   */
  if ((nPrevPostDiv == 2) && (pConfig->PostDivs.Spark.nMain == 0))
  {
    HAL_CLK_PLL_HWIO_OUT(PLL_USER_CTL, pSource, nUserVal);
  }
...
} /* END HAL_clk_MSSSilverConfigPLLSlew */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLConfigPLLNormal
**
**  Returns:
**    boolean - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
{
  ...
  bPLLEnabled = HAL_clk_SparkSilverPLLIsEnabled(pSource);
   ...
   */
  if ((pConfig->PostDivs.Spark.nMain == 2) ||
      (pConfig->PostDivs.Spark.nMain == 4) ||
      (pConfig->PostDivs.Spark.nMain == 8) ||
      (pConfig->PostDivs.Spark.nMain == 16))
  {
    nUserVal |= HWIO_FVAL(PLL_USER_CTL,
                          POST_DIV_RATIO, (pConfig->PostDivs.Spark.nMain - 1));
  }

  /*
   * Program the Aux post-div value (dive - 1, 3, 5, and 7 are supported)
   */
  if ((pConfig->PostDivs.Spark.nAux == 3) ||
      (pConfig->PostDivs.Spark.nAux == 5) ||
      (pConfig->PostDivs.Spark.nAux == 7))
  {
    nUserVal |= HWIO_FVAL(PLL_USER_CTL,
                          AUX_POST_DIV_RATIO, (pConfig->PostDivs.Spark.nAux));
  }
  ...
  {
    HAL_clk_SparkSilverPLLEnableNormal(pSource);
  }

  return TRUE;

} /* END HAL_clk_SparkSilverPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLConfigPLL
**
**  Returns:
**    boolean - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  ...
  {
    bResult = HAL_clk_SparkSilverPLLConfigPLLNormal(pSource, pConfig);
  }
  else if(eMode == HAL_CLK_SOURCE_CONFIG_MODE_SLEW)
  {
    bResult = HAL_clk_SparkSilverPLLConfigPLLSlew(pSource, pConfig, TRUE);
  }
  else if (eMode == HAL_CLK_SOURCE_CONFIG_MODE_PENDING)
  {
    bResult = HAL_clk_SparkSilverPLLConfigPLLSlew(pSource, pConfig, FALSE);
  }

  return bResult;

} /* END HAL_clk_SparkSilverPLLConfigPLL */
...
static boolean HAL_clk_MSSSilverConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
  HAL_clk_SourceConfigMode     eMode
)
{
  ...
  {
    bResult = HAL_clk_MSSSilverConfigPLLSlew(pSource, pConfig, TRUE);
  }
  else if (eMode == HAL_CLK_SOURCE_CONFIG_MODE_PENDING)
  {
    bResult = HAL_clk_SparkSilverPLLConfigPLLSlew(pSource, pConfig, FALSE);
...
/* ===========================================================================
**  HAL_clk_SparkSilverPLLDetectPLLConfig
**
** ======================================================================== */

static void HAL_clk_SparkSilverPLLDetectPLLConfig
(
  HAL_clk_SourceDescType *pSource,
...
)
{
  ...
  /*
   * Spark PLL 11LPP is supporting VCO mode 2.1 which is identified by
   * USER_CTL[22]
   */
  if ((pConfig->nMode == SPARK_PLL_VCO2) &&
      HAL_CLK_PLL_HWIO_INF(PLL_USER_CTL, pSource, VCO_BOOST))
  {
...
} /* END HAL_clk_SparkSilverPLLDetectPLLConfig */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLIsPLLConfigEqual
**
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLIsPLLConfigEqual
(
...
} /* END HAL_clk_SparkSilverPLLIsPLLConfigEqual */


/* ===========================================================================
**  HAL_clk_SparkSilverPLLIsCalibrated
**
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLIsCalibrated
(
  HAL_clk_SourceDescType *pSource
)
{
  /*
   * Check CAL_L_VAL in USER_CTL_U
   */
  if( HAL_CLK_PLL_HWIO_INF(PLL_USER_CTL_U, pSource, CAL_L_VAL) !=0 )
  {
    return TRUE;
  }
  return FALSE;
...
/* ===========================================================================
**  HAL_clk_SparkSilverPLLSetCalConfig
**
** ======================================================================== */

static boolean HAL_clk_SparkSilverPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_SparkSilverPLLSetRegSettings
**
** ======================================================================== */

static void HAL_clk_SparkSilverPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
...
} /* END HAL_clk_SparkSilverPLLSetRegSettings */
