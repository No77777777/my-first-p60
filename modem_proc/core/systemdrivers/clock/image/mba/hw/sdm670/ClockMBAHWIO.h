...
/**
  ...
  'Include' filters applied: MSS_BUS_CRYPTO_CBCR[MPSS_PERPH] MSS_OFFLINE_PLL[MPSS_PERPH] MSS_AXI_DMA_CBCR[MPSS_PERPH] MSS_AXI_CRYPTO_CBCR[MPSS_PERPH] MSS_Q6_PBL_GPLL_ENA_VOTE[MPSS_PERPH] GCC_MSS_Q6_CLOCK_BRANCH_ENA_VOTE[GCC_CLK_CTL_REG] GCC_PRNG_AHB_CBCR[GCC_CLK_CTL_REG] GCC_DEHR_CBCR[GCC_CLK_CTL_REG] GCC_BLSP1_AHB_CBCR[GCC_CLK_CTL_REG] GCC_MSS_Q6_GPLL_ENA_VOTE[GCC_CLK_CTL_REG] MSS_QDSP6SS_CORE[MSS_QDSP6V65SS_PUB] MSS_QDSP6SS_PLL[MSS_QDSP6V65SS_PUB] MSS_QDSP6SS_STRAP_ACC[MSS_QDSP6V65SS_PUB] 

  Generation parameters: 
  { u'filename': u'ClockMBAHWIO.h',
    u'module-filter-exclude': { },
    u'module-filter-include': { u'GCC_CLK_CTL_REG': [ u'GCC_MSS_Q6_CLOCK_BRANCH_ENA_VOTE',
                                                      u'GCC_PRNG_AHB_CBCR',
                                                      u'GCC_DEHR_CBCR',
                                                      u'GCC_BLSP1_AHB_CBCR',
                                                      u'GCC_MSS_Q6_GPLL_ENA_VOTE'],
                                u'MPSS_PERPH': [ u'MSS_BUS_CRYPTO_CBCR',
                                                 u'MSS_OFFLINE_PLL',
                                                 u'MSS_AXI_DMA_CBCR',
                                                 u'MSS_AXI_CRYPTO_CBCR',
                                                 u'MSS_Q6_PBL_GPLL_ENA_VOTE'],
                                u'MSS_QDSP6V65SS_PUB': [ u'MSS_QDSP6SS_CORE',
                                                         u'MSS_QDSP6SS_PLL',
                                                         u'MSS_QDSP6SS_STRAP_ACC']},
    u'modules': [u'GCC_CLK_CTL_REG', u'MPSS_PERPH', u'MSS_QDSP6V65SS_PUB']}
*/
/*
  ===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mba/hw/sdm670/ClockMBAHWIO.h#1 $
...
#define HWIO_GCC_MSS_Q6_CLOCK_BRANCH_ENA_VOTE_1_RMSK                                               0x7fffffc0
...
#define HWIO_GCC_MSS_Q6_CLOCK_BRANCH_ENA_VOTE_1_TLMM_WEST_AHB_CLK_ENA_BMSK                         0x40000000
#define HWIO_GCC_MSS_Q6_CLOCK_BRANCH_ENA_VOTE_1_TLMM_WEST_AHB_CLK_ENA_SHFT                               0x1e
