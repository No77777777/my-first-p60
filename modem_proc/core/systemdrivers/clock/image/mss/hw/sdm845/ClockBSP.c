...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SDM845v1 (napali_1.0):
      GCC       : napali_clk_ctl_prj_v1.0_p3q3r36_post_mto_07132017_sdc2_clk [napali_gcc.r33]
      MSS_CC    : atlas_mss_5ca_10lp_napali_p3q2r14 [napali_mss_cc.r6]
      NavSS     : nav_ss_cc_v1.0 [napali_nav_ss_cc.r1]

    SDM845v2 (napali_2.0):
      GCC       : napali_clk_ctl_prj_v1.0_p3q3r124 [napali_v2_gcc.r7]
      MSS_CC    : atlas_mss_5ca_10lp_napali_v2_p3q3r6 [napali_mss_cc.r6]
      NavSS     : nav_ss_cc_v1.0 [napali_nav_ss_cc.r1]


==============================================================================

$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/sdm845/ClockBSP.c#1 $
...
{
  {  307200000, &ClockSource_XO, { 0, 0, 1, 16,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {.Fabia.nEven = 8}             }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },
};
...
/*
 * ClockSourceBSP_NAVSS_NAVPLL4PLL
 *
 * Used by:
 *   ClockSource_NAVSS_NAVPLL4PLL
 */
static const ClockSourceFreqConfigType ClockSourceBSP_NAVSS_NAVPLL4PLL[] =
{
...
static ClockSourceNodeType ClockSource_NAVSS_NAVPLL4PLL =
{
  .szName       = "nav_pll4_pll",
  .nFlags       = 0x0,
  .aBSP         = ClockSourceBSP_NAVSS_NAVPLL4PLL,
  .nBSPLen      = SIZEOF_ARRAY(ClockSourceBSP_NAVSS_NAVPLL4PLL),
  .pRail        = &ClockRail_VDDCX,
  .nConfigMask  = 0x0,
  .eDisableMode = HAL_CLK_SOURCE_DISABLE_MODE_NORMAL,
  .HALSource = {
...
{
  {    7372800, &ClockSource_GCC_GPLL0,                   { 6,     2,     384,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {    7372800, &ClockSource_GCC_GPLL0,                   { 6,     2,     384,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   14745600, &ClockSource_GCC_GPLL0,                   { 6,     2,     768,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   14745600, &ClockSource_GCC_GPLL0,                   { 6,     2,     768,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   19200000, &ClockSource_XO,                          { 0,     2,     0,     0,     0x00 }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },                                                            /* Mux[0] = BI_TCXO */
  {   29491200, &ClockSource_GCC_GPLL0,                   { 6,     2,     1536,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   29491200, &ClockSource_GCC_GPLL0,                   { 6,     2,     1536,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   32000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     8,     75,    0x01 }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   32000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     8,     75,    0x01 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   38400000, &ClockSource_GCC_GPLL0,                   { 6,     2,     16,    125,   0x02 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   48000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     4,     25,    0x02 }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   48000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     4,     25,    0x03 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   64000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     16,    75,    0x04 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   64000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     16,    75,    0x03 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   80000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     4,     15,    0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[6] = GPLL0_OUT_EVEN */
  {   96000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     8,     25,    0x05 }, RAIL_VOLTAGE_LEVEL_SVS,        {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {   96000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     8,     25,    0x04 }, RAIL_VOLTAGE_LEVEL_SVS,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  100000000, &ClockSource_GCC_GPLL0,                   { 6,     6,     0,     0,     0x06 }, RAIL_VOLTAGE_LEVEL_SVS,        {{0x01, 0x00}, {0x02, 0x00}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  100000000, &ClockSource_GCC_GPLL0,                   { 6,     6,     0,     0,     0x05 }, RAIL_VOLTAGE_LEVEL_SVS,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  102400000, &ClockSource_GCC_GPLL0,                   { 6,     2,     128,   375,   0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  112000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     28,    75,    0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  117964800, &ClockSource_GCC_GPLL0,                   { 6,     2,     6144,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  120000000, &ClockSource_GCC_GPLL0,                   { 6,     5,     0,     0,     0x06 }, RAIL_VOLTAGE_LEVEL_NOM,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[6] = GPLL0_OUT_EVEN */
  {  128000000, &ClockSource_GCC_GPLL0,                   { 1,     2,     16,    75,    0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0x02, 0x00}, {0xFF, 0xFF}, CHIPINFO_FAMILY_SDM845}, },      /* Mux[1] = GPLL0_OUT_MAIN */
};
...
{
  {   75000000, &ClockSource_GCC_GPLL0,                   { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },                                                            /* Mux[1] = CLK_SRC_BUS_DIV */
};
...
{
  {  288000000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 0] /* 288.0  */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
  {  460800000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 1] /* 460.0  */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
  {  614400000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 2] /* 614.0  */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
  {  787200000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 3] /* 787.0  */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
  {  940800000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 4] /* 940.0  */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
  { 1190400000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 5] /* 1190.0 */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
};
...
{
  {    3840000, &ClockSource_XO,                          { 0,     10,    0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },                                                            /* Mux[0] = XO */
  {    4800000, &ClockSource_XO,                          { 0,     8,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },                                                            /* Mux[0] = XO */
};
