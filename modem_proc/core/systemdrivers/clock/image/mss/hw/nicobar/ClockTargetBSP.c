...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/nicobar/ClockTargetBSP.c#1 $
...
ClockImageBSPType ClockImageBSP =
{
  ...
  .bCPUCXIpeakEnabled = TRUE, /* TRUE if Modem is client of CX-iPeak */
};
