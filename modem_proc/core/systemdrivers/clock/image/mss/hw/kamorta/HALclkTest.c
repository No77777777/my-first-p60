...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/kamorta/HALclkTest.c#3 $
...
/*=========================================================================
      MSS_CC Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxMSSCC
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                   nMuxSel
)
{
  HWIO_OUTF(MSS_CC_DEBUG_MUX_MUXR, MUX_SEL, nMuxSel);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlMSSCC =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxMSSCC,
};


/*=========================================================================
      MSS_CC_Q6 Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxMSSCCQ6
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                   nMuxSel
)
{
  HWIO_OUTF(MSS_QDSP6SS_TEST_CLK_CTL, DBG_CLK_SEL, nMuxSel);
  HWIO_OUTF(MSS_QDSP6SS_TEST_CLK_CTL, Q6_DBG_CLK_EN, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlMSSCCQ6 =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxMSSCCQ6,
};


/*=========================================================================
      NAV_CC Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxNAVCC
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                   nMuxSel
)
{
  HWIO_OUTF(MSS_NAV_CC_DEBUG_MUX_MUXR, MUX_SEL, nMuxSel);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlNAVCC =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxNAVCC,
};
