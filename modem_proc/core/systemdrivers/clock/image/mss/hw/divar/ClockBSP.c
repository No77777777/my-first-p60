...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM6225v1 (divar_1.0):
      PLL_HSR   : 2.0
      GCC       : divar_gcc_z_divar_clk_ctl_1.0_p3q2r23_fp12 [divar_gcc.r2]
      MSS_CC    : habanero_mss_divar_1.0_p3q3r2 [divar_mss_cc.r1]
      NAV_CC    : nav_ss_divar_1.0_p2q1r1.0 [divar_nav_cc.r0]


  Generated using the following clockdrivergen settings:

CLOCKDRIVERGEN_CONFIG = \
{'chip_aliases': ['divar_1.0'],
 ...
 'generators': [{'options': {'cc_clock_flags': {},
                             'clock_flags': {'gcc_wcss_ahb_s0_clk': ['SUPPRESSIBLE'],
                                             'gpll2': ['READ_ONLY'],
                                             'mss_cc_bit_coxm_clk_src': ['DOMAIN_WAIT_FOR_ROOT_OFF'],
                                             'mss_cc_bus_pre_mux_clk_src': ['SUPPRESSIBLE'],
                                             'mss_cc_modem_bus_clk_src': ['SUPPRESSIBLE'],
                                             'mss_cc_uim0_mnd_clk_src': ['DOMAIN_WAIT_FOR_ROOT_OFF'],
                                             'mss_cc_uim1_mnd_clk_src': ['DOMAIN_WAIT_FOR_ROOT_OFF'],
                                             'mss_cc_xo_clk_src': ['DOMAIN_WAIT_FOR_ROOT_OFF'],
                                             'q6_core_clk_src': ['SUPPRESSIBLE']},
                             'driver_flags': ['LOG_CLOCK_FREQ_CHANGE',
                                              'LOG_SOURCE_STATE_CHANGE'],
                             'env': 'mss',
                             'hal_ctl_structs': {'clk_silver': 'HAL_clk_MSSSilverClockControl',
                                                 'nav_ss_gdsc': 'HAL_clk_NavPowerDomainControl'},
                             'include_divider': {'mss_cc_uim_div_clk_src': 'MSS_CC_UIM_DIV_CDIVR'},
                             'include_file': {'HALclkPLLSettings.h': True},
                             'npa_rename': {'/pmic/client/xo': '/xo/cxo'},
                             'npa_resources': {'/clk/mss/config_bus': {'clock': 'mss_cc_bridge_bus_clk',
                                                                       'init_state': 72000},
                                               '/xo/cxo': {'init_state': 1}},
                             'pll_config_flags': {'mpll1': ['EARLY_OUTPUT_ENABLE',
                                                            'AUX_OUTPUT_ENABLE']},
...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/divar/ClockBSP.c#5 $
...
extern HAL_clk_SourceControlType          HAL_clk_RimacPLLControl;
...
{
  {  600000000, &ClockSource_XO, { 0, 0, 1, 31,  0x00004000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {.Lucid.nEven = 2, .Lucid.nOdd = 3} }, RAIL_VOLTAGE_LEVEL_LOW_SVS,   },
};
static const ClockSourceFreqConfigType ClockSourceBSPCal_GCC_GPLL0[] =
{
...
{
  {  768000000, &ClockSource_XO, { 0, 0, 1, 40,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {.Lucid.nEven = 2}           }, RAIL_VOLTAGE_LEVEL_SVS,       },
};
...
{
  {  336000000, &ClockSource_XO, { 0, 0, 1, 17,  0x00008000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_LOW_SVS,   },
  {  633600000, &ClockSource_XO, { 0, 0, 1, 33,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS,       },
...
{
  { 1152000000, &ClockSource_XO, { 0, 0, 1, 60,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {.Rimac.nMain = 2}           }, RAIL_VOLTAGE_LEVEL_LOW_SVS,       },
};
...
{
  {  499200000, &ClockSource_XO, { 0, 0, 1, 26,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_LOW_SVS,   },
  {  614400000, &ClockSource_XO, { 0, 0, 1, 32,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_LOW_SVS,   },
  ...
  { 1267200000, &ClockSource_XO, { 0, 0, 1, 66,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS_L1,    },
};
...
{
  {  403200000, &ClockSource_XO, { 0, 0, 1, 21,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_LOW_SVS,   },
  {  595200000, &ClockSource_XO, { 0, 0, 1, 31,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_LOW_SVS,   },
  ...
  {  864000000, &ClockSource_XO, { 0, 0, 1, 45,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS,       },
  {  921600000, &ClockSource_XO, { 0, 0, 1, 48,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS,       },
  {  998400000, &ClockSource_XO, { 0, 0, 1, 52,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_SVS,       },
};
...
static ClockSourceNodeType ClockSource_GCC_GPLL0 =
{
  ...
  .pCalibrationFreqConfig     = ClockSourceBSPCal_GCC_GPLL0,
  .nCalibrationFreqConfigLen  = SIZEOF_ARRAY(ClockSourceBSPCal_GCC_GPLL0),
};
...
static ClockSourceNodeType ClockSource_MSSCC_MPLL1 =
{
  ...
  .HALSource = {
    ...
    .pmControl      = &HAL_clk_RimacPLLControl,
  },
...
{
  {    7372800, &ClockSource_GCC_GPLL0,                   { 2,     2,     384,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   14745600, &ClockSource_GCC_GPLL0,                   { 2,     2,     768,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   19200000, &ClockSource_XO,                          { 0,     2,     0,     0,     0x00 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[0] = BI_TCXO */
  {   29491200, &ClockSource_GCC_GPLL0,                   { 2,     2,     1536,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   32000000, &ClockSource_GCC_GPLL0,                   { 2,     2,     8,     75,    0x01 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   48000000, &ClockSource_GCC_GPLL0,                   { 2,     2,     4,     25,    0x02 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   64000000, &ClockSource_GCC_GPLL0,                   { 2,     2,     16,    75,    0x03 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   75000000, &ClockSource_GCC_GPLL0,                   { 2,     8,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   80000000, &ClockSource_GCC_GPLL0,                   { 2,     2,     4,     15,    0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {   96000000, &ClockSource_GCC_GPLL0,                   { 2,     2,     8,     25,    0x04 }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {  100000000, &ClockSource_GCC_GPLL0,                   { 2,     6,     0,     0,     0x05 }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {  102400000, &ClockSource_GCC_GPLL0,                   { 2,     2,     128,   375,   0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {  112000000, &ClockSource_GCC_GPLL0,                   { 2,     2,     28,    75,    0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {  117964800, &ClockSource_GCC_GPLL0,                   { 2,     2,     6144,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {  120000000, &ClockSource_GCC_GPLL0,                   { 2,     5,     0,     0,     0x06 }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[2] = GCC_GPLL0_OUT_EVEN_PWRGRP35_CLKGEN_ACGC_CLK */
  {  128000000, &ClockSource_GCC_GPLL6,                   { 4,     6,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[4] = GCC_GPLL6_OUT_EVEN_PWRGRP2_CLKGEN_ACGC_CLK */
};
...
static ClockMuxConfigType ClockDomainBSP_MSSCC_MSSCCMODEMBUSPREMUX[] =
{
  ...
  {  576000000, &ClockSource_MSSCC_MPLL1,                 { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[1] = MPLL1_OUT_MAIN */
};
...
{
  {  403200000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 0] /* 403.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
  {  595200000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 1] /* 595.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
  {  729600000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 2] /* 729.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
  {  806400000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 3] /* 806.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
  {  864000000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 4] /* 864.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
  {  921600000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM_L1,     {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 5] /* 921.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
  {  998400000, &ClockSource_MSSCC_MPLL3,                 { 4,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{0}}, &ClockSourceBSP_MSSCC_MPLL3[ 6] /* 998.0  */ },        /* Mux[4] = MPLL3_OUT_EARLY */
};
...
{
  {  499200000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 0] /* 499.0  */ },        /* Mux[2] = MPLL2_OUT_EARLY */
  {  614400000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 1] /* 614.0  */ },        /* Mux[2] = MPLL2_OUT_EARLY */
  {  787200000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 2] /* 787.0  */ },        /* Mux[2] = MPLL2_OUT_EARLY */
  {  921600000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 3] /* 921.0  */ },        /* Mux[2] = MPLL2_OUT_EARLY */
  { 1036800000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM_L1,     {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 4] /* 1036.0 */ },        /* Mux[2] = MPLL2_OUT_EARLY */
  { 1171200000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 5] /* 1171.0 */ },        /* Mux[2] = MPLL2_OUT_EARLY */
  { 1267200000, &ClockSource_MSSCC_MPLL2,                 { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR_L1,     {{0}}, &ClockSourceBSP_MSSCC_MPLL2[ 6] /* 1267.0 */ },        /* Mux[2] = MPLL2_OUT_EARLY */
};
...
static ClockNodeType aClocks[] =
{
  ...
  /*-----------------------------------------------------------------------*/
  {
    .szName    = "gcc_qupv3_wrapper_1_bcr",
    .pDomain   = &ClockDomain_GCC_CLOCKDRIVERGENNOSOURCE,
    .pDebugMux = NULL,
    .nUniqueId = 0x5217940D,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { 0, HWIO_ADDR(GCC_QUPV3_WRAPPER_1_BCR), {0, 0} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = HAL_CLK_NO_DEBUG_MUX_SEL,
    },
  },
   ...
   */
  {
    .szName    = "mss_cc_modem_bus_pre_mux_clk_src",
    .pDomain   = &ClockDomain_MSSCC_MSSCCMODEMBUSPREMUX,
    .pDebugMux = NULL,
    .nUniqueId = 0xB0BC3860,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { 0, HWIO_ADDR(MSS_CC_BUS_BCR), {0, 0} },
      .pmControl    = NULL,
