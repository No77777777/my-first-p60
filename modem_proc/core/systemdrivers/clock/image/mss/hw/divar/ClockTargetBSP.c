...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/divar/ClockTargetBSP.c#1 $
...
ClockImageBSPType ClockImageBSP =
{
  ...
  .bCPUCXIpeakEnabled = FALSE, /* TRUE if Modem is client of CX-iPeak */
};
