...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM6150v1 (talos_1.0):
      PLL_HSR   : 4.0
      GCC       : z_talos_clk_ctl_P3Q3R33.0 [talos_gcc.r14]
      MSS_CC    : atlas_mss_3ca_11lpp_talos_p3q3r38.3 [talos_mss_cc.r5]
      NAV_CC    : nav_ss_talos_1.0_p3q3r13 [talos_nav_cc.r2]


==============================================================================

$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/sm6150/ClockBSP.c#1 $
...
extern HAL_clk_ClockControlType           HAL_clk_mQlinkClkRefControl;
...
static const ClockSourceRegSettingsType ClockSourceRegSettings_MSSCC_QDSP6SSPLL[] =
{
  {
    .HALSettings = {
      .nConfigCtl   = 0x4001055B,
...
{
  {  600000000, &ClockSource_XO, { 0, 2, 1, 31,  0x4000000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_MIN_SVS,   },
};
...
/*
 * ClockSourceBSP_NAVCC_NAVPLL4PLL
 *
 * Used by:
 *   ClockSource_NAVCC_NAVPLL4PLL
 */
static const ClockSourceFreqConfigType ClockSourceBSP_NAVCC_NAVPLL4PLL[] =
{
  {  672000000, &ClockSource_XO, { 0, 2, 1, 35,  0x00000000, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                      }, RAIL_VOLTAGE_LEVEL_MIN_SVS,   },
};
...
static ClockSourceNodeType ClockSource_MSSCC_QDSP6SSPLL =
{
  ...
  .pRegSettings               = ClockSourceRegSettings_MSSCC_QDSP6SSPLL,
  .nRegSettingsLen            = SIZEOF_ARRAY(ClockSourceRegSettings_MSSCC_QDSP6SSPLL),
};

static ClockSourceNodeType ClockSource_NAVCC_NAVPLL4PLL =
{
  .szName       = "nav_pll4_pll",
  .nFlags       = 0x0,
  .aBSP         = ClockSourceBSP_NAVCC_NAVPLL4PLL,
  .nBSPLen      = SIZEOF_ARRAY(ClockSourceBSP_NAVCC_NAVPLL4PLL),
  .pRail        = &ClockRail_VDDCX,
  .nConfigMask  = CLOCK_CONFIG_PLL_AUX_OUTPUT_ENABLE,
  ...
  .pCalibrationFreqConfig     = ClockSourceBSP_NAVCC_NAVPLL4PLL,
  .nCalibrationFreqConfigLen  = SIZEOF_ARRAY(ClockSourceBSP_NAVCC_NAVPLL4PLL),
  .pRegSettings               = ClockSourceRegSettings_MSSCC_QDSP6SSPLL,
  .nRegSettingsLen            = SIZEOF_ARRAY(ClockSourceRegSettings_MSSCC_QDSP6SSPLL),
};
...
{
  {    7372800, &ClockSource_GCC_GPLL0,                   { 6,     2,     384,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   14745600, &ClockSource_GCC_GPLL0,                   { 6,     2,     768,   15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   19200000, &ClockSource_XO,                          { 0,     2,     0,     0,     0x00 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[0] = BI_TCXO */
  {   29491200, &ClockSource_GCC_GPLL0,                   { 6,     2,     1536,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   32000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     8,     75,    0x01 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   48000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     4,     25,    0x02 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   64000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     16,    75,    0x03 }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   75000000, &ClockSource_GCC_GPLL0,                   { 6,     8,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   80000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     4,     15,    0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {   96000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     8,     25,    0x04 }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {  100000000, &ClockSource_GCC_GPLL0,                   { 1,     12,    0,     0,     0x05 }, RAIL_VOLTAGE_LEVEL_SVS,        },                                                            /* Mux[1] = GPLL0_OUT_MAIN */
  {  102400000, &ClockSource_GCC_GPLL0,                   { 6,     2,     128,   375,   0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {  112000000, &ClockSource_GCC_GPLL0,                   { 6,     2,     28,    75,    0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {  117964800, &ClockSource_GCC_GPLL0,                   { 6,     2,     6144,  15625, 0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {  120000000, &ClockSource_GCC_GPLL0,                   { 6,     5,     0,     0,     0x06 }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[6] = GPLL0_OUT_AUX2_DIV */
  {  128000000, &ClockSource_GCC_GPLL6,                   { 2,     6,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        },                                                            /* Mux[2] = GPLL6_OUT_MAIN */
};
...
{
  {  403200000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     4,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{0}}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 3] /* 806.4  */ },   /* Mux[1] = QDSP6SS_PLL_OUT_MAIN */
  {  595200000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        {{0}}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 0] /* 595.2  */ },   /* Mux[1] = QDSP6SS_PLL_OUT_MAIN */
  {  729600000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     {{0}}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 2] /* 729.6  */ },   /* Mux[1] = QDSP6SS_PLL_OUT_MAIN */
  ...
  {  921600000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM_L1,     {{0}}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 5] /* 921.6  */ },   /* Mux[1] = QDSP6SS_PLL_OUT_MAIN */
  {  998400000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{0}}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 6] /* 998.4  */ },   /* Mux[1] = QDSP6SS_PLL_OUT_MAIN */
};
...
static ClockNodeType aClocks[] =
{
  ...
  /*-----------------------------------------------------------------------*/
  {
    .szName    = "gcc_rx4_qlink_clkref_en",
    .pDomain   = &ClockDomain_GCC_CLOCKDRIVERGENNOSOURCE,
    .pDebugMux = NULL,
    .nUniqueId = 0x27B28C26,
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(GCC_RX4_QLINK_CLKREF_EN), 0, {0, 0} },
      .pmControl    = &HAL_clk_mQlinkClkRefControl,
