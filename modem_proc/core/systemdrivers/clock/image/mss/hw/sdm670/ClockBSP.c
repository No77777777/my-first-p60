...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SDM670v1 (napaliq_1.0):
      GCC       : z_napaliq_clk_ctl_V1.0_p3q2r57.5" [napaliq_gcc.r3]
      MSS_CC    : atlas_mss_3ca_10lp_napaliq_04_17_2017_p3q3_frequency_plan [napali_mss_cc.r6]
      NavSS     : nav_ss_napali_2.0_p3q3r6.4 [napali_v2_nav_ss_cc.r1]


==============================================================================

$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/sdm670/ClockBSP.c#1 $
...
static ClockMuxConfigType ClockDomainBSP_MSSCC_CLKSRCQ6[] =
{
  ...
  { 1056000000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM_L1,     {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 5] /* 1056.0 */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
  { 1190400000, &ClockSource_MSSCC_QDSP6SSPLL,            { 1,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{ 0 }}, &ClockSourceBSP_MSSCC_QDSP6SSPLL[ 6] /* 1190.0 */ },  /* Mux[1] = QDSP6SS_PLL_OUT_EVEN */
};
