...
$Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/sdm670/HALclkTest.c#1 $
...
/*=========================================================================
      NAVSS Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxNAVSS
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlNAVSS =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxNAVSS,
};
