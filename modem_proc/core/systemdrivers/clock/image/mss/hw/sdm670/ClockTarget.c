...
/*
  ...
  ====================================================================
  $Header: //components/rel/core.mpss/10.0/systemdrivers/clock/image/mss/hw/sdm670/ClockTarget.c#1 $
...
DALResult Clock_InitTarget (ClockDrvCtxt *pDrvCtxt)
{
  ...
  /*
   * Set divider to div-4 to provide MPSS with a 150MHz source.
   */
  HWIO_OUTF(GCC_MSS_PLL0_MAIN_DIV_CDIVR, CLK_DIV, 3);
  HWIO_OUTF(MSS_BUS_CFG_RCGR, SRC_DIV, 3);
