...
$Header: //components/rel/core.mpss/10.0/settings/debugtrace/hwevent/config/sdm845/hwevent_config.c#1 $
...
{0x408200C,0x408200C,0x0},//HWIO_MSS_QDSP6SS_PWRDBG_CTL_ADDR
{0x0413004C,0x041300CC,0x0},//MSS_QDSP6SS_RSCC_HW_EVENT_MUXm_SELECT_DRVd
{0x0420004C,0x042000CC,0x0},//MSS_RSCC_HW_EVENT_MUXm_SELECT_DRVd
{NULL,NULL,NULL}
};
