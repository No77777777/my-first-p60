 ...
 *  
 *    Platform: Agatti.XX.1.0
 *    Revision: AGATTI.XX.1.0-MODEM-00005
 *    Template Version: 
 *    $Header: //components/rel/core.mpss/10.0/settings/pmic/pm/config/kamorta/pm_config_pam_agatti.c#4 $ 
 *    $DateTime: 2021/05/08 01:42:46 $  $Author: pwbldsvc $
 *  
 *  &copy; Copyright July 16, 2020 Qualcomm Technologies Incorporated, All Rights Reserved
 */
...
#define PMIC_NPA_CLIENT_NODE_WCN_RF_CLK "/node/pmic/client/wcn_rf_clk"
...
pm_pam_rf1_tech_1x_a_ldo5 [] =
{
   ...
   // Comments: RF_CLK1 on, L16/LDO18 off (use for GPS only scenarios)
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_VREG_MODE_LPM,  /**< [Retention, LPM (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_MICRO_VOLT, 4, 1232000, /**< [X uV] -> max aggregation. */
    },
   // Mode: PMIC_NPA_MODE_ID_GENERIC_ACTIVE
   // Comments: RF_CLK1 on, L16/LDO18 on (use if non GPS tech active)
   {
...
pm_pam_rf1_tech_1x_a_ldo20 [] =
{
   ...
   // Comments: RF_CLK1 on, L16/LDO18 off (use for GPS only scenarios)
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_VREG_MODE_NPM,  /**< [Retention, LPM (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_MICRO_VOLT, 4, 2864000, /**< [X uV] -> max aggregation. */
    },
   // Mode: PMIC_NPA_MODE_ID_GENERIC_ACTIVE
   // Comments: RF_CLK1 on, L16/LDO18 on (use if non GPS tech active)
   {
...
pm_pam_rf1_tech_1x_rails_info [] =
{
   ...
   {
      (void*)pm_pam_rf1_tech_1x_a_ldo5,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_tech_1x_a_ldo11,
      PM_NPA_VREG_LDO
   },
   {
   ...
   {
      (void*)pm_pam_rf1_tech_1x_a_ldo20,
      PM_NPA_VREG_LDO
   },
};
...
pm_pam_rf1_tech_gps_rails_info [] =
{
   ...
   {
      (void*)pm_pam_rf1_tech_gps_a_ldo5,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_tech_gps_a_ldo11,
      PM_NPA_VREG_LDO
   },
   {
...
static const pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo10 [] =
{
   // Mode: PMIC_NPA_MODE_ID_GENERIC_OFF
   // Comments: RF_SLEEP
   {
...
static const pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo11 [] =
{
   // Mode: PMIC_NPA_MODE_ID_GENERIC_OFF
   // Comments: RF_SLEEP
   {
...
static const pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo15 [] =
{
   // Mode: PMIC_NPA_MODE_ID_GENERIC_OFF
   // Comments: RF_SLEEP
   {
...
static const pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo16 [] =
{
   // Mode: PMIC_NPA_MODE_ID_GENERIC_OFF
   // Comments: RF_SLEEP
   {
...
pm_pam_rf1_tech_gps_elna_rails_info [] =
{
   ...
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo10,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo11,
      PM_NPA_VREG_LDO
   },
   {
   ...
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo15,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo16,
      PM_NPA_VREG_LDO
   },
};
...
{
   {
      (void*)pm_pam_rf1_tech_init_a_ldo11,
      PM_NPA_VREG_LDO
   },
};
...
pm_pam_rf1_tech_vref_msm_a_vs2 [] =
{
   // Mode: PMIC_NPA_MODE_ID_GENERIC_OFF
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_DISABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
...
{
   {
      (void*)pm_pam_rf1_tech_vref_msm_a_vs2,
      PM_NPA_VREG_VS
   },
};
...
{
   {
      (void*)pm_pam_uim1_activity_a_ldo18,
      PM_NPA_VREG_LDO
   },
};
...
{
   {
      (void*)pm_pam_uim1_enable_a_ldo18,
      PM_NPA_VREG_LDO
   },
};
...
{
   {
      (void*)pm_pam_uim2_activity_a_ldo19,
      PM_NPA_VREG_LDO
   },
};
...
{
   {
      (void*)pm_pam_uim2_enable_a_ldo19,
      PM_NPA_VREG_LDO
   },
};
...
{
   {
      (void*)pm_pam_wcn_activity_a_smps3,
      PM_NPA_VREG_SMPS
   },
   {
      (void*)pm_pam_wcn_activity_a_smps4,
      PM_NPA_VREG_SMPS
   },
};
...
{
   {
      (void*)pm_pam_wcn_core_a_ldo10,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_wcn_core_a_ldo13,
      PM_NPA_VREG_LDO
   },
};
...
pm_pam_wcn_pa_a_ldo22 [] =
{
   ...
   // Mode: PMIC_NPA_MODE_ID_GENERIC_LOW_LV
   // Comments: Enable, 2.85V,LPM
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_VREG_MODE_LPM,  /**< [Retention, LPM (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_MICRO_VOLT, 4, 2850000, /**< [X uV] -> max aggregation. */
    },
   // Mode: PMIC_NPA_MODE_ID_GENERIC_LOW_MV
   // Comments: Enable, 3.1V,LPM
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_VREG_MODE_LPM,  /**< [Retention, LPM (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_MICRO_VOLT, 4, 3100000, /**< [X uV] -> max aggregation. */
    },
   // Mode: PMIC_NPA_MODE_ID_GENERIC_LOW_HV
   // Comments: Enable, 3.2V,LPM
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_VREG_MODE_LPM,  /**< [Retention, LPM (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_MICRO_VOLT, 4, 3200000, /**< [X uV] -> max aggregation. */
    },
};
static const pm_npa_pam_client_cfg_type
...
static const pm_npa_pam_client_cfg_type
pm_pam_wcn_rf_clk_rails_info [] =
{
   {
      (void*)pm_pam_wcn_rf_clk_a_clk_buff5,
      PM_NPA_CLK_BUFF
   },
};

static npa_node_dependency
pm_pam_deps_wcn_rf_clk [] =
{
      PMIC_NPA_NODE_DEP_LIST( A,  rfclk, 5 ),
};
...
pm_npa_pam_node_rsrcs [] =
{
   ...
   },
   {
      ...
      PMIC_NPA_MODE_ID_GENERIC_LOW_HV,   // Maximum Value
      NPA_RESOURCE_SINGLE_CLIENT | NPA_RESOURCE_DRIVER_UNCONDITIONAL, // Resource Attribute
   ...
   {
      PMIC_NPA_GROUP_ID_WCN_RF_CLK, // Resource Name
      PMIC_NPA_MODE_ID_GENERIC_ACTIVE,   // Maximum Value
      NPA_RESOURCE_SINGLE_CLIENT | NPA_RESOURCE_DRIVER_UNCONDITIONAL, // Resource Attribute
      (void*) pm_pam_wcn_rf_clk_rails_info, // Resource User Data
      PMIC_NPA_CLIENT_NODE_WCN_RF_CLK, // Node Name
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_pam_deps_wcn_rf_clk, // Node Dependency
      NPA_ARRAY_SIZE(pm_pam_deps_wcn_rf_clk),  // Deps Count
   },
   {
