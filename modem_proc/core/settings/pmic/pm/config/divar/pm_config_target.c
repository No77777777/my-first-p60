...
$Header: //components/rel/core.mpss/10.0/settings/pmic/pm/config/divar/pm_config_target.c#2 $ 
...
static uint32   num_of_gpio[] =      {9,  12};
...
static uint32   num_of_pbs_client[] ={2,  2};
static uint32   num_of_sdam[]       ={5,  4};
