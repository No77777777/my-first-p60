 ...
 *  
 *    Platform: Divar.XX.1.0
 *    Revision: DIVAR.XX.1.0-MODEM-00004
 *    Template Version: 
 *    $Header: //components/rel/core.mpss/10.0/settings/pmic/pm/config/divar/pm_config_pam.c#5 $ 
 *    $DateTime: 2021/10/14 01:48:44 $  $Author: pwbldsvc $
 *  
 *  &copy; Copyright Oct. 14, 2021 Qualcomm Technologies Incorporated, All Rights Reserved
 */
...
pm_pam_uim1_enable_a_smps6 [] =
{
   // Mode: PMIC_NPA_MODE_ID_UIM_STANDBY
   // Comments: UIM_NO_VOTE
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_DISABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_SMPS_SOFTWARE_MODE, 4, PM_NPA_VREG_MODE_LPM,  /**< [Retention, LPM, AUTO(default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_MICRO_VOLT, 4, 0, /**< [X uV] -> max aggregation. */
    },
   // Mode: PMIC_NPA_MODE_ID_UIM_ACTIVE_CLASS_C_LOW
   // Comments: UIM_CLASS_C_LOW
...
pm_pam_uim1_enable_rails_info [] =
{
   ...
   {
      (void*)pm_pam_uim1_enable_a_smps6,
      PM_NPA_VREG_SMPS
   },
};
...
pm_pam_uim2_enable_rails_info [] =
{
   ...
   {
      (void*)pm_pam_uim2_enable_a_smps6,
      PM_NPA_VREG_SMPS
   },
};
