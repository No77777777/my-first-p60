 ...
 * @file:  SpmiBlock.c
 * 
 * Copyright (c) 2013-2017,2020 by Qualcomm Technologies 
 * Incorporated. All Rights Reserved. 
 * 
 * $DateTime: 2020/04/28 03:26:25 $
 * $Header: //components/rel/core.mpss/10.0/settings/pmic/spmi/config/kamorta/SpmiBlock.c#2 $
 * $Change: 23606458 $ 
 * 
 *                              Edit History
 * Date     Description
