...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/nicobar/internal/VAdcInternalSettings.c#1 $
...
extern const VAdcChannelConfigType gVAdcChannelsPMI455[];
extern const uint32 guNumVAdcChannelsPMI455;
...
const VAdcBspType VAdcBspPMI455[] =
{
   {
      .paChannels              = gVAdcChannelsPMI455,
      .puNumChannels           = &guNumVAdcChannelsPMI455,
