...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/agatti/VAdcSettings.c#1 $
...
const AdcIntTableType gVAdcSysThermTable_agatti =
{
   .pTable  = adcMap_NTCG104EF104FB,
   .uLength = ARRAY_LENGTH(adcMap_NTCG104EF104FB),
};

const AdcIntTableType gVAdcXoThermTable_agatti =
{
...
/*----------------------------------------------------------------------------
 * PM6250_WAIMEA Settings
 * -------------------------------------------------------------------------*/
/*
 * VAdc channel configuration.
 */
const VAdcChannelConfigType gVAdcChannels_agatti[] =
{
   /* VPH_PWR (VPH_PWR pin) */
   {
   ...
   /* XO_THERM (XO_THERM pin) */
   {
      ...
      .uPullUp                   = 100000,
      .pIntTable                 = &gVAdcXoThermTable_agatti,
   },
   ...
   /* PA_THERM (AMUX_1 pin) */
   {
      ...
      .eScalingMethod            = VADC_SCALE_THERMISTOR,
      .uPullUp                   = 100000,
      .pIntTable                 = &gVAdcSysThermTable_agatti,
   },
   
   /* SYS_THERM1 (Quiet_Therm) (AMUX_2 pin) */
   {
...
const VAdcAveragedChannelConfigType gVAdcAveragedChannels_agatti[] =
{
   {
...
const uint32 guNumVAdcChannels_agatti = ARRAY_LENGTH(gVAdcChannels_agatti);
const uint32 guNumVAdcAveragedChannels_agatti = ARRAY_LENGTH(gVAdcAveragedChannels_agatti);

/*----------------------------------------------------------------------------
 * PMI455_NEBULA Settings
 * -------------------------------------------------------------------------*/
/*
 * VAdc channel configuration.
 */
const VAdcChannelConfigType gVAdcChannelsPMI455_agatti[] =
{
   /* VPH_PWR (VPH_PWR pin) */
   {
      .pszName                   = ADC_INPUT_VPH_PWR,
...
const uint32 guNumVAdcChannelsPMI455_agatti = ARRAY_LENGTH(gVAdcChannelsPMI455_agatti);
