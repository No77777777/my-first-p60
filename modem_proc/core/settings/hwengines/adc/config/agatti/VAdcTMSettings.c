...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/agatti/VAdcTMSettings.c#1 $
 ...
 * -------------------------------------------------------------------------*/
extern const AdcIntTableType gVAdcXoThermTable_agatti;
...
const VAdcTMMeasConfigType gVAdcTMMeasurements_agatti[] =
{
...
const VAdcTMCommonConfigType gVAdcTMCommonConfig_agatti =
{
...
const uint32 guNumVAdcTMMeas_agatti = ARRAY_LENGTH(gVAdcTMMeasurements_agatti);
