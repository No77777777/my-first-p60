...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/divar/VAdcSettings.c#1 $
 ...
 * VAdc channel configuration.
 */
const VAdcChannelConfigType gVAdcChannelsPM7xxxB[] =
{
...
const uint32 guNumVAdcChannelsPM7xxxB = ARRAY_LENGTH(gVAdcChannelsPM7xxxB);
