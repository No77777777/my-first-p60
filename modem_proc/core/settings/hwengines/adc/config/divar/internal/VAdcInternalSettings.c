...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/divar/internal/VAdcInternalSettings.c#1 $
...
extern const VAdcChannelConfigType gVAdcChannelsPM7xxxB[];
extern const uint32 guNumVAdcChannelsPM7xxxB;
 ...
 * PM7xxxB Settings
 * -------------------------------------------------------------------------*/
static const VAdcGpioChannelMappingType vAdcGpioChannelMappingsPM7xxxB[] =
{
   {
...
const VAdcBspType VAdcBspPM7xxxB[] =
{
   {
      .paChannels              = gVAdcChannelsPM7xxxB,
      .puNumChannels           = &guNumVAdcChannelsPM7xxxB,
      .paAveragedChannels      = NULL,
      .puNumAveragedChannels   = NULL,
      .paGpioChannelMappings   = vAdcGpioChannelMappingsPM7xxxB,
      .uNumGpioChannelMappings = ARRAY_LENGTH(vAdcGpioChannelMappingsPM7xxxB),
      .bUsesInterrupts         = FALSE,
      .uFullScale_code         = 0x70E4,
      .uFullScale_uV           = 1875000,
      .uReadTimeout_us         = 500000,
