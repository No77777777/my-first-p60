/*============================================================================
  ...
  DEPENDENCIES: None
                ...
                Copyright (c) 2012, 2015-2016, 2018 Qualcomm Technologies, Inc.
                All Rights Reserved.
...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/kamorta/internal/AdcInternalSettings.c#2 $
...
static const AdcPhysicalDeviceType adcPhysicalDevices_noPMI[] =
{
   {
      .pszDevName = "/vadc/pm6250",
...
const AdcBspType AdcBsp_noPMI[] =
{
   {
      .paAdcPhysicalDevices = adcPhysicalDevices_noPMI,
      .uNumPhysicalDevices  = ARRAY_LENGTH(adcPhysicalDevices_noPMI),
