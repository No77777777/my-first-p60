...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/kamorta/VAdcSettings.c#1 $
 ...
 * VAdc channel configuration.
 */
const VAdcChannelConfigType gVAdcChannelsPMI455[] =
{
   /* VPH_PWR (VPH_PWR pin) */
   {
      .pszName                   = ADC_INPUT_VPH_PWR,
...
const uint32 guNumVAdcChannelsPMI455 = ARRAY_LENGTH(gVAdcChannelsPMI455);
