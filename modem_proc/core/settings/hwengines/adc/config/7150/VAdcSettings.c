...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/hwengines/adc/config/7150/VAdcSettings.c#1 $
 ...
 * VAdc channel configuration.
 */
const VAdcChannelConfigType gVAdcChannelsPM855A[] =
{
   /* VPH_PWR (VPH_PWR pin) */
   {
      .pszName                   = ADC_INPUT_VPH_PWR,
...
const uint32 guNumVAdcChannelsPM855A = ARRAY_LENGTH(gVAdcChannelsPM855A);
