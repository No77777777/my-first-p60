...
$Header: //components/rel/core.mpss/10.0/settings/mproc/ipc_router/interface/ipc_router_settings.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/25/17   vr      Initial version; establish settings interface
===========================================================================*/
