...
$Header: //components/rel/core.mpss/10.0/settings/mproc/glink/xport_smem/config/855/xport_smem_spss.c#1 $
...
{
  outpdw( XPORT_SMEM_SP_SCSR_CLR_REG, 1 );
}
