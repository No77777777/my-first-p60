/*===========================================================================
            ...
            GLink SMEM transport 24 MPSS Configuration Structures
...
$Header: //components/rel/core.mpss/10.0/settings/mproc/glink/xport_smem/config/855/xport_smem_devcfg_modem.c#1 $
