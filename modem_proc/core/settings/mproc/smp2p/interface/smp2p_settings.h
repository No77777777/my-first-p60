...
$Header: //components/rel/core.mpss/10.0/settings/mproc/smp2p/interface/smp2p_settings.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/24/17    vr     Initial version; created settings interface for SMP2P
===========================================================================*/
