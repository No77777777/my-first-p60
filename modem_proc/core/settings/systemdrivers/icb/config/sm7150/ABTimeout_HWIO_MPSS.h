#ifndef __ABTIMEOUT_HWIO_MPSS_H__
#define __ABTIMEOUT_HWIO_MPSS_H__
/*
===========================================================================
*/
/**
  @file ABTimeout_HWIO_MPSS.h
  @brief Auto-generated HWIO interface include file.

  Reference chip release:
    SM7150 (Moorea) [moorea_v1.0_p3q2r49]
 
  This file contains HWIO register definitions for the following modules:
    MSS_CONF_BUS_TIMEOUT
    TCSR_TCSR_REGS

  'Include' filters applied: TIMEOUT_SLAVE_GLB_EN[TCSR_TCSR_REGS] TCSR_TIMEOUT_INTR_STATUS[TCSR_TCSR_REGS] TCSR_TIMEOUT_INTR_MSS_ENABLE[TCSR_TCSR_REGS] BASE[MSS_CONF_BUS_TIMEOUT] 

  Generation parameters: 
  { u'filename': u'ABTimeout_HWIO_MPSS.h',
    u'header': u'#include "msmhwiobase.h"',
    u'module-filter-exclude': { },
    u'module-filter-include': { u'MSS_CONF_BUS_TIMEOUT': [u'BASE'],
                                u'TCSR_TCSR_REGS': [ u'TIMEOUT_SLAVE_GLB_EN',
                                                     u'TCSR_TIMEOUT_INTR_STATUS',
                                                     u'TCSR_TIMEOUT_INTR_MSS_ENABLE']},
    u'modules': [u'MSS_CONF_BUS_TIMEOUT', u'TCSR_TCSR_REGS'],
...
/*
  ...
  $Header: //components/rel/core.mpss/10.0/settings/systemdrivers/icb/config/sm7150/ABTimeout_HWIO_MPSS.h#1 $
...
#define MSS_CONF_BUS_TIMEOUT_REG_BASE                          (MODEM_TOP_BASE      + 0x001b0000)
#define MSS_CONF_BUS_TIMEOUT_REG_BASE_SIZE                     0x1000
#define MSS_CONF_BUS_TIMEOUT_REG_BASE_USED                     0x34
#define MSS_CONF_BUS_TIMEOUT_REG_BASE_OFFS                     0x001b0000
...
#endif /* __ABTIMEOUT_HWIO_MPSS_H__ */
