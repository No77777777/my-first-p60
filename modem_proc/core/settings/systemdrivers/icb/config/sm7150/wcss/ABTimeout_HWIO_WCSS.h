...
/**
  ...
  { u'filename': u'ABTimeout_HWIO_WCSS.h',
    u'header': u'#include "msmhwiobase.h"',
    u'module-filter-exclude': { },
    u'module-filter-include': { u'TCSR_TCSR_REGS': [u'TIMEOUT_SLAVE_GLB_EN'],
                                u'WCSS_ECAHB_TSLV': [u'BASE'],
                                u'WCSS_HM_A_NOC_CFG_WIFI_NOC': [ u'WCSS_HM_A_NOC_CFG_WNOC_OBS_ID_COREID',
                                                                 u'WCSS_HM_A_NOC_CFG_WNOC_SBM_ID_COREID'],
                                u'WCSS_HM_A_WCSS_WAHB_AHB_TSLV_WFSS_WAHB_AHB_TSLV': [ u'BASE'],
                                u'WCSS_HM_A_WIFI_APB_1_A_WCSS_WAHB_APB_TSLV_WFSS_WAHB_APB_TSLV': [ u'BASE'],
                                u'WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG': [ u'QDSP_ERROR_INTR_ENABLES_SET',
                                                                               u'QDSP_ERROR_INTR_MASKED_STATUS',
                                                                               u'WAKEUP_INTR_ENABLES_SET'],
                                u'WCSS_SR': [ u'WCSS_SR_SR_INTERRUPT_ENABLE',
                                              u'WCSS_SR_SR_INTERRUPT_STATUS']},
    u'modules': [ u'WCSS_ECAHB_TSLV',
                  u'WCSS_HM_A_WCSS_WAHB_AHB_TSLV_WFSS_WAHB_AHB_TSLV',
                  u'WCSS_HM_A_WIFI_APB_1_A_WCSS_WAHB_APB_TSLV_WFSS_WAHB_APB_TSLV',
                  u'WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG',
                  u'WCSS_SR',
                  u'TCSR_TCSR_REGS',
                  u'WCSS_HM_A_NOC_CFG_WIFI_NOC'],
...
/*
  ...
  $Header: //components/rel/core.mpss/10.0/settings/systemdrivers/icb/config/sm7150/wcss/ABTimeout_HWIO_WCSS.h#1 $
...
#define WCSS_ECAHB_TSLV_REG_BASE_OFFS                                 0x00010000
...
#define WCSS_HM_A_WCSS_WAHB_AHB_TSLV_WFSS_WAHB_AHB_TSLV_REG_BASE_OFFS              0x00101000
...
#define WCSS_HM_A_WIFI_APB_1_A_WCSS_WAHB_APB_TSLV_WFSS_WAHB_APB_TSLV_REG_BASE_OFFS              0x00272000
...
#define WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS                                                                0x002f0000
...
#define HWIO_WCSS_HM_A_WIFI_APB_3_A_WCMN_QDSP_ERROR_INTR_ENABLES_SET_OFFS                                                     (WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS + 0x00000088)
...
#define HWIO_WCSS_HM_A_WIFI_APB_3_A_WCMN_QDSP_ERROR_INTR_ENABLES_SET_2_OFFS                                                   (WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS + 0x0000008c)
...
#define HWIO_WCSS_HM_A_WIFI_APB_3_A_WCMN_QDSP_ERROR_INTR_MASKED_STATUS_OFFS                                                   (WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS + 0x000000a0)
...
#define HWIO_WCSS_HM_A_WIFI_APB_3_A_WCMN_QDSP_ERROR_INTR_MASKED_STATUS_2_OFFS                                                 (WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS + 0x000000a4)
...
#define HWIO_WCSS_HM_A_WIFI_APB_3_A_WCMN_WAKEUP_INTR_ENABLES_SET_1_OFFS                                                       (WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS + 0x000000ec)
...
#define HWIO_WCSS_HM_A_WIFI_APB_3_A_WCMN_WAKEUP_INTR_ENABLES_SET_2_OFFS                                                       (WCSS_HM_A_WIFI_APB_3_A_WCMN_MAC_WCMN_REG_REG_BASE_OFFS + 0x000000f0)
...
#define WCSS_SR_REG_BASE_OFFS                                                                   0x00020000

#define HWIO_WCSS_SR_SR_INTERRUPT_STATUS_ADDR                                                   (WCSS_SR_REG_BASE      + 0x0000000c)
#define HWIO_WCSS_SR_SR_INTERRUPT_STATUS_OFFS                                                   (WCSS_SR_REG_BASE_OFFS + 0x0000000c)
...
#define HWIO_WCSS_SR_SR_INTERRUPT_ENABLE_OFFS                                                   (WCSS_SR_REG_BASE_OFFS + 0x00000010)
...
#define WCSS_HM_A_NOC_CFG_WIFI_NOC_REG_BASE_SIZE                                                              0x8000
#define WCSS_HM_A_NOC_CFG_WIFI_NOC_REG_BASE_USED                                                              0x4028
#define WCSS_HM_A_NOC_CFG_WIFI_NOC_REG_BASE_OFFS                                                              0x00180000

#define HWIO_WCSS_HM_A_NOC_CFG_WNOC_OBS_ID_COREID_ADDR                                                        (WCSS_HM_A_NOC_CFG_WIFI_NOC_REG_BASE      + 0x00000000)
#define HWIO_WCSS_HM_A_NOC_CFG_WNOC_OBS_ID_COREID_OFFS                                                        (WCSS_HM_A_NOC_CFG_WIFI_NOC_REG_BASE_OFFS + 0x00000000)
...
#define HWIO_WCSS_HM_A_NOC_CFG_WNOC_SBM_ID_COREID_OFFS                                                        (WCSS_HM_A_NOC_CFG_WIFI_NOC_REG_BASE_OFFS + 0x00000200)
