...
/**
  ...
  { 'filename': 'ABTimeout_HWIO_MPSS.h',
    ...
    'module-filter-include': { 'MSS_CONF_BUS_TIMEOUT': ['BASE'],
                               'TCSR_TCSR_REGS': [ 'TIMEOUT_SLAVE_GLB_EN',
                                                   'TCSR_TIMEOUT_INTR_STATUS',
                                                   'TCSR_TIMEOUT_INTR_MSS_ENABLE']},
    'modules': ['MSS_CONF_BUS_TIMEOUT', 'TCSR_TCSR_REGS']}
*/
/*
  ===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/settings/systemdrivers/icb/config/kamorta/ABTimeout_HWIO_MPSS.h#2 $
  $DateTime: 2019/05/20 08:08:22 $
  $Author: pwbldsvc $
...
#define TCSR_TCSR_REGS_REG_BASE_USED                                                                      0x3a020
