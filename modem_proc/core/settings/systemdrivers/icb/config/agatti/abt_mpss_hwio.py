...
if __name__ == "__main__":
  ...
  hwiogen = Popen([r"python", r"\\ben\corebsp_labdata_0001\sysdrv\hwio\HWIOGen.py", r"--cfg="+__file__, r"--flat=..\..\..\..\..\api\systemdrivers\hwio\kamorta\ARM_ADDRESS_FILE.FLAT"], shell=True)
  hwiogen.wait()
