...
$Header: //components/rel/core.mpss/10.0/settings/systemdrivers/icb/config/sm6150/icbcfg_query_data.c#1 $ 
...
icbcfg_mem_region_type map_ddr_regions_sdm640[] =
{
  { 0x080000000ULL, 0x400000000ULL },
};

/* Translation block base addresses. */
uint8 *trans_bases_sdm640[] = 
{
  (uint8 *)HWIO_ADDR(LLCC0_LLCC_BEAC0_LLCC_BEAC_ADDR_TRANSLATOR_CFG),
  (uint8 *)HWIO_ADDR(LLCC0_LLCC_BEAC1_LLCC_BEAC_ADDR_TRANSLATOR_CFG),
};

icbcfg_device_config_type sdm640 =
{
  /* Chip version information for this device data. */
  CHIPINFO_FAMILY_SDM640,   /**< Chip family */
  false,                       /**< Exact match for version? */
  CHIPINFO_VERSION(0,0),       /**< Chip version */

  /* Device information. */
  ARRAY_SIZE(map_ddr_regions_sdm640), /**< Number of regions in the DDR map */
  map_ddr_regions_sdm640,             /**< Array of mappable DDR regions */
  6,                                     /**< Number of mapping segments. */
  2,                                     /**< Number of channels. */
  36,                                    /**< Address width in bits. */
  ICBCFG_ADDR_TRANS_LLCC,                /**< Address translator hardware type. */
  trans_bases_sdm640,                 /**< Translation block base addresses. */
...
/* Definitions list */
icbcfg_device_config_type *configs_sdm640[] =
{
  &sdm640,
};
