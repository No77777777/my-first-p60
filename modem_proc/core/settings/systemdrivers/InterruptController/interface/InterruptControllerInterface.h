...
$Header: //components/rel/core.mpss/10.0/settings/systemdrivers/InterruptController/interface/InterruptControllerInterface.h#1 $ 
 ...
 */
#define IST_THREAD_PRIORITY_BASE    174
#define IST_THREAD_HIGHEST_PRIORITY 180
#define IST_THREAD_HIGHEST_FW_PRIORITY 255

#define IST_THREAD_SET_FW_PRIORITY(x) ((x) | 0x80)
#define IST_THREAD_IS_FW_PRIORITY(x)  ((x) & 0x80)
