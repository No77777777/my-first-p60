...
/**
  This enum is used to determine direct connect base 
 */
typedef enum{
  GPIOMGR_DIRECTCONNECT_LPASS,     /**< LPASS direct connect base. */
  GPIOMGR_DIRECTCONNECT_SENSORS,   /**< SENSORS direct connect base . */
  GPIOMGR_DIRECTCONNECT_MSS,       /**< MSS direct connect base . */
 
  GPIOMGR_DIRECTCONNECT_NONE,     /**<Default  direct connect base . */
/** @cond */
  PLACEHOLDER_GPIOMgrDirectConnectBaseType = 0x7f
/** @endcond */
}GPIOMgrDirectConnectBaseType;
