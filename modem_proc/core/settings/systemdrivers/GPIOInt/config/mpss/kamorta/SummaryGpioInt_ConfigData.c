...
$Header: //components/rel/core.mpss/10.0/settings/systemdrivers/GPIOInt/config/mpss/kamorta/SummaryGpioInt_ConfigData.c#1 $
...
//#include "DALReg.h"
//#include "SummaryGpioIntInterface.h"
