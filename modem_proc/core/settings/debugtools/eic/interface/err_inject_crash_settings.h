...
$Header: //components/rel/core.mpss/10.0/settings/debugtools/eic/interface/err_inject_crash_settings.h#2 $
...
typedef enum
{
  ...
  ERR_INJECT_WDOG_NMI,
  ERR_INJECT_WDOG_NMI_MULTITHREADED,
  ERR_INJECT_WDOG_BARK,
