...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs_qmi_put_get/client/src/fs_qmi_client.c#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2019-11-22   vm    Add instance id support to qmi put get service
...
struct fs_qmi_client_object_type
{
  ...
  /* The instance id for the qmi service */
  unsigned int service_instance_id;
...
fs_qmi_client_init (void)
{
  ...
  fs_qmi_client_obj.service_instance_id = 0;
#ifdef EFS_QMI_PUT_GET_SERVICE_INSTANCE_ID
  fs_qmi_client_obj.service_instance_id = EFS_QMI_PUT_GET_SERVICE_INSTANCE_ID;
#endif
...
fs_qmi_client_open (void)
{
  ...
  err = qmi_client_init_instance (fs_qmi_client_obj.service_object,
                                  fs_qmi_client_obj.service_instance_id,
                                  NULL, NULL,
