 ...
 *
 * Copyright (C) 2011-2014,2015,2017,2019 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs_qmi_put_get/service/src/fs_qmi_service.c#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2019-11-20   vm    Add instance id support to qmi put get service
2017-30-10   as    Fixed compiler warnings
...
struct fs_qmi_service_object_type
{
 ...
 /* Time in msecs when the service is done processing the last request. */
  ...
  /* The server instance id for the qmi service. */
  unsigned int server_instance_id;
...
fs_qmi_service_init (void)
{
  ...
  fs_qmi_service_obj.server_instance_id = 0;
#ifdef EFS_QMI_PUT_GET_SERVICE_INSTANCE_ID
  fs_qmi_service_obj.server_instance_id = EFS_QMI_PUT_GET_SERVICE_INSTANCE_ID;
#endif

  /* Registers function for handling QMI Message Query Requests */
  (void) qmi_si_register_object(service_obj,
                                fs_qmi_service_obj.server_instance_id,
