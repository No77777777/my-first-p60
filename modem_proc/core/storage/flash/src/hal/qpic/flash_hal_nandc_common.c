 ...
 *
 * Copyright (c) 2011-2012,2014-2015, 2017 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/10.0/storage/flash/src/hal/qpic/flash_hal_nandc_common.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 ...
 * 01/21/15     sb      Add dummy CW to page layout
...
//  }
  ...
  if (FLASH_HAL_HW_ECC_DISABLE == priv_data->ecc_state)
  {
    ...
    /* Bad block byte number */
    FLASH_BAD_BLOCK_BYTE_NUM(priv_data, NAND_16BIT_ECC_BAD_BLOCK_BYTE_NUM);
