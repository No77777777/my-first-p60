 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/10.0/storage/flash/src/hal/qpic/flashi_hal_nandc.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 ...
 * 01/21/15     sb      Increase HAL mem for QPIC reset WA 
