 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/10.0/storage/flash/src/hal/qpic/flash_hal_nandc_predef_bam_exec.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 08/11/15     sb      Enhance ONFI param page read to read multiple copies
 * 08/11/15     sb      Remove WA for QPIC reset issue
 * 03/19/15     sb      Pass pysical address of dummy cw buffer to QPIC 
 * 01/21/15     sb      Read 2 dummy CW along with actual page
