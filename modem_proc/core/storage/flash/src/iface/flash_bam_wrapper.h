 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/10.0/storage/flash/src/iface/flash_bam_wrapper.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 01/25/17     eo      Update QPIC base address
 * 08/11/15     sb      Remove WA for QPIC reset issue
 * 01/21/15     sb      Increase BAM CMD desc FIFO size for QPIC reset WA 
...
#define NAND_BAM_BASE_PHY_ADDR (QPIC_QPIC_XPU3_BASE_PHYS + 0x4000)
