 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/10.0/storage/flash/src/dal/flash_nor_entry.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 ...
 * 01/18/12     sv      Add power management support for SPI NOR
...
static int nor_entry_mem_init(void)
{
  ...
  dal_mem_size = flash_get_property(FLASH_NOR_DRV_WS_BUFF_SIZE_ID);
