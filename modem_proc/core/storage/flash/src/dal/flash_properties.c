 ...
 *
 * Copyright (c) 2011-2013, 2015,2016 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *   $Header: //components/rel/core.mpss/10.0/storage/flash/src/dal/flash_properties.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 10/12/16     eo      Update default EBI2 clock speed to 100Mhz
