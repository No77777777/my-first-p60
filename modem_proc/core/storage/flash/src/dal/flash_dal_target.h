 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/10.0/storage/flash/src/dal/flash_dal_target.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 01/21/15     sb      Increase HAL WS for QPIC reset WA 
...
*/
  ...
  #define FLASH_MULTI_RW_SUPPORT_COUNT    1
      ...
      #define FLASH_HAL_WS_BUFF_SIZE_BYTES    2048  
    #else
      /* HAL Memory allocated */
      #define FLASH_HAL_WS_BUFF_SIZE_BYTES    3072  
    #endif
  #else
