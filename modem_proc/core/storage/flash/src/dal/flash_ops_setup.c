 ...
 *
 * $Header: //components/rel/core.mpss/10.0/storage/flash/src/dal/flash_ops_setup.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 * when         who     what, where, why
 * --------     ---     ----------------------------------------------
 * 01/25/17     eo      fix spi-nor deep pwr down featurization  
