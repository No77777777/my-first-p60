 ...
 * order.
 *
 * $Header: //components/rel/core.mpss/10.0/storage/flash/src/dal/flash_nor_entry.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 01/03/11     sv      Update flash profile include file name
