...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/flash_scrub/src/flash_scrub_config_i.h#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2017-07-12   rp    Restrict SBL-image to first 2MB regardless partition-size.
...
/**----------------------------------------------------------------------------
 * Restrict the SBL-image within the first 2MB of the nand-flash regardless
 * of the SBL-partition-size because PBL searches for SBL only within the
 * first 2MB of the nand-flash.
----------------------------------------------------------------------------**/
