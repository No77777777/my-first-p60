...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/fs_mfse/src/fs_mfse_task.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
fs_mfse_task (dword parm)
{
  ...
  FS_MSG_MED_0 ("FS_MFSE Service started");
  ...
  for (;;)
  {
    ...
    FS_MSG_MED_0 ("FS_MFSE_HANDLE_EVENT received");
