...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/tftp/client/inc/tftp_client_config.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
#include "tftp_config_i.h"
  ...
  #define TFTP_CLIENT_MAX_CLIENTS    20
#endif
  ...
  #elif defined (TFTP_CDSP_BUILD)
    #define TFTP_CLIENT_SERVER_INSTANCE_ID TFTP_SERVER_INSTANCE_ID_MSM_CDSP
  #endif
  ...
  #elif defined (TFTP_CDSP_BUILD)
    #define TFTP_CLIENT_SERVER_INSTANCE_ID TFTP_SERVER_INSTANCE_ID_MDM_CDSP
