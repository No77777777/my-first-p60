...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/tftp/os/inc/tftp_socket.h#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $
...
enum tftp_socket_result_type
{
  ...
  TFTP_SOCKET_RESULT_RCVD_CTRL_PKT,
};
...
enum tftp_socket_result_type tftp_socket_update_family (void);
...
enum tftp_socket_result_type
tftp_socket_set_tx_timeout (tftp_socket *socket_handle, uint32 timeout_sec);
