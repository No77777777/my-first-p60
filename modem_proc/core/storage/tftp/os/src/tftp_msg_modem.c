...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/tftp/os/src/tftp_msg_modem.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
#include "msg.h"
  ...
  #define TFTP_DIAG_PROC_NAME "CDSP "
#else
