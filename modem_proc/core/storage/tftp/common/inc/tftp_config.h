...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/tftp/common/inc/tftp_config.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2018-05-06   eo    Port to CDSP image.
...
enum tftp_server_instance_id_type
{
  ...
  TFTP_SERVER_INSTANCE_ID_MSM_CDSP     = 9,
  TFTP_SERVER_INSTANCE_ID_MDM_CDSP     = 10,
  TFTP_SERVER_INSTANCE_ID_MAX          = 11,
};
...
/* IPCR pkt size is 8k. Leaving space for IPCR header keep tftp blk at 7.5K */
  ...
  #define TFTP_SERVER_DEFAULT_TIMEOUT_IN_MS    300
#endif
  ...
  #define TFTP_CLIENT_TIMEOUT_IN_MS            1000
#endif
  ...
  #define TFTP_MAX_PKT_RETRY_COUNT             2
#endif
