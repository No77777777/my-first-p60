...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/tftp/common/inc/tftp_protocol.h#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2019-11-20   vm    Add support for upstreamed qsockets.
2019-11-20   vm    Store TFTP packets in RAM for debug
2017-08-17   np    Improve the debug-logs to store TX/RX packets details
