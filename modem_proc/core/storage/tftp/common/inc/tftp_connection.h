...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/tftp/common/inc/tftp_connection.h#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $
...
enum tftp_connection_result
{
  ...
  TFTP_CONNECTION_RESULT_RCVD_CTRL_PKT,
};
