...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/src/fs_profile.h#2 $ $DateTime: 2021/12/06 03:42:39 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2021-11-22   ms    Add global efs_logging_enabled flag and storage location
...
/* Global efs logging flag to enable logging*/
uint32 efs_logging_enabled;

/* Defines the flash memory address where the efs logging flag is stored. */
#define EFS_LOGGING_STATE_FILE "/storage/item_file/efslog/enable.uint"
