 ...
 * Copyright (C) 2009-2013, 2015-2017,2019 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/src/fs_rmts_pm.h#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $
...
PACKED struct fs_rmts_pm_debug_info
{
  ...
  uint32 fsg_enc_time_in_us;
  uint32 fsg_dec_time_in_us;
