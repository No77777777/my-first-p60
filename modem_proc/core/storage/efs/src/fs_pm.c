 ...
 * fs_pm.c
 *
 * Copyright (C) 2003-2016, 2018, 2019 QUALCOMM Technologies, Inc.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/src/fs_pm.c#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $

when          who     what, where, why
--------      ---     ------------------------------------------------------
11/24/19      vm      Add compressed FSG zip-tar support.
01/05/18      as      Fix corner case of reboot during super page write.
...
{
  (void) pm_data; (void) golden_copy_type;
  return -EPERM;
}
                            ...
                            uint32 partition, int do_encryption)
{
  ...
  (void) buf; (void) buf_size; (void) partition; (void) do_encryption;
