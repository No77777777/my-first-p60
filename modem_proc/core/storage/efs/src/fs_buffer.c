 ...
 * Copyright (C) 2003-2013,2015-2016,2018, 2019 QUALCOMM Technologies, Inc.
 */
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/src/fs_buffer.c#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $
...
b_make_golden_copy_invalid (fsb_t imp,
                               enum fs_golden_copy_type golden_copy_type)
{
  (void) imp; (void) golden_copy_type;
  return -EPERM;
}
...
static int
b_make_golden_copy (fsb_t imp, enum fs_golden_copy_type golden_copy_type)
{
  fsb_nand_t buf = (fsb_nand_t) imp;

  return (buf->gc->ops.make_golden_copy (buf->gc, golden_copy_type));
}
                ...
                int do_encryption)
{
  ...
  return (buf->gc->ops.write_to_fsg (buf->gc, buff, buff_size,
          partition, do_encryption));
}
