...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/inc/fs_zip.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
/* Allocate some extra room in the heap that is provided to zlib library
 * for future growth
 */
#ifndef FS_ZIP_COMPRESSION_MEMORY_FUTURE_GROWTH
#define FS_ZIP_COMPRESSION_MEMORY_FUTURE_GROWTH  (4 * 1024)
#endif
