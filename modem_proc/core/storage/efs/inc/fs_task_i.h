...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/inc/fs_task_i.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
#define FS_DIAGD_SIG               0x0080      /* Delayed Diag signal  */
