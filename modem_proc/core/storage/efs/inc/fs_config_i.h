...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/storage/efs/inc/fs_config_i.h#2 $ $DateTime: 2019/12/17 05:16:47 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2019-11-26   vm    Add compressed FSG zip-tar support
...
#ifndef EFS_DIR_ITER_FSG_DIRECTORY
#define EFS_DIR_ITER_FSG_DIRECTORY  ("/.efs/fsg/")
#endif


#ifndef EFS_DIR_ITER_WHITE_LIST_FILE
#define EFS_DIR_ITER_WHITE_LIST_FILE  ("/.efs/fsg/white_list_files")
#endif

#ifndef EFS_DIR_ITER_BLACK_LIST_FILE
#define EFS_DIR_ITER_BLACK_LIST_FILE  ("/.efs/fsg/black_list_files")
#endif
