...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/hwengines/adc/devices/vadc/src/DalVAdc.c#4 $$DateTime: 2020/02/13 04:15:11 $$Author: pwbldsvc $
...
VAdc_DeviceInit(VAdcClientCtxt *pCtxt)
{
   ...
   if (pmic_model == PMIC_IS_UNKNOWN || pmic_model == PMIC_IS_INVALID )
   {
      /* PMIC is not present or not supported*/
      pDevCtxt->bHardwareSupported = FALSE;
      return DAL_SUCCESS;
   }
