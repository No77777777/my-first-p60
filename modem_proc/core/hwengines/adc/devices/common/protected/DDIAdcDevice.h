...
============================================================================*/
/* $Header: //components/rel/core.mpss/10.0/hwengines/adc/devices/common/protected/DDIAdcDevice.h#1 $ */
 ...
 * ----------------------------------------------------------------------*/
#define DALADCDEVICE_INTERFACE_VERSION DALINTERFACE_VERSION(4,3)
...
{
   DalDevice DalDevice;
   DALResult (*SetDeviceIndex)(uint32 ClientHandle, DalDeviceHandle * _h, uint32);
   DALResult (*GetInputProperties)(uint32 ClientHandle, DalDeviceHandle * _h, const char * pChannelName, uint32 *);
   DALResult (*GetDeviceProperties)(uint32 ClientHandle, DalDeviceHandle * _h, AdcDeviceDevicePropertiesType *pAdcDeviceProp);
   DALResult (*RecalibrateChannel)(uint32 ClientHandle, DalDeviceHandle * _h, uint32  uChannelIdx, AdcDeviceRecalibrateResultType *);
   DALResult (*ReadChannel)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 uChannelIdx, AdcDeviceResultType *);
#ifndef ADC_BOOT_DRIVER
   DALResult (*TMGetInputProperties)(uint32 ClientHandle, DalDeviceHandle * _h, const char * pInputName, uint32 *puChannelIdx);
   DALResult (*TMGetRange)(uint32 ClientHandle, DalDeviceHandle *h, uint32 uMeasIdx, AdcDeviceTMRangeType *pAdcTMDeviceRange);
   DALResult (*TMSetThreshold)(uint32 ClientHandle, DalDeviceHandle *_h, uint32 uChannelId, const DALSYSEventHandle hEvent, AdcDeviceTMThresholdType eThreshold, const int32 *pnThresholdDesired, int32 *pnThresholdSet);
#endif
};
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->SetDeviceIndex(DALDEVICE_LOCAL_CLIENTID,  _h, uDeviceIndex);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->GetDeviceProperties(DALDEVICE_LOCAL_CLIENTID,  _h, pAdcDeviceProp);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->GetInputProperties(DALDEVICE_LOCAL_CLIENTID,  _h, pChannelName, puChannelIdx);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->RecalibrateChannel(DALDEVICE_LOCAL_CLIENTID,  _h, uChannelIdx, pAdcDeviceRecalibrateResult);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->ReadChannel(DALDEVICE_LOCAL_CLIENTID,  _h, uChannelIdx, pAdcDeviceReadResult);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->TMGetInputProperties(DALDEVICE_LOCAL_CLIENTID,  _h, pInputName, puMeasIdx);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->TMGetRange(DALDEVICE_LOCAL_CLIENTID,  _h, uMeasIdx, pAdcTMDeviceRange);
}
...
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->TMSetThreshold(DALDEVICE_LOCAL_CLIENTID,  _h, uMeasIdx, hEvent, eThreshold, pnThresholdDesired, pnThresholdSet);
}
#endif
