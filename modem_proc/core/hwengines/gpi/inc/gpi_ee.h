...
04/21/17   ah      Added gpitgtcfgdata.h, cleaned ee de-init
02/19/16   ah      Created
...
#include "err.h"
#include "ULogFront.h"
#define GPI_ULOG_BUFFER_MAX       4096
#endif

#define GPII_HEAP_SIZE                           0x400

#define EVT_RINGS_HEAP_SIZE                      0x400
...
#define MAX_NUM_QUP_COMMON_CLOCKS     4
 ...
 */
GPI_RETURN_STATUS gpi_clock_enable(void *gpii_ctxt);
 ...
 * @return   GPI_RETURN_STATUS    Return status.
 */
GPI_RETURN_STATUS gpi_clock_disable(void *gpii_ctxt);
