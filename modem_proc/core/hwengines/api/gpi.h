...
--------   ---     ------------------------------------------------------------
05/30/18   pc      Updated QUP instaces based on talos/Moorea
03/09/18   ah      Hana changes
06/14/17   ah      Introduced user_data to non-transfer results, increased ring
04/21/17   ah      Add I3C definitions, redefine MAX_NUM_GPI_RING_ELEM
...
#define GPI_LINK_RX__MASK                             0x800
#define GPI_LINK_RX__SHIFT                            0xB
