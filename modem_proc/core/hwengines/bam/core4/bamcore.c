...
===============================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/hwengines/bam/core4/bamcore.c#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
03/04/16   SS      Optimized and removed bam core dump to debug part.
...
#define BAM_MAX_VERSION                   0xB // Istari, Nazgul
