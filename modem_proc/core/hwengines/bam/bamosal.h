...
===============================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/hwengines/bam/bamosal.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
12/08/17   PC      Added support for Minidump
08/21/17   PC      Added bam_osal_busywait function
...
//For Minidump related APIs, if MD is not enabled on a target 
//MD APIs will be replaced by static in-line as false/true based on API
...
/* ============================================================================
**  Function : bam_osal_check_if_md_path
** ============================================================================
*/
/**
  Check if bam driver is running in minidump path or not
...
*/
uint32 bam_osal_check_if_md_path();
/* ============================================================================
