...
--------   ---     ------------------------------------------------------------
01/09/20   KS      Added enums to support multi descriptor WA
10/23/17   KS      Added macros related to Crypto BAM
03/10/16   SS      Added macro for desc fifo alignemnt and size sanity
...
typedef struct _descfifo
{
   ...
   check_for_eot desc_wait_for_eot;
}desc_fifo_type;
