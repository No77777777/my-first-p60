...
============================================================================*/
/* $Header: //components/rel/core.mpss/10.0/hwengines/tsens/dal/v2/HALtsens.h#1 $ */
...
uint32 HAL_tsens_tm_GetInterruptStatus(uint8 *pucTsensTMAddr, HAL_tsens_tm_Threshold eThreshold);
