...
Copyright (c) 2001 - 2012, 2015-2016, 2018 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.mpss/10.0/services/diag/DCM/common/src/diagtarget.h#1 $
