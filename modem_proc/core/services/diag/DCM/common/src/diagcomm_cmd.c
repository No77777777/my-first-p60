...
Copyright (c) 2013-2015, 2017-2018 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/services/diag/DCM/common/src/diagcomm_cmd.c#1 $
...
diagcomm_cmd_status (diagcomm_enum_port_type port)
{
  ...
  return (diagcomm_io_cmd_conn[DIAGCOMM_PORT_SIO][port].connected \
  	       && diagcomm_io_cmd_conn[DIAGCOMM_PORT_SIO][port].channel_connected);   
#else
