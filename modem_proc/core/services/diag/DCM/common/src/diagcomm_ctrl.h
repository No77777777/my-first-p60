...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/services/diag/DCM/common/src/diagcomm_ctrl.h#1 $
...
12/20/16   tbg     Added DiagID control packet
...
#define DIAG_CTRL_PD_STATUS_VER            1   // Version # for PD status
...
#define DIAG_CTRL_PD_STATUS_DOWN        0
#define DIAG_CTRL_PD_STATUS_UP          1
...
/******************************************************************************
  ...
  9    - DIAG_CTRL_MSG_PERIPH_BUF_BIT_POS
...
/* PD status packet format (30) */
/* This is used for sending pd status from modem to apps */
typedef PACK(struct)
{
   uint32          version;            /* version number of this control packet type */
   uint32          pid;                /* PD # that has come up or down*/
   uint8           status;    /* Status set to 0 - PD is down, 1 - PD is up */
} diag_ctrl_pd_status_type;
...
typedef PACK(union)
{
  ...
  diag_ctrl_pd_status_type ctrl_pd_status;                         /* DIAG_CTRL_PD_STATUS */
