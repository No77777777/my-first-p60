...
Notice that changes are listed in reverse chronological order.
 ...
 $Header: //components/rel/core.mpss/10.0/services/diag/DCM/common/src/feature.c#1 $
...
11/05/16   sa      Added support for DiagID feature bit 
04/20/16   nk      Added Extended Packet support for DCI
07/02/15   rh      Added function to register modem feature mask callback
...
void diag_init_feature_mask( void )
{
  ...
  DIAG_INT_FEATURE_MASK_SET(F_DIAG_DCI_EXTENDED_HEADER_SUPPORT);
...
void diag_ctrl_send_feature_mask( void )
{
  ...
  if(feature_mask_fwd_status == DIAG_CTRL_INFO_FWD_STATUS_NOT_SENT)
  {
    ...
    {
      bytes_written = diagcomm_ctrl_send_mult_pkt( &ctrl_msg, DIAGCOMM_CTRL_MSG_HDR_SIZE + sizeof(diag_ctrl_msg_feature_type),
...
diag_feature_mask_cb modem_feature_mask_cb = NULL;

void diag_reg_modem_feature_mask_cb(diag_feature_mask_cb cb_ptr)
{
    modem_feature_mask_cb = cb_ptr;
}
