...
/*===========================================================================
      ...
      $Header: //components/rel/core.mpss/10.0/services/diag/DCM/common/src/diagbuf_v.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/05/18   sa      Added Non-Public APIs.
...
03/12/16   sa      Update UserPD commit threshold in NRT mode
...
08/16/15   vk      Added PACK() to diag_send_desc_type
08/16/15   vk      Added function prototypes for micro diagbuffer drain
...
DESCRIPTION
  Adds the diagbuffer handle pointer to the linked list that keeps track of
  all diag buffers that are serviced and drained by diag task.
  It simply returns if the handle is already present in the list.
...
PARAMETERS
  *ptr      -    Specifying the ptr whose allocation size is to be reduced
   length  -    Length requested.
