...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/services/diag/DCM/common/src/diagcomm_io.h#1 $
...
02/22/17   ph      Tag DIAG ID header to all the diag packets sent out.
...
07/23/14   rh      Changes for 16kB cmd/rsp
...
typedef struct
{
  ...
  boolean diag_prev_tx_pending;     /* Flag set when the io_transmit fails and retransmit is needed. */
