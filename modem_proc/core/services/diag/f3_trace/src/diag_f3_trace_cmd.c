...
Copyright (c) 2012-2013, 2015-2016 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/*==========================================================================

                        EDIT HISTORY FOR MODULEW
$Header: //components/rel/core.mpss/10.0/services/diag/f3_trace/src/diag_f3_trace_cmd.c#1 $
...
diag_f3_trace_handle core_f3_trace = { FALSE, 0,  FALSE, DIAG_F3_TRACE_QTIMER, &(err_f3_trace_buffer[0]), 0 , DIAG_F3_TRACE_BUFFER_SIZE};
