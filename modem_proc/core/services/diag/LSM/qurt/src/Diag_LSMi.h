...
Copyright (c) 2008-2009, 2012, 2014-2016,2018 Qualcomm Technologies Incorporated. 
All Rights Reserved.
...
$Header: //components/rel/core.mpss/10.0/services/diag/LSM/qurt/src/Diag_LSMi.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/01/18   sa      Added mask bit defines.
...
12/04/14   vk      Added healthcommand in UserPD
...
#define DIAG_MASKS_MSG_BIT   0x1 // Bit 0: F3s / Messages
#define DIAG_MASKS_LOG_BIT   0x2 // Bit 1: Logs
#define DIAG_MASKS_EVENT_BIT 0x4 // Bit 2: Events
