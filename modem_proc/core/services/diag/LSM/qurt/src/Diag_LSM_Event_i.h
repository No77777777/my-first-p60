...
Copyright (c) 2007-2008, 2012, 2016 QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
$Header: //components/rel/core.mpss/10.0/services/diag/LSM/qurt/src/Diag_LSM_Event_i.h#1 $
...
/* checks if the event mask is set */
