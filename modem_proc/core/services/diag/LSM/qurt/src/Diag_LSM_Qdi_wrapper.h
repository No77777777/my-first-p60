...
09/18/17   sa      Make a QDI call to drain events in userpd queue.
...
FUNCTION diag_lsm_clear_drain_timer

DESCRIPTION
 This function clears diag buf drain timer in guest OS

RETURN VALUE 
   0 Always.

===========================================================================*/
int diag_lsm_clear_drain_timer(void);


/*===========================================================================

FUNCTION diag_lsm_set_event_stale

DESCRIPTION
 This function makes a QDI call to drain all events in userpd queue.

RETURN VALUE 
   0 Always.

===========================================================================*/
int diag_lsm_set_event_stale(void);

/*===========================================================================

FUNCTION diag_lsm_clear_event_stale_timer

DESCRIPTION
 This function makes a QDI call to clear event stale timer.

RETURN VALUE 
   0 Always.

===========================================================================*/
int diag_lsm_clear_event_stale_timer(void);
