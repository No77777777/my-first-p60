...
Copyright (c) 1991-2013,2015-2018 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
      ...
      $Header: //components/rel/core.mpss/10.0/services/diag/LSM/common/src/diag_v.h#1 $
...
02/05/15   tbg     Removed FEATURE_SMD and FEATURE_SMD_LITE error check
                   (requested by SMD team for mainlining)
11/25/14   ph      Mainlined the feature DIAG_CONSUMER_API.
07/16/14   xy      Update Diag delayed response command to take parameter  
01/30/14   ph      Removed the usage of macro DIAG_TASK_HANDLE()
...
#if defined (FEATURE_RUNTIME_DEVMAP) && !defined(DIAG_APPS_ONLY_BRINGUP) && defined(DIAG_SIO_SUPPORT)
#if defined (DIAG_MP)
...
osal_tcb_t *diag_task_tcb; /* Cache the Diag task handle here */
...
typedef enum
{
    DIAGBUF_VERSION_0  = DIAG_EXT_API_VERSION_0,
    DIAGBUF_VERSION_1 = DIAG_EXT_API_VERSION_1,
    DIAGBUF_VERSION_2 = DIAG_EXT_API_VERSION_2,
...
boolean diagpkt_master_tbl_init (void);
