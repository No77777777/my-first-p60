...
/*===========================================================================
      ...
      $Header: //components/rel/core.mpss/10.0/services/diag/LSM/common/src/diagbuf_mpd.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/18/17   sa      Make qdi call to drain events from userpd.
...
DESCRIPTION
  calls diag_lsm_set_event_stale() to set event stale timer to drain  the events in the queue.
