...
Copyright (c) 2016, 2018, 2020 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
$Header: //components/rel/core.mpss/10.0/services/diag/LSM/common/src/ULog_Diag.h#2 $
...
#define DIAG_ERR_ULOG_SIZE    (1024 * 16)
#define DIAG_DEBUG_ULOG_SIZE  (1024 * 2)
#define DIAG_CMD_ULOG_SIZE    (1024 * 1)
#define DIAG_DATA_ULOG_SIZE   (1024 * 3)
