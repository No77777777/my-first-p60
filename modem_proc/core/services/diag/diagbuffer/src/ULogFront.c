...
Copyright (c) 2009-2014, 2018 Qualcomm Technologies Incorporated.
All Rights Reserved.
Qualcomm Confidential and Proprietary

$Header: //components/rel/core.mpss/10.0/services/diag/diagbuffer/src/ULogFront.c#1 $
============================================================================*/
                                      ...
                                      va_list ap )
{
  ...
  switch(ULogInternal_FastFmtSizeTS(h, total_size, ULOG_REALTIME_SUBTYPE_PRINTF, NULL)){
 ...
 *         Errors are defined in the ULOG_ERRORS enum.
 */
DLL_API_GLOBAL ULogResult ULogFront_RealTimePrintf(ULogHandle h, uint32 dataCount, const char * formatStr, ...)
{
  uint32 total_size;
  uint32 dataArray[14];
#ifdef ULOG_64BIT_TIME
...
ULogResult ULogFront_RealTimeData(ULogHandle h, uint32 dataCount, ...)
{
  ...
  switch(ULogInternal_FastFmtSizeTS(h, total_size, ULOG_REALTIME_SUBTYPE_WORDDATA, NULL)){
 ...
 *         Errors are defined in the ULOG_ERRORS enum.
 */
DLL_API_GLOBAL ULogResult ULogFront_RealTimeString(ULogHandle h, char * cStr)
{
  uint32 logData[3];
  uint32 length;
#ifdef ULOG_64BIT_TIME
