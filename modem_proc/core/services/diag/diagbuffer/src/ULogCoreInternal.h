...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/services/diag/diagbuffer/src/ULogCoreInternal.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/09/18   sa      Added Internal APIs.
...
#define DIAGBUFFER_MSG_FORMAT_LEGACY                 0
#define DIAGBUFFER_MSG_FORMAT_DIAG                   1
...
#define DIAGBUFFER_MASK_NONE        0
#define DIAGBUFFER_MASK_DIAG        1
#define DIAGBUFFER_MASK_CUSTOM      2
#define DIAGBUFFER_MAX_MASK         2

#define DIAGBUFFER_TIMESTAMP_TYPE_QTIMER  0
#define DIAGBUFFER_TIMESTAMP_TYPE_CUSTOM  1
#define DIAGBUFFER_TIMESTAMP_TYPE_DIAG    2
#define DIAGBUFFER_TIMESTAMP_TYPE_MAX     2

#define DIAGBUFFER_TOOL_FILTER_DISABLED 0
#define DIAGBUFFER_TOOL_FILTER_ENABLED  1
#define DIAGBUFFER_TOOL_FILTER_MAX      1



typedef struct
{
  uint16  high_mark;              // high mark in percentage
  uint16  low_mark;               // low mark in percentage
  uint8   tx_mode;                // mode set for this ULOG
  uint8   ts_type;                // Timestamp type
  uint8   mask_type;              // Type of mask applied
  uint8   tool_filter;            // Tool filter to accept/reject the buffer
}diagbuffer_param_type;
...
typedef struct ULOG_STRUCT
{
 ...
 uint32 transactionWriteStart;                 // Starting point of the Write
  ...
  diagbuffer_param_type param;                  // diagbuffer params
