/*=============================================================================
  Copyright (c) 2003-2013,2015-2017 Qualcomm Technologies, Inc.
  All rights reserved.
...
$Header: //components/rel/core.mpss/10.0/services/time_qmi/src/qmi_time_server.c#1 $
...
)
{
   ...
   if(NULL != recv_msg)
   {
     ...
     if(recv_msg->base != TIME_SERVICE_BASE_USER_V01
