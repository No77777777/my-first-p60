...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/services/osal/rex/src/osal_rex.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2018-08-03    gn   Diag timers categorization into deferrable and non-deferrable
...
2017-03-02    sp   New API, osal_dog_get_report_period() to get the dog
                   timeout value 
2015-08-12    xy   Verified DIAG uimage APIs in island mode 
...
timer_group_type  diag_non_deferrable_timer_group;  /* non-deferrable to wakeup from sleep */
#endif
...
DESCRIPTION
  Defines a non-deferrable timer.
...
int osal_create_diag_timer(rex_timer_type *timer, rex_tcb_type *tcb_ptr, rex_sigs_type sigs)
{
  ...
  {
    #ifdef FEATURE_USE_TIME_VU
      timer_def(timer, &diag_non_deferrable_timer_group, tcb_ptr, sigs, NULL, 0);
      ret_value = OSAL_SUCCESS;
    #else
                              ...
                              rex_timer_cb_type timer_cb_ptr, unsigned long cb_param)
{
  ...
  {
    #ifdef FEATURE_USE_TIME_VU
      timer_def(timer_ptr, &diag_non_deferrable_timer_group, tcb_ptr, 0, (timer_t1_cb_type)timer_cb_ptr, (timer_cb_data_type)cb_param);
      ret_value = OSAL_SUCCESS;
    #else
      ret_value = OSAL_FAILURE;
    #endif
