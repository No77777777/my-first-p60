...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/services/osal/rex/inc/osal_rex_types.h#2 $ $DateTime: 2020/11/17 02:07:16 $ $Author: pwbldsvc $
...
typedef struct
{
 ...
 typedef unsigned int                       osal_timer_t;
