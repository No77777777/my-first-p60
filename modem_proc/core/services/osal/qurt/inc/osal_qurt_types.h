 ...
 *
 * Copyright (C) 2011, 2013-2014, 2017 QUALCOMM Technologies, Inc.
 *
 *
 ***********************************************************************/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/services/osal/qurt/inc/osal_qurt_types.h#2 $ $DateTime: 2020/11/17 02:07:16 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   --------------------------------------------------------- 
2017-07-12    gn   OSAL APIs updated to use ATS timers instead of qurt timers
2014-07-14    xy   Replaced qmsgq_callback_t with void* for qube deprecation  
...
typedef unsigned int                    osal_timer_cnt_t;
