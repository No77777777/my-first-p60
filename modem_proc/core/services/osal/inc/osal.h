...
*/
 /*
 * Copyright (C) 2008-2013, 2017-2018 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/services/osal/inc/osal.h#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
2017-03-02    sp   New API, osal_dog_get_report_period() to get the dog
                   timeout value
