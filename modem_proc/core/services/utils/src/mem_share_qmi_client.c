...
/*===========================================================================
  ...
  Copyright (c) 2009-2014,2016-2017 QUALCOMM Technologies Incorporated. All Rights Reserved
...
$Header: //components/rel/core.mpss/10.0/services/utils/src/mem_share_qmi_client.c#1 $
