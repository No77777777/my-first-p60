...
Copyright (c) 1990-2016 by Qualcomm Technologies, Inc.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/10.0/services/utils/src/ran.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/11/16   nk      Fixed KW errors
...
static void ran_qmutex_init(void)
{
  ...
  if(NULL == ran_q6_mutex)
  {
     ERR_FATAL("ran_mutex_init: Malloc for ran_q6_mutex failed",0,0,0);
  }else
  {
