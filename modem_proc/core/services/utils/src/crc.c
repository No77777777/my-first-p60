...
Copyright (c) 1990-1992 by Qualcomm Technologies, Inc.  All Rights Reserved.
Copyright (c) 1996-1999 by Qualcomm Technologies, Inc.  All Rights Reserved.
Copyright (c) 2005-2017 by Qualcomm Technologies, Inc.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/10.0/services/utils/src/crc.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
DLL_API_GLOBAL word crc_16_calc
(
  byte *buf_ptr,
...
DLL_API_GLOBAL word crc_16_step
(
  word seed,
