...
$Header: //components/rel/core.mpss/10.0/services/utils/src/list.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
09/12/16    nk     Moved LIST_ASSERT api to internal files and it returns 
