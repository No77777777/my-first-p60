...
Copyright (c) 2012-16      by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================ */
...
$Header: //components/rel/core.mpss/10.0/services/utils/src/mba_uncached_heap.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
