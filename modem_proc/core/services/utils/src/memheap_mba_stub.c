...
$Header: //components/rel/core.mpss/10.0/services/utils/src/memheap_mba_stub.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
04/11/16  ph     Added support for QShrink 4.0
07/13/15  ps     Added stub APIs for optimizations on compiler 7.3.02 
09/15/14  rks    Added stubs for err_Fatal_internal2 and err_Fatal_internal1
