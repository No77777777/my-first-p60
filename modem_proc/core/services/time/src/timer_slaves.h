...
$Header: //components/rel/core.mpss/10.0/services/time/src/timer_slaves.h#1 $
...
Set the corresponding bit in array based on priority 

@return
TRUE    On successful operation 
FALSE   On failed operation
...
None
*/
boolean timer_slave_set_dependency_bit(int priority);
