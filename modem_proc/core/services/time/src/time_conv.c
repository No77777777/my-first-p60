...
$Header: //components/rel/core.mpss/10.0/services/time/src/time_conv.c#1 $
...
=============================================================================*/
static void time_conv_uint64_to_qw(uint64 native, time_type legacy)
{
  legacy[0] = (uint32)(native&0xFFFFFFFFuLL);
  legacy[1] = (uint32)((native>>32)&0xFFFFFFFFuLL);
}

static uint64 time_conv_qw_to_uint64(time_type legacy)
{
