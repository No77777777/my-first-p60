...
$Header: //components/rel/core.mpss/10.0/services/time/src/time_genoff_v.h#1 $
...
typedef struct time_genoff_cb_struct_s
{
time_genoff_t2_cb_type cb_func;
uint32 cb_data;
struct time_genoff_cb_struct_s * next;
}time_genoff_cb_struct_type;
typedef time_genoff_cb_struct_type * time_genoff_cb_struct_ptr;
...
typedef struct time_genoff_ext_struct
{
  ...
  time_genoff_cb_struct_ptr       cb_list_ptr;
...
/* Function pointer typedef, for updating the time offset information to client user PD */
typedef void (*time_genoff_client_update_func)
(
  /* Pointer to genoff for which the update is made */
  time_genoff_ptr ptime_genoff,

  /* The client index of user PD for which the update is passed */
  int client_index
);
...
DESCRIPTION
 Registers with QDI Framework for time-services.
...
=============================================================================*/
void time_genoff_qdi_init(void);
...
=============================================================================*/
void time_genoff_get_init_updates(int client_index);
...
DESCRIPTION
  Provides timeick of the last update and delta msecs for passed base.
