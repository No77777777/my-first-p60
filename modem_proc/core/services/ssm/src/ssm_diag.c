...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/services/ssm/src/ssm_diag.c#1 $
...
)
{
  ...
  switch ( req->command )
  {
     ...
     case SSM_GLINK_WRITE :
       
      #ifdef SSM_USES_SMDL
       ssm_smdl_handle_tx( SSM_PROC_APPS, "abcdefghij",  10);
      #else /* SSM_USES_SMDL */
       ssm_glink_handle_tx( SSM_PROC_APPS, "abcdefghij",  10);
      #endif /* SSM_USES_SMDL */
