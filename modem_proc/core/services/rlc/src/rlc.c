...
$Header: //components/rel/core.mpss/10.0/services/rlc/src/rlc.c#2 $
...
static inline rlc_attribute_type* rlc_map_internal_attribute(rlc_external_attribute_type attr)
{
