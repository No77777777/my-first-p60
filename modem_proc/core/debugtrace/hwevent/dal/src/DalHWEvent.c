...
$Header: //components/rel/core.mpss/10.0/debugtrace/hwevent/dal/src/DalHWEvent.c#1 $
=============================================================================*/
...
static uint32
HWEvent_DeviceDetach(uint32 ClientHandle, DalDeviceHandle* h)
{
...
static DALResult
HWEvent_DeviceInit(uint32 ClientHandle, DalDeviceHandle *h)
{
...
static DALResult
HWEvent_DeviceDeInit(uint32 ClientHandle, DalDeviceHandle *h)
{
...
static DALResult
HWEvent_DevicePowerEvent(uint32 ClientHandle, DalDeviceHandle *h, DalPowerCmd PowerCmd,
...
static DALResult
HWEvent_DeviceOpen(uint32 ClientHandle, DalDeviceHandle* h, uint32 mode)
{
...
static DALResult
HWEvent_DeviceClose(uint32 ClientHandle, DalDeviceHandle* h)
{
   return DAL_SUCCESS;
}

static DALResult
HWEvent_DeviceInfo(uint32 ClientHandle, DalDeviceHandle* h, DalDeviceInfo* info, uint32 infoSize)
{
...
static DALResult
HWEvent_DeviceSysRequest(uint32 ClientHandle, DalDeviceHandle* h,DalSysReq ReqIdx,
...
------------------------------------------------------------------------------*/
DALResult HWEvent_SetRegister(uint32 ClientHandle, DalDeviceHandle* h,uint32 phys_addr,uint32 value,
                              uint8 *pret_code)
{
   HWEventDevCtxt *pDevCtxt;
   DALClientCtxt * pClientCtxt = (DALClientCtxt *)(h->pClientCtxt);
...
DALResult HWEvent_ConfigurePresetEvents(uint32 ClientHandle, DalDeviceHandle* h)
{
   HWEventDevCtxt *pDevCtxt;
   DALClientCtxt * pClientCtxt = (DALClientCtxt *)(h->pClientCtxt);
