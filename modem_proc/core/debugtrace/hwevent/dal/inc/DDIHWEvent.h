...
//                             Edit History
//
// $Header: //components/rel/core.mpss/10.0/debugtrace/hwevent/dal/inc/DDIHWEvent.h#1 $
//
//========================================================================
...
struct DalHWEvent
{
   ...
   DALResult (*SetRegister)(uint32 ClientHandle, DalDeviceHandle* h,uint32 phys_addr,uint32 value,uint8 *pret_code);
   DALResult (*ConfigurePreset)(uint32 ClientHandle, DalDeviceHandle* h);
};
