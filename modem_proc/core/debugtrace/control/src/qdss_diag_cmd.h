...
typedef qdss_generic_req qdss_wcss_req;
typedef qdss_generic_rsp qdss_wcss_rsp;

#define QDSS_WCSS_SET_PARAM       1
#define QDSS_WCSS_GET_PARAM       2


typedef PACK(struct)
{
   uint8 param_id;
}qdss_wcss_get_param_req;

typedef PACK(struct)
{
   uint32 val;
}qdss_wcss_get_param_rsp;
...
typedef PACK(struct)
{
   ...
   uint16 reserved;
   uint32 val;
}qdss_wcss_set_param_req;

typedef qdss_generic_no_args qdss_wcss_set_param_rsp;
