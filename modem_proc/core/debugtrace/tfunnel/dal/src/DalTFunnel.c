...
static uint32
TFunnel_DeviceDetach(uint32 ClientHandle, DalDeviceHandle* h)
{
...
static DALResult
TFunnel_DeviceInit(uint32 ClientHandle, DalDeviceHandle *h)
{
...
static DALResult
TFunnel_DeviceDeInit(uint32 ClientHandle, DalDeviceHandle *h)
{
   TFunnelDevCtxt *pDevCtxt = (TFunnelDevCtxt *)((DALClientCtxt *)(h->pClientCtxt))->pDALDevCtxt;
   uint32 HalDevId;
...
static DALResult
TFunnel_DevicePowerEvent(uint32 ClientHandle, DalDeviceHandle *h, DalPowerCmd PowerCmd,
...
static DALResult
TFunnel_DeviceOpen(uint32 ClientHandle, DalDeviceHandle* h, uint32 mode)
{
   return DAL_SUCCESS;
}

static DALResult
TFunnel_DeviceClose(uint32 ClientHandle, DalDeviceHandle* h)
{
   return DAL_SUCCESS;
}

static DALResult
TFunnel_DeviceInfo(uint32 ClientHandle, DalDeviceHandle* h, DalDeviceInfo* info, uint32 infoSize)
{
...
static DALResult
TFunnel_DeviceSysRequest(uint32 ClientHandle, DalDeviceHandle* h,DalSysReq ReqIdx,
...
static DALResult
TFunnel_DeviceControl(uint32 ClientHandle,  DalDeviceHandle *h, TFunnelControlType  eCtrl,
