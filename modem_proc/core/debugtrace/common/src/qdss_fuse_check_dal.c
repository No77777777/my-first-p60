...
/*========================================================================== 
 $Header: //components/rel/core.mpss/10.0/debugtrace/common/src/qdss_fuse_check_dal.c#1 $
==========================================================================*/  
...
//Below can be enabled only after qdss clock voting is in place
#ifdef QDSS_CLOCK_VOTING_INPLACE
int qdss_fuse_trace_access(void)
{
