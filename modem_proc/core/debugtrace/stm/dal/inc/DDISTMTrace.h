...
//                             Edit History
//
// $Header: //components/rel/core.mpss/10.0/debugtrace/stm/dal/inc/DDISTMTrace.h#1 $
//
...
struct DalSTMTrace
{
   ...
   DALResult (*NewPort)(uint32 ClientHandle, DalDeviceHandle * _h, STMTracePortType * uPort, STMTracePortType *uPortDMA);
   void (*FreePort)(uint32 ClientHandle, DalDeviceHandle * _h, STMTracePortType  uPort);
};
