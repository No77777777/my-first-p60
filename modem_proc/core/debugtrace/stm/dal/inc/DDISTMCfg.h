/*=============================================================================	
   ...
   All Rights Reserved.
	$Header: //components/rel/core.mpss/10.0/debugtrace/stm/dal/inc/DDISTMCfg.h#1 $
=============================================================================*/
#ifndef DDISTMCFG_H
#define DDISTMCFG_H
...
struct DalSTMCfg
{
   ...
   DALResult (*STMControl)(uint32 ClientHandle, DalDeviceHandle * _h, STMControlType  uCtrl, uint32  uVal);
};
