...
===========================================================================*/
/* $Header: //components/rel/core.mpss/10.0/debugtrace/tracer/src/tracer_ost.h#1 $ */
...
/** Below two private tracer option flags are used
    for sending partial OST packets */

#define TRACER_OPT_NO_HEAD       0x04
#define TRACER_OPT_NO_TAIL       0x08
