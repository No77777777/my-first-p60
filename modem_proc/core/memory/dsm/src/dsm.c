...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/memory/dsm/src/dsm.c#1 $
...
)
{
  ...
  ----------------------------------------------------------------------*/
    ...
    dsm_item_set_priority((*dup_ptr),dsm_item_get_priority(src_ptr));
...
)
{
  ...
  else
  {
    ...
    if((*pkt_head_ptr) != NULL)
    {
      ...
      dsm_item_set_priority(item_ptr,dsm_item_get_priority(*pkt_head_ptr));
    }
...
)
{
  ...
  dsm_item_header_priority_type priority = DSM_QUEUE_PRIORITY_NORMAL;           /* priority field */
  ...
  if(*pkt_head_ptr != NULL) 
  {
    ...
    priority = dsm_item_get_priority(*pkt_head_ptr);
  ...
  while(size != 0)
  {
    ...
    if(*pkt_head_ptr == NULL)
    {
      ...
      dsm_item_set_priority((*pkt_head_ptr),priority); 
  ...
  while(cnt != 0 && (item_ptr = *pkt_head_ptr) != NULL)
  {
    ...
    if(item_ptr->used == 0)
    {
      /*---------------------------------------------------------------------
        ...
        pointer.
      ---------------------------------------------------------------------*/
      priority = dsm_item_get_priority(item_ptr);
