...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/uSleep/src/client_user/ddr/client_callback.c#1 $
...
#define USLEEP_PRI                0x01  /* Highest priority so it can be scheduled 
