...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/uSleep/src/util/uSleep_util.c#1 $
                                     ...
                                     uSleep_internal_state setState)
{
  ...
  CORE_VERIFY(setState == (setState & -setState));

  USLEEP_STATE_LOCK();
  if(0 != (g_uSleepData.state & checkState))
  {
    g_uSleepData.state = setState;
  }
  USLEEP_STATE_FREE();
