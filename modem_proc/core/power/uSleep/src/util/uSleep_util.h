...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/uSleep/src/util/uSleep_util.h#1 $
...
#ifdef USLEEP_SUPPORT_TRANSITIONS
/**
 * uSleep_checkAndSetStateInternal
 * 
 * @brief Sets the current uSleep internal state ONLY if the current state matches 
 *        [one] the checked state(s) 
 *         
 * @param checkState: uSleep internal state that is used for comparison
 * @param setState:   uSleep internal state to set if the checked state matches the current 
 *                    active state 
 */
void uSleep_checkAndSetStateInternal(uSleep_internal_state checkState, 
                                     uSleep_internal_state setState);
