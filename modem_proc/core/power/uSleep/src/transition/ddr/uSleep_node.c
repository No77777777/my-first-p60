...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/uSleep/src/transition/ddr/uSleep_node.c#1 $
...
static lprEvents g_uSleepLprEvents[] =
{
  ...
  { 1, "/uSleep/event/rpmh",        SLEEP_RPM_LPR_NODE_NAME,    uSleepNode_processLPRChangeEvent},
};
