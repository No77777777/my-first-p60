...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/uSleep/src/transition/uSleep_transi.h#1 $
...
/* Index values for early exit tracking */
#define EARLY_EXIT_CANCEL   0
#define EARLY_EXIT_OK_STG1  1
#define EARLY_EXIT_OK_STG2  2
...
typedef struct uSleep_transition_profiling_s
{
  ...
  /* Timestamp of last uSleep exit request start point */
  ...
  uint32              early_exits_cnt[3];

  /* Lifetime transition latency - not reset */
 ...
 * 
 * @param shortCutBypass : Flag to indicate this is a shortened exit and profiling data should
 *                         not be counted
 */
void uSleepTrans_completeTransitionToNormalMode(boolean shortCutBypass);
