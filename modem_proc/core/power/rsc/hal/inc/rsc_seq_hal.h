...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/rsc/hal/inc/rsc_seq_hal.h#1 $
...
/**
 * rsc_hal_get_trigger_seq
 *
 * @brief Get this register RSC_SEQ_OVERRIDE_TRIGGER_DRV0
 * @param base: RSC instance's base address.
 *
 * @return register value
 */
uint8 rsc_hal_get_trigger_seq(uint32 rsc_base);
