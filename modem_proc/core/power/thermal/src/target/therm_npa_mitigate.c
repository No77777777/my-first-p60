...
============================================================================*/
/*=======================================================================
$Header: //components/rel/core.mpss/10.0/power/thermal/src/target/therm_npa_mitigate.c#3 $
$DateTime: 2020/01/06 11:19:17 $
$Author: pwbldsvc $
========================================================================*/
/*===========================================================================
...
static npa_resource_definition therm_mitigate_resource[] =
{
  ...
  {
    "/therm/mitigate/modem_bw",              /* name of resource */
    "State Level",                           /* Units of the resource */
    0x5,                                     /* Maximum value of resource */
    &therm_mitigate_plugin,
    NPA_RESOURCE_DRIVER_UNCONDITIONAL,
    (void *)0x1,
    NULL
  ...
  {
    "/therm/mitigate/wlan",                  /* name of resource */
    "State Level",                           /* Units of the resource */
    0x1,                                     /* Maximum value of resource */
    &therm_mitigate_plugin,
    NPA_RESOURCE_DRIVER_UNCONDITIONAL,
  ...
  {
    "/therm/mitigate/wlan_bw",                  /* name of resource */
    "State Level",                           /* Units of the resource */
    0x1,                                     /* Maximum value of resource */
    &therm_mitigate_plugin,
    NPA_RESOURCE_DRIVER_UNCONDITIONAL,
...
void therm_npa_mitigate_init( void )
{
  ...
  /* Define nodes */
  CORE_VERIFY(ARR_SIZE(therm_mitigate_resource) == ARR_SIZE(initial_mitigate_state));
