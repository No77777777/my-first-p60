...
============================================================================*/
/*=======================================================================
$Header: //components/rel/core.mpss/10.0/power/thermal/src/target/therm_target.c#5 $
...
const char *therm_monitor_res_avail[] =
{
  ...
  "/therm/sensor/qfe_wtr0",
  "/therm/sensor/qfe_wtr0/sampling",
#endif
  "/therm/mitigate/pa",
  ...
  "/therm/mitigate/modem_bw",
  "/therm/mitigate/wlan",
  "/therm/mitigate/wlan_bw",
};
...
static void handle_v_restrict_state(unsigned int state)
{
  switch (state)
  {
    ...
    case 1:
      ...
      npa_issue_scalar_request(mssClientHandle, RAIL_VOLTAGE_LEVEL_NOM);
      break;
  }
}
                                    ...
                                    unsigned int  data_size )
{
  ...
  mssClientHandle = npa_create_sync_client("/vcs/vdd_mss_q6",
                                           "MSS_V Restrict",
