...
============================================================================*/
/*=======================================================================
$Header: //components/rel/core.mpss/10.0/power/thermal/src/common/therm_monitor.c#1 $
...
#ifndef MCFG_GCF
static boolean mcfg_gcf_nv_get_status(void) {return FALSE;}
#endif
...
static void therm_monitor_gcf_mode_test_handler( void )
{
  ...
  {
    therm_monitor_gcf.disable_tm_algo = mcfg_gcf_nv_get_status();
    therm_monitor_gcf.polling_attempts++;
