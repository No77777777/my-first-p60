...
================================================================================
$Header: //components/rel/core.mpss/10.2/power/sleep2.0/inc/sleep_masterstats.h#1 $
 ...
 *
 * @param powerdown_timestamp:  CX collapse Mode Software Entry timestamp
 */
 ...
 *
 * @param wakeup_timestamp: CX collapse LPM exit timestamp
 * @param validLpmCycle   : Last cx lpm cycle status,
 *                          if FALSE: last cx lpm cycle is bailed out before sending cx vote.
 */
