...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/sleep2.0/src/statistics/sleep_statsi.h#1 $
...
/*==============================================================================
 ...
 =============================================================================*/
/* Initial number of sleep cycle statistics to gather before making any latency adjustments
 * Note that this value must be less than the final cycle count */
#define SLEEPSTATS_INITIAL_CYCLE_COUNT  0x00000020

/* Maximum number of statistics to gather. Adjustments will be made after every x number
 * of cycles once this value is reached.
...
/* Data strcuture for tracking of total time in PC */
...
typedef struct sleep_state_s
{
  ...
  /* Flag to indicate if we are in an RPM assisted mode */
...
/* Various time and data values that are stored at certain points and later
 * retrieved by the statistic functions */
 ...
 *  
 * @param time:             Time spent in the last power collapse cycle 
 * @param pcExitTimestamp:  Timestamp of the last power collapse cycle exit
 */
