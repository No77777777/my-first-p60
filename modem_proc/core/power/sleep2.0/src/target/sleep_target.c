...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/sleep2.0/src/target/sleep_target.c#2 $
 ...
 * The general agreement with RPM is that the wakeup will be the last IPC for
 * the subsystem */
#define RPM_WAKEUP_INTERRUPT_VALUE 335
...
extern npa_node_definition g_tcmCacheNode;
                                     ...
                                     unsigned int dataSize)
{
  ...
  sleepTarget_registerLPRNode(&g_tcmCacheNode, SLEEP_TCM_LPR_NONRET_ONLY);
...
#ifdef SLEEP_SUPPORT_MASTER_STATS
  sleepLPR_registerNodelessLPR("masterstats", SLEEP_ALL_LPRMS);
#endif
