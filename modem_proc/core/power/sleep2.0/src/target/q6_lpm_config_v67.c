/*==============================================================================
  ...
  NOTE:         This file depends on how Q6 core is integrated within a
                ...
                Based on HPG_QDSP6SS_v67_1.0.docm (rev 4.91 - Dec 11, 2018)

  DEPENDENCIES: None

                Copyright (c) 2018-2019 Qualcomm Technologies, Inc. (QTI).
                All Rights Reserved.
                Qualcomm Confidential and Proprietary.
                Export of this technology or software is regulated by the U.S. Government.
                Diversion contrary to U.S. law prohibited.
================================================================================
$Header: //components/rel/core.mpss/10.0/power/sleep2.0/src/target/q6_lpm_config_v67.c#2 $
...
void q6LPMConfig_setupQ6PLLMode(boolean off)
{
  if(TRUE == off)
  {
    ...
    SLEEP_HWIO_OUT(RSCCTL_EN_PLL,
                 SLEEP_HWIO_FVAL(RSCCTL_EN_PLL, PLL_FREEZE,     0x1) | /* Power down PLL (standby / off) */
                 SLEEP_HWIO_FVAL(RSCCTL_EN_PLL, PLL_OUTDIS,   0x1) |
                 SLEEP_HWIO_FVAL(RSCCTL_EN_PLL, PLL_BYPASS,  0x0) | /* Not used */
