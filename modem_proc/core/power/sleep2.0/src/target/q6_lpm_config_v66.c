/*==============================================================================
  ...
  NOTE:         This file depends on how Q6 core is integrated within a 
                ...
                Based on HPG_QDSP6SS_v66_1.0.docm (rev 1.04 - May 23, 2017)
...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/sleep2.0/src/target/q6_lpm_config_v66.c#1 $
...
void q6LPMConfig_setupBase(void)
{
  ...
  SLEEP_HWIO_OUT(RSCCTL_EN_PLL,
                 SLEEP_HWIO_FVAL(RSCCTL_EN_PLL, PLL_FREEZE,     0x0) | /* pwr down PLL */   	
                 SLEEP_HWIO_FVAL(RSCCTL_EN_PLL, PLL_OUTDIS,     0x1) |
                 SLEEP_HWIO_FVAL(RSCCTL_EN_PLL, PLL_BYPASS,     0x1) |      			
...
#if defined(SLEEP_SUPPORT_V66_1_1) && (SLEEP_PROFILING_ID != SLEEP_PMI_ID)
