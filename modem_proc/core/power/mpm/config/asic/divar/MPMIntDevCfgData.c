...
===============================================================================
$Header: //components/rel/core.mpss/10.0/power/mpm/config/asic/divar/MPMIntDevCfgData.c#4 $
 ...
 * BAsed on: divar_v1.0_p3q0r25
 */
mpm_int_pin_mapping_type MpmInterruptPinNum_Mapping[] =
{
  ...
  { MPM_TRIGGER_LEVEL_HIGH,  MPM_UNMAPPED_INT, MPM_GPIO },
