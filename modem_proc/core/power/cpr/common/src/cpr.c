 ...
 * $Header: //components/rel/core.mpss/10.0/power/cpr/common/src/cpr.c#1 $
 * $Change: 18983508 $
 */
#include "cpr.h"
#include "cpr_logs.h"
...
void cpr_reset_controller()
{
    ...
    cpr_image_reset_controller();
}

uint32 cpr_get_hw_ol_count(uint32 mode)
{
    return cpr_image_get_hw_ol_count(mode);
}
