 ...
 * $Header: //components/rel/core.mpss/10.0/power/cpr/image/mpss/target/kamorta/cpr_image_target.c#1 $
 * $Change: 19007111 $
 */
...
{
    extern const cpr_settings cpr_settings_kamorta;

    return &cpr_settings_kamorta;
}
...
cpr_foundry_id cpr_image_target_get_foundry(void)
{
    ...
    if (familyVersion == DALCHIPINFO_FAMILY_SDM845)
    {
