...
================================================================================
$Header: //components/rel/core.mpss/10.0/power/unpa/src/framework/unpa_resource.c#1 $
...
{
  if (updateFcn == unpa_minUpdateFcn ||
      updateFcn == unpa_maxUpdateFcn ||
      updateFcn == unpa_binaryUpdateFcn)
  {
