...
$Header: //components/rel/core.mpss/10.0/power/npa/hw/core_guest/npa_target_config.c#1 $
============================================================================*/
...
npa_resource_config npa_resource_overrides_data[] = 
{
  ...
  { "/core/mca/clk", { 10000, 1000, 300 } },
  { "/mcpm/bus/q6ddr/scalar2vect", { 12000, 1000, 300 } },
