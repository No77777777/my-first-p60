...
$Header: //components/rel/core.mpss/10.0/power/npa/src/remote/npa_remote_qdi_protocol.h#2 $
==============================================================================*/
...
#define NPA_QDI_CREATE_EVENT_HANDLE        (QDI_PRIVATE + 36)
#define NPA_QDI_ANY_RESOURCE_EVENT         (QDI_PRIVATE + 37)
#define NPA_QDI_ISSUE_SCALAR_REQUEST_UNCONDITIONAL  (QDI_PRIVATE + 38)
