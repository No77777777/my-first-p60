...
Copyright (c) 2009-2013,2016,2018 Qualcomm Technologies Incorporated.
All Rights Reserved.
QUALCOMM Proprietary/GTDR

$Header: //components/rel/core.mpss/10.0/power/npa/src/scheduler/npa_scheduler_internal.h#1 $
============================================================================*/
...
#define NPA_SCHEDULER_SLEEP_LPR_RESOURCE_NAME               SLEEP_LPR_NODE_NAME

/* Sleep's /core/cpu/wakeup Resource Name */
#define NPA_SCHEDULER_SLEEP_MAX_DURATION_RESOURCE_NAME      SLEEP_MAX_DURATION_NODE_NAME
...
/* 
 * struct to record stats
 */
typedef struct npa_scheduler_stats_generic
{
...
typedef struct npa_scheduler_control
{
  ...
  struct
  {
   ...
   /* dynamic adjustment stats used for lpr wakeup related events */
	npa_scheduler_stats_generic lpr_adjust_stats;  
#endif	
  } adjust;
