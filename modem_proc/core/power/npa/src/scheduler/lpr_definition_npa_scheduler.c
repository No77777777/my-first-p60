...
Copyright (c) 2010-2013,2016 Qualcomm Technologies Incorporated.
All Rights Reserved.
Qualcomm Confidential and Proprietary

$Header: //components/rel/core.mpss/10.0/power/npa/src/scheduler/lpr_definition_npa_scheduler.c#1 $
============================================================================*/
                                        ...
                                        uint64 *hard_time_ptr)
{
  ...
  uint32 soft_duration = NPA_MAX_STATE; /* soft wakeup duration from now */
...
void npa_scheduler_lpr_init( void )
{
  ...
  { /* feature has not been turned off */
    CORE_VERIFY_PTR(npa_scheduler.sleep.lpr_client = sleepLPR_registerNodelessLPR("npa_scheduler", 0));
