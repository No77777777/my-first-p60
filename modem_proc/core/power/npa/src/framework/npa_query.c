...
$Header: //components/rel/core.mpss/10.0/power/npa/src/framework/npa_query.c#1 $
============================================================================*/
 ...
 * @return success/failure of query (npa_query_status)
 */
DLL_API_GLOBAL npa_query_status npa_query_by_name( const char *resource_name,
                                                   uint32 query_id,
                                                   npa_query_type *result )
 ...
 *
 */
DLL_API_GLOBAL npa_query_status npa_query_by_client( npa_client_handle client,
                                      uint32            query_id,
                                      npa_query_type   *result )
{
  npa_query_status status = NPA_QUERY_UNSUPPORTED_QUERY_ID;
 ...
 */
DLL_API_GLOBAL npa_query_status
npa_query_resource_available( const char *resource_name )
{
