...
$Header: //components/rel/core.mpss/10.0/power/npa/src/framework/npa.c#1 $
============================================================================*/
 ...
 */
DLL_API_GLOBAL void npa_init( void )
{
  ...
  if ( NULL == npa.log )
  {
    ...
    npa_stub_resource( "/protocol/rpm/polling_mode" );
#endif                        
...
#ifndef NPA_RPM_REMOTING_SUPPORTED
/**
 * Dummy routines and globals for linkage in platforms without RPM.
 */
unsigned npa_rpm_num_deferred_nas_updates = 0;
