...
$Header: //components/rel/core.mpss/10.0/power/npa/src/framework/npa_graph.c#2 $
============================================================================*/
                              ...
                              npa_resource_state   default_state[] )
{
  ...
  if ( NULL != creation_event )
  {
    ...
    /* A tad inefficient; will worry about it when this path is actually used */
    creation_event->trigger_type |= NPA_TRIGGER_DESTROY_FLAG;
    npa_remove_event_from_resource( resource, creation_event );
 ...
 * is invoked
 */
DLL_API_GLOBAL void npa_resource_available_cb( const char     *resource_name,
                                               npa_callback    callback,
                                               npa_user_data   context )
{
  npa_resource *resource;
