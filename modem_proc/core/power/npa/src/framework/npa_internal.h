...
$Header: //components/rel/core.mpss/10.0/power/npa/src/framework/npa_internal.h#2 $
============================================================================*/
...
#define NPA_TRIGGER_META_EVENT          NPA_TRIGGER_RESERVED_EVENT_1
#define NPA_TRIGGER_SYNC_EVENT          NPA_TRIGGER_RESERVED_EVENT_2

/* NPA internal event type */
#define NPA_EVENT_META                  NPA_EVENT_RESERVED_1
...
typedef struct npa_event_list
{
  ...
  npa_event        *meta_events;   /* Event list change events */
  
  volatile uint32_t state_count;   /* Count of state change events */
  volatile uint32_t meta_count;    /* Count of system events */
...
typedef struct npa_resource_internal_data
{
  ...
  /* Time spent in update and driver functions for regular requests */
  npa_duration request_duration;
  
  /* Time spent in update and driver functions for NAS requests*/
  npa_duration fork_duration;
