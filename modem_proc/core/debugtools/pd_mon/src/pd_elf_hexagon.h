...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/pd_mon/src/pd_elf_hexagon.h#2 $
...
#define NT_HEXAGON_REGFILE             0x60000000 // .note type; NOT Used
#define NT_HEXAGON_DUMP_NAME           0x20000000 // .note type; NOT Used
#define NT_HEXAGON_DUMP_PROCESS        0x20000001 // .note type; Name of the process
#define NT_HEXAGON_DUMP_VERSION        0x20000002 // .note type; Image Versioning Info
#define NT_HEXAGON_DUMP_PID           0x20000003 // .note type; PID of process
#define NT_HEXAGON_DUMP_CONTEXT        0x20000004 // .note type; Not Used
#define NT_HEXAGON_PRSTATUS            0x00000001 // .note type; TCB Info
#define NT_HEXAGON_RTLD_LINKMAP        0x20000005 // .note type; RTLD Link Map Address
#define NT_HEXAGON_PLATFORM_VER        0x20000006 // .note type; Platform Version
#define NT_HEXAGON_PRHVXREG            0x20000007 // .note type; HVX info
