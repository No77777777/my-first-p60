...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/rcinit/src/rcinit_internal.c#1 $
...
struct rcinit_internal_static_s rcinit_internal_static;                          // Internal Runtime Instruments  
