...
Copyright (c) 1992-2010,2018 by QUALCOMM Technologies Inc. All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/debugtools/task/src/mobile.c#1 $
...
NOTICE_TYPE rel_date[] = "Feb 12 2026";
NOTICE_TYPE rel_time[] = "10:00:00";
...
NOTICE_TYPE mob_sw_rev[] = "MPSS.HA.1.1-00549-KD_ALL_PACK-2";
