...
Copyright (c) 2016, 18 by Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/core.mpss/10.0/debugtools/api/procinfo_qdi.h#1 $ 
...
typedef struct procinfo_qdi_device_data_s
{
  boolean islocal;
  unsigned int  pid;
  char    oem_name[PROCINFO_NAME_MAX_LEN];
  char    internal_name[PROCINFO_NAME_MAX_LEN];
  char    domain_name[PROCINFO_NAME_MAX_LEN];
