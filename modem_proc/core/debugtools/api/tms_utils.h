...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/api/tms_utils.h#2 $
...
#define TMS_TIME_DIFF(x,y)          (x > y) ? ((x)-(y)) : ((y)-(x))
#define TMS_TIME_DIFF_IN_MSEC(x,y)  (x > y) ? (((x)-(y))/19200) : (((y)-(x))/19200)

/* Task Stack sizes and priorities */

#define TMS_TASK_STACK_256            256
#define TMS_TASK_STACK_512            512
#define TMS_TASK_STACK_1K             1024
#define TMS_TASK_STACK_2K             (1024 * 2)
#define TMS_TASK_STACK_3K             (1024 * 3)
#define TMS_TASK_STACK_4K             (1024 * 4)
#define TMS_TASK_STACK_5K             (1024 * 5)
#define TMS_TASK_STACK_6K             (1024 * 6)

/* Low number is High priority (between 1 - 255) */

#define TMS_TASK_PRIO_EXCEPTION       1
#define TMS_TASK_PRIO_WORKER          205
#define TMS_TASK_PRIO_SLEEP           255

#define TMS_TASK_PRIO_SYS_M           152
#define TMS_TASK_PRIO_DOG_HB          164
#define TMS_TASK_PRIO_RCINIT_WORKLOOP 112
#define TMS_TASK_PRIO_RCINIT_WORKER   94 

#define TMS_TASK_PRIO_DEFAULT         qurt_thread_get_priority(qurt_thread_get_id()) - 1
#define TMS_TASK_PRIO_LOW             qurt_thread_get_priority(qurt_thread_get_id()) + 5
#define TMS_TASK_PRIO_HIGH            qurt_thread_get_priority(qurt_thread_get_id()) - 10
...
#define TMS_UTILS_BUFFER_SIZE_EXT   128
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_FORMAT_PRINTF(3,4)
...
@param[in]  TMS_UTILS_BUF_SZ  Output Buffer Size
@param[in]  TMS_UTILS_FMT_P   Format Template Pointer (NULL Terminated)
@param[in]  va_list           Format Template Expansion Arguments
@return     TMS_UTILS_RET_T   Byte Count Output into Buffer Pointer (>=0) w/ NULL Terminator, Error Indications (<0)
*/
TMS_UTILS_RET_T tms_utils_fmt_va_list(TMS_UTILS_BUF_P out_buf_p, TMS_UTILS_BUF_SZ out_buf_sz, TMS_UTILS_FMT_P fmt_tpl,  va_list argv);
...
*/
DLL_API_WARN_UNUSED_RESULT 
tms_utils_sem_p tms_utils_sem_init(tms_utils_sem_p const sem_p);
...
*/
DLL_API_WARN_UNUSED_RESULT 
tms_utils_sem_p tms_utils_sem_wait(tms_utils_sem_p const sem_p);
...
*/
DLL_API_WARN_UNUSED_RESULT 
tms_utils_sem_p tms_utils_sem_signal(tms_utils_sem_p const sem_p);
...
/**
API, CPU,DDR and VDD vote.
*/
void tms_utils_vote_resources(void);

/**
API, CPU,DDR and VDD unvote.
*/
void tms_utils_unvote_resources(void);

/**
API, to lanuch  QuRT tasks
*/
DLL_API_WARN_UNUSED_RESULT
