...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/api/dog_hal.h#1 $
...
#define DOG_HWIO_JOIN(x,y) x ## _ ## y // Internal Joiner macro
#define DOG_HWIO_EVALUATE(x,y) DOG_HWIO_JOIN(x,y) // Second level of indirection for macro resolution inside another wrapper

#define DOG_HWIO_FMT(x) DOG_HWIO_EVALUATE(DOG_HWIO_FMT_PREFIX,x) // Create formatted macro for HWIO_X functions using DOG_HWIO_FMT_PREFIX from SCons
#define DOG_HWIO(x) DOG_HWIO_EVALUATE(DOG_HWIO_PREFIX,x) // Create full macro for bitmasks/shifts using DOG_HWIO_PREFIX from SCons
