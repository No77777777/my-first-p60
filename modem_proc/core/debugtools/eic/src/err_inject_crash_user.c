...
$Header: //components/rel/core.mpss/10.0/debugtools/eic/src/err_inject_crash_user.c#2 $
...
void err_inject_crash_wdog_nmi_multithreaded(void)
{
  TMS_MSG_ERROR("Injecting multithreaded DOG NMI, Not Supported in User PD");
}
...
void err_inject_crash_wdog_bark(void)
{
  TMS_MSG_ERROR("Injecting DOG Bark, Not Supported in User PD");
}
