...
Copyright (c) 2011 - 2017,2019 by Qualcomm Technologies, Inc.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/10.0/debugtools/eic/src/err_inject_crash.c#2 $
...
extern void err_inject_crash_wdog_nmi_multithreaded(void);
extern void err_inject_crash_wdog_multithreaded(void);
extern void err_inject_crash_wdog_bark(void);
...
void err_inject_crash_execute(timer_cb_data_type data)
{
  ...
  if ( temp_crash_info->image_mode == ERR_MAINIMAGE_MODE )
  {
    ...
    case ERR_INJECT_WDOG_NMI:
      ...
      break;
    case ERR_INJECT_WDOG_NMI_MULTITHREADED:
      err_inject_crash_wdog_nmi_multithreaded();
      break;
    case ERR_INJECT_WDOG_BARK:
      err_inject_crash_wdog_bark();
      break;
    case ERR_INJECT_WDOG_MULTITHREADED:
