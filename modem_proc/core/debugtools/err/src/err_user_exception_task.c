...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/10.0/debugtools/err/src/err_user_exception_task.c#1 $
...
void err_spawn_exception_handler(void)
{
   ...
   if (qurt_atomic_compare_and_set(&task_spawn_flag, FALSE, TRUE) )
   {
    ...
    (void)tms_utils_launch_qurt_task(tname, TMS_TASK_STACK_2K, TMS_TASK_PRIO_EXCEPTION,  err_exception_handler, NULL, TRUE);
   }
}
