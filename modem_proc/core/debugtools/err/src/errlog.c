...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/10.0/debugtools/err/src/errlog.c#1 $ $DateTime: 2019/04/24 00:03:26 $ $Author: pwbldsvc $
...
static void err_log_err(void)
{
  ...
  WRITE_BUF("Start Timetick : %lu\n", (unsigned long)coredump.err.start_time);
  WRITE_BUF("End   Timetick : %lu\n", (unsigned long)coredump.err.end_time);
