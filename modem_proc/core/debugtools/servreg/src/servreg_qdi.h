...
#define SERVREG_QDI_ROOT_TO_USER_PD_SYNC_MUTEX_SIG         0x1
...
#define SERVREG_QDI_DEREG_ROOT_MASK_VALUE              0x8
#define SERVREG_QDI_FREE_MON_HANDLE_MASK_VALUE         0x10
...
#define SERVREG_QDI_DEREGISTER_NEW_HANDLE              (12+QDI_PRIVATE)
#define SERVREG_QDI_FREE_MONITOR_HANDLE                (13+QDI_PRIVATE)
