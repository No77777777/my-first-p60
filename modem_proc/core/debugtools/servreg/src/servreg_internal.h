...
#define SERVREG_REMOTE_REQ_TASK                           "sr_remote_req_task"
...
struct servreg_mon_node_s
{
   ...
   /* e_d_transaction_id is used for identification of early down state change */
   int32_t e_d_transaction_id;

   /* relationship refers to the relationship of service with local process("soc/domain/subdomain") */
   servreg_relationship_type relationship;
