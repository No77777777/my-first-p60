 ...
 *     None
 * =====================================================================  */
static void servreg_qmi_server_req_task(void *argv DLL_API_UNUSED)
{
   uint32_t q_mask;
...
void servreg_qmi_notif_server_init(void)
{
   ...
   (void)tms_utils_launch_qurt_task(SERVREG_QMI_NOTIF_REQ_SERVER_TASK_NAME, TMS_TASK_STACK_4K, TMS_TASK_PRIO_HIGH, servreg_qmi_server_req_task, NULL, TRUE);
