...
Copyright (c) 2011-18 by Qualcomm Technologies Incorporated. All Rights Reserved.
...
$Header: //components/rel/core.mpss/10.0/debugtools/sys_m/src/sys_m.h#1 $
...
#define SYS_M_SMSM_TASK_NAME          "sys_m_smsm"
