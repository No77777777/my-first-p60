...
===============================================================================*/
/*=============================================================================
Copyright (c) 2013-18 Qualcomm Technologies Incorporated.
All rights reserved.
Qualcomm Confidential and Proprietary
=============================================================================*/
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/sys_m/src/sys_m.c#1 $
...
void sys_m_process_rcinit_shutdown_init(void)
{
   qurt_anysignal_init(&sys_m_internal.sig);

   sys_m_internal.rcevt_sigex.signal = &sys_m_internal.sig;
   sys_m_internal.rcevt_sigex.mask = SYS_M_SIG_ACK;

   (void)rcevt_register_sigex_name(RCINIT_RCEVT_TERMGROUPS, RCEVT_SIGEX_TYPE_SIGQURT, &sys_m_internal.rcevt_sigex);

   rcinit_handle_init(&sys_m_internal.workloop_handle, RCINIT_RCECB_TERMGROUPS, RCINIT_RCESN_TERMGROUPS, RCINIT_RCEVT_TERMGROUPS, TERM_PROCESS_TABLE, NULL);

   rcinit_term_init( &sys_m_internal.workloop_handle);
}

void sys_m_process_rcinit_shutdown(void)
{
   //rcinit_workloop_update_rcinit_internal(&sys_m_internal.workloop_handle);

   rcinit_process_autogen_table(&sys_m_internal.workloop_handle);

   qurt_anysignal_wait(&sys_m_internal.sig, SYS_M_SIG_ACK);
