...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/rcevt/src/rcevt_common.c#1 $
...
rce_nfy_p rce_nfy_pool_init(void)
{
   ...
   {
      next_pool = (rce_nfy_pool_p)malloc(sizeof(rce_nfy_pool_t));                // allocate
   }
...
rce_nde_p rce_nde_pool_init(void)
{
   ...
   {
      next_pool = (rce_nde_pool_p)malloc(sizeof(rce_nde_pool_t));                // allocate
   }
