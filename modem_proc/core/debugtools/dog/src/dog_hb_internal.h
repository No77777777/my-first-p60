...
#endif
   qurt_mutex_t virtual_mutex;              /* Serialize using PI virtual_mutex */
   int virtual_mutex_inited;                /* Flag set if dog_hb.virtual_mutex initialized */
   dog_hb_device_p virtual_dog_head;        /* Internal dog_hb processes (virtual dog) list */
};
...
#define DOG_HB_VIRTUAL_PING_ERROR_CNT             5                              /* Ping No Response Error Count for Virtual DOG (User Processes) */
