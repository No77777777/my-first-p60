...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/dog/src/dog_timeouts.h#2 $
...
#define DOG_BARK_ENABLE_TIMEOUT_NOW_SCLK    0x0001           // BARK "NOW"
#define DOG_NMI_ENABLE_TIMEOUT_NOW_SCLK     0x0001           // NMI  "NOW"

#define DOG_BITE_ENABLE_TIMEOUT_SCLK_FORCE  MS_TO_SCLK(100)  // 100ms 
