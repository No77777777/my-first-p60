...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/10.0/debugtools/rcxh/src/rcxh.c#1 $
...
#endif
#if !defined(RCINIT_EXCLUDE_MSG_SWEVT)
      TMS_STARTUP_MSG_SPRINTF_HIGH_4("Throw check task # %lx %s %s#%d", task_hash,
...
#if !defined(RCINIT_EXCLUDE_MSG_SWEVT)
      TMS_STARTUP_MSG_SPRINTF_HIGH_4("Throw unwind task # %lx %s %s#%d", task_hash,
                    NULL != handle && NULL != handle->name ? handle->name : "*",
                    NULL != file ? file : "*", line);
#endif
...
#endif
#if !defined(RCINIT_EXCLUDE_MSG_SWEVT)
      TMS_STARTUP_MSG_SPRINTF_HIGH_2("Catch task # %lx check %s", task_hash,
                    NULL != handle && NULL != handle->name ? handle->name : "*");
#endif
...
#endif
#if !defined(RCINIT_EXCLUDE_MSG_SWEVT)
                  TMS_STARTUP_MSG_SPRINTF_HIGH_2("Caught task # %lx %s", task_hash,
                                NULL != handle && NULL != handle->name ? handle->name : "*");
#endif
