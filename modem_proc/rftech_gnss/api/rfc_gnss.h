...
$Header: //components/rel/rftech_gnss.mpss/3.11/api/rfc_gnss.h#1 $
...
public:
  ...
  void** get_rf_device_obj(rfdevice_type_enum_type dev_type);
...
private:
  ...
  rfdevice_class *gnss_trx_devices[RFDEVICE_TYPE_MAX_NUM][RFC_MAX_DEVICE_INSTANCES_PER_BAND];
