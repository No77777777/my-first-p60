...
#ifndef RFC_WTR2965_NON_CA_QPA8673_CDMA_CONFIG_AG
#define RFC_WTR2965_NON_CA_QPA8673_CDMA_CONFIG_AG
...
class rfc_wtr2965_non_ca_qpa8673_cdma_ag:public rfc_cdma_data
{
public:
...
protected:
  rfc_wtr2965_non_ca_qpa8673_cdma_ag(void);  /*  Constructor  */
};
