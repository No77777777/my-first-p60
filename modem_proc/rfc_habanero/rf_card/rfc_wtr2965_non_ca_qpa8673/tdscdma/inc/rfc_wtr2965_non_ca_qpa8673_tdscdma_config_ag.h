...
#ifndef RFC_WTR2965_NON_CA_QPA8673_TDSCDMA_CONFIG_AG
#define RFC_WTR2965_NON_CA_QPA8673_TDSCDMA_CONFIG_AG
...
class rfc_wtr2965_non_ca_qpa8673_tdscdma_ag:public rfc_tdscdma_data
{
public:
...
protected:
  rfc_wtr2965_non_ca_qpa8673_tdscdma_ag(void);  /*  Constructor  */
};
