...
#ifndef RFC_WTR2965_NON_CA_QPA8673_LTE_CONFIG_AG
#define RFC_WTR2965_NON_CA_QPA8673_LTE_CONFIG_AG
...
class rfc_wtr2965_non_ca_qpa8673_lte_ag:public rfc_lte_data
{
public:
...
protected:
  rfc_wtr2965_non_ca_qpa8673_lte_ag(void);  /*  Constructor  */
};
