...
#ifndef RFC_WTR2965_NON_CA_QPA8673_WCDMA_CONFIG_AG
#define RFC_WTR2965_NON_CA_QPA8673_WCDMA_CONFIG_AG
...
class rfc_wtr2965_non_ca_qpa8673_wcdma_ag:public rfc_wcdma_data
{
public:
...
protected:
  rfc_wtr2965_non_ca_qpa8673_wcdma_ag(void);  /*  Constructor  */
};
