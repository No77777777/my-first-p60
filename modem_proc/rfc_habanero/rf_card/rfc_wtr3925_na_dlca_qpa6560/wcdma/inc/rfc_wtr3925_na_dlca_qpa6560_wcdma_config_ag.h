...
#ifndef RFC_WTR3925_NA_DLCA_QPA6560_WCDMA_CONFIG_AG
#define RFC_WTR3925_NA_DLCA_QPA6560_WCDMA_CONFIG_AG
...
class rfc_wtr3925_na_dlca_qpa6560_wcdma_ag:public rfc_wcdma_data
{
public:
...
protected:
  rfc_wtr3925_na_dlca_qpa6560_wcdma_ag(void);  /*  Constructor  */
};
