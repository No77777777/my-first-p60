...
rfc_phy_device_info_type rfc_wtr3925_sdr425_row_dl_6560_phy_devices_list[] = 
{
  { /*Device: WTR3925 */ 
  ...
  { /*Device: QPA8821 */ 
    GEN_PA /* QPA8821 */, /* PHY_DEVICE_NAME */ 
  ...
  { /*Device: SP6T_B11_B21 */ 
    GEN_ASM /* SP6T_B11_B21 */, /* PHY_DEVICE_NAME */ 
  ...
  { /*Device: MB_DRX_SP4T */ 
    GEN_ASM /* MB_DRX_SP4T */, /* PHY_DEVICE_NAME */ 
...
rfc_logical_device_info_type rfc_wtr3925_sdr425_row_dl_6560_logical_devices_list[] = 
{
  { /*Device: WTR3925 */ 
  ...
  { /*Device: QPA8821 */ 
    RFDEVICE_PA, /* DEVICE_MODULE_TYPE */ 
    GEN_PA /* QPA8821 */, /* DEVICE_MODULE_NAME */ 
  ...
  { /*Device: SP6T_B11_B21 */ 
    RFDEVICE_ASM, /* DEVICE_MODULE_TYPE */ 
    GEN_ASM /* SP6T_B11_B21 */, /* DEVICE_MODULE_NAME */ 
  ...
  { /*Device: MB_DRX_SP4T */ 
    RFDEVICE_ASM, /* DEVICE_MODULE_TYPE */ 
    GEN_ASM /* MB_DRX_SP4T */, /* DEVICE_MODULE_NAME */ 
  ...
  { /*Device: QAT5515 */ 
    ...
    2, /* DEVICE_MODULE_TYPE_INSTANCE */ 
    20, /* ASSOCIATED_PHY_DEVICE_INSTANCE */ 
  }, /* END - Device: QAT5515 */ 
  ...
  { /*Device: QAT5515 */ 
    ...
    QAT5515, /* DEVICE_MODULE_NAME */ 
    3, /* DEVICE_MODULE_TYPE_INSTANCE */ 
    21, /* ASSOCIATED_PHY_DEVICE_INSTANCE */ 
  }, /* END - Device: QAT5515 */ 
  ...
  { /*Device: TEST_GRFC_COUPLER */ 
    ...
    0, /* DEVICE_MODULE_TYPE_INSTANCE */ 
    22, /* ASSOCIATED_PHY_DEVICE_INSTANCE */ 
  }, /* END - Device: TEST_GRFC_COUPLER */ 
...
rfc_signal_info_type rfc_wtr3925_sdr425_row_dl_6560_sig_info[RFC_WTR3925_SDR425_ROW_DL_6560_SIG_NUM + 1] = 
{
  { RFC_MSM_TIMING_PA_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PA_CTL */ 
  { RFC_MSM_TIMING_PA_RANGE , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PA_RANGE */ 
  { RFC_MSM_TIMING_ASM_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_ASM_CTL */ 
  { RFC_MSM_TIMING_TUNER_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_TUNER_CTL */ 
  { RFC_MSM_TIMING_PAPM_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PAPM_CTL */ 
  { RFC_MSM_TIMING_TX_TX_RF_ON0 , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_TX_TX_RF_ON0 */ 
  { RFC_MSM_TIMING_TX_RX_RF_ON0 , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_TX_RX_RF_ON0 */ 
  { RFC_MSM_TIMING_ASM_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_ASM_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_TX_TX_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PAPM_TX_TX_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_OFF_TX_RX_TX_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PAPM_OFF_TX_RX_TX_TRIGGER */ 
  { RFC_MSM_TIMING_PA_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PA_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_OFF_TX_RX_TX_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PAPM_OFF_TX_RX_TX_CTL */ 
  { RFC_MSM_TIMING_PAPM_TX_TX_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PAPM_TX_TX_CTL */ 
  { RFC_MSM_TIMING_PAPM_MULTISLOT_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TIMING_PAPM_MULTISLOT_CTL */ 
  { RFC_MSM_PA_ON_10 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_PA_ON_10 */ 
  { RFC_MSM_PA1_R2 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_PA1_R2 */ 
  { RFC_MSM_PA0_R1 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_PA0_R1 */ 
  { RFC_MSM_RF_PATH_SEL_01 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_01 */ 
  { RFC_MSM_RF_PATH_SEL_09 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_09 */ 
  { RFC_MSM_RF_PATH_SEL_02 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_02 */ 
  { RFC_MSM_RF_PATH_SEL_11 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_11 */ 
  { RFC_MSM_RF_PATH_SEL_04 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_04 */ 
  { RFC_MSM_RF_PATH_SEL_17 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_17 */ 
  { RFC_MSM_RF_PATH_SEL_15 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_15 */ 
  { RFC_MSM_RF_PATH_SEL_05 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_05 */ 
  { RFC_MSM_RF_PATH_SEL_20 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_20 */ 
  { RFC_MSM_RF_PATH_SEL_06 , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_06 */ 
  { RFC_MSM_RF_PATH_SEL_14 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_14 */ 
  { RFC_MSM_RF_PATH_SEL_07 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_07 */ 
  { RFC_MSM_RF_PATH_SEL_16 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_16 */ 
  { RFC_MSM_RF_PATH_SEL_08 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_08 */ 
  { RFC_MSM_RF_PATH_SEL_21 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RF_PATH_SEL_21 */ 
  { RFC_MSM_GPDATA0_0 , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_GPDATA0_0 */ 
  { RFC_MSM_RFFE1_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE1_CLK */ 
  { RFC_MSM_RFFE1_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE1_DATA */ 
  { RFC_MSM_RFFE2_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE2_CLK */ 
  { RFC_MSM_RFFE2_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE2_DATA */ 
  { RFC_MSM_RFFE3_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_4MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE3_CLK */ 
  { RFC_MSM_RFFE3_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_4MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE3_DATA */ 
  { RFC_MSM_RFFE4_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE4_CLK */ 
  { RFC_MSM_RFFE4_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE4_DATA */ 
  { RFC_MSM_RFFE5_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE5_CLK */ 
  { RFC_MSM_RFFE5_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_RFFE5_DATA */ 
  { RFC_MSM_INTERNAL_GNSS_BLANK , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_INTERNAL_GNSS_BLANK */ 
  { RFC_MSM_INTERNAL_GNSS_BLANK_CONCURRENCY , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_INTERNAL_GNSS_BLANK_CONCURRENCY */ 
  { RFC_MSM_TX_GTR_TH , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_TX_GTR_TH */ 
  { RFC_MSM_PA_IND , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_SDR425_ROW_DL_6560_PA_IND */ 
...
rfc_common_data* rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::get_instance(rf_hw_type rf_hw)
{
  if (rfc_common_data_ptr == NULL)
  {
    rfc_common_data_ptr = (rfc_common_data *)new rfc_wtr3925_sdr425_row_dl_6560_cmn_ag(rf_hw);
  }
  return( (rfc_common_data *)rfc_common_data_ptr);
}

//constructor
rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::rfc_wtr3925_sdr425_row_dl_6560_cmn_ag(rf_hw_type rf_hw)
  :rfc_common_data(rf_hw)
{
}


uint32 rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::sig_info_table_get(rfc_signal_info_type **rfc_info_table)
{
  ...
  *rfc_info_table = &rfc_wtr3925_sdr425_row_dl_6560_sig_info[0];

#ifdef FEATURE_GSM
  // Create GSM RFC AG Data Object
  rfc_gsm_data *rfc_gsm_data = rfc_wtr3925_sdr425_row_dl_6560_gsm_ag::get_instance(); 
  ...
  rfc_cdma_data *rfc_cdma_data = rfc_wtr3925_sdr425_row_dl_6560_cdma_ag::get_instance(); 
  ...
  rfc_wcdma_data *rfc_wcdma_data = rfc_wtr3925_sdr425_row_dl_6560_wcdma_ag::get_instance(); 
  ...
  rfc_lte_data *rfc_lte_data = rfc_wtr3925_sdr425_row_dl_6560_lte_ag::get_instance(); 
  ...
  rfc_tdscdma_data *rfc_tdscdma_data = rfc_wtr3925_sdr425_row_dl_6560_tdscdma_ag::get_instance(); 
  ...
  rfc_gnss_data *rfc_gnss_data = rfc_wtr3925_sdr425_row_dl_6560_gnss_ag::get_instance(); 
  ...
  return RFC_WTR3925_SDR425_ROW_DL_6560_SIG_NUM;
}

rfc_phy_device_info_type* rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::get_phy_device_cfg( void )
{
  return (&rfc_wtr3925_sdr425_row_dl_6560_phy_devices_list[0]);
}

rfc_logical_device_info_type* rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::get_logical_device_cfg( void )
{
  return (&rfc_wtr3925_sdr425_row_dl_6560_logical_devices_list[0]);
}


rfm_devices_configuration_type rfc_wtr3925_sdr425_row_dl_6560_logical_device_properties = 
{
  565, /* HWID */
  { /* device_support */ 
    { /* Logical Device 0 */ 
      ...
      {
        {
          ...
          /* Bit mask element 2 */ 
          ( ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND11 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND18 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND19 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND20 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND21 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND26 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND27 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND28 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND29 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND32 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND34 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND38 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND39 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND40 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND41 - 128) ) ),
        },
      },
      ...
      {
        {
          ...
          ( ( (uint64)1 << (SYS_BAND_WCDMA_I_IMT_2000 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_II_PCS_1900 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_III_1700 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_IV_1700 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_V_850 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_VI_800 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_VIII_900 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_IX_1700 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_XI_1500 - 64) ) | ( (uint64)1 << (SYS_BAND_WCDMA_XIX_850 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND1 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND2 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND3 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND4 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND5 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND7 - 64) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND8 - 64) ) ),
          /* Bit mask element 2 */ 
          ( ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND11 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND18 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND19 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND21 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND26 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND27 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND29 - 128) ) | ( (uint64)1 << (SYS_BAND_LTE_EUTRAN_BAND32 - 128) ) ),
        },
      },
...
boolean rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::get_logical_path_config(rfm_devices_configuration_type* dev_cfg)
{
  if ( dev_cfg == NULL )
  {
  ...
  memscpy(dev_cfg,
          ...
          &rfc_wtr3925_sdr425_row_dl_6560_logical_device_properties,
          sizeof(rfm_devices_configuration_type));

  return TRUE;
}

const rfm_devices_configuration_type* rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::get_logical_device_properties( void )
{
  return &rfc_wtr3925_sdr425_row_dl_6560_logical_device_properties;
}



rfc_cmn_properties_type rfc_wtr3925_sdr425_row_dl_6560_cmn_properties = 
{
  RFC_ENCODED_REVISION,   
  RFC_ATTENUATION_STATE_MID,
};

boolean rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::get_cmn_properties(rfc_cmn_properties_type **ptr)
{
  if (NULL==ptr)
  {
    return FALSE;
  ...
  *ptr = &rfc_wtr3925_sdr425_row_dl_6560_cmn_properties;
  return TRUE;
}

boolean rfc_wtr3925_sdr425_row_dl_6560_cmn_ag::rfc_get_remapped_device_info
(
