...
#include "rfc_wtr3925_qrd_ca_qpa8673_cdma_config_ag.h" 
#endif 
...
#ifdef FEATURE_CGPS
#include "rfc_wtr3925_qrd_ca_qpa8673_gnss_config_ag.h" 
#endif 



rfc_phy_device_info_type rfc_wtr3925_qrd_ca_qpa8673_phy_devices_list[] = 
{
  { /*Device: WTR3925 */ 
...
rfc_logical_device_info_type rfc_wtr3925_qrd_ca_qpa8673_logical_devices_list[] = 
{
  { /*Device: WTR3925 */ 
...
rfc_signal_info_type rfc_wtr3925_qrd_ca_qpa8673_sig_info[RFC_WTR3925_QRD_CA_QPA8673_SIG_NUM + 1] = 
{
  { RFC_MSM_TIMING_PA_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PA_CTL */ 
  { RFC_MSM_TIMING_PA_RANGE , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PA_RANGE */ 
  { RFC_MSM_TIMING_ASM_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_ASM_CTL */ 
  { RFC_MSM_TIMING_TUNER_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_TUNER_CTL */ 
  { RFC_MSM_TIMING_PAPM_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PAPM_CTL */ 
  { RFC_MSM_TIMING_TX_TX_RF_ON0 , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_TX_TX_RF_ON0 */ 
  { RFC_MSM_TIMING_TX_RX_RF_ON0 , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_TX_RX_RF_ON0 */ 
  { RFC_MSM_TIMING_ASM_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_ASM_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_TX_TX_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PAPM_TX_TX_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_OFF_TX_RX_TX_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PAPM_OFF_TX_RX_TX_TRIGGER */ 
  { RFC_MSM_TIMING_PA_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PA_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_OFF_TX_RX_TX_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PAPM_OFF_TX_RX_TX_CTL */ 
  { RFC_MSM_TIMING_PAPM_MULTISLOT_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PAPM_MULTISLOT_CTL */ 
  { RFC_MSM_TIMING_PAPM_TX_TX_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TIMING_PAPM_TX_TX_CTL */ 
  { RFC_MSM_RF_PATH_SEL_09 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RF_PATH_SEL_09 */ 
  { RFC_MSM_GPDATA0_0 , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_GPDATA0_0 */ 
  { RFC_MSM_RFFE5_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE5_CLK */ 
  { RFC_MSM_RFFE5_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE5_DATA */ 
  { RFC_MSM_RFFE2_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE2_CLK */ 
  { RFC_MSM_RFFE2_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE2_DATA */ 
  { RFC_MSM_RFFE3_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE3_CLK */ 
  { RFC_MSM_RFFE3_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE3_DATA */ 
  { RFC_MSM_RFFE4_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE4_CLK */ 
  { RFC_MSM_RFFE4_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RFFE4_DATA */ 
  { RFC_MSM_INTERNAL_GNSS_BLANK , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_INTERNAL_GNSS_BLANK */ 
  { RFC_MSM_INTERNAL_GNSS_BLANK_CONCURRENCY , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_INTERNAL_GNSS_BLANK_CONCURRENCY */ 
  { RFC_MSM_RF_PATH_SEL_14 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_RF_PATH_SEL_14 */ 
  { RFC_MSM_TX_GTR_TH , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_TX_GTR_TH */ 
  { RFC_MSM_PA_IND , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR3925_QRD_CA_QPA8673_PA_IND */ 
...
rfc_common_data* rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_instance(rf_hw_type rf_hw)
{
  if (rfc_common_data_ptr == NULL)
  {
    rfc_common_data_ptr = (rfc_common_data *)new rfc_wtr3925_qrd_ca_qpa8673_cmn_ag(rf_hw);
  }
  return( (rfc_common_data *)rfc_common_data_ptr);
}

//constructor
rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::rfc_wtr3925_qrd_ca_qpa8673_cmn_ag(rf_hw_type rf_hw)
  :rfc_common_data(rf_hw)
{
}


uint32 rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::sig_info_table_get(rfc_signal_info_type **rfc_info_table)
{
  ...
  *rfc_info_table = &rfc_wtr3925_qrd_ca_qpa8673_sig_info[0];

#ifdef FEATURE_GSM
  // Create GSM RFC AG Data Object
  rfc_gsm_data *rfc_gsm_data = rfc_wtr3925_qrd_ca_qpa8673_gsm_ag::get_instance(); 
  ...
  rfc_wcdma_data *rfc_wcdma_data = rfc_wtr3925_qrd_ca_qpa8673_wcdma_ag::get_instance(); 
  ...
  rfc_lte_data *rfc_lte_data = rfc_wtr3925_qrd_ca_qpa8673_lte_ag::get_instance(); 
  ...
  rfc_cdma_data *rfc_cdma_data = rfc_wtr3925_qrd_ca_qpa8673_cdma_ag::get_instance(); 
  ...
  rfc_tdscdma_data *rfc_tdscdma_data = rfc_wtr3925_qrd_ca_qpa8673_tdscdma_ag::get_instance(); 
  ...
  rfc_gnss_data *rfc_gnss_data = rfc_wtr3925_qrd_ca_qpa8673_gnss_ag::get_instance(); 
  ...
  return RFC_WTR3925_QRD_CA_QPA8673_SIG_NUM;
}

rfc_phy_device_info_type* rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_phy_device_cfg( void )
{
  return (&rfc_wtr3925_qrd_ca_qpa8673_phy_devices_list[0]);
}

rfc_logical_device_info_type* rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_logical_device_cfg( void )
{
  return (&rfc_wtr3925_qrd_ca_qpa8673_logical_devices_list[0]);
}


rfm_devices_configuration_type rfc_wtr3925_qrd_ca_qpa8673_logical_device_properties = 
{
  584, /* HWID */
  { /* device_support */ 
    { /* Logical Device 0 */ 
...
boolean rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_logical_path_config(rfm_devices_configuration_type* dev_cfg)
{
  if ( dev_cfg == NULL )
  {
  ...
  memscpy(dev_cfg,
          ...
          &rfc_wtr3925_qrd_ca_qpa8673_logical_device_properties,
          sizeof(rfm_devices_configuration_type));

  return TRUE;
}

const rfm_devices_configuration_type* rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_logical_device_properties( void )
{
  return &rfc_wtr3925_qrd_ca_qpa8673_logical_device_properties;
}
...
rfc_alt_path_sel_type rfc_wtr3925_qrd_ca_qpa8673_alt_path_selection_tbl[8][RFM_MAX_WAN_DEVICES] = 
{
  {  /* Index 0 */ 
...
rfc_alt_path_sel_type* rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_alt_path_selection_tbl(uint32 *tbl_size)
{
  *tbl_size  = 8; 
  return &rfc_wtr3925_qrd_ca_qpa8673_alt_path_selection_tbl[0][0]; 
}

rfc_cmn_properties_type rfc_wtr3925_qrd_ca_qpa8673_cmn_properties = 
{
  RFC_ENCODED_REVISION,   
  RFC_ATTENUATION_STATE_MID,
};

boolean rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::get_cmn_properties(rfc_cmn_properties_type **ptr)
{
  if (NULL==ptr)
  {
    return FALSE;
  ...
  *ptr = &rfc_wtr3925_qrd_ca_qpa8673_cmn_properties;
  return TRUE;
}

boolean rfc_wtr3925_qrd_ca_qpa8673_cmn_ag::rfc_get_remapped_device_info
(
