...
#ifndef RFC_WTR3925_QRD_CA_QPA8673_CDMA_CONFIG_AG
#define RFC_WTR3925_QRD_CA_QPA8673_CDMA_CONFIG_AG
...
class rfc_wtr3925_qrd_ca_qpa8673_cdma_ag:public rfc_cdma_data
{
public:
...
protected:
  rfc_wtr3925_qrd_ca_qpa8673_cdma_ag(void);  /*  Constructor  */
};
