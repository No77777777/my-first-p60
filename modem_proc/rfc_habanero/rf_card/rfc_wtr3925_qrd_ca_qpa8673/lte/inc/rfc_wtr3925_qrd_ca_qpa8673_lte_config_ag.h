...
#ifndef RFC_WTR3925_QRD_CA_QPA8673_LTE_CONFIG_AG
#define RFC_WTR3925_QRD_CA_QPA8673_LTE_CONFIG_AG
...
class rfc_wtr3925_qrd_ca_qpa8673_lte_ag:public rfc_lte_data
{
public:
...
protected:
  rfc_wtr3925_qrd_ca_qpa8673_lte_ag(void);  /*  Constructor  */
};
