...
Generated from:  v6.0.24 of RFC_HWSWCD.xlsm
*/
...
rfc_msm_signal_info_type rfc_divar_signal_info[RFC_MSM_SIG_NUM] = 
{
  ...
  {  RFC_ANT_SEL                         ,  49              ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_RF_PATH_SEL_16, MSM Pin Name: GPIO_49*/
  ...
  {  RFC_PA_ON                           ,  49              ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_PA_ON_03, MSM Pin Name: GPIO_49*/
  ...
  {  RFC_PA_IND                          ,  49              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"pa_indicator_1_or_2"},  /* Signal: RFC_MSM_PA_IND, MSM Pin Name: GPIO_49*/
...
uint32 rfc_msm_sig_info_table_get(rfc_msm_signal_info_type **msm_info_table)
{
  ...
  *msm_info_table = &rfc_divar_signal_info[0];
