...
rfc_msm_signal_info_type rfc_kamorta_signal_info[RFC_MSM_SIG_NUM] = 
{
  ...
  {  RFC_ANT_SEL                         ,  37              ,  0              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[0]"},  /* Signal: RFC_MSM_RF_PATH_SEL_01, MSM Pin Name: GPIO_37*/
  {  RFC_ANT_SEL                         ,  39              ,  2              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[2]"},  /* Signal: RFC_MSM_RF_PATH_SEL_02, MSM Pin Name: GPIO_39*/
  ...
  {  RFC_ANT_SEL                         ,  41              ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_RF_PATH_SEL_04, MSM Pin Name: GPIO_41*/
  {  RFC_ANT_SEL                         ,  44              ,  7              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[7]"},  /* Signal: RFC_MSM_RF_PATH_SEL_05, MSM Pin Name: GPIO_44*/
  {  RFC_ANT_SEL                         ,  46              ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_RF_PATH_SEL_06, MSM Pin Name: GPIO_46*/
  {  RFC_ANT_SEL                         ,  48              ,  11             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[11]"},  /* Signal: RFC_MSM_RF_PATH_SEL_07, MSM Pin Name: GPIO_48*/
  {  RFC_ANT_SEL                         ,  50              ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_RF_PATH_SEL_08, MSM Pin Name: GPIO_50*/
  {  RFC_ANT_SEL                         ,  38              ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_RF_PATH_SEL_09, MSM Pin Name: GPIO_38*/
  ...
  {  RFC_ANT_SEL                         ,  40              ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_RF_PATH_SEL_11, MSM Pin Name: GPIO_40*/
  ...
  {  RFC_ANT_SEL                         ,  47              ,  10             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[10]"},  /* Signal: RFC_MSM_RF_PATH_SEL_14, MSM Pin Name: GPIO_47*/
  {  RFC_ANT_SEL                         ,  43              ,  6              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[6]"},  /* Signal: RFC_MSM_RF_PATH_SEL_15, MSM Pin Name: GPIO_43*/
  {  RFC_ANT_SEL                         ,  RFC_GPIO_INVALID              ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_RF_PATH_SEL_16, MSM Pin Name: GPIO_49*/
  {  RFC_ANT_SEL                         ,  42              ,  5              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[5]"},  /* Signal: RFC_MSM_RF_PATH_SEL_17, MSM Pin Name: GPIO_42*/
  ...
  {  RFC_ANT_SEL                         ,  45              ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_RF_PATH_SEL_20, MSM Pin Name: GPIO_45*/
  {  RFC_ANT_SEL                         ,  51              ,  14             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[14]"},  /* Signal: RFC_MSM_RF_PATH_SEL_21, MSM Pin Name: GPIO_51*/
  ...
  {  RFC_PA_RANGE0                       ,  42              ,  5              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[5]"},  /* Signal: RFC_MSM_PA0_R0, MSM Pin Name: GPIO_42*/
  {  RFC_PA_RANGE1                       ,  47              ,  10             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[10]"},  /* Signal: RFC_MSM_PA0_R1, MSM Pin Name: GPIO_47*/
  {  RFC_PA_RANGE0                       ,  38              ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_PA1_R0_DEFAULT, MSM Pin Name: GPIO_38*/
  {  RFC_PA_RANGE1                       ,  40              ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_PA1_R1_DEFAULT, MSM Pin Name: GPIO_40*/
  {  RFC_PA_RANGE0                       ,  45              ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_PA0_R0_ALT1, MSM Pin Name: GPIO_45*/
  {  RFC_PA_RANGE1                       ,  46              ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_PA0_R1_ALT1, MSM Pin Name: GPIO_46*/
  {  RFC_PA_RANGE0                       ,  50              ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_PA1_R2, MSM Pin Name: GPIO_50*/
  {  RFC_PA_RANGE1                       ,  43              ,  6              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[6]"},  /* Signal: RFC_MSM_PA0_R2, MSM Pin Name: GPIO_43*/
  {  RFC_PA_RANGE0                       ,  41              ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_PA0_R3, MSM Pin Name: GPIO_41*/
  ...
  {  RFC_PA_ON                           ,  45              ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_PA_ON_00, MSM Pin Name: GPIO_45*/
  {  RFC_PA_ON                           ,  40              ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_PA_ON_01, MSM Pin Name: GPIO_40*/
  {  RFC_PA_ON                           ,  44              ,  7              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[7]"},  /* Signal: RFC_MSM_PA_ON_02, MSM Pin Name: GPIO_44*/
  {  RFC_PA_ON                           ,  RFC_GPIO_INVALID              ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_PA_ON_03, MSM Pin Name: GPIO_49*/
  {  RFC_PA_ON                           ,  37              ,  0              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[0]"},  /* Signal: RFC_MSM_PA_ON_04, MSM Pin Name: GPIO_37*/
  {  RFC_PA_ON                           ,  51              ,  14             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[14]"},  /* Signal: RFC_MSM_PA_ON_05, MSM Pin Name: GPIO_51*/
  {  RFC_PA_ON                           ,  41              ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_PA_ON_06, MSM Pin Name: GPIO_41*/
  {  RFC_PA_ON                           ,  39              ,  2              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[2]"},  /* Signal: RFC_MSM_PA_ON_07, MSM Pin Name: GPIO_39*/
  ...
  {  RFC_PA_ON                           ,  38              ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_PA_ON_10, MSM Pin Name: GPIO_38*/
  ...
  {  RFC_PA_ON                           ,  50              ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_PA_ON_12, MSM Pin Name: GPIO_50*/
  ...
  {  RFC_PA_ON                           ,  46              ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_PA_ON_18, MSM Pin Name: GPIO_46*/
  ...
  {  RFC_RFFE1_CLK                       ,  54              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe1_clk"},  /* Signal: RFC_MSM_RFFE1_CLK, MSM Pin Name: GPIO_54*/
  {  RFC_RFFE1_DATA                      ,  53              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe1_data"},  /* Signal: RFC_MSM_RFFE1_DATA, MSM Pin Name: GPIO_53*/
  {  RFC_RFFE2_CLK                       ,  56              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe2_clk"},  /* Signal: RFC_MSM_RFFE2_CLK, MSM Pin Name: GPIO_56*/
  {  RFC_RFFE2_DATA                      ,  55              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe2_data"},  /* Signal: RFC_MSM_RFFE2_DATA, MSM Pin Name: GPIO_55*/
  {  RFC_RFFE3_CLK                       ,  58              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe3_clk"},  /* Signal: RFC_MSM_RFFE3_CLK, MSM Pin Name: GPIO_58*/
  {  RFC_RFFE3_DATA                      ,  57              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe3_data"},  /* Signal: RFC_MSM_RFFE3_DATA, MSM Pin Name: GPIO_57*/
  {  RFC_RFFE4_CLK                       ,  60              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe4_clk"},  /* Signal: RFC_MSM_RFFE4_CLK, MSM Pin Name: GPIO_60*/
  {  RFC_RFFE4_DATA                      ,  59              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe4_data"},  /* Signal: RFC_MSM_RFFE4_DATA, MSM Pin Name: GPIO_59*/
  {  RFC_RFFE5_CLK                       ,  62              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe5_clk"},  /* Signal: RFC_MSM_RFFE5_CLK, MSM Pin Name: GPIO_62*/
  {  RFC_RFFE5_DATA                      ,  61              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe5_data"},  /* Signal: RFC_MSM_RFFE5_DATA, MSM Pin Name: GPIO_61*/
  ...
  {  RFC_GPDATA_CHAN0                    ,  64              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  1,  DAL_GPIO_OUTPUT                      ,"gsm0_tx_phase_d"},  /* Signal: RFC_MSM_GPDATA0_0, MSM Pin Name: GPIO_64*/
  ...
  {  RFC_GPDATA_CHAN1                    ,  53              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"gsm1_tx_phase_d"},  /* Signal: RFC_MSM_GPDATA1_0, MSM Pin Name: GPIO_53*/
  ...
  {  RFC_PA_IND                          ,  RFC_GPIO_INVALID              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"pa_indicator_1_or_2"},  /* Signal: RFC_MSM_PA_IND, MSM Pin Name: GPIO_49*/
  ...
  {  RFC_ANT_SEL                         ,  52              ,  15             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[15]"},  /* Signal: RFC_MSM_RF_PATH_SEL_26, MSM Pin Name: GPIO_52*/
};
...
uint32 rfc_msm_sig_info_table_get(rfc_msm_signal_info_type **msm_info_table)
{
  ...
  *msm_info_table = &rfc_kamorta_signal_info[0];
...
{
  {  LTE_TX_ON_UL_SF_SMPS_PGM,  -730 },  /* FDD, TDD, Unit: Ts */
  {  LTE_TX_ON_UL_SF_PA_CTL_ON,  -684 },  /* FDD, TDD, Unit: Ts */
  ...
  {  LTE_TX_OFF_CELL_SRS_PA_CTL_OFF,  -32 },  /* FDD, TDD, Unit: Ts */
