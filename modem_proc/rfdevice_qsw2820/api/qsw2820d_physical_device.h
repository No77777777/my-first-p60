#ifndef QSW2820D_PHYSICAL_DEVICE_H
#define QSW2820D_PHYSICAL_DEVICE_H
/*!
   @file
   qsw2820d_physical_device.h

   @brief
   qsw2820d physical device driver
...
$Header: //components/rel/rfdevice_qsw2820.mpss/1.11/api/qsw2820d_physical_device.h#1 $ 
...
#include "qsw2820d_asm_config_main_ag.h"
#include "qsw2820d_coupler_config_main_ag.h"

class qsw2820d_physical_device : public rfdevice_physical_device
{
public:

  qsw2820d_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qsw2820d_physical_device* qsw2820d_physical_device_p;
...
private:
  ...
  rfdevice_qasm_2g* qsw2820d_asm_obj_ptr;

  /* COUPLER */
  void create_coupler_object(rfc_logical_device_info_type *logical_device_cfg);

  rfdevice_qcoupler* qsw2820d_coupler_obj_ptr;
};
#endif