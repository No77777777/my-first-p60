...
$Header: //source/qcom/qct/modem/fw/components/fw_c2k.mpss/rel/17.0/api/cdmafw_const.h#1 $
...
#define CDMAFW_LOG_DIAG_PKT_END_ID              0x1631
...
#define CDMAFW_FL_FINGER_CFG_ASSIGN_MSG_LOG_PKT_VER   1
...
/*!< Finger, QLIC_FING & Global DMEM Log */
#define CDMAFW_FL_FING_QLIC_DMEM_LOG_PKT_OFS    0x6
#define CDMAFW_FL_FING_QLIC_DMEM_LOG_PKT_ID     (CDMAFW_LOG_DIAG_PKT_START_ID + \
                                                 CDMAFW_FL_FING_QLIC_DMEM_LOG_PKT_OFS)
#define CDMAFW_FL_FING_QLIC_DMEM_LOG_PKT_VER    0

#define CDMAFW_FL_FINGER_TT_LOG_PKT_OFS         0x7
#define CDMAFW_FL_FINGER_TT_LOG_PKT_ID         (CDMAFW_LOG_DIAG_PKT_START_ID + \
                                                 CDMAFW_FL_FINGER_TT_LOG_PKT_OFS)
#define CDMAFW_FL_FINGER_TT_LOG_PKT_VER         0
...
/*!< Fing/Comb Deskew Log Packet */
#define CDMAFW_FL_FING_COMB_DESKEW_LOG_PKT_OFS  0x28
#define CDMAFW_FL_FING_COMB_DESKEW_LOG_PKT_ID   (CDMAFW_LOG_DIAG_PKT_START_ID + \
                                                 CDMAFW_FL_FING_COMB_DESKEW_LOG_PKT_OFS)
#define CDMAFW_FL_FING_COMB_DESKEW_LOG_PKT_VER  0

/*!< LC Timing Log Packet */
#define CDMAFW_FL_LC_TIMING_LOG_PKT_OFS         0x29
#define CDMAFW_FL_LC_TIMING_LOG_PKT_ID          (CDMAFW_LOG_DIAG_PKT_START_ID + \
                                                 CDMAFW_FL_LC_TIMING_LOG_PKT_OFS)
#define CDMAFW_FL_LC_TIMING_LOG_PKT_VER         0
...
#define CDMAFW_RPC_LOG_PKT_VER                 1
...
/*!<X->1x QTA Log */
#define CDMAFW_QTA_LOG_PKT_OFS                 0x12
#define CDMAFW_QTA_LOG_PKT_ID                  (CDMAFW_LOG_DIAG_PKT_START_ID + \
                                                 CDMAFW_QTA_LOG_PKT_OFS)
#define CDMAFW_QTA_LOG_PKT_VER                 0
...
/*!< FL DRX Log */
#define CDMAFW_FL_DRX_LOG_PKT_OFS               0x16
#define CDMAFW_FL_DRX_LOG_PKT_ID                (CDMAFW_LOG_DIAG_PKT_START_ID + \
                                                 CDMAFW_FL_DRX_LOG_PKT_OFS)
#define CDMAFW_FL_DRX_LOG_PKT_VER     0
