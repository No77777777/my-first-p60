...
/** 
  ...
  $Header: //source/qcom/qct/modem/fw/components/fw_c2k.mpss/rel/17.0/api/cfw_rf_intf.h#1 $
...
typedef struct {
  ...
  /* Script index for RF script to be run as part of QTA
   * and IRAT gap clean up.
   * */
  uint32                    rf_stop_script_idx;
