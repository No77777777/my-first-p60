...
#ifndef QFE2082FC_V200_COUPLER_CONFIG_AG_H
#define QFE2082FC_V200_COUPLER_CONFIG_AG_H/*
...
boolean rfdevice_qcoupler_qfe2082fc_v200_construct_driver_ag
(
  rfdevice_qcoupler_settings_type* qcoupler_settings,
  rfdevice_qcoupler_func_tbl_type* qcoupler_fn_ptrs
);

boolean rfdevice_qcoupler_qfe2082fc_v200_get_config_data_ag
(
