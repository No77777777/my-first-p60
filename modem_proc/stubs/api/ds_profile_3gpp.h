...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/ds_profile_3gpp.h#3 $ $DateTime: 2021/07/08 09:57:42 $ $Author: tfong $
...
/* MAX Number of Operator Reserved PCOs */
#define DS_PROFILE_3GPP_OP_RESERVED_PCO_ID_LIST_MAX 10
...
/** MSISDN Request flag type */
typedef boolean ds_profile_3gpp_request_msisdn_flag_type;
...
/**< PDN Throttle Timers */
typedef uint16 
  ds_profile_3gpp_op_reserved_pco_id_list[DS_PROFILE_3GPP_OP_RESERVED_PCO_ID_LIST_MAX];
...
typedef enum
{
  ...
  */
  ...
  DS_PROFILE_3GPP_PROFILE_OP_RESERVED_PCO_ID_LIST         = 0x47,
  /**< List of operator reserved pco IDs*/ 
  DS_PROFILE_3GPP_PROFILE_MSISDN_REQ_FLAG                 = 0x48,
  /**< MSISDN Request flag */   
  
  /*< 0x49 RESERVE PROFIED PARAM*/

  DS_PROFILE_3GPP_PROFILE_PARAM_PDN_LABEL                = 0x4A,
  /**< 3GPP PDN Label */
  DS_PROFILE_3GPP_PROFILE_PARAM_SUBS_ID                   = 0x4B,
     /** SUBS ID */
  DS_PROFILE_3GPP_PROFILE_PARAM_APN_TYPE                  = 0x4C,
  /**< APN Type */   
  DS_PROFILE_3GPP_PROFILE_PARAM_MAX = DS_PROFILE_3GPP_PROFILE_PARAM_APN_TYPE
