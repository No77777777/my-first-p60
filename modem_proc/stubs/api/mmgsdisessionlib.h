...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/mmgsdisessionlib.h#3 $$ $DateTime: 2021/07/08 09:57:42 $ $Author: tfong $
...
/**
  ...
  @param[in] client_ref         User data returned upon completion of this
                                command.
  @param[in] is_auto_activation MMGSDI auto-activate or client req
...
/**
  ...
  @param[in] mmgsdi_session    Session to retrieve NVRUIM data
...
DESCRIPTION
  This function will purge the temorary identity stored in UICC and 
...
DESCRIPTION
  This function reads the IMSI data based on session id and compares the MCC value in IMSI against
  set of reserved MCC values to figure out if it is a test IMSI.
...
RETURN VALUE
  MMGSDI_SUCCESS         :   Successful determination of whether test card is used or not
