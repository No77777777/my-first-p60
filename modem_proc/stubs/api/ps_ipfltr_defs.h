...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/ps_ipfltr_defs.h#3 $ $DateTime: 2021/07/08 09:57:42 $ $Author: tfong $
...
typedef struct
{
  ...
  union
  {
    ...
    {    
      ...
      uint8   type_range; /**< ICMP code range */
