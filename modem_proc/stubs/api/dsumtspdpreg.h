...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/dsumtspdpreg.h#3 $ $DateTime: 2021/07/08 09:57:42 $ $Author: tfong $
...
*/
#define  DS_UMTS_MAX_PDP_PROFILE_NUM   42
#define  DS_UMTS_MAX_PDP_TRANSIENT_PROFILE_NUM 16 
...
#define DS_3GPP_OP_RESERVED_PCO_ID_LIST_MAX     10
#define DS_3GPP_MAX_PDN_LABLE_LENTH             100
...
uint16                         tech_mask;
 ...
 /*-------------------------------------------------------------------------------------------- 
  ...
  boolean                        attach_flag;
                                            /**<This flag specifies whether the profile is 
                                              Attach Profile or not */
...
boolean                         request_msisdn_flag;
                               /*request msisdn pco*/

  uint8                         profile_client;
									   /**< Profile client */
  char                          pdn_label[DS_3GPP_MAX_PDN_LABLE_LENTH + 1];    /*PDN label*/
