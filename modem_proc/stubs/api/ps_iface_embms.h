...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/ps_iface_embms.h#3 $
  $Author: tfong $ $DateTime: 2021/07/08 09:57:42 $
...
/**
  @brief This is the payload carried along with the event
         IFACE_EMBMS_SVC_INTEREST_IND_EV */
typedef struct
{
  int16 debug_trace_id;
} ps_iface_embms_svc_interest_ind_type;

/**
  @brief This is the payload for the PS_IFACE_IOCTL_EMBMS_SVC_INTEREST
  request IOCTL 
*/
typedef struct
{
  int16                       debug_trace_id;
  uint8                       num_tmgi;
  ps_iface_embms_tmgi_type  * tmgi_list;
} ps_iface_embms_svc_interest_req_type;
