...
Copyright (c) 2008 - 2013, 2015, 2017 QUALCOMM Technologies, Inc (QTI) and its licensors.  
...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/mmgsdilib_v.h#3 $
...
/*----------------------------------------------------------------------------
  DEFINE:      MMGSDI_MAX_RECS_IN_LINEAR_FIXED_EF

  DESCRIPTION: Defined the maximum Record number for linear fixed file.
  -----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------*/
#define MMGSDI_MAX_SEARCH_RECORD_NUMBER  MMGSDI_MAX_RECS_IN_LINEAR_FIXED_EF
...
/* ------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------*/
#define MMGSDI_MAX_ENHANCED_SEARCH_RECORD_OFFSET  MMGSDI_MAX_RECS_IN_LINEAR_FIXED_EF
