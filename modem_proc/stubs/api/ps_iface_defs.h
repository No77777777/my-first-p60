...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/ps_iface_defs.h#3 $ : //source/qcom/qct/modem/api/datacommon/main/latest/ps_iface_defs.h#41 $ $DateTime: 2021/07/08 09:57:42 $ $Author: tfong $
...
typedef enum
{
  ...
  */
  ...
  /**< Posted by mode hander to enable or disable offload flow control.
  */

  IFACE_DPD_PING_INFO_EV                             = 85,
  /**< Posted by mode hander to indicate the statistics 
  ...
  */
  ...
  /**< Posted by mode hander to update RAN assist media adaptation information
       from the network.
  */
  ...
  /**< Posted by mode hander to Send Flow control information.
  */
