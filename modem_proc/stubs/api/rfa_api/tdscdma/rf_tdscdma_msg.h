...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/tdscdma/rf_tdscdma_msg.h#1 $
...
/*! RF per cycle RxD on indication type */
/* Primary path only, or Primary and Diversity path  */
typedef enum
{
  RFA_TDSCDMA_WAKEUP_PRIM_ONLY,
  RFA_TDSCDMA_WAKEUP_PRIM_DIV,
  RFA_TDSCDMA_WAKEUP_MAX,
} rfa_tdscdma_wakeup_rxd_ind_t;
...
typedef struct
{
  ...
  /* New: RF per cycle RxD on indication*/
