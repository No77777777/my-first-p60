...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/lte/ftm_lte_ns_msg.h#1 $
$Author: mplcsds1 $
...
#define FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_CMD_CODE_C  19
#define FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_CMD_CODE_C 20
#define FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_CMD_CODE_C    21
#define FTM_LTE_NS_MAX_CMD_CODE_C                       22
...
enum
{
  ...
  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, ENABLE_MULTI_SCELL_RX_TX, FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_CMD_CODE_C,ftm_lte_ns_enable_multi_scell_rx_tx_req_msg_type), /* FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, ENABLE_MULTI_SCELL_RX_TX, FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_CMD_CODE_C,ftm_lte_ns_enable_multi_scell_rx_tx_cnf_msg_type), /* FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_CNF */
  ...
  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, DISABLE_MULTI_SCELL_RX_TX,            FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_CMD_CODE_C,              ftm_lte_ns_disable_multi_scell_rx_tx_req_msg_type), /* FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, DISABLE_MULTI_SCELL_RX_TX,            FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_CMD_CODE_C,              ftm_lte_ns_disable_multi_scell_rx_tx_cnf_msg_type), /* FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, ACTIVE_DL_CARRIER_MASK,            FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_CMD_CODE_C,              ftm_lte_ns_active_dl_carrier_mask_req_msg_type), /* FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, ACTIVE_DL_CARRIER_MASK,            FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_CMD_CODE_C,              ftm_lte_ns_active_dl_carrier_mask_cnf_msg_type), /* FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_CNF */
};
...
typedef PACK(struct)
{
  ftm_lte_ns_enable_scell_req_data_type ns_ul_scell_data;
...
} ftm_lte_ns_enable_multi_ul_scell_req_data_type;

/*! @brief This structure holds the complete DL and UL parameters of ENABLE_SCELL_RX_TX_REQ 
 *         to be sent to LTE L1
 */
typedef PACK(struct)
{

  ftm_lte_ns_enable_multi_scell_req_data_type ns_dl_req_data;
  uint8 ul_carrier_mask;
  ftm_lte_ns_enable_multi_ul_scell_req_data_type ns_ul_req_data [FTM_LTE_NS_MAX_CARRIERS-1];

} ftm_lte_ns_enable_multi_scell_rx_tx_req_data_type;


/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_REQ
 */
typedef PACK(struct)
{
  msgr_hdr_struct_type         hdr;
  ftm_lte_ns_enable_multi_scell_rx_tx_req_data_type enable_multi_scell_rx_tx_data;
} ftm_lte_ns_enable_multi_scell_rx_tx_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_ENABLE_MULTI_SCELL_RX_TX_CNF
 */
typedef PACK(struct)
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_enable_multi_scell_rx_tx_cnf_msg_type;
...
/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_ENABLE_MULTI_RX_TX_SCELL_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type       status;
} ftm_lte_ns_enable_multi_scell_rx_tx_cnf_diag_rsp_type;
...
/*! @brief This structure holds the parameters for the
 *         FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_REQ
 */
typedef PACK(struct)
{
  uint8                dl_carr_cfg_mask;
  uint8                ul_carr_cfg_mask;
} ftm_lte_ns_disable_multi_scell_rx_tx_req_data_type;
...
{
  msgr_hdr_struct_type hdr;
  ftm_lte_ns_disable_multi_scell_rx_tx_req_data_type  disable_multi_scell_rx_tx_data;
} ftm_lte_ns_disable_multi_scell_rx_tx_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_CNF
 */
typedef PACK(struct)
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_disable_multi_scell_rx_tx_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_DISABLE_MULTI_SCELL_RX_TX_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type       status;
} ftm_lte_ns_disable_multi_scell_rx_tx_cnf_diag_rsp_type;

/*! @brief This structure holds the parameters of ACTIVE_DL_CARRIER_MASK 
 *         to be sent to LTE L1
 */
typedef PACK(struct)
{
  uint16 active_dl_carrier_mask;
} ftm_lte_ns_active_dl_carrier_mask_req_data_type;


/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK
 */
typedef PACK(struct)
{
  msgr_hdr_struct_type         hdr;
  ftm_lte_ns_active_dl_carrier_mask_req_data_type active_dl_carrier_mask_data;
} ftm_lte_ns_active_dl_carrier_mask_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_RX_TX_CNF
 */
typedef PACK(struct)
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_active_dl_carrier_mask_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_ACTIVE_DL_CARRIER_MASK_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type       status;
} ftm_lte_ns_active_dl_carrier_mask_cnf_diag_rsp_type;
/*===========================================================================
