...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/common/ftm_mgr_msg.h#1 $
...
typedef union
{
  ...
  ftm_lte_ns_enable_multi_scell_rx_tx_req_msg_type enable_multi_scell_rx_tx_req_msg;
  ftm_lte_ns_enable_multi_scell_rx_tx_cnf_msg_type enable_multi_scell_rx_tx_cnf_msg;
  ...
  ftm_lte_ns_disable_multi_scell_rx_tx_req_msg_type disable_multi_scell_rx_tx_req_msg;
  ftm_lte_ns_disable_multi_scell_rx_tx_cnf_msg_type disable_multi_scell_rx_tx_cnf_msg;
  ftm_lte_ns_active_dl_carrier_mask_req_msg_type active_dl_carrier_mask_req_msg;
  ftm_lte_ns_active_dl_carrier_mask_cnf_msg_type active_dl_carrier_mask_cnf_msg;
