...
/*==============================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/common/rfm_async_types.h#1 $ 
...
typedef enum
{
  ...
  RFM_EXIT_MODE_COMPLETE, /*!< The radio has completed the exit mode operation. */
  ...
  RFM_WCDMA_RX_DEINIT_COMPLETE, /*!< WCDMA Rx Deinit Complete */
