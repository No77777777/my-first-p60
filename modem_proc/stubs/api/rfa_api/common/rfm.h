...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/common/rfm.h#1 $
...
*/
  void rfm_get_cell_txpll_script_v2( rfm_mode_enum_type mode,
                                     uint32 carrier_idx,
                                     uint32 txlm_handle,
                                     int32 rx_freq_error_in_hz);
  
/*----------------------------------------------------------------------------*/
void rfm_get_cell_txpll_script( rfm_mode_enum_type mode,
                                uint32 carrier_idx,
                                int32 rx_freq_error_in_hz);
