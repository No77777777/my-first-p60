...
/*==============================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/common/rfcommon_autopin_api.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
06/06/16   wxl     Add autopin flag enable check API
12/09/15   kma     Added WTR PAR result into capture control structure 
11/20/15   vr      Autopin check-in 
11/10/15   whz     Move WTR PAR CCS programming delay macros to RFLM
