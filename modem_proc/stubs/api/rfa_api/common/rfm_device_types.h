...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/common/rfm_device_types.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
08/28/15   fhuo    Add support for RFM_DEVICE_WLAN_PRX and RFM_DEVICE_WLAN_DRX
06/12/15   stw     Add support for RFM_DEVICE_8 and RFM_DEVICE_9
03/05/15   zhw     Add support for RFM_DEVICE_6 and RFM_DEVICE_7
