...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/gsm/rfgsm_ftm_msg.h#1 $
 ...
 */
#define RFA_RF_GSM_FTM_MSG_ID_SET_MODE                          0x01

/*! @brief ID for FTM to turn Tx on */
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_ON                         0x02

/*! @brief ID for FTM to turn Tx off */
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_OFF                        0x03

/*! @brief ID for FTM to set LNA range */
#define RFA_RF_GSM_FTM_MSG_ID_SET_LNA_RANGE                     0x04

/*! @brief ID for FTM to set PDM */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PDM                           0x05

/*! @brief ID for FTM to set channel */
#define RFA_RF_GSM_FTM_MSG_ID_SET_BAND                          0x06

/*! @brief ID for FTM to set Tx in continuous mode */
#define RFA_RF_GSM_FTM_MSG_ID_SET_TRANSMIT_CONT                 0x07

/*! @brief ID for FTM to set Tx in burst mode */
#define RFA_RF_GSM_FTM_MSG_ID_SET_TRANSMIT_BURST                0x08

/*! @brief ID for FTM to set Rx to burst mode */
#define RFA_RF_GSM_FTM_MSG_ID_SET_RX_BURST                      0x09

/*! @brief ID for FTM to get RSSI */
#define RFA_RF_GSM_FTM_MSG_ID_GET_RSSI                          0x0A

/*! @brief ID for FTM to set PA start delta */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_START_DELTA                0x0B

/*! @brief ID for FTM to set PA stop delta */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_STOP_DELTA                 0x0C

/*! @brief ID for FTM to set PA DAC input */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_DAC_INPUT                  0x0D

/*! @brief ID for FTM to set Rx in continuous mode */
#define RFA_RF_GSM_FTM_MSG_ID_SET_RX_CONTINUOUS                 0x0E

/*! @brief ID for FTM to set GSM Tx path delay */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY                    0x0F

/*! @brief ID for FTM to set the Tx frame matrix */
#define RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG            0x10

/*! @brief ID for FTM to perform Rx gain range calibration */
#define RFA_RF_GSM_FTM_MSG_ID_RX_GAIN_RANGE_CAL                 0x11

/*! @brief ID for FTM to perform Tx KVCO calibration */
#define RFA_RF_GSM_FTM_MSG_ID_TX_KV_CAL                         0x12

/*! @brief ID for FTM to perform Tx KVCO calibration version 2 algorithm (speed optimised) */
#define RFA_RF_GSM_FTM_MSG_ID_TX_KV_CAL_V2                      0x13

/*! @brief ID for FTM to set the PA gain range */
#define RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE               0x14

/*! @brief ID for FTM to set the RGI (Radio Gain Index) value */
#define RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI                    0x15

/*! @brief ID for FTM to capture GSM Rx IQ samples */
#define RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ                        0x16

/*! @brief ID for FTM to adjust Rx timing */
#define RFA_RF_GSM_FTM_MSG_ID_SET_RX_TIMING                     0x17

/*! @brief ID for FTM to adjust Tx timing */
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_TIMING                     0x18

/*! @brief ID for FTM to perform Tx gain sweep for calibration */
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_GAIN_SWEEP                 0x19

/*! @brief ID for FTM to perform Tx envelope DC sweep for calibration */
#define RFA_RF_GSM_FTM_MSG_ID_TX_ENVDC_CS_SWEEP                 0x1A

/*! @brief ID for FTM to perform AMAM sweep version 2 calibration */
#define RFA_RF_GSM_FTM_MSG_ID_CFG2_AMAM_SWEEP_V2                0x1B

/*! @brief ID for FTM to set Rx multislot */
#define RFA_RF_GSM_FTM_MSG_ID_SET_RX_MULTISLOT                  0x1C

/*! @brief ID for FTM to set Rx burst gain for the expected power level */
#define RFA_RF_GSM_FTM_MSG_ID_SET_RX_BURST_FOR_EXPECTED_PWR     0x1D

/*! @brief ID for FTM to get the measured power for the previous Rx bursts */
#define RFA_RF_GSM_FTM_MSG_ID_GET_MEAS_PWR                      0x1E

/*! @brief ID for FTM to set the tx power in dBm*/
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM                    0x1F

/*! @brief ID for FTM to tune Tx */
#define RFA_RF_GSM_FTM_MSG_ID_TUNE_TX                           0x20

/*! @brief ID for FTM to override tuner code */
#define RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE                    0x21

#define RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS                0x22

#define RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS                0x23

#define RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS               0x24

#define RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE              0x25

#define RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE              0x26

#define RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS               0x27


 /*! @define MSGR SUB1 FTM IDs to enter GSM mode of operation */
/*! @brief SUB1 IDs for all of the commands to RF GSM  */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_START_DELTA_SUB1            0x30
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_STOP_DELTA_SUB1             0x31
#define RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY_SUB1                0x32
#define RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG_SUB1        0x33
#define RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE_SUB1           0x34
#define RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI_SUB1                0x35
#define RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ_SUB1                    0x36
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM_SUB1                0x37
#define RFA_RF_GSM_FTM_MSG_ID_TUNE_TX_SUB1                       0x38
#define RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE_SUB1                0x39
#define RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS_SUB1            0x3A 
#define RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS_SUB1            0x3B
#define RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS_SUB1           0x3C
#define RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE_SUB1          0x3D
#define RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE_SUB1          0x3E
#define RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS_SUB1           0x3F


/*! @define MSGR SUB2 FTM IDs to enter GSM mode of operation */
/*! @brief SUB2 IDs for all of the commands to RF GSM  */
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_START_DELTA_SUB2            0x60
#define RFA_RF_GSM_FTM_MSG_ID_SET_PA_STOP_DELTA_SUB2             0x61
#define RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY_SUB2                0x62
#define RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG_SUB2        0x63
#define RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE_SUB2           0x64
#define RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI_SUB2                0x65
#define RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ_SUB2                    0x66
#define RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM_SUB2                0x67
#define RFA_RF_GSM_FTM_MSG_ID_TUNE_TX_SUB2                       0x68
#define RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE_SUB2                0x69
#define RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS_SUB2            0x6A 
#define RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS_SUB2            0x6B
#define RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS_SUB2           0x6C
#define RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE_SUB2          0x6D
#define RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE_SUB2          0x6E
#define RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS_SUB2           0x6F
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_QPOET_MODE_BIAS, RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS, rfa_rf_gsm_ftm_set_qpoet_mode_bias_cmd_s),
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_QPOET_MODE_BIAS, RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS, rfa_rf_gsm_ftm_set_qpoet_mode_bias_rsp_s),
...
/*=============================================================================
                            FTM Task GSM messages
===================================================================================*/
/*! @enum                                                                          */
/*! @brief SUB1 request(cmd) UMIDs                                                 */
/*! @details MACRO-based enumeration members for SUB1 MSGR confirmation IDs        */
/*!          This enum is never called by name. It just defines symbols.           */
/*!          GSM subsystem message IDs the FTM task sends.                         */
/*!          RFA_RF_GSM_FTM<command>_CNF = (MSGR_RFA_RF_GSM_FTM & 0xFFFF) << 16 |  */
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |              */
/*!                                   (RFA_RF_GSM_FTM_MSG_ID_<command> & 0xFF)     */
/*!          RFA_RF_GSM_FTM_CNF_<command> = (MSGR_RFA_RF_GSM_FTM & 0xFFFF) << 16 |  */
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |              */
/*!                                     (RFA_RF_GSM_FTM_MSG_ID_<command> & 0xFF)   */
enum
{
  /*! Command to set GSM Tx path delay, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_PATH_DELAY_SUB1,             RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY_SUB1,          rfa_rf_gsm_ftm_set_path_delay_type_cmd_s),

  /*! Command to set the slot_override_flag, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_SLOT_OVERRIDE_FLAG_SUB1,     RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG_SUB1,  rfa_rf_gsm_ftm_set_slot_override_flag_type_cmd_s),

  /*! Command to set the PA gain range, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_LINEAR_PA_RANGE_SUB1,        RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE_SUB1,     rfa_rf_gsm_ftm_set_pa_range_type_cmd_s),

    /*! Command to set the RGI (Radio Gain Index) value, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_LINEAR_RGI_SUB1,             RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI_SUB1,          rfa_rf_gsm_ftm_set_mode_type_cmd_s),

	
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_QPOET_MODE_BIAS_SUB1, RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS_SUB1, rfa_rf_gsm_ftm_set_qpoet_mode_bias_cmd_s),

  /*! Command to capture GSM Rx IQ samples, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, CAPTURE_IQ_SUB1,                 RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ_SUB1,              rfa_rf_gsm_ftm_capture_iq_type_cmd_s),

  /*! Command to set the Tx power in dBm for a specific slot index, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_TX_POW_DBM_SUB1,             RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM_SUB1,          rfa_rf_gsm_ftm_set_tx_pow_dbm_type_cmd_s),
  
  /*! Command to tune the RF to a specific arfcn, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, TUNE_TX_SUB1,                    RFA_RF_GSM_FTM_MSG_ID_TUNE_TX_SUB1,                 rfa_rf_gsm_ftm_tune_tx_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, TUNER_TUNE_CODE_OVERRIDE_SUB1,   RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE_SUB1,          rfa_rf_gsm_ftm_tuner_override_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_IP2_CAL_PARAMS_SUB1,         RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS_SUB1,      rfa_rf_gsm_ftm_ip2_cal_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, GET_IP2_CAL_PARAMS_SUB1,         RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS_SUB1,      rfa_rf_gsm_ftm_get_ip2_cal_info_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, GET_IP2_CAL_RESULTS_SUB1,        RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS_SUB1,     rfa_rf_gsm_ftm_get_ip2_cal_results_cmd_s),

  /*! Override the Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_SAWLESS_LIN_MODE_SUB1,        RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE_SUB1,   rfa_rf_gsm_ftm_set_sawless_lin_mode_cmd_s),

  /*! Report current Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, GET_SAWLESS_LIN_MODE_SUB1,        RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE_SUB1,   rfa_rf_gsm_ftm_get_sawless_lin_mode_cmd_s),
  
};

/*!================================================================================*/
/*! @enum                                                                          */
/*! @brief SUB2 request(cmd) UMIDs                                                 */
...
{
  /*! Command to set GSM Tx path delay, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_PATH_DELAY_SUB2,             RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY_SUB2,          rfa_rf_gsm_ftm_set_path_delay_type_cmd_s),

  /*! Command to set the slot_override_flag, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_SLOT_OVERRIDE_FLAG_SUB2,     RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG_SUB2,  rfa_rf_gsm_ftm_set_slot_override_flag_type_cmd_s),

  /*! Command to set the PA gain range, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_LINEAR_PA_RANGE_SUB2,        RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE_SUB2,     rfa_rf_gsm_ftm_set_pa_range_type_cmd_s),

      /*! Command to set the RGI (Radio Gain Index) value, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_LINEAR_RGI_SUB2,             RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI_SUB2,          rfa_rf_gsm_ftm_set_mode_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_QPOET_MODE_BIAS_SUB2, RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS_SUB2, rfa_rf_gsm_ftm_set_qpoet_mode_bias_cmd_s),

  /*! Command to capture GSM Rx IQ samples, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, CAPTURE_IQ_SUB2,                 RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ_SUB2,              rfa_rf_gsm_ftm_capture_iq_type_cmd_s),

  /*! Command to set the Tx power in dBm for a specific slot index, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_TX_POW_DBM_SUB2,             RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM_SUB2,          rfa_rf_gsm_ftm_set_tx_pow_dbm_type_cmd_s),
  
  /*! Command to tune the RF to a specific arfcn, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, TUNE_TX_SUB2,                    RFA_RF_GSM_FTM_MSG_ID_TUNE_TX_SUB2,                 rfa_rf_gsm_ftm_tune_tx_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, TUNER_TUNE_CODE_OVERRIDE_SUB2,   RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE_SUB2,          rfa_rf_gsm_ftm_tuner_override_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_IP2_CAL_PARAMS_SUB2,         RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS_SUB2,      rfa_rf_gsm_ftm_ip2_cal_type_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, GET_IP2_CAL_PARAMS_SUB2,         RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS_SUB2,      rfa_rf_gsm_ftm_get_ip2_cal_info_cmd_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, GET_IP2_CAL_RESULTS_SUB2,        RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS_SUB2,     rfa_rf_gsm_ftm_get_ip2_cal_results_cmd_s),

  /*! Override the Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, SET_SAWLESS_LIN_MODE_SUB2,        RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE_SUB2,   rfa_rf_gsm_ftm_set_sawless_lin_mode_cmd_s),

  /*! Report current Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CMD, GET_SAWLESS_LIN_MODE_SUB2,        RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE_SUB2,   rfa_rf_gsm_ftm_get_sawless_lin_mode_cmd_s),
...
{
  /*! Command to set GSM Tx path delay, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_PATH_DELAY_SUB1,             RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY_SUB1,          rfa_rf_gsm_ftm_set_path_delay_type_rsp_s),

  /*! Command to set the slot_override_flag, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_SLOT_OVERRIDE_FLAG_SUB1,     RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG_SUB1,  rfa_rf_gsm_ftm_set_slot_override_flag_type_rsp_s),

  /*! Command to set the PA gain range, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_LINEAR_PA_RANGE_SUB1,        RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE_SUB1,     rfa_rf_gsm_ftm_set_pa_range_type_rsp_s),

  /*! Command to set the RGI (Radio Gain Index) value, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_LINEAR_RGI_SUB1,             RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI_SUB1,          rfa_rf_gsm_ftm_set_mode_type_rsp_s),

	
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_QPOET_MODE_BIAS_SUB1, RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS_SUB1, rfa_rf_gsm_ftm_set_qpoet_mode_bias_rsp_s),

  /*! Command to capture GSM Rx IQ samples, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, CAPTURE_IQ_SUB1,                 RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ_SUB1,              rfa_rf_gsm_ftm_capture_iq_type_rsp_s),

  /*! Command to set the Tx power in dBm for a specific slot index, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_TX_POW_DBM_SUB1,             RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM_SUB1,          rfa_rf_gsm_ftm_set_tx_pow_dbm_type_rsp_s),
  
  /*! Command to tune the RF to a specific arfcn, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, TUNE_TX_SUB1,                    RFA_RF_GSM_FTM_MSG_ID_TUNE_TX_SUB1,                 rfa_rf_gsm_ftm_tune_tx_type_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, TUNER_TUNE_CODE_OVERRIDE_SUB1,   RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE_SUB1,          rfa_rf_gsm_ftm_tuner_override_type_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_IP2_CAL_PARAMS_SUB1,         RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS_SUB1,      rfa_rf_gsm_ftm_ip2_cal_type_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, GET_IP2_CAL_PARAMS_SUB1,         RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS_SUB1,      rfa_rf_gsm_ftm_get_ip2_cal_info_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, GET_IP2_CAL_RESULTS_SUB1,        RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS_SUB1,     rfa_rf_gsm_ftm_get_ip2_cal_results_rsp_s),

  /*! Override the Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_SAWLESS_LIN_MODE_SUB1,        RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE_SUB1,   rfa_rf_gsm_ftm_set_sawless_lin_mode_rsp_s),

  /*! Report current Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, GET_SAWLESS_LIN_MODE_SUB1,        RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE_SUB1,   rfa_rf_gsm_ftm_get_sawless_lin_mode_rsp_s),
...
{
  /*! Command to set GSM Tx path delay, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_PATH_DELAY_SUB2,             RFA_RF_GSM_FTM_MSG_ID_SET_PATH_DELAY_SUB2,          rfa_rf_gsm_ftm_set_path_delay_type_rsp_s),

  /*! Command to set the slot_override_flag, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_SLOT_OVERRIDE_FLAG_SUB2,     RFA_RF_GSM_FTM_MSG_ID_SET_SLOT_OVERRIDE_FLAG_SUB2,  rfa_rf_gsm_ftm_set_slot_override_flag_type_rsp_s),

  /*! Command to set the PA gain range, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_LINEAR_PA_RANGE_SUB2,        RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_PA_RANGE_SUB2,     rfa_rf_gsm_ftm_set_pa_range_type_rsp_s),

    /*! Command to set the RGI (Radio Gain Index) value, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_LINEAR_RGI_SUB2,             RFA_RF_GSM_FTM_MSG_ID_SET_LINEAR_RGI_SUB2,          rfa_rf_gsm_ftm_set_mode_type_rsp_s),

	
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_QPOET_MODE_BIAS_SUB2, RFA_RF_GSM_FTM_MSG_ID_SET_QPOET_MODE_BIAS_SUB2, rfa_rf_gsm_ftm_set_qpoet_mode_bias_rsp_s),

  /*! Command to capture GSM Rx IQ samples, sent by the FTM task to the RF task.*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, CAPTURE_IQ_SUB2,                 RFA_RF_GSM_FTM_MSG_ID_CAPTURE_IQ_SUB2,              rfa_rf_gsm_ftm_capture_iq_type_rsp_s),

  /*! Command to set the Tx power in dBm for a specific slot index, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_TX_POW_DBM_SUB2,             RFA_RF_GSM_FTM_MSG_ID_SET_TX_POW_DBM_SUB2,          rfa_rf_gsm_ftm_set_tx_pow_dbm_type_rsp_s),
  
  /*! Command to tune the RF to a specific arfcn, sent from FTM task to the RF task*/
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, TUNE_TX_SUB2,                    RFA_RF_GSM_FTM_MSG_ID_TUNE_TX_SUB2,                 rfa_rf_gsm_ftm_tune_tx_type_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, TUNER_TUNE_CODE_OVERRIDE_SUB2,   RFA_RF_GSM_FTM_MSG_ID_TUNER_OVERRIDE_SUB2,          rfa_rf_gsm_ftm_tuner_override_type_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_IP2_CAL_PARAMS_SUB2,         RFA_RF_GSM_FTM_MSG_ID_SET_IP2_CAL_PARAMS_SUB2,      rfa_rf_gsm_ftm_ip2_cal_type_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, GET_IP2_CAL_PARAMS_SUB2,         RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_PARAMS_SUB2,      rfa_rf_gsm_ftm_get_ip2_cal_info_rsp_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, GET_IP2_CAL_RESULTS_SUB2,        RFA_RF_GSM_FTM_MSG_ID_GET_IP2_CAL_RESULTS_SUB2,     rfa_rf_gsm_ftm_get_ip2_cal_results_rsp_s),

  /*! Override the Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, SET_SAWLESS_LIN_MODE_SUB2,        RFA_RF_GSM_FTM_MSG_ID_SET_SAWLESS_LIN_MODE_SUB2,   rfa_rf_gsm_ftm_set_sawless_lin_mode_rsp_s),

  /*! Report current Rx Linearity mode per ARFCN on a SAWless target */
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, RSP, GET_SAWLESS_LIN_MODE_SUB2,        RFA_RF_GSM_FTM_MSG_ID_GET_SAWLESS_LIN_MODE_SUB2,   rfa_rf_gsm_ftm_get_sawless_lin_mode_rsp_s),
...
typedef struct
{
  msgr_hdr_struct_type                     hdr;
  rfm_device_enum_type                     rfm_dev;
  rf_gsm_ftm_qpoet_param_type              qpoet_params;
} rfa_rf_gsm_ftm_set_qpoet_mode_bias_cmd_s;
...
typedef struct
{
  ...
  rf_gsm_ftm_qpoet_param_type              qpoet_params;
  rfa_rf_gsm_ftm_cmd_outcome_t             cmd_result;
} rfa_rf_gsm_ftm_set_qpoet_mode_bias_rsp_s;
...
typedef union
{
  ...
  rfa_rf_gsm_ftm_set_qpoet_mode_bias_cmd_s                         rfa_rf_gsm_ftm_set_qpoet_mode_bias_cmd;
  ...
  rfa_rf_gsm_ftm_set_qpoet_mode_bias_rsp_s                         rfa_rf_gsm_ftm_set_qpoet_mode_bias_rsp;
