...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/gsm/ftm_gsm.h#1 $ 
...
12/09/14   ck      Add structure for setting alt_path 
11/20/14   zbz     Fix KW
...
typedef PACK(struct)
{
  ...
  uint16 bias;
  boolean override;
}ftm_gsm_qpoet_mode_bias_type;

typedef PACK(struct)
{
    /*Results*/
  boolean status;
}ftm_gsm_set_qpoet_mode_bias_resp_type;
...
typedef PACK(struct)
{
  ...
  PACK(union)
  {
    ...
    ftm_gsm_set_alt_path_type     ftm_gsm_set_alt_path_params;  
    ftm_gsm_get_nv_container_type ftm_gsm_get_nv_container_params;
    ftm_gsm_qpoet_mode_bias_type  ftm_gsm_qpoet_mode_bias_params;
  } ftm_gsm_data_union;
} gsm_option_type;
