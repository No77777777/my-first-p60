...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/gsm/ftm_egprs_ber.h#1 $ 
...
DESCRIPTION    This function returns current state of FTM EGPRS BER operations for a specific
				ftm gsm chain.
PARAMETERS 
...
===========================================================================*/
ftm_egprs_ber_state_type ftm_egprs_ber_get_dev_state( uint8 curr_chain);
