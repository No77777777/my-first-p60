...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/gsm/rfgsm_msg.h#1 $
$DateTime: 2018/04/15 02:22:08 $
$Author: mplcsds1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/13/16   kpa     Add aci_flag in GRF- GL1 interface msgr
11/10/15   tws     Add FBRX VSWR support
08/18/15   sc      Deprecate subscription 3 reducing memory footprint
07/04/15   cpm     FR27546: MTPL reported for the top/bottom antennas
07/02/15   ec      Add typedef to encapsulate SAWless support table
...
04/17/15   ggs     Pass back Tx power in  dBm100 to GL1 in Tx confirmation
                   message
04/16/15   sc      Enable idle frame processing for split Rx/Tx devices
04/08/15   sc      Add sawless, therm and ccs execution time support
03/11/15   sc      Add Rx/Tx Wakeup/Sleep interface
03/10/15   cpm     added number of antenna tuner device count
02/19/15   sw      Add probe burst variable for Drx chain to maintain correct 
...
#define RFA_RF_GSM_MSG_ID_START_GSM                  0x01
#define RFA_RF_GSM_MSG_ID_STOP_GSM                   0x02
#define RFA_RF_GSM_MSG_ID_WAKEUP                     0x03
#define RFA_RF_GSM_MSG_ID_RX_WAKEUP                  0x04
#define RFA_RF_GSM_MSG_ID_TX_WAKEUP                  0x05
#define RFA_RF_GSM_MSG_ID_SLEEP                      0x06
#define RFA_RF_GSM_MSG_ID_RX_SLEEP                   0x07
#define RFA_RF_GSM_MSG_ID_TX_SLEEP                   0x08

#define RFA_RF_GSM_MSG_ID_RX_BURST                   0x09

#define RFA_RF_GSM_MSG_ID_TX_ENABLE                  0x0A
#define RFA_RF_GSM_MSG_ID_TX_DISABLE                 0x0B
#define RFA_RF_GSM_MSG_ID_SET_TX_BAND                0x0C
#define RFA_RF_GSM_MSG_ID_TX_BURST                   0x0D

#define RFA_RF_GSM_MSG_ID_IDLE_FRAME_PROCESSING      0x0E

#define RFA_RF_GSM_MSG_ID_CM_ENTER                   0x0F
#define RFA_RF_GSM_MSG_ID_CM_EXIT                    0x10

#define RFA_RF_GSM_MSG_ID_UPDATE_TEMP_COMP           0x11
#define RFA_RF_GSM_MSG_ID_SET_SAR_LIMIT              0x12
#define RFA_RF_GSM_MSG_ID_SET_ANTENNA                0x13
#define RFA_RF_GSM_MSG_ID_START_IP2_CAL              0x14
#define RFA_RF_GSM_MSG_ID_INIT_MSM_IP2_CAL           0x15
#define RFA_RF_GSM_MSG_ID_PROCESS_BURST_METRICS      0x16

#define RFA_RF_GSM_MSG_ID_ENTER_MODE                 0x17
#define RFA_RF_GSM_MSG_ID_EXIT_MODE                  0x18
#define RFA_RF_GSM_MSG_ID_SET_VBATT_LIMIT            0x19
...
#define RFA_RF_GSM_MSG_ID_START_GSM_SUB2             0x21
#define RFA_RF_GSM_MSG_ID_STOP_GSM_SUB2              0x22
#define RFA_RF_GSM_MSG_ID_WAKEUP_SUB2                0x23
#define RFA_RF_GSM_MSG_ID_RX_WAKEUP_SUB2             0x24
#define RFA_RF_GSM_MSG_ID_TX_WAKEUP_SUB2             0x25
#define RFA_RF_GSM_MSG_ID_SLEEP_SUB2                 0x26
#define RFA_RF_GSM_MSG_ID_RX_SLEEP_SUB2              0x27
#define RFA_RF_GSM_MSG_ID_TX_SLEEP_SUB2              0x28

#define RFA_RF_GSM_MSG_ID_RX_BURST_SUB2              0x29

#define RFA_RF_GSM_MSG_ID_TX_ENABLE_SUB2             0x2A
#define RFA_RF_GSM_MSG_ID_TX_DISABLE_SUB2            0x2B
#define RFA_RF_GSM_MSG_ID_SET_TX_BAND_SUB2           0x2C
#define RFA_RF_GSM_MSG_ID_TX_BURST_SUB2              0x2D

#define RFA_RF_GSM_MSG_ID_IDLE_FRAME_PROCESSING_SUB2 0x2E

#define RFA_RF_GSM_MSG_ID_CM_ENTER_SUB2              0x2F
#define RFA_RF_GSM_MSG_ID_CM_EXIT_SUB2               0x30

#define RFA_RF_GSM_MSG_ID_UPDATE_TEMP_COMP_SUB2      0x31
#define RFA_RF_GSM_MSG_ID_SET_SAR_LIMIT_SUB2         0x32
#define RFA_RF_GSM_MSG_ID_SET_ANTENNA_SUB2           0x33
#define RFA_RF_GSM_MSG_ID_START_IP2_CAL_SUB2         0x34
#define RFA_RF_GSM_MSG_ID_INIT_MSM_IP2_CAL_SUB2      0x35
#define RFA_RF_GSM_MSG_ID_PROCESS_BURST_METRICS_SUB2 0x36

#define RFA_RF_GSM_MSG_ID_ENTER_MODE_SUB2            0x37
#define RFA_RF_GSM_MSG_ID_EXIT_MODE_SUB2             0x38
#define RFA_RF_GSM_MSG_ID_SET_VBATT_LIMIT_SUB2       0x39
...
/*! @details MACRO-based enumeration members for SUB1 MSGR confirmation IDs  */
/*!          This enum is never called by name. It just defines symbols.     */
/*!          GSM subsystem message IDs the RF task sends.                    */
...
enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, START_GSM,        RFA_RF_GSM_MSG_ID_START_GSM,          rfa_rf_gsm_start_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, STOP_GSM,         RFA_RF_GSM_MSG_ID_STOP_GSM,           rfa_rf_gsm_stop_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, WAKEUP,           RFA_RF_GSM_MSG_ID_WAKEUP,             rfa_rf_gsm_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_WAKEUP,        RFA_RF_GSM_MSG_ID_RX_WAKEUP,          rfa_rf_gsm_rx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, TX_WAKEUP,        RFA_RF_GSM_MSG_ID_TX_WAKEUP,          rfa_rf_gsm_tx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, SLEEP,            RFA_RF_GSM_MSG_ID_SLEEP,              rfa_rf_gsm_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_SLEEP,         RFA_RF_GSM_MSG_ID_RX_SLEEP,           rfa_rf_gsm_rx_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, TX_SLEEP,         RFA_RF_GSM_MSG_ID_TX_SLEEP,           rfa_rf_gsm_tx_sleep_cnf_s),
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, SET_TX_BAND,      RFA_RF_GSM_MSG_ID_SET_TX_BAND,        rfa_rf_gsm_set_tx_band_cnf_s),
...
/*! @details MACRO-based enumeration members for SUB2 MSGR confirmation IDs  */
/*!          This enum is never called by name. It just defines symbols.     */
/*!          GSM subsystem message IDs the RF task sends.                    */
/*!          RFA_RF_GSM_<command>_CNF = (MSGR_RFA_RF_GSM & 0xFFFF) << 16 |   */
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |        */
...
enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, START_GSM_SUB2,        RFA_RF_GSM_MSG_ID_START_GSM_SUB2,          rfa_rf_gsm_start_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, STOP_GSM_SUB2,         RFA_RF_GSM_MSG_ID_STOP_GSM_SUB2,           rfa_rf_gsm_stop_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, WAKEUP_SUB2,           RFA_RF_GSM_MSG_ID_WAKEUP_SUB2,             rfa_rf_gsm_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_WAKEUP_SUB2,        RFA_RF_GSM_MSG_ID_RX_WAKEUP_SUB2,          rfa_rf_gsm_rx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, TX_WAKEUP_SUB2,        RFA_RF_GSM_MSG_ID_TX_WAKEUP_SUB2,          rfa_rf_gsm_tx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, SLEEP_SUB2,            RFA_RF_GSM_MSG_ID_SLEEP_SUB2,              rfa_rf_gsm_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_SLEEP_SUB2,         RFA_RF_GSM_MSG_ID_RX_SLEEP_SUB2,           rfa_rf_gsm_rx_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, TX_SLEEP_SUB2,         RFA_RF_GSM_MSG_ID_TX_SLEEP_SUB2,           rfa_rf_gsm_tx_sleep_cnf_s),
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, SET_TX_BAND_SUB2,      RFA_RF_GSM_MSG_ID_SET_TX_BAND_SUB2,        rfa_rf_gsm_set_tx_band_cnf_s),
...
/*!==========================================================================*/
/*! @enum                                                                    */
/*! @brief SUB1 request UMIDs                                                */
/*! @details MACRO-based enumeration members for SUB1 MSGR request IDs       */
/*!          This enum is never called by name. It just defines symbols.     */
/*!          GSM subsystem message IDs the RF task receives.                 */
/*!          RFA_RF_GSM_<command>_REQ = (MSGR_RFA_RF_GSM & 0xFFFF) << 16 |   */
/*!                                     (MSGR_TYPE_REQ & 0xFF) << 8 |        */
/*!                                     (RFA_RF_GSM_MSG_ID_<command> & 0xFF) */
/*!          RFA_RF_GSM_REQ_<command> = (MSGR_RFA_RF_GSM & 0xFFFF) << 16 |   */
/*!                                     (MSGR_TYPE_REQ & 0xFF) << 8 |        */
/*!                                     (RFA_RF_GSM_MSG_ID_<command> & 0xFF) */
enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, START_GSM,        RFA_RF_GSM_MSG_ID_START_GSM,          rfa_rf_gsm_start_gsm_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, STOP_GSM,         RFA_RF_GSM_MSG_ID_STOP_GSM,           rfa_rf_gsm_stop_gsm_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, WAKEUP,           RFA_RF_GSM_MSG_ID_WAKEUP,             rfa_rf_gsm_wakeup_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, RX_WAKEUP,        RFA_RF_GSM_MSG_ID_RX_WAKEUP,          rfa_rf_gsm_rx_wakeup_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, TX_WAKEUP,        RFA_RF_GSM_MSG_ID_TX_WAKEUP,          rfa_rf_gsm_tx_wakeup_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, SLEEP,            RFA_RF_GSM_MSG_ID_SLEEP,              rfa_rf_gsm_sleep_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, RX_SLEEP,         RFA_RF_GSM_MSG_ID_RX_SLEEP,           rfa_rf_gsm_rx_sleep_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, TX_SLEEP,         RFA_RF_GSM_MSG_ID_TX_SLEEP,           rfa_rf_gsm_tx_sleep_req_s),
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, SET_TX_BAND,      RFA_RF_GSM_MSG_ID_SET_TX_BAND,        rfa_rf_gsm_set_tx_band_req_s),
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, IND, SET_VBATT_LIMIT,  RFA_RF_GSM_MSG_ID_SET_VBATT_LIMIT,      rfa_rf_gsm_set_vbatt_limit_ind_s),     
...
/*!==========================================================================*/
/*! @enum                                                                    */
/*! @brief SUB2 request UMIDs                                                */
/*! @details MACRO-based enumeration members for SUB2 MSGR request IDs       */
/*!          This enum is never called by name. It just defines symbols.     */
/*!          GSM subsystem message IDs the RF task receives.                 */
/*!          RFA_RF_GSM_<command>_REQ = (MSGR_RFA_RF_GSM & 0xFFFF) << 16 |   */
/*!                                     (MSGR_TYPE_REQ & 0xFF) << 8 |        */
...
enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, START_GSM_SUB2,        RFA_RF_GSM_MSG_ID_START_GSM_SUB2,          rfa_rf_gsm_start_gsm_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, STOP_GSM_SUB2,         RFA_RF_GSM_MSG_ID_STOP_GSM_SUB2,           rfa_rf_gsm_stop_gsm_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, WAKEUP_SUB2,           RFA_RF_GSM_MSG_ID_WAKEUP_SUB2,             rfa_rf_gsm_wakeup_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, RX_WAKEUP_SUB2,        RFA_RF_GSM_MSG_ID_RX_WAKEUP_SUB2,          rfa_rf_gsm_rx_wakeup_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, TX_WAKEUP_SUB2,        RFA_RF_GSM_MSG_ID_TX_WAKEUP_SUB2,          rfa_rf_gsm_tx_wakeup_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, SLEEP_SUB2,            RFA_RF_GSM_MSG_ID_SLEEP_SUB2,              rfa_rf_gsm_sleep_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, RX_SLEEP_SUB2,         RFA_RF_GSM_MSG_ID_RX_SLEEP_SUB2,           rfa_rf_gsm_rx_sleep_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, TX_SLEEP_SUB2,         RFA_RF_GSM_MSG_ID_TX_SLEEP_SUB2,           rfa_rf_gsm_tx_sleep_req_s),
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, SET_TX_BAND_SUB2,      RFA_RF_GSM_MSG_ID_SET_TX_BAND_SUB2,        rfa_rf_gsm_set_tx_band_req_s),
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, IND, SET_VBATT_LIMIT_SUB2,	 RFA_RF_GSM_MSG_ID_SET_VBATT_LIMIT_SUB2, 	 rfa_rf_gsm_set_vbatt_limit_ind_s), 	 
...
/*!==========================================================================*/
/*! @enum                                                                    */
/*! @brief FTM confirmation UMIDs                                            */
/*! @details MACRO-based enumeration members for FTM MSGR confirmation IDs   */
/*!          This enum is never called by name. It just defines symbols.     */
/*!          GSM subsystem message IDs the RF task sends.                    */
/*!          RFA_RF_GSM_<command>_CNF = (MSGR_RFA_RF_GSM_FTM & 0xFFFF) << 16 |*/
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |        */
/*!                                     (RFA_RF_GSM_MSG_ID_<command> & 0xFF) */
/*!          RFA_RF_GSM_CNF_<command> = (MSGR_RFA_RF_GSM_FTM & 0xFFFF) << 16 |*/
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |        */
/*!                                     (RFA_RF_GSM_MSG_ID_<command> & 0xFF) */
enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, START_GSM,        RFA_RF_GSM_MSG_ID_START_GSM,          rfa_rf_gsm_start_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, STOP_GSM,         RFA_RF_GSM_MSG_ID_STOP_GSM,           rfa_rf_gsm_stop_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, RX_WAKEUP,        RFA_RF_GSM_MSG_ID_RX_WAKEUP,          rfa_rf_gsm_rx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, TX_WAKEUP,        RFA_RF_GSM_MSG_ID_TX_WAKEUP,          rfa_rf_gsm_tx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, RX_SLEEP,         RFA_RF_GSM_MSG_ID_RX_SLEEP,           rfa_rf_gsm_rx_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, TX_SLEEP,         RFA_RF_GSM_MSG_ID_TX_SLEEP,           rfa_rf_gsm_tx_sleep_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, RX_BURST,         RFA_RF_GSM_MSG_ID_RX_BURST,           rfa_rf_gsm_rx_burst_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, SET_TX_BAND,      RFA_RF_GSM_MSG_ID_SET_TX_BAND,        rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, TX_BURST,         RFA_RF_GSM_MSG_ID_TX_BURST,           rfa_rf_gsm_tx_burst_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, IDLE_FRAME_PROCESSING, RFA_RF_GSM_MSG_ID_IDLE_FRAME_PROCESSING, rfa_rf_gsm_idle_frame_processing_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, CM_ENTER,         RFA_RF_GSM_MSG_ID_CM_ENTER,           rfa_rf_gsm_cm_enter_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, CM_EXIT,          RFA_RF_GSM_MSG_ID_CM_EXIT,            rfa_rf_gsm_cm_exit_cnf_s), 
};
...
/*!          RFA_RF_GSM_<command>_CNF = (MSGR_RFA_RF_GSM_FTM & 0xFFFF) << 16 |*/
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |        */
/*!                                     (MSGR_RFA_RF_GSM_FTM<command> & 0xFF) */
/*!          RFA_RF_GSM_CNF_<command> = (MSGR_RFA_RF_GSM & 0xFFFF) << 16 |   */
/*!                                     (MSGR_TYPE_CNF & 0xFF) << 8 |        */
/*!                                     (RFA_RF_GSM_MSG_ID_<command> & 0xFF) */
enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, START_GSM_SUB2,        RFA_RF_GSM_MSG_ID_START_GSM_SUB2,          rfa_rf_gsm_start_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, STOP_GSM_SUB2,         RFA_RF_GSM_MSG_ID_STOP_GSM_SUB2,           rfa_rf_gsm_stop_gsm_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, RX_WAKEUP_SUB2,        RFA_RF_GSM_MSG_ID_RX_WAKEUP_SUB2,          rfa_rf_gsm_rx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, TX_WAKEUP_SUB2,        RFA_RF_GSM_MSG_ID_TX_WAKEUP_SUB2,          rfa_rf_gsm_tx_wakeup_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, RX_SLEEP_SUB2,         RFA_RF_GSM_MSG_ID_RX_SLEEP_SUB2,           rfa_rf_gsm_rx_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, TX_SLEEP_SUB2,         RFA_RF_GSM_MSG_ID_TX_SLEEP_SUB2,           rfa_rf_gsm_tx_sleep_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, RX_BURST_SUB2,         RFA_RF_GSM_MSG_ID_RX_BURST_SUB2,           rfa_rf_gsm_rx_burst_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, SET_TX_BAND_SUB2,      RFA_RF_GSM_MSG_ID_SET_TX_BAND_SUB2,        rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, TX_BURST_SUB2,         RFA_RF_GSM_MSG_ID_TX_BURST_SUB2,           rfa_rf_gsm_tx_burst_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, IDLE_FRAME_PROCESSING_SUB2, RFA_RF_GSM_MSG_ID_IDLE_FRAME_PROCESSING_SUB2, rfa_rf_gsm_idle_frame_processing_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, CM_ENTER_SUB2,         RFA_RF_GSM_MSG_ID_CM_ENTER_SUB2,           rfa_rf_gsm_cm_enter_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM_FTM, CNF, CM_EXIT_SUB2,          RFA_RF_GSM_MSG_ID_CM_EXIT_SUB2,            rfa_rf_gsm_cm_exit_cnf_s), 
};
...
/*! @brief An enum for the result of a particular GSM RF command.            */
typedef enum
{
...
/*! @brief An enum for the specific Rx burst type for processing.            */
typedef enum
{
...
/*!==========================================================================*/
/*! @enum  rfgsm_op_mode_type                                                */
/*! @brief An enum to indicate the specific mode of operation for wakeup and */
/*!        sleep processing.                                                 */
typedef enum
{
  RFGSM_DEFAULT_OP_MODE,
  RFGSM_PRX_OP_MODE,
  RFGSM_DRX_OP_MODE,
  RFGSM_PRX_DRX_OP_MODE,
  RFGSM_MAX_OP_MODE
} rfgsm_op_mode_type;
...
/*! @brief An enum for the specific Enter mode type for processing.          */
typedef enum
{
...
/*! @brief An enum for the specific Exit mode type for processing.           */
typedef enum
{
  RFGSM_PRX_EXIT_MODE,
  RFGSM_DRX_EXIT_MODE,
...
/*! @brief An enum for the specific Wake up mode type for processing.        */
typedef enum
{
...
/*! @brief An enum for the specific sleep mode type for processing.          */
typedef enum
{
...
/*! @brief An structure for the handling rxlm buffer index type for Enter    */
/*!        mode.                                                             */
typedef struct
{
  uint32 prx_idx; 			
 ...
 *  @param  blanked - Has TRM blanked this Rx, therefore do not create
...
/*===========================================================================*/
/*! @struct rfa_rf_gsm_vbatt_limit_params_type*/
/*! @brief This structure contains all the information required for  GSM VBATT limit 
 *  for different modulations and different number of frame upto RFGSM_MAX_TX_SLOTS_PER_FRAME per frame.
 *  @param  device - RFM device
 *  @param  vbatt_tx_limit - VBATT Tx pwr limit for each modulation and number of slots in a frame
 */
typedef struct
{
  rfcom_device_enum_type device;
  int16                  vbatt_tx_limit[MAX_MOD_TYPE][RFGSM_MAX_TX_SLOTS_PER_FRAME];
}rfa_rf_gsm_vbatt_limit_params_type;
...
/*=============================================================================
                    RFA_RF_GSM_MSG_ID_START_GSM
=============================================================================*/
/*RFA_RF_GSM_START_GSM_REQ*/
/*! @struct rfa_rf_gsm_start_gsm_req_s*/
/*! @brief  This structure is the payload for initialising the RF Driver for 
 *          GSM.
 *  @details This triggers the creation of RFLM DM memory
...
} rfa_rf_gsm_start_gsm_req_s;

/*===========================================================================*/
/* Define typedef for consistency across layers */
/* This is the table which holds SAWless support information per band, per device */
typedef boolean sawless_support_table_t[RFM_MAX_WAN_DEVICES][RFGSM_MAX_UNIQUE_RFCOM_BANDS];
/*===========================================================================*/
/*RFA_RF_GSM_START_GSM_CNF*/
/*! @struct rfa_rf_gsm_start_gsm_cnf_s*/
/*! @brief  This structure is the payload for confirming the completion of 
 *          initialisation of the RF Driver for GSM.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  sub_id - subscription command is for
 *  @param  exec_time_us - duration of API in us
 *  @param  sawless_sup - tables of sawless support per band\device
...
typedef struct
{
  ...
  uint8                         sub_id;
  uint32                        exec_time_us;
  sawless_support_table_t       sawless_sup;
  rfa_rf_gsm_cmd_outcome_t      req_result;
} rfa_rf_gsm_start_gsm_cnf_s;
...
/*=============================================================================
                    RFA_RF_GSM_MSG_ID_STOP_GSM
=============================================================================*/
/*RFA_RF_GSM_STOP_GSM_REQ*/
/*! @struct rfa_rf_gsm_stop_gsm_req_s*/
/*! @brief  This structure is the payload for deinitialising the RF Driver 
 *          from GSM.
 *  @details This triggers the freeing of RFLM DM memory
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  sub_id - subscription command is for
 *  @param  cnf_required - L1 to request RF to send confirmation msg or not
 */
typedef struct
{
  ...
  uint8                         sub_id;
  boolean                       cnf_required;
} rfa_rf_gsm_stop_gsm_req_s;

/*===========================================================================*/
/*RFA_RF_GSM_STOP_GSM_CNF*/
/*! @struct rfa_rf_gsm_stop_gsm_cnf_s*/
/*! @brief  This structure is the payload for confirming the completion of 
 *          deinitialisation of the RF Driver from GSM.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  sub_id - subscription command is for
 *  @param  exec_time_us - duration of API in us
 *  @param  req_result - Result detailing the success/failure of the command
 ...
 *         sleep mode, setting the hardware to the same band it was in before
 *         sleep.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  device - RFM device type to be passed from L1 to RF device
 *  @param  sub_id - subscription command is for
...
/*! @struct rfa_rf_gsm_rx_wakeup_req_s                                       */
/*! @brief This structure is the payload for waking up the Rx RF hardware
 *         from sleep mode, setting the hardware to the same band it was in
 *         before sleep.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  prx_device - RFM primary device ID to be passed from L1 to RF
 *  @param  drx_device - RFM diversity device ID to be passed from L1 to RF
 *  @param  op_mode - PRx or PRx+DRx operation
 *  @param  sub_id - subscription command is for
 *  @param  cnf_required - L1 to request RF to send confirmation msg or not
 *  @param  rxlm_buf_index - Rx Link Manager buffer index
...
typedef struct
{
  ...
  void                          *gfw_buff_ptr;
  rfgsm_timing_info_type        *timing_info;
} rfa_rf_gsm_rx_wakeup_req_s;

/*===========================================================================*/
/*  RFA_RF_GSM_TX_WAKEUP_REQ                                                 */
/*! @struct rfa_rf_gsm_tx_wakeup_req_s                                       */
/*! @brief This structure is the payload for waking up the Tx RF hardware
 *         from sleep mode, setting the hardware to the same band it was in
 *         before sleep.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  tx_device - RFM primary device ID to be passed from L1 to RF
 *  @param  sub_id - subscription command is for
 *  @param  cnf_required - L1 to request RF to send confirmation msg or not
 *  @param  rxlm_buf_index - Rx Link Manager buffer index
 *  @param  gfw_buff_ptr - Pointer to GFW shared memory
 *  @param  gfw_therm_read_buff_ptr - Pointer to Therm read GFW shared memory
 *  @param  timing_info - Timings required to setup monitor, Rx and Tx bursts
 */
typedef struct
{
 ...
 *  @param  sbi_init_writes_buff_ptr - Pointer to GFW shared memory
 *  @param  timing_info - Timings required to setup monitor, Rx and Tx bursts
 *  @param  exec_time - Execution Time (in pcycles)
 *  @param  avg_exec_time - Average Case Execution Time (in pcycles)
 *  @param  exec_time_us - Execution Time (in micro seconds)
 *  @param  req_result - rfa_rf_gsm_cmd_outcome_t result of the command
 *  @param  prx_device_req_result - rfa_rf_gsm_cmd_outcome_t
 *  @param  drx_device_req_result - rfa_rf_gsm_cmd_outcome_t
 *  @param  ccs_time_us - rough estimate of script execution time next frame.
 *  @param  num_of_atuner_dev - number of antenna tuner used for wake-up
 */
typedef struct
{
  msgr_hdr_struct_type          hdr;
...
/*! @struct rfa_rf_gsm_rx_wakeup_cnf_s                                       */
/*! @brief This structure is the payload for confirming the RF hardware has
 *         woken up.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  prx_device - RFM primary device ID to be passed from L1 to RF
 ...
 *  @param  timing_info - Timings required to setup monitor, Rx and Tx bursts
 *  @param  exec_time_us - duration of API in us
 *  @param  ccs_time_us - calculated duration of transactions over the bus
 *  @param  prx_device_req_result - Primary Rx wakeup result
 *  @param  drx_device_req_result - Diversity Rx wakeup result
 *  @param  req_result - Result detailing the success/failure of the command
 */
typedef struct
{
  ...
  rfa_rf_gsm_cmd_outcome_t      drx_device_req_result;
  rfa_rf_gsm_cmd_outcome_t      req_result;
} rfa_rf_gsm_rx_wakeup_cnf_s;

/*===========================================================================*/
/*  RFA_RF_GSM_TX_WAKEUP_CNF                                                 */
/*! @struct rfa_rf_gsm_tx_wakeup_cnf_s                                       */
/*! @brief This structure is the payload for confirming the RF hardware has
 *         woken up.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  tx_device - RFM device type to be passed from L1 to RF device
 *  @param  buffer_id - which RF buffer to use (should be 0 for wakeup)
 *  @param  txlm_buf_index - Tx Link Manager buffer index
 *  @param  gfw_buff_ptr - Pointer to GFW shared memory
 *  @param  timing_info - Timings required to setup monitor, Rx and Tx bursts
 *  @param  exec_time_us - duration of API in us
 *  @param  ccs_time_us - calculated duration of transactions over the bus
 ...
 *  @param  prx_device - RFM primary device type to be passed from L1 to RF
 *  @param  drx_device - RFM diversity device type to be passed from L1 to RF
 *  @param  sub_id - subscription command is for
 *  @param  cnf_required - L1 to request RF to send confirmation msg or not
...
/*! @struct rfa_rf_gsm_sleep_req_s                                           */
/*! @brief This structure is the payload for placing the Rx RF hardware to
 *         sleep for GSM mode.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  prx_device - RFM primary device type to be passed from L1 to RF
 *  @param  drx_device - RFM diversity device type to be passed from L1 to RF
...
typedef struct
{
  ...
  uint8                         sub_id;
  boolean                       cnf_required;
} rfa_rf_gsm_rx_sleep_req_s;

/*===========================================================================*/
/*RFA_RF_GSM_TX_SLEEP_REQ                                                    */
/*! @struct rfa_rf_gsm_tx_sleep_req_s                                        */
/*! @brief This structure is the payload for placing the Tx RF hardware to
 *         sleep for GSM mode.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  tx_device - RFM device type to be passed from L1 to RF
 *  @param  sub_id - subscription command is for
 *  @param  cnf_required - L1 to request RF to send confirmation msg or not
 */
typedef struct
 ...
 *  @param  buffer_id - which RF buffer to use (should be 0 for sleep)
 *  @param  rxlm_buf_idx - Rx Link Manager buffer index
 *  @param  prx_device_req_result - Result success/failure Prx sleep
 *  @param  drx_device_req_result - Result success/failure Drx sleep
 *  @param  req_result - Result detailing the success/failure of the command
 */
typedef struct
{
...
/*! @struct rfa_rf_gsm_rx_sleep_cnf_s                                        */
/*! @brief This structure is the payload for confirming that the Rx RF
 *         hardware has been triggered to go to sleep.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  prx_device - RFM primary device type to be passed from L1 to RF
 *  @param  drx_device - RFM diversity device type to be passed from L1 to RF
 *  @param  op_mode - PRx or PRx+DRx operation
...
typedef struct
{
  ...
  rfa_rf_gsm_cmd_outcome_t      drx_device_req_result;
  rfa_rf_gsm_cmd_outcome_t      req_result;
} rfa_rf_gsm_rx_sleep_cnf_s;

/*===========================================================================*/
/*RFA_RF_GSM_TX_SLEEP_CNF                                                    */
/*! @struct rfa_rf_gsm_tx_sleep_cnf_s                                        */
/*! @brief This structure is the payload for confirming that the Tx RF
 *         hardware has been triggered to go to sleep.
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  tx_device - RFM device type to be passed from L1 to RF
 *  @param  exec_time_us - duration of API in us
 ...
 *  @param  buffer_id - which RF buffer to use (should be 0, 1, 2 for Tx burst)
 *  @param  tx_burst_params - pointer to parameters for all Tx's
 *  @param  tx_pwr_in_dBm100 - Return the actual Tx power per slot in dBm100 to GL1
 *  @param  req_result - Result detailing the success/failure of the command
 *  @param  mtpl_dBm100[] - estimated Max Transmit Power Limit on Prxtx/Drx antennas
 */
typedef struct
{
  msgr_hdr_struct_type          hdr;
  ...
  uint8                         buffer_id;
  rfa_rf_gsm_tx_burst_type      *tx_burst_params;
  int32                         tx_pwr_in_dBm100[RFGSM_MAX_TX_SLOTS_PER_FRAME];
  boolean                       vswr_meas_requested;
  uint32                        exec_time_us;
  int16                         mtpl_dBm100[RFM_ANTENNA_MAX];
  rfa_rf_gsm_cmd_outcome_t      req_result;
 ...
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  device - @TODO DEPRECATE when GL1 populate PRx and Tx devices
 *  @param  prx_device - RFM PRx device type to be passed from L1 to RF device
 *  @param  tx_device - RFM Tx device type to be passed from L1 to RF device
 *  @param  sub_id - subscription command is for
 *  @param  cnf_required - L1 to request RF to send confirmation msg or not
 *  @param  req_result - Result detailing the success/failure of the command
 */
...
/*=============================================================================
                   RFA_RF_GSM_MSG_ID_SET_VBATT_LIMIT
=============================================================================*/
/*  RFA_RF_GSM_SET_VBATT_LIMIT_IND  */
/*! @struct rfa_rf_gsm_set_vbatt_limit_ind_s*/
/*! @brief This structure is the payload for confirmation that RF has received
 *  a vbatt limit update
 *  @param  hdr - MSGR details for each UMID i.e priority, sending module etc
 *  @param  rfa_rf_gsm_vbatt_limit_params - VBATT limit params from MCS to RF
 */
typedef struct
{
  msgr_hdr_struct_type		   hdr;
  rfa_rf_gsm_vbatt_limit_params_type rfa_rf_gsm_vbatt_limit_params;
}rfa_rf_gsm_set_vbatt_limit_ind_s;
/*===========================================================================*/
...
#define RFA_RF_GSM_MSG_STUB_GTA_ENTER_MODE        0xE0
#define RFA_RF_GSM_MSG_STUB_GTA_EXIT_MODE         0xE1
#define RFA_RF_GSM_MSG_STUB_GET_TIMING_INFOR      0xE2
#define RFA_RF_GSM_MSG_STUB_VREG_ON               0xE3
#define RFA_RF_GSM_MSG_STUB_VREG_OFF              0xE4
#define RFA_RF_GSM_MSG_STUB_RX_ENTER_MODE         0xE5

#define RFA_RF_GSM_MSG_STUB_GTA_ENTER_MODE_SUB2   0xE6
#define RFA_RF_GSM_MSG_STUB_GTA_EXIT_MODE_SUB2    0xE7
#define RFA_RF_GSM_MSG_STUB_GET_TIMING_INFOR_SUB2 0xE8
#define RFA_RF_GSM_MSG_STUB_VREG_ON_SUB2          0xE9
#define RFA_RF_GSM_MSG_STUB_VREG_OFF_SUB2         0xEA
#define RFA_RF_GSM_MSG_STUB_RX_ENTER_MODE_SUB2    0xEB

#define RFA_RF_GSM_MSG_STUB_GTA_ENTER_MODE_SUB3   0xEC
#define RFA_RF_GSM_MSG_STUB_GTA_EXIT_MODE_SUB3    0xED
#define RFA_RF_GSM_MSG_STUB_GET_TIMING_INFOR_SUB3 0xEE
#define RFA_RF_GSM_MSG_STUB_VREG_ON_SUB3          0xEF
#define RFA_RF_GSM_MSG_STUB_VREG_OFF_SUB3         0xF0
#define RFA_RF_GSM_MSG_STUB_RX_ENTER_MODE_SUB3    0xF1

#define RFA_RF_GSM_MSG_STUB_SET_VBATT_LIMIT_SUB3    0xF2
#define RFA_RF_GSM_MSG_STUB_SET_SAR_LIMIT_SUB3      0xF3

enum
{
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GTA_ENTER_MODE,        RFA_RF_GSM_MSG_STUB_GTA_ENTER_MODE,        rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GTA_EXIT_MODE,         RFA_RF_GSM_MSG_STUB_GTA_EXIT_MODE,         rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GET_TIMING_INFOR,      RFA_RF_GSM_MSG_STUB_GET_TIMING_INFOR,      rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, VREG_ON,               RFA_RF_GSM_MSG_STUB_VREG_ON,               rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, VREG_OFF,              RFA_RF_GSM_MSG_STUB_VREG_OFF,              rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_ENTER_MODE,         RFA_RF_GSM_MSG_STUB_RX_ENTER_MODE,         rfa_rf_gsm_stub_cnf_s),
  
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GTA_ENTER_MODE_SUB2,   RFA_RF_GSM_MSG_STUB_GTA_ENTER_MODE_SUB2,   rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GTA_EXIT_MODE_SUB2,    RFA_RF_GSM_MSG_STUB_GTA_EXIT_MODE_SUB2,    rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GET_TIMING_INFOR_SUB2, RFA_RF_GSM_MSG_STUB_GET_TIMING_INFOR_SUB2, rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, VREG_ON_SUB2,          RFA_RF_GSM_MSG_STUB_VREG_ON_SUB2,          rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, VREG_OFF_SUB2,         RFA_RF_GSM_MSG_STUB_VREG_OFF_SUB2,         rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_ENTER_MODE_SUB2,    RFA_RF_GSM_MSG_STUB_RX_ENTER_MODE_SUB2,    rfa_rf_gsm_stub_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GTA_ENTER_MODE_SUB3,   RFA_RF_GSM_MSG_STUB_GTA_ENTER_MODE_SUB3,   rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GTA_EXIT_MODE_SUB3,    RFA_RF_GSM_MSG_STUB_GTA_EXIT_MODE_SUB3,    rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, GET_TIMING_INFOR_SUB3, RFA_RF_GSM_MSG_STUB_GET_TIMING_INFOR_SUB3, rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, VREG_ON_SUB3,          RFA_RF_GSM_MSG_STUB_VREG_ON_SUB3,          rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, VREG_OFF_SUB3,         RFA_RF_GSM_MSG_STUB_VREG_OFF_SUB3,         rfa_rf_gsm_stub_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, RX_ENTER_MODE_SUB3,    RFA_RF_GSM_MSG_STUB_RX_ENTER_MODE_SUB3,    rfa_rf_gsm_stub_cnf_s),

  MSGR_DEFINE_UMID(RFA, RF_GSM, IND, SET_SAR_LIMIT_SUB3,    RFA_RF_GSM_MSG_STUB_SET_SAR_LIMIT_SUB3,    rfa_rf_gsm_set_sar_limit_ind_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, IND, SET_VBATT_LIMIT_SUB3,  RFA_RF_GSM_MSG_STUB_SET_VBATT_LIMIT_SUB3,  rfa_rf_gsm_set_vbatt_limit_ind_s), 	
};
