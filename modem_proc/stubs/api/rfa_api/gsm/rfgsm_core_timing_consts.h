...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/gsm/rfgsm_core_timing_consts.h#1 $
$DateTime: 2018/04/15 02:22:08 $
$Author: mplcsds1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
07/21/15   sc      Correct header define typo
...
#endif  /* RFGSM_CORE_TIMING_CONSTS_H */
