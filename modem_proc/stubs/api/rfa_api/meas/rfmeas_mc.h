...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/meas/rfmeas_mc.h#1 $
...
/*!
  ...
  correctly or not.
*/
typedef rfm_meas_result_type (*rfmeas_mc_enter_fp_type)(rfm_meas_enter_param_type *meas_enter_param, boolean is_source);
...
/*!
  ...
  correctly or not.
*/
typedef rfm_meas_result_type (*rfmeas_build_reset_scripts_fp_type)(rfm_meas_setup_param_type *meas_scripts_param, boolean is_source);
...
/*!
  ...
  correctly or not.
*/
typedef rfm_meas_result_type (*rfmeas_build_scripts_fp_type)(rfm_meas_setup_param_type *meas_scripts_param, boolean is_source);
...
/*!
  ...
  correctly or not.
*/
typedef rfm_meas_result_type (*rfmeas_pre_config_fp_type)(rfm_meas_setup_param_type *meas_scripts_param, boolean is_source);
...
/*!
  ...
  correctly or not.
*/
typedef rfm_meas_result_type (*rfmeas_mc_exit_fp_type)(rfm_meas_exit_param_type *meas_exit_param, boolean is_source);
...
/*----------------------------------------------------------------------------*/
void rfmeas_mc_common_log_data(rfm_meas_common_api_type api_type,void *param_ptr,
                                               rfm_cb_handler_type cb_handler);
