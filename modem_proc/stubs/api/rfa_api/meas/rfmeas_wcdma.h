...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/rfa_api/meas/rfmeas_wcdma.h#1 $
...
04/24/15   rmb     Adding a comment to remove all these type after merge back to mainline
...
/*! Remove these structures after merge back to mainline and after L1 removes referenc to these structures */
typedef struct 
{
