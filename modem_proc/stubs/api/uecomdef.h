...
$Header: //commercial/MPSS.TA.3.0.c1/Main/modem_proc/stubs/api/uecomdef.h#3 $ $DateTime: 2021/07/08 09:57:42 $ $Author: tfong $
...
#define WCDMA_INTLOCK() REX_ISR_LOCK(&wl1m_ext_cntrl_params[wsub_id].wcdma_crit_sect)
#define WCDMA_INTFREE() REX_ISR_UNLOCK(&wl1m_ext_cntrl_params[wsub_id].wcdma_crit_sect)

#define WCDMA_INTLOCK_SAV(sav) REX_ISR_LOCK(&wl1m_ext_cntrl_params[wsub_id].wcdma_crit_sect)
#define WCDMA_INTFREE_SAV(sav) REX_ISR_UNLOCK(&wl1m_ext_cntrl_params[wsub_id].wcdma_crit_sect)
...
#define WCDMA_SUB_ID_0 SYS_MODEM_AS_ID_1
#define WCDMA_SUB_ID_1 SYS_MODEM_AS_ID_2

#ifdef FEATURE_DUAL_WCDMA
#define WCDMA_NUM_SUBS 2
#else
#define WCDMA_NUM_SUBS 1
#endif

typedef sys_modem_as_id_e_type wsub_id_e_type;

#define WL1_HARDCODE_SUB_ID SYS_MODEM_AS_ID_1

#define WL1_DEFAULT_SUB_ID SYS_MODEM_AS_ID_1

#define WL1_GET_ALT_SUB_ID(val)       ((val == SYS_MODEM_AS_ID_1) ? SYS_MODEM_AS_ID_2 : SYS_MODEM_AS_ID_1)

#define WL1_INVALID_SUB_ID SYS_MODEM_AS_ID_NONE
