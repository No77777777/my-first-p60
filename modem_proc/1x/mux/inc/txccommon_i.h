...
$Header: //components/rel/1x.mpss/8.0/mux/inc/txccommon_i.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
extern uint32 txc_enc_pdu_byte_count;
...
extern boolean txc_frame_offset_change_in_progress;
/* This is to check whether fpc mode was changed. */
extern boolean rxc_fpc_mode_changed;
#endif /* FEATURE_MODEM_1X_DRX */

/* This flag keeps track whether response has been sent to RXTX task for 
 * TXC_MSG_F cmd or not. */
extern boolean txc_need_to_send_msg_rsp;
...
SIDE EFFECTS
  None
===========================================================================*/
extern void txc_set_frame_off_in_progress( boolean offset_change );
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean txc_get_frame_off_in_progress( void );
#endif /* FEATURE_MODEM_1X_DRX */
