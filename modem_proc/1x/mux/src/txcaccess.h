...
DESCRIPTION
  ...
  Copyright (c) 2000 - 2016 Qualcomm Technologies, Inc.
...
$Header: //components/rel/1x.mpss/8.0/mux/src/txcaccess.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
typedef struct {
  byte    data[24] ALIGN(4);      /* up to 24 bytes of info */
...
extern mux_log_acc_info_type acc_log;
