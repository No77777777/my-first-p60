...
/*===========================================================================
 ...
 $Header: //components/rel/1x.mpss/8.0/mux/src/mux.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
--------   ---     ----------------------------------------------------------
09/06/13   srk     Add 3 extra debug level message for 1xA.
02/19/13   srk     Add extra debug level message for 1xA.
10/30/12   srk     Added 1xA debug level message.
...
/* 1x Advanced Debug Masks */
#ifdef FEATURE_IS2000_1X_ADV
#define ADV_DBG_MSG( ... ) \
    M1X_MSG( MUX, DBG_1XA, __VA_ARGS__ )
