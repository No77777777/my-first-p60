...
$Header: //components/rel/1x.mpss/8.0/srch/inc/srch_mdsp_i.h#2 $
...
/*===========================================================================
FUNCTION      SRCH_MDSP_IS_QTA_ACTIVE
...
SIDE EFFECTS  None
===========================================================================*/
extern boolean srch_mdsp_is_qta_active
(
  boolean *in_div_mode /* FW is configured for div demod */
);

/*===========================================================================
FUNCTION      SRCH_MDSP_SCHEDULED_RX_STOP

DESCRIPTION   This function sends Rx STOP message to FW to disable Rx
              @rtc_cx1_trigger, and then waits for the response from the FW.

DEPENDENCIES  This function currently supports schedlued Rx stop only for
              Offline QPCH.

RETURN VALUE  TRUE, if FW could succesfully schedule the Rx Stop, else FALSE

SIDE EFFECTS  None
===========================================================================*/
extern boolean srch_mdsp_scheduled_rx_stop
(
  rx_sm_client_enum_t rx_client,

  /* rtc value in cx for scheduled rx disable */
  uint32              rtc_cx1_trigger
);

/*===========================================================================
FUNCTION       SRCH_MDSP_RX_STOP_RSP_HANDLER

DESCRIPTION    This function processes Rx STOP RSP msg from FW and
               updates rx_stop_status field of srch_mdsp struct.
...
===========================================================================*/
extern void srch_mdsp_rx_stop_rsp_handler( void );

/*===========================================================================
FUNCTION      SRCH_MDSP_STOP_QTA

DESCRIPTION   This function sends QTA STOP message to FW and then waits for
              the response from the FW.
...
SIDE EFFECTS  None
===========================================================================*/
extern void srch_mdsp_stop_qta( void );

/*===========================================================================
FUNCTION      SRCH_MDSP_START_QTA

DESCRIPTION   This function sends QTA START message to FW and then waits for
              the response from the FW.
...
SIDE EFFECTS  None
===========================================================================*/
extern void srch_mdsp_start_qta( void );

/*===========================================================================
FUNCTION       SRCH_MDSP_QTA_RSP_HANDLER

DESCRIPTION    This function logs timing info from FW rsp msg.
...
SIDE EFFECTS   None.
===========================================================================*/
extern void srch_mdsp_qta_rsp_handler
(
  void *timing,
  boolean qta_start_rsp
);
