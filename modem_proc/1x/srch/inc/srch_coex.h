...
--------   ---     ---------------------------------------------------------- 
08/29/17   pk      Lower CXM priority for 1x->X QTA GAP
01/10/17   pk      Add DSDS support API
...
typedef enum
{
  ...
  /* Tier 3 RX  activities ->	ACTIVITY_TIER_30 */
  COEX_RX_QTA_TRAFFIC,
...
typedef enum
{
  ...
  /* Tier 3 TX  activities ->	ACTIVITY_TIER_30 */
  COEX_TX_QTA_TRAFFIC,

  COEX_TX_ACTIVITY_MAX
}
...
FUNCTION      SRCH_COEX_DSDS_IS_ENABLED

DESCRIPTION   This function returns TRUE if DSDS is enabled
          
DEPENDENCIES  None

RETURN VALUE  TRUE  : DSDS ENABLED
              FALSE : DSDS DISABLED

SIDE EFFECTS  None

===========================================================================*/
extern boolean srch_coex_dsds_is_enabled( void );
