...
$Header: //components/rel/1x.mpss/8.0/srch/inc/srch_fing_driver_i.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/30/17   ab      Pass the ebnt Threshold of fingers to FW
08/24/16   sst     Created cached version of srch_fing_in_lock()
03/21/16   sst     Collate finger de-assignment calls
07/16/15   bb      Changes to de-assign finger if it is out of sync between
                   sector pointer asosciated to finger and pilot PN that is
                   actually tracking
06/15/15   bb      Changes to avoid de-assigning finger if that is the only
                   active finger
...
/* Mask of avaliable fingers */
#define ALL_FING_MASK             0xFF

/* maximum number of fingers used for neigbhbors */
#if MAX_FING_CNT < 8
  #define  MAX_NS_FING_CNT   0
  #define NS_FING_MASK            0x0
#else
  #define  MAX_NS_FING_CNT   2
  #define NS_FING_MASK            0xC0
#endif
...
FUNCTION       SRCH_FING_ECIO_CHECK

DESCRIPTION    This function checks the ECIO of all the current fingers and
               disables time tracking of any of the fingers if it is too weak.
...
===========================================================================*/
extern void srch_fing_ecio_check( void );
...
FUNCTION       SRCH_FING_DEASSIGN_F_MASK

DESCRIPTION    This function de-assigns fingers specified from a mask.
...
===========================================================================*/
void srch_fing_deassign_f_mask
(
  uint16 f_mask       /* fingers to deassign */
);
...
===========================================================================*/
extern boolean srch_fing_in_lock
(
  boolean refresh                                /* use updated data?      */
);
...
FUNCTION       SRCH_FING_ACTIVE_FING_CNT

DESCRIPTION    This function returns how many fingers are enabled

DEPENDENCIES   None.

RETURN VALUE   Number of active fingers

SIDE EFFECTS   None.

===========================================================================*/
extern uint8 srch_fing_active_fing_cnt( void );

#ifdef FEATURE_MODEM_1X_TA_MCVS
/*===========================================================================

FUNCTION       SRCH_FING_MCVS_READ_NV_ITEM

DESCRIPTION    This function reads the NV values for mcvs Low SVS and NOM voltages
...
===========================================================================*/
extern void srch_fing_mcvs_read_nv_item( void );
#endif /* FEATURE_MODEM_1X_TA_MCVS */

/*===========================================================================

FUNCTION       SRCH_FING_EBNT_READ_NV_ITEM

DESCRIPTION    This function reads the NV values for ebnt thresholds for
               finger assignment.
...
===========================================================================*/
extern void srch_fing_ebnt_read_nv_item( void );
