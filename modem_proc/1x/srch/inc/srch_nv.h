...
EXTERNALIZED FUNCTIONS
  ...
  Copyright (c) 2005 - 2020 Qualcomm Technologies, Inc.
...
$Header: //components/rel/1x.mpss/8.0/srch/inc/srch_nv.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/11/20   dmd     Changes for sotware dipswitches cleanup, new NV ID-74201
10/30/17   ab      Added NV for ebnt Threshold of fingers
02/05/16   ab      1x2GTA Feature changes
06/16/15   eye     1x MCVS changes for TA.
06/03/15   srk     Add QTA NV to the 1x srch config file.
05/15/15   ab      Added NV for QTA feature
...
typedef enum
{
  ...
  SRCH_EFS_1X_QTA_PARAMS,
  SRCH_EFS_DIAG_DIP_SWITCH,
  /*
    For any newer NVs, please add the EFS file path and the size in bytes
    here. Without this, 1x srch config file will not contain the newly added
    NV and hence it can't be edited in QXDM.
  */
  SRCH_EFS_1X_TA_MCVS_PARAMS,
  SRCH_EFS_1X_TRAFFIC_TA_PARAMS,
  SRCH_EFS_1X_FINGER_EBNT_THRESHOLDS,
...
/* EFS file name containing default values 1x QTA */
#define SRCH_EFS_1X_QTA_PARAMS_FILENAME \
          "/nv/item_files/modem/1x/1x_qta_params"

/*
  For any newer NVs, please add the EFS file path here.
*/

/* EFS file for replacement of software switches */
#define SRCH_EFS_DIAG_EFS_FILENAME \
	      "/nv/item_files/modem/1x/diag_dip_switch"

/* EFS file name containing default values 1x TA MCVS feature */
#define SRCH_EFS_1X_TA_MCVS_PARAMS_FILENAME \
          "/nv/item_files/modem/1x/1x_ta_mcvs_params"
...
/* EFS file name containing values for ebnt threshold for finger assignment */
#define SRCH_EFS_1X_FINGER_EBNT_THRESHOLDS_FILENAME \
          "/nv/item_files/modem/1x/1x_finger_ebnt_thresh_params"
