...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  ...
  Copyright (c) 2005 - 2018 Qualcomm Technologies, Inc.
...
$Header: //components/rel/1x.mpss/8.0/srch/inc/srch_rx_t_i.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/16/18   ab      Added TRM_REQUEST_DURATION_FOR_TX_ACCESS
11/10/17   pk      FR 33958: TRM-U Enhancements and Optimizations
09/29/15   pk      Update TRM-U sub reason for RX_PROC_MOD_REAS_DUR
08/27/15   jh      added MAX_RX_CLIENTS as the max number of true 'RX' clients
...
/* Minimum duration, we should request PRx for ACCESS in ms*/
#define TRM_REQUEST_DURATION_FOR_ACCESS 200

/* Minimum duration, we should request TX for ACCESS in ms*/
#define TRM_REQUEST_DURATION_FOR_TX_ACCESS 100
...
typedef enum
{
  CLIENT_1X_RX_PRI,                         /* primary RX_SM client */
  CLIENT_1X_RX_SEC,                         /* secondary RX_SM client */
  CLIENT_1X_TX,                             /* TX_SM client */
  MAX_RX_CLIENTS = CLIENT_1X_TX,            /* max number of true 'RX' clients */
  NUM_RX_CLIENT,                            /* total number of RX state machine clients */
  NO_RX_CLIENT
} rx_sm_client_enum_t;
...
typedef struct
{
  ...
  sys_proc_type_e_type       sub_reason;    /* sub reason corresponding to 
