...
$Header: //components/rel/1x.mpss/8.0/srch/protected/srch_irm.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/17/13   bb      Changes to explicitly wait for PPM clean up call back while going
                   to sleep if PPM resources are actually allocated
...
FUNCTION       SRCH_IRM_RESOURCES_ALLOCATED

DESCRIPTION    This function returns TRUE, if resources are allocated
               to client ID passed to this function
...
===========================================================================*/
extern boolean srch_irm_resource_allocated
(
  srch_irm_client_type  client_id
);
