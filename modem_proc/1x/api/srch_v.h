...
$Header: //components/rel/1x.mpss/8.0/api/srch_v.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/03/18   svu     Added new API to get curr finger energies
15/07/16   ab/bb   Changes to provide CDMA time for LTE-D
...
extern void  srch_get_cdma_curr_ecio_all_chains ( int32* ecio_comb,
                                                  int32* ecio_rx0,
                                                  int32* ecio_rx1 );
...
SIDE EFFECTS  None
===========================================================================*/
extern void srch_get_cdma_xo_snapshot_time
(
  uint64* xo_tick,
