...
$Header: //components/rel/1x.mpss/8.0/api/srch_cgps.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------
08/05/16   ab      Return False in gts_ustmr_to_cdmatime if 1x is not active
03/07/16   srk     1x Time Transfer support for ATLAS
...
typedef struct
{
  ...
  boolean           priority;             /* Whether Rude wakeup is required or not */
...
typedef struct
{
  boolean           priority;      /* Whether Rude wakeup is required or not */
  srch_cgps_tt_type tt_type;       /* Time transfer type - regular or TCal */
} srch_gts_time_transfer_req_type;
...
FUNCTION       SRCH_GTS_REQUEST_TIME_TRANSFER

DESCRIPTION    This function handles the GPS request for Time Transfer Data
               from the GTS module (from ATLAS).
...
===========================================================================*/
extern void srch_gts_request_time_transfer( srch_gts_time_transfer_req_type* params );

/*===========================================================================

FUNCTION       SRCH_GTS_USTMR_TO_CDMATIME

DESCRIPTION    This function updates CDMA RTC and Phase based on USTMR
               for the GTS module (from ATLAS).
...
===========================================================================*/
extern boolean srch_gts_ustmr_to_cdmatime( uint32 ustmr, uint32* rtc, uint32* phase );
#endif /* SRCH_CGPS_H */
