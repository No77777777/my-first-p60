...
$Header: //components/rel/1x.mpss/8.0/api/public/db.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
/**
  Changes the value of a specified item. The tasks that need to know when
  a value has changed are notified. This is a wrapper API specific for mmode.

  @param[in] item        Item to be changed.
  @param[in] value_ptr   Pointer to the buffer that holds the value.
  @param[in] asubs_id    Active Subscription id passed by mmode.
