...
$Header: //components/rel/1x.mpss/8.0/api/onexl3_qsh_ext.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
{
  qsh_metric_hdr_s  hdr; /* This header has the timestamp (uint16) */
  int16 rssi0; /* RSSI on primary antenna (in dBm) */ 
  int16 rssi1; /* RSSI on diversity antenna (in dBm) */
  int16 ecio0; /* EcIo on primary antenna (in dB) */
  int16 ecio1; /* EcIo on diversity antenna (in dB) */
  int16 rssi_comb; /* Combined RSSI value */
  int16 ecio_comb; /* Combined EcIo value */
