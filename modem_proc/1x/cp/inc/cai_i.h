...
$Header: //components/rel/1x.mpss/8.0/cp/inc/cai_i.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
#define CAI_GEN_PAGE_MIN  \
  ( sizeof(cai_gen_page_class_type) + sizeof(cai_pc_3_sc_0_fix_type) )
