...
$Header: //components/rel/1x.mpss/8.0/cp/inc/rxtx_v.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
#define RXTX_TX_HDM_ACK_SIG 0x0020
  /* This signal is set by the RXTX task when Ack for an HDM message 
   * has been sent by TX */     
