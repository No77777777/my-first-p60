...
$Header: //components/rel/1x.mpss/8.0/cp/inc/mccqsh_i.h#2 $ $DateTime: 2020/01/27 00:26:21 $ $Author: pwbldsvc $
...
/*===========================================================================
FUNCTION mc_qsh_mdump_collect_mccidl_data

DESCRIPTION
This function dumps the mccidl data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_mccidl_data( void );
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_mccsa_data( void );

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_auth_data

DESCRIPTION
This function dumps the auth data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_auth_data( void );

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_snm_data

DESCRIPTION
This function dumps the snm data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_snm_data( void );

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_rx_sm_data

DESCRIPTION
This function dumps the SRCH rx sm data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_rx_sm_data
(  
  void
);
...
/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_rx_util_data

DESCRIPTION
This function dumps the SRCH rx util data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_rx_util_data
(  
  void
);
...
/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_stm_data

DESCRIPTION
This function dumps the SRCH stm data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_stm_data
(  
  void
);

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_lto1x_sm_data

DESCRIPTION
This function dumps the SRCH irat data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_lto1x_sm_data
(  
  void
);
...
/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_acq_sm_data

DESCRIPTION
This function dumps the Srch acq sm data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_acq_sm_data();

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_rx_div_sm_data

DESCRIPTION
This function dumps the srch rx div sm data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_rx_div_sm_data();
...
/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_lib_data

DESCRIPTION
This function dumps the srch lib int data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_lib_data();

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_tram_sm_data

DESCRIPTION
This function dumps the srch tram sm data to QSH after a crash
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_tram_sm_data();

/*===========================================================================
FUNCTION mc_qsh_mdump_collect_srch_trm_post_sm_data
...
===========================================================================*/
QSH_MDUMP_FN_ATTR
void mc_qsh_mdump_collect_srch_trm_post_sm_data();
