...
$Header: //components/rel/1x.mpss/8.0/cp/inc/mctrans_i.h#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
typedef struct
{
  /* indicator of whether the call is in non DDS sub or not */
