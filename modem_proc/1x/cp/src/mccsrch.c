...
$Header: //components/rel/1x.mpss/8.0/cp/src/mccsrch.c#1 $ $DateTime: 2019/06/11 23:51:40 $ $Author: pwbldsvc $
...
q_type mcc_srch_q;
  /* Queue holding messages from the Searcher task for the Main control task
     to process  */

q_type mcc_srch_bkup_q;
  /* Queue to hold SRCH rpts for backup to process them later */
