...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  ...
  Copyright (c) 1994 - 2020 Qualcomm Technologies, Inc. 
...
$Header: //components/rel/1x.mpss/8.0/cp/src/loopback.c#2 $ $DateTime: 2020/01/27 00:26:21 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (lb_test_mode == LB_RFCH_BLANKING_TEST)
  {
    ...
    {
      ONEX_ERR_FATAL( "Invalid Rate, %d", (int) max_rate, 0, 0 );
    }
    return (tx_data_rate);
  }
#endif /* FEATURE_IS2000_1X_ADV */
  ...
  if (max_rate == CAI_FULL_RATE)
  {
    ...
    ** ---------------------------------------------------------- */
    ...
    switch (rx_data_item->frame_category)
    {
      ...
      default:
        ONEX_ERR_FATAL( "Invalid rx frame category",
