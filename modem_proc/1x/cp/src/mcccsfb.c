...
$Header: //components/rel/1x.mpss/8.0/cp/src/mcccsfb.c#2 $ $DateTime: 2020/01/27 00:26:21 $ $Author: pwbldsvc $
...
07/23/15   ppr     UHDM Call:Chgs to clear RXTX queue except UHDM msg
...
word cdma_csfb_state( void )
{
  ...
  while(MAIN_STATE(cdma.curr_state) == CDMA_CSFB)
  {
    switch(cdma.curr_state)
    {
      ...
      default:
      {
        ONEX_ERR_FATAL("DEBUG: Unknown CSFB state, CSFB busted ",0,0,0);
        break;
      }
...
void mcc_csfb_state_init( void )
{
 ...
 /* Reset flag that indicates call_clear rxed in native 1x */
     ...
     else if(c2k_parms_msg.params_state == MCC_1X_PARAM_RSP_INVALID)
     {
       ...
       { /* CSFB Mode */
         ...
         mc_msgr_send_msg( &ho_fail_rsp.hdr,
                          ...
                          sizeof(ho_fail_rsp));
         mcc_enqueue_dbg_lte_rrc_cnf( MCC_CSFB_ACCESS_STATE_PROCESS,
      ...
      else if(c2k_parms_msg.params_state == MCC_1X_PARAM_RSP_INVALID)
      {
...
#endif /* FEATURE_MODEM_1X_IRAT_LTO1X_TUNNELED_SMS */
        {
          ...
          mc_msgr_send_msg( &ho_fail_rsp.hdr,
                          ONEX_CP_LTE_1xCSFB_HO_FAILED_RSP,
                          sizeof(ho_fail_rsp));
          mcc_enqueue_dbg_lte_rrc_cnf( MCC_CSFB_ACCESS_STATE_PROCESS_1,
                                       MC_ONEX_CP_LTE_1xCSFB_HO_FAILED_RSP );
        }
        /* Mark that UE is waiting for csfb_call_clear_f from CM */
        csfb_cdma.waiting_for_call_clear = TRUE;
            ...
            )
          {
...
#endif /* FEATURE_MODEM_1X_IRAT_LTO1X_TUNNELED_SMS */
            {
              ...
              { /* CSFB Mode */
                ...
                mcc_enqueue_dbg_lte_rrc_cnf( MCC_CSFB_ACCESS_STATE,
                                         MC_ONEX_CP_LTE_1xCSFB_HO_FAILED_RSP );
            ...
            )
          {
...
#endif /* FEATURE_MODEM_1X_IRAT_LTO1X_TUNNELED_SMS */
            {
              ...
              { /* CSFB Mode */
                ...
                mcc_enqueue_dbg_lte_rrc_cnf( MCC_CSFB_ACCESS_STATE_1,
                                         MC_ONEX_CP_LTE_1xCSFB_HO_FAILED_RSP );
             ...
             )
      {
                 ...
                 (cdma.so_req == CAI_SO_CSFB_TUNNELED_SMS) )
        {
          ...
          mc_msgr_send_msg( &ho_fail_rsp.hdr,
                            ONEX_CP_LTE_1xCSFB_HO_FAILED_RSP,
                            sizeof(ho_fail_rsp) );
          mcc_enqueue_dbg_lte_rrc_cnf( MCC_CSFB_ACCESS_STATE_2,
                                       MC_ONEX_CP_LTE_1xCSFB_HO_FAILED_RSP );
        }
        else if(mcc_csfb_access_reason == MCC_CSFB_ACCESS_MSG)
        {
