...
$Header: //components/rel/1x.mpss/8.0/drivers/inc/m1x_time_i.h#1 $
...
/**
Returns the current CDMA system Time and the current XO time in Cx.

@return
The current 64-bit time in uint64 Cx type
