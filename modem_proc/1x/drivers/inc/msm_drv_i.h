...
$Header: //components/rel/1x.mpss/8.0/drivers/inc/msm_drv_i.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/28/15   srk     Fix compilation issues in ATLAS.
...
#define GET_DEMBACK_ADDR( reg ) NULL

/* Read register */
#define GET_DEMBACK_REG( reg ) 0x02

/* Read register field */
#define GET_DEMBACK_REG_F( reg, field ) 0xFF

/* Dword register read */
#define GET_DEMBACK_REG_DW( reg ) 0xFF

#elif defined ( FEATURE_MODEM_1X_SINGLE_DEMBACK )
...
#else /* !FEATURE_MODEM_1X_THOR_REVISIT && !FEATURE_MODEM_1X_TABASCO_REVISIT */
