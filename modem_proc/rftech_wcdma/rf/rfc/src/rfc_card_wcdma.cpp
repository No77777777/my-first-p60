...
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/rfc/src/rfc_card_wcdma.cpp#1 $
...
)
{
  ...
  data_config_ptr = rfc_obj->mode_config_get(config_data);
...
*/
uint32 rfc_wcdma_get_fb_chain(rfm_device_enum_type tx_device, rfcom_wcdma_band_type tx_band)
{
  ...
  if ( rfc_obj == NULL )
  {
    MSG_1(MSG_SSID_RF, MSG_LEGACY_FATAL,"rfc_wcdma_ptr is NOT created. ",0);
