...
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/nv/src/rfnv_wcdma_1500.c#1 $
...
void rfnv_wcdma_1500_init_nv_item_list()
{
  ...
  rfnv_wcdma_1500_nv_items_list.nv_items_type.tx_static_data.rfnv_item_id = RFNV_WCDMA_1500_TX_STATIC_DATA_I;
}
