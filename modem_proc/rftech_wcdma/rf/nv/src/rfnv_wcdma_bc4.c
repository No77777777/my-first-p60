...
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/nv/src/rfnv_wcdma_bc4.c#1 $
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/nv/src/rfnv_wcdma_bc4.c#1 $
$DateTime: 2021/03/09 05:08:47 $ $Author: pwbldsvc $
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/nv/src/rfnv_wcdma_bc4.c#1 $
...
void rfnv_wcdma_bc4_init_nv_item_list(void)
{
  ...
  rfnv_wcdma_bc4_nv_items_list.nv_items_type.tx_static_data.rfnv_item_id = RFNV_WCDMA_BC4_TX_STATIC_DATA_I;
}
