...
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/nv/src/rfnv_wcdma_1800.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/16/18   nik     Enabling NV 2981
...
void rfnv_wcdma_1800_init_nv_item_list(void)
{
  ...
  rfnv_wcdma_1800_nv_items_list.nv_items_type.utran_tx_lim_vs_temp_offset.rfnv_item_id = RFNV_WCDMA_1800_UTRAN_TX_LIM_VS_TEMP_OFFSET_I;
  ...
  rfnv_wcdma_1800_nv_items_list.nv_items_type.tx_static_data.rfnv_item_id = RFNV_WCDMA_1800_TX_STATIC_DATA_I;
}
