...
$Header: //components/rel/rftech_wcdma.mpss/3.11/rf/nv/inc/rfnv_wcdma_types.h#1 $
...
typedef struct
{
  ...
  rfcommon_rfnv_items_list_type tx_static_data;
...
typedef struct
{
  ...
  rfnv_wcdma_copy_func_ptr copy_tx_static_data;
