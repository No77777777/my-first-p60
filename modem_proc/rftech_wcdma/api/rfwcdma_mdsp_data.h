...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_mdsp_data.h#1 $
...
02/11/14   dw      Added CCS allocation device mask shadow in MDSP data
...
typedef struct
{
  ...
  /*!< Bitmask flag to track CCS TQ pair allocation per device */
  uint32 ccs_device_allocation;
...
*/
boolean rfwcdma_mdsp_data_handle_cleanup
(
  rflm_dm_handle_id_t rflm_handle
);
