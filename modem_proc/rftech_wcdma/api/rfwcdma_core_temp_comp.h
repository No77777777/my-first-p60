...
$Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_core_temp_comp.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
07/04/15   ak      Rx/Tx Split Changes - Do Sub/device based temp comp
06/02/15   gh/zhh  Add support for therm read to be triggered by FED
