...
$Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_core_txctl.h#1 $
...
06/02/15   gh/zhh  Added support to build therm_enable script and event
...
typedef enum
{
  ...
  THERM_ENABLE,
  /*! Coupler FWD event */
  TX_CONFIG_COUPLER_FWD,
  /*! Coupler REV event */
  TX_CONFIG_COUPLER_REV,
...
(
  ...
  uint32 txlm_handle,
  rfcom_tx_multi_carrier_cfg_type tx_mc_state
);
/*----------------------------------------------------------------------------*/
