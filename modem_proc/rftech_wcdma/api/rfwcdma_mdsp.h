...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_mdsp.h#1 $
  $DateTime: 2021/03/09 05:08:47 $
  $Author: pwbldsvc $

when       who     what, where, why 
--------   ---     ---------------------------------------------------------- 
06/18/15   ag      Add additional parameter for device in send_lpm_agc_cmd()
05/21/15   sd      Dispatch clk voting in Rf task only when enabled
04/30/15   ac      rxagc changes for w plus w
...
void rfwcdma_mdsp_send_lpm_agc_cmd( rfm_device_enum_type device,rfcom_lpm_config_enum_type lpm_config, 
