...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_mdsp_sync.h#1 $
...
02/11/15   dw      Changed API for config_CCS and allocate TQ pair
...
/*!
  @brief
  This function will allocate CCS TQ pair given device

  @details
  This function will allocate CCS TQ pair given device
  One device pair will only need to allocate TQ pair once. So if the
  second device of the device pair requested it shall be ignored.
...
boolean rfwcdma_mdsp_ccs_allocate_tq_pair( rfm_device_enum_type device);
