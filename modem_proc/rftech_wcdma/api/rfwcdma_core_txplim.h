...
$Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_core_txplim.h#1 $
...
06/29/14   sd      Support for FR 27572 SAR AsDiv backoff 
...
typedef enum
{
  ...
  ASDIV_POS_1 = 1,
  ASDIV_POS_MAX =2
} rfwcdma_asdiv_position_enum_type;
...
/*--------------------------------------------------------------------------*/
void rfwcdma_core_txplim_set_mcs_mtpl
(
  int16 limit_in_dbm
);
