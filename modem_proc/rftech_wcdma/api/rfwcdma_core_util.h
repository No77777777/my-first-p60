...
$Header: //components/rel/rftech_wcdma.mpss/3.11/api/rfwcdma_core_util.h#1 $
...
02/11/15   dw      Added get paired device and get device pair
4/16/15    vbh     rfwcdma_core_util_is_sleeping - update argument to device
4/15/15    vbh     [Rx/Tx split] Add device param for rfwcdma_core_util_get_tx_rotator_angle
4/10/15    vbh     [Rx/Tx split] Updates for WCDMA data routine
02/11/15   dw      Added get paired device and get device pair
04/01/15   ndb     Added the API's rfwcdma_core_util_get_min_max_tx_carrier_freqs & 
                   rfwcdma_core_util_get_min_max_rx_carrier_freqs
12/12/14   rmb     Change enum for irat measurement.
...
typedef rfm_wcdma_rxagc_output_params rfwcdma_core_util_rxagc_output_params;

/*--------------------------------------------------------------------------*/

typedef rfm_wcdma_rxagc_input_params rfwcdma_core_util_rxagc_input_params;
...
/* ----------------------------------------------------------------------- */
rfm_wcdma_antenna_index rfwcdma_core_util_device_to_antenna
(
