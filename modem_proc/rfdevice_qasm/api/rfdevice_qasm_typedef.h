...
Qualcomm Proprietary
  ...
  $Header: //components/rel/rfdevice_qasm.mpss/1.32/api/rfdevice_qasm_typedef.h#1 $
  $DateTime: 2021/03/09 04:40:34 $
  $Author: pwbldsvc $

when       who    what, where, why
--------   ---    ---------------------------------------------------------------
10/08/15   px     Add common tab settings
...
typedef struct
{
  ...
  /* Trigger_enable_rx    QFE4465fc trigger workaround*/ 
  uint8 asm_trigger_enable_rx_script_size;
  rfdevice_qasm_ag_settings_type asm_trigger_enable_rx;

  /* Trigger_enable_tx    QFE4465fc trigger workaround*/
  uint8 asm_trigger_enable_tx_script_size;
  rfdevice_qasm_ag_settings_type asm_trigger_enable_tx;
