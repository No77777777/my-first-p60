...
Qualcomm Proprietary
  ...
  $Header: //components/rel/rfdevice_qasm.mpss/1.32/api/rfdevice_qasm_2g_typedef.h#1 $
  $DateTime: 2021/03/09 04:40:34 $
  $Author: pwbldsvc $

when       who   what, where, why
--------   ---   ---------------------------------------------------------------
10/20/15   hzh   Added QFE3340FC TDD rx/tx trigger
