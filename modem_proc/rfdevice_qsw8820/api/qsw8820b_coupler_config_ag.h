...
#ifndef QSW8820B_COUPLER_CONFIG_AG_H
#define QSW8820B_COUPLER_CONFIG_AG_H/*
...
boolean rfdevice_qcoupler_qsw8820b_construct_driver_ag
(
  rfdevice_qcoupler_settings_type* qcoupler_settings,
  rfdevice_qcoupler_func_tbl_type* qcoupler_fn_ptrs
);

boolean rfdevice_qcoupler_qsw8820b_get_config_data_ag
(
