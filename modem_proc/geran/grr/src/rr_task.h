...
$Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_task.h#2 $ $DateTime: 2019/09/19 07:13:01 $ $Author: pwbldsvc $
...
typedef union
{
  ...
  mmode_qmi_nas_prioritize_lte_ind_msg_type qmi_nas_prioritize_lte_ind;
#endif /* FEATURE_PRIORITIZE_LTE_FREQ */
#endif /* FEATURE_LTE */
#ifdef FEATURE_GSM_BAND_AVOIDANCE
  cxm_coex_ba_ind_s               band_avoid_blacklist_ind;
#endif /*FEATURE_GSM_BAND_AVOIDANCE*/
  cxm_coex_tech_state_bcast_ind_s tech_state_bcast_ind;
...
typedef union
{
  ...
  rr_interrat_wl1_stop_ind_type           rr_wl1_stop_ind;
#endif /* FEATURE_WCDMA */
  ...
  tdsrr_interrat_cc_order_abort_req_type  tdsrr_interrat_cc_order_abort_req;
#endif /*FEATURE_GSM_TDS*/
