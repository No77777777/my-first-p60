...
$Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_intra_ho.c#2 $ $DateTime: 2020/01/27 04:29:28 $ $Author: pwbldsvc $
...
#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
void grr_mdump_rr_intra_ho(const gas_id_t gas_id)
{
  rr_intra_ho_data_t *rr_intra_ho_ptr = rr_intra_ho_get_data_ptr(gas_id);
  qsh_mdump_collect_high(rr_intra_ho_ptr, sizeof(rr_intra_ho_data_t));
}
