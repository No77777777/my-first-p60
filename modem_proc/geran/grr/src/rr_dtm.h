...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_dtm.h#2 $ */
...
/**
  @brief Determines whether the uplink tbf request can be processed now.
 */
extern boolean rr_dtm_can_process_ul_tbf_req(
  const gas_id_t gas_id
);

#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
extern void grr_mdump_rr_dtm(const gas_id_t gas_id);
