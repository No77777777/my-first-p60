...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_band_avoid_if.c#1 $ */
                                      ...
                                      const gas_id_t gas_id)
{
  ...
  blist_rsp.blist_res_data.tech_id        = geran_map_gas_id_to_cxm_id(gas_id);
...
void rr_band_avoid_send_cxm_freq_ind(frequency_list_T *freq, const gas_id_t gas_id)
{
  ...
  freq_ind.serv_freq_data.tech_id = geran_map_gas_id_to_cxm_id(gas_id);
