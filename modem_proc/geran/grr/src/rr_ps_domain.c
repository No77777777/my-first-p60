...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_ps_domain.c#1 $ */
  ...
  if (rr_ps_domain_data_ptr->gmm.gprs_suspended)
  {
...
#endif // #ifdef FEATURE_DUAL_SIM
    {
      ...
      */
      ...
      rr_send_grr_gmm_gprs_resumption_ind(resumption_ind, FALSE, gas_id);
#endif /* FEATURE_GSM_DTM */
...
/*!
 * \brief Return the value of non_updated_lai_in_nmo1 received from MM.
 *
 * \param gas_id
 */
boolean rr_get_non_updated_lai_nmo1(gas_id_t gas_id)
{
  rr_ps_domain_data_t *rr_ps_domain_data_ptr;
  ...
  MSG_GERAN_HIGH_1_G("non_updated_lai_in_nmo1 (%d)", rr_ps_domain_data_ptr->gmm.non_updated_lai_in_nmo1);

  return(rr_ps_domain_data_ptr->gmm.non_updated_lai_in_nmo1);
}

/*!
 * \brief Set the value of non_updated_lai_in_nmo1 received from MM.
 *
 * \param non_updated_lai_in_nmo1
 * \param gas_id
 */
void rr_set_non_updated_lai_nmo1(boolean non_updated_lai_in_nmo1, gas_id_t gas_id)
{
  rr_ps_domain_data_t *rr_ps_domain_data_ptr;
  ...
  MSG_GERAN_HIGH_1_G("Set non_updated_lai_in_nmo1 to (%d)", non_updated_lai_in_nmo1);
 
  rr_ps_domain_data_ptr->gmm.non_updated_lai_in_nmo1 = non_updated_lai_in_nmo1;
}

/*!
 * \brief Set the value of non_updated_lai_in_nmo1 to FALSE
 *
 * \param gas_id
 */
void rr_reset_non_updated_lai_nmo1(gas_id_t gas_id)
{
  rr_ps_domain_data_t *rr_ps_domain_data_ptr;
  ...
  rr_ps_domain_data_ptr->gmm.non_updated_lai_in_nmo1 = FALSE;

  MSG_GERAN_HIGH_1_G("Reset non_updated_lai_in_nmo1 (%d)", rr_ps_domain_data_ptr->gmm.non_updated_lai_in_nmo1);
}
...
)
{
  ...
  rr_set_non_updated_lai_nmo1(msg_ptr->non_updated_lai_in_nmo1, gas_id);
...
)
{
  ...
  rr_reset_non_updated_lai_nmo1(gas_id);
...
void rr_gprs_set_l1_in_mm_non_drx(const gas_id_t gas_id)
{
  ...
  {
    rr_send_mph_start_mm_non_drx_ind(rr_get_non_updated_lai_nmo1(gas_id), gas_id);
