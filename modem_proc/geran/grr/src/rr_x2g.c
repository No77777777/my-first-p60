...
)
{
  switch (status)
  {
    ...
    case RR_CCO_STATUS_FAILURE_NO_RESPONSE:                   return TDSRR_GSM_CCO_RA_FAILURE;
    case RR_CCO_STATUS_FAILURE_IA_REJECT:                     return TDSRR_GSM_CCO_RA_FAILURE;
    case RR_CCO_STATUS_FAILURE_CONTENTION_RESOLUTION_FAILURE: return TDSRR_GSM_CCO_RA_FAILURE;
    case RR_CCO_STATUS_FAILURE_DSF:                           return TDSRR_GSM_CCO_RA_FAILURE;
...
void rr_x2g_send_x2g_IRAT_rej(rr_x2g_resel_type_e x2g_resel_type,const gas_id_t gas_id)
{
 ...
 switch (x2g_resel_type)
 {
   ...
   default:
   {
    MSG_GERAN_ERROR_1_G("Unexpected x2g_resel_type: %d", x2g_resel_type);
   }
 }
}	

void rr_x2g_send_x2g_cco_failure_procedure_ind(rr_rat_e rat,const gas_id_t gas_id)
{
  switch (rat)
  {
#ifdef FEATURE_WCDMA
