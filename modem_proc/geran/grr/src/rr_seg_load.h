...
$Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_seg_load.h#1 $   $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
#define tdsrrc_get_inter_rat_bplmn_prtl_result(available_plmn_list) \
        ITDSCDMA_tdsrrc_get_inter_rat_bplmn_prtl_result(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr,available_plmn_list)
#define tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id(available_plmn_list,as_id) \
        ITDSCDMA_tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr,available_plmn_list,as_id)
#define tdsrrc_is_arfcn_valid_sub_id(UARFCN,as_id) \
        ITDSCDMA_tdsrrc_is_arfcn_valid_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr,UARFCN,as_id)
#define tdsrrc_set_ue_in_deep_sleep_sub_id(value,as_id) \
        ITDSCDMA_tdsrrc_set_ue_in_deep_sleep_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr,value,as_id)
#define tdsrrc_check_cell_barred_sub_id(req, cpid, as_id) \
        ITDSCDMA_tdsrrc_check_cell_barred_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr, req, cpid, as_id)
#define tdsrrc_get_classmark_change_handover_info_sub_id(msg_ptr, msg_len, irat_ho_info_compressed, as_id) \
        ITDSCDMA_tdsrrc_get_classmark_change_handover_info_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr, msg_ptr, msg_len, irat_ho_info_compressed, as_id)
#define tdsrrc_delete_classmark_change_handover_info_sub_id(as_id) \
        ITDSCDMA_tdsrrc_delete_classmark_change_handover_info_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr,as_id)
#define tdsrrc_update_band_preference_sub_id(band_pref_mask,as_id) \
        ITDSCDMA_tdsrrc_update_band_preference_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_TDSCDMA].rat_interface_ptr,band_pref_mask,as_id)
...
#define rrc_put_rr_cmd_sub_id(cmd_buf,as_id) IWCDMA_rrc_put_rr_cmd_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_WCDMA].rat_interface_ptr,cmd_buf,as_id)
...
#define wrrc_get_inter_rat_bplmn_prtl_result(available_plmn_list) \
        IWCDMA_wrrc_get_inter_rat_bplmn_prtl_result(rr_seg_load_ptr[RR_SEG_LOAD_WCDMA].rat_interface_ptr,available_plmn_list)
#define wrrc_get_inter_rat_bplmn_prtl_result_sub_id(available_plmn_list,as_id) \
        IWCDMA_wrrc_get_inter_rat_bplmn_prtl_result_sub_id(rr_seg_load_ptr[RR_SEG_LOAD_WCDMA].rat_interface_ptr,available_plmn_list,as_id)
#endif /*PERLUTF*/
