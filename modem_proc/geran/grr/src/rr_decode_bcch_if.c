...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_decode_bcch_if.c#1 $ */
...
)
{
  ...
  {
    msg.bcch_decode_type = bcch_decode_type;
    msg.si3_only = si3_only;
    msg.bcch_freq_list = *bcch_freq_list_ptr;
