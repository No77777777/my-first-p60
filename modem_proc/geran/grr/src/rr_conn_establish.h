...
$Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_conn_establish.h#2 $ $DateTime: 2020/01/27 04:29:28 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  /**
   * Offset position of CM1 and/or CM2 IEs in the Layer3 message (service_request_message)
   */
  uint8 cm1_start_pos;
  uint8 cm2_start_pos;
...
extern boolean rr_ce_max_failed_rach_sent(const gas_id_t gas_id);

#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
extern void grr_mdump_rr_conn_est(const gas_id_t gas_id);
