...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_channel_mode.c#1 $ */
...
uint32 rr_eng_mode_get_speech_sample_frequency(sys_speech_codec_e_type speech_codec)
{
  ...
  switch (speech_codec)
  {
    ...
    case SYS_SPEECH_CODEC_AMR_WB:
      speech_enc_samp_freq = RR_ENHANCED_SAMPLE_RATE; /*WB*/
    break;
#endif /*FEATURE_GSM_AMR_WB*/

#ifdef FEATURE_GSM_AMR
    case SYS_SPEECH_CODEC_AMR_NB:
      /* Please note now for Enhanced AMR also, DSP starts with Default Rate, NB */
      speech_enc_samp_freq = RR_DEFAULT_SAMPLE_RATE; /*NB*/
    break;
#endif /*FEATURE_GSM_AMR*/
    case SYS_SPEECH_CODEC_GSM_EFR:
    case SYS_SPEECH_CODEC_GSM_FR:
    case SYS_SPEECH_CODEC_GSM_HR:
      speech_enc_samp_freq = RR_DEFAULT_SAMPLE_RATE; /*All other GSM codecs are NB*/
      break;
