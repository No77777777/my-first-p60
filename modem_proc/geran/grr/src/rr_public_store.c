...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_public_store.c#2 $ */
/* $DateTime: 2019/09/09 01:08:19 $$Author: pwbldsvc $ */
...
)
{
  ...
  MSG_GERAN_HIGH_2_G("split_page_cycle=%d multislot_class=%d",
...
#ifdef FEATURE_GSM_DTM
  MSG_GERAN_HIGH_2_G("dtm_enabled=%d dtm_egprs_multislot_subclass=%d",(int)ms_data_ptr->dtm_enabled,(int)ms_data_ptr->dtm_egprs_multislot_subclass);
#ifdef FEATURE_GSM_EDTM
...
#ifdef FEATURE_GSM_GPRS_MSC33
  MSG_GERAN_HIGH_2_G("hmsc_gprs_coded_ms_class=%d hmsc_egprs_coded_ms_class=%d",(int)ms_data_ptr->hmsc_gprs_coded_ms_class,(int)ms_data_ptr->hmsc_egprs_coded_ms_class);
#endif /* FEATURE_GSM_GPRS_MSC33 */
...
#ifdef FEATURE_GSM_DTM
    rrps_ms_data_ptr->dtm_egprs_multislot_subclass =
