...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_l1_idle_mode.h#2 $ */
...
/**
  @brief State checking function
   
  Note: The primary purpose of this function is to return TRUE if RR_L1_IDLE state is RR_L1_STATE_START_EARLY_CAMP.
*/ 
extern boolean rr_l1_is_early_camp (const gas_id_t gas_id);

#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
extern void grr_mdump_rr_l1_idle(const gas_id_t gas_id);
