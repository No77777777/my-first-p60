...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_ps_domain.h#1 $ */
 ...
 */
extern void rr_set_non_updated_lai_nmo1(boolean non_updated_lai_in_nmo1, gas_id_t gas_id);

/*!
 * \brief returns the non_updated_lai_in_nmo1 value.
 */
extern boolean rr_get_non_updated_lai_nmo1(gas_id_t gas_id);

/*!
 * \brief Resets the value of non_updated_lai_in_nmo1 to FALSE.
 */
extern void rr_reset_non_updated_lai_nmo1(gas_id_t gas_id);
