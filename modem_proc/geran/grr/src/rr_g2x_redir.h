...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_g2x_redir.h#1 $ */
...
/**
  @brief This function maps redir type to target rat.
*/
extern rr_rat_e rr_g2x_redir_map_redir_type_to_target_rat( rr_cell_selection_target_e type);
...
/**
  @brief checking g2x redirection state.
         TRUE: if redir state is in deactivating, otherwise FALSE
*/
extern boolean rr_g2x_is_in_redirecting_state(const gas_id_t gas_id);
