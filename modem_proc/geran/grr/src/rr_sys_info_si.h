...
/**
  ...
  $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_sys_info_si.h#1 $
*/
 ...
 *--------------------------------------------------------------------------*/
#define RR_SI_PRINT_BITMASK(xx_descr_text, xx_si_bitmask) \
    { \
      MSG_GERAN_HIGH_0(xx_descr_text);  \
      rr_si_print_bitmask(xx_si_bitmask);  \
    }
 ...
 * \return uint16
 */
extern uint16 rr_si_get_remaining_si_bitmask(gprs_scell_info_t *cell_info);
 ...
 * \param si_bitmask (in)
 */
extern void rr_si_print_bitmask(uint16 si_bitmask);
