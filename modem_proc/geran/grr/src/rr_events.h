...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_events.h#1 $ */
...
typedef enum
{
  ...
  RR_EV_DSF_DURING_EARLY_CAMP                = 0x0d,
  RR_EV_DSF_DUE_TO_DENIAL_DURING_EARLY_CAMP  = 0x0e,
  ...
  RR_EV_TRIGGER_CELL_SELECTION_ACQ_DB_ONLY   = 0x26,
  ...
  EV_TRIGGER_CELL_SELECTION_ACQ_DB_ONLY      = 0x4a,
...
EV_ACCESS_CLASS_NOT_ALLOWED_EMERGECNY_CALL = 0xae,
  /**********************************************/
  ...
  EV_DEACTIVATE_GSM_MODE_FOR_X2G_HO_FAIL     = 0xcf,
  ...
  EV_ACTIVATE_GSM_MODE_FOR_X2G_HO            = 0xd7,
  ...
  **********************************************/
  ...
  EV_G2X_CONN_RESEL_PS_BLOCKED            = 0x0805,
   ...
   /**********************************************/
   /* ARFCN locking events                                            */
   /**********************************************/

#ifdef FEATURE_LOCK_ARFCN
  EV_WAIT_FOR_ARFCN                       = 0x0900,
  EV_START_LOCKING_TO_CHANNEL             = 0x0901,
  EV_START_UNLOCKING_TO_CHANNEL           = 0x0902,
  EV_NO_LOCKING_REQUIRED                  = 0x0903,  
#endif /*FEATURE_LOCK_ARFCN*/

  /* Event to GRR control after RACH faili due to resource unavailable*/
  RR_EV_CAMP_ON_CELL_FOR_RACH_FAIL_OTA    = 0x0904,
  /* Event to trigger RPS following resource denial */  
  RR_EV_START_RPS_AFTER_DENIAL            = 0x0905,
  RR_EV_NUM_OF_EVENTS
