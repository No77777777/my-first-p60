...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_select_bcch.h#2 $ */
 ...
 * \param gas_id 
 */
extern void rr_select_bcch_init(const gas_id_t gas_id);
 ...
 * \param gas_id 
 */
extern void rr_select_bcch_recovery_init(const gas_id_t gas_id);
 ...
 * \param gas_id 
 */
extern void rr_select_bcch_control(rr_cmd_bdy_type *msg_ptr, const gas_id_t gas_id);
 ...
 * \param gas_id
 */
extern void rr_select_bcch_send_l1_read_sys_info_req(
...
QSH_MDUMP_FN_ATTR
extern void grr_mdump_rr_select_bcch(const gas_id_t gas_id);
