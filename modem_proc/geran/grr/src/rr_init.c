...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_init.c#3 $ */
...
#if defined (FEATURE_QSH_DUMP) || defined (FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_EVENT_NOTIFY_TO_QSH)
#include "rr_qsh.h"
#endif // FEATURE_QSH_DUMP || FEATURE_QSH_EVENT_METRIC || FEATURE_QSH_EVENT_NOTIFY_TO_QSH
 ...
 */
void discard_all_rr_temporary_data(const gas_id_t gas_id)
{
...
static void rr_initialise(const gas_id_t gas_id)
{
 ...
 (void)rr_register_scan_complete_callback(rr_default_power_scan_cb , gas_id);
#endif /*FEATURE_LOCK_ARFCN*/ 

  (void) discard_all_rr_temporary_data(gas_id);

#ifdef FEATURE_FAKE_BTS_CELL_DEPRIORITIZE
  rr_init_deprioritized_cell_list(gas_id);
...
#endif /* FEATURE_CGPS_UMTS_CP_GSM */
#if defined (FEATURE_QSH_DUMP) || defined (FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_EVENT_NOTIFY_TO_QSH) || defined(FEATURE_QSH_MDUMP)
  rr_qsh_task_start_init();
#ifdef FEATURE_QSH_MDUMP
  qsh_add_thread_id(QSH_CLT_GRR);
#endif /* FEATURE_QSH_MDUMP */
#endif /* FEATURE_QSH_DUMP || FEATURE_QSH_EVENT_METRIC || FEATURE_QSH_EVENT_NOTIFY_TO_QSH || FEATURE_QSH_MDUMP */
  rr_find_cell_task_start_init();
