...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_log.h#1 $ */
...
/*!
 * \brief Output EVENT_EV_SRVCC_SYNC_IND_SENT indicating SYNC sent to NAS.
 * 
 * \param gas_id 
 */

extern void rr_log_sync_ind_sent_during_srvcc(
  const gas_id_t gas_id
);
 ...
 * \param gas_id
 */
extern void rr_log_csi_flush_data(
 ...
 * \param gas_id
 */
extern void rr_log_irat_si2q_resel_params(
 ...
 * \param gas_id
 */
extern void rr_log_irat_si2q_meas_params(
  mph_wcdma_cell_update_list_req_T *cell_update_list_req,
  mph_dedicated_wcdma_cell_update_list_req_T  *ded_cell_update_list_req,
  const gas_id_t gas_id
);
 ...
 *
 */
extern void rr_log_csi_cache_flush_data(
  csi_entry_t *entry_ptr,
  const rr_si_cache_flush_cause_T csi_flush_cause,
 ...
 *
 */
extern void rr_log_x2g_redir_gsm_cell_list(
  rr_reselection_pscan_cell_list_T *rr_w2g_redir_cell_list_ptr,
  const gas_id_t gas_id
);

#ifdef FEATURE_FAKE_BTS_CELL_INFO
extern void rr_log_fake_cell_data(
  geran_grr_qmi_cell_info_ind_t *entry_ptr,
  const gas_id_t gas_id
);
 ...
 *
 */
extern void rr_log_gsm_meas_params(rr_gsm_meas_params_t * gsm_meas_params, const gas_id_t gas_id);
 ...
 *
 */
extern void rr_log_utran_meas_params(rr_utran_meas_params_t * utran_meas_params, const gas_id_t gas_id);
 ...
 *
 */
extern void rr_log_eutran_meas_params(rr_eutran_meas_params_t * eutran_meas_params, const gas_id_t gas_id);

/*!
 * \brief Outputs ARFCNs added to acq_db in a log packet.
 * 
 * \param gas_id 
 */

extern void rr_log_acq_db_arfcn_list_add(
  gas_id_t gas_id
);
