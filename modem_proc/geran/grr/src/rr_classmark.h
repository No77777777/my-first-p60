...
/*============================================================================
 $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_classmark.h#1 $$DateTime: 2019/06/06 23:27:31 $$$
...
extern uint8 rr_encode_classmark1(const gas_id_t gas_id);

extern boolean rr_encode_classmark2and3(
  rr_classmark_encode_t,
  classmark_2_ie_T *,
  classmark_3_ie_T *,
