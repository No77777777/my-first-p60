...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_irat_overlap_detect.c#1 $ */
...
static void rr_construct_lte_earfcn_to_phys_freq_map(uint8 earfcn_count, rr_l1_eutran_frequency_t* earfcn_list, const gas_id_t gas_id )
{
  ...
  {
    phy_lte_freq = lte_rrc_get_freq_from_earfcn(RR_GAS_ID_TO_AS_ID, earfcn_list[index].earfcn);
