...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_select_bcch_if.c#1 $ */
 ...
 *                              Set to NULL if not required.
 * \param csi_params_ptr      - CSI paramters (optional).
 *                              Set to NULL if not required.
...
void rr_select_bcch_send_imsg_acquire_si_req(
  ...
  rr_select_bcch_csi_params_t *csi_params_ptr,
...
)
{
  ...
  if (csi_params_ptr != NULL)
  {
    msg.csi_params = *csi_params_ptr;
    msg.csi_params_valid = TRUE;
  }
 ...
 */
void rr_select_bcch_init_params_init(rr_select_bcch_init_params_t *init_params_ptr)
{
  RR_NULL_CHECK_RETURN_VOID(init_params_ptr);

  init_params_ptr->bs_ag_blks_res = 0;
  init_params_ptr->bs_cc_chans = 0;
  init_params_ptr->bs_ccch_sdcch_comb = 0;
  init_params_ptr->bs_pa_mfrms = 0;
  init_params_ptr->ci = 0;
  init_params_ptr->imsi_mod_1000 = 0;
  init_params_ptr->imsi_valid = FALSE;
  init_params_ptr->lai.location_area_code = 0;
  init_params_ptr->lai.plmn_id.identity[0] = 0xFF;
  init_params_ptr->lai.plmn_id.identity[1] = 0xFF;
  init_params_ptr->lai.plmn_id.identity[2] = 0xFF;
  init_params_ptr->si_messages_not_broadcast = MASK_SI_NONE;
  init_params_ptr->si_messages_on_bcch_ext = MASK_SI_NONE;
 ...
 */
void rr_select_bcch_csi_params_init(rr_select_bcch_csi_params_t *csi_params_ptr)
{
  RR_NULL_CHECK_RETURN_VOID(csi_params_ptr);

  csi_params_ptr->dont_deact_pend_store_when_finished = FALSE;
