...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_grr.h#2 $ */
...
/**
  @brief Determine whether PS access enable is in progress.

  @return TRUE if GRR is trying to enable PS access, FALSE otherwise.
*/
extern boolean grr_is_ps_enable_in_progress(const gas_id_t gas_id);

/**
  @brief Determine whether PS access disable is in progress.

  @return TRUE if GRR is trying to disable PS access, FALSE otherwise.
*/
extern boolean grr_is_ps_disable_in_progress(const gas_id_t gas_id);
...
QSH_MDUMP_FN_ATTR
extern void grr_mdump_grr_control(const gas_id_t gas_id);
