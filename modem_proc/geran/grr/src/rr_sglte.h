...
$Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_sglte.h#1 $
...
extern boolean rr_sglte_is_serv_cell_in_lte_cgi_req(rr_cmd_bdy_type*  new_message_ptr, const gas_id_t gas_id);

extern void rr_sglte_send_serv_cell_lte_cgi_rsp(rr_cmd_bdy_type* new_message_ptr, const gas_id_t  gas_id);

extern void rr_sglte_send_empty_lte_cgi_rsp(const gas_id_t gas_id);

extern void rr_sglte_send_lte_cgi_abort_rsp(const gas_id_t gas_id);
