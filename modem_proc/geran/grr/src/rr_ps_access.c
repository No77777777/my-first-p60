...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_ps_access.c#2 $ */
...
#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
void grr_mdump_rr_ps_access(const gas_id_t gas_id)
{
  rr_ps_access_data_t *rr_ps_access_data_ptr = rr_ps_access_get_data_ptr(gas_id);
  qsh_mdump_collect_high(rr_ps_access_data_ptr, sizeof(rr_ps_access_data_t));
}
