...
*** TITLE
***
*** $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_gprs_defs.h#1 $
***
*** DESCRIPTION
***
...
typedef struct
{
  ...
  uint16                       si_not_broadcast;
  uint16                       si_on_bcch_ext;
} bcch_ncell_info_t;
...
extern mscr_t rr_si_get_mscr(const gas_id_t gas_id);
...
extern boolean grr_can_process_rr_procedure_ind(const gas_id_t gas_id);
...
/****************************************************************************
 *   Function name:  grr_can_process_rr_restore_scell_info
 *   --------------------------
 *
 *   Description: Checks whether GRR_CONTROL is in correct state to restore SCELL INFO.
 *
 *   Parameters: gas_id_t
 *   -----------
 *
 ...
 *
 ****************************************************************************/
extern boolean grr_can_process_rr_restore_scell_info(const gas_id_t gas_id);
