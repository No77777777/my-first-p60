...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_l1_send.h#1 $ */
 ...
 * \param arfcn (in)
 */
extern rr_l1_band_bitmap_T rr_l1_get_band_bitmap_for_arfcn(ARFCN_T arfcn);
...
extern void rr_send_mph_set_priority_ind(
  rr_priority_info_t* rr_priority_info_p,
  const gas_id_t          gas_id
);
...
extern sys_band_mask_type rr_l1_band_bitmap_to_sys_band_mask(rr_l1_band_bitmap_T rr_l1_band_bitmap);
