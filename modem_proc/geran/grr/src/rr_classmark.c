/*============================================================================
 $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_classmark.c#1 $
 ...
 */
static rr_classmark_data_t *rr_classmark_get_data_ptr(const gas_id_t gas_id)
{
...
/*!
 * \brief Populates the 'classmark params' required when calling MMCP APIs to obtain the Classmark 2/3 IE.
 * 
 * \param cm_params (out)
 * \param gas_id (in)
 */
static void rr_get_params_for_nas_classmark_query(classmark_params_T *cm_params, const gas_id_t gas_id)
{
  ...
  if (rr_si_get_mscr(gas_id) == MSCR_REV_99)
  {
    rel99_support = TRUE;
  }
  else
...
/*!
 * \brief Returns an encoded Classmark 1 IE
 * 
 * \param gas_id (in)
 * 
 * \return classmark_1_ie_T 
 */
uint8 rr_encode_classmark1(const gas_id_t gas_id)
{
  classmark_params_T cm_params;

  rr_get_params_for_nas_classmark_query(&cm_params, gas_id);

#ifdef PERLUTF
  #error code not present
#else
  return gs_get_classmark_1_with_rat(&cm_params);
#endif
}

/*===========================================================================

FUNCTION  rr_encode_classmark2and3
...
===========================================================================*/
boolean rr_encode_classmark2and3(
...
)
{
  ...
  classmark_3_valid = rr_encode_classmark2and3(
