...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_grr_if.c#1 $ */
...
const char * rr_grr_imsg_name(const rr_grr_imsg_e imsg)
{
  switch (imsg)
  {
    ...
    case RR_GRR_IMSG_IRAT_ALLOWED_UPDATED_IND:
      return "RR_GRR_IMSG_IRAT_ALLOWED_UPDATED_IND";
#endif /* FEATURE_LTE */
    ...
    case RR_GRR_IMSG_FREQ_LIST_UPDATE_IND:
      return "RR_GRR_IMSG_FREQ_LIST_UPDATE_IND";
#endif /*FEATURE_GERAN_HST_OPT*/

    case RR_GRR_IMSG_REVERT_SCELL_INFO_IND:
      return "RR_GRR_IMSG_REVERT_SCELL_INFO_IND";
...
#else
  MSG_GERAN_HIGH_1_G("Sending RR_GRR_IMSG_RR_EVENT_IND with %d", rr_event);
