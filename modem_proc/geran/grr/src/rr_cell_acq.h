...
============================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_cell_acq.h#2 $ */
...
/**
  ...
  @return TRUE if RR cell acquisition state machine is suspending MAC, FALSE
          otherwise.
*/
extern boolean rr_cell_acq_pending_mac_suspension(const gas_id_t gas_id);
...
extern boolean rr_cell_acq_can_process_surr_si_received_ind(const gas_id_t gas_id);

#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR
extern void grr_mdump_rr_cell_acq(const gas_id_t gas_id);
