...
*/
/* $Header: //components/rel/geran.mpss/7.4.0/grr/src/rr_ce_paging.c#1 $ */
 ...
 */
void rr_ce_update_l1_page_mode(paging_mode_T page_mode, const gas_id_t gas_id)
{
...
boolean rr_ce_compare_ota_ptmsi(byte *IE, const gas_id_t gas_id)
{
     ...
     )
  {
    ...
    {
      // They match - exit early
      return TRUE;
    }
  }

  if (rr_siminfo_get_old_ptmsi(
        sim_ptmsi,           // ptmsi
        sizeof(sim_ptmsi),   // destsize
        gas_id               // gas_id
      )
