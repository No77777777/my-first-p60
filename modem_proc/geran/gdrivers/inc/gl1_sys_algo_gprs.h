...
$Header: //components/rel/geran.mpss/7.4.0/gdrivers/inc/gl1_sys_algo_gprs.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
(
  ...
  sys_algo_agc_T *gprs_agc_divrx,  /* gprs Rx diversity agc pointer */
#endif
