...
$Header: //depot/SBA/users/lteswint/ebf/mpl/BF-ENG-RFM-MEAS-INT-MPSS.TH.2.0-00278-M9645MAARANAAM-1/modem_proc/geran/gdrivers/inc/gl1_msg_wcdma_meas.h#2 
...
01/09/15   cgc      CR897441 renamed and removed MAX_FRAMES_FOR_IRAT_TRANSFER_MODE to MAX_FRAMES_FOR_IRAT_CONNECTED_MODE
...
#define MAX_FRAMES_FOR_W_RECONF                   (6)
...
typedef void (*gl1_msg_wcdma_ded_abort_cb_type)(boolean w_aborted_gap,gas_id_t gas_id);
#ifdef FEATURE_GSM_TO_WCDMA_MSGR
typedef void (*gl1_msg_wcdma_meas_handler_done_cb_type)(gas_id_t gas_id);
#endif
...
extern boolean gl1_msg_wcdma_reconfirm (
                             uint16                       UARFCN,
...
#ifdef FEATURE_GSM_TO_WCDMA_MSGR
extern int16 gl1_g2w_get_ecio_logarithmic_average(int16 current_ecio, int16 previous_ecio);
extern void gl1_handle_wcdma_irat_mgsr_msgs(
