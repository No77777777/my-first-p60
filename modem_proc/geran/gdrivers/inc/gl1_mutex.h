...
*/
/*==========================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/gdrivers/inc/gl1_mutex.h#2 $ */
...
extern rex_crit_sect_type gl1_multi_sim_mode_crit_gbta_sec;
extern rex_crit_sect_type gl1_g2x_tuneaway_crit_sec;
extern rex_crit_sect_type gl1_dpc_queue_crit_sec[];
...
extern 	void  gl1_irat_mutex_lock(gas_id_t  gas_id);
extern 	void  gl1_irat_mutex_unlock(gas_id_t gas_id);
