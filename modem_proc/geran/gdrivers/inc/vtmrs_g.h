...
$Header: //components/rel/geran.mpss/7.4.0/gdrivers/inc/vtmrs_g.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
extern int16 vstmr_get_drift( gas_id_t gas_id );

extern void vstmr_reset_drift( int as_idx );
#endif /* VTMRS_G_H */
