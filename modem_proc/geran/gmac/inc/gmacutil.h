...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gmac/inc/gmacutil.h#1 $
***
...
extern void gmac_util_send_mac_l1_recovery_req (gas_id_t gas_id);
extern void gmac_util_handle_error_recovery (gas_id_t gas_id);
