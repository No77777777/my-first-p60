...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gmac/inc/gmactransfer.h#2 $   
***
...
typedef struct
{
  ...
  uint32                     fn_of_last_PTR;  /*used to detect PTR's rcvd on the same FN*/
                                              /*re set on release from transfer and on  */
                                              /*entry into transfer                     */
...
QSH_MDUMP_FN_ATTR
extern void gmac_qsh_mdump_collect_trans_data(boolean actv_sub, gas_id_t gas_id);
#endif
