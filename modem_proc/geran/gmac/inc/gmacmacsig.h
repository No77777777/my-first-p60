...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gmac/inc/gmacmacsig.h#1 $
***
...
typedef struct
{
  qsh_client_cb_params_s  qsh_cb_params;  /*Parmaters QSH provides via gmac_qsh_data_capture_cb()*/
}
mac_task_qsh_metric_data_t;
...
#ifdef FEATURE_QSH_EVENT_METRIC
  mac_task_qsh_metric_data_t                    mac_task_qsh_metric_data;         
#endif // FEATURE_QSH_EVENT_METRIC
} mac_mac_msg_u;
