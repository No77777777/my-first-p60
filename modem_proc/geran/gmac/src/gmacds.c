...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gmac/src/gmacds.c#1 $
***
...
gas_id_t gmac_get_l1_gas_id(l1_mac_sig_t *l1_msg_ptr )
{
  ...
  switch(l1_msg_ptr->sig_id)
  {
    ...
    case L1_MAC_RECOVERY_IND:
      gas_id = l1_msg_ptr->msg.recovery_ind.gas_id;
    break;

    case L1_MAC_RECOVERY_CNF:
      gas_id = l1_msg_ptr->msg.recovery_cnf.gas_id;
    break;
                                      ...
                                      gas_id_t      gas_id)
{
  ...
  switch (common_msg_ptr->mac_l1_freq_config.message_header.message_id)
  {
    ...
    case MAC_L1_RECOVERY_REQ:
      common_msg_ptr->mac_l1_recovery_req.gas_id = gas_id;
      break;
