...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gmac/src/gmactimers.c#1 $
***
...
void gmac_stop_t3166(gas_id_t gas_id)
{
  ...
  MSG_GERAN_MED_0_G("MAC Timer stopped T3166");
...
void gmac_start_t3168(uint8 period, gas_id_t gas_id)
{
  ...
  MSG_GERAN_MED_0_G("MAC Timer start T3168");
...
void gmac_stop_t3168(gas_id_t gas_id)
{
  ...
  MSG_GERAN_MED_0_G("MAC Timer stop T3168");
