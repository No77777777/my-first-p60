...
***  xxx
***
*** Copyright (c) 2001,2002,2003,2004,2005-2015 Qualcomm Technologies, Inc.
...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gmac/src/gmactransfer.c#2 $
***
...
transfer_data_ptr->fn_of_last_PTR = 0xffffffff;
        ...
        switch (signal_id)
        {
          ...
          case L1_MAC_RRBP_FAILED_IND:
            ...
            if(global_data_ptr->msg_ptr->l1_mac_sig.msg.rrbp_failed_ind.rrbp_contained_chan_des == TRUE)
            {
              ...
              if (gmac_util_is_rlc_blocked(GMAC_TRAN, __LINE__, gas_id) == UNBLOCKED)
              {
        ...
        switch (signal_id)
        {
          ...
          case GRR_MAC_PSHO_REQ:
            ...
            if(gmac_util_ps_ho_req_handler(transfer_data_ptr->mac_transfer_substate,gas_id) == TRUE)
            {
              ...
              MSG_GERAN_MED_0_G( "GMAC State tran = TRANSFER_PS_HANDOVER");
            ...
            if (global_data_ptr->c_flags.tbf_release_pending_flg == FALSE)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    MSG_GERAN_ERROR_1_G("GMAC AB recovery, Expected DL (0x01) in PH_CONNECT_IND, received: 0x%x",
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
            ...
            if(transfer_data_ptr->t_flags.abnormal_ul_and_dl_rel_flg == FALSE)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (TRUE == geran_nv_ptm_err_recovery())
                  {
                    MSG_GERAN_ERROR_1_G("GMAC AB recovery, Expected UL (0x00) in PH_CONNECT_IND, received: 0x%x", 
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                    gmac_util_handle_error_recovery(gas_id);
                  }
                  else
#endif /* FEATURE_GERAN_PTM_ERR_RECOVERY */
                  {
                    ...
                    QSH_MDUMP_SET(QSH_MDUMP_CRASH_CAT_UNKNOWN, QSH_CLT_GMAC, QSH_CLT_GMAC)
#endif /* FEATURE_QSH_MDUMP */
                    ERR_GERAN_FATAL_1_G("GMAC AB Rel, Expected UL (0x00) in PH_CONNECT_IND, received: 0x%x", 
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                  }
                }
              }
          ...
          case MAC_PH_CONNECT_IND:
            ...
            if(transfer_data_ptr->t_flags.abnormal_ul_and_dl_rel_flg == FALSE)
            {
                  ...
                  ))
              {
                if(geran_get_nv_recovery_restart_enabled(gas_id))
                {
                  MSG_GERAN_ERROR_1_G("GMAC AB Rel, DL_REL pending and received PH_CONNECT_IND: 0x%x",
                    global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                  MSG_GERAN_ERROR_0_G("GMAC initiated Recovery Restart");
                  geran_initiate_recovery_restart(GERAN_CLIENT_GMAC, gas_id);
                }
...
#endif /* FEATURE_GERAN_PTM_ERR_RECOVERY */
                  {
                    ERR_GERAN_FATAL_1_G("GMAC AB Rel, DL_REL pending and received PH_CONNECT_IND: 0x%x",
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                  }
                }
              }
              ...
              if (global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind == UPLINK_TBF_ESTABLISHED ||
                  global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind == UPLINK_DOWNLINK_TBF_ESTABLISHED)
              {
            ...
            if(transfer_data_ptr->t_flags.abnormal_ul_and_dl_rel_flg == FALSE)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (TRUE == geran_nv_ptm_err_recovery())
                  {
                    MSG_GERAN_ERROR_1_G("GMAC AB recovery, Expected UL_DL (0x02) in PH_CONNECT_IND, received: 0x%x",
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                    gmac_util_handle_error_recovery(gas_id);
                  }
                  else
#endif /* FEATURE_GERAN_PTM_ERR_RECOVERY */
                  {
                    ...
                    QSH_MDUMP_SET(QSH_MDUMP_CRASH_CAT_UNKNOWN, QSH_CLT_GMAC, QSH_CLT_GMAC)
#endif /* FEATURE_QSH_MDUMP */
                    ERR_GERAN_FATAL_1_G("GMAC AB Rel, Expected UL_DL (0x02) in PH_CONNECT_IND, received: 0x%x",
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                  }
                }
              }
            ...
            if(transfer_data_ptr->t_flags.abnormal_ul_and_dl_rel_flg == FALSE)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (TRUE == geran_nv_ptm_err_recovery())
                  {
                    MSG_GERAN_ERROR_1_G("MAC AB recovery, Expected UL_DL (0x02) in PH_CONNECT_IND, received: 0x%x",
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                    gmac_util_handle_error_recovery(gas_id);
                  }
                  else
#endif /* FEATURE_GERAN_PTM_ERR_RECOVERY */
                  {
                    ...
                    QSH_MDUMP_SET(QSH_MDUMP_CRASH_CAT_UNKNOWN, QSH_CLT_GMAC, QSH_CLT_GMAC)
#endif /* FEATURE_QSH_MDUMP */
                    ERR_GERAN_FATAL_1_G("MAC AB Rel, Expected UL_DL (0x02) in PH_CONNECT_IND, received: 0x%x",
                      global_data_ptr->msg_ptr->l1_mac_sig.msg.connect_ind.tbf_type_ind);
                  }
                }
              }
              ...
              else
              {
  ...
  
                {
                  ...
                  else
                  {
                    ...
                    QSH_MDUMP_SET(QSH_MDUMP_CRASH_CAT_UNKNOWN, QSH_CLT_GMAC, QSH_CLT_GMAC)
#endif
                    ERR_GERAN_FATAL_0("MAC error MALLOC failed");
                  }
                           ...
                           gas_id_t                         gas_id )
{
  ...
  {
    gmac_send_mac_grr_dtm_channel_assign_rej( ass_status, MAC_TRANSFER, gas_id );
  }
    ...
    case TRANSFER_DL_WITH_DYNAMIC_ALLOC:
      ...
      else
      {
        ...
        else
        {
          ...
          QSH_MDUMP_SET(QSH_MDUMP_CRASH_CAT_UNKNOWN, QSH_CLT_GMAC, QSH_CLT_GMAC)
#endif
          ERR_GERAN_FATAL_2_G("GMAC unknown msg_type: 0x%x in transfer substate: 0x%x",
            global_data_ptr->csn_dec_hdr_ptr->message_type,transfer_data_ptr->mac_transfer_substate);
        }
      }
    break;
...
case TRANSFER_CONCURRENT_DL_REASSIGN_DYNAMIC_REALLOC:
    ...
    case TRANSFER_CONCURRENT_DYNAMIC_TRANSFER:
      if(geran_get_nv_recovery_restart_enabled(gas_id))
      {
        MSG_GERAN_ERROR_1_G("GMAC simulate freq cnf called in wrong state: 0x%x", transfer_data_ptr->mac_transfer_substate);
        MSG_GERAN_ERROR_0_G("GMAC initiated Recovery Restart");
        geran_initiate_recovery_restart(GERAN_CLIENT_GMAC, gas_id);
      }
      else
    ...
    switch (pcri_tbf_type)
    {
      ...
      case UL_TBF_PRESENT:
        switch(transfer_state)
        {
          ...
          case TRANSFER_DL:
          case TRANSFER_DL_REASSIGN:
            MSG_GERAN_MED_1_G( "GMAC, PCRI Expected DL TBF, received UL TBF in %d, AB Release",transfer_state);
            gmac_tran_edtm_cs_rel_handle_abnormal_rel(gas_id);
          break;
          ...
          case TRANSFER_CONCURRENT_DYNAMIC_REALLOC:
          case TRANSFER_CONCURRENT_DL_REASSIGN_DYNAMIC_REALLOC:
            MSG_GERAN_MED_1_G( "GMAC, PCRI Expected UL+DL TBF, received UL TBF in %d, AB Release",transfer_state);
            gmac_tran_edtm_cs_rel_handle_abnormal_rel(gas_id);
          break;
      ...
      case DL_TBF_PRESENT:
        switch(transfer_state)
        {
          ...
          case TRANSFER_UL_DYNAMIC:
          case TRANSFER_UL_DYNAMIC_REALLOC:
            MSG_GERAN_MED_1_G( "GMAC, PCRI Expected UL TBF, received DL TBF in %d, AB Release",transfer_state);
            gmac_tran_edtm_cs_rel_handle_abnormal_rel(gas_id);
          break;
          ...
          case TRANSFER_DL_WITH_DYNAMIC_ALLOC:
            ...
            {
              MSG_GERAN_MED_1_G( "GMAC, PCRI Expected UL+DL TBF, received DL TBF in %d, AB Release",transfer_state);
              gmac_tran_edtm_cs_rel_handle_abnormal_rel(gas_id);
            }
          break;
      ...
      case UL_DL_TBF_PRESENT:
        switch(transfer_state)
        {
          ...
          case TRANSFER_DL:
          case TRANSFER_DL_REASSIGN:
            MSG_GERAN_MED_1_G( "GMAC, PCRI Expected DL TBF, received UL+DL TBF in %d, AB Release",transfer_state);
            gmac_tran_edtm_cs_rel_handle_abnormal_rel(gas_id);
          break;
          ...
          case TRANSFER_DL_REASSIGN_DYNAMIC_ALLOC:
            ...
            if (ctrl_ack_set == TRUE)
            {
              MSG_GERAN_MED_1_G( "GMAC,PCRI Ctrl Ack removes DL, Cannot realloc UL in state: %d, AB Release",transfer_state);
              gmac_tran_edtm_cs_rel_handle_abnormal_rel(gas_id);
            }
            else
            {
...
===
===  DESCRIPTION
===   This function can be called externally to transfer in order to determine
===   which TBFs are active.  Note: A TBF is only active when L1 has indicated
===   that it has been connected. This function should only be called in
===   Transfer mode otherwise it will print an ERROR F3.
===
===  DEPENDENCIES
===
===  RETURN VALUE
...
/*===========================================================================
===
===  FUNCTION    gmac_transfer_set_transfer_state()
===
===  DESCRIPTION
===  This is an access function for external entities to set the mac_transfer_substate.
===
===  PARAMS
===
===  RETURN VALUE
...
===
===========================================================================*/
void gmac_transfer_set_transfer_state(gprs_mac_transfer_substates_t substate, gas_id_t gas_id)
{
  gmac_transfer_data_t *transfer_data_ptr = gmac_get_transfer_data_ptr(gas_id);
  transfer_data_ptr->mac_transfer_substate = substate;
}

#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR void gmac_qsh_mdump_collect_trans_data(boolean actv_sub, gas_id_t gas_id)
{
  gmac_transfer_data_t *trans_data_ptr = gmac_get_transfer_data_ptr(gas_id);

  qsh_mdump_collect_high(trans_data_ptr, sizeof(gmac_transfer_data_t));
  NOTUSED(actv_sub);
}
#endif /* FEATURE_QSH_MDUMP */
