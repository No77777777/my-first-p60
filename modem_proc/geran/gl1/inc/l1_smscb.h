...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/l1_smscb.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $

when       who      what, where, why
--------   -------- ---------------------------------------------
16/05/16   db       CR1009490 Move CBCH priority handling from GRR to GL1
14/08/15   sp       CR729269 Skip reserving CB activity for non TC0 occasions, if TC0 is not decoded yet.
...
RETURN VALUE:
  TRUE, if CBCH TC=1/2/3 needs to be skipped.

SIDE EFFECTS:
  None
===========================================================================*/
extern boolean l1_skip_cbch_non_tc0_block(l1_smscb_cbch_info_type *cbch_info, uint32  fn, gas_id_t gas_id );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern geran_priority_t l1_smscb_get_cbch_priority(const gas_id_t gas_id);
#endif /* FEATURE_DUAL_SIM | FEATURE_TRIPLE_SIM */

extern void l1_reset_non_drx_tc0(gas_id_t gas_id);
