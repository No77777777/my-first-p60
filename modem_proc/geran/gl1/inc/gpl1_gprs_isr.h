...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/gpl1_gprs_isr.h#1 $
...
DESCRIPTION
function computes slammed  uplink PS timeslot allocation for DTM and TRANSFER MODE using the usf array, and stores them in a ul array 
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_get_slammed_ps_ul_alloc(boolean *slammed_ps_ul_alloc, dynamic_tbf_information_T *tbf_dynamic,
...
DESCRIPTION
function computes slammed downlink PS timeslot allocation for DTM and TRANSFER MODE, using the downlink slot bit map and the usf array and stores it in a dl array 
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_get_slammed_ps_dl_alloc(boolean *slammed_ps_dl_alloc, downlink_tbf_information_T *tbf_dl, 
                               dynamic_tbf_information_T *tbf_dynamic, uint8 *lowest_dl_OTA_timeslot, gas_id_t gas_id);
...
DESCRIPTION
Function sets the coex params update flag , such that there is no notify_ps_access
in two phase access
...
DESCRIPTION   sets the value of the DTM assignment flag to true when a new DTM assignment message is received from MAC
