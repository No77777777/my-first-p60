...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/gpl1_gprs_serving_cell.h#1 $
...
/* Number of Bursts */
#define GL1_ONE_BURSTS   1
#define GL1_TWO_BURSTS   2
#define GL1_THREE_BURSTS 3
#define GL1_FOUR_BURSTS  4
...
typedef struct
{
  ...
  int16    burst_ss_divrx[ GL1_DEFS_FRAMES_IN_BLK_PERIOD ];
  int16    accum_block_rssi_divrx;
...
{
  gl1_defs_coding_type  coding_type;
  boolean               header_decode_ok;
  boolean               tfi_match;
  boolean               data_payload_error;
  uint16                rxqual;
} gpl1_gprs_decode_metrics_T;
...
#if defined(FEATURE_GSM_RX_DIVERSITY_IDLE) || defined(FEATURE_GSM_RX_DIVERSITY_DATA) 
  int16               rla_p_isr_avg_divrx;
  int16               ssblockn_divrx;
#endif /*FEATURE_GSM_RX_DIVERSITY_IDLE || FEATURE_GSM_RX_DIVERSITY_DATA*/
...
extern int16     gpl1_scell_calc_ssblockn( int16 accum_block_rssi, 
                                          uint8 num_bursts, 
                                          gas_id_t gas_id );
...
extern dBx16_T*   gpl1_gprs_get_serv_cell_meas_buf( gl1_power_meas_buffer_type prx_drx_buffer,
                                                    gas_id_t gas_id );
extern gpl1_egprs_qual_meas_queue_T*   gpl1_gprs_get_serv_cell_head_ptr( gas_id_t gas_id );

extern void  gpl1_calc_gprs_egprs_dl_bler( tbf_mode_T  egprs_or_gprs_tbf,
                                           gas_id_t    gas_id
                                         );
