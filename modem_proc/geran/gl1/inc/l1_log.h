...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/l1_log.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
{
   GL1_DRX_NO_ERROR,
   GL1_DRX_ERROR_TOO_MANY_REQ_TICKS,
   GL1_DRX_ERROR_REQ_CURR_FN,
   GL1_DRX_ERROR_CAN_NOT_REQ,
   GL1_DRX_ERROR_INVALID_STATE,
   GL1_DRX_ERROR_BAD_REF,
   GL1_DRX_ERROR_CAN_NOT_REL
} l1_drx_ref_error_T;
...
typedef struct
{
   ...
   uint8  ref_count;
   uint8  drx_state;
   l1_drx_ref_error_T l1_drx_ref_error;
} l1_drx_ref_log_T;
...
typedef struct {
     ...
     l1_drx_ref_log_T l1_drx_ref_log_buf[L1_DRX_LOG_LEN];
     uint8 l1_drx_ref_log_buf_index;
