...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/gl1_arbitrator_utils.h#1 $
...
DESCRIPTION   This function gets rx power during specific bcch read.
...
DESCRIPTION   This function sets desense band in X+G DSDA ( DR-DSDS).
