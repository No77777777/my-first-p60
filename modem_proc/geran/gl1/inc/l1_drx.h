...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/l1_drx.h#1 $
...
extern uint32  gl1_hw_wkupmgr_wakeup_point_reprog_fn[NUM_GERAN_DATA_SPACES];
...
extern uint16  gl1_hw_frame_number_ols[NUM_GERAN_DATA_SPACES];
extern uint16  gl1_hw_frame_number_mdsp_wakeup[NUM_GERAN_DATA_SPACES];
extern uint16  gl1_hw_frame_number_gts[NUM_GERAN_DATA_SPACES];
extern uint32  sleep_duration_frames[NUM_GERAN_DATA_SPACES];
