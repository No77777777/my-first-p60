...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/7.4.0/gl1/inc/gl1_sys_params.h#1 $
...
07/03/17   sn      CR2015796 Correcting the NCELL SCH Duration during Initilisation
...
/* ------------------------------------------------------------------------- */
#define SYS_PARAM_MAX_FRAMES_FOR_SCH_DECODING 23
...
/* ------------------------------------------------------------------------- */
/* Item Name:       SYS_PARAM_MIN_ACCEPTABLE_NCELL_RX_LVL_dBm_x16_COEX       */
/* Description:     NCELL for which measurement has not been done , using an */
/*                  extreme value of -110 dbm cuases blanking for X TECH     */
/*                  Using Recommmended value will result in apllying backoff */
/* Suggested Value: -110 dBm.                                                */
/*                  This parameter is specified in 1/16 dB units.            */
/* ------------------------------------------------------------------------- */
#define SYS_PARAM_MIN_ACCEPTABLE_NCELL_RX_LVL_dBm_x16_COEX  (-100*16) /* -100 dBm */
...
/* ------------------------------------------------------------------------- */
/* Item Name:       SYS_PARAM_DEDI_NCELL_ACQ_START_FNCOUNTER_THRESHOLD       */
/* Description:     Minimum number of Frames from dedicated transition time  */
/*                  before which Ncell acq activities should not be started  */
/*                  in dedicated mode.                                       */
/* Suggested Value: 150 TDMA Frames.                                         */
/* ------------------------------------------------------------------------- */
#define SYS_PARAM_DEDI_NCELL_ACQ_START_FN_THRESHOLD    150
