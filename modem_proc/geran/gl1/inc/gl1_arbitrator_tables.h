...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/gl1_arbitrator_tables.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
extern void (*garb_resolve_conflict_lut[GARB_CHAN_MAX][GARB_CHAN_MAX])(uint8 ts, boolean is_rx, uint8 conflict_index, cxm_activity_type* conflict_priority_tier, uint8 conflict_read_t_index,gas_id_t);
...
/* FR DTX */
#define IS_FR_DTX_FRAME(FnMod104) ( \
   (FnMod104==51)   || \
   (FnMod104==52)   || \
   (FnMod104==53)   || \
   (FnMod104==54)   || \
...
/* HR DTX */
#define IS_HR_DTX_FRAME(FnMod104, subchannel) ( \
 ( (subchannel==0) && \
 ( (FnMod104==104)  || \
   (FnMod104==1)    || \
   (FnMod104==3)    || \
