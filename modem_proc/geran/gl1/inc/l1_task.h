...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/l1_task.h#1 $
...
06/05/15   cja      CR827065 Handle G2W initialisation requested when G2W shutdown in progress
27/04/15   ws       CR815011 Featurise cfcm_cpu_monitor handling under FEATURE_DUAL_DATA
...
extern volatile boolean  gl1_TDS_IRAT_STOP_MODE_pending;
extern volatile boolean  g2t_stop_mode_cnf_pending;
#endif
...
extern sys_proc_type_e_type gl1_get_specific_sys_proc(geran_procedure_t geran_procedure, gas_id_t gas_id);
...
#ifdef FEATURE_GSM_TDS
extern boolean l1_g2t_delay_for_fw_cleanup;
...
#define   bALL_RATS_INACTIVE   ( bTDS_RAT_INACTIVE | bWCDMA_RAT_INACTIVE | bLTE_RAT_INACTIVE)
...
extern void L1_enable_dual_receive(grm_client_enum_t    grm_client_id,
                                   gas_id_t             gas_id);
...
void  L1_send_MPH_SURROUND_IRAT_MEAS_IND( rr_l1_irat_rat_e                  rat,
                                          const rr_l1_irat_measurements_u*  measurements_ptr,gas_id_t gas_id
                                        );
...
extern void l1_send_coll_msg_to_rr( trm_idle_coll_event_data  *idle_coll_event_info, gas_id_t gas_id);
