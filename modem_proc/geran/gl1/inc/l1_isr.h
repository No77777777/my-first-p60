...
$Header: //components/rel/geran.mpss/7.4.0/gl1/inc/l1_isr.h#2 $
...
27/11/15   hd       CR924654 Added the function prototype if_starting_time_elapsed_or_valid
...
18/02/15   am       CR770270 Ensure CBCH is not scheduled if it is being from frame manager
...
int l1_frames_in_null_mode ;
int l1_frames_in_find_bcch ;
int l1_frames_in_random_access_mode;

/* This is used to send the message to MAC once gsm L1
 * has finished stopping the access mode and is ready
 * to drop back to idle mode for both 51MF and 52MF.
 */
boolean  l1_access_isr_send_mac_sb_failure ;

#ifdef FEATURE_GSM_DTM
l1_dtm_command_event_t dtm_command_event ;
l1_dtm_mode_state_t old_l1_dtm_mode_state ;
l1_dtm_mode_state_t l1_dtm_mode_state ;

#endif
#ifdef FEATURE_WTOG_BACKGROUND_PLMN_SEARCH
boolean leaving_bplmn ;
boolean  l1_bplmn_suspend_in_progress ;
#if defined ( FEATURE_DUAL_SIM ) || defined ( FEATURE_TRIPLE_SIM )
int16 rf_fw_warmup_timer;
byte suspension_timer;
#endif /* FEATURE_DUAL_SIM | FEATURE_TRIPLE_SIM */
#endif /* FEATURE_WTOG_BACKGROUND_PLMN_SEARCH */
int32 frames_required;
int16 mdsp_awake_panic;
}l1_isr_data_t;
...
void L1_get_CCH_filler_message( l2_channel_type_T channel_type,
                                byte              *op_buffer_ptr,
                                uint16            *num_octets_copied_ptr , gas_id_t gas_id );
...
DESCRIPTION
  This function sets the x2g indicator flag
...
DESCRIPTION
  This function reads x2g indicator flag
...
boolean l1_idle_ta_prepared( gas_id_t gas_id );
