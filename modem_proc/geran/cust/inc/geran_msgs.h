...
$Header: //components/rel/geran.mpss/7.4.0/cust/inc/geran_msgs.h#4 $
...
#ifdef FEATURE_QSH_MDUMP
extern void geran_qsh_mdump_set_vars(qsh_mdump_crash_cat_e category, qsh_clt_e rep_client, qsh_clt_e client);

#define QSH_MDUMP_SET(category, rep_client, client)  geran_qsh_mdump_set_vars(category, rep_client, client);
#else
#define QSH_MDUMP_SET(category, rep_client, client)
#endif /* FEATURE_QSH_MDUMP */
