...
$Header: //components/rel/geran.mpss/7.4.0/cust/inc/custgsm.h#4 $
...
20/03/18   bala    CR1013525 FR 35208: Increasing Decode BCCH list frequencies during cell selection
...
24/07/17   mk      CR2071218 FR44121 -Synchronous Ncell Quality Monitor - added feature flag
...
25/07/16   hd      CR1045519 Enable FEATURE_GERAN_SAR: FR 32791 - ASDiv enable/disable based on DSI status 
29/02/16   js      CR980305 Enabling QTA in FIND BCCH
02/24/16   vr      CR981110 Disabling FR 27391(CR909145) : GL1 should allow QBTA/QTA gaps in find_BCCH state to avoid LTA gaps 
01/02/16   js      CR909145 FR 27391: GL1 should allow QBTA/QTA gaps in find_BCCH state to avoid LTA gaps 
...
22/04/15   ab      CR848697 : using CR to enable for XCCH Debug in GBTA.
22/04/15   am      CR803948 TA in idle mode when mm_non_drx is enabled
29/05/15   sbr     CR738835 disable FEATURE_GSM_DED_SCELL_MONITOR for Tabasco
...
15/05/13   nn      CR487943 Enable FEATURE_GSM_SEARCH_ALL_WCEL
...
#define FEATURE_GERAN_UL_DEBUG
#define FEATURE_GERAN_LOG_OPT

#ifdef FEATURE_LTE
#define FEATURE_PRIORITIZE_LTE_FREQ
#endif /* FEATURE_LTE */

#define FEATURE_GSM_AUDIO_GAP_OPTIMIZATION
/*---------------------------------------------------------------------------
                               GSM L1
---------------------------------------------------------------------------*/
...
#define FEATURE_GSM_COEX_ADAPTIVE_MON_TDD_SCHED

#define FEATURE_IRAT_RESERVE_SLEEP
...
/*---------------------------------------------------------------------------
                           GPRS MAC
---------------------------------------------------------------------------*/
#define FEATURE_GERAN_PTM_ERR_RECOVERY
...
#define FEATURE_G2L_TIME_TRANSFER
#endif
...
#define FEATURE_GSM_G2X_TIMELINE_REDUCTION
...
#define FEATURE_GPRS_GBTA_DEBUG // Temp enabled
#define FEATURE_G2X_TUNEAWAY
#define FEATURE_G2L_TUNEAWAY
#define FEATURE_GTA_GBTA_IN_2PHASE_ACCESS
#define FEATURE_GTA_DURING_PS_RACH
#define FEATURE_G2X_IDLE_TUNEAWAY
#define FEATURE_G2X_REORG_TUNEAWAY
//feature flag for G to 1x TA 
#define FEATURE_G2_1X_TUNEAWAY

#if defined FEATURE_ONEX_DATA_TUNEAWAY
#define FEATURE_QTA_IN_FINDBCCH
#endif

#define FEATURE_GSM_GPRS_DL_REL_HDR_DEC_ONLY
#endif /*FEATURE_DUAL_SIM*/
...
/* FR20667: SCE optimisation: reduce number of ncells from 6 to 2 */
...
#if defined(FEATURE_GERAN_ANTENNA_SWITCH_DIVERSITY_ACQ)
/*FR 38050: Acquisition Antenna Switch Diversity (ACQ ASDIV)  and Multisim CSFB*/
#define FEATURE_GL1_ASDIV_ACQ 
#endif
#define FEATURE_GERAN_SAR
#endif

  /* FR 21036 : Own Pch in Transfer */
  #define FEATURE_GSM_GPRS_READ_CCCH_IN_XFER
  #define FEATURE_GSM_GPRS_READ_CCCH_IN_XFER_DEBUG

// Enable use of AS-ID in TDSRRC<->GRR i/f
#ifdef FEATURE_DUAL_SIM
  #define FEATURE_TDS_SUB_ID_INTERFACE

/*FEATURE_GTA_2PHASE_ACCESS becomes obsolete when FEATURE_GTA_GBTA_IN_2PHASE_ACCESS is defined*/
#ifndef FEATURE_GTA_GBTA_IN_2PHASE_ACCESS
#define #define FEATURE_GTA_2PHASE_ACCESS
#endif /*FEATURE_GTA_GBTA_IN_2PHASE_ACCESS*/

#endif /* FEATURE_DUAL_SIM */


/* To debug problems with SCE power monitors */
#define FEATURE_GSM_SCE_PWR_MEAS_DBG

#if defined(FEATURE_THOR_MODEM) && !defined(FEATURE_GERAN_ATLAS_MODEM)
#define FEATURE_GERAN_RF_SELF_TEST
#endif /* FEATURE_THOR_MODEM */

/* This along with EFS item enables logging of data PDU at each layer */
#define FEATURE_DATA_PDU_DEBUG

/* Feature flag to store GRLC F3s in internal buffer */
#define FEATURE_GRLC_STORE_F3_MSG

#ifndef PERLUTF
/*Feature flag for Fake BS detection */
#define FEATURE_FAKE_BTS_CELL_INFO
#define FEATURE_FAKE_BTS_CELL_BARRING
#define FEATURE_FAKE_BTS_CELL_DEPRIORITIZE
#endif

/*FR 40251: SMART NCELL SCH (SeNS)*/
#define FEATURE_GSM_SENS_SUPPORT

#if defined (GL1_GMSK_MOD_DET)
#define FEATURE_GSM_SYNQ_SUPPORT
#endif

/* FR 35208: Increasing Decode BCCH list frequencies during cell selection */
#define FEATURE_GSM_DECODE_ALL_FREQS
