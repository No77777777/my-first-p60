...
$Header: //components/rel/geran.mpss/7.4.0/cust/inc/custgsmdrv.h#2 $
...
16/10/15   us      CR928760 Disable FEATURE_XO_RX_GAP_TEMP_COMP 
...
04/08/15   cja     CR884573 Feature for default GFW recovery
...
21/11/14   pg      CR760899 Enable Idle RxD for Thor
...
06/11/14   sb      CR751807 Correct the featurisation of DRDSDS for Jolokia and Tabasco
...
#define FEATURE_GSM_TO_WCDMA_MSGR
/* RFA_TASK and CCS IF support */
/* Enabling Voice and Idle RX Diversity by default */
#define FEATURE_GSM_RX_DIVERSITY
#define FEATURE_GSM_RX_DIVERSITY_IDLE
/* Enabling Data RX Diversity for Thor only */
/* RxD for data is build on top of RxD for idle and is not currently supported independently */
#ifdef FEATURE_GSM_RX_DIVERSITY_IDLE
#define FEATURE_GSM_RX_DIVERSITY_DATA
#endif

/*---------------------------------------------------------------------------
                           GSM MDSP
---------------------------------------------------------------------------*/
#define FEATURE_GSM_RF_DEBUG_NV 
...
/* Default for GFW to crash on CCS error (can be over written by NV) */
#if defined(FEATURE_GERAN_ATLAS_MODEM)
#define FEATURE_GSM_GFW_CRASH_ON_ERROR
#endif

/* Enables error recovery for RF burst building time line issues
   ERR FATAL if timeline issue occurs more than 5 times in any state */
#define FEATURE_GERAN_TIMELINE_ERROR_RECOVERY
...
#define FEATURE_GERAN_PHYSICAL_LAYER_POWER_INFO

#define FEATURE_GERAN_RF_TIMELINE_ERROR_RECOVERY

#define FEATURE_GSM_MCPM_DL_DATA_RATE
#define FEATURE_GSM_RFLM_FED
#if defined FEATURE_DUAL_SIM || defined FEATURE_TRIPLE_SIM
#define FEATURE_GERAN_DRDSDS
//#define FEATURE_PERSISTENT_DENIAL_DEBUG
#define DEBUG_DRDSDS
#endif
...
#define FEATURE_GSM_RX_TX_SPLIT
...
#define FEATURE_GSM_NCELL_BCCH_DECODE_IMPROVEMENT
...
#define FEATURE_CONFIG_VFR_REGISTER
#endif
...
#if defined (FEATURE_GSM_GPRS_TIMELINE_REPORTING)
#define FEATURE_GSM_COEX
  ...
  #define FEATURE_GSM_COEX_REDUCED_MEAS_GPRS
  #define FEATURE_GSM_COEX_TX_BLOCK_DELAY /* FACCH, RATSCCH etc delay */
  #define FEATURE_GSM_COEX_RACH_DELAY
...
/* Use l1_sleep EFS file to enable QDSS logging */
#define FEATURE_GL1_SLEEP_QDSS_LOG
