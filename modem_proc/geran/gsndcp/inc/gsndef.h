...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gsndcp/inc/gsndef.h#2 $   
***
...
#define GSN_ASSERT(xx_exp)                                                       \
  if (!(xx_exp))                                                                 \
  {                                                                              \
     QSH_MDUMP_SET(QSH_MDUMP_CRASH_CAT_UNKNOWN, QSH_CLT_GSNDCP, QSH_CLT_GSNDCP)  \
     ERR_GERAN_FATAL_0( "Assertion " #xx_exp " failed");                         \
  }
