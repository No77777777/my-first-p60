...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gsndcp/src/gsndcp.c#5 $
***
...
***
*****************************************************************************/
#define WM_REG_DEREG_CB(CB_FUNC, CB_DATA, STATUS) if (CB_FUNC != NULL) (CB_FUNC)(CB_DATA, STATUS)
...
geran_pdu_priority_t gsndcp_ul_pdu_priority_hdlr( gas_id_t gas_id, dsm_item_type *npdu );
...
{
  qsh_dump_hdr_s hdr;
  gsndcp_qsh_dump_tag_data_s   gsndcp_qsh_dump_tag_data;
  gsndcp_qsh_dump_tag_data_s   gsndcp_qsh_dump_tag_data_2;
} gsndcp_qsh_tc_dump_collect_s;

/* Pointer declared as type of QSH data structure for parser */
gsndcp_qsh_dump_tag_data_s    *gsndcp_qsh_dump_tag_0_ptr;
gsndcp_qsh_dump_tag_data_s    *gsndcp_qsh_dump_tag_1_ptr;

#endif

#ifdef FEATURE_QSH_EVENT_METRIC

#define GSNDCP_QSH_METRIC_DEFAULT_CONFIG_COUNT 2
#define GSNDCP_QSH_METRIC_DATA_COUNT 50

qsh_ext_metric_cfg_s  gsndcp_qsh_metric_cfg_arr[GSNDCP_QSH_METRIC_DEFAULT_CONFIG_COUNT];

#endif /* FEATURE_QSH_EVENT_METRIC */

#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR static void gsndcp_qsh_mdump_collect(qsh_client_cb_params_s *param);
  ...
  */
  ...
  if( actv_sapis[gas_id][sapi] != NULL )
  {
    ...
    if ( sapi_ptr->is_nsapi_ptr_q_valid )
    {
      ...
      {
        MSG_GERAN_LOW_1_G("GSN ""LL %d: No mapped NSAPIs", gsn_extern_sapi[sapi]);
      }
    }
    else
    {
  ...
  {
    MSG_GERAN_LOW_1_G("GSN ""LL %d: Inactive SAPI", gsn_extern_sapi[sapi]);
  }
...
#error code not present
    ...
    case LL_DATA_IND:
      ...
      {
        MSG_GERAN_ERROR_1_G("GSN " "LL %d: DL Dat Put: LL-DATA-IND: Discard",
          mes_ptr -> sapi);
    ...
    case LL_UNITDATA_IND:
      ...
      {
        MSG_GERAN_ERROR_1_G("GSN " "LL %d: DL Dat Put: LL-UDATA-IND: Discard",
          mes_ptr -> sapi);
        GPRS_PDU_FREE( &l3_pdu_ptr );
        GPRS_MEM_FREE( mes_ptr );
      }
...
void gsn_ll3_ul_ack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  NOTUSED(wm_p);
   ...
   MSG_GERAN_LOW_0_G("GSN " "LL 3: Info ACK UL Suspend");
...
void gsn_ll3_ul_ack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 3: Info ACK UL Resume");
...
void gsn_ll3_ul_unack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 3: Info UNACK UL Suspend");
...
void gsn_ll3_ul_unack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 3: Info UNACK UL Resume");
...
void gsn_ll5_ul_ack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 5: Info ACK UL Suspend");
...
void gsn_ll5_ul_ack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 5: Info ACK UL Resume");
...
void gsn_ll5_ul_unack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 5: Info UNACK UL Suspend");
...
void gsn_ll5_ul_unack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 5: Info UNACK UL Resume");
...
void gsn_ll9_ul_ack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 9: Info ACK UL Suspend");
...
void gsn_ll9_ul_ack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 9: Info ACK UL Resume");
...
void gsn_ll9_ul_unack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 9: Info UNACK UL Suspend");
...
void gsn_ll9_ul_unack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 9: Info UNACK UL Resume");
...
void gsn_ll11_ul_ack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 11: Info ACK UL Suspend");
...
void gsn_ll11_ul_ack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 11: Info ACK UL Resume");
...
void gsn_ll11_ul_unack_hiwater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "LL 11: Info UNACK UL Suspend");
...
void gsn_ll11_ul_unack_lowater( dsm_watermark_type *wm_p, void *context )
{
  ...
  MSG_GERAN_LOW_0_G("GSN " "GSN LL 11: Info UNACK UL Resume");
...
)
{
  ...
  gsndcp_qsh_init();
#ifdef FEATURE_QSH_MDUMP
  qsh_add_thread_id(QSH_CLT_GSNDCP);
#endif
#endif
...
)
{
  ...
  if (GSN_VALID_NSAPI(nsapi))
  {
    ...
    {
      MSG_GERAN_ERROR_1_G("GSN ""GSN: INACTIVE NSAPI %d",nsapi);
    }
    else
    {
      ...
      {
        MSG_GERAN_ERROR_1_G("GSN ""Buffer not available %d",nsapi);
      }
    }
  }
  else
  {
    MSG_GERAN_ERROR_1_G("GSN ""GSN: INVALID NSAPI %d",nsapi);
  }
...
)
{
  ...
  if ( GSN_VALID_NSAPI(external_nsapi) )
  {
    ...
    {
      MSG_GERAN_HIGH_1_G("GSN ""Invalid NSAPI %d", external_nsapi);
    }
  }
  else
  {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
      ...
      (actv_nsapis[ gas_id ][nsapi]->to_gsndcp_wm != NULL))
  {
    ...
    */
    ...
    if ( actv_nsapis[ gas_id ][nsapi]== NULL )
    {
      MSG_GERAN_HIGH_1_G("GSN ""NSAPI %d got invalid",external_nsapi);
  ...
  {
    MSG_GERAN_ERROR_3_G("GSN ""ule.susp_flag %d, to_gsndcp_wm ptr %p ",
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    MSG_GERAN_ERROR_0_G("GSN ""Invalid GAS_ID %d");
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_ptr, cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_parm, FALSE);
    return FALSE;
  }
  ...
  {
    MSG_GERAN_ERROR_1_G("GSN ""Invalid NSAPI %d", cmd_ptr->cmd.gsndcp_reg_wm.nsapi);
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_ptr, cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_parm, FALSE);
    return FALSE;
  }
  ...
  if ( actv_nsapis[ gas_id ][nsapi] == NULL )
  {
    MSG_GERAN_ERROR_1_G("GSN ""Inactive NSAPI %d", cmd_ptr->cmd.gsndcp_reg_wm.nsapi);
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_ptr, cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_parm, FALSE);
    return FALSE;
  }
...
#endif /*FEATURE_DUAL_SIM*/
  {
    MSG_GERAN_ERROR_0_G("GSN ""Unexpected GAS_ID %d");
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_ptr, cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_parm, FALSE);
    return FALSE;
  }
  ...
  {
    MSG_GERAN_ERROR_0_G("GSN ""NULL ptr in wm reg");
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_ptr, cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_parm, FALSE);
    return FALSE;
  }
  ...
  /* Call the registered call back to notify DS */
  WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_ptr, cmd_ptr->cmd.gsndcp_reg_wm.reg_wm_func_parm, TRUE);
  ...
  MSG_GERAN_HIGH_0_G("GSN ""SNDCP-SMD WM registered");
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    MSG_GERAN_ERROR_0_G("GSN ""Invalid GAS_ID %d");
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_ptr, cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_parm, FALSE);
    return;
  }

  /* Get the right NSAPI */
  nsapi = GSN_INTERN_NSAPI(cmd_ptr->cmd.gsndcp_dereg_wm.nsapi);
  MSG_GERAN_HIGH_1_G("GSNDCP dereg wm, nsapi: %d", nsapi);

  /* If there was no active NSAPI, return immediately */

  if ( !GSN_VALID_NSAPI( cmd_ptr->cmd.gsndcp_dereg_wm.nsapi ) )
  {
    MSG_GERAN_HIGH_1_G("GSN ""NSAPI %d is invalid ", cmd_ptr->cmd.gsndcp_dereg_wm.nsapi);
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_ptr, cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_parm, FALSE);
    return;
  }
  ...
  if ( actv_nsapis[ gas_id ][nsapi] == NULL )
  {
    MSG_GERAN_HIGH_1_G("GSN ""NSAPI %d is inactive ", cmd_ptr->cmd.gsndcp_dereg_wm.nsapi);
    WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_ptr, cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_parm, FALSE);
    return;
  }
  ...
  /* Call the registered call back to notify DS */
  WM_REG_DEREG_CB(cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_ptr, cmd_ptr->cmd.gsndcp_dereg_wm.dereg_wm_func_parm, TRUE);

  MSG_GERAN_HIGH_0_G("GSN ""SNDCP-SMD WM deregistered");
...
geran_pdu_priority_t gsndcp_ul_pdu_priority_hdlr( gas_id_t gas_id, dsm_item_type *npdu )
{
    ...
    */
    ...
    if( npdu_copy != NULL )
    {
      ...
      {
        MSG_GERAN_ERROR_0_G("GSN " "GSNDCP PDU priority hdlr: gprs_pdu_strip_head() failed");
      }
      else
      {
        ...
        {
          MSG_GERAN_ERROR_0_G("GSN " "GSNDCP PDU priority handler: Invalid IP version");
        }

        MSG_GERAN_LOW_3_G("GSN " "GSNDCP PDU priority hdlr DBG: ip_hdr_len: %d, ip_total_len: %d, ip_prtcol_type: %d",
                            ip_hdr_len,
                            ip_total_len,
                            ip_prtcol_type );

        MSG_GERAN_LOW_2_G("GSN " "GSNDCP PDU priority hdlr DBG: tcp_hdr_ctrl: 0x%x, pdu_priority: %d ", tcp_hdr_ctrl,
                                                                                                       pdu_priority );
    ...
    {
      MSG_GERAN_ERROR_0_G("GSN " "GSNDCP PDU priority handler: run out of dup dsm items");
    }
...
)
{
  ...
  */
  while( q_cnt(&gsn_cmd_q) )
  {
    ...
    {
      MSG_GERAN_ERROR_0_G("GSN ""q_get() returned NULL");
    }
    ...
    case ( LL_CMD ):
      ...
      if ( gas_id >  GERAN_ACCESS_STRATUM_ID_MAX )
      {
        ...
        MSG_GERAN_ERROR_0_G("GSN ""Invalid GAS_ID: %d in LL msg");
        ...
        */
            ...
            (ll_msg_ptr->mes.xid_ind_mes.n201_u) )
        {
          ...
          if( GSN_VALID_SAPI(ll_msg_ptr->sapi) )
          {
            ...
            MSG_GERAN_ERROR_1_G("GSN ""Invalid SAPI: %d",ll_msg_ptr->sapi);
        }
        else
        {
          ...
          */
          ...
          {
            MSG_GERAN_HIGH_1_G("GSN ""Inactive SAPI: %d",ll_msg_ptr->sapi);
          }
    ...
    case ( SM_CMD ):
      ...
      if ( gas_id >  GERAN_ACCESS_STRATUM_ID_MAX )
      {
        MSG_GERAN_ERROR_0_G("GSN ""Invalid GAS_ID in SM msg");
      }
      else
      {
    ...
    default:
      ...
      MSG_GERAN_ERROR_1_G("GSN ""ME: Invalid control prim id: %d",
                      adpt_msg_ptr->cmd_id);
      break;
...
)
{
  ...
  while ( lead_item_ptr != NULL )
  {
    ...
    if ( mes_ptr != NULL )
    {
      ...
      {
        MSG_GERAN_ERROR_2_G("GSN ""LL %d: Invalid/Inactive SAPI or GAS_ID %d",mes_ptr->sapi,gas_id);
        ...
        else if( mes_ptr->mes.prim == LL_UNITDATA_IND )
        {
          ...
          MSG_GERAN_ERROR_1_G("GSN ""LL %d: Invalid LL data prim",mes_ptr->sapi);
      }
      else
      {
        /* Translate LLC SAPI number to SNDCP internal SAPI number */
            ...
            (mes_ptr->mes.data_ind_mes.l3_pdu != NULL) )
        {
          ...
          {
            MSG_GERAN_ERROR_1_G("GSN ""LL %d: Not EST for LL_DATA_IND",
                 ...
                 (mes_ptr->mes.unitdata_ind_mes.l3_pdu != NULL ) )
        {
          ...
          MSG_GERAN_ERROR_1_G("GSN ""LL %d: Invalid data indication",mes_ptr->sapi);
        ...
        {
          MSG_GERAN_HIGH_3_G("GSN " "LL DL Proc Delay > %d ms - %d ms, Highest %d ms",
    ...
    {
      MSG_GERAN_ERROR_0_G("GSN " "LL DL Proc: App Field Err");
...
)
{
  ...
  */
...
#endif
    MSG_GERAN_LOW_1_G("GSN ""Interrupt UL data thread for SNDCP cmd",nsapi);
  }
  ...
  if( (npdu != NULL) && (*npdu != NULL) )
  {
    ...
    pdu_priority = gsndcp_ul_pdu_priority_hdlr( gas_id, *npdu);
    ...
    if( GSN_VALID_NSAPI(nsapi) )
    {
      ...
      if( nsapi_ptr != NULL)
      {
        ...
        if( nsapi_ptr->op_mode == ACK )
        {
          ...
          {
            MSG_GERAN_ERROR_2_G("GSN ""NS %d: Rcvd SN_DATA for un-established SAPI %d",
          ...
          {
            MSG_GERAN_ERROR_1_G("GSN ""NS %d: Rcvd SN_DATA for inalid SAPI - sapi_ptr NULL",
              nsapi);
          ...
          {
            MSG_GERAN_ERROR_1_G("GSN ""NS %d: N-PDU buff holds GPRS_MAX_RETR_NPDUS",nsapi);
          }

          /* Check if NSAPI is suspended */
          else if( nsapi_ptr->ule.susp_flag )
          {
            MSG_GERAN_HIGH_2_G("GSN ""NS %d: Rcvd SN_DATA_REQ while suspended: susp_flag %x",
        ...
        else
        {
          ...
          if( nsapi_ptr->sapi_ptr == NULL)
          {
            MSG_GERAN_ERROR_1_G("GSN ""NS %d: Rcvd SN_UDATA_REQ for inalid SAPI - sapi_ptr NULL",
              nsapi);
          ...
          {
            MSG_GERAN_HIGH_2_G("GSN ""NS %d: Rcvd SN_UDATA_REQ while suspended: susp_flag %x",
                            nsapi, nsapi_ptr->ule.susp_flag);
          }
      ...
      else
      {
        ...
        MSG_GERAN_ERROR_1_G("GSN ""ME: INVALID or INACTIVE  NSAPI %d",nsapi);
      }
    }
    else
    {
    ...
    MSG_GERAN_ERROR_1_G("GSN ""ME NSAPI %d: Inval UL NPDU",nsapi);
}
...
)
{
  ...
  if( GSN_VALID_NSAPI(nsapi_addr) )
  {
    ...
    {
      MSG_GERAN_ERROR_1_G("GSN ""ME NSAPI %d: Inactive NSAPI",nsapi_addr);
    }
  }
  else
  {
    MSG_GERAN_ERROR_1_G("GSN ""ME NSAPI %d: Invalid NSAPI",nsapi_addr);
  }
}
...
/*===========================================================================
===
===  FUNCTION      gsndcp_qsh_init
===
===  DESCRIPTION   Initializes GSNDCP QSH client.
===
===  DEPENDENCIES
===
===    None.
...
void gsndcp_qsh_init(void)
{
  ...
  client_reg.client                 = QSH_CLT_GSNDCP;    
  client_reg.major_ver              = GSNDCP_QSH_MAJOR_VER;
  client_reg.minor_ver              = GSNDCP_QSH_MINOR_VER;
  client_reg.client_cb_ptr          = gsndcp_qsh_data_capture_cb; 
...
#ifdef FEATURE_QSH_EVENT_METRIC
  qsh_client_metric_cfg_init(gsndcp_qsh_metric_cfg_arr,
                          GSNDCP_QSH_METRIC_DEFAULT_CONFIG_COUNT);
  
  /* Signaling metric enable for AS_ID_1 */
  gsndcp_qsh_metric_cfg_arr[0].id                       = GSNDCP_QSH_METRIC_DATA;
  gsndcp_qsh_metric_cfg_arr[0].subs_id                  = SYS_MODEM_AS_ID_1;
  gsndcp_qsh_metric_cfg_arr[0].fifo.element_size_bytes  = sizeof(gsndcp_qsh_metric_data_s);
  gsndcp_qsh_metric_cfg_arr[0].fifo.element_count_total = GSNDCP_QSH_METRIC_DATA_COUNT;
                                
  /* Signaling metric enable for AS_ID_2 */
  gsndcp_qsh_metric_cfg_arr[1].id                       = GSNDCP_QSH_METRIC_DATA;
  gsndcp_qsh_metric_cfg_arr[1].subs_id                  = SYS_MODEM_AS_ID_2;
  gsndcp_qsh_metric_cfg_arr[1].fifo.element_size_bytes  = sizeof(gsndcp_qsh_metric_data_s);
  gsndcp_qsh_metric_cfg_arr[1].fifo.element_count_total = GSNDCP_QSH_METRIC_DATA_COUNT;

  client_reg.metric_info.metric_cfg_count               = GSNDCP_QSH_METRIC_DEFAULT_CONFIG_COUNT;
  client_reg.metric_info.metric_cfg_arr_ptr             = &gsndcp_qsh_metric_cfg_arr[0];
#endif  /* FEATURE_QSH_EVENT_METRIC */

#ifdef FEATURE_QSH_DUMP 
  client_reg.dump_info.max_size_bytes = sizeof(gsndcp_qsh_tc_dump_collect_s) - sizeof(qsh_dump_hdr_s);
#endif
...
/*===========================================================================
===
===  FUNCTION      gsndcp_qsh_data_capture_cb
===
===  DESCRIPTION   
===  
...
QSH_MDUMP_FN_ATTR
#endif
void gsndcp_qsh_data_capture_cb
(
...
)
{
  ...
  GSN_ASSERT( qsh_cb_params_ptr != NULL );
  ...
  switch (qsh_cb_params_ptr->action)
  {
    ...
    case QSH_ACTION_METRIC_TIMER_EXPIRY:
      ...
      MSG_GERAN_HIGH_1("GSNDCP QSH action = %u EVENT/ANALYSIS/TIMER not supported", qsh_cb_params_ptr->action);
      break;    
    ...
    case QSH_ACTION_METRIC_CFG:
      ...
      MSG_GERAN_HIGH_1_G("GSNDCP QSH cb action = %u METRIC_CFG", qsh_cb_params_ptr->action);

      /* Send internal sig to run action in SNDCP's  task context with a copy of qsh_ch_params */       
      msg_ptr = gsn_int_get_mes_buf();
      GSN_ASSERT( msg_ptr != NULL );  
  
      msg_ptr->cmd_id                                     =  QSH_METRIC_DATA_REQ;         
      msg_ptr->gsn_cmd.qsh_metric_data_req.gas_id         =  gas_id;
      msg_ptr->gsn_cmd.qsh_metric_data_req.qsh_cb_params  = *qsh_cb_params_ptr;
      gsn_int_put_mes( msg_ptr );
      break;
#endif /*FEATURE_QSH_EVENT_METRIC*/
    ...
    case QSH_ACTION_DUMP_COLLECT:
      ...
      gsndcp_populate_qsh_dump_data(qsh_cb_params_ptr);
      break;
#endif/*FEATURE_QSH_EVENT_METRIC*/

#ifdef FEATURE_QSH_MDUMP
    case QSH_ACTION_MDUMP:
      gsndcp_qsh_mdump_collect(qsh_cb_params_ptr);
    break;
#endif /*FEATURE_QSH_MDUMP*/
...
/*===========================================================================
===
===  FUNCTION      gsndcp_populate_qsh_dump_data
===
===  DESCRIPTION   
===  
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
void gsndcp_populate_qsh_dump_data
(
  qsh_client_cb_params_s  *qsh_cb_params_ptr
)
{
  ...
  /* ptr to qsh dump loaction for SNDCP */
  ...
  if (QSH_DUMP_TAG_ENABLED((qsh_cb_params_ptr->action_params.dump_collect.dump_tag_mask),
                            GSNDCP_QSH_DUMP_TAG_DATA)
                          )
  {
    if(remaining_size >= sizeof(gsndcp_qsh_dump_tag_data_s))
    {
      gsndcp_get_qsh_dump_data((gsndcp_qsh_dump_tag_data_s *)cb_param_dump_ptr, GSNDCP_QSH_DUMP_TAG_DATA);
      
      cb_param_dump_ptr   = cb_param_dump_ptr + (sizeof(gsndcp_qsh_dump_tag_data_s));
      remaining_size     -= sizeof(gsndcp_qsh_dump_tag_data_s);
      total_size_written += sizeof(gsndcp_qsh_dump_tag_data_s);
    }  
  }

  if (QSH_DUMP_TAG_ENABLED((qsh_cb_params_ptr->action_params.dump_collect.dump_tag_mask),
                            GSNDCP_QSH_DUMP_TAG_DATA_2)
                          )
  {   
    if(remaining_size >= sizeof(gsndcp_qsh_dump_tag_data_s))
    {
      gsndcp_get_qsh_dump_data((gsndcp_qsh_dump_tag_data_s *)cb_param_dump_ptr, GSNDCP_QSH_DUMP_TAG_DATA_2);
...
/*===========================================================================
===
===  FUNCTION      gsndcp_get_qsh_dump_data
===
===  DESCRIPTION   
===  
===  GSNDCP getting QSH dump data for for Dump collection action.
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
void gsndcp_get_qsh_dump_data
(
  gsndcp_qsh_dump_tag_data_s *dump_data_ptr, 
  gsndcp_qsh_dump_tag_e       tag
)
{
  gas_id_t gas_id  = GERAN_ACCESS_STRATUM_ID_1;
  
  qsh_client_dump_tag_hdr_init((qsh_dump_tag_hdr_s *)dump_data_ptr,(uint16)tag,
                                   (sizeof(gsndcp_qsh_dump_tag_data_s)));

  if(tag == GSNDCP_QSH_DUMP_TAG_DATA_2)
  {
    gas_id = GERAN_ACCESS_STRATUM_ID_2;
  }
  gsndcp_qsh_dump_data_get(gas_id, dump_data_ptr);  
}  /* gsndcp_get_qsh_dump_data */

/*===========================================================================
===
===  FUNCTION      gsndcp_qsh_dump_data_get
===
===  DESCRIPTION   
===
===  GSNDCP copies key variables for dump data collection
===
===  DEPENDENCIES
===
===    None.
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
void gsndcp_qsh_dump_data_get( gas_id_t gas_id, gsndcp_qsh_dump_tag_data_s *dump_data_ptr )
{
  uint8 nsapi_count = 0;
  uint8 qsh_nsapi   = 0;
  uint8 qsh_sapi    = 0;

  GSN_ASSERT( gsndcp_qsh_dump_data_get != NULL );

  /* Collecting data only for the first 4 active NSAPIs */
  for( qsh_nsapi = GSN_NSAPI_5; (qsh_nsapi < GSN_NSAPI_MAX) && (nsapi_count < QSH_NSAPI_MAX_CNT); qsh_nsapi++)
  {
    if(actv_nsapis[gas_id][qsh_nsapi] != NULL)
    {
      dump_data_ptr->data.nsapi[nsapi_count]              = actv_nsapis[gas_id][qsh_nsapi]->nsapi;
      dump_data_ptr->data.nsapi_ul_state[nsapi_count]     = actv_nsapis[gas_id][qsh_nsapi]->ule.susp_flag;
      dump_data_ptr->data.nsapi_dl_state[nsapi_count]     = actv_nsapis[gas_id][qsh_nsapi]->dle.state;
      dump_data_ptr->data.reliability_class[nsapi_count]  = actv_nsapis[gas_id][qsh_nsapi]->qos.reliability_class;
      dump_data_ptr->data.peak_throughput[nsapi_count]    = actv_nsapis[gas_id][qsh_nsapi]->qos.peak_throughput;
      dump_data_ptr->data.radio_priority[nsapi_count]     = actv_nsapis[gas_id][qsh_nsapi]->radio_pr;
      dump_data_ptr->data.data_comp_alg[nsapi_count]      = actv_nsapis[gas_id][qsh_nsapi]->data_comp;
      dump_data_ptr->data.snpdu_tx_cnt[nsapi_count]       = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_tx_cnt;
      dump_data_ptr->data.snpdu_octet_tx_cnt[nsapi_count] = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_octet_tx_cnt;
      dump_data_ptr->data.snpdu_rx_cnt[nsapi_count]       = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_rx_cnt;
      dump_data_ptr->data.snpdu_octet_rx_cnt[nsapi_count] = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_octet_rx_cnt;
      
      nsapi_count++;
    }   
  }/* for */ 
    
  for( qsh_sapi = GSN_SAPI_3; qsh_sapi < GSN_SAPI_MAX; qsh_sapi++)
  {
    if (actv_sapis[gas_id][qsh_sapi] != NULL )
    {
      dump_data_ptr->data.xid_state[qsh_sapi]  = actv_sapis[gas_id][qsh_sapi]->xid_state; /* state of XID request/negotiation process */
      dump_data_ptr->data.sapi_state[qsh_sapi] = actv_sapis[gas_id][qsh_sapi]->state;     /* Sate of SAPI entity */
    }
    dump_data_ptr->data.n201_u[qsh_sapi] = gsn_n201_u[gas_id][qsh_sapi];
    dump_data_ptr->data.n201_i[qsh_sapi] = gsn_n201_i[gas_id][qsh_sapi];  
  }/* for */
...
/*===========================================================================
===
===  FUNCTION      gsndcp_ind_cb_action_done
===
===  DESCRIPTION   
===  
===  Indicate QSH METRIC_CFG callback action done
===
===  DEPENDENCIES
===
===    None.
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
void gsndcp_ind_cb_action_done(qsh_client_cb_params_s *cb_params_ptr)
{
...
/*===========================================================================
===
===  FUNCTION      gsndcp_qsh_metric_capture
===
===  DESCRIPTION   
===  
...
===  signal.
===
===  input: QSH provides a new pointer to the next section in it's SNDCP metric
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
void gsndcp_qsh_metric_capture(gas_id_t gas_id)
{
  /* data passed to QSH when client has finished */
  qsh_client_metric_log_done_s client_metric_done;  
  
  /* ptr to QSH dump loaction for SNDCP metric data */
  gsndcp_qsh_metric_data_s     *metric_ptr;           

  uint8 nsapi_count = 0;
  uint8 qsh_nsapi   = 0;
  uint8 qsh_sapi    = 0;
  
  gsndcp_debug_data_t *debug_data_ptr = gsndcp_get_debug_data_ptr(gas_id);

  GSN_ASSERT( debug_data_ptr != NULL );

  if(debug_data_ptr->gsndcp_qsh_metrics_capture_activate == TRUE)
  {   
    MSG_GERAN_HIGH_0_G("GSNDCP QSH Debug - Filling Metric Data ");

    /*load last last sent/rcvd msg into into QSH metric dump loaction */
    metric_ptr = (gsndcp_qsh_metric_data_s *) (debug_data_ptr->saved_cb_metric_dump_ptr);
    ...
    for( qsh_nsapi = GSN_NSAPI_5; (qsh_nsapi < GSN_NSAPI_MAX) && (nsapi_count < QSH_NSAPI_MAX_CNT); qsh_nsapi++)
    {
      if (actv_nsapis[gas_id][qsh_nsapi] != NULL)
      {
        metric_ptr->data.nsapi[nsapi_count]              = actv_nsapis[gas_id][qsh_nsapi]->nsapi;
        metric_ptr->data.nsapi_ul_state[nsapi_count]     = actv_nsapis[gas_id][qsh_nsapi]->ule.susp_flag;
        metric_ptr->data.nsapi_dl_state[nsapi_count]     = actv_nsapis[gas_id][qsh_nsapi]->dle.state;         
        metric_ptr->data.reliability_class[nsapi_count]  = actv_nsapis[gas_id][qsh_nsapi]->qos.reliability_class;
        metric_ptr->data.snpdu_tx_cnt[nsapi_count]       = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_tx_cnt;
        metric_ptr->data.snpdu_octet_tx_cnt[nsapi_count] = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_octet_tx_cnt;
        metric_ptr->data.snpdu_rx_cnt[nsapi_count]       = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_rx_cnt;
        metric_ptr->data.snpdu_octet_rx_cnt[nsapi_count] = actv_nsapis[gas_id][qsh_nsapi]->diag_pdu_stat_rsp.snpdu_octet_rx_cnt;
    ...
    for( qsh_sapi = GSN_SAPI_3; qsh_sapi < GSN_SAPI_MAX; qsh_sapi++)
    {
      if (actv_sapis[gas_id][qsh_sapi] != NULL)
      {   
        metric_ptr->data.xid_state[qsh_sapi]  = actv_sapis[gas_id][qsh_sapi]->xid_state; /* state of XID request/negotiation process */;
        metric_ptr->data.sapi_state[qsh_sapi] = actv_sapis[gas_id][qsh_sapi]->state;     /* Sate of SAPI entity */
      }
      metric_ptr->data.n201_u[qsh_sapi] = gsn_n201_u[gas_id][qsh_sapi];
      metric_ptr->data.n201_i[qsh_sapi] = gsn_n201_i[gas_id][qsh_sapi];
    }/* for */
    ...
    client_metric_done.metric_id         = GSNDCP_QSH_METRIC_DATA;
    client_metric_done.client            = QSH_CLT_GSNDCP;

    /*qsh retuns pointer to the next SNDCP metric dump loaction*/
...
FUNCTION  gsndcp_qsh_mdump_collect
...
===========================================================================*/
QSH_MDUMP_FN_ATTR void gsndcp_qsh_mdump_collect(qsh_client_cb_params_s *param)
{
  gas_id_t                 gas_id;
  gsn_nsapi_t              nsapi;
  gsn_sapi_t               sapi;
  ...
  for (gas_id = 0; gas_id < NUM_GERAN_DATA_SPACES; gas_id++)
  {
    for (nsapi = GSN_NSAPI_5; nsapi <= GSN_NSAPI_LAST; nsapi++)
    {
      if (actv_nsapis[gas_id][nsapi] != NULL)
      {
        qsh_mdump_collect_high(&actv_nsapis[gas_id][nsapi], sizeof(gsn_nsapi_e_t*));
        qsh_mdump_collect_high(actv_nsapis[gas_id][nsapi], sizeof(gsn_nsapi_e_t));
      }
    }
    
    for (sapi = GSN_SAPI_3; sapi <= GSN_SAPI_LAST; sapi++)
    {
      if (actv_sapis[gas_id][sapi] != NULL)
      {
        qsh_mdump_collect_high(&actv_sapis[gas_id][sapi], sizeof(gsn_sapi_e_t*));
        qsh_mdump_collect_high(actv_sapis[gas_id][sapi], sizeof(gsn_sapi_e_t));
      }
    }
  }

  qsh_mdump_prioritize_client(QSH_CLT_GSNDCP, QSH_CLT_GLLC);
  qsh_mdump_prioritize_client(QSH_CLT_GSNDCP, QSH_CLT_GRLCUL);
  qsh_mdump_prioritize_client(QSH_CLT_GSNDCP, QSH_CLT_GRLCDL);
  qsh_mdump_prioritize_client(QSH_CLT_GSNDCP, QSH_CLT_GMAC);
  qsh_mdump_prioritize_client(QSH_CLT_GSNDCP, QSH_CLT_GRR);
}
#endif /* FEATURE_QSH_MDUMP */
