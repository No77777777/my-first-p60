...
$Header: //components/rel/geran.mpss/7.4.0/gl2/src/l2_send.c#1 $
...
static void l2_send_ph_data_cnf(l2_store_T *l2_data_ptr, ph_data_cnf_type_t cnf_type, uint32 frame_num)
{
  ...
  gs_status = gs_send_message(geran_get_gl1_queue_id(l2_data_ptr->gas_id), &ph_data_cnf, TRUE);
...
void l2_send_ph_random_access_req(const dl_random_access_req_T *req_ptr)
{
  ...
  #error code not present
#endif /* FEATURE_QSH_EVENT_NOTIFY_HANDLER */
  gs_status = gs_send_message(geran_get_gl1_queue_id(gas_id), &ph_random_access_req, TRUE);
...
void l2_send_ph_random_access_ind(const dl_random_access_req_T *req_ptr, const boolean repeat_ind)
{
  ...
  #error code not present
#endif /* FEATURE_QSH_EVENT_NOTIFY_HANDLER */
  gs_status = gs_send_message(geran_get_gl1_queue_id(gas_id), &ph_random_access_ind, TRUE);
...
void l2_send_ph_data_req(l2_store_T *l2_data_ptr, SAPI_T sapi, channel_info_T *channel_info, byte frame_length)
{
  ...
  #error code not present
#endif /* FEATURE_QSH_EVENT_NOTIFY_HANDLER */
  gs_status = gs_send_message(geran_get_gl1_queue_id(l2_data_ptr->gas_id), &ph_data_req, TRUE);
...
void l2_send_ph_stop_sacch_measurement_report(l2_store_T *l2_data_ptr)
{
  ...
  #error code not present
#endif /* FEATURE_QSH_EVENT_NOTIFY_HANDLER */
  gs_status = gs_send_message(geran_get_gl1_queue_id(l2_data_ptr->gas_id), &ph_stop_sacch_measurement_report, TRUE);
