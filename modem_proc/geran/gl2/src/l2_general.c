...
$Header: //components/rel/geran.mpss/7.4.0/gl2/src/l2_general.c#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
void l2_clear_T200_timer(sapi_info_T *sapi_info)
{
  if (sapi_info != NULL)
  {
    gas_id_t gas_id = sapi_info->gas_id;
    ...
    MSG_GERAN_MED_1_G("Cleared T200 SAPI%1d",(int)(sapi_info->sapi));
  }
...
void l2_clear_T_ack_timer(sapi_info_T *sapi_info)
{
  if (sapi_info != NULL)
  {
    ...
    MSG_GERAN_MED_1_G("Cleared TACK SAPI%1d",(int)(sapi_info->sapi));
  }
