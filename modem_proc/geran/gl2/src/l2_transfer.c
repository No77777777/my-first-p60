...
$Header: //components/rel/geran.mpss/7.4.0/gl2/src/l2_transfer.c#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $

when       who      what, where, why
--------   ---      ----------------------------------------------------------
21/10/13   NN       CR542822 Change the L2_ASSERT_FATAL macro name for consistency
