...
$Header: //components/rel/geran.mpss/7.4.0/gdiag/inc/log_codes_gsm_v.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
#define LOG_GSM_RR_SI2QUATER_RESELECTION_PARAMETERS_C (320  + LOG_GSM_BASE_C) /* 0x5140 */
#define LOG_GSM_RR_SI2QUATER_MEASUREMENT_PARAMETERS_C (321  + LOG_GSM_BASE_C) /* 0x5141 */
#define LOG_GSM_RR_CSI_CACHE_FLUSH_DATA_C             (322  + LOG_GSM_BASE_C) /* 0x5142 */
#define LOG_GSM_RR_X2G_REDIR_CELL_LIST_C              (323  + LOG_GSM_BASE_C) /* 0x5143 */
/* ========================   GSM CS DATA PACKETS  ======================== */
