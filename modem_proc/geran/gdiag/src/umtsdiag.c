...
General Description
  ...
  target.
  Documentation: 80-V4083-2 "Serial Interface Control Document for UMTS"
...
$Header: //components/rel/geran.mpss/7.4.0/gdiag/src/umtsdiag.c#1 $
...
extern  WCDMA_AGC_LOG_PACKET_type rf_agc_log_pkt; // extern_in_c_ignore rftech_wcdma\rf\core\src\rfwcdma_core_util.c
extern  uint16 rf_agc_log_cnt;                    // extern_in_c_ignore rftech_wcdma\rf\core\src\rfwcdma_core_util.c
#endif
...
#ifndef FEATURE_WPLT
extern PACKED void * PACKED_POST cfa_diag_config_pkt (PACKED void * PACKED_POST, word); // extern_in_c_ignore  mmcp\nas\services\src\cfa_msm.c
#endif
