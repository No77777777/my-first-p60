...
$Header: //components/rel/geran.mpss/7.4.0/gmdsp6/inc/mdsp_intf_g.h#2 $
...
24/08/15    mc       CR.874662 : CXM Freq ID support for X2G startup and X2G preload
...
17/07/15    mc       CR.871205 : Incorrect CXM Channel ID assigned to W2G activities in W+W mode
...
#define NO_IQ_SCALING_IN_FTM -128 /* dBm value less than any plausible IQ scaling threshold*/
...
typedef struct
{
  ...
  uint32                         desense_id;
  uint32                         interband_monitors;
} mdsp_x2g_coex_params_type;
...
===========================================================================*/
extern void * mdsp_getcmd_buf_address(gas_id_t gas_id);
...
#ifdef FEATURE_GERAN_RF_SELF_TEST 
  /* selftest parameter interface with FTM */
  mdsp_selftest_params_type gsm_selftest_params; 
#endif /*FEATURE_GERAN_RF_SELF_TEST*/
...
extern boolean mdsp_rf_debug_NV_enable_g [NUM_GERAN_DATA_SPACES];
extern int16   mdsp_rf_debug_upper_power_limit_g[NUM_GERAN_DATA_SPACES];
extern int16   mdsp_rf_debug_lower_power_limit_g[NUM_GERAN_DATA_SPACES];
extern int8    mdsp_rf_debug_band_g[NUM_GERAN_DATA_SPACES];
extern int32   mdsp_rf_debug_arfcn_g[NUM_GERAN_DATA_SPACES];
extern boolean flag_for_fw_pwr_meas_crash[NUM_GERAN_DATA_SPACES][MDSP_MAX_STANDALONE_RSSI_MEASUREMENTS+1];
#endif
...
extern boolean mdsp_get_Parallel_SCH_log_data(
...
/*********************************************************************
One NV item 73563 used for controling GFW recovery features 
Masked bits: 
1 - crash 
0 - recover 
-------------------------------------------------------------------- 
SEQ NUM err recovery |  Rx blanking     | Acquisition  | RF timeline 
-------------------------------------------------------------------- 
T2G    TX   RX   MON |                  |     X2G   DEL| 
MON                  |                  |              |  
--------------------------------------------------------------------
32768 16384 8192 4096|2048 1024 512 256 | 128 64 32 16 | 8 4 2 1
--------------------------------------------------------------------
    1     1    1    1|   0    0   0   1 |   0  1  0  1 | x x x x     
***********************************************************************/
typedef enum
{
  GL1_GFW_RECOVERY_MON = 1,
  GL1_GFW_RECOVERY_RX,
  GL1_GFW_RECOVERY_TX,
  GL1_GFW_RECOVERY_T2G_MON
} gl1_gfw_recovery_burst_type;

//RF timeline error recovery handling
#define   GL1_GFW_RECOVER_AND_MOVE_ON  (0x05)   	
#define   GL1_GFW_CRASH_IN_FW          (0x06)
#define   GL1_GFW_CRASH_IN_SW          (0x07)   
#define   GL1_GFW_CALL_DROP            (0x08) 

//ACQ del and RX blanking recovery handling 
//crash if bits are not set, recover otherwise
#define   GL1_GFW_ACQ_DELAYED_CRASH_IN_SW          (1<<4) 
#define   GL1_GFW_X2G_ACQ_CANCEL_CRASH_IN_SW       (1<<6)
#define   GL1_GFW_RX_BLANKING_CRASH_IN_SW          (1<<8) 

//SEQ NUM err recovery
#define   GL1_GFW_SEQ_NUM_REC_MON_CRASH_IN_SW      (1<<12) 
#define   GL1_GFW_SEQ_NUM_REC_RX_CRASH_IN_SW       (1<<13)
#define   GL1_GFW_SEQ_NUM_REC_TX_CRASH_IN_SW       (1<<14) 
#define   GL1_GFW_SEQ_NUM_REC_T2G_MON_CRASH_IN_SW  (1<<15)

#define   GL1_GFW_RF_RECOVERY_NV_MASK              (0x0F) 
#define   GL1_GFW_ACQ_DEL_RECOVERY_NV_MASK         (0x30)
#define   GL1_GFW_X2G_ACQ_CANCEL_RECOVERY_NV_MASK  (0xC0)  
#define   GL1_GFW_RX_BLANKING_RECOVERY_NV_MASK     (0xF00) 

#define   GL1_GFW_SEQ_NUM_REC_MON_NV_MASK          (1<<12) 
#define   GL1_GFW_SEQ_NUM_REC_RX_NV_MASK           (1<<13)
#define   GL1_GFW_SEQ_NUM_REC_TX_NV_MASK           (1<<14) 
#define   GL1_GFW_SEQ_NUM_REC_T2G_MON_NV_MASK      (1<<15)

extern uint32 gl1_gfw_nv_recovery;
