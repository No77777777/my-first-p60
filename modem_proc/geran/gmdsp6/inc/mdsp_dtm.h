...
$Header: //components/rel/geran.mpss/7.4.0/gmdsp6/inc/mdsp_dtm.h#1 $
...
typedef struct
{
   ...
   gl1_rxd_channel_type      rxd_channel_type;
#endif
...
typedef struct
{
   ...
   boolean                   selftest_flag_to_issue_TxCmd;
...
void mdsp_dtm_tx (mdsp_dtm_tx_params_type *params, ARFCN_T arfcn, uint16 pa_index[], uint32 rf_seq_num, gas_id_t gas_id );
