...
***
*** $Header: //components/rel/geran.mpss/7.4.0/grlc/src/grlcultst.c#1 $
***
...
const grlc_diag_ul_statistics_t* grlc_diag_get_ul_statistics (gas_id_t gas_id)
{
  static grlc_diag_ul_statistics_t  temp_st[NUM_GERAN_DATA_SPACES];

  temp_st[gas_id] = ul_diag_stats_st[gas_id];
...
{
  static grlc_diag_ul_abnormal_release_counts_t   temp_st[NUM_GERAN_DATA_SPACES];

  temp_st[gas_id] = ul_diag_abn_rel_cnts_st[gas_id];
...
const grlc_diag_ul_event_counts_t* grlc_diag_get_ul_event_counts ( gas_id_t gas_id )
{
  static grlc_diag_ul_event_counts_t  temp_st[NUM_GERAN_DATA_SPACES];

  temp_st[gas_id] = ul_diag_evt_cnts_st[gas_id];
