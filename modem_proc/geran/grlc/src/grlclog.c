...
$Header: //components/rel/geran.mpss/7.4.0/grlc/src/grlclog.c#2 $
...
grlc_f3_msg_buf_t grlc_f3_msg_buf;
#endif /* FEATURE_GRLC_STORE_F3_MSG */
...
#ifdef FEATURE_QSH_MDUMP
QSH_MDUMP_FN_ATTR void grlcul_qsh_mdump_collect_buf_data(void)
{
  grlc_f3_msg_buf_t *grlcul_buf_ptr = grlc_get_f3_msg_buf_ptr();
  qsh_mdump_collect_high(grlcul_buf_ptr, sizeof(grlc_f3_msg_buf_t));
}
