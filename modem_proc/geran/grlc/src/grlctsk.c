...
***
*** $Header: //components/rel/geran.mpss/7.4.0/grlc/src/grlctsk.c#2 $
***
...
)
{
  ...
  qsh_add_thread_id(QSH_CLT_GRLCUL);
#endif
#endif
...
#ifdef FEATURE_QSH_EVENT_METRIC
      else if ( grlc_ul_task_sigs[gas_id] & GRLC_UL_QSH_SIG )
      {
        /* Handle internal uplink signal */
        grlc_ul_handle_qsh_sig(gas_id);
      }
#endif /* FEATURE_QSH_EVENT_METRIC */
...
#ifdef FEATURE_QSH_MDUMP
  qsh_add_thread_id(QSH_CLT_GRLCDL);
#endif
#endif
...
#ifdef FEATURE_QSH_EVENT_METRIC
      else if ( grlc_dl_task_sigs[gas_id] & GRLC_DL_QSH_SIG )
      {
        /* Handle internal uplink signal */
        grlc_dl_handle_qsh_sig(gas_id);
      }
#endif /* FEATURE_QSH_EVENT_METRIC */
