...
***
*** $Header: //components/rel/geran.mpss/7.4.0/grlc/src/grlcul.h#2 $
***
...
extern rex_crit_sect_type grlc_ul_procedure_crit_sec[NUM_GERAN_DATA_SPACES];
...
QSH_MDUMP_FN_ATTR
#endif
extern void grlc_ul_qsh_debug_callback (qsh_client_cb_params_s *param);
__attribute__((section(".uncompressible.text")))
extern void grlc_ul_qsh_register(void);
#endif
