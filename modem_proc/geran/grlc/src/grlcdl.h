...
***
*** $Header: //components/rel/geran.mpss/7.4.0/grlc/src/grlcdl.h#2 $
***
...
QSH_MDUMP_FN_ATTR
#endif
extern void grlc_dl_qsh_debug_callback (qsh_client_cb_params_s *param);
__attribute__((section(".uncompressible.text")))
extern void grlc_dl_qsh_register(void);
#endif
...
#define SHOW_BLOCK(b, gas_id)   show_block(b, gas_id)
#else /* FEATURE_DATA_PDU_DEBUG */
#define SHOW_BLOCK(b, gas_id)
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
extern void grlc_dl_qsh_metric_report (gas_id_t gas_id);
...
extern dl_state_t grlc_dl_get_state (gas_id_t gas_id);
