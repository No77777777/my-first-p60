...
***
*** $Header: //components/rel/geran.mpss/7.4.0/grlc/inc/grlcutil.h#1 $
***
...
#define RLC_UL_SET_QSH_SIG(gas_id)          RLC_UL_SET_SIG(gas_id, GRLC_UL_QSH_SIG)
#define RLC_UL_CLR_QSH_SIG(gas_id)          RLC_UL_CLR_SIG(gas_id, GRLC_UL_QSH_SIG)
...
#define RLC_UL_IS_QSH_SIG_SET(gas_id)         (grlc_ul_task_sigs[gas_id] & GRLC_UL_QSH_SIG)
...
#define RLC_DL_IS_QSH_SIG_SET(gas_id)           (grlc_dl_task_sigs[gas_id] & GRLC_DL_QSH_SIG)
...
#define RLC_DL_SET_QSH_SIG(gas_id)            RLC_DL_SET_SIG(gas_id, GRLC_DL_QSH_SIG)
#define RLC_DL_CLR_QSH_SIG(gas_id)            RLC_DL_CLR_SIG(gas_id, GRLC_DL_QSH_SIG)
