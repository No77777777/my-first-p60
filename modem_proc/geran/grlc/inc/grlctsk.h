...
***
*** $Header: //components/rel/geran.mpss/7.4.0/grlc/inc/grlctsk.h#1 $
***
...
/* Signal mask for the QSH callback
*/
#define GRLC_UL_QSH_SIG             0x0100UL
