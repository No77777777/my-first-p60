...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gllc/src/gllclient.c#2 $
***
...
void gmmllc_ll_put_mes( gmmllc_ll_mes_type *mes_ptr )
{
  ...
  default:
    ...
    MSG_GERAN_ERROR_1_G("GLLGMM CLIENT: Invalid Msg Id %d", mes_ptr -> mes.prim);
...
void gsmsllc_ll_put_mes( gsmsllc_ll_mes_type *mes_ptr )
{
  ...
  default:
    ...
    MSG_GERAN_ERROR_1_G("GLLSMS CLIENT: Invalid Msg Id %d", mes_ptr -> mes.prim);
