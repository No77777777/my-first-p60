...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gllc/src/gllci.h#2 $
***
...
typedef struct
{
  gllc_trace_msg_t                gllc_trace_msg_buf[100];
  byte                            gllc_trace_msg_buf_index;
  
  uint8                           *saved_cb_metric_dump_ptr;            /* Points to the current QSH metic location alloacted for LLC*/
  ...
  boolean                         gllc_qsh_metrics_capture_activate;    /* set by the metric action type rcvd from QSH*/
} gllc_debug_data_t;
...
#define GLLC_QSH_METRIC_SIG               0x20UL  
#endif                          
...
#ifdef FEATURE_DATA_PDU_DEBUG
#define GLLC_DEBUG_NUM_PRINT_LINES      45
#define GLLC_DEBUG_NUM_OCTETS_PER_LINE  12

/*===========================================================================
===
===  FUNCTION      GLLC_DEBUG_GEA_TEST()
===
===  Internal prototype.
===  Refer to gllccode.c for full description.
===
...
void gllc_debug_gea_test( gas_id_t gas_id );
...
extern void gllc_debug_print_raw_frame_content
(
  gas_id_t       gas_id,
  dsm_item_type *pdu
);
...
===  Description:
===
===  GLLC getting QSH dump data for for Dump collection action.
...
===========================================================================*/
__attribute__((section(".uncompressible.text")))
gllc_debug_data_t* gllc_get_debug_data_ptr
(
  gas_id_t  gas_id
);
