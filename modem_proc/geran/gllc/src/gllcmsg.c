...
***
*** $Header: //components/rel/geran.mpss/7.4.0/gllc/src/gllcmsg.c#2 $
***
...
void gllc_llme_send_llgmm_trigger_ind_mes( gas_id_t gas_id )
{
  ...
  if ( llgmm_dl_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent LLGMM-TRIG-IND");
...
void gllc_llme_send_llgmm_rdy_tmr_ind_mes( gas_id_t gas_id )
{
  ...
  if ( llgmm_dl_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent LLGMM-RDY-TMR-IND");
...
void gllc_llme_send_llgmm_suspend_cnf_mes( gas_id_t gas_id )
{
  ...
  if ( llgmm_dl_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent LLGMM-SUSPEND-CNF");
...
void gllc_llme_send_llgmm_new_tlli_ind_mes( gas_id_t gas_id, uint32 new_tlli )
{
  ...
  if ( llgmm_dl_mes != NULL )
  {
    MSG_GERAN_HIGH_1("GLC ME: Sent LLGMM-NEW-TLLI-IND 0x%x", new_tlli);
...
void gllc_lle_send_ll_rst_ind_mes( gas_id_t gas_id, gllc_ll_sapi_t lle, uint32 tlli )
{
  ...
  {
#if 0
    MSG_GERAN_HIGH_1_G( "GLC LL %d: Sent LL-RESET-IND",
      gllc_sapi_addr_lookup[lle]);
#endif
...
)
{
  ...
  gllc_lle_report_l2_xid_content( gas_id, MSG_LEGACY_HIGH,
...
{
  MSG_GERAN_MED_1_G("GLC LL %d: Sent DISC", gllc_sapi_addr_lookup[lle]);
...
)
{
  ...
  if ( l3_xid_req != NULL )
  {
    ...
    MSG_GERAN_HIGH_1_G( "GLC LL %d: Sent XID Cmd L3",
      gllc_sapi_addr_lookup[lle]);
  }
  else
  {
    MSG_GERAN_HIGH_1_G( "GLC LL %d: Sent XID Cmd L2",
      gllc_sapi_addr_lookup[lle]);
  }
...
{
  MSG_GERAN_HIGH_1("GLC LL %d: Sent NULL Cmd", gllc_sapi_addr_lookup[lle]);
...
)
{
  ...
  if ( l3_xid_neg != NULL )
  {
    ...
    MSG_GERAN_MED_1_G("GLC LL %d: Sent UA L3", gllc_sapi_addr_lookup[lle]);
  }
  else
  {
    MSG_GERAN_MED_1_G("GLC LL %d: Sent UA L2", gllc_sapi_addr_lookup[lle]);
  }
...
)
{
  ...
  if ( l3_xid_neg != NULL )
  {
    ...
    MSG_GERAN_HIGH_1_G( "GLC LL %d: Sent XID Res L3",
      gllc_sapi_addr_lookup[lle]);
  }
  else
  {
    MSG_GERAN_HIGH_1_G( "GLC LL %d: Sent XID Res L2",
      gllc_sapi_addr_lookup[lle]);
  }
...
)
{
  ...
  MSG_GERAN_HIGH_1_G("GLC LL %d: Sent FRMR Res", gllc_sapi_addr_lookup[lle]);
...
void gllc_llme_send_grr_suspend_req_mes( gas_id_t gas_id )
{
  ...
  if ( grr_ul_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent GRR-SUSPEND-REQ");
...
void gllc_llme_send_grr_resume_req_mes( gas_id_t gas_id )
{
  ...
  if ( grr_ul_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent GRR-RESUME-REQ");
...
void gllc_llme_send_grr_purge_suspended_data_req_mes( gas_id_t gas_id )
{
  ...
  if ( grr_ul_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent GRR-PURGE-SUSPENDED-DATA-REQ");
...
void gllc_llme_send_grr_purge_data_req_mes( gas_id_t gas_id, gllc_ll_sapi_t lle )
{
  ...
  if ( grr_ul_mes != NULL )
  {
    MSG_GERAN_HIGH_0_G( "GLC ME: Sent GRR-PURGE-DATA-REQ");
