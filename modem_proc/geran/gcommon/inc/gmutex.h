...
*/
/*==========================================================================*/
/* $Header: //components/rel/geran.mpss/7.4.0/gcommon/inc/gmutex.h#2 $ 
***
...
#define GL1_DPC_QUEUE_LOCK(A)       rex_enter_crit_sect(&gl1_dpc_queue_crit_sec[(A)]);
#define GL1_DPC_QUEUE_UNLOCK(A)     rex_leave_crit_sect(&gl1_dpc_queue_crit_sec[(A)]);
...
/* GL1 */
#define GL1_MULTI_SIM_MODE_GBTA_LOCK()        rex_enter_crit_sect(&gl1_multi_sim_mode_crit_gbta_sec)
#define GL1_MULTI_SIM_MODE_GBTA_UNLOCK()      rex_leave_crit_sect(&gl1_multi_sim_mode_crit_gbta_sec)
...
#define GRLC_UL_PROCEDURE_LOCK(gas_id)    rex_enter_crit_sect(&grlc_ul_procedure_crit_sec[gas_id])
#define GRLC_UL_PROCEDURE_UNLOCK(gas_id)  rex_leave_crit_sect(&grlc_ul_procedure_crit_sec[gas_id])
