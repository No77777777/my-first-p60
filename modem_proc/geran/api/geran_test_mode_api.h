...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/7.4.0/api/geran_test_mode_api.h#1 $
...
typedef enum
{
    GSM_ONLY_PRX_ENABLED = 0,
    GSM_ONLY_DRX_ENABLED = 1,
    GSM_BOTH_PRX_DRX_ENABLED = 2,
    GSM_NO_ACTION = 3
}RxChainType;
...
typedef struct
{
    ...
    boolean enableDrx;
    boolean enablePrx;
} geran_test_mode_api_rxd_type;

typedef struct
{
    rfm_device_enum_type  prx;
    rfm_device_enum_type  drx;
    rfm_device_enum_type  tx;
    boolean               drx_band_support[RFGSM_MAX_UNIQUE_RFCOM_BANDS];
    RxChainType   ftm_rxchain;
} geran_test_mode_api_device_type;
...
SIDE EFFECTS
  None
===========================================================================*/
void geran_test_mode_api_set_ftm_devices
(
   geran_test_mode_api_device_type devices, 
   sys_modem_as_id_e_type as_id
);

void geran_test_mode_api_set_chain_select
(
   geran_test_mode_api_device_type  devices, 
   sys_modem_as_id_e_type           as_id
);
