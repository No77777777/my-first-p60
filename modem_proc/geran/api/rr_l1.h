...
$Header: //components/rel/geran.mpss/7.4.0/api/rr_l1.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
/*,MPH_STOP_EXT_MEASUREMENTS_REQ         = 0x39 */
  ...
  ,MPH_REDUCED_NCELL_MEAS_IND            = 0x4B
...
/*,MPH_EXT_MEASUREMENT_IND               = 0xb2 */
  ...
  ,MPH_PREEMPTION_IND                    = 0xe7
  ,MPH_VOICE_SAMPLE_RATE_CHANGE_IND      = 0xe8
  ,MPH_ACQUISITION_STATE_IND             = 0xe9
  ,MPH_XMSI_UPDATE_IND                   = 0xea
  ,MPH_IDLE_COLL_FALLBACK_IND            = 0xeb
  ,MPH_RESET_IND                         = 0xfd
  ,MPH_RESET_CNF                         = 0xfe
