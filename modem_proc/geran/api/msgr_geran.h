...
enum
{
  ...
  /*  Define message  - GERAN_X2G_IRAT_CM_GSM_INIT_REQ */
  MSGR_DEFINE_UMID(GERAN, GL1 , REQ,  X2G_IRAT_CM_GSM_INIT , 0x3,
                    x2g_irat_cm_gsm_init_req_type ),

  /*  Define message  - GERAN_X2G_IRAT_CM_GSM_INIT_RSP */
  MSGR_DEFINE_UMID(GERAN, GL1 , RSP,  X2G_IRAT_CM_GSM_INIT , 0x4,
                    x2g_irat_cm_gsm_init_rsp_type ),

  MSGR_DEFINE_UMID(GERAN, GL1 , IND,  CFCM_CPU_MONITOR , 0x5,
                   cfcm_cmd_msg_type_s ),

   /*  Define message  - GERAN_GL1_QTA_STARTUP_REQ */
  MSGR_DEFINE_UMID(GERAN, GL1 , REQ,  QTA_STARTUP , 0x6,
                    geran_gl1_qta_msg_type ),

   /*  Define message  - GERAN_GL1_QTA_CLEANUP_REQ */
  MSGR_DEFINE_UMID(GERAN, GL1 , REQ,  QTA_CLEANUP , 0x7,
                    geran_gl1_qta_msg_type )
