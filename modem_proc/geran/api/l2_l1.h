...
$Header: //components/rel/geran.mpss/7.4.0/api/l2_l1.h#1 $ $DateTime: 2019/06/06 23:27:31 $ $Author: mplcsds1 $
...
/**********************************************************/
/* PH_CS_ABORT_IND primitive :                            */
/* FROM :  LAYER 1                                        */
/* TO   :  LAYER 2                                        */
/* DESCRIPTION :                                          */
/*                                                        */
/*    Message from Layer 1 to Layer 2 indicating that the */
/*    current circuit-switched connection must be aborted */
/*                                                        */
/**********************************************************/
typedef enum
{
  GL1_CS_ABORT_FOR_PREEMPTION,
  GL1_CS_ABORT_FOR_COEXISTENCE,
  GL1_CS_ABORT_UNKNOWN
} geran_abort_cause_t;

typedef struct
{
   IMH_T               message_header;
   geran_abort_cause_t l1_abort_cause;
   l2_channel_type_T   l2_channel_type;
   gas_id_t            gas_id;
} ph_cs_abort_ind_T;
