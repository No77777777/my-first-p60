...
$Header: //components/rel/geran.mpss/7.4.0/api/public/l1_ds.h#1 $
...
DESCRIPTION
  This function provides the serving cell rxlev
  
 Arguments
   as id
   
 Return value: ( void *) &gpl1_serving_cell_meas
===========================================================================*/

extern void* gl1_get_serving_cell_meas( sys_modem_as_id_e_type as_id );
