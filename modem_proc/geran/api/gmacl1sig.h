...
***
*** $Header: //components/rel/geran.mpss/7.4.0/api/gmacl1sig.h#1 $
***
...
typedef enum
{
  ...
  L1_MAC_RECOVERY_IND         = 0x09, /* Sent when state mismatch is detected at GL1*/
  L1_MAC_RECOVERY_CNF         = 0x0A, /* Sent when recovery procedure is complete */
  /**************************************************************************
...
/*************************************************************************
*   "L1_MAC_RECOVERY_IND " L1 to MAC message structure
*************************************************************************/
typedef struct
{
  gas_id_t        gas_id;
} l1_mac_recovery_ind_t;

/*************************************************************************
*   "L1_MAC_RECOVERY_CNF " L1 to MAC message structure
*************************************************************************/
typedef struct
{
  gas_id_t        gas_id;
} l1_mac_recovery_cnf_t;
