...
/* $Header: //components/rel/geran.mpss/7.4.0/api/geran_gl1_api.h#1 $ */
...
FUNCTION  gl1_is_qbta_reason

DESCRIPTION
To be used by X-tech (LTE) to query if reserved reason is a QBTA possible activity.

RETURN VALUE
TRUE if QBTA possible.
