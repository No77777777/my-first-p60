...
$Header: //components/rel/tdscdma.mpss/4.3/api/log_codes_tdscdma.h#1 $
...
#define TDSCDMA_L1_MCPM_POWER_REPORTING_LOG_PACKET               (LOG_1X_BASE_C + 0x87C)
//DRX MGR PCH PATTEN DET log packet
#define TDSCDMA_L1_DRX_PCH_PATTERN_LOG_PACKET                           (LOG_TDSL1_BASE_C + 0x75)
