...
/*===========================================================================
  ...
  $Header: //components/rel/tdscdma.mpss/4.3/api/ITDSCDMA.h#1 $
...
typedef boolean (*fn_rrc_is_tds_active_sub)(sys_modem_as_id_e_type as_id);
...
typedef boolean (*fn_tdsl2_dl_service_register_sub)
(
...
typedef boolean (*fn_tdsl2_dl_submit_datamodem_msg_sub)
(
  sys_modem_as_id_e_type as_id,
  tdsl2_dl_datamodem_api_type * cmd_ptr
);
...
typedef boolean (*fn_tdsl2_ul_service_register_sub)
(
  sys_modem_as_id_e_type as_id,
  tdsl2_ul_service_register_type *srvc_ptr
);	
...
typedef boolean (*fn_tdsl2_ul_submit_datamodem_msg_sub)
(
  sys_modem_as_id_e_type as_id,
  tdsl2_ul_datamodem_api_type * cmd_ptr
);
...
typedef rrc_rab_id_type (*fn_tdsrrc_find_rab_for_rb_in_est_rabs_sub)
(
  sys_modem_as_id_e_type as_id,
  uint8 rb_id
);
...
typedef tdsrrc_hsdpa_status_enum_type (*fn_tdsrrc_get_hsdpa_status_sub)
(
  sys_modem_as_id_e_type as_id
);
...
typedef tdsrrc_hsupa_status_enum_type (*fn_tdsrrc_get_hsupa_status_sub)
(
  sys_modem_as_id_e_type as_id
);
...
typedef tdsrrc_status_e_type (*fn_tdsrrc_return_cs_data_call_parms_sub)
( 
  sys_modem_as_id_e_type as_id,
  uint32                  rab_id,
  tdsrrc_cs_data_parms_type *cs_data_parms_ptr
...
typedef tdsrrc_rab_search_e_type (*fn_tdsrrc_return_lc_info_for_rab_sub)
(
  sys_modem_as_id_e_type as_id,
  tdsrrc_user_plane_lc_info_type *ptr
);
...
//#endif
typedef uint32 (*fn_tds_ext_audio_api) (uint32 cmd_id, void* params, uint32 size);
...
typedef void 
  (*fn_tdsrrc_get_ul_rate_info_sub)
    (
      sys_modem_as_id_e_type as_id,
      tdsrrc_ul_rate_info_type *ul_rate_info_ptr
    );
...
typedef boolean 
  (*fn_tdsrrc_get_inter_rat_bplmn_prtl_result)
    (
      sys_detailed_plmn_list_s_type *available_plmn_list
    );

typedef boolean 
  (*fn_tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id)
    (
      sys_detailed_plmn_list_s_type *available_plmn_list,
      sys_modem_as_id_e_type as_id
    );
...
typedef boolean 
  (*fn_tdsrrc_is_arfcn_valid_sub_id)
    (
      uint32 UARFCN,
      sys_modem_as_id_e_type as_id
    );
...
typedef void 
  (*fn_tdsrrc_set_ue_in_deep_sleep_sub_id)
    (
      boolean value,
      sys_modem_as_id_e_type as_id
    );

typedef tdsrrc_cell_bar_info_e_type 
  (*fn_tdsrrc_check_cell_barred_sub_id)
    (
      uint16 freq, 
      uint8 cpid, 
      sys_modem_as_id_e_type as_id
...
typedef void 
  (*fn_tdsrrc_get_classmark_change_handover_info_sub_id)
    (
      byte ** msg_ptr,    /* The command to be sent to UTRAN */
      uint8 * msg_len,    /* Length of the message           */
      boolean irat_ho_info_compressed,
...
typedef void 
  (*fn_tdsrrc_delete_classmark_change_handover_info_sub_id)
    (
      sys_modem_as_id_e_type as_id
    );

typedef void 
  (*fn_tdsrrc_update_band_preference_sub_id)
    (
      sys_band_mask_type band_pref_mask,  /* band mask */
      sys_modem_as_id_e_type  as_id
    );
...
typedef tdsrrc_rel_version_enum (*fn_tdsrrc_get_3gpp_release_version_ext)
(
  void
);

/*for Absolute priority support */
typedef boolean 
  (*fn_tdsrrc_rr_absolute_priority_support)
  (
    sys_modem_as_id_e_type tdsrrc_as_id
  );
...
typedef struct
{
  ...
  fn_rrc_is_tds_active_sub     rrc_is_tds_active_sub;
  ...
  fn_tdsl2_dl_service_register_sub		tdsl2_dl_service_register_sub;
  fn_tdsl2_dl_submit_datamodem_msg		tdsl2_dl_submit_datamodem_msg;
  fn_tdsl2_dl_submit_datamodem_msg_sub		tdsl2_dl_submit_datamodem_msg_sub;
  fn_tdsl2_ul_service_register		tdsl2_ul_service_register;
  fn_tdsl2_ul_service_register_sub		tdsl2_ul_service_register_sub;
  fn_tdsl2_ul_submit_datamodem_msg		tdsl2_ul_submit_datamodem_msg;
  fn_tdsl2_ul_submit_datamodem_msg_sub		tdsl2_ul_submit_datamodem_msg_sub;
  ...
  fn_tdsrrc_find_rab_for_rb_in_est_rabs_sub		tdsrrc_find_rab_for_rb_in_est_rabs_sub;
  ...
  fn_tdsrrc_get_hsdpa_status_sub		tdsrrc_get_hsdpa_status_sub;
  fn_tdsrrc_get_hsupa_status		tdsrrc_get_hsupa_status;
  fn_tdsrrc_get_hsupa_status_sub		tdsrrc_get_hsupa_status_sub;
  ...
  fn_tdsrrc_return_cs_data_call_parms_sub		tdsrrc_return_cs_data_call_parms_sub;
  fn_tdsrrc_return_lc_info_for_rab		tdsrrc_return_lc_info_for_rab;
  fn_tdsrrc_return_lc_info_for_rab_sub		tdsrrc_return_lc_info_for_rab_sub;
 ...
 */
  ...
  fn_tdsrrc_get_ul_rate_info_sub tdsrrc_get_ul_rate_info_sub;
...
//#endif
  fn_tds_ext_audio_api tds_ext_audio_api;
  fn_tdsrrc_get_inter_rat_bplmn_prtl_result tdsrrc_get_inter_rat_bplmn_prtl_result;
  fn_tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id;
  fn_tdsrrc_is_arfcn_valid_sub_id tdsrrc_is_arfcn_valid_sub_id;
  fn_tdsrrc_set_ue_in_deep_sleep_sub_id tdsrrc_set_ue_in_deep_sleep_sub_id;
  fn_tdsrrc_check_cell_barred_sub_id tdsrrc_check_cell_barred_sub_id;
  fn_tdsrrc_get_classmark_change_handover_info_sub_id tdsrrc_get_classmark_change_handover_info_sub_id;
  fn_tdsrrc_delete_classmark_change_handover_info_sub_id tdsrrc_delete_classmark_change_handover_info_sub_id;
  fn_tdsrrc_update_band_preference_sub_id tdsrrc_update_band_preference_sub_id;
  ...
  fn_tdsrrc_get_3gpp_release_version_ext tdsrrc_get_3gpp_release_version_ext;

  /* for external Absolute priority support*/
  fn_tdsrrc_rr_absolute_priority_support tdsrrc_rr_absolute_priority_support;
...
#define ITDSCDMA_rrc_is_tds_active_sub(pi,as_id) (TDSCDMA_vtbl(pi))->rrc_is_tds_active_sub(as_id)
...
#define ITDSCDMA_tdsl2_dl_service_register_sub(pi,as_id, srvc_ptr) (TDSCDMA_vtbl(pi))->tdsl2_dl_service_register_sub(as_id,srvc_ptr)

#define ITDSCDMA_tdsl2_dl_submit_datamodem_msg(pi, cmd_ptr) (TDSCDMA_vtbl(pi))->tdsl2_dl_submit_datamodem_msg(cmd_ptr)

#define ITDSCDMA_tdsl2_dl_submit_datamodem_msg_sub(pi,as_id, cmd_ptr) (TDSCDMA_vtbl(pi))->tdsl2_dl_submit_datamodem_msg_sub(as_id,cmd_ptr)

#define ITDSCDMA_tdsl2_ul_service_register(pi, srvc_ptr) (TDSCDMA_vtbl(pi))->tdsl2_ul_service_register(srvc_ptr)

#define ITDSCDMA_tdsl2_ul_service_register_sub(pi,as_id, srvc_ptr) (TDSCDMA_vtbl(pi))->tdsl2_ul_service_register_sub(as_id,srvc_ptr)

#define ITDSCDMA_tdsl2_ul_submit_datamodem_msg(pi, cmd_ptr) (TDSCDMA_vtbl(pi))->tdsl2_ul_submit_datamodem_msg(cmd_ptr)

#define ITDSCDMA_tdsl2_ul_submit_datamodem_msg_sub(pi,as_id, cmd_ptr) (TDSCDMA_vtbl(pi))->tdsl2_ul_submit_datamodem_msg_sub(as_id,cmd_ptr)
...
#define ITDSCDMA_tdsrrc_find_rab_for_rb_in_est_rabs_sub(pi, as_id, rb_id) (TDSCDMA_vtbl(pi))->tdsrrc_find_rab_for_rb_in_est_rabs_sub(as_id, rb_id)
...
#define ITDSCDMA_tdsrrc_get_hsdpa_status_sub(pi,as_id) (TDSCDMA_vtbl(pi))->tdsrrc_get_hsdpa_status_sub(as_id)

#define ITDSCDMA_tdsrrc_get_hsupa_status(pi) (TDSCDMA_vtbl(pi))->tdsrrc_get_hsupa_status()

#define ITDSCDMA_tdsrrc_get_hsupa_status_sub(pi,as_id) (TDSCDMA_vtbl(pi))->tdsrrc_get_hsupa_status_sub(as_id)
...
#define ITDSCDMA_tdsrrc_return_cs_data_call_parms_sub(pi,as_id, rab_id, cs_data_parms_ptr) (TDSCDMA_vtbl(pi))->tdsrrc_return_cs_data_call_parms_sub(as_id,rab_id, cs_data_parms_ptr)

#define ITDSCDMA_tdsrrc_return_lc_info_for_rab(pi, ptr) (TDSCDMA_vtbl(pi))->tdsrrc_return_lc_info_for_rab(ptr)

#define ITDSCDMA_tdsrrc_return_lc_info_for_rab_sub(pi,as_id, ptr) (TDSCDMA_vtbl(pi))->tdsrrc_return_lc_info_for_rab_sub(as_id,ptr)
...
#define ITDSCDMA_tdsrrc_get_ul_rate_info_sub(pi, as_id,ul_rate_info_ptr) \
          (TDSCDMA_vtbl(pi))->tdsrrc_get_ul_rate_info_sub(as_id,ul_rate_info_ptr)
...
#define ITDSCDMA_tds_ext_audio_api(pi, cmd_id, param, size) \
        (TDSCDMA_vtbl(pi))->tds_ext_audio_api(cmd_id, param, size)

#define ITDSCDMA_tdsrrc_get_inter_rat_bplmn_prtl_result(pi, available_plmn_list) \
        (TDSCDMA_vtbl(pi))->tdsrrc_get_inter_rat_bplmn_prtl_result(available_plmn_list)

#define ITDSCDMA_tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id(pi, available_plmn_list, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_get_inter_rat_bplmn_prtl_result_sub_id(available_plmn_list, as_id)

#define ITDSCDMA_tdsrrc_is_arfcn_valid_sub_id(pi, UARFCN, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_is_arfcn_valid_sub_id(UARFCN, as_id)

#define ITDSCDMA_tdsrrc_set_ue_in_deep_sleep_sub_id(pi, value, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_set_ue_in_deep_sleep_sub_id(value, as_id)

#define ITDSCDMA_tdsrrc_check_cell_barred_sub_id(pi, freq, cpid, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_check_cell_barred_sub_id(freq, cpid, as_id)

#define ITDSCDMA_tdsrrc_get_classmark_change_handover_info_sub_id(pi, msg_ptr, msg_len, irat_ho_info_compressed, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_get_classmark_change_handover_info_sub_id(msg_ptr, msg_len, irat_ho_info_compressed, as_id)

#define ITDSCDMA_tdsrrc_delete_classmark_change_handover_info_sub_id(pi, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_delete_classmark_change_handover_info_sub_id(as_id)

#define ITDSCDMA_tdsrrc_update_band_preference_sub_id(pi, band_pref_mask, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_update_band_preference_sub_id(band_pref_mask, as_id)

#define ITDSCDMA_tdsrrc_get_3gpp_release_version_ext(pi) \
        (TDSCDMA_vtbl(pi))->tdsrrc_get_3gpp_release_version_ext()

/*for external Absolute priority support*/
#define ITDSCDMA_tdsrrc_rr_absolute_priority_support(pi, as_id) \
        (TDSCDMA_vtbl(pi))->tdsrrc_rr_absolute_priority_support(as_id)
