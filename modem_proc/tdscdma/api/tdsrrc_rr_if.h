...
$Header: //components/rel/tdscdma.mpss/4.3/api/tdsrrc_rr_if.h#1 $   
...
typedef struct
{
  ...
  /* Indicate this G2T PLMN search is for background or foreground*/
  boolean is_foreground_search;

  /*Set the flag according to current GSM DRX count
   *True:TDS use ACQ_INV for BPLMN search
   *False:TDS use ACQ for BPLMN search
   */
...
===========================================================================*/
boolean tdsrrc_rr_absolute_priority_support
(
