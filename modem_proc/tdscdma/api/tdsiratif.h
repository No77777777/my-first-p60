...
$Header: //components/rel/tdscdma.mpss/4.3/api/tdsiratif.h#1 $ 
$DateTime: 2019/08/19 10:51:23 $ 
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
04/07/15   zl      New X2T APIs
...
typedef struct
{
  ...
  /*! This is the common RF data structure provided by source tech */
  
  rfm_meas_common_param_type *p_comm_rf_params;
  #ifdef FEATURE_RF_USES_RFM_PATH_ARCH
  /* Using RF Path IDs instead of RFM_DEVICE */
  rfm_path_type target_rf_path;
...
typedef struct
{
  ...
  tdsirat_startup_param_type  startup_params;
...
/*===========================================================================
  FUNCTION     : tdsirat_rf_enter

  DESCRIPTION: This function will call RF script enter function for X2T IRAT. 

      source tech needs to provide: 
          1) source tech RF parameters
          2) target tech device ID
  
  DEPENDENCIES:
 
  INPUT PARAMETERS: pointer to a RF common data structure.
...
extern void tdsirat_rf_enter(tdsirat_meas_rf_param_type * p_rf_comm);


/*===========================================================================
  FUNCTION     : tdsirat_rf_exit

  DESCRIPTION: This function will call RF script exit function for X2T IRAT. 
...
extern void tdsirat_rf_exit(tdsirat_meas_rf_param_type * p_rf_comm); 
