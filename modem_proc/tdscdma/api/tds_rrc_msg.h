...
$Header: //components/rel/tdscdma.mpss/4.3/api/tds_rrc_msg.h#1 $    $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
#define TDSCDMA_RRC_LTE_MAX_TDS_IRAT_ACQ_DB_FREQ 6
...
typedef struct
{
  /* Number successful irat attempts made on this uarfcn [0…255] */
  uint8 success_count;

  /* TDS uarfcn on which previous IRAT was successful */
  uint16 uarfcn;
} tds_rrc_lte_tds_irat_acq_db_entry_type;

typedef struct
{
  /* nbr of valid LTE TDS IRAT ACQ DB ENTRIES */
  uint8   acq_db_entry_count;
  tds_rrc_lte_tds_irat_acq_db_entry_type tds_irat_acq_db_entries[TDSCDMA_RRC_LTE_MAX_TDS_IRAT_ACQ_DB_FREQ];
} tds_rrc_lte_tds_irat_acq_db_list_type;
...
typedef struct
{
  ...
  /* list of TDSCDMA frequencies from LTE TDS IRAT ACQ DB */
  tds_rrc_lte_tds_irat_acq_db_list_type  tds_irat_acq_db;
