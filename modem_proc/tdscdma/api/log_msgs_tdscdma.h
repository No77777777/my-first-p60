...
$Header: //components/rel/tdscdma.mpss/4.3/api/log_msgs_tdscdma.h#1 $
...
/***************************************************************************/
/* Trace with sprintf format */
#define TDSRRC_MSG_SPRINTF_1(xx_ss_mask, xx_fmt, a)                    \
    MSG_SPRINTF_1(MSG_SSID_TDSCDMA_RRC, (xx_ss_mask), xx_fmt, a)

#define TDSRRC_MSG_SPRINTF_2(xx_ss_mask, xx_fmt, a, b)                 \
    MSG_SPRINTF_2(MSG_SSID_TDSCDMA_RRC, (xx_ss_mask), xx_fmt, a, b)

#define TDSRRC_MSG_SPRINTF_3(xx_ss_mask, xx_fmt, a, b, c)                 \
    MSG_SPRINTF_3(MSG_SSID_TDSCDMA_RRC, (xx_ss_mask), xx_fmt, a, b, c)
