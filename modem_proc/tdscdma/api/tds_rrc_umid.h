...
$Header: //components/rel/tdscdma.mpss/4.3/api/tds_rrc_umid.h#1 $    $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
/*
  ...
  >QMITOTD: Drx level req                        TDSCDMA_RRC_QMI_DRX_LEVEL_REQ
*/
enum
{
  ...
  MSGR_DEFINE_UMID(TDSCDMA,RRC,REQ,QMI_DRX_LEVEL,0x12,tds_rrc_qmi_drx_level_req_type),
};
...
/*
  ...
  >TDtoQMI: Drx level response                   TDSCDMA_RRC_QMI_DRX_LEVEL_RSP
*/
...
enum
{
  ...
  MSGR_DEFINE_UMID(TDSCDMA,RRC,RSP,QMI_DRX_LEVEL,0x10,tds_rrc_qmi_drx_level_rsp_type),
};
