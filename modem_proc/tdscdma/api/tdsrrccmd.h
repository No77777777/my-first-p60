...
$Header: //components/rel/tdscdma.mpss/4.3/api/tdsrrccmd.h#2 $    $DateTime: 2020/04/28 04:35:54 $ $Author: pwbldsvc $
...
#define TDSRRC_RR_CMD_ID_BASE 0x07000000 /* NOTE: This value should not be changed.
                                         The same value is also used in rrccmd.h */

/* Command identifier base for the commands received by RRC from WCDMA RRC */
#define TDSRRC_RRC_CMD_ID_BASE 0x0E000000 /* NOTE: This value should not be changed.
                                             The same value is also used in tdsrrccmd_v.h */
...
/*#endif*/
  ...
  TDSRRC_QSH_CB_IND = 0x010000A5,

  TDSRRC_RCE_TA_ALLOW_EXPIRED_IND = 0x010000A6,

 TDSRRC_OUT_OF_SERVICE_INTERNAL_IND = 0x010000A7,

 TDSRRC_QTA_GUARD_TIMER_EXPIRED_IND = 0x010000A8,
 
   TDSRRC_HOLD_PS_TIMER_EXPIRED_IND = 0x010000A9,

  
  TDSRRCTMR_SIB_ALL_ONE_MASK_TMR_EXPIRED_IND = 0x010000AA,
...
/*--------------------------------------------------------*/
  ...
  TDSRRC_PROCEDURE_IND = 0x05000022,
  TDSRRC_BARRING_INFO_IND = 0x05000023,

//#ifdef FEATURE_TDSCDMA_MSIM_L_PLUS_L
  TDSRRC_SUBSCRIPTION_ID_IND = 0x05000024,
//#endif
...
/**********************************************************************/
  /* RR to RRC command base. Note: starting value is TDSRRC_RR_CMD_ID_BASE */
  TDSRR_TO_RRC_BASE = TDSRRC_RR_CMD_ID_BASE,
...
/*--------------------------------------------------------*/
  ...
  TDSRRC_CMD_ID_WCDMA_RRC_PLACEHLDER_BEGIN = TDSRRC_RRC_CMD_ID_BASE,
...
/*temporary mainined */
  ...
  /* Will remove following command for TRM-U later */
 ...
 * present in the structure in ARM.*/
  ...
  /*uint64 dummyPadding;*/
 tdsrrc_barring_info_ind_type	  tdsrrc_barring_info_ind;
