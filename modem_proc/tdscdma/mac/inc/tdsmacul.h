...
$Header: //components/rel/tdscdma.mpss/4.3/mac/inc/tdsmacul.h#2 $ $DateTime: 2021/02/04 23:39:42 $ $Author: pwbldsvc $
...
typedef struct{
uint8* start_address;
qsh_metric_id_t mac_qsh_metric_id;
qsh_client_metric_context_id_t mac_qsh_metric_cntxt_id;
} tdsmac_qsh_metric_address_type;


typedef enum{
	TDSMAC_QSH_R99_METRICS_DISABLED = 0,
	TDSMAC_QSH_R99_METRICS_ENABLED = 1,	
	TDSMAC_QSH_EUL_METRICS_DISABLED = 2,
	TDSMAC_QSH_EUL_METRICS_ENABLED = 3,	
}tdsmac_qsh_status_e_type;
#endif
...
DESCRIPTION
  Registering TDS L2 MAC for QSH metrics collection with QSH
