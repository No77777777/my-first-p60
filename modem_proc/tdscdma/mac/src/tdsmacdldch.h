#ifndef TDSMACDLDCH_H
#define TDSMACDLDCH_H
...
$Header: //components/rel/tdscdma.mpss/4.3/mac/src/tdsmacdldch.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
============================================================================================*/
extern		void	tdsprocess_dl_dch_config 
(
	/* Number of DCHs */
	uint8  num_dchs,
...
==============================================================================================*/
extern	void	tdsprocess_dl_dch_tbs_hdr 
(
	/* transport Block ID */
	uint8	tb_id,
...
===============================================================================================*/
log_tdscdma_trch_type tdsmac_dl_check_dch_trch
(
