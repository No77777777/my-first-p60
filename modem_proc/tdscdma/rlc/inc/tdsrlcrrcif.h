...
$Header: //components/rel/tdscdma.mpss/4.3/rlc/inc/tdsrlcrrcif.h#1 $
...
typedef enum
{
  TDSRLC_SUCC_IND,
  TDSRLC_FAIL_IND,
  TDSRLC_TA_SUCC_MAX_ENUM
}tdsrlc_ta_success_e_type;

typedef enum
{
  TDSRLC_LTA_START_IND,
  TDSRLC_LTA_STOP_IND,
  TDSRLC_TA_IND_MAX_ENUM
}tdsrlc_ta_ind_e_type;
#endif
/*===========================================================================
**                      TYPE DECLARATIONS
**=========================================================================*/
...
#ifdef FEATURE_TDSCDMA_THROUGHPUT_OPT_AFTER_TA 
typedef struct{
  tdsrlc_ta_ind_e_type tune_away_ind;
  tdsrlc_ta_success_e_type tune_away_succ;
}tdsrlc_ta_info_type;
#endif
