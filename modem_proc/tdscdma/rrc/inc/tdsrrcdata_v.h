...
$Header: //components/rel/tdscdma.mpss/4.3/rrc/inc/tdsrrcdata_v.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  tdscdma_icommon_event_callback_fn_t rrc_tdscdma_call_open_info_cb_func;
  ...
  TDSRRC_CODEC_HO_INFO_CB_FUNC_TYPE *rrc_codec_ho_info_cb_func;
#endif
}tdsrrcdata_codec_info_type_s;
...
extern tdsrrcdata_codec_info_type_s tdsrrcdata_codec_info;
