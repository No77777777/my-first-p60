...
$Header: //components/rel/tdscdma.mpss/4.3/rrc/inc/tdsrrccmd_v.h#1 $    $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
typedef union
{
   ...
   tds_rrc_qmi_drx_level_req_type tds_rrc_qmi_drx_level_req;
