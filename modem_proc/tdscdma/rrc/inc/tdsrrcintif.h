...
$Header: //components/rel/tdscdma.mpss/4.3/rrc/inc/tdsrrcintif.h#1 $    $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
typedef union
{
  ...
  tdsl1_sib_timer_len_ind_type    sib_timer_length_ind;
} tdsl1_req_cmd;
