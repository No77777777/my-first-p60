...
$Header: //components/rel/tdscdma.mpss/4.3/rrc/inc/tdsrrccsp.h#1 $    $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
DESCRIPTION
  ...
  This function check bplmn_drx_cnt and determain which priority should be 
update 
...
===========================================================================*/
trm_reason_enum_t tdsrrcdsds_check_for_auto_bplmn_srch_priority(void);
...
DESCRIPTION
  ...
  This function check bplmn_drx_cnt and determain which activity should be 
update 
  to TDRM before T2T/X manual BPLMN search.

  T2T/X Manual BPLMN
  bplmn_drx_cnt mod 5 != 1   update " TRM_ACQUISITION_CELL_SELECT_INV "
  bplmn_drx_cnt mod 5 == 1   update " TRM_ACQUISITION_CELL_SELECT"
...
===========================================================================*/
trm_reason_enum_t tdsrrcdsds_check_for_manual_bplmn_srch_priority(void);
