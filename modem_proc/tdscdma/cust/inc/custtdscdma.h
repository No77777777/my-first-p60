...
$Header: //components/rel/tdscdma.mpss/4.3/cust/inc/custtdscdma.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
8/26/15    mkh     FEATURE_TDSCDMA_READ_RXD_NV is now moved under softcomponents
...
#define FEATURE_TDSCDMA_ATLAS_MODEM
#endif
...
//#define FEATURE_TDSCDMA_TRM_U

//#ifdef FEATURE_THOR_MODEM
//#define FEATURE_TDSCDMA_RXTX_SPLIT
//#endif
...
#define FEATURE_TDSCDMA_TO_LTE_PING_PONG_REDIR_OPT
   ...
   #define FEATURE_L2TD_REDIRECT_OPT_IRAT_ACQ_DB
...
#if defined(FEATURE_DIMEPM_MODEM) || defined(FEATURE_THOR_MODEM) || defined(FEATURE_JOLOKIA_MODEM) || defined(FEATURE_TABASCO_MODEM)
...
#if defined(FEATURE_DIMEPM_MODEM) || defined(FEATURE_BOLT_MODEM) || defined(FEATURE_JOLOKIA_MODEM) || defined(FEATURE_TABASCO_MODEM)
...
#if defined(FEATURE_TABASCO_MODEM) && !defined(FEATURE_TDSCDMA_PLT)
#define FEATURE_TDSCDMA_WLAN_COEX
#ifdef FEATURE_TDSCDMA_WLAN_COEX
#define FEATURE_TDSCDMA_DSDA
#endif
...
#if defined(FEATURE_TRITON_MODEM) || defined(FEATURE_JOLOKIA_MODEM) || defined(FEATURE_TABASCO_MODEM)
...
#if defined(T_MSM8996) && !defined(FEATURE_TDSCDMA_ATLAS)
#define FEATURE_TDSCDMA_MOTION_SENSOR_AID_MEAS_SUPPRESS
#endif

#if defined(T_MSM8996) && !defined(FEATURE_TDSCDMA_ATLAS)
#define FEATURE_TDSCDMA_EAMM_OPT
#endif
...
#if defined(FEATURE_THOR_MODEM) || defined(FEATURE_TABASCO_MODEM) || defined(FEATURE_JOLOKIA_MODEM)
#define FEATURE_TDSCDMA_RRC_REPORT_STATE_MODE_TO_MCS
#endif

#ifdef FEATURE_THOR_MODEM
#define FEATURE_TDSCDMA_NFTL
#endif /*FEATURE_THOR_MODEM*/

#define FEATURE_TDSCDMA_L1_NEW_GAP_DETECT_API

#define FEATURE_TDSCDMA_EFS_NEW_API

/*For X2T and T2X new APIs required by RF changes*/
#define FEATURE_TDSCDMA_CRAT_NEW_RF_API

#ifndef FEATURE_TDSCDMA_CRAT_NEW_RF_API
#define FEATURE_TDSCDMA_IRAT_BUILD_RF_CMD
#endif

#define FEATURE_TDSCDMA_HSUPA_UPPCH_DELAY_ONE_SUBFRAME

#define FEATURE_TDSCDMA_ADAPTIVE_T2G

//define this in soft component
//#if defined(FEATURE_THOR_MODEM)
//#define FEATURE_TDSCDMA_T2G_CPU_BOOST
//#endif

#define FEATURE_TDSCDMA_RRC_INDICATE_CODEC_TO_CM

#define FEATURE_TDSCDMA_FATAL_RECOVERY

#define FEATURE_TDSCDMA_THROUGHPUT_OPT_AFTER_TA

#ifdef FEATURE_TDSCDMA_DMO_SUPPORT
#define FEATURE_TDSCDMA_TO_LTE_FORCED_GAP
#endif

#define FEATURE_TDSCDMA_T2X_COLLIDE_WITH_SUB2_PICH_OPT

#ifdef FEATURE_TDSCDMA_ATLAS 
#define FEATURE_TDSCDMA_T2G_PARALLEL_FCCH_SCH
#endif

/*FR32505*/
#define FEATURE_TDSCDMA_T2X_BPLMN_PAGE_RATE_OPT

#if defined(FEATURE_TDSCDMA_ATLAS) || defined(FEATURE_TABASCO_MODEM) 
#define FEATURE_TDSCDMA_MCJD_IC
#endif 

#define FEATURE_TDSCDMA_USE_NO_BLOCKING_RANDOM_API

#define FEATURE_TDSCDMA_MSIM_L_PLUS_L

#ifdef FEATURE_MSGR_VARIANT
#define FEATURE_TDSCDMA_MSGR_VARIANT
#endif

#define FEATURE_TDSCDMA_GTS

#define FEATURE_TDSCDMA_ADAPTIVE_PAGE_SKIPPING
