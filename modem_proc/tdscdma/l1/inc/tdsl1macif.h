...
$Header: //components/rel/tdscdma.mpss/4.3/l1/inc/tdsl1macif.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
============================================================*/
extern void tdsl1_l2_build_copy_engine_ctrl_info
(
  uint32 hdr_len_bits,
