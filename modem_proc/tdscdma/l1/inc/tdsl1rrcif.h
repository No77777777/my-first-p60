...
$Header: //components/rel/tdscdma.mpss/4.3/l1/inc/tdsl1rrcif.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
#define TDS_PAGE_PATTERN_DETECT_HIGH_LOADING_UE_NUM 7
...
/* Define page pattern detect cause*/
typedef enum
{
   CAUSE_NONE,
   NORMAL_DETECT,
   PERIODIC_DETECT
}tdsrrc_pg_pattern_cause_enum;
/*===========================================================================
...
typedef enum
{
  ...
  /*Reason to indicate L1 that need Tx lock for change mode*/
  TDSL1_IRAT_TX_NEEDED,
  TDSL1_IRAT_NONE
...
typedef struct
{
  ...
  int16 rscp[TDSL1_MAX_MSET_LIST_NUM];  /*range [-120,-25] dbm*/
...
typedef struct 
{
  ...
  */
  uint8  *sib_sfn_bit_mask;
	/* Tell L1 if they needs to release lock during SIB gap */
...
#ifdef FEATURE_TDSCDMA_TO_LTE_PING_PONG_REDIR_OPT
  lte_rrc_irat_to_lte_redir_forbidden_earfcn_info_s *forbidden_earfch_cell_list;
#endif
...
typedef struct
{
  uint32 timer_length_ms; 
} tdsl1_sib_timer_len_ind_type;
...
===========================================================================*/
void tdsrrcwrm_update_rrc_lock_status(trm_reason_enum_t l1_reason);
...
===========================================================================*/
extern boolean tdsrrcpg1_pg_pattern_detect(tdsrrc_pg_pattern_detect_operation_enum l1_req, uint8 *detect_value_ptr,tdsrrc_pg_pattern_cause_enum detect_cause);
/*=========================================================================
FUNCTION 

DESCRIPTION
  RRC Call L1 function to indicate whehter NW with High Page Loading or not
...
SIDE EFFECTS
  None.
=========================================================================*/
void tdsdrxmgr_pch_det_patt_set_paging_load_value(uint8 high_loading_value);
...
FUNCTION  tdsl1m_rrc_abort_l1_curr_activity_cb

DESCRIPTION

  After activity based TDRM, RRC uses this function to abort L1 lock wait procedure.
...
===========================================================================*/
void tdsl1m_rrc_abort_l1_curr_activity(void);
#endif /* TDSL1INF_H */
