...
$Header: //components/rel/tdscdma.mpss/4.3/l1/inc/tdsl1macdata.h#1 $ 
...
/* FEATURE_MCAL_TDSCDMA has to be enabled */
#ifndef FEATURE_MCAL_TDSCDMA
#error "without FEATURE_MCAL_TDSCDMA"
#endif
