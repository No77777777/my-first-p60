...
$Header: //components/rel/tdscdma.mpss/4.3/l1/inc/tdsl1sapcommon.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
typedef struct
{
  /** Number of transport block set for which the data and status is to be
     transferred to L2. 
     If the feature DL_DATA_PATH_OPT is defined, field is valid
