...
$Header: //components/rel/tdscdma.mpss/4.3/l1/inc/tdsl1msgr.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
//#endif
...
#endif  
  #if (defined (FEATURE_DIMEPM_MODEM) || defined (FEATURE_JOLOKIA_MODEM)  || defined(FEATURE_TABASCO_MODEM)) && defined (FEATURE_TDSCDMA_WLAN_COEX)
  ...
  tfw_irat_t2x_cleanup_rsp_t t2x_cleanup_rsp; 
#endif
  
#ifdef FEATURE_TDSCDMA_FATAL_RECOVERY
  tfw_error_detected_ind_t error_detect_ind;
#endif

#ifdef FEATURE_TDSCDMA_MSGR_VARIANT
  mmoc_vfr_map_s_type mmoc_vfr_map_s;
#endif
