...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsl1cmmeas.h#1 $
...
//#define TDSL1CMMEAS_INVALID_FILTERED_RSRP -1
//#define TDSL1CMMEAS_INVALID_FILTERED_RSRQ -1
//-1 is not a good invalid value, it will be treated as MAX. value 
