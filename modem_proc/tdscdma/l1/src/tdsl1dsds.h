...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsl1dsds.h#1 $
...
#define TDRM_ACQ_INVERSION_TIMER_LEN_MS 400/* for TDRM use to invert acq priority for ACQ/FS */

#define TDRM_BCH_SETUP_CM_INV_TIMER_LEN_MS 1000/* for TDRM use to invert CM priority for PCCPCH setup */
...
extern boolean tdsl1_ds_extend_lock_allowed;

//#define TDSL1DS_PERIOD_OF_EXTEND_LOCK_FOR_CELL_SEL_BCH (40) // 2 BCH TTIs
//#define TDSL1DS_DURATION_OF_LOCK_FOR_CELL_SEL_BCH (60) // 2 BCH TTIs + 20 msec overhead for channel setup/drop
#endif
...
//#define TDRM_SBCH_DRX_CM_INV_TIMER_LEN_MS 6000/* for TDRM use to invert CM priority for serving cell BCH reading*/
#define TDSL1DS_PERIOD_OF_EXTEND_LOCK_FOR_BCH (40) // 2 BCH TTIs
#define TDSL1DS_DURATION_OF_LOCK_FOR_BCH_RECV (60) // 2 BCH TTIs + 20 msec overhead for channel setup/drop
...
#define TDSL1_DS_IS_PROC_FOR_SETUP(ds_proc) ((ds_proc == TDSL1_DS_PROC_SETUP_SBCH) || \
  ...
  (ds_proc == TDSL1_DS_PROC_SETUP_NBCH_IN_FACH) || (ds_proc == TDSL1_DS_PROC_SETUP_SBCH_IN_FACH))
...
#define TDSL1_DS_NONG2T_FS_PRIORITY_INVERSION_TIME_MS 400
#define TDSL1_DS_NONG2T_FS_EXTEND_DURATION_MS 15
...
extern void tdsl1_ds_post_proc_paging_decode_done(void);
extern void tdsl1_ds_set_paging_lock_status(tdsl1_ds_channel_type chnl_type, boolean lock_fail);
...
extern void tdsl1_ds_sib_prior_timer_clear(boolean b_add, boolean b_s_pccpch);
#ifdef FEATURE_TDSCDMA_LOW_SIB_PRIORITY_DUR_CELL_SEL
...
extern void tdsl1_ds_reserve_lock_during_bplmn_srch(uint32 msec_to_req);
extern boolean tdsl1_ds_req_lock_during_bplmn_srch(void);
...
extern void tdsl1dsds_secondary_client_status(boolean is_available);
/*===========================================================================
...
RETURN VALUE
  ...
  FALSE: fallabck is not triggered, running as DR-DSDS
===========================================================================*/
boolean tdsl1dsds_dual_rx_legacy_fallback_metrics_update(void);

void tdsl1dsds_dual_rx_legacy_fallback_update_pch_crc_result(uint8 crc_error, uint8 crc_total);
void tdsl1dsds_dual_rx_legacy_fallback_update_densense_glitch_result(boolean d_g_error);
...
SIDE EFFECTS
  None.
===========================================================================*/
extern int64 tdsl1dsds_get_rem_time_in_ms(uint32 rem_sclk);
/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
extern tdsl1_qta_qbta_ul_tx_data_type tdsl1dsds_ul_query_qta_gaps
(
  /* start sub frame */
...
SIDE EFFECTS
  None.
===========================================================================*/
extern boolean tdsl1_ds_request_and_notify_for_split(trm_reason_enum_t reason, uint16 duration_ms);
...
/*===========================================================================
FUNCTION  tdsl1dsds_fillup_QTA_set_state_input
...
SIDE EFFECTS
  None
===========================================================================*/
void tdsl1dsds_fillup_qta_set_state_input(trm_set_client_state_input_type *input_tds_state, boolean qta_start);
...
/*===========================================================================
FUNCTION     tdsl1_ds_sib_read_timer_cb

DESCRIPTION
  this function is to set a flag to indicate the use high priority to reading SIB in DRX state.
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_sib_read_reset_timer(uint32 timer_len);
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_sib_read_timer_cb(uint32 unused);

/*===========================================================================
FUNCTION     tdsl1_ds_sib_read_timer_cmd_handler

DESCRIPTION
  this function is to set a flag to indicate the use high priority to reading SIB in DRX state; 
  and send RnN with CM_INV reason if the timer is timeout when RnN is not get grant.
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_sib_read_timer_cmd(void);

/*===========================================================================
FUNCTION     tdsl1_ds_sib_read_clr_timer

DESCRIPTION
  this function is to clear timer for sib_read_priority_set_timer.
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_sib_read_clr_timer(void);

/*===========================================================================
FUNCTION     tdsl1_ds_acq_inv_clr_timer

DESCRIPTION
  this function is to clear timer for acq inversion
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_clr_acq_cm_inv_timer(void);
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_acq_inv_clr_timer(void);


/*===========================================================================
FUNCTION     tdsl1_ds_check_wakeup_proc

DESCRIPTION
  This function check the wakeup proc for DSDS.
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_check_wakeup_proc(void);


/*===========================================================================
FUNCTION     tdsl1_ds_get_rsn_dur_for_wakeup_proc

DESCRIPTION
  This function is to calcultate TRM lock duration and lock reason for wakeup proc
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_get_rsn_dur_for_wakeup_proc(trm_duration_t* dur_ptr, trm_reason_enum_t* rsn_ptr, trm_time_t wakeup_time);



/*===========================================================================
FUNCTION     tdsl1_ds_req_lock_block_wait

DESCRIPTION
  this function is to send RnN to TRM and blocking wait result with a timeout timer.
...
SIDE EFFECTS
  None.
===========================================================================*/
void tdsl1_ds_req_lock_block_wait
(
  /* The RF resource which is being requested */
  ...
  trm_frequency_type_t            band,

  uint32                          wait_timer_len
);
