...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdseulsg.h#1 $
...
#define TDSHSUPA_MAX_NUM_ETFCI                          ( 64 )
...
typedef struct
{
  ...
  /** beta_0_e, in unit 0.001 dB, 5 dimentation table, order are:
      ...
      <4> E-TFCI
  */
  int16 beta_0_e[TDSL1_MAX_EPUCH_TS][5][8][2][TDSHSUPA_MAX_NUM_ETFCI];
...
typedef struct
{
  ...
  uint8 epuch_timeslot[TDSL1_MAX_EPUCH_TS];
...
typedef struct
{
  ...
  uint8 num_epuch_ts;
  uint8 epuch_ts[TDSL1_MAX_EPUCH_TS];
  boolean abort_uppch;
  ...
  uint8 dpch_epuch_comm_ts[TDSL1_MAX_EPUCH_TS];
...
extern uint16 tdseulsg_cat_1_2_etfci_table[3][TDSHSUPA_MAX_NUM_ETFCI];
extern uint16 tdseulsg_cat_3_to_6_etfci_table[5][TDSHSUPA_MAX_NUM_ETFCI];
