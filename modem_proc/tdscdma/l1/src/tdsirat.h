...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsirat.h#1 $ 
...
typedef struct
{
  ...
  /*whether ACQ/MEAS cmd has been sent to FW,currently for L2T only*/
  boolean fw_cmd_sent;

  /*for RF abort script if built but not used,currently for L2T only*/
  boolean gap_aborted;
