...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsl1msetup.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
FUNCTION tdsl1msetup_check_if_QTA_conflict_with_cphy
...
SIDE EFFECTS
  None
===========================================================================*/
boolean tdsl1msetup_check_if_QTA_conflict_with_cphy(void);
