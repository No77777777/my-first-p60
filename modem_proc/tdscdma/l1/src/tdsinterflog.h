...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsinterflog.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
#define L1_WCDMA_INTERF_STEP1_SRCH_LOG_PKT L1_WCDMA_INTERF_STEP1_0x4174_SRCH_LOG_PKT
#else
...
#define L1_WCDMA_INTERF_LIST_SRCH_LOG_PKT L1_WCDMA_INTERF_LIST_0x4175_SRCH_LOG_PKT
#else
...
typedef PACKED struct PACKED_POST
{
  ...
  /* PN peaks position in Cx8 units for div chain */
  uint32 div_pn_pos_cx8;
  /* searcher energy in linear units for div chain */
  uint16 div_srch_egy;
} l1_wcdma_interf_pn_srch_task_result_log_info_struct_type;

/* L1 WCDMA inter-freq pn search task div log info */
typedef PACKED struct PACKED_POST
{
  /* Results in primary antenna valid */
  boolean prim_valid;
  /* Results in diversity antenna valid */
  boolean div_valid;
} l1_wcdma_interf_pn_srch_task_div_log_info_struct_type;
...
#define L1_WCDMA_INTERF_LOG_PN_SRCH_TASK_N_RESULT_BUF_SZ \
  (sizeof(l1_wcdma_interf_pn_srch_task_log_info_struct_type) + \
   ...
   sizeof(l1_wcdma_interf_pn_srch_task_div_log_info_struct_type))
...
LOG_RECORD_DEFINE(L1_WCDMA_INTERF_LIST_SRCH_LOG_PKT)
  ...
  PACKED struct PACKED_POST
  {
    ...
    l1_wcdma_interf_pn_srch_task_div_log_info_struct_type valid_result;
    /* task results */
    l1_wcdma_interf_pn_srch_task_result_log_info_struct_type
