...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsmathutil.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
RETURN VALUE
  tdsmath_reverse_bits

SIDE EFFECTS
  None
=========================================================================*/
extern uint32  tdsmath_reverse_bits(
  /* Original bits */
  uint32 org_bits);

/*=========================================================================

FUNCTION tdsmath_sqrt

DESCRIPTION
  This function returns the square root value (or ceiling of it) of a number.

DEPENDENCIES
  None

RETURN VALUE
  The square root (or the ceiling of it) of the input number, 
