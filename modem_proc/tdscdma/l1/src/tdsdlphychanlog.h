...
$PVCSPath:  L:/src/asw/MSM5200/l1/vcs/tdsdlphychanlog.h_v   1.9   31 May 2002 13:43:24   arao  $
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsdlphychanlog.h#1 $ $DateTime: 2019/08/19 10:51:23 $ $Author: pwbldsvc $
...
typedef PACKED struct PACKED_POST {
  ...
  per_dpch_info_struct_type dpch[TDSL1_DL_MAX_DPCH];
...
LOG_RECORD_DEFINE(WCDMA_DED_DL_PHYCHAN_LOG_PACKET)
  ...
  per_rl_info_struct_type rl[TDSL1_MAX_RL];
