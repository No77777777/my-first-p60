...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdshscfg.h#2 $
...
SIDE EFFECTS
  None
===========================================================================*/
extern tdsl1_hsdpa_setup_ops_enum_type tdshscfg_get_hsdpa_rrc_operation(void);
...
/*===========================================================================
FUNCTION tdshscfg_delay_dpa_config_handler()
...
SIDE EFFECTS
  None
===========================================================================*/
extern void tdshscfg_delay_dpa_config_handler(void);
