...
#define TDSSRCHGSMDRV_GSM_T_START_QS_PWR_SCAN(as_id) (GL1_HW_CM_X2G_STARTUP_CMD_DURATION_QS(as_id))
/* Power scan burst win size (this include RF tune + burst size) */
#define TDSSRCHGSMDRV_GSM_PWR_SCAN_BURST_MEAS_WIN_SIZE_QS(as_id) ((GL1_HW_CM_X2G_PWR_MEAS_CMD_OVERHEAD_QS(as_id)) + (TDSSRCHGSMDRV_GSM_PWR_SCAN_BURST_SIZE_QS))
...
#define TDSSRCHGSMDRV_GSM_PWR_SCAN_CNT_GAP_LEN_I(len, as_id) (((((len * 722) - 577) - \
                                               TDSSRCHGSMDRV_GSM_T_START_QS_PWR_SCAN(as_id)) - \
                                               TDSSRCHGSMDRV_GSM_T_CLEAN_QS_PWR_SCAN) / \
                                              TDSSRCHGSMDRV_GSM_PWR_SCAN_BURST_MEAS_WIN_SIZE_QS(as_id))
                                              
#define TDSSRCHGSMDRV_GSM_PWR_SCAN_CNT_GAP_LEN(len, as_id) TDSSRCHGSMDRV_GSM_PWR_SCAN_CNT_GAP_LEN_I(len, as_id)
                                             
/* T start and cleanup for FCCH detect */
#define TDSSRCHGSMDRV_GSM_T_START_QS_FCCH_DETECT(as_id) ((GL1_HW_CM_X2G_STARTUP_CMD_DURATION_QS(as_id)) + (GL1_HW_CM_X2G_ACQ_CMD_OVERHEAD_QS(as_id)))
...
#define TDSSRCHGSMDRV_GSM_T_START_QS_SCH_DEC(as_id) ((GL1_HW_CM_X2G_STARTUP_CMD_DURATION_QS(as_id)) + (GL1_HW_CM_X2G_ASYNC_RX_CMD_OVERHEAD_QS(as_id)))
...
extern gl1_hw_cm_rf_info_t tdssrchgsmdrv_gl1_rf_info;
...
#ifdef FEATURE_TDSCDMA_CRAT_NEW_RF_API
extern void tdssrchgsmdrv_t2g_rf_enter(void);
extern void tdssrchgsmdrv_t2g_rf_exit(void);
#endif
