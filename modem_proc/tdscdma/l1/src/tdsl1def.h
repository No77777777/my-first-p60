...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsl1def.h#1 $
...
typedef enum
{
  ...
  TDS_L1_HS_DELAY_DPA_CONFIG_CMD = 0x3C,

  TDSRXD_TURN_OFF_RXD_CMD           =   0x3E,
 ...
 /*Used to evaluate events 6A to 6G in DCH state when internal meas
  ...
  TDS_L1_L1M_CMD_PROCESS_DONE = 0x9B,

  TDS_L1_TDRM_TX_GRANT_CALLBACK_CMD = 0x9C,

#if defined(FEATURE_QSH_EVENT_METRIC) || defined(FEATURE_QSH_DUMP)
  TDS_L1_QSH_INFO_REPORT = 0x9D,
#endif /*FEATURE_QSH_EVENT_METRIC) || FEATURE_QSH_DUMP */

  TDS_L1_DRX_PCH_PATTERN_LOGPKT_SUBMIT = 0x9E,
  TDSRXD_CLK_PREP1_TIME_OUT_CMD = 0x9F,
  
  TDS_L1_CANCEL_CPHY_SETUP = 0xA0,
  
  TDS_L1_PENDING_CLEANUP_PROC_CMD = 0xA1,
  
  TDS_L1_X2T_FW_CMD = 0xA2,
	
  TDS_L1_TDRM_CM_INV_TIMEOUT_CMD = 0xA3,

  TDS_L1_BLIND_PSHO_DO_MEAS = 0xA4,
