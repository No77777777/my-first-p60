...
extern tdsl1_nv_e3a_threshold_opt_params_type tdsl1_e3a_threshold_opt_params;
...
__inline boolean TDSSRCHDCH_FHO_2A_RSCP_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_2A_RSCP_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_2A_TS_RSP_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_2A_TSRSP_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_2A_SIR_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_2A_SIRTARGET_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_2A_UL_POWER_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_3A_UL_TxPower_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_3A_RSCP_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_3A_RSCP_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_3A_TS_RSP_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_3A_TSRSP_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_3A_UL_POWER_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_3A_UL_TxPower_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_3A_SIR_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_3A_SIRTARGET_fast_HO_Feature_Switch;
}

__inline boolean TDSSRCHDCH_FHO_1G2A_NEW_TIMER_SWITCH(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_1G2A_TTT_earlier_fast_HO_Feature_Switch;
}

#ifdef FEATURE_TDSCDMA_REPEAT_TO_SECOND_BEST 
__inline uint8 TDSSRCHDCH_FHO_1G_REPEAT_TIMES(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_1G_MR_Repeat_Times;
}

__inline uint8 TDSSRCHDCH_FHO_2A_REPEAT_TIMES(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_2A_MR_Repeat_Times;
}
__inline uint8 TDSSRCHDCH_FHO_1G_REPEAT_CELL_NUM(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_1G_MR_Repeat_Cell_Num;
}

__inline uint8 TDSSRCHDCH_FHO_2A_REPEAT_CELL_NUM(void)
{
  return tdsl1_fast_ho_control_struct_type2.tdssrchdch_evt_2A_MR_Repeat_Cell_Num;
}
#endif
#if defined (FEATURE_TDSCDMA_E3A_THRESHOLD_OPT)
__inline int8 TDSSRCHDCH_E3A_THRESHOLD_OPT_TD(void)
{
  return tdsl1_e3a_threshold_opt_params.tdssrchgsm_e3a_opt_td_threshold;
}
__inline int8 TDSSRCHDCH_E3A_THRESHOLD_OPT_GSM(void)
{
  return tdsl1_e3a_threshold_opt_params.tdssrchgsm_e3a_opt_gsm_threshold;
}
__inline int8 TDSSRCHDCH_E3A_THRESHOLD_OPT_TD_FOR_CS_ONLY(void)
{
  return tdsl1_e3a_threshold_opt_params.tdssrchgsm_e3a_opt_td_threshold_for_CS_only;
}
__inline int8 TDSSRCHDCH_E3A_THRESHOLD_OPT_GSM_FOR_CS_ONLY(void)
{
  return tdsl1_e3a_threshold_opt_params.tdssrchgsm_e3a_opt_gsm_threshold_for_CS_only;
}
#endif
...
extern void tdssrch_blind_x2t_psho_do_meas(void);
