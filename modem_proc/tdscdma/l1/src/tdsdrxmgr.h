...
/*===========================================================================
  ...
  $Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsdrxmgr.h#1 $
...
typedef enum
{
  ...
  ** a way to wake the UE for sleep aborts. */
  ...
  TDSDRXMGR_ENTITY_IRAT_MEAS,  /* = 8*/
  TDSDRXMGR_ENTITY_ONE_INSTANCE_ONLY_MAX_TYPE = TDSDRXMGR_ENTITY_IRAT_MEAS,  
#else    
  ...
  ** say we can only have 3 at once for now. */
  TDSDRXMGR_ENTITY_ALWAYS_ACTIVE,  /* = 9 */
...
#ifdef FEATURE_TDSCDMA_T2X_COLLIDE_WITH_SUB2_PICH_OPT
/*===========================================================================
FUNCTION     DRX_MANAGER_NEXT_WAKEUP_TIME_BYPASS_HANDLE

DESCRIPTION
  This function is called to ask DRX Manager when one or more channels
  are going to wake up next.  This function will return the wakeup time of
  the channel that wants to wake up the soonest.

  At the moment, this function only supports serving cell channels.
  TODO - add support for non serving cell channels. (neighbor cell OTD shall be 
...
PARAMETERS
  next_wakeup_handle   - output the handle of earliest wake up channels .
  next_wakeup_time     - Absolute time (sub-FN/chipx8) of next wakeup.

RETURN VALUE
  int32 - Duration until next wakeup in microseconds.
===========================================================================*/
extern int32 tdsdrxmgr_next_wakeup_time_bypass_handle
(
  tdsdrxmgr_entity_handle_type bypass_handle,
  tdsdrxmgr_entity_handle_type *next_wakeup_handle,
  tdsdrxmgr_sleep_struct_type  *next_wakeup_time
);
#endif
...
#ifdef FEATURE_TDSCDMA_T2X_COLLIDE_WITH_SUB2_PICH_OPT
/*===========================================================================
FUNCTION     tdsdrxmgr_only_IRAT_entity_awake
...
RETURN VALUE
  .
===========================================================================*/
extern boolean tdsdrxmgr_only_IRAT_entity_awake(void);
#endif
/*===========================================================================
...
typedef enum
{
	...
	TDSDRXMGR_PWR_TEST_EVTS_IN_DS_MODE,    /*test the DSDS mode we disabe the flow.*/
    ...
    TDSDRXMGR_PWR_TEST_EVTS_PCH_PATTEN_NW_HIGH_LOAD, /*RRC detect NW has high loading, disable skip to avoid miss paging, restart detecting*/
		TDSDRXMGR_PWR_TEST_EVTS_PCH_PATTEN_PERIODIC_TIME_OUT,	/*180s timer expired, restart detecting*/
...
#define TDSDRXMGR_PCH_DETECT_PATT_PERIODIC_TIMER 18000 //unit 10ms


/*Seperate the PCH pattern detection state machine*/
typedef enum
{
    TDSDRXMGR_PCH_DETECT_PATT_NO_SKIP = 0,
	TDSDRXMGR_PCH_DETECT_PATT_SKIP_PI,
    TDSDRXMGR_PCH_DETECT_PATT_SKIP_PCH,
    TDSDRXMGR_PCH_DETECT_PATT_NUM_SKIP_TYPES
} tdsdrxmgr_pch_det_patt_skip_type;
...
typedef enum
{
    ...
    TDSDRXMGR_PCH_DETECT_PATT_EVTS_NW_HIGH_LOAD,
	TDSDRXMGR_PCH_DETECT_PATT_EVTS_PERIODIC_TIME_OUT,	/*180s timer expired, need restart detect*/
    TDSDRXMGR_PCH_DETECT_PATT_EVTS_IN_DS_MODE,    /*once detect no lock happen, off the FSM*/
...
typedef struct
{
    ...
    tdsdrxmgr_pch_det_patt_skip_type skip_type;
	tdsdrxmgr_pch_det_patt_skip_type last_skip_type;
	boolean not_skip;
	tdsdrxmgr_pch_det_patt_snr_filter_type filter_info;
	uint16 periodic_timer; /*180s timer to restart PCH pattern detect, counted by DRX cycle length*/
	boolean periodic_time_out; /*flag to indicate if 180s timer expired*/
    uint8 pg_rate;
...
/*===========================================================================
  FUNCTION     tdsdrxmgr_pch_det_patt_log_info
  ...
  None.
  ===========================================================================*/
void tdsdrxmgr_pch_det_patt_log_info(void);

/*===========================================================================
  FUNCTION     tdsdrxmgr_pch_det_patt_log_submit
  ...
  None.
  ===========================================================================*/
void tdsdrxmgr_pch_det_patt_log_submit(void);

/*===========================================================================
  FUNCTION     boolean tdsdrxmgr_pwr_test_is_page_detect_skip(void)
...
boolean tdsdrxmgr_pwr_test_is_page_detect_skip(void);
