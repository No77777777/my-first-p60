...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdssrchltedrv.h#1 $ DateTime: $ $Author: pwbldsvc $
...
#define TDSSRCHLTEDRV_MAX_MEAS_CELLS    LTE_CPHY_IMEAS_MAX_MEAS_CELLS //12 
//#define TDSSRCHLTEDRV_CM_MAX_NEW_DETECTED_CELLS   12
#define TDSSRCHLTEDRV_MAX_NEW_DETECTED_CELLS   LTE_CPHY_IMEAS_MAX_DETECTED_CELLS  //8
...
typedef struct
{
  ...
  boolean gap_aborted; //add for T2L abort
  /* Number of cells */
...
extern lte_cphy_irat_meas_rf_param_s tdssrchltedrv_lte_rf_setup_params;
#endif
...
/*===========================================================================
FUNCTION  TDSRCHLTEDRV_GET_DEINIT_CNF_STATE

DESCRIPTION: 
  This function returns the state of tdssrchltedrv_deinit_cnf_done flag.
...
SIDE EFFECTS
  None
===========================================================================*/
boolean tdssrchltedrv_get_deinit_cnf_state(void);
#endif
/*===========================================================================
...
#ifdef FEATURE_TDSCDMA_CRAT_NEW_RF_API
void tdssrchltedrv_proc_irat_cleanup_done(void);
#endif
