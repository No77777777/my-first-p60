...
/*===========================================================================
  ...
  $Header: //components/rel/tdscdma.mpss/4.3/l1/src/tdsdrxentity.h#1 $
...
/*===========================================================================
FUNCTION     tdsdrxentity_is_IRAT_target_entity

DESCRIPTION
  This function check and return whether tdsdrxentity_target_handle is IRAT or not.
...
RETURN VALUE
  ...
  FALSE otherwise, i.e. IRAT is not the target entity at UE wake-up.
===========================================================================*/
extern boolean tdsdrxentity_is_IRAT_target_entity(void);
#endif
