...
#define TDSSRCHGSM_CELL_BSIC_IDENTIFY_MAX_DCH 3

#define TDSSRCHGSM_CELL_BSIC_IDENTIFY_MAX_FACH 3
...
#define TDSCRHGSM_BSIC_ID_ABORT_MAX_SUBFRAME  400  
#define TDSCRHGSM_BSIC_RC_ABORT_MAX_SUBFRAME  1000  
#define TDSCRHGSM_BSIC_ABORT_PENALTY_TIMER  1000
/*define the min timer between two BSIC RC*/
#define TDSCRHGSM_BSIC_RC_DISTANCE  200  //40
...
typedef struct
{
 ...
 int16 rssi_dbmx16;
  ...
  uint16 bsic_abort_penalty_timer;
...
extern W_ARFCN_T tdssrchgsm_last_bsic_verified_arfcn;
...
extern void tdssrchgsm_bsic_verification_abort_timer_update(void);
...
extern boolean tdssrchgsm_begin_do_gsm_handler(void);
...
/*===========================================================================
FUNCTION tdssrchgsm_register_gsm_band_with_trm
...
SIDE EFFECTS
  None
===========================================================================*/
boolean tdssrchgsm_register_gsm_band_with_trm(void);
...
boolean tdssrchgsm_register_gsm_band_for_t2g_gap(trm_freq_input_type gsm_band_register
                                                 ...
                                                 #endif
                                                 , boolean is_for_prebuild
                                                 );

/*===========================================================================
FUNCTION tdssrchgsm_deregister_gsm_band_with_trm
...
SIDE EFFECTS
  None
===========================================================================*/
boolean tdssrchgsm_deregister_gsm_band_with_trm(boolean force_deregister);
...
FUNCTION     tdssrchgsm_register_gsm_band_for_t2g_prebuild

DESCRIPTION
  Register GSM band, which is to be scheduled in T2G measurement.
...
SIDE EFFECTS
  None.
===========================================================================*/
boolean tdssrchgsm_register_gsm_band_for_t2g_prebuild (void);



#ifdef FEATURE_TDSCDMA_L1M_PROFILING_LOG_PACKET
void tdssrchgsm_send_rssi_profiling_event(uint8 num_rssi, boolean is_start_event);
#endif

#ifdef FEATURE_TDSCDMA_T2G_CPU_BOOST
void tdssrchgsm_cal_boost_duration(void);
#endif
