...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/hal/mkBasedEnc/tdseulenc.h#1 $
...
typedef struct
{
  /* number of EUCCH per timeslot */
  uint16 num_eucch_slot;
} tdseul_eucch_info_type ;
#endif
...
typedef struct
{
    ...
    /* EUCCH info per timeslot */
    uint16 num_eucch_slot[TDSL1_UL_MAX_NUM_TS];
...
FUNCTION tdsedpch_data1_data2_sym

DESCRIPTION
  Calculates symbol numbers of data1 and data2 per slot for FW
...
SIDE EFFECTS
  None
=========================================================================*/
void tdsedpch_data1_data2_sym( tdseulenc_hw_cfg_parms_type * hw_cfg_ptr, mcaltds_eul_epuch_tti_info_struct_type *epuch_info_ptr );
#endif
