...
$Header: //components/rel/tdscdma.mpss/4.3/l1/src/hal/mkBasedEnc/tdsenc.h#1 $ 
...
#define ERAMA_DUMP_BUF_SIZE  10
#define WAVE_IB_DUMP_BUF_SIZE 10
#define EIB_DUMP_BUF_SIZE 10
...
extern tdsl1_ul_tx_data_type tdsenc_l1_ul_tx_buf;
...
/*=========================================================================
FUNCTION tdsenc_erucch_rmram_dump
...
SIDE EFFECTS
  None.
=========================================================================*/
void tdsenc_erucch_rmram_dump(uint32 cmd_status);
#endif /*TDSCDMA_FEATURE_UL_HWRAM_DBG*/
