...
$Header: //components/rel/rftech_lte.mpss/3.11/api/rf_control_msg.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
08/02/17   ks      Variance id changes
07/18/15   bmg     Adding Check Config version 2 message support
...
//PATLIM  rfa_rf_lte_do_hdet_req_s                rfa_rf_lte_do_hdet;  
  ...
  rfa_rf_lte_config_req_s                    rfa_rf_lte_config;
  rfa_rf_lte_config_complete_s               rfa_rf_lte_config_complete;
  rfa_rf_lte_check_config_v2_req_s           rfa_rf_lte_check_config_v2;
#endif
...
typedef enum
{
  ...
  RF_DISPATCH_SUB_ID_MISMATCH =4,
  RF_DISPATCH_INVALID_PARAM =5,
  RF_DISPATCH_MAX
