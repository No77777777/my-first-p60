...
$Header: //components/rel/rftech_lte.mpss/3.11/api/ftm_lte_common_msgr_helper_functions.h#1 $
...
*/
/*=========================================================================*/
boolean ftm_lte_build_msgr_msg(ftm_lte_payload_type *payload_ptr, ftm_msgr_u *msgr_msg_ptr, uint32 request_packet_size);
